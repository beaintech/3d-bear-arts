...
}`;function x1(n,t,e){let i=new Iu;const s=new Qt,o=new Qt,r=new Xe,a=new m1({depthPacking:Jv}),c=new g1,l={},h=e.maxTextureSize,u={[_s]:jn,[jn]:_s,[Ae]:Ae},d=new un({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Qt},radius:{value:4}},vertexShader:v1,fragmentShader:_1}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const v=new En;v.setAttribute("position",new Li(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new _(v,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Jf;let p=this.type;this.render=function(I,R,G){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||I.length===0)return;const tt=n.getRenderTarget(),M=n.getActiveCubeFace(),T=n.getActiveMipmapLevel(),U=n.state;U.setBlending(ms),U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const $=p!==ji&&this.type===ji,et=p===ji&&this.type!==ji;for(let at=0,j=I.length;at<j;at++){const nt=I[at],W=nt.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",nt,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;s.copy(W.mapSize);const gt=W.getFrameExtents();if(s.multiply(gt),o.copy(W.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(o.x=Math.floor(h/gt.x),s.x=o.x*gt.x,W.mapSize.x=o.x),s.y>h&&(o.y=Math.floor(h/gt.y),s.y=o.y*gt.y,W.mapSize.y=o.y)),W.map===null||$===!0||et===!0){const wt=this.type!==ji?{minFilter:ai,magFilter:ai}:{};W.map!==null&&W.map.dispose(),W.map=new Gs(s.x,s.y,wt),W.map.texture.name=nt.name+".shadowMap",W.camera.updateProjectionMatrix()}n.setRenderTarget(W.map),n.clear();const xt=W.getViewportCount();for(let wt=0;wt<xt;wt++){const Nt=W.getViewport(wt);r.set(o.x*Nt.x,o.y*Nt.y,o.x*Nt.z,o.y*Nt.w),U.viewport(r),W.updateMatrices(nt,wt),i=W.getFrustum(),w(R,G,W.camera,nt,this.type)}W.isPointLightShadow!==!0&&this.type===ji&&E(W,G),W.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(tt,M,T)};function E(I,R){const G=t.update(y);d.defines.VSM_SAMPLES!==I.blurSamples&&(d.defines.VSM_SAMPLES=I.blurSamples,f.defines.VSM_SAMPLES=I.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new Gs(s.x,s.y)),d.uniforms.shadow_pass.value=I.map.texture,d.uniforms.resolution.value=I.mapSize,d.uniforms.radius.value=I.radius,n.setRenderTarget(I.mapPass),n.clear(),n.renderBufferDirect(R,null,G,d,y,null),f.uniforms.shadow_pass.value=I.mapPass.texture,f.uniforms.resolution.value=I.mapSize,f.uniforms.radius.value=I.radius,n.setRenderTarget(I.map),n.clear(),n.renderBufferDirect(R,null,G,f,y,null)}function b(I,R,G,tt){let M=null;const T=G.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(T!==void 0)M=T;else if(M=G.isPointLight===!0?c:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const U=M.uuid,$=R.uuid;let et=l[U];et===void 0&&(et={},l[U]=et);let at=et[$];at===void 0&&(at=M.clone(),et[$]=at,R.addEventListener("dispose",O)),M=at}if(M.visible=R.visible,M.wireframe=R.wireframe,tt===ji?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:u[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,G.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const U=n.properties.get(M);U.light=G}return M}function w(I,R,G,tt,M){if(I.visible===!1)return;if(I.layers.test(R.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&M===ji)&&(!I.frustumCulled||i.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,I.matrixWorld);const $=t.update(I),et=I.material;if(Array.isArray(et)){const at=$.groups;for(let j=0,nt=at.length;j<nt;j++){const W=at[j],gt=et[W.materialIndex];if(gt&&gt.visible){const xt=b(I,gt,tt,M);I.onBeforeShadow(n,I,R,G,$,xt,W),n.renderBufferDirect(G,null,$,xt,I,W),I.onAfterShadow(n,I,R,G,$,xt,W)}}}else if(et.visible){const at=b(I,et,tt,M);I.onBeforeShadow(n,I,R,G,$,at,null),n.renderBufferDirect(G,null,$,at,I,null),I.onAfterShadow(n,I,R,G,$,at,null)}}const U=I.children;for(let $=0,et=U.length;$<et;$++)w(U[$],R,G,tt,M)}function O(I){I.target.removeEventListener("dispose",O);for(const G in l){const tt=l[G],M=I.target.uuid;M in tt&&(tt[M].dispose(),delete tt[M])}}}const y1={[ul]:hl,[dl]:ml,[fl]:gl,[Eo]:pl,[hl]:ul,[ml]:dl,[gl]:fl,[pl]:Eo};function M1(n){function t(){let H=!1;const Mt=new Xe;let st=null;const Q=new Xe(0,0,0,0);return{setMask:function(St){st!==St&&!H&&(n.colorMask(St,St,St,St),st=St)},setLocked:function(St){H=St},setClear:function(St,Et,Wt,ne,ie){ie===!0&&(St*=ne,Et*=ne,Wt*=ne),Mt.set(St,Et,Wt,ne),Q.equals(Mt)===!1&&(n.clearColor(St,Et,Wt,ne),Q.copy(Mt))},reset:function(){H=!1,st=null,Q.set(-1,0,0,0)}}}function e(){let H=!1,Mt=!1,st=null,Q=null,St=null;return{setReversed:function(Et){Mt=Et},setTest:function(Et){Et?Pt(n.DEPTH_TEST):B(n.DEPTH_TEST)},setMask:function(Et){st!==Et&&!H&&(n.depthMask(Et),st=Et)},setFunc:function(Et){if(Mt&&(Et=y1[Et]),Q!==Et){switch(Et){case ul:n.depthFunc(n.NEVER);break;case hl:n.depthFunc(n.ALWAYS);break;case dl:n.depthFunc(n.LESS);break;case Eo:n.depthFunc(n.LEQUAL);break;case fl:n.depthFunc(n.EQUAL);break;case pl:n.depthFunc(n.GEQUAL);break;case ml:n.depthFunc(n.GREATER);break;case gl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Q=Et}},setLocked:function(Et){H=Et},setClear:function(Et){St!==Et&&(n.clearDepth(Et),St=Et)},reset:function(){H=!1,st=null,Q=null,St=null}}}function i(){let H=!1,Mt=null,st=null,Q=null,St=null,Et=null,Wt=null,ne=null,ie=null;return{setTest:function(ce){H||(ce?Pt(n.STENCIL_TEST):B(n.STENCIL_TEST))},setMask:function(ce){Mt!==ce&&!H&&(n.stencilMask(ce),Mt=ce)},setFunc:function(ce,re,fe){(st!==ce||Q!==re||St!==fe)&&(n.stencilFunc(ce,re,fe),st=ce,Q=re,St=fe)},setOp:function(ce,re,fe){(Et!==ce||Wt!==re||ne!==fe)&&(n.stencilOp(ce,re,fe),Et=ce,Wt=re,ne=fe)},setLocked:function(ce){H=ce},setClear:function(ce){ie!==ce&&(n.clearStencil(ce),ie=ce)},reset:function(){H=!1,Mt=null,st=null,Q=null,St=null,Et=null,Wt=null,ne=null,ie=null}}}const s=new t,o=new e,r=new i,a=new WeakMap,c=new WeakMap;let l={},h={},u=new WeakMap,d=[],f=null,v=!1,y=null,m=null,p=null,E=null,b=null,w=null,O=null,I=new Me(0,0,0),R=0,G=!1,tt=null,M=null,T=null,U=null,$=null;const et=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let at=!1,j=0;const nt=n.getParameter(n.VERSION);nt.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(nt)[1]),at=j>=1):nt.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(nt)[1]),at=j>=2);let W=null,gt={};const xt=n.getParameter(n.SCISSOR_BOX),wt=n.getParameter(n.VIEWPORT),Nt=new Xe().fromArray(xt),kt=new Xe().fromArray(wt);function rt(H,Mt,st,Q){const St=new Uint8Array(4),Et=n.createTexture();n.bindTexture(H,Et),n.texParameteri(H,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(H,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Wt=0;Wt<st;Wt++)H===n.TEXTURE_3D||H===n.TEXTURE_2D_ARRAY?n.texImage3D(Mt,0,n.RGBA,1,1,Q,0,n.RGBA,n.UNSIGNED_BYTE,St):n.texImage2D(Mt+Wt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,St);return Et}const pt={};pt[n.TEXTURE_2D]=rt(n.TEXTURE_2D,n.TEXTURE_2D,1),pt[n.TEXTURE_CUBE_MAP]=rt(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),pt[n.TEXTURE_2D_ARRAY]=rt(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),pt[n.TEXTURE_3D]=rt(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),r.setClear(0),Pt(n.DEPTH_TEST),o.setFunc(Eo),D(!1),F(Lh),Pt(n.CULL_FACE),g(ms);function Pt(H){l[H]!==!0&&(n.enable(H),l[H]=!0)}function B(H){l[H]!==!1&&(n.disable(H),l[H]=!1)}function lt(H,Mt){return h[H]!==Mt?(n.bindFramebuffer(H,Mt),h[H]=Mt,H===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=Mt),H===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=Mt),!0):!1}function ot(H,Mt){let st=d,Q=!1;if(H){st=u.get(Mt),st===void 0&&(st=[],u.set(Mt,st));const St=H.textures;if(st.length!==St.length||st[0]!==n.COLOR_ATTACHMENT0){for(let Et=0,Wt=St.length;Et<Wt;Et++)st[Et]=n.COLOR_ATTACHMENT0+Et;st.length=St.length,Q=!0}}else st[0]!==n.BACK&&(st[0]=n.BACK,Q=!0);Q&&n.drawBuffers(st)}function ht(H){return f!==H?(n.useProgram(H),f=H,!0):!1}const yt={[Ds]:n.FUNC_ADD,[bv]:n.FUNC_SUBTRACT,[Ev]:n.FUNC_REVERSE_SUBTRACT};yt[Tv]=n.MIN,yt[Av]=n.MAX;const it={[Pv]:n.ZERO,[Rv]:n.ONE,[Cv]:n.SRC_COLOR,[cl]:n.SRC_ALPHA,[Fv]:n.SRC_ALPHA_SATURATE,[Uv]:n.DST_COLOR,[Lv]:n.DST_ALPHA,[Iv]:n.ONE_MINUS_SRC_COLOR,[ll]:n.ONE_MINUS_SRC_ALPHA,[Nv]:n.ONE_MINUS_DST_COLOR,[Dv]:n.ONE_MINUS_DST_ALPHA,[Ov]:n.CONSTANT_COLOR,[Bv]:n.ONE_MINUS_CONSTANT_COLOR,[zv]:n.CONSTANT_ALPHA,[Gv]:n.ONE_MINUS_CONSTANT_ALPHA};function g(H,Mt,st,Q,St,Et,Wt,ne,ie,ce){if(H===ms){v===!0&&(B(n.BLEND),v=!1);return}if(v===!1&&(Pt(n.BLEND),v=!0),H!==Sv){if(H!==y||ce!==G){if((m!==Ds||b!==Ds)&&(n.blendEquation(n.FUNC_ADD),m=Ds,b=Ds),ce)switch(H){case _o:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Dh:n.blendFunc(n.ONE,n.ONE);break;case Uh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nh:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}else switch(H){case _o:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Dh:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Uh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nh:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}p=null,E=null,w=null,O=null,I.set(0,0,0),R=0,y=H,G=ce}return}St=St||Mt,Et=Et||st,Wt=Wt||Q,(Mt!==m||St!==b)&&(n.blendEquationSeparate(yt[Mt],yt[St]),m=Mt,b=St),(st!==p||Q!==E||Et!==w||Wt!==O)&&(n.blendFuncSeparate(it[st],it[Q],it[Et],it[Wt]),p=st,E=Q,w=Et,O=Wt),(ne.equals(I)===!1||ie!==R)&&(n.blendColor(ne.r,ne.g,ne.b,ie),I.copy(ne),R=ie),y=H,G=!1}function P(H,Mt){H.side===Ae?B(n.CULL_FACE):Pt(n.CULL_FACE);let st=H.side===jn;Mt&&(st=!st),D(st),H.blending===_o&&H.transparent===!1?g(ms):g(H.blending,H.blendEquation,H.blendSrc,H.blendDst,H.blendEquationAlpha,H.blendSrcAlpha,H.blendDstAlpha,H.blendColor,H.blendAlpha,H.premultipliedAlpha),o.setFunc(H.depthFunc),o.setTest(H.depthTest),o.setMask(H.depthWrite),s.setMask(H.colorWrite);const Q=H.stencilWrite;r.setTest(Q),Q&&(r.setMask(H.stencilWriteMask),r.setFunc(H.stencilFunc,H.stencilRef,H.stencilFuncMask),r.setOp(H.stencilFail,H.stencilZFail,H.stencilZPass)),K(H.polygonOffset,H.polygonOffsetFactor,H.polygonOffsetUnits),H.alphaToCoverage===!0?Pt(n.SAMPLE_ALPHA_TO_COVERAGE):B(n.SAMPLE_ALPHA_TO_COVERAGE)}function D(H){tt!==H&&(H?n.frontFace(n.CW):n.frontFace(n.CCW),tt=H)}function F(H){H!==yv?(Pt(n.CULL_FACE),H!==M&&(H===Lh?n.cullFace(n.BACK):H===Mv?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):B(n.CULL_FACE),M=H}function N(H){H!==T&&(at&&n.lineWidth(H),T=H)}function K(H,Mt,st){H?(Pt(n.POLYGON_OFFSET_FILL),(U!==Mt||$!==st)&&(n.polygonOffset(Mt,st),U=Mt,$=st)):B(n.POLYGON_OFFSET_FILL)}function Z(H){H?Pt(n.SCISSOR_TEST):B(n.SCISSOR_TEST)}function S(H){H===void 0&&(H=n.TEXTURE0+et-1),W!==H&&(n.activeTexture(H),W=H)}function x(H,Mt,st){st===void 0&&(W===null?st=n.TEXTURE0+et-1:st=W);let Q=gt[st];Q===void 0&&(Q={type:void 0,texture:void 0},gt[st]=Q),(Q.type!==H||Q.texture!==Mt)&&(W!==st&&(n.activeTexture(st),W=st),n.bindTexture(H,Mt||pt[H]),Q.type=H,Q.texture=Mt)}function C(){const H=gt[W];H!==void 0&&H.type!==void 0&&(n.bindTexture(H.type,null),H.type=void 0,H.texture=void 0)}function Y(){try{n.compressedTexImage2D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function X(){try{n.compressedTexImage3D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function q(){try{n.texSubImage2D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ft(){try{n.texSubImage3D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ct(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function vt(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function At(){try{n.texStorage2D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function dt(){try{n.texStorage3D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function _t(){try{n.texImage2D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Dt(){try{n.texImage3D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Bt(H){Nt.equals(H)===!1&&(n.scissor(H.x,H.y,H.z,H.w),Nt.copy(H))}function It(H){kt.equals(H)===!1&&(n.viewport(H.x,H.y,H.z,H.w),kt.copy(H))}function Kt(H,Mt){let st=c.get(Mt);st===void 0&&(st=new WeakMap,c.set(Mt,st));let Q=st.get(H);Q===void 0&&(Q=n.getUniformBlockIndex(Mt,H.name),st.set(H,Q))}function Gt(H,Mt){const Q=c.get(Mt).get(H);a.get(Mt)!==Q&&(n.uniformBlockBinding(Mt,Q,H.__bindingPointIndex),a.set(Mt,Q))}function Zt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),l={},W=null,gt={},h={},u=new WeakMap,d=[],f=null,v=!1,y=null,m=null,p=null,E=null,b=null,w=null,O=null,I=new Me(0,0,0),R=0,G=!1,tt=null,M=null,T=null,U=null,$=null,Nt.set(0,0,n.canvas.width,n.canvas.height),kt.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),r.reset()}return{buffers:{color:s,depth:o,stencil:r},enable:Pt,disable:B,bindFramebuffer:lt,drawBuffers:ot,useProgram:ht,setBlending:g,setMaterial:P,setFlipSided:D,setCullFace:F,setLineWidth:N,setPolygonOffset:K,setScissorTest:Z,activeTexture:S,bindTexture:x,unbindTexture:C,compressedTexImage2D:Y,compressedTexImage3D:X,texImage2D:_t,texImage3D:Dt,updateUBOMapping:Kt,uniformBlockBinding:Gt,texStorage2D:At,texStorage3D:dt,texSubImage2D:q,texSubImage3D:ft,compressedTexSubImage2D:ct,compressedTexSubImage3D:vt,scissor:Bt,viewport:It,reset:Zt}}function Td(n,t,e,i){const s=w1(i);switch(e){case sp:return n*t;case rp:return n*t;case ap:return n*t*2;case cp:return n*t/s.components*s.byteLength;case Eu:return n*t/s.components*s.byteLength;case lp:return n*t*2/s.components*s.byteLength;case Tu:return n*t*2/s.components*s.byteLength;case op:return n*t*3/s.components*s.byteLength;case qn:return n*t*4/s.components*s.byteLength;case Au:return n*t*4/s.components*s.byteLength;case fa:case pa:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*8;case ma:case ga:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case yl:case wl:return Math.max(n,16)*Math.max(t,8)/4;case xl:case Ml:return Math.max(n,8)*Math.max(t,8)/2;case Sl:case bl:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*8;case El:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case Tl:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case Al:return Math.floor((n+4)/5)*Math.floor((t+3)/4)*16;case Pl:return Math.floor((n+4)/5)*Math.floor((t+4)/5)*16;case Rl:return Math.floor((n+5)/6)*Math.floor((t+4)/5)*16;case Cl:return Math.floor((n+5)/6)*Math.floor((t+5)/6)*16;case Il:return Math.floor((n+7)/8)*Math.floor((t+4)/5)*16;case Ll:return Math.floor((n+7)/8)*Math.floor((t+5)/6)*16;case Dl:return Math.floor((n+7)/8)*Math.floor((t+7)/8)*16;case Ul:return Math.floor((n+9)/10)*Math.floor((t+4)/5)*16;case Nl:return Math.floor((n+9)/10)*Math.floor((t+5)/6)*16;case Fl:return Math.floor((n+9)/10)*Math.floor((t+7)/8)*16;case Ol:return Math.floor((n+9)/10)*Math.floor((t+9)/10)*16;case Bl:return Math.floor((n+11)/12)*Math.floor((t+9)/10)*16;case zl:return Math.floor((n+11)/12)*Math.floor((t+11)/12)*16;case va:case Gl:case Hl:return Math.ceil(n/4)*Math.ceil(t/4)*16;case up:case kl:return Math.ceil(n/4)*Math.ceil(t/4)*8;case Vl:case Wl:return Math.ceil(n/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function w1(n){switch(n){case ts:case ep:return{byteLength:1,components:1};case pr:case np:case Sr:return{byteLength:2,components:1};case Su:case bu:return{byteLength:2,components:4};case zs:case wu:case Ki:return{byteLength:4,components:1};case ip:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function S1(n,t,e,i,s,o,r){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Qt,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(S,x){return f?new OffscreenCanvas(S,x):gr("canvas")}function y(S,x,C){let Y=1;const X=Z(S);if((X.width>C||X.height>C)&&(Y=C/Math.max(X.width,X.height)),Y<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const q=Math.floor(Y*X.width),ft=Math.floor(Y*X.height);u===void 0&&(u=v(q,ft));const ct=x?v(q,ft):u;return ct.width=q,ct.height=ft,ct.getContext("2d").drawImage(S,0,0,q,ft),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+X.width+"x"+X.height+") to ("+q+"x"+ft+")."),ct}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+X.width+"x"+X.height+")."),S;return S}function m(S){return S.generateMipmaps&&S.minFilter!==ai&&S.minFilter!==xi}function p(S){n.generateMipmap(S)}function E(S,x,C,Y,X=!1){if(S!==null){if(n[S]!==void 0)return n[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let q=x;if(x===n.RED&&(C===n.FLOAT&&(q=n.R32F),C===n.HALF_FLOAT&&(q=n.R16F),C===n.UNSIGNED_BYTE&&(q=n.R8)),x===n.RED_INTEGER&&(C===n.UNSIGNED_BYTE&&(q=n.R8UI),C===n.UNSIGNED_SHORT&&(q=n.R16UI),C===n.UNSIGNED_INT&&(q=n.R32UI),C===n.BYTE&&(q=n.R8I),C===n.SHORT&&(q=n.R16I),C===n.INT&&(q=n.R32I)),x===n.RG&&(C===n.FLOAT&&(q=n.RG32F),C===n.HALF_FLOAT&&(q=n.RG16F),C===n.UNSIGNED_BYTE&&(q=n.RG8)),x===n.RG_INTEGER&&(C===n.UNSIGNED_BYTE&&(q=n.RG8UI),C===n.UNSIGNED_SHORT&&(q=n.RG16UI),C===n.UNSIGNED_INT&&(q=n.RG32UI),C===n.BYTE&&(q=n.RG8I),C===n.SHORT&&(q=n.RG16I),C===n.INT&&(q=n.RG32I)),x===n.RGB_INTEGER&&(C===n.UNSIGNED_BYTE&&(q=n.RGB8UI),C===n.UNSIGNED_SHORT&&(q=n.RGB16UI),C===n.UNSIGNED_INT&&(q=n.RGB32UI),C===n.BYTE&&(q=n.RGB8I),C===n.SHORT&&(q=n.RGB16I),C===n.INT&&(q=n.RGB32I)),x===n.RGBA_INTEGER&&(C===n.UNSIGNED_BYTE&&(q=n.RGBA8UI),C===n.UNSIGNED_SHORT&&(q=n.RGBA16UI),C===n.UNSIGNED_INT&&(q=n.RGBA32UI),C===n.BYTE&&(q=n.RGBA8I),C===n.SHORT&&(q=n.RGBA16I),C===n.INT&&(q=n.RGBA32I)),x===n.RGB&&C===n.UNSIGNED_INT_5_9_9_9_REV&&(q=n.RGB9_E5),x===n.RGBA){const ft=X?Aa:Be.getTransfer(Y);C===n.FLOAT&&(q=n.RGBA32F),C===n.HALF_FLOAT&&(q=n.RGBA16F),C===n.UNSIGNED_BYTE&&(q=ft===nn?n.SRGB8_ALPHA8:n.RGBA8),C===n.UNSIGNED_SHORT_4_4_4_4&&(q=n.RGBA4),C===n.UNSIGNED_SHORT_5_5_5_1&&(q=n.RGB5_A1)}return(q===n.R16F||q===n.R32F||q===n.RG16F||q===n.RG32F||q===n.RGBA16F||q===n.RGBA32F)&&t.get("EXT_color_buffer_float"),q}function b(S,x){let C;return S?x===null||x===zs||x===Po?C=n.DEPTH24_STENCIL8:x===Ki?C=n.DEPTH32F_STENCIL8:x===pr&&(C=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===zs||x===Po?C=n.DEPTH_COMPONENT24:x===Ki?C=n.DEPTH_COMPONENT32F:x===pr&&(C=n.DEPTH_COMPONENT16),C}function w(S,x){return m(S)===!0||S.isFramebufferTexture&&S.minFilter!==ai&&S.minFilter!==xi?Math.log2(Math.max(x.width,x.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?x.mipmaps.length:1}function O(S){const x=S.target;x.removeEventListener("dispose",O),R(x),x.isVideoTexture&&h.delete(x)}function I(S){const x=S.target;x.removeEventListener("dispose",I),tt(x)}function R(S){const x=i.get(S);if(x.__webglInit===void 0)return;const C=S.source,Y=d.get(C);if(Y){const X=Y[x.__cacheKey];X.usedTimes--,X.usedTimes===0&&G(S),Object.keys(Y).length===0&&d.delete(C)}i.remove(S)}function G(S){const x=i.get(S);n.deleteTexture(x.__webglTexture);const C=S.source,Y=d.get(C);delete Y[x.__cacheKey],r.memory.textures--}function tt(S){const x=i.get(S);if(S.depthTexture&&S.depthTexture.dispose(),S.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(x.__webglFramebuffer[Y]))for(let X=0;X<x.__webglFramebuffer[Y].length;X++)n.deleteFramebuffer(x.__webglFramebuffer[Y][X]);else n.deleteFramebuffer(x.__webglFramebuffer[Y]);x.__webglDepthbuffer&&n.deleteRenderbuffer(x.__webglDepthbuffer[Y])}else{if(Array.isArray(x.__webglFramebuffer))for(let Y=0;Y<x.__webglFramebuffer.length;Y++)n.deleteFramebuffer(x.__webglFramebuffer[Y]);else n.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&n.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&n.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let Y=0;Y<x.__webglColorRenderbuffer.length;Y++)x.__webglColorRenderbuffer[Y]&&n.deleteRenderbuffer(x.__webglColorRenderbuffer[Y]);x.__webglDepthRenderbuffer&&n.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const C=S.textures;for(let Y=0,X=C.length;Y<X;Y++){const q=i.get(C[Y]);q.__webglTexture&&(n.deleteTexture(q.__webglTexture),r.memory.textures--),i.remove(C[Y])}i.remove(S)}let M=0;function T(){M=0}function U(){const S=M;return S>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),M+=1,S}function $(S){const x=[];return x.push(S.wrapS),x.push(S.wrapT),x.push(S.wrapR||0),x.push(S.magFilter),x.push(S.minFilter),x.push(S.anisotropy),x.push(S.internalFormat),x.push(S.format),x.push(S.type),x.push(S.generateMipmaps),x.push(S.premultiplyAlpha),x.push(S.flipY),x.push(S.unpackAlignment),x.push(S.colorSpace),x.join()}function et(S,x){const C=i.get(S);if(S.isVideoTexture&&N(S),S.isRenderTargetTexture===!1&&S.version>0&&C.__version!==S.version){const Y=S.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{kt(C,S,x);return}}e.bindTexture(n.TEXTURE_2D,C.__webglTexture,n.TEXTURE0+x)}function at(S,x){const C=i.get(S);if(S.version>0&&C.__version!==S.version){kt(C,S,x);return}e.bindTexture(n.TEXTURE_2D_ARRAY,C.__webglTexture,n.TEXTURE0+x)}function j(S,x){const C=i.get(S);if(S.version>0&&C.__version!==S.version){kt(C,S,x);return}e.bindTexture(n.TEXTURE_3D,C.__webglTexture,n.TEXTURE0+x)}function nt(S,x){const C=i.get(S);if(S.version>0&&C.__version!==S.version){rt(C,S,x);return}e.bindTexture(n.TEXTURE_CUBE_MAP,C.__webglTexture,n.TEXTURE0+x)}const W={[Qe]:n.REPEAT,[Ns]:n.CLAMP_TO_EDGE,[_l]:n.MIRRORED_REPEAT},gt={[ai]:n.NEAREST,[Kv]:n.NEAREST_MIPMAP_NEAREST,[Nr]:n.NEAREST_MIPMAP_LINEAR,[xi]:n.LINEAR,[pc]:n.LINEAR_MIPMAP_NEAREST,[Ci]:n.LINEAR_MIPMAP_LINEAR},xt={[t_]:n.NEVER,[r_]:n.ALWAYS,[e_]:n.LESS,[dp]:n.LEQUAL,[n_]:n.EQUAL,[o_]:n.GEQUAL,[i_]:n.GREATER,[s_]:n.NOTEQUAL};function wt(S,x){if(x.type===Ki&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===xi||x.magFilter===pc||x.magFilter===Nr||x.magFilter===Ci||x.minFilter===xi||x.minFilter===pc||x.minFilter===Nr||x.minFilter===Ci)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(S,n.TEXTURE_WRAP_S,W[x.wrapS]),n.texParameteri(S,n.TEXTURE_WRAP_T,W[x.wrapT]),(S===n.TEXTURE_3D||S===n.TEXTURE_2D_ARRAY)&&n.texParameteri(S,n.TEXTURE_WRAP_R,W[x.wrapR]),n.texParameteri(S,n.TEXTURE_MAG_FILTER,gt[x.magFilter]),n.texParameteri(S,n.TEXTURE_MIN_FILTER,gt[x.minFilter]),x.compareFunction&&(n.texParameteri(S,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(S,n.TEXTURE_COMPARE_FUNC,xt[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===ai||x.minFilter!==Nr&&x.minFilter!==Ci||x.type===Ki&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){const C=t.get("EXT_texture_filter_anisotropic");n.texParameterf(S,C.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function Nt(S,x){let C=!1;S.__webglInit===void 0&&(S.__webglInit=!0,x.addEventListener("dispose",O));const Y=x.source;let X=d.get(Y);X===void 0&&(X={},d.set(Y,X));const q=$(x);if(q!==S.__cacheKey){X[q]===void 0&&(X[q]={texture:n.createTexture(),usedTimes:0},r.memory.textures++,C=!0),X[q].usedTimes++;const ft=X[S.__cacheKey];ft!==void 0&&(X[S.__cacheKey].usedTimes--,ft.usedTimes===0&&G(x)),S.__cacheKey=q,S.__webglTexture=X[q].texture}return C}function kt(S,x,C){let Y=n.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(Y=n.TEXTURE_2D_ARRAY),x.isData3DTexture&&(Y=n.TEXTURE_3D);const X=Nt(S,x),q=x.source;e.bindTexture(Y,S.__webglTexture,n.TEXTURE0+C);const ft=i.get(q);if(q.version!==ft.__version||X===!0){e.activeTexture(n.TEXTURE0+C);const ct=Be.getPrimaries(Be.workingColorSpace),vt=x.colorSpace===ps?null:Be.getPrimaries(x.colorSpace),At=x.colorSpace===ps||ct===vt?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,At);let dt=y(x.image,!1,s.maxTextureSize);dt=K(x,dt);const _t=o.convert(x.format,x.colorSpace),Dt=o.convert(x.type);let Bt=E(x.internalFormat,_t,Dt,x.colorSpace,x.isVideoTexture);wt(Y,x);let It;const Kt=x.mipmaps,Gt=x.isVideoTexture!==!0,Zt=ft.__version===void 0||X===!0,H=q.dataReady,Mt=w(x,dt);if(x.isDepthTexture)Bt=b(x.format===Ro,x.type),Zt&&(Gt?e.texStorage2D(n.TEXTURE_2D,1,Bt,dt.width,dt.height):e.texImage2D(n.TEXTURE_2D,0,Bt,dt.width,dt.height,0,_t,Dt,null));else if(x.isDataTexture)if(Kt.length>0){Gt&&Zt&&e.texStorage2D(n.TEXTURE_2D,Mt,Bt,Kt[0].width,Kt[0].height);for(let st=0,Q=Kt.length;st<Q;st++)It=Kt[st],Gt?H&&e.texSubImage2D(n.TEXTURE_2D,st,0,0,It.width,It.height,_t,Dt,It.data):e.texImage2D(n.TEXTURE_2D,st,Bt,It.width,It.height,0,_t,Dt,It.data);x.generateMipmaps=!1}else Gt?(Zt&&e.texStorage2D(n.TEXTURE_2D,Mt,Bt,dt.width,dt.height),H&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,dt.width,dt.height,_t,Dt,dt.data)):e.texImage2D(n.TEXTURE_2D,0,Bt,dt.width,dt.height,0,_t,Dt,dt.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Gt&&Zt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,Mt,Bt,Kt[0].width,Kt[0].height,dt.depth);for(let st=0,Q=Kt.length;st<Q;st++)if(It=Kt[st],x.format!==qn)if(_t!==null)if(Gt){if(H)if(x.layerUpdates.size>0){const St=Td(It.width,It.height,x.format,x.type);for(const Et of x.layerUpdates){const Wt=It.data.subarray(Et*St/It.data.BYTES_PER_ELEMENT,(Et+1)*St/It.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,st,0,0,Et,It.width,It.height,1,_t,Wt,0,0)}x.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,st,0,0,0,It.width,It.height,dt.depth,_t,It.data,0,0)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,st,Bt,It.width,It.height,dt.depth,0,It.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Gt?H&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,st,0,0,0,It.width,It.height,dt.depth,_t,Dt,It.data):e.texImage3D(n.TEXTURE_2D_ARRAY,st,Bt,It.width,It.height,dt.depth,0,_t,Dt,It.data)}else{Gt&&Zt&&e.texStorage2D(n.TEXTURE_2D,Mt,Bt,Kt[0].width,Kt[0].height);for(let st=0,Q=Kt.length;st<Q;st++)It=Kt[st],x.format!==qn?_t!==null?Gt?H&&e.compressedTexSubImage2D(n.TEXTURE_2D,st,0,0,It.width,It.height,_t,It.data):e.compressedTexImage2D(n.TEXTURE_2D,st,Bt,It.width,It.height,0,It.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Gt?H&&e.texSubImage2D(n.TEXTURE_2D,st,0,0,It.width,It.height,_t,Dt,It.data):e.texImage2D(n.TEXTURE_2D,st,Bt,It.width,It.height,0,_t,Dt,It.data)}else if(x.isDataArrayTexture)if(Gt){if(Zt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,Mt,Bt,dt.width,dt.height,dt.depth),H)if(x.layerUpdates.size>0){const st=Td(dt.width,dt.height,x.format,x.type);for(const Q of x.layerUpdates){const St=dt.data.subarray(Q*st/dt.data.BYTES_PER_ELEMENT,(Q+1)*st/dt.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,Q,dt.width,dt.height,1,_t,Dt,St)}x.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,dt.width,dt.height,dt.depth,_t,Dt,dt.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,Bt,dt.width,dt.height,dt.depth,0,_t,Dt,dt.data);else if(x.isData3DTexture)Gt?(Zt&&e.texStorage3D(n.TEXTURE_3D,Mt,Bt,dt.width,dt.height,dt.depth),H&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,dt.width,dt.height,dt.depth,_t,Dt,dt.data)):e.texImage3D(n.TEXTURE_3D,0,Bt,dt.width,dt.height,dt.depth,0,_t,Dt,dt.data);else if(x.isFramebufferTexture){if(Zt)if(Gt)e.texStorage2D(n.TEXTURE_2D,Mt,Bt,dt.width,dt.height);else{let st=dt.width,Q=dt.height;for(let St=0;St<Mt;St++)e.texImage2D(n.TEXTURE_2D,St,Bt,st,Q,0,_t,Dt,null),st>>=1,Q>>=1}}else if(Kt.length>0){if(Gt&&Zt){const st=Z(Kt[0]);e.texStorage2D(n.TEXTURE_2D,Mt,Bt,st.width,st.height)}for(let st=0,Q=Kt.length;st<Q;st++)It=Kt[st],Gt?H&&e.texSubImage2D(n.TEXTURE_2D,st,0,0,_t,Dt,It):e.texImage2D(n.TEXTURE_2D,st,Bt,_t,Dt,It);x.generateMipmaps=!1}else if(Gt){if(Zt){const st=Z(dt);e.texStorage2D(n.TEXTURE_2D,Mt,Bt,st.width,st.height)}H&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,_t,Dt,dt)}else e.texImage2D(n.TEXTURE_2D,0,Bt,_t,Dt,dt);m(x)&&p(Y),ft.__version=q.version,x.onUpdate&&x.onUpdate(x)}S.__version=x.version}function rt(S,x,C){if(x.image.length!==6)return;const Y=Nt(S,x),X=x.source;e.bindTexture(n.TEXTURE_CUBE_MAP,S.__webglTexture,n.TEXTURE0+C);const q=i.get(X);if(X.version!==q.__version||Y===!0){e.activeTexture(n.TEXTURE0+C);const ft=Be.getPrimaries(Be.workingColorSpace),ct=x.colorSpace===ps?null:Be.getPrimaries(x.colorSpace),vt=x.colorSpace===ps||ft===ct?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,vt);const At=x.isCompressedTexture||x.image[0].isCompressedTexture,dt=x.image[0]&&x.image[0].isDataTexture,_t=[];for(let Q=0;Q<6;Q++)!At&&!dt?_t[Q]=y(x.image[Q],!0,s.maxCubemapSize):_t[Q]=dt?x.image[Q].image:x.image[Q],_t[Q]=K(x,_t[Q]);const Dt=_t[0],Bt=o.convert(x.format,x.colorSpace),It=o.convert(x.type),Kt=E(x.internalFormat,Bt,It,x.colorSpace),Gt=x.isVideoTexture!==!0,Zt=q.__version===void 0||Y===!0,H=X.dataReady;let Mt=w(x,Dt);wt(n.TEXTURE_CUBE_MAP,x);let st;if(At){Gt&&Zt&&e.texStorage2D(n.TEXTURE_CUBE_MAP,Mt,Kt,Dt.width,Dt.height);for(let Q=0;Q<6;Q++){st=_t[Q].mipmaps;for(let St=0;St<st.length;St++){const Et=st[St];x.format!==qn?Bt!==null?Gt?H&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,St,0,0,Et.width,Et.height,Bt,Et.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,St,Kt,Et.width,Et.height,0,Et.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Gt?H&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,St,0,0,Et.width,Et.height,Bt,It,Et.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,St,Kt,Et.width,Et.height,0,Bt,It,Et.data)}}}else{if(st=x.mipmaps,Gt&&Zt){st.length>0&&Mt++;const Q=Z(_t[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,Mt,Kt,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(dt){Gt?H&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,_t[Q].width,_t[Q].height,Bt,It,_t[Q].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Kt,_t[Q].width,_t[Q].height,0,Bt,It,_t[Q].data);for(let St=0;St<st.length;St++){const Wt=st[St].image[Q].image;Gt?H&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,St+1,0,0,Wt.width,Wt.height,Bt,It,Wt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,St+1,Kt,Wt.width,Wt.height,0,Bt,It,Wt.data)}}else{Gt?H&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Bt,It,_t[Q]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,Kt,Bt,It,_t[Q]);for(let St=0;St<st.length;St++){const Et=st[St];Gt?H&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,St+1,0,0,Bt,It,Et.image[Q]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+Q,St+1,Kt,Bt,It,Et.image[Q])}}}m(x)&&p(n.TEXTURE_CUBE_MAP),q.__version=X.version,x.onUpdate&&x.onUpdate(x)}S.__version=x.version}function pt(S,x,C,Y,X,q){const ft=o.convert(C.format,C.colorSpace),ct=o.convert(C.type),vt=E(C.internalFormat,ft,ct,C.colorSpace);if(!i.get(x).__hasExternalTextures){const dt=Math.max(1,x.width>>q),_t=Math.max(1,x.height>>q);X===n.TEXTURE_3D||X===n.TEXTURE_2D_ARRAY?e.texImage3D(X,q,vt,dt,_t,x.depth,0,ft,ct,null):e.texImage2D(X,q,vt,dt,_t,0,ft,ct,null)}e.bindFramebuffer(n.FRAMEBUFFER,S),F(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Y,X,i.get(C).__webglTexture,0,D(x)):(X===n.TEXTURE_2D||X>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&X<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Y,X,i.get(C).__webglTexture,q),e.bindFramebuffer(n.FRAMEBUFFER,null)}function Pt(S,x,C){if(n.bindRenderbuffer(n.RENDERBUFFER,S),x.depthBuffer){const Y=x.depthTexture,X=Y&&Y.isDepthTexture?Y.type:null,q=b(x.stencilBuffer,X),ft=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ct=D(x);F(x)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ct,q,x.width,x.height):C?n.renderbufferStorageMultisample(n.RENDERBUFFER,ct,q,x.width,x.height):n.renderbufferStorage(n.RENDERBUFFER,q,x.width,x.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ft,n.RENDERBUFFER,S)}else{const Y=x.textures;for(let X=0;X<Y.length;X++){const q=Y[X],ft=o.convert(q.format,q.colorSpace),ct=o.convert(q.type),vt=E(q.internalFormat,ft,ct,q.colorSpace),At=D(x);C&&F(x)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,At,vt,x.width,x.height):F(x)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,At,vt,x.width,x.height):n.renderbufferStorage(n.RENDERBUFFER,vt,x.width,x.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function B(S,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,S),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),et(x.depthTexture,0);const Y=i.get(x.depthTexture).__webglTexture,X=D(x);if(x.depthTexture.format===xo)F(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Y,0,X):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Y,0);else if(x.depthTexture.format===Ro)F(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Y,0,X):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Y,0);else throw new Error("Unknown depthTexture format")}function lt(S){const x=i.get(S),C=S.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==S.depthTexture){const Y=S.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),Y){const X=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,Y.removeEventListener("dispose",X)};Y.addEventListener("dispose",X),x.__depthDisposeCallback=X}x.__boundDepthTexture=Y}if(S.depthTexture&&!x.__autoAllocateDepthBuffer){if(C)throw new Error("target.depthTexture not supported in Cube render targets");B(x.__webglFramebuffer,S)}else if(C){x.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(e.bindFramebuffer(n.FRAMEBUFFER,x.__webglFramebuffer[Y]),x.__webglDepthbuffer[Y]===void 0)x.__webglDepthbuffer[Y]=n.createRenderbuffer(),Pt(x.__webglDepthbuffer[Y],S,!1);else{const X=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,q=x.__webglDepthbuffer[Y];n.bindRenderbuffer(n.RENDERBUFFER,q),n.framebufferRenderbuffer(n.FRAMEBUFFER,X,n.RENDERBUFFER,q)}}else if(e.bindFramebuffer(n.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=n.createRenderbuffer(),Pt(x.__webglDepthbuffer,S,!1);else{const Y=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,X=x.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,X),n.framebufferRenderbuffer(n.FRAMEBUFFER,Y,n.RENDERBUFFER,X)}e.bindFramebuffer(n.FRAMEBUFFER,null)}function ot(S,x,C){const Y=i.get(S);x!==void 0&&pt(Y.__webglFramebuffer,S,S.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),C!==void 0&&lt(S)}function ht(S){const x=S.texture,C=i.get(S),Y=i.get(x);S.addEventListener("dispose",I);const X=S.textures,q=S.isWebGLCubeRenderTarget===!0,ft=X.length>1;if(ft||(Y.__webglTexture===void 0&&(Y.__webglTexture=n.createTexture()),Y.__version=x.version,r.memory.textures++),q){C.__webglFramebuffer=[];for(let ct=0;ct<6;ct++)if(x.mipmaps&&x.mipmaps.length>0){C.__webglFramebuffer[ct]=[];for(let vt=0;vt<x.mipmaps.length;vt++)C.__webglFramebuffer[ct][vt]=n.createFramebuffer()}else C.__webglFramebuffer[ct]=n.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){C.__webglFramebuffer=[];for(let ct=0;ct<x.mipmaps.length;ct++)C.__webglFramebuffer[ct]=n.createFramebuffer()}else C.__webglFramebuffer=n.createFramebuffer();if(ft)for(let ct=0,vt=X.length;ct<vt;ct++){const At=i.get(X[ct]);At.__webglTexture===void 0&&(At.__webglTexture=n.createTexture(),r.memory.textures++)}if(S.samples>0&&F(S)===!1){C.__webglMultisampledFramebuffer=n.createFramebuffer(),C.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,C.__webglMultisampledFramebuffer);for(let ct=0;ct<X.length;ct++){const vt=X[ct];C.__webglColorRenderbuffer[ct]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,C.__webglColorRenderbuffer[ct]);const At=o.convert(vt.format,vt.colorSpace),dt=o.convert(vt.type),_t=E(vt.internalFormat,At,dt,vt.colorSpace,S.isXRRenderTarget===!0),Dt=D(S);n.renderbufferStorageMultisample(n.RENDERBUFFER,Dt,_t,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ct,n.RENDERBUFFER,C.__webglColorRenderbuffer[ct])}n.bindRenderbuffer(n.RENDERBUFFER,null),S.depthBuffer&&(C.__webglDepthRenderbuffer=n.createRenderbuffer(),Pt(C.__webglDepthRenderbuffer,S,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(q){e.bindTexture(n.TEXTURE_CUBE_MAP,Y.__webglTexture),wt(n.TEXTURE_CUBE_MAP,x);for(let ct=0;ct<6;ct++)if(x.mipmaps&&x.mipmaps.length>0)for(let vt=0;vt<x.mipmaps.length;vt++)pt(C.__webglFramebuffer[ct][vt],S,x,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ct,vt);else pt(C.__webglFramebuffer[ct],S,x,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ct,0);m(x)&&p(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ft){for(let ct=0,vt=X.length;ct<vt;ct++){const At=X[ct],dt=i.get(At);e.bindTexture(n.TEXTURE_2D,dt.__webglTexture),wt(n.TEXTURE_2D,At),pt(C.__webglFramebuffer,S,At,n.COLOR_ATTACHMENT0+ct,n.TEXTURE_2D,0),m(At)&&p(n.TEXTURE_2D)}e.unbindTexture()}else{let ct=n.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ct=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(ct,Y.__webglTexture),wt(ct,x),x.mipmaps&&x.mipmaps.length>0)for(let vt=0;vt<x.mipmaps.length;vt++)pt(C.__webglFramebuffer[vt],S,x,n.COLOR_ATTACHMENT0,ct,vt);else pt(C.__webglFramebuffer,S,x,n.COLOR_ATTACHMENT0,ct,0);m(x)&&p(ct),e.unbindTexture()}S.depthBuffer&&lt(S)}function yt(S){const x=S.textures;for(let C=0,Y=x.length;C<Y;C++){const X=x[C];if(m(X)){const q=S.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ft=i.get(X).__webglTexture;e.bindTexture(q,ft),p(q),e.unbindTexture()}}}const it=[],g=[];function P(S){if(S.samples>0){if(F(S)===!1){const x=S.textures,C=S.width,Y=S.height;let X=n.COLOR_BUFFER_BIT;const q=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ft=i.get(S),ct=x.length>1;if(ct)for(let vt=0;vt<x.length;vt++)e.bindFramebuffer(n.FRAMEBUFFER,ft.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+vt,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,ft.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+vt,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,ft.__webglMultisampledFramebuffer),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ft.__webglFramebuffer);for(let vt=0;vt<x.length;vt++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(X|=n.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(X|=n.STENCIL_BUFFER_BIT)),ct){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ft.__webglColorRenderbuffer[vt]);const At=i.get(x[vt]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,At,0)}n.blitFramebuffer(0,0,C,Y,0,0,C,Y,X,n.NEAREST),c===!0&&(it.length=0,g.length=0,it.push(n.COLOR_ATTACHMENT0+vt),S.depthBuffer&&S.resolveDepthBuffer===!1&&(it.push(q),g.push(q),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,g)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,it))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ct)for(let vt=0;vt<x.length;vt++){e.bindFramebuffer(n.FRAMEBUFFER,ft.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+vt,n.RENDERBUFFER,ft.__webglColorRenderbuffer[vt]);const At=i.get(x[vt]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,ft.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+vt,n.TEXTURE_2D,At,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ft.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&c){const x=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[x])}}}function D(S){return Math.min(s.maxSamples,S.samples)}function F(S){const x=i.get(S);return S.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function N(S){const x=r.render.frame;h.get(S)!==x&&(h.set(S,x),S.update())}function K(S,x){const C=S.colorSpace,Y=S.format,X=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||C!==Ms&&C!==ps&&(Be.getTransfer(C)===nn?(Y!==qn||X!==ts)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",C)),x}function Z(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(l.width=S.naturalWidth||S.width,l.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(l.width=S.displayWidth,l.height=S.displayHeight):(l.width=S.width,l.height=S.height),l}this.allocateTextureUnit=U,this.resetTextureUnits=T,this.setTexture2D=et,this.setTexture2DArray=at,this.setTexture3D=j,this.setTextureCube=nt,this.rebindTextures=ot,this.setupRenderTarget=ht,this.updateRenderTargetMipmap=yt,this.updateMultisampleRenderTarget=P,this.setupDepthRenderbuffer=lt,this.setupFrameBufferTexture=pt,this.useMultisampledRTT=F}function b1(n,t){function e(i,s=ps){let o;const r=Be.getTransfer(s);if(i===ts)return n.UNSIGNED_BYTE;if(i===Su)return n.UNSIGNED_SHORT_4_4_4_4;if(i===bu)return n.UNSIGNED_SHORT_5_5_5_1;if(i===ip)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===ep)return n.BYTE;if(i===np)return n.SHORT;if(i===pr)return n.UNSIGNED_SHORT;if(i===wu)return n.INT;if(i===zs)return n.UNSIGNED_INT;if(i===Ki)return n.FLOAT;if(i===Sr)return n.HALF_FLOAT;if(i===sp)return n.ALPHA;if(i===op)return n.RGB;if(i===qn)return n.RGBA;if(i===rp)return n.LUMINANCE;if(i===ap)return n.LUMINANCE_ALPHA;if(i===xo)return n.DEPTH_COMPONENT;if(i===Ro)return n.DEPTH_STENCIL;if(i===cp)return n.RED;if(i===Eu)return n.RED_INTEGER;if(i===lp)return n.RG;if(i===Tu)return n.RG_INTEGER;if(i===Au)return n.RGBA_INTEGER;if(i===fa||i===pa||i===ma||i===ga)if(r===nn)if(o=t.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(i===fa)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===pa)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ma)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ga)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=t.get("WEBGL_compressed_texture_s3tc"),o!==null){if(i===fa)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===pa)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ma)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ga)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===xl||i===yl||i===Ml||i===wl)if(o=t.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(i===xl)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===yl)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ml)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===wl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Sl||i===bl||i===El)if(o=t.get("WEBGL_compressed_texture_etc"),o!==null){if(i===Sl||i===bl)return r===nn?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(i===El)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Tl||i===Al||i===Pl||i===Rl||i===Cl||i===Il||i===Ll||i===Dl||i===Ul||i===Nl||i===Fl||i===Ol||i===Bl||i===zl)if(o=t.get("WEBGL_compressed_texture_astc"),o!==null){if(i===Tl)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Al)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Pl)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Rl)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Cl)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Il)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Ll)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Dl)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Ul)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Nl)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Fl)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Ol)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Bl)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===zl)return r===nn?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===va||i===Gl||i===Hl)if(o=t.get("EXT_texture_compression_bptc"),o!==null){if(i===va)return r===nn?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Gl)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Hl)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===up||i===kl||i===Vl||i===Wl)if(o=t.get("EXT_texture_compression_rgtc"),o!==null){if(i===va)return o.COMPRESSED_RED_RGTC1_EXT;if(i===kl)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Vl)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Wl)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Po?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}class E1 extends Ke{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Xt extends wn{constructor(){super(),this.isGroup=!0,this.type="Group"}}const T1={type:"move"};class kc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Xt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Xt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new J,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new J),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Xt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new J,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new J),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const i of t.hand.values())this._getHandJoint(e,i)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,i){let s=null,o=null,r=null;const a=this._targetRay,c=this._grip,l=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(l&&t.hand){r=!0;for(const y of t.hand.values()){const m=e.getJointPose(y,i),p=this._getHandJoint(l,y);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const h=l.joints["index-finger-tip"],u=l.joints["thumb-tip"],d=h.position.distanceTo(u.position),f=.02,v=.005;l.inputState.pinching&&d>f+v?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!l.inputState.pinching&&d<=f-v&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(o=e.getPose(t.gripSpace,i),o!==null&&(c.matrix.fromArray(o.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,o.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(o.linearVelocity)):c.hasLinearVelocity=!1,o.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(o.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=e.getPose(t.targetRaySpace,i),s===null&&o!==null&&(s=o),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(T1)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=o!==null),l!==null&&(l.visible=r!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const i=new Xt;i.matrixAutoUpdate=!1,i.visible=!1,t.joints[e.jointName]=i,t.add(i)}return t.joints[e.jointName]}}const A1=`
void main() {
...
}`;class R1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,i){if(this.texture===null){const s=new In,o=t.properties.get(s);o.__webglTexture=e.texture,(e.depthNear!=i.depthNear||e.depthFar!=i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,i=new un({vertexShader:A1,fragmentShader:P1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new _(new Ka(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class C1 extends Lo{constructor(t,e){super();const i=this;let s=null,o=1,r=null,a="local-floor",c=1,l=null,h=null,u=null,d=null,f=null,v=null;const y=new R1,m=e.getContextAttributes();let p=null,E=null;const b=[],w=[],O=new Qt;let I=null;const R=new Ke;R.layers.enable(1),R.viewport=new Xe;const G=new Ke;G.layers.enable(2),G.viewport=new Xe;const tt=[R,G],M=new E1;M.layers.enable(1),M.layers.enable(2);let T=null,U=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(rt){let pt=b[rt];return pt===void 0&&(pt=new kc,b[rt]=pt),pt.getTargetRaySpace()},this.getControllerGrip=function(rt){let pt=b[rt];return pt===void 0&&(pt=new kc,b[rt]=pt),pt.getGripSpace()},this.getHand=function(rt){let pt=b[rt];return pt===void 0&&(pt=new kc,b[rt]=pt),pt.getHandSpace()};function $(rt){const pt=w.indexOf(rt.inputSource);if(pt===-1)return;const Pt=b[pt];Pt!==void 0&&(Pt.update(rt.inputSource,rt.frame,l||r),Pt.dispatchEvent({type:rt.type,data:rt.inputSource}))}function et(){s.removeEventListener("select",$),s.removeEventListener("selectstart",$),s.removeEventListener("selectend",$),s.removeEventListener("squeeze",$),s.removeEventListener("squeezestart",$),s.removeEventListener("squeezeend",$),s.removeEventListener("end",et),s.removeEventListener("inputsourceschange",at);for(let rt=0;rt<b.length;rt++){const pt=w[rt];pt!==null&&(w[rt]=null,b[rt].disconnect(pt))}T=null,U=null,y.reset(),t.setRenderTarget(p),f=null,d=null,u=null,s=null,E=null,kt.stop(),i.isPresenting=!1,t.setPixelRatio(I),t.setSize(O.width,O.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(rt){o=rt,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(rt){a=rt,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||r},this.setReferenceSpace=function(rt){l=rt},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return u},this.getFrame=function(){return v},this.getSession=function(){return s},this.setSession=async function(rt){if(s=rt,s!==null){if(p=t.getRenderTarget(),s.addEventListener("select",$),s.addEventListener("selectstart",$),s.addEventListener("selectend",$),s.addEventListener("squeeze",$),s.addEventListener("squeezestart",$),s.addEventListener("squeezeend",$),s.addEventListener("end",et),s.addEventListener("inputsourceschange",at),m.xrCompatible!==!0&&await e.makeXRCompatible(),I=t.getPixelRatio(),t.getSize(O),s.renderState.layers===void 0){const pt={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:o};f=new XRWebGLLayer(s,e,pt),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),E=new Gs(f.framebufferWidth,f.framebufferHeight,{format:qn,type:ts,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil})}else{let pt=null,Pt=null,B=null;m.depth&&(B=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,pt=m.stencil?Ro:xo,Pt=m.stencil?Po:zs);const lt={colorFormat:e.RGBA8,depthFormat:B,scaleFactor:o};u=new XRWebGLBinding(s,e),d=u.createProjectionLayer(lt),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),E=new Gs(d.textureWidth,d.textureHeight,{format:qn,type:ts,depthTexture:new Ep(d.textureWidth,d.textureHeight,Pt,void 0,void 0,void 0,void 0,void 0,void 0,pt),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(c),l=null,r=await s.requestReferenceSpace(a),kt.setContext(s),kt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function at(rt){for(let pt=0;pt<rt.removed.length;pt++){const Pt=rt.removed[pt],B=w.indexOf(Pt);B>=0&&(w[B]=null,b[B].disconnect(Pt))}for(let pt=0;pt<rt.added.length;pt++){const Pt=rt.added[pt];let B=w.indexOf(Pt);if(B===-1){for(let ot=0;ot<b.length;ot++)if(ot>=w.length){w.push(Pt),B=ot;break}else if(w[ot]===null){w[ot]=Pt,B=ot;break}if(B===-1)break}const lt=b[B];lt&&lt.connect(Pt)}}const j=new J,nt=new J;function W(rt,pt,Pt){j.setFromMatrixPosition(pt.matrixWorld),nt.setFromMatrixPosition(Pt.matrixWorld);const B=j.distanceTo(nt),lt=pt.projectionMatrix.elements,ot=Pt.projectionMatrix.elements,ht=lt[14]/(lt[10]-1),yt=lt[14]/(lt[10]+1),it=(lt[9]+1)/lt[5],g=(lt[9]-1)/lt[5],P=(lt[8]-1)/lt[0],D=(ot[8]+1)/ot[0],F=ht*P,N=ht*D,K=B/(-P+D),Z=K*-P;if(pt.matrixWorld.decompose(rt.position,rt.quaternion,rt.scale),rt.translateX(Z),rt.translateZ(K),rt.matrixWorld.compose(rt.position,rt.quaternion,rt.scale),rt.matrixWorldInverse.copy(rt.matrixWorld).invert(),lt[10]===-1)rt.projectionMatrix.copy(pt.projectionMatrix),rt.projectionMatrixInverse.copy(pt.projectionMatrixInverse);else{const S=ht+K,x=yt+K,C=F-Z,Y=N+(B-Z),X=it*yt/x*S,q=g*yt/x*S;rt.projectionMatrix.makePerspective(C,Y,X,q,S,x),rt.projectionMatrixInverse.copy(rt.projectionMatrix).invert()}}function gt(rt,pt){pt===null?rt.matrixWorld.copy(rt.matrix):rt.matrixWorld.multiplyMatrices(pt.matrixWorld,rt.matrix),rt.matrixWorldInverse.copy(rt.matrixWorld).invert()}this.updateCamera=function(rt){if(s===null)return;let pt=rt.near,Pt=rt.far;y.texture!==null&&(y.depthNear>0&&(pt=y.depthNear),y.depthFar>0&&(Pt=y.depthFar)),M.near=G.near=R.near=pt,M.far=G.far=R.far=Pt,(T!==M.near||U!==M.far)&&(s.updateRenderState({depthNear:M.near,depthFar:M.far}),T=M.near,U=M.far);const B=rt.parent,lt=M.cameras;gt(M,B);for(let ot=0;ot<lt.length;ot++)gt(lt[ot],B);lt.length===2?W(M,R,G):M.projectionMatrix.copy(R.projectionMatrix),xt(rt,M,B)};function xt(rt,pt,Pt){Pt===null?rt.matrix.copy(pt.matrixWorld):(rt.matrix.copy(Pt.matrixWorld),rt.matrix.invert(),rt.matrix.multiply(pt.matrixWorld)),rt.matrix.decompose(rt.position,rt.quaternion,rt.scale),rt.updateMatrixWorld(!0),rt.projectionMatrix.copy(pt.projectionMatrix),rt.projectionMatrixInverse.copy(pt.projectionMatrixInverse),rt.isPerspectiveCamera&&(rt.fov=mr*2*Math.atan(1/rt.projectionMatrix.elements[5]),rt.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(d===null&&f===null))return c},this.setFoveation=function(rt){c=rt,d!==null&&(d.fixedFoveation=rt),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=rt)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(M)};let wt=null;function Nt(rt,pt){if(h=pt.getViewerPose(l||r),v=pt,h!==null){const Pt=h.views;f!==null&&(t.setRenderTargetFramebuffer(E,f.framebuffer),t.setRenderTarget(E));let B=!1;Pt.length!==M.cameras.length&&(M.cameras.length=0,B=!0);for(let ot=0;ot<Pt.length;ot++){const ht=Pt[ot];let yt=null;if(f!==null)yt=f.getViewport(ht);else{const g=u.getViewSubImage(d,ht);yt=g.viewport,ot===0&&(t.setRenderTargetTextures(E,g.colorTexture,d.ignoreDepthValues?void 0:g.depthStencilTexture),t.setRenderTarget(E))}let it=tt[ot];it===void 0&&(it=new Ke,it.layers.enable(ot),it.viewport=new Xe,tt[ot]=it),it.matrix.fromArray(ht.transform.matrix),it.matrix.decompose(it.position,it.quaternion,it.scale),it.projectionMatrix.fromArray(ht.projectionMatrix),it.projectionMatrixInverse.copy(it.projectionMatrix).invert(),it.viewport.set(yt.x,yt.y,yt.width,yt.height),ot===0&&(M.matrix.copy(it.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),B===!0&&M.cameras.push(it)}const lt=s.enabledFeatures;if(lt&&lt.includes("depth-sensing")){const ot=u.getDepthInformation(Pt[0]);ot&&ot.isValid&&ot.texture&&y.init(t,ot,s.renderState)}}for(let Pt=0;Pt<b.length;Pt++){const B=w[Pt],lt=b[Pt];B!==null&&lt!==void 0&&lt.update(B,pt,l||r)}wt&&wt(rt,pt),pt.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:pt}),v=null}const kt=new Sp;kt.setAnimationLoop(Nt),this.setAnimationLoop=function(rt){wt=rt},this.dispose=function(){}}}const Rs=new Ui,I1=new sn;function L1(n,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,Mp(n)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,E,b,w){p.isMeshBasicMaterial||p.isMeshLambertMaterial?o(m,p):p.isMeshToonMaterial?(o(m,p),u(m,p)):p.isMeshPhongMaterial?(o(m,p),h(m,p)):p.isMeshStandardMaterial?(o(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,w)):p.isMeshMatcapMaterial?(o(m,p),v(m,p)):p.isMeshDepthMaterial?o(m,p):p.isMeshDistanceMaterial?(o(m,p),y(m,p)):p.isMeshNormalMaterial?o(m,p):p.isLineBasicMaterial?(r(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?c(m,p,E,b):p.isSpriteMaterial?l(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function o(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===jn&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===jn&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const E=t.get(p),b=E.envMap,w=E.envMapRotation;b&&(m.envMap.value=b,Rs.copy(w),Rs.x*=-1,Rs.y*=-1,Rs.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Rs.y*=-1,Rs.z*=-1),m.envMapRotation.value.setFromMatrix4(I1.makeRotationFromEuler(Rs)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function r(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function c(m,p,E,b){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*E,m.scale.value=b*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function l(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function u(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,E){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===jn&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function v(m,p){p.matcap&&(m.matcap.value=p.matcap)}function y(m,p){const E=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function D1(n,t,e,i){let s={},o={},r=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function c(E,b){const w=b.program;i.uniformBlockBinding(E,w)}function l(E,b){let w=s[E.id];w===void 0&&(v(E),w=h(E),s[E.id]=w,E.addEventListener("dispose",m));const O=b.program;i.updateUBOMapping(E,O);const I=t.render.frame;o[E.id]!==I&&(d(E),o[E.id]=I)}function h(E){const b=u();E.__bindingPointIndex=b;const w=n.createBuffer(),O=E.__size,I=E.usage;return n.bindBuffer(n.UNIFORM_BUFFER,w),n.bufferData(n.UNIFORM_BUFFER,O,I),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,b,w),w}function u(){for(let E=0;E<a;E++)if(r.indexOf(E)===-1)return r.push(E),E;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(E){const b=s[E.id],w=E.uniforms,O=E.__cache;n.bindBuffer(n.UNIFORM_BUFFER,b);for(let I=0,R=w.length;I<R;I++){const G=Array.isArray(w[I])?w[I]:[w[I]];for(let tt=0,M=G.length;tt<M;tt++){const T=G[tt];if(f(T,I,tt,O)===!0){const U=T.__offset,$=Array.isArray(T.value)?T.value:[T.value];let et=0;for(let at=0;at<$.length;at++){const j=$[at],nt=y(j);typeof j=="number"||typeof j=="boolean"?(T.__data[0]=j,n.bufferSubData(n.UNIFORM_BUFFER,U+et,T.__data)):j.isMatrix3?(T.__data[0]=j.elements[0],T.__data[1]=j.elements[1],T.__data[2]=j.elements[2],T.__data[3]=0,T.__data[4]=j.elements[3],T.__data[5]=j.elements[4],T.__data[6]=j.elements[5],T.__data[7]=0,T.__data[8]=j.elements[6],T.__data[9]=j.elements[7],T.__data[10]=j.elements[8],T.__data[11]=0):(j.toArray(T.__data,et),et+=nt.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,U,T.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function f(E,b,w,O){const I=E.value,R=b+"_"+w;if(O[R]===void 0)return typeof I=="number"||typeof I=="boolean"?O[R]=I:O[R]=I.clone(),!0;{const G=O[R];if(typeof I=="number"||typeof I=="boolean"){if(G!==I)return O[R]=I,!0}else if(G.equals(I)===!1)return G.copy(I),!0}return!1}function v(E){const b=E.uniforms;let w=0;const O=16;for(let R=0,G=b.length;R<G;R++){const tt=Array.isArray(b[R])?b[R]:[b[R]];for(let M=0,T=tt.length;M<T;M++){const U=tt[M],$=Array.isArray(U.value)?U.value:[U.value];for(let et=0,at=$.length;et<at;et++){const j=$[et],nt=y(j),W=w%O,gt=W%nt.boundary,xt=W+gt;w+=gt,xt!==0&&O-xt<nt.storage&&(w+=O-xt),U.__data=new Float32Array(nt.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=w,w+=nt.storage}}}const I=w%O;return I>0&&(w+=O-I),E.__size=w,E.__cache={},this}function y(E){const b={boundary:0,storage:0};return typeof E=="number"||typeof E=="boolean"?(b.boundary=4,b.storage=4):E.isVector2?(b.boundary=8,b.storage=8):E.isVector3||E.isColor?(b.boundary=16,b.storage=12):E.isVector4?(b.boundary=16,b.storage=16):E.isMatrix3?(b.boundary=48,b.storage=48):E.isMatrix4?(b.boundary=64,b.storage=64):E.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",E),b}function m(E){const b=E.target;b.removeEventListener("dispose",m);const w=r.indexOf(b.__bindingPointIndex);r.splice(w,1),n.deleteBuffer(s[b.id]),delete s[b.id],delete o[b.id]}function p(){for(const E in s)n.deleteBuffer(s[E]);r=[],s={},o={}}return{bind:c,update:l,dispose:p}}class Hn{constructor(t={}){const{canvas:e=S_(),context:i=null,depth:s=!0,stencil:o=!1,alpha:r=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1}=t;this.isWebGLRenderer=!0;let d;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=i.getContextAttributes().alpha}else d=r;const f=new Uint32Array(4),v=new Int32Array(4);let y=null,m=null;const p=[],E=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=vi,this.toneMapping=gs,this.toneMappingExposure=1;const b=this;let w=!1,O=0,I=0,R=null,G=-1,tt=null;const M=new Xe,T=new Xe;let U=null;const $=new Me(0);let et=0,at=e.width,j=e.height,nt=1,W=null,gt=null;const xt=new Xe(0,0,at,j),wt=new Xe(0,0,at,j);let Nt=!1;const kt=new Iu;let rt=!1,pt=!1;const Pt=new sn,B=new sn,lt=new J,ot=new Xe,ht={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let yt=!1;function it(){return R===null?nt:1}let g=i;function P(A,V){return e.getContext(A,V)}try{const A={alpha:!0,depth:s,stencil:o,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Mu}`),e.addEventListener("webglcontextlost",Q,!1),e.addEventListener("webglcontextrestored",St,!1),e.addEventListener("webglcontextcreationerror",Et,!1),g===null){const V="webgl2";if(g=P(V,A),g===null)throw P(V)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw console.error("THREE.WebGLRenderer: "+A.message),A}let D,F,N,K,Z,S,x,C,Y,X,q,ft,ct,vt,At,dt,_t,Dt,Bt,It,Kt,Gt,Zt,H;function Mt(){D=new zM(g),D.init(),Gt=new b1(g,D),F=new DM(g,D,t,Gt),N=new M1(g),F.reverseDepthBuffer&&N.buffers.depth.setReversed(!0),K=new kM(g),Z=new r1,S=new S1(g,D,N,Z,F,Gt,K),x=new NM(b),C=new BM(b),Y=new $_(g),Zt=new IM(g,Y),X=new GM(g,Y,K,Zt),q=new WM(g,X,Y,K),Bt=new VM(g,F,S),dt=new UM(Z),ft=new o1(b,x,C,D,F,Zt,dt),ct=new L1(b,Z),vt=new c1,At=new p1(D),Dt=new CM(b,x,C,N,q,d,c),_t=new x1(b,q,F),H=new D1(g,K,F,N),It=new LM(g,D,K),Kt=new HM(g,D,K),K.programs=ft.programs,b.capabilities=F,b.extensions=D,b.properties=Z,b.renderLists=vt,b.shadowMap=_t,b.state=N,b.info=K}Mt();const st=new C1(b,g);this.xr=st,this.getContext=function(){return g},this.getContextAttributes=function(){return g.getContextAttributes()},this.forceContextLoss=function(){const A=D.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=D.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return nt},this.setPixelRatio=function(A){A!==void 0&&(nt=A,this.setSize(at,j,!1))},this.getSize=function(A){return A.set(at,j)},this.setSize=function(A,V,L=!0){if(st.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}at=A,j=V,e.width=Math.floor(A*nt),e.height=Math.floor(V*nt),L===!0&&(e.style.width=A+"px",e.style.height=V+"px"),this.setViewport(0,0,A,V)},this.getDrawingBufferSize=function(A){return A.set(at*nt,j*nt).floor()},this.setDrawingBufferSize=function(A,V,L){at=A,j=V,nt=L,e.width=Math.floor(A*L),e.height=Math.floor(V*L),this.setViewport(0,0,A,V)},this.getCurrentViewport=function(A){return A.copy(M)},this.getViewport=function(A){return A.copy(xt)},this.setViewport=function(A,V,L,k){A.isVector4?xt.set(A.x,A.y,A.z,A.w):xt.set(A,V,L,k),N.viewport(M.copy(xt).multiplyScalar(nt).round())},this.getScissor=function(A){return A.copy(wt)},this.setScissor=function(A,V,L,k){A.isVector4?wt.set(A.x,A.y,A.z,A.w):wt.set(A,V,L,k),N.scissor(T.copy(wt).multiplyScalar(nt).round())},this.getScissorTest=function(){return Nt},this.setScissorTest=function(A){N.setScissorTest(Nt=A)},this.setOpaqueSort=function(A){W=A},this.setTransparentSort=function(A){gt=A},this.getClearColor=function(A){return A.copy(Dt.getClearColor())},this.setClearColor=function(){Dt.setClearColor.apply(Dt,arguments)},this.getClearAlpha=function(){return Dt.getClearAlpha()},this.setClearAlpha=function(){Dt.setClearAlpha.apply(Dt,arguments)},this.clear=function(A=!0,V=!0,L=!0){let k=0;if(A){let z=!1;if(R!==null){const mt=R.texture.format;z=mt===Au||mt===Tu||mt===Eu}if(z){const mt=R.texture.type,Rt=mt===ts||mt===zs||mt===pr||mt===Po||mt===Su||mt===bu,Ut=Dt.getClearColor(),Ft=Dt.getClearAlpha(),jt=Ut.r,qt=Ut.g,Vt=Ut.b;Rt?(f[0]=jt,f[1]=qt,f[2]=Vt,f[3]=Ft,g.clearBufferuiv(g.COLOR,0,f)):(v[0]=jt,v[1]=qt,v[2]=Vt,v[3]=Ft,g.clearBufferiv(g.COLOR,0,v))}else k|=g.COLOR_BUFFER_BIT}V&&(k|=g.DEPTH_BUFFER_BIT,g.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),L&&(k|=g.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),g.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Q,!1),e.removeEventListener("webglcontextrestored",St,!1),e.removeEventListener("webglcontextcreationerror",Et,!1),vt.dispose(),At.dispose(),Z.dispose(),x.dispose(),C.dispose(),q.dispose(),Zt.dispose(),H.dispose(),ft.dispose(),st.dispose(),st.removeEventListener("sessionstart",we),st.removeEventListener("sessionend",ae),he.stop()};function Q(A){A.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),w=!0}function St(){console.log("THREE.WebGLRenderer: Context Restored."),w=!1;const A=K.autoReset,V=_t.enabled,L=_t.autoUpdate,k=_t.needsUpdate,z=_t.type;Mt(),K.autoReset=A,_t.enabled=V,_t.autoUpdate=L,_t.needsUpdate=k,_t.type=z}function Et(A){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Wt(A){const V=A.target;V.removeEventListener("dispose",Wt),ne(V)}function ne(A){ie(A),Z.remove(A)}function ie(A){const V=Z.get(A).programs;V!==void 0&&(V.forEach(function(L){ft.releaseProgram(L)}),A.isShaderMaterial&&ft.releaseShaderCache(A))}this.renderBufferDirect=function(A,V,L,k,z,mt){V===null&&(V=ht);const Rt=z.isMesh&&z.matrixWorld.determinant()<0,Ut=ke(A,V,L,k,z);N.setMaterial(k,Rt);let Ft=L.index,jt=1;if(k.wireframe===!0){if(Ft=X.getWireframeAttribute(L),Ft===void 0)return;jt=2}const qt=L.drawRange,Vt=L.attributes.position;let ee=qt.start*jt,ge=(qt.start+qt.count)*jt;mt!==null&&(ee=Math.max(ee,mt.start*jt),ge=Math.min(ge,(mt.start+mt.count)*jt)),Ft!==null?(ee=Math.max(ee,0),ge=Math.min(ge,Ft.count)):Vt!=null&&(ee=Math.max(ee,0),ge=Math.min(ge,Vt.count));const de=ge-ee;if(de<0||de===1/0)return;Zt.setup(z,k,Ut,L,Ft);let Ct,Yt=It;if(Ft!==null&&(Ct=Y.get(Ft),Yt=Kt,Yt.setIndex(Ct)),z.isMesh)k.wireframe===!0?(N.setLineWidth(k.wireframeLinewidth*it()),Yt.setMode(g.LINES)):Yt.setMode(g.TRIANGLES);else if(z.isLine){let Ht=k.linewidth;Ht===void 0&&(Ht=1),N.setLineWidth(Ht*it()),z.isLineSegments?Yt.setMode(g.LINES):z.isLineLoop?Yt.setMode(g.LINE_LOOP):Yt.setMode(g.LINE_STRIP)}else z.isPoints?Yt.setMode(g.POINTS):z.isSprite&&Yt.setMode(g.TRIANGLES);if(z.isBatchedMesh)if(z._multiDrawInstances!==null)Yt.renderMultiDrawInstances(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount,z._multiDrawInstances);else if(D.get("WEBGL_multi_draw"))Yt.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const Ht=z._multiDrawStarts,le=z._multiDrawCounts,Tt=z._multiDrawCount,Se=Ft?Y.get(Ft).bytesPerElement:1,Pe=Z.get(k).currentProgram.getUniforms();for(let _e=0;_e<Tt;_e++)Pe.setValue(g,"_gl_DrawID",_e),Yt.render(Ht[_e]/Se,le[_e])}else if(z.isInstancedMesh)Yt.renderInstances(ee,de,z.count);else if(L.isInstancedBufferGeometry){const Ht=L._maxInstanceCount!==void 0?L._maxInstanceCount:1/0,le=Math.min(L.instanceCount,Ht);Yt.renderInstances(ee,de,le)}else Yt.render(ee,de)};function ce(A,V,L){A.transparent===!0&&A.side===Ae&&A.forceSinglePass===!1?(A.side=jn,A.needsUpdate=!0,se(A,V,L),A.side=_s,A.needsUpdate=!0,se(A,V,L),A.side=Ae):se(A,V,L)}this.compile=function(A,V,L=null){L===null&&(L=A),m=At.get(L),m.init(V),E.push(m),L.traverseVisible(function(z){z.isLight&&z.layers.test(V.layers)&&(m.pushLight(z),z.castShadow&&m.pushShadow(z))}),A!==L&&A.traverseVisible(function(z){z.isLight&&z.layers.test(V.layers)&&(m.pushLight(z),z.castShadow&&m.pushShadow(z))}),m.setupLights();const k=new Set;return A.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const mt=z.material;if(mt)if(Array.isArray(mt))for(let Rt=0;Rt<mt.length;Rt++){const Ut=mt[Rt];ce(Ut,L,z),k.add(Ut)}else ce(mt,L,z),k.add(mt)}),E.pop(),m=null,k},this.compileAsync=function(A,V,L=null){const k=this.compile(A,V,L);return new Promise(z=>{function mt(){if(k.forEach(function(Rt){Z.get(Rt).currentProgram.isReady()&&k.delete(Rt)}),k.size===0){z(A);return}setTimeout(mt,10)}D.get("KHR_parallel_shader_compile")!==null?mt():setTimeout(mt,10)})};let re=null;function fe(A){re&&re(A)}function we(){he.stop()}function ae(){he.start()}const he=new Sp;he.setAnimationLoop(fe),typeof self<"u"&&he.setContext(self),this.setAnimationLoop=function(A){re=A,st.setAnimationLoop(A),A===null?he.stop():he.start()},st.addEventListener("sessionstart",we),st.addEventListener("sessionend",ae),this.render=function(A,V){if(V!==void 0&&V.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),V.parent===null&&V.matrixWorldAutoUpdate===!0&&V.updateMatrixWorld(),st.enabled===!0&&st.isPresenting===!0&&(st.cameraAutoUpdate===!0&&st.updateCamera(V),V=st.getCamera()),A.isScene===!0&&A.onBeforeRender(b,A,V,R),m=At.get(A,E.length),m.init(V),E.push(m),B.multiplyMatrices(V.projectionMatrix,V.matrixWorldInverse),kt.setFromProjectionMatrix(B),pt=this.localClippingEnabled,rt=dt.init(this.clippingPlanes,pt),y=vt.get(A,p.length),y.init(),p.push(y),st.enabled===!0&&st.isPresenting===!0){const mt=b.xr.getDepthSensingMesh();mt!==null&&pe(mt,V,-1/0,b.sortObjects)}pe(A,V,0,b.sortObjects),y.finish(),b.sortObjects===!0&&y.sort(W,gt),yt=st.enabled===!1||st.isPresenting===!1||st.hasDepthSensing()===!1,yt&&Dt.addToRenderList(y,A),this.info.render.frame++,rt===!0&&dt.beginShadows();const L=m.state.shadowsArray;_t.render(L,A,V),rt===!0&&dt.endShadows(),this.info.autoReset===!0&&this.info.reset();const k=y.opaque,z=y.transmissive;if(m.setupLights(),V.isArrayCamera){const mt=V.cameras;if(z.length>0)for(let Rt=0,Ut=mt.length;Rt<Ut;Rt++){const Ft=mt[Rt];Ie(k,z,A,Ft)}yt&&Dt.render(A);for(let Rt=0,Ut=mt.length;Rt<Ut;Rt++){const Ft=mt[Rt];me(y,A,Ft,Ft.viewport)}}else z.length>0&&Ie(k,z,A,V),yt&&Dt.render(A),me(y,A,V);R!==null&&(S.updateMultisampleRenderTarget(R),S.updateRenderTargetMipmap(R)),A.isScene===!0&&A.onAfterRender(b,A,V),Zt.resetDefaultState(),G=-1,tt=null,E.pop(),E.length>0?(m=E[E.length-1],rt===!0&&dt.setGlobalState(b.clippingPlanes,m.state.camera)):m=null,p.pop(),p.length>0?y=p[p.length-1]:y=null};function pe(A,V,L,k){if(A.visible===!1)return;if(A.layers.test(V.layers)){if(A.isGroup)L=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(V);else if(A.isLight)m.pushLight(A),A.castShadow&&m.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||kt.intersectsSprite(A)){k&&ot.setFromMatrixPosition(A.matrixWorld).applyMatrix4(B);const Rt=q.update(A),Ut=A.material;Ut.visible&&y.push(A,Rt,Ut,L,ot.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||kt.intersectsObject(A))){const Rt=q.update(A),Ut=A.material;if(k&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),ot.copy(A.boundingSphere.center)):(Rt.boundingSphere===null&&Rt.computeBoundingSphere(),ot.copy(Rt.boundingSphere.center)),ot.applyMatrix4(A.matrixWorld).applyMatrix4(B)),Array.isArray(Ut)){const Ft=Rt.groups;for(let jt=0,qt=Ft.length;jt<qt;jt++){const Vt=Ft[jt],ee=Ut[Vt.materialIndex];ee&&ee.visible&&y.push(A,Rt,ee,L,ot.z,Vt)}}else Ut.visible&&y.push(A,Rt,Ut,L,ot.z,null)}}const mt=A.children;for(let Rt=0,Ut=mt.length;Rt<Ut;Rt++)pe(mt[Rt],V,L,k)}function me(A,V,L,k){const z=A.opaque,mt=A.transmissive,Rt=A.transparent;m.setupLightsView(L),rt===!0&&dt.setGlobalState(b.clippingPlanes,L),k&&N.viewport(M.copy(k)),z.length>0&&xe(z,V,L),mt.length>0&&xe(mt,V,L),Rt.length>0&&xe(Rt,V,L),N.buffers.depth.setTest(!0),N.buffers.depth.setMask(!0),N.buffers.color.setMask(!0),N.setPolygonOffset(!1)}function Ie(A,V,L,k){if((L.isScene===!0?L.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[k.id]===void 0&&(m.state.transmissionRenderTarget[k.id]=new Gs(1,1,{generateMipmaps:!0,type:D.has("EXT_color_buffer_half_float")||D.has("EXT_color_buffer_float")?Sr:ts,minFilter:Ci,samples:4,stencilBuffer:o,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Be.workingColorSpace}));const mt=m.state.transmissionRenderTarget[k.id],Rt=k.viewport||M;mt.setSize(Rt.z,Rt.w);const Ut=b.getRenderTarget();b.setRenderTarget(mt),b.getClearColor($),et=b.getClearAlpha(),et<1&&b.setClearColor(16777215,.5),b.clear(),yt&&Dt.render(L);const Ft=b.toneMapping;b.toneMapping=gs;const jt=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),m.setupLightsView(k),rt===!0&&dt.setGlobalState(b.clippingPlanes,k),xe(A,L,k),S.updateMultisampleRenderTarget(mt),S.updateRenderTargetMipmap(mt),D.has("WEBGL_multisampled_render_to_texture")===!1){let qt=!1;for(let Vt=0,ee=V.length;Vt<ee;Vt++){const ge=V[Vt],de=ge.object,Ct=ge.geometry,Yt=ge.material,Ht=ge.group;if(Yt.side===Ae&&de.layers.test(k.layers)){const le=Yt.side;Yt.side=jn,Yt.needsUpdate=!0,De(de,L,k,Ct,Yt,Ht),Yt.side=le,Yt.needsUpdate=!0,qt=!0}}qt===!0&&(S.updateMultisampleRenderTarget(mt),S.updateRenderTargetMipmap(mt))}b.setRenderTarget(Ut),b.setClearColor($,et),jt!==void 0&&(k.viewport=jt),b.toneMapping=Ft}function xe(A,V,L){const k=V.isScene===!0?V.overrideMaterial:null;for(let z=0,mt=A.length;z<mt;z++){const Rt=A[z],Ut=Rt.object,Ft=Rt.geometry,jt=k===null?Rt.material:k,qt=Rt.group;Ut.layers.test(L.layers)&&De(Ut,V,L,Ft,jt,qt)}}function De(A,V,L,k,z,mt){A.onBeforeRender(b,V,L,k,z,mt),A.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),z.onBeforeRender(b,V,L,k,A,mt),z.transparent===!0&&z.side===Ae&&z.forceSinglePass===!1?(z.side=jn,z.needsUpdate=!0,b.renderBufferDirect(L,V,k,z,A,mt),z.side=_s,z.needsUpdate=!0,b.renderBufferDirect(L,V,k,z,A,mt),z.side=Ae):b.renderBufferDirect(L,V,k,z,A,mt),A.onAfterRender(b,V,L,k,z,mt)}function se(A,V,L){V.isScene!==!0&&(V=ht);const k=Z.get(A),z=m.state.lights,mt=m.state.shadowsArray,Rt=z.state.version,Ut=ft.getParameters(A,z.state,mt,V,L),Ft=ft.getProgramCacheKey(Ut);let jt=k.programs;k.environment=A.isMeshStandardMaterial?V.environment:null,k.fog=V.fog,k.envMap=(A.isMeshStandardMaterial?C:x).get(A.envMap||k.environment),k.envMapRotation=k.environment!==null&&A.envMap===null?V.environmentRotation:A.envMapRotation,jt===void 0&&(A.addEventListener("dispose",Wt),jt=new Map,k.programs=jt);let qt=jt.get(Ft);if(qt!==void 0){if(k.currentProgram===qt&&k.lightsStateVersion===Rt)return Ue(A,Ut),qt}else Ut.uniforms=ft.getUniforms(A),A.onBeforeCompile(Ut,b),qt=ft.acquireProgram(Ut,Ft),jt.set(Ft,qt),k.uniforms=Ut.uniforms;const Vt=k.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Vt.clippingPlanes=dt.uniform),Ue(A,Ut),k.needsLights=oe(A),k.lightsStateVersion=Rt,k.needsLights&&(Vt.ambientLightColor.value=z.state.ambient,Vt.lightProbe.value=z.state.probe,Vt.directionalLights.value=z.state.directional,Vt.directionalLightShadows.value=z.state.directionalShadow,Vt.spotLights.value=z.state.spot,Vt.spotLightShadows.value=z.state.spotShadow,Vt.rectAreaLights.value=z.state.rectArea,Vt.ltc_1.value=z.state.rectAreaLTC1,Vt.ltc_2.value=z.state.rectAreaLTC2,Vt.pointLights.value=z.state.point,Vt.pointLightShadows.value=z.state.pointShadow,Vt.hemisphereLights.value=z.state.hemi,Vt.directionalShadowMap.value=z.state.directionalShadowMap,Vt.directionalShadowMatrix.value=z.state.directionalShadowMatrix,Vt.spotShadowMap.value=z.state.spotShadowMap,Vt.spotLightMatrix.value=z.state.spotLightMatrix,Vt.spotLightMap.value=z.state.spotLightMap,Vt.pointShadowMap.value=z.state.pointShadowMap,Vt.pointShadowMatrix.value=z.state.pointShadowMatrix),k.currentProgram=qt,k.uniformsList=null,qt}function Ne(A){if(A.uniformsList===null){const V=A.currentProgram.getUniforms();A.uniformsList=xa.seqWithValue(V.seq,A.uniforms)}return A.uniformsList}function Ue(A,V){const L=Z.get(A);L.outputColorSpace=V.outputColorSpace,L.batching=V.batching,L.batchingColor=V.batchingColor,L.instancing=V.instancing,L.instancingColor=V.instancingColor,L.instancingMorph=V.instancingMorph,L.skinning=V.skinning,L.morphTargets=V.morphTargets,L.morphNormals=V.morphNormals,L.morphColors=V.morphColors,L.morphTargetsCount=V.morphTargetsCount,L.numClippingPlanes=V.numClippingPlanes,L.numIntersection=V.numClipIntersection,L.vertexAlphas=V.vertexAlphas,L.vertexTangents=V.vertexTangents,L.toneMapping=V.toneMapping}function ke(A,V,L,k,z){V.isScene!==!0&&(V=ht),S.resetTextureUnits();const mt=V.fog,Rt=k.isMeshStandardMaterial?V.environment:null,Ut=R===null?b.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:Ms,Ft=(k.isMeshStandardMaterial?C:x).get(k.envMap||Rt),jt=k.vertexColors===!0&&!!L.attributes.color&&L.attributes.color.itemSize===4,qt=!!L.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Vt=!!L.morphAttributes.position,ee=!!L.morphAttributes.normal,ge=!!L.morphAttributes.color;let de=gs;k.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(de=b.toneMapping);const Ct=L.morphAttributes.position||L.morphAttributes.normal||L.morphAttributes.color,Yt=Ct!==void 0?Ct.length:0,Ht=Z.get(k),le=m.state.lights;if(rt===!0&&(pt===!0||A!==tt)){const Re=A===tt&&k.id===G;dt.setState(k,A,Re)}let Tt=!1;k.version===Ht.__version?(Ht.needsLights&&Ht.lightsStateVersion!==le.state.version||Ht.outputColorSpace!==Ut||z.isBatchedMesh&&Ht.batching===!1||!z.isBatchedMesh&&Ht.batching===!0||z.isBatchedMesh&&Ht.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&Ht.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&Ht.instancing===!1||!z.isInstancedMesh&&Ht.instancing===!0||z.isSkinnedMesh&&Ht.skinning===!1||!z.isSkinnedMesh&&Ht.skinning===!0||z.isInstancedMesh&&Ht.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&Ht.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&Ht.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&Ht.instancingMorph===!1&&z.morphTexture!==null||Ht.envMap!==Ft||k.fog===!0&&Ht.fog!==mt||Ht.numClippingPlanes!==void 0&&(Ht.numClippingPlanes!==dt.numPlanes||Ht.numIntersection!==dt.numIntersection)||Ht.vertexAlphas!==jt||Ht.vertexTangents!==qt||Ht.morphTargets!==Vt||Ht.morphNormals!==ee||Ht.morphColors!==ge||Ht.toneMapping!==de||Ht.morphTargetsCount!==Yt)&&(Tt=!0):(Tt=!0,Ht.__version=k.version);let Se=Ht.currentProgram;Tt===!0&&(Se=se(k,V,z));let Pe=!1,_e=!1,Fe=!1;const ve=Se.getUniforms(),Le=Ht.uniforms;if(N.useProgram(Se.program)&&(Pe=!0,_e=!0,Fe=!0),k.id!==G&&(G=k.id,_e=!0),Pe||tt!==A){F.reverseDepthBuffer?(Pt.copy(A.projectionMatrix),E_(Pt),T_(Pt),ve.setValue(g,"projectionMatrix",Pt)):ve.setValue(g,"projectionMatrix",A.projectionMatrix),ve.setValue(g,"viewMatrix",A.matrixWorldInverse);const Re=ve.map.cameraPosition;Re!==void 0&&Re.setValue(g,lt.setFromMatrixPosition(A.matrixWorld)),F.logarithmicDepthBuffer&&ve.setValue(g,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&ve.setValue(g,"isOrthographic",A.isOrthographicCamera===!0),tt!==A&&(tt=A,_e=!0,Fe=!0)}if(z.isSkinnedMesh){ve.setOptional(g,z,"bindMatrix"),ve.setOptional(g,z,"bindMatrixInverse");const Re=z.skeleton;Re&&(Re.boneTexture===null&&Re.computeBoneTexture(),ve.setValue(g,"boneTexture",Re.boneTexture,S))}z.isBatchedMesh&&(ve.setOptional(g,z,"batchingTexture"),ve.setValue(g,"batchingTexture",z._matricesTexture,S),ve.setOptional(g,z,"batchingIdTexture"),ve.setValue(g,"batchingIdTexture",z._indirectTexture,S),ve.setOptional(g,z,"batchingColorTexture"),z._colorsTexture!==null&&ve.setValue(g,"batchingColorTexture",z._colorsTexture,S));const Ve=L.morphAttributes;if((Ve.position!==void 0||Ve.normal!==void 0||Ve.color!==void 0)&&Bt.update(z,L,Se),(_e||Ht.receiveShadow!==z.receiveShadow)&&(Ht.receiveShadow=z.receiveShadow,ve.setValue(g,"receiveShadow",z.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(Le.envMap.value=Ft,Le.flipEnvMap.value=Ft.isCubeTexture&&Ft.isRenderTargetTexture===!1?-1:1),k.isMeshStandardMaterial&&k.envMap===null&&V.environment!==null&&(Le.envMapIntensity.value=V.environmentIntensity),_e&&(ve.setValue(g,"toneMappingExposure",b.toneMappingExposure),Ht.needsLights&&bt(Le,Fe),mt&&k.fog===!0&&ct.refreshFogUniforms(Le,mt),ct.refreshMaterialUniforms(Le,k,nt,j,m.state.transmissionRenderTarget[A.id]),xa.upload(g,Ne(Ht),Le,S)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(xa.upload(g,Ne(Ht),Le,S),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&ve.setValue(g,"center",z.center),ve.setValue(g,"modelViewMatrix",z.modelViewMatrix),ve.setValue(g,"normalMatrix",z.normalMatrix),ve.setValue(g,"modelMatrix",z.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){const Re=k.uniformsGroups;for(let Ge=0,tn=Re.length;Ge<tn;Ge++){const Ye=Re[Ge];H.update(Ye,Se),H.bind(Ye,Se)}}return Se}function bt(A,V){A.ambientLightColor.needsUpdate=V,A.lightProbe.needsUpdate=V,A.directionalLights.needsUpdate=V,A.directionalLightShadows.needsUpdate=V,A.pointLights.needsUpdate=V,A.pointLightShadows.needsUpdate=V,A.spotLights.needsUpdate=V,A.spotLightShadows.needsUpdate=V,A.rectAreaLights.needsUpdate=V,A.hemisphereLights.needsUpdate=V}function oe(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return O},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(A,V,L){Z.get(A.texture).__webglTexture=V,Z.get(A.depthTexture).__webglTexture=L;const k=Z.get(A);k.__hasExternalTextures=!0,k.__autoAllocateDepthBuffer=L===void 0,k.__autoAllocateDepthBuffer||D.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),k.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(A,V){const L=Z.get(A);L.__webglFramebuffer=V,L.__useDefaultFramebuffer=V===void 0},this.setRenderTarget=function(A,V=0,L=0){R=A,O=V,I=L;let k=!0,z=null,mt=!1,Rt=!1;if(A){const Ft=Z.get(A);if(Ft.__useDefaultFramebuffer!==void 0)N.bindFramebuffer(g.FRAMEBUFFER,null),k=!1;else if(Ft.__webglFramebuffer===void 0)S.setupRenderTarget(A);else if(Ft.__hasExternalTextures)S.rebindTextures(A,Z.get(A.texture).__webglTexture,Z.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Vt=A.depthTexture;if(Ft.__boundDepthTexture!==Vt){if(Vt!==null&&Z.has(Vt)&&(A.width!==Vt.image.width||A.height!==Vt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");S.setupDepthRenderbuffer(A)}}const jt=A.texture;(jt.isData3DTexture||jt.isDataArrayTexture||jt.isCompressedArrayTexture)&&(Rt=!0);const qt=Z.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(qt[V])?z=qt[V][L]:z=qt[V],mt=!0):A.samples>0&&S.useMultisampledRTT(A)===!1?z=Z.get(A).__webglMultisampledFramebuffer:Array.isArray(qt)?z=qt[L]:z=qt,M.copy(A.viewport),T.copy(A.scissor),U=A.scissorTest}else M.copy(xt).multiplyScalar(nt).floor(),T.copy(wt).multiplyScalar(nt).floor(),U=Nt;if(N.bindFramebuffer(g.FRAMEBUFFER,z)&&k&&N.drawBuffers(A,z),N.viewport(M),N.scissor(T),N.setScissorTest(U),mt){const Ft=Z.get(A.texture);g.framebufferTexture2D(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_CUBE_MAP_POSITIVE_X+V,Ft.__webglTexture,L)}else if(Rt){const Ft=Z.get(A.texture),jt=V||0;g.framebufferTextureLayer(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,Ft.__webglTexture,L||0,jt)}G=-1},this.readRenderTargetPixels=function(A,V,L,k,z,mt,Rt){if(!(A&&A.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ut=Z.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Rt!==void 0&&(Ut=Ut[Rt]),Ut){N.bindFramebuffer(g.FRAMEBUFFER,Ut);try{const Ft=A.texture,jt=Ft.format,qt=Ft.type;if(!F.textureFormatReadable(jt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!F.textureTypeReadable(qt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}V>=0&&V<=A.width-k&&L>=0&&L<=A.height-z&&g.readPixels(V,L,k,z,Gt.convert(jt),Gt.convert(qt),mt)}finally{const Ft=R!==null?Z.get(R).__webglFramebuffer:null;N.bindFramebuffer(g.FRAMEBUFFER,Ft)}}},this.readRenderTargetPixelsAsync=async function(A,V,L,k,z,mt,Rt){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ut=Z.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Rt!==void 0&&(Ut=Ut[Rt]),Ut){const Ft=A.texture,jt=Ft.format,qt=Ft.type;if(!F.textureFormatReadable(jt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!F.textureTypeReadable(qt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(V>=0&&V<=A.width-k&&L>=0&&L<=A.height-z){N.bindFramebuffer(g.FRAMEBUFFER,Ut);const Vt=g.createBuffer();g.bindBuffer(g.PIXEL_PACK_BUFFER,Vt),g.bufferData(g.PIXEL_PACK_BUFFER,mt.byteLength,g.STREAM_READ),g.readPixels(V,L,k,z,Gt.convert(jt),Gt.convert(qt),0);const ee=R!==null?Z.get(R).__webglFramebuffer:null;N.bindFramebuffer(g.FRAMEBUFFER,ee);const ge=g.fenceSync(g.SYNC_GPU_COMMANDS_COMPLETE,0);return g.flush(),await b_(g,ge,4),g.bindBuffer(g.PIXEL_PACK_BUFFER,Vt),g.getBufferSubData(g.PIXEL_PACK_BUFFER,0,mt),g.deleteBuffer(Vt),g.deleteSync(ge),mt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(A,V=null,L=0){A.isTexture!==!0&&(_a("WebGLRenderer: copyFramebufferToTexture function signature has changed."),V=arguments[0]||null,A=arguments[1]);const k=Math.pow(2,-L),z=Math.floor(A.image.width*k),mt=Math.floor(A.image.height*k),Rt=V!==null?V.x:0,Ut=V!==null?V.y:0;S.setTexture2D(A,0),g.copyTexSubImage2D(g.TEXTURE_2D,L,0,0,Rt,Ut,z,mt),N.unbindTexture()},this.copyTextureToTexture=function(A,V,L=null,k=null,z=0){A.isTexture!==!0&&(_a("WebGLRenderer: copyTextureToTexture function signature has changed."),k=arguments[0]||null,A=arguments[1],V=arguments[2],z=arguments[3]||0,L=null);let mt,Rt,Ut,Ft,jt,qt;L!==null?(mt=L.max.x-L.min.x,Rt=L.max.y-L.min.y,Ut=L.min.x,Ft=L.min.y):(mt=A.image.width,Rt=A.image.height,Ut=0,Ft=0),k!==null?(jt=k.x,qt=k.y):(jt=0,qt=0);const Vt=Gt.convert(V.format),ee=Gt.convert(V.type);S.setTexture2D(V,0),g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,V.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,V.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,V.unpackAlignment);const ge=g.getParameter(g.UNPACK_ROW_LENGTH),de=g.getParameter(g.UNPACK_IMAGE_HEIGHT),Ct=g.getParameter(g.UNPACK_SKIP_PIXELS),Yt=g.getParameter(g.UNPACK_SKIP_ROWS),Ht=g.getParameter(g.UNPACK_SKIP_IMAGES),le=A.isCompressedTexture?A.mipmaps[z]:A.image;g.pixelStorei(g.UNPACK_ROW_LENGTH,le.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,le.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Ut),g.pixelStorei(g.UNPACK_SKIP_ROWS,Ft),A.isDataTexture?g.texSubImage2D(g.TEXTURE_2D,z,jt,qt,mt,Rt,Vt,ee,le.data):A.isCompressedTexture?g.compressedTexSubImage2D(g.TEXTURE_2D,z,jt,qt,le.width,le.height,Vt,le.data):g.texSubImage2D(g.TEXTURE_2D,z,jt,qt,mt,Rt,Vt,ee,le),g.pixelStorei(g.UNPACK_ROW_LENGTH,ge),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,de),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Ct),g.pixelStorei(g.UNPACK_SKIP_ROWS,Yt),g.pixelStorei(g.UNPACK_SKIP_IMAGES,Ht),z===0&&V.generateMipmaps&&g.generateMipmap(g.TEXTURE_2D),N.unbindTexture()},this.copyTextureToTexture3D=function(A,V,L=null,k=null,z=0){A.isTexture!==!0&&(_a("WebGLRenderer: copyTextureToTexture3D function signature has changed."),L=arguments[0]||null,k=arguments[1]||null,A=arguments[2],V=arguments[3],z=arguments[4]||0);let mt,Rt,Ut,Ft,jt,qt,Vt,ee,ge;const de=A.isCompressedTexture?A.mipmaps[z]:A.image;L!==null?(mt=L.max.x-L.min.x,Rt=L.max.y-L.min.y,Ut=L.max.z-L.min.z,Ft=L.min.x,jt=L.min.y,qt=L.min.z):(mt=de.width,Rt=de.height,Ut=de.depth,Ft=0,jt=0,qt=0),k!==null?(Vt=k.x,ee=k.y,ge=k.z):(Vt=0,ee=0,ge=0);const Ct=Gt.convert(V.format),Yt=Gt.convert(V.type);let Ht;if(V.isData3DTexture)S.setTexture3D(V,0),Ht=g.TEXTURE_3D;else if(V.isDataArrayTexture||V.isCompressedArrayTexture)S.setTexture2DArray(V,0),Ht=g.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,V.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,V.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,V.unpackAlignment);const le=g.getParameter(g.UNPACK_ROW_LENGTH),Tt=g.getParameter(g.UNPACK_IMAGE_HEIGHT),Se=g.getParameter(g.UNPACK_SKIP_PIXELS),Pe=g.getParameter(g.UNPACK_SKIP_ROWS),_e=g.getParameter(g.UNPACK_SKIP_IMAGES);g.pixelStorei(g.UNPACK_ROW_LENGTH,de.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,de.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Ft),g.pixelStorei(g.UNPACK_SKIP_ROWS,jt),g.pixelStorei(g.UNPACK_SKIP_IMAGES,qt),A.isDataTexture||A.isData3DTexture?g.texSubImage3D(Ht,z,Vt,ee,ge,mt,Rt,Ut,Ct,Yt,de.data):V.isCompressedArrayTexture?g.compressedTexSubImage3D(Ht,z,Vt,ee,ge,mt,Rt,Ut,Ct,de.data):g.texSubImage3D(Ht,z,Vt,ee,ge,mt,Rt,Ut,Ct,Yt,de),g.pixelStorei(g.UNPACK_ROW_LENGTH,le),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,Tt),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Se),g.pixelStorei(g.UNPACK_SKIP_ROWS,Pe),g.pixelStorei(g.UNPACK_SKIP_IMAGES,_e),z===0&&V.generateMipmaps&&g.generateMipmap(Ht),N.unbindTexture()},this.initRenderTarget=function(A){Z.get(A).__webglFramebuffer===void 0&&S.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?S.setTextureCube(A,0):A.isData3DTexture?S.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?S.setTexture2DArray(A,0):S.setTexture2D(A,0),N.unbindTexture()},this.resetState=function(){O=0,I=0,R=null,N.reset(),Zt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Zi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=t===Pu?"display-p3":"srgb",e.unpackColorSpace=Be.workingColorSpace===qa?"display-p3":"srgb"}}class kn extends wn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Ui,this.environmentIntensity=1,this.environmentRotation=new Ui,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class vr extends Do{constructor(t){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Me(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.alphaMap=t.alphaMap,this.size=t.size,this.sizeAttenuation=t.sizeAttenuation,this.fog=t.fog,this}}const Ad=new sn,ql=new gp,na=new ja,ia=new J;class sr extends wn{constructor(t=new En,e=new vr){super(),this.isPoints=!0,this.type="Points",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}raycast(t,e){const i=this.geometry,s=this.matrixWorld,o=t.params.Points.threshold,r=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),na.copy(i.boundingSphere),na.applyMatrix4(s),na.radius+=o,t.ray.intersectsSphere(na)===!1)return;Ad.copy(s).invert(),ql.copy(t.ray).applyMatrix4(Ad);const a=o/((this.scale.x+this.scale.y+this.scale.z)/3),c=a*a,l=i.index,u=i.attributes.position;if(l!==null){const d=Math.max(0,r.start),f=Math.min(l.count,r.start+r.count);for(let v=d,y=f;v<y;v++){const m=l.getX(v);ia.fromBufferAttribute(u,m),Pd(ia,m,c,s,t,e,this)}}else{const d=Math.max(0,r.start),f=Math.min(u.count,r.start+r.count);for(let v=d,y=f;v<y;v++)ia.fromBufferAttribute(u,v),Pd(ia,v,c,s,t,e,this)}}updateMorphTargets(){const e=this.geometry.morphAttributes,i=Object.keys(e);if(i.length>0){const s=e[i[0]];if(s!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let o=0,r=s.length;o<r;o++){const a=s[o].name||String(o);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=o}}}}}function Pd(n,t,e,i,s,o,r){const a=ql.distanceSqToPoint(n);if(a<e){const c=new J;ql.closestPointToPoint(n,c),c.applyMatrix4(i);const l=s.ray.origin.distanceTo(c);if(l<s.near||l>s.far)return;o.push({distance:l,distanceToRay:Math.sqrt(a),point:c,index:t,face:null,faceIndex:null,barycoord:null,object:r})}}class U1 extends In{constructor(t,e,i,s,o,r,a,c,l){super(t,e,i,s,o,r,a,c,l),this.isCanvasTexture=!0,this.needsUpdate=!0}}class Ni{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(t,e){const i=this.getUtoTmapping(t);return this.getPoint(i,e)}getPoints(t=5){const e=[];for(let i=0;i<=t;i++)e.push(this.getPoint(i/t));return e}getSpacedPoints(t=5){const e=[];for(let i=0;i<=t;i++)e.push(this.getPointAt(i/t));return e}getLength(){const t=this.getLengths();return t[t.length-1]}getLengths(t=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===t+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const e=[];let i,s=this.getPoint(0),o=0;e.push(0);for(let r=1;r<=t;r++)i=this.getPoint(r/t),o+=i.distanceTo(s),e.push(o),s=i;return this.cacheArcLengths=e,e}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(t,e){const i=this.getLengths();let s=0;const o=i.length;let r;e?r=e:r=t*i[o-1];let a=0,c=o-1,l;for(;a<=c;)if(s=Math.floor(a+(c-a)/2),l=i[s]-r,l<0)a=s+1;else if(l>0)c=s-1;else{c=s;break}if(s=c,i[s]===r)return s/(o-1);const h=i[s],d=i[s+1]-h,f=(r-h)/d;return(s+f)/(o-1)}getTangent(t,e){let s=t-1e-4,o=t+1e-4;s<0&&(s=0),o>1&&(o=1);const r=this.getPoint(s),a=this.getPoint(o),c=e||(r.isVector2?new Qt:new J);return c.copy(a).sub(r).normalize(),c}getTangentAt(t,e){const i=this.getUtoTmapping(t);return this.getTangent(i,e)}computeFrenetFrames(t,e){const i=new J,s=[],o=[],r=[],a=new J,c=new sn;for(let f=0;f<=t;f++){const v=f/t;s[f]=this.getTangentAt(v,new J)}o[0]=new J,r[0]=new J;let l=Number.MAX_VALUE;const h=Math.abs(s[0].x),u=Math.abs(s[0].y),d=Math.abs(s[0].z);h<=l&&(l=h,i.set(1,0,0)),u<=l&&(l=u,i.set(0,1,0)),d<=l&&i.set(0,0,1),a.crossVectors(s[0],i).normalize(),o[0].crossVectors(s[0],a),r[0].crossVectors(s[0],o[0]);for(let f=1;f<=t;f++){if(o[f]=o[f-1].clone(),r[f]=r[f-1].clone(),a.crossVectors(s[f-1],s[f]),a.length()>Number.EPSILON){a.normalize();const v=Math.acos(xn(s[f-1].dot(s[f]),-1,1));o[f].applyMatrix4(c.makeRotationAxis(a,v))}r[f].crossVectors(s[f],o[f])}if(e===!0){let f=Math.acos(xn(o[0].dot(o[t]),-1,1));f/=t,s[0].dot(a.crossVectors(o[0],o[t]))>0&&(f=-f);for(let v=1;v<=t;v++)o[v].applyMatrix4(c.makeRotationAxis(s[v],f*v)),r[v].crossVectors(s[v],o[v])}return{tangents:s,normals:o,binormals:r}}clone(){return new this.constructor().copy(this)}copy(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}toJSON(){const t={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return t.arcLengthDivisions=this.arcLengthDivisions,t.type=this.type,t}fromJSON(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}}class Du extends Ni{constructor(t=0,e=0,i=1,s=1,o=0,r=Math.PI*2,a=!1,c=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=t,this.aY=e,this.xRadius=i,this.yRadius=s,this.aStartAngle=o,this.aEndAngle=r,this.aClockwise=a,this.aRotation=c}getPoint(t,e=new Qt){const i=e,s=Math.PI*2;let o=this.aEndAngle-this.aStartAngle;const r=Math.abs(o)<Number.EPSILON;for(;o<0;)o+=s;for(;o>s;)o-=s;o<Number.EPSILON&&(r?o=0:o=s),this.aClockwise===!0&&!r&&(o===s?o=-s:o=o-s);const a=this.aStartAngle+t*o;let c=this.aX+this.xRadius*Math.cos(a),l=this.aY+this.yRadius*Math.sin(a);if(this.aRotation!==0){const h=Math.cos(this.aRotation),u=Math.sin(this.aRotation),d=c-this.aX,f=l-this.aY;c=d*h-f*u+this.aX,l=d*u+f*h+this.aY}return i.set(c,l)}copy(t){return super.copy(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}toJSON(){const t=super.toJSON();return t.aX=this.aX,t.aY=this.aY,t.xRadius=this.xRadius,t.yRadius=this.yRadius,t.aStartAngle=this.aStartAngle,t.aEndAngle=this.aEndAngle,t.aClockwise=this.aClockwise,t.aRotation=this.aRotation,t}fromJSON(t){return super.fromJSON(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}}class N1 extends Du{constructor(t,e,i,s,o,r){super(t,e,i,i,s,o,r),this.isArcCurve=!0,this.type="ArcCurve"}}function Uu(){let n=0,t=0,e=0,i=0;function s(o,r,a,c){n=o,t=a,e=-3*o+3*r-2*a-c,i=2*o-2*r+a+c}return{initCatmullRom:function(o,r,a,c,l){s(r,a,l*(a-o),l*(c-r))},initNonuniformCatmullRom:function(o,r,a,c,l,h,u){let d=(r-o)/l-(a-o)/(l+h)+(a-r)/h,f=(a-r)/h-(c-r)/(h+u)+(c-a)/u;d*=h,f*=h,s(r,a,d,f)},calc:function(o){const r=o*o,a=r*o;return n+t*o+e*r+i*a}}}const sa=new J,Vc=new Uu,Wc=new Uu,Xc=new Uu;class F1 extends Ni{constructor(t=[],e=!1,i="centripetal",s=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=t,this.closed=e,this.curveType=i,this.tension=s}getPoint(t,e=new J){const i=e,s=this.points,o=s.length,r=(o-(this.closed?0:1))*t;let a=Math.floor(r),c=r-a;this.closed?a+=a>0?0:(Math.floor(Math.abs(a)/o)+1)*o:c===0&&a===o-1&&(a=o-2,c=1);let l,h;this.closed||a>0?l=s[(a-1)%o]:(sa.subVectors(s[0],s[1]).add(s[0]),l=sa);const u=s[a%o],d=s[(a+1)%o];if(this.closed||a+2<o?h=s[(a+2)%o]:(sa.subVectors(s[o-1],s[o-2]).add(s[o-1]),h=sa),this.curveType==="centripetal"||this.curveType==="chordal"){const f=this.curveType==="chordal"?.5:.25;let v=Math.pow(l.distanceToSquared(u),f),y=Math.pow(u.distanceToSquared(d),f),m=Math.pow(d.distanceToSquared(h),f);y<1e-4&&(y=1),v<1e-4&&(v=y),m<1e-4&&(m=y),Vc.initNonuniformCatmullRom(l.x,u.x,d.x,h.x,v,y,m),Wc.initNonuniformCatmullRom(l.y,u.y,d.y,h.y,v,y,m),Xc.initNonuniformCatmullRom(l.z,u.z,d.z,h.z,v,y,m)}else this.curveType==="catmullrom"&&(Vc.initCatmullRom(l.x,u.x,d.x,h.x,this.tension),Wc.initCatmullRom(l.y,u.y,d.y,h.y,this.tension),Xc.initCatmullRom(l.z,u.z,d.z,h.z,this.tension));return i.set(Vc.calc(c),Wc.calc(c),Xc.calc(c)),i}copy(t){super.copy(t),this.points=[];for(let e=0,i=t.points.length;e<i;e++){const s=t.points[e];this.points.push(s.clone())}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,i=this.points.length;e<i;e++){const s=this.points[e];t.points.push(s.toArray())}return t.closed=this.closed,t.curveType=this.curveType,t.tension=this.tension,t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,i=t.points.length;e<i;e++){const s=t.points[e];this.points.push(new J().fromArray(s))}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}}function Rd(n,t,e,i,s){const o=(i-t)*.5,r=(s-e)*.5,a=n*n,c=n*a;return(2*e-2*i+o+r)*c+(-3*e+3*i-2*o-r)*a+o*n+e}function O1(n,t){const e=1-n;return e*e*t}function B1(n,t){return 2*(1-n)*n*t}function z1(n,t){return n*n*t}function or(n,t,e,i){return O1(n,t)+B1(n,e)+z1(n,i)}function G1(n,t){const e=1-n;return e*e*e*t}function H1(n,t){const e=1-n;return 3*e*e*n*t}function k1(n,t){return 3*(1-n)*n*n*t}function V1(n,t){return n*n*n*t}function rr(n,t,e,i,s){return G1(n,t)+H1(n,e)+k1(n,i)+V1(n,s)}class Cp extends Ni{constructor(t=new Qt,e=new Qt,i=new Qt,s=new Qt){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=t,this.v1=e,this.v2=i,this.v3=s}getPoint(t,e=new Qt){const i=e,s=this.v0,o=this.v1,r=this.v2,a=this.v3;return i.set(rr(t,s.x,o.x,r.x,a.x),rr(t,s.y,o.y,r.y,a.y)),i}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class W1 extends Ni{constructor(t=new J,e=new J,i=new J,s=new J){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=t,this.v1=e,this.v2=i,this.v3=s}getPoint(t,e=new J){const i=e,s=this.v0,o=this.v1,r=this.v2,a=this.v3;return i.set(rr(t,s.x,o.x,r.x,a.x),rr(t,s.y,o.y,r.y,a.y),rr(t,s.z,o.z,r.z,a.z)),i}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class Ip extends Ni{constructor(t=new Qt,e=new Qt){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=t,this.v2=e}getPoint(t,e=new Qt){const i=e;return t===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(t).add(this.v1)),i}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new Qt){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class X1 extends Ni{constructor(t=new J,e=new J){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=t,this.v2=e}getPoint(t,e=new J){const i=e;return t===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(t).add(this.v1)),i}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new J){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Lp extends Ni{constructor(t=new Qt,e=new Qt,i=new Qt){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=t,this.v1=e,this.v2=i}getPoint(t,e=new Qt){const i=e,s=this.v0,o=this.v1,r=this.v2;return i.set(or(t,s.x,o.x,r.x),or(t,s.y,o.y,r.y)),i}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class q1 extends Ni{constructor(t=new J,e=new J,i=new J){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=t,this.v1=e,this.v2=i}getPoint(t,e=new J){const i=e,s=this.v0,o=this.v1,r=this.v2;return i.set(or(t,s.x,o.x,r.x),or(t,s.y,o.y,r.y),or(t,s.z,o.z,r.z)),i}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Dp extends Ni{constructor(t=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=t}getPoint(t,e=new Qt){const i=e,s=this.points,o=(s.length-1)*t,r=Math.floor(o),a=o-r,c=s[r===0?r:r-1],l=s[r],h=s[r>s.length-2?s.length-1:r+1],u=s[r>s.length-3?s.length-1:r+2];return i.set(Rd(a,c.x,l.x,h.x,u.x),Rd(a,c.y,l.y,h.y,u.y)),i}copy(t){super.copy(t),this.points=[];for(let e=0,i=t.points.length;e<i;e++){const s=t.points[e];this.points.push(s.clone())}return this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,i=this.points.length;e<i;e++){const s=this.points[e];t.points.push(s.toArray())}return t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,i=t.points.length;e<i;e++){const s=t.points[e];this.points.push(new Qt().fromArray(s))}return this}}var jl=Object.freeze({__proto__:null,ArcCurve:N1,CatmullRomCurve3:F1,CubicBezierCurve:Cp,CubicBezierCurve3:W1,EllipseCurve:Du,LineCurve:Ip,LineCurve3:X1,QuadraticBezierCurve:Lp,QuadraticBezierCurve3:q1,SplineCurve:Dp});class j1 extends Ni{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(t){this.curves.push(t)}closePath(){const t=this.curves[0].getPoint(0),e=this.curves[this.curves.length-1].getPoint(1);if(!t.equals(e)){const i=t.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new jl[i](e,t))}return this}getPoint(t,e){const i=t*this.getLength(),s=this.getCurveLengths();let o=0;for(;o<s.length;){if(s[o]>=i){const r=s[o]-i,a=this.curves[o],c=a.getLength(),l=c===0?0:1-r/c;return a.getPointAt(l,e)}o++}return null}getLength(){const t=this.getCurveLengths();return t[t.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const t=[];let e=0;for(let i=0,s=this.curves.length;i<s;i++)e+=this.curves[i].getLength(),t.push(e);return this.cacheLengths=t,t}getSpacedPoints(t=40){const e=[];for(let i=0;i<=t;i++)e.push(this.getPoint(i/t));return this.autoClose&&e.push(e[0]),e}getPoints(t=12){const e=[];let i;for(let s=0,o=this.curves;s<o.length;s++){const r=o[s],a=r.isEllipseCurve?t*2:r.isLineCurve||r.isLineCurve3?1:r.isSplineCurve?t*r.points.length:t,c=r.getPoints(a);for(let l=0;l<c.length;l++){const h=c[l];i&&i.equals(h)||(e.push(h),i=h)}}return this.autoClose&&e.length>1&&!e[e.length-1].equals(e[0])&&e.push(e[0]),e}copy(t){super.copy(t),this.curves=[];for(let e=0,i=t.curves.length;e<i;e++){const s=t.curves[e];this.curves.push(s.clone())}return this.autoClose=t.autoClose,this}toJSON(){const t=super.toJSON();t.autoClose=this.autoClose,t.curves=[];for(let e=0,i=this.curves.length;e<i;e++){const s=this.curves[e];t.curves.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.autoClose=t.autoClose,this.curves=[];for(let e=0,i=t.curves.length;e<i;e++){const s=t.curves[e];this.curves.push(new jl[s.type]().fromJSON(s))}return this}}class Yl extends j1{constructor(t){super(),this.type="Path",this.currentPoint=new Qt,t&&this.setFromPoints(t)}setFromPoints(t){this.moveTo(t[0].x,t[0].y);for(let e=1,i=t.length;e<i;e++)this.lineTo(t[e].x,t[e].y);return this}moveTo(t,e){return this.currentPoint.set(t,e),this}lineTo(t,e){const i=new Ip(this.currentPoint.clone(),new Qt(t,e));return this.curves.push(i),this.currentPoint.set(t,e),this}quadraticCurveTo(t,e,i,s){const o=new Lp(this.currentPoint.clone(),new Qt(t,e),new Qt(i,s));return this.curves.push(o),this.currentPoint.set(i,s),this}bezierCurveTo(t,e,i,s,o,r){const a=new Cp(this.currentPoint.clone(),new Qt(t,e),new Qt(i,s),new Qt(o,r));return this.curves.push(a),this.currentPoint.set(o,r),this}splineThru(t){const e=[this.currentPoint.clone()].concat(t),i=new Dp(e);return this.curves.push(i),this.currentPoint.copy(t[t.length-1]),this}arc(t,e,i,s,o,r){const a=this.currentPoint.x,c=this.currentPoint.y;return this.absarc(t+a,e+c,i,s,o,r),this}absarc(t,e,i,s,o,r){return this.absellipse(t,e,i,i,s,o,r),this}ellipse(t,e,i,s,o,r,a,c){const l=this.currentPoint.x,h=this.currentPoint.y;return this.absellipse(t+l,e+h,i,s,o,r,a,c),this}absellipse(t,e,i,s,o,r,a,c){const l=new Du(t,e,i,s,o,r,a,c);if(this.curves.length>0){const u=l.getPoint(0);u.equals(this.currentPoint)||this.lineTo(u.x,u.y)}this.curves.push(l);const h=l.getPoint(1);return this.currentPoint.copy(h),this}copy(t){return super.copy(t),this.currentPoint.copy(t.currentPoint),this}toJSON(){const t=super.toJSON();return t.currentPoint=this.currentPoint.toArray(),t}fromJSON(t){return super.fromJSON(t),this.currentPoint.fromArray(t.currentPoint),this}}class Ce extends En{constructor(t=1,e=32,i=0,s=Math.PI*2){super(),this.type="CircleGeometry",this.parameters={radius:t,segments:e,thetaStart:i,thetaLength:s},e=Math.max(3,e);const o=[],r=[],a=[],c=[],l=new J,h=new Qt;r.push(0,0,0),a.push(0,0,1),c.push(.5,.5);for(let u=0,d=3;u<=e;u++,d+=3){const f=i+u/e*s;l.x=t*Math.cos(f),l.y=t*Math.sin(f),r.push(l.x,l.y,l.z),a.push(0,0,1),h.x=(r[d]/t+1)/2,h.y=(r[d+1]/t+1)/2,c.push(h.x,h.y)}for(let u=1;u<=e;u++)o.push(u,u+1,0);this.setIndex(o),this.setAttribute("position",new on(r,3)),this.setAttribute("normal",new on(a,3)),this.setAttribute("uv",new on(c,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Ce(t.radius,t.segments,t.thetaStart,t.thetaLength)}}class te extends En{constructor(t=1,e=1,i=1,s=32,o=1,r=!1,a=0,c=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:t,radiusBottom:e,height:i,radialSegments:s,heightSegments:o,openEnded:r,thetaStart:a,thetaLength:c};const l=this;s=Math.floor(s),o=Math.floor(o);const h=[],u=[],d=[],f=[];let v=0;const y=[],m=i/2;let p=0;E(),r===!1&&(t>0&&b(!0),e>0&&b(!1)),this.setIndex(h),this.setAttribute("position",new on(u,3)),this.setAttribute("normal",new on(d,3)),this.setAttribute("uv",new on(f,2));function E(){const w=new J,O=new J;let I=0;const R=(e-t)/i;for(let G=0;G<=o;G++){const tt=[],M=G/o,T=M*(e-t)+t;for(let U=0;U<=s;U++){const $=U/s,et=$*c+a,at=Math.sin(et),j=Math.cos(et);O.x=T*at,O.y=-M*i+m,O.z=T*j,u.push(O.x,O.y,O.z),w.set(at,R,j).normalize(),d.push(w.x,w.y,w.z),f.push($,1-M),tt.push(v++)}y.push(tt)}for(let G=0;G<s;G++)for(let tt=0;tt<o;tt++){const M=y[tt][G],T=y[tt+1][G],U=y[tt+1][G+1],$=y[tt][G+1];t>0&&(h.push(M,T,$),I+=3),e>0&&(h.push(T,U,$),I+=3)}l.addGroup(p,I,0),p+=I}function b(w){const O=v,I=new Qt,R=new J;let G=0;const tt=w===!0?t:e,M=w===!0?1:-1;for(let U=1;U<=s;U++)u.push(0,m*M,0),d.push(0,M,0),f.push(.5,.5),v++;const T=v;for(let U=0;U<=s;U++){const et=U/s*c+a,at=Math.cos(et),j=Math.sin(et);R.x=tt*j,R.y=m*M,R.z=tt*at,u.push(R.x,R.y,R.z),d.push(0,M,0),I.x=at*.5+.5,I.y=j*.5*M+.5,f.push(I.x,I.y),v++}for(let U=0;U<s;U++){const $=O+U,et=T+U;w===!0?h.push(et,et+1,$):h.push(et+1,et,$),G+=3}l.addGroup(p,G,w===!0?1:2),p+=G}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new te(t.radiusTop,t.radiusBottom,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class oi extends te{constructor(t=1,e=1,i=32,s=1,o=!1,r=0,a=Math.PI*2){super(0,t,e,i,s,o,r,a),this.type="ConeGeometry",this.parameters={radius:t,height:e,radialSegments:i,heightSegments:s,openEnded:o,thetaStart:r,thetaLength:a}}static fromJSON(t){return new oi(t.radius,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class Sn extends Yl{constructor(t){super(t),this.uuid=Vs(),this.type="Shape",this.holes=[]}getPointsHoles(t){const e=[];for(let i=0,s=this.holes.length;i<s;i++)e[i]=this.holes[i].getPoints(t);return e}extractPoints(t){return{shape:this.getPoints(t),holes:this.getPointsHoles(t)}}copy(t){super.copy(t),this.holes=[];for(let e=0,i=t.holes.length;e<i;e++){const s=t.holes[e];this.holes.push(s.clone())}return this}toJSON(){const t=super.toJSON();t.uuid=this.uuid,t.holes=[];for(let e=0,i=this.holes.length;e<i;e++){const s=this.holes[e];t.holes.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.uuid=t.uuid,this.holes=[];for(let e=0,i=t.holes.length;e<i;e++){const s=t.holes[e];this.holes.push(new Yl().fromJSON(s))}return this}}const Y1={triangulate:function(n,t,e=2){const i=t&&t.length,s=i?t[0]*e:n.length;let o=Up(n,0,s,e,!0);const r=[];if(!o||o.next===o.prev)return r;let a,c,l,h,u,d,f;if(i&&(o=Q1(n,t,o,e)),n.length>80*e){a=l=n[0],c=h=n[1];for(let v=e;v<s;v+=e)u=n[v],d=n[v+1],u<a&&(a=u),d<c&&(c=d),u>l&&(l=u),d>h&&(h=d);f=Math.max(l-a,h-c),f=f!==0?32767/f:0}return _r(o,r,e,a,c,f,0),r}};function Up(n,t,e,i,s){let o,r;if(s===uS(n,t,e,i)>0)for(o=t;o<e;o+=i)r=Cd(o,n[o],n[o+1],r);else for(o=e-i;o>=t;o-=i)r=Cd(o,n[o],n[o+1],r);return r&&Ja(r,r.next)&&(yr(r),r=r.next),r}function Hs(n,t){if(!n)return n;t||(t=n);let e=n,i;do if(i=!1,!e.steiner&&(Ja(e,e.next)||cn(e.prev,e,e.next)===0)){if(yr(e),e=t=e.prev,e===e.next)break;i=!0}else e=e.next;while(i||e!==t);return t}function _r(n,t,e,i,s,o,r){if(!n)return;!r&&o&&sS(n,i,s,o);let a=n,c,l;for(;n.prev!==n.next;){if(c=n.prev,l=n.next,o?K1(n,i,s,o):$1(n)){t.push(c.i/e|0),t.push(n.i/e|0),t.push(l.i/e|0),yr(n),n=l.next,a=l.next;continue}if(n=l,n===a){r?r===1?(n=Z1(Hs(n),t,e),_r(n,t,e,i,s,o,2)):r===2&&J1(n,t,e,i,s,o):_r(Hs(n),t,e,i,s,o,1);break}}}function $1(n){const t=n.prev,e=n,i=n.next;if(cn(t,e,i)>=0)return!1;const s=t.x,o=e.x,r=i.x,a=t.y,c=e.y,l=i.y,h=s<o?s<r?s:r:o<r?o:r,u=a<c?a<l?a:l:c<l?c:l,d=s>o?s>r?s:r:o>r?o:r,f=a>c?a>l?a:l:c>l?c:l;let v=i.next;for(;v!==t;){if(v.x>=h&&v.x<=d&&v.y>=u&&v.y<=f&&ho(s,a,o,c,r,l,v.x,v.y)&&cn(v.prev,v,v.next)>=0)return!1;v=v.next}return!0}function K1(n,t,e,i){const s=n.prev,o=n,r=n.next;if(cn(s,o,r)>=0)return!1;const a=s.x,c=o.x,l=r.x,h=s.y,u=o.y,d=r.y,f=a<c?a<l?a:l:c<l?c:l,v=h<u?h<d?h:d:u<d?u:d,y=a>c?a>l?a:l:c>l?c:l,m=h>u?h>d?h:d:u>d?u:d,p=$l(f,v,t,e,i),E=$l(y,m,t,e,i);let b=n.prevZ,w=n.nextZ;for(;b&&b.z>=p&&w&&w.z<=E;){if(b.x>=f&&b.x<=y&&b.y>=v&&b.y<=m&&b!==s&&b!==r&&ho(a,h,c,u,l,d,b.x,b.y)&&cn(b.prev,b,b.next)>=0||(b=b.prevZ,w.x>=f&&w.x<=y&&w.y>=v&&w.y<=m&&w!==s&&w!==r&&ho(a,h,c,u,l,d,w.x,w.y)&&cn(w.prev,w,w.next)>=0))return!1;w=w.nextZ}for(;b&&b.z>=p;){if(b.x>=f&&b.x<=y&&b.y>=v&&b.y<=m&&b!==s&&b!==r&&ho(a,h,c,u,l,d,b.x,b.y)&&cn(b.prev,b,b.next)>=0)return!1;b=b.prevZ}for(;w&&w.z<=E;){if(w.x>=f&&w.x<=y&&w.y>=v&&w.y<=m&&w!==s&&w!==r&&ho(a,h,c,u,l,d,w.x,w.y)&&cn(w.prev,w,w.next)>=0)return!1;w=w.nextZ}return!0}function Z1(n,t,e){let i=n;do{const s=i.prev,o=i.next.next;!Ja(s,o)&&Np(s,i,i.next,o)&&xr(s,o)&&xr(o,s)&&(t.push(s.i/e|0),t.push(i.i/e|0),t.push(o.i/e|0),yr(i),yr(i.next),i=n=o),i=i.next}while(i!==n);return Hs(i)}function J1(n,t,e,i,s,o){let r=n;do{let a=r.next.next;for(;a!==r.prev;){if(r.i!==a.i&&aS(r,a)){let c=Fp(r,a);r=Hs(r,r.next),c=Hs(c,c.next),_r(r,t,e,i,s,o,0),_r(c,t,e,i,s,o,0);return}a=a.next}r=r.next}while(r!==n)}function Q1(n,t,e,i){const s=[];let o,r,a,c,l;for(o=0,r=t.length;o<r;o++)a=t[o]*i,c=o<r-1?t[o+1]*i:n.length,l=Up(n,a,c,i,!1),l===l.next&&(l.steiner=!0),s.push(rS(l));for(s.sort(tS),o=0;o<s.length;o++)e=eS(s[o],e);return e}function tS(n,t){return n.x-t.x}function eS(n,t){const e=nS(n,t);if(!e)return t;const i=Fp(e,n);return Hs(i,i.next),Hs(e,e.next)}function nS(n,t){let e=t,i=-1/0,s;const o=n.x,r=n.y;do{if(r<=e.y&&r>=e.next.y&&e.next.y!==e.y){const d=e.x+(r-e.y)*(e.next.x-e.x)/(e.next.y-e.y);if(d<=o&&d>i&&(i=d,s=e.x<e.next.x?e:e.next,d===o))return s}e=e.next}while(e!==t);if(!s)return null;const a=s,c=s.x,l=s.y;let h=1/0,u;e=s;do o>=e.x&&e.x>=c&&o!==e.x&&ho(r<l?o:i,r,c,l,r<l?i:o,r,e.x,e.y)&&(u=Math.abs(r-e.y)/(o-e.x),xr(e,n)&&(u<h||u===h&&(e.x>s.x||e.x===s.x&&iS(s,e)))&&(s=e,h=u)),e=e.next;while(e!==a);return s}function iS(n,t){return cn(n.prev,n,t.prev)<0&&cn(t.next,n,n.next)<0}function sS(n,t,e,i){let s=n;do s.z===0&&(s.z=$l(s.x,s.y,t,e,i)),s.prevZ=s.prev,s.nextZ=s.next,s=s.next;while(s!==n);s.prevZ.nextZ=null,s.prevZ=null,oS(s)}function oS(n){let t,e,i,s,o,r,a,c,l=1;do{for(e=n,n=null,o=null,r=0;e;){for(r++,i=e,a=0,t=0;t<l&&(a++,i=i.nextZ,!!i);t++);for(c=l;a>0||c>0&&i;)a!==0&&(c===0||!i||e.z<=i.z)?(s=e,e=e.nextZ,a--):(s=i,i=i.nextZ,c--),o?o.nextZ=s:n=s,s.prevZ=o,o=s;e=i}o.nextZ=null,l*=2}while(r>1);return n}function $l(n,t,e,i,s){return n=(n-e)*s|0,t=(t-i)*s|0,n=(n|n<<8)&16711935,n=(n|n<<4)&252645135,n=(n|n<<2)&858993459,n=(n|n<<1)&1431655765,t=(t|t<<8)&16711935,t=(t|t<<4)&252645135,t=(t|t<<2)&858993459,t=(t|t<<1)&1431655765,n|t<<1}function rS(n){let t=n,e=n;do(t.x<e.x||t.x===e.x&&t.y<e.y)&&(e=t),t=t.next;while(t!==n);return e}function ho(n,t,e,i,s,o,r,a){return(s-r)*(t-a)>=(n-r)*(o-a)&&(n-r)*(i-a)>=(e-r)*(t-a)&&(e-r)*(o-a)>=(s-r)*(i-a)}function aS(n,t){return n.next.i!==t.i&&n.prev.i!==t.i&&!cS(n,t)&&(xr(n,t)&&xr(t,n)&&lS(n,t)&&(cn(n.prev,n,t.prev)||cn(n,t.prev,t))||Ja(n,t)&&cn(n.prev,n,n.next)>0&&cn(t.prev,t,t.next)>0)}function cn(n,t,e){return(t.y-n.y)*(e.x-t.x)-(t.x-n.x)*(e.y-t.y)}function Ja(n,t){return n.x===t.x&&n.y===t.y}function Np(n,t,e,i){const s=ra(cn(n,t,e)),o=ra(cn(n,t,i)),r=ra(cn(e,i,n)),a=ra(cn(e,i,t));return!!(s!==o&&r!==a||s===0&&oa(n,e,t)||o===0&&oa(n,i,t)||r===0&&oa(e,n,i)||a===0&&oa(e,t,i))}function oa(n,t,e){return t.x<=Math.max(n.x,e.x)&&t.x>=Math.min(n.x,e.x)&&t.y<=Math.max(n.y,e.y)&&t.y>=Math.min(n.y,e.y)}function ra(n){return n>0?1:n<0?-1:0}function cS(n,t){let e=n;do{if(e.i!==n.i&&e.next.i!==n.i&&e.i!==t.i&&e.next.i!==t.i&&Np(e,e.next,n,t))return!0;e=e.next}while(e!==n);return!1}function xr(n,t){return cn(n.prev,n,n.next)<0?cn(n,t,n.next)>=0&&cn(n,n.prev,t)>=0:cn(n,t,n.prev)<0||cn(n,n.next,t)<0}function lS(n,t){let e=n,i=!1;const s=(n.x+t.x)/2,o=(n.y+t.y)/2;do e.y>o!=e.next.y>o&&e.next.y!==e.y&&s<(e.next.x-e.x)*(o-e.y)/(e.next.y-e.y)+e.x&&(i=!i),e=e.next;while(e!==n);return i}function Fp(n,t){const e=new Kl(n.i,n.x,n.y),i=new Kl(t.i,t.x,t.y),s=n.next,o=t.prev;return n.next=t,t.prev=n,e.next=s,s.prev=e,i.next=e,e.prev=i,o.next=i,i.prev=o,i}function Cd(n,t,e,i){const s=new Kl(n,t,e);return i?(s.next=i.next,s.prev=i,i.next.prev=s,i.next=s):(s.prev=s,s.next=s),s}function yr(n){n.next.prev=n.prev,n.prev.next=n.next,n.prevZ&&(n.prevZ.nextZ=n.nextZ),n.nextZ&&(n.nextZ.prevZ=n.prevZ)}function Kl(n,t,e){this.i=n,this.x=t,this.y=e,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function uS(n,t,e,i){let s=0;for(let o=t,r=e-i;o<e;o+=i)s+=(n[r]-n[o])*(n[o+1]+n[r+1]),r=o;return s}class Mo{static area(t){const e=t.length;let i=0;for(let s=e-1,o=0;o<e;s=o++)i+=t[s].x*t[o].y-t[o].x*t[s].y;return i*.5}static isClockWise(t){return Mo.area(t)<0}static triangulateShape(t,e){const i=[],s=[],o=[];Id(t),Ld(i,t);let r=t.length;e.forEach(Id);for(let c=0;c<e.length;c++)s.push(r),r+=e[c].length,Ld(i,e[c]);const a=Y1.triangulate(i,s);for(let c=0;c<a.length;c+=3)o.push(a.slice(c,c+3));return o}}function Id(n){const t=n.length;t>2&&n[t-1].equals(n[0])&&n.pop()}function Ld(n,t){for(let e=0;e<t.length;e++)n.push(t[e].x),n.push(t[e].y)}class Dn extends En{constructor(t=new Sn([new Qt(.5,.5),new Qt(-.5,.5),new Qt(-.5,-.5),new Qt(.5,-.5)]),e={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:t,options:e},t=Array.isArray(t)?t:[t];const i=this,s=[],o=[];for(let a=0,c=t.length;a<c;a++){const l=t[a];r(l)}this.setAttribute("position",new on(s,3)),this.setAttribute("uv",new on(o,2)),this.computeVertexNormals();function r(a){const c=[],l=e.curveSegments!==void 0?e.curveSegments:12,h=e.steps!==void 0?e.steps:1,u=e.depth!==void 0?e.depth:1;let d=e.bevelEnabled!==void 0?e.bevelEnabled:!0,f=e.bevelThickness!==void 0?e.bevelThickness:.2,v=e.bevelSize!==void 0?e.bevelSize:f-.1,y=e.bevelOffset!==void 0?e.bevelOffset:0,m=e.bevelSegments!==void 0?e.bevelSegments:3;const p=e.extrudePath,E=e.UVGenerator!==void 0?e.UVGenerator:hS;let b,w=!1,O,I,R,G;p&&(b=p.getSpacedPoints(h),w=!0,d=!1,O=p.computeFrenetFrames(h,!1),I=new J,R=new J,G=new J),d||(m=0,f=0,v=0,y=0);const tt=a.extractPoints(l);let M=tt.shape;const T=tt.holes;if(!Mo.isClockWise(M)){M=M.reverse();for(let it=0,g=T.length;it<g;it++){const P=T[it];Mo.isClockWise(P)&&(T[it]=P.reverse())}}const $=Mo.triangulateShape(M,T),et=M;for(let it=0,g=T.length;it<g;it++){const P=T[it];M=M.concat(P)}function at(it,g,P){return g||console.error("THREE.ExtrudeGeometry: vec does not exist"),it.clone().addScaledVector(g,P)}const j=M.length,nt=$.length;function W(it,g,P){let D,F,N;const K=it.x-g.x,Z=it.y-g.y,S=P.x-it.x,x=P.y-it.y,C=K*K+Z*Z,Y=K*x-Z*S;if(Math.abs(Y)>Number.EPSILON){const X=Math.sqrt(C),q=Math.sqrt(S*S+x*x),ft=g.x-Z/X,ct=g.y+K/X,vt=P.x-x/q,At=P.y+S/q,dt=((vt-ft)*x-(At-ct)*S)/(K*x-Z*S);D=ft+K*dt-it.x,F=ct+Z*dt-it.y;const _t=D*D+F*F;if(_t<=2)return new Qt(D,F);N=Math.sqrt(_t/2)}else{let X=!1;K>Number.EPSILON?S>Number.EPSILON&&(X=!0):K<-Number.EPSILON?S<-Number.EPSILON&&(X=!0):Math.sign(Z)===Math.sign(x)&&(X=!0),X?(D=-Z,F=K,N=Math.sqrt(C)):(D=K,F=Z,N=Math.sqrt(C/2))}return new Qt(D/N,F/N)}const gt=[];for(let it=0,g=et.length,P=g-1,D=it+1;it<g;it++,P++,D++)P===g&&(P=0),D===g&&(D=0),gt[it]=W(et[it],et[P],et[D]);const xt=[];let wt,Nt=gt.concat();for(let it=0,g=T.length;it<g;it++){const P=T[it];wt=[];for(let D=0,F=P.length,N=F-1,K=D+1;D<F;D++,N++,K++)N===F&&(N=0),K===F&&(K=0),wt[D]=W(P[D],P[N],P[K]);xt.push(wt),Nt=Nt.concat(wt)}for(let it=0;it<m;it++){const g=it/m,P=f*Math.cos(g*Math.PI/2),D=v*Math.sin(g*Math.PI/2)+y;for(let F=0,N=et.length;F<N;F++){const K=at(et[F],gt[F],D);B(K.x,K.y,-P)}for(let F=0,N=T.length;F<N;F++){const K=T[F];wt=xt[F];for(let Z=0,S=K.length;Z<S;Z++){const x=at(K[Z],wt[Z],D);B(x.x,x.y,-P)}}}const kt=v+y;for(let it=0;it<j;it++){const g=d?at(M[it],Nt[it],kt):M[it];w?(R.copy(O.normals[0]).multiplyScalar(g.x),I.copy(O.binormals[0]).multiplyScalar(g.y),G.copy(b[0]).add(R).add(I),B(G.x,G.y,G.z)):B(g.x,g.y,0)}for(let it=1;it<=h;it++)for(let g=0;g<j;g++){const P=d?at(M[g],Nt[g],kt):M[g];w?(R.copy(O.normals[it]).multiplyScalar(P.x),I.copy(O.binormals[it]).multiplyScalar(P.y),G.copy(b[it]).add(R).add(I),B(G.x,G.y,G.z)):B(P.x,P.y,u/h*it)}for(let it=m-1;it>=0;it--){const g=it/m,P=f*Math.cos(g*Math.PI/2),D=v*Math.sin(g*Math.PI/2)+y;for(let F=0,N=et.length;F<N;F++){const K=at(et[F],gt[F],D);B(K.x,K.y,u+P)}for(let F=0,N=T.length;F<N;F++){const K=T[F];wt=xt[F];for(let Z=0,S=K.length;Z<S;Z++){const x=at(K[Z],wt[Z],D);w?B(x.x,x.y+b[h-1].y,b[h-1].x+P):B(x.x,x.y,u+P)}}}rt(),pt();function rt(){const it=s.length/3;if(d){let g=0,P=j*g;for(let D=0;D<nt;D++){const F=$[D];lt(F[2]+P,F[1]+P,F[0]+P)}g=h+m*2,P=j*g;for(let D=0;D<nt;D++){const F=$[D];lt(F[0]+P,F[1]+P,F[2]+P)}}else{for(let g=0;g<nt;g++){const P=$[g];lt(P[2],P[1],P[0])}for(let g=0;g<nt;g++){const P=$[g];lt(P[0]+j*h,P[1]+j*h,P[2]+j*h)}}i.addGroup(it,s.length/3-it,0)}function pt(){const it=s.length/3;let g=0;Pt(et,g),g+=et.length;for(let P=0,D=T.length;P<D;P++){const F=T[P];Pt(F,g),g+=F.length}i.addGroup(it,s.length/3-it,1)}function Pt(it,g){let P=it.length;for(;--P>=0;){const D=P;let F=P-1;F<0&&(F=it.length-1);for(let N=0,K=h+m*2;N<K;N++){const Z=j*N,S=j*(N+1),x=g+D+Z,C=g+F+Z,Y=g+F+S,X=g+D+S;ot(x,C,Y,X)}}}function B(it,g,P){c.push(it),c.push(g),c.push(P)}function lt(it,g,P){ht(it),ht(g),ht(P);const D=s.length/3,F=E.generateTopUV(i,s,D-3,D-2,D-1);yt(F[0]),yt(F[1]),yt(F[2])}function ot(it,g,P,D){ht(it),ht(g),ht(D),ht(g),ht(P),ht(D);const F=s.length/3,N=E.generateSideWallUV(i,s,F-6,F-3,F-2,F-1);yt(N[0]),yt(N[1]),yt(N[3]),yt(N[1]),yt(N[2]),yt(N[3])}function ht(it){s.push(c[it*3+0]),s.push(c[it*3+1]),s.push(c[it*3+2])}function yt(it){o.push(it.x),o.push(it.y)}}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){const t=super.toJSON(),e=this.parameters.shapes,i=this.parameters.options;return dS(e,i,t)}static fromJSON(t,e){const i=[];for(let o=0,r=t.shapes.length;o<r;o++){const a=e[t.shapes[o]];i.push(a)}const s=t.options.extrudePath;return s!==void 0&&(t.options.extrudePath=new jl[s.type]().fromJSON(s)),new Dn(i,t.options)}}const hS={generateTopUV:function(n,t,e,i,s){const o=t[e*3],r=t[e*3+1],a=t[i*3],c=t[i*3+1],l=t[s*3],h=t[s*3+1];return[new Qt(o,r),new Qt(a,c),new Qt(l,h)]},generateSideWallUV:function(n,t,e,i,s,o){const r=t[e*3],a=t[e*3+1],c=t[e*3+2],l=t[i*3],h=t[i*3+1],u=t[i*3+2],d=t[s*3],f=t[s*3+1],v=t[s*3+2],y=t[o*3],m=t[o*3+1],p=t[o*3+2];return Math.abs(a-h)<Math.abs(r-l)?[new Qt(r,1-c),new Qt(l,1-u),new Qt(d,1-v),new Qt(y,1-p)]:[new Qt(a,1-c),new Qt(h,1-u),new Qt(f,1-v),new Qt(m,1-p)]}};function dS(n,t,e){if(e.shapes=[],Array.isArray(n))for(let i=0,s=n.length;i<s;i++){const o=n[i];e.shapes.push(o.uuid)}else e.shapes.push(n.uuid);return e.options=Object.assign({},t),t.extrudePath!==void 0&&(e.options.extrudePath=t.extrudePath.toJSON()),e}class ut extends En{constructor(t=1,e=32,i=16,s=0,o=Math.PI*2,r=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:t,widthSegments:e,heightSegments:i,phiStart:s,phiLength:o,thetaStart:r,thetaLength:a},e=Math.max(3,Math.floor(e)),i=Math.max(2,Math.floor(i));const c=Math.min(r+a,Math.PI);let l=0;const h=[],u=new J,d=new J,f=[],v=[],y=[],m=[];for(let p=0;p<=i;p++){const E=[],b=p/i;let w=0;p===0&&r===0?w=.5/e:p===i&&c===Math.PI&&(w=-.5/e);for(let O=0;O<=e;O++){const I=O/e;u.x=-t*Math.cos(s+I*o)*Math.sin(r+b*a),u.y=t*Math.cos(r+b*a),u.z=t*Math.sin(s+I*o)*Math.sin(r+b*a),v.push(u.x,u.y,u.z),d.copy(u).normalize(),y.push(d.x,d.y,d.z),m.push(I+w,1-b),E.push(l++)}h.push(E)}for(let p=0;p<i;p++)for(let E=0;E<e;E++){const b=h[p][E+1],w=h[p][E],O=h[p+1][E],I=h[p+1][E+1];(p!==0||r>0)&&f.push(b,w,I),(p!==i-1||c<Math.PI)&&f.push(w,O,I)}this.setIndex(f),this.setAttribute("position",new on(v,3)),this.setAttribute("normal",new on(y,3)),this.setAttribute("uv",new on(m,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new ut(t.radius,t.widthSegments,t.heightSegments,t.phiStart,t.phiLength,t.thetaStart,t.thetaLength)}}class Gn extends En{constructor(t=1,e=.4,i=12,s=48,o=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:t,tube:e,radialSegments:i,tubularSegments:s,arc:o},i=Math.floor(i),s=Math.floor(s);const r=[],a=[],c=[],l=[],h=new J,u=new J,d=new J;for(let f=0;f<=i;f++)for(let v=0;v<=s;v++){const y=v/s*o,m=f/i*Math.PI*2;u.x=(t+e*Math.cos(m))*Math.cos(y),u.y=(t+e*Math.cos(m))*Math.sin(y),u.z=e*Math.sin(m),a.push(u.x,u.y,u.z),h.x=t*Math.cos(y),h.y=t*Math.sin(y),d.subVectors(u,h).normalize(),c.push(d.x,d.y,d.z),l.push(v/s),l.push(f/i)}for(let f=1;f<=i;f++)for(let v=1;v<=s;v++){const y=(s+1)*f+v-1,m=(s+1)*(f-1)+v-1,p=(s+1)*(f-1)+v,E=(s+1)*f+v;r.push(y,m,E),r.push(m,p,E)}this.setIndex(r),this.setAttribute("position",new on(a,3)),this.setAttribute("normal",new on(c,3)),this.setAttribute("uv",new on(l,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Gn(t.radius,t.tube,t.radialSegments,t.tubularSegments,t.arc)}}class Lt extends Do{constructor(t){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Me(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Me(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=hp,this.normalScale=new Qt(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Ui,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.defines={STANDARD:""},this.color.copy(t.color),this.roughness=t.roughness,this.metalness=t.metalness,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.roughnessMap=t.roughnessMap,this.metalnessMap=t.metalnessMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.envMapIntensity=t.envMapIntensity,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class Ot extends Lt{constructor(t){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new Qt(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return xn(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(e){this.ior=(1+.4*e)/(1-.4*e)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new Me(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new Me(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new Me(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._dispersion=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(t)}get anisotropy(){return this._anisotropy}set anisotropy(t){this._anisotropy>0!=t>0&&this.version++,this._anisotropy=t}get clearcoat(){return this._clearcoat}set clearcoat(t){this._clearcoat>0!=t>0&&this.version++,this._clearcoat=t}get iridescence(){return this._iridescence}set iridescence(t){this._iridescence>0!=t>0&&this.version++,this._iridescence=t}get dispersion(){return this._dispersion}set dispersion(t){this._dispersion>0!=t>0&&this.version++,this._dispersion=t}get sheen(){return this._sheen}set sheen(t){this._sheen>0!=t>0&&this.version++,this._sheen=t}get transmission(){return this._transmission}set transmission(t){this._transmission>0!=t>0&&this.version++,this._transmission=t}copy(t){return super.copy(t),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=t.anisotropy,this.anisotropyRotation=t.anisotropyRotation,this.anisotropyMap=t.anisotropyMap,this.clearcoat=t.clearcoat,this.clearcoatMap=t.clearcoatMap,this.clearcoatRoughness=t.clearcoatRoughness,this.clearcoatRoughnessMap=t.clearcoatRoughnessMap,this.clearcoatNormalMap=t.clearcoatNormalMap,this.clearcoatNormalScale.copy(t.clearcoatNormalScale),this.dispersion=t.dispersion,this.ior=t.ior,this.iridescence=t.iridescence,this.iridescenceMap=t.iridescenceMap,this.iridescenceIOR=t.iridescenceIOR,this.iridescenceThicknessRange=[...t.iridescenceThicknessRange],this.iridescenceThicknessMap=t.iridescenceThicknessMap,this.sheen=t.sheen,this.sheenColor.copy(t.sheenColor),this.sheenColorMap=t.sheenColorMap,this.sheenRoughness=t.sheenRoughness,this.sheenRoughnessMap=t.sheenRoughnessMap,this.transmission=t.transmission,this.transmissionMap=t.transmissionMap,this.thickness=t.thickness,this.thicknessMap=t.thicknessMap,this.attenuationDistance=t.attenuationDistance,this.attenuationColor.copy(t.attenuationColor),this.specularIntensity=t.specularIntensity,this.specularIntensityMap=t.specularIntensityMap,this.specularColor.copy(t.specularColor),this.specularColorMap=t.specularColorMap,this}}const Ia={enabled:!1,files:{},add:function(n,t){this.enabled!==!1&&(this.files[n]=t)},get:function(n){if(this.enabled!==!1)return this.files[n]},remove:function(n){delete this.files[n]},clear:function(){this.files={}}};class fS{constructor(t,e,i){const s=this;let o=!1,r=0,a=0,c;const l=[];this.onStart=void 0,this.onLoad=t,this.onProgress=e,this.onError=i,this.itemStart=function(h){a++,o===!1&&s.onStart!==void 0&&s.onStart(h,r,a),o=!0},this.itemEnd=function(h){r++,s.onProgress!==void 0&&s.onProgress(h,r,a),r===a&&(o=!1,s.onLoad!==void 0&&s.onLoad())},this.itemError=function(h){s.onError!==void 0&&s.onError(h)},this.resolveURL=function(h){return c?c(h):h},this.setURLModifier=function(h){return c=h,this},this.addHandler=function(h,u){return l.push(h,u),this},this.removeHandler=function(h){const u=l.indexOf(h);return u!==-1&&l.splice(u,2),this},this.getHandler=function(h){for(let u=0,d=l.length;u<d;u+=2){const f=l[u],v=l[u+1];if(f.global&&(f.lastIndex=0),f.test(h))return v}return null}}}const pS=new fS;class No{constructor(t){this.manager=t!==void 0?t:pS,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(t,e){const i=this;return new Promise(function(s,o){i.load(t,s,e,o)})}parse(){}setCrossOrigin(t){return this.crossOrigin=t,this}setWithCredentials(t){return this.withCredentials=t,this}setPath(t){return this.path=t,this}setResourcePath(t){return this.resourcePath=t,this}setRequestHeader(t){return this.requestHeader=t,this}}No.DEFAULT_MATERIAL_NAME="__DEFAULT";const qi={};class mS extends Error{constructor(t,e){super(t),this.response=e}}class gS extends No{constructor(t){super(t)}load(t,e,i,s){t===void 0&&(t=""),this.path!==void 0&&(t=this.path+t),t=this.manager.resolveURL(t);const o=Ia.get(t);if(o!==void 0)return this.manager.itemStart(t),setTimeout(()=>{e&&e(o),this.manager.itemEnd(t)},0),o;if(qi[t]!==void 0){qi[t].push({onLoad:e,onProgress:i,onError:s});return}qi[t]=[],qi[t].push({onLoad:e,onProgress:i,onError:s});const r=new Request(t,{headers:new Headers(this.requestHeader),credentials:this.withCredentials?"include":"same-origin"}),a=this.mimeType,c=this.responseType;fetch(r).then(l=>{if(l.status===200||l.status===0){if(l.status===0&&console.warn("THREE.FileLoader: HTTP Status 0 received."),typeof ReadableStream>"u"||l.body===void 0||l.body.getReader===void 0)return l;const h=qi[t],u=l.body.getReader(),d=l.headers.get("X-File-Size")||l.headers.get("Content-Length"),f=d?parseInt(d):0,v=f!==0;let y=0;const m=new ReadableStream({start(p){E();function E(){u.read().then(({done:b,value:w})=>{if(b)p.close();else{y+=w.byteLength;const O=new ProgressEvent("progress",{lengthComputable:v,loaded:y,total:f});for(let I=0,R=h.length;I<R;I++){const G=h[I];G.onProgress&&G.onProgress(O)}p.enqueue(w),E()}},b=>{p.error(b)})}}});return new Response(m)}else throw new mS(`fetch for "${l.url}" responded with ${l.status}: ${l.statusText}`,l)}).then(l=>{switch(c){case"arraybuffer":return l.arrayBuffer();case"blob":return l.blob();case"document":return l.text().then(h=>new DOMParser().parseFromString(h,a));case"json":return l.json();default:if(a===void 0)return l.text();{const u=/charset="?([^;"\s]*)"?/i.exec(a),d=u&&u[1]?u[1].toLowerCase():void 0,f=new TextDecoder(d);return l.arrayBuffer().then(v=>f.decode(v))}}}).then(l=>{Ia.add(t,l);const h=qi[t];delete qi[t];for(let u=0,d=h.length;u<d;u++){const f=h[u];f.onLoad&&f.onLoad(l)}}).catch(l=>{const h=qi[t];if(h===void 0)throw this.manager.itemError(t),l;delete qi[t];for(let u=0,d=h.length;u<d;u++){const f=h[u];f.onError&&f.onError(l)}this.manager.itemError(t)}).finally(()=>{this.manager.itemEnd(t)}),this.manager.itemStart(t)}setResponseType(t){return this.responseType=t,this}setMimeType(t){return this.mimeType=t,this}}class Op extends No{constructor(t){super(t)}load(t,e,i,s){this.path!==void 0&&(t=this.path+t),t=this.manager.resolveURL(t);const o=this,r=Ia.get(t);if(r!==void 0)return o.manager.itemStart(t),setTimeout(function(){e&&e(r),o.manager.itemEnd(t)},0),r;const a=gr("img");function c(){h(),Ia.add(t,this),e&&e(this),o.manager.itemEnd(t)}function l(u){h(),s&&s(u),o.manager.itemError(t),o.manager.itemEnd(t)}function h(){a.removeEventListener("load",c,!1),a.removeEventListener("error",l,!1)}return a.addEventListener("load",c,!1),a.addEventListener("error",l,!1),t.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(a.crossOrigin=this.crossOrigin),o.manager.itemStart(t),a.src=t,a}}class Tr extends No{constructor(t){super(t)}load(t,e,i,s){const o=new Cu;o.colorSpace=vi;const r=new Op(this.manager);r.setCrossOrigin(this.crossOrigin),r.setPath(this.path);let a=0;function c(l){r.load(t[l],function(h){o.images[l]=h,a++,a===6&&(o.needsUpdate=!0,e&&e(o))},void 0,s)}for(let l=0;l<t.length;++l)c(l);return o}}class Yn extends No{constructor(t){super(t)}load(t,e,i,s){const o=new In,r=new Op(this.manager);return r.setCrossOrigin(this.crossOrigin),r.setPath(this.path),r.load(t,function(a){o.image=a,o.needsUpdate=!0,e!==void 0&&e(o)},i,s),o}}class Nu extends wn{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new Me(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(e.object.target=this.target.uuid),e}}const qc=new sn,Dd=new J,Ud=new J;class Bp{constructor(t){this.camera=t,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Qt(512,512),this.map=null,this.mapPass=null,this.matrix=new sn,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Iu,this._frameExtents=new Qt(1,1),this._viewportCount=1,this._viewports=[new Xe(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,i=this.matrix;Dd.setFromMatrixPosition(t.matrixWorld),e.position.copy(Dd),Ud.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(Ud),e.updateMatrixWorld(),qc.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(qc),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(qc)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.intensity=t.intensity,this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.intensity!==1&&(t.intensity=this.intensity),this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}const Nd=new sn,Xo=new J,jc=new J;class vS extends Bp{constructor(){super(new Ke(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new Qt(4,2),this._viewportCount=6,this._viewports=[new Xe(2,1,1,1),new Xe(0,1,1,1),new Xe(3,1,1,1),new Xe(1,1,1,1),new Xe(3,0,1,1),new Xe(1,0,1,1)],this._cubeDirections=[new J(1,0,0),new J(-1,0,0),new J(0,0,1),new J(0,0,-1),new J(0,1,0),new J(0,-1,0)],this._cubeUps=[new J(0,1,0),new J(0,1,0),new J(0,1,0),new J(0,1,0),new J(0,0,1),new J(0,0,-1)]}updateMatrices(t,e=0){const i=this.camera,s=this.matrix,o=t.distance||i.far;o!==i.far&&(i.far=o,i.updateProjectionMatrix()),Xo.setFromMatrixPosition(t.matrixWorld),i.position.copy(Xo),jc.copy(i.position),jc.add(this._cubeDirections[e]),i.up.copy(this._cubeUps[e]),i.lookAt(jc),i.updateMatrixWorld(),s.makeTranslation(-Xo.x,-Xo.y,-Xo.z),Nd.multiplyMatrices(i.projectionMatrix,i.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Nd)}}class li extends Nu{constructor(t,e,i=0,s=2){super(t,e),this.isPointLight=!0,this.type="PointLight",this.distance=i,this.decay=s,this.shadow=new vS}get power(){return this.intensity*4*Math.PI}set power(t){this.intensity=t/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(t,e){return super.copy(t,e),this.distance=t.distance,this.decay=t.decay,this.shadow=t.shadow.clone(),this}}class _S extends Bp{constructor(){super(new bp(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class ui extends Nu{constructor(t,e){super(t,e),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(wn.DEFAULT_UP),this.updateMatrix(),this.target=new wn,this.shadow=new _S}dispose(){this.shadow.dispose()}copy(t){return super.copy(t),this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}class hi extends Nu{constructor(t,e){super(t,e),this.isAmbientLight=!0,this.type="AmbientLight"}}class zp{constructor(t=!0){this.autoStart=t,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Fd(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let t=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const e=Fd();t=(e-this.oldTime)/1e3,this.oldTime=e,this.elapsedTime+=t}return t}}function Fd(){return performance.now()}class xS{constructor(){this.type="ShapePath",this.color=new Me,this.subPaths=[],this.currentPath=null}moveTo(t,e){return this.currentPath=new Yl,this.subPaths.push(this.currentPath),this.currentPath.moveTo(t,e),this}lineTo(t,e){return this.currentPath.lineTo(t,e),this}quadraticCurveTo(t,e,i,s){return this.currentPath.quadraticCurveTo(t,e,i,s),this}bezierCurveTo(t,e,i,s,o,r){return this.currentPath.bezierCurveTo(t,e,i,s,o,r),this}splineThru(t){return this.currentPath.splineThru(t),this}toShapes(t){function e(p){const E=[];for(let b=0,w=p.length;b<w;b++){const O=p[b],I=new Sn;I.curves=O.curves,E.push(I)}return E}function i(p,E){const b=E.length;let w=!1;for(let O=b-1,I=0;I<b;O=I++){let R=E[O],G=E[I],tt=G.x-R.x,M=G.y-R.y;if(Math.abs(M)>Number.EPSILON){if(M<0&&(R=E[I],tt=-tt,G=E[O],M=-M),p.y<R.y||p.y>G.y)continue;if(p.y===R.y){if(p.x===R.x)return!0}else{const T=M*(p.x-R.x)-tt*(p.y-R.y);if(T===0)return!0;if(T<0)continue;w=!w}}else{if(p.y!==R.y)continue;if(G.x<=p.x&&p.x<=R.x||R.x<=p.x&&p.x<=G.x)return!0}}return w}const s=Mo.isClockWise,o=this.subPaths;if(o.length===0)return[];let r,a,c;const l=[];if(o.length===1)return a=o[0],c=new Sn,c.curves=a.curves,l.push(c),l;let h=!s(o[0].getPoints());h=t?!h:h;const u=[],d=[];let f=[],v=0,y;d[v]=void 0,f[v]=[];for(let p=0,E=o.length;p<E;p++)a=o[p],y=a.getPoints(),r=s(y),r=t?!r:r,r?(!h&&d[v]&&v++,d[v]={s:new Sn,p:y},d[v].s.curves=a.curves,h&&v++,f[v]=[]):f[v].push({h:a,p:y[0]});if(!d[0])return e(o);if(d.length>1){let p=!1,E=0;for(let b=0,w=d.length;b<w;b++)u[b]=[];for(let b=0,w=d.length;b<w;b++){const O=f[b];for(let I=0;I<O.length;I++){const R=O[I];let G=!0;for(let tt=0;tt<d.length;tt++)i(R.p,d[tt].p)&&(b!==tt&&E++,G?(G=!1,u[tt].push(R)):p=!0);G&&u[b].push(R)}}E>0&&p===!1&&(f=u)}let m;for(let p=0,E=d.length;p<E;p++){c=d[p].s,l.push(c),m=f[p];for(let b=0,w=m.length;b<w;b++)c.holes.push(m[b].h)}return l}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Mu}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Mu);class di extends No{constructor(t){super(t)}load(t,e,i,s){const o=this,r=new gS(this.manager);r.setPath(this.path),r.setRequestHeader(this.requestHeader),r.setWithCredentials(this.withCredentials),r.load(t,function(a){const c=o.parse(JSON.parse(a));e&&e(c)},i,s)}parse(t){return new yS(t)}}class yS{constructor(t){this.isFont=!0,this.type="Font",this.data=t}generateShapes(t,e=100){const i=[],s=MS(t,e,this.data);for(let o=0,r=s.length;o<r;o++)i.push(...s[o].toShapes());return i}}function MS(n,t,e){const i=Array.from(n),s=t/e.resolution,o=(e.boundingBox.yMax-e.boundingBox.yMin+e.underlineThickness)*s,r=[];let a=0,c=0;for(let l=0;l<i.length;l++){const h=i[l];if(h===`
`)a=0,c-=o;else{const u=wS(h,s,a,c,e);a+=u.offsetX,r.push(u.path)}}return r}function wS(n,t,e,i,s){const o=s.glyphs[n]||s.glyphs["?"];if(!o){console.error('THREE.Font: character "'+n+'" does not exists in font family '+s.familyName+".");return}const r=new xS;let a,c,l,h,u,d,f,v;if(o.o){const y=o._cachedOutline||(o._cachedOutline=o.o.split(" "));for(let m=0,p=y.length;m<p;)switch(y[m++]){case"m":a=y[m++]*t+e,c=y[m++]*t+i,r.moveTo(a,c);break;case"l":a=y[m++]*t+e,c=y[m++]*t+i,r.lineTo(a,c);break;case"q":l=y[m++]*t+e,h=y[m++]*t+i,u=y[m++]*t+e,d=y[m++]*t+i,r.quadraticCurveTo(u,d,l,h);break;case"b":l=y[m++]*t+e,h=y[m++]*t+i,u=y[m++]*t+e,d=y[m++]*t+i,f=y[m++]*t+e,v=y[m++]*t+i,r.bezierCurveTo(u,d,f,v,l,h);break}}return{offsetX:o.ha*t,path:r}}class qe extends Dn{constructor(t,e={}){const i=e.font;if(i===void 0)super();else{const s=i.generateShapes(t,e.size);e.depth===void 0&&e.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),e.depth=e.depth!==void 0?e.depth:e.height!==void 0?e.height:50,e.bevelThickness===void 0&&(e.bevelThickness=10),e.bevelSize===void 0&&(e.bevelSize=8),e.bevelEnabled===void 0&&(e.bevelEnabled=!1),super(s,e)}this.type="TextGeometry"}}const SS=Un({__name:"MetalBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);let i=null,s=$t(!1),o=$t(!1),r=$t(!1);return Wn(()=>{if(e.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:o.value&&(u.rotation.y-=.03),h.render(c,l)};const c=new kn,l=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),h=new Hn({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(h.domElement);const u=new Xt,d=new hi(16777215,2);c.add(d);const f=new ui(16777215,4);f.position.set(5,5,5),c.add(f);const v=new li(16777215,5,50);v.position.set(0,2,4),c.add(v);const y=new Yn,m=y.load("/3d-bear-arts/assets/lv2.jpg"),p=y.load("/3d-bear-arts/assets/lv2.jpg");m.wrapS=m.wrapT=Qe,p.wrapS=p.wrapT=Qe;const E=new Ot({color:8343336,metalness:0,roughness:.8,bumpMap:m,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:p,envMapIntensity:.7}),b=new Ot({color:5978654,metalness:0,roughness:.8,bumpMap:m,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:p,envMapIntensity:.7}),w=new Ot({color:13152668,metalness:.2,roughness:.05,bumpMap:m,bumpScale:.05,clearcoat:1,clearcoatRoughness:.05,map:p,transparent:!0,opacity:.4,transmission:.9,envMapIntensity:1,reflectivity:.9,ior:1.45,side:Ae});new Ot({color:13421772,metalness:1,roughness:.5,clearcoat:.3,clearcoatRoughness:.3});const O=new ut(1,32,32,0,Math.PI),I=new _(O,w),R=new _(O,E);I.scale.set(.85,.85,.8),R.scale.set(.85,.85,.8),I.position.y=-.2,R.position.y=-.2,I.rotation.y=Math.PI/2,R.rotation.y=Math.PI*1.5;const G=new Ce(1,32),tt=new _(G,E);tt.scale.set(.85,.85,.8),tt.position.set(0,-.2,0),tt.rotation.y=Math.PI/2;const M=new Xt;M.add(I),M.add(R),M.add(tt),u.add(M);const T=new ut(.6,32,32,0,Math.PI),U=new _(T,E);U.scale.set(1,.95,.95),U.position.set(0,1,0),U.rotation.y=Math.PI*1.5;const $=new _(T,w);$.scale.set(1,.95,.95),$.position.set(0,1,0),$.rotation.y=Math.PI/2;const et=new Ce(.6,32),at=new _(et,E);at.position.set(0,1,0),at.rotation.y=Math.PI/2,at.scale.set(1,.95,.95);const j=new Xt;j.add(U),j.add($),j.add(at),u.add(j);const nt=new ut(.25,32,32),W=new _(nt,E);W.position.set(-.45,1.35,-.1),u.add(W);const gt=new _(nt,w);gt.position.set(.45,1.35,-.1),u.add(gt);const xt=new ut(.25,32,32,Math.PI/2,Math.PI),wt=new _(xt,b);wt.scale.set(1.1,.6,.8),wt.position.set(0,.84,.5),wt.rotation.y=Math.PI;const Nt=new ut(.25,32,32,Math.PI/2,Math.PI),kt=new _(Nt,w);kt.scale.set(1.1,.6,.8),kt.position.set(0,.84,.5),kt.rotation.y=0;const rt=new Ce(.25,32),pt=new _(rt,E);pt.scale.set(.8,.6,.8),pt.position.set(0,.84,.5),pt.rotation.y=Math.PI/2;const Pt=new Xt;Pt.add(wt),Pt.add(kt),Pt.add(pt),u.add(Pt);const B=new Sn;B.moveTo(0,0),B.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),B.bezierCurveTo(-.6,.3,0,.6,0,1),B.bezierCurveTo(0,.6,.6,.3,.6,0),B.bezierCurveTo(.6,-.3,0,-.3,0,0);const lt={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Ot({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const ot=new Dn(B,lt),ht=new _(ot,E);ht.scale.set(.1,.1,.1),ht.rotation.z=ue.degToRad(210),ht.rotation.x=ue.degToRad(5),ht.rotation.y=ue.degToRad(-45),ht.position.set(-.4,.9,.45);const yt=new _(ot,b);yt.scale.set(.6,.5,.5),yt.position.set(.35,0,0),yt.rotation.y=Math.PI,yt.rotation.x=Math.PI;const it=new _(ot,b);it.scale.set(.2,.2,.2),it.position.set(.5,-.1,.2),it.rotation.y=Math.PI,it.rotation.x=Math.PI,u.add(it);const g=new yn(1.3,1.2,.6),P=new _(g,E);P.scale.set(.45,.45,.45),P.position.set(.35,-.2,.1),P.rotation.y=Math.PI;const D=new Gn(.15,.025,10,100);new Ot({color:8343336,metalness:.3,roughness:.4,clearcoat:.5});const F=new _(D,E);F.position.set(.35,.1,.1),F.rotation.z=Math.PI/2,F.rotation.x=Math.PI/8,F.rotation.y=Math.PI/14;const N=new _(D,E);N.position.set(.35,.1,.13),N.rotation.z=Math.PI/2,N.rotation.x=Math.PI/-8,N.rotation.y=Math.PI/12;const K=new Xt;K.add(P),K.add(F),K.add(N),u.add(K);const Z=new ut(.35,32,32),S=new _(Z,E);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),u.add(S);const x=new _(Z,w);x.scale.set(.75,1.25,.65),x.position.set(.7,-.15,.2),u.add(x);const C=new te(.2,.22,.6,32),Y=new _(C,E);Y.position.set(-.4,-1.05,0),u.add(Y);const X=new _(C,w);X.position.set(.4,-1.05,0),u.add(X);const q=new ut(.3,32,32),ft=new _(q,E);ft.scale.set(1,.72,1.5),ft.position.set(-.4,-1.45,.17),u.add(ft);const ct=new _(q,w);ct.scale.set(1,.72,1.5),ct.position.set(.4,-1.45,.17),u.add(ct);const vt=new ut(.44,32,32),At=new _(vt,E);At.position.set(-.15,-.45,-.4),u.add(At);const dt=new _(vt,w);dt.position.set(.15,-.45,-.4),u.add(dt);const _t=new ut(.18,32,32),Dt=new _(_t,E);Dt.position.set(0,-.35,-.8),u.add(Dt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Q){const St=new qe("X",{font:Q,size:.2,depth:.05});new es({color:0});const Et=new _(St,b);Et.position.set(-.3,.99,.53),Et.rotation.x=ue.degToRad(-5),Et.rotation.y=ue.degToRad(-15),u.add(Et);const Wt=new qe("O",{font:Q,size:.2,depth:.05});new es({color:0});const ne=new _(Wt,b);ne.position.set(.14,.99,.53),ne.rotation.y=ue.degToRad(12),ne.rotation.x=ue.degToRad(-5),u.add(ne)}),Dt.renderOrder=1,u.scale.set(1.35,1.35,1.35),c.add(u),u.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),l.position.set(t.bodyPosition.x,1,t.cameraPosition),l.lookAt(t.bodyPosition.x,0,0),l.position.z=4;const It=()=>{u.rotation.y,u.rotation.x},Kt=()=>{s.value=!0,o.value=!1,r.value=!1},Gt=()=>{s.value=!1,o.value=!0,r.value=!1},Zt=()=>{s.value=!1,o.value=!1,It()},H=Q=>{const St=window.innerWidth/2;Q>St?Kt():Gt(),It()},Mt=Q=>{clearTimeout(i),Zt(),r.value=!0;const St={x:Q.clientX/window.innerWidth*2-1,y:-(Q.clientY/window.innerHeight)*2+1};if(r.value){const Et=St.x*Math.PI*.2,Wt=St.y*Math.PI*.2;u.rotation.y=Et,u.rotation.x=Wt}i=setTimeout(()=>{r.value=!1,H(Q.clientX)},500)};window.addEventListener("mousemove",Mt);const st=Q=>{if(r.value){const St={x:Q.clientX/window.innerWidth*2-1,y:-(Q.clientY/window.innerHeight)*2+1},Et=St.x*Math.PI*.2,Wt=St.y*Math.PI*.2;u.rotation.y=Et,u.rotation.x=Wt}};window.addEventListener("mousemove",st),a(),je(()=>t.bodyPosition,Q=>{u.position.set(Q.x,Q.y,Q.z)}),je(()=>t.cameraPosition,Q=>{l.position.set(t.bodyPosition.x,1,Q),l.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,c)=>(Xn(),$n("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2))}}),bS=Kn(SS,[["__scopeId","data-v-f3beb116"]]),ES=Un({__name:"PopartBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);let i=null,s=$t(!1),o=$t(!1),r=$t(!1);return Wn(()=>{if(e.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:o.value&&(u.rotation.y-=.03),h.render(c,l)};const c=new kn,l=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),h=new Hn({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(h.domElement);const u=new Xt,d=new hi(16777215,2);c.add(d);const f=new ui(16777215,4);f.position.set(5,5,5),c.add(f);const v=new li(16777215,5,50);v.position.set(0,2,4),c.add(v);const y=new Yn,m=y.load("/3d-bear-arts/assets/pop6.jpg"),p=y.load("/3d-bear-arts/assets/pop7.jpg");m.wrapS=m.wrapT=Qe,p.wrapS=p.wrapT=Qe;const E=new Ot({color:16738740,map:p,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),b=new Ot({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),w=new Ot({color:16766720,map:m,metalness:.3,roughness:.5}),O=new Ot({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),I=new Ot({color:9055202,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new Ot({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae});const R=new Ot({color:65535,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),G=new Ot({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),tt=new ut(1,32,32,0,Math.PI),M=new _(tt,b),T=new _(tt,E);M.scale.set(.85,.85,.8),T.scale.set(.85,.85,.8),M.position.y=-.2,T.position.y=-.2,M.rotation.y=Math.PI/2,T.rotation.y=Math.PI*1.5;const U=new Ce(1,32),$=new _(U,E);$.scale.set(.85,.85,.8),$.position.set(0,-.2,0),$.rotation.y=Math.PI/2;const et=new Xt;et.add(M),et.add(T),et.add($),u.add(et);const at=new ut(.6,32,32,0,Math.PI),j=new _(at,w);j.scale.set(1,.95,.95),j.position.set(0,1,0),j.rotation.y=Math.PI*1.5;const nt=new _(at,O);nt.scale.set(1,.95,.95),nt.position.set(0,1,0),nt.rotation.y=Math.PI/2;const W=new Ce(.6,32),gt=new _(W,w);gt.position.set(0,1,0),gt.rotation.y=Math.PI/2,gt.scale.set(1,.95,.95);const xt=new Xt;xt.add(j),xt.add(nt),xt.add(gt),u.add(xt);const wt=new ut(.25,32,32),Nt=new _(wt,E);Nt.position.set(-.45,1.35,-.1),u.add(Nt);const kt=new _(wt,b);kt.position.set(.45,1.35,-.1),u.add(kt);const rt=new ut(.25,32,32,Math.PI/2,Math.PI),pt=new _(rt,w);pt.scale.set(1.1,.6,.8),pt.position.set(0,.84,.5),pt.rotation.y=Math.PI;const Pt=new ut(.25,32,32,Math.PI/2,Math.PI),B=new _(Pt,O);B.scale.set(1.1,.6,.8),B.position.set(0,.84,.5),B.rotation.y=0;const lt=new Ce(.25,32),ot=new _(lt,w);ot.scale.set(.8,.6,.8),ot.position.set(0,.84,.5),ot.rotation.y=Math.PI/2;const ht=new Xt;ht.add(pt),ht.add(B),ht.add(ot),u.add(ht);const yt=new Sn;yt.moveTo(0,0),yt.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),yt.bezierCurveTo(-.6,.3,0,.6,0,1),yt.bezierCurveTo(0,.6,.6,.3,.6,0),yt.bezierCurveTo(.6,-.3,0,-.3,0,0);const it={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},g=new Dn(yt,it),P=new _(g,w);P.scale.set(.5,.5,.5),P.position.set(.35,0,0),P.rotation.y=Math.PI,P.rotation.x=Math.PI,u.add(P);const D=new _(g,R);D.scale.set(.2,.2,.25),D.position.set(.5,-.3,.4),D.rotation.y=Math.PI,D.rotation.x=Math.PI,u.add(D);const F=new _(g,E);F.scale.set(.25,.25,.27),F.position.set(.4,.3,-.2),F.rotation.y=Math.PI,F.rotation.x=Math.PI,u.add(F);const N=new ut(.35,32,32),K=new _(N,R);K.scale.set(.75,1.25,.65),K.position.set(-.7,-.15,.2),u.add(K);const Z=new _(N,G);Z.scale.set(.75,1.25,.65),Z.position.set(.7,-.15,.2),u.add(Z);const S=new te(.2,.22,.6,32),x=new _(S,w);x.position.set(-.4,-1.05,0),u.add(x);const C=new _(S,O);C.position.set(.4,-1.05,0),u.add(C);const Y=new ut(.3,32,32),X=new _(Y,w);X.scale.set(1,.72,1.5),X.position.set(-.4,-1.45,.17),u.add(X);const q=new _(Y,O);q.scale.set(1,.72,1.5),q.position.set(.4,-1.45,.17),u.add(q);const ft=new ut(.44,32,32),ct=new _(ft,E);ct.position.set(-.15,-.45,-.4),u.add(ct);const vt=new _(ft,b);vt.position.set(.15,-.45,-.4),u.add(vt);const At=new ut(.18,32,32),dt=new _(At,E);dt.position.set(0,-.35,-.8),u.add(dt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Mt){const st=new qe("X",{font:Mt,size:.2,depth:.05});new es({color:0});const Q=new _(st,E);Q.position.set(-.3,.99,.53),Q.rotation.x=ue.degToRad(-5),Q.rotation.y=ue.degToRad(-15),u.add(Q);const St=new qe("O",{font:Mt,size:.2,depth:.05});new es({color:0});const Et=new _(St,R);Et.position.set(.14,.99,.53),Et.rotation.y=ue.degToRad(12),Et.rotation.x=ue.degToRad(-5),u.add(Et);const Wt=new qe("POP",{font:Mt,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),ne=new Ot({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const ie=new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),ce=new Ot({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),re=new _(Wt,ne);re.scale.set(.15,.15,.15),re.position.set(.03,1.16,.1),re.rotateZ(-25),u.add(re);const fe=new _(Wt,I);fe.scale.set(.14,.14,.14),fe.rotateZ(45),fe.position.set(.2,-.7,.3),u.add(fe);const we=new _(Wt,ie);we.scale.set(.14,.14,.14),we.rotateZ(45),we.rotateY(45),we.position.set(.3,.7,.3),u.add(we);const ae=new _(Wt,ie);ae.scale.set(.15,.15,.15),ae.rotateZ(45),ae.rotateY(45),ae.position.set(.35,-1.5,.3),u.add(ae);const he=new _(Wt,ce);he.scale.set(.17,.17,.17),he.rotateZ(45),he.rotateY(15),he.position.set(.35,1,.3),u.add(he)}),dt.renderOrder=1,u.scale.set(1.35,1.35,1.35),c.add(u),u.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),l.position.set(t.bodyPosition.x,1,t.cameraPosition),l.lookAt(t.bodyPosition.x,0,0),l.position.z=4;const Dt=()=>{u.rotation.y,u.rotation.x},Bt=()=>{s.value=!0,o.value=!1,r.value=!1},It=()=>{s.value=!1,o.value=!0,r.value=!1},Kt=()=>{s.value=!1,o.value=!1,Dt()},Gt=Mt=>{const st=window.innerWidth/2;Mt>st?Bt():It(),Dt()},Zt=Mt=>{clearTimeout(i),Kt(),r.value=!0;const st={x:Mt.clientX/window.innerWidth*2-1,y:-(Mt.clientY/window.innerHeight)*2+1};if(r.value){const Q=st.x*Math.PI*.2,St=st.y*Math.PI*.2;u.rotation.y=Q,u.rotation.x=St}i=setTimeout(()=>{r.value=!1,Gt(Mt.clientX)},500)};window.addEventListener("mousemove",Zt);const H=Mt=>{if(r.value){const st={x:Mt.clientX/window.innerWidth*2-1,y:-(Mt.clientY/window.innerHeight)*2+1},Q=st.x*Math.PI*.2,St=st.y*Math.PI*.2;u.rotation.y=Q,u.rotation.x=St}};window.addEventListener("mousemove",H),a(),je(()=>t.bodyPosition,Mt=>{u.position.set(Mt.x,Mt.y,Mt.z)}),je(()=>t.cameraPosition,Mt=>{l.position.set(t.bodyPosition.x,1,Mt),l.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,c)=>(Xn(),$n("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2))}}),TS=Kn(ES,[["__scopeId","data-v-8cfea564"]]),AS={class:"pixel-controls"},PS={class:"side-buttons"},RS=Un({__name:"PopArtBear3",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);let i=$t(!1),s=$t(!1),o=$t(!1),r=$t(!1);Wn(()=>{if(e.value){let d=function(){requestAnimationFrame(d),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),o.value&&(m.rotation.x-=.03),r.value&&(m.rotation.x+=.03);const Q=Mt.getElapsedTime();H.forEach((St,Et)=>{const Wt=.2+Math.sin(Q*3+st[Et])*.1;St.scale.set(Wt,Wt,Wt)}),y.render(f,v)};const f=new kn,v=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),y=new Hn({antialias:!0,alpha:!0});y.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(y.domElement);const m=new Xt,p=new Xt;f.add(p);const E=new hi(16777215,2);f.add(E);const b=new ui(16777215,4);b.position.set(5,5,5),f.add(b);const w=new li(16777215,5,50);w.position.set(0,2,4),f.add(w);const O=new Yn,I=O.load("/3d-bear-arts/assets/pop6.jpg"),R=O.load("/3d-bear-arts/assets/pop7.jpg");I.wrapS=I.wrapT=Qe,R.wrapS=R.wrapT=Qe,R.repeat.set(2,2);const G=new Ot({color:16738740,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),tt=new Ot({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),M=new Ot({color:16766720,map:I,metalness:.3,roughness:.5}),T=new Ot({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),U=new Ot({color:9055202,map:I,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),$=new Ot({color:65535,map:I,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),et=new Ot({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),at=new ut(1,32,32,0,Math.PI),j=new _(at,tt),nt=new _(at,G);j.scale.set(.85,.85,.8),nt.scale.set(.85,.85,.8),j.position.y=-.2,nt.position.y=-.2,j.rotation.y=Math.PI/2,nt.rotation.y=Math.PI*1.5;const W=new Ce(1,32),gt=new _(W,G);gt.scale.set(.85,.85,.8),gt.position.set(0,-.2,0),gt.rotation.y=Math.PI/2;const xt=new Xt;xt.add(j),xt.add(nt),xt.add(gt),m.add(xt);const wt=new ut(.6,32,32,0,Math.PI),Nt=new _(wt,M);Nt.scale.set(1,.95,.95),Nt.position.set(0,1,0),Nt.rotation.y=Math.PI*1.5;const kt=new _(wt,T);kt.scale.set(1,.95,.95),kt.position.set(0,1,0),kt.rotation.y=Math.PI/2;const rt=new Ce(.6,32),pt=new _(rt,M);pt.position.set(0,1,0),pt.rotation.y=Math.PI/2,pt.scale.set(1,.95,.95);const Pt=new Xt;Pt.add(Nt),Pt.add(kt),Pt.add(pt),m.add(Pt);const B=new ut(.25,32,32),lt=new _(B,G);lt.position.set(-.45,1.35,-.1),m.add(lt);const ot=new _(B,tt);ot.position.set(.45,1.35,-.1),m.add(ot);const ht=new ut(.25,32,32,Math.PI/2,Math.PI),yt=new _(ht,M);yt.scale.set(1.1,.6,.8),yt.position.set(0,.84,.5),yt.rotation.y=Math.PI;const it=new ut(.25,32,32,Math.PI/2,Math.PI),g=new _(it,T);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=0;const P=new Ce(.25,32),D=new _(P,M);D.scale.set(.8,.6,.8),D.position.set(0,.84,.5),D.rotation.y=Math.PI/2;const F=new Xt;F.add(yt),F.add(g),F.add(D),m.add(F);const N=new Sn;N.moveTo(0,0),N.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),N.bezierCurveTo(-.6,.3,0,.6,0,1),N.bezierCurveTo(0,.6,.6,.3,.6,0),N.bezierCurveTo(.6,-.3,0,-.3,0,0);const K={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},Z=new Dn(N,K),S=new _(Z,M);S.scale.set(.5,.5,.5),S.position.set(.3,0,0),S.rotation.y=Math.PI,S.rotation.x=Math.PI,m.add(S);const x=new _(Z,$);x.scale.set(.2,.2,.25),x.position.set(.35,-.3,.4),x.rotation.y=Math.PI,x.rotation.x=Math.PI,m.add(x);const C=new _(Z,G);C.scale.set(.25,.25,.27),C.position.set(.38,.3,-.2),C.rotation.y=Math.PI,C.rotation.x=Math.PI,m.add(C);const Y=new ut(.35,32,32),X=new _(Y,$);X.scale.set(.75,1.25,.65),X.position.set(-.7,-.15,.2),m.add(X);const q=new _(Y,et);q.scale.set(.75,1.25,.65),q.position.set(.7,-.15,.2),m.add(q);const ft=new te(.2,.22,.6,32),ct=new _(ft,M);ct.position.set(-.4,-1.05,0),m.add(ct);const vt=new _(ft,T);vt.position.set(.4,-1.05,0),m.add(vt);const At=new ut(.3,32,32),dt=new _(At,M);dt.scale.set(1,.72,1.5),dt.position.set(-.4,-1.45,.17),m.add(dt);const _t=new _(At,T);_t.scale.set(1,.72,1.5),_t.position.set(.4,-1.45,.17),m.add(_t);const Dt=new ut(.44,32,32),Bt=new _(Dt,G);Bt.position.set(-.15,-.45,-.4),m.add(Bt);const It=new _(Dt,tt);It.position.set(.15,-.45,-.4),m.add(It);const Kt=new ut(.18,32,32),Gt=new _(Kt,G);Gt.position.set(0,-.35,-.8),m.add(Gt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Q){const St=new qe("X",{font:Q,size:.2,depth:.05}),Et=new _(St,G);Et.position.set(-.3,.99,.53),Et.rotation.x=ue.degToRad(-5),Et.rotation.y=ue.degToRad(-15),m.add(Et);const Wt=new qe("O",{font:Q,size:.2,depth:.05}),ne=new _(Wt,$);ne.position.set(.14,.99,.53),ne.rotation.y=ue.degToRad(12),ne.rotation.x=ue.degToRad(-5),m.add(ne);const ie=new qe("POP",{font:Q,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});new qe("🐻",{font:Q,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});const ce=new qe("BAO      BEAR",{font:Q,size:2,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:3}),re=new Ot({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const fe=new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),we=new Ot({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),ae=new _(ie,re);ae.scale.set(.15,.15,.15),ae.position.set(.02,1.16,.1),ae.rotateZ(-25),m.add(ae);const he=new _(ie,U);he.scale.set(.14,.14,.14),he.rotateZ(45),he.position.set(.2,-.7,.3),m.add(he);const pe=new _(ie,fe);pe.scale.set(.14,.14,.14),pe.rotateZ(45),pe.rotateY(45),pe.position.set(.3,.7,.3),m.add(pe);const me=new _(ie,fe);me.scale.set(.15,.15,.15),me.rotateZ(45),me.rotateY(45),me.position.set(.35,-1.5,.3),m.add(me);const Ie=new _(ie,we);Ie.scale.set(.17,.17,.17),Ie.rotateZ(45),Ie.rotateY(15),Ie.position.set(.35,1,.3),m.add(Ie);const xe=new _(ce,re);xe.scale.set(.7,.7,.7),xe.position.set(-6,0,-3),p.add(xe)}),Gt.renderOrder=1,m.scale.set(1.4,1.4,1.4),f.add(m),m.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),v.position.set(t.bodyPosition.x,1,t.cameraPosition),v.lookAt(t.bodyPosition.x,0,0),v.position.z=4,m.rotation.x=.1;const H=[S,x,C],Mt=new zp,st=[0,Math.PI/2,Math.PI,0,Math.PI/3];d(),je(()=>t.bodyPosition,Q=>{m.position.set(Q.x,Q.y,Q.z)}),je(()=>t.cameraPosition,Q=>{v.position.set(t.bodyPosition.x,1,Q),v.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{v.aspect=window.innerWidth/window.innerHeight,v.updateProjectionMatrix(),y.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,f)=>(Xn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2),zt("div",AS,[zt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),zt("div",PS,[zt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),CS=Kn(RS,[["__scopeId","data-v-cb52c927"]]),IS={class:"pixel-controls"},LS={class:"side-buttons"},DS=Un({__name:"MetalMachineBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);let i=$t(!1),s=$t(!1),o=$t(!1),r=$t(!1);Wn(()=>{if(e.value){let d=function(fe,we){const ae=new te(Zt,Zt,H,32);ae.rotateX(Math.PI/2);const he=new _(ae,fe),pe=new Xt;for(let Ie=0;Ie<Mt;Ie++){const xe=Ie/Mt*Math.PI*2,De=new yn(st,Q,St),se=new _(De,fe);se.position.set((Zt+St/26)*Math.cos(xe),(Zt+St/26)*Math.sin(xe),0),se.rotation.z=xe,pe.add(se)}const me=new Xt;return me.add(he),me.add(pe),me.position.set(we.x,we.y,we.z),me},f=function(){requestAnimationFrame(f),i.value&&(p.rotation.y+=.03),s.value&&(p.rotation.y-=.03),o.value&&(p.rotation.x-=.03),r.value&&(p.rotation.x+=.03),Et.rotation.z-=.02,Wt.rotation.z+=.03,ne.rotation.z+=.02,ie.rotation.z+=.02,ce.rotation.z-=.03,re.rotation.y+=.04,m.render(v,y)};const v=new kn,y=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),m=new Hn({antialias:!0,alpha:!0});m.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(m.domElement);const p=new Xt,E=new Xt;v.add(E);const b=new hi(16777215,2);v.add(b);const w=new ui(16777215,4);w.position.set(5,5,5),v.add(w);const O=new li(16777215,5,50);O.position.set(0,2,4),v.add(O);const I=new Yn,R=I.load("/3d-bear-arts/assets/metal.jpg"),G=I.load("/3d-bear-arts/assets/pop7.jpg"),tt=I.load("/3d-bear-arts/assets/gear.jpg");R.wrapS=R.wrapT=Qe,G.wrapS=G.wrapT=Qe,G.repeat.set(2,2);const M=new Ot({color:13882323,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:R});tt.mapping=Ta;const T=new Ot({color:"#d3d3d3",metalness:1,roughness:.25,map:R,envMap:tt,clearcoat:.7,clearcoatRoughness:.3}),U=new Ot({color:"#C0C0C0",metalness:1,roughness:.25,envMap:tt,clearcoat:.7,clearcoatRoughness:.3}),$=new Ot({color:"#C0C0C0",metalness:1,roughness:.25,map:R,envMap:tt,transparent:!0,opacity:.8,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),et=new Ot({color:"#C0C0C0",metalness:1,roughness:.5,map:R,envMap:tt,transparent:!0,opacity:.23,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),at=new Ot({color:13882323,metalness:1,roughness:.25,clearcoat:1,clearcoatRoughness:.05,reflectivity:.9,envMapIntensity:1,side:Ae});new Ot({color:"#C0C0C0",metalness:1,roughness:.2,transparent:!0,opacity:.4,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45});const j=new Ot({color:"#d3d3d3",metalness:1,roughness:.2,map:tt,envMap:tt,clearcoat:.7,clearcoatRoughness:.3});new Ot({color:12632256,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:tt}),new Ot({color:12632256,metalness:1,roughness:.3,clearcoat:.5,clearcoatRoughness:.1,map:R,transparent:!0,opacity:.3});const nt=new ut(1,32,32,0,Math.PI),W=new _(nt,et),gt=new _(nt,T);W.scale.set(.85,.85,.8),gt.scale.set(.85,.85,.8),W.position.y=-.2,gt.position.y=-.2,W.rotation.y=Math.PI/2,gt.rotation.y=Math.PI*1.5;const xt=new Ce(1,32),wt=new _(xt,$);wt.scale.set(.85,.85,.8),wt.position.set(0,-.2,0),wt.rotation.y=Math.PI/2;const Nt=new Xt;Nt.add(W),Nt.add(gt),Nt.add(wt),p.add(Nt);const kt=new ut(.6,32,32,0,Math.PI),rt=new _(kt,T);rt.scale.set(1,.95,.95),rt.position.set(0,1,0),rt.rotation.y=Math.PI*1.5;const pt=new _(kt,et);pt.scale.set(1,.95,.95),pt.position.set(0,1,0),pt.rotation.y=Math.PI/2;const Pt=new Ce(.6,32),B=new _(Pt,$);B.position.set(0,1,0),B.rotation.y=Math.PI/2,B.scale.set(1,.95,.95);const lt=new Xt;lt.add(rt),lt.add(pt),lt.add(B),p.add(lt);const ot=new ut(.25,32,32),ht=new _(ot,T);ht.position.set(-.45,1.35,-.1),p.add(ht);const yt=new _(ot,$);yt.position.set(.45,1.35,-.1),p.add(yt);const it=new ut(.25,32,32,Math.PI/2,Math.PI),g=new _(it,T);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=Math.PI;const P=new ut(.25,32,32,Math.PI/2,Math.PI),D=new _(P,$);D.scale.set(1.1,.6,.8),D.position.set(0,.84,.5),D.rotation.y=0;const F=new Ce(.25,32),N=new _(F,at);N.scale.set(.8,.6,.8),N.position.set(0,.84,.5),N.rotation.y=Math.PI/2;const K=new Xt;K.add(g),K.add(D),K.add(N),p.add(K);const Z=new Sn;Z.moveTo(0,0),Z.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Z.bezierCurveTo(-.6,.3,0,.6,0,1),Z.bezierCurveTo(0,.6,.6,.3,.6,0),Z.bezierCurveTo(.6,-.3,0,-.3,0,0);const S={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},x=new Dn(Z,S),C=new ut(.35,32,32),Y=new _(C,T);Y.scale.set(.75,1.25,.65),Y.position.set(-.7,-.15,.2),p.add(Y);const X=new _(C,$);X.scale.set(.75,1.25,.65),X.position.set(.7,-.15,.2),p.add(X);const q=new te(.2,.22,.6,32),ft=new _(q,T);ft.position.set(-.4,-1.05,0),p.add(ft);const ct=new _(q,$);ct.position.set(.4,-1.05,0),p.add(ct);const vt=new ut(.3,32,32),At=new _(vt,T);At.scale.set(1,.72,1.5),At.position.set(-.4,-1.45,.17),p.add(At);const dt=new _(vt,$);dt.scale.set(1,.72,1.5),dt.position.set(.4,-1.45,.17),p.add(dt);const _t=new ut(.44,32,32),Dt=new _(_t,T);Dt.position.set(-.15,-.45,-.4),p.add(Dt);const Bt=new _(_t,et);Bt.position.set(.15,-.45,-.4),p.add(Bt);const It=new ut(.18,32,32),Kt=new _(It,T);Kt.position.set(0,-.35,-.8),p.add(Kt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(fe){const we=new qe("X",{font:fe,size:.2,depth:.05});new es({color:0});const ae=new _(we,M);ae.position.set(-.3,.99,.53),ae.rotation.x=ue.degToRad(-5),ae.rotation.y=ue.degToRad(-15),p.add(ae);const he=new qe("O",{font:fe,size:.2,depth:.05});new es({color:0});const pe=new _(he,M);pe.position.set(.14,.99,.53),pe.rotation.y=ue.degToRad(12),pe.rotation.x=ue.degToRad(-5),p.add(pe)}),Kt.renderOrder=1;const Zt=1.2,H=.5,Mt=8,st=.7,Q=.3,St=.5,Et=d(j,{x:-2,y:0,z:0}),Wt=d(j,{x:0,y:0,z:0}),ne=d(j,{x:2,y:0,z:0}),ie=d(j,{x:2,y:0,z:0}),ce=d(j,{x:2,y:-2,z:0}),re=new _(x,U);re.scale.set(.3,.3,.3),re.position.set(.25,1.1,0),re.rotation.y=Math.PI,re.rotation.x=Math.PI,p.add(re),Et.position.set(.35,0,0),Wt.position.set(.25,-.3,.4),ne.position.set(.3,.3,-.2),ie.position.set(.25,.17,.4),ce.position.set(.5,-.3,.45),Et.scale.set(.2,.2,.2),Wt.scale.set(.18,.18,.18),ne.scale.set(.15,.15,.15),ie.scale.set(.17,.17,.17),ce.scale.set(.15,.15,.15),Wt.rotation.z=Math.PI/4,ne.rotation.z=-Math.PI/4,ie.rotation.y=-Math.PI/2,ce.rotation.y=-Math.PI/2,p.add(Et),p.add(Wt),p.add(ne),p.add(ie),p.add(ce),p.rotation.x=.1,p.scale.set(1.4,1.4,1.4),v.add(p),p.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),y.position.set(t.bodyPosition.x,1,t.cameraPosition),y.lookAt(t.bodyPosition.x,0,0),y.position.z=4,f(),je(()=>t.bodyPosition,fe=>{p.position.set(fe.x,fe.y,fe.z)}),je(()=>t.cameraPosition,fe=>{y.position.set(t.bodyPosition.x,1,fe),y.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{y.aspect=window.innerWidth/window.innerHeight,y.updateProjectionMatrix(),m.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,f)=>(Xn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2),zt("div",IS,[zt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),zt("div",LS,[zt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),US=Kn(DS,[["__scopeId","data-v-9a57b6d8"]]),NS={class:"pixel-controls"},FS={class:"side-buttons"},OS={class:"directional-buttons"},BS={class:"horizontal-buttons"},zS={class:"directional-buttons-woman"},GS={class:"horizontal-buttons-woman"},HS={class:"directional-buttons-kid"},kS={class:"horizontal-buttons-kid"},aa=.1,ca=.05,la=.08,VS=Un({__name:"Water",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);let i=$t(!1),s=$t(!1),o=$t(!1),r=$t(!1);const a=po(null),c=$t(!1),l=$t(!1),h=$t(!1),u=$t(!1),d=po(null),f=po(null),v=$t(!1),y=$t(!1),m=$t(!1),p=$t(!1),E=$t(!1),b=$t(!1),w=$t(!1),O=$t(!1),I=new Hn({antialias:!0});I.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(I.domElement);const R=new kn,G=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3);G.position.z=5,Wn(()=>{if(e.value){let it=function(){const Tt=new Xt,Se=new ut(.2,32,32),Pe=new Lt({color:16767916}),_e=new _(Se,Pe);_e.position.set(0,1.5,0),Tt.add(_e);const Fe=new ut(.21,32,32,0,Math.PI*2,0,Math.PI/2),ve=new Lt({color:16711680}),Le=new _(Fe,ve);Le.position.set(0,1.58,0),Tt.add(Le);const Ve=new te(.25,.25,.6,32),Re=new Lt({color:16767916}),Ge=new _(Ve,Re);Ge.position.set(0,1,0),Tt.add(Ge);const tn=new te(.26,.26,.3,32),Ye=new Lt({color:255}),ln=new _(tn,Ye);ln.position.set(0,.65,0),Tt.add(ln);const an=new te(.1,.1,.5,32),Ze=new Lt({color:16767916}),rn=new _(an,Ze);rn.position.set(-.15,.25,0),Tt.add(rn);const en=new _(an,Ze);en.position.set(.15,.25,0),Tt.add(en);const dn=new te(.08,.08,.5,32),pn=new _(dn,Ze);pn.position.set(-.35,1.3,0),pn.rotation.z=Math.PI/4,Tt.add(pn);const Tn=new _(dn,Ze);return Tn.position.set(.35,1.3,0),Tn.rotation.z=-Math.PI/4,Tt.add(Tn),Tt.scale.set(.27,.27,.27),Tt.position.set(-.2,-.1,-.15),Tt},g=function(){const Tt=new Xt,Se=new ut(.18,32,32),Pe=new Lt({color:16767916}),_e=new _(Se,Pe);_e.position.set(0,1.2,.04),Tt.add(_e);const Fe=new ut(.19,32,32,.4,Math.PI*2,0,Math.PI/2),ve=new te(.18,.18,.4,32),Le=new Lt({color:9127187}),Ve=new _(Fe,Le);Ve.position.set(0,1.28,0),Tt.add(Ve);const Re=new _(ve,Le);Re.position.set(0,1.1,-.01),Tt.add(Re);const Ge=new te(.18,.2,.5,32),tn=new Lt({color:16767916}),Ye=new _(Ge,tn);Ye.position.set(0,.85,0),Tt.add(Ye);const ln=new ut(.08,32,32,0,Math.PI),an=new Lt({color:16738740}),Ze=new _(ln,an);Ze.position.set(-.09,.98,.15),Tt.add(Ze);const rn=new _(ln,an);rn.position.set(.09,.98,.15),Tt.add(rn);const en=new te(.22,.22,.25,32),dn=new Lt({color:16738740}),pn=new _(en,dn);pn.position.set(0,.6,0),Tt.add(pn);const Tn=new te(.1,.1,.6,32),bi=new Lt({color:16767916}),Fi=new _(Tn,bi);Fi.position.set(-.09,.5,.2),Fi.rotation.x=Math.PI/2,Tt.add(Fi);const Oi=new _(Tn,bi);Oi.position.set(.09,.5,.2),Oi.rotation.x=Math.PI/2,Tt.add(Oi);const Bi=new te(.08,.08,.35,32),Ei=new _(Bi,bi);Ei.position.set(-.24,.95,.18),Ei.rotation.x=Math.PI/2,Tt.add(Ei);const fi=new _(Bi,bi);return fi.position.set(.2,.85,0),fi.rotation.z=Math.PI/20,Tt.add(fi),Tt.scale.set(.27,.27,.27),Tt.position.set(.2,-.15,-.32),Tt},P=function(){const Tt=new Xt,Se=new ut(.2,32,32),Pe=new Lt({color:16767916}),_e=new _(Se,Pe);_e.position.set(0,1.5,0),Tt.add(_e);const Fe=new ut(.21,32,32,0,Math.PI*2,0,Math.PI/2),ve=new Lt({color:25600}),Le=new _(Fe,ve);Le.position.set(0,1.58,0),Tt.add(Le);const Ve=new te(.22,.22,.5,32),Re=new Lt({color:16767916}),Ge=new _(Ve,Re);Ge.position.set(0,1,0),Tt.add(Ge);const tn=new te(.23,.23,.3,32),Ye=new Lt({color:8388736}),ln=new _(tn,Ye);ln.position.set(0,.65,0),Tt.add(ln);const an=new te(.1,.1,.5,32),Ze=new Lt({color:16767916}),rn=new _(an,Ze);rn.position.set(-.15,.3,-.25),rn.rotation.x=Math.PI/6,Tt.add(rn);const en=new _(an,Ze);en.position.set(.15,.3,.25),en.rotation.x=-Math.PI/6,Tt.add(en);const dn=new te(.08,.08,.4,32),pn=new _(dn,Ze);pn.position.set(-.28,1,-.2),pn.rotation.x=Math.PI/6,Tt.add(pn);const Tn=new _(dn,Ze);return Tn.position.set(.28,1.3,.1),Tn.rotation.z=-Math.PI/8,Tt.add(Tn),Tt.scale.set(.15,.15,.15),Tt.position.set(.3,-.25,.25),Tt.rotation.x=Math.PI/12,Tt.rotation.y=Math.PI/2,Tt.rotation.z=-Math.PI/3,Tt},D=function(Tt){let Se=1,Pe=0;function _e(){requestAnimationFrame(_e),Tt.position.x+=.01*Se,Tt.position.x>=.35?(Se=-1,Tt.rotation.y=Math.PI):Tt.position.x<=-.35&&(Se=1,Tt.rotation.y=0),Pe+=.003,Tt.position.y=-.4+Math.sin(Pe)*.1,Z.render(N,K)}_e()},F=function(){requestAnimationFrame(F),i.value&&(S.rotation.y+=.03),s.value&&(S.rotation.y-=.03),o.value&&(S.rotation.x-=.03),r.value&&(S.rotation.x+=.03),ae.uniforms.u_time.value+=.25,k.rotation.y+=.04,Z.render(N,K)};const N=new kn,K=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),Z=new Hn({antialias:!0,alpha:!0});Z.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(Z.domElement);const S=new Xt,x=new Xt;N.add(x);const C=new hi(16777215,2);N.add(C);const Y=new ui(16777215,4);Y.position.set(5,5,5),N.add(Y);const X=new li(16777215,5,50);X.position.set(0,2,4),N.add(X);const q=new Yn,ft=q.load("/3d-bear-arts/assets/beach.jpg");ft.repeat.set(.8,1);const ct=q.load("/3d-bear-arts/assets/sun.jpg");ft.wrapS=ft.wrapT=Qe,ft.repeat.set(.8,1),ct.wrapS=ct.wrapT=Qe;const vt=new Ot({color:11592447,map:ft,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),At=new Ot({color:11592447,map:ft,metalness:.3,roughness:.5,transparent:!0,opacity:.6,side:Ae,ior:1.33,depthWrite:!1,depthTest:!0}),dt=new Ot({color:11592447,map:ft,metalness:.1,roughness:.6,transparent:!0,opacity:.6,clearcoat:.9,clearcoatRoughness:.4,transmission:.7,ior:1.2,depthTest:!0,envMapIntensity:.8}),_t=new Ot({color:11592447,map:ft,metalness:.1,roughness:.6,transparent:!0,opacity:.3,clearcoat:.9,clearcoatRoughness:.4,ior:1.2,depthWrite:!1,depthTest:!0,envMapIntensity:.6,side:Ae}),Dt=new Ot({color:11592447,map:ft,metalness:.3,roughness:.5,transparent:!0,opacity:.8,side:Ae,ior:1.33}),Bt=new Ot({color:11592447,map:ft,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),It=new ut(1,32,32,0,Math.PI),Kt=new _(It,_t),Gt=new _(It,At);Kt.scale.set(.85,.85,.8),Gt.scale.set(.85,.85,.8),Kt.position.y=-.2,Gt.position.y=-.2,Kt.rotation.y=Math.PI/2,Gt.rotation.y=Math.PI*1.5;const Zt=new Ce(1,32),H=new _(Zt,vt);H.scale.set(.85,.85,.8),H.position.set(0,-.2,0),H.rotation.y=Math.PI/2;const Mt=new Xt;Mt.add(Kt),Mt.add(Gt),Mt.add(H),S.add(Mt);const st=new ut(.6,32,32,0,Math.PI),Q=new _(st,vt);Q.scale.set(1,.95,.95),Q.position.set(0,1,0),Q.rotation.y=Math.PI*1.5;const St=new _(st,dt);St.scale.set(1,.95,.95),St.position.set(0,1,0),St.rotation.y=Math.PI/2;const Et=new Ce(.6,32),Wt=new _(Et,vt);Wt.position.set(0,1,0),Wt.rotation.y=Math.PI/2,Wt.scale.set(1,.95,.95);const ne=new Xt;ne.add(Q),ne.add(St),ne.add(Wt),S.add(ne);const ie=new ut(.6,32,32,0,Math.PI*2,0,Math.PI/2),ce=new Ot({color:11592447,metalness:.1,roughness:.2,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.9,transmission:.9,ior:1.33,reflectivity:.8,envMapIntensity:1}),re=new _(ie,ce);re.position.set(0,-.2,0),re.rotation.x=Math.PI,re.scale.set(1.25,1.25,1.25),Mt.add(re);const fe=new Ot({color:49151,metalness:.1,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,side:Ae,transparent:!0,opacity:.7,depthWrite:!1}),we=new _(Zt,fe);we.scale.set(.7,.7,.7),we.position.set(0,-.3,0),we.rotation.x=Math.PI/2,we.renderOrder=1,Mt.add(we),S.add(Mt);const ae=new un({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:8},u_waveAmplitude:{value:.05},u_waveSpeed:{value:.2}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),he=new _(Zt,ae);he.position.set(0,-.3,0),he.scale.set(.7,.7,.7),he.rotation.x=-Math.PI/2,he.renderOrder=1,Mt.add(he);const pe=new ut(.25,32,32),me=new _(pe,Dt);me.position.set(-.45,1.35,-.1),S.add(me);const Ie=new _(pe,dt);Ie.position.set(.45,1.35,-.1),S.add(Ie);const xe=new ut(.25,32,32,Math.PI/2,Math.PI),De=new _(xe,Dt);De.scale.set(1.1,.6,.8),De.position.set(0,.84,.5),De.rotation.y=Math.PI;const se=new ut(.25,32,32,Math.PI/2,Math.PI),Ne=new _(se,dt);Ne.scale.set(1.1,.6,.8),Ne.position.set(0,.84,.5),Ne.rotation.y=0;const Ue=new Ce(.25,32),ke=new _(Ue,At);ke.scale.set(.8,.6,.8),ke.position.set(0,.84,.5),ke.rotation.y=Math.PI/2;const bt=new Xt;bt.add(De),bt.add(Ne),bt.add(ke),S.add(bt);const oe=new Ot({color:8374441,metalness:1,roughness:.25,envMap:ct,clearcoat:.7,clearcoatRoughness:.3}),A=new Sn;A.moveTo(0,0),A.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),A.bezierCurveTo(-.6,.3,0,.6,0,1),A.bezierCurveTo(0,.6,.6,.3,.6,0),A.bezierCurveTo(.6,-.3,0,-.3,0,0);const V={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},L=new Dn(A,V),k=new _(L,oe);k.scale.set(.2,.2,.2),k.position.set(.25,1.2,0),k.rotation.y=Math.PI,k.rotation.x=Math.PI,S.add(k);const z=new ut(.35,32,32),mt=new _(z,At);mt.scale.set(.75,1.25,.65),mt.position.set(-.7,-.15,.2),S.add(mt);const Rt=new _(z,_t);Rt.scale.set(.75,1.25,.65),Rt.position.set(.7,-.15,.2),S.add(Rt);const Ut=new te(.2,.22,.6,32),Ft=new _(Ut,Dt);Ft.position.set(-.4,-1.05,0),S.add(Ft);const jt=new _(Ut,dt);jt.position.set(.4,-1.05,0),S.add(jt);const qt=new ut(.3,32,32),Vt=new _(qt,Dt);Vt.scale.set(1,.72,1.5),Vt.position.set(-.4,-1.45,.17),S.add(Vt);const ee=new _(qt,dt);ee.scale.set(1,.72,1.5),ee.position.set(.4,-1.45,.17),S.add(ee);const ge=new ut(.44,32,32),de=new _(ge,Dt);de.position.set(-.15,-.45,-.4),S.add(de);const Ct=new _(ge,Dt);Ct.position.set(.15,-.45,-.4),S.add(Ct);const Yt=new ut(.18,32,32),Ht=new _(Yt,Dt);Ht.position.set(0,-.35,-.8),S.add(Ht),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Tt){const Se=new qe("X",{font:Tt,size:.2,depth:.05}),Pe=new _(Se,Bt);Pe.position.set(-.3,.99,.53),Pe.rotation.x=ue.degToRad(-5),Pe.rotation.y=ue.degToRad(-15),S.add(Pe);const _e=new qe("O",{font:Tt,size:.2,depth:.05}),Fe=new _(_e,Bt);Fe.position.set(.14,.99,.53),Fe.rotation.y=ue.degToRad(12),Fe.rotation.x=ue.degToRad(-5),S.add(Fe)}),a.value=it(),S.add(a.value),N.add(S),d.value=g(),S.add(d.value),f.value=P(),S.add(f.value),D(f.value),S.scale.set(1.4,1.4,1.4),N.add(S),S.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),K.position.set(t.bodyPosition.x,1,t.cameraPosition),K.lookAt(t.bodyPosition.x,0,0),K.position.z=4,S.rotation.x=.1,F(),je(()=>t.bodyPosition,Tt=>{S.position.set(Tt.x,Tt.y,Tt.z)}),je(()=>t.cameraPosition,Tt=>{K.position.set(t.bodyPosition.x,1,Tt),K.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{K.aspect=window.innerWidth/window.innerHeight,K.updateProjectionMatrix(),Z.setSize(window.innerWidth,window.innerHeight)})}});function tt(){s.value=!0}function M(){i.value=!0}function T(){o.value=!0}function U(){r.value=!0}function $(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}const et=()=>{c.value=!0,console.log(c.value),a.value&&(a.value.rotation.y=0),console.log(a.value)},at=()=>{l.value=!0,a.value&&(a.value.rotation.y=Math.PI),console.log(a.value)},j=()=>{h.value=!0,a.value&&(a.value.rotation.y=Math.PI/2)},nt=()=>{u.value=!0,a.value&&(a.value.rotation.y=-Math.PI/2)},W=()=>{c.value=!1,l.value=!1,h.value=!1,u.value=!1},gt=()=>{v.value=!0,d.value&&(d.value.rotation.y=Math.PI)},xt=()=>{y.value=!0,d.value&&(d.value.rotation.y=0)},wt=()=>{m.value=!0,d.value&&(d.value.rotation.y=-Math.PI/2)},Nt=()=>{p.value=!0,d.value&&(d.value.rotation.y=Math.PI/2)},kt=()=>{v.value=!1,y.value=!1,m.value=!1,p.value=!1},rt=()=>{requestAnimationFrame(rt),a.value&&(c.value&&(a.value.position.z-=aa),l.value&&(a.value.position.z+=aa),h.value&&(a.value.position.x-=aa),u.value&&(a.value.position.x+=aa)),I.render(R,G)},pt=()=>{requestAnimationFrame(pt),d.value&&(v.value&&(d.value.position.z-=ca),y.value&&(d.value.position.z+=ca),m.value&&(d.value.position.x-=ca),p.value&&(d.value.position.x+=ca))};pt(),rt();const Pt=()=>{E.value=!0,f.value&&(f.value.rotation.y=0)},B=()=>{b.value=!0,f.value&&(f.value.rotation.y=Math.PI)},lt=()=>{w.value=!0,f.value&&(f.value.rotation.y=Math.PI/2)},ot=()=>{O.value=!0,f.value&&(f.value.rotation.y=-Math.PI/2)},ht=()=>{E.value=!1,b.value=!1,w.value=!1,O.value=!1},yt=()=>{requestAnimationFrame(yt),f.value&&(E.value&&(f.value.position.z-=la),b.value&&(f.value.position.z+=la),w.value&&(f.value.position.x-=la),O.value&&(f.value.position.x+=la))};return yt(),(it,g)=>(Xn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2),zt("div",NS,[zt("button",{class:"pixel-btn up",onMousedown:T,onMouseup:$},"UP",32),zt("div",FS,[zt("button",{class:"pixel-btn left",onMousedown:tt,onMouseup:$},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:M,onMouseup:$},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:U,onMouseup:$},"DOWN",32)]),zt("div",OS,[zt("button",{id:"move-north",class:"directional-btn north-btn",onMousedown:et,onMouseup:W},"UP",32),zt("div",BS,[zt("button",{id:"move-west",class:"directional-btn west-btn",onMousedown:j,onMouseup:W},"LEFT",32),zt("button",{id:"move-east",class:"directional-btn east-btn",onMousedown:nt,onMouseup:W},"RIGHT",32)]),zt("button",{id:"move-south",class:"directional-btn south-btn",onMousedown:at,onMouseup:W},"DOWN",32)]),zt("div",zS,[zt("button",{class:"directional-btn-woman north-btn",onMousedown:gt,onMouseup:kt},"UP",32),zt("div",GS,[zt("button",{class:"directional-btn-woman west-btn",onMousedown:wt,onMouseup:kt},"LEFT",32),zt("button",{class:"directional-btn-woman east-btn",onMousedown:Nt,onMouseup:kt},"RIGHT",32)]),zt("button",{class:"directional-btn-woman south-btn",onMousedown:xt,onMouseup:kt},"DOWN",32)]),zt("div",HS,[zt("button",{class:"directional-btn-kid north-btn",onMousedown:Pt,onMouseup:ht},"UP",32),zt("div",kS,[zt("button",{class:"directional-btn-kid west-btn",onMousedown:lt,onMouseup:ht},"LEFT",32),zt("button",{class:"directional-btn-kid east-btn",onMousedown:ot,onMouseup:ht},"RIGHT",32)]),zt("button",{class:"directional-btn-kid south-btn",onMousedown:B,onMouseup:ht},"DOWN",32)])],64))}}),WS=Kn(VS,[["__scopeId","data-v-f25dfda5"]]),XS={class:"pixel-controls"},qS={class:"side-buttons"},jS=Un({__name:"GhostBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);let i=$t(!1),s=$t(!1),o=$t(!1),r=$t(!1);Wn(()=>{if(e.value){let d=function(me,Ie){const xe=new Xt,De=new ut(1,32,32),se=new _(De,at);se.scale.set(1,.8,1),xe.add(se);const Ne=new te(.1,.1,.5,16),Ue=new Lt({color:9127187}),ke=new _(Ne,Ue);return ke.position.set(0,.9,0),xe.add(ke),xe},f=function(){requestAnimationFrame(f),i.value&&(p.rotation.y+=.03),s.value&&(p.rotation.y-=.03),o.value&&(p.rotation.x-=.03),r.value&&(p.rotation.x+=.03),Zt.rotation.z-=.04,H.rotation.z+=.04,Mt.rotation.z+=.03,st.rotation.z+=.03,x.rotation.y+=.04,pe+=ae,p.position.y=t.bodyPosition.y+Math.sin(pe)*he;const me=fe.getElapsedTime();re.forEach((Ie,xe)=>{const De=.1+Math.sin(me*3+we[xe])*.1;Ie.scale.set(De,De,De)}),m.render(v,y)};const v=new kn,y=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),m=new Hn({antialias:!0,alpha:!0});m.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(m.domElement);const p=new Xt,E=new Xt;v.add(E);const b=new hi(16777215,2);v.add(b);const w=new ui(16777215,4);w.position.set(5,5,5),v.add(w);const O=new li(16777215,5,50);O.position.set(0,2,4),v.add(O);const I=new Yn,R=I.load("/3d-bear-arts/assets/pumpkin.jpg");R.wrapS=R.wrapT=Qe,R.repeat.set(.8,.85);const G=I.load("/3d-bear-arts/assets/pumpkin.jpg");G.wrapS=G.wrapT=Qe,G.repeat.set(1,1);const tt=I.load("/3d-bear-arts/assets/pumpkin.jpg");tt.wrapS=G.wrapT=Qe,tt.repeat.set(2,.8);const M=new Ot({color:16747520,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),T=new Xt,U=new Ot({color:16747520,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),$=new Ot({color:16747520,map:G,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),et=new Ot({color:16747520,map:tt,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.6,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),at=new Ot({color:16747520,map:tt,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new Ot({color:16766720,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new Ot({color:9109504,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new Ot({color:4915330,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});const j=new ut(1,32,32,0,Math.PI),nt=new _(j,et),W=new _(j,U);nt.scale.set(.85,.85,.8),W.scale.set(.85,.85,.8),nt.position.y=-.2,W.position.y=-.2,nt.rotation.y=Math.PI/2,W.rotation.y=Math.PI*1.5;const gt=new Ce(1,32),xt=new _(gt,$);xt.scale.set(.85,.85,.8),xt.position.set(0,-.2,0),xt.rotation.y=Math.PI/2;const wt=new Xt;wt.add(nt),wt.add(W),wt.add(xt),p.add(wt);const Nt=new ut(.6,32,32,0,Math.PI),kt=new _(Nt,U);kt.scale.set(1,.95,.95),kt.position.set(0,1,0),kt.rotation.y=Math.PI*1.5;const rt=new _(Nt,et);rt.scale.set(1,.95,.95),rt.position.set(0,1,0),rt.rotation.y=Math.PI/2;const pt=new Ce(.6,32),Pt=new _(pt,$);Pt.position.set(0,1,0),Pt.rotation.y=Math.PI/2,Pt.scale.set(1,.95,.95);const B=new Xt;B.add(kt),B.add(rt),B.add(Pt),p.add(B);const lt=new ut(.25,32,32),ot=new _(lt,at);ot.position.set(-.45,1.35,-.1),p.add(ot);const ht=new _(lt,et);ht.position.set(.45,1.35,-.1),p.add(ht);const yt=new ut(.25,32,32,Math.PI/2,Math.PI),it=new _(yt,U);it.scale.set(1.1,.6,.8),it.position.set(0,.84,.5),it.rotation.y=Math.PI;const g=new ut(.25,32,32,Math.PI/2,Math.PI),P=new _(g,et);P.scale.set(1.1,.6,.8),P.position.set(0,.84,.5),P.rotation.y=0;const D=new Ce(.25,32),F=new _(D,U);F.scale.set(.8,.6,.8),F.position.set(0,.84,.5),F.rotation.y=Math.PI/2;const N=new Xt;N.add(it),N.add(P),N.add(F),p.add(N);const K=new Sn;K.moveTo(0,0),K.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),K.bezierCurveTo(-.6,.3,0,.6,0,1),K.bezierCurveTo(0,.6,.6,.3,.6,0),K.bezierCurveTo(.6,-.3,0,-.3,0,0);const Z={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},S=new Dn(K,Z),x=new _(S,M);x.scale.set(.3,.3,.3),x.position.set(.25,1.1,0),x.rotation.y=Math.PI,x.rotation.x=Math.PI,p.add(x);const C=new ut(.35,32,32),Y=new _(C,$);Y.scale.set(.75,1.25,.65),Y.position.set(-.7,-.15,.2),p.add(Y);const X=new _(C,et);X.scale.set(.75,1.25,.65),X.position.set(.7,-.15,.2),p.add(X);const q=new te(.2,.22,.6,32),ft=new _(q,$);ft.position.set(-.4,-1.05,0),p.add(ft);const ct=new _(q,et);ct.position.set(.4,-1.05,0),p.add(ct);const vt=new ut(.3,32,32),At=new _(vt,at);At.scale.set(1,.72,1.5),At.position.set(-.4,-1.45,.17),p.add(At);const dt=new _(vt,et);dt.scale.set(1,.72,1.5),dt.position.set(.4,-1.45,.17),p.add(dt);const _t=new ut(.44,32,32),Dt=new _(_t,U);Dt.position.set(-.15,-.45,-.4),p.add(Dt);const Bt=new _(_t,et);Bt.position.set(.15,-.45,-.4),p.add(Bt);const It=new ut(.18,32,32),Kt=new _(It,at);Kt.position.set(0,-.35,-.8),p.add(Kt),Kt.renderOrder=1,new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(me){const Ie=new qe("X",{font:me,size:.2,depth:.05}),xe=new _(Ie,$);xe.position.set(-.3,.99,.53),xe.rotation.x=ue.degToRad(-5),xe.rotation.y=ue.degToRad(-15),p.add(xe);const De=new qe("O",{font:me,size:.2,depth:.05}),se=new _(De,$);se.position.set(.14,.99,.53),se.rotation.y=ue.degToRad(12),se.rotation.x=ue.degToRad(-5),p.add(se)}),p.add(T);const Zt=d(),H=d(),Mt=d(),st=d();Zt.position.set(.35,-.35,-.3),H.position.set(.25,-.45,.3),Mt.position.set(.3,.1,-.2),st.position.set(.25,.18,.4),Zt.scale.set(.3,.3,.3),H.scale.set(.28,.28,.28),Mt.scale.set(.25,.25,.25),st.scale.set(.23,.23,.23),H.rotation.z=Math.PI/4,Mt.rotation.z=-Math.PI/4,st.rotation.y=-Math.PI/2,p.add(Zt),p.add(H),p.add(Mt),p.add(st);const Q=new Sn;Q.moveTo(-.5,0),Q.bezierCurveTo(-.75,.25,-1,.6,-.5,.8),Q.bezierCurveTo(-.25,.85,-.25,.5,-.15,.4),Q.bezierCurveTo(-.05,.6,.05,.6,.15,.4),Q.bezierCurveTo(.25,.5,.25,.85,.5,.8),Q.bezierCurveTo(1,.6,.75,.25,.5,0),Q.bezierCurveTo(.3,-.25,-.3,-.25,-.5,0);const St={depth:.3,bevelEnabled:!1},Et=new Dn(Q,St),Wt=new es({color:0}),ne=new _(Et,Wt);ne.scale.set(.3,.3,.6),ne.rotation.x=0,ne.rotation.z=0,ne.position.set(.26,.35,.25),p.add(ne);const ie=new _(Et,Wt);ie.scale.set(.5,.5,.5),ie.position.set(.4,-.1,.54),p.add(ie);const ce=new _(Et,Wt);ce.scale.set(.5,.5,.5),ce.position.set(.32,-.35,.65),p.add(ce),p.rotation.x=.1,p.scale.set(1.4,1.4,1.4),v.add(p),p.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),y.position.set(t.bodyPosition.x,1,t.cameraPosition),y.lookAt(t.bodyPosition.x,0,0),y.position.z=4;const re=[ne,ie,ce],fe=new zp,we=[0,Math.PI/2,Math.PI,0,Math.PI/3];let ae=.05,he=.25,pe=0;f(),je(()=>t.bodyPosition,me=>{p.position.set(me.x,me.y,me.z)}),je(()=>t.cameraPosition,me=>{y.position.set(t.bodyPosition.x,1,me),y.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{y.aspect=window.innerWidth/window.innerHeight,y.updateProjectionMatrix(),m.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,f)=>(Xn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2),zt("div",XS,[zt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),zt("div",qS,[zt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),YS=Kn(jS,[["__scopeId","data-v-5eff72b3"]]),$S={class:"pixel-controls"},KS={class:"side-buttons"},ZS=Un({__name:"GhostBallonBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);let i=$t(!1),s=$t(!1),o=$t(!1),r=$t(!1);Wn(()=>{if(e.value){let d=function(){requestAnimationFrame(d),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),o.value&&(m.rotation.x-=.03),r.value&&(m.rotation.x+=.03),Z.rotation.y+=.03,Wt+=st,ne+=Q,m.position.y=t.bodyPosition.y+Math.sin(Wt)*Et,Z.position.y=t.bodyPosition.y+Math.sin(ne)*St,Zt.uniforms.u_time.value+=.25,y.render(f,v)};const f=new kn,v=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),y=new Hn({antialias:!0,alpha:!0});y.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(y.domElement);const m=new Xt,p=new Xt;f.add(p);const E=new hi(16777215,2);f.add(E);const b=new ui(16777215,4);b.position.set(5,5,5),f.add(b);const w=new li(16777215,5,50);w.position.set(0,2,4),f.add(w);const O=new Yn,I=O.load("/3d-bear-arts/assets/ghost.jpg");I.wrapS=I.wrapT=Qe,I.repeat.set(2,2);const R=O.load("/3d-bear-arts/assets/ghost.jpg");R.wrapS=R.wrapT=Qe,R.repeat.set(1,1);const G=new Ot({color:16777215,metalness:0,roughness:.8,clearcoat:.3,clearcoatRoughness:.9,transparent:!0,opacity:.15,transmission:.95,ior:1.1,reflectivity:.2,envMapIntensity:.3,depthTest:!0,depthWrite:!1,side:Ae}),tt=new Ot({color:16777215,metalness:0,roughness:.8,clearcoat:.3,clearcoatRoughness:.9,transparent:!0,opacity:.1,envMapIntensity:.3}),M=new Ot({color:9109504,map:I,metalness:.9,roughness:.25,clearcoat:.7,clearcoatRoughness:.3}),T=new Ot({color:16777215,metalness:.1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.1,transmission:.95,ior:1,reflectivity:.2,envMapIntensity:.4,depthTest:!0,depthWrite:!1,side:Ae}),U=new Ot({color:16777215,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.45,transmission:.8,reflectivity:.9,envMapIntensity:1,depthTest:!0,depthWrite:!1,side:Ae}),$=new Ot({color:16777215,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.45,transmission:.8,reflectivity:.9,envMapIntensity:1,side:Ae}),et=new ut(1,32,32,0,Math.PI),at=new _(et,G),j=new _(et,U);at.scale.set(.85,.85,.8),j.scale.set(.85,.85,.8),at.position.y=-.2,j.position.y=-.2,at.rotation.y=Math.PI/2,j.rotation.y=Math.PI*1.5;const nt=new Ce(1,32),W=new _(nt,U);W.scale.set(.85,.85,.8),W.position.set(0,-.2,0),W.rotation.y=Math.PI/2;const gt=new Xt;gt.add(at),gt.add(j),gt.add(W),m.add(gt);const xt=new ut(.6,32,32,0,Math.PI),wt=new _(xt,$);wt.scale.set(1,.95,.95),wt.position.set(0,1,0),wt.rotation.y=Math.PI*1.5;const Nt=new _(xt,tt);Nt.scale.set(1,.95,.95),Nt.position.set(0,1,0),Nt.rotation.y=Math.PI/2;const kt=new Ce(.6,32),rt=new _(kt,U);rt.position.set(0,1,0),rt.rotation.y=Math.PI/2,rt.scale.set(1,.95,.95);const pt=new Xt;pt.add(wt),pt.add(Nt),pt.add(rt),m.add(pt);const Pt=new ut(.25,32,32),B=new _(Pt,$);B.position.set(-.45,1.35,-.1),m.add(B);const lt=new _(Pt,tt);lt.position.set(.45,1.35,-.1),m.add(lt);const ot=new ut(.25,32,32,Math.PI/2,Math.PI),ht=new _(ot,$);ht.scale.set(1.1,.6,.8),ht.position.set(0,.84,.5),ht.rotation.y=Math.PI;const yt=new ut(.25,32,32,Math.PI/2,Math.PI),it=new _(yt,tt);it.scale.set(1.1,.6,.8),it.position.set(0,.84,.5),it.rotation.y=0;const g=new Ce(.25,32),P=new _(g,T);P.scale.set(.8,.6,.8),P.position.set(0,.84,.5),P.rotation.y=Math.PI/2;const D=new Xt;D.add(ht),D.add(it),D.add(P),m.add(D);const F=new Sn;F.moveTo(0,0),F.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),F.bezierCurveTo(-.6,.3,0,.6,0,1),F.bezierCurveTo(0,.6,.6,.3,.6,0),F.bezierCurveTo(.6,-.3,0,-.3,0,0);const N={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},K=new Dn(F,N),Z=new _(K,M);Z.scale.set(.35,.35,.35),Z.position.set(0,-.05,0),Z.rotation.y=Math.PI,Z.rotation.x=Math.PI,m.add(Z);const S=new ut(.35,32,32),x=new _(S,U);x.scale.set(.75,1.25,.65),x.position.set(-.7,-.15,.2),m.add(x);const C=new _(S,T);C.scale.set(.75,1.25,.65),C.position.set(.7,-.15,.2),m.add(C);const Y=new te(.2,.22,.6,32),X=new _(Y,U);X.position.set(-.4,-1.05,0),m.add(X);const q=new _(Y,T);q.position.set(.4,-1.05,0),m.add(q);const ft=new ut(.3,32,32),ct=new _(ft,U);ct.scale.set(1,.72,1.5),ct.position.set(-.4,-1.45,.17),m.add(ct);const vt=new _(ft,T);vt.scale.set(1,.72,1.5),vt.position.set(.4,-1.45,.17),m.add(vt);const At=new ut(.44,32,32),dt=new _(At,T);dt.position.set(-.15,-.45,-.4),m.add(dt);const _t=new _(At,T);_t.position.set(.15,-.45,-.4),m.add(_t);const Dt=new ut(.18,32,32),Bt=new _(Dt,U);Bt.position.set(0,-.35,-.8),m.add(Bt);const It=new ut(.6,32,32,0,Math.PI*2,0,Math.PI/2),Kt=new Ot({color:9109504,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.8,transmission:.85,ior:1.4,reflectivity:.9,envMapIntensity:1.2}),Gt=new _(It,Kt);Gt.position.set(0,-.2,0),Gt.rotation.x=Math.PI,Gt.scale.set(1.25,1.25,1.25),gt.add(Gt);const Zt=new un({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:4},u_waveAmplitude:{value:.5},u_waveSpeed:{value:.3}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),H=new _(nt,Zt);H.position.set(0,-.26,0),H.scale.set(.7,.7,.7),H.rotation.x=-Math.PI/2,H.renderOrder=1,gt.add(H),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ie){const ce=new qe("X",{font:ie,size:.2,depth:.05}),re=new _(ce,U);re.position.set(-.3,.99,.53),re.rotation.x=ue.degToRad(-5),re.rotation.y=ue.degToRad(-15),m.add(re);const fe=new qe("O",{font:ie,size:.2,depth:.05}),we=new _(fe,U);we.position.set(.14,.99,.53),we.rotation.y=ue.degToRad(12),we.rotation.x=ue.degToRad(-5),m.add(we)}),Bt.renderOrder=1,m.rotation.x=.1,m.scale.set(1.4,1.4,1.4),f.add(m),m.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),v.position.set(t.bodyPosition.x,1,t.cameraPosition),v.lookAt(t.bodyPosition.x,0,0),v.position.z=4;let st=.05,Q=.06,St=.2,Et=.25,Wt=0,ne=0;d(),je(()=>t.bodyPosition,ie=>{m.position.set(ie.x,ie.y,ie.z)}),je(()=>t.cameraPosition,ie=>{v.position.set(t.bodyPosition.x,1,ie),v.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{v.aspect=window.innerWidth/window.innerHeight,v.updateProjectionMatrix(),y.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,f)=>(Xn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2),zt("div",$S,[zt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),zt("div",KS,[zt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),JS=Kn(ZS,[["__scopeId","data-v-eb44448e"]]),QS={class:"pixel-controls"},tb={class:"side-buttons"},eb=15,nb=5,ib=Un({__name:"Santa",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);let i=$t(!1),s=$t(!1),o=$t(!1),r=$t(!1);const a=po(null),c=new Hn({antialias:!0});c.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(c.domElement),new kn;const l=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3);l.position.z=4,Wn(()=>{if(e.value){let y=function(){const bt=new Xt,oe=new Gn(.12,.05,16,100),A=new Lt({color:16777215}),V=new _(oe,A);V.position.set(0,1.65,0),V.rotation.x=Math.PI/2,bt.add(V);const L=new oi(.15,.3,32),k=new Lt({color:16711680}),z=new _(L,k);z.position.set(0,1.8,0),bt.add(z);const mt=new ut(.05,32,32),Rt=new Lt({color:16777215}),Ut=new _(mt,Rt);return Ut.position.set(0,1.93,0),bt.add(Ut),bt.position.set(0,-.1,0),bt},m=function(){const bt=new Xt,oe=new ut(.15,32,32),A=new Lt({color:16764057}),V=new _(oe,A);V.position.set(0,.4,0),bt.add(V);const L=new oi(.08,.15,32);new Lt({color:16764057});const k=new _(L,Nt);k.position.set(-.1,.55,0),k.rotation.z=Math.PI/6,bt.add(k);const z=new _(L,Nt);z.position.set(.1,.55,0),z.rotation.z=-Math.PI/6,bt.add(z);const mt=new te(.12,.15,.3,32),Rt=new Lt({color:16764057}),Ut=new _(mt,Rt);Ut.position.set(0,.2,0),bt.add(Ut);const Ft=new te(.05,.05,.2,32),jt=new Lt({color:16764057}),qt=new _(Ft,jt);qt.position.set(-.07,-.05,.05),bt.add(qt);const Vt=new _(Ft,jt);Vt.position.set(.07,-.05,.05),bt.add(Vt);const ee=new te(.04,.04,.2,32),ge=new Lt({color:16764057}),de=new _(ee,Nt);de.position.set(-.15,.25,0),de.rotation.z=Math.PI/4,bt.add(de);const Ct=new _(ee,ge);Ct.position.set(.15,.25,0),Ct.rotation.z=-Math.PI/4,bt.add(Ct);const Yt=new te(.03,.03,.25,32),Ht=new Lt({color:16764057}),le=new _(Yt,Ht);return le.position.set(0,.1,-.2),le.rotation.x=Math.PI/4,bt.add(le),bt.scale.set(.75,.75,.75),bt.position.set(.2,0,.2),bt},p=function(){const bt=new Xt,oe=new ut(.2,32,32),A=new Lt({color:16764057}),V=new _(oe,A);V.position.set(0,1,0),bt.add(V);const L=new Lt({color:16777215}),k=[{x:0,y:.85,z:.15,size:.12},{x:-.1,y:.88,z:.1,size:.1},{x:.1,y:.88,z:.1,size:.1},{x:-.15,y:.95,z:.1,size:.08},{x:.15,y:.95,z:.1,size:.08}];for(const fi of k){const Ar=new ut(fi.size,16,16),Ws=new _(Ar,L);Ws.position.set(fi.x,fi.y-.06,fi.z-.01),bt.add(Ws)}const z=new Lt({color:16777215}),mt=new te(.05,.06,.1,32),Rt=new _(mt,z);Rt.position.set(-.06,.93,.18),Rt.rotation.z=Math.PI/4;const Ut=new te(.05,.06,.1,32),Ft=new _(Ut,z);Ft.position.set(.06,.93,.18),Ft.rotation.z=-Math.PI/4;const jt=new Gn(.12,.05,16,100),qt=new Lt({color:16777215}),Vt=new _(jt,qt);Vt.position.set(0,1.15,0),Vt.rotation.x=Math.PI/2,bt.add(Vt);const ee=new oi(.15,.3,32),ge=new Lt({color:16711680}),de=new _(ee,ge);de.position.set(0,1.3,0),bt.add(de);const Ct=new ut(.05,32,32),Yt=new Lt({color:16777215}),Ht=new _(Ct,Yt);Ht.position.set(0,1.43,0),bt.add(Ht);const le=new te(.2,.25,.6,32),Tt=new Lt({color:16711680}),Se=new _(le,Tt);Se.position.set(0,.5,0),bt.add(Se);const Pe=new te(.25,.25,.1,32),_e=new Lt({color:0}),Fe=new _(Pe,_e);Fe.position.set(0,.4,.005),bt.add(Fe);const ve=new te(.06,.06,.3,32),Le=new Lt({color:16711680}),Ve=new _(ve,Le);Ve.position.set(-.25,.75,0),Ve.rotation.z=Math.PI/4,bt.add(Ve);const Re=new _(ve,Le);Re.position.set(.25,.75,0),Re.rotation.z=-Math.PI/4,bt.add(Re);const Ge=new ut(.07,32,32),tn=new Lt({color:16777215}),Ye=new _(Ge,tn);Ye.position.set(-.35,.85,0),bt.add(Ye);const ln=new _(Ge,tn);ln.position.set(.35,.85,0),bt.add(ln);const an=new te(.1,.1,.15,32),Ze=new Lt({color:16711680}),rn=new te(.08,.08,.4,32),en=new Lt({color:0}),dn=new _(rn,en);dn.position.set(-.1,.1,0),bt.add(dn);const pn=new _(an,Ze);pn.position.set(-.1,-.05,0),bt.add(pn);const Tn=new _(rn,en);Tn.position.set(.1,.1,0),bt.add(Tn);const bi=new _(an,Ze);bi.position.set(.1,-.05,0),bt.add(bi);const Fi=new ut(.12,32,32),Oi=new Lt({color:16711680}),Bi=new _(Fi,Oi);Bi.scale.set(1,.7,1.5),Bi.position.set(-.1,-.12,.12),bt.add(Bi);const Ei=new _(Fi,Oi);return Ei.scale.set(1,.7,1.5),Ei.position.set(.1,-.1,.12),bt.add(Ei),bt.scale.set(.25,.25,.25),bt.position.set(.2,.5,-0),bt},E=function(){let bt=0;function oe(){requestAnimationFrame(oe),bt+=.4,ae.position.y=.45+Math.sin(bt)*.5,T.render(tt,M)}oe()},b=function(bt){let oe=1,A=0;function V(){requestAnimationFrame(V),bt.position.x+=.01*oe,bt.position.x>=.5?(oe=-1,bt.rotation.y=Math.PI):bt.position.x<=0&&(oe=1,bt.rotation.y=0),A+=1,bt.position.y=-.2+Math.sin(A)*.01,bt.position.z=.5,T.render(tt,M)}V()},w=function(){const bt=new Xt,oe=new yn(.7,.8,.7),A=new Lt({color:9127187}),V=new _(oe,A);V.position.set(0,.4,0),bt.add(V);const L=new oi(.55,.25,4),k=new Lt({color:16777215}),z=new _(L,k);z.position.set(0,.9,0),z.rotation.y=Math.PI/4,bt.add(z);const mt=new yn(.25,.35,.05),Rt=new Lt({color:6636321}),Ut=new _(mt,Rt);Ut.position.set(0,.2,.36),bt.add(Ut);const Ft=new yn(.15,.15,.05),jt=new Lt({color:8900331}),qt=new _(Ft,jt);qt.position.set(-.2,.5,.38),bt.add(qt);const Vt=new _(Ft,jt);Vt.position.set(.2,.5,.38),bt.add(Vt);const ee=new yn(.2,.4,.2),ge=new Lt({color:8421504}),de=new _(ee,ge);de.position.set(0,.95,0),bt.add(de);const Ct=new Gn(.07,.04,32,100),Yt=new Lt({color:2263842}),Ht=new _(Ct,Yt);return Ht.position.set(0,.45,.38),bt.add(Ht),bt.position.set(.22,-.2,0),bt.scale.set(.5,.5,.5),bt},O=function(bt=1,oe={x:0,y:0,z:0}){const A=new Xt,V=new te(1.2,.9,3,32),L=new Lt({color:25153}),k=new _(V,L);A.add(k);const z=new te(1.3,1.3,.2,32),mt=new Lt({color:3355443}),Rt=new _(z,mt);Rt.position.y=1.6,A.add(Rt);const Ut=2,Ft=new te(1.1,1.1,Ut,32),jt=new Lt({color:9127187}),qt=new _(Ft,jt);return qt.position.y=0,new Yn().load("/3d-bear-arts/assets/starbucks-logo.png",function(ee){ee.repeat.set(4,1),ee.offset.set(.25,0),ee.wrapS=Qe,ee.wrapT=Qe;const ge=new Lt({color:9127187,map:ee,transparent:!0}),de=new te(1.1,1.05,1.5,32),Ct=new _(de,ge);Ct.position.y=-.5,A.add(Ct)}),A.scale.set(bt,bt,bt),A.position.set(oe.x,oe.y,oe.z),A},I=function(){let bt=1;function oe(){requestAnimationFrame(oe),bt-=.1,xe.position.y=.5+Math.sin(bt)*.8,T.render(tt,M)}oe()},R=function(){requestAnimationFrame(R);const bt=se.attributes.position.array;for(let oe=1;oe<bt.length;oe+=3)bt[oe]-=.02,bt[oe]<-10&&(bt[oe]=10);se.attributes.position.needsUpdate=!0,T.render(tt,M)},G=function(){requestAnimationFrame(G),i.value&&(U.rotation.y+=.03),s.value&&(U.rotation.y-=.03),o.value&&(U.rotation.x-=.03),r.value&&(U.rotation.x+=.03),a.value&&(a.value.rotation.y+=.7),Y.uniforms.u_time.value+=.5,he.rotation.y+=.45,Ie.rotation.y+=.05,xe.rotation.y+=.08,T.render(tt,M)};const tt=new kn,M=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),T=new Hn({antialias:!0,alpha:!0});T.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(T.domElement);const U=new Xt,$=new Xt;tt.add($);const et=new hi(16777215,2);tt.add(et);const at=new ui(16777215,4);at.position.set(5,5,5),tt.add(at);const j=new li(16777215,5,50);j.position.set(0,2,4),tt.add(j);const nt=new Yn,W=nt.load("/3d-bear-arts/assets/house.jpg");W.wrapS=W.wrapT=Qe,W.repeat.set(1,1),nt.load("/3d-bear-arts/assets/houseenv_texture_5.jpg");const gt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.6,transmission:1,ior:1.33,thickness:.01,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae}),xt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.35,transmission:1,ior:1.33,thickness:.01,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae}),wt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.4,transmission:.7,ior:1.33,thickness:.5,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae}),Nt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.6,transmission:.8,ior:1.33,thickness:.7,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae}),kt=new Tr().load(["/3d-bear-arts/assets/house_env_texture_1.jpg","/3d-bear-arts/assets/house_env_texture_4.jpg","/3d-bear-arts/assets/house_env_texture_6.jpg","/3d-bear-arts/assets/house_env_texture_2.jpg","/3d-bear-arts/assets/house_env_texture_5.jpg","/3d-bear-arts/assets/house_env_texture_3.jpg"]);tt.environment=kt;const rt=new Ot({color:16777215,metalness:.05,roughness:.2,transparent:!0,opacity:.5,transmission:.2,ior:1.5,depthWrite:!0,envMapIntensity:1,side:Ae}),pt=new Ot({color:16777215,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Pt=new ut(1,32,32,0,Math.PI),B=new _(Pt,xt),lt=new _(Pt,wt);B.scale.set(.85,.85,.8),lt.scale.set(.85,.85,.8),B.position.y=-.2,lt.position.y=-.2,B.rotation.y=Math.PI/2,lt.rotation.y=Math.PI*1.5;const ot=new Ce(1,32),ht=new _(ot,rt);ht.scale.set(.85,.85,.8),ht.position.set(0,-.2,0),ht.rotation.y=Math.PI/2;const yt=new Xt;yt.add(B),yt.add(lt),yt.add(ht),U.add(yt);const it=new ut(.6,32,32,0,Math.PI),g=new _(it,Nt);g.scale.set(1,.95,.95),g.position.set(0,1,0),g.rotation.y=Math.PI*1.5;const P=new _(it,xt);P.scale.set(1,.95,.95),P.position.set(0,1,0),P.rotation.y=Math.PI/2;const D=new Ce(.6,32),F=new _(D,rt);F.position.set(0,1,0),F.rotation.y=Math.PI/2,F.scale.set(1,.95,.95);const N=new Xt;N.add(g),N.add(P),N.add(F),U.add(N);const K=new ut(.6,32,32,0,Math.PI*2,0,Math.PI/2),Z=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.5,clearcoatRoughness:.7,transparent:!1,opacity:.85}),S=new _(K,Z);S.position.set(0,-.2,0),S.rotation.x=Math.PI,S.scale.set(1.25,1.25,1.25),yt.add(S);const x=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.6,clearcoatRoughness:.8,side:Ae,transparent:!1,opacity:.8}),C=new _(ot,x);C.scale.set(.7,.7,.7),C.position.set(0,-.3,0),C.rotation.x=Math.PI/2,C.renderOrder=1,yt.add(C),U.add(yt);const Y=new un({transparent:!0,uniforms:{u_time:{value:0}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),X=new _(ot,Y);X.position.set(0,-.2,0),X.scale.set(.7,.7,.7),X.rotation.x=-Math.PI/2,X.renderOrder=2,yt.add(X);const q=new ut(.25,32,32),ft=new _(q,Nt);ft.position.set(-.45,1.35,-.1),U.add(ft);const ct=new _(q,gt);ct.position.set(.45,1.35,-.1),U.add(ct);const vt=new ut(.25,32,32,Math.PI/2,Math.PI),At=new _(vt,Nt);At.scale.set(1.1,.6,.8),At.position.set(0,.84,.5),At.rotation.y=Math.PI;const dt=new ut(.25,32,32,Math.PI/2,Math.PI),_t=new _(dt,gt);_t.scale.set(1.1,.6,.8),_t.position.set(0,.84,.5),_t.rotation.y=0;const Dt=new Ce(.25,32),Bt=new _(Dt,rt);Bt.scale.set(.8,.6,.8),Bt.position.set(0,.84,.5),Bt.rotation.y=Math.PI/2;const It=new Xt;It.add(At),It.add(_t),It.add(Bt),U.add(It);const Kt=new ut(.35,32,32),Gt=new _(Kt,Nt);Gt.scale.set(.75,1.25,.65),Gt.position.set(-.7,-.15,.2),U.add(Gt);const Zt=new _(Kt,gt);Zt.scale.set(.75,1.25,.65),Zt.position.set(.7,-.15,.2),U.add(Zt);const H=new te(.2,.22,.6,32),Mt=new _(H,Nt);Mt.position.set(-.4,-1.05,0),U.add(Mt);const st=new _(H,gt);st.position.set(.4,-1.05,0),U.add(st);const Q=new ut(.3,32,32),St=new _(Q,Nt);St.scale.set(1,.72,1.5),St.position.set(-.4,-1.45,.17),U.add(St);const Et=new _(Q,gt);Et.scale.set(1,.72,1.5),Et.position.set(.4,-1.45,.17),U.add(Et);const Wt=new ut(.44,32,32),ne=new _(Wt,Nt);ne.position.set(-.15,-.45,-.4),U.add(ne);const ie=new _(Wt,pt);ie.position.set(.15,-.45,-.4),U.add(ie);const ce=new ut(.18,32,32),re=new _(ce,Nt);re.position.set(0,-.35,-.8),U.add(re),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(bt){const oe=new qe("X",{font:bt,size:.2,depth:.05}),A=new _(oe,pt);A.position.set(-.3,.99,.53),A.rotation.x=ue.degToRad(-5),A.rotation.y=ue.degToRad(-15),U.add(A);const V=new qe("+",{font:bt,size:.25,depth:.1}),L=new _(V,pt);L.position.set(.12,.99,.53),L.rotation.y=ue.degToRad(12),L.rotation.x=ue.degToRad(-5),U.add(L)});const we=y();U.add(we),m();const ae=p();U.add(ae);const he=p();he.position.set(-.2,-.1,.5),U.add(he),E(),a.value=p(),U.add(a.value),b(a.value);const pe=w();U.add(pe);const me=w();me.position.set(-.2,-.2,0),me.scale.set(.35,.35,.35),U.add(me);const Ie=O(.1,{x:0,y:0,z:1}),xe=O(1.1,{x:0,y:-1.2,z:0});I();const De=1e3,se=new En,Ne=[];for(let bt=0;bt<De;bt++){const oe=(Math.random()-.5)*20,A=Math.random()*20,V=(Math.random()-.5)*20;Ne.push(oe,A,V)}se.setAttribute("position",new on(Ne,3));const Ue=new vr({color:16777215,size:.1,transparent:!0,opacity:.8}),ke=new sr(se,Ue);U.add(ke),R(),U.scale.set(1.2,1.2,1.2),tt.add(U),U.scale.set(1.4,1.4,1.4),U.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),tt.add(U),U.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),U.position.y=-.25,M.position.set(t.bodyPosition.x,1.4,t.cameraPosition),M.position.set(0,1,4),M.lookAt(t.bodyPosition.x,0,0),M.position.z=4,U.rotation.x=.1,G(),je(()=>t.bodyPosition,bt=>{U.position.set(bt.x,bt.y,bt.z)}),je(()=>t.cameraPosition,bt=>{M.position.set(t.bodyPosition.x,1,bt),M.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{M.aspect=window.innerWidth/window.innerHeight,M.updateProjectionMatrix(),T.setSize(window.innerWidth,window.innerHeight)})}});function h(){s.value=!0}function u(){i.value=!0}function d(){o.value=!0}function f(){r.value=!0}function v(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let y=0;y<eb;y++){const m=document.createElement("div");m.classList.add("confetti"),m.style.left=`${Math.random()*100}vw`,m.style.animationDuration=`${Math.random()*3+4}s`,m.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(m)}for(let y=0;y<nb;y++){const m=document.createElement("div");m.classList.add("light"),document.body.appendChild(m)}return(y,m)=>(Xn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2),zt("div",QS,[zt("button",{class:"pixel-btn up",onMousedown:d,onMouseup:v},"UP",32),zt("div",tb,[zt("button",{class:"pixel-btn left",onMousedown:h,onMouseup:v},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:u,onMouseup:v},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:f,onMouseup:v},"DOWN",32)])],64))}}),sb=Kn(ib,[["__scopeId","data-v-43013412"]]),ob={class:"pixel-controls"},rb={class:"side-buttons"},ab=15,cb=5,lb=Un({__name:"Aquar",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);let i=$t(!1),s=$t(!1),o=$t(!1),r=$t(!1);const a=po(null),c=new Hn({antialias:!0});c.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(c.domElement),new kn;const l=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3);l.position.z=5,Wn(()=>{if(e.value){let y=function(){const L=new Xt,k=new Gn(.12,.05,16,100),z=new Lt({color:16777215}),mt=new _(k,z);mt.position.set(0,1.65,0),mt.rotation.x=Math.PI/2,L.add(mt);const Rt=new oi(.15,.3,32),Ut=new Lt({color:16711680}),Ft=new _(Rt,Ut);Ft.position.set(0,1.8,0),L.add(Ft);const jt=new ut(.05,32,32),qt=new Lt({color:16777215}),Vt=new _(jt,qt);return Vt.position.set(0,1.93,0),L.add(Vt),L.position.set(0,-.1,0),L},m=function(){const L=new Xt,k=new ut(.15,32,32),z=new Lt({color:16764057}),mt=new _(k,z);mt.position.set(0,.4,0),L.add(mt);const Rt=new oi(.08,.15,32);new Lt({color:16764057});const Ut=new _(Rt,xt);Ut.position.set(-.1,.55,0),Ut.rotation.z=Math.PI/6,L.add(Ut);const Ft=new _(Rt,xt);Ft.position.set(.1,.55,0),Ft.rotation.z=-Math.PI/6,L.add(Ft);const jt=new te(.12,.15,.3,32),qt=new Lt({color:16764057}),Vt=new _(jt,qt);Vt.position.set(0,.2,0),L.add(Vt);const ee=new te(.05,.05,.2,32),ge=new Lt({color:16764057}),de=new _(ee,ge);de.position.set(-.07,-.05,.05),L.add(de);const Ct=new _(ee,ge);Ct.position.set(.07,-.05,.05),L.add(Ct);const Yt=new te(.04,.04,.2,32),Ht=new Lt({color:16764057}),le=new _(Yt,xt);le.position.set(-.15,.25,0),le.rotation.z=Math.PI/4,L.add(le);const Tt=new _(Yt,Ht);Tt.position.set(.15,.25,0),Tt.rotation.z=-Math.PI/4,L.add(Tt);const Se=new te(.03,.03,.25,32),Pe=new Lt({color:16764057}),_e=new _(Se,Pe);return _e.position.set(0,.1,-.2),_e.rotation.x=Math.PI/4,L.add(_e),L.scale.set(.75,.75,.75),L.position.set(.2,0,.2),L},p=function(){const L=new Xt,k=new ut(.2,32,32),z=new Lt({color:16764057}),mt=new _(k,z);mt.position.set(0,1,0),L.add(mt);const Rt=new Lt({color:16777215}),Ut=[{x:0,y:.85,z:.15,size:.12},{x:-.1,y:.88,z:.1,size:.1},{x:.1,y:.88,z:.1,size:.1},{x:-.15,y:.95,z:.1,size:.08},{x:.15,y:.95,z:.1,size:.08}];for(const Pr of Ut){const kp=new ut(Pr.size,16,16),Fu=new _(kp,Rt);Fu.position.set(Pr.x,Pr.y-.06,Pr.z-.01),L.add(Fu)}const Ft=new Lt({color:16777215}),jt=new te(.05,.06,.1,32),qt=new _(jt,Ft);qt.position.set(-.06,.93,.18),qt.rotation.z=Math.PI/4;const Vt=new te(.05,.06,.1,32),ee=new _(Vt,Ft);ee.position.set(.06,.93,.18),ee.rotation.z=-Math.PI/4;const ge=new Gn(.12,.05,16,100),de=new Lt({color:16777215}),Ct=new _(ge,de);Ct.position.set(0,1.15,0),Ct.rotation.x=Math.PI/2,L.add(Ct);const Yt=new oi(.15,.3,32),Ht=new Lt({color:16711680}),le=new _(Yt,Ht);le.position.set(0,1.3,0),L.add(le);const Tt=new ut(.05,32,32),Se=new Lt({color:16777215}),Pe=new _(Tt,Se);Pe.position.set(0,1.43,0),L.add(Pe);const _e=new te(.2,.25,.6,32),Fe=new Lt({color:16711680}),ve=new _(_e,Fe);ve.position.set(0,.5,0),L.add(ve);const Le=new te(.25,.25,.1,32),Ve=new Lt({color:0}),Re=new _(Le,Ve);Re.position.set(0,.4,.005),L.add(Re);const Ge=new te(.06,.06,.3,32),tn=new Lt({color:16711680}),Ye=new _(Ge,tn);Ye.position.set(-.25,.75,0),Ye.rotation.z=Math.PI/4,L.add(Ye);const ln=new _(Ge,tn);ln.position.set(.25,.75,0),ln.rotation.z=-Math.PI/4,L.add(ln);const an=new ut(.07,32,32),Ze=new Lt({color:16777215}),rn=new _(an,Ze);rn.position.set(-.35,.85,0),L.add(rn);const en=new _(an,Ze);en.position.set(.35,.85,0),L.add(en);const dn=new te(.1,.1,.15,32),pn=new Lt({color:16711680}),Tn=new te(.08,.08,.4,32),bi=new Lt({color:0}),Fi=new _(Tn,bi);Fi.position.set(-.1,.1,0),L.add(Fi);const Oi=new _(dn,pn);Oi.position.set(-.1,-.05,0),L.add(Oi);const Bi=new _(Tn,bi);Bi.position.set(.1,.1,0),L.add(Bi);const Ei=new _(dn,pn);Ei.position.set(.1,-.05,0),L.add(Ei);const fi=new ut(.12,32,32),Ar=new Lt({color:16711680}),Ws=new _(fi,Ar);Ws.scale.set(1,.7,1.5),Ws.position.set(-.1,-.12,.12),L.add(Ws);const Qa=new _(fi,Ar);return Qa.scale.set(1,.7,1.5),Qa.position.set(.1,-.1,.12),L.add(Qa),L.scale.set(.25,.25,.25),L.position.set(.2,.5,-0),L},E=function(){let L=0;function k(){requestAnimationFrame(k),L+=.4,fe.position.y=.45+Math.sin(L)*.5,T.render(tt,M)}k()},b=function(L){let k=1,z=0;function mt(){requestAnimationFrame(mt),L.position.x+=.01*k,L.position.x>=.5?(k=-1,L.rotation.y=Math.PI):L.position.x<=0&&(k=1,L.rotation.y=0),z+=1,L.position.y=-.2+Math.sin(z)*.01,L.position.z=.5,T.render(tt,M)}mt()},w=function(){const L=new Xt,k=new yn(.7,.8,.7),z=new Lt({color:9127187}),mt=new _(k,z);mt.position.set(0,.4,0),L.add(mt);const Rt=new oi(.55,.25,4),Ut=new Lt({color:16777215}),Ft=new _(Rt,Ut);Ft.position.set(0,.9,0),Ft.rotation.y=Math.PI/4,L.add(Ft);const jt=new yn(.25,.35,.05),qt=new Lt({color:6636321}),Vt=new _(jt,qt);Vt.position.set(0,.2,.36),L.add(Vt);const ee=new yn(.15,.15,.05),ge=new Lt({color:8900331}),de=new _(ee,ge);de.position.set(-.2,.5,.38),L.add(de);const Ct=new _(ee,ge);Ct.position.set(.2,.5,.38),L.add(Ct);const Yt=new yn(.2,.4,.2),Ht=new Lt({color:8421504}),le=new _(Yt,Ht);le.position.set(0,.95,0),L.add(le);const Tt=new Gn(.07,.04,32,100),Se=new Lt({color:2263842}),Pe=new _(Tt,Se);return Pe.position.set(0,.45,.38),L.add(Pe),L.position.set(.22,-.2,0),L.scale.set(.5,.5,.5),L},O=function(L=1,k={x:0,y:0,z:0}){const z=new Xt,mt=new te(1.2,.9,3,32),Rt=new Lt({color:25153}),Ut=new _(mt,Rt);z.add(Ut);const Ft=new te(1.3,1.3,.2,32),jt=new Lt({color:3355443}),qt=new _(Ft,jt);return qt.position.y=1.6,z.add(qt),new Yn().load("/3d-bear-arts/assets/starbucks-logo.png",function(ee){ee.repeat.set(4,1),ee.offset.set(.25,0),ee.wrapS=Qe,ee.wrapT=Qe;const ge=new Lt({color:9127187,map:ee,transparent:!0}),de=new te(1.1,1.05,1.5,32),Ct=new _(de,ge);Ct.position.y=-.5,z.add(Ct)}),z.scale.set(L,L,L),z.position.set(k.x,k.y,k.z),z},I=function(){requestAnimationFrame(I);const L=xe.attributes.position.array;for(let k=1;k<L.length;k+=3)L[k]-=.02,L[k]<-10&&(L[k]=10);xe.attributes.position.needsUpdate=!0,T.render(tt,M)},R=function(){requestAnimationFrame(R);const L=oe.attributes.position.array;for(let k=1;k<L.length;k+=3)L[k]-=.02,L[k]<-bt&&(L[k]=bt);oe.attributes.position.needsUpdate=!0,T.render(tt,M)},G=function(){requestAnimationFrame(G),i.value&&(U.rotation.y+=.03),s.value&&(U.rotation.y-=.03),o.value&&(U.rotation.x-=.03),r.value&&(U.rotation.x+=.03),a.value&&(a.value.rotation.y+=.7),x.uniforms.u_time.value+=.5,we.rotation.y+=.45,pe.rotation.y+=.05,me.rotation.y+=.05,U.rotation.y-=.05,T.render(tt,M)};const tt=new kn,M=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),T=new Hn({antialias:!0,alpha:!0});T.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(T.domElement);const U=new Xt,$=new Xt;tt.add($);const et=new hi(16777215,2);tt.add(et);const at=new ui(16777215,4);at.position.set(5,5,5),tt.add(at);const j=new li(16777215,5,50);j.position.set(0,2,4),tt.add(j);const nt=new Yn,W=nt.load("/3d-bear-arts/assets/house.jpg");W.wrapS=W.wrapT=Qe,W.repeat.set(1,1),nt.load("/3d-bear-arts/assets/houseenv_texture_5.jpg");const gt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.5,transmission:1,ior:1.33,thickness:.01,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae});new Ot({color:16777215,metalness:.3,map:W,roughness:.05,transparent:!0,opacity:.5,transmission:.7,ior:1.33,thickness:.4,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae});const xt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.6,transmission:.8,ior:1.33,thickness:.7,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae}),wt=new Tr().load(["/3d-bear-arts/assets/house_env_texture_1.jpg","/3d-bear-arts/assets/house_env_texture_4.jpg","/3d-bear-arts/assets/house_env_texture_6.jpg","/3d-bear-arts/assets/house_env_texture_2.jpg","/3d-bear-arts/assets/house_env_texture_5.jpg","/3d-bear-arts/assets/house_env_texture_3.jpg"]);tt.environment=wt;const Nt=new Ot({color:16777215,metalness:.05,roughness:.2,transparent:!0,opacity:.5,transmission:.2,ior:1.5,depthWrite:!0,envMapIntensity:1,side:Ae}),kt=new Ot({color:16777215,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),rt=new ut(1,32,32,0,Math.PI),pt=new _(rt,gt),Pt=new _(rt,xt);pt.scale.set(.85,.85,.8),Pt.scale.set(.85,.85,.8),pt.position.y=-.2,Pt.position.y=-.2,pt.rotation.y=Math.PI/2,Pt.rotation.y=Math.PI*1.5;const B=new Ce(1,32),lt=new _(B,Nt);lt.scale.set(.85,.85,.8),lt.position.set(0,-.2,0),lt.rotation.y=Math.PI/2;const ot=new Xt;ot.add(pt),ot.add(Pt),ot.add(lt),U.add(ot);const ht=new ut(.6,32,32,0,Math.PI),yt=new _(ht,xt);yt.scale.set(1,.95,.95),yt.position.set(0,1,0),yt.rotation.y=Math.PI*1.5;const it=new _(ht,gt);it.scale.set(1,.95,.95),it.position.set(0,1,0),it.rotation.y=Math.PI/2;const g=new Ce(.6,32),P=new _(g,Nt);P.position.set(0,1,0),P.rotation.y=Math.PI/2,P.scale.set(1,.95,.95);const D=new Xt;D.add(yt),D.add(it),D.add(P),U.add(D);const F=new ut(.6,32,32,0,Math.PI*2,0,Math.PI/2),N=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.5,clearcoatRoughness:.7,transparent:!1,opacity:.85}),K=new _(F,N);K.position.set(0,-.2,0),K.rotation.x=Math.PI,K.scale.set(1.25,1.25,1.25),ot.add(K);const Z=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.6,clearcoatRoughness:.8,side:Ae,transparent:!1,opacity:.8}),S=new _(B,Z);S.scale.set(.7,.7,.7),S.position.set(0,-.3,0),S.rotation.x=Math.PI/2,S.renderOrder=1,ot.add(S),U.add(ot);const x=new un({transparent:!0,uniforms:{u_time:{value:0}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),C=new _(B,x);C.position.set(0,-.2,0),C.scale.set(.7,.7,.7),C.rotation.x=-Math.PI/2,C.renderOrder=2,ot.add(C);const Y=new ut(.25,32,32),X=new _(Y,xt);X.position.set(-.45,1.35,-.1),U.add(X);const q=new _(Y,gt);q.position.set(.45,1.35,-.1),U.add(q);const ft=new ut(.25,32,32,Math.PI/2,Math.PI),ct=new _(ft,xt);ct.scale.set(1.1,.6,.8),ct.position.set(0,.84,.5),ct.rotation.y=Math.PI;const vt=new ut(.25,32,32,Math.PI/2,Math.PI),At=new _(vt,gt);At.scale.set(1.1,.6,.8),At.position.set(0,.84,.5),At.rotation.y=0;const dt=new Ce(.25,32),_t=new _(dt,Nt);_t.scale.set(.8,.6,.8),_t.position.set(0,.84,.5),_t.rotation.y=Math.PI/2;const Dt=new Xt;Dt.add(ct),Dt.add(At),Dt.add(_t),U.add(Dt);const Bt=new ut(.35,32,32),It=new _(Bt,xt);It.scale.set(.75,1.25,.65),It.position.set(-.7,-.15,.2),U.add(It);const Kt=new _(Bt,gt);Kt.scale.set(.75,1.25,.65),Kt.position.set(.7,-.15,.2),U.add(Kt);const Gt=new te(.2,.22,.6,32),Zt=new _(Gt,xt);Zt.position.set(-.4,-1.05,0),U.add(Zt);const H=new _(Gt,gt);H.position.set(.4,-1.05,0),U.add(H);const Mt=new ut(.3,32,32),st=new _(Mt,xt);st.scale.set(1,.72,1.5),st.position.set(-.4,-1.45,.17),U.add(st);const Q=new _(Mt,gt);Q.scale.set(1,.72,1.5),Q.position.set(.4,-1.45,.17),U.add(Q);const St=new ut(.44,32,32),Et=new _(St,xt);Et.position.set(-.15,-.45,-.4),U.add(Et);const Wt=new _(St,xt);Wt.position.set(.15,-.45,-.4),U.add(Wt);const ne=new ut(.18,32,32),ie=new _(ne,xt);ie.position.set(0,-.35,-.8),U.add(ie),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(L){const k=new qe("X",{font:L,size:.2,depth:.05}),z=new _(k,kt);z.position.set(-.3,.99,.53),z.rotation.x=ue.degToRad(-5),z.rotation.y=ue.degToRad(-15),U.add(z);const mt=new qe("O",{font:L,size:.2,depth:.05}),Rt=new _(mt,kt);Rt.position.set(.14,.99,.53),Rt.rotation.y=ue.degToRad(12),Rt.rotation.x=ue.degToRad(-5),U.add(Rt)});const re=y();U.add(re),m();const fe=p();U.add(fe);const we=p();we.position.set(-.2,-.1,.5),U.add(we),E(),a.value=p(),U.add(a.value),b(a.value);const ae=w();U.add(ae);const he=w();he.position.set(-.2,-.2,0),he.scale.set(.35,.35,.35),U.add(he);const pe=O(.1,{x:0,y:0,z:1}),me=O(.6,{x:0,y:-1.5,z:0}),Ie=1e3,xe=new En,De=[];for(let L=0;L<Ie;L++){const k=(Math.random()-.5)*20,z=Math.random()*20,mt=(Math.random()-.5)*20;De.push(k,z,mt)}xe.setAttribute("position",new on(De,3));const se=new vr({color:16777215,size:.1,transparent:!0,opacity:.8}),Ne=new sr(xe,se);U.add(Ne),I();const Ue=2e3,ke=[],bt=.6;for(let L=0;L<Ue;L++){const k=(Math.random()-.5)*bt*2,z=(Math.random()-.5)*bt*2,mt=(Math.random()-.5)*bt*2;Math.sqrt(k*k+z*z+mt*mt)<bt&&ke.push(k,z,mt)}const oe=new En;oe.setAttribute("position",new on(ke,3)),new vr({color:16777215,size:.05,transparent:!0,opacity:.9}),new sr(oe,N).position.set(0,-.2,0),new sr(oe,Z).position.set(0,.8,0),R(),U.scale.set(.85,.85,.85),U.position.set(t.bodyPosition.x,t.bodyPosition.y+.9,t.bodyPosition.z),tt.add(U),tt.add(me),M.position.set(t.bodyPosition.x,1,t.cameraPosition),M.lookAt(t.bodyPosition.x,0,0),M.position.z=4,U.rotation.x=.1,G(),je(()=>t.bodyPosition,L=>{U.position.set(L.x,L.y,L.z)}),je(()=>t.cameraPosition,L=>{M.position.set(t.bodyPosition.x,1,L),M.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{M.aspect=window.innerWidth/window.innerHeight,M.updateProjectionMatrix(),T.setSize(window.innerWidth,window.innerHeight)})}});function h(){s.value=!0}function u(){i.value=!0}function d(){o.value=!0}function f(){r.value=!0}function v(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let y=0;y<ab;y++){const m=document.createElement("div");m.classList.add("confetti"),m.style.left=`${Math.random()*100}vw`,m.style.animationDuration=`${Math.random()*3+4}s`,m.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(m)}for(let y=0;y<cb;y++){const m=document.createElement("div");m.classList.add("light"),document.body.appendChild(m)}return(y,m)=>(Xn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2),zt("div",ob,[zt("button",{class:"pixel-btn up",onMousedown:d,onMouseup:v},"UP",32),zt("div",rb,[zt("button",{class:"pixel-btn left",onMousedown:h,onMouseup:v},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:u,onMouseup:v},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:f,onMouseup:v},"DOWN",32)])],64))}}),ub=Kn(lb,[["__scopeId","data-v-ceb84432"]]),hb={key:0,class:"bear-face-container"},db=Un({__name:"BearFaceWhite",props:{color:{type:String,default:"white"}},setup(n){const t=$t(null),e=$t(!1),i=n;return Wn(()=>{const s=t.value;if(s){s.width=window.innerWidth,s.height=window.innerHeight*.7;const o=s.getContext("2d");o&&(()=>{const a=s.width/2,c=s.height/1.8,l=s.height/2,h=s.height/2.05,u=l*.45,d=l*.18,f=l*.3,v=l*.275,y=f*.35,m=f*.32;o.save(),o.beginPath(),o.rect(0,0,s.width/2,s.height),o.clip(),o.lineWidth=15,o.strokeStyle=i.color,o.beginPath(),o.arc(a-l*.85,c-h*.8,u,0,Math.PI*2,!0),o.stroke(),o.beginPath(),o.arc(a+l*.85,c-l*.8,u,0,Math.PI*2,!0),o.stroke(),o.lineWidth=15,o.beginPath(),o.arc(a,c,h,0,Math.PI*2,!0),o.stroke(),o.lineWidth=15,o.beginPath(),o.arc(a-l*.4,c-l*.2,d,0,Math.PI*2,!0),o.stroke(),o.beginPath(),o.moveTo(a+l*.2,c-l*.3),o.lineTo(a+l*.5,c-l*.05),o.moveTo(a+l*.5,c-l*.3),o.lineTo(a+l*.2,c-l*.05),o.stroke(),o.beginPath(),o.ellipse(a,c+l*.4,v*1.5,v,0,0,Math.PI*2),o.stroke(),o.beginPath(),o.arc(a,c+l*.3,m,0,Math.PI*2,!0),o.stroke(),o.restore(),o.save(),o.beginPath(),o.rect(s.width/2,0,s.width/2,s.height),o.clip(),o.fillStyle=i.color,o.beginPath(),o.arc(a-l*.85,c-l*.8,u,0,Math.PI*2,!0),o.fill(),o.beginPath(),o.arc(a+l*.85,c-l*.8,u,0,Math.PI*2,!0),o.fill(),o.beginPath(),o.arc(a,c,l,0,Math.PI*2,!0),o.fill(),o.fillStyle=i.color,o.beginPath(),o.arc(a-l*.4,c-l*.2,d,0,Math.PI*2,!0),o.fill(),o.lineWidth=15,o.beginPath(),o.moveTo(a+l*.2,c-l*.3),o.lineTo(a+l*.5,c-l*.05),o.moveTo(a+l*.5,c-l*.3),o.lineTo(a+l*.2,c-l*.05),o.strokeStyle="#000000",o.stroke(),o.fillStyle="#000000",o.beginPath(),o.ellipse(a,c+l*.4,f*1.5,f,0,0,Math.PI*2),o.fill(),o.fillStyle=i.color,o.beginPath(),o.arc(a,c+l*.3,y*1.2,0,Math.PI*2,!0),o.fill(),o.restore()})()}}),(s,o)=>e.value?Lm("",!0):(Xn(),$n("div",hb,[zt("canvas",{ref_key:"bearCanvas",ref:t},null,512)]))}}),Gp=Kn(db,[["__scopeId","data-v-6ce68a75"]]),fb={class:"pixel-controls"},pb={class:"side-buttons"},mb=15,gb=5,vb=Un({__name:"SliverBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);Wn(()=>{if(e.value){let d=function(){E.visible=!1,G.update(p,y),E.visible=!0,requestAnimationFrame(d)},f=function(){const ae=new Xt,he=new Lt({color:16777215}),pe=new Lt({color:16753920}),me=new Lt({color:0}),Ie=new Lt({color:16711680}),xe=new Lt({color:9127187}),De=new ut(.5,32,32),se=new _(De,he);se.position.set(0,1.5,0),ae.add(se);const Ne=new te(.25,.2,.5,32),Ue=new _(Ne,pe);Ue.position.set(0,1.3,.5),Ue.rotation.x=Math.PI/2,ae.add(Ue);const ke=new ut(.8,32,32),bt=new _(ke,he);bt.position.set(0,.6,0),ae.add(bt);const oe=new te(.2,.2,.6,32),A=new _(oe,pe);A.position.set(-.3,-.6,0),ae.add(A);const V=new _(oe,pe);V.position.set(.3,-.6,0),ae.add(V);const L=new yn(.5,.2,.3),k=new _(L,pe);k.position.set(-.3,-.9,.15),ae.add(k);const z=new _(L,pe);z.position.set(.3,-.9,.15),ae.add(z);const mt=new te(.4,.4,.1,32),Rt=new _(mt,me);Rt.position.set(0,2.1,0),ae.add(Rt);const Ut=new te(.3,.3,.6,32),Ft=new _(Ut,me);Ft.position.set(0,2.4,0),ae.add(Ft);const jt=new Gn(.2,.05,16,100),qt=new _(jt,Ie);qt.position.set(0,1,.5),ae.add(qt);const Vt=new te(.05,.05,2,32),ee=new _(Vt,xe);return ee.position.set(.5,0,0),ee.rotation.z=Math.PI/8,ae.add(ee),ae},v=function(){requestAnimationFrame(v),Nt.uniforms.time.value+=.05,gt.uniforms.time.value+=.05,i.value&&(E.rotation.y+=.05),s.value&&(E.rotation.y-=.07),o.value&&(E.rotation.x-=.05),r.value&&(E.rotation.x+=.05),p.render(y,m)};const y=new kn,m=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),p=new Hn({antialias:!0,alpha:!0});p.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(p.domElement);const E=new Xt,b=new hi(16777215,2);y.add(b);const w=new ui(16777215,4);w.position.set(5,5,5),y.add(w);const O=new li(16777215,5,50);O.position.set(0,2,4),y.add(O);const I=new Yn,R=new $a(256,{format:qn,generateMipmaps:!0,minFilter:Ci}),G=new Ya(1,1e3,R);new Ot({color:12632256,metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.4,envMap:R.texture,envMapIntensity:1.5}),y.add(G),y.environment=R.texture,d();const M=new Tr().load(["/3d-bear-arts/assets/popbear1.jpg","/3d-bear-arts/assets/popbear1.jpg","/3d-bear-arts/assets/popbear1.jpg","/3d-bear-arts/assets/popbear1.jpg","/3d-bear-arts/assets/popbear1.jpg","/3d-bear-arts/assets/popbear1.jpg"]);y.environment=M;const T=new Ot({color:"hotpink",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:M,reflectivity:1}),U=new Ot({color:"hotpink",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.6,envMap:M,reflectivity:0}),$=new Ot({color:"hotpink",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.35,envMap:M,reflectivity:0}),et=I.load("/3d-bear-arts/assets/popbear1.jpg"),at=new Ot({color:"hotpink",map:et,metalness:.3,roughness:.5,transparent:!0,opacity:1}),j=new un({uniforms:{time:{value:0},color1:{value:new Me(16766720)},color2:{value:new Me(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,gt=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:nt,fragmentShader:W,transparent:!1,depthWrite:!0}),xt=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,Nt=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:xt,fragmentShader:wt,transparent:!1,depthWrite:!0}),kt=new ut(1,32,32,0,Math.PI),rt=new _(kt,$),pt=new _(kt,T);rt.scale.set(.85,.85,.8),pt.scale.set(.85,.85,.8),rt.position.y=-.2,pt.position.y=-.2,rt.rotation.y=Math.PI/2,pt.rotation.y=Math.PI*1.5;const Pt=new Ce(1,32),B=new _(Pt,at);B.scale.set(.85,.85,.8),B.position.set(0,-.2,0),B.rotation.y=Math.PI/2;const lt=new Xt;lt.add(rt),lt.add(pt),lt.add(B),E.add(lt);const ot=new ut(.6,32,32,0,Math.PI),ht=new _(ot,T);ht.scale.set(1,.95,.95),ht.position.set(0,1,0),ht.rotation.y=Math.PI*1.5;const yt=new _(ot,U);yt.scale.set(1,.95,.95),yt.position.set(0,1,0),yt.rotation.y=Math.PI/2;const it=new Ce(.6,32),g=new _(it,at);g.position.set(0,1,0),g.rotation.y=Math.PI/2,g.scale.set(1,.95,.95);const P=new Xt;P.add(ht),P.add(yt),P.add(g),E.add(P);const D=new ut(.25,32,32),F=new _(D,T);F.position.set(-.45,1.35,-.1),E.add(F);const N=new _(D,U);N.position.set(.45,1.35,-.1),E.add(N);const K=new ut(.25,32,32,Math.PI/2,Math.PI),Z=new _(K,T);Z.scale.set(1.1,.6,.8),Z.position.set(0,.84,.5),Z.rotation.y=Math.PI;const S=new ut(.25,32,32,Math.PI/2,Math.PI),x=new _(S,U);x.scale.set(1.1,.6,.8),x.position.set(0,.84,.5),x.rotation.y=0;const C=new Ce(.25,32),Y=new _(C,at);Y.scale.set(.8,.6,.8),Y.position.set(0,.84,.5),Y.rotation.y=Math.PI/2;const X=new Xt;X.add(Z),X.add(x),X.add(Y),E.add(X);const q=new Sn;q.moveTo(0,0),q.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),q.bezierCurveTo(-.6,.3,0,.6,0,1),q.bezierCurveTo(0,.6,.6,.3,.6,0),q.bezierCurveTo(.6,-.3,0,-.3,0,0);const ft={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ct=new Dn(q,ft),vt=new _(ct,gt);vt.scale.set(.38,.38,.38),vt.position.set(.35,0,0),vt.rotation.y=Math.PI,vt.rotation.x=Math.PI,E.add(vt);const At=new _(ct,gt);At.scale.set(.35,.35,.35),At.position.set(.3,0,0),At.rotation.y=Math.PI,At.rotation.x=Math.PI,E.add(At);const dt=new _(ct,T);dt.scale.set(.22,.22,.22),dt.position.set(.27,.4,0),dt.rotation.y=Math.PI,dt.rotation.x=Math.PI,E.add(dt);const _t=new _(ct,T);_t.scale.set(.25,.25,.25),_t.position.set(.23,-.5,.3),_t.rotation.y=Math.PI,_t.rotation.x=Math.PI,E.add(_t);const Dt=new _(ct,T);Dt.scale.set(.3,.3,.3),Dt.position.set(.23,.2,-.4),Dt.rotation.y=Math.PI,Dt.rotation.x=Math.PI,E.add(Dt);const Bt=new ut(.35,32,32),It=new _(Bt,T);It.scale.set(.75,1.25,.65),It.position.set(-.7,-.15,.2),E.add(It);const Kt=new _(Bt,U);Kt.scale.set(.75,1.25,.65),Kt.position.set(.7,-.15,.2),E.add(Kt);const Gt=new te(.2,.22,.6,32),Zt=new _(Gt,T);Zt.position.set(-.4,-1.05,0),E.add(Zt);const H=new _(Gt,U);H.position.set(.4,-1.05,0),E.add(H);const Mt=new ut(.3,32,32),st=new _(Mt,T);st.scale.set(1,.72,1.5),st.position.set(-.4,-1.45,.17),E.add(st);const Q=new _(Mt,U);Q.scale.set(1,.72,1.5),Q.position.set(.4,-1.45,.17),E.add(Q);const St=new ut(.44,32,32),Et=new _(St,T);Et.position.set(-.15,-.45,-.4),E.add(Et);const Wt=new _(St,U);Wt.position.set(.15,-.45,-.4),E.add(Wt);const ne=new ut(.18,32,32),ie=new _(ne,T);ie.position.set(0,-.35,-.8),E.add(ie),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ae){const he=new qe("X",{font:ae,size:.18,depth:.05}),pe=new _(he,gt);pe.position.set(-.3,.99,.53),pe.rotation.x=ue.degToRad(-5),pe.rotation.y=ue.degToRad(-15),E.add(pe);const me=new qe("+",{font:ae,size:.25,depth:.1}),Ie=new _(me,gt);Ie.position.set(.14,.99,.53),Ie.rotation.y=ue.degToRad(12),Ie.rotation.x=ue.degToRad(-5),E.add(Ie)}),ie.renderOrder=1;const re=f();re.scale.set(.2,.2,.2),re.position.set(1,.6,.3),E.add(re),E.scale.set(1.4,1.4,1.4),y.add(E),E.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),m.position.set(t.bodyPosition.x,1.4,t.cameraPosition),m.lookAt(t.bodyPosition.x,0,0),m.position.z=4;let fe=$t(!1);const we=ae=>{if(fe.value){const he={x:ae.clientX/window.innerWidth*2-1,y:-(ae.clientY/window.innerHeight)*2+1},pe=he.x*Math.PI*.2,me=he.y*Math.PI*.2;E.rotation.y=pe,E.rotation.x=me}};window.addEventListener("mousemove",we),j.uniforms.time.value+=.04,v(),je(()=>t.bodyPosition,ae=>{E.position.set(ae.x,ae.y,ae.z)}),je(()=>t.cameraPosition,ae=>{m.position.set(t.bodyPosition.x,1,ae),m.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{m.aspect=window.innerWidth/window.innerHeight,m.updateProjectionMatrix(),p.setSize(window.innerWidth,window.innerHeight)})}});let i=$t(!1),s=$t(!1),o=$t(!1),r=$t(!1);function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let d=0;d<mb;d++){const f=document.createElement("div");f.classList.add("confetti"),f.style.left=`${Math.random()*100}vw`,f.style.animationDuration=`${Math.random()*3+4}s`,f.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(f)}for(let d=0;d<gb;d++){const f=document.createElement("div");f.classList.add("light"),document.body.appendChild(f)}return(d,f)=>(Xn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2),zt("div",null,[We(Gp,{class:"bear-background",color:"#FF69B4"})]),zt("div",fb,[zt("button",{class:"pixel-btn up border-gold",onMousedown:l,onMouseup:u},"▲",32),zt("div",pb,[zt("button",{class:"pixel-btn left border-silver",onMousedown:a,onMouseup:u},"◀",32),zt("button",{class:"pixel-btn right border-silver",onMousedown:c,onMouseup:u},"▶",32)]),zt("button",{class:"pixel-btn down border-gold",onMousedown:h,onMouseup:u},"▼",32)])],64))}}),_b=Kn(vb,[["__scopeId","data-v-262b0f1d"]]),xb={class:"pixel-controls"},yb={class:"side-buttons"},Mb=15,wb=5,Sb=Un({__name:"Money",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);Wn(()=>{if(e.value){let d=function(){w.visible=!1,T.update(b,p),w.visible=!0,requestAnimationFrame(d)},f=function(){const se=new Xt;new Lt({color:16777215}),new Lt({color:16770244}),new Lt({color:16776960}),new Lt({color:16316671});const Ne=new ut(.2,32,32),Ue=new _(Ne,j);Ue.position.set(0,1.5,0),se.add(Ue);const ke=new te(.2,.35,.6,32),bt=new _(ke,j);bt.position.set(0,1,0),se.add(bt);const oe=new Sn;oe.moveTo(0,0),oe.bezierCurveTo(.5,.2,.8,.7,.5,1.5),oe.bezierCurveTo(.3,1.3,0,.8,0,0);const A=new Dn(oe,{depth:.05,bevelEnabled:!1}),V=new _(A,kt);V.position.set(-.2,1.2,-.05),V.rotation.y=Math.PI/12,V.rotation.z=Math.PI/4,V.scale.set(-.5,.5,.5),se.add(V);const L=new _(A,kt);L.position.set(-.1,1.1,-.05),L.rotation.y=Math.PI/10,L.rotation.z=Math.PI/3,L.scale.set(-.5,.5,.5),se.add(L);const k=new _(A,kt);k.position.set(0,1,-.05),k.rotation.y=Math.PI/8,k.rotation.z=Math.PI/2.5,k.scale.set(-.5,.5,.5),se.add(k);const z=new _(A,kt);z.position.set(.2,1.2,-.05),z.rotation.y=-Math.PI/12,z.rotation.z=-Math.PI/4,z.scale.set(.5,.5,.5),se.add(z);const mt=new _(A,kt);mt.position.set(.1,1.1,-.05),mt.rotation.y=-Math.PI/10,mt.rotation.z=-Math.PI/3,mt.scale.set(.5,.5,.5),se.add(mt);const Rt=new _(A,kt);Rt.position.set(0,1,-.05),Rt.rotation.y=-Math.PI/8,Rt.rotation.z=-Math.PI/2.5,Rt.scale.set(.5,.5,.5),se.add(Rt);const Ut=new Gn(.15,.05,16,100),Ft=new _(Ut,kt);Ft.position.set(0,1.8,0),Ft.rotation.x=Math.PI/2,se.add(Ft);const jt=new te(.05,.05,.3,32),qt=new _(jt,kt);qt.position.set(-.15,.55,0),qt.rotation.z=Math.PI/1;const Vt=new _(jt,kt);return Vt.position.set(.15,.55,0),Vt.rotation.z=-Math.PI/1,se.add(qt),se.add(Vt),se},v=function(){const se=new Xt,Ne=new te(.8,.8,.25,32),Ue=new _(Ne,j);se.add(Ue);const ke=new oi(.2,.4,32),bt=8,oe=.6;for(let V=0;V<bt;V++){const L=V/bt*Math.PI*2,k=new _(ke,j);k.position.set(Math.cos(L)*oe,.23,Math.sin(L)*oe),k.rotation.y=-L,se.add(k)}const A=new ut(.08,16,16);for(let V=0;V<bt;V++){const L=V/bt*Math.PI*2,k=new _(A,kt);k.position.set(Math.cos(L)*oe,.45,Math.sin(L)*oe),se.add(k)}return se},y=function(){requestAnimationFrame(y),fe.rotation.y+=.01,b.render(p,E)},m=function(){requestAnimationFrame(m),Pt.uniforms.time.value+=.05,kt.uniforms.time.value+=.05,i.value&&(w.rotation.y+=.05),s.value&&(w.rotation.y-=.07),o.value&&(w.rotation.x-=.05),r.value&&(w.rotation.x+=.05),xe+=he,De+=pe,re.position.y=t.bodyPosition.y+Math.sin(xe)*Ie-.7,re.position.y=t.bodyPosition.y+Math.sin(De)*me-.6,b.render(p,E)};const p=new kn,E=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),b=new Hn({antialias:!0,alpha:!0});b.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(b.domElement);const w=new Xt,O=new hi(16777215,2);p.add(O);const I=new ui(16777215,4);I.position.set(5,5,5),p.add(I);const R=new li(16777215,5,50);R.position.set(0,2,4),p.add(R);const tt=new Yn().load("/3d-bear-arts/assets/cashwings.jpg"),M=new $a(256,{format:qn,generateMipmaps:!0,minFilter:Ci}),T=new Ya(1,1e3,M),U=new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.4,envMap:M.texture,envMapIntensity:1.5});p.add(T),p.environment=M.texture,d();const $=new Tr,et=$.load(["/3d-bear-arts/assets/cash2.jpg","/3d-bear-arts/assets/cash8.jpg","/3d-bear-arts/assets/cash1.jpg","/3d-bear-arts/assets/cash11.jpg","/3d-bear-arts/assets/cash4.jpg","/3d-bear-arts/assets/cash3.jpg"]);p.environment=et;const at=$.load(["/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg"]);p.environment=at;const j=new Ot({color:"lightgreen",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:et,reflectivity:1});new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:at,reflectivity:1});const nt=new Ot({color:"lightgreen",map:tt,metalness:.3,roughness:.5,transparent:!0,opacity:1}),W=new Ot({color:"lightgreen",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.45,envMap:et,reflectivity:0}),gt=new Ot({color:"lightgreen",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.35,envMap:et,reflectivity:0}),xt=new un({uniforms:{time:{value:0},color1:{value:new Me(16766720)},color2:{value:new Me(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,kt=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:wt,fragmentShader:Nt,transparent:!1,depthWrite:!0}),rt=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,Pt=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:rt,fragmentShader:pt,transparent:!1,depthWrite:!0}),B=new ut(1,32,32,0,Math.PI),lt=new _(B,gt),ot=new _(B,j);lt.scale.set(.85,.85,.8),ot.scale.set(.85,.85,.8),lt.position.y=-.2,ot.position.y=-.2,lt.rotation.y=Math.PI/2,ot.rotation.y=Math.PI*1.5;const ht=new Ce(1,32),yt=new _(ht,nt);yt.scale.set(.85,.85,.8),yt.position.set(0,-.2,0),yt.rotation.y=Math.PI/2;const it=new Xt;it.add(lt),it.add(ot),it.add(yt),w.add(it);const g=new ut(.6,32,32,0,Math.PI),P=new _(g,j);P.scale.set(1,.95,.95),P.position.set(0,1,0),P.rotation.y=Math.PI*1.5;const D=new _(g,gt);D.scale.set(1,.95,.95),D.position.set(0,1,0),D.rotation.y=Math.PI/2;const F=new Ce(.6,32),N=new _(F,nt);N.position.set(0,1,0),N.rotation.y=Math.PI/2,N.scale.set(1,.95,.95);const K=new Xt;K.add(P),K.add(D),K.add(N),w.add(K);const Z=new ut(.25,32,32),S=new _(Z,j);S.position.set(-.45,1.35,-.1),w.add(S);const x=new _(Z,gt);x.position.set(.45,1.35,-.1),w.add(x);const C=new ut(.25,32,32,Math.PI/2,Math.PI),Y=new _(C,j);Y.scale.set(1.1,.6,.8),Y.position.set(0,.84,.5),Y.rotation.y=Math.PI;const X=new ut(.25,32,32,Math.PI/2,Math.PI),q=new _(X,gt);q.scale.set(1.1,.6,.8),q.position.set(0,.84,.5),q.rotation.y=0;const ft=new Ce(.25,32),ct=new _(ft,nt);ct.scale.set(.8,.6,.8),ct.position.set(0,.84,.5),ct.rotation.y=Math.PI/2;const vt=new Xt;vt.add(Y),vt.add(q),vt.add(ct),w.add(vt);const At=new Sn;At.moveTo(0,0),At.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),At.bezierCurveTo(-.6,.3,0,.6,0,1),At.bezierCurveTo(0,.6,.6,.3,.6,0),At.bezierCurveTo(.6,-.3,0,-.3,0,0);const dt={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},_t=new Dn(At,dt),Dt=new _(_t,U);Dt.scale.set(.38,.38,.38),Dt.position.set(.35,0,0),Dt.rotation.y=Math.PI,Dt.rotation.x=Math.PI;const Bt=new ut(.35,32,32),It=new _(Bt,j);It.scale.set(.75,1.25,.65),It.position.set(-.7,-.15,.2),w.add(It);const Kt=new _(Bt,W);Kt.scale.set(.75,1.25,.65),Kt.position.set(.7,-.15,.2),w.add(Kt);const Gt=new te(.2,.22,.6,32),Zt=new _(Gt,j);Zt.position.set(-.4,-1.05,0),w.add(Zt);const H=new _(Gt,W);H.position.set(.4,-1.05,0),w.add(H);const Mt=new ut(.3,32,32),st=new _(Mt,j);st.scale.set(1,.72,1.5),st.position.set(-.4,-1.45,.17),w.add(st);const Q=new _(Mt,W);Q.scale.set(1,.72,1.5),Q.position.set(.4,-1.45,.17),w.add(Q);const St=new ut(.44,32,32),Et=new _(St,j);Et.position.set(-.15,-.45,-.4),w.add(Et);const Wt=new _(St,W);Wt.position.set(.15,-.45,-.4),w.add(Wt);const ne=new ut(.18,32,32),ie=new _(ne,j);ie.position.set(0,-.35,-.8),w.add(ie),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(se){const Ne=new qe("X",{font:se,size:.18,depth:.05}),Ue=new _(Ne,kt);Ue.position.set(-.3,.99,.53),Ue.rotation.x=ue.degToRad(-5),Ue.rotation.y=ue.degToRad(-15),w.add(Ue);const ke=new qe("+",{font:se,size:.25,depth:.1}),bt=new _(ke,kt);bt.position.set(.14,.99,.53),bt.rotation.y=ue.degToRad(12),bt.rotation.x=ue.degToRad(-5),w.add(bt)}),ie.renderOrder=1;const re=f();re.scale.set(.37,.37,.37),re.position.set(.35,-.5,.25),w.add(re);const fe=v();fe.scale.set(.3,.3,.3),fe.position.set(-.06,1.6,.1),fe.rotation.set(0,0,Math.PI/20),w.add(fe),y(),w.scale.set(1.4,1.4,1.4),p.add(w),w.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),E.position.set(t.bodyPosition.x,1.4,t.cameraPosition),E.lookAt(t.bodyPosition.x,0,0),E.position.z=4;let we=$t(!1);const ae=se=>{if(we.value){const Ne={x:se.clientX/window.innerWidth*2-1,y:-(se.clientY/window.innerHeight)*2+1},Ue=Ne.x*Math.PI*.2,ke=Ne.y*Math.PI*.2;w.rotation.y=Ue,w.rotation.x=ke}};window.addEventListener("mousemove",ae);let he=.05,pe=.06,me=.2,Ie=.25,xe=0,De=0;xt.uniforms.time.value+=.04,m(),je(()=>t.bodyPosition,se=>{w.position.set(se.x,se.y,se.z)}),je(()=>t.cameraPosition,se=>{E.position.set(t.bodyPosition.x,1,se),E.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{E.aspect=window.innerWidth/window.innerHeight,E.updateProjectionMatrix(),b.setSize(window.innerWidth,window.innerHeight)})}});let i=$t(!1),s=$t(!1),o=$t(!1),r=$t(!1);function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let d=0;d<Mb;d++){const f=document.createElement("div");f.classList.add("confetti"),f.style.left=`${Math.random()*100}vw`,f.style.animationDuration=`${Math.random()*3+4}s`,f.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(f)}for(let d=0;d<wb;d++){const f=document.createElement("div");f.classList.add("light"),document.body.appendChild(f)}return(d,f)=>(Xn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2),zt("div",null,[We(Gp,{class:"bear-background",color:"lightgreen"})]),zt("div",xb,[zt("button",{class:"pixel-btn up border-gold",onMousedown:l,onMouseup:u},"▲",32),zt("div",yb,[zt("button",{class:"pixel-btn left border-silver",onMousedown:a,onMouseup:u},"◀",32),zt("button",{class:"pixel-btn right border-silver",onMousedown:c,onMouseup:u},"▶",32)]),zt("button",{class:"pixel-btn down border-gold",onMousedown:h,onMouseup:u},"▼",32)])],64))}}),bb=Kn(Sb,[["__scopeId","data-v-90a2a8bc"]]),Eb={class:"pixel-controls"},Tb={class:"side-buttons"},Ab=15,Pb=5,Rb=Un({__name:"Snowman",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=$t(null);Wn(()=>{if(e.value){let d=function(){R.visible=!1,et.update(I,w),R.visible=!0,requestAnimationFrame(d)},f=function(){const Ct=document.createElement("canvas"),Yt=Ct.getContext("2d");Ct.width=512,Ct.height=512;const Ht=Ct.width/10;for(let Tt=0;Tt<10;Tt++)Yt.fillStyle=Tt%2===0?"#FF0000":"#FFFFFF",Yt.fillRect(Tt*Ht,0,Ht,Ct.height);const le=new U1(Ct);return le.wrapS=Qe,le.wrapT=Qe,le.repeat.set(1,0),le},v=function(){const Ct=new Xt,Yt=new Lt({color:16777215}),Ht=new Lt({color:0}),le=new Lt({color:16753920}),Tt=new Lt({color:16711680}),Se=new Lt({color:0}),Pe=new _(new ut(.6,32,32),Yt);Pe.position.set(0,.6,0),Ct.add(Pe);const _e=new _(new ut(.4,32,32),Yt);_e.position.set(0,1.2,0),Ct.add(_e);const Fe=new _(new ut(.3,32,32),Yt);Fe.position.set(0,1.7,0),Ct.add(Fe);const ve=new _(new ut(.05,16,16),Ht);ve.position.set(-.1,1.75,.25),Ct.add(ve);const Le=new _(new ut(.05,16,16),Ht);Le.position.set(.1,1.75,.25),Ct.add(Le);const Ve=new oi(.05,.2,32),Re=new _(Ve,le);Re.position.set(0,1.7,.35),Re.rotation.x=Math.PI/2,Ct.add(Re);for(let dn=0;dn<3;dn++){const pn=new _(new ut(.05,16,16),Ht);pn.position.set(0,1-dn*.3,.4),Ct.add(pn)}const Ge=new Gn(.3,.08,16,100),tn=new _(Ge,Tt);tn.position.set(0,1.45,0),tn.rotation.x=Math.PI/2,Ct.add(tn);const Ye=new yn(.1,.4,.05),ln=new _(Ye,Tt);ln.position.set(.25,1.3,0),Ct.add(ln);const an=new te(.3,.3,.05,32),Ze=new _(an,Se);Ze.position.set(0,1.9,0),Ct.add(Ze);const rn=new te(.2,.2,.3,32),en=new _(rn,Se);return en.position.set(0,2.05,0),Ct.add(en),Ct},y=function(){const Ct=new Xt;new Lt({color:16777215});const Yt=new Lt({color:0}),Ht=new Lt({color:16753920}),le=new Lt({color:16711680}),Tt=new Lt({color:0}),Se=new _(new ut(.6,32,32),W);Se.position.set(0,.6,0),Ct.add(Se);const Pe=new _(new ut(.4,32,32),W);Pe.position.set(0,1.2,0),Ct.add(Pe);const _e=new _(new ut(.3,32,32),W);_e.position.set(0,1.7,0),Ct.add(_e);const Fe=new _(new ut(.05,16,16),Yt);Fe.position.set(-.1,1.75,.25),Ct.add(Fe);const ve=new _(new ut(.05,16,16),Yt);ve.position.set(.1,1.75,.25),Ct.add(ve);const Le=new oi(.05,.2,32),Ve=new _(Le,Ht);Ve.position.set(0,1.7,.35),Ve.rotation.x=Math.PI/2,Ct.add(Ve);for(let en=0;en<3;en++){const dn=new _(new ut(.05,16,16),Yt);dn.position.set(0,1-en*.3,.4),Ct.add(dn)}const Re=new Gn(.3,.08,16,100),Ge=new _(Re,le);Ge.position.set(0,1.45,0),Ge.rotation.x=Math.PI/2,Ct.add(Ge);const tn=new yn(.1,.4,.05),Ye=new _(tn,le);Ye.position.set(.25,1.3,0),Ct.add(Ye);const ln=new te(.3,.3,.05,32),an=new _(ln,Tt);an.position.set(0,1.9,0),Ct.add(an);const Ze=new te(.2,.2,.3,32),rn=new _(Ze,Tt);return rn.position.set(0,2.05,0),Ct.add(rn),Ct},m=function(){const Ct=new Xt;new Lt({color:16777215});const Yt=new Lt({color:16770244}),Ht=new Lt({color:16776960}),le=new Lt({color:16316671}),Tt=new ut(.2,32,32),Se=new _(Tt,Yt);Se.position.set(0,1.5,0),Ct.add(Se);const Pe=new te(.2,.35,.6,32),_e=new _(Pe,Yt);_e.position.set(0,1,0),Ct.add(_e);const Fe=new Sn;Fe.moveTo(0,0),Fe.bezierCurveTo(.5,.2,.8,.7,.5,1.5),Fe.bezierCurveTo(.3,1.3,0,.8,0,0);const ve=new Dn(Fe,{depth:.05,bevelEnabled:!1}),Le=new _(ve,le);Le.position.set(-.2,1.2,-.05),Le.rotation.y=Math.PI/12,Le.rotation.z=Math.PI/4,Le.scale.set(-.5,.5,.5),Ct.add(Le);const Ve=new _(ve,le);Ve.position.set(-.1,1.1,-.05),Ve.rotation.y=Math.PI/10,Ve.rotation.z=Math.PI/3,Ve.scale.set(-.5,.5,.5),Ct.add(Ve);const Re=new _(ve,le);Re.position.set(0,1,-.05),Re.rotation.y=Math.PI/8,Re.rotation.z=Math.PI/2.5,Re.scale.set(-.5,.5,.5),Ct.add(Re);const Ge=new _(ve,le);Ge.position.set(.2,1.2,-.05),Ge.rotation.y=-Math.PI/12,Ge.rotation.z=-Math.PI/4,Ge.scale.set(.5,.5,.5),Ct.add(Ge);const tn=new _(ve,le);tn.position.set(.1,1.1,-.05),tn.rotation.y=-Math.PI/10,tn.rotation.z=-Math.PI/3,tn.scale.set(.5,.5,.5),Ct.add(tn);const Ye=new _(ve,le);Ye.position.set(0,1,-.05),Ye.rotation.y=-Math.PI/8,Ye.rotation.z=-Math.PI/2.5,Ye.scale.set(.5,.5,.5),Ct.add(Ye);const ln=new Gn(.15,.05,16,100),an=new _(ln,Ht);an.position.set(0,1.8,0),an.rotation.x=Math.PI/2,Ct.add(an);const Ze=new te(.05,.05,.3,32),rn=new _(Ze,Yt);rn.position.set(-.15,.55,0),rn.rotation.z=Math.PI/1;const en=new _(Ze,Yt);return en.position.set(.15,.55,0),en.rotation.z=-Math.PI/1,Ct.add(rn),Ct.add(en),Ct},p=function(){requestAnimationFrame(p);const Ct=1.5,Yt=.5;De+=.03,Ne+=.005*ke,Ne>Yt&&(ke=-1),Ne<-Yt&&(ke=1),oe.position.x=Math.cos(De)*Ct,oe.position.z=Math.sin(De)*Ct,oe.position.y=Ne+1,se+=.03,Ue+=.005*bt,Ue>Yt&&(bt=-1),Ue<-Yt&&(bt=1),A.position.x=Math.cos(se)*Ct,A.position.z=Math.sin(se)*Ct,A.position.y=Ue+1,oe.lookAt(R.position),A.lookAt(R.position),I.render(w,O)},E=function(){requestAnimationFrame(E);const Ct=jt.attributes.position.array;for(let Yt=1;Yt<Ct.length;Yt+=3)Ct[Yt]-=.02,Ct[Yt]<-10&&(Ct[Yt]=10);jt.attributes.position.needsUpdate=!0,I.render(w,O)},b=function(){requestAnimationFrame(b),lt.uniforms.time.value+=.05,pt.uniforms.time.value+=.05,i.value&&(R.rotation.y+=.05),s.value&&(R.rotation.y-=.07),o.value&&(R.rotation.x-=.05),r.value&&(R.rotation.x+=.05),I.render(w,O)};const w=new kn,O=new Ke(75,window.innerWidth/window.innerHeight,.1,1e3),I=new Hn({antialias:!0,alpha:!0});I.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(I.domElement);const R=new Xt,G=new hi(16777215,2);w.add(G);const tt=new ui(16777215,4);tt.position.set(5,5,5),w.add(tt);const M=new li(16777215,5,50);M.position.set(0,2,4),w.add(M);const U=new Yn().load("/3d-bear-arts/assets/cashwings.jpg"),$=new $a(256,{format:qn,generateMipmaps:!0,minFilter:Ci}),et=new Ya(1,1e3,$);new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.4,envMap:$.texture,envMapIntensity:1.5}),w.add(et),w.environment=$.texture,d();const at=new Tr,j=at.load(["/3d-bear-arts/assets/christmas_garden.jpg","/3d-bear-arts/assets/christmas_ground.jpg","/3d-bear-arts/assets/christmas_front.jpg","/3d-bear-arts/assets/christmas_house.jpg","/3d-bear-arts/assets/christmas_tree.jpg","/3d-bear-arts/assets/christmas_sky.jpg"]);at.load(["/3d-bear-arts/assets/cash2.jpg","/3d-bear-arts/assets/cash8.jpg","/3d-bear-arts/assets/cash1.jpg","/3d-bear-arts/assets/cash11.jpg","/3d-bear-arts/assets/cash4.jpg","/3d-bear-arts/assets/cash3.jpg"]),w.environment=j;const nt=at.load(["/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg"]);w.environment=nt;const W=new Ot({color:"white",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:j,reflectivity:1});new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:nt,reflectivity:1});const gt=new Ot({color:"sliver",map:U,metalness:.3,roughness:.5,transparent:!0,opacity:1}),xt=new Ot({color:"white",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.3,envMap:j,reflectivity:0}),wt=new Ot({color:"white",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.7,envMap:j,reflectivity:0}),Nt=new un({uniforms:{time:{value:0},color1:{value:new Me(16766720)},color2:{value:new Me(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,pt=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:kt,fragmentShader:rt,transparent:!1,depthWrite:!0}),Pt=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,lt=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:Pt,fragmentShader:B,transparent:!1,depthWrite:!0}),ot=new ut(1,32,32,0,Math.PI),ht=new _(ot,xt),yt=new _(ot,W);ht.scale.set(.85,.85,.8),yt.scale.set(.85,.85,.8),ht.position.y=-.2,yt.position.y=-.2,ht.rotation.y=Math.PI/2,yt.rotation.y=Math.PI*1.5;const it=new Ce(1,32),g=new _(it,W);g.scale.set(.85,.85,.8),g.position.set(0,-.2,0),g.rotation.y=Math.PI/2;const P=new Xt;P.add(ht),P.add(yt),P.add(g),R.add(P);const D=new ut(.6,32,32,0,Math.PI),F=new _(D,W);F.scale.set(1,.95,.95),F.position.set(0,1,0),F.rotation.y=Math.PI*1.5;const N=new _(D,wt);N.scale.set(1,.95,.95),N.position.set(0,1,0),N.rotation.y=Math.PI/2;const K=new Ce(.6,32),Z=new _(K,W);Z.position.set(0,1,0),Z.rotation.y=Math.PI/2,Z.scale.set(1,.95,.95);const S=new Xt;S.add(F),S.add(N),S.add(Z),R.add(S);const x=new ut(.25,32,32),C=new _(x,W);C.position.set(-.45,1.35,-.1),R.add(C);const Y=new _(x,wt);Y.position.set(.45,1.35,-.1),R.add(Y);const X=new ut(.25,32,32,Math.PI/2,Math.PI),q=new _(X,W);q.scale.set(1.1,.6,.8),q.position.set(0,.84,.5),q.rotation.y=Math.PI;const ft=new ut(.25,32,32,Math.PI/2,Math.PI),ct=new _(ft,wt);ct.scale.set(1.1,.6,.8),ct.position.set(0,.84,.5),ct.rotation.y=0;const vt=new Ce(.25,32),At=new _(vt,gt);At.scale.set(.8,.6,.8),At.position.set(0,.84,.5),At.rotation.y=Math.PI/2;const dt=new Xt;dt.add(q),dt.add(ct),dt.add(At),R.add(dt);const _t=new Sn;_t.moveTo(0,0),_t.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),_t.bezierCurveTo(-.6,.3,0,.6,0,1),_t.bezierCurveTo(0,.6,.6,.3,.6,0),_t.bezierCurveTo(.6,-.3,0,-.3,0,0);const Dt={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},Bt=new Dn(_t,Dt),It=new _(Bt,W);It.scale.set(.23,.23,.23),It.position.set(.25,1.2,0),It.rotation.y=Math.PI,It.rotation.x=Math.PI;const Kt=new ut(.35,32,32),Gt=new _(Kt,W);Gt.scale.set(.75,1.25,.65),Gt.position.set(-.7,-.15,.2),R.add(Gt);const Zt=new _(Kt,wt);Zt.scale.set(.75,1.25,.65),Zt.position.set(.7,-.15,.2),R.add(Zt);const H=new te(.2,.22,.6,32),Mt=new _(H,W);Mt.position.set(-.4,-1.05,0),R.add(Mt);const st=new _(H,wt);st.position.set(.4,-1.05,0),R.add(st);const Q=new ut(.3,32,32),St=new _(Q,W);St.scale.set(1,.72,1.5),St.position.set(-.4,-1.45,.17),R.add(St);const Et=new _(Q,wt);Et.scale.set(1,.72,1.5),Et.position.set(.4,-1.45,.17),R.add(Et);const Wt=new ut(.44,32,32),ne=new _(Wt,W);ne.position.set(-.15,-.45,-.4),R.add(ne);const ie=new _(Wt,wt);ie.position.set(.15,-.45,-.4),R.add(ie);const ce=new ut(.18,32,32),re=new _(ce,W);re.position.set(0,-.35,-.8),R.add(re),re.renderOrder=1,new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Ct){const Yt=new qe("X",{font:Ct,size:.18,depth:.05}),Ht=new _(Yt,W);Ht.position.set(-.3,.99,.53),Ht.rotation.x=ue.degToRad(-5),Ht.rotation.y=ue.degToRad(-15),R.add(Ht);const le=new qe("+",{font:Ct,size:.25,depth:.1}),Tt=new _(le,W);Tt.position.set(.13,.99,.53),Tt.rotation.y=ue.degToRad(12),Tt.rotation.x=ue.degToRad(-5),R.add(Tt)});const we=f(),ae=new Lt({map:we,metalness:.1,roughness:.8}),he=new Gn(.5,.1,24,100,Math.PI),pe=new _(he,ae);pe.position.set(0,.54,0),pe.rotation.x=Math.PI/2,pe.rotation.y=Math.PI/1,pe.rotation.z=Math.PI/-2,R.add(pe);const me=v();me.scale.set(.38,.38,.38),me.position.set(.3,-.45,0),R.add(me);const Ie=y();Ie.scale.set(.2,.2,.2),Ie.position.set(.5,-.3,.3),R.add(Ie);const xe=y();xe.scale.set(.12,.12,.12),xe.position.set(.2,-.3,.5),R.add(xe);let De=0,se=Math.PI,Ne=0,Ue=0,ke=1,bt=-1;const oe=m();oe.scale.set(.4,.4,.4),w.add(oe);const A=m();A.scale.set(.4,.4,.4),w.add(A),p();const V=new ut(.6,32,32,0,Math.PI*2,0,Math.PI/2),L=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.5,clearcoatRoughness:.7,transparent:!1,opacity:.85}),k=new _(V,L);k.position.set(0,-.2,0),k.rotation.x=Math.PI,k.scale.set(1.25,1.25,1.25),P.add(k);const z=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.6,clearcoatRoughness:.8,side:Ae,transparent:!1,opacity:.8}),mt=new _(it,z);mt.scale.set(.7,.7,.7),mt.position.set(0,-.3,0),mt.rotation.x=Math.PI/2,mt.renderOrder=1,P.add(mt),R.add(P);const Rt=new un({transparent:!0,uniforms:{u_time:{value:0}},vertexShader:`
        precision mediump float;
        varying vec2 vUv;
        void main() {
            vUv = uv;
    ...
    `}),Ut=new _(it,Rt);Ut.position.set(0,-.2,0),Ut.scale.set(.7,.7,.7),Ut.rotation.x=-Math.PI/2,Ut.renderOrder=2,P.add(Ut);const Ft=1e3,jt=new En,qt=[];for(let Ct=0;Ct<Ft;Ct++){const Yt=(Math.random()-.5)*20,Ht=Math.random()*20,le=(Math.random()-.5)*20;qt.push(Yt,Ht,le)}jt.setAttribute("position",new on(qt,3));const Vt=new vr({color:16777215,size:.1,transparent:!0,opacity:.8}),ee=new sr(jt,Vt);R.add(ee),E(),R.scale.set(1.2,1.2,1.2),w.add(R),R.scale.set(1.4,1.4,1.4),w.add(R),R.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),O.position.set(t.bodyPosition.x,1.4,t.cameraPosition),O.lookAt(t.bodyPosition.x,0,0),O.position.z=4;let ge=$t(!1);const de=Ct=>{if(ge.value){const Yt={x:Ct.clientX/window.innerWidth*2-1,y:-(Ct.clientY/window.innerHeight)*2+1},Ht=Yt.x*Math.PI*.2,le=Yt.y*Math.PI*.2;R.rotation.y=Ht,R.rotation.x=le}};window.addEventListener("mousemove",de),Nt.uniforms.time.value+=.04,b(),je(()=>t.bodyPosition,Ct=>{R.position.set(Ct.x,Ct.y,Ct.z)}),je(()=>t.cameraPosition,Ct=>{O.position.set(t.bodyPosition.x,1,Ct),O.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{O.aspect=window.innerWidth/window.innerHeight,O.updateProjectionMatrix(),I.setSize(window.innerWidth,window.innerHeight)})}});let i=$t(!1),s=$t(!1),o=$t(!1),r=$t(!1);function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let d=0;d<Ab;d++){const f=document.createElement("div");f.classList.add("confetti"),f.style.left=`${Math.random()*100}vw`,f.style.animationDuration=`${Math.random()*3+4}s`,f.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(f)}for(let d=0;d<Pb;d++){const f=document.createElement("div");f.classList.add("light"),document.body.appendChild(f)}return(d,f)=>(Xn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:Vn(n.background?"no-bg":"three-canvas")},null,2),zt("div",Eb,[zt("button",{class:"pixel-btn up border-gold",onMousedown:l,onMouseup:u},"▲",32),zt("div",Tb,[zt("button",{class:"pixel-btn left border-silver",onMousedown:a,onMouseup:u},"◀",32),zt("button",{class:"pixel-btn right border-silver",onMousedown:c,onMouseup:u},"▶",32)]),zt("button",{class:"pixel-btn down border-gold",onMousedown:h,onMouseup:u},"▼",32)])],64))}}),Cb=Kn(Rb,[["__scopeId","data-v-4439572d"]]),Ib=[{path:"/3d-bear-arts/leather",name:"Leather",component:bS},{path:"/3d-bear-arts/pop-art",name:"Pop",component:TS},{path:"/3d-bear-arts/pop-art-bear-3",name:"PopArtBear 3",component:CS},{path:"/3d-bear-arts/machine",name:"MetalMachineBear",component:US},{path:"/3d-bear-arts/water",name:"Water",component:WS},{path:"/3d-bear-arts/ghost-bear",name:"GhostBear",component:YS},{path:"/3d-bear-arts/white-ghost-bear",name:"GhostBallonBear",component:JS},{path:"/3d-bear-arts/santa",name:"Santa",component:sb},{path:"/3d-bear-arts/coffee",name:"Coffee",component:ub},{path:"/3d-bear-arts/bears",name:"Bears",component:_b},{path:"/3d-bear-arts/money",name:"Money",component:bb},{path:"/3d-bear-arts/",name:"Snowman",component:Cb}],Lb=_v({history:Yg(),routes:Ib}),Hp=dg(vg);Hp.use(Lb);Hp.mount("#app");
