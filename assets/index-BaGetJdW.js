...
`)+`
`+p);const S=T+m+r,b=T+p+a,B=vd(s,s.VERTEX_SHADER,S),I=vd(s,s.FRAGMENT_SHADER,b);s.attachShader(y,B),s.attachShader(y,I),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function R(E){if(n.debug.checkShaderErrors){const U=s.getProgramInfoLog(y).trim(),$=s.getShaderInfoLog(B).trim(),Z=s.getShaderInfoLog(I).trim();let ct=!0,j=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(ct=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,y,B,I);else{const st=_d(s,B,"vertex"),k=_d(s,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
}`;function x1(n,t,e){let i=new Iu;const s=new Jt,o=new Jt,r=new We,a=new m1({depthPacking:Jv}),c=new g1,l={},h=e.maxTextureSize,u={[_s]:jn,[jn]:_s,[Ae]:Ae},d=new un({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Jt},radius:{value:4}},vertexShader:v1,fragmentShader:_1}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const v=new En;v.setAttribute("position",new Li(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new _(v,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Jf;let p=this.type;this.render=function(I,R,z){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||I.length===0)return;const tt=n.getRenderTarget(),M=n.getActiveCubeFace(),E=n.getActiveMipmapLevel(),U=n.state;U.setBlending(ms),U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const $=p!==ji&&this.type===ji,Z=p===ji&&this.type!==ji;for(let ct=0,j=I.length;ct<j;ct++){const st=I[ct],k=st.shadow;if(k===void 0){console.warn("THREE.WebGLShadowMap:",st,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;s.copy(k.mapSize);const xt=k.getFrameExtents();if(s.multiply(xt),o.copy(k.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(o.x=Math.floor(h/xt.x),s.x=o.x*xt.x,k.mapSize.x=o.x),s.y>h&&(o.y=Math.floor(h/xt.y),s.y=o.y*xt.y,k.mapSize.y=o.y)),k.map===null||$===!0||Z===!0){const gt=this.type!==ji?{minFilter:ri,magFilter:ri}:{};k.map!==null&&k.map.dispose(),k.map=new Gs(s.x,s.y,gt),k.map.texture.name=st.name+".shadowMap",k.camera.updateProjectionMatrix()}n.setRenderTarget(k.map),n.clear();const Mt=k.getViewportCount();for(let gt=0;gt<Mt;gt++){const Nt=k.getViewport(gt);r.set(o.x*Nt.x,o.y*Nt.y,o.x*Nt.z,o.y*Nt.w),U.viewport(r),k.updateMatrices(st,gt),i=k.getFrustum(),b(R,z,k.camera,st,this.type)}k.isPointLightShadow!==!0&&this.type===ji&&T(k,z),k.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(tt,M,E)};function T(I,R){const z=t.update(y);d.defines.VSM_SAMPLES!==I.blurSamples&&(d.defines.VSM_SAMPLES=I.blurSamples,f.defines.VSM_SAMPLES=I.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new Gs(s.x,s.y)),d.uniforms.shadow_pass.value=I.map.texture,d.uniforms.resolution.value=I.mapSize,d.uniforms.radius.value=I.radius,n.setRenderTarget(I.mapPass),n.clear(),n.renderBufferDirect(R,null,z,d,y,null),f.uniforms.shadow_pass.value=I.mapPass.texture,f.uniforms.resolution.value=I.mapSize,f.uniforms.radius.value=I.radius,n.setRenderTarget(I.map),n.clear(),n.renderBufferDirect(R,null,z,f,y,null)}function S(I,R,z,tt){let M=null;const E=z.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(E!==void 0)M=E;else if(M=z.isPointLight===!0?c:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const U=M.uuid,$=R.uuid;let Z=l[U];Z===void 0&&(Z={},l[U]=Z);let ct=Z[$];ct===void 0&&(ct=M.clone(),Z[$]=ct,R.addEventListener("dispose",B)),M=ct}if(M.visible=R.visible,M.wireframe=R.wireframe,tt===ji?M.side=R.shadowSide!==null?R.shadowSide:R.side:M.side=R.shadowSide!==null?R.shadowSide:u[R.side],M.alphaMap=R.alphaMap,M.alphaTest=R.alphaTest,M.map=R.map,M.clipShadows=R.clipShadows,M.clippingPlanes=R.clippingPlanes,M.clipIntersection=R.clipIntersection,M.displacementMap=R.displacementMap,M.displacementScale=R.displacementScale,M.displacementBias=R.displacementBias,M.wireframeLinewidth=R.wireframeLinewidth,M.linewidth=R.linewidth,z.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const U=n.properties.get(M);U.light=z}return M}function b(I,R,z,tt,M){if(I.visible===!1)return;if(I.layers.test(R.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&M===ji)&&(!I.frustumCulled||i.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,I.matrixWorld);const $=t.update(I),Z=I.material;if(Array.isArray(Z)){const ct=$.groups;for(let j=0,st=ct.length;j<st;j++){const k=ct[j],xt=Z[k.materialIndex];if(xt&&xt.visible){const Mt=S(I,xt,tt,M);I.onBeforeShadow(n,I,R,z,$,Mt,k),n.renderBufferDirect(z,null,$,Mt,I,k),I.onAfterShadow(n,I,R,z,$,Mt,k)}}}else if(Z.visible){const ct=S(I,Z,tt,M);I.onBeforeShadow(n,I,R,z,$,ct,null),n.renderBufferDirect(z,null,$,ct,I,null),I.onAfterShadow(n,I,R,z,$,ct,null)}}const U=I.children;for(let $=0,Z=U.length;$<Z;$++)b(U[$],R,z,tt,M)}function B(I){I.target.removeEventListener("dispose",B);for(const z in l){const tt=l[z],M=I.target.uuid;M in tt&&(tt[M].dispose(),delete tt[M])}}}const y1={[ul]:hl,[dl]:ml,[fl]:gl,[Eo]:pl,[hl]:ul,[ml]:dl,[gl]:fl,[pl]:Eo};function M1(n){function t(){let H=!1;const yt=new We;let it=null;const et=new We(0,0,0,0);return{setMask:function(St){it!==St&&!H&&(n.colorMask(St,St,St,St),it=St)},setLocked:function(St){H=St},setClear:function(St,Et,Vt,te,se){se===!0&&(St*=te,Et*=te,Vt*=te),yt.set(St,Et,Vt,te),et.equals(yt)===!1&&(n.clearColor(St,Et,Vt,te),et.copy(yt))},reset:function(){H=!1,it=null,et.set(-1,0,0,0)}}}function e(){let H=!1,yt=!1,it=null,et=null,St=null;return{setReversed:function(Et){yt=Et},setTest:function(Et){Et?wt(n.DEPTH_TEST):O(n.DEPTH_TEST)},setMask:function(Et){it!==Et&&!H&&(n.depthMask(Et),it=Et)},setFunc:function(Et){if(yt&&(Et=y1[Et]),et!==Et){switch(Et){case ul:n.depthFunc(n.NEVER);break;case hl:n.depthFunc(n.ALWAYS);break;case dl:n.depthFunc(n.LESS);break;case Eo:n.depthFunc(n.LEQUAL);break;case fl:n.depthFunc(n.EQUAL);break;case pl:n.depthFunc(n.GEQUAL);break;case ml:n.depthFunc(n.GREATER);break;case gl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}et=Et}},setLocked:function(Et){H=Et},setClear:function(Et){St!==Et&&(n.clearDepth(Et),St=Et)},reset:function(){H=!1,it=null,et=null,St=null}}}function i(){let H=!1,yt=null,it=null,et=null,St=null,Et=null,Vt=null,te=null,se=null;return{setTest:function(ie){H||(ie?wt(n.STENCIL_TEST):O(n.STENCIL_TEST))},setMask:function(ie){yt!==ie&&!H&&(n.stencilMask(ie),yt=ie)},setFunc:function(ie,re,ce){(it!==ie||et!==re||St!==ce)&&(n.stencilFunc(ie,re,ce),it=ie,et=re,St=ce)},setOp:function(ie,re,ce){(Et!==ie||Vt!==re||te!==ce)&&(n.stencilOp(ie,re,ce),Et=ie,Vt=re,te=ce)},setLocked:function(ie){H=ie},setClear:function(ie){se!==ie&&(n.clearStencil(ie),se=ie)},reset:function(){H=!1,yt=null,it=null,et=null,St=null,Et=null,Vt=null,te=null,se=null}}}const s=new t,o=new e,r=new i,a=new WeakMap,c=new WeakMap;let l={},h={},u=new WeakMap,d=[],f=null,v=!1,y=null,m=null,p=null,T=null,S=null,b=null,B=null,I=new xe(0,0,0),R=0,z=!1,tt=null,M=null,E=null,U=null,$=null;const Z=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ct=!1,j=0;const st=n.getParameter(n.VERSION);st.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(st)[1]),ct=j>=1):st.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(st)[1]),ct=j>=2);let k=null,xt={};const Mt=n.getParameter(n.SCISSOR_BOX),gt=n.getParameter(n.VIEWPORT),Nt=new We().fromArray(Mt),Wt=new We().fromArray(gt);function rt(H,yt,it,et){const St=new Uint8Array(4),Et=n.createTexture();n.bindTexture(H,Et),n.texParameteri(H,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(H,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Vt=0;Vt<it;Vt++)H===n.TEXTURE_3D||H===n.TEXTURE_2D_ARRAY?n.texImage3D(yt,0,n.RGBA,1,1,et,0,n.RGBA,n.UNSIGNED_BYTE,St):n.texImage2D(yt+Vt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,St);return Et}const pt={};pt[n.TEXTURE_2D]=rt(n.TEXTURE_2D,n.TEXTURE_2D,1),pt[n.TEXTURE_CUBE_MAP]=rt(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),pt[n.TEXTURE_2D_ARRAY]=rt(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),pt[n.TEXTURE_3D]=rt(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),r.setClear(0),wt(n.DEPTH_TEST),o.setFunc(Eo),L(!1),F(Lh),wt(n.CULL_FACE),g(ms);function wt(H){l[H]!==!0&&(n.enable(H),l[H]=!0)}function O(H){l[H]!==!1&&(n.disable(H),l[H]=!1)}function ht(H,yt){return h[H]!==yt?(n.bindFramebuffer(H,yt),h[H]=yt,H===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=yt),H===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=yt),!0):!1}function ot(H,yt){let it=d,et=!1;if(H){it=u.get(yt),it===void 0&&(it=[],u.set(yt,it));const St=H.textures;if(it.length!==St.length||it[0]!==n.COLOR_ATTACHMENT0){for(let Et=0,Vt=St.length;Et<Vt;Et++)it[Et]=n.COLOR_ATTACHMENT0+Et;it.length=St.length,et=!0}}else it[0]!==n.BACK&&(it[0]=n.BACK,et=!0);et&&n.drawBuffers(it)}function lt(H){return f!==H?(n.useProgram(H),f=H,!0):!1}const bt={[Ds]:n.FUNC_ADD,[bv]:n.FUNC_SUBTRACT,[Ev]:n.FUNC_REVERSE_SUBTRACT};bt[Tv]=n.MIN,bt[Av]=n.MAX;const nt={[Pv]:n.ZERO,[Rv]:n.ONE,[Cv]:n.SRC_COLOR,[cl]:n.SRC_ALPHA,[Fv]:n.SRC_ALPHA_SATURATE,[Uv]:n.DST_COLOR,[Lv]:n.DST_ALPHA,[Iv]:n.ONE_MINUS_SRC_COLOR,[ll]:n.ONE_MINUS_SRC_ALPHA,[Nv]:n.ONE_MINUS_DST_COLOR,[Dv]:n.ONE_MINUS_DST_ALPHA,[Ov]:n.CONSTANT_COLOR,[Bv]:n.ONE_MINUS_CONSTANT_COLOR,[zv]:n.CONSTANT_ALPHA,[Gv]:n.ONE_MINUS_CONSTANT_ALPHA};function g(H,yt,it,et,St,Et,Vt,te,se,ie){if(H===ms){v===!0&&(O(n.BLEND),v=!1);return}if(v===!1&&(wt(n.BLEND),v=!0),H!==Sv){if(H!==y||ie!==z){if((m!==Ds||S!==Ds)&&(n.blendEquation(n.FUNC_ADD),m=Ds,S=Ds),ie)switch(H){case _o:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Dh:n.blendFunc(n.ONE,n.ONE);break;case Uh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nh:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}else switch(H){case _o:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Dh:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Uh:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Nh:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}p=null,T=null,b=null,B=null,I.set(0,0,0),R=0,y=H,z=ie}return}St=St||yt,Et=Et||it,Vt=Vt||et,(yt!==m||St!==S)&&(n.blendEquationSeparate(bt[yt],bt[St]),m=yt,S=St),(it!==p||et!==T||Et!==b||Vt!==B)&&(n.blendFuncSeparate(nt[it],nt[et],nt[Et],nt[Vt]),p=it,T=et,b=Et,B=Vt),(te.equals(I)===!1||se!==R)&&(n.blendColor(te.r,te.g,te.b,se),I.copy(te),R=se),y=H,z=!1}function P(H,yt){H.side===Ae?O(n.CULL_FACE):wt(n.CULL_FACE);let it=H.side===jn;yt&&(it=!it),L(it),H.blending===_o&&H.transparent===!1?g(ms):g(H.blending,H.blendEquation,H.blendSrc,H.blendDst,H.blendEquationAlpha,H.blendSrcAlpha,H.blendDstAlpha,H.blendColor,H.blendAlpha,H.premultipliedAlpha),o.setFunc(H.depthFunc),o.setTest(H.depthTest),o.setMask(H.depthWrite),s.setMask(H.colorWrite);const et=H.stencilWrite;r.setTest(et),et&&(r.setMask(H.stencilWriteMask),r.setFunc(H.stencilFunc,H.stencilRef,H.stencilFuncMask),r.setOp(H.stencilFail,H.stencilZFail,H.stencilZPass)),K(H.polygonOffset,H.polygonOffsetFactor,H.polygonOffsetUnits),H.alphaToCoverage===!0?wt(n.SAMPLE_ALPHA_TO_COVERAGE):O(n.SAMPLE_ALPHA_TO_COVERAGE)}function L(H){tt!==H&&(H?n.frontFace(n.CW):n.frontFace(n.CCW),tt=H)}function F(H){H!==yv?(wt(n.CULL_FACE),H!==M&&(H===Lh?n.cullFace(n.BACK):H===Mv?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):O(n.CULL_FACE),M=H}function N(H){H!==E&&(ct&&n.lineWidth(H),E=H)}function K(H,yt,it){H?(wt(n.POLYGON_OFFSET_FILL),(U!==yt||$!==it)&&(n.polygonOffset(yt,it),U=yt,$=it)):O(n.POLYGON_OFFSET_FILL)}function J(H){H?wt(n.SCISSOR_TEST):O(n.SCISSOR_TEST)}function w(H){H===void 0&&(H=n.TEXTURE0+Z-1),k!==H&&(n.activeTexture(H),k=H)}function x(H,yt,it){it===void 0&&(k===null?it=n.TEXTURE0+Z-1:it=k);let et=xt[it];et===void 0&&(et={type:void 0,texture:void 0},xt[it]=et),(et.type!==H||et.texture!==yt)&&(k!==it&&(n.activeTexture(it),k=it),n.bindTexture(H,yt||pt[H]),et.type=H,et.texture=yt)}function C(){const H=xt[k];H!==void 0&&H.type!==void 0&&(n.bindTexture(H.type,null),H.type=void 0,H.texture=void 0)}function Y(){try{n.compressedTexImage2D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function V(){try{n.compressedTexImage3D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function X(){try{n.texSubImage2D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ut(){try{n.texSubImage3D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function at(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function vt(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function At(){try{n.texStorage2D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ft(){try{n.texStorage3D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function _t(){try{n.texImage2D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Dt(){try{n.texImage3D.apply(n,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Ft(H){Nt.equals(H)===!1&&(n.scissor(H.x,H.y,H.z,H.w),Nt.copy(H))}function Rt(H){Wt.equals(H)===!1&&(n.viewport(H.x,H.y,H.z,H.w),Wt.copy(H))}function Qt(H,yt){let it=c.get(yt);it===void 0&&(it=new WeakMap,c.set(yt,it));let et=it.get(H);et===void 0&&(et=n.getUniformBlockIndex(yt,H.name),it.set(H,et))}function Bt(H,yt){const et=c.get(yt).get(H);a.get(yt)!==et&&(n.uniformBlockBinding(yt,et,H.__bindingPointIndex),a.set(yt,et))}function Yt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),l={},k=null,xt={},h={},u=new WeakMap,d=[],f=null,v=!1,y=null,m=null,p=null,T=null,S=null,b=null,B=null,I=new xe(0,0,0),R=0,z=!1,tt=null,M=null,E=null,U=null,$=null,Nt.set(0,0,n.canvas.width,n.canvas.height),Wt.set(0,0,n.canvas.width,n.canvas.height),s.reset(),o.reset(),r.reset()}return{buffers:{color:s,depth:o,stencil:r},enable:wt,disable:O,bindFramebuffer:ht,drawBuffers:ot,useProgram:lt,setBlending:g,setMaterial:P,setFlipSided:L,setCullFace:F,setLineWidth:N,setPolygonOffset:K,setScissorTest:J,activeTexture:w,bindTexture:x,unbindTexture:C,compressedTexImage2D:Y,compressedTexImage3D:V,texImage2D:_t,texImage3D:Dt,updateUBOMapping:Qt,uniformBlockBinding:Bt,texStorage2D:At,texStorage3D:ft,texSubImage2D:X,texSubImage3D:ut,compressedTexSubImage2D:at,compressedTexSubImage3D:vt,scissor:Ft,viewport:Rt,reset:Yt}}function Td(n,t,e,i){const s=w1(i);switch(e){case sp:return n*t;case rp:return n*t;case ap:return n*t*2;case cp:return n*t/s.components*s.byteLength;case Eu:return n*t/s.components*s.byteLength;case lp:return n*t*2/s.components*s.byteLength;case Tu:return n*t*2/s.components*s.byteLength;case op:return n*t*3/s.components*s.byteLength;case Xn:return n*t*4/s.components*s.byteLength;case Au:return n*t*4/s.components*s.byteLength;case fa:case pa:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*8;case ma:case ga:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case yl:case wl:return Math.max(n,16)*Math.max(t,8)/4;case xl:case Ml:return Math.max(n,8)*Math.max(t,8)/2;case Sl:case bl:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*8;case El:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case Tl:return Math.floor((n+3)/4)*Math.floor((t+3)/4)*16;case Al:return Math.floor((n+4)/5)*Math.floor((t+3)/4)*16;case Pl:return Math.floor((n+4)/5)*Math.floor((t+4)/5)*16;case Rl:return Math.floor((n+5)/6)*Math.floor((t+4)/5)*16;case Cl:return Math.floor((n+5)/6)*Math.floor((t+5)/6)*16;case Il:return Math.floor((n+7)/8)*Math.floor((t+4)/5)*16;case Ll:return Math.floor((n+7)/8)*Math.floor((t+5)/6)*16;case Dl:return Math.floor((n+7)/8)*Math.floor((t+7)/8)*16;case Ul:return Math.floor((n+9)/10)*Math.floor((t+4)/5)*16;case Nl:return Math.floor((n+9)/10)*Math.floor((t+5)/6)*16;case Fl:return Math.floor((n+9)/10)*Math.floor((t+7)/8)*16;case Ol:return Math.floor((n+9)/10)*Math.floor((t+9)/10)*16;case Bl:return Math.floor((n+11)/12)*Math.floor((t+9)/10)*16;case zl:return Math.floor((n+11)/12)*Math.floor((t+11)/12)*16;case va:case Gl:case Hl:return Math.ceil(n/4)*Math.ceil(t/4)*16;case up:case kl:return Math.ceil(n/4)*Math.ceil(t/4)*8;case Vl:case Wl:return Math.ceil(n/4)*Math.ceil(t/4)*16}throw new Error(`Unable to determine texture byte length for ${e} format.`)}function w1(n){switch(n){case ts:case ep:return{byteLength:1,components:1};case pr:case np:case Sr:return{byteLength:2,components:1};case Su:case bu:return{byteLength:2,components:4};case zs:case wu:case Ki:return{byteLength:4,components:1};case ip:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function S1(n,t,e,i,s,o,r){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Jt,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(w,x){return f?new OffscreenCanvas(w,x):gr("canvas")}function y(w,x,C){let Y=1;const V=J(w);if((V.width>C||V.height>C)&&(Y=C/Math.max(V.width,V.height)),Y<1)if(typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&w instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&w instanceof ImageBitmap||typeof VideoFrame<"u"&&w instanceof VideoFrame){const X=Math.floor(Y*V.width),ut=Math.floor(Y*V.height);u===void 0&&(u=v(X,ut));const at=x?v(X,ut):u;return at.width=X,at.height=ut,at.getContext("2d").drawImage(w,0,0,X,ut),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+V.width+"x"+V.height+") to ("+X+"x"+ut+")."),at}else return"data"in w&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+V.width+"x"+V.height+")."),w;return w}function m(w){return w.generateMipmaps&&w.minFilter!==ri&&w.minFilter!==xi}function p(w){n.generateMipmap(w)}function T(w,x,C,Y,V=!1){if(w!==null){if(n[w]!==void 0)return n[w];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+w+"'")}let X=x;if(x===n.RED&&(C===n.FLOAT&&(X=n.R32F),C===n.HALF_FLOAT&&(X=n.R16F),C===n.UNSIGNED_BYTE&&(X=n.R8)),x===n.RED_INTEGER&&(C===n.UNSIGNED_BYTE&&(X=n.R8UI),C===n.UNSIGNED_SHORT&&(X=n.R16UI),C===n.UNSIGNED_INT&&(X=n.R32UI),C===n.BYTE&&(X=n.R8I),C===n.SHORT&&(X=n.R16I),C===n.INT&&(X=n.R32I)),x===n.RG&&(C===n.FLOAT&&(X=n.RG32F),C===n.HALF_FLOAT&&(X=n.RG16F),C===n.UNSIGNED_BYTE&&(X=n.RG8)),x===n.RG_INTEGER&&(C===n.UNSIGNED_BYTE&&(X=n.RG8UI),C===n.UNSIGNED_SHORT&&(X=n.RG16UI),C===n.UNSIGNED_INT&&(X=n.RG32UI),C===n.BYTE&&(X=n.RG8I),C===n.SHORT&&(X=n.RG16I),C===n.INT&&(X=n.RG32I)),x===n.RGB_INTEGER&&(C===n.UNSIGNED_BYTE&&(X=n.RGB8UI),C===n.UNSIGNED_SHORT&&(X=n.RGB16UI),C===n.UNSIGNED_INT&&(X=n.RGB32UI),C===n.BYTE&&(X=n.RGB8I),C===n.SHORT&&(X=n.RGB16I),C===n.INT&&(X=n.RGB32I)),x===n.RGBA_INTEGER&&(C===n.UNSIGNED_BYTE&&(X=n.RGBA8UI),C===n.UNSIGNED_SHORT&&(X=n.RGBA16UI),C===n.UNSIGNED_INT&&(X=n.RGBA32UI),C===n.BYTE&&(X=n.RGBA8I),C===n.SHORT&&(X=n.RGBA16I),C===n.INT&&(X=n.RGBA32I)),x===n.RGB&&C===n.UNSIGNED_INT_5_9_9_9_REV&&(X=n.RGB9_E5),x===n.RGBA){const ut=V?Aa:Fe.getTransfer(Y);C===n.FLOAT&&(X=n.RGBA32F),C===n.HALF_FLOAT&&(X=n.RGBA16F),C===n.UNSIGNED_BYTE&&(X=ut===en?n.SRGB8_ALPHA8:n.RGBA8),C===n.UNSIGNED_SHORT_4_4_4_4&&(X=n.RGBA4),C===n.UNSIGNED_SHORT_5_5_5_1&&(X=n.RGB5_A1)}return(X===n.R16F||X===n.R32F||X===n.RG16F||X===n.RG32F||X===n.RGBA16F||X===n.RGBA32F)&&t.get("EXT_color_buffer_float"),X}function S(w,x){let C;return w?x===null||x===zs||x===Po?C=n.DEPTH24_STENCIL8:x===Ki?C=n.DEPTH32F_STENCIL8:x===pr&&(C=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===zs||x===Po?C=n.DEPTH_COMPONENT24:x===Ki?C=n.DEPTH_COMPONENT32F:x===pr&&(C=n.DEPTH_COMPONENT16),C}function b(w,x){return m(w)===!0||w.isFramebufferTexture&&w.minFilter!==ri&&w.minFilter!==xi?Math.log2(Math.max(x.width,x.height))+1:w.mipmaps!==void 0&&w.mipmaps.length>0?w.mipmaps.length:w.isCompressedTexture&&Array.isArray(w.image)?x.mipmaps.length:1}function B(w){const x=w.target;x.removeEventListener("dispose",B),R(x),x.isVideoTexture&&h.delete(x)}function I(w){const x=w.target;x.removeEventListener("dispose",I),tt(x)}function R(w){const x=i.get(w);if(x.__webglInit===void 0)return;const C=w.source,Y=d.get(C);if(Y){const V=Y[x.__cacheKey];V.usedTimes--,V.usedTimes===0&&z(w),Object.keys(Y).length===0&&d.delete(C)}i.remove(w)}function z(w){const x=i.get(w);n.deleteTexture(x.__webglTexture);const C=w.source,Y=d.get(C);delete Y[x.__cacheKey],r.memory.textures--}function tt(w){const x=i.get(w);if(w.depthTexture&&w.depthTexture.dispose(),w.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(x.__webglFramebuffer[Y]))for(let V=0;V<x.__webglFramebuffer[Y].length;V++)n.deleteFramebuffer(x.__webglFramebuffer[Y][V]);else n.deleteFramebuffer(x.__webglFramebuffer[Y]);x.__webglDepthbuffer&&n.deleteRenderbuffer(x.__webglDepthbuffer[Y])}else{if(Array.isArray(x.__webglFramebuffer))for(let Y=0;Y<x.__webglFramebuffer.length;Y++)n.deleteFramebuffer(x.__webglFramebuffer[Y]);else n.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&n.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&n.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let Y=0;Y<x.__webglColorRenderbuffer.length;Y++)x.__webglColorRenderbuffer[Y]&&n.deleteRenderbuffer(x.__webglColorRenderbuffer[Y]);x.__webglDepthRenderbuffer&&n.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const C=w.textures;for(let Y=0,V=C.length;Y<V;Y++){const X=i.get(C[Y]);X.__webglTexture&&(n.deleteTexture(X.__webglTexture),r.memory.textures--),i.remove(C[Y])}i.remove(w)}let M=0;function E(){M=0}function U(){const w=M;return w>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+w+" texture units while this GPU supports only "+s.maxTextures),M+=1,w}function $(w){const x=[];return x.push(w.wrapS),x.push(w.wrapT),x.push(w.wrapR||0),x.push(w.magFilter),x.push(w.minFilter),x.push(w.anisotropy),x.push(w.internalFormat),x.push(w.format),x.push(w.type),x.push(w.generateMipmaps),x.push(w.premultiplyAlpha),x.push(w.flipY),x.push(w.unpackAlignment),x.push(w.colorSpace),x.join()}function Z(w,x){const C=i.get(w);if(w.isVideoTexture&&N(w),w.isRenderTargetTexture===!1&&w.version>0&&C.__version!==w.version){const Y=w.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Wt(C,w,x);return}}e.bindTexture(n.TEXTURE_2D,C.__webglTexture,n.TEXTURE0+x)}function ct(w,x){const C=i.get(w);if(w.version>0&&C.__version!==w.version){Wt(C,w,x);return}e.bindTexture(n.TEXTURE_2D_ARRAY,C.__webglTexture,n.TEXTURE0+x)}function j(w,x){const C=i.get(w);if(w.version>0&&C.__version!==w.version){Wt(C,w,x);return}e.bindTexture(n.TEXTURE_3D,C.__webglTexture,n.TEXTURE0+x)}function st(w,x){const C=i.get(w);if(w.version>0&&C.__version!==w.version){rt(C,w,x);return}e.bindTexture(n.TEXTURE_CUBE_MAP,C.__webglTexture,n.TEXTURE0+x)}const k={[Je]:n.REPEAT,[Ns]:n.CLAMP_TO_EDGE,[_l]:n.MIRRORED_REPEAT},xt={[ri]:n.NEAREST,[Kv]:n.NEAREST_MIPMAP_NEAREST,[Nr]:n.NEAREST_MIPMAP_LINEAR,[xi]:n.LINEAR,[pc]:n.LINEAR_MIPMAP_NEAREST,[Ci]:n.LINEAR_MIPMAP_LINEAR},Mt={[t_]:n.NEVER,[r_]:n.ALWAYS,[e_]:n.LESS,[dp]:n.LEQUAL,[n_]:n.EQUAL,[o_]:n.GEQUAL,[i_]:n.GREATER,[s_]:n.NOTEQUAL};function gt(w,x){if(x.type===Ki&&t.has("OES_texture_float_linear")===!1&&(x.magFilter===xi||x.magFilter===pc||x.magFilter===Nr||x.magFilter===Ci||x.minFilter===xi||x.minFilter===pc||x.minFilter===Nr||x.minFilter===Ci)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(w,n.TEXTURE_WRAP_S,k[x.wrapS]),n.texParameteri(w,n.TEXTURE_WRAP_T,k[x.wrapT]),(w===n.TEXTURE_3D||w===n.TEXTURE_2D_ARRAY)&&n.texParameteri(w,n.TEXTURE_WRAP_R,k[x.wrapR]),n.texParameteri(w,n.TEXTURE_MAG_FILTER,xt[x.magFilter]),n.texParameteri(w,n.TEXTURE_MIN_FILTER,xt[x.minFilter]),x.compareFunction&&(n.texParameteri(w,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(w,n.TEXTURE_COMPARE_FUNC,Mt[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===ri||x.minFilter!==Nr&&x.minFilter!==Ci||x.type===Ki&&t.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||i.get(x).__currentAnisotropy){const C=t.get("EXT_texture_filter_anisotropic");n.texParameterf(w,C.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy}}}function Nt(w,x){let C=!1;w.__webglInit===void 0&&(w.__webglInit=!0,x.addEventListener("dispose",B));const Y=x.source;let V=d.get(Y);V===void 0&&(V={},d.set(Y,V));const X=$(x);if(X!==w.__cacheKey){V[X]===void 0&&(V[X]={texture:n.createTexture(),usedTimes:0},r.memory.textures++,C=!0),V[X].usedTimes++;const ut=V[w.__cacheKey];ut!==void 0&&(V[w.__cacheKey].usedTimes--,ut.usedTimes===0&&z(x)),w.__cacheKey=X,w.__webglTexture=V[X].texture}return C}function Wt(w,x,C){let Y=n.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(Y=n.TEXTURE_2D_ARRAY),x.isData3DTexture&&(Y=n.TEXTURE_3D);const V=Nt(w,x),X=x.source;e.bindTexture(Y,w.__webglTexture,n.TEXTURE0+C);const ut=i.get(X);if(X.version!==ut.__version||V===!0){e.activeTexture(n.TEXTURE0+C);const at=Fe.getPrimaries(Fe.workingColorSpace),vt=x.colorSpace===ps?null:Fe.getPrimaries(x.colorSpace),At=x.colorSpace===ps||at===vt?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,At);let ft=y(x.image,!1,s.maxTextureSize);ft=K(x,ft);const _t=o.convert(x.format,x.colorSpace),Dt=o.convert(x.type);let Ft=T(x.internalFormat,_t,Dt,x.colorSpace,x.isVideoTexture);gt(Y,x);let Rt;const Qt=x.mipmaps,Bt=x.isVideoTexture!==!0,Yt=ut.__version===void 0||V===!0,H=X.dataReady,yt=b(x,ft);if(x.isDepthTexture)Ft=S(x.format===Ro,x.type),Yt&&(Bt?e.texStorage2D(n.TEXTURE_2D,1,Ft,ft.width,ft.height):e.texImage2D(n.TEXTURE_2D,0,Ft,ft.width,ft.height,0,_t,Dt,null));else if(x.isDataTexture)if(Qt.length>0){Bt&&Yt&&e.texStorage2D(n.TEXTURE_2D,yt,Ft,Qt[0].width,Qt[0].height);for(let it=0,et=Qt.length;it<et;it++)Rt=Qt[it],Bt?H&&e.texSubImage2D(n.TEXTURE_2D,it,0,0,Rt.width,Rt.height,_t,Dt,Rt.data):e.texImage2D(n.TEXTURE_2D,it,Ft,Rt.width,Rt.height,0,_t,Dt,Rt.data);x.generateMipmaps=!1}else Bt?(Yt&&e.texStorage2D(n.TEXTURE_2D,yt,Ft,ft.width,ft.height),H&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,ft.width,ft.height,_t,Dt,ft.data)):e.texImage2D(n.TEXTURE_2D,0,Ft,ft.width,ft.height,0,_t,Dt,ft.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Bt&&Yt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,yt,Ft,Qt[0].width,Qt[0].height,ft.depth);for(let it=0,et=Qt.length;it<et;it++)if(Rt=Qt[it],x.format!==Xn)if(_t!==null)if(Bt){if(H)if(x.layerUpdates.size>0){const St=Td(Rt.width,Rt.height,x.format,x.type);for(const Et of x.layerUpdates){const Vt=Rt.data.subarray(Et*St/Rt.data.BYTES_PER_ELEMENT,(Et+1)*St/Rt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,it,0,0,Et,Rt.width,Rt.height,1,_t,Vt,0,0)}x.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,it,0,0,0,Rt.width,Rt.height,ft.depth,_t,Rt.data,0,0)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,it,Ft,Rt.width,Rt.height,ft.depth,0,Rt.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Bt?H&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,it,0,0,0,Rt.width,Rt.height,ft.depth,_t,Dt,Rt.data):e.texImage3D(n.TEXTURE_2D_ARRAY,it,Ft,Rt.width,Rt.height,ft.depth,0,_t,Dt,Rt.data)}else{Bt&&Yt&&e.texStorage2D(n.TEXTURE_2D,yt,Ft,Qt[0].width,Qt[0].height);for(let it=0,et=Qt.length;it<et;it++)Rt=Qt[it],x.format!==Xn?_t!==null?Bt?H&&e.compressedTexSubImage2D(n.TEXTURE_2D,it,0,0,Rt.width,Rt.height,_t,Rt.data):e.compressedTexImage2D(n.TEXTURE_2D,it,Ft,Rt.width,Rt.height,0,Rt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Bt?H&&e.texSubImage2D(n.TEXTURE_2D,it,0,0,Rt.width,Rt.height,_t,Dt,Rt.data):e.texImage2D(n.TEXTURE_2D,it,Ft,Rt.width,Rt.height,0,_t,Dt,Rt.data)}else if(x.isDataArrayTexture)if(Bt){if(Yt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,yt,Ft,ft.width,ft.height,ft.depth),H)if(x.layerUpdates.size>0){const it=Td(ft.width,ft.height,x.format,x.type);for(const et of x.layerUpdates){const St=ft.data.subarray(et*it/ft.data.BYTES_PER_ELEMENT,(et+1)*it/ft.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,et,ft.width,ft.height,1,_t,Dt,St)}x.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ft.width,ft.height,ft.depth,_t,Dt,ft.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,Ft,ft.width,ft.height,ft.depth,0,_t,Dt,ft.data);else if(x.isData3DTexture)Bt?(Yt&&e.texStorage3D(n.TEXTURE_3D,yt,Ft,ft.width,ft.height,ft.depth),H&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ft.width,ft.height,ft.depth,_t,Dt,ft.data)):e.texImage3D(n.TEXTURE_3D,0,Ft,ft.width,ft.height,ft.depth,0,_t,Dt,ft.data);else if(x.isFramebufferTexture){if(Yt)if(Bt)e.texStorage2D(n.TEXTURE_2D,yt,Ft,ft.width,ft.height);else{let it=ft.width,et=ft.height;for(let St=0;St<yt;St++)e.texImage2D(n.TEXTURE_2D,St,Ft,it,et,0,_t,Dt,null),it>>=1,et>>=1}}else if(Qt.length>0){if(Bt&&Yt){const it=J(Qt[0]);e.texStorage2D(n.TEXTURE_2D,yt,Ft,it.width,it.height)}for(let it=0,et=Qt.length;it<et;it++)Rt=Qt[it],Bt?H&&e.texSubImage2D(n.TEXTURE_2D,it,0,0,_t,Dt,Rt):e.texImage2D(n.TEXTURE_2D,it,Ft,_t,Dt,Rt);x.generateMipmaps=!1}else if(Bt){if(Yt){const it=J(ft);e.texStorage2D(n.TEXTURE_2D,yt,Ft,it.width,it.height)}H&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,_t,Dt,ft)}else e.texImage2D(n.TEXTURE_2D,0,Ft,_t,Dt,ft);m(x)&&p(Y),ut.__version=X.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function rt(w,x,C){if(x.image.length!==6)return;const Y=Nt(w,x),V=x.source;e.bindTexture(n.TEXTURE_CUBE_MAP,w.__webglTexture,n.TEXTURE0+C);const X=i.get(V);if(V.version!==X.__version||Y===!0){e.activeTexture(n.TEXTURE0+C);const ut=Fe.getPrimaries(Fe.workingColorSpace),at=x.colorSpace===ps?null:Fe.getPrimaries(x.colorSpace),vt=x.colorSpace===ps||ut===at?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,x.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,x.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,vt);const At=x.isCompressedTexture||x.image[0].isCompressedTexture,ft=x.image[0]&&x.image[0].isDataTexture,_t=[];for(let et=0;et<6;et++)!At&&!ft?_t[et]=y(x.image[et],!0,s.maxCubemapSize):_t[et]=ft?x.image[et].image:x.image[et],_t[et]=K(x,_t[et]);const Dt=_t[0],Ft=o.convert(x.format,x.colorSpace),Rt=o.convert(x.type),Qt=T(x.internalFormat,Ft,Rt,x.colorSpace),Bt=x.isVideoTexture!==!0,Yt=X.__version===void 0||Y===!0,H=V.dataReady;let yt=b(x,Dt);gt(n.TEXTURE_CUBE_MAP,x);let it;if(At){Bt&&Yt&&e.texStorage2D(n.TEXTURE_CUBE_MAP,yt,Qt,Dt.width,Dt.height);for(let et=0;et<6;et++){it=_t[et].mipmaps;for(let St=0;St<it.length;St++){const Et=it[St];x.format!==Xn?Ft!==null?Bt?H&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,St,0,0,Et.width,Et.height,Ft,Et.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,St,Qt,Et.width,Et.height,0,Et.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Bt?H&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,St,0,0,Et.width,Et.height,Ft,Rt,Et.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,St,Qt,Et.width,Et.height,0,Ft,Rt,Et.data)}}}else{if(it=x.mipmaps,Bt&&Yt){it.length>0&&yt++;const et=J(_t[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,yt,Qt,et.width,et.height)}for(let et=0;et<6;et++)if(ft){Bt?H&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,_t[et].width,_t[et].height,Ft,Rt,_t[et].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Qt,_t[et].width,_t[et].height,0,Ft,Rt,_t[et].data);for(let St=0;St<it.length;St++){const Vt=it[St].image[et].image;Bt?H&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,St+1,0,0,Vt.width,Vt.height,Ft,Rt,Vt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,St+1,Qt,Vt.width,Vt.height,0,Ft,Rt,Vt.data)}}else{Bt?H&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,0,0,Ft,Rt,_t[et]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,0,Qt,Ft,Rt,_t[et]);for(let St=0;St<it.length;St++){const Et=it[St];Bt?H&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,St+1,0,0,Ft,Rt,Et.image[et]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+et,St+1,Qt,Ft,Rt,Et.image[et])}}}m(x)&&p(n.TEXTURE_CUBE_MAP),X.__version=V.version,x.onUpdate&&x.onUpdate(x)}w.__version=x.version}function pt(w,x,C,Y,V,X){const ut=o.convert(C.format,C.colorSpace),at=o.convert(C.type),vt=T(C.internalFormat,ut,at,C.colorSpace);if(!i.get(x).__hasExternalTextures){const ft=Math.max(1,x.width>>X),_t=Math.max(1,x.height>>X);V===n.TEXTURE_3D||V===n.TEXTURE_2D_ARRAY?e.texImage3D(V,X,vt,ft,_t,x.depth,0,ut,at,null):e.texImage2D(V,X,vt,ft,_t,0,ut,at,null)}e.bindFramebuffer(n.FRAMEBUFFER,w),F(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Y,V,i.get(C).__webglTexture,0,L(x)):(V===n.TEXTURE_2D||V>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&V<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Y,V,i.get(C).__webglTexture,X),e.bindFramebuffer(n.FRAMEBUFFER,null)}function wt(w,x,C){if(n.bindRenderbuffer(n.RENDERBUFFER,w),x.depthBuffer){const Y=x.depthTexture,V=Y&&Y.isDepthTexture?Y.type:null,X=S(x.stencilBuffer,V),ut=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,at=L(x);F(x)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,at,X,x.width,x.height):C?n.renderbufferStorageMultisample(n.RENDERBUFFER,at,X,x.width,x.height):n.renderbufferStorage(n.RENDERBUFFER,X,x.width,x.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ut,n.RENDERBUFFER,w)}else{const Y=x.textures;for(let V=0;V<Y.length;V++){const X=Y[V],ut=o.convert(X.format,X.colorSpace),at=o.convert(X.type),vt=T(X.internalFormat,ut,at,X.colorSpace),At=L(x);C&&F(x)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,At,vt,x.width,x.height):F(x)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,At,vt,x.width,x.height):n.renderbufferStorage(n.RENDERBUFFER,vt,x.width,x.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function O(w,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(n.FRAMEBUFFER,w),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),Z(x.depthTexture,0);const Y=i.get(x.depthTexture).__webglTexture,V=L(x);if(x.depthTexture.format===xo)F(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Y,0,V):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Y,0);else if(x.depthTexture.format===Ro)F(x)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Y,0,V):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Y,0);else throw new Error("Unknown depthTexture format")}function ht(w){const x=i.get(w),C=w.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==w.depthTexture){const Y=w.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),Y){const V=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,Y.removeEventListener("dispose",V)};Y.addEventListener("dispose",V),x.__depthDisposeCallback=V}x.__boundDepthTexture=Y}if(w.depthTexture&&!x.__autoAllocateDepthBuffer){if(C)throw new Error("target.depthTexture not supported in Cube render targets");O(x.__webglFramebuffer,w)}else if(C){x.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(e.bindFramebuffer(n.FRAMEBUFFER,x.__webglFramebuffer[Y]),x.__webglDepthbuffer[Y]===void 0)x.__webglDepthbuffer[Y]=n.createRenderbuffer(),wt(x.__webglDepthbuffer[Y],w,!1);else{const V=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,X=x.__webglDepthbuffer[Y];n.bindRenderbuffer(n.RENDERBUFFER,X),n.framebufferRenderbuffer(n.FRAMEBUFFER,V,n.RENDERBUFFER,X)}}else if(e.bindFramebuffer(n.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=n.createRenderbuffer(),wt(x.__webglDepthbuffer,w,!1);else{const Y=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,V=x.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,V),n.framebufferRenderbuffer(n.FRAMEBUFFER,Y,n.RENDERBUFFER,V)}e.bindFramebuffer(n.FRAMEBUFFER,null)}function ot(w,x,C){const Y=i.get(w);x!==void 0&&pt(Y.__webglFramebuffer,w,w.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),C!==void 0&&ht(w)}function lt(w){const x=w.texture,C=i.get(w),Y=i.get(x);w.addEventListener("dispose",I);const V=w.textures,X=w.isWebGLCubeRenderTarget===!0,ut=V.length>1;if(ut||(Y.__webglTexture===void 0&&(Y.__webglTexture=n.createTexture()),Y.__version=x.version,r.memory.textures++),X){C.__webglFramebuffer=[];for(let at=0;at<6;at++)if(x.mipmaps&&x.mipmaps.length>0){C.__webglFramebuffer[at]=[];for(let vt=0;vt<x.mipmaps.length;vt++)C.__webglFramebuffer[at][vt]=n.createFramebuffer()}else C.__webglFramebuffer[at]=n.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){C.__webglFramebuffer=[];for(let at=0;at<x.mipmaps.length;at++)C.__webglFramebuffer[at]=n.createFramebuffer()}else C.__webglFramebuffer=n.createFramebuffer();if(ut)for(let at=0,vt=V.length;at<vt;at++){const At=i.get(V[at]);At.__webglTexture===void 0&&(At.__webglTexture=n.createTexture(),r.memory.textures++)}if(w.samples>0&&F(w)===!1){C.__webglMultisampledFramebuffer=n.createFramebuffer(),C.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,C.__webglMultisampledFramebuffer);for(let at=0;at<V.length;at++){const vt=V[at];C.__webglColorRenderbuffer[at]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,C.__webglColorRenderbuffer[at]);const At=o.convert(vt.format,vt.colorSpace),ft=o.convert(vt.type),_t=T(vt.internalFormat,At,ft,vt.colorSpace,w.isXRRenderTarget===!0),Dt=L(w);n.renderbufferStorageMultisample(n.RENDERBUFFER,Dt,_t,w.width,w.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+at,n.RENDERBUFFER,C.__webglColorRenderbuffer[at])}n.bindRenderbuffer(n.RENDERBUFFER,null),w.depthBuffer&&(C.__webglDepthRenderbuffer=n.createRenderbuffer(),wt(C.__webglDepthRenderbuffer,w,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(X){e.bindTexture(n.TEXTURE_CUBE_MAP,Y.__webglTexture),gt(n.TEXTURE_CUBE_MAP,x);for(let at=0;at<6;at++)if(x.mipmaps&&x.mipmaps.length>0)for(let vt=0;vt<x.mipmaps.length;vt++)pt(C.__webglFramebuffer[at][vt],w,x,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+at,vt);else pt(C.__webglFramebuffer[at],w,x,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+at,0);m(x)&&p(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ut){for(let at=0,vt=V.length;at<vt;at++){const At=V[at],ft=i.get(At);e.bindTexture(n.TEXTURE_2D,ft.__webglTexture),gt(n.TEXTURE_2D,At),pt(C.__webglFramebuffer,w,At,n.COLOR_ATTACHMENT0+at,n.TEXTURE_2D,0),m(At)&&p(n.TEXTURE_2D)}e.unbindTexture()}else{let at=n.TEXTURE_2D;if((w.isWebGL3DRenderTarget||w.isWebGLArrayRenderTarget)&&(at=w.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(at,Y.__webglTexture),gt(at,x),x.mipmaps&&x.mipmaps.length>0)for(let vt=0;vt<x.mipmaps.length;vt++)pt(C.__webglFramebuffer[vt],w,x,n.COLOR_ATTACHMENT0,at,vt);else pt(C.__webglFramebuffer,w,x,n.COLOR_ATTACHMENT0,at,0);m(x)&&p(at),e.unbindTexture()}w.depthBuffer&&ht(w)}function bt(w){const x=w.textures;for(let C=0,Y=x.length;C<Y;C++){const V=x[C];if(m(V)){const X=w.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ut=i.get(V).__webglTexture;e.bindTexture(X,ut),p(X),e.unbindTexture()}}}const nt=[],g=[];function P(w){if(w.samples>0){if(F(w)===!1){const x=w.textures,C=w.width,Y=w.height;let V=n.COLOR_BUFFER_BIT;const X=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ut=i.get(w),at=x.length>1;if(at)for(let vt=0;vt<x.length;vt++)e.bindFramebuffer(n.FRAMEBUFFER,ut.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+vt,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,ut.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+vt,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,ut.__webglMultisampledFramebuffer),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ut.__webglFramebuffer);for(let vt=0;vt<x.length;vt++){if(w.resolveDepthBuffer&&(w.depthBuffer&&(V|=n.DEPTH_BUFFER_BIT),w.stencilBuffer&&w.resolveStencilBuffer&&(V|=n.STENCIL_BUFFER_BIT)),at){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ut.__webglColorRenderbuffer[vt]);const At=i.get(x[vt]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,At,0)}n.blitFramebuffer(0,0,C,Y,0,0,C,Y,V,n.NEAREST),c===!0&&(nt.length=0,g.length=0,nt.push(n.COLOR_ATTACHMENT0+vt),w.depthBuffer&&w.resolveDepthBuffer===!1&&(nt.push(X),g.push(X),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,g)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,nt))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),at)for(let vt=0;vt<x.length;vt++){e.bindFramebuffer(n.FRAMEBUFFER,ut.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+vt,n.RENDERBUFFER,ut.__webglColorRenderbuffer[vt]);const At=i.get(x[vt]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,ut.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+vt,n.TEXTURE_2D,At,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ut.__webglMultisampledFramebuffer)}else if(w.depthBuffer&&w.resolveDepthBuffer===!1&&c){const x=w.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[x])}}}function L(w){return Math.min(s.maxSamples,w.samples)}function F(w){const x=i.get(w);return w.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function N(w){const x=r.render.frame;h.get(w)!==x&&(h.set(w,x),w.update())}function K(w,x){const C=w.colorSpace,Y=w.format,V=w.type;return w.isCompressedTexture===!0||w.isVideoTexture===!0||C!==Ms&&C!==ps&&(Fe.getTransfer(C)===en?(Y!==Xn||V!==ts)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",C)),x}function J(w){return typeof HTMLImageElement<"u"&&w instanceof HTMLImageElement?(l.width=w.naturalWidth||w.width,l.height=w.naturalHeight||w.height):typeof VideoFrame<"u"&&w instanceof VideoFrame?(l.width=w.displayWidth,l.height=w.displayHeight):(l.width=w.width,l.height=w.height),l}this.allocateTextureUnit=U,this.resetTextureUnits=E,this.setTexture2D=Z,this.setTexture2DArray=ct,this.setTexture3D=j,this.setTextureCube=st,this.rebindTextures=ot,this.setupRenderTarget=lt,this.updateRenderTargetMipmap=bt,this.updateMultisampleRenderTarget=P,this.setupDepthRenderbuffer=ht,this.setupFrameBufferTexture=pt,this.useMultisampledRTT=F}function b1(n,t){function e(i,s=ps){let o;const r=Fe.getTransfer(s);if(i===ts)return n.UNSIGNED_BYTE;if(i===Su)return n.UNSIGNED_SHORT_4_4_4_4;if(i===bu)return n.UNSIGNED_SHORT_5_5_5_1;if(i===ip)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===ep)return n.BYTE;if(i===np)return n.SHORT;if(i===pr)return n.UNSIGNED_SHORT;if(i===wu)return n.INT;if(i===zs)return n.UNSIGNED_INT;if(i===Ki)return n.FLOAT;if(i===Sr)return n.HALF_FLOAT;if(i===sp)return n.ALPHA;if(i===op)return n.RGB;if(i===Xn)return n.RGBA;if(i===rp)return n.LUMINANCE;if(i===ap)return n.LUMINANCE_ALPHA;if(i===xo)return n.DEPTH_COMPONENT;if(i===Ro)return n.DEPTH_STENCIL;if(i===cp)return n.RED;if(i===Eu)return n.RED_INTEGER;if(i===lp)return n.RG;if(i===Tu)return n.RG_INTEGER;if(i===Au)return n.RGBA_INTEGER;if(i===fa||i===pa||i===ma||i===ga)if(r===en)if(o=t.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(i===fa)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===pa)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===ma)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===ga)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=t.get("WEBGL_compressed_texture_s3tc"),o!==null){if(i===fa)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===pa)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===ma)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===ga)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===xl||i===yl||i===Ml||i===wl)if(o=t.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(i===xl)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===yl)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ml)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===wl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Sl||i===bl||i===El)if(o=t.get("WEBGL_compressed_texture_etc"),o!==null){if(i===Sl||i===bl)return r===en?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(i===El)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Tl||i===Al||i===Pl||i===Rl||i===Cl||i===Il||i===Ll||i===Dl||i===Ul||i===Nl||i===Fl||i===Ol||i===Bl||i===zl)if(o=t.get("WEBGL_compressed_texture_astc"),o!==null){if(i===Tl)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Al)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Pl)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Rl)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Cl)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Il)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Ll)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Dl)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Ul)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Nl)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Fl)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Ol)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Bl)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===zl)return r===en?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===va||i===Gl||i===Hl)if(o=t.get("EXT_texture_compression_bptc"),o!==null){if(i===va)return r===en?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Gl)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Hl)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===up||i===kl||i===Vl||i===Wl)if(o=t.get("EXT_texture_compression_rgtc"),o!==null){if(i===va)return o.COMPRESSED_RED_RGTC1_EXT;if(i===kl)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Vl)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Wl)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Po?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}class E1 extends $e{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class Xt extends wn{constructor(){super(),this.isGroup=!0,this.type="Group"}}const T1={type:"move"};class kc{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Xt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Xt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new Q,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new Q),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Xt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new Q,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new Q),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const i of t.hand.values())this._getHandJoint(e,i)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,i){let s=null,o=null,r=null;const a=this._targetRay,c=this._grip,l=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(l&&t.hand){r=!0;for(const y of t.hand.values()){const m=e.getJointPose(y,i),p=this._getHandJoint(l,y);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const h=l.joints["index-finger-tip"],u=l.joints["thumb-tip"],d=h.position.distanceTo(u.position),f=.02,v=.005;l.inputState.pinching&&d>f+v?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!l.inputState.pinching&&d<=f-v&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else c!==null&&t.gripSpace&&(o=e.getPose(t.gripSpace,i),o!==null&&(c.matrix.fromArray(o.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,o.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(o.linearVelocity)):c.hasLinearVelocity=!1,o.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(o.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(s=e.getPose(t.targetRaySpace,i),s===null&&o!==null&&(s=o),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(T1)))}return a!==null&&(a.visible=s!==null),c!==null&&(c.visible=o!==null),l!==null&&(l.visible=r!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const i=new Xt;i.matrixAutoUpdate=!1,i.visible=!1,t.joints[e.jointName]=i,t.add(i)}return t.joints[e.jointName]}}const A1=`
void main() {
...
}`;class R1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,i){if(this.texture===null){const s=new In,o=t.properties.get(s);o.__webglTexture=e.texture,(e.depthNear!=i.depthNear||e.depthFar!=i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,i=new un({vertexShader:A1,fragmentShader:P1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new _(new Ka(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class C1 extends Lo{constructor(t,e){super();const i=this;let s=null,o=1,r=null,a="local-floor",c=1,l=null,h=null,u=null,d=null,f=null,v=null;const y=new R1,m=e.getContextAttributes();let p=null,T=null;const S=[],b=[],B=new Jt;let I=null;const R=new $e;R.layers.enable(1),R.viewport=new We;const z=new $e;z.layers.enable(2),z.viewport=new We;const tt=[R,z],M=new E1;M.layers.enable(1),M.layers.enable(2);let E=null,U=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(rt){let pt=S[rt];return pt===void 0&&(pt=new kc,S[rt]=pt),pt.getTargetRaySpace()},this.getControllerGrip=function(rt){let pt=S[rt];return pt===void 0&&(pt=new kc,S[rt]=pt),pt.getGripSpace()},this.getHand=function(rt){let pt=S[rt];return pt===void 0&&(pt=new kc,S[rt]=pt),pt.getHandSpace()};function $(rt){const pt=b.indexOf(rt.inputSource);if(pt===-1)return;const wt=S[pt];wt!==void 0&&(wt.update(rt.inputSource,rt.frame,l||r),wt.dispatchEvent({type:rt.type,data:rt.inputSource}))}function Z(){s.removeEventListener("select",$),s.removeEventListener("selectstart",$),s.removeEventListener("selectend",$),s.removeEventListener("squeeze",$),s.removeEventListener("squeezestart",$),s.removeEventListener("squeezeend",$),s.removeEventListener("end",Z),s.removeEventListener("inputsourceschange",ct);for(let rt=0;rt<S.length;rt++){const pt=b[rt];pt!==null&&(b[rt]=null,S[rt].disconnect(pt))}E=null,U=null,y.reset(),t.setRenderTarget(p),f=null,d=null,u=null,s=null,T=null,Wt.stop(),i.isPresenting=!1,t.setPixelRatio(I),t.setSize(B.width,B.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(rt){o=rt,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(rt){a=rt,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||r},this.setReferenceSpace=function(rt){l=rt},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return u},this.getFrame=function(){return v},this.getSession=function(){return s},this.setSession=async function(rt){if(s=rt,s!==null){if(p=t.getRenderTarget(),s.addEventListener("select",$),s.addEventListener("selectstart",$),s.addEventListener("selectend",$),s.addEventListener("squeeze",$),s.addEventListener("squeezestart",$),s.addEventListener("squeezeend",$),s.addEventListener("end",Z),s.addEventListener("inputsourceschange",ct),m.xrCompatible!==!0&&await e.makeXRCompatible(),I=t.getPixelRatio(),t.getSize(B),s.renderState.layers===void 0){const pt={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:o};f=new XRWebGLLayer(s,e,pt),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),T=new Gs(f.framebufferWidth,f.framebufferHeight,{format:Xn,type:ts,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil})}else{let pt=null,wt=null,O=null;m.depth&&(O=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,pt=m.stencil?Ro:xo,wt=m.stencil?Po:zs);const ht={colorFormat:e.RGBA8,depthFormat:O,scaleFactor:o};u=new XRWebGLBinding(s,e),d=u.createProjectionLayer(ht),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),T=new Gs(d.textureWidth,d.textureHeight,{format:Xn,type:ts,depthTexture:new Ep(d.textureWidth,d.textureHeight,wt,void 0,void 0,void 0,void 0,void 0,void 0,pt),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(c),l=null,r=await s.requestReferenceSpace(a),Wt.setContext(s),Wt.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function ct(rt){for(let pt=0;pt<rt.removed.length;pt++){const wt=rt.removed[pt],O=b.indexOf(wt);O>=0&&(b[O]=null,S[O].disconnect(wt))}for(let pt=0;pt<rt.added.length;pt++){const wt=rt.added[pt];let O=b.indexOf(wt);if(O===-1){for(let ot=0;ot<S.length;ot++)if(ot>=b.length){b.push(wt),O=ot;break}else if(b[ot]===null){b[ot]=wt,O=ot;break}if(O===-1)break}const ht=S[O];ht&&ht.connect(wt)}}const j=new Q,st=new Q;function k(rt,pt,wt){j.setFromMatrixPosition(pt.matrixWorld),st.setFromMatrixPosition(wt.matrixWorld);const O=j.distanceTo(st),ht=pt.projectionMatrix.elements,ot=wt.projectionMatrix.elements,lt=ht[14]/(ht[10]-1),bt=ht[14]/(ht[10]+1),nt=(ht[9]+1)/ht[5],g=(ht[9]-1)/ht[5],P=(ht[8]-1)/ht[0],L=(ot[8]+1)/ot[0],F=lt*P,N=lt*L,K=O/(-P+L),J=K*-P;if(pt.matrixWorld.decompose(rt.position,rt.quaternion,rt.scale),rt.translateX(J),rt.translateZ(K),rt.matrixWorld.compose(rt.position,rt.quaternion,rt.scale),rt.matrixWorldInverse.copy(rt.matrixWorld).invert(),ht[10]===-1)rt.projectionMatrix.copy(pt.projectionMatrix),rt.projectionMatrixInverse.copy(pt.projectionMatrixInverse);else{const w=lt+K,x=bt+K,C=F-J,Y=N+(O-J),V=nt*bt/x*w,X=g*bt/x*w;rt.projectionMatrix.makePerspective(C,Y,V,X,w,x),rt.projectionMatrixInverse.copy(rt.projectionMatrix).invert()}}function xt(rt,pt){pt===null?rt.matrixWorld.copy(rt.matrix):rt.matrixWorld.multiplyMatrices(pt.matrixWorld,rt.matrix),rt.matrixWorldInverse.copy(rt.matrixWorld).invert()}this.updateCamera=function(rt){if(s===null)return;let pt=rt.near,wt=rt.far;y.texture!==null&&(y.depthNear>0&&(pt=y.depthNear),y.depthFar>0&&(wt=y.depthFar)),M.near=z.near=R.near=pt,M.far=z.far=R.far=wt,(E!==M.near||U!==M.far)&&(s.updateRenderState({depthNear:M.near,depthFar:M.far}),E=M.near,U=M.far);const O=rt.parent,ht=M.cameras;xt(M,O);for(let ot=0;ot<ht.length;ot++)xt(ht[ot],O);ht.length===2?k(M,R,z):M.projectionMatrix.copy(R.projectionMatrix),Mt(rt,M,O)};function Mt(rt,pt,wt){wt===null?rt.matrix.copy(pt.matrixWorld):(rt.matrix.copy(wt.matrixWorld),rt.matrix.invert(),rt.matrix.multiply(pt.matrixWorld)),rt.matrix.decompose(rt.position,rt.quaternion,rt.scale),rt.updateMatrixWorld(!0),rt.projectionMatrix.copy(pt.projectionMatrix),rt.projectionMatrixInverse.copy(pt.projectionMatrixInverse),rt.isPerspectiveCamera&&(rt.fov=mr*2*Math.atan(1/rt.projectionMatrix.elements[5]),rt.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(d===null&&f===null))return c},this.setFoveation=function(rt){c=rt,d!==null&&(d.fixedFoveation=rt),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=rt)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(M)};let gt=null;function Nt(rt,pt){if(h=pt.getViewerPose(l||r),v=pt,h!==null){const wt=h.views;f!==null&&(t.setRenderTargetFramebuffer(T,f.framebuffer),t.setRenderTarget(T));let O=!1;wt.length!==M.cameras.length&&(M.cameras.length=0,O=!0);for(let ot=0;ot<wt.length;ot++){const lt=wt[ot];let bt=null;if(f!==null)bt=f.getViewport(lt);else{const g=u.getViewSubImage(d,lt);bt=g.viewport,ot===0&&(t.setRenderTargetTextures(T,g.colorTexture,d.ignoreDepthValues?void 0:g.depthStencilTexture),t.setRenderTarget(T))}let nt=tt[ot];nt===void 0&&(nt=new $e,nt.layers.enable(ot),nt.viewport=new We,tt[ot]=nt),nt.matrix.fromArray(lt.transform.matrix),nt.matrix.decompose(nt.position,nt.quaternion,nt.scale),nt.projectionMatrix.fromArray(lt.projectionMatrix),nt.projectionMatrixInverse.copy(nt.projectionMatrix).invert(),nt.viewport.set(bt.x,bt.y,bt.width,bt.height),ot===0&&(M.matrix.copy(nt.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),O===!0&&M.cameras.push(nt)}const ht=s.enabledFeatures;if(ht&&ht.includes("depth-sensing")){const ot=u.getDepthInformation(wt[0]);ot&&ot.isValid&&ot.texture&&y.init(t,ot,s.renderState)}}for(let wt=0;wt<S.length;wt++){const O=b[wt],ht=S[wt];O!==null&&ht!==void 0&&ht.update(O,pt,l||r)}gt&&gt(rt,pt),pt.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:pt}),v=null}const Wt=new Sp;Wt.setAnimationLoop(Nt),this.setAnimationLoop=function(rt){gt=rt},this.dispose=function(){}}}const Rs=new Ui,I1=new nn;function L1(n,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,Mp(n)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,T,S,b){p.isMeshBasicMaterial||p.isMeshLambertMaterial?o(m,p):p.isMeshToonMaterial?(o(m,p),u(m,p)):p.isMeshPhongMaterial?(o(m,p),h(m,p)):p.isMeshStandardMaterial?(o(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,b)):p.isMeshMatcapMaterial?(o(m,p),v(m,p)):p.isMeshDepthMaterial?o(m,p):p.isMeshDistanceMaterial?(o(m,p),y(m,p)):p.isMeshNormalMaterial?o(m,p):p.isLineBasicMaterial?(r(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?c(m,p,T,S):p.isSpriteMaterial?l(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function o(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===jn&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===jn&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const T=t.get(p),S=T.envMap,b=T.envMapRotation;S&&(m.envMap.value=S,Rs.copy(b),Rs.x*=-1,Rs.y*=-1,Rs.z*=-1,S.isCubeTexture&&S.isRenderTargetTexture===!1&&(Rs.y*=-1,Rs.z*=-1),m.envMapRotation.value.setFromMatrix4(I1.makeRotationFromEuler(Rs)),m.flipEnvMap.value=S.isCubeTexture&&S.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function r(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function c(m,p,T,S){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*T,m.scale.value=S*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function l(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function u(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,T){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===jn&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function v(m,p){p.matcap&&(m.matcap.value=p.matcap)}function y(m,p){const T=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function D1(n,t,e,i){let s={},o={},r=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function c(T,S){const b=S.program;i.uniformBlockBinding(T,b)}function l(T,S){let b=s[T.id];b===void 0&&(v(T),b=h(T),s[T.id]=b,T.addEventListener("dispose",m));const B=S.program;i.updateUBOMapping(T,B);const I=t.render.frame;o[T.id]!==I&&(d(T),o[T.id]=I)}function h(T){const S=u();T.__bindingPointIndex=S;const b=n.createBuffer(),B=T.__size,I=T.usage;return n.bindBuffer(n.UNIFORM_BUFFER,b),n.bufferData(n.UNIFORM_BUFFER,B,I),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,S,b),b}function u(){for(let T=0;T<a;T++)if(r.indexOf(T)===-1)return r.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(T){const S=s[T.id],b=T.uniforms,B=T.__cache;n.bindBuffer(n.UNIFORM_BUFFER,S);for(let I=0,R=b.length;I<R;I++){const z=Array.isArray(b[I])?b[I]:[b[I]];for(let tt=0,M=z.length;tt<M;tt++){const E=z[tt];if(f(E,I,tt,B)===!0){const U=E.__offset,$=Array.isArray(E.value)?E.value:[E.value];let Z=0;for(let ct=0;ct<$.length;ct++){const j=$[ct],st=y(j);typeof j=="number"||typeof j=="boolean"?(E.__data[0]=j,n.bufferSubData(n.UNIFORM_BUFFER,U+Z,E.__data)):j.isMatrix3?(E.__data[0]=j.elements[0],E.__data[1]=j.elements[1],E.__data[2]=j.elements[2],E.__data[3]=0,E.__data[4]=j.elements[3],E.__data[5]=j.elements[4],E.__data[6]=j.elements[5],E.__data[7]=0,E.__data[8]=j.elements[6],E.__data[9]=j.elements[7],E.__data[10]=j.elements[8],E.__data[11]=0):(j.toArray(E.__data,Z),Z+=st.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,U,E.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function f(T,S,b,B){const I=T.value,R=S+"_"+b;if(B[R]===void 0)return typeof I=="number"||typeof I=="boolean"?B[R]=I:B[R]=I.clone(),!0;{const z=B[R];if(typeof I=="number"||typeof I=="boolean"){if(z!==I)return B[R]=I,!0}else if(z.equals(I)===!1)return z.copy(I),!0}return!1}function v(T){const S=T.uniforms;let b=0;const B=16;for(let R=0,z=S.length;R<z;R++){const tt=Array.isArray(S[R])?S[R]:[S[R]];for(let M=0,E=tt.length;M<E;M++){const U=tt[M],$=Array.isArray(U.value)?U.value:[U.value];for(let Z=0,ct=$.length;Z<ct;Z++){const j=$[Z],st=y(j),k=b%B,xt=k%st.boundary,Mt=k+xt;b+=xt,Mt!==0&&B-Mt<st.storage&&(b+=B-Mt),U.__data=new Float32Array(st.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=b,b+=st.storage}}}const I=b%B;return I>0&&(b+=B-I),T.__size=b,T.__cache={},this}function y(T){const S={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(S.boundary=4,S.storage=4):T.isVector2?(S.boundary=8,S.storage=8):T.isVector3||T.isColor?(S.boundary=16,S.storage=12):T.isVector4?(S.boundary=16,S.storage=16):T.isMatrix3?(S.boundary=48,S.storage=48):T.isMatrix4?(S.boundary=64,S.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),S}function m(T){const S=T.target;S.removeEventListener("dispose",m);const b=r.indexOf(S.__bindingPointIndex);r.splice(b,1),n.deleteBuffer(s[S.id]),delete s[S.id],delete o[S.id]}function p(){for(const T in s)n.deleteBuffer(s[T]);r=[],s={},o={}}return{bind:c,update:l,dispose:p}}class Gn{constructor(t={}){const{canvas:e=S_(),context:i=null,depth:s=!0,stencil:o=!1,alpha:r=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1}=t;this.isWebGLRenderer=!0;let d;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=i.getContextAttributes().alpha}else d=r;const f=new Uint32Array(4),v=new Int32Array(4);let y=null,m=null;const p=[],T=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=vi,this.toneMapping=gs,this.toneMappingExposure=1;const S=this;let b=!1,B=0,I=0,R=null,z=-1,tt=null;const M=new We,E=new We;let U=null;const $=new xe(0);let Z=0,ct=e.width,j=e.height,st=1,k=null,xt=null;const Mt=new We(0,0,ct,j),gt=new We(0,0,ct,j);let Nt=!1;const Wt=new Iu;let rt=!1,pt=!1;const wt=new nn,O=new nn,ht=new Q,ot=new We,lt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let bt=!1;function nt(){return R===null?st:1}let g=i;function P(A,q){return e.getContext(A,q)}try{const A={alpha:!0,depth:s,stencil:o,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Mu}`),e.addEventListener("webglcontextlost",et,!1),e.addEventListener("webglcontextrestored",St,!1),e.addEventListener("webglcontextcreationerror",Et,!1),g===null){const q="webgl2";if(g=P(q,A),g===null)throw P(q)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw console.error("THREE.WebGLRenderer: "+A.message),A}let L,F,N,K,J,w,x,C,Y,V,X,ut,at,vt,At,ft,_t,Dt,Ft,Rt,Qt,Bt,Yt,H;function yt(){L=new zM(g),L.init(),Bt=new b1(g,L),F=new DM(g,L,t,Bt),N=new M1(g),F.reverseDepthBuffer&&N.buffers.depth.setReversed(!0),K=new kM(g),J=new r1,w=new S1(g,L,N,J,F,Bt,K),x=new NM(S),C=new BM(S),Y=new $_(g),Yt=new IM(g,Y),V=new GM(g,Y,K,Yt),X=new WM(g,V,Y,K),Ft=new VM(g,F,w),ft=new UM(J),ut=new o1(S,x,C,L,F,Yt,ft),at=new L1(S,J),vt=new c1,At=new p1(L),Dt=new CM(S,x,C,N,X,d,c),_t=new x1(S,X,F),H=new D1(g,K,F,N),Rt=new LM(g,L,K),Qt=new HM(g,L,K),K.programs=ut.programs,S.capabilities=F,S.extensions=L,S.properties=J,S.renderLists=vt,S.shadowMap=_t,S.state=N,S.info=K}yt();const it=new C1(S,g);this.xr=it,this.getContext=function(){return g},this.getContextAttributes=function(){return g.getContextAttributes()},this.forceContextLoss=function(){const A=L.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=L.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return st},this.setPixelRatio=function(A){A!==void 0&&(st=A,this.setSize(ct,j,!1))},this.getSize=function(A){return A.set(ct,j)},this.setSize=function(A,q,D=!0){if(it.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}ct=A,j=q,e.width=Math.floor(A*st),e.height=Math.floor(q*st),D===!0&&(e.style.width=A+"px",e.style.height=q+"px"),this.setViewport(0,0,A,q)},this.getDrawingBufferSize=function(A){return A.set(ct*st,j*st).floor()},this.setDrawingBufferSize=function(A,q,D){ct=A,j=q,st=D,e.width=Math.floor(A*D),e.height=Math.floor(q*D),this.setViewport(0,0,A,q)},this.getCurrentViewport=function(A){return A.copy(M)},this.getViewport=function(A){return A.copy(Mt)},this.setViewport=function(A,q,D,W){A.isVector4?Mt.set(A.x,A.y,A.z,A.w):Mt.set(A,q,D,W),N.viewport(M.copy(Mt).multiplyScalar(st).round())},this.getScissor=function(A){return A.copy(gt)},this.setScissor=function(A,q,D,W){A.isVector4?gt.set(A.x,A.y,A.z,A.w):gt.set(A,q,D,W),N.scissor(E.copy(gt).multiplyScalar(st).round())},this.getScissorTest=function(){return Nt},this.setScissorTest=function(A){N.setScissorTest(Nt=A)},this.setOpaqueSort=function(A){k=A},this.setTransparentSort=function(A){xt=A},this.getClearColor=function(A){return A.copy(Dt.getClearColor())},this.setClearColor=function(){Dt.setClearColor.apply(Dt,arguments)},this.getClearAlpha=function(){return Dt.getClearAlpha()},this.setClearAlpha=function(){Dt.setClearAlpha.apply(Dt,arguments)},this.clear=function(A=!0,q=!0,D=!0){let W=0;if(A){let G=!1;if(R!==null){const mt=R.texture.format;G=mt===Au||mt===Tu||mt===Eu}if(G){const mt=R.texture.type,It=mt===ts||mt===zs||mt===pr||mt===Po||mt===Su||mt===bu,Lt=Dt.getClearColor(),Gt=Dt.getClearAlpha(),qt=Lt.r,$t=Lt.g,kt=Lt.b;It?(f[0]=qt,f[1]=$t,f[2]=kt,f[3]=Gt,g.clearBufferuiv(g.COLOR,0,f)):(v[0]=qt,v[1]=$t,v[2]=kt,v[3]=Gt,g.clearBufferiv(g.COLOR,0,v))}else W|=g.COLOR_BUFFER_BIT}q&&(W|=g.DEPTH_BUFFER_BIT,g.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),D&&(W|=g.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),g.clear(W)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",et,!1),e.removeEventListener("webglcontextrestored",St,!1),e.removeEventListener("webglcontextcreationerror",Et,!1),vt.dispose(),At.dispose(),J.dispose(),x.dispose(),C.dispose(),X.dispose(),Yt.dispose(),H.dispose(),ut.dispose(),it.dispose(),it.removeEventListener("sessionstart",he),it.removeEventListener("sessionend",ve),fe.stop()};function et(A){A.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),b=!0}function St(){console.log("THREE.WebGLRenderer: Context Restored."),b=!1;const A=K.autoReset,q=_t.enabled,D=_t.autoUpdate,W=_t.needsUpdate,G=_t.type;yt(),K.autoReset=A,_t.enabled=q,_t.autoUpdate=D,_t.needsUpdate=W,_t.type=G}function Et(A){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Vt(A){const q=A.target;q.removeEventListener("dispose",Vt),te(q)}function te(A){se(A),J.remove(A)}function se(A){const q=J.get(A).programs;q!==void 0&&(q.forEach(function(D){ut.releaseProgram(D)}),A.isShaderMaterial&&ut.releaseShaderCache(A))}this.renderBufferDirect=function(A,q,D,W,G,mt){q===null&&(q=lt);const It=G.isMesh&&G.matrixWorld.determinant()<0,Lt=He(A,q,D,W,G);N.setMaterial(W,It);let Gt=D.index,qt=1;if(W.wireframe===!0){if(Gt=V.getWireframeAttribute(D),Gt===void 0)return;qt=2}const $t=D.drawRange,kt=D.attributes.position;let ee=$t.start*qt,de=($t.start+$t.count)*qt;mt!==null&&(ee=Math.max(ee,mt.start*qt),de=Math.min(de,(mt.start+mt.count)*qt)),Gt!==null?(ee=Math.max(ee,0),de=Math.min(de,Gt.count)):kt!=null&&(ee=Math.max(ee,0),de=Math.min(de,kt.count));const ue=de-ee;if(ue<0||ue===1/0)return;Yt.setup(G,W,Lt,D,Gt);let Pt,jt=Rt;if(Gt!==null&&(Pt=Y.get(Gt),jt=Qt,jt.setIndex(Pt)),G.isMesh)W.wireframe===!0?(N.setLineWidth(W.wireframeLinewidth*nt()),jt.setMode(g.LINES)):jt.setMode(g.TRIANGLES);else if(G.isLine){let Ht=W.linewidth;Ht===void 0&&(Ht=1),N.setLineWidth(Ht*nt()),G.isLineSegments?jt.setMode(g.LINES):G.isLineLoop?jt.setMode(g.LINE_LOOP):jt.setMode(g.LINE_STRIP)}else G.isPoints?jt.setMode(g.POINTS):G.isSprite&&jt.setMode(g.TRIANGLES);if(G.isBatchedMesh)if(G._multiDrawInstances!==null)jt.renderMultiDrawInstances(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount,G._multiDrawInstances);else if(L.get("WEBGL_multi_draw"))jt.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const Ht=G._multiDrawStarts,oe=G._multiDrawCounts,Tt=G._multiDrawCount,Me=Gt?Y.get(Gt).bytesPerElement:1,Pe=J.get(W).currentProgram.getUniforms();for(let ge=0;ge<Tt;ge++)Pe.setValue(g,"_gl_DrawID",ge),jt.render(Ht[ge]/Me,oe[ge])}else if(G.isInstancedMesh)jt.renderInstances(ee,ue,G.count);else if(D.isInstancedBufferGeometry){const Ht=D._maxInstanceCount!==void 0?D._maxInstanceCount:1/0,oe=Math.min(D.instanceCount,Ht);jt.renderInstances(ee,ue,oe)}else jt.render(ee,ue)};function ie(A,q,D){A.transparent===!0&&A.side===Ae&&A.forceSinglePass===!1?(A.side=jn,A.needsUpdate=!0,Le(A,q,D),A.side=_s,A.needsUpdate=!0,Le(A,q,D),A.side=Ae):Le(A,q,D)}this.compile=function(A,q,D=null){D===null&&(D=A),m=At.get(D),m.init(q),T.push(m),D.traverseVisible(function(G){G.isLight&&G.layers.test(q.layers)&&(m.pushLight(G),G.castShadow&&m.pushShadow(G))}),A!==D&&A.traverseVisible(function(G){G.isLight&&G.layers.test(q.layers)&&(m.pushLight(G),G.castShadow&&m.pushShadow(G))}),m.setupLights();const W=new Set;return A.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const mt=G.material;if(mt)if(Array.isArray(mt))for(let It=0;It<mt.length;It++){const Lt=mt[It];ie(Lt,D,G),W.add(Lt)}else ie(mt,D,G),W.add(mt)}),T.pop(),m=null,W},this.compileAsync=function(A,q,D=null){const W=this.compile(A,q,D);return new Promise(G=>{function mt(){if(W.forEach(function(It){J.get(It).currentProgram.isReady()&&W.delete(It)}),W.size===0){G(A);return}setTimeout(mt,10)}L.get("KHR_parallel_shader_compile")!==null?mt():setTimeout(mt,10)})};let re=null;function ce(A){re&&re(A)}function he(){fe.stop()}function ve(){fe.start()}const fe=new Sp;fe.setAnimationLoop(ce),typeof self<"u"&&fe.setContext(self),this.setAnimationLoop=function(A){re=A,it.setAnimationLoop(A),A===null?fe.stop():fe.start()},it.addEventListener("sessionstart",he),it.addEventListener("sessionend",ve),this.render=function(A,q){if(q!==void 0&&q.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(b===!0)return;if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),q.parent===null&&q.matrixWorldAutoUpdate===!0&&q.updateMatrixWorld(),it.enabled===!0&&it.isPresenting===!0&&(it.cameraAutoUpdate===!0&&it.updateCamera(q),q=it.getCamera()),A.isScene===!0&&A.onBeforeRender(S,A,q,R),m=At.get(A,T.length),m.init(q),T.push(m),O.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),Wt.setFromProjectionMatrix(O),pt=this.localClippingEnabled,rt=ft.init(this.clippingPlanes,pt),y=vt.get(A,p.length),y.init(),p.push(y),it.enabled===!0&&it.isPresenting===!0){const mt=S.xr.getDepthSensingMesh();mt!==null&&Se(mt,q,-1/0,S.sortObjects)}Se(A,q,0,S.sortObjects),y.finish(),S.sortObjects===!0&&y.sort(k,xt),bt=it.enabled===!1||it.isPresenting===!1||it.hasDepthSensing()===!1,bt&&Dt.addToRenderList(y,A),this.info.render.frame++,rt===!0&&ft.beginShadows();const D=m.state.shadowsArray;_t.render(D,A,q),rt===!0&&ft.endShadows(),this.info.autoReset===!0&&this.info.reset();const W=y.opaque,G=y.transmissive;if(m.setupLights(),q.isArrayCamera){const mt=q.cameras;if(G.length>0)for(let It=0,Lt=mt.length;It<Lt;It++){const Gt=mt[It];De(W,G,A,Gt)}bt&&Dt.render(A);for(let It=0,Lt=mt.length;It<Lt;It++){const Gt=mt[It];ye(y,A,Gt,Gt.viewport)}}else G.length>0&&De(W,G,A,q),bt&&Dt.render(A),ye(y,A,q);R!==null&&(w.updateMultisampleRenderTarget(R),w.updateRenderTargetMipmap(R)),A.isScene===!0&&A.onAfterRender(S,A,q),Yt.resetDefaultState(),z=-1,tt=null,T.pop(),T.length>0?(m=T[T.length-1],rt===!0&&ft.setGlobalState(S.clippingPlanes,m.state.camera)):m=null,p.pop(),p.length>0?y=p[p.length-1]:y=null};function Se(A,q,D,W){if(A.visible===!1)return;if(A.layers.test(q.layers)){if(A.isGroup)D=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(q);else if(A.isLight)m.pushLight(A),A.castShadow&&m.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Wt.intersectsSprite(A)){W&&ot.setFromMatrixPosition(A.matrixWorld).applyMatrix4(O);const It=X.update(A),Lt=A.material;Lt.visible&&y.push(A,It,Lt,D,ot.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Wt.intersectsObject(A))){const It=X.update(A),Lt=A.material;if(W&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),ot.copy(A.boundingSphere.center)):(It.boundingSphere===null&&It.computeBoundingSphere(),ot.copy(It.boundingSphere.center)),ot.applyMatrix4(A.matrixWorld).applyMatrix4(O)),Array.isArray(Lt)){const Gt=It.groups;for(let qt=0,$t=Gt.length;qt<$t;qt++){const kt=Gt[qt],ee=Lt[kt.materialIndex];ee&&ee.visible&&y.push(A,It,ee,D,ot.z,kt)}}else Lt.visible&&y.push(A,It,Lt,D,ot.z,null)}}const mt=A.children;for(let It=0,Lt=mt.length;It<Lt;It++)Se(mt[It],q,D,W)}function ye(A,q,D,W){const G=A.opaque,mt=A.transmissive,It=A.transparent;m.setupLightsView(D),rt===!0&&ft.setGlobalState(S.clippingPlanes,D),W&&N.viewport(M.copy(W)),G.length>0&&Te(G,q,D),mt.length>0&&Te(mt,q,D),It.length>0&&Te(It,q,D),N.buffers.depth.setTest(!0),N.buffers.depth.setMask(!0),N.buffers.color.setMask(!0),N.setPolygonOffset(!1)}function De(A,q,D,W){if((D.isScene===!0?D.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[W.id]===void 0&&(m.state.transmissionRenderTarget[W.id]=new Gs(1,1,{generateMipmaps:!0,type:L.has("EXT_color_buffer_half_float")||L.has("EXT_color_buffer_float")?Sr:ts,minFilter:Ci,samples:4,stencilBuffer:o,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Fe.workingColorSpace}));const mt=m.state.transmissionRenderTarget[W.id],It=W.viewport||M;mt.setSize(It.z,It.w);const Lt=S.getRenderTarget();S.setRenderTarget(mt),S.getClearColor($),Z=S.getClearAlpha(),Z<1&&S.setClearColor(16777215,.5),S.clear(),bt&&Dt.render(D);const Gt=S.toneMapping;S.toneMapping=gs;const qt=W.viewport;if(W.viewport!==void 0&&(W.viewport=void 0),m.setupLightsView(W),rt===!0&&ft.setGlobalState(S.clippingPlanes,W),Te(A,D,W),w.updateMultisampleRenderTarget(mt),w.updateRenderTargetMipmap(mt),L.has("WEBGL_multisampled_render_to_texture")===!1){let $t=!1;for(let kt=0,ee=q.length;kt<ee;kt++){const de=q[kt],ue=de.object,Pt=de.geometry,jt=de.material,Ht=de.group;if(jt.side===Ae&&ue.layers.test(W.layers)){const oe=jt.side;jt.side=jn,jt.needsUpdate=!0,Be(ue,D,W,Pt,jt,Ht),jt.side=oe,jt.needsUpdate=!0,$t=!0}}$t===!0&&(w.updateMultisampleRenderTarget(mt),w.updateRenderTargetMipmap(mt))}S.setRenderTarget(Lt),S.setClearColor($,Z),qt!==void 0&&(W.viewport=qt),S.toneMapping=Gt}function Te(A,q,D){const W=q.isScene===!0?q.overrideMaterial:null;for(let G=0,mt=A.length;G<mt;G++){const It=A[G],Lt=It.object,Gt=It.geometry,qt=W===null?It.material:W,$t=It.group;Lt.layers.test(D.layers)&&Be(Lt,q,D,Gt,qt,$t)}}function Be(A,q,D,W,G,mt){A.onBeforeRender(S,q,D,W,G,mt),A.modelViewMatrix.multiplyMatrices(D.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),G.onBeforeRender(S,q,D,W,A,mt),G.transparent===!0&&G.side===Ae&&G.forceSinglePass===!1?(G.side=jn,G.needsUpdate=!0,S.renderBufferDirect(D,q,W,G,A,mt),G.side=_s,G.needsUpdate=!0,S.renderBufferDirect(D,q,W,G,A,mt),G.side=Ae):S.renderBufferDirect(D,q,W,G,A,mt),A.onAfterRender(S,q,D,W,G,mt)}function Le(A,q,D){q.isScene!==!0&&(q=lt);const W=J.get(A),G=m.state.lights,mt=m.state.shadowsArray,It=G.state.version,Lt=ut.getParameters(A,G.state,mt,q,D),Gt=ut.getProgramCacheKey(Lt);let qt=W.programs;W.environment=A.isMeshStandardMaterial?q.environment:null,W.fog=q.fog,W.envMap=(A.isMeshStandardMaterial?C:x).get(A.envMap||W.environment),W.envMapRotation=W.environment!==null&&A.envMap===null?q.environmentRotation:A.envMapRotation,qt===void 0&&(A.addEventListener("dispose",Vt),qt=new Map,W.programs=qt);let $t=qt.get(Gt);if($t!==void 0){if(W.currentProgram===$t&&W.lightsStateVersion===It)return cn(A,Lt),$t}else Lt.uniforms=ut.getUniforms(A),A.onBeforeCompile(Lt,S),$t=ut.acquireProgram(Lt,Gt),qt.set(Gt,$t),W.uniforms=Lt.uniforms;const kt=W.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(kt.clippingPlanes=ft.uniform),cn(A,Lt),W.needsLights=ae(A),W.lightsStateVersion=It,W.needsLights&&(kt.ambientLightColor.value=G.state.ambient,kt.lightProbe.value=G.state.probe,kt.directionalLights.value=G.state.directional,kt.directionalLightShadows.value=G.state.directionalShadow,kt.spotLights.value=G.state.spot,kt.spotLightShadows.value=G.state.spotShadow,kt.rectAreaLights.value=G.state.rectArea,kt.ltc_1.value=G.state.rectAreaLTC1,kt.ltc_2.value=G.state.rectAreaLTC2,kt.pointLights.value=G.state.point,kt.pointLightShadows.value=G.state.pointShadow,kt.hemisphereLights.value=G.state.hemi,kt.directionalShadowMap.value=G.state.directionalShadowMap,kt.directionalShadowMatrix.value=G.state.directionalShadowMatrix,kt.spotShadowMap.value=G.state.spotShadowMap,kt.spotLightMatrix.value=G.state.spotLightMatrix,kt.spotLightMap.value=G.state.spotLightMap,kt.pointShadowMap.value=G.state.pointShadowMap,kt.pointShadowMatrix.value=G.state.pointShadowMatrix),W.currentProgram=$t,W.uniformsList=null,$t}function me(A){if(A.uniformsList===null){const q=A.currentProgram.getUniforms();A.uniformsList=xa.seqWithValue(q.seq,A.uniforms)}return A.uniformsList}function cn(A,q){const D=J.get(A);D.outputColorSpace=q.outputColorSpace,D.batching=q.batching,D.batchingColor=q.batchingColor,D.instancing=q.instancing,D.instancingColor=q.instancingColor,D.instancingMorph=q.instancingMorph,D.skinning=q.skinning,D.morphTargets=q.morphTargets,D.morphNormals=q.morphNormals,D.morphColors=q.morphColors,D.morphTargetsCount=q.morphTargetsCount,D.numClippingPlanes=q.numClippingPlanes,D.numIntersection=q.numClipIntersection,D.vertexAlphas=q.vertexAlphas,D.vertexTangents=q.vertexTangents,D.toneMapping=q.toneMapping}function He(A,q,D,W,G){q.isScene!==!0&&(q=lt),w.resetTextureUnits();const mt=q.fog,It=W.isMeshStandardMaterial?q.environment:null,Lt=R===null?S.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:Ms,Gt=(W.isMeshStandardMaterial?C:x).get(W.envMap||It),qt=W.vertexColors===!0&&!!D.attributes.color&&D.attributes.color.itemSize===4,$t=!!D.attributes.tangent&&(!!W.normalMap||W.anisotropy>0),kt=!!D.morphAttributes.position,ee=!!D.morphAttributes.normal,de=!!D.morphAttributes.color;let ue=gs;W.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(ue=S.toneMapping);const Pt=D.morphAttributes.position||D.morphAttributes.normal||D.morphAttributes.color,jt=Pt!==void 0?Pt.length:0,Ht=J.get(W),oe=m.state.lights;if(rt===!0&&(pt===!0||A!==tt)){const Re=A===tt&&W.id===z;ft.setState(W,A,Re)}let Tt=!1;W.version===Ht.__version?(Ht.needsLights&&Ht.lightsStateVersion!==oe.state.version||Ht.outputColorSpace!==Lt||G.isBatchedMesh&&Ht.batching===!1||!G.isBatchedMesh&&Ht.batching===!0||G.isBatchedMesh&&Ht.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&Ht.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&Ht.instancing===!1||!G.isInstancedMesh&&Ht.instancing===!0||G.isSkinnedMesh&&Ht.skinning===!1||!G.isSkinnedMesh&&Ht.skinning===!0||G.isInstancedMesh&&Ht.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Ht.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&Ht.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&Ht.instancingMorph===!1&&G.morphTexture!==null||Ht.envMap!==Gt||W.fog===!0&&Ht.fog!==mt||Ht.numClippingPlanes!==void 0&&(Ht.numClippingPlanes!==ft.numPlanes||Ht.numIntersection!==ft.numIntersection)||Ht.vertexAlphas!==qt||Ht.vertexTangents!==$t||Ht.morphTargets!==kt||Ht.morphNormals!==ee||Ht.morphColors!==de||Ht.toneMapping!==ue||Ht.morphTargetsCount!==jt)&&(Tt=!0):(Tt=!0,Ht.__version=W.version);let Me=Ht.currentProgram;Tt===!0&&(Me=Le(W,q,G));let Pe=!1,ge=!1,Ue=!1;const pe=Me.getUniforms(),Ie=Ht.uniforms;if(N.useProgram(Me.program)&&(Pe=!0,ge=!0,Ue=!0),W.id!==z&&(z=W.id,ge=!0),Pe||tt!==A){F.reverseDepthBuffer?(wt.copy(A.projectionMatrix),E_(wt),T_(wt),pe.setValue(g,"projectionMatrix",wt)):pe.setValue(g,"projectionMatrix",A.projectionMatrix),pe.setValue(g,"viewMatrix",A.matrixWorldInverse);const Re=pe.map.cameraPosition;Re!==void 0&&Re.setValue(g,ht.setFromMatrixPosition(A.matrixWorld)),F.logarithmicDepthBuffer&&pe.setValue(g,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(W.isMeshPhongMaterial||W.isMeshToonMaterial||W.isMeshLambertMaterial||W.isMeshBasicMaterial||W.isMeshStandardMaterial||W.isShaderMaterial)&&pe.setValue(g,"isOrthographic",A.isOrthographicCamera===!0),tt!==A&&(tt=A,ge=!0,Ue=!0)}if(G.isSkinnedMesh){pe.setOptional(g,G,"bindMatrix"),pe.setOptional(g,G,"bindMatrixInverse");const Re=G.skeleton;Re&&(Re.boneTexture===null&&Re.computeBoneTexture(),pe.setValue(g,"boneTexture",Re.boneTexture,w))}G.isBatchedMesh&&(pe.setOptional(g,G,"batchingTexture"),pe.setValue(g,"batchingTexture",G._matricesTexture,w),pe.setOptional(g,G,"batchingIdTexture"),pe.setValue(g,"batchingIdTexture",G._indirectTexture,w),pe.setOptional(g,G,"batchingColorTexture"),G._colorsTexture!==null&&pe.setValue(g,"batchingColorTexture",G._colorsTexture,w));const ke=D.morphAttributes;if((ke.position!==void 0||ke.normal!==void 0||ke.color!==void 0)&&Ft.update(G,D,Me),(ge||Ht.receiveShadow!==G.receiveShadow)&&(Ht.receiveShadow=G.receiveShadow,pe.setValue(g,"receiveShadow",G.receiveShadow)),W.isMeshGouraudMaterial&&W.envMap!==null&&(Ie.envMap.value=Gt,Ie.flipEnvMap.value=Gt.isCubeTexture&&Gt.isRenderTargetTexture===!1?-1:1),W.isMeshStandardMaterial&&W.envMap===null&&q.environment!==null&&(Ie.envMapIntensity.value=q.environmentIntensity),ge&&(pe.setValue(g,"toneMappingExposure",S.toneMappingExposure),Ht.needsLights&&Ct(Ie,Ue),mt&&W.fog===!0&&at.refreshFogUniforms(Ie,mt),at.refreshMaterialUniforms(Ie,W,st,j,m.state.transmissionRenderTarget[A.id]),xa.upload(g,me(Ht),Ie,w)),W.isShaderMaterial&&W.uniformsNeedUpdate===!0&&(xa.upload(g,me(Ht),Ie,w),W.uniformsNeedUpdate=!1),W.isSpriteMaterial&&pe.setValue(g,"center",G.center),pe.setValue(g,"modelViewMatrix",G.modelViewMatrix),pe.setValue(g,"normalMatrix",G.normalMatrix),pe.setValue(g,"modelMatrix",G.matrixWorld),W.isShaderMaterial||W.isRawShaderMaterial){const Re=W.uniformsGroups;for(let ze=0,Qe=Re.length;ze<Qe;ze++){const je=Re[ze];H.update(je,Me),H.bind(je,Me)}}return Me}function Ct(A,q){A.ambientLightColor.needsUpdate=q,A.lightProbe.needsUpdate=q,A.directionalLights.needsUpdate=q,A.directionalLightShadows.needsUpdate=q,A.pointLights.needsUpdate=q,A.pointLightShadows.needsUpdate=q,A.spotLights.needsUpdate=q,A.spotLightShadows.needsUpdate=q,A.rectAreaLights.needsUpdate=q,A.hemisphereLights.needsUpdate=q}function ae(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return B},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(A,q,D){J.get(A.texture).__webglTexture=q,J.get(A.depthTexture).__webglTexture=D;const W=J.get(A);W.__hasExternalTextures=!0,W.__autoAllocateDepthBuffer=D===void 0,W.__autoAllocateDepthBuffer||L.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),W.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(A,q){const D=J.get(A);D.__webglFramebuffer=q,D.__useDefaultFramebuffer=q===void 0},this.setRenderTarget=function(A,q=0,D=0){R=A,B=q,I=D;let W=!0,G=null,mt=!1,It=!1;if(A){const Gt=J.get(A);if(Gt.__useDefaultFramebuffer!==void 0)N.bindFramebuffer(g.FRAMEBUFFER,null),W=!1;else if(Gt.__webglFramebuffer===void 0)w.setupRenderTarget(A);else if(Gt.__hasExternalTextures)w.rebindTextures(A,J.get(A.texture).__webglTexture,J.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const kt=A.depthTexture;if(Gt.__boundDepthTexture!==kt){if(kt!==null&&J.has(kt)&&(A.width!==kt.image.width||A.height!==kt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");w.setupDepthRenderbuffer(A)}}const qt=A.texture;(qt.isData3DTexture||qt.isDataArrayTexture||qt.isCompressedArrayTexture)&&(It=!0);const $t=J.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray($t[q])?G=$t[q][D]:G=$t[q],mt=!0):A.samples>0&&w.useMultisampledRTT(A)===!1?G=J.get(A).__webglMultisampledFramebuffer:Array.isArray($t)?G=$t[D]:G=$t,M.copy(A.viewport),E.copy(A.scissor),U=A.scissorTest}else M.copy(Mt).multiplyScalar(st).floor(),E.copy(gt).multiplyScalar(st).floor(),U=Nt;if(N.bindFramebuffer(g.FRAMEBUFFER,G)&&W&&N.drawBuffers(A,G),N.viewport(M),N.scissor(E),N.setScissorTest(U),mt){const Gt=J.get(A.texture);g.framebufferTexture2D(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_CUBE_MAP_POSITIVE_X+q,Gt.__webglTexture,D)}else if(It){const Gt=J.get(A.texture),qt=q||0;g.framebufferTextureLayer(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,Gt.__webglTexture,D||0,qt)}z=-1},this.readRenderTargetPixels=function(A,q,D,W,G,mt,It){if(!(A&&A.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Lt=J.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&It!==void 0&&(Lt=Lt[It]),Lt){N.bindFramebuffer(g.FRAMEBUFFER,Lt);try{const Gt=A.texture,qt=Gt.format,$t=Gt.type;if(!F.textureFormatReadable(qt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!F.textureTypeReadable($t)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}q>=0&&q<=A.width-W&&D>=0&&D<=A.height-G&&g.readPixels(q,D,W,G,Bt.convert(qt),Bt.convert($t),mt)}finally{const Gt=R!==null?J.get(R).__webglFramebuffer:null;N.bindFramebuffer(g.FRAMEBUFFER,Gt)}}},this.readRenderTargetPixelsAsync=async function(A,q,D,W,G,mt,It){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Lt=J.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&It!==void 0&&(Lt=Lt[It]),Lt){const Gt=A.texture,qt=Gt.format,$t=Gt.type;if(!F.textureFormatReadable(qt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!F.textureTypeReadable($t))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(q>=0&&q<=A.width-W&&D>=0&&D<=A.height-G){N.bindFramebuffer(g.FRAMEBUFFER,Lt);const kt=g.createBuffer();g.bindBuffer(g.PIXEL_PACK_BUFFER,kt),g.bufferData(g.PIXEL_PACK_BUFFER,mt.byteLength,g.STREAM_READ),g.readPixels(q,D,W,G,Bt.convert(qt),Bt.convert($t),0);const ee=R!==null?J.get(R).__webglFramebuffer:null;N.bindFramebuffer(g.FRAMEBUFFER,ee);const de=g.fenceSync(g.SYNC_GPU_COMMANDS_COMPLETE,0);return g.flush(),await b_(g,de,4),g.bindBuffer(g.PIXEL_PACK_BUFFER,kt),g.getBufferSubData(g.PIXEL_PACK_BUFFER,0,mt),g.deleteBuffer(kt),g.deleteSync(de),mt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(A,q=null,D=0){A.isTexture!==!0&&(_a("WebGLRenderer: copyFramebufferToTexture function signature has changed."),q=arguments[0]||null,A=arguments[1]);const W=Math.pow(2,-D),G=Math.floor(A.image.width*W),mt=Math.floor(A.image.height*W),It=q!==null?q.x:0,Lt=q!==null?q.y:0;w.setTexture2D(A,0),g.copyTexSubImage2D(g.TEXTURE_2D,D,0,0,It,Lt,G,mt),N.unbindTexture()},this.copyTextureToTexture=function(A,q,D=null,W=null,G=0){A.isTexture!==!0&&(_a("WebGLRenderer: copyTextureToTexture function signature has changed."),W=arguments[0]||null,A=arguments[1],q=arguments[2],G=arguments[3]||0,D=null);let mt,It,Lt,Gt,qt,$t;D!==null?(mt=D.max.x-D.min.x,It=D.max.y-D.min.y,Lt=D.min.x,Gt=D.min.y):(mt=A.image.width,It=A.image.height,Lt=0,Gt=0),W!==null?(qt=W.x,$t=W.y):(qt=0,$t=0);const kt=Bt.convert(q.format),ee=Bt.convert(q.type);w.setTexture2D(q,0),g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,q.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,q.unpackAlignment);const de=g.getParameter(g.UNPACK_ROW_LENGTH),ue=g.getParameter(g.UNPACK_IMAGE_HEIGHT),Pt=g.getParameter(g.UNPACK_SKIP_PIXELS),jt=g.getParameter(g.UNPACK_SKIP_ROWS),Ht=g.getParameter(g.UNPACK_SKIP_IMAGES),oe=A.isCompressedTexture?A.mipmaps[G]:A.image;g.pixelStorei(g.UNPACK_ROW_LENGTH,oe.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,oe.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Lt),g.pixelStorei(g.UNPACK_SKIP_ROWS,Gt),A.isDataTexture?g.texSubImage2D(g.TEXTURE_2D,G,qt,$t,mt,It,kt,ee,oe.data):A.isCompressedTexture?g.compressedTexSubImage2D(g.TEXTURE_2D,G,qt,$t,oe.width,oe.height,kt,oe.data):g.texSubImage2D(g.TEXTURE_2D,G,qt,$t,mt,It,kt,ee,oe),g.pixelStorei(g.UNPACK_ROW_LENGTH,de),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,ue),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Pt),g.pixelStorei(g.UNPACK_SKIP_ROWS,jt),g.pixelStorei(g.UNPACK_SKIP_IMAGES,Ht),G===0&&q.generateMipmaps&&g.generateMipmap(g.TEXTURE_2D),N.unbindTexture()},this.copyTextureToTexture3D=function(A,q,D=null,W=null,G=0){A.isTexture!==!0&&(_a("WebGLRenderer: copyTextureToTexture3D function signature has changed."),D=arguments[0]||null,W=arguments[1]||null,A=arguments[2],q=arguments[3],G=arguments[4]||0);let mt,It,Lt,Gt,qt,$t,kt,ee,de;const ue=A.isCompressedTexture?A.mipmaps[G]:A.image;D!==null?(mt=D.max.x-D.min.x,It=D.max.y-D.min.y,Lt=D.max.z-D.min.z,Gt=D.min.x,qt=D.min.y,$t=D.min.z):(mt=ue.width,It=ue.height,Lt=ue.depth,Gt=0,qt=0,$t=0),W!==null?(kt=W.x,ee=W.y,de=W.z):(kt=0,ee=0,de=0);const Pt=Bt.convert(q.format),jt=Bt.convert(q.type);let Ht;if(q.isData3DTexture)w.setTexture3D(q,0),Ht=g.TEXTURE_3D;else if(q.isDataArrayTexture||q.isCompressedArrayTexture)w.setTexture2DArray(q,0),Ht=g.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,q.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,q.unpackAlignment);const oe=g.getParameter(g.UNPACK_ROW_LENGTH),Tt=g.getParameter(g.UNPACK_IMAGE_HEIGHT),Me=g.getParameter(g.UNPACK_SKIP_PIXELS),Pe=g.getParameter(g.UNPACK_SKIP_ROWS),ge=g.getParameter(g.UNPACK_SKIP_IMAGES);g.pixelStorei(g.UNPACK_ROW_LENGTH,ue.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,ue.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Gt),g.pixelStorei(g.UNPACK_SKIP_ROWS,qt),g.pixelStorei(g.UNPACK_SKIP_IMAGES,$t),A.isDataTexture||A.isData3DTexture?g.texSubImage3D(Ht,G,kt,ee,de,mt,It,Lt,Pt,jt,ue.data):q.isCompressedArrayTexture?g.compressedTexSubImage3D(Ht,G,kt,ee,de,mt,It,Lt,Pt,ue.data):g.texSubImage3D(Ht,G,kt,ee,de,mt,It,Lt,Pt,jt,ue),g.pixelStorei(g.UNPACK_ROW_LENGTH,oe),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,Tt),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Me),g.pixelStorei(g.UNPACK_SKIP_ROWS,Pe),g.pixelStorei(g.UNPACK_SKIP_IMAGES,ge),G===0&&q.generateMipmaps&&g.generateMipmap(Ht),N.unbindTexture()},this.initRenderTarget=function(A){J.get(A).__webglFramebuffer===void 0&&w.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?w.setTextureCube(A,0):A.isData3DTexture?w.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?w.setTexture2DArray(A,0):w.setTexture2D(A,0),N.unbindTexture()},this.resetState=function(){B=0,I=0,R=null,N.reset(),Yt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Zi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=t===Pu?"display-p3":"srgb",e.unpackColorSpace=Fe.workingColorSpace===qa?"display-p3":"srgb"}}class Hn extends wn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Ui,this.environmentIntensity=1,this.environmentRotation=new Ui,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class vr extends Do{constructor(t){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new xe(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.alphaMap=t.alphaMap,this.size=t.size,this.sizeAttenuation=t.sizeAttenuation,this.fog=t.fog,this}}const Ad=new nn,ql=new gp,na=new ja,ia=new Q;class sr extends wn{constructor(t=new En,e=new vr){super(),this.isPoints=!0,this.type="Points",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}raycast(t,e){const i=this.geometry,s=this.matrixWorld,o=t.params.Points.threshold,r=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),na.copy(i.boundingSphere),na.applyMatrix4(s),na.radius+=o,t.ray.intersectsSphere(na)===!1)return;Ad.copy(s).invert(),ql.copy(t.ray).applyMatrix4(Ad);const a=o/((this.scale.x+this.scale.y+this.scale.z)/3),c=a*a,l=i.index,u=i.attributes.position;if(l!==null){const d=Math.max(0,r.start),f=Math.min(l.count,r.start+r.count);for(let v=d,y=f;v<y;v++){const m=l.getX(v);ia.fromBufferAttribute(u,m),Pd(ia,m,c,s,t,e,this)}}else{const d=Math.max(0,r.start),f=Math.min(u.count,r.start+r.count);for(let v=d,y=f;v<y;v++)ia.fromBufferAttribute(u,v),Pd(ia,v,c,s,t,e,this)}}updateMorphTargets(){const e=this.geometry.morphAttributes,i=Object.keys(e);if(i.length>0){const s=e[i[0]];if(s!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let o=0,r=s.length;o<r;o++){const a=s[o].name||String(o);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=o}}}}}function Pd(n,t,e,i,s,o,r){const a=ql.distanceSqToPoint(n);if(a<e){const c=new Q;ql.closestPointToPoint(n,c),c.applyMatrix4(i);const l=s.ray.origin.distanceTo(c);if(l<s.near||l>s.far)return;o.push({distance:l,distanceToRay:Math.sqrt(a),point:c,index:t,face:null,faceIndex:null,barycoord:null,object:r})}}class U1 extends In{constructor(t,e,i,s,o,r,a,c,l){super(t,e,i,s,o,r,a,c,l),this.isCanvasTexture=!0,this.needsUpdate=!0}}class Ni{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(t,e){const i=this.getUtoTmapping(t);return this.getPoint(i,e)}getPoints(t=5){const e=[];for(let i=0;i<=t;i++)e.push(this.getPoint(i/t));return e}getSpacedPoints(t=5){const e=[];for(let i=0;i<=t;i++)e.push(this.getPointAt(i/t));return e}getLength(){const t=this.getLengths();return t[t.length-1]}getLengths(t=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===t+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const e=[];let i,s=this.getPoint(0),o=0;e.push(0);for(let r=1;r<=t;r++)i=this.getPoint(r/t),o+=i.distanceTo(s),e.push(o),s=i;return this.cacheArcLengths=e,e}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(t,e){const i=this.getLengths();let s=0;const o=i.length;let r;e?r=e:r=t*i[o-1];let a=0,c=o-1,l;for(;a<=c;)if(s=Math.floor(a+(c-a)/2),l=i[s]-r,l<0)a=s+1;else if(l>0)c=s-1;else{c=s;break}if(s=c,i[s]===r)return s/(o-1);const h=i[s],d=i[s+1]-h,f=(r-h)/d;return(s+f)/(o-1)}getTangent(t,e){let s=t-1e-4,o=t+1e-4;s<0&&(s=0),o>1&&(o=1);const r=this.getPoint(s),a=this.getPoint(o),c=e||(r.isVector2?new Jt:new Q);return c.copy(a).sub(r).normalize(),c}getTangentAt(t,e){const i=this.getUtoTmapping(t);return this.getTangent(i,e)}computeFrenetFrames(t,e){const i=new Q,s=[],o=[],r=[],a=new Q,c=new nn;for(let f=0;f<=t;f++){const v=f/t;s[f]=this.getTangentAt(v,new Q)}o[0]=new Q,r[0]=new Q;let l=Number.MAX_VALUE;const h=Math.abs(s[0].x),u=Math.abs(s[0].y),d=Math.abs(s[0].z);h<=l&&(l=h,i.set(1,0,0)),u<=l&&(l=u,i.set(0,1,0)),d<=l&&i.set(0,0,1),a.crossVectors(s[0],i).normalize(),o[0].crossVectors(s[0],a),r[0].crossVectors(s[0],o[0]);for(let f=1;f<=t;f++){if(o[f]=o[f-1].clone(),r[f]=r[f-1].clone(),a.crossVectors(s[f-1],s[f]),a.length()>Number.EPSILON){a.normalize();const v=Math.acos(xn(s[f-1].dot(s[f]),-1,1));o[f].applyMatrix4(c.makeRotationAxis(a,v))}r[f].crossVectors(s[f],o[f])}if(e===!0){let f=Math.acos(xn(o[0].dot(o[t]),-1,1));f/=t,s[0].dot(a.crossVectors(o[0],o[t]))>0&&(f=-f);for(let v=1;v<=t;v++)o[v].applyMatrix4(c.makeRotationAxis(s[v],f*v)),r[v].crossVectors(s[v],o[v])}return{tangents:s,normals:o,binormals:r}}clone(){return new this.constructor().copy(this)}copy(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}toJSON(){const t={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return t.arcLengthDivisions=this.arcLengthDivisions,t.type=this.type,t}fromJSON(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}}class Du extends Ni{constructor(t=0,e=0,i=1,s=1,o=0,r=Math.PI*2,a=!1,c=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=t,this.aY=e,this.xRadius=i,this.yRadius=s,this.aStartAngle=o,this.aEndAngle=r,this.aClockwise=a,this.aRotation=c}getPoint(t,e=new Jt){const i=e,s=Math.PI*2;let o=this.aEndAngle-this.aStartAngle;const r=Math.abs(o)<Number.EPSILON;for(;o<0;)o+=s;for(;o>s;)o-=s;o<Number.EPSILON&&(r?o=0:o=s),this.aClockwise===!0&&!r&&(o===s?o=-s:o=o-s);const a=this.aStartAngle+t*o;let c=this.aX+this.xRadius*Math.cos(a),l=this.aY+this.yRadius*Math.sin(a);if(this.aRotation!==0){const h=Math.cos(this.aRotation),u=Math.sin(this.aRotation),d=c-this.aX,f=l-this.aY;c=d*h-f*u+this.aX,l=d*u+f*h+this.aY}return i.set(c,l)}copy(t){return super.copy(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}toJSON(){const t=super.toJSON();return t.aX=this.aX,t.aY=this.aY,t.xRadius=this.xRadius,t.yRadius=this.yRadius,t.aStartAngle=this.aStartAngle,t.aEndAngle=this.aEndAngle,t.aClockwise=this.aClockwise,t.aRotation=this.aRotation,t}fromJSON(t){return super.fromJSON(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}}class N1 extends Du{constructor(t,e,i,s,o,r){super(t,e,i,i,s,o,r),this.isArcCurve=!0,this.type="ArcCurve"}}function Uu(){let n=0,t=0,e=0,i=0;function s(o,r,a,c){n=o,t=a,e=-3*o+3*r-2*a-c,i=2*o-2*r+a+c}return{initCatmullRom:function(o,r,a,c,l){s(r,a,l*(a-o),l*(c-r))},initNonuniformCatmullRom:function(o,r,a,c,l,h,u){let d=(r-o)/l-(a-o)/(l+h)+(a-r)/h,f=(a-r)/h-(c-r)/(h+u)+(c-a)/u;d*=h,f*=h,s(r,a,d,f)},calc:function(o){const r=o*o,a=r*o;return n+t*o+e*r+i*a}}}const sa=new Q,Vc=new Uu,Wc=new Uu,Xc=new Uu;class F1 extends Ni{constructor(t=[],e=!1,i="centripetal",s=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=t,this.closed=e,this.curveType=i,this.tension=s}getPoint(t,e=new Q){const i=e,s=this.points,o=s.length,r=(o-(this.closed?0:1))*t;let a=Math.floor(r),c=r-a;this.closed?a+=a>0?0:(Math.floor(Math.abs(a)/o)+1)*o:c===0&&a===o-1&&(a=o-2,c=1);let l,h;this.closed||a>0?l=s[(a-1)%o]:(sa.subVectors(s[0],s[1]).add(s[0]),l=sa);const u=s[a%o],d=s[(a+1)%o];if(this.closed||a+2<o?h=s[(a+2)%o]:(sa.subVectors(s[o-1],s[o-2]).add(s[o-1]),h=sa),this.curveType==="centripetal"||this.curveType==="chordal"){const f=this.curveType==="chordal"?.5:.25;let v=Math.pow(l.distanceToSquared(u),f),y=Math.pow(u.distanceToSquared(d),f),m=Math.pow(d.distanceToSquared(h),f);y<1e-4&&(y=1),v<1e-4&&(v=y),m<1e-4&&(m=y),Vc.initNonuniformCatmullRom(l.x,u.x,d.x,h.x,v,y,m),Wc.initNonuniformCatmullRom(l.y,u.y,d.y,h.y,v,y,m),Xc.initNonuniformCatmullRom(l.z,u.z,d.z,h.z,v,y,m)}else this.curveType==="catmullrom"&&(Vc.initCatmullRom(l.x,u.x,d.x,h.x,this.tension),Wc.initCatmullRom(l.y,u.y,d.y,h.y,this.tension),Xc.initCatmullRom(l.z,u.z,d.z,h.z,this.tension));return i.set(Vc.calc(c),Wc.calc(c),Xc.calc(c)),i}copy(t){super.copy(t),this.points=[];for(let e=0,i=t.points.length;e<i;e++){const s=t.points[e];this.points.push(s.clone())}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,i=this.points.length;e<i;e++){const s=this.points[e];t.points.push(s.toArray())}return t.closed=this.closed,t.curveType=this.curveType,t.tension=this.tension,t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,i=t.points.length;e<i;e++){const s=t.points[e];this.points.push(new Q().fromArray(s))}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}}function Rd(n,t,e,i,s){const o=(i-t)*.5,r=(s-e)*.5,a=n*n,c=n*a;return(2*e-2*i+o+r)*c+(-3*e+3*i-2*o-r)*a+o*n+e}function O1(n,t){const e=1-n;return e*e*t}function B1(n,t){return 2*(1-n)*n*t}function z1(n,t){return n*n*t}function or(n,t,e,i){return O1(n,t)+B1(n,e)+z1(n,i)}function G1(n,t){const e=1-n;return e*e*e*t}function H1(n,t){const e=1-n;return 3*e*e*n*t}function k1(n,t){return 3*(1-n)*n*n*t}function V1(n,t){return n*n*n*t}function rr(n,t,e,i,s){return G1(n,t)+H1(n,e)+k1(n,i)+V1(n,s)}class Cp extends Ni{constructor(t=new Jt,e=new Jt,i=new Jt,s=new Jt){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=t,this.v1=e,this.v2=i,this.v3=s}getPoint(t,e=new Jt){const i=e,s=this.v0,o=this.v1,r=this.v2,a=this.v3;return i.set(rr(t,s.x,o.x,r.x,a.x),rr(t,s.y,o.y,r.y,a.y)),i}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class W1 extends Ni{constructor(t=new Q,e=new Q,i=new Q,s=new Q){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=t,this.v1=e,this.v2=i,this.v3=s}getPoint(t,e=new Q){const i=e,s=this.v0,o=this.v1,r=this.v2,a=this.v3;return i.set(rr(t,s.x,o.x,r.x,a.x),rr(t,s.y,o.y,r.y,a.y),rr(t,s.z,o.z,r.z,a.z)),i}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class Ip extends Ni{constructor(t=new Jt,e=new Jt){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=t,this.v2=e}getPoint(t,e=new Jt){const i=e;return t===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(t).add(this.v1)),i}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new Jt){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class X1 extends Ni{constructor(t=new Q,e=new Q){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=t,this.v2=e}getPoint(t,e=new Q){const i=e;return t===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(t).add(this.v1)),i}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new Q){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Lp extends Ni{constructor(t=new Jt,e=new Jt,i=new Jt){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=t,this.v1=e,this.v2=i}getPoint(t,e=new Jt){const i=e,s=this.v0,o=this.v1,r=this.v2;return i.set(or(t,s.x,o.x,r.x),or(t,s.y,o.y,r.y)),i}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class q1 extends Ni{constructor(t=new Q,e=new Q,i=new Q){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=t,this.v1=e,this.v2=i}getPoint(t,e=new Q){const i=e,s=this.v0,o=this.v1,r=this.v2;return i.set(or(t,s.x,o.x,r.x),or(t,s.y,o.y,r.y),or(t,s.z,o.z,r.z)),i}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Dp extends Ni{constructor(t=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=t}getPoint(t,e=new Jt){const i=e,s=this.points,o=(s.length-1)*t,r=Math.floor(o),a=o-r,c=s[r===0?r:r-1],l=s[r],h=s[r>s.length-2?s.length-1:r+1],u=s[r>s.length-3?s.length-1:r+2];return i.set(Rd(a,c.x,l.x,h.x,u.x),Rd(a,c.y,l.y,h.y,u.y)),i}copy(t){super.copy(t),this.points=[];for(let e=0,i=t.points.length;e<i;e++){const s=t.points[e];this.points.push(s.clone())}return this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,i=this.points.length;e<i;e++){const s=this.points[e];t.points.push(s.toArray())}return t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,i=t.points.length;e<i;e++){const s=t.points[e];this.points.push(new Jt().fromArray(s))}return this}}var jl=Object.freeze({__proto__:null,ArcCurve:N1,CatmullRomCurve3:F1,CubicBezierCurve:Cp,CubicBezierCurve3:W1,EllipseCurve:Du,LineCurve:Ip,LineCurve3:X1,QuadraticBezierCurve:Lp,QuadraticBezierCurve3:q1,SplineCurve:Dp});class j1 extends Ni{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(t){this.curves.push(t)}closePath(){const t=this.curves[0].getPoint(0),e=this.curves[this.curves.length-1].getPoint(1);if(!t.equals(e)){const i=t.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new jl[i](e,t))}return this}getPoint(t,e){const i=t*this.getLength(),s=this.getCurveLengths();let o=0;for(;o<s.length;){if(s[o]>=i){const r=s[o]-i,a=this.curves[o],c=a.getLength(),l=c===0?0:1-r/c;return a.getPointAt(l,e)}o++}return null}getLength(){const t=this.getCurveLengths();return t[t.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const t=[];let e=0;for(let i=0,s=this.curves.length;i<s;i++)e+=this.curves[i].getLength(),t.push(e);return this.cacheLengths=t,t}getSpacedPoints(t=40){const e=[];for(let i=0;i<=t;i++)e.push(this.getPoint(i/t));return this.autoClose&&e.push(e[0]),e}getPoints(t=12){const e=[];let i;for(let s=0,o=this.curves;s<o.length;s++){const r=o[s],a=r.isEllipseCurve?t*2:r.isLineCurve||r.isLineCurve3?1:r.isSplineCurve?t*r.points.length:t,c=r.getPoints(a);for(let l=0;l<c.length;l++){const h=c[l];i&&i.equals(h)||(e.push(h),i=h)}}return this.autoClose&&e.length>1&&!e[e.length-1].equals(e[0])&&e.push(e[0]),e}copy(t){super.copy(t),this.curves=[];for(let e=0,i=t.curves.length;e<i;e++){const s=t.curves[e];this.curves.push(s.clone())}return this.autoClose=t.autoClose,this}toJSON(){const t=super.toJSON();t.autoClose=this.autoClose,t.curves=[];for(let e=0,i=this.curves.length;e<i;e++){const s=this.curves[e];t.curves.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.autoClose=t.autoClose,this.curves=[];for(let e=0,i=t.curves.length;e<i;e++){const s=t.curves[e];this.curves.push(new jl[s.type]().fromJSON(s))}return this}}class Yl extends j1{constructor(t){super(),this.type="Path",this.currentPoint=new Jt,t&&this.setFromPoints(t)}setFromPoints(t){this.moveTo(t[0].x,t[0].y);for(let e=1,i=t.length;e<i;e++)this.lineTo(t[e].x,t[e].y);return this}moveTo(t,e){return this.currentPoint.set(t,e),this}lineTo(t,e){const i=new Ip(this.currentPoint.clone(),new Jt(t,e));return this.curves.push(i),this.currentPoint.set(t,e),this}quadraticCurveTo(t,e,i,s){const o=new Lp(this.currentPoint.clone(),new Jt(t,e),new Jt(i,s));return this.curves.push(o),this.currentPoint.set(i,s),this}bezierCurveTo(t,e,i,s,o,r){const a=new Cp(this.currentPoint.clone(),new Jt(t,e),new Jt(i,s),new Jt(o,r));return this.curves.push(a),this.currentPoint.set(o,r),this}splineThru(t){const e=[this.currentPoint.clone()].concat(t),i=new Dp(e);return this.curves.push(i),this.currentPoint.copy(t[t.length-1]),this}arc(t,e,i,s,o,r){const a=this.currentPoint.x,c=this.currentPoint.y;return this.absarc(t+a,e+c,i,s,o,r),this}absarc(t,e,i,s,o,r){return this.absellipse(t,e,i,i,s,o,r),this}ellipse(t,e,i,s,o,r,a,c){const l=this.currentPoint.x,h=this.currentPoint.y;return this.absellipse(t+l,e+h,i,s,o,r,a,c),this}absellipse(t,e,i,s,o,r,a,c){const l=new Du(t,e,i,s,o,r,a,c);if(this.curves.length>0){const u=l.getPoint(0);u.equals(this.currentPoint)||this.lineTo(u.x,u.y)}this.curves.push(l);const h=l.getPoint(1);return this.currentPoint.copy(h),this}copy(t){return super.copy(t),this.currentPoint.copy(t.currentPoint),this}toJSON(){const t=super.toJSON();return t.currentPoint=this.currentPoint.toArray(),t}fromJSON(t){return super.fromJSON(t),this.currentPoint.fromArray(t.currentPoint),this}}class Ce extends En{constructor(t=1,e=32,i=0,s=Math.PI*2){super(),this.type="CircleGeometry",this.parameters={radius:t,segments:e,thetaStart:i,thetaLength:s},e=Math.max(3,e);const o=[],r=[],a=[],c=[],l=new Q,h=new Jt;r.push(0,0,0),a.push(0,0,1),c.push(.5,.5);for(let u=0,d=3;u<=e;u++,d+=3){const f=i+u/e*s;l.x=t*Math.cos(f),l.y=t*Math.sin(f),r.push(l.x,l.y,l.z),a.push(0,0,1),h.x=(r[d]/t+1)/2,h.y=(r[d+1]/t+1)/2,c.push(h.x,h.y)}for(let u=1;u<=e;u++)o.push(u,u+1,0);this.setIndex(o),this.setAttribute("position",new sn(r,3)),this.setAttribute("normal",new sn(a,3)),this.setAttribute("uv",new sn(c,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new Ce(t.radius,t.segments,t.thetaStart,t.thetaLength)}}class ne extends En{constructor(t=1,e=1,i=1,s=32,o=1,r=!1,a=0,c=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:t,radiusBottom:e,height:i,radialSegments:s,heightSegments:o,openEnded:r,thetaStart:a,thetaLength:c};const l=this;s=Math.floor(s),o=Math.floor(o);const h=[],u=[],d=[],f=[];let v=0;const y=[],m=i/2;let p=0;T(),r===!1&&(t>0&&S(!0),e>0&&S(!1)),this.setIndex(h),this.setAttribute("position",new sn(u,3)),this.setAttribute("normal",new sn(d,3)),this.setAttribute("uv",new sn(f,2));function T(){const b=new Q,B=new Q;let I=0;const R=(e-t)/i;for(let z=0;z<=o;z++){const tt=[],M=z/o,E=M*(e-t)+t;for(let U=0;U<=s;U++){const $=U/s,Z=$*c+a,ct=Math.sin(Z),j=Math.cos(Z);B.x=E*ct,B.y=-M*i+m,B.z=E*j,u.push(B.x,B.y,B.z),b.set(ct,R,j).normalize(),d.push(b.x,b.y,b.z),f.push($,1-M),tt.push(v++)}y.push(tt)}for(let z=0;z<s;z++)for(let tt=0;tt<o;tt++){const M=y[tt][z],E=y[tt+1][z],U=y[tt+1][z+1],$=y[tt][z+1];t>0&&(h.push(M,E,$),I+=3),e>0&&(h.push(E,U,$),I+=3)}l.addGroup(p,I,0),p+=I}function S(b){const B=v,I=new Jt,R=new Q;let z=0;const tt=b===!0?t:e,M=b===!0?1:-1;for(let U=1;U<=s;U++)u.push(0,m*M,0),d.push(0,M,0),f.push(.5,.5),v++;const E=v;for(let U=0;U<=s;U++){const Z=U/s*c+a,ct=Math.cos(Z),j=Math.sin(Z);R.x=tt*j,R.y=m*M,R.z=tt*ct,u.push(R.x,R.y,R.z),d.push(0,M,0),I.x=ct*.5+.5,I.y=j*.5*M+.5,f.push(I.x,I.y),v++}for(let U=0;U<s;U++){const $=B+U,Z=E+U;b===!0?h.push(Z,Z+1,$):h.push(Z+1,Z,$),z+=3}l.addGroup(p,z,b===!0?1:2),p+=z}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new ne(t.radiusTop,t.radiusBottom,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class ai extends ne{constructor(t=1,e=1,i=32,s=1,o=!1,r=0,a=Math.PI*2){super(0,t,e,i,s,o,r,a),this.type="ConeGeometry",this.parameters={radius:t,height:e,radialSegments:i,heightSegments:s,openEnded:o,thetaStart:r,thetaLength:a}}static fromJSON(t){return new ai(t.radius,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class Sn extends Yl{constructor(t){super(t),this.uuid=Vs(),this.type="Shape",this.holes=[]}getPointsHoles(t){const e=[];for(let i=0,s=this.holes.length;i<s;i++)e[i]=this.holes[i].getPoints(t);return e}extractPoints(t){return{shape:this.getPoints(t),holes:this.getPointsHoles(t)}}copy(t){super.copy(t),this.holes=[];for(let e=0,i=t.holes.length;e<i;e++){const s=t.holes[e];this.holes.push(s.clone())}return this}toJSON(){const t=super.toJSON();t.uuid=this.uuid,t.holes=[];for(let e=0,i=this.holes.length;e<i;e++){const s=this.holes[e];t.holes.push(s.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.uuid=t.uuid,this.holes=[];for(let e=0,i=t.holes.length;e<i;e++){const s=t.holes[e];this.holes.push(new Yl().fromJSON(s))}return this}}const Y1={triangulate:function(n,t,e=2){const i=t&&t.length,s=i?t[0]*e:n.length;let o=Up(n,0,s,e,!0);const r=[];if(!o||o.next===o.prev)return r;let a,c,l,h,u,d,f;if(i&&(o=Q1(n,t,o,e)),n.length>80*e){a=l=n[0],c=h=n[1];for(let v=e;v<s;v+=e)u=n[v],d=n[v+1],u<a&&(a=u),d<c&&(c=d),u>l&&(l=u),d>h&&(h=d);f=Math.max(l-a,h-c),f=f!==0?32767/f:0}return _r(o,r,e,a,c,f,0),r}};function Up(n,t,e,i,s){let o,r;if(s===uS(n,t,e,i)>0)for(o=t;o<e;o+=i)r=Cd(o,n[o],n[o+1],r);else for(o=e-i;o>=t;o-=i)r=Cd(o,n[o],n[o+1],r);return r&&Ja(r,r.next)&&(yr(r),r=r.next),r}function Hs(n,t){if(!n)return n;t||(t=n);let e=n,i;do if(i=!1,!e.steiner&&(Ja(e,e.next)||an(e.prev,e,e.next)===0)){if(yr(e),e=t=e.prev,e===e.next)break;i=!0}else e=e.next;while(i||e!==t);return t}function _r(n,t,e,i,s,o,r){if(!n)return;!r&&o&&sS(n,i,s,o);let a=n,c,l;for(;n.prev!==n.next;){if(c=n.prev,l=n.next,o?K1(n,i,s,o):$1(n)){t.push(c.i/e|0),t.push(n.i/e|0),t.push(l.i/e|0),yr(n),n=l.next,a=l.next;continue}if(n=l,n===a){r?r===1?(n=Z1(Hs(n),t,e),_r(n,t,e,i,s,o,2)):r===2&&J1(n,t,e,i,s,o):_r(Hs(n),t,e,i,s,o,1);break}}}function $1(n){const t=n.prev,e=n,i=n.next;if(an(t,e,i)>=0)return!1;const s=t.x,o=e.x,r=i.x,a=t.y,c=e.y,l=i.y,h=s<o?s<r?s:r:o<r?o:r,u=a<c?a<l?a:l:c<l?c:l,d=s>o?s>r?s:r:o>r?o:r,f=a>c?a>l?a:l:c>l?c:l;let v=i.next;for(;v!==t;){if(v.x>=h&&v.x<=d&&v.y>=u&&v.y<=f&&ho(s,a,o,c,r,l,v.x,v.y)&&an(v.prev,v,v.next)>=0)return!1;v=v.next}return!0}function K1(n,t,e,i){const s=n.prev,o=n,r=n.next;if(an(s,o,r)>=0)return!1;const a=s.x,c=o.x,l=r.x,h=s.y,u=o.y,d=r.y,f=a<c?a<l?a:l:c<l?c:l,v=h<u?h<d?h:d:u<d?u:d,y=a>c?a>l?a:l:c>l?c:l,m=h>u?h>d?h:d:u>d?u:d,p=$l(f,v,t,e,i),T=$l(y,m,t,e,i);let S=n.prevZ,b=n.nextZ;for(;S&&S.z>=p&&b&&b.z<=T;){if(S.x>=f&&S.x<=y&&S.y>=v&&S.y<=m&&S!==s&&S!==r&&ho(a,h,c,u,l,d,S.x,S.y)&&an(S.prev,S,S.next)>=0||(S=S.prevZ,b.x>=f&&b.x<=y&&b.y>=v&&b.y<=m&&b!==s&&b!==r&&ho(a,h,c,u,l,d,b.x,b.y)&&an(b.prev,b,b.next)>=0))return!1;b=b.nextZ}for(;S&&S.z>=p;){if(S.x>=f&&S.x<=y&&S.y>=v&&S.y<=m&&S!==s&&S!==r&&ho(a,h,c,u,l,d,S.x,S.y)&&an(S.prev,S,S.next)>=0)return!1;S=S.prevZ}for(;b&&b.z<=T;){if(b.x>=f&&b.x<=y&&b.y>=v&&b.y<=m&&b!==s&&b!==r&&ho(a,h,c,u,l,d,b.x,b.y)&&an(b.prev,b,b.next)>=0)return!1;b=b.nextZ}return!0}function Z1(n,t,e){let i=n;do{const s=i.prev,o=i.next.next;!Ja(s,o)&&Np(s,i,i.next,o)&&xr(s,o)&&xr(o,s)&&(t.push(s.i/e|0),t.push(i.i/e|0),t.push(o.i/e|0),yr(i),yr(i.next),i=n=o),i=i.next}while(i!==n);return Hs(i)}function J1(n,t,e,i,s,o){let r=n;do{let a=r.next.next;for(;a!==r.prev;){if(r.i!==a.i&&aS(r,a)){let c=Fp(r,a);r=Hs(r,r.next),c=Hs(c,c.next),_r(r,t,e,i,s,o,0),_r(c,t,e,i,s,o,0);return}a=a.next}r=r.next}while(r!==n)}function Q1(n,t,e,i){const s=[];let o,r,a,c,l;for(o=0,r=t.length;o<r;o++)a=t[o]*i,c=o<r-1?t[o+1]*i:n.length,l=Up(n,a,c,i,!1),l===l.next&&(l.steiner=!0),s.push(rS(l));for(s.sort(tS),o=0;o<s.length;o++)e=eS(s[o],e);return e}function tS(n,t){return n.x-t.x}function eS(n,t){const e=nS(n,t);if(!e)return t;const i=Fp(e,n);return Hs(i,i.next),Hs(e,e.next)}function nS(n,t){let e=t,i=-1/0,s;const o=n.x,r=n.y;do{if(r<=e.y&&r>=e.next.y&&e.next.y!==e.y){const d=e.x+(r-e.y)*(e.next.x-e.x)/(e.next.y-e.y);if(d<=o&&d>i&&(i=d,s=e.x<e.next.x?e:e.next,d===o))return s}e=e.next}while(e!==t);if(!s)return null;const a=s,c=s.x,l=s.y;let h=1/0,u;e=s;do o>=e.x&&e.x>=c&&o!==e.x&&ho(r<l?o:i,r,c,l,r<l?i:o,r,e.x,e.y)&&(u=Math.abs(r-e.y)/(o-e.x),xr(e,n)&&(u<h||u===h&&(e.x>s.x||e.x===s.x&&iS(s,e)))&&(s=e,h=u)),e=e.next;while(e!==a);return s}function iS(n,t){return an(n.prev,n,t.prev)<0&&an(t.next,n,n.next)<0}function sS(n,t,e,i){let s=n;do s.z===0&&(s.z=$l(s.x,s.y,t,e,i)),s.prevZ=s.prev,s.nextZ=s.next,s=s.next;while(s!==n);s.prevZ.nextZ=null,s.prevZ=null,oS(s)}function oS(n){let t,e,i,s,o,r,a,c,l=1;do{for(e=n,n=null,o=null,r=0;e;){for(r++,i=e,a=0,t=0;t<l&&(a++,i=i.nextZ,!!i);t++);for(c=l;a>0||c>0&&i;)a!==0&&(c===0||!i||e.z<=i.z)?(s=e,e=e.nextZ,a--):(s=i,i=i.nextZ,c--),o?o.nextZ=s:n=s,s.prevZ=o,o=s;e=i}o.nextZ=null,l*=2}while(r>1);return n}function $l(n,t,e,i,s){return n=(n-e)*s|0,t=(t-i)*s|0,n=(n|n<<8)&16711935,n=(n|n<<4)&252645135,n=(n|n<<2)&858993459,n=(n|n<<1)&1431655765,t=(t|t<<8)&16711935,t=(t|t<<4)&252645135,t=(t|t<<2)&858993459,t=(t|t<<1)&1431655765,n|t<<1}function rS(n){let t=n,e=n;do(t.x<e.x||t.x===e.x&&t.y<e.y)&&(e=t),t=t.next;while(t!==n);return e}function ho(n,t,e,i,s,o,r,a){return(s-r)*(t-a)>=(n-r)*(o-a)&&(n-r)*(i-a)>=(e-r)*(t-a)&&(e-r)*(o-a)>=(s-r)*(i-a)}function aS(n,t){return n.next.i!==t.i&&n.prev.i!==t.i&&!cS(n,t)&&(xr(n,t)&&xr(t,n)&&lS(n,t)&&(an(n.prev,n,t.prev)||an(n,t.prev,t))||Ja(n,t)&&an(n.prev,n,n.next)>0&&an(t.prev,t,t.next)>0)}function an(n,t,e){return(t.y-n.y)*(e.x-t.x)-(t.x-n.x)*(e.y-t.y)}function Ja(n,t){return n.x===t.x&&n.y===t.y}function Np(n,t,e,i){const s=ra(an(n,t,e)),o=ra(an(n,t,i)),r=ra(an(e,i,n)),a=ra(an(e,i,t));return!!(s!==o&&r!==a||s===0&&oa(n,e,t)||o===0&&oa(n,i,t)||r===0&&oa(e,n,i)||a===0&&oa(e,t,i))}function oa(n,t,e){return t.x<=Math.max(n.x,e.x)&&t.x>=Math.min(n.x,e.x)&&t.y<=Math.max(n.y,e.y)&&t.y>=Math.min(n.y,e.y)}function ra(n){return n>0?1:n<0?-1:0}function cS(n,t){let e=n;do{if(e.i!==n.i&&e.next.i!==n.i&&e.i!==t.i&&e.next.i!==t.i&&Np(e,e.next,n,t))return!0;e=e.next}while(e!==n);return!1}function xr(n,t){return an(n.prev,n,n.next)<0?an(n,t,n.next)>=0&&an(n,n.prev,t)>=0:an(n,t,n.prev)<0||an(n,n.next,t)<0}function lS(n,t){let e=n,i=!1;const s=(n.x+t.x)/2,o=(n.y+t.y)/2;do e.y>o!=e.next.y>o&&e.next.y!==e.y&&s<(e.next.x-e.x)*(o-e.y)/(e.next.y-e.y)+e.x&&(i=!i),e=e.next;while(e!==n);return i}function Fp(n,t){const e=new Kl(n.i,n.x,n.y),i=new Kl(t.i,t.x,t.y),s=n.next,o=t.prev;return n.next=t,t.prev=n,e.next=s,s.prev=e,i.next=e,e.prev=i,o.next=i,i.prev=o,i}function Cd(n,t,e,i){const s=new Kl(n,t,e);return i?(s.next=i.next,s.prev=i,i.next.prev=s,i.next=s):(s.prev=s,s.next=s),s}function yr(n){n.next.prev=n.prev,n.prev.next=n.next,n.prevZ&&(n.prevZ.nextZ=n.nextZ),n.nextZ&&(n.nextZ.prevZ=n.prevZ)}function Kl(n,t,e){this.i=n,this.x=t,this.y=e,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function uS(n,t,e,i){let s=0;for(let o=t,r=e-i;o<e;o+=i)s+=(n[r]-n[o])*(n[o+1]+n[r+1]),r=o;return s}class Mo{static area(t){const e=t.length;let i=0;for(let s=e-1,o=0;o<e;s=o++)i+=t[s].x*t[o].y-t[o].x*t[s].y;return i*.5}static isClockWise(t){return Mo.area(t)<0}static triangulateShape(t,e){const i=[],s=[],o=[];Id(t),Ld(i,t);let r=t.length;e.forEach(Id);for(let c=0;c<e.length;c++)s.push(r),r+=e[c].length,Ld(i,e[c]);const a=Y1.triangulate(i,s);for(let c=0;c<a.length;c+=3)o.push(a.slice(c,c+3));return o}}function Id(n){const t=n.length;t>2&&n[t-1].equals(n[0])&&n.pop()}function Ld(n,t){for(let e=0;e<t.length;e++)n.push(t[e].x),n.push(t[e].y)}class Dn extends En{constructor(t=new Sn([new Jt(.5,.5),new Jt(-.5,.5),new Jt(-.5,-.5),new Jt(.5,-.5)]),e={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:t,options:e},t=Array.isArray(t)?t:[t];const i=this,s=[],o=[];for(let a=0,c=t.length;a<c;a++){const l=t[a];r(l)}this.setAttribute("position",new sn(s,3)),this.setAttribute("uv",new sn(o,2)),this.computeVertexNormals();function r(a){const c=[],l=e.curveSegments!==void 0?e.curveSegments:12,h=e.steps!==void 0?e.steps:1,u=e.depth!==void 0?e.depth:1;let d=e.bevelEnabled!==void 0?e.bevelEnabled:!0,f=e.bevelThickness!==void 0?e.bevelThickness:.2,v=e.bevelSize!==void 0?e.bevelSize:f-.1,y=e.bevelOffset!==void 0?e.bevelOffset:0,m=e.bevelSegments!==void 0?e.bevelSegments:3;const p=e.extrudePath,T=e.UVGenerator!==void 0?e.UVGenerator:hS;let S,b=!1,B,I,R,z;p&&(S=p.getSpacedPoints(h),b=!0,d=!1,B=p.computeFrenetFrames(h,!1),I=new Q,R=new Q,z=new Q),d||(m=0,f=0,v=0,y=0);const tt=a.extractPoints(l);let M=tt.shape;const E=tt.holes;if(!Mo.isClockWise(M)){M=M.reverse();for(let nt=0,g=E.length;nt<g;nt++){const P=E[nt];Mo.isClockWise(P)&&(E[nt]=P.reverse())}}const $=Mo.triangulateShape(M,E),Z=M;for(let nt=0,g=E.length;nt<g;nt++){const P=E[nt];M=M.concat(P)}function ct(nt,g,P){return g||console.error("THREE.ExtrudeGeometry: vec does not exist"),nt.clone().addScaledVector(g,P)}const j=M.length,st=$.length;function k(nt,g,P){let L,F,N;const K=nt.x-g.x,J=nt.y-g.y,w=P.x-nt.x,x=P.y-nt.y,C=K*K+J*J,Y=K*x-J*w;if(Math.abs(Y)>Number.EPSILON){const V=Math.sqrt(C),X=Math.sqrt(w*w+x*x),ut=g.x-J/V,at=g.y+K/V,vt=P.x-x/X,At=P.y+w/X,ft=((vt-ut)*x-(At-at)*w)/(K*x-J*w);L=ut+K*ft-nt.x,F=at+J*ft-nt.y;const _t=L*L+F*F;if(_t<=2)return new Jt(L,F);N=Math.sqrt(_t/2)}else{let V=!1;K>Number.EPSILON?w>Number.EPSILON&&(V=!0):K<-Number.EPSILON?w<-Number.EPSILON&&(V=!0):Math.sign(J)===Math.sign(x)&&(V=!0),V?(L=-J,F=K,N=Math.sqrt(C)):(L=K,F=J,N=Math.sqrt(C/2))}return new Jt(L/N,F/N)}const xt=[];for(let nt=0,g=Z.length,P=g-1,L=nt+1;nt<g;nt++,P++,L++)P===g&&(P=0),L===g&&(L=0),xt[nt]=k(Z[nt],Z[P],Z[L]);const Mt=[];let gt,Nt=xt.concat();for(let nt=0,g=E.length;nt<g;nt++){const P=E[nt];gt=[];for(let L=0,F=P.length,N=F-1,K=L+1;L<F;L++,N++,K++)N===F&&(N=0),K===F&&(K=0),gt[L]=k(P[L],P[N],P[K]);Mt.push(gt),Nt=Nt.concat(gt)}for(let nt=0;nt<m;nt++){const g=nt/m,P=f*Math.cos(g*Math.PI/2),L=v*Math.sin(g*Math.PI/2)+y;for(let F=0,N=Z.length;F<N;F++){const K=ct(Z[F],xt[F],L);O(K.x,K.y,-P)}for(let F=0,N=E.length;F<N;F++){const K=E[F];gt=Mt[F];for(let J=0,w=K.length;J<w;J++){const x=ct(K[J],gt[J],L);O(x.x,x.y,-P)}}}const Wt=v+y;for(let nt=0;nt<j;nt++){const g=d?ct(M[nt],Nt[nt],Wt):M[nt];b?(R.copy(B.normals[0]).multiplyScalar(g.x),I.copy(B.binormals[0]).multiplyScalar(g.y),z.copy(S[0]).add(R).add(I),O(z.x,z.y,z.z)):O(g.x,g.y,0)}for(let nt=1;nt<=h;nt++)for(let g=0;g<j;g++){const P=d?ct(M[g],Nt[g],Wt):M[g];b?(R.copy(B.normals[nt]).multiplyScalar(P.x),I.copy(B.binormals[nt]).multiplyScalar(P.y),z.copy(S[nt]).add(R).add(I),O(z.x,z.y,z.z)):O(P.x,P.y,u/h*nt)}for(let nt=m-1;nt>=0;nt--){const g=nt/m,P=f*Math.cos(g*Math.PI/2),L=v*Math.sin(g*Math.PI/2)+y;for(let F=0,N=Z.length;F<N;F++){const K=ct(Z[F],xt[F],L);O(K.x,K.y,u+P)}for(let F=0,N=E.length;F<N;F++){const K=E[F];gt=Mt[F];for(let J=0,w=K.length;J<w;J++){const x=ct(K[J],gt[J],L);b?O(x.x,x.y+S[h-1].y,S[h-1].x+P):O(x.x,x.y,u+P)}}}rt(),pt();function rt(){const nt=s.length/3;if(d){let g=0,P=j*g;for(let L=0;L<st;L++){const F=$[L];ht(F[2]+P,F[1]+P,F[0]+P)}g=h+m*2,P=j*g;for(let L=0;L<st;L++){const F=$[L];ht(F[0]+P,F[1]+P,F[2]+P)}}else{for(let g=0;g<st;g++){const P=$[g];ht(P[2],P[1],P[0])}for(let g=0;g<st;g++){const P=$[g];ht(P[0]+j*h,P[1]+j*h,P[2]+j*h)}}i.addGroup(nt,s.length/3-nt,0)}function pt(){const nt=s.length/3;let g=0;wt(Z,g),g+=Z.length;for(let P=0,L=E.length;P<L;P++){const F=E[P];wt(F,g),g+=F.length}i.addGroup(nt,s.length/3-nt,1)}function wt(nt,g){let P=nt.length;for(;--P>=0;){const L=P;let F=P-1;F<0&&(F=nt.length-1);for(let N=0,K=h+m*2;N<K;N++){const J=j*N,w=j*(N+1),x=g+L+J,C=g+F+J,Y=g+F+w,V=g+L+w;ot(x,C,Y,V)}}}function O(nt,g,P){c.push(nt),c.push(g),c.push(P)}function ht(nt,g,P){lt(nt),lt(g),lt(P);const L=s.length/3,F=T.generateTopUV(i,s,L-3,L-2,L-1);bt(F[0]),bt(F[1]),bt(F[2])}function ot(nt,g,P,L){lt(nt),lt(g),lt(L),lt(g),lt(P),lt(L);const F=s.length/3,N=T.generateSideWallUV(i,s,F-6,F-3,F-2,F-1);bt(N[0]),bt(N[1]),bt(N[3]),bt(N[1]),bt(N[2]),bt(N[3])}function lt(nt){s.push(c[nt*3+0]),s.push(c[nt*3+1]),s.push(c[nt*3+2])}function bt(nt){o.push(nt.x),o.push(nt.y)}}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){const t=super.toJSON(),e=this.parameters.shapes,i=this.parameters.options;return dS(e,i,t)}static fromJSON(t,e){const i=[];for(let o=0,r=t.shapes.length;o<r;o++){const a=e[t.shapes[o]];i.push(a)}const s=t.options.extrudePath;return s!==void 0&&(t.options.extrudePath=new jl[s.type]().fromJSON(s)),new Dn(i,t.options)}}const hS={generateTopUV:function(n,t,e,i,s){const o=t[e*3],r=t[e*3+1],a=t[i*3],c=t[i*3+1],l=t[s*3],h=t[s*3+1];return[new Jt(o,r),new Jt(a,c),new Jt(l,h)]},generateSideWallUV:function(n,t,e,i,s,o){const r=t[e*3],a=t[e*3+1],c=t[e*3+2],l=t[i*3],h=t[i*3+1],u=t[i*3+2],d=t[s*3],f=t[s*3+1],v=t[s*3+2],y=t[o*3],m=t[o*3+1],p=t[o*3+2];return Math.abs(a-h)<Math.abs(r-l)?[new Jt(r,1-c),new Jt(l,1-u),new Jt(d,1-v),new Jt(y,1-p)]:[new Jt(a,1-c),new Jt(h,1-u),new Jt(f,1-v),new Jt(m,1-p)]}};function dS(n,t,e){if(e.shapes=[],Array.isArray(n))for(let i=0,s=n.length;i<s;i++){const o=n[i];e.shapes.push(o.uuid)}else e.shapes.push(n.uuid);return e.options=Object.assign({},t),t.extrudePath!==void 0&&(e.options.extrudePath=t.extrudePath.toJSON()),e}class dt extends En{constructor(t=1,e=32,i=16,s=0,o=Math.PI*2,r=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:t,widthSegments:e,heightSegments:i,phiStart:s,phiLength:o,thetaStart:r,thetaLength:a},e=Math.max(3,Math.floor(e)),i=Math.max(2,Math.floor(i));const c=Math.min(r+a,Math.PI);let l=0;const h=[],u=new Q,d=new Q,f=[],v=[],y=[],m=[];for(let p=0;p<=i;p++){const T=[],S=p/i;let b=0;p===0&&r===0?b=.5/e:p===i&&c===Math.PI&&(b=-.5/e);for(let B=0;B<=e;B++){const I=B/e;u.x=-t*Math.cos(s+I*o)*Math.sin(r+S*a),u.y=t*Math.cos(r+S*a),u.z=t*Math.sin(s+I*o)*Math.sin(r+S*a),v.push(u.x,u.y,u.z),d.copy(u).normalize(),y.push(d.x,d.y,d.z),m.push(I+b,1-S),T.push(l++)}h.push(T)}for(let p=0;p<i;p++)for(let T=0;T<e;T++){const S=h[p][T+1],b=h[p][T],B=h[p+1][T],I=h[p+1][T+1];(p!==0||r>0)&&f.push(S,b,I),(p!==i-1||c<Math.PI)&&f.push(b,B,I)}this.setIndex(f),this.setAttribute("position",new sn(v,3)),this.setAttribute("normal",new sn(y,3)),this.setAttribute("uv",new sn(m,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new dt(t.radius,t.widthSegments,t.heightSegments,t.phiStart,t.phiLength,t.thetaStart,t.thetaLength)}}class qn extends En{constructor(t=1,e=.4,i=12,s=48,o=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:t,tube:e,radialSegments:i,tubularSegments:s,arc:o},i=Math.floor(i),s=Math.floor(s);const r=[],a=[],c=[],l=[],h=new Q,u=new Q,d=new Q;for(let f=0;f<=i;f++)for(let v=0;v<=s;v++){const y=v/s*o,m=f/i*Math.PI*2;u.x=(t+e*Math.cos(m))*Math.cos(y),u.y=(t+e*Math.cos(m))*Math.sin(y),u.z=e*Math.sin(m),a.push(u.x,u.y,u.z),h.x=t*Math.cos(y),h.y=t*Math.sin(y),d.subVectors(u,h).normalize(),c.push(d.x,d.y,d.z),l.push(v/s),l.push(f/i)}for(let f=1;f<=i;f++)for(let v=1;v<=s;v++){const y=(s+1)*f+v-1,m=(s+1)*(f-1)+v-1,p=(s+1)*(f-1)+v,T=(s+1)*f+v;r.push(y,m,T),r.push(m,p,T)}this.setIndex(r),this.setAttribute("position",new sn(a,3)),this.setAttribute("normal",new sn(c,3)),this.setAttribute("uv",new sn(l,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new qn(t.radius,t.tube,t.radialSegments,t.tubularSegments,t.arc)}}class Ut extends Do{constructor(t){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new xe(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new xe(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=hp,this.normalScale=new Jt(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Ui,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.defines={STANDARD:""},this.color.copy(t.color),this.roughness=t.roughness,this.metalness=t.metalness,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.roughnessMap=t.roughnessMap,this.metalnessMap=t.metalnessMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.envMapIntensity=t.envMapIntensity,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class Ot extends Ut{constructor(t){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new Jt(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return xn(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(e){this.ior=(1+.4*e)/(1-.4*e)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new xe(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new xe(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new xe(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._dispersion=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(t)}get anisotropy(){return this._anisotropy}set anisotropy(t){this._anisotropy>0!=t>0&&this.version++,this._anisotropy=t}get clearcoat(){return this._clearcoat}set clearcoat(t){this._clearcoat>0!=t>0&&this.version++,this._clearcoat=t}get iridescence(){return this._iridescence}set iridescence(t){this._iridescence>0!=t>0&&this.version++,this._iridescence=t}get dispersion(){return this._dispersion}set dispersion(t){this._dispersion>0!=t>0&&this.version++,this._dispersion=t}get sheen(){return this._sheen}set sheen(t){this._sheen>0!=t>0&&this.version++,this._sheen=t}get transmission(){return this._transmission}set transmission(t){this._transmission>0!=t>0&&this.version++,this._transmission=t}copy(t){return super.copy(t),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=t.anisotropy,this.anisotropyRotation=t.anisotropyRotation,this.anisotropyMap=t.anisotropyMap,this.clearcoat=t.clearcoat,this.clearcoatMap=t.clearcoatMap,this.clearcoatRoughness=t.clearcoatRoughness,this.clearcoatRoughnessMap=t.clearcoatRoughnessMap,this.clearcoatNormalMap=t.clearcoatNormalMap,this.clearcoatNormalScale.copy(t.clearcoatNormalScale),this.dispersion=t.dispersion,this.ior=t.ior,this.iridescence=t.iridescence,this.iridescenceMap=t.iridescenceMap,this.iridescenceIOR=t.iridescenceIOR,this.iridescenceThicknessRange=[...t.iridescenceThicknessRange],this.iridescenceThicknessMap=t.iridescenceThicknessMap,this.sheen=t.sheen,this.sheenColor.copy(t.sheenColor),this.sheenColorMap=t.sheenColorMap,this.sheenRoughness=t.sheenRoughness,this.sheenRoughnessMap=t.sheenRoughnessMap,this.transmission=t.transmission,this.transmissionMap=t.transmissionMap,this.thickness=t.thickness,this.thicknessMap=t.thicknessMap,this.attenuationDistance=t.attenuationDistance,this.attenuationColor.copy(t.attenuationColor),this.specularIntensity=t.specularIntensity,this.specularIntensityMap=t.specularIntensityMap,this.specularColor.copy(t.specularColor),this.specularColorMap=t.specularColorMap,this}}const Ia={enabled:!1,files:{},add:function(n,t){this.enabled!==!1&&(this.files[n]=t)},get:function(n){if(this.enabled!==!1)return this.files[n]},remove:function(n){delete this.files[n]},clear:function(){this.files={}}};class fS{constructor(t,e,i){const s=this;let o=!1,r=0,a=0,c;const l=[];this.onStart=void 0,this.onLoad=t,this.onProgress=e,this.onError=i,this.itemStart=function(h){a++,o===!1&&s.onStart!==void 0&&s.onStart(h,r,a),o=!0},this.itemEnd=function(h){r++,s.onProgress!==void 0&&s.onProgress(h,r,a),r===a&&(o=!1,s.onLoad!==void 0&&s.onLoad())},this.itemError=function(h){s.onError!==void 0&&s.onError(h)},this.resolveURL=function(h){return c?c(h):h},this.setURLModifier=function(h){return c=h,this},this.addHandler=function(h,u){return l.push(h,u),this},this.removeHandler=function(h){const u=l.indexOf(h);return u!==-1&&l.splice(u,2),this},this.getHandler=function(h){for(let u=0,d=l.length;u<d;u+=2){const f=l[u],v=l[u+1];if(f.global&&(f.lastIndex=0),f.test(h))return v}return null}}}const pS=new fS;class No{constructor(t){this.manager=t!==void 0?t:pS,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(t,e){const i=this;return new Promise(function(s,o){i.load(t,s,e,o)})}parse(){}setCrossOrigin(t){return this.crossOrigin=t,this}setWithCredentials(t){return this.withCredentials=t,this}setPath(t){return this.path=t,this}setResourcePath(t){return this.resourcePath=t,this}setRequestHeader(t){return this.requestHeader=t,this}}No.DEFAULT_MATERIAL_NAME="__DEFAULT";const qi={};class mS extends Error{constructor(t,e){super(t),this.response=e}}class gS extends No{constructor(t){super(t)}load(t,e,i,s){t===void 0&&(t=""),this.path!==void 0&&(t=this.path+t),t=this.manager.resolveURL(t);const o=Ia.get(t);if(o!==void 0)return this.manager.itemStart(t),setTimeout(()=>{e&&e(o),this.manager.itemEnd(t)},0),o;if(qi[t]!==void 0){qi[t].push({onLoad:e,onProgress:i,onError:s});return}qi[t]=[],qi[t].push({onLoad:e,onProgress:i,onError:s});const r=new Request(t,{headers:new Headers(this.requestHeader),credentials:this.withCredentials?"include":"same-origin"}),a=this.mimeType,c=this.responseType;fetch(r).then(l=>{if(l.status===200||l.status===0){if(l.status===0&&console.warn("THREE.FileLoader: HTTP Status 0 received."),typeof ReadableStream>"u"||l.body===void 0||l.body.getReader===void 0)return l;const h=qi[t],u=l.body.getReader(),d=l.headers.get("X-File-Size")||l.headers.get("Content-Length"),f=d?parseInt(d):0,v=f!==0;let y=0;const m=new ReadableStream({start(p){T();function T(){u.read().then(({done:S,value:b})=>{if(S)p.close();else{y+=b.byteLength;const B=new ProgressEvent("progress",{lengthComputable:v,loaded:y,total:f});for(let I=0,R=h.length;I<R;I++){const z=h[I];z.onProgress&&z.onProgress(B)}p.enqueue(b),T()}},S=>{p.error(S)})}}});return new Response(m)}else throw new mS(`fetch for "${l.url}" responded with ${l.status}: ${l.statusText}`,l)}).then(l=>{switch(c){case"arraybuffer":return l.arrayBuffer();case"blob":return l.blob();case"document":return l.text().then(h=>new DOMParser().parseFromString(h,a));case"json":return l.json();default:if(a===void 0)return l.text();{const u=/charset="?([^;"\s]*)"?/i.exec(a),d=u&&u[1]?u[1].toLowerCase():void 0,f=new TextDecoder(d);return l.arrayBuffer().then(v=>f.decode(v))}}}).then(l=>{Ia.add(t,l);const h=qi[t];delete qi[t];for(let u=0,d=h.length;u<d;u++){const f=h[u];f.onLoad&&f.onLoad(l)}}).catch(l=>{const h=qi[t];if(h===void 0)throw this.manager.itemError(t),l;delete qi[t];for(let u=0,d=h.length;u<d;u++){const f=h[u];f.onError&&f.onError(l)}this.manager.itemError(t)}).finally(()=>{this.manager.itemEnd(t)}),this.manager.itemStart(t)}setResponseType(t){return this.responseType=t,this}setMimeType(t){return this.mimeType=t,this}}class Op extends No{constructor(t){super(t)}load(t,e,i,s){this.path!==void 0&&(t=this.path+t),t=this.manager.resolveURL(t);const o=this,r=Ia.get(t);if(r!==void 0)return o.manager.itemStart(t),setTimeout(function(){e&&e(r),o.manager.itemEnd(t)},0),r;const a=gr("img");function c(){h(),Ia.add(t,this),e&&e(this),o.manager.itemEnd(t)}function l(u){h(),s&&s(u),o.manager.itemError(t),o.manager.itemEnd(t)}function h(){a.removeEventListener("load",c,!1),a.removeEventListener("error",l,!1)}return a.addEventListener("load",c,!1),a.addEventListener("error",l,!1),t.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(a.crossOrigin=this.crossOrigin),o.manager.itemStart(t),a.src=t,a}}class Tr extends No{constructor(t){super(t)}load(t,e,i,s){const o=new Cu;o.colorSpace=vi;const r=new Op(this.manager);r.setCrossOrigin(this.crossOrigin),r.setPath(this.path);let a=0;function c(l){r.load(t[l],function(h){o.images[l]=h,a++,a===6&&(o.needsUpdate=!0,e&&e(o))},void 0,s)}for(let l=0;l<t.length;++l)c(l);return o}}class Yn extends No{constructor(t){super(t)}load(t,e,i,s){const o=new In,r=new Op(this.manager);return r.setCrossOrigin(this.crossOrigin),r.setPath(this.path),r.load(t,function(a){o.image=a,o.needsUpdate=!0,e!==void 0&&e(o)},i,s),o}}class Nu extends wn{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new xe(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(e.object.target=this.target.uuid),e}}const qc=new nn,Dd=new Q,Ud=new Q;class Bp{constructor(t){this.camera=t,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Jt(512,512),this.map=null,this.mapPass=null,this.matrix=new nn,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Iu,this._frameExtents=new Jt(1,1),this._viewportCount=1,this._viewports=[new We(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,i=this.matrix;Dd.setFromMatrixPosition(t.matrixWorld),e.position.copy(Dd),Ud.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(Ud),e.updateMatrixWorld(),qc.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(qc),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(qc)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.intensity=t.intensity,this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.intensity!==1&&(t.intensity=this.intensity),this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}const Nd=new nn,Xo=new Q,jc=new Q;class vS extends Bp{constructor(){super(new $e(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new Jt(4,2),this._viewportCount=6,this._viewports=[new We(2,1,1,1),new We(0,1,1,1),new We(3,1,1,1),new We(1,1,1,1),new We(3,0,1,1),new We(1,0,1,1)],this._cubeDirections=[new Q(1,0,0),new Q(-1,0,0),new Q(0,0,1),new Q(0,0,-1),new Q(0,1,0),new Q(0,-1,0)],this._cubeUps=[new Q(0,1,0),new Q(0,1,0),new Q(0,1,0),new Q(0,1,0),new Q(0,0,1),new Q(0,0,-1)]}updateMatrices(t,e=0){const i=this.camera,s=this.matrix,o=t.distance||i.far;o!==i.far&&(i.far=o,i.updateProjectionMatrix()),Xo.setFromMatrixPosition(t.matrixWorld),i.position.copy(Xo),jc.copy(i.position),jc.add(this._cubeDirections[e]),i.up.copy(this._cubeUps[e]),i.lookAt(jc),i.updateMatrixWorld(),s.makeTranslation(-Xo.x,-Xo.y,-Xo.z),Nd.multiplyMatrices(i.projectionMatrix,i.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Nd)}}class li extends Nu{constructor(t,e,i=0,s=2){super(t,e),this.isPointLight=!0,this.type="PointLight",this.distance=i,this.decay=s,this.shadow=new vS}get power(){return this.intensity*4*Math.PI}set power(t){this.intensity=t/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(t,e){return super.copy(t,e),this.distance=t.distance,this.decay=t.decay,this.shadow=t.shadow.clone(),this}}class _S extends Bp{constructor(){super(new bp(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class ui extends Nu{constructor(t,e){super(t,e),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(wn.DEFAULT_UP),this.updateMatrix(),this.target=new wn,this.shadow=new _S}dispose(){this.shadow.dispose()}copy(t){return super.copy(t),this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}class hi extends Nu{constructor(t,e){super(t,e),this.isAmbientLight=!0,this.type="AmbientLight"}}class zp{constructor(t=!0){this.autoStart=t,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Fd(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let t=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const e=Fd();t=(e-this.oldTime)/1e3,this.oldTime=e,this.elapsedTime+=t}return t}}function Fd(){return performance.now()}class xS{constructor(){this.type="ShapePath",this.color=new xe,this.subPaths=[],this.currentPath=null}moveTo(t,e){return this.currentPath=new Yl,this.subPaths.push(this.currentPath),this.currentPath.moveTo(t,e),this}lineTo(t,e){return this.currentPath.lineTo(t,e),this}quadraticCurveTo(t,e,i,s){return this.currentPath.quadraticCurveTo(t,e,i,s),this}bezierCurveTo(t,e,i,s,o,r){return this.currentPath.bezierCurveTo(t,e,i,s,o,r),this}splineThru(t){return this.currentPath.splineThru(t),this}toShapes(t){function e(p){const T=[];for(let S=0,b=p.length;S<b;S++){const B=p[S],I=new Sn;I.curves=B.curves,T.push(I)}return T}function i(p,T){const S=T.length;let b=!1;for(let B=S-1,I=0;I<S;B=I++){let R=T[B],z=T[I],tt=z.x-R.x,M=z.y-R.y;if(Math.abs(M)>Number.EPSILON){if(M<0&&(R=T[I],tt=-tt,z=T[B],M=-M),p.y<R.y||p.y>z.y)continue;if(p.y===R.y){if(p.x===R.x)return!0}else{const E=M*(p.x-R.x)-tt*(p.y-R.y);if(E===0)return!0;if(E<0)continue;b=!b}}else{if(p.y!==R.y)continue;if(z.x<=p.x&&p.x<=R.x||R.x<=p.x&&p.x<=z.x)return!0}}return b}const s=Mo.isClockWise,o=this.subPaths;if(o.length===0)return[];let r,a,c;const l=[];if(o.length===1)return a=o[0],c=new Sn,c.curves=a.curves,l.push(c),l;let h=!s(o[0].getPoints());h=t?!h:h;const u=[],d=[];let f=[],v=0,y;d[v]=void 0,f[v]=[];for(let p=0,T=o.length;p<T;p++)a=o[p],y=a.getPoints(),r=s(y),r=t?!r:r,r?(!h&&d[v]&&v++,d[v]={s:new Sn,p:y},d[v].s.curves=a.curves,h&&v++,f[v]=[]):f[v].push({h:a,p:y[0]});if(!d[0])return e(o);if(d.length>1){let p=!1,T=0;for(let S=0,b=d.length;S<b;S++)u[S]=[];for(let S=0,b=d.length;S<b;S++){const B=f[S];for(let I=0;I<B.length;I++){const R=B[I];let z=!0;for(let tt=0;tt<d.length;tt++)i(R.p,d[tt].p)&&(S!==tt&&T++,z?(z=!1,u[tt].push(R)):p=!0);z&&u[S].push(R)}}T>0&&p===!1&&(f=u)}let m;for(let p=0,T=d.length;p<T;p++){c=d[p].s,l.push(c),m=f[p];for(let S=0,b=m.length;S<b;S++)c.holes.push(m[S].h)}return l}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Mu}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Mu);class di extends No{constructor(t){super(t)}load(t,e,i,s){const o=this,r=new gS(this.manager);r.setPath(this.path),r.setRequestHeader(this.requestHeader),r.setWithCredentials(this.withCredentials),r.load(t,function(a){const c=o.parse(JSON.parse(a));e&&e(c)},i,s)}parse(t){return new yS(t)}}class yS{constructor(t){this.isFont=!0,this.type="Font",this.data=t}generateShapes(t,e=100){const i=[],s=MS(t,e,this.data);for(let o=0,r=s.length;o<r;o++)i.push(...s[o].toShapes());return i}}function MS(n,t,e){const i=Array.from(n),s=t/e.resolution,o=(e.boundingBox.yMax-e.boundingBox.yMin+e.underlineThickness)*s,r=[];let a=0,c=0;for(let l=0;l<i.length;l++){const h=i[l];if(h===`
`)a=0,c-=o;else{const u=wS(h,s,a,c,e);a+=u.offsetX,r.push(u.path)}}return r}function wS(n,t,e,i,s){const o=s.glyphs[n]||s.glyphs["?"];if(!o){console.error('THREE.Font: character "'+n+'" does not exists in font family '+s.familyName+".");return}const r=new xS;let a,c,l,h,u,d,f,v;if(o.o){const y=o._cachedOutline||(o._cachedOutline=o.o.split(" "));for(let m=0,p=y.length;m<p;)switch(y[m++]){case"m":a=y[m++]*t+e,c=y[m++]*t+i,r.moveTo(a,c);break;case"l":a=y[m++]*t+e,c=y[m++]*t+i,r.lineTo(a,c);break;case"q":l=y[m++]*t+e,h=y[m++]*t+i,u=y[m++]*t+e,d=y[m++]*t+i,r.quadraticCurveTo(u,d,l,h);break;case"b":l=y[m++]*t+e,h=y[m++]*t+i,u=y[m++]*t+e,d=y[m++]*t+i,f=y[m++]*t+e,v=y[m++]*t+i,r.bezierCurveTo(u,d,f,v,l,h);break}}return{offsetX:o.ha*t,path:r}}class Xe extends Dn{constructor(t,e={}){const i=e.font;if(i===void 0)super();else{const s=i.generateShapes(t,e.size);e.depth===void 0&&e.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),e.depth=e.depth!==void 0?e.depth:e.height!==void 0?e.height:50,e.bevelThickness===void 0&&(e.bevelThickness=10),e.bevelSize===void 0&&(e.bevelSize=8),e.bevelEnabled===void 0&&(e.bevelEnabled=!1),super(s,e)}this.type="TextGeometry"}}const SS=Un({__name:"MetalBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);let i=null,s=Kt(!1),o=Kt(!1),r=Kt(!1);return Vn(()=>{if(e.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:o.value&&(u.rotation.y-=.03),h.render(c,l)};const c=new Hn,l=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),h=new Gn({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(h.domElement);const u=new Xt,d=new hi(16777215,2);c.add(d);const f=new ui(16777215,4);f.position.set(5,5,5),c.add(f);const v=new li(16777215,5,50);v.position.set(0,2,4),c.add(v);const y=new Yn,m=y.load("/3d-bear-arts/assets/lv2.jpg"),p=y.load("/3d-bear-arts/assets/lv2.jpg");m.wrapS=m.wrapT=Je,p.wrapS=p.wrapT=Je;const T=new Ot({color:8343336,metalness:0,roughness:.8,bumpMap:m,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:p,envMapIntensity:.7}),S=new Ot({color:5978654,metalness:0,roughness:.8,bumpMap:m,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:p,envMapIntensity:.7}),b=new Ot({color:13152668,metalness:.2,roughness:.05,bumpMap:m,bumpScale:.05,clearcoat:1,clearcoatRoughness:.05,map:p,transparent:!0,opacity:.4,transmission:.9,envMapIntensity:1,reflectivity:.9,ior:1.45,side:Ae});new Ot({color:13421772,metalness:1,roughness:.5,clearcoat:.3,clearcoatRoughness:.3});const B=new dt(1,32,32,0,Math.PI),I=new _(B,b),R=new _(B,T);I.scale.set(.85,.85,.8),R.scale.set(.85,.85,.8),I.position.y=-.2,R.position.y=-.2,I.rotation.y=Math.PI/2,R.rotation.y=Math.PI*1.5;const z=new Ce(1,32),tt=new _(z,T);tt.scale.set(.85,.85,.8),tt.position.set(0,-.2,0),tt.rotation.y=Math.PI/2;const M=new Xt;M.add(I),M.add(R),M.add(tt),u.add(M);const E=new dt(.6,32,32,0,Math.PI),U=new _(E,T);U.scale.set(1,.95,.95),U.position.set(0,1,0),U.rotation.y=Math.PI*1.5;const $=new _(E,b);$.scale.set(1,.95,.95),$.position.set(0,1,0),$.rotation.y=Math.PI/2;const Z=new Ce(.6,32),ct=new _(Z,T);ct.position.set(0,1,0),ct.rotation.y=Math.PI/2,ct.scale.set(1,.95,.95);const j=new Xt;j.add(U),j.add($),j.add(ct),u.add(j);const st=new dt(.25,32,32),k=new _(st,T);k.position.set(-.45,1.35,-.1),u.add(k);const xt=new _(st,b);xt.position.set(.45,1.35,-.1),u.add(xt);const Mt=new dt(.25,32,32,Math.PI/2,Math.PI),gt=new _(Mt,S);gt.scale.set(1.1,.6,.8),gt.position.set(0,.84,.5),gt.rotation.y=Math.PI;const Nt=new dt(.25,32,32,Math.PI/2,Math.PI),Wt=new _(Nt,b);Wt.scale.set(1.1,.6,.8),Wt.position.set(0,.84,.5),Wt.rotation.y=0;const rt=new Ce(.25,32),pt=new _(rt,T);pt.scale.set(.8,.6,.8),pt.position.set(0,.84,.5),pt.rotation.y=Math.PI/2;const wt=new Xt;wt.add(gt),wt.add(Wt),wt.add(pt),u.add(wt);const O=new Sn;O.moveTo(0,0),O.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),O.bezierCurveTo(-.6,.3,0,.6,0,1),O.bezierCurveTo(0,.6,.6,.3,.6,0),O.bezierCurveTo(.6,-.3,0,-.3,0,0);const ht={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Ot({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const ot=new Dn(O,ht),lt=new _(ot,T);lt.scale.set(.1,.1,.1),lt.rotation.z=le.degToRad(210),lt.rotation.x=le.degToRad(5),lt.rotation.y=le.degToRad(-45),lt.position.set(-.4,.9,.45);const bt=new _(ot,S);bt.scale.set(.6,.5,.5),bt.position.set(.35,0,0),bt.rotation.y=Math.PI,bt.rotation.x=Math.PI;const nt=new _(ot,S);nt.scale.set(.2,.2,.2),nt.position.set(.5,-.1,.2),nt.rotation.y=Math.PI,nt.rotation.x=Math.PI,u.add(nt);const g=new Mn(1.3,1.2,.6),P=new _(g,T);P.scale.set(.45,.45,.45),P.position.set(.35,-.2,.1),P.rotation.y=Math.PI;const L=new qn(.15,.025,10,100);new Ot({color:8343336,metalness:.3,roughness:.4,clearcoat:.5});const F=new _(L,T);F.position.set(.35,.1,.1),F.rotation.z=Math.PI/2,F.rotation.x=Math.PI/8,F.rotation.y=Math.PI/14;const N=new _(L,T);N.position.set(.35,.1,.13),N.rotation.z=Math.PI/2,N.rotation.x=Math.PI/-8,N.rotation.y=Math.PI/12;const K=new Xt;K.add(P),K.add(F),K.add(N),u.add(K);const J=new dt(.35,32,32),w=new _(J,T);w.scale.set(.75,1.25,.65),w.position.set(-.7,-.15,.2),u.add(w);const x=new _(J,b);x.scale.set(.75,1.25,.65),x.position.set(.7,-.15,.2),u.add(x);const C=new ne(.2,.22,.6,32),Y=new _(C,T);Y.position.set(-.4,-1.05,0),u.add(Y);const V=new _(C,b);V.position.set(.4,-1.05,0),u.add(V);const X=new dt(.3,32,32),ut=new _(X,T);ut.scale.set(1,.72,1.5),ut.position.set(-.4,-1.45,.17),u.add(ut);const at=new _(X,b);at.scale.set(1,.72,1.5),at.position.set(.4,-1.45,.17),u.add(at);const vt=new dt(.44,32,32),At=new _(vt,T);At.position.set(-.15,-.45,-.4),u.add(At);const ft=new _(vt,b);ft.position.set(.15,-.45,-.4),u.add(ft);const _t=new dt(.18,32,32),Dt=new _(_t,T);Dt.position.set(0,-.35,-.8),u.add(Dt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(et){const St=new Xe("X",{font:et,size:.2,depth:.05});new es({color:0});const Et=new _(St,S);Et.position.set(-.3,.99,.53),Et.rotation.x=le.degToRad(-5),Et.rotation.y=le.degToRad(-15),u.add(Et);const Vt=new Xe("O",{font:et,size:.2,depth:.05});new es({color:0});const te=new _(Vt,S);te.position.set(.14,.99,.53),te.rotation.y=le.degToRad(12),te.rotation.x=le.degToRad(-5),u.add(te)}),Dt.renderOrder=1,u.scale.set(1.35,1.35,1.35),c.add(u),u.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),l.position.set(t.bodyPosition.x,1,t.cameraPosition),l.lookAt(t.bodyPosition.x,0,0),l.position.z=4;const Rt=()=>{u.rotation.y,u.rotation.x},Qt=()=>{s.value=!0,o.value=!1,r.value=!1},Bt=()=>{s.value=!1,o.value=!0,r.value=!1},Yt=()=>{s.value=!1,o.value=!1,Rt()},H=et=>{const St=window.innerWidth/2;et>St?Qt():Bt(),Rt()},yt=et=>{clearTimeout(i),Yt(),r.value=!0;const St={x:et.clientX/window.innerWidth*2-1,y:-(et.clientY/window.innerHeight)*2+1};if(r.value){const Et=St.x*Math.PI*.2,Vt=St.y*Math.PI*.2;u.rotation.y=Et,u.rotation.x=Vt}i=setTimeout(()=>{r.value=!1,H(et.clientX)},500)};window.addEventListener("mousemove",yt);const it=et=>{if(r.value){const St={x:et.clientX/window.innerWidth*2-1,y:-(et.clientY/window.innerHeight)*2+1},Et=St.x*Math.PI*.2,Vt=St.y*Math.PI*.2;u.rotation.y=Et,u.rotation.x=Vt}};window.addEventListener("mousemove",it),a(),qe(()=>t.bodyPosition,et=>{u.position.set(et.x,et.y,et.z)}),qe(()=>t.cameraPosition,et=>{l.position.set(t.bodyPosition.x,1,et),l.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,c)=>(Wn(),$n("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),bS=Kn(SS,[["__scopeId","data-v-f3beb116"]]),ES=Un({__name:"PopartBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);let i=null,s=Kt(!1),o=Kt(!1),r=Kt(!1);return Vn(()=>{if(e.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:o.value&&(u.rotation.y-=.03),h.render(c,l)};const c=new Hn,l=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),h=new Gn({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(h.domElement);const u=new Xt,d=new hi(16777215,2);c.add(d);const f=new ui(16777215,4);f.position.set(5,5,5),c.add(f);const v=new li(16777215,5,50);v.position.set(0,2,4),c.add(v);const y=new Yn,m=y.load("/3d-bear-arts/assets/pop6.jpg"),p=y.load("/3d-bear-arts/assets/pop7.jpg");m.wrapS=m.wrapT=Je,p.wrapS=p.wrapT=Je;const T=new Ot({color:16738740,map:p,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),S=new Ot({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),b=new Ot({color:16766720,map:m,metalness:.3,roughness:.5}),B=new Ot({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),I=new Ot({color:9055202,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new Ot({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae});const R=new Ot({color:65535,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),z=new Ot({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),tt=new dt(1,32,32,0,Math.PI),M=new _(tt,S),E=new _(tt,T);M.scale.set(.85,.85,.8),E.scale.set(.85,.85,.8),M.position.y=-.2,E.position.y=-.2,M.rotation.y=Math.PI/2,E.rotation.y=Math.PI*1.5;const U=new Ce(1,32),$=new _(U,T);$.scale.set(.85,.85,.8),$.position.set(0,-.2,0),$.rotation.y=Math.PI/2;const Z=new Xt;Z.add(M),Z.add(E),Z.add($),u.add(Z);const ct=new dt(.6,32,32,0,Math.PI),j=new _(ct,b);j.scale.set(1,.95,.95),j.position.set(0,1,0),j.rotation.y=Math.PI*1.5;const st=new _(ct,B);st.scale.set(1,.95,.95),st.position.set(0,1,0),st.rotation.y=Math.PI/2;const k=new Ce(.6,32),xt=new _(k,b);xt.position.set(0,1,0),xt.rotation.y=Math.PI/2,xt.scale.set(1,.95,.95);const Mt=new Xt;Mt.add(j),Mt.add(st),Mt.add(xt),u.add(Mt);const gt=new dt(.25,32,32),Nt=new _(gt,T);Nt.position.set(-.45,1.35,-.1),u.add(Nt);const Wt=new _(gt,S);Wt.position.set(.45,1.35,-.1),u.add(Wt);const rt=new dt(.25,32,32,Math.PI/2,Math.PI),pt=new _(rt,b);pt.scale.set(1.1,.6,.8),pt.position.set(0,.84,.5),pt.rotation.y=Math.PI;const wt=new dt(.25,32,32,Math.PI/2,Math.PI),O=new _(wt,B);O.scale.set(1.1,.6,.8),O.position.set(0,.84,.5),O.rotation.y=0;const ht=new Ce(.25,32),ot=new _(ht,b);ot.scale.set(.8,.6,.8),ot.position.set(0,.84,.5),ot.rotation.y=Math.PI/2;const lt=new Xt;lt.add(pt),lt.add(O),lt.add(ot),u.add(lt);const bt=new Sn;bt.moveTo(0,0),bt.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),bt.bezierCurveTo(-.6,.3,0,.6,0,1),bt.bezierCurveTo(0,.6,.6,.3,.6,0),bt.bezierCurveTo(.6,-.3,0,-.3,0,0);const nt={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},g=new Dn(bt,nt),P=new _(g,b);P.scale.set(.5,.5,.5),P.position.set(.35,0,0),P.rotation.y=Math.PI,P.rotation.x=Math.PI,u.add(P);const L=new _(g,R);L.scale.set(.2,.2,.25),L.position.set(.5,-.3,.4),L.rotation.y=Math.PI,L.rotation.x=Math.PI,u.add(L);const F=new _(g,T);F.scale.set(.25,.25,.27),F.position.set(.4,.3,-.2),F.rotation.y=Math.PI,F.rotation.x=Math.PI,u.add(F);const N=new dt(.35,32,32),K=new _(N,R);K.scale.set(.75,1.25,.65),K.position.set(-.7,-.15,.2),u.add(K);const J=new _(N,z);J.scale.set(.75,1.25,.65),J.position.set(.7,-.15,.2),u.add(J);const w=new ne(.2,.22,.6,32),x=new _(w,b);x.position.set(-.4,-1.05,0),u.add(x);const C=new _(w,B);C.position.set(.4,-1.05,0),u.add(C);const Y=new dt(.3,32,32),V=new _(Y,b);V.scale.set(1,.72,1.5),V.position.set(-.4,-1.45,.17),u.add(V);const X=new _(Y,B);X.scale.set(1,.72,1.5),X.position.set(.4,-1.45,.17),u.add(X);const ut=new dt(.44,32,32),at=new _(ut,T);at.position.set(-.15,-.45,-.4),u.add(at);const vt=new _(ut,S);vt.position.set(.15,-.45,-.4),u.add(vt);const At=new dt(.18,32,32),ft=new _(At,T);ft.position.set(0,-.35,-.8),u.add(ft),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(yt){const it=new Xe("X",{font:yt,size:.2,depth:.05});new es({color:0});const et=new _(it,T);et.position.set(-.3,.99,.53),et.rotation.x=le.degToRad(-5),et.rotation.y=le.degToRad(-15),u.add(et);const St=new Xe("O",{font:yt,size:.2,depth:.05});new es({color:0});const Et=new _(St,R);Et.position.set(.14,.99,.53),Et.rotation.y=le.degToRad(12),Et.rotation.x=le.degToRad(-5),u.add(Et);const Vt=new Xe("POP",{font:yt,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),te=new Ot({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const se=new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),ie=new Ot({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),re=new _(Vt,te);re.scale.set(.15,.15,.15),re.position.set(.03,1.16,.1),re.rotateZ(-25),u.add(re);const ce=new _(Vt,I);ce.scale.set(.14,.14,.14),ce.rotateZ(45),ce.position.set(.2,-.7,.3),u.add(ce);const he=new _(Vt,se);he.scale.set(.14,.14,.14),he.rotateZ(45),he.rotateY(45),he.position.set(.3,.7,.3),u.add(he);const ve=new _(Vt,se);ve.scale.set(.15,.15,.15),ve.rotateZ(45),ve.rotateY(45),ve.position.set(.35,-1.5,.3),u.add(ve);const fe=new _(Vt,ie);fe.scale.set(.17,.17,.17),fe.rotateZ(45),fe.rotateY(15),fe.position.set(.35,1,.3),u.add(fe)}),ft.renderOrder=1,u.scale.set(1.35,1.35,1.35),c.add(u),u.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),l.position.set(t.bodyPosition.x,1,t.cameraPosition),l.lookAt(t.bodyPosition.x,0,0),l.position.z=4;const Dt=()=>{u.rotation.y,u.rotation.x},Ft=()=>{s.value=!0,o.value=!1,r.value=!1},Rt=()=>{s.value=!1,o.value=!0,r.value=!1},Qt=()=>{s.value=!1,o.value=!1,Dt()},Bt=yt=>{const it=window.innerWidth/2;yt>it?Ft():Rt(),Dt()},Yt=yt=>{clearTimeout(i),Qt(),r.value=!0;const it={x:yt.clientX/window.innerWidth*2-1,y:-(yt.clientY/window.innerHeight)*2+1};if(r.value){const et=it.x*Math.PI*.2,St=it.y*Math.PI*.2;u.rotation.y=et,u.rotation.x=St}i=setTimeout(()=>{r.value=!1,Bt(yt.clientX)},500)};window.addEventListener("mousemove",Yt);const H=yt=>{if(r.value){const it={x:yt.clientX/window.innerWidth*2-1,y:-(yt.clientY/window.innerHeight)*2+1},et=it.x*Math.PI*.2,St=it.y*Math.PI*.2;u.rotation.y=et,u.rotation.x=St}};window.addEventListener("mousemove",H),a(),qe(()=>t.bodyPosition,yt=>{u.position.set(yt.x,yt.y,yt.z)}),qe(()=>t.cameraPosition,yt=>{l.position.set(t.bodyPosition.x,1,yt),l.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,c)=>(Wn(),$n("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),TS=Kn(ES,[["__scopeId","data-v-8cfea564"]]),AS={class:"pixel-controls"},PS={class:"side-buttons"},RS=Un({__name:"PopArtBear3",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);let i=Kt(!1),s=Kt(!1),o=Kt(!1),r=Kt(!1);Vn(()=>{if(e.value){let d=function(){requestAnimationFrame(d),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),o.value&&(m.rotation.x-=.03),r.value&&(m.rotation.x+=.03);const et=yt.getElapsedTime();H.forEach((St,Et)=>{const Vt=.2+Math.sin(et*3+it[Et])*.1;St.scale.set(Vt,Vt,Vt)}),y.render(f,v)};const f=new Hn,v=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),y=new Gn({antialias:!0,alpha:!0});y.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(y.domElement);const m=new Xt,p=new Xt;f.add(p);const T=new hi(16777215,2);f.add(T);const S=new ui(16777215,4);S.position.set(5,5,5),f.add(S);const b=new li(16777215,5,50);b.position.set(0,2,4),f.add(b);const B=new Yn,I=B.load("/3d-bear-arts/assets/pop6.jpg"),R=B.load("/3d-bear-arts/assets/pop7.jpg");I.wrapS=I.wrapT=Je,R.wrapS=R.wrapT=Je,R.repeat.set(2,2);const z=new Ot({color:16738740,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),tt=new Ot({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),M=new Ot({color:16766720,map:I,metalness:.3,roughness:.5}),E=new Ot({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),U=new Ot({color:9055202,map:I,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),$=new Ot({color:65535,map:I,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Z=new Ot({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),ct=new dt(1,32,32,0,Math.PI),j=new _(ct,tt),st=new _(ct,z);j.scale.set(.85,.85,.8),st.scale.set(.85,.85,.8),j.position.y=-.2,st.position.y=-.2,j.rotation.y=Math.PI/2,st.rotation.y=Math.PI*1.5;const k=new Ce(1,32),xt=new _(k,z);xt.scale.set(.85,.85,.8),xt.position.set(0,-.2,0),xt.rotation.y=Math.PI/2;const Mt=new Xt;Mt.add(j),Mt.add(st),Mt.add(xt),m.add(Mt);const gt=new dt(.6,32,32,0,Math.PI),Nt=new _(gt,M);Nt.scale.set(1,.95,.95),Nt.position.set(0,1,0),Nt.rotation.y=Math.PI*1.5;const Wt=new _(gt,E);Wt.scale.set(1,.95,.95),Wt.position.set(0,1,0),Wt.rotation.y=Math.PI/2;const rt=new Ce(.6,32),pt=new _(rt,M);pt.position.set(0,1,0),pt.rotation.y=Math.PI/2,pt.scale.set(1,.95,.95);const wt=new Xt;wt.add(Nt),wt.add(Wt),wt.add(pt),m.add(wt);const O=new dt(.25,32,32),ht=new _(O,z);ht.position.set(-.45,1.35,-.1),m.add(ht);const ot=new _(O,tt);ot.position.set(.45,1.35,-.1),m.add(ot);const lt=new dt(.25,32,32,Math.PI/2,Math.PI),bt=new _(lt,M);bt.scale.set(1.1,.6,.8),bt.position.set(0,.84,.5),bt.rotation.y=Math.PI;const nt=new dt(.25,32,32,Math.PI/2,Math.PI),g=new _(nt,E);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=0;const P=new Ce(.25,32),L=new _(P,M);L.scale.set(.8,.6,.8),L.position.set(0,.84,.5),L.rotation.y=Math.PI/2;const F=new Xt;F.add(bt),F.add(g),F.add(L),m.add(F);const N=new Sn;N.moveTo(0,0),N.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),N.bezierCurveTo(-.6,.3,0,.6,0,1),N.bezierCurveTo(0,.6,.6,.3,.6,0),N.bezierCurveTo(.6,-.3,0,-.3,0,0);const K={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},J=new Dn(N,K),w=new _(J,M);w.scale.set(.5,.5,.5),w.position.set(.3,0,0),w.rotation.y=Math.PI,w.rotation.x=Math.PI,m.add(w);const x=new _(J,$);x.scale.set(.2,.2,.25),x.position.set(.35,-.3,.4),x.rotation.y=Math.PI,x.rotation.x=Math.PI,m.add(x);const C=new _(J,z);C.scale.set(.25,.25,.27),C.position.set(.38,.3,-.2),C.rotation.y=Math.PI,C.rotation.x=Math.PI,m.add(C);const Y=new dt(.35,32,32),V=new _(Y,$);V.scale.set(.75,1.25,.65),V.position.set(-.7,-.15,.2),m.add(V);const X=new _(Y,Z);X.scale.set(.75,1.25,.65),X.position.set(.7,-.15,.2),m.add(X);const ut=new ne(.2,.22,.6,32),at=new _(ut,M);at.position.set(-.4,-1.05,0),m.add(at);const vt=new _(ut,E);vt.position.set(.4,-1.05,0),m.add(vt);const At=new dt(.3,32,32),ft=new _(At,M);ft.scale.set(1,.72,1.5),ft.position.set(-.4,-1.45,.17),m.add(ft);const _t=new _(At,E);_t.scale.set(1,.72,1.5),_t.position.set(.4,-1.45,.17),m.add(_t);const Dt=new dt(.44,32,32),Ft=new _(Dt,z);Ft.position.set(-.15,-.45,-.4),m.add(Ft);const Rt=new _(Dt,tt);Rt.position.set(.15,-.45,-.4),m.add(Rt);const Qt=new dt(.18,32,32),Bt=new _(Qt,z);Bt.position.set(0,-.35,-.8),m.add(Bt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(et){const St=new Xe("X",{font:et,size:.2,depth:.05}),Et=new _(St,z);Et.position.set(-.3,.99,.53),Et.rotation.x=le.degToRad(-5),Et.rotation.y=le.degToRad(-15),m.add(Et);const Vt=new Xe("O",{font:et,size:.2,depth:.05}),te=new _(Vt,$);te.position.set(.14,.99,.53),te.rotation.y=le.degToRad(12),te.rotation.x=le.degToRad(-5),m.add(te);const se=new Xe("POP",{font:et,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});new Xe("🐻",{font:et,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});const ie=new Xe("BAO      BEAR",{font:et,size:2,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:3}),re=new Ot({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const ce=new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),he=new Ot({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),ve=new _(se,re);ve.scale.set(.15,.15,.15),ve.position.set(.02,1.16,.1),ve.rotateZ(-25),m.add(ve);const fe=new _(se,U);fe.scale.set(.14,.14,.14),fe.rotateZ(45),fe.position.set(.2,-.7,.3),m.add(fe);const Se=new _(se,ce);Se.scale.set(.14,.14,.14),Se.rotateZ(45),Se.rotateY(45),Se.position.set(.3,.7,.3),m.add(Se);const ye=new _(se,ce);ye.scale.set(.15,.15,.15),ye.rotateZ(45),ye.rotateY(45),ye.position.set(.35,-1.5,.3),m.add(ye);const De=new _(se,he);De.scale.set(.17,.17,.17),De.rotateZ(45),De.rotateY(15),De.position.set(.35,1,.3),m.add(De);const Te=new _(ie,re);Te.scale.set(.7,.7,.7),Te.position.set(-6,0,-3),p.add(Te)}),Bt.renderOrder=1,m.scale.set(1.4,1.4,1.4),f.add(m),m.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),v.position.set(t.bodyPosition.x,1,t.cameraPosition),v.lookAt(t.bodyPosition.x,0,0),v.position.z=4,m.rotation.x=.1;const H=[w,x,C],yt=new zp,it=[0,Math.PI/2,Math.PI,0,Math.PI/3];d(),qe(()=>t.bodyPosition,et=>{m.position.set(et.x,et.y,et.z)}),qe(()=>t.cameraPosition,et=>{v.position.set(t.bodyPosition.x,1,et),v.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{v.aspect=window.innerWidth/window.innerHeight,v.updateProjectionMatrix(),y.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,f)=>(Wn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),zt("div",AS,[zt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),zt("div",PS,[zt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),CS=Kn(RS,[["__scopeId","data-v-cb52c927"]]),IS={class:"pixel-controls"},LS={class:"side-buttons"},DS=Un({__name:"MetalMachineBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);let i=Kt(!1),s=Kt(!1),o=Kt(!1),r=Kt(!1);Vn(()=>{if(e.value){let d=function(ce,he){const ve=new ne(Yt,Yt,H,32);ve.rotateX(Math.PI/2);const fe=new _(ve,ce),Se=new Xt;for(let De=0;De<yt;De++){const Te=De/yt*Math.PI*2,Be=new Mn(it,et,St),Le=new _(Be,ce);Le.position.set((Yt+St/26)*Math.cos(Te),(Yt+St/26)*Math.sin(Te),0),Le.rotation.z=Te,Se.add(Le)}const ye=new Xt;return ye.add(fe),ye.add(Se),ye.position.set(he.x,he.y,he.z),ye},f=function(){requestAnimationFrame(f),i.value&&(p.rotation.y+=.03),s.value&&(p.rotation.y-=.03),o.value&&(p.rotation.x-=.03),r.value&&(p.rotation.x+=.03),Et.rotation.z-=.02,Vt.rotation.z+=.03,te.rotation.z+=.02,se.rotation.z+=.02,ie.rotation.z-=.03,re.rotation.y+=.04,m.render(v,y)};const v=new Hn,y=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),m=new Gn({antialias:!0,alpha:!0});m.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(m.domElement);const p=new Xt,T=new Xt;v.add(T);const S=new hi(16777215,2);v.add(S);const b=new ui(16777215,4);b.position.set(5,5,5),v.add(b);const B=new li(16777215,5,50);B.position.set(0,2,4),v.add(B);const I=new Yn,R=I.load("/3d-bear-arts/assets/metal.jpg"),z=I.load("/3d-bear-arts/assets/pop7.jpg"),tt=I.load("/3d-bear-arts/assets/gear.jpg");R.wrapS=R.wrapT=Je,z.wrapS=z.wrapT=Je,z.repeat.set(2,2);const M=new Ot({color:13882323,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:R});tt.mapping=Ta;const E=new Ot({color:"#d3d3d3",metalness:1,roughness:.25,map:R,envMap:tt,clearcoat:.7,clearcoatRoughness:.3}),U=new Ot({color:"#C0C0C0",metalness:1,roughness:.25,envMap:tt,clearcoat:.7,clearcoatRoughness:.3}),$=new Ot({color:"#C0C0C0",metalness:1,roughness:.25,map:R,envMap:tt,transparent:!0,opacity:.8,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),Z=new Ot({color:"#C0C0C0",metalness:1,roughness:.5,map:R,envMap:tt,transparent:!0,opacity:.23,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),ct=new Ot({color:13882323,metalness:1,roughness:.25,clearcoat:1,clearcoatRoughness:.05,reflectivity:.9,envMapIntensity:1,side:Ae});new Ot({color:"#C0C0C0",metalness:1,roughness:.2,transparent:!0,opacity:.4,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45});const j=new Ot({color:"#d3d3d3",metalness:1,roughness:.2,map:tt,envMap:tt,clearcoat:.7,clearcoatRoughness:.3});new Ot({color:12632256,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:tt}),new Ot({color:12632256,metalness:1,roughness:.3,clearcoat:.5,clearcoatRoughness:.1,map:R,transparent:!0,opacity:.3});const st=new dt(1,32,32,0,Math.PI),k=new _(st,Z),xt=new _(st,E);k.scale.set(.85,.85,.8),xt.scale.set(.85,.85,.8),k.position.y=-.2,xt.position.y=-.2,k.rotation.y=Math.PI/2,xt.rotation.y=Math.PI*1.5;const Mt=new Ce(1,32),gt=new _(Mt,$);gt.scale.set(.85,.85,.8),gt.position.set(0,-.2,0),gt.rotation.y=Math.PI/2;const Nt=new Xt;Nt.add(k),Nt.add(xt),Nt.add(gt),p.add(Nt);const Wt=new dt(.6,32,32,0,Math.PI),rt=new _(Wt,E);rt.scale.set(1,.95,.95),rt.position.set(0,1,0),rt.rotation.y=Math.PI*1.5;const pt=new _(Wt,Z);pt.scale.set(1,.95,.95),pt.position.set(0,1,0),pt.rotation.y=Math.PI/2;const wt=new Ce(.6,32),O=new _(wt,$);O.position.set(0,1,0),O.rotation.y=Math.PI/2,O.scale.set(1,.95,.95);const ht=new Xt;ht.add(rt),ht.add(pt),ht.add(O),p.add(ht);const ot=new dt(.25,32,32),lt=new _(ot,E);lt.position.set(-.45,1.35,-.1),p.add(lt);const bt=new _(ot,$);bt.position.set(.45,1.35,-.1),p.add(bt);const nt=new dt(.25,32,32,Math.PI/2,Math.PI),g=new _(nt,E);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=Math.PI;const P=new dt(.25,32,32,Math.PI/2,Math.PI),L=new _(P,$);L.scale.set(1.1,.6,.8),L.position.set(0,.84,.5),L.rotation.y=0;const F=new Ce(.25,32),N=new _(F,ct);N.scale.set(.8,.6,.8),N.position.set(0,.84,.5),N.rotation.y=Math.PI/2;const K=new Xt;K.add(g),K.add(L),K.add(N),p.add(K);const J=new Sn;J.moveTo(0,0),J.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),J.bezierCurveTo(-.6,.3,0,.6,0,1),J.bezierCurveTo(0,.6,.6,.3,.6,0),J.bezierCurveTo(.6,-.3,0,-.3,0,0);const w={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},x=new Dn(J,w),C=new dt(.35,32,32),Y=new _(C,E);Y.scale.set(.75,1.25,.65),Y.position.set(-.7,-.15,.2),p.add(Y);const V=new _(C,$);V.scale.set(.75,1.25,.65),V.position.set(.7,-.15,.2),p.add(V);const X=new ne(.2,.22,.6,32),ut=new _(X,E);ut.position.set(-.4,-1.05,0),p.add(ut);const at=new _(X,$);at.position.set(.4,-1.05,0),p.add(at);const vt=new dt(.3,32,32),At=new _(vt,E);At.scale.set(1,.72,1.5),At.position.set(-.4,-1.45,.17),p.add(At);const ft=new _(vt,$);ft.scale.set(1,.72,1.5),ft.position.set(.4,-1.45,.17),p.add(ft);const _t=new dt(.44,32,32),Dt=new _(_t,E);Dt.position.set(-.15,-.45,-.4),p.add(Dt);const Ft=new _(_t,Z);Ft.position.set(.15,-.45,-.4),p.add(Ft);const Rt=new dt(.18,32,32),Qt=new _(Rt,E);Qt.position.set(0,-.35,-.8),p.add(Qt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ce){const he=new Xe("X",{font:ce,size:.2,depth:.05});new es({color:0});const ve=new _(he,M);ve.position.set(-.3,.99,.53),ve.rotation.x=le.degToRad(-5),ve.rotation.y=le.degToRad(-15),p.add(ve);const fe=new Xe("O",{font:ce,size:.2,depth:.05});new es({color:0});const Se=new _(fe,M);Se.position.set(.14,.99,.53),Se.rotation.y=le.degToRad(12),Se.rotation.x=le.degToRad(-5),p.add(Se)}),Qt.renderOrder=1;const Yt=1.2,H=.5,yt=8,it=.7,et=.3,St=.5,Et=d(j,{x:-2,y:0,z:0}),Vt=d(j,{x:0,y:0,z:0}),te=d(j,{x:2,y:0,z:0}),se=d(j,{x:2,y:0,z:0}),ie=d(j,{x:2,y:-2,z:0}),re=new _(x,U);re.scale.set(.3,.3,.3),re.position.set(.25,1.1,0),re.rotation.y=Math.PI,re.rotation.x=Math.PI,p.add(re),Et.position.set(.35,0,0),Vt.position.set(.25,-.3,.4),te.position.set(.3,.3,-.2),se.position.set(.25,.17,.4),ie.position.set(.5,-.3,.45),Et.scale.set(.2,.2,.2),Vt.scale.set(.18,.18,.18),te.scale.set(.15,.15,.15),se.scale.set(.17,.17,.17),ie.scale.set(.15,.15,.15),Vt.rotation.z=Math.PI/4,te.rotation.z=-Math.PI/4,se.rotation.y=-Math.PI/2,ie.rotation.y=-Math.PI/2,p.add(Et),p.add(Vt),p.add(te),p.add(se),p.add(ie),p.rotation.x=.1,p.scale.set(1.4,1.4,1.4),v.add(p),p.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),y.position.set(t.bodyPosition.x,1,t.cameraPosition),y.lookAt(t.bodyPosition.x,0,0),y.position.z=4,f(),qe(()=>t.bodyPosition,ce=>{p.position.set(ce.x,ce.y,ce.z)}),qe(()=>t.cameraPosition,ce=>{y.position.set(t.bodyPosition.x,1,ce),y.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{y.aspect=window.innerWidth/window.innerHeight,y.updateProjectionMatrix(),m.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,f)=>(Wn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),zt("div",IS,[zt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),zt("div",LS,[zt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),US=Kn(DS,[["__scopeId","data-v-9a57b6d8"]]),NS={class:"pixel-controls"},FS={class:"side-buttons"},OS={class:"directional-buttons"},BS={class:"horizontal-buttons"},zS={class:"directional-buttons-woman"},GS={class:"horizontal-buttons-woman"},HS={class:"directional-buttons-kid"},kS={class:"horizontal-buttons-kid"},aa=.1,ca=.05,la=.08,VS=Un({__name:"Water",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);let i=Kt(!1),s=Kt(!1),o=Kt(!1),r=Kt(!1);const a=po(null),c=Kt(!1),l=Kt(!1),h=Kt(!1),u=Kt(!1),d=po(null),f=po(null),v=Kt(!1),y=Kt(!1),m=Kt(!1),p=Kt(!1),T=Kt(!1),S=Kt(!1),b=Kt(!1),B=Kt(!1),I=new Gn({antialias:!0});I.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(I.domElement);const R=new Hn,z=new $e(75,window.innerWidth/window.innerHeight,.1,1e3);z.position.z=5,Vn(()=>{if(e.value){let nt=function(){const Tt=new Xt,Me=new dt(.2,32,32),Pe=new Ut({color:16767916}),ge=new _(Me,Pe);ge.position.set(0,1.5,0),Tt.add(ge);const Ue=new dt(.21,32,32,0,Math.PI*2,0,Math.PI/2),pe=new Ut({color:16711680}),Ie=new _(Ue,pe);Ie.position.set(0,1.58,0),Tt.add(Ie);const ke=new ne(.25,.25,.6,32),Re=new Ut({color:16767916}),ze=new _(ke,Re);ze.position.set(0,1,0),Tt.add(ze);const Qe=new ne(.26,.26,.3,32),je=new Ut({color:255}),ln=new _(Qe,je);ln.position.set(0,.65,0),Tt.add(ln);const rn=new ne(.1,.1,.5,32),Ke=new Ut({color:16767916}),on=new _(rn,Ke);on.position.set(-.15,.25,0),Tt.add(on);const tn=new _(rn,Ke);tn.position.set(.15,.25,0),Tt.add(tn);const dn=new ne(.08,.08,.5,32),pn=new _(dn,Ke);pn.position.set(-.35,1.3,0),pn.rotation.z=Math.PI/4,Tt.add(pn);const Tn=new _(dn,Ke);return Tn.position.set(.35,1.3,0),Tn.rotation.z=-Math.PI/4,Tt.add(Tn),Tt.scale.set(.27,.27,.27),Tt.position.set(-.2,-.1,-.15),Tt},g=function(){const Tt=new Xt,Me=new dt(.18,32,32),Pe=new Ut({color:16767916}),ge=new _(Me,Pe);ge.position.set(0,1.2,.04),Tt.add(ge);const Ue=new dt(.19,32,32,.4,Math.PI*2,0,Math.PI/2),pe=new ne(.18,.18,.4,32),Ie=new Ut({color:9127187}),ke=new _(Ue,Ie);ke.position.set(0,1.28,0),Tt.add(ke);const Re=new _(pe,Ie);Re.position.set(0,1.1,-.01),Tt.add(Re);const ze=new ne(.18,.2,.5,32),Qe=new Ut({color:16767916}),je=new _(ze,Qe);je.position.set(0,.85,0),Tt.add(je);const ln=new dt(.08,32,32,0,Math.PI),rn=new Ut({color:16738740}),Ke=new _(ln,rn);Ke.position.set(-.09,.98,.15),Tt.add(Ke);const on=new _(ln,rn);on.position.set(.09,.98,.15),Tt.add(on);const tn=new ne(.22,.22,.25,32),dn=new Ut({color:16738740}),pn=new _(tn,dn);pn.position.set(0,.6,0),Tt.add(pn);const Tn=new ne(.1,.1,.6,32),bi=new Ut({color:16767916}),Fi=new _(Tn,bi);Fi.position.set(-.09,.5,.2),Fi.rotation.x=Math.PI/2,Tt.add(Fi);const Oi=new _(Tn,bi);Oi.position.set(.09,.5,.2),Oi.rotation.x=Math.PI/2,Tt.add(Oi);const Bi=new ne(.08,.08,.35,32),Ei=new _(Bi,bi);Ei.position.set(-.24,.95,.18),Ei.rotation.x=Math.PI/2,Tt.add(Ei);const fi=new _(Bi,bi);return fi.position.set(.2,.85,0),fi.rotation.z=Math.PI/20,Tt.add(fi),Tt.scale.set(.27,.27,.27),Tt.position.set(.2,-.15,-.32),Tt},P=function(){const Tt=new Xt,Me=new dt(.2,32,32),Pe=new Ut({color:16767916}),ge=new _(Me,Pe);ge.position.set(0,1.5,0),Tt.add(ge);const Ue=new dt(.21,32,32,0,Math.PI*2,0,Math.PI/2),pe=new Ut({color:25600}),Ie=new _(Ue,pe);Ie.position.set(0,1.58,0),Tt.add(Ie);const ke=new ne(.22,.22,.5,32),Re=new Ut({color:16767916}),ze=new _(ke,Re);ze.position.set(0,1,0),Tt.add(ze);const Qe=new ne(.23,.23,.3,32),je=new Ut({color:8388736}),ln=new _(Qe,je);ln.position.set(0,.65,0),Tt.add(ln);const rn=new ne(.1,.1,.5,32),Ke=new Ut({color:16767916}),on=new _(rn,Ke);on.position.set(-.15,.3,-.25),on.rotation.x=Math.PI/6,Tt.add(on);const tn=new _(rn,Ke);tn.position.set(.15,.3,.25),tn.rotation.x=-Math.PI/6,Tt.add(tn);const dn=new ne(.08,.08,.4,32),pn=new _(dn,Ke);pn.position.set(-.28,1,-.2),pn.rotation.x=Math.PI/6,Tt.add(pn);const Tn=new _(dn,Ke);return Tn.position.set(.28,1.3,.1),Tn.rotation.z=-Math.PI/8,Tt.add(Tn),Tt.scale.set(.15,.15,.15),Tt.position.set(.3,-.25,.25),Tt.rotation.x=Math.PI/12,Tt.rotation.y=Math.PI/2,Tt.rotation.z=-Math.PI/3,Tt},L=function(Tt){let Me=1,Pe=0;function ge(){requestAnimationFrame(ge),Tt.position.x+=.01*Me,Tt.position.x>=.35?(Me=-1,Tt.rotation.y=Math.PI):Tt.position.x<=-.35&&(Me=1,Tt.rotation.y=0),Pe+=.003,Tt.position.y=-.4+Math.sin(Pe)*.1,J.render(N,K)}ge()},F=function(){requestAnimationFrame(F),i.value&&(w.rotation.y+=.03),s.value&&(w.rotation.y-=.03),o.value&&(w.rotation.x-=.03),r.value&&(w.rotation.x+=.03),ve.uniforms.u_time.value+=.25,W.rotation.y+=.04,J.render(N,K)};const N=new Hn,K=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),J=new Gn({antialias:!0,alpha:!0});J.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(J.domElement);const w=new Xt,x=new Xt;N.add(x);const C=new hi(16777215,2);N.add(C);const Y=new ui(16777215,4);Y.position.set(5,5,5),N.add(Y);const V=new li(16777215,5,50);V.position.set(0,2,4),N.add(V);const X=new Yn,ut=X.load("/3d-bear-arts/assets/beach.jpg");ut.repeat.set(.8,1);const at=X.load("/3d-bear-arts/assets/sun.jpg");ut.wrapS=ut.wrapT=Je,ut.repeat.set(.8,1),at.wrapS=at.wrapT=Je;const vt=new Ot({color:11592447,map:ut,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),At=new Ot({color:11592447,map:ut,metalness:.3,roughness:.5,transparent:!0,opacity:.6,side:Ae,ior:1.33,depthWrite:!1,depthTest:!0}),ft=new Ot({color:11592447,map:ut,metalness:.1,roughness:.6,transparent:!0,opacity:.6,clearcoat:.9,clearcoatRoughness:.4,transmission:.7,ior:1.2,depthTest:!0,envMapIntensity:.8}),_t=new Ot({color:11592447,map:ut,metalness:.1,roughness:.6,transparent:!0,opacity:.3,clearcoat:.9,clearcoatRoughness:.4,ior:1.2,depthWrite:!1,depthTest:!0,envMapIntensity:.6,side:Ae}),Dt=new Ot({color:11592447,map:ut,metalness:.3,roughness:.5,transparent:!0,opacity:.8,side:Ae,ior:1.33}),Ft=new Ot({color:11592447,map:ut,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Rt=new dt(1,32,32,0,Math.PI),Qt=new _(Rt,_t),Bt=new _(Rt,At);Qt.scale.set(.85,.85,.8),Bt.scale.set(.85,.85,.8),Qt.position.y=-.2,Bt.position.y=-.2,Qt.rotation.y=Math.PI/2,Bt.rotation.y=Math.PI*1.5;const Yt=new Ce(1,32),H=new _(Yt,vt);H.scale.set(.85,.85,.8),H.position.set(0,-.2,0),H.rotation.y=Math.PI/2;const yt=new Xt;yt.add(Qt),yt.add(Bt),yt.add(H),w.add(yt);const it=new dt(.6,32,32,0,Math.PI),et=new _(it,vt);et.scale.set(1,.95,.95),et.position.set(0,1,0),et.rotation.y=Math.PI*1.5;const St=new _(it,ft);St.scale.set(1,.95,.95),St.position.set(0,1,0),St.rotation.y=Math.PI/2;const Et=new Ce(.6,32),Vt=new _(Et,vt);Vt.position.set(0,1,0),Vt.rotation.y=Math.PI/2,Vt.scale.set(1,.95,.95);const te=new Xt;te.add(et),te.add(St),te.add(Vt),w.add(te);const se=new dt(.6,32,32,0,Math.PI*2,0,Math.PI/2),ie=new Ot({color:11592447,metalness:.1,roughness:.2,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.9,transmission:.9,ior:1.33,reflectivity:.8,envMapIntensity:1}),re=new _(se,ie);re.position.set(0,-.2,0),re.rotation.x=Math.PI,re.scale.set(1.25,1.25,1.25),yt.add(re);const ce=new Ot({color:49151,metalness:.1,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,side:Ae,transparent:!0,opacity:.7,depthWrite:!1}),he=new _(Yt,ce);he.scale.set(.7,.7,.7),he.position.set(0,-.3,0),he.rotation.x=Math.PI/2,he.renderOrder=1,yt.add(he),w.add(yt);const ve=new un({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:8},u_waveAmplitude:{value:.05},u_waveSpeed:{value:.2}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),fe=new _(Yt,ve);fe.position.set(0,-.3,0),fe.scale.set(.7,.7,.7),fe.rotation.x=-Math.PI/2,fe.renderOrder=1,yt.add(fe);const Se=new dt(.25,32,32),ye=new _(Se,Dt);ye.position.set(-.45,1.35,-.1),w.add(ye);const De=new _(Se,ft);De.position.set(.45,1.35,-.1),w.add(De);const Te=new dt(.25,32,32,Math.PI/2,Math.PI),Be=new _(Te,Dt);Be.scale.set(1.1,.6,.8),Be.position.set(0,.84,.5),Be.rotation.y=Math.PI;const Le=new dt(.25,32,32,Math.PI/2,Math.PI),me=new _(Le,ft);me.scale.set(1.1,.6,.8),me.position.set(0,.84,.5),me.rotation.y=0;const cn=new Ce(.25,32),He=new _(cn,At);He.scale.set(.8,.6,.8),He.position.set(0,.84,.5),He.rotation.y=Math.PI/2;const Ct=new Xt;Ct.add(Be),Ct.add(me),Ct.add(He),w.add(Ct);const ae=new Ot({color:8374441,metalness:1,roughness:.25,envMap:at,clearcoat:.7,clearcoatRoughness:.3}),A=new Sn;A.moveTo(0,0),A.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),A.bezierCurveTo(-.6,.3,0,.6,0,1),A.bezierCurveTo(0,.6,.6,.3,.6,0),A.bezierCurveTo(.6,-.3,0,-.3,0,0);const q={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},D=new Dn(A,q),W=new _(D,ae);W.scale.set(.2,.2,.2),W.position.set(.25,1.2,0),W.rotation.y=Math.PI,W.rotation.x=Math.PI,w.add(W);const G=new dt(.35,32,32),mt=new _(G,At);mt.scale.set(.75,1.25,.65),mt.position.set(-.7,-.15,.2),w.add(mt);const It=new _(G,_t);It.scale.set(.75,1.25,.65),It.position.set(.7,-.15,.2),w.add(It);const Lt=new ne(.2,.22,.6,32),Gt=new _(Lt,Dt);Gt.position.set(-.4,-1.05,0),w.add(Gt);const qt=new _(Lt,ft);qt.position.set(.4,-1.05,0),w.add(qt);const $t=new dt(.3,32,32),kt=new _($t,Dt);kt.scale.set(1,.72,1.5),kt.position.set(-.4,-1.45,.17),w.add(kt);const ee=new _($t,ft);ee.scale.set(1,.72,1.5),ee.position.set(.4,-1.45,.17),w.add(ee);const de=new dt(.44,32,32),ue=new _(de,Dt);ue.position.set(-.15,-.45,-.4),w.add(ue);const Pt=new _(de,Dt);Pt.position.set(.15,-.45,-.4),w.add(Pt);const jt=new dt(.18,32,32),Ht=new _(jt,Dt);Ht.position.set(0,-.35,-.8),w.add(Ht),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Tt){const Me=new Xe("X",{font:Tt,size:.2,depth:.05}),Pe=new _(Me,Ft);Pe.position.set(-.3,.99,.53),Pe.rotation.x=le.degToRad(-5),Pe.rotation.y=le.degToRad(-15),w.add(Pe);const ge=new Xe("O",{font:Tt,size:.2,depth:.05}),Ue=new _(ge,Ft);Ue.position.set(.14,.99,.53),Ue.rotation.y=le.degToRad(12),Ue.rotation.x=le.degToRad(-5),w.add(Ue)}),a.value=nt(),w.add(a.value),N.add(w),d.value=g(),w.add(d.value),f.value=P(),w.add(f.value),L(f.value),w.scale.set(1.4,1.4,1.4),N.add(w),w.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),K.position.set(t.bodyPosition.x,1,t.cameraPosition),K.lookAt(t.bodyPosition.x,0,0),K.position.z=4,w.rotation.x=.1,F(),qe(()=>t.bodyPosition,Tt=>{w.position.set(Tt.x,Tt.y,Tt.z)}),qe(()=>t.cameraPosition,Tt=>{K.position.set(t.bodyPosition.x,1,Tt),K.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{K.aspect=window.innerWidth/window.innerHeight,K.updateProjectionMatrix(),J.setSize(window.innerWidth,window.innerHeight)})}});function tt(){s.value=!0}function M(){i.value=!0}function E(){o.value=!0}function U(){r.value=!0}function $(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}const Z=()=>{c.value=!0,console.log(c.value),a.value&&(a.value.rotation.y=0),console.log(a.value)},ct=()=>{l.value=!0,a.value&&(a.value.rotation.y=Math.PI),console.log(a.value)},j=()=>{h.value=!0,a.value&&(a.value.rotation.y=Math.PI/2)},st=()=>{u.value=!0,a.value&&(a.value.rotation.y=-Math.PI/2)},k=()=>{c.value=!1,l.value=!1,h.value=!1,u.value=!1},xt=()=>{v.value=!0,d.value&&(d.value.rotation.y=Math.PI)},Mt=()=>{y.value=!0,d.value&&(d.value.rotation.y=0)},gt=()=>{m.value=!0,d.value&&(d.value.rotation.y=-Math.PI/2)},Nt=()=>{p.value=!0,d.value&&(d.value.rotation.y=Math.PI/2)},Wt=()=>{v.value=!1,y.value=!1,m.value=!1,p.value=!1},rt=()=>{requestAnimationFrame(rt),a.value&&(c.value&&(a.value.position.z-=aa),l.value&&(a.value.position.z+=aa),h.value&&(a.value.position.x-=aa),u.value&&(a.value.position.x+=aa)),I.render(R,z)},pt=()=>{requestAnimationFrame(pt),d.value&&(v.value&&(d.value.position.z-=ca),y.value&&(d.value.position.z+=ca),m.value&&(d.value.position.x-=ca),p.value&&(d.value.position.x+=ca))};pt(),rt();const wt=()=>{T.value=!0,f.value&&(f.value.rotation.y=0)},O=()=>{S.value=!0,f.value&&(f.value.rotation.y=Math.PI)},ht=()=>{b.value=!0,f.value&&(f.value.rotation.y=Math.PI/2)},ot=()=>{B.value=!0,f.value&&(f.value.rotation.y=-Math.PI/2)},lt=()=>{T.value=!1,S.value=!1,b.value=!1,B.value=!1},bt=()=>{requestAnimationFrame(bt),f.value&&(T.value&&(f.value.position.z-=la),S.value&&(f.value.position.z+=la),b.value&&(f.value.position.x-=la),B.value&&(f.value.position.x+=la))};return bt(),(nt,g)=>(Wn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),zt("div",NS,[zt("button",{class:"pixel-btn up",onMousedown:E,onMouseup:$},"UP",32),zt("div",FS,[zt("button",{class:"pixel-btn left",onMousedown:tt,onMouseup:$},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:M,onMouseup:$},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:U,onMouseup:$},"DOWN",32)]),zt("div",OS,[zt("button",{id:"move-north",class:"directional-btn north-btn",onMousedown:Z,onMouseup:k},"UP",32),zt("div",BS,[zt("button",{id:"move-west",class:"directional-btn west-btn",onMousedown:j,onMouseup:k},"LEFT",32),zt("button",{id:"move-east",class:"directional-btn east-btn",onMousedown:st,onMouseup:k},"RIGHT",32)]),zt("button",{id:"move-south",class:"directional-btn south-btn",onMousedown:ct,onMouseup:k},"DOWN",32)]),zt("div",zS,[zt("button",{class:"directional-btn-woman north-btn",onMousedown:xt,onMouseup:Wt},"UP",32),zt("div",GS,[zt("button",{class:"directional-btn-woman west-btn",onMousedown:gt,onMouseup:Wt},"LEFT",32),zt("button",{class:"directional-btn-woman east-btn",onMousedown:Nt,onMouseup:Wt},"RIGHT",32)]),zt("button",{class:"directional-btn-woman south-btn",onMousedown:Mt,onMouseup:Wt},"DOWN",32)]),zt("div",HS,[zt("button",{class:"directional-btn-kid north-btn",onMousedown:wt,onMouseup:lt},"UP",32),zt("div",kS,[zt("button",{class:"directional-btn-kid west-btn",onMousedown:ht,onMouseup:lt},"LEFT",32),zt("button",{class:"directional-btn-kid east-btn",onMousedown:ot,onMouseup:lt},"RIGHT",32)]),zt("button",{class:"directional-btn-kid south-btn",onMousedown:O,onMouseup:lt},"DOWN",32)])],64))}}),WS=Kn(VS,[["__scopeId","data-v-f25dfda5"]]),XS={class:"pixel-controls"},qS={class:"side-buttons"},jS=Un({__name:"GhostBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);let i=Kt(!1),s=Kt(!1),o=Kt(!1),r=Kt(!1);Vn(()=>{if(e.value){let d=function(ye,De){const Te=new Xt,Be=new dt(1,32,32),Le=new _(Be,ct);Le.scale.set(1,.8,1),Te.add(Le);const me=new ne(.1,.1,.5,16),cn=new Ut({color:9127187}),He=new _(me,cn);return He.position.set(0,.9,0),Te.add(He),Te},f=function(){requestAnimationFrame(f),i.value&&(p.rotation.y+=.03),s.value&&(p.rotation.y-=.03),o.value&&(p.rotation.x-=.03),r.value&&(p.rotation.x+=.03),Yt.rotation.z-=.04,H.rotation.z+=.04,yt.rotation.z+=.03,it.rotation.z+=.03,x.rotation.y+=.04,Se+=ve,p.position.y=t.bodyPosition.y+Math.sin(Se)*fe;const ye=ce.getElapsedTime();re.forEach((De,Te)=>{const Be=.1+Math.sin(ye*3+he[Te])*.1;De.scale.set(Be,Be,Be)}),m.render(v,y)};const v=new Hn,y=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),m=new Gn({antialias:!0,alpha:!0});m.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(m.domElement);const p=new Xt,T=new Xt;v.add(T);const S=new hi(16777215,2);v.add(S);const b=new ui(16777215,4);b.position.set(5,5,5),v.add(b);const B=new li(16777215,5,50);B.position.set(0,2,4),v.add(B);const I=new Yn,R=I.load("/3d-bear-arts/assets/pumpkin.jpg");R.wrapS=R.wrapT=Je,R.repeat.set(.8,.85);const z=I.load("/3d-bear-arts/assets/pumpkin.jpg");z.wrapS=z.wrapT=Je,z.repeat.set(1,1);const tt=I.load("/3d-bear-arts/assets/pumpkin.jpg");tt.wrapS=z.wrapT=Je,tt.repeat.set(2,.8);const M=new Ot({color:16747520,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),E=new Xt,U=new Ot({color:16747520,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),$=new Ot({color:16747520,map:z,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Z=new Ot({color:16747520,map:tt,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.6,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:Ae}),ct=new Ot({color:16747520,map:tt,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new Ot({color:16766720,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new Ot({color:9109504,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new Ot({color:4915330,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});const j=new dt(1,32,32,0,Math.PI),st=new _(j,Z),k=new _(j,U);st.scale.set(.85,.85,.8),k.scale.set(.85,.85,.8),st.position.y=-.2,k.position.y=-.2,st.rotation.y=Math.PI/2,k.rotation.y=Math.PI*1.5;const xt=new Ce(1,32),Mt=new _(xt,$);Mt.scale.set(.85,.85,.8),Mt.position.set(0,-.2,0),Mt.rotation.y=Math.PI/2;const gt=new Xt;gt.add(st),gt.add(k),gt.add(Mt),p.add(gt);const Nt=new dt(.6,32,32,0,Math.PI),Wt=new _(Nt,U);Wt.scale.set(1,.95,.95),Wt.position.set(0,1,0),Wt.rotation.y=Math.PI*1.5;const rt=new _(Nt,Z);rt.scale.set(1,.95,.95),rt.position.set(0,1,0),rt.rotation.y=Math.PI/2;const pt=new Ce(.6,32),wt=new _(pt,$);wt.position.set(0,1,0),wt.rotation.y=Math.PI/2,wt.scale.set(1,.95,.95);const O=new Xt;O.add(Wt),O.add(rt),O.add(wt),p.add(O);const ht=new dt(.25,32,32),ot=new _(ht,ct);ot.position.set(-.45,1.35,-.1),p.add(ot);const lt=new _(ht,Z);lt.position.set(.45,1.35,-.1),p.add(lt);const bt=new dt(.25,32,32,Math.PI/2,Math.PI),nt=new _(bt,U);nt.scale.set(1.1,.6,.8),nt.position.set(0,.84,.5),nt.rotation.y=Math.PI;const g=new dt(.25,32,32,Math.PI/2,Math.PI),P=new _(g,Z);P.scale.set(1.1,.6,.8),P.position.set(0,.84,.5),P.rotation.y=0;const L=new Ce(.25,32),F=new _(L,U);F.scale.set(.8,.6,.8),F.position.set(0,.84,.5),F.rotation.y=Math.PI/2;const N=new Xt;N.add(nt),N.add(P),N.add(F),p.add(N);const K=new Sn;K.moveTo(0,0),K.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),K.bezierCurveTo(-.6,.3,0,.6,0,1),K.bezierCurveTo(0,.6,.6,.3,.6,0),K.bezierCurveTo(.6,-.3,0,-.3,0,0);const J={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},w=new Dn(K,J),x=new _(w,M);x.scale.set(.3,.3,.3),x.position.set(.25,1.1,0),x.rotation.y=Math.PI,x.rotation.x=Math.PI,p.add(x);const C=new dt(.35,32,32),Y=new _(C,$);Y.scale.set(.75,1.25,.65),Y.position.set(-.7,-.15,.2),p.add(Y);const V=new _(C,Z);V.scale.set(.75,1.25,.65),V.position.set(.7,-.15,.2),p.add(V);const X=new ne(.2,.22,.6,32),ut=new _(X,$);ut.position.set(-.4,-1.05,0),p.add(ut);const at=new _(X,Z);at.position.set(.4,-1.05,0),p.add(at);const vt=new dt(.3,32,32),At=new _(vt,ct);At.scale.set(1,.72,1.5),At.position.set(-.4,-1.45,.17),p.add(At);const ft=new _(vt,Z);ft.scale.set(1,.72,1.5),ft.position.set(.4,-1.45,.17),p.add(ft);const _t=new dt(.44,32,32),Dt=new _(_t,U);Dt.position.set(-.15,-.45,-.4),p.add(Dt);const Ft=new _(_t,Z);Ft.position.set(.15,-.45,-.4),p.add(Ft);const Rt=new dt(.18,32,32),Qt=new _(Rt,ct);Qt.position.set(0,-.35,-.8),p.add(Qt),Qt.renderOrder=1,new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ye){const De=new Xe("X",{font:ye,size:.2,depth:.05}),Te=new _(De,$);Te.position.set(-.3,.99,.53),Te.rotation.x=le.degToRad(-5),Te.rotation.y=le.degToRad(-15),p.add(Te);const Be=new Xe("O",{font:ye,size:.2,depth:.05}),Le=new _(Be,$);Le.position.set(.14,.99,.53),Le.rotation.y=le.degToRad(12),Le.rotation.x=le.degToRad(-5),p.add(Le)}),p.add(E);const Yt=d(),H=d(),yt=d(),it=d();Yt.position.set(.35,-.35,-.3),H.position.set(.25,-.45,.3),yt.position.set(.3,.1,-.2),it.position.set(.25,.18,.4),Yt.scale.set(.3,.3,.3),H.scale.set(.28,.28,.28),yt.scale.set(.25,.25,.25),it.scale.set(.23,.23,.23),H.rotation.z=Math.PI/4,yt.rotation.z=-Math.PI/4,it.rotation.y=-Math.PI/2,p.add(Yt),p.add(H),p.add(yt),p.add(it);const et=new Sn;et.moveTo(-.5,0),et.bezierCurveTo(-.75,.25,-1,.6,-.5,.8),et.bezierCurveTo(-.25,.85,-.25,.5,-.15,.4),et.bezierCurveTo(-.05,.6,.05,.6,.15,.4),et.bezierCurveTo(.25,.5,.25,.85,.5,.8),et.bezierCurveTo(1,.6,.75,.25,.5,0),et.bezierCurveTo(.3,-.25,-.3,-.25,-.5,0);const St={depth:.3,bevelEnabled:!1},Et=new Dn(et,St),Vt=new es({color:0}),te=new _(Et,Vt);te.scale.set(.3,.3,.6),te.rotation.x=0,te.rotation.z=0,te.position.set(.26,.35,.25),p.add(te);const se=new _(Et,Vt);se.scale.set(.5,.5,.5),se.position.set(.4,-.1,.54),p.add(se);const ie=new _(Et,Vt);ie.scale.set(.5,.5,.5),ie.position.set(.32,-.35,.65),p.add(ie),p.rotation.x=.1,p.scale.set(1.4,1.4,1.4),v.add(p),p.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),y.position.set(t.bodyPosition.x,1,t.cameraPosition),y.lookAt(t.bodyPosition.x,0,0),y.position.z=4;const re=[te,se,ie],ce=new zp,he=[0,Math.PI/2,Math.PI,0,Math.PI/3];let ve=.05,fe=.25,Se=0;f(),qe(()=>t.bodyPosition,ye=>{p.position.set(ye.x,ye.y,ye.z)}),qe(()=>t.cameraPosition,ye=>{y.position.set(t.bodyPosition.x,1,ye),y.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{y.aspect=window.innerWidth/window.innerHeight,y.updateProjectionMatrix(),m.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,f)=>(Wn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),zt("div",XS,[zt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),zt("div",qS,[zt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),YS=Kn(jS,[["__scopeId","data-v-5eff72b3"]]),$S={class:"pixel-controls"},KS={class:"side-buttons"},ZS=Un({__name:"GhostBallonBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);let i=Kt(!1),s=Kt(!1),o=Kt(!1),r=Kt(!1);Vn(()=>{if(e.value){let d=function(){requestAnimationFrame(d),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),o.value&&(m.rotation.x-=.03),r.value&&(m.rotation.x+=.03),J.rotation.y+=.03,Vt+=it,te+=et,m.position.y=t.bodyPosition.y+Math.sin(Vt)*Et,J.position.y=t.bodyPosition.y+Math.sin(te)*St,Yt.uniforms.u_time.value+=.25,y.render(f,v)};const f=new Hn,v=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),y=new Gn({antialias:!0,alpha:!0});y.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(y.domElement);const m=new Xt,p=new Xt;f.add(p);const T=new hi(16777215,2);f.add(T);const S=new ui(16777215,4);S.position.set(5,5,5),f.add(S);const b=new li(16777215,5,50);b.position.set(0,2,4),f.add(b);const B=new Yn,I=B.load("/3d-bear-arts/assets/ghost.jpg");I.wrapS=I.wrapT=Je,I.repeat.set(2,2);const R=B.load("/3d-bear-arts/assets/ghost.jpg");R.wrapS=R.wrapT=Je,R.repeat.set(1,1);const z=new Ot({color:16777215,metalness:0,roughness:.8,clearcoat:.3,clearcoatRoughness:.9,transparent:!0,opacity:.15,transmission:.95,ior:1.1,reflectivity:.2,envMapIntensity:.3,depthTest:!0,depthWrite:!1,side:Ae}),tt=new Ot({color:16777215,metalness:0,roughness:.8,clearcoat:.3,clearcoatRoughness:.9,transparent:!0,opacity:.1,envMapIntensity:.3}),M=new Ot({color:9109504,map:I,metalness:.9,roughness:.25,clearcoat:.7,clearcoatRoughness:.3}),E=new Ot({color:16777215,metalness:.1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.1,transmission:.95,ior:1,reflectivity:.2,envMapIntensity:.4,depthTest:!0,depthWrite:!1,side:Ae}),U=new Ot({color:16777215,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.45,transmission:.8,reflectivity:.9,envMapIntensity:1,depthTest:!0,depthWrite:!1,side:Ae}),$=new Ot({color:16777215,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.45,transmission:.8,reflectivity:.9,envMapIntensity:1,side:Ae}),Z=new dt(1,32,32,0,Math.PI),ct=new _(Z,z),j=new _(Z,U);ct.scale.set(.85,.85,.8),j.scale.set(.85,.85,.8),ct.position.y=-.2,j.position.y=-.2,ct.rotation.y=Math.PI/2,j.rotation.y=Math.PI*1.5;const st=new Ce(1,32),k=new _(st,U);k.scale.set(.85,.85,.8),k.position.set(0,-.2,0),k.rotation.y=Math.PI/2;const xt=new Xt;xt.add(ct),xt.add(j),xt.add(k),m.add(xt);const Mt=new dt(.6,32,32,0,Math.PI),gt=new _(Mt,$);gt.scale.set(1,.95,.95),gt.position.set(0,1,0),gt.rotation.y=Math.PI*1.5;const Nt=new _(Mt,tt);Nt.scale.set(1,.95,.95),Nt.position.set(0,1,0),Nt.rotation.y=Math.PI/2;const Wt=new Ce(.6,32),rt=new _(Wt,U);rt.position.set(0,1,0),rt.rotation.y=Math.PI/2,rt.scale.set(1,.95,.95);const pt=new Xt;pt.add(gt),pt.add(Nt),pt.add(rt),m.add(pt);const wt=new dt(.25,32,32),O=new _(wt,$);O.position.set(-.45,1.35,-.1),m.add(O);const ht=new _(wt,tt);ht.position.set(.45,1.35,-.1),m.add(ht);const ot=new dt(.25,32,32,Math.PI/2,Math.PI),lt=new _(ot,$);lt.scale.set(1.1,.6,.8),lt.position.set(0,.84,.5),lt.rotation.y=Math.PI;const bt=new dt(.25,32,32,Math.PI/2,Math.PI),nt=new _(bt,tt);nt.scale.set(1.1,.6,.8),nt.position.set(0,.84,.5),nt.rotation.y=0;const g=new Ce(.25,32),P=new _(g,E);P.scale.set(.8,.6,.8),P.position.set(0,.84,.5),P.rotation.y=Math.PI/2;const L=new Xt;L.add(lt),L.add(nt),L.add(P),m.add(L);const F=new Sn;F.moveTo(0,0),F.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),F.bezierCurveTo(-.6,.3,0,.6,0,1),F.bezierCurveTo(0,.6,.6,.3,.6,0),F.bezierCurveTo(.6,-.3,0,-.3,0,0);const N={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},K=new Dn(F,N),J=new _(K,M);J.scale.set(.35,.35,.35),J.position.set(0,-.05,0),J.rotation.y=Math.PI,J.rotation.x=Math.PI,m.add(J);const w=new dt(.35,32,32),x=new _(w,U);x.scale.set(.75,1.25,.65),x.position.set(-.7,-.15,.2),m.add(x);const C=new _(w,E);C.scale.set(.75,1.25,.65),C.position.set(.7,-.15,.2),m.add(C);const Y=new ne(.2,.22,.6,32),V=new _(Y,U);V.position.set(-.4,-1.05,0),m.add(V);const X=new _(Y,E);X.position.set(.4,-1.05,0),m.add(X);const ut=new dt(.3,32,32),at=new _(ut,U);at.scale.set(1,.72,1.5),at.position.set(-.4,-1.45,.17),m.add(at);const vt=new _(ut,E);vt.scale.set(1,.72,1.5),vt.position.set(.4,-1.45,.17),m.add(vt);const At=new dt(.44,32,32),ft=new _(At,E);ft.position.set(-.15,-.45,-.4),m.add(ft);const _t=new _(At,E);_t.position.set(.15,-.45,-.4),m.add(_t);const Dt=new dt(.18,32,32),Ft=new _(Dt,U);Ft.position.set(0,-.35,-.8),m.add(Ft);const Rt=new dt(.6,32,32,0,Math.PI*2,0,Math.PI/2),Qt=new Ot({color:9109504,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.8,transmission:.85,ior:1.4,reflectivity:.9,envMapIntensity:1.2}),Bt=new _(Rt,Qt);Bt.position.set(0,-.2,0),Bt.rotation.x=Math.PI,Bt.scale.set(1.25,1.25,1.25),xt.add(Bt);const Yt=new un({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:4},u_waveAmplitude:{value:.5},u_waveSpeed:{value:.3}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),H=new _(st,Yt);H.position.set(0,-.26,0),H.scale.set(.7,.7,.7),H.rotation.x=-Math.PI/2,H.renderOrder=1,xt.add(H),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(se){const ie=new Xe("X",{font:se,size:.2,depth:.05}),re=new _(ie,U);re.position.set(-.3,.99,.53),re.rotation.x=le.degToRad(-5),re.rotation.y=le.degToRad(-15),m.add(re);const ce=new Xe("O",{font:se,size:.2,depth:.05}),he=new _(ce,U);he.position.set(.14,.99,.53),he.rotation.y=le.degToRad(12),he.rotation.x=le.degToRad(-5),m.add(he)}),Ft.renderOrder=1,m.rotation.x=.1,m.scale.set(1.4,1.4,1.4),f.add(m),m.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),v.position.set(t.bodyPosition.x,1,t.cameraPosition),v.lookAt(t.bodyPosition.x,0,0),v.position.z=4;let it=.05,et=.06,St=.2,Et=.25,Vt=0,te=0;d(),qe(()=>t.bodyPosition,se=>{m.position.set(se.x,se.y,se.z)}),qe(()=>t.cameraPosition,se=>{v.position.set(t.bodyPosition.x,1,se),v.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{v.aspect=window.innerWidth/window.innerHeight,v.updateProjectionMatrix(),y.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,f)=>(Wn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),zt("div",$S,[zt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),zt("div",KS,[zt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),JS=Kn(ZS,[["__scopeId","data-v-eb44448e"]]),QS={class:"pixel-controls"},tb={class:"side-buttons"},eb=15,nb=5,ib=Un({__name:"Santa",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);let i=Kt(!1),s=Kt(!1),o=Kt(!1),r=Kt(!1);const a=po(null),c=new Gn({antialias:!0});c.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(c.domElement),new Hn;const l=new $e(75,window.innerWidth/window.innerHeight,.1,1e3);l.position.z=4,Vn(()=>{if(e.value){let y=function(){const Ct=new Xt,ae=new qn(.12,.05,16,100),A=new Ut({color:16777215}),q=new _(ae,A);q.position.set(0,1.65,0),q.rotation.x=Math.PI/2,Ct.add(q);const D=new ai(.15,.3,32),W=new Ut({color:16711680}),G=new _(D,W);G.position.set(0,1.8,0),Ct.add(G);const mt=new dt(.05,32,32),It=new Ut({color:16777215}),Lt=new _(mt,It);return Lt.position.set(0,1.93,0),Ct.add(Lt),Ct.position.set(0,-.1,0),Ct},m=function(){const Ct=new Xt,ae=new dt(.15,32,32),A=new Ut({color:16764057}),q=new _(ae,A);q.position.set(0,.4,0),Ct.add(q);const D=new ai(.08,.15,32);new Ut({color:16764057});const W=new _(D,Nt);W.position.set(-.1,.55,0),W.rotation.z=Math.PI/6,Ct.add(W);const G=new _(D,Nt);G.position.set(.1,.55,0),G.rotation.z=-Math.PI/6,Ct.add(G);const mt=new ne(.12,.15,.3,32),It=new Ut({color:16764057}),Lt=new _(mt,It);Lt.position.set(0,.2,0),Ct.add(Lt);const Gt=new ne(.05,.05,.2,32),qt=new Ut({color:16764057}),$t=new _(Gt,qt);$t.position.set(-.07,-.05,.05),Ct.add($t);const kt=new _(Gt,qt);kt.position.set(.07,-.05,.05),Ct.add(kt);const ee=new ne(.04,.04,.2,32),de=new Ut({color:16764057}),ue=new _(ee,Nt);ue.position.set(-.15,.25,0),ue.rotation.z=Math.PI/4,Ct.add(ue);const Pt=new _(ee,de);Pt.position.set(.15,.25,0),Pt.rotation.z=-Math.PI/4,Ct.add(Pt);const jt=new ne(.03,.03,.25,32),Ht=new Ut({color:16764057}),oe=new _(jt,Ht);return oe.position.set(0,.1,-.2),oe.rotation.x=Math.PI/4,Ct.add(oe),Ct.scale.set(.75,.75,.75),Ct.position.set(.2,0,.2),Ct},p=function(){const Ct=new Xt,ae=new dt(.2,32,32),A=new Ut({color:16764057}),q=new _(ae,A);q.position.set(0,1,0),Ct.add(q);const D=new Ut({color:16777215}),W=[{x:0,y:.85,z:.15,size:.12},{x:-.1,y:.88,z:.1,size:.1},{x:.1,y:.88,z:.1,size:.1},{x:-.15,y:.95,z:.1,size:.08},{x:.15,y:.95,z:.1,size:.08}];for(const fi of W){const Ar=new dt(fi.size,16,16),Ws=new _(Ar,D);Ws.position.set(fi.x,fi.y-.06,fi.z-.01),Ct.add(Ws)}const G=new Ut({color:16777215}),mt=new ne(.05,.06,.1,32),It=new _(mt,G);It.position.set(-.06,.93,.18),It.rotation.z=Math.PI/4;const Lt=new ne(.05,.06,.1,32),Gt=new _(Lt,G);Gt.position.set(.06,.93,.18),Gt.rotation.z=-Math.PI/4;const qt=new qn(.12,.05,16,100),$t=new Ut({color:16777215}),kt=new _(qt,$t);kt.position.set(0,1.15,0),kt.rotation.x=Math.PI/2,Ct.add(kt);const ee=new ai(.15,.3,32),de=new Ut({color:16711680}),ue=new _(ee,de);ue.position.set(0,1.3,0),Ct.add(ue);const Pt=new dt(.05,32,32),jt=new Ut({color:16777215}),Ht=new _(Pt,jt);Ht.position.set(0,1.43,0),Ct.add(Ht);const oe=new ne(.2,.25,.6,32),Tt=new Ut({color:16711680}),Me=new _(oe,Tt);Me.position.set(0,.5,0),Ct.add(Me);const Pe=new ne(.25,.25,.1,32),ge=new Ut({color:0}),Ue=new _(Pe,ge);Ue.position.set(0,.4,.005),Ct.add(Ue);const pe=new ne(.06,.06,.3,32),Ie=new Ut({color:16711680}),ke=new _(pe,Ie);ke.position.set(-.25,.75,0),ke.rotation.z=Math.PI/4,Ct.add(ke);const Re=new _(pe,Ie);Re.position.set(.25,.75,0),Re.rotation.z=-Math.PI/4,Ct.add(Re);const ze=new dt(.07,32,32),Qe=new Ut({color:16777215}),je=new _(ze,Qe);je.position.set(-.35,.85,0),Ct.add(je);const ln=new _(ze,Qe);ln.position.set(.35,.85,0),Ct.add(ln);const rn=new ne(.1,.1,.15,32),Ke=new Ut({color:16711680}),on=new ne(.08,.08,.4,32),tn=new Ut({color:0}),dn=new _(on,tn);dn.position.set(-.1,.1,0),Ct.add(dn);const pn=new _(rn,Ke);pn.position.set(-.1,-.05,0),Ct.add(pn);const Tn=new _(on,tn);Tn.position.set(.1,.1,0),Ct.add(Tn);const bi=new _(rn,Ke);bi.position.set(.1,-.05,0),Ct.add(bi);const Fi=new dt(.12,32,32),Oi=new Ut({color:16711680}),Bi=new _(Fi,Oi);Bi.scale.set(1,.7,1.5),Bi.position.set(-.1,-.12,.12),Ct.add(Bi);const Ei=new _(Fi,Oi);return Ei.scale.set(1,.7,1.5),Ei.position.set(.1,-.1,.12),Ct.add(Ei),Ct.scale.set(.25,.25,.25),Ct.position.set(.2,.5,-0),Ct},T=function(){let Ct=0;function ae(){requestAnimationFrame(ae),Ct+=.4,ve.position.y=.45+Math.sin(Ct)*.5,E.render(tt,M)}ae()},S=function(Ct){let ae=1,A=0;function q(){requestAnimationFrame(q),Ct.position.x+=.01*ae,Ct.position.x>=.5?(ae=-1,Ct.rotation.y=Math.PI):Ct.position.x<=0&&(ae=1,Ct.rotation.y=0),A+=1,Ct.position.y=-.2+Math.sin(A)*.01,Ct.position.z=.5,E.render(tt,M)}q()},b=function(){const Ct=new Xt,ae=new Mn(.7,.8,.7),A=new Ut({color:9127187}),q=new _(ae,A);q.position.set(0,.4,0),Ct.add(q);const D=new ai(.55,.25,4),W=new Ut({color:16777215}),G=new _(D,W);G.position.set(0,.9,0),G.rotation.y=Math.PI/4,Ct.add(G);const mt=new Mn(.25,.35,.05),It=new Ut({color:6636321}),Lt=new _(mt,It);Lt.position.set(0,.2,.36),Ct.add(Lt);const Gt=new Mn(.15,.15,.05),qt=new Ut({color:8900331}),$t=new _(Gt,qt);$t.position.set(-.2,.5,.38),Ct.add($t);const kt=new _(Gt,qt);kt.position.set(.2,.5,.38),Ct.add(kt);const ee=new Mn(.2,.4,.2),de=new Ut({color:8421504}),ue=new _(ee,de);ue.position.set(0,.95,0),Ct.add(ue);const Pt=new qn(.07,.04,32,100),jt=new Ut({color:2263842}),Ht=new _(Pt,jt);return Ht.position.set(0,.45,.38),Ct.add(Ht),Ct.position.set(.22,-.2,0),Ct.scale.set(.5,.5,.5),Ct},B=function(Ct=1,ae={x:0,y:0,z:0}){const A=new Xt,q=new ne(1.2,.9,3,32),D=new Ut({color:25153}),W=new _(q,D);A.add(W);const G=new ne(1.3,1.3,.2,32),mt=new Ut({color:3355443}),It=new _(G,mt);It.position.y=1.6,A.add(It);const Lt=2,Gt=new ne(1.1,1.1,Lt,32),qt=new Ut({color:9127187}),$t=new _(Gt,qt);return $t.position.y=0,new Yn().load("/3d-bear-arts/assets/starbucks-logo.png",function(ee){ee.repeat.set(4,1),ee.offset.set(.25,0),ee.wrapS=Je,ee.wrapT=Je;const de=new Ut({color:9127187,map:ee,transparent:!0}),ue=new ne(1.1,1.05,1.5,32),Pt=new _(ue,de);Pt.position.y=-.5,A.add(Pt)}),A.scale.set(Ct,Ct,Ct),A.position.set(ae.x,ae.y,ae.z),A},I=function(){let Ct=1;function ae(){requestAnimationFrame(ae),Ct-=.1,Te.position.y=.5+Math.sin(Ct)*.8,E.render(tt,M)}ae()},R=function(){requestAnimationFrame(R);const Ct=Le.attributes.position.array;for(let ae=1;ae<Ct.length;ae+=3)Ct[ae]-=.02,Ct[ae]<-10&&(Ct[ae]=10);Le.attributes.position.needsUpdate=!0,E.render(tt,M)},z=function(){requestAnimationFrame(z),i.value&&(U.rotation.y+=.03),s.value&&(U.rotation.y-=.03),o.value&&(U.rotation.x-=.03),r.value&&(U.rotation.x+=.03),a.value&&(a.value.rotation.y+=.7),Y.uniforms.u_time.value+=.5,fe.rotation.y+=.45,De.rotation.y+=.05,Te.rotation.y+=.08,E.render(tt,M)};const tt=new Hn,M=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),E=new Gn({antialias:!0,alpha:!0});E.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(E.domElement);const U=new Xt,$=new Xt;tt.add($);const Z=new hi(16777215,2);tt.add(Z);const ct=new ui(16777215,4);ct.position.set(5,5,5),tt.add(ct);const j=new li(16777215,5,50);j.position.set(0,2,4),tt.add(j);const st=new Yn,k=st.load("/3d-bear-arts/assets/house.jpg");k.wrapS=k.wrapT=Je,k.repeat.set(1,1),st.load("/3d-bear-arts/assets/houseenv_texture_5.jpg");const xt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.6,transmission:1,ior:1.33,thickness:.01,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae}),Mt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.35,transmission:1,ior:1.33,thickness:.01,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae}),gt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.4,transmission:.7,ior:1.33,thickness:.5,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae}),Nt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.6,transmission:.8,ior:1.33,thickness:.7,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae}),Wt=new Tr().load(["/3d-bear-arts/assets/house_env_texture_1.jpg","/3d-bear-arts/assets/house_env_texture_4.jpg","/3d-bear-arts/assets/house_env_texture_6.jpg","/3d-bear-arts/assets/house_env_texture_2.jpg","/3d-bear-arts/assets/house_env_texture_5.jpg","/3d-bear-arts/assets/house_env_texture_3.jpg"]);tt.environment=Wt;const rt=new Ot({color:16777215,metalness:.05,roughness:.2,transparent:!0,opacity:.5,transmission:.2,ior:1.5,depthWrite:!0,envMapIntensity:1,side:Ae}),pt=new Ot({color:16777215,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),wt=new dt(1,32,32,0,Math.PI),O=new _(wt,Mt),ht=new _(wt,gt);O.scale.set(.85,.85,.8),ht.scale.set(.85,.85,.8),O.position.y=-.2,ht.position.y=-.2,O.rotation.y=Math.PI/2,ht.rotation.y=Math.PI*1.5;const ot=new Ce(1,32),lt=new _(ot,rt);lt.scale.set(.85,.85,.8),lt.position.set(0,-.2,0),lt.rotation.y=Math.PI/2;const bt=new Xt;bt.add(O),bt.add(ht),bt.add(lt),U.add(bt);const nt=new dt(.6,32,32,0,Math.PI),g=new _(nt,Nt);g.scale.set(1,.95,.95),g.position.set(0,1,0),g.rotation.y=Math.PI*1.5;const P=new _(nt,Mt);P.scale.set(1,.95,.95),P.position.set(0,1,0),P.rotation.y=Math.PI/2;const L=new Ce(.6,32),F=new _(L,rt);F.position.set(0,1,0),F.rotation.y=Math.PI/2,F.scale.set(1,.95,.95);const N=new Xt;N.add(g),N.add(P),N.add(F),U.add(N);const K=new dt(.6,32,32,0,Math.PI*2,0,Math.PI/2),J=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.5,clearcoatRoughness:.7,transparent:!1,opacity:.85}),w=new _(K,J);w.position.set(0,-.2,0),w.rotation.x=Math.PI,w.scale.set(1.25,1.25,1.25),bt.add(w);const x=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.6,clearcoatRoughness:.8,side:Ae,transparent:!1,opacity:.8}),C=new _(ot,x);C.scale.set(.7,.7,.7),C.position.set(0,-.3,0),C.rotation.x=Math.PI/2,C.renderOrder=1,bt.add(C),U.add(bt);const Y=new un({transparent:!0,uniforms:{u_time:{value:0}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),V=new _(ot,Y);V.position.set(0,-.2,0),V.scale.set(.7,.7,.7),V.rotation.x=-Math.PI/2,V.renderOrder=2,bt.add(V);const X=new dt(.25,32,32),ut=new _(X,Nt);ut.position.set(-.45,1.35,-.1),U.add(ut);const at=new _(X,xt);at.position.set(.45,1.35,-.1),U.add(at);const vt=new dt(.25,32,32,Math.PI/2,Math.PI),At=new _(vt,Nt);At.scale.set(1.1,.6,.8),At.position.set(0,.84,.5),At.rotation.y=Math.PI;const ft=new dt(.25,32,32,Math.PI/2,Math.PI),_t=new _(ft,xt);_t.scale.set(1.1,.6,.8),_t.position.set(0,.84,.5),_t.rotation.y=0;const Dt=new Ce(.25,32),Ft=new _(Dt,rt);Ft.scale.set(.8,.6,.8),Ft.position.set(0,.84,.5),Ft.rotation.y=Math.PI/2;const Rt=new Xt;Rt.add(At),Rt.add(_t),Rt.add(Ft),U.add(Rt);const Qt=new dt(.35,32,32),Bt=new _(Qt,Nt);Bt.scale.set(.75,1.25,.65),Bt.position.set(-.7,-.15,.2),U.add(Bt);const Yt=new _(Qt,xt);Yt.scale.set(.75,1.25,.65),Yt.position.set(.7,-.15,.2),U.add(Yt);const H=new ne(.2,.22,.6,32),yt=new _(H,Nt);yt.position.set(-.4,-1.05,0),U.add(yt);const it=new _(H,xt);it.position.set(.4,-1.05,0),U.add(it);const et=new dt(.3,32,32),St=new _(et,Nt);St.scale.set(1,.72,1.5),St.position.set(-.4,-1.45,.17),U.add(St);const Et=new _(et,xt);Et.scale.set(1,.72,1.5),Et.position.set(.4,-1.45,.17),U.add(Et);const Vt=new dt(.44,32,32),te=new _(Vt,Nt);te.position.set(-.15,-.45,-.4),U.add(te);const se=new _(Vt,pt);se.position.set(.15,-.45,-.4),U.add(se);const ie=new dt(.18,32,32),re=new _(ie,Nt);re.position.set(0,-.35,-.8),U.add(re),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Ct){const ae=new Xe("X",{font:Ct,size:.2,depth:.05}),A=new _(ae,pt);A.position.set(-.3,.99,.53),A.rotation.x=le.degToRad(-5),A.rotation.y=le.degToRad(-15),U.add(A);const q=new Xe("+",{font:Ct,size:.25,depth:.1}),D=new _(q,pt);D.position.set(.12,.99,.53),D.rotation.y=le.degToRad(12),D.rotation.x=le.degToRad(-5),U.add(D)});const he=y();U.add(he),m();const ve=p();U.add(ve);const fe=p();fe.position.set(-.2,-.1,.5),U.add(fe),T(),a.value=p(),U.add(a.value),S(a.value);const Se=b();U.add(Se);const ye=b();ye.position.set(-.2,-.2,0),ye.scale.set(.35,.35,.35),U.add(ye);const De=B(.1,{x:0,y:0,z:1}),Te=B(1.1,{x:0,y:-1.2,z:0});I();const Be=1e3,Le=new En,me=[];for(let Ct=0;Ct<Be;Ct++){const ae=(Math.random()-.5)*20,A=Math.random()*20,q=(Math.random()-.5)*20;me.push(ae,A,q)}Le.setAttribute("position",new sn(me,3));const cn=new vr({color:16777215,size:.1,transparent:!0,opacity:.8}),He=new sr(Le,cn);U.add(He),R(),U.scale.set(1.2,1.2,1.2),tt.add(U),U.scale.set(1.4,1.4,1.4),U.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),tt.add(U),U.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),U.position.y=-.25,M.position.set(t.bodyPosition.x,1.4,t.cameraPosition),M.position.set(0,1,4),M.lookAt(t.bodyPosition.x,0,0),M.position.z=4,U.rotation.x=.1,z(),qe(()=>t.bodyPosition,Ct=>{U.position.set(Ct.x,Ct.y,Ct.z)}),qe(()=>t.cameraPosition,Ct=>{M.position.set(t.bodyPosition.x,1,Ct),M.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{M.aspect=window.innerWidth/window.innerHeight,M.updateProjectionMatrix(),E.setSize(window.innerWidth,window.innerHeight)})}});function h(){s.value=!0}function u(){i.value=!0}function d(){o.value=!0}function f(){r.value=!0}function v(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let y=0;y<eb;y++){const m=document.createElement("div");m.classList.add("confetti"),m.style.left=`${Math.random()*100}vw`,m.style.animationDuration=`${Math.random()*3+4}s`,m.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(m)}for(let y=0;y<nb;y++){const m=document.createElement("div");m.classList.add("light"),document.body.appendChild(m)}return(y,m)=>(Wn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),zt("div",QS,[zt("button",{class:"pixel-btn up",onMousedown:d,onMouseup:v},"UP",32),zt("div",tb,[zt("button",{class:"pixel-btn left",onMousedown:h,onMouseup:v},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:u,onMouseup:v},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:f,onMouseup:v},"DOWN",32)])],64))}}),sb=Kn(ib,[["__scopeId","data-v-43013412"]]),ob={class:"pixel-controls"},rb={class:"side-buttons"},ab=15,cb=5,lb=Un({__name:"Aquar",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);let i=Kt(!1),s=Kt(!1),o=Kt(!1),r=Kt(!1);const a=po(null),c=new Gn({antialias:!0});c.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(c.domElement),new Hn;const l=new $e(75,window.innerWidth/window.innerHeight,.1,1e3);l.position.z=5,Vn(()=>{if(e.value){let y=function(){const D=new Xt,W=new qn(.12,.05,16,100),G=new Ut({color:16777215}),mt=new _(W,G);mt.position.set(0,1.65,0),mt.rotation.x=Math.PI/2,D.add(mt);const It=new ai(.15,.3,32),Lt=new Ut({color:16711680}),Gt=new _(It,Lt);Gt.position.set(0,1.8,0),D.add(Gt);const qt=new dt(.05,32,32),$t=new Ut({color:16777215}),kt=new _(qt,$t);return kt.position.set(0,1.93,0),D.add(kt),D.position.set(0,-.1,0),D},m=function(){const D=new Xt,W=new dt(.15,32,32),G=new Ut({color:16764057}),mt=new _(W,G);mt.position.set(0,.4,0),D.add(mt);const It=new ai(.08,.15,32);new Ut({color:16764057});const Lt=new _(It,Mt);Lt.position.set(-.1,.55,0),Lt.rotation.z=Math.PI/6,D.add(Lt);const Gt=new _(It,Mt);Gt.position.set(.1,.55,0),Gt.rotation.z=-Math.PI/6,D.add(Gt);const qt=new ne(.12,.15,.3,32),$t=new Ut({color:16764057}),kt=new _(qt,$t);kt.position.set(0,.2,0),D.add(kt);const ee=new ne(.05,.05,.2,32),de=new Ut({color:16764057}),ue=new _(ee,de);ue.position.set(-.07,-.05,.05),D.add(ue);const Pt=new _(ee,de);Pt.position.set(.07,-.05,.05),D.add(Pt);const jt=new ne(.04,.04,.2,32),Ht=new Ut({color:16764057}),oe=new _(jt,Mt);oe.position.set(-.15,.25,0),oe.rotation.z=Math.PI/4,D.add(oe);const Tt=new _(jt,Ht);Tt.position.set(.15,.25,0),Tt.rotation.z=-Math.PI/4,D.add(Tt);const Me=new ne(.03,.03,.25,32),Pe=new Ut({color:16764057}),ge=new _(Me,Pe);return ge.position.set(0,.1,-.2),ge.rotation.x=Math.PI/4,D.add(ge),D.scale.set(.75,.75,.75),D.position.set(.2,0,.2),D},p=function(){const D=new Xt,W=new dt(.2,32,32),G=new Ut({color:16764057}),mt=new _(W,G);mt.position.set(0,1,0),D.add(mt);const It=new Ut({color:16777215}),Lt=[{x:0,y:.85,z:.15,size:.12},{x:-.1,y:.88,z:.1,size:.1},{x:.1,y:.88,z:.1,size:.1},{x:-.15,y:.95,z:.1,size:.08},{x:.15,y:.95,z:.1,size:.08}];for(const Pr of Lt){const kp=new dt(Pr.size,16,16),Fu=new _(kp,It);Fu.position.set(Pr.x,Pr.y-.06,Pr.z-.01),D.add(Fu)}const Gt=new Ut({color:16777215}),qt=new ne(.05,.06,.1,32),$t=new _(qt,Gt);$t.position.set(-.06,.93,.18),$t.rotation.z=Math.PI/4;const kt=new ne(.05,.06,.1,32),ee=new _(kt,Gt);ee.position.set(.06,.93,.18),ee.rotation.z=-Math.PI/4;const de=new qn(.12,.05,16,100),ue=new Ut({color:16777215}),Pt=new _(de,ue);Pt.position.set(0,1.15,0),Pt.rotation.x=Math.PI/2,D.add(Pt);const jt=new ai(.15,.3,32),Ht=new Ut({color:16711680}),oe=new _(jt,Ht);oe.position.set(0,1.3,0),D.add(oe);const Tt=new dt(.05,32,32),Me=new Ut({color:16777215}),Pe=new _(Tt,Me);Pe.position.set(0,1.43,0),D.add(Pe);const ge=new ne(.2,.25,.6,32),Ue=new Ut({color:16711680}),pe=new _(ge,Ue);pe.position.set(0,.5,0),D.add(pe);const Ie=new ne(.25,.25,.1,32),ke=new Ut({color:0}),Re=new _(Ie,ke);Re.position.set(0,.4,.005),D.add(Re);const ze=new ne(.06,.06,.3,32),Qe=new Ut({color:16711680}),je=new _(ze,Qe);je.position.set(-.25,.75,0),je.rotation.z=Math.PI/4,D.add(je);const ln=new _(ze,Qe);ln.position.set(.25,.75,0),ln.rotation.z=-Math.PI/4,D.add(ln);const rn=new dt(.07,32,32),Ke=new Ut({color:16777215}),on=new _(rn,Ke);on.position.set(-.35,.85,0),D.add(on);const tn=new _(rn,Ke);tn.position.set(.35,.85,0),D.add(tn);const dn=new ne(.1,.1,.15,32),pn=new Ut({color:16711680}),Tn=new ne(.08,.08,.4,32),bi=new Ut({color:0}),Fi=new _(Tn,bi);Fi.position.set(-.1,.1,0),D.add(Fi);const Oi=new _(dn,pn);Oi.position.set(-.1,-.05,0),D.add(Oi);const Bi=new _(Tn,bi);Bi.position.set(.1,.1,0),D.add(Bi);const Ei=new _(dn,pn);Ei.position.set(.1,-.05,0),D.add(Ei);const fi=new dt(.12,32,32),Ar=new Ut({color:16711680}),Ws=new _(fi,Ar);Ws.scale.set(1,.7,1.5),Ws.position.set(-.1,-.12,.12),D.add(Ws);const Qa=new _(fi,Ar);return Qa.scale.set(1,.7,1.5),Qa.position.set(.1,-.1,.12),D.add(Qa),D.scale.set(.25,.25,.25),D.position.set(.2,.5,-0),D},T=function(){let D=0;function W(){requestAnimationFrame(W),D+=.4,ce.position.y=.45+Math.sin(D)*.5,E.render(tt,M)}W()},S=function(D){let W=1,G=0;function mt(){requestAnimationFrame(mt),D.position.x+=.01*W,D.position.x>=.5?(W=-1,D.rotation.y=Math.PI):D.position.x<=0&&(W=1,D.rotation.y=0),G+=1,D.position.y=-.2+Math.sin(G)*.01,D.position.z=.5,E.render(tt,M)}mt()},b=function(){const D=new Xt,W=new Mn(.7,.8,.7),G=new Ut({color:9127187}),mt=new _(W,G);mt.position.set(0,.4,0),D.add(mt);const It=new ai(.55,.25,4),Lt=new Ut({color:16777215}),Gt=new _(It,Lt);Gt.position.set(0,.9,0),Gt.rotation.y=Math.PI/4,D.add(Gt);const qt=new Mn(.25,.35,.05),$t=new Ut({color:6636321}),kt=new _(qt,$t);kt.position.set(0,.2,.36),D.add(kt);const ee=new Mn(.15,.15,.05),de=new Ut({color:8900331}),ue=new _(ee,de);ue.position.set(-.2,.5,.38),D.add(ue);const Pt=new _(ee,de);Pt.position.set(.2,.5,.38),D.add(Pt);const jt=new Mn(.2,.4,.2),Ht=new Ut({color:8421504}),oe=new _(jt,Ht);oe.position.set(0,.95,0),D.add(oe);const Tt=new qn(.07,.04,32,100),Me=new Ut({color:2263842}),Pe=new _(Tt,Me);return Pe.position.set(0,.45,.38),D.add(Pe),D.position.set(.22,-.2,0),D.scale.set(.5,.5,.5),D},B=function(D=1,W={x:0,y:0,z:0}){const G=new Xt,mt=new ne(1.2,.9,3,32),It=new Ut({color:25153}),Lt=new _(mt,It);G.add(Lt);const Gt=new ne(1.3,1.3,.2,32),qt=new Ut({color:3355443}),$t=new _(Gt,qt);return $t.position.y=1.6,G.add($t),new Yn().load("/3d-bear-arts/assets/starbucks-logo.png",function(ee){ee.repeat.set(4,1),ee.offset.set(.25,0),ee.wrapS=Je,ee.wrapT=Je;const de=new Ut({color:9127187,map:ee,transparent:!0}),ue=new ne(1.1,1.05,1.5,32),Pt=new _(ue,de);Pt.position.y=-.5,G.add(Pt)}),G.scale.set(D,D,D),G.position.set(W.x,W.y,W.z),G},I=function(){requestAnimationFrame(I);const D=Te.attributes.position.array;for(let W=1;W<D.length;W+=3)D[W]-=.02,D[W]<-10&&(D[W]=10);Te.attributes.position.needsUpdate=!0,E.render(tt,M)},R=function(){requestAnimationFrame(R);const D=ae.attributes.position.array;for(let W=1;W<D.length;W+=3)D[W]-=.02,D[W]<-Ct&&(D[W]=Ct);ae.attributes.position.needsUpdate=!0,E.render(tt,M)},z=function(){requestAnimationFrame(z),i.value&&(U.rotation.y+=.03),s.value&&(U.rotation.y-=.03),o.value&&(U.rotation.x-=.03),r.value&&(U.rotation.x+=.03),a.value&&(a.value.rotation.y+=.7),x.uniforms.u_time.value+=.5,he.rotation.y+=.45,Se.rotation.y+=.05,ye.rotation.y+=.05,U.rotation.y-=.05,E.render(tt,M)};const tt=new Hn,M=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),E=new Gn({antialias:!0,alpha:!0});E.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(E.domElement);const U=new Xt,$=new Xt;tt.add($);const Z=new hi(16777215,2);tt.add(Z);const ct=new ui(16777215,4);ct.position.set(5,5,5),tt.add(ct);const j=new li(16777215,5,50);j.position.set(0,2,4),tt.add(j);const st=new Yn,k=st.load("/3d-bear-arts/assets/house.jpg");k.wrapS=k.wrapT=Je,k.repeat.set(1,1),st.load("/3d-bear-arts/assets/houseenv_texture_5.jpg");const xt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.5,transmission:1,ior:1.33,thickness:.01,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae});new Ot({color:16777215,metalness:.3,map:k,roughness:.05,transparent:!0,opacity:.5,transmission:.7,ior:1.33,thickness:.4,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae});const Mt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.6,transmission:.8,ior:1.33,thickness:.7,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:Ae}),gt=new Tr().load(["/3d-bear-arts/assets/house_env_texture_1.jpg","/3d-bear-arts/assets/house_env_texture_4.jpg","/3d-bear-arts/assets/house_env_texture_6.jpg","/3d-bear-arts/assets/house_env_texture_2.jpg","/3d-bear-arts/assets/house_env_texture_5.jpg","/3d-bear-arts/assets/house_env_texture_3.jpg"]);tt.environment=gt;const Nt=new Ot({color:16777215,metalness:.05,roughness:.2,transparent:!0,opacity:.5,transmission:.2,ior:1.5,depthWrite:!0,envMapIntensity:1,side:Ae}),Wt=new Ot({color:16777215,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),rt=new dt(1,32,32,0,Math.PI),pt=new _(rt,xt),wt=new _(rt,Mt);pt.scale.set(.85,.85,.8),wt.scale.set(.85,.85,.8),pt.position.y=-.2,wt.position.y=-.2,pt.rotation.y=Math.PI/2,wt.rotation.y=Math.PI*1.5;const O=new Ce(1,32),ht=new _(O,Nt);ht.scale.set(.85,.85,.8),ht.position.set(0,-.2,0),ht.rotation.y=Math.PI/2;const ot=new Xt;ot.add(pt),ot.add(wt),ot.add(ht),U.add(ot);const lt=new dt(.6,32,32,0,Math.PI),bt=new _(lt,Mt);bt.scale.set(1,.95,.95),bt.position.set(0,1,0),bt.rotation.y=Math.PI*1.5;const nt=new _(lt,xt);nt.scale.set(1,.95,.95),nt.position.set(0,1,0),nt.rotation.y=Math.PI/2;const g=new Ce(.6,32),P=new _(g,Nt);P.position.set(0,1,0),P.rotation.y=Math.PI/2,P.scale.set(1,.95,.95);const L=new Xt;L.add(bt),L.add(nt),L.add(P),U.add(L);const F=new dt(.6,32,32,0,Math.PI*2,0,Math.PI/2),N=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.5,clearcoatRoughness:.7,transparent:!1,opacity:.85}),K=new _(F,N);K.position.set(0,-.2,0),K.rotation.x=Math.PI,K.scale.set(1.25,1.25,1.25),ot.add(K);const J=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.6,clearcoatRoughness:.8,side:Ae,transparent:!1,opacity:.8}),w=new _(O,J);w.scale.set(.7,.7,.7),w.position.set(0,-.3,0),w.rotation.x=Math.PI/2,w.renderOrder=1,ot.add(w),U.add(ot);const x=new un({transparent:!0,uniforms:{u_time:{value:0}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),C=new _(O,x);C.position.set(0,-.2,0),C.scale.set(.7,.7,.7),C.rotation.x=-Math.PI/2,C.renderOrder=2,ot.add(C);const Y=new dt(.25,32,32),V=new _(Y,Mt);V.position.set(-.45,1.35,-.1),U.add(V);const X=new _(Y,xt);X.position.set(.45,1.35,-.1),U.add(X);const ut=new dt(.25,32,32,Math.PI/2,Math.PI),at=new _(ut,Mt);at.scale.set(1.1,.6,.8),at.position.set(0,.84,.5),at.rotation.y=Math.PI;const vt=new dt(.25,32,32,Math.PI/2,Math.PI),At=new _(vt,xt);At.scale.set(1.1,.6,.8),At.position.set(0,.84,.5),At.rotation.y=0;const ft=new Ce(.25,32),_t=new _(ft,Nt);_t.scale.set(.8,.6,.8),_t.position.set(0,.84,.5),_t.rotation.y=Math.PI/2;const Dt=new Xt;Dt.add(at),Dt.add(At),Dt.add(_t),U.add(Dt);const Ft=new dt(.35,32,32),Rt=new _(Ft,Mt);Rt.scale.set(.75,1.25,.65),Rt.position.set(-.7,-.15,.2),U.add(Rt);const Qt=new _(Ft,xt);Qt.scale.set(.75,1.25,.65),Qt.position.set(.7,-.15,.2),U.add(Qt);const Bt=new ne(.2,.22,.6,32),Yt=new _(Bt,Mt);Yt.position.set(-.4,-1.05,0),U.add(Yt);const H=new _(Bt,xt);H.position.set(.4,-1.05,0),U.add(H);const yt=new dt(.3,32,32),it=new _(yt,Mt);it.scale.set(1,.72,1.5),it.position.set(-.4,-1.45,.17),U.add(it);const et=new _(yt,xt);et.scale.set(1,.72,1.5),et.position.set(.4,-1.45,.17),U.add(et);const St=new dt(.44,32,32),Et=new _(St,Mt);Et.position.set(-.15,-.45,-.4),U.add(Et);const Vt=new _(St,Mt);Vt.position.set(.15,-.45,-.4),U.add(Vt);const te=new dt(.18,32,32),se=new _(te,Mt);se.position.set(0,-.35,-.8),U.add(se),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(D){const W=new Xe("X",{font:D,size:.2,depth:.05}),G=new _(W,Wt);G.position.set(-.3,.99,.53),G.rotation.x=le.degToRad(-5),G.rotation.y=le.degToRad(-15),U.add(G);const mt=new Xe("O",{font:D,size:.2,depth:.05}),It=new _(mt,Wt);It.position.set(.14,.99,.53),It.rotation.y=le.degToRad(12),It.rotation.x=le.degToRad(-5),U.add(It)});const re=y();U.add(re),m();const ce=p();U.add(ce);const he=p();he.position.set(-.2,-.1,.5),U.add(he),T(),a.value=p(),U.add(a.value),S(a.value);const ve=b();U.add(ve);const fe=b();fe.position.set(-.2,-.2,0),fe.scale.set(.35,.35,.35),U.add(fe);const Se=B(.1,{x:0,y:0,z:1}),ye=B(.6,{x:0,y:-1.5,z:0}),De=1e3,Te=new En,Be=[];for(let D=0;D<De;D++){const W=(Math.random()-.5)*20,G=Math.random()*20,mt=(Math.random()-.5)*20;Be.push(W,G,mt)}Te.setAttribute("position",new sn(Be,3));const Le=new vr({color:16777215,size:.1,transparent:!0,opacity:.8}),me=new sr(Te,Le);U.add(me),I();const cn=2e3,He=[],Ct=.6;for(let D=0;D<cn;D++){const W=(Math.random()-.5)*Ct*2,G=(Math.random()-.5)*Ct*2,mt=(Math.random()-.5)*Ct*2;Math.sqrt(W*W+G*G+mt*mt)<Ct&&He.push(W,G,mt)}const ae=new En;ae.setAttribute("position",new sn(He,3)),new vr({color:16777215,size:.05,transparent:!0,opacity:.9}),new sr(ae,N).position.set(0,-.2,0),new sr(ae,J).position.set(0,.8,0),R(),U.scale.set(.85,.85,.85),U.position.set(t.bodyPosition.x,t.bodyPosition.y+.9,t.bodyPosition.z),tt.add(U),tt.add(ye),M.position.set(t.bodyPosition.x,1,t.cameraPosition),M.lookAt(t.bodyPosition.x,0,0),M.position.z=4,U.rotation.x=.1,z(),qe(()=>t.bodyPosition,D=>{U.position.set(D.x,D.y,D.z)}),qe(()=>t.cameraPosition,D=>{M.position.set(t.bodyPosition.x,1,D),M.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{M.aspect=window.innerWidth/window.innerHeight,M.updateProjectionMatrix(),E.setSize(window.innerWidth,window.innerHeight)})}});function h(){s.value=!0}function u(){i.value=!0}function d(){o.value=!0}function f(){r.value=!0}function v(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let y=0;y<ab;y++){const m=document.createElement("div");m.classList.add("confetti"),m.style.left=`${Math.random()*100}vw`,m.style.animationDuration=`${Math.random()*3+4}s`,m.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(m)}for(let y=0;y<cb;y++){const m=document.createElement("div");m.classList.add("light"),document.body.appendChild(m)}return(y,m)=>(Wn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),zt("div",ob,[zt("button",{class:"pixel-btn up",onMousedown:d,onMouseup:v},"UP",32),zt("div",rb,[zt("button",{class:"pixel-btn left",onMousedown:h,onMouseup:v},"LEFT",32),zt("button",{class:"pixel-btn right",onMousedown:u,onMouseup:v},"RIGHT",32)]),zt("button",{class:"pixel-btn down",onMousedown:f,onMouseup:v},"DOWN",32)])],64))}}),ub=Kn(lb,[["__scopeId","data-v-ceb84432"]]),hb={key:0,class:"bear-face-container"},db=Un({__name:"BearFaceWhite",props:{color:{type:String,default:"white"}},setup(n){const t=Kt(null),e=Kt(!1),i=n;return Vn(()=>{const s=t.value;if(s){s.width=window.innerWidth,s.height=window.innerHeight*.7;const o=s.getContext("2d");o&&(()=>{const a=s.width/2,c=s.height/1.8,l=s.height/2,h=s.height/2.05,u=l*.45,d=l*.18,f=l*.3,v=l*.275,y=f*.35,m=f*.32;o.save(),o.beginPath(),o.rect(0,0,s.width/2,s.height),o.clip(),o.lineWidth=15,o.strokeStyle=i.color,o.beginPath(),o.arc(a-l*.85,c-h*.8,u,0,Math.PI*2,!0),o.stroke(),o.beginPath(),o.arc(a+l*.85,c-l*.8,u,0,Math.PI*2,!0),o.stroke(),o.lineWidth=15,o.beginPath(),o.arc(a,c,h,0,Math.PI*2,!0),o.stroke(),o.lineWidth=15,o.beginPath(),o.arc(a-l*.4,c-l*.2,d,0,Math.PI*2,!0),o.stroke(),o.beginPath(),o.moveTo(a+l*.2,c-l*.3),o.lineTo(a+l*.5,c-l*.05),o.moveTo(a+l*.5,c-l*.3),o.lineTo(a+l*.2,c-l*.05),o.stroke(),o.beginPath(),o.ellipse(a,c+l*.4,v*1.5,v,0,0,Math.PI*2),o.stroke(),o.beginPath(),o.arc(a,c+l*.3,m,0,Math.PI*2,!0),o.stroke(),o.restore(),o.save(),o.beginPath(),o.rect(s.width/2,0,s.width/2,s.height),o.clip(),o.fillStyle=i.color,o.beginPath(),o.arc(a-l*.85,c-l*.8,u,0,Math.PI*2,!0),o.fill(),o.beginPath(),o.arc(a+l*.85,c-l*.8,u,0,Math.PI*2,!0),o.fill(),o.beginPath(),o.arc(a,c,l,0,Math.PI*2,!0),o.fill(),o.fillStyle=i.color,o.beginPath(),o.arc(a-l*.4,c-l*.2,d,0,Math.PI*2,!0),o.fill(),o.lineWidth=15,o.beginPath(),o.moveTo(a+l*.2,c-l*.3),o.lineTo(a+l*.5,c-l*.05),o.moveTo(a+l*.5,c-l*.3),o.lineTo(a+l*.2,c-l*.05),o.strokeStyle="#000000",o.stroke(),o.fillStyle="#000000",o.beginPath(),o.ellipse(a,c+l*.4,f*1.5,f,0,0,Math.PI*2),o.fill(),o.fillStyle=i.color,o.beginPath(),o.arc(a,c+l*.3,y*1.2,0,Math.PI*2,!0),o.fill(),o.restore()})()}}),(s,o)=>e.value?Lm("",!0):(Wn(),$n("div",hb,[zt("canvas",{ref_key:"bearCanvas",ref:t},null,512)]))}}),Gp=Kn(db,[["__scopeId","data-v-6ce68a75"]]),fb={class:"pixel-controls"},pb={class:"side-buttons"},mb=15,gb=5,vb=Un({__name:"SliverBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);Vn(()=>{if(e.value){let d=function(){p.visible=!1,R.update(m,v),p.visible=!0,requestAnimationFrame(d)},f=function(){requestAnimationFrame(f),gt.uniforms.time.value+=.05,k.uniforms.time.value+=.05,i.value&&(p.rotation.y+=.05),s.value&&(p.rotation.y-=.07),o.value&&(p.rotation.x-=.05),r.value&&(p.rotation.x+=.05),m.render(v,y)};const v=new Hn,y=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),m=new Gn({antialias:!0,alpha:!0});m.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(m.domElement);const p=new Xt,T=new hi(16777215,2);v.add(T);const S=new ui(16777215,4);S.position.set(5,5,5),v.add(S);const b=new li(16777215,5,50);b.position.set(0,2,4),v.add(b);const B=new Yn,I=new $a(256,{format:Xn,generateMipmaps:!0,minFilter:Ci}),R=new Ya(1,1e3,I);new Ot({color:12632256,metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.4,envMap:I.texture,envMapIntensity:1.5}),v.add(R),v.environment=I.texture,d();const tt=new Tr().load(["/3d-bear-arts/assets/popbear1.jpg","/3d-bear-arts/assets/popbear1.jpg","/3d-bear-arts/assets/popbear1.jpg","/3d-bear-arts/assets/popbear1.jpg","/3d-bear-arts/assets/popbear1.jpg","/3d-bear-arts/assets/popbear1.jpg"]);v.environment=tt;const M=new Ot({color:16738740,metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:tt,reflectivity:1}),E=new Ot({color:"hotpink",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,envMap:tt,reflectivity:0}),U=new Ot({color:"hotpink",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.3,envMap:tt,reflectivity:0}),$=B.load("/3d-bear-arts/assets/popbear1.jpg"),Z=new Ot({color:"hotpink",map:$,metalness:.3,roughness:.5,transparent:!0,opacity:1}),ct=new un({uniforms:{time:{value:0},color1:{value:new xe(16766720)},color2:{value:new xe(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,k=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:j,fragmentShader:st,transparent:!1,depthWrite:!0}),xt=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,gt=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:xt,fragmentShader:Mt,transparent:!1,depthWrite:!0}),Nt=new dt(1,32,32,0,Math.PI),Wt=new _(Nt,U),rt=new _(Nt,M);Wt.scale.set(.85,.85,.8),rt.scale.set(.85,.85,.8),Wt.position.y=-.2,rt.position.y=-.2,Wt.rotation.y=Math.PI/2,rt.rotation.y=Math.PI*1.5;const pt=new Ce(1,32),wt=new _(pt,Z);wt.scale.set(.85,.85,.8),wt.position.set(0,-.2,0),wt.rotation.y=Math.PI/2;const O=new Xt;O.add(Wt),O.add(rt),O.add(wt),p.add(O);const ht=new dt(.6,32,32,0,Math.PI),ot=new _(ht,M);ot.scale.set(1,.95,.95),ot.position.set(0,1,0),ot.rotation.y=Math.PI*1.5;const lt=new _(ht,E);lt.scale.set(1,.95,.95),lt.position.set(0,1,0),lt.rotation.y=Math.PI/2;const bt=new Ce(.6,32),nt=new _(bt,Z);nt.position.set(0,1,0),nt.rotation.y=Math.PI/2,nt.scale.set(1,.95,.95);const g=new Xt;g.add(ot),g.add(lt),g.add(nt),p.add(g);const P=new dt(.25,32,32),L=new _(P,M);L.position.set(-.45,1.35,-.1),p.add(L);const F=new _(P,E);F.position.set(.45,1.35,-.1),p.add(F);const N=new dt(.25,32,32,Math.PI/2,Math.PI),K=new _(N,M);K.scale.set(1.1,.6,.8),K.position.set(0,.84,.5),K.rotation.y=Math.PI;const J=new dt(.25,32,32,Math.PI/2,Math.PI),w=new _(J,E);w.scale.set(1.1,.6,.8),w.position.set(0,.84,.5),w.rotation.y=0;const x=new Ce(.25,32),C=new _(x,Z);C.scale.set(.8,.6,.8),C.position.set(0,.84,.5),C.rotation.y=Math.PI/2;const Y=new Xt;Y.add(K),Y.add(w),Y.add(C),p.add(Y);const V=new Sn;V.moveTo(0,0),V.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),V.bezierCurveTo(-.6,.3,0,.6,0,1),V.bezierCurveTo(0,.6,.6,.3,.6,0),V.bezierCurveTo(.6,-.3,0,-.3,0,0);const X={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ut=new Dn(V,X),at=new _(ut,k);at.scale.set(.38,.38,.38),at.position.set(.35,0,0),at.rotation.y=Math.PI,at.rotation.x=Math.PI,p.add(at);const vt=new _(ut,k);vt.scale.set(.35,.35,.35),vt.position.set(.3,0,0),vt.rotation.y=Math.PI,vt.rotation.x=Math.PI,p.add(vt);const At=new _(ut,M);At.scale.set(.22,.22,.22),At.position.set(.27,.4,0),At.rotation.y=Math.PI,At.rotation.x=Math.PI,p.add(At);const ft=new _(ut,M);ft.scale.set(.25,.25,.25),ft.position.set(.23,-.5,.3),ft.rotation.y=Math.PI,ft.rotation.x=Math.PI,p.add(ft);const _t=new _(ut,M);_t.scale.set(.3,.3,.3),_t.position.set(.23,.2,-.4),_t.rotation.y=Math.PI,_t.rotation.x=Math.PI,p.add(_t);const Dt=new dt(.35,32,32),Ft=new _(Dt,M);Ft.scale.set(.75,1.25,.65),Ft.position.set(-.7,-.15,.2),p.add(Ft);const Rt=new _(Dt,E);Rt.scale.set(.75,1.25,.65),Rt.position.set(.7,-.15,.2),p.add(Rt);const Qt=new ne(.2,.22,.6,32),Bt=new _(Qt,M);Bt.position.set(-.4,-1.05,0),p.add(Bt);const Yt=new _(Qt,E);Yt.position.set(.4,-1.05,0),p.add(Yt);const H=new dt(.3,32,32),yt=new _(H,M);yt.scale.set(1,.72,1.5),yt.position.set(-.4,-1.45,.17),p.add(yt);const it=new _(H,E);it.scale.set(1,.72,1.5),it.position.set(.4,-1.45,.17),p.add(it);const et=new dt(.44,32,32),St=new _(et,M);St.position.set(-.15,-.45,-.4),p.add(St);const Et=new _(et,E);Et.position.set(.15,-.45,-.4),p.add(Et);const Vt=new dt(.18,32,32),te=new _(Vt,M);te.position.set(0,-.35,-.8),p.add(te),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ce){const he=new Xe("X",{font:ce,size:.18,depth:.05}),ve=new _(he,k);ve.position.set(-.3,.99,.53),ve.rotation.x=le.degToRad(-5),ve.rotation.y=le.degToRad(-15),p.add(ve);const fe=new Xe("+",{font:ce,size:.25,depth:.1}),Se=new _(fe,k);Se.position.set(.14,.99,.53),Se.rotation.y=le.degToRad(12),Se.rotation.x=le.degToRad(-5),p.add(Se)}),te.renderOrder=1,p.scale.set(1.4,1.4,1.4),v.add(p),p.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),y.position.set(t.bodyPosition.x,1.4,t.cameraPosition),y.lookAt(t.bodyPosition.x,0,0),y.position.z=4;let ie=Kt(!1);const re=ce=>{if(ie.value){const he={x:ce.clientX/window.innerWidth*2-1,y:-(ce.clientY/window.innerHeight)*2+1},ve=he.x*Math.PI*.2,fe=he.y*Math.PI*.2;p.rotation.y=ve,p.rotation.x=fe}};window.addEventListener("mousemove",re),ct.uniforms.time.value+=.04,f(),qe(()=>t.bodyPosition,ce=>{p.position.set(ce.x,ce.y,ce.z)}),qe(()=>t.cameraPosition,ce=>{y.position.set(t.bodyPosition.x,1,ce),y.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{y.aspect=window.innerWidth/window.innerHeight,y.updateProjectionMatrix(),m.setSize(window.innerWidth,window.innerHeight)})}});let i=Kt(!1),s=Kt(!1),o=Kt(!1),r=Kt(!1);function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let d=0;d<mb;d++){const f=document.createElement("div");f.classList.add("confetti"),f.style.left=`${Math.random()*100}vw`,f.style.animationDuration=`${Math.random()*3+4}s`,f.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(f)}for(let d=0;d<gb;d++){const f=document.createElement("div");f.classList.add("light"),document.body.appendChild(f)}return(d,f)=>(Wn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),zt("div",null,[Ve(Gp,{class:"bear-background",color:"#FF69B4"})]),zt("div",fb,[zt("button",{class:"pixel-btn up border-gold",onMousedown:l,onMouseup:u},"▲",32),zt("div",pb,[zt("button",{class:"pixel-btn left border-silver",onMousedown:a,onMouseup:u},"◀",32),zt("button",{class:"pixel-btn right border-silver",onMousedown:c,onMouseup:u},"▶",32)]),zt("button",{class:"pixel-btn down border-gold",onMousedown:h,onMouseup:u},"▼",32)])],64))}}),_b=Kn(vb,[["__scopeId","data-v-06c75f17"]]),xb={class:"pixel-controls"},yb={class:"side-buttons"},Mb=15,wb=5,Sb=Un({__name:"Money",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);Vn(()=>{if(e.value){let d=function(){T.visible=!1,tt.update(p,y),T.visible=!0,requestAnimationFrame(d)},f=function(){const me=new Xt;new Ut({color:16777215}),new Ut({color:16770244}),new Ut({color:16776960}),new Ut({color:16316671});const cn=new dt(.2,32,32),He=new _(cn,Z);He.position.set(0,1.5,0),me.add(He);const Ct=new ne(.2,.35,.6,32),ae=new _(Ct,Z);ae.position.set(0,1,0),me.add(ae);const A=new Sn;A.moveTo(0,0),A.bezierCurveTo(.5,.2,.8,.7,.5,1.5),A.bezierCurveTo(.3,1.3,0,.8,0,0);const q=new Dn(A,{depth:.05,bevelEnabled:!1}),D=new _(q,gt);D.position.set(-.2,1.2,-.05),D.rotation.y=Math.PI/12,D.rotation.z=Math.PI/4,D.scale.set(-.5,.5,.5),me.add(D);const W=new _(q,gt);W.position.set(-.1,1.1,-.05),W.rotation.y=Math.PI/10,W.rotation.z=Math.PI/3,W.scale.set(-.5,.5,.5),me.add(W);const G=new _(q,gt);G.position.set(0,1,-.05),G.rotation.y=Math.PI/8,G.rotation.z=Math.PI/2.5,G.scale.set(-.5,.5,.5),me.add(G);const mt=new _(q,gt);mt.position.set(.2,1.2,-.05),mt.rotation.y=-Math.PI/12,mt.rotation.z=-Math.PI/4,mt.scale.set(.5,.5,.5),me.add(mt);const It=new _(q,gt);It.position.set(.1,1.1,-.05),It.rotation.y=-Math.PI/10,It.rotation.z=-Math.PI/3,It.scale.set(.5,.5,.5),me.add(It);const Lt=new _(q,gt);Lt.position.set(0,1,-.05),Lt.rotation.y=-Math.PI/8,Lt.rotation.z=-Math.PI/2.5,Lt.scale.set(.5,.5,.5),me.add(Lt);const Gt=new qn(.15,.05,16,100),qt=new _(Gt,gt);qt.position.set(0,1.8,0),qt.rotation.x=Math.PI/2,me.add(qt);const $t=new ne(.05,.05,.3,32),kt=new _($t,gt);kt.position.set(-.15,.55,0),kt.rotation.z=Math.PI/1;const ee=new _($t,gt);return ee.position.set(.15,.55,0),ee.rotation.z=-Math.PI/1,me.add(kt),me.add(ee),me},v=function(){requestAnimationFrame(v),rt.uniforms.time.value+=.05,gt.uniforms.time.value+=.05,i.value&&(T.rotation.y+=.05),s.value&&(T.rotation.y-=.07),o.value&&(T.rotation.x-=.05),r.value&&(T.rotation.x+=.05),Be+=Se,Le+=ye,he.position.y=t.bodyPosition.y+Math.sin(Be)*Te-.5,he.position.y=t.bodyPosition.y+Math.sin(Le)*De-.5,p.render(y,m)};const y=new Hn,m=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),p=new Gn({antialias:!0,alpha:!0});p.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(p.domElement);const T=new Xt,S=new hi(16777215,2);y.add(S);const b=new ui(16777215,4);b.position.set(5,5,5),y.add(b);const B=new li(16777215,5,50);B.position.set(0,2,4),y.add(B);const R=new Yn().load("/3d-bear-arts/assets/cashwings.jpg"),z=new $a(256,{format:Xn,generateMipmaps:!0,minFilter:Ci}),tt=new Ya(1,1e3,z),M=new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.4,envMap:z.texture,envMapIntensity:1.5});y.add(tt),y.environment=z.texture,d();const E=new Tr,U=E.load(["/3d-bear-arts/assets/cash2.jpg","/3d-bear-arts/assets/cash8.jpg","/3d-bear-arts/assets/cash1.jpg","/3d-bear-arts/assets/cash11.jpg","/3d-bear-arts/assets/cash4.jpg","/3d-bear-arts/assets/cash3.jpg"]);y.environment=U;const $=E.load(["/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg"]);y.environment=$;const Z=new Ot({color:"lightgreen",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:U,reflectivity:1});new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:$,reflectivity:1});const ct=new Ot({color:"lightgreen",map:R,metalness:.3,roughness:.5,transparent:!0,opacity:1}),j=new Ot({color:"lightgreen",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.6,envMap:U,reflectivity:0}),st=new Ot({color:"lightgreen",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.35,envMap:U,reflectivity:0}),k=new un({uniforms:{time:{value:0},color1:{value:new xe(16766720)},color2:{value:new xe(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,gt=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:xt,fragmentShader:Mt,transparent:!1,depthWrite:!0}),Nt=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,rt=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:Nt,fragmentShader:Wt,transparent:!1,depthWrite:!0}),pt=new dt(1,32,32,0,Math.PI),wt=new _(pt,st),O=new _(pt,Z);wt.scale.set(.85,.85,.8),O.scale.set(.85,.85,.8),wt.position.y=-.2,O.position.y=-.2,wt.rotation.y=Math.PI/2,O.rotation.y=Math.PI*1.5;const ht=new Ce(1,32),ot=new _(ht,ct);ot.scale.set(.85,.85,.8),ot.position.set(0,-.2,0),ot.rotation.y=Math.PI/2;const lt=new Xt;lt.add(wt),lt.add(O),lt.add(ot),T.add(lt);const bt=new dt(.6,32,32,0,Math.PI),nt=new _(bt,Z);nt.scale.set(1,.95,.95),nt.position.set(0,1,0),nt.rotation.y=Math.PI*1.5;const g=new _(bt,j);g.scale.set(1,.95,.95),g.position.set(0,1,0),g.rotation.y=Math.PI/2;const P=new Ce(.6,32),L=new _(P,ct);L.position.set(0,1,0),L.rotation.y=Math.PI/2,L.scale.set(1,.95,.95);const F=new Xt;F.add(nt),F.add(g),F.add(L),T.add(F);const N=new dt(.25,32,32),K=new _(N,Z);K.position.set(-.45,1.35,-.1),T.add(K);const J=new _(N,j);J.position.set(.45,1.35,-.1),T.add(J);const w=new dt(.25,32,32,Math.PI/2,Math.PI),x=new _(w,Z);x.scale.set(1.1,.6,.8),x.position.set(0,.84,.5),x.rotation.y=Math.PI;const C=new dt(.25,32,32,Math.PI/2,Math.PI),Y=new _(C,j);Y.scale.set(1.1,.6,.8),Y.position.set(0,.84,.5),Y.rotation.y=0;const V=new Ce(.25,32),X=new _(V,ct);X.scale.set(.8,.6,.8),X.position.set(0,.84,.5),X.rotation.y=Math.PI/2;const ut=new Xt;ut.add(x),ut.add(Y),ut.add(X),T.add(ut);const at=new Sn;at.moveTo(0,0),at.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),at.bezierCurveTo(-.6,.3,0,.6,0,1),at.bezierCurveTo(0,.6,.6,.3,.6,0),at.bezierCurveTo(.6,-.3,0,-.3,0,0);const vt={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},At=new Dn(at,vt),ft=new _(At,M);ft.scale.set(.38,.38,.38),ft.position.set(.35,0,0),ft.rotation.y=Math.PI,ft.rotation.x=Math.PI;const _t=new _(At,Z);_t.scale.set(.35,.35,.35),_t.position.set(.3,0,0),_t.rotation.y=Math.PI,_t.rotation.x=Math.PI;const Dt=new _(At,Z);Dt.scale.set(.22,.22,.22),Dt.position.set(.27,.4,0),Dt.rotation.y=Math.PI,Dt.rotation.x=Math.PI;const Ft=new _(At,Z);Ft.scale.set(.25,.25,.25),Ft.position.set(.23,-.5,.3),Ft.rotation.y=Math.PI,Ft.rotation.x=Math.PI;const Rt=new _(At,Z);Rt.scale.set(.3,.3,.3),Rt.position.set(.23,.2,-.4),Rt.rotation.y=Math.PI,Rt.rotation.x=Math.PI;const Qt=new dt(.35,32,32),Bt=new _(Qt,Z);Bt.scale.set(.75,1.25,.65),Bt.position.set(-.7,-.15,.2),T.add(Bt);const Yt=new _(Qt,j);Yt.scale.set(.75,1.25,.65),Yt.position.set(.7,-.15,.2),T.add(Yt);const H=new ne(.2,.22,.6,32),yt=new _(H,Z);yt.position.set(-.4,-1.05,0),T.add(yt);const it=new _(H,j);it.position.set(.4,-1.05,0),T.add(it);const et=new dt(.3,32,32),St=new _(et,Z);St.scale.set(1,.72,1.5),St.position.set(-.4,-1.45,.17),T.add(St);const Et=new _(et,j);Et.scale.set(1,.72,1.5),Et.position.set(.4,-1.45,.17),T.add(Et);const Vt=new dt(.44,32,32),te=new _(Vt,Z);te.position.set(-.15,-.45,-.4),T.add(te);const se=new _(Vt,j);se.position.set(.15,-.45,-.4),T.add(se);const ie=new dt(.18,32,32),re=new _(ie,Z);re.position.set(0,-.35,-.8),T.add(re),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(me){const cn=new Xe("X",{font:me,size:.18,depth:.05}),He=new _(cn,Z);He.position.set(-.3,.99,.53),He.rotation.x=le.degToRad(-5),He.rotation.y=le.degToRad(-15),T.add(He);const Ct=new Xe("+",{font:me,size:.25,depth:.1}),ae=new _(Ct,Z);ae.position.set(.14,.99,.53),ae.rotation.y=le.degToRad(12),ae.rotation.x=le.degToRad(-5),T.add(ae)}),re.renderOrder=1;const he=f();he.scale.set(.37,.37,.37),he.position.set(.35,-.5,.25),T.add(he),T.scale.set(1.4,1.4,1.4),y.add(T),T.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),m.position.set(t.bodyPosition.x,1.4,t.cameraPosition),m.lookAt(t.bodyPosition.x,0,0),m.position.z=4;let ve=Kt(!1);const fe=me=>{if(ve.value){const cn={x:me.clientX/window.innerWidth*2-1,y:-(me.clientY/window.innerHeight)*2+1},He=cn.x*Math.PI*.2,Ct=cn.y*Math.PI*.2;T.rotation.y=He,T.rotation.x=Ct}};window.addEventListener("mousemove",fe);let Se=.05,ye=.06,De=.2,Te=.25,Be=0,Le=0;k.uniforms.time.value+=.04,v(),qe(()=>t.bodyPosition,me=>{T.position.set(me.x,me.y,me.z)}),qe(()=>t.cameraPosition,me=>{m.position.set(t.bodyPosition.x,1,me),m.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{m.aspect=window.innerWidth/window.innerHeight,m.updateProjectionMatrix(),p.setSize(window.innerWidth,window.innerHeight)})}});let i=Kt(!1),s=Kt(!1),o=Kt(!1),r=Kt(!1);function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let d=0;d<Mb;d++){const f=document.createElement("div");f.classList.add("confetti"),f.style.left=`${Math.random()*100}vw`,f.style.animationDuration=`${Math.random()*3+4}s`,f.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(f)}for(let d=0;d<wb;d++){const f=document.createElement("div");f.classList.add("light"),document.body.appendChild(f)}return(d,f)=>(Wn(),$n(mn,null,[zt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),zt("div",null,[Ve(Gp,{class:"bear-background",color:"lightgreen"})]),zt("div",xb,[zt("button",{class:"pixel-btn up border-gold",onMousedown:l,onMouseup:u},"▲",32),zt("div",yb,[zt("button",{class:"pixel-btn left border-silver",onMousedown:a,onMouseup:u},"◀",32),zt("button",{class:"pixel-btn right border-silver",onMousedown:c,onMouseup:u},"▶",32)]),zt("button",{class:"pixel-btn down border-gold",onMousedown:h,onMouseup:u},"▼",32)])],64))}}),bb=Kn(Sb,[["__scopeId","data-v-df2039b3"]]),Eb={class:"pixel-controls"},Tb={class:"side-buttons"},Ab=15,Pb=5,Rb=Un({__name:"Snowman",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=Kt(null);Vn(()=>{if(e.value){let d=function(){R.visible=!1,Z.update(I,b),R.visible=!0,requestAnimationFrame(d)},f=function(){const Pt=document.createElement("canvas"),jt=Pt.getContext("2d");Pt.width=512,Pt.height=512;const Ht=Pt.width/10;for(let Tt=0;Tt<10;Tt++)jt.fillStyle=Tt%2===0?"#FF0000":"#FFFFFF",jt.fillRect(Tt*Ht,0,Ht,Pt.height);const oe=new U1(Pt);return oe.wrapS=Je,oe.wrapT=Je,oe.repeat.set(1,0),oe},v=function(){const Pt=new Xt,jt=new Ut({color:16777215}),Ht=new Ut({color:0}),oe=new Ut({color:16753920}),Tt=new Ut({color:16711680}),Me=new Ut({color:0}),Pe=new _(new dt(.6,32,32),jt);Pe.position.set(0,.6,0),Pt.add(Pe);const ge=new _(new dt(.4,32,32),jt);ge.position.set(0,1.2,0),Pt.add(ge);const Ue=new _(new dt(.3,32,32),jt);Ue.position.set(0,1.7,0),Pt.add(Ue);const pe=new _(new dt(.05,16,16),Ht);pe.position.set(-.1,1.75,.25),Pt.add(pe);const Ie=new _(new dt(.05,16,16),Ht);Ie.position.set(.1,1.75,.25),Pt.add(Ie);const ke=new ai(.05,.2,32),Re=new _(ke,oe);Re.position.set(0,1.7,.35),Re.rotation.x=Math.PI/2,Pt.add(Re);for(let dn=0;dn<3;dn++){const pn=new _(new dt(.05,16,16),Ht);pn.position.set(0,1-dn*.3,.4),Pt.add(pn)}const ze=new qn(.3,.08,16,100),Qe=new _(ze,Tt);Qe.position.set(0,1.45,0),Qe.rotation.x=Math.PI/2,Pt.add(Qe);const je=new Mn(.1,.4,.05),ln=new _(je,Tt);ln.position.set(.25,1.3,0),Pt.add(ln);const rn=new ne(.3,.3,.05,32),Ke=new _(rn,Me);Ke.position.set(0,1.9,0),Pt.add(Ke);const on=new ne(.2,.2,.3,32),tn=new _(on,Me);return tn.position.set(0,2.05,0),Pt.add(tn),Pt},y=function(){const Pt=new Xt;new Ut({color:16777215});const jt=new Ut({color:0}),Ht=new Ut({color:16753920}),oe=new Ut({color:16711680}),Tt=new Ut({color:0}),Me=new _(new dt(.6,32,32),k);Me.position.set(0,.6,0),Pt.add(Me);const Pe=new _(new dt(.4,32,32),k);Pe.position.set(0,1.2,0),Pt.add(Pe);const ge=new _(new dt(.3,32,32),k);ge.position.set(0,1.7,0),Pt.add(ge);const Ue=new _(new dt(.05,16,16),jt);Ue.position.set(-.1,1.75,.25),Pt.add(Ue);const pe=new _(new dt(.05,16,16),jt);pe.position.set(.1,1.75,.25),Pt.add(pe);const Ie=new ai(.05,.2,32),ke=new _(Ie,Ht);ke.position.set(0,1.7,.35),ke.rotation.x=Math.PI/2,Pt.add(ke);for(let tn=0;tn<3;tn++){const dn=new _(new dt(.05,16,16),jt);dn.position.set(0,1-tn*.3,.4),Pt.add(dn)}const Re=new qn(.3,.08,16,100),ze=new _(Re,oe);ze.position.set(0,1.45,0),ze.rotation.x=Math.PI/2,Pt.add(ze);const Qe=new Mn(.1,.4,.05),je=new _(Qe,oe);je.position.set(.25,1.3,0),Pt.add(je);const ln=new ne(.3,.3,.05,32),rn=new _(ln,Tt);rn.position.set(0,1.9,0),Pt.add(rn);const Ke=new ne(.2,.2,.3,32),on=new _(Ke,Tt);return on.position.set(0,2.05,0),Pt.add(on),Pt},m=function(){const Pt=new Xt;new Ut({color:16777215});const jt=new Ut({color:16770244}),Ht=new Ut({color:16776960}),oe=new Ut({color:16316671}),Tt=new dt(.2,32,32),Me=new _(Tt,jt);Me.position.set(0,1.5,0),Pt.add(Me);const Pe=new ne(.2,.35,.6,32),ge=new _(Pe,jt);ge.position.set(0,1,0),Pt.add(ge);const Ue=new Sn;Ue.moveTo(0,0),Ue.bezierCurveTo(.5,.2,.8,.7,.5,1.5),Ue.bezierCurveTo(.3,1.3,0,.8,0,0);const pe=new Dn(Ue,{depth:.05,bevelEnabled:!1}),Ie=new _(pe,oe);Ie.position.set(-.2,1.2,-.05),Ie.rotation.y=Math.PI/12,Ie.rotation.z=Math.PI/4,Ie.scale.set(-.5,.5,.5),Pt.add(Ie);const ke=new _(pe,oe);ke.position.set(-.1,1.1,-.05),ke.rotation.y=Math.PI/10,ke.rotation.z=Math.PI/3,ke.scale.set(-.5,.5,.5),Pt.add(ke);const Re=new _(pe,oe);Re.position.set(0,1,-.05),Re.rotation.y=Math.PI/8,Re.rotation.z=Math.PI/2.5,Re.scale.set(-.5,.5,.5),Pt.add(Re);const ze=new _(pe,oe);ze.position.set(.2,1.2,-.05),ze.rotation.y=-Math.PI/12,ze.rotation.z=-Math.PI/4,ze.scale.set(.5,.5,.5),Pt.add(ze);const Qe=new _(pe,oe);Qe.position.set(.1,1.1,-.05),Qe.rotation.y=-Math.PI/10,Qe.rotation.z=-Math.PI/3,Qe.scale.set(.5,.5,.5),Pt.add(Qe);const je=new _(pe,oe);je.position.set(0,1,-.05),je.rotation.y=-Math.PI/8,je.rotation.z=-Math.PI/2.5,je.scale.set(.5,.5,.5),Pt.add(je);const ln=new qn(.15,.05,16,100),rn=new _(ln,Ht);rn.position.set(0,1.8,0),rn.rotation.x=Math.PI/2,Pt.add(rn);const Ke=new ne(.05,.05,.3,32),on=new _(Ke,jt);on.position.set(-.15,.55,0),on.rotation.z=Math.PI/1;const tn=new _(Ke,jt);return tn.position.set(.15,.55,0),tn.rotation.z=-Math.PI/1,Pt.add(on),Pt.add(tn),Pt},p=function(){requestAnimationFrame(p);const Pt=1.5,jt=.5;Be+=.03,me+=.005*He,me>jt&&(He=-1),me<-jt&&(He=1),ae.position.x=Math.cos(Be)*Pt,ae.position.z=Math.sin(Be)*Pt,ae.position.y=me+1,Le+=.03,cn+=.005*Ct,cn>jt&&(Ct=-1),cn<-jt&&(Ct=1),A.position.x=Math.cos(Le)*Pt,A.position.z=Math.sin(Le)*Pt,A.position.y=cn+1,ae.lookAt(R.position),A.lookAt(R.position),I.render(b,B)},T=function(){requestAnimationFrame(T);const Pt=qt.attributes.position.array;for(let jt=1;jt<Pt.length;jt+=3)Pt[jt]-=.02,Pt[jt]<-10&&(Pt[jt]=10);qt.attributes.position.needsUpdate=!0,I.render(b,B)},S=function(){requestAnimationFrame(S),ht.uniforms.time.value+=.05,pt.uniforms.time.value+=.05,i.value&&(R.rotation.y+=.05),s.value&&(R.rotation.y-=.07),o.value&&(R.rotation.x-=.05),r.value&&(R.rotation.x+=.05),I.render(b,B)};const b=new Hn,B=new $e(75,window.innerWidth/window.innerHeight,.1,1e3),I=new Gn({antialias:!0,alpha:!0});I.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(I.domElement);const R=new Xt,z=new hi(16777215,2);b.add(z);const tt=new ui(16777215,4);tt.position.set(5,5,5),b.add(tt);const M=new li(16777215,5,50);M.position.set(0,2,4),b.add(M);const U=new Yn().load("/3d-bear-arts/assets/cashwings.jpg"),$=new $a(256,{format:Xn,generateMipmaps:!0,minFilter:Ci}),Z=new Ya(1,1e3,$);new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.4,envMap:$.texture,envMapIntensity:1.5}),b.add(Z),b.environment=$.texture,d();const ct=new Tr,j=ct.load(["/3d-bear-arts/assets/christmas_garden.jpg","/3d-bear-arts/assets/christmas_ground.jpg","/3d-bear-arts/assets/christmas_front.jpg","/3d-bear-arts/assets/christmas_house.jpg","/3d-bear-arts/assets/christmas_tree.jpg","/3d-bear-arts/assets/christmas_sky.jpg"]);ct.load(["/3d-bear-arts/assets/cash2.jpg","/3d-bear-arts/assets/cash8.jpg","/3d-bear-arts/assets/cash1.jpg","/3d-bear-arts/assets/cash11.jpg","/3d-bear-arts/assets/cash4.jpg","/3d-bear-arts/assets/cash3.jpg"]),b.environment=j;const st=ct.load(["/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg"]);b.environment=st;const k=new Ot({color:"white",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:j,reflectivity:1});new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:st,reflectivity:1});const xt=new Ot({color:"sliver",map:U,metalness:.3,roughness:.5,transparent:!0,opacity:1}),Mt=new Ot({color:"white",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.3,envMap:j,reflectivity:0}),gt=new Ot({color:"white",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.7,envMap:j,reflectivity:0}),Nt=new un({uniforms:{time:{value:0},color1:{value:new xe(16766720)},color2:{value:new xe(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,pt=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:Wt,fragmentShader:rt,transparent:!1,depthWrite:!0}),wt=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,ht=new un({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:wt,fragmentShader:O,transparent:!1,depthWrite:!0}),ot=new dt(1,32,32,0,Math.PI),lt=new _(ot,Mt),bt=new _(ot,k);lt.scale.set(.85,.85,.8),bt.scale.set(.85,.85,.8),lt.position.y=-.2,bt.position.y=-.2,lt.rotation.y=Math.PI/2,bt.rotation.y=Math.PI*1.5;const nt=new Ce(1,32),g=new _(nt,k);g.scale.set(.85,.85,.8),g.position.set(0,-.2,0),g.rotation.y=Math.PI/2;const P=new Xt;P.add(lt),P.add(bt),P.add(g),R.add(P);const L=new dt(.6,32,32,0,Math.PI),F=new _(L,k);F.scale.set(1,.95,.95),F.position.set(0,1,0),F.rotation.y=Math.PI*1.5;const N=new _(L,gt);N.scale.set(1,.95,.95),N.position.set(0,1,0),N.rotation.y=Math.PI/2;const K=new Ce(.6,32),J=new _(K,k);J.position.set(0,1,0),J.rotation.y=Math.PI/2,J.scale.set(1,.95,.95);const w=new Xt;w.add(F),w.add(N),w.add(J),R.add(w);const x=new dt(.25,32,32),C=new _(x,k);C.position.set(-.45,1.35,-.1),R.add(C);const Y=new _(x,gt);Y.position.set(.45,1.35,-.1),R.add(Y);const V=new dt(.25,32,32,Math.PI/2,Math.PI),X=new _(V,k);X.scale.set(1.1,.6,.8),X.position.set(0,.84,.5),X.rotation.y=Math.PI;const ut=new dt(.25,32,32,Math.PI/2,Math.PI),at=new _(ut,gt);at.scale.set(1.1,.6,.8),at.position.set(0,.84,.5),at.rotation.y=0;const vt=new Ce(.25,32),At=new _(vt,xt);At.scale.set(.8,.6,.8),At.position.set(0,.84,.5),At.rotation.y=Math.PI/2;const ft=new Xt;ft.add(X),ft.add(at),ft.add(At),R.add(ft);const _t=new Sn;_t.moveTo(0,0),_t.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),_t.bezierCurveTo(-.6,.3,0,.6,0,1),_t.bezierCurveTo(0,.6,.6,.3,.6,0),_t.bezierCurveTo(.6,-.3,0,-.3,0,0);const Dt={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},Ft=new Dn(_t,Dt),Rt=new _(Ft,k);Rt.scale.set(.23,.23,.23),Rt.position.set(.25,1.2,0),Rt.rotation.y=Math.PI,Rt.rotation.x=Math.PI;const Qt=new dt(.35,32,32),Bt=new _(Qt,k);Bt.scale.set(.75,1.25,.65),Bt.position.set(-.7,-.15,.2),R.add(Bt);const Yt=new _(Qt,gt);Yt.scale.set(.75,1.25,.65),Yt.position.set(.7,-.15,.2),R.add(Yt);const H=new ne(.2,.22,.6,32),yt=new _(H,k);yt.position.set(-.4,-1.05,0),R.add(yt);const it=new _(H,gt);it.position.set(.4,-1.05,0),R.add(it);const et=new dt(.3,32,32),St=new _(et,k);St.scale.set(1,.72,1.5),St.position.set(-.4,-1.45,.17),R.add(St);const Et=new _(et,gt);Et.scale.set(1,.72,1.5),Et.position.set(.4,-1.45,.17),R.add(Et);const Vt=new dt(.44,32,32),te=new _(Vt,k);te.position.set(-.15,-.45,-.4),R.add(te);const se=new _(Vt,gt);se.position.set(.15,-.45,-.4),R.add(se);const ie=new dt(.18,32,32),re=new _(ie,k);re.position.set(0,-.35,-.8),R.add(re),re.renderOrder=1,new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Pt){const jt=new Xe("X",{font:Pt,size:.18,depth:.05}),Ht=new _(jt,k);Ht.position.set(-.3,.99,.53),Ht.rotation.x=le.degToRad(-5),Ht.rotation.y=le.degToRad(-15),R.add(Ht);const oe=new Xe("+",{font:Pt,size:.25,depth:.1}),Tt=new _(oe,k);Tt.position.set(.13,.99,.53),Tt.rotation.y=le.degToRad(12),Tt.rotation.x=le.degToRad(-5),R.add(Tt)});const he=f(),ve=new Ut({map:he,metalness:.1,roughness:.8}),fe=new qn(.5,.1,24,100,Math.PI),Se=new _(fe,ve);Se.position.set(0,.54,0),Se.rotation.x=Math.PI/2,Se.rotation.y=Math.PI/1,Se.rotation.z=Math.PI/-2,R.add(Se);const ye=v();ye.scale.set(.38,.38,.38),ye.position.set(.3,-.45,0),R.add(ye);const De=y();De.scale.set(.2,.2,.2),De.position.set(.5,-.3,.3),R.add(De);const Te=y();Te.scale.set(.12,.12,.12),Te.position.set(.2,-.3,.5),R.add(Te);let Be=0,Le=Math.PI,me=0,cn=0,He=1,Ct=-1;const ae=m();ae.scale.set(.4,.4,.4),b.add(ae);const A=m();A.scale.set(.4,.4,.4),b.add(A),p();const q=new dt(.6,32,32,0,Math.PI*2,0,Math.PI/2),D=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.5,clearcoatRoughness:.7,transparent:!1,opacity:.85}),W=new _(q,D);W.position.set(0,-.2,0),W.rotation.x=Math.PI,W.scale.set(1.25,1.25,1.25),P.add(W);const G=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.6,clearcoatRoughness:.8,side:Ae,transparent:!1,opacity:.8}),mt=new _(nt,G);mt.scale.set(.7,.7,.7),mt.position.set(0,-.3,0),mt.rotation.x=Math.PI/2,mt.renderOrder=1,P.add(mt),R.add(P);const It=new un({transparent:!0,uniforms:{u_time:{value:0}},vertexShader:`
        precision mediump float;
        varying vec2 vUv;
        void main() {
            vUv = uv;
