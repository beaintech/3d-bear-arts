...
}`;function NS(n,e,t){let i=new Gc;const s=new Ce,r=new Ce,o=new at,a=new LS({depthPacking:h_}),l=new IS,c={},h=t.maxTextureSize,u={[vi]:Qt,[Qt]:vi,[ht]:ht},f=new xi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ce},radius:{value:4}},vertexShader:DS,fragmentShader:US}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new gn;_.setAttribute("position",new Un(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new j(_,f),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ud;let m=this.type;this.render=function(P,R,I){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||P.length===0)return;const ne=n.getRenderTarget(),x=n.getActiveCubeFace(),w=n.getActiveMipmapLevel(),$=n.state;$.setBlending(mi),$.buffers.color.setClear(1,1,1,1),$.buffers.depth.setTest(!0),$.setScissorTest(!1);const q=m!==qn&&this.type===qn,Z=m===qn&&this.type!==qn;for(let re=0,G=P.length;re<G;re++){const J=P[re],W=J.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;s.copy(W.mapSize);const me=W.getFrameExtents();if(s.multiply(me),r.copy(W.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/me.x),s.x=r.x*me.x,W.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/me.y),s.y=r.y*me.y,W.mapSize.y=r.y)),W.map===null||q===!0||Z===!0){const ge=this.type!==qn?{minFilter:dn,magFilter:dn}:{};W.map!==null&&W.map.dispose(),W.map=new Xi(s.x,s.y,ge),W.map.texture.name=J.name+".shadowMap",W.camera.updateProjectionMatrix()}n.setRenderTarget(W.map),n.clear();const _e=W.getViewportCount();for(let ge=0;ge<_e;ge++){const Le=W.getViewport(ge);o.set(r.x*Le.x,r.y*Le.y,r.x*Le.z,r.y*Le.w),$.viewport(o),W.updateMatrices(J,ge),i=W.getFrustum(),E(R,I,W.camera,J,this.type)}W.isPointLightShadow!==!0&&this.type===qn&&b(W,I),W.needsUpdate=!1}m=this.type,d.needsUpdate=!1,n.setRenderTarget(ne,x,w)};function b(P,R){const I=e.update(M);f.defines.VSM_SAMPLES!==P.blurSamples&&(f.defines.VSM_SAMPLES=P.blurSamples,p.defines.VSM_SAMPLES=P.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new Xi(s.x,s.y)),f.uniforms.shadow_pass.value=P.map.texture,f.uniforms.resolution.value=P.mapSize,f.uniforms.radius.value=P.radius,n.setRenderTarget(P.mapPass),n.clear(),n.renderBufferDirect(R,null,I,f,M,null),p.uniforms.shadow_pass.value=P.mapPass.texture,p.uniforms.resolution.value=P.mapSize,p.uniforms.radius.value=P.radius,n.setRenderTarget(P.map),n.clear(),n.renderBufferDirect(R,null,I,p,M,null)}function y(P,R,I,ne){let x=null;const w=I.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(w!==void 0)x=w;else if(x=I.isPointLight===!0?l:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const $=x.uuid,q=R.uuid;let Z=c[$];Z===void 0&&(Z={},c[$]=Z);let re=Z[q];re===void 0&&(re=x.clone(),Z[q]=re,R.addEventListener("dispose",N)),x=re}if(x.visible=R.visible,x.wireframe=R.wireframe,ne===qn?x.side=R.shadowSide!==null?R.shadowSide:R.side:x.side=R.shadowSide!==null?R.shadowSide:u[R.side],x.alphaMap=R.alphaMap,x.alphaTest=R.alphaTest,x.map=R.map,x.clipShadows=R.clipShadows,x.clippingPlanes=R.clippingPlanes,x.clipIntersection=R.clipIntersection,x.displacementMap=R.displacementMap,x.displacementScale=R.displacementScale,x.displacementBias=R.displacementBias,x.wireframeLinewidth=R.wireframeLinewidth,x.linewidth=R.linewidth,I.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const $=n.properties.get(x);$.light=I}return x}function E(P,R,I,ne,x){if(P.visible===!1)return;if(P.layers.test(R.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&x===qn)&&(!P.frustumCulled||i.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,P.matrixWorld);const q=e.update(P),Z=P.material;if(Array.isArray(Z)){const re=q.groups;for(let G=0,J=re.length;G<J;G++){const W=re[G],me=Z[W.materialIndex];if(me&&me.visible){const _e=y(P,me,ne,x);P.onBeforeShadow(n,P,R,I,q,_e,W),n.renderBufferDirect(I,null,q,_e,P,W),P.onAfterShadow(n,P,R,I,q,_e,W)}}}else if(Z.visible){const re=y(P,Z,ne,x);P.onBeforeShadow(n,P,R,I,q,re,null),n.renderBufferDirect(I,null,q,re,P,null),P.onAfterShadow(n,P,R,I,q,re,null)}}const $=P.children;for(let q=0,Z=$.length;q<Z;q++)E($[q],R,I,ne,x)}function N(P){P.target.removeEventListener("dispose",N);for(const I in c){const ne=c[I],x=P.target.uuid;x in ne&&(ne[x].dispose(),delete ne[x])}}}const OS={[Ml]:yl,[Sl]:bl,[El]:Tl,[Is]:wl,[yl]:Ml,[bl]:Sl,[Tl]:El,[wl]:Is};function FS(n){function e(){let F=!1;const ye=new at;let ee=null;const se=new at(0,0,0,0);return{setMask:function(Me){ee!==Me&&!F&&(n.colorMask(Me,Me,Me,Me),ee=Me)},setLocked:function(Me){F=Me},setClear:function(Me,Ee,Ve,Je,ft){ft===!0&&(Me*=Je,Ee*=Je,Ve*=Je),ye.set(Me,Ee,Ve,Je),se.equals(ye)===!1&&(n.clearColor(Me,Ee,Ve,Je),se.copy(ye))},reset:function(){F=!1,ee=null,se.set(-1,0,0,0)}}}function t(){let F=!1,ye=!1,ee=null,se=null,Me=null;return{setReversed:function(Ee){ye=Ee},setTest:function(Ee){Ee?xe(n.DEPTH_TEST):O(n.DEPTH_TEST)},setMask:function(Ee){ee!==Ee&&!F&&(n.depthMask(Ee),ee=Ee)},setFunc:function(Ee){if(ye&&(Ee=OS[Ee]),se!==Ee){switch(Ee){case Ml:n.depthFunc(n.NEVER);break;case yl:n.depthFunc(n.ALWAYS);break;case Sl:n.depthFunc(n.LESS);break;case Is:n.depthFunc(n.LEQUAL);break;case El:n.depthFunc(n.EQUAL);break;case wl:n.depthFunc(n.GEQUAL);break;case bl:n.depthFunc(n.GREATER);break;case Tl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}se=Ee}},setLocked:function(Ee){F=Ee},setClear:function(Ee){Me!==Ee&&(n.clearDepth(Ee),Me=Ee)},reset:function(){F=!1,ee=null,se=null,Me=null}}}function i(){let F=!1,ye=null,ee=null,se=null,Me=null,Ee=null,Ve=null,Je=null,ft=null;return{setTest:function($e){F||($e?xe(n.STENCIL_TEST):O(n.STENCIL_TEST))},setMask:function($e){ye!==$e&&!F&&(n.stencilMask($e),ye=$e)},setFunc:function($e,Qe,dt){(ee!==$e||se!==Qe||Me!==dt)&&(n.stencilFunc($e,Qe,dt),ee=$e,se=Qe,Me=dt)},setOp:function($e,Qe,dt){(Ee!==$e||Ve!==Qe||Je!==dt)&&(n.stencilOp($e,Qe,dt),Ee=$e,Ve=Qe,Je=dt)},setLocked:function($e){F=$e},setClear:function($e){ft!==$e&&(n.clearStencil($e),ft=$e)},reset:function(){F=!1,ye=null,ee=null,se=null,Me=null,Ee=null,Ve=null,Je=null,ft=null}}}const s=new e,r=new t,o=new i,a=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,f=[],p=null,_=!1,M=null,d=null,m=null,b=null,y=null,E=null,N=null,P=new Ze(0,0,0),R=0,I=!1,ne=null,x=null,w=null,$=null,q=null;const Z=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let re=!1,G=0;const J=n.getParameter(n.VERSION);J.indexOf("WebGL")!==-1?(G=parseFloat(/^WebGL (\d)/.exec(J)[1]),re=G>=1):J.indexOf("OpenGL ES")!==-1&&(G=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),re=G>=2);let W=null,me={};const _e=n.getParameter(n.SCISSOR_BOX),ge=n.getParameter(n.VIEWPORT),Le=new at().fromArray(_e),Oe=new at().fromArray(ge);function ae(F,ye,ee,se){const Me=new Uint8Array(4),Ee=n.createTexture();n.bindTexture(F,Ee),n.texParameteri(F,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(F,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ve=0;Ve<ee;Ve++)F===n.TEXTURE_3D||F===n.TEXTURE_2D_ARRAY?n.texImage3D(ye,0,n.RGBA,1,1,se,0,n.RGBA,n.UNSIGNED_BYTE,Me):n.texImage2D(ye+Ve,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Me);return Ee}const de={};de[n.TEXTURE_2D]=ae(n.TEXTURE_2D,n.TEXTURE_2D,1),de[n.TEXTURE_CUBE_MAP]=ae(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),de[n.TEXTURE_2D_ARRAY]=ae(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),de[n.TEXTURE_3D]=ae(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),xe(n.DEPTH_TEST),r.setFunc(Is),L(!1),D($u),xe(n.CULL_FACE),g(mi);function xe(F){c[F]!==!0&&(n.enable(F),c[F]=!0)}function O(F){c[F]!==!1&&(n.disable(F),c[F]=!1)}function le(F,ye){return h[F]!==ye?(n.bindFramebuffer(F,ye),h[F]=ye,F===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=ye),F===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=ye),!0):!1}function oe(F,ye){let ee=f,se=!1;if(F){ee=u.get(ye),ee===void 0&&(ee=[],u.set(ye,ee));const Me=F.textures;if(ee.length!==Me.length||ee[0]!==n.COLOR_ATTACHMENT0){for(let Ee=0,Ve=Me.length;Ee<Ve;Ee++)ee[Ee]=n.COLOR_ATTACHMENT0+Ee;ee.length=Me.length,se=!0}}else ee[0]!==n.BACK&&(ee[0]=n.BACK,se=!0);se&&n.drawBuffers(ee)}function ue(F){return p!==F?(n.useProgram(F),p=F,!0):!1}const Se={[Bi]:n.FUNC_ADD,[F0]:n.FUNC_SUBTRACT,[B0]:n.FUNC_REVERSE_SUBTRACT};Se[z0]=n.MIN,Se[H0]=n.MAX;const Q={[G0]:n.ZERO,[V0]:n.ONE,[k0]:n.SRC_COLOR,[vl]:n.SRC_ALPHA,[K0]:n.SRC_ALPHA_SATURATE,[Y0]:n.DST_COLOR,[X0]:n.DST_ALPHA,[W0]:n.ONE_MINUS_SRC_COLOR,[xl]:n.ONE_MINUS_SRC_ALPHA,[$0]:n.ONE_MINUS_DST_COLOR,[q0]:n.ONE_MINUS_DST_ALPHA,[j0]:n.CONSTANT_COLOR,[Z0]:n.ONE_MINUS_CONSTANT_COLOR,[J0]:n.CONSTANT_ALPHA,[Q0]:n.ONE_MINUS_CONSTANT_ALPHA};function g(F,ye,ee,se,Me,Ee,Ve,Je,ft,$e){if(F===mi){_===!0&&(O(n.BLEND),_=!1);return}if(_===!1&&(xe(n.BLEND),_=!0),F!==O0){if(F!==M||$e!==I){if((d!==Bi||y!==Bi)&&(n.blendEquation(n.FUNC_ADD),d=Bi,y=Bi),$e)switch(F){case bs:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ku:n.blendFunc(n.ONE,n.ONE);break;case ju:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Zu:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}else switch(F){case bs:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ku:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case ju:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Zu:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}m=null,b=null,E=null,N=null,P.set(0,0,0),R=0,M=F,I=$e}return}Me=Me||ye,Ee=Ee||ee,Ve=Ve||se,(ye!==d||Me!==y)&&(n.blendEquationSeparate(Se[ye],Se[Me]),d=ye,y=Me),(ee!==m||se!==b||Ee!==E||Ve!==N)&&(n.blendFuncSeparate(Q[ee],Q[se],Q[Ee],Q[Ve]),m=ee,b=se,E=Ee,N=Ve),(Je.equals(P)===!1||ft!==R)&&(n.blendColor(Je.r,Je.g,Je.b,ft),P.copy(Je),R=ft),M=F,I=!1}function T(F,ye){F.side===ht?O(n.CULL_FACE):xe(n.CULL_FACE);let ee=F.side===Qt;ye&&(ee=!ee),L(ee),F.blending===bs&&F.transparent===!1?g(mi):g(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),r.setFunc(F.depthFunc),r.setTest(F.depthTest),r.setMask(F.depthWrite),s.setMask(F.colorWrite);const se=F.stencilWrite;o.setTest(se),se&&(o.setMask(F.stencilWriteMask),o.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),o.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),Y(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?xe(n.SAMPLE_ALPHA_TO_COVERAGE):O(n.SAMPLE_ALPHA_TO_COVERAGE)}function L(F){ne!==F&&(F?n.frontFace(n.CW):n.frontFace(n.CCW),ne=F)}function D(F){F!==D0?(xe(n.CULL_FACE),F!==x&&(F===$u?n.cullFace(n.BACK):F===U0?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):O(n.CULL_FACE),x=F}function U(F){F!==w&&(re&&n.lineWidth(F),w=F)}function Y(F,ye,ee){F?(xe(n.POLYGON_OFFSET_FILL),($!==ye||q!==ee)&&(n.polygonOffset(ye,ee),$=ye,q=ee)):O(n.POLYGON_OFFSET_FILL)}function K(F){F?xe(n.SCISSOR_TEST):O(n.SCISSOR_TEST)}function S(F){F===void 0&&(F=n.TEXTURE0+Z-1),W!==F&&(n.activeTexture(F),W=F)}function v(F,ye,ee){ee===void 0&&(W===null?ee=n.TEXTURE0+Z-1:ee=W);let se=me[ee];se===void 0&&(se={type:void 0,texture:void 0},me[ee]=se),(se.type!==F||se.texture!==ye)&&(W!==ee&&(n.activeTexture(ee),W=ee),n.bindTexture(F,ye||de[F]),se.type=F,se.texture=ye)}function C(){const F=me[W];F!==void 0&&F.type!==void 0&&(n.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function V(){try{n.compressedTexImage2D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function B(){try{n.compressedTexImage3D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function z(){try{n.texSubImage2D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function he(){try{n.texSubImage3D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ce(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function pe(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ae(){try{n.texStorage2D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function fe(){try{n.texStorage3D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ve(){try{n.texImage2D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Pe(){try{n.texImage3D.apply(n,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Te(F){Le.equals(F)===!1&&(n.scissor(F.x,F.y,F.z,F.w),Le.copy(F))}function be(F){Oe.equals(F)===!1&&(n.viewport(F.x,F.y,F.z,F.w),Oe.copy(F))}function Ge(F,ye){let ee=l.get(ye);ee===void 0&&(ee=new WeakMap,l.set(ye,ee));let se=ee.get(F);se===void 0&&(se=n.getUniformBlockIndex(ye,F.name),ee.set(F,se))}function De(F,ye){const se=l.get(ye).get(F);a.get(ye)!==se&&(n.uniformBlockBinding(ye,se,F.__bindingPointIndex),a.set(ye,se))}function Fe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),c={},W=null,me={},h={},u=new WeakMap,f=[],p=null,_=!1,M=null,d=null,m=null,b=null,y=null,E=null,N=null,P=new Ze(0,0,0),R=0,I=!1,ne=null,x=null,w=null,$=null,q=null,Le.set(0,0,n.canvas.width,n.canvas.height),Oe.set(0,0,n.canvas.width,n.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:xe,disable:O,bindFramebuffer:le,drawBuffers:oe,useProgram:ue,setBlending:g,setMaterial:T,setFlipSided:L,setCullFace:D,setLineWidth:U,setPolygonOffset:Y,setScissorTest:K,activeTexture:S,bindTexture:v,unbindTexture:C,compressedTexImage2D:V,compressedTexImage3D:B,texImage2D:ve,texImage3D:Pe,updateUBOMapping:Ge,uniformBlockBinding:De,texStorage2D:Ae,texStorage3D:fe,texSubImage2D:z,texSubImage3D:he,compressedTexSubImage2D:ce,compressedTexSubImage3D:pe,scissor:Te,viewport:be,reset:Fe}}function Vh(n,e,t,i){const s=BS(i);switch(t){case gd:return n*e;case vd:return n*e;case xd:return n*e*2;case Md:return n*e/s.components*s.byteLength;case Nc:return n*e/s.components*s.byteLength;case yd:return n*e*2/s.components*s.byteLength;case Oc:return n*e*2/s.components*s.byteLength;case _d:return n*e*3/s.components*s.byteLength;case wn:return n*e*4/s.components*s.byteLength;case Fc:return n*e*4/s.components*s.byteLength;case bo:case To:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case Ao:case Ro:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Ll:case Dl:return Math.max(n,16)*Math.max(e,8)/4;case Pl:case Il:return Math.max(n,8)*Math.max(e,8)/2;case Ul:case Nl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case Ol:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Fl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Bl:return Math.floor((n+4)/5)*Math.floor((e+3)/4)*16;case zl:return Math.floor((n+4)/5)*Math.floor((e+4)/5)*16;case Hl:return Math.floor((n+5)/6)*Math.floor((e+4)/5)*16;case Gl:return Math.floor((n+5)/6)*Math.floor((e+5)/6)*16;case Vl:return Math.floor((n+7)/8)*Math.floor((e+4)/5)*16;case kl:return Math.floor((n+7)/8)*Math.floor((e+5)/6)*16;case Wl:return Math.floor((n+7)/8)*Math.floor((e+7)/8)*16;case Xl:return Math.floor((n+9)/10)*Math.floor((e+4)/5)*16;case ql:return Math.floor((n+9)/10)*Math.floor((e+5)/6)*16;case Yl:return Math.floor((n+9)/10)*Math.floor((e+7)/8)*16;case $l:return Math.floor((n+9)/10)*Math.floor((e+9)/10)*16;case Kl:return Math.floor((n+11)/12)*Math.floor((e+9)/10)*16;case jl:return Math.floor((n+11)/12)*Math.floor((e+11)/12)*16;case Co:case Zl:case Jl:return Math.ceil(n/4)*Math.ceil(e/4)*16;case Sd:case Ql:return Math.ceil(n/4)*Math.ceil(e/4)*8;case ec:case tc:return Math.ceil(n/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function BS(n){switch(n){case ei:case dd:return{byteLength:1,components:1};case Er:case pd:case Lr:return{byteLength:2,components:1};case Dc:case Uc:return{byteLength:2,components:4};case Wi:case Ic:case Kn:return{byteLength:4,components:1};case md:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function zS(n,e,t,i,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ce,h=new WeakMap;let u;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(S,v){return p?new OffscreenCanvas(S,v):br("canvas")}function M(S,v,C){let V=1;const B=K(S);if((B.width>C||B.height>C)&&(V=C/Math.max(B.width,B.height)),V<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const z=Math.floor(V*B.width),he=Math.floor(V*B.height);u===void 0&&(u=_(z,he));const ce=v?_(z,he):u;return ce.width=z,ce.height=he,ce.getContext("2d").drawImage(S,0,0,z,he),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+B.width+"x"+B.height+") to ("+z+"x"+he+")."),ce}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+B.width+"x"+B.height+")."),S;return S}function d(S){return S.generateMipmaps&&S.minFilter!==dn&&S.minFilter!==Sn}function m(S){n.generateMipmap(S)}function b(S,v,C,V,B=!1){if(S!==null){if(n[S]!==void 0)return n[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let z=v;if(v===n.RED&&(C===n.FLOAT&&(z=n.R32F),C===n.HALF_FLOAT&&(z=n.R16F),C===n.UNSIGNED_BYTE&&(z=n.R8)),v===n.RED_INTEGER&&(C===n.UNSIGNED_BYTE&&(z=n.R8UI),C===n.UNSIGNED_SHORT&&(z=n.R16UI),C===n.UNSIGNED_INT&&(z=n.R32UI),C===n.BYTE&&(z=n.R8I),C===n.SHORT&&(z=n.R16I),C===n.INT&&(z=n.R32I)),v===n.RG&&(C===n.FLOAT&&(z=n.RG32F),C===n.HALF_FLOAT&&(z=n.RG16F),C===n.UNSIGNED_BYTE&&(z=n.RG8)),v===n.RG_INTEGER&&(C===n.UNSIGNED_BYTE&&(z=n.RG8UI),C===n.UNSIGNED_SHORT&&(z=n.RG16UI),C===n.UNSIGNED_INT&&(z=n.RG32UI),C===n.BYTE&&(z=n.RG8I),C===n.SHORT&&(z=n.RG16I),C===n.INT&&(z=n.RG32I)),v===n.RGB_INTEGER&&(C===n.UNSIGNED_BYTE&&(z=n.RGB8UI),C===n.UNSIGNED_SHORT&&(z=n.RGB16UI),C===n.UNSIGNED_INT&&(z=n.RGB32UI),C===n.BYTE&&(z=n.RGB8I),C===n.SHORT&&(z=n.RGB16I),C===n.INT&&(z=n.RGB32I)),v===n.RGBA_INTEGER&&(C===n.UNSIGNED_BYTE&&(z=n.RGBA8UI),C===n.UNSIGNED_SHORT&&(z=n.RGBA16UI),C===n.UNSIGNED_INT&&(z=n.RGBA32UI),C===n.BYTE&&(z=n.RGBA8I),C===n.SHORT&&(z=n.RGBA16I),C===n.INT&&(z=n.RGBA32I)),v===n.RGB&&C===n.UNSIGNED_INT_5_9_9_9_REV&&(z=n.RGB9_E5),v===n.RGBA){const he=B?Bo:it.getTransfer(V);C===n.FLOAT&&(z=n.RGBA32F),C===n.HALF_FLOAT&&(z=n.RGBA16F),C===n.UNSIGNED_BYTE&&(z=he===mt?n.SRGB8_ALPHA8:n.RGBA8),C===n.UNSIGNED_SHORT_4_4_4_4&&(z=n.RGBA4),C===n.UNSIGNED_SHORT_5_5_5_1&&(z=n.RGB5_A1)}return(z===n.R16F||z===n.R32F||z===n.RG16F||z===n.RG32F||z===n.RGBA16F||z===n.RGBA32F)&&e.get("EXT_color_buffer_float"),z}function y(S,v){let C;return S?v===null||v===Wi||v===Ns?C=n.DEPTH24_STENCIL8:v===Kn?C=n.DEPTH32F_STENCIL8:v===Er&&(C=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Wi||v===Ns?C=n.DEPTH_COMPONENT24:v===Kn?C=n.DEPTH_COMPONENT32F:v===Er&&(C=n.DEPTH_COMPONENT16),C}function E(S,v){return d(S)===!0||S.isFramebufferTexture&&S.minFilter!==dn&&S.minFilter!==Sn?Math.log2(Math.max(v.width,v.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?v.mipmaps.length:1}function N(S){const v=S.target;v.removeEventListener("dispose",N),R(v),v.isVideoTexture&&h.delete(v)}function P(S){const v=S.target;v.removeEventListener("dispose",P),ne(v)}function R(S){const v=i.get(S);if(v.__webglInit===void 0)return;const C=S.source,V=f.get(C);if(V){const B=V[v.__cacheKey];B.usedTimes--,B.usedTimes===0&&I(S),Object.keys(V).length===0&&f.delete(C)}i.remove(S)}function I(S){const v=i.get(S);n.deleteTexture(v.__webglTexture);const C=S.source,V=f.get(C);delete V[v.__cacheKey],o.memory.textures--}function ne(S){const v=i.get(S);if(S.depthTexture&&S.depthTexture.dispose(),S.isWebGLCubeRenderTarget)for(let V=0;V<6;V++){if(Array.isArray(v.__webglFramebuffer[V]))for(let B=0;B<v.__webglFramebuffer[V].length;B++)n.deleteFramebuffer(v.__webglFramebuffer[V][B]);else n.deleteFramebuffer(v.__webglFramebuffer[V]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[V])}else{if(Array.isArray(v.__webglFramebuffer))for(let V=0;V<v.__webglFramebuffer.length;V++)n.deleteFramebuffer(v.__webglFramebuffer[V]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let V=0;V<v.__webglColorRenderbuffer.length;V++)v.__webglColorRenderbuffer[V]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[V]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const C=S.textures;for(let V=0,B=C.length;V<B;V++){const z=i.get(C[V]);z.__webglTexture&&(n.deleteTexture(z.__webglTexture),o.memory.textures--),i.remove(C[V])}i.remove(S)}let x=0;function w(){x=0}function $(){const S=x;return S>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),x+=1,S}function q(S){const v=[];return v.push(S.wrapS),v.push(S.wrapT),v.push(S.wrapR||0),v.push(S.magFilter),v.push(S.minFilter),v.push(S.anisotropy),v.push(S.internalFormat),v.push(S.format),v.push(S.type),v.push(S.generateMipmaps),v.push(S.premultiplyAlpha),v.push(S.flipY),v.push(S.unpackAlignment),v.push(S.colorSpace),v.join()}function Z(S,v){const C=i.get(S);if(S.isVideoTexture&&U(S),S.isRenderTargetTexture===!1&&S.version>0&&C.__version!==S.version){const V=S.image;if(V===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(V.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Oe(C,S,v);return}}t.bindTexture(n.TEXTURE_2D,C.__webglTexture,n.TEXTURE0+v)}function re(S,v){const C=i.get(S);if(S.version>0&&C.__version!==S.version){Oe(C,S,v);return}t.bindTexture(n.TEXTURE_2D_ARRAY,C.__webglTexture,n.TEXTURE0+v)}function G(S,v){const C=i.get(S);if(S.version>0&&C.__version!==S.version){Oe(C,S,v);return}t.bindTexture(n.TEXTURE_3D,C.__webglTexture,n.TEXTURE0+v)}function J(S,v){const C=i.get(S);if(S.version>0&&C.__version!==S.version){ae(C,S,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,C.__webglTexture,n.TEXTURE0+v)}const W={[cn]:n.REPEAT,[Hi]:n.CLAMP_TO_EDGE,[Cl]:n.MIRRORED_REPEAT},me={[dn]:n.NEAREST,[c_]:n.NEAREST_MIPMAP_NEAREST,[Zr]:n.NEAREST_MIPMAP_LINEAR,[Sn]:n.LINEAR,[wa]:n.LINEAR_MIPMAP_NEAREST,[Gi]:n.LINEAR_MIPMAP_LINEAR},_e={[d_]:n.NEVER,[x_]:n.ALWAYS,[p_]:n.LESS,[wd]:n.LEQUAL,[m_]:n.EQUAL,[v_]:n.GEQUAL,[g_]:n.GREATER,[__]:n.NOTEQUAL};function ge(S,v){if(v.type===Kn&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Sn||v.magFilter===wa||v.magFilter===Zr||v.magFilter===Gi||v.minFilter===Sn||v.minFilter===wa||v.minFilter===Zr||v.minFilter===Gi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(S,n.TEXTURE_WRAP_S,W[v.wrapS]),n.texParameteri(S,n.TEXTURE_WRAP_T,W[v.wrapT]),(S===n.TEXTURE_3D||S===n.TEXTURE_2D_ARRAY)&&n.texParameteri(S,n.TEXTURE_WRAP_R,W[v.wrapR]),n.texParameteri(S,n.TEXTURE_MAG_FILTER,me[v.magFilter]),n.texParameteri(S,n.TEXTURE_MIN_FILTER,me[v.minFilter]),v.compareFunction&&(n.texParameteri(S,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(S,n.TEXTURE_COMPARE_FUNC,_e[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===dn||v.minFilter!==Zr&&v.minFilter!==Gi||v.type===Kn&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const C=e.get("EXT_texture_filter_anisotropic");n.texParameterf(S,C.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function Le(S,v){let C=!1;S.__webglInit===void 0&&(S.__webglInit=!0,v.addEventListener("dispose",N));const V=v.source;let B=f.get(V);B===void 0&&(B={},f.set(V,B));const z=q(v);if(z!==S.__cacheKey){B[z]===void 0&&(B[z]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,C=!0),B[z].usedTimes++;const he=B[S.__cacheKey];he!==void 0&&(B[S.__cacheKey].usedTimes--,he.usedTimes===0&&I(v)),S.__cacheKey=z,S.__webglTexture=B[z].texture}return C}function Oe(S,v,C){let V=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(V=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(V=n.TEXTURE_3D);const B=Le(S,v),z=v.source;t.bindTexture(V,S.__webglTexture,n.TEXTURE0+C);const he=i.get(z);if(z.version!==he.__version||B===!0){t.activeTexture(n.TEXTURE0+C);const ce=it.getPrimaries(it.workingColorSpace),pe=v.colorSpace===pi?null:it.getPrimaries(v.colorSpace),Ae=v.colorSpace===pi||ce===pe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);let fe=M(v.image,!1,s.maxTextureSize);fe=Y(v,fe);const ve=r.convert(v.format,v.colorSpace),Pe=r.convert(v.type);let Te=b(v.internalFormat,ve,Pe,v.colorSpace,v.isVideoTexture);ge(V,v);let be;const Ge=v.mipmaps,De=v.isVideoTexture!==!0,Fe=he.__version===void 0||B===!0,F=z.dataReady,ye=E(v,fe);if(v.isDepthTexture)Te=y(v.format===Os,v.type),Fe&&(De?t.texStorage2D(n.TEXTURE_2D,1,Te,fe.width,fe.height):t.texImage2D(n.TEXTURE_2D,0,Te,fe.width,fe.height,0,ve,Pe,null));else if(v.isDataTexture)if(Ge.length>0){De&&Fe&&t.texStorage2D(n.TEXTURE_2D,ye,Te,Ge[0].width,Ge[0].height);for(let ee=0,se=Ge.length;ee<se;ee++)be=Ge[ee],De?F&&t.texSubImage2D(n.TEXTURE_2D,ee,0,0,be.width,be.height,ve,Pe,be.data):t.texImage2D(n.TEXTURE_2D,ee,Te,be.width,be.height,0,ve,Pe,be.data);v.generateMipmaps=!1}else De?(Fe&&t.texStorage2D(n.TEXTURE_2D,ye,Te,fe.width,fe.height),F&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,fe.width,fe.height,ve,Pe,fe.data)):t.texImage2D(n.TEXTURE_2D,0,Te,fe.width,fe.height,0,ve,Pe,fe.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){De&&Fe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ye,Te,Ge[0].width,Ge[0].height,fe.depth);for(let ee=0,se=Ge.length;ee<se;ee++)if(be=Ge[ee],v.format!==wn)if(ve!==null)if(De){if(F)if(v.layerUpdates.size>0){const Me=Vh(be.width,be.height,v.format,v.type);for(const Ee of v.layerUpdates){const Ve=be.data.subarray(Ee*Me/be.data.BYTES_PER_ELEMENT,(Ee+1)*Me/be.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ee,0,0,Ee,be.width,be.height,1,ve,Ve,0,0)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ee,0,0,0,be.width,be.height,fe.depth,ve,be.data,0,0)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ee,Te,be.width,be.height,fe.depth,0,be.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else De?F&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ee,0,0,0,be.width,be.height,fe.depth,ve,Pe,be.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ee,Te,be.width,be.height,fe.depth,0,ve,Pe,be.data)}else{De&&Fe&&t.texStorage2D(n.TEXTURE_2D,ye,Te,Ge[0].width,Ge[0].height);for(let ee=0,se=Ge.length;ee<se;ee++)be=Ge[ee],v.format!==wn?ve!==null?De?F&&t.compressedTexSubImage2D(n.TEXTURE_2D,ee,0,0,be.width,be.height,ve,be.data):t.compressedTexImage2D(n.TEXTURE_2D,ee,Te,be.width,be.height,0,be.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?F&&t.texSubImage2D(n.TEXTURE_2D,ee,0,0,be.width,be.height,ve,Pe,be.data):t.texImage2D(n.TEXTURE_2D,ee,Te,be.width,be.height,0,ve,Pe,be.data)}else if(v.isDataArrayTexture)if(De){if(Fe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ye,Te,fe.width,fe.height,fe.depth),F)if(v.layerUpdates.size>0){const ee=Vh(fe.width,fe.height,v.format,v.type);for(const se of v.layerUpdates){const Me=fe.data.subarray(se*ee/fe.data.BYTES_PER_ELEMENT,(se+1)*ee/fe.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,se,fe.width,fe.height,1,ve,Pe,Me)}v.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,fe.width,fe.height,fe.depth,ve,Pe,fe.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Te,fe.width,fe.height,fe.depth,0,ve,Pe,fe.data);else if(v.isData3DTexture)De?(Fe&&t.texStorage3D(n.TEXTURE_3D,ye,Te,fe.width,fe.height,fe.depth),F&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,fe.width,fe.height,fe.depth,ve,Pe,fe.data)):t.texImage3D(n.TEXTURE_3D,0,Te,fe.width,fe.height,fe.depth,0,ve,Pe,fe.data);else if(v.isFramebufferTexture){if(Fe)if(De)t.texStorage2D(n.TEXTURE_2D,ye,Te,fe.width,fe.height);else{let ee=fe.width,se=fe.height;for(let Me=0;Me<ye;Me++)t.texImage2D(n.TEXTURE_2D,Me,Te,ee,se,0,ve,Pe,null),ee>>=1,se>>=1}}else if(Ge.length>0){if(De&&Fe){const ee=K(Ge[0]);t.texStorage2D(n.TEXTURE_2D,ye,Te,ee.width,ee.height)}for(let ee=0,se=Ge.length;ee<se;ee++)be=Ge[ee],De?F&&t.texSubImage2D(n.TEXTURE_2D,ee,0,0,ve,Pe,be):t.texImage2D(n.TEXTURE_2D,ee,Te,ve,Pe,be);v.generateMipmaps=!1}else if(De){if(Fe){const ee=K(fe);t.texStorage2D(n.TEXTURE_2D,ye,Te,ee.width,ee.height)}F&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ve,Pe,fe)}else t.texImage2D(n.TEXTURE_2D,0,Te,ve,Pe,fe);d(v)&&m(V),he.__version=z.version,v.onUpdate&&v.onUpdate(v)}S.__version=v.version}function ae(S,v,C){if(v.image.length!==6)return;const V=Le(S,v),B=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,S.__webglTexture,n.TEXTURE0+C);const z=i.get(B);if(B.version!==z.__version||V===!0){t.activeTexture(n.TEXTURE0+C);const he=it.getPrimaries(it.workingColorSpace),ce=v.colorSpace===pi?null:it.getPrimaries(v.colorSpace),pe=v.colorSpace===pi||he===ce?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const Ae=v.isCompressedTexture||v.image[0].isCompressedTexture,fe=v.image[0]&&v.image[0].isDataTexture,ve=[];for(let se=0;se<6;se++)!Ae&&!fe?ve[se]=M(v.image[se],!0,s.maxCubemapSize):ve[se]=fe?v.image[se].image:v.image[se],ve[se]=Y(v,ve[se]);const Pe=ve[0],Te=r.convert(v.format,v.colorSpace),be=r.convert(v.type),Ge=b(v.internalFormat,Te,be,v.colorSpace),De=v.isVideoTexture!==!0,Fe=z.__version===void 0||V===!0,F=B.dataReady;let ye=E(v,Pe);ge(n.TEXTURE_CUBE_MAP,v);let ee;if(Ae){De&&Fe&&t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,Ge,Pe.width,Pe.height);for(let se=0;se<6;se++){ee=ve[se].mipmaps;for(let Me=0;Me<ee.length;Me++){const Ee=ee[Me];v.format!==wn?Te!==null?De?F&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Me,0,0,Ee.width,Ee.height,Te,Ee.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Me,Ge,Ee.width,Ee.height,0,Ee.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):De?F&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Me,0,0,Ee.width,Ee.height,Te,be,Ee.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Me,Ge,Ee.width,Ee.height,0,Te,be,Ee.data)}}}else{if(ee=v.mipmaps,De&&Fe){ee.length>0&&ye++;const se=K(ve[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,Ge,se.width,se.height)}for(let se=0;se<6;se++)if(fe){De?F&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,ve[se].width,ve[se].height,Te,be,ve[se].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Ge,ve[se].width,ve[se].height,0,Te,be,ve[se].data);for(let Me=0;Me<ee.length;Me++){const Ve=ee[Me].image[se].image;De?F&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Me+1,0,0,Ve.width,Ve.height,Te,be,Ve.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Me+1,Ge,Ve.width,Ve.height,0,Te,be,Ve.data)}}else{De?F&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,Te,be,ve[se]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Ge,Te,be,ve[se]);for(let Me=0;Me<ee.length;Me++){const Ee=ee[Me];De?F&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Me+1,0,0,Te,be,Ee.image[se]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Me+1,Ge,Te,be,Ee.image[se])}}}d(v)&&m(n.TEXTURE_CUBE_MAP),z.__version=B.version,v.onUpdate&&v.onUpdate(v)}S.__version=v.version}function de(S,v,C,V,B,z){const he=r.convert(C.format,C.colorSpace),ce=r.convert(C.type),pe=b(C.internalFormat,he,ce,C.colorSpace);if(!i.get(v).__hasExternalTextures){const fe=Math.max(1,v.width>>z),ve=Math.max(1,v.height>>z);B===n.TEXTURE_3D||B===n.TEXTURE_2D_ARRAY?t.texImage3D(B,z,pe,fe,ve,v.depth,0,he,ce,null):t.texImage2D(B,z,pe,fe,ve,0,he,ce,null)}t.bindFramebuffer(n.FRAMEBUFFER,S),D(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,V,B,i.get(C).__webglTexture,0,L(v)):(B===n.TEXTURE_2D||B>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&B<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,V,B,i.get(C).__webglTexture,z),t.bindFramebuffer(n.FRAMEBUFFER,null)}function xe(S,v,C){if(n.bindRenderbuffer(n.RENDERBUFFER,S),v.depthBuffer){const V=v.depthTexture,B=V&&V.isDepthTexture?V.type:null,z=y(v.stencilBuffer,B),he=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ce=L(v);D(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ce,z,v.width,v.height):C?n.renderbufferStorageMultisample(n.RENDERBUFFER,ce,z,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,z,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,he,n.RENDERBUFFER,S)}else{const V=v.textures;for(let B=0;B<V.length;B++){const z=V[B],he=r.convert(z.format,z.colorSpace),ce=r.convert(z.type),pe=b(z.internalFormat,he,ce,z.colorSpace),Ae=L(v);C&&D(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ae,pe,v.width,v.height):D(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ae,pe,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,pe,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function O(S,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,S),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Z(v.depthTexture,0);const V=i.get(v.depthTexture).__webglTexture,B=L(v);if(v.depthTexture.format===Ts)D(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,V,0,B):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,V,0);else if(v.depthTexture.format===Os)D(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,V,0,B):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,V,0);else throw new Error("Unknown depthTexture format")}function le(S){const v=i.get(S),C=S.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==S.depthTexture){const V=S.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),V){const B=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,V.removeEventListener("dispose",B)};V.addEventListener("dispose",B),v.__depthDisposeCallback=B}v.__boundDepthTexture=V}if(S.depthTexture&&!v.__autoAllocateDepthBuffer){if(C)throw new Error("target.depthTexture not supported in Cube render targets");O(v.__webglFramebuffer,S)}else if(C){v.__webglDepthbuffer=[];for(let V=0;V<6;V++)if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[V]),v.__webglDepthbuffer[V]===void 0)v.__webglDepthbuffer[V]=n.createRenderbuffer(),xe(v.__webglDepthbuffer[V],S,!1);else{const B=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,z=v.__webglDepthbuffer[V];n.bindRenderbuffer(n.RENDERBUFFER,z),n.framebufferRenderbuffer(n.FRAMEBUFFER,B,n.RENDERBUFFER,z)}}else if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),xe(v.__webglDepthbuffer,S,!1);else{const V=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,B=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,B),n.framebufferRenderbuffer(n.FRAMEBUFFER,V,n.RENDERBUFFER,B)}t.bindFramebuffer(n.FRAMEBUFFER,null)}function oe(S,v,C){const V=i.get(S);v!==void 0&&de(V.__webglFramebuffer,S,S.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),C!==void 0&&le(S)}function ue(S){const v=S.texture,C=i.get(S),V=i.get(v);S.addEventListener("dispose",P);const B=S.textures,z=S.isWebGLCubeRenderTarget===!0,he=B.length>1;if(he||(V.__webglTexture===void 0&&(V.__webglTexture=n.createTexture()),V.__version=v.version,o.memory.textures++),z){C.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(v.mipmaps&&v.mipmaps.length>0){C.__webglFramebuffer[ce]=[];for(let pe=0;pe<v.mipmaps.length;pe++)C.__webglFramebuffer[ce][pe]=n.createFramebuffer()}else C.__webglFramebuffer[ce]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){C.__webglFramebuffer=[];for(let ce=0;ce<v.mipmaps.length;ce++)C.__webglFramebuffer[ce]=n.createFramebuffer()}else C.__webglFramebuffer=n.createFramebuffer();if(he)for(let ce=0,pe=B.length;ce<pe;ce++){const Ae=i.get(B[ce]);Ae.__webglTexture===void 0&&(Ae.__webglTexture=n.createTexture(),o.memory.textures++)}if(S.samples>0&&D(S)===!1){C.__webglMultisampledFramebuffer=n.createFramebuffer(),C.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,C.__webglMultisampledFramebuffer);for(let ce=0;ce<B.length;ce++){const pe=B[ce];C.__webglColorRenderbuffer[ce]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,C.__webglColorRenderbuffer[ce]);const Ae=r.convert(pe.format,pe.colorSpace),fe=r.convert(pe.type),ve=b(pe.internalFormat,Ae,fe,pe.colorSpace,S.isXRRenderTarget===!0),Pe=L(S);n.renderbufferStorageMultisample(n.RENDERBUFFER,Pe,ve,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ce,n.RENDERBUFFER,C.__webglColorRenderbuffer[ce])}n.bindRenderbuffer(n.RENDERBUFFER,null),S.depthBuffer&&(C.__webglDepthRenderbuffer=n.createRenderbuffer(),xe(C.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(z){t.bindTexture(n.TEXTURE_CUBE_MAP,V.__webglTexture),ge(n.TEXTURE_CUBE_MAP,v);for(let ce=0;ce<6;ce++)if(v.mipmaps&&v.mipmaps.length>0)for(let pe=0;pe<v.mipmaps.length;pe++)de(C.__webglFramebuffer[ce][pe],S,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe);else de(C.__webglFramebuffer[ce],S,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);d(v)&&m(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(he){for(let ce=0,pe=B.length;ce<pe;ce++){const Ae=B[ce],fe=i.get(Ae);t.bindTexture(n.TEXTURE_2D,fe.__webglTexture),ge(n.TEXTURE_2D,Ae),de(C.__webglFramebuffer,S,Ae,n.COLOR_ATTACHMENT0+ce,n.TEXTURE_2D,0),d(Ae)&&m(n.TEXTURE_2D)}t.unbindTexture()}else{let ce=n.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ce=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ce,V.__webglTexture),ge(ce,v),v.mipmaps&&v.mipmaps.length>0)for(let pe=0;pe<v.mipmaps.length;pe++)de(C.__webglFramebuffer[pe],S,v,n.COLOR_ATTACHMENT0,ce,pe);else de(C.__webglFramebuffer,S,v,n.COLOR_ATTACHMENT0,ce,0);d(v)&&m(ce),t.unbindTexture()}S.depthBuffer&&le(S)}function Se(S){const v=S.textures;for(let C=0,V=v.length;C<V;C++){const B=v[C];if(d(B)){const z=S.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,he=i.get(B).__webglTexture;t.bindTexture(z,he),m(z),t.unbindTexture()}}}const Q=[],g=[];function T(S){if(S.samples>0){if(D(S)===!1){const v=S.textures,C=S.width,V=S.height;let B=n.COLOR_BUFFER_BIT;const z=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,he=i.get(S),ce=v.length>1;if(ce)for(let pe=0;pe<v.length;pe++)t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,he.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer);for(let pe=0;pe<v.length;pe++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(B|=n.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(B|=n.STENCIL_BUFFER_BIT)),ce){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,he.__webglColorRenderbuffer[pe]);const Ae=i.get(v[pe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Ae,0)}n.blitFramebuffer(0,0,C,V,0,0,C,V,B,n.NEAREST),l===!0&&(Q.length=0,g.length=0,Q.push(n.COLOR_ATTACHMENT0+pe),S.depthBuffer&&S.resolveDepthBuffer===!1&&(Q.push(z),g.push(z),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,g)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Q))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ce)for(let pe=0;pe<v.length;pe++){t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,he.__webglColorRenderbuffer[pe]);const Ae=i.get(v[pe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.TEXTURE_2D,Ae,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){const v=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function L(S){return Math.min(s.maxSamples,S.samples)}function D(S){const v=i.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function U(S){const v=o.render.frame;h.get(S)!==v&&(h.set(S,v),S.update())}function Y(S,v){const C=S.colorSpace,V=S.format,B=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||C!==wi&&C!==pi&&(it.getTransfer(C)===mt?(V!==wn||B!==ei)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",C)),v}function K(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(c.width=S.naturalWidth||S.width,c.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(c.width=S.displayWidth,c.height=S.displayHeight):(c.width=S.width,c.height=S.height),c}this.allocateTextureUnit=$,this.resetTextureUnits=w,this.setTexture2D=Z,this.setTexture2DArray=re,this.setTexture3D=G,this.setTextureCube=J,this.rebindTextures=oe,this.setupRenderTarget=ue,this.updateRenderTargetMipmap=Se,this.updateMultisampleRenderTarget=T,this.setupDepthRenderbuffer=le,this.setupFrameBufferTexture=de,this.useMultisampledRTT=D}function HS(n,e){function t(i,s=pi){let r;const o=it.getTransfer(s);if(i===ei)return n.UNSIGNED_BYTE;if(i===Dc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Uc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===md)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===dd)return n.BYTE;if(i===pd)return n.SHORT;if(i===Er)return n.UNSIGNED_SHORT;if(i===Ic)return n.INT;if(i===Wi)return n.UNSIGNED_INT;if(i===Kn)return n.FLOAT;if(i===Lr)return n.HALF_FLOAT;if(i===gd)return n.ALPHA;if(i===_d)return n.RGB;if(i===wn)return n.RGBA;if(i===vd)return n.LUMINANCE;if(i===xd)return n.LUMINANCE_ALPHA;if(i===Ts)return n.DEPTH_COMPONENT;if(i===Os)return n.DEPTH_STENCIL;if(i===Md)return n.RED;if(i===Nc)return n.RED_INTEGER;if(i===yd)return n.RG;if(i===Oc)return n.RG_INTEGER;if(i===Fc)return n.RGBA_INTEGER;if(i===bo||i===To||i===Ao||i===Ro)if(o===mt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===bo)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===To)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ao)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Ro)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===bo)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===To)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ao)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Ro)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Pl||i===Ll||i===Il||i===Dl)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===Pl)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Ll)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Il)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Dl)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Ul||i===Nl||i===Ol)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Ul||i===Nl)return o===mt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Ol)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Fl||i===Bl||i===zl||i===Hl||i===Gl||i===Vl||i===kl||i===Wl||i===Xl||i===ql||i===Yl||i===$l||i===Kl||i===jl)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Fl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Bl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===zl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Hl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Gl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Vl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===kl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Wl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Xl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===ql)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Yl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===$l)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Kl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===jl)return o===mt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Co||i===Zl||i===Jl)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Co)return o===mt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Zl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Jl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Sd||i===Ql||i===ec||i===tc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Co)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Ql)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===ec)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===tc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ns?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}class GS extends Ot{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class ct extends kt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const VS={type:"move"};class Ja{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ct,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ct,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new H,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new H),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ct,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new H,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new H),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const M of e.hand.values()){const d=t.getJointPose(M,i),m=this._getHandJoint(c,M);d!==null&&(m.matrix.fromArray(d.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=d.radius),m.visible=d!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],f=h.position.distanceTo(u.position),p=.02,_=.005;c.inputState.pinching&&f>p+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=p-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,i),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,i),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(VS)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new ct;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}const kS=`
void main() {
...
}`;class XS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,i){if(this.texture===null){const s=new jt,r=e.properties.get(s);r.__webglTexture=t.texture,(t.depthNear!=i.depthNear||t.depthFar!=i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new xi({vertexShader:kS,fragmentShader:WS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new j(new sa(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class qS extends Vs{constructor(e,t){super();const i=this;let s=null,r=1,o=null,a="local-floor",l=1,c=null,h=null,u=null,f=null,p=null,_=null;const M=new XS,d=t.getContextAttributes();let m=null,b=null;const y=[],E=[],N=new Ce;let P=null;const R=new Ot;R.layers.enable(1),R.viewport=new at;const I=new Ot;I.layers.enable(2),I.viewport=new at;const ne=[R,I],x=new GS;x.layers.enable(1),x.layers.enable(2);let w=null,$=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ae){let de=y[ae];return de===void 0&&(de=new Ja,y[ae]=de),de.getTargetRaySpace()},this.getControllerGrip=function(ae){let de=y[ae];return de===void 0&&(de=new Ja,y[ae]=de),de.getGripSpace()},this.getHand=function(ae){let de=y[ae];return de===void 0&&(de=new Ja,y[ae]=de),de.getHandSpace()};function q(ae){const de=E.indexOf(ae.inputSource);if(de===-1)return;const xe=y[de];xe!==void 0&&(xe.update(ae.inputSource,ae.frame,c||o),xe.dispatchEvent({type:ae.type,data:ae.inputSource}))}function Z(){s.removeEventListener("select",q),s.removeEventListener("selectstart",q),s.removeEventListener("selectend",q),s.removeEventListener("squeeze",q),s.removeEventListener("squeezestart",q),s.removeEventListener("squeezeend",q),s.removeEventListener("end",Z),s.removeEventListener("inputsourceschange",re);for(let ae=0;ae<y.length;ae++){const de=E[ae];de!==null&&(E[ae]=null,y[ae].disconnect(de))}w=null,$=null,M.reset(),e.setRenderTarget(m),p=null,f=null,u=null,s=null,b=null,Oe.stop(),i.isPresenting=!1,e.setPixelRatio(P),e.setSize(N.width,N.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ae){r=ae,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ae){a=ae,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(ae){c=ae},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return u},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(ae){if(s=ae,s!==null){if(m=e.getRenderTarget(),s.addEventListener("select",q),s.addEventListener("selectstart",q),s.addEventListener("selectend",q),s.addEventListener("squeeze",q),s.addEventListener("squeezestart",q),s.addEventListener("squeezeend",q),s.addEventListener("end",Z),s.addEventListener("inputsourceschange",re),d.xrCompatible!==!0&&await t.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(N),s.renderState.layers===void 0){const de={antialias:d.antialias,alpha:!0,depth:d.depth,stencil:d.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,t,de),s.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),b=new Xi(p.framebufferWidth,p.framebufferHeight,{format:wn,type:ei,colorSpace:e.outputColorSpace,stencilBuffer:d.stencil})}else{let de=null,xe=null,O=null;d.depth&&(O=d.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,de=d.stencil?Os:Ts,xe=d.stencil?Ns:Wi);const le={colorFormat:t.RGBA8,depthFormat:O,scaleFactor:r};u=new XRWebGLBinding(s,t),f=u.createProjectionLayer(le),s.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),b=new Xi(f.textureWidth,f.textureHeight,{format:wn,type:ei,depthTexture:new Fd(f.textureWidth,f.textureHeight,xe,void 0,void 0,void 0,void 0,void 0,void 0,de),stencilBuffer:d.stencil,colorSpace:e.outputColorSpace,samples:d.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await s.requestReferenceSpace(a),Oe.setContext(s),Oe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function re(ae){for(let de=0;de<ae.removed.length;de++){const xe=ae.removed[de],O=E.indexOf(xe);O>=0&&(E[O]=null,y[O].disconnect(xe))}for(let de=0;de<ae.added.length;de++){const xe=ae.added[de];let O=E.indexOf(xe);if(O===-1){for(let oe=0;oe<y.length;oe++)if(oe>=E.length){E.push(xe),O=oe;break}else if(E[oe]===null){E[oe]=xe,O=oe;break}if(O===-1)break}const le=y[O];le&&le.connect(xe)}}const G=new H,J=new H;function W(ae,de,xe){G.setFromMatrixPosition(de.matrixWorld),J.setFromMatrixPosition(xe.matrixWorld);const O=G.distanceTo(J),le=de.projectionMatrix.elements,oe=xe.projectionMatrix.elements,ue=le[14]/(le[10]-1),Se=le[14]/(le[10]+1),Q=(le[9]+1)/le[5],g=(le[9]-1)/le[5],T=(le[8]-1)/le[0],L=(oe[8]+1)/oe[0],D=ue*T,U=ue*L,Y=O/(-T+L),K=Y*-T;if(de.matrixWorld.decompose(ae.position,ae.quaternion,ae.scale),ae.translateX(K),ae.translateZ(Y),ae.matrixWorld.compose(ae.position,ae.quaternion,ae.scale),ae.matrixWorldInverse.copy(ae.matrixWorld).invert(),le[10]===-1)ae.projectionMatrix.copy(de.projectionMatrix),ae.projectionMatrixInverse.copy(de.projectionMatrixInverse);else{const S=ue+Y,v=Se+Y,C=D-K,V=U+(O-K),B=Q*Se/v*S,z=g*Se/v*S;ae.projectionMatrix.makePerspective(C,V,B,z,S,v),ae.projectionMatrixInverse.copy(ae.projectionMatrix).invert()}}function me(ae,de){de===null?ae.matrixWorld.copy(ae.matrix):ae.matrixWorld.multiplyMatrices(de.matrixWorld,ae.matrix),ae.matrixWorldInverse.copy(ae.matrixWorld).invert()}this.updateCamera=function(ae){if(s===null)return;let de=ae.near,xe=ae.far;M.texture!==null&&(M.depthNear>0&&(de=M.depthNear),M.depthFar>0&&(xe=M.depthFar)),x.near=I.near=R.near=de,x.far=I.far=R.far=xe,(w!==x.near||$!==x.far)&&(s.updateRenderState({depthNear:x.near,depthFar:x.far}),w=x.near,$=x.far);const O=ae.parent,le=x.cameras;me(x,O);for(let oe=0;oe<le.length;oe++)me(le[oe],O);le.length===2?W(x,R,I):x.projectionMatrix.copy(R.projectionMatrix),_e(ae,x,O)};function _e(ae,de,xe){xe===null?ae.matrix.copy(de.matrixWorld):(ae.matrix.copy(xe.matrixWorld),ae.matrix.invert(),ae.matrix.multiply(de.matrixWorld)),ae.matrix.decompose(ae.position,ae.quaternion,ae.scale),ae.updateMatrixWorld(!0),ae.projectionMatrix.copy(de.projectionMatrix),ae.projectionMatrixInverse.copy(de.projectionMatrixInverse),ae.isPerspectiveCamera&&(ae.fov=wr*2*Math.atan(1/ae.projectionMatrix.elements[5]),ae.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(ae){l=ae,f!==null&&(f.fixedFoveation=ae),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=ae)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(x)};let ge=null;function Le(ae,de){if(h=de.getViewerPose(c||o),_=de,h!==null){const xe=h.views;p!==null&&(e.setRenderTargetFramebuffer(b,p.framebuffer),e.setRenderTarget(b));let O=!1;xe.length!==x.cameras.length&&(x.cameras.length=0,O=!0);for(let oe=0;oe<xe.length;oe++){const ue=xe[oe];let Se=null;if(p!==null)Se=p.getViewport(ue);else{const g=u.getViewSubImage(f,ue);Se=g.viewport,oe===0&&(e.setRenderTargetTextures(b,g.colorTexture,f.ignoreDepthValues?void 0:g.depthStencilTexture),e.setRenderTarget(b))}let Q=ne[oe];Q===void 0&&(Q=new Ot,Q.layers.enable(oe),Q.viewport=new at,ne[oe]=Q),Q.matrix.fromArray(ue.transform.matrix),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.projectionMatrix.fromArray(ue.projectionMatrix),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert(),Q.viewport.set(Se.x,Se.y,Se.width,Se.height),oe===0&&(x.matrix.copy(Q.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),O===!0&&x.cameras.push(Q)}const le=s.enabledFeatures;if(le&&le.includes("depth-sensing")){const oe=u.getDepthInformation(xe[0]);oe&&oe.isValid&&oe.texture&&M.init(e,oe,s.renderState)}}for(let xe=0;xe<y.length;xe++){const O=E[xe],le=y[xe];O!==null&&le!==void 0&&le.update(O,de,c||o)}ge&&ge(ae,de),de.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:de}),_=null}const Oe=new Nd;Oe.setAnimationLoop(Le),this.setAnimationLoop=function(ae){ge=ae},this.dispose=function(){}}}const Ui=new On,YS=new vt;function $S(n,e){function t(d,m){d.matrixAutoUpdate===!0&&d.updateMatrix(),m.value.copy(d.matrix)}function i(d,m){m.color.getRGB(d.fogColor.value,Id(n)),m.isFog?(d.fogNear.value=m.near,d.fogFar.value=m.far):m.isFogExp2&&(d.fogDensity.value=m.density)}function s(d,m,b,y,E){m.isMeshBasicMaterial||m.isMeshLambertMaterial?r(d,m):m.isMeshToonMaterial?(r(d,m),u(d,m)):m.isMeshPhongMaterial?(r(d,m),h(d,m)):m.isMeshStandardMaterial?(r(d,m),f(d,m),m.isMeshPhysicalMaterial&&p(d,m,E)):m.isMeshMatcapMaterial?(r(d,m),_(d,m)):m.isMeshDepthMaterial?r(d,m):m.isMeshDistanceMaterial?(r(d,m),M(d,m)):m.isMeshNormalMaterial?r(d,m):m.isLineBasicMaterial?(o(d,m),m.isLineDashedMaterial&&a(d,m)):m.isPointsMaterial?l(d,m,b,y):m.isSpriteMaterial?c(d,m):m.isShadowMaterial?(d.color.value.copy(m.color),d.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function r(d,m){d.opacity.value=m.opacity,m.color&&d.diffuse.value.copy(m.color),m.emissive&&d.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(d.map.value=m.map,t(m.map,d.mapTransform)),m.alphaMap&&(d.alphaMap.value=m.alphaMap,t(m.alphaMap,d.alphaMapTransform)),m.bumpMap&&(d.bumpMap.value=m.bumpMap,t(m.bumpMap,d.bumpMapTransform),d.bumpScale.value=m.bumpScale,m.side===Qt&&(d.bumpScale.value*=-1)),m.normalMap&&(d.normalMap.value=m.normalMap,t(m.normalMap,d.normalMapTransform),d.normalScale.value.copy(m.normalScale),m.side===Qt&&d.normalScale.value.negate()),m.displacementMap&&(d.displacementMap.value=m.displacementMap,t(m.displacementMap,d.displacementMapTransform),d.displacementScale.value=m.displacementScale,d.displacementBias.value=m.displacementBias),m.emissiveMap&&(d.emissiveMap.value=m.emissiveMap,t(m.emissiveMap,d.emissiveMapTransform)),m.specularMap&&(d.specularMap.value=m.specularMap,t(m.specularMap,d.specularMapTransform)),m.alphaTest>0&&(d.alphaTest.value=m.alphaTest);const b=e.get(m),y=b.envMap,E=b.envMapRotation;y&&(d.envMap.value=y,Ui.copy(E),Ui.x*=-1,Ui.y*=-1,Ui.z*=-1,y.isCubeTexture&&y.isRenderTargetTexture===!1&&(Ui.y*=-1,Ui.z*=-1),d.envMapRotation.value.setFromMatrix4(YS.makeRotationFromEuler(Ui)),d.flipEnvMap.value=y.isCubeTexture&&y.isRenderTargetTexture===!1?-1:1,d.reflectivity.value=m.reflectivity,d.ior.value=m.ior,d.refractionRatio.value=m.refractionRatio),m.lightMap&&(d.lightMap.value=m.lightMap,d.lightMapIntensity.value=m.lightMapIntensity,t(m.lightMap,d.lightMapTransform)),m.aoMap&&(d.aoMap.value=m.aoMap,d.aoMapIntensity.value=m.aoMapIntensity,t(m.aoMap,d.aoMapTransform))}function o(d,m){d.diffuse.value.copy(m.color),d.opacity.value=m.opacity,m.map&&(d.map.value=m.map,t(m.map,d.mapTransform))}function a(d,m){d.dashSize.value=m.dashSize,d.totalSize.value=m.dashSize+m.gapSize,d.scale.value=m.scale}function l(d,m,b,y){d.diffuse.value.copy(m.color),d.opacity.value=m.opacity,d.size.value=m.size*b,d.scale.value=y*.5,m.map&&(d.map.value=m.map,t(m.map,d.uvTransform)),m.alphaMap&&(d.alphaMap.value=m.alphaMap,t(m.alphaMap,d.alphaMapTransform)),m.alphaTest>0&&(d.alphaTest.value=m.alphaTest)}function c(d,m){d.diffuse.value.copy(m.color),d.opacity.value=m.opacity,d.rotation.value=m.rotation,m.map&&(d.map.value=m.map,t(m.map,d.mapTransform)),m.alphaMap&&(d.alphaMap.value=m.alphaMap,t(m.alphaMap,d.alphaMapTransform)),m.alphaTest>0&&(d.alphaTest.value=m.alphaTest)}function h(d,m){d.specular.value.copy(m.specular),d.shininess.value=Math.max(m.shininess,1e-4)}function u(d,m){m.gradientMap&&(d.gradientMap.value=m.gradientMap)}function f(d,m){d.metalness.value=m.metalness,m.metalnessMap&&(d.metalnessMap.value=m.metalnessMap,t(m.metalnessMap,d.metalnessMapTransform)),d.roughness.value=m.roughness,m.roughnessMap&&(d.roughnessMap.value=m.roughnessMap,t(m.roughnessMap,d.roughnessMapTransform)),m.envMap&&(d.envMapIntensity.value=m.envMapIntensity)}function p(d,m,b){d.ior.value=m.ior,m.sheen>0&&(d.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),d.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(d.sheenColorMap.value=m.sheenColorMap,t(m.sheenColorMap,d.sheenColorMapTransform)),m.sheenRoughnessMap&&(d.sheenRoughnessMap.value=m.sheenRoughnessMap,t(m.sheenRoughnessMap,d.sheenRoughnessMapTransform))),m.clearcoat>0&&(d.clearcoat.value=m.clearcoat,d.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(d.clearcoatMap.value=m.clearcoatMap,t(m.clearcoatMap,d.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(d.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,t(m.clearcoatRoughnessMap,d.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(d.clearcoatNormalMap.value=m.clearcoatNormalMap,t(m.clearcoatNormalMap,d.clearcoatNormalMapTransform),d.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===Qt&&d.clearcoatNormalScale.value.negate())),m.dispersion>0&&(d.dispersion.value=m.dispersion),m.iridescence>0&&(d.iridescence.value=m.iridescence,d.iridescenceIOR.value=m.iridescenceIOR,d.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],d.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(d.iridescenceMap.value=m.iridescenceMap,t(m.iridescenceMap,d.iridescenceMapTransform)),m.iridescenceThicknessMap&&(d.iridescenceThicknessMap.value=m.iridescenceThicknessMap,t(m.iridescenceThicknessMap,d.iridescenceThicknessMapTransform))),m.transmission>0&&(d.transmission.value=m.transmission,d.transmissionSamplerMap.value=b.texture,d.transmissionSamplerSize.value.set(b.width,b.height),m.transmissionMap&&(d.transmissionMap.value=m.transmissionMap,t(m.transmissionMap,d.transmissionMapTransform)),d.thickness.value=m.thickness,m.thicknessMap&&(d.thicknessMap.value=m.thicknessMap,t(m.thicknessMap,d.thicknessMapTransform)),d.attenuationDistance.value=m.attenuationDistance,d.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(d.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(d.anisotropyMap.value=m.anisotropyMap,t(m.anisotropyMap,d.anisotropyMapTransform))),d.specularIntensity.value=m.specularIntensity,d.specularColor.value.copy(m.specularColor),m.specularColorMap&&(d.specularColorMap.value=m.specularColorMap,t(m.specularColorMap,d.specularColorMapTransform)),m.specularIntensityMap&&(d.specularIntensityMap.value=m.specularIntensityMap,t(m.specularIntensityMap,d.specularIntensityMapTransform))}function _(d,m){m.matcap&&(d.matcap.value=m.matcap)}function M(d,m){const b=e.get(m).light;d.referencePosition.value.setFromMatrixPosition(b.matrixWorld),d.nearDistance.value=b.shadow.camera.near,d.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function KS(n,e,t,i){let s={},r={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(b,y){const E=y.program;i.uniformBlockBinding(b,E)}function c(b,y){let E=s[b.id];E===void 0&&(_(b),E=h(b),s[b.id]=E,b.addEventListener("dispose",d));const N=y.program;i.updateUBOMapping(b,N);const P=e.render.frame;r[b.id]!==P&&(f(b),r[b.id]=P)}function h(b){const y=u();b.__bindingPointIndex=y;const E=n.createBuffer(),N=b.__size,P=b.usage;return n.bindBuffer(n.UNIFORM_BUFFER,E),n.bufferData(n.UNIFORM_BUFFER,N,P),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,y,E),E}function u(){for(let b=0;b<a;b++)if(o.indexOf(b)===-1)return o.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(b){const y=s[b.id],E=b.uniforms,N=b.__cache;n.bindBuffer(n.UNIFORM_BUFFER,y);for(let P=0,R=E.length;P<R;P++){const I=Array.isArray(E[P])?E[P]:[E[P]];for(let ne=0,x=I.length;ne<x;ne++){const w=I[ne];if(p(w,P,ne,N)===!0){const $=w.__offset,q=Array.isArray(w.value)?w.value:[w.value];let Z=0;for(let re=0;re<q.length;re++){const G=q[re],J=M(G);typeof G=="number"||typeof G=="boolean"?(w.__data[0]=G,n.bufferSubData(n.UNIFORM_BUFFER,$+Z,w.__data)):G.isMatrix3?(w.__data[0]=G.elements[0],w.__data[1]=G.elements[1],w.__data[2]=G.elements[2],w.__data[3]=0,w.__data[4]=G.elements[3],w.__data[5]=G.elements[4],w.__data[6]=G.elements[5],w.__data[7]=0,w.__data[8]=G.elements[6],w.__data[9]=G.elements[7],w.__data[10]=G.elements[8],w.__data[11]=0):(G.toArray(w.__data,Z),Z+=J.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,$,w.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(b,y,E,N){const P=b.value,R=y+"_"+E;if(N[R]===void 0)return typeof P=="number"||typeof P=="boolean"?N[R]=P:N[R]=P.clone(),!0;{const I=N[R];if(typeof P=="number"||typeof P=="boolean"){if(I!==P)return N[R]=P,!0}else if(I.equals(P)===!1)return I.copy(P),!0}return!1}function _(b){const y=b.uniforms;let E=0;const N=16;for(let R=0,I=y.length;R<I;R++){const ne=Array.isArray(y[R])?y[R]:[y[R]];for(let x=0,w=ne.length;x<w;x++){const $=ne[x],q=Array.isArray($.value)?$.value:[$.value];for(let Z=0,re=q.length;Z<re;Z++){const G=q[Z],J=M(G),W=E%N,me=W%J.boundary,_e=W+me;E+=me,_e!==0&&N-_e<J.storage&&(E+=N-_e),$.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),$.__offset=E,E+=J.storage}}}const P=E%N;return P>0&&(E+=N-P),b.__size=E,b.__cache={},this}function M(b){const y={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(y.boundary=4,y.storage=4):b.isVector2?(y.boundary=8,y.storage=8):b.isVector3||b.isColor?(y.boundary=16,y.storage=12):b.isVector4?(y.boundary=16,y.storage=16):b.isMatrix3?(y.boundary=48,y.storage=48):b.isMatrix4?(y.boundary=64,y.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),y}function d(b){const y=b.target;y.removeEventListener("dispose",d);const E=o.indexOf(y.__bindingPointIndex);o.splice(E,1),n.deleteBuffer(s[y.id]),delete s[y.id],delete r[y.id]}function m(){for(const b in s)n.deleteBuffer(s[b]);o=[],s={},r={}}return{bind:l,update:c,dispose:m}}class Nr{constructor(e={}){const{canvas:t=O_(),context:i=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1}=e;this.isWebGLRenderer=!0;let f;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=i.getContextAttributes().alpha}else f=o;const p=new Uint32Array(4),_=new Int32Array(4);let M=null,d=null;const m=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Pn,this.toneMapping=gi,this.toneMappingExposure=1;const y=this;let E=!1,N=0,P=0,R=null,I=-1,ne=null;const x=new at,w=new at;let $=null;const q=new Ze(0);let Z=0,re=t.width,G=t.height,J=1,W=null,me=null;const _e=new at(0,0,re,G),ge=new at(0,0,re,G);let Le=!1;const Oe=new Gc;let ae=!1,de=!1;const xe=new vt,O=new vt,le=new H,oe=new at,ue={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Se=!1;function Q(){return R===null?J:1}let g=i;function T(A,k){return t.getContext(A,k)}try{const A={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Lc}`),t.addEventListener("webglcontextlost",se,!1),t.addEventListener("webglcontextrestored",Me,!1),t.addEventListener("webglcontextcreationerror",Ee,!1),g===null){const k="webgl2";if(g=T(k,A),g===null)throw T(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw console.error("THREE.WebGLRenderer: "+A.message),A}let L,D,U,Y,K,S,v,C,V,B,z,he,ce,pe,Ae,fe,ve,Pe,Te,be,Ge,De,Fe,F;function ye(){L=new ty(g),L.init(),De=new HS(g,L),D=new KM(g,L,e,De),U=new FS(g),D.reverseDepthBuffer&&U.buffers.depth.setReversed(!0),Y=new sy(g),K=new SS,S=new zS(g,L,U,K,D,De,Y),v=new ZM(y),C=new ey(y),V=new hv(g),Fe=new YM(g,V),B=new ny(g,V,Y,Fe),z=new oy(g,B,V,Y),Te=new ry(g,D,S),fe=new jM(K),he=new yS(y,v,C,L,D,Fe,fe),ce=new $S(y,K),pe=new wS,Ae=new PS(L),Pe=new qM(y,v,C,U,z,f,l),ve=new NS(y,z,D),F=new KS(g,Y,D,U),be=new $M(g,L,Y),Ge=new iy(g,L,Y),Y.programs=he.programs,y.capabilities=D,y.extensions=L,y.properties=K,y.renderLists=pe,y.shadowMap=ve,y.state=U,y.info=Y}ye();const ee=new qS(y,g);this.xr=ee,this.getContext=function(){return g},this.getContextAttributes=function(){return g.getContextAttributes()},this.forceContextLoss=function(){const A=L.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=L.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return J},this.setPixelRatio=function(A){A!==void 0&&(J=A,this.setSize(re,G,!1))},this.getSize=function(A){return A.set(re,G)},this.setSize=function(A,k,te=!0){if(ee.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}re=A,G=k,t.width=Math.floor(A*J),t.height=Math.floor(k*J),te===!0&&(t.style.width=A+"px",t.style.height=k+"px"),this.setViewport(0,0,A,k)},this.getDrawingBufferSize=function(A){return A.set(re*J,G*J).floor()},this.setDrawingBufferSize=function(A,k,te){re=A,G=k,J=te,t.width=Math.floor(A*te),t.height=Math.floor(k*te),this.setViewport(0,0,A,k)},this.getCurrentViewport=function(A){return A.copy(x)},this.getViewport=function(A){return A.copy(_e)},this.setViewport=function(A,k,te,ie){A.isVector4?_e.set(A.x,A.y,A.z,A.w):_e.set(A,k,te,ie),U.viewport(x.copy(_e).multiplyScalar(J).round())},this.getScissor=function(A){return A.copy(ge)},this.setScissor=function(A,k,te,ie){A.isVector4?ge.set(A.x,A.y,A.z,A.w):ge.set(A,k,te,ie),U.scissor(w.copy(ge).multiplyScalar(J).round())},this.getScissorTest=function(){return Le},this.setScissorTest=function(A){U.setScissorTest(Le=A)},this.setOpaqueSort=function(A){W=A},this.setTransparentSort=function(A){me=A},this.getClearColor=function(A){return A.copy(Pe.getClearColor())},this.setClearColor=function(){Pe.setClearColor.apply(Pe,arguments)},this.getClearAlpha=function(){return Pe.getClearAlpha()},this.setClearAlpha=function(){Pe.setClearAlpha.apply(Pe,arguments)},this.clear=function(A=!0,k=!0,te=!0){let ie=0;if(A){let X=!1;if(R!==null){const we=R.texture.format;X=we===Fc||we===Oc||we===Nc}if(X){const we=R.texture.type,Ie=we===ei||we===Wi||we===Er||we===Ns||we===Dc||we===Uc,Ue=Pe.getClearColor(),Ne=Pe.getClearAlpha(),ke=Ue.r,Xe=Ue.g,Be=Ue.b;Ie?(p[0]=ke,p[1]=Xe,p[2]=Be,p[3]=Ne,g.clearBufferuiv(g.COLOR,0,p)):(_[0]=ke,_[1]=Xe,_[2]=Be,_[3]=Ne,g.clearBufferiv(g.COLOR,0,_))}else ie|=g.COLOR_BUFFER_BIT}k&&(ie|=g.DEPTH_BUFFER_BIT,g.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),te&&(ie|=g.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),g.clear(ie)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",se,!1),t.removeEventListener("webglcontextrestored",Me,!1),t.removeEventListener("webglcontextcreationerror",Ee,!1),pe.dispose(),Ae.dispose(),K.dispose(),v.dispose(),C.dispose(),z.dispose(),Fe.dispose(),F.dispose(),he.dispose(),ee.dispose(),ee.removeEventListener("sessionstart",bt),ee.removeEventListener("sessionend",Zt),At.stop()};function se(A){A.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),E=!0}function Me(){console.log("THREE.WebGLRenderer: Context Restored."),E=!1;const A=Y.autoReset,k=ve.enabled,te=ve.autoUpdate,ie=ve.needsUpdate,X=ve.type;ye(),Y.autoReset=A,ve.enabled=k,ve.autoUpdate=te,ve.needsUpdate=ie,ve.type=X}function Ee(A){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Ve(A){const k=A.target;k.removeEventListener("dispose",Ve),Je(k)}function Je(A){ft(A),K.remove(A)}function ft(A){const k=K.get(A).programs;k!==void 0&&(k.forEach(function(te){he.releaseProgram(te)}),A.isShaderMaterial&&he.releaseShaderCache(A))}this.renderBufferDirect=function(A,k,te,ie,X,we){k===null&&(k=ue);const Ie=X.isMesh&&X.matrixWorld.determinant()<0,Ue=Jd(A,k,te,ie,X);U.setMaterial(ie,Ie);let Ne=te.index,ke=1;if(ie.wireframe===!0){if(Ne=B.getWireframeAttribute(te),Ne===void 0)return;ke=2}const Xe=te.drawRange,Be=te.attributes.position;let rt=Xe.start*ke,pt=(Xe.start+Xe.count)*ke;we!==null&&(rt=Math.max(rt,we.start*ke),pt=Math.min(pt,(we.start+we.count)*ke)),Ne!==null?(rt=Math.max(rt,0),pt=Math.min(pt,Ne.count)):Be!=null&&(rt=Math.max(rt,0),pt=Math.min(pt,Be.count));const yt=pt-rt;if(yt<0||yt===1/0)return;Fe.setup(X,ie,Ue,te,Ne);let en,et=be;if(Ne!==null&&(en=V.get(Ne),et=Ge,et.setIndex(en)),X.isMesh)ie.wireframe===!0?(U.setLineWidth(ie.wireframeLinewidth*Q()),et.setMode(g.LINES)):et.setMode(g.TRIANGLES);else if(X.isLine){let ze=ie.linewidth;ze===void 0&&(ze=1),U.setLineWidth(ze*Q()),X.isLineSegments?et.setMode(g.LINES):X.isLineLoop?et.setMode(g.LINE_LOOP):et.setMode(g.LINE_STRIP)}else X.isPoints?et.setMode(g.POINTS):X.isSprite&&et.setMode(g.TRIANGLES);if(X.isBatchedMesh)if(X._multiDrawInstances!==null)et.renderMultiDrawInstances(X._multiDrawStarts,X._multiDrawCounts,X._multiDrawCount,X._multiDrawInstances);else if(L.get("WEBGL_multi_draw"))et.renderMultiDraw(X._multiDrawStarts,X._multiDrawCounts,X._multiDrawCount);else{const ze=X._multiDrawStarts,Ut=X._multiDrawCounts,tt=X._multiDrawCount,_n=Ne?V.get(Ne).bytesPerElement:1,Zi=K.get(ie).currentProgram.getUniforms();for(let tn=0;tn<tt;tn++)Zi.setValue(g,"_gl_DrawID",tn),et.render(ze[tn]/_n,Ut[tn])}else if(X.isInstancedMesh)et.renderInstances(rt,yt,X.count);else if(te.isInstancedBufferGeometry){const ze=te._maxInstanceCount!==void 0?te._maxInstanceCount:1/0,Ut=Math.min(te.instanceCount,ze);et.renderInstances(rt,yt,Ut)}else et.render(rt,yt)};function $e(A,k,te){A.transparent===!0&&A.side===ht&&A.forceSinglePass===!1?(A.side=Qt,A.needsUpdate=!0,Wr(A,k,te),A.side=vi,A.needsUpdate=!0,Wr(A,k,te),A.side=ht):Wr(A,k,te)}this.compile=function(A,k,te=null){te===null&&(te=A),d=Ae.get(te),d.init(k),b.push(d),te.traverseVisible(function(X){X.isLight&&X.layers.test(k.layers)&&(d.pushLight(X),X.castShadow&&d.pushShadow(X))}),A!==te&&A.traverseVisible(function(X){X.isLight&&X.layers.test(k.layers)&&(d.pushLight(X),X.castShadow&&d.pushShadow(X))}),d.setupLights();const ie=new Set;return A.traverse(function(X){if(!(X.isMesh||X.isPoints||X.isLine||X.isSprite))return;const we=X.material;if(we)if(Array.isArray(we))for(let Ie=0;Ie<we.length;Ie++){const Ue=we[Ie];$e(Ue,te,X),ie.add(Ue)}else $e(we,te,X),ie.add(we)}),b.pop(),d=null,ie},this.compileAsync=function(A,k,te=null){const ie=this.compile(A,k,te);return new Promise(X=>{function we(){if(ie.forEach(function(Ie){K.get(Ie).currentProgram.isReady()&&ie.delete(Ie)}),ie.size===0){X(A);return}setTimeout(we,10)}L.get("KHR_parallel_shader_compile")!==null?we():setTimeout(we,10)})};let Qe=null;function dt(A){Qe&&Qe(A)}function bt(){At.stop()}function Zt(){At.start()}const At=new Nd;At.setAnimationLoop(dt),typeof self<"u"&&At.setContext(self),this.setAnimationLoop=function(A){Qe=A,ee.setAnimationLoop(A),A===null?At.stop():At.start()},ee.addEventListener("sessionstart",bt),ee.addEventListener("sessionend",Zt),this.render=function(A,k){if(k!==void 0&&k.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),ee.enabled===!0&&ee.isPresenting===!0&&(ee.cameraAutoUpdate===!0&&ee.updateCamera(k),k=ee.getCamera()),A.isScene===!0&&A.onBeforeRender(y,A,k,R),d=Ae.get(A,b.length),d.init(k),b.push(d),O.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),Oe.setFromProjectionMatrix(O),de=this.localClippingEnabled,ae=fe.init(this.clippingPlanes,de),M=pe.get(A,m.length),M.init(),m.push(M),ee.enabled===!0&&ee.isPresenting===!0){const we=y.xr.getDepthSensingMesh();we!==null&&Ti(we,k,-1/0,y.sortObjects)}Ti(A,k,0,y.sortObjects),M.finish(),y.sortObjects===!0&&M.sort(W,me),Se=ee.enabled===!1||ee.isPresenting===!1||ee.hasDepthSensing()===!1,Se&&Pe.addToRenderList(M,A),this.info.render.frame++,ae===!0&&fe.beginShadows();const te=d.state.shadowsArray;ve.render(te,A,k),ae===!0&&fe.endShadows(),this.info.autoReset===!0&&this.info.reset();const ie=M.opaque,X=M.transmissive;if(d.setupLights(),k.isArrayCamera){const we=k.cameras;if(X.length>0)for(let Ie=0,Ue=we.length;Ie<Ue;Ie++){const Ne=we[Ie];$c(ie,X,A,Ne)}Se&&Pe.render(A);for(let Ie=0,Ue=we.length;Ie<Ue;Ie++){const Ne=we[Ie];Yc(M,A,Ne,Ne.viewport)}}else X.length>0&&$c(ie,X,A,k),Se&&Pe.render(A),Yc(M,A,k);R!==null&&(S.updateMultisampleRenderTarget(R),S.updateRenderTargetMipmap(R)),A.isScene===!0&&A.onAfterRender(y,A,k),Fe.resetDefaultState(),I=-1,ne=null,b.pop(),b.length>0?(d=b[b.length-1],ae===!0&&fe.setGlobalState(y.clippingPlanes,d.state.camera)):d=null,m.pop(),m.length>0?M=m[m.length-1]:M=null};function Ti(A,k,te,ie){if(A.visible===!1)return;if(A.layers.test(k.layers)){if(A.isGroup)te=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(k);else if(A.isLight)d.pushLight(A),A.castShadow&&d.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Oe.intersectsSprite(A)){ie&&oe.setFromMatrixPosition(A.matrixWorld).applyMatrix4(O);const Ie=z.update(A),Ue=A.material;Ue.visible&&M.push(A,Ie,Ue,te,oe.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Oe.intersectsObject(A))){const Ie=z.update(A),Ue=A.material;if(ie&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),oe.copy(A.boundingSphere.center)):(Ie.boundingSphere===null&&Ie.computeBoundingSphere(),oe.copy(Ie.boundingSphere.center)),oe.applyMatrix4(A.matrixWorld).applyMatrix4(O)),Array.isArray(Ue)){const Ne=Ie.groups;for(let ke=0,Xe=Ne.length;ke<Xe;ke++){const Be=Ne[ke],rt=Ue[Be.materialIndex];rt&&rt.visible&&M.push(A,Ie,rt,te,oe.z,Be)}}else Ue.visible&&M.push(A,Ie,Ue,te,oe.z,null)}}const we=A.children;for(let Ie=0,Ue=we.length;Ie<Ue;Ie++)Ti(we[Ie],k,te,ie)}function Yc(A,k,te,ie){const X=A.opaque,we=A.transmissive,Ie=A.transparent;d.setupLightsView(te),ae===!0&&fe.setGlobalState(y.clippingPlanes,te),ie&&U.viewport(x.copy(ie)),X.length>0&&kr(X,k,te),we.length>0&&kr(we,k,te),Ie.length>0&&kr(Ie,k,te),U.buffers.depth.setTest(!0),U.buffers.depth.setMask(!0),U.buffers.color.setMask(!0),U.setPolygonOffset(!1)}function $c(A,k,te,ie){if((te.isScene===!0?te.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[ie.id]===void 0&&(d.state.transmissionRenderTarget[ie.id]=new Xi(1,1,{generateMipmaps:!0,type:L.has("EXT_color_buffer_half_float")||L.has("EXT_color_buffer_float")?Lr:ei,minFilter:Gi,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:it.workingColorSpace}));const we=d.state.transmissionRenderTarget[ie.id],Ie=ie.viewport||x;we.setSize(Ie.z,Ie.w);const Ue=y.getRenderTarget();y.setRenderTarget(we),y.getClearColor(q),Z=y.getClearAlpha(),Z<1&&y.setClearColor(16777215,.5),y.clear(),Se&&Pe.render(te);const Ne=y.toneMapping;y.toneMapping=gi;const ke=ie.viewport;if(ie.viewport!==void 0&&(ie.viewport=void 0),d.setupLightsView(ie),ae===!0&&fe.setGlobalState(y.clippingPlanes,ie),kr(A,te,ie),S.updateMultisampleRenderTarget(we),S.updateRenderTargetMipmap(we),L.has("WEBGL_multisampled_render_to_texture")===!1){let Xe=!1;for(let Be=0,rt=k.length;Be<rt;Be++){const pt=k[Be],yt=pt.object,en=pt.geometry,et=pt.material,ze=pt.group;if(et.side===ht&&yt.layers.test(ie.layers)){const Ut=et.side;et.side=Qt,et.needsUpdate=!0,Kc(yt,te,ie,en,et,ze),et.side=Ut,et.needsUpdate=!0,Xe=!0}}Xe===!0&&(S.updateMultisampleRenderTarget(we),S.updateRenderTargetMipmap(we))}y.setRenderTarget(Ue),y.setClearColor(q,Z),ke!==void 0&&(ie.viewport=ke),y.toneMapping=Ne}function kr(A,k,te){const ie=k.isScene===!0?k.overrideMaterial:null;for(let X=0,we=A.length;X<we;X++){const Ie=A[X],Ue=Ie.object,Ne=Ie.geometry,ke=ie===null?Ie.material:ie,Xe=Ie.group;Ue.layers.test(te.layers)&&Kc(Ue,k,te,Ne,ke,Xe)}}function Kc(A,k,te,ie,X,we){A.onBeforeRender(y,k,te,ie,X,we),A.modelViewMatrix.multiplyMatrices(te.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),X.onBeforeRender(y,k,te,ie,A,we),X.transparent===!0&&X.side===ht&&X.forceSinglePass===!1?(X.side=Qt,X.needsUpdate=!0,y.renderBufferDirect(te,k,ie,X,A,we),X.side=vi,X.needsUpdate=!0,y.renderBufferDirect(te,k,ie,X,A,we),X.side=ht):y.renderBufferDirect(te,k,ie,X,A,we),A.onAfterRender(y,k,te,ie,X,we)}function Wr(A,k,te){k.isScene!==!0&&(k=ue);const ie=K.get(A),X=d.state.lights,we=d.state.shadowsArray,Ie=X.state.version,Ue=he.getParameters(A,X.state,we,k,te),Ne=he.getProgramCacheKey(Ue);let ke=ie.programs;ie.environment=A.isMeshStandardMaterial?k.environment:null,ie.fog=k.fog,ie.envMap=(A.isMeshStandardMaterial?C:v).get(A.envMap||ie.environment),ie.envMapRotation=ie.environment!==null&&A.envMap===null?k.environmentRotation:A.envMapRotation,ke===void 0&&(A.addEventListener("dispose",Ve),ke=new Map,ie.programs=ke);let Xe=ke.get(Ne);if(Xe!==void 0){if(ie.currentProgram===Xe&&ie.lightsStateVersion===Ie)return Zc(A,Ue),Xe}else Ue.uniforms=he.getUniforms(A),A.onBeforeCompile(Ue,y),Xe=he.acquireProgram(Ue,Ne),ke.set(Ne,Xe),ie.uniforms=Ue.uniforms;const Be=ie.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(Be.clippingPlanes=fe.uniform),Zc(A,Ue),ie.needsLights=ep(A),ie.lightsStateVersion=Ie,ie.needsLights&&(Be.ambientLightColor.value=X.state.ambient,Be.lightProbe.value=X.state.probe,Be.directionalLights.value=X.state.directional,Be.directionalLightShadows.value=X.state.directionalShadow,Be.spotLights.value=X.state.spot,Be.spotLightShadows.value=X.state.spotShadow,Be.rectAreaLights.value=X.state.rectArea,Be.ltc_1.value=X.state.rectAreaLTC1,Be.ltc_2.value=X.state.rectAreaLTC2,Be.pointLights.value=X.state.point,Be.pointLightShadows.value=X.state.pointShadow,Be.hemisphereLights.value=X.state.hemi,Be.directionalShadowMap.value=X.state.directionalShadowMap,Be.directionalShadowMatrix.value=X.state.directionalShadowMatrix,Be.spotShadowMap.value=X.state.spotShadowMap,Be.spotLightMatrix.value=X.state.spotLightMatrix,Be.spotLightMap.value=X.state.spotLightMap,Be.pointShadowMap.value=X.state.pointShadowMap,Be.pointShadowMatrix.value=X.state.pointShadowMatrix),ie.currentProgram=Xe,ie.uniformsList=null,Xe}function jc(A){if(A.uniformsList===null){const k=A.currentProgram.getUniforms();A.uniformsList=Lo.seqWithValue(k.seq,A.uniforms)}return A.uniformsList}function Zc(A,k){const te=K.get(A);te.outputColorSpace=k.outputColorSpace,te.batching=k.batching,te.batchingColor=k.batchingColor,te.instancing=k.instancing,te.instancingColor=k.instancingColor,te.instancingMorph=k.instancingMorph,te.skinning=k.skinning,te.morphTargets=k.morphTargets,te.morphNormals=k.morphNormals,te.morphColors=k.morphColors,te.morphTargetsCount=k.morphTargetsCount,te.numClippingPlanes=k.numClippingPlanes,te.numIntersection=k.numClipIntersection,te.vertexAlphas=k.vertexAlphas,te.vertexTangents=k.vertexTangents,te.toneMapping=k.toneMapping}function Jd(A,k,te,ie,X){k.isScene!==!0&&(k=ue),S.resetTextureUnits();const we=k.fog,Ie=ie.isMeshStandardMaterial?k.environment:null,Ue=R===null?y.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:wi,Ne=(ie.isMeshStandardMaterial?C:v).get(ie.envMap||Ie),ke=ie.vertexColors===!0&&!!te.attributes.color&&te.attributes.color.itemSize===4,Xe=!!te.attributes.tangent&&(!!ie.normalMap||ie.anisotropy>0),Be=!!te.morphAttributes.position,rt=!!te.morphAttributes.normal,pt=!!te.morphAttributes.color;let yt=gi;ie.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(yt=y.toneMapping);const en=te.morphAttributes.position||te.morphAttributes.normal||te.morphAttributes.color,et=en!==void 0?en.length:0,ze=K.get(ie),Ut=d.state.lights;if(ae===!0&&(de===!0||A!==ne)){const un=A===ne&&ie.id===I;fe.setState(ie,A,un)}let tt=!1;ie.version===ze.__version?(ze.needsLights&&ze.lightsStateVersion!==Ut.state.version||ze.outputColorSpace!==Ue||X.isBatchedMesh&&ze.batching===!1||!X.isBatchedMesh&&ze.batching===!0||X.isBatchedMesh&&ze.batchingColor===!0&&X.colorTexture===null||X.isBatchedMesh&&ze.batchingColor===!1&&X.colorTexture!==null||X.isInstancedMesh&&ze.instancing===!1||!X.isInstancedMesh&&ze.instancing===!0||X.isSkinnedMesh&&ze.skinning===!1||!X.isSkinnedMesh&&ze.skinning===!0||X.isInstancedMesh&&ze.instancingColor===!0&&X.instanceColor===null||X.isInstancedMesh&&ze.instancingColor===!1&&X.instanceColor!==null||X.isInstancedMesh&&ze.instancingMorph===!0&&X.morphTexture===null||X.isInstancedMesh&&ze.instancingMorph===!1&&X.morphTexture!==null||ze.envMap!==Ne||ie.fog===!0&&ze.fog!==we||ze.numClippingPlanes!==void 0&&(ze.numClippingPlanes!==fe.numPlanes||ze.numIntersection!==fe.numIntersection)||ze.vertexAlphas!==ke||ze.vertexTangents!==Xe||ze.morphTargets!==Be||ze.morphNormals!==rt||ze.morphColors!==pt||ze.toneMapping!==yt||ze.morphTargetsCount!==et)&&(tt=!0):(tt=!0,ze.__version=ie.version);let _n=ze.currentProgram;tt===!0&&(_n=Wr(ie,k,X));let Zi=!1,tn=!1,aa=!1;const St=_n.getUniforms(),ni=ze.uniforms;if(U.useProgram(_n.program)&&(Zi=!0,tn=!0,aa=!0),ie.id!==I&&(I=ie.id,tn=!0),Zi||ne!==A){D.reverseDepthBuffer?(xe.copy(A.projectionMatrix),B_(xe),z_(xe),St.setValue(g,"projectionMatrix",xe)):St.setValue(g,"projectionMatrix",A.projectionMatrix),St.setValue(g,"viewMatrix",A.matrixWorldInverse);const un=St.map.cameraPosition;un!==void 0&&un.setValue(g,le.setFromMatrixPosition(A.matrixWorld)),D.logarithmicDepthBuffer&&St.setValue(g,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(ie.isMeshPhongMaterial||ie.isMeshToonMaterial||ie.isMeshLambertMaterial||ie.isMeshBasicMaterial||ie.isMeshStandardMaterial||ie.isShaderMaterial)&&St.setValue(g,"isOrthographic",A.isOrthographicCamera===!0),ne!==A&&(ne=A,tn=!0,aa=!0)}if(X.isSkinnedMesh){St.setOptional(g,X,"bindMatrix"),St.setOptional(g,X,"bindMatrixInverse");const un=X.skeleton;un&&(un.boneTexture===null&&un.computeBoneTexture(),St.setValue(g,"boneTexture",un.boneTexture,S))}X.isBatchedMesh&&(St.setOptional(g,X,"batchingTexture"),St.setValue(g,"batchingTexture",X._matricesTexture,S),St.setOptional(g,X,"batchingIdTexture"),St.setValue(g,"batchingIdTexture",X._indirectTexture,S),St.setOptional(g,X,"batchingColorTexture"),X._colorsTexture!==null&&St.setValue(g,"batchingColorTexture",X._colorsTexture,S));const la=te.morphAttributes;if((la.position!==void 0||la.normal!==void 0||la.color!==void 0)&&Te.update(X,te,_n),(tn||ze.receiveShadow!==X.receiveShadow)&&(ze.receiveShadow=X.receiveShadow,St.setValue(g,"receiveShadow",X.receiveShadow)),ie.isMeshGouraudMaterial&&ie.envMap!==null&&(ni.envMap.value=Ne,ni.flipEnvMap.value=Ne.isCubeTexture&&Ne.isRenderTargetTexture===!1?-1:1),ie.isMeshStandardMaterial&&ie.envMap===null&&k.environment!==null&&(ni.envMapIntensity.value=k.environmentIntensity),tn&&(St.setValue(g,"toneMappingExposure",y.toneMappingExposure),ze.needsLights&&Qd(ni,aa),we&&ie.fog===!0&&ce.refreshFogUniforms(ni,we),ce.refreshMaterialUniforms(ni,ie,J,G,d.state.transmissionRenderTarget[A.id]),Lo.upload(g,jc(ze),ni,S)),ie.isShaderMaterial&&ie.uniformsNeedUpdate===!0&&(Lo.upload(g,jc(ze),ni,S),ie.uniformsNeedUpdate=!1),ie.isSpriteMaterial&&St.setValue(g,"center",X.center),St.setValue(g,"modelViewMatrix",X.modelViewMatrix),St.setValue(g,"normalMatrix",X.normalMatrix),St.setValue(g,"modelMatrix",X.matrixWorld),ie.isShaderMaterial||ie.isRawShaderMaterial){const un=ie.uniformsGroups;for(let ca=0,tp=un.length;ca<tp;ca++){const Jc=un[ca];F.update(Jc,_n),F.bind(Jc,_n)}}return _n}function Qd(A,k){A.ambientLightColor.needsUpdate=k,A.lightProbe.needsUpdate=k,A.directionalLights.needsUpdate=k,A.directionalLightShadows.needsUpdate=k,A.pointLights.needsUpdate=k,A.pointLightShadows.needsUpdate=k,A.spotLights.needsUpdate=k,A.spotLightShadows.needsUpdate=k,A.rectAreaLights.needsUpdate=k,A.hemisphereLights.needsUpdate=k}function ep(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return N},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(A,k,te){K.get(A.texture).__webglTexture=k,K.get(A.depthTexture).__webglTexture=te;const ie=K.get(A);ie.__hasExternalTextures=!0,ie.__autoAllocateDepthBuffer=te===void 0,ie.__autoAllocateDepthBuffer||L.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),ie.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(A,k){const te=K.get(A);te.__webglFramebuffer=k,te.__useDefaultFramebuffer=k===void 0},this.setRenderTarget=function(A,k=0,te=0){R=A,N=k,P=te;let ie=!0,X=null,we=!1,Ie=!1;if(A){const Ne=K.get(A);if(Ne.__useDefaultFramebuffer!==void 0)U.bindFramebuffer(g.FRAMEBUFFER,null),ie=!1;else if(Ne.__webglFramebuffer===void 0)S.setupRenderTarget(A);else if(Ne.__hasExternalTextures)S.rebindTextures(A,K.get(A.texture).__webglTexture,K.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const Be=A.depthTexture;if(Ne.__boundDepthTexture!==Be){if(Be!==null&&K.has(Be)&&(A.width!==Be.image.width||A.height!==Be.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");S.setupDepthRenderbuffer(A)}}const ke=A.texture;(ke.isData3DTexture||ke.isDataArrayTexture||ke.isCompressedArrayTexture)&&(Ie=!0);const Xe=K.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray(Xe[k])?X=Xe[k][te]:X=Xe[k],we=!0):A.samples>0&&S.useMultisampledRTT(A)===!1?X=K.get(A).__webglMultisampledFramebuffer:Array.isArray(Xe)?X=Xe[te]:X=Xe,x.copy(A.viewport),w.copy(A.scissor),$=A.scissorTest}else x.copy(_e).multiplyScalar(J).floor(),w.copy(ge).multiplyScalar(J).floor(),$=Le;if(U.bindFramebuffer(g.FRAMEBUFFER,X)&&ie&&U.drawBuffers(A,X),U.viewport(x),U.scissor(w),U.setScissorTest($),we){const Ne=K.get(A.texture);g.framebufferTexture2D(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_CUBE_MAP_POSITIVE_X+k,Ne.__webglTexture,te)}else if(Ie){const Ne=K.get(A.texture),ke=k||0;g.framebufferTextureLayer(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,Ne.__webglTexture,te||0,ke)}I=-1},this.readRenderTargetPixels=function(A,k,te,ie,X,we,Ie){if(!(A&&A.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ue=K.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Ie!==void 0&&(Ue=Ue[Ie]),Ue){U.bindFramebuffer(g.FRAMEBUFFER,Ue);try{const Ne=A.texture,ke=Ne.format,Xe=Ne.type;if(!D.textureFormatReadable(ke)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!D.textureTypeReadable(Xe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=A.width-ie&&te>=0&&te<=A.height-X&&g.readPixels(k,te,ie,X,De.convert(ke),De.convert(Xe),we)}finally{const Ne=R!==null?K.get(R).__webglFramebuffer:null;U.bindFramebuffer(g.FRAMEBUFFER,Ne)}}},this.readRenderTargetPixelsAsync=async function(A,k,te,ie,X,we,Ie){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ue=K.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Ie!==void 0&&(Ue=Ue[Ie]),Ue){const Ne=A.texture,ke=Ne.format,Xe=Ne.type;if(!D.textureFormatReadable(ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!D.textureTypeReadable(Xe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(k>=0&&k<=A.width-ie&&te>=0&&te<=A.height-X){U.bindFramebuffer(g.FRAMEBUFFER,Ue);const Be=g.createBuffer();g.bindBuffer(g.PIXEL_PACK_BUFFER,Be),g.bufferData(g.PIXEL_PACK_BUFFER,we.byteLength,g.STREAM_READ),g.readPixels(k,te,ie,X,De.convert(ke),De.convert(Xe),0);const rt=R!==null?K.get(R).__webglFramebuffer:null;U.bindFramebuffer(g.FRAMEBUFFER,rt);const pt=g.fenceSync(g.SYNC_GPU_COMMANDS_COMPLETE,0);return g.flush(),await F_(g,pt,4),g.bindBuffer(g.PIXEL_PACK_BUFFER,Be),g.getBufferSubData(g.PIXEL_PACK_BUFFER,0,we),g.deleteBuffer(Be),g.deleteSync(pt),we}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(A,k=null,te=0){A.isTexture!==!0&&(Po("WebGLRenderer: copyFramebufferToTexture function signature has changed."),k=arguments[0]||null,A=arguments[1]);const ie=Math.pow(2,-te),X=Math.floor(A.image.width*ie),we=Math.floor(A.image.height*ie),Ie=k!==null?k.x:0,Ue=k!==null?k.y:0;S.setTexture2D(A,0),g.copyTexSubImage2D(g.TEXTURE_2D,te,0,0,Ie,Ue,X,we),U.unbindTexture()},this.copyTextureToTexture=function(A,k,te=null,ie=null,X=0){A.isTexture!==!0&&(Po("WebGLRenderer: copyTextureToTexture function signature has changed."),ie=arguments[0]||null,A=arguments[1],k=arguments[2],X=arguments[3]||0,te=null);let we,Ie,Ue,Ne,ke,Xe;te!==null?(we=te.max.x-te.min.x,Ie=te.max.y-te.min.y,Ue=te.min.x,Ne=te.min.y):(we=A.image.width,Ie=A.image.height,Ue=0,Ne=0),ie!==null?(ke=ie.x,Xe=ie.y):(ke=0,Xe=0);const Be=De.convert(k.format),rt=De.convert(k.type);S.setTexture2D(k,0),g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,k.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,k.unpackAlignment);const pt=g.getParameter(g.UNPACK_ROW_LENGTH),yt=g.getParameter(g.UNPACK_IMAGE_HEIGHT),en=g.getParameter(g.UNPACK_SKIP_PIXELS),et=g.getParameter(g.UNPACK_SKIP_ROWS),ze=g.getParameter(g.UNPACK_SKIP_IMAGES),Ut=A.isCompressedTexture?A.mipmaps[X]:A.image;g.pixelStorei(g.UNPACK_ROW_LENGTH,Ut.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,Ut.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Ue),g.pixelStorei(g.UNPACK_SKIP_ROWS,Ne),A.isDataTexture?g.texSubImage2D(g.TEXTURE_2D,X,ke,Xe,we,Ie,Be,rt,Ut.data):A.isCompressedTexture?g.compressedTexSubImage2D(g.TEXTURE_2D,X,ke,Xe,Ut.width,Ut.height,Be,Ut.data):g.texSubImage2D(g.TEXTURE_2D,X,ke,Xe,we,Ie,Be,rt,Ut),g.pixelStorei(g.UNPACK_ROW_LENGTH,pt),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,yt),g.pixelStorei(g.UNPACK_SKIP_PIXELS,en),g.pixelStorei(g.UNPACK_SKIP_ROWS,et),g.pixelStorei(g.UNPACK_SKIP_IMAGES,ze),X===0&&k.generateMipmaps&&g.generateMipmap(g.TEXTURE_2D),U.unbindTexture()},this.copyTextureToTexture3D=function(A,k,te=null,ie=null,X=0){A.isTexture!==!0&&(Po("WebGLRenderer: copyTextureToTexture3D function signature has changed."),te=arguments[0]||null,ie=arguments[1]||null,A=arguments[2],k=arguments[3],X=arguments[4]||0);let we,Ie,Ue,Ne,ke,Xe,Be,rt,pt;const yt=A.isCompressedTexture?A.mipmaps[X]:A.image;te!==null?(we=te.max.x-te.min.x,Ie=te.max.y-te.min.y,Ue=te.max.z-te.min.z,Ne=te.min.x,ke=te.min.y,Xe=te.min.z):(we=yt.width,Ie=yt.height,Ue=yt.depth,Ne=0,ke=0,Xe=0),ie!==null?(Be=ie.x,rt=ie.y,pt=ie.z):(Be=0,rt=0,pt=0);const en=De.convert(k.format),et=De.convert(k.type);let ze;if(k.isData3DTexture)S.setTexture3D(k,0),ze=g.TEXTURE_3D;else if(k.isDataArrayTexture||k.isCompressedArrayTexture)S.setTexture2DArray(k,0),ze=g.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,k.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,k.unpackAlignment);const Ut=g.getParameter(g.UNPACK_ROW_LENGTH),tt=g.getParameter(g.UNPACK_IMAGE_HEIGHT),_n=g.getParameter(g.UNPACK_SKIP_PIXELS),Zi=g.getParameter(g.UNPACK_SKIP_ROWS),tn=g.getParameter(g.UNPACK_SKIP_IMAGES);g.pixelStorei(g.UNPACK_ROW_LENGTH,yt.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,yt.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Ne),g.pixelStorei(g.UNPACK_SKIP_ROWS,ke),g.pixelStorei(g.UNPACK_SKIP_IMAGES,Xe),A.isDataTexture||A.isData3DTexture?g.texSubImage3D(ze,X,Be,rt,pt,we,Ie,Ue,en,et,yt.data):k.isCompressedArrayTexture?g.compressedTexSubImage3D(ze,X,Be,rt,pt,we,Ie,Ue,en,yt.data):g.texSubImage3D(ze,X,Be,rt,pt,we,Ie,Ue,en,et,yt),g.pixelStorei(g.UNPACK_ROW_LENGTH,Ut),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,tt),g.pixelStorei(g.UNPACK_SKIP_PIXELS,_n),g.pixelStorei(g.UNPACK_SKIP_ROWS,Zi),g.pixelStorei(g.UNPACK_SKIP_IMAGES,tn),X===0&&k.generateMipmaps&&g.generateMipmap(ze),U.unbindTexture()},this.initRenderTarget=function(A){K.get(A).__webglFramebuffer===void 0&&S.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?S.setTextureCube(A,0):A.isData3DTexture?S.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?S.setTexture2DArray(A,0):S.setTexture2D(A,0),U.unbindTexture()},this.resetState=function(){N=0,P=0,R=null,U.reset(),Fe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return jn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Bc?"display-p3":"srgb",t.unpackColorSpace=it.workingColorSpace===ia?"display-p3":"srgb"}}class Or extends kt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new On,this.environmentIntensity=1,this.environmentRotation=new On,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(t.object.environmentIntensity=this.environmentIntensity),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class Fn{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,t){const i=this.getUtoTmapping(e);return this.getPoint(i,t)}getPoints(e=5){const t=[];for(let i=0;i<=e;i++)t.push(this.getPoint(i/e));return t}getSpacedPoints(e=5){const t=[];for(let i=0;i<=e;i++)t.push(this.getPointAt(i/e));return t}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const t=[];let i,s=this.getPoint(0),r=0;t.push(0);for(let o=1;o<=e;o++)i=this.getPoint(o/e),r+=i.distanceTo(s),t.push(r),s=i;return this.cacheArcLengths=t,t}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,t){const i=this.getLengths();let s=0;const r=i.length;let o;t?o=t:o=e*i[r-1];let a=0,l=r-1,c;for(;a<=l;)if(s=Math.floor(a+(l-a)/2),c=i[s]-o,c<0)a=s+1;else if(c>0)l=s-1;else{l=s;break}if(s=l,i[s]===o)return s/(r-1);const h=i[s],f=i[s+1]-h,p=(o-h)/f;return(s+p)/(r-1)}getTangent(e,t){let s=e-1e-4,r=e+1e-4;s<0&&(s=0),r>1&&(r=1);const o=this.getPoint(s),a=this.getPoint(r),l=t||(o.isVector2?new Ce:new H);return l.copy(a).sub(o).normalize(),l}getTangentAt(e,t){const i=this.getUtoTmapping(e);return this.getTangent(i,t)}computeFrenetFrames(e,t){const i=new H,s=[],r=[],o=[],a=new H,l=new vt;for(let p=0;p<=e;p++){const _=p/e;s[p]=this.getTangentAt(_,new H)}r[0]=new H,o[0]=new H;let c=Number.MAX_VALUE;const h=Math.abs(s[0].x),u=Math.abs(s[0].y),f=Math.abs(s[0].z);h<=c&&(c=h,i.set(1,0,0)),u<=c&&(c=u,i.set(0,1,0)),f<=c&&i.set(0,0,1),a.crossVectors(s[0],i).normalize(),r[0].crossVectors(s[0],a),o[0].crossVectors(s[0],r[0]);for(let p=1;p<=e;p++){if(r[p]=r[p-1].clone(),o[p]=o[p-1].clone(),a.crossVectors(s[p-1],s[p]),a.length()>Number.EPSILON){a.normalize();const _=Math.acos(Lt(s[p-1].dot(s[p]),-1,1));r[p].applyMatrix4(l.makeRotationAxis(a,_))}o[p].crossVectors(s[p],r[p])}if(t===!0){let p=Math.acos(Lt(r[0].dot(r[e]),-1,1));p/=e,s[0].dot(a.crossVectors(r[0],r[e]))>0&&(p=-p);for(let _=1;_<=e;_++)r[_].applyMatrix4(l.makeRotationAxis(s[_],p*_)),o[_].crossVectors(s[_],r[_])}return{tangents:s,normals:r,binormals:o}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}class kc extends Fn{constructor(e=0,t=0,i=1,s=1,r=0,o=Math.PI*2,a=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=e,this.aY=t,this.xRadius=i,this.yRadius=s,this.aStartAngle=r,this.aEndAngle=o,this.aClockwise=a,this.aRotation=l}getPoint(e,t=new Ce){const i=t,s=Math.PI*2;let r=this.aEndAngle-this.aStartAngle;const o=Math.abs(r)<Number.EPSILON;for(;r<0;)r+=s;for(;r>s;)r-=s;r<Number.EPSILON&&(o?r=0:r=s),this.aClockwise===!0&&!o&&(r===s?r=-s:r=r-s);const a=this.aStartAngle+e*r;let l=this.aX+this.xRadius*Math.cos(a),c=this.aY+this.yRadius*Math.sin(a);if(this.aRotation!==0){const h=Math.cos(this.aRotation),u=Math.sin(this.aRotation),f=l-this.aX,p=c-this.aY;l=f*h-p*u+this.aX,c=f*u+p*h+this.aY}return i.set(l,c)}copy(e){return super.copy(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}toJSON(){const e=super.toJSON();return e.aX=this.aX,e.aY=this.aY,e.xRadius=this.xRadius,e.yRadius=this.yRadius,e.aStartAngle=this.aStartAngle,e.aEndAngle=this.aEndAngle,e.aClockwise=this.aClockwise,e.aRotation=this.aRotation,e}fromJSON(e){return super.fromJSON(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}}class jS extends kc{constructor(e,t,i,s,r,o){super(e,t,i,i,s,r,o),this.isArcCurve=!0,this.type="ArcCurve"}}function Wc(){let n=0,e=0,t=0,i=0;function s(r,o,a,l){n=r,e=a,t=-3*r+3*o-2*a-l,i=2*r-2*o+a+l}return{initCatmullRom:function(r,o,a,l,c){s(o,a,c*(a-r),c*(l-o))},initNonuniformCatmullRom:function(r,o,a,l,c,h,u){let f=(o-r)/c-(a-r)/(c+h)+(a-o)/h,p=(a-o)/h-(l-o)/(h+u)+(l-a)/u;f*=h,p*=h,s(o,a,f,p)},calc:function(r){const o=r*r,a=o*r;return n+e*r+t*o+i*a}}}const xo=new H,Qa=new Wc,el=new Wc,tl=new Wc;class ZS extends Fn{constructor(e=[],t=!1,i="centripetal",s=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=t,this.curveType=i,this.tension=s}getPoint(e,t=new H){const i=t,s=this.points,r=s.length,o=(r-(this.closed?0:1))*e;let a=Math.floor(o),l=o-a;this.closed?a+=a>0?0:(Math.floor(Math.abs(a)/r)+1)*r:l===0&&a===r-1&&(a=r-2,l=1);let c,h;this.closed||a>0?c=s[(a-1)%r]:(xo.subVectors(s[0],s[1]).add(s[0]),c=xo);const u=s[a%r],f=s[(a+1)%r];if(this.closed||a+2<r?h=s[(a+2)%r]:(xo.subVectors(s[r-1],s[r-2]).add(s[r-1]),h=xo),this.curveType==="centripetal"||this.curveType==="chordal"){const p=this.curveType==="chordal"?.5:.25;let _=Math.pow(c.distanceToSquared(u),p),M=Math.pow(u.distanceToSquared(f),p),d=Math.pow(f.distanceToSquared(h),p);M<1e-4&&(M=1),_<1e-4&&(_=M),d<1e-4&&(d=M),Qa.initNonuniformCatmullRom(c.x,u.x,f.x,h.x,_,M,d),el.initNonuniformCatmullRom(c.y,u.y,f.y,h.y,_,M,d),tl.initNonuniformCatmullRom(c.z,u.z,f.z,h.z,_,M,d)}else this.curveType==="catmullrom"&&(Qa.initCatmullRom(c.x,u.x,f.x,h.x,this.tension),el.initCatmullRom(c.y,u.y,f.y,h.y,this.tension),tl.initCatmullRom(c.z,u.z,f.z,h.z,this.tension));return i.set(Qa.calc(l),el.calc(l),tl.calc(l)),i}copy(e){super.copy(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const s=e.points[t];this.points.push(s.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,i=this.points.length;t<i;t++){const s=this.points[t];e.points.push(s.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const s=e.points[t];this.points.push(new H().fromArray(s))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}function kh(n,e,t,i,s){const r=(i-e)*.5,o=(s-t)*.5,a=n*n,l=n*a;return(2*t-2*i+r+o)*l+(-3*t+3*i-2*r-o)*a+r*n+t}function JS(n,e){const t=1-n;return t*t*e}function QS(n,e){return 2*(1-n)*n*e}function eE(n,e){return n*n*e}function dr(n,e,t,i){return JS(n,e)+QS(n,t)+eE(n,i)}function tE(n,e){const t=1-n;return t*t*t*e}function nE(n,e){const t=1-n;return 3*t*t*n*e}function iE(n,e){return 3*(1-n)*n*n*e}function sE(n,e){return n*n*n*e}function pr(n,e,t,i,s){return tE(n,e)+nE(n,t)+iE(n,i)+sE(n,s)}class Vd extends Fn{constructor(e=new Ce,t=new Ce,i=new Ce,s=new Ce){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=e,this.v1=t,this.v2=i,this.v3=s}getPoint(e,t=new Ce){const i=t,s=this.v0,r=this.v1,o=this.v2,a=this.v3;return i.set(pr(e,s.x,r.x,o.x,a.x),pr(e,s.y,r.y,o.y,a.y)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class rE extends Fn{constructor(e=new H,t=new H,i=new H,s=new H){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=e,this.v1=t,this.v2=i,this.v3=s}getPoint(e,t=new H){const i=t,s=this.v0,r=this.v1,o=this.v2,a=this.v3;return i.set(pr(e,s.x,r.x,o.x,a.x),pr(e,s.y,r.y,o.y,a.y),pr(e,s.z,r.z,o.z,a.z)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class kd extends Fn{constructor(e=new Ce,t=new Ce){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=e,this.v2=t}getPoint(e,t=new Ce){const i=t;return e===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(e).add(this.v1)),i}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new Ce){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class oE extends Fn{constructor(e=new H,t=new H){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=e,this.v2=t}getPoint(e,t=new H){const i=t;return e===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(e).add(this.v1)),i}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new H){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Wd extends Fn{constructor(e=new Ce,t=new Ce,i=new Ce){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=e,this.v1=t,this.v2=i}getPoint(e,t=new Ce){const i=t,s=this.v0,r=this.v1,o=this.v2;return i.set(dr(e,s.x,r.x,o.x),dr(e,s.y,r.y,o.y)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class aE extends Fn{constructor(e=new H,t=new H,i=new H){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=e,this.v1=t,this.v2=i}getPoint(e,t=new H){const i=t,s=this.v0,r=this.v1,o=this.v2;return i.set(dr(e,s.x,r.x,o.x),dr(e,s.y,r.y,o.y),dr(e,s.z,r.z,o.z)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Xd extends Fn{constructor(e=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=e}getPoint(e,t=new Ce){const i=t,s=this.points,r=(s.length-1)*e,o=Math.floor(r),a=r-o,l=s[o===0?o:o-1],c=s[o],h=s[o>s.length-2?s.length-1:o+1],u=s[o>s.length-3?s.length-1:o+2];return i.set(kh(a,l.x,c.x,h.x,u.x),kh(a,l.y,c.y,h.y,u.y)),i}copy(e){super.copy(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const s=e.points[t];this.points.push(s.clone())}return this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,i=this.points.length;t<i;t++){const s=this.points[t];e.points.push(s.toArray())}return e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const s=e.points[t];this.points.push(new Ce().fromArray(s))}return this}}var ic=Object.freeze({__proto__:null,ArcCurve:jS,CatmullRomCurve3:ZS,CubicBezierCurve:Vd,CubicBezierCurve3:rE,EllipseCurve:kc,LineCurve:kd,LineCurve3:oE,QuadraticBezierCurve:Wd,QuadraticBezierCurve3:aE,SplineCurve:Xd});class lE extends Fn{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(e){this.curves.push(e)}closePath(){const e=this.curves[0].getPoint(0),t=this.curves[this.curves.length-1].getPoint(1);if(!e.equals(t)){const i=e.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new ic[i](t,e))}return this}getPoint(e,t){const i=e*this.getLength(),s=this.getCurveLengths();let r=0;for(;r<s.length;){if(s[r]>=i){const o=s[r]-i,a=this.curves[r],l=a.getLength(),c=l===0?0:1-o/l;return a.getPointAt(c,t)}r++}return null}getLength(){const e=this.getCurveLengths();return e[e.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const e=[];let t=0;for(let i=0,s=this.curves.length;i<s;i++)t+=this.curves[i].getLength(),e.push(t);return this.cacheLengths=e,e}getSpacedPoints(e=40){const t=[];for(let i=0;i<=e;i++)t.push(this.getPoint(i/e));return this.autoClose&&t.push(t[0]),t}getPoints(e=12){const t=[];let i;for(let s=0,r=this.curves;s<r.length;s++){const o=r[s],a=o.isEllipseCurve?e*2:o.isLineCurve||o.isLineCurve3?1:o.isSplineCurve?e*o.points.length:e,l=o.getPoints(a);for(let c=0;c<l.length;c++){const h=l[c];i&&i.equals(h)||(t.push(h),i=h)}}return this.autoClose&&t.length>1&&!t[t.length-1].equals(t[0])&&t.push(t[0]),t}copy(e){super.copy(e),this.curves=[];for(let t=0,i=e.curves.length;t<i;t++){const s=e.curves[t];this.curves.push(s.clone())}return this.autoClose=e.autoClose,this}toJSON(){const e=super.toJSON();e.autoClose=this.autoClose,e.curves=[];for(let t=0,i=this.curves.length;t<i;t++){const s=this.curves[t];e.curves.push(s.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.autoClose=e.autoClose,this.curves=[];for(let t=0,i=e.curves.length;t<i;t++){const s=e.curves[t];this.curves.push(new ic[s.type]().fromJSON(s))}return this}}class sc extends lE{constructor(e){super(),this.type="Path",this.currentPoint=new Ce,e&&this.setFromPoints(e)}setFromPoints(e){this.moveTo(e[0].x,e[0].y);for(let t=1,i=e.length;t<i;t++)this.lineTo(e[t].x,e[t].y);return this}moveTo(e,t){return this.currentPoint.set(e,t),this}lineTo(e,t){const i=new kd(this.currentPoint.clone(),new Ce(e,t));return this.curves.push(i),this.currentPoint.set(e,t),this}quadraticCurveTo(e,t,i,s){const r=new Wd(this.currentPoint.clone(),new Ce(e,t),new Ce(i,s));return this.curves.push(r),this.currentPoint.set(i,s),this}bezierCurveTo(e,t,i,s,r,o){const a=new Vd(this.currentPoint.clone(),new Ce(e,t),new Ce(i,s),new Ce(r,o));return this.curves.push(a),this.currentPoint.set(r,o),this}splineThru(e){const t=[this.currentPoint.clone()].concat(e),i=new Xd(t);return this.curves.push(i),this.currentPoint.copy(e[e.length-1]),this}arc(e,t,i,s,r,o){const a=this.currentPoint.x,l=this.currentPoint.y;return this.absarc(e+a,t+l,i,s,r,o),this}absarc(e,t,i,s,r,o){return this.absellipse(e,t,i,i,s,r,o),this}ellipse(e,t,i,s,r,o,a,l){const c=this.currentPoint.x,h=this.currentPoint.y;return this.absellipse(e+c,t+h,i,s,r,o,a,l),this}absellipse(e,t,i,s,r,o,a,l){const c=new kc(e,t,i,s,r,o,a,l);if(this.curves.length>0){const u=c.getPoint(0);u.equals(this.currentPoint)||this.lineTo(u.x,u.y)}this.curves.push(c);const h=c.getPoint(1);return this.currentPoint.copy(h),this}copy(e){return super.copy(e),this.currentPoint.copy(e.currentPoint),this}toJSON(){const e=super.toJSON();return e.currentPoint=this.currentPoint.toArray(),e}fromJSON(e){return super.fromJSON(e),this.currentPoint.fromArray(e.currentPoint),this}}class Ft extends gn{constructor(e=1,t=32,i=0,s=Math.PI*2){super(),this.type="CircleGeometry",this.parameters={radius:e,segments:t,thetaStart:i,thetaLength:s},t=Math.max(3,t);const r=[],o=[],a=[],l=[],c=new H,h=new Ce;o.push(0,0,0),a.push(0,0,1),l.push(.5,.5);for(let u=0,f=3;u<=t;u++,f+=3){const p=i+u/t*s;c.x=e*Math.cos(p),c.y=e*Math.sin(p),o.push(c.x,c.y,c.z),a.push(0,0,1),h.x=(o[f]/e+1)/2,h.y=(o[f+1]/e+1)/2,l.push(h.x,h.y)}for(let u=1;u<=t;u++)r.push(u,u+1,0);this.setIndex(r),this.setAttribute("position",new Et(o,3)),this.setAttribute("normal",new Et(a,3)),this.setAttribute("uv",new Et(l,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Ft(e.radius,e.segments,e.thetaStart,e.thetaLength)}}class ji extends gn{constructor(e=1,t=1,i=1,s=32,r=1,o=!1,a=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:t,height:i,radialSegments:s,heightSegments:r,openEnded:o,thetaStart:a,thetaLength:l};const c=this;s=Math.floor(s),r=Math.floor(r);const h=[],u=[],f=[],p=[];let _=0;const M=[],d=i/2;let m=0;b(),o===!1&&(e>0&&y(!0),t>0&&y(!1)),this.setIndex(h),this.setAttribute("position",new Et(u,3)),this.setAttribute("normal",new Et(f,3)),this.setAttribute("uv",new Et(p,2));function b(){const E=new H,N=new H;let P=0;const R=(t-e)/i;for(let I=0;I<=r;I++){const ne=[],x=I/r,w=x*(t-e)+e;for(let $=0;$<=s;$++){const q=$/s,Z=q*l+a,re=Math.sin(Z),G=Math.cos(Z);N.x=w*re,N.y=-x*i+d,N.z=w*G,u.push(N.x,N.y,N.z),E.set(re,R,G).normalize(),f.push(E.x,E.y,E.z),p.push(q,1-x),ne.push(_++)}M.push(ne)}for(let I=0;I<s;I++)for(let ne=0;ne<r;ne++){const x=M[ne][I],w=M[ne+1][I],$=M[ne+1][I+1],q=M[ne][I+1];e>0&&(h.push(x,w,q),P+=3),t>0&&(h.push(w,$,q),P+=3)}c.addGroup(m,P,0),m+=P}function y(E){const N=_,P=new Ce,R=new H;let I=0;const ne=E===!0?e:t,x=E===!0?1:-1;for(let $=1;$<=s;$++)u.push(0,d*x,0),f.push(0,x,0),p.push(.5,.5),_++;const w=_;for(let $=0;$<=s;$++){const Z=$/s*l+a,re=Math.cos(Z),G=Math.sin(Z);R.x=ne*G,R.y=d*x,R.z=ne*re,u.push(R.x,R.y,R.z),f.push(0,x,0),P.x=re*.5+.5,P.y=G*.5*x+.5,p.push(P.x,P.y),_++}for(let $=0;$<s;$++){const q=N+$,Z=w+$;E===!0?h.push(Z,Z+1,q):h.push(Z+1,Z,q),I+=3}c.addGroup(m,I,E===!0?1:2),m+=I}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new ji(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class Qn extends sc{constructor(e){super(e),this.uuid=Ki(),this.type="Shape",this.holes=[]}getPointsHoles(e){const t=[];for(let i=0,s=this.holes.length;i<s;i++)t[i]=this.holes[i].getPoints(e);return t}extractPoints(e){return{shape:this.getPoints(e),holes:this.getPointsHoles(e)}}copy(e){super.copy(e),this.holes=[];for(let t=0,i=e.holes.length;t<i;t++){const s=e.holes[t];this.holes.push(s.clone())}return this}toJSON(){const e=super.toJSON();e.uuid=this.uuid,e.holes=[];for(let t=0,i=this.holes.length;t<i;t++){const s=this.holes[t];e.holes.push(s.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.uuid=e.uuid,this.holes=[];for(let t=0,i=e.holes.length;t<i;t++){const s=e.holes[t];this.holes.push(new sc().fromJSON(s))}return this}}const cE={triangulate:function(n,e,t=2){const i=e&&e.length,s=i?e[0]*t:n.length;let r=qd(n,0,s,t,!0);const o=[];if(!r||r.next===r.prev)return o;let a,l,c,h,u,f,p;if(i&&(r=pE(n,e,r,t)),n.length>80*t){a=c=n[0],l=h=n[1];for(let _=t;_<s;_+=t)u=n[_],f=n[_+1],u<a&&(a=u),f<l&&(l=f),u>c&&(c=u),f>h&&(h=f);p=Math.max(c-a,h-l),p=p!==0?32767/p:0}return Tr(r,o,t,a,l,p,0),o}};function qd(n,e,t,i,s){let r,o;if(s===bE(n,e,t,i)>0)for(r=e;r<t;r+=i)o=Wh(r,n[r],n[r+1],o);else for(r=t-i;r>=e;r-=i)o=Wh(r,n[r],n[r+1],o);return o&&oa(o,o.next)&&(Rr(o),o=o.next),o}function qi(n,e){if(!n)return n;e||(e=n);let t=n,i;do if(i=!1,!t.steiner&&(oa(t,t.next)||Mt(t.prev,t,t.next)===0)){if(Rr(t),t=e=t.prev,t===t.next)break;i=!0}else t=t.next;while(i||t!==e);return e}function Tr(n,e,t,i,s,r,o){if(!n)return;!o&&r&&xE(n,i,s,r);let a=n,l,c;for(;n.prev!==n.next;){if(l=n.prev,c=n.next,r?hE(n,i,s,r):uE(n)){e.push(l.i/t|0),e.push(n.i/t|0),e.push(c.i/t|0),Rr(n),n=c.next,a=c.next;continue}if(n=c,n===a){o?o===1?(n=fE(qi(n),e,t),Tr(n,e,t,i,s,r,2)):o===2&&dE(n,e,t,i,s,r):Tr(qi(n),e,t,i,s,r,1);break}}}function uE(n){const e=n.prev,t=n,i=n.next;if(Mt(e,t,i)>=0)return!1;const s=e.x,r=t.x,o=i.x,a=e.y,l=t.y,c=i.y,h=s<r?s<o?s:o:r<o?r:o,u=a<l?a<c?a:c:l<c?l:c,f=s>r?s>o?s:o:r>o?r:o,p=a>l?a>c?a:c:l>c?l:c;let _=i.next;for(;_!==e;){if(_.x>=h&&_.x<=f&&_.y>=u&&_.y<=p&&Ms(s,a,r,l,o,c,_.x,_.y)&&Mt(_.prev,_,_.next)>=0)return!1;_=_.next}return!0}function hE(n,e,t,i){const s=n.prev,r=n,o=n.next;if(Mt(s,r,o)>=0)return!1;const a=s.x,l=r.x,c=o.x,h=s.y,u=r.y,f=o.y,p=a<l?a<c?a:c:l<c?l:c,_=h<u?h<f?h:f:u<f?u:f,M=a>l?a>c?a:c:l>c?l:c,d=h>u?h>f?h:f:u>f?u:f,m=rc(p,_,e,t,i),b=rc(M,d,e,t,i);let y=n.prevZ,E=n.nextZ;for(;y&&y.z>=m&&E&&E.z<=b;){if(y.x>=p&&y.x<=M&&y.y>=_&&y.y<=d&&y!==s&&y!==o&&Ms(a,h,l,u,c,f,y.x,y.y)&&Mt(y.prev,y,y.next)>=0||(y=y.prevZ,E.x>=p&&E.x<=M&&E.y>=_&&E.y<=d&&E!==s&&E!==o&&Ms(a,h,l,u,c,f,E.x,E.y)&&Mt(E.prev,E,E.next)>=0))return!1;E=E.nextZ}for(;y&&y.z>=m;){if(y.x>=p&&y.x<=M&&y.y>=_&&y.y<=d&&y!==s&&y!==o&&Ms(a,h,l,u,c,f,y.x,y.y)&&Mt(y.prev,y,y.next)>=0)return!1;y=y.prevZ}for(;E&&E.z<=b;){if(E.x>=p&&E.x<=M&&E.y>=_&&E.y<=d&&E!==s&&E!==o&&Ms(a,h,l,u,c,f,E.x,E.y)&&Mt(E.prev,E,E.next)>=0)return!1;E=E.nextZ}return!0}function fE(n,e,t){let i=n;do{const s=i.prev,r=i.next.next;!oa(s,r)&&Yd(s,i,i.next,r)&&Ar(s,r)&&Ar(r,s)&&(e.push(s.i/t|0),e.push(i.i/t|0),e.push(r.i/t|0),Rr(i),Rr(i.next),i=n=r),i=i.next}while(i!==n);return qi(i)}function dE(n,e,t,i,s,r){let o=n;do{let a=o.next.next;for(;a!==o.prev;){if(o.i!==a.i&&SE(o,a)){let l=$d(o,a);o=qi(o,o.next),l=qi(l,l.next),Tr(o,e,t,i,s,r,0),Tr(l,e,t,i,s,r,0);return}a=a.next}o=o.next}while(o!==n)}function pE(n,e,t,i){const s=[];let r,o,a,l,c;for(r=0,o=e.length;r<o;r++)a=e[r]*i,l=r<o-1?e[r+1]*i:n.length,c=qd(n,a,l,i,!1),c===c.next&&(c.steiner=!0),s.push(yE(c));for(s.sort(mE),r=0;r<s.length;r++)t=gE(s[r],t);return t}function mE(n,e){return n.x-e.x}function gE(n,e){const t=_E(n,e);if(!t)return e;const i=$d(t,n);return qi(i,i.next),qi(t,t.next)}function _E(n,e){let t=e,i=-1/0,s;const r=n.x,o=n.y;do{if(o<=t.y&&o>=t.next.y&&t.next.y!==t.y){const f=t.x+(o-t.y)*(t.next.x-t.x)/(t.next.y-t.y);if(f<=r&&f>i&&(i=f,s=t.x<t.next.x?t:t.next,f===r))return s}t=t.next}while(t!==e);if(!s)return null;const a=s,l=s.x,c=s.y;let h=1/0,u;t=s;do r>=t.x&&t.x>=l&&r!==t.x&&Ms(o<c?r:i,o,l,c,o<c?i:r,o,t.x,t.y)&&(u=Math.abs(o-t.y)/(r-t.x),Ar(t,n)&&(u<h||u===h&&(t.x>s.x||t.x===s.x&&vE(s,t)))&&(s=t,h=u)),t=t.next;while(t!==a);return s}function vE(n,e){return Mt(n.prev,n,e.prev)<0&&Mt(e.next,n,n.next)<0}function xE(n,e,t,i){let s=n;do s.z===0&&(s.z=rc(s.x,s.y,e,t,i)),s.prevZ=s.prev,s.nextZ=s.next,s=s.next;while(s!==n);s.prevZ.nextZ=null,s.prevZ=null,ME(s)}function ME(n){let e,t,i,s,r,o,a,l,c=1;do{for(t=n,n=null,r=null,o=0;t;){for(o++,i=t,a=0,e=0;e<c&&(a++,i=i.nextZ,!!i);e++);for(l=c;a>0||l>0&&i;)a!==0&&(l===0||!i||t.z<=i.z)?(s=t,t=t.nextZ,a--):(s=i,i=i.nextZ,l--),r?r.nextZ=s:n=s,s.prevZ=r,r=s;t=i}r.nextZ=null,c*=2}while(o>1);return n}function rc(n,e,t,i,s){return n=(n-t)*s|0,e=(e-i)*s|0,n=(n|n<<8)&16711935,n=(n|n<<4)&252645135,n=(n|n<<2)&858993459,n=(n|n<<1)&1431655765,e=(e|e<<8)&16711935,e=(e|e<<4)&252645135,e=(e|e<<2)&858993459,e=(e|e<<1)&1431655765,n|e<<1}function yE(n){let e=n,t=n;do(e.x<t.x||e.x===t.x&&e.y<t.y)&&(t=e),e=e.next;while(e!==n);return t}function Ms(n,e,t,i,s,r,o,a){return(s-o)*(e-a)>=(n-o)*(r-a)&&(n-o)*(i-a)>=(t-o)*(e-a)&&(t-o)*(r-a)>=(s-o)*(i-a)}function SE(n,e){return n.next.i!==e.i&&n.prev.i!==e.i&&!EE(n,e)&&(Ar(n,e)&&Ar(e,n)&&wE(n,e)&&(Mt(n.prev,n,e.prev)||Mt(n,e.prev,e))||oa(n,e)&&Mt(n.prev,n,n.next)>0&&Mt(e.prev,e,e.next)>0)}function Mt(n,e,t){return(e.y-n.y)*(t.x-e.x)-(e.x-n.x)*(t.y-e.y)}function oa(n,e){return n.x===e.x&&n.y===e.y}function Yd(n,e,t,i){const s=yo(Mt(n,e,t)),r=yo(Mt(n,e,i)),o=yo(Mt(t,i,n)),a=yo(Mt(t,i,e));return!!(s!==r&&o!==a||s===0&&Mo(n,t,e)||r===0&&Mo(n,i,e)||o===0&&Mo(t,n,i)||a===0&&Mo(t,e,i))}function Mo(n,e,t){return e.x<=Math.max(n.x,t.x)&&e.x>=Math.min(n.x,t.x)&&e.y<=Math.max(n.y,t.y)&&e.y>=Math.min(n.y,t.y)}function yo(n){return n>0?1:n<0?-1:0}function EE(n,e){let t=n;do{if(t.i!==n.i&&t.next.i!==n.i&&t.i!==e.i&&t.next.i!==e.i&&Yd(t,t.next,n,e))return!0;t=t.next}while(t!==n);return!1}function Ar(n,e){return Mt(n.prev,n,n.next)<0?Mt(n,e,n.next)>=0&&Mt(n,n.prev,e)>=0:Mt(n,e,n.prev)<0||Mt(n,n.next,e)<0}function wE(n,e){let t=n,i=!1;const s=(n.x+e.x)/2,r=(n.y+e.y)/2;do t.y>r!=t.next.y>r&&t.next.y!==t.y&&s<(t.next.x-t.x)*(r-t.y)/(t.next.y-t.y)+t.x&&(i=!i),t=t.next;while(t!==n);return i}function $d(n,e){const t=new oc(n.i,n.x,n.y),i=new oc(e.i,e.x,e.y),s=n.next,r=e.prev;return n.next=e,e.prev=n,t.next=s,s.prev=t,i.next=t,t.prev=i,r.next=i,i.prev=r,i}function Wh(n,e,t,i){const s=new oc(n,e,t);return i?(s.next=i.next,s.prev=i,i.next.prev=s,i.next=s):(s.prev=s,s.next=s),s}function Rr(n){n.next.prev=n.prev,n.prev.next=n.next,n.prevZ&&(n.prevZ.nextZ=n.nextZ),n.nextZ&&(n.nextZ.prevZ=n.prevZ)}function oc(n,e,t){this.i=n,this.x=e,this.y=t,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function bE(n,e,t,i){let s=0;for(let r=e,o=t-i;r<t;r+=i)s+=(n[o]-n[r])*(n[r+1]+n[o+1]),o=r;return s}class Rs{static area(e){const t=e.length;let i=0;for(let s=t-1,r=0;r<t;s=r++)i+=e[s].x*e[r].y-e[r].x*e[s].y;return i*.5}static isClockWise(e){return Rs.area(e)<0}static triangulateShape(e,t){const i=[],s=[],r=[];Xh(e),qh(i,e);let o=e.length;t.forEach(Xh);for(let l=0;l<t.length;l++)s.push(o),o+=t[l].length,qh(i,t[l]);const a=cE.triangulate(i,s);for(let l=0;l<a.length;l+=3)r.push(a.slice(l,l+3));return r}}function Xh(n){const e=n.length;e>2&&n[e-1].equals(n[0])&&n.pop()}function qh(n,e){for(let t=0;t<e.length;t++)n.push(e[t].x),n.push(e[t].y)}class bi extends gn{constructor(e=new Qn([new Ce(.5,.5),new Ce(-.5,.5),new Ce(-.5,-.5),new Ce(.5,-.5)]),t={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:e,options:t},e=Array.isArray(e)?e:[e];const i=this,s=[],r=[];for(let a=0,l=e.length;a<l;a++){const c=e[a];o(c)}this.setAttribute("position",new Et(s,3)),this.setAttribute("uv",new Et(r,2)),this.computeVertexNormals();function o(a){const l=[],c=t.curveSegments!==void 0?t.curveSegments:12,h=t.steps!==void 0?t.steps:1,u=t.depth!==void 0?t.depth:1;let f=t.bevelEnabled!==void 0?t.bevelEnabled:!0,p=t.bevelThickness!==void 0?t.bevelThickness:.2,_=t.bevelSize!==void 0?t.bevelSize:p-.1,M=t.bevelOffset!==void 0?t.bevelOffset:0,d=t.bevelSegments!==void 0?t.bevelSegments:3;const m=t.extrudePath,b=t.UVGenerator!==void 0?t.UVGenerator:TE;let y,E=!1,N,P,R,I;m&&(y=m.getSpacedPoints(h),E=!0,f=!1,N=m.computeFrenetFrames(h,!1),P=new H,R=new H,I=new H),f||(d=0,p=0,_=0,M=0);const ne=a.extractPoints(c);let x=ne.shape;const w=ne.holes;if(!Rs.isClockWise(x)){x=x.reverse();for(let Q=0,g=w.length;Q<g;Q++){const T=w[Q];Rs.isClockWise(T)&&(w[Q]=T.reverse())}}const q=Rs.triangulateShape(x,w),Z=x;for(let Q=0,g=w.length;Q<g;Q++){const T=w[Q];x=x.concat(T)}function re(Q,g,T){return g||console.error("THREE.ExtrudeGeometry: vec does not exist"),Q.clone().addScaledVector(g,T)}const G=x.length,J=q.length;function W(Q,g,T){let L,D,U;const Y=Q.x-g.x,K=Q.y-g.y,S=T.x-Q.x,v=T.y-Q.y,C=Y*Y+K*K,V=Y*v-K*S;if(Math.abs(V)>Number.EPSILON){const B=Math.sqrt(C),z=Math.sqrt(S*S+v*v),he=g.x-K/B,ce=g.y+Y/B,pe=T.x-v/z,Ae=T.y+S/z,fe=((pe-he)*v-(Ae-ce)*S)/(Y*v-K*S);L=he+Y*fe-Q.x,D=ce+K*fe-Q.y;const ve=L*L+D*D;if(ve<=2)return new Ce(L,D);U=Math.sqrt(ve/2)}else{let B=!1;Y>Number.EPSILON?S>Number.EPSILON&&(B=!0):Y<-Number.EPSILON?S<-Number.EPSILON&&(B=!0):Math.sign(K)===Math.sign(v)&&(B=!0),B?(L=-K,D=Y,U=Math.sqrt(C)):(L=Y,D=K,U=Math.sqrt(C/2))}return new Ce(L/U,D/U)}const me=[];for(let Q=0,g=Z.length,T=g-1,L=Q+1;Q<g;Q++,T++,L++)T===g&&(T=0),L===g&&(L=0),me[Q]=W(Z[Q],Z[T],Z[L]);const _e=[];let ge,Le=me.concat();for(let Q=0,g=w.length;Q<g;Q++){const T=w[Q];ge=[];for(let L=0,D=T.length,U=D-1,Y=L+1;L<D;L++,U++,Y++)U===D&&(U=0),Y===D&&(Y=0),ge[L]=W(T[L],T[U],T[Y]);_e.push(ge),Le=Le.concat(ge)}for(let Q=0;Q<d;Q++){const g=Q/d,T=p*Math.cos(g*Math.PI/2),L=_*Math.sin(g*Math.PI/2)+M;for(let D=0,U=Z.length;D<U;D++){const Y=re(Z[D],me[D],L);O(Y.x,Y.y,-T)}for(let D=0,U=w.length;D<U;D++){const Y=w[D];ge=_e[D];for(let K=0,S=Y.length;K<S;K++){const v=re(Y[K],ge[K],L);O(v.x,v.y,-T)}}}const Oe=_+M;for(let Q=0;Q<G;Q++){const g=f?re(x[Q],Le[Q],Oe):x[Q];E?(R.copy(N.normals[0]).multiplyScalar(g.x),P.copy(N.binormals[0]).multiplyScalar(g.y),I.copy(y[0]).add(R).add(P),O(I.x,I.y,I.z)):O(g.x,g.y,0)}for(let Q=1;Q<=h;Q++)for(let g=0;g<G;g++){const T=f?re(x[g],Le[g],Oe):x[g];E?(R.copy(N.normals[Q]).multiplyScalar(T.x),P.copy(N.binormals[Q]).multiplyScalar(T.y),I.copy(y[Q]).add(R).add(P),O(I.x,I.y,I.z)):O(T.x,T.y,u/h*Q)}for(let Q=d-1;Q>=0;Q--){const g=Q/d,T=p*Math.cos(g*Math.PI/2),L=_*Math.sin(g*Math.PI/2)+M;for(let D=0,U=Z.length;D<U;D++){const Y=re(Z[D],me[D],L);O(Y.x,Y.y,u+T)}for(let D=0,U=w.length;D<U;D++){const Y=w[D];ge=_e[D];for(let K=0,S=Y.length;K<S;K++){const v=re(Y[K],ge[K],L);E?O(v.x,v.y+y[h-1].y,y[h-1].x+T):O(v.x,v.y,u+T)}}}ae(),de();function ae(){const Q=s.length/3;if(f){let g=0,T=G*g;for(let L=0;L<J;L++){const D=q[L];le(D[2]+T,D[1]+T,D[0]+T)}g=h+d*2,T=G*g;for(let L=0;L<J;L++){const D=q[L];le(D[0]+T,D[1]+T,D[2]+T)}}else{for(let g=0;g<J;g++){const T=q[g];le(T[2],T[1],T[0])}for(let g=0;g<J;g++){const T=q[g];le(T[0]+G*h,T[1]+G*h,T[2]+G*h)}}i.addGroup(Q,s.length/3-Q,0)}function de(){const Q=s.length/3;let g=0;xe(Z,g),g+=Z.length;for(let T=0,L=w.length;T<L;T++){const D=w[T];xe(D,g),g+=D.length}i.addGroup(Q,s.length/3-Q,1)}function xe(Q,g){let T=Q.length;for(;--T>=0;){const L=T;let D=T-1;D<0&&(D=Q.length-1);for(let U=0,Y=h+d*2;U<Y;U++){const K=G*U,S=G*(U+1),v=g+L+K,C=g+D+K,V=g+D+S,B=g+L+S;oe(v,C,V,B)}}}function O(Q,g,T){l.push(Q),l.push(g),l.push(T)}function le(Q,g,T){ue(Q),ue(g),ue(T);const L=s.length/3,D=b.generateTopUV(i,s,L-3,L-2,L-1);Se(D[0]),Se(D[1]),Se(D[2])}function oe(Q,g,T,L){ue(Q),ue(g),ue(L),ue(g),ue(T),ue(L);const D=s.length/3,U=b.generateSideWallUV(i,s,D-6,D-3,D-2,D-1);Se(U[0]),Se(U[1]),Se(U[3]),Se(U[1]),Se(U[2]),Se(U[3])}function ue(Q){s.push(l[Q*3+0]),s.push(l[Q*3+1]),s.push(l[Q*3+2])}function Se(Q){r.push(Q.x),r.push(Q.y)}}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}toJSON(){const e=super.toJSON(),t=this.parameters.shapes,i=this.parameters.options;return AE(t,i,e)}static fromJSON(e,t){const i=[];for(let r=0,o=e.shapes.length;r<o;r++){const a=t[e.shapes[r]];i.push(a)}const s=e.options.extrudePath;return s!==void 0&&(e.options.extrudePath=new ic[s.type]().fromJSON(s)),new bi(i,e.options)}}const TE={generateTopUV:function(n,e,t,i,s){const r=e[t*3],o=e[t*3+1],a=e[i*3],l=e[i*3+1],c=e[s*3],h=e[s*3+1];return[new Ce(r,o),new Ce(a,l),new Ce(c,h)]},generateSideWallUV:function(n,e,t,i,s,r){const o=e[t*3],a=e[t*3+1],l=e[t*3+2],c=e[i*3],h=e[i*3+1],u=e[i*3+2],f=e[s*3],p=e[s*3+1],_=e[s*3+2],M=e[r*3],d=e[r*3+1],m=e[r*3+2];return Math.abs(a-h)<Math.abs(o-c)?[new Ce(o,1-l),new Ce(c,1-u),new Ce(f,1-_),new Ce(M,1-m)]:[new Ce(a,1-l),new Ce(h,1-u),new Ce(p,1-_),new Ce(d,1-m)]}};function AE(n,e,t){if(t.shapes=[],Array.isArray(n))for(let i=0,s=n.length;i<s;i++){const r=n[i];t.shapes.push(r.uuid)}else t.shapes.push(n.uuid);return t.options=Object.assign({},e),e.extrudePath!==void 0&&(t.options.extrudePath=e.extrudePath.toJSON()),t}class We extends gn{constructor(e=1,t=32,i=16,s=0,r=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:i,phiStart:s,phiLength:r,thetaStart:o,thetaLength:a},t=Math.max(3,Math.floor(t)),i=Math.max(2,Math.floor(i));const l=Math.min(o+a,Math.PI);let c=0;const h=[],u=new H,f=new H,p=[],_=[],M=[],d=[];for(let m=0;m<=i;m++){const b=[],y=m/i;let E=0;m===0&&o===0?E=.5/t:m===i&&l===Math.PI&&(E=-.5/t);for(let N=0;N<=t;N++){const P=N/t;u.x=-e*Math.cos(s+P*r)*Math.sin(o+y*a),u.y=e*Math.cos(o+y*a),u.z=e*Math.sin(s+P*r)*Math.sin(o+y*a),_.push(u.x,u.y,u.z),f.copy(u).normalize(),M.push(f.x,f.y,f.z),d.push(P+E,1-y),b.push(c++)}h.push(b)}for(let m=0;m<i;m++)for(let b=0;b<t;b++){const y=h[m][b+1],E=h[m][b],N=h[m+1][b],P=h[m+1][b+1];(m!==0||o>0)&&p.push(y,E,P),(m!==i-1||l<Math.PI)&&p.push(E,N,P)}this.setIndex(p),this.setAttribute("position",new Et(_,3)),this.setAttribute("normal",new Et(M,3)),this.setAttribute("uv",new Et(d,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new We(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class Xc extends gn{constructor(e=1,t=.4,i=12,s=48,r=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:e,tube:t,radialSegments:i,tubularSegments:s,arc:r},i=Math.floor(i),s=Math.floor(s);const o=[],a=[],l=[],c=[],h=new H,u=new H,f=new H;for(let p=0;p<=i;p++)for(let _=0;_<=s;_++){const M=_/s*r,d=p/i*Math.PI*2;u.x=(e+t*Math.cos(d))*Math.cos(M),u.y=(e+t*Math.cos(d))*Math.sin(M),u.z=t*Math.sin(d),a.push(u.x,u.y,u.z),h.x=e*Math.cos(M),h.y=e*Math.sin(M),f.subVectors(u,h).normalize(),l.push(f.x,f.y,f.z),c.push(_/s),c.push(p/i)}for(let p=1;p<=i;p++)for(let _=1;_<=s;_++){const M=(s+1)*p+_-1,d=(s+1)*(p-1)+_-1,m=(s+1)*(p-1)+_,b=(s+1)*p+_;o.push(M,d,b),o.push(d,m,b)}this.setIndex(o),this.setAttribute("position",new Et(a,3)),this.setAttribute("normal",new Et(l,3)),this.setAttribute("uv",new Et(c,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Xc(e.radius,e.tube,e.radialSegments,e.tubularSegments,e.arc)}}class Kd extends Ur{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Ze(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ze(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Ed,this.normalScale=new Ce(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new On,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class He extends Kd{constructor(e){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new Ce(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return Lt(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(t){this.ior=(1+.4*t)/(1-.4*t)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new Ze(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new Ze(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new Ze(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._dispersion=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(e)}get anisotropy(){return this._anisotropy}set anisotropy(e){this._anisotropy>0!=e>0&&this.version++,this._anisotropy=e}get clearcoat(){return this._clearcoat}set clearcoat(e){this._clearcoat>0!=e>0&&this.version++,this._clearcoat=e}get iridescence(){return this._iridescence}set iridescence(e){this._iridescence>0!=e>0&&this.version++,this._iridescence=e}get dispersion(){return this._dispersion}set dispersion(e){this._dispersion>0!=e>0&&this.version++,this._dispersion=e}get sheen(){return this._sheen}set sheen(e){this._sheen>0!=e>0&&this.version++,this._sheen=e}get transmission(){return this._transmission}set transmission(e){this._transmission>0!=e>0&&this.version++,this._transmission=e}copy(e){return super.copy(e),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=e.anisotropy,this.anisotropyRotation=e.anisotropyRotation,this.anisotropyMap=e.anisotropyMap,this.clearcoat=e.clearcoat,this.clearcoatMap=e.clearcoatMap,this.clearcoatRoughness=e.clearcoatRoughness,this.clearcoatRoughnessMap=e.clearcoatRoughnessMap,this.clearcoatNormalMap=e.clearcoatNormalMap,this.clearcoatNormalScale.copy(e.clearcoatNormalScale),this.dispersion=e.dispersion,this.ior=e.ior,this.iridescence=e.iridescence,this.iridescenceMap=e.iridescenceMap,this.iridescenceIOR=e.iridescenceIOR,this.iridescenceThicknessRange=[...e.iridescenceThicknessRange],this.iridescenceThicknessMap=e.iridescenceThicknessMap,this.sheen=e.sheen,this.sheenColor.copy(e.sheenColor),this.sheenColorMap=e.sheenColorMap,this.sheenRoughness=e.sheenRoughness,this.sheenRoughnessMap=e.sheenRoughnessMap,this.transmission=e.transmission,this.transmissionMap=e.transmissionMap,this.thickness=e.thickness,this.thicknessMap=e.thicknessMap,this.attenuationDistance=e.attenuationDistance,this.attenuationColor.copy(e.attenuationColor),this.specularIntensity=e.specularIntensity,this.specularIntensityMap=e.specularIntensityMap,this.specularColor.copy(e.specularColor),this.specularColorMap=e.specularColorMap,this}}const Vo={enabled:!1,files:{},add:function(n,e){this.enabled!==!1&&(this.files[n]=e)},get:function(n){if(this.enabled!==!1)return this.files[n]},remove:function(n){delete this.files[n]},clear:function(){this.files={}}};class RE{constructor(e,t,i){const s=this;let r=!1,o=0,a=0,l;const c=[];this.onStart=void 0,this.onLoad=e,this.onProgress=t,this.onError=i,this.itemStart=function(h){a++,r===!1&&s.onStart!==void 0&&s.onStart(h,o,a),r=!0},this.itemEnd=function(h){o++,s.onProgress!==void 0&&s.onProgress(h,o,a),o===a&&(r=!1,s.onLoad!==void 0&&s.onLoad())},this.itemError=function(h){s.onError!==void 0&&s.onError(h)},this.resolveURL=function(h){return l?l(h):h},this.setURLModifier=function(h){return l=h,this},this.addHandler=function(h,u){return c.push(h,u),this},this.removeHandler=function(h){const u=c.indexOf(h);return u!==-1&&c.splice(u,2),this},this.getHandler=function(h){for(let u=0,f=c.length;u<f;u+=2){const p=c[u],_=c[u+1];if(p.global&&(p.lastIndex=0),p.test(h))return _}return null}}}const CE=new RE;class Fr{constructor(e){this.manager=e!==void 0?e:CE,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(e,t){const i=this;return new Promise(function(s,r){i.load(e,s,t,r)})}parse(){}setCrossOrigin(e){return this.crossOrigin=e,this}setWithCredentials(e){return this.withCredentials=e,this}setPath(e){return this.path=e,this}setResourcePath(e){return this.resourcePath=e,this}setRequestHeader(e){return this.requestHeader=e,this}}Fr.DEFAULT_MATERIAL_NAME="__DEFAULT";const Xn={};class PE extends Error{constructor(e,t){super(e),this.response=t}}class LE extends Fr{constructor(e){super(e)}load(e,t,i,s){e===void 0&&(e=""),this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const r=Vo.get(e);if(r!==void 0)return this.manager.itemStart(e),setTimeout(()=>{t&&t(r),this.manager.itemEnd(e)},0),r;if(Xn[e]!==void 0){Xn[e].push({onLoad:t,onProgress:i,onError:s});return}Xn[e]=[],Xn[e].push({onLoad:t,onProgress:i,onError:s});const o=new Request(e,{headers:new Headers(this.requestHeader),credentials:this.withCredentials?"include":"same-origin"}),a=this.mimeType,l=this.responseType;fetch(o).then(c=>{if(c.status===200||c.status===0){if(c.status===0&&console.warn("THREE.FileLoader: HTTP Status 0 received."),typeof ReadableStream>"u"||c.body===void 0||c.body.getReader===void 0)return c;const h=Xn[e],u=c.body.getReader(),f=c.headers.get("X-File-Size")||c.headers.get("Content-Length"),p=f?parseInt(f):0,_=p!==0;let M=0;const d=new ReadableStream({start(m){b();function b(){u.read().then(({done:y,value:E})=>{if(y)m.close();else{M+=E.byteLength;const N=new ProgressEvent("progress",{lengthComputable:_,loaded:M,total:p});for(let P=0,R=h.length;P<R;P++){const I=h[P];I.onProgress&&I.onProgress(N)}m.enqueue(E),b()}},y=>{m.error(y)})}}});return new Response(d)}else throw new PE(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`,c)}).then(c=>{switch(l){case"arraybuffer":return c.arrayBuffer();case"blob":return c.blob();case"document":return c.text().then(h=>new DOMParser().parseFromString(h,a));case"json":return c.json();default:if(a===void 0)return c.text();{const u=/charset="?([^;"\s]*)"?/i.exec(a),f=u&&u[1]?u[1].toLowerCase():void 0,p=new TextDecoder(f);return c.arrayBuffer().then(_=>p.decode(_))}}}).then(c=>{Vo.add(e,c);const h=Xn[e];delete Xn[e];for(let u=0,f=h.length;u<f;u++){const p=h[u];p.onLoad&&p.onLoad(c)}}).catch(c=>{const h=Xn[e];if(h===void 0)throw this.manager.itemError(e),c;delete Xn[e];for(let u=0,f=h.length;u<f;u++){const p=h[u];p.onError&&p.onError(c)}this.manager.itemError(e)}).finally(()=>{this.manager.itemEnd(e)}),this.manager.itemStart(e)}setResponseType(e){return this.responseType=e,this}setMimeType(e){return this.mimeType=e,this}}class IE extends Fr{constructor(e){super(e)}load(e,t,i,s){this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const r=this,o=Vo.get(e);if(o!==void 0)return r.manager.itemStart(e),setTimeout(function(){t&&t(o),r.manager.itemEnd(e)},0),o;const a=br("img");function l(){h(),Vo.add(e,this),t&&t(this),r.manager.itemEnd(e)}function c(u){h(),s&&s(u),r.manager.itemError(e),r.manager.itemEnd(e)}function h(){a.removeEventListener("load",l,!1),a.removeEventListener("error",c,!1)}return a.addEventListener("load",l,!1),a.addEventListener("error",c,!1),e.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(a.crossOrigin=this.crossOrigin),r.manager.itemStart(e),a.src=e,a}}class Br extends Fr{constructor(e){super(e)}load(e,t,i,s){const r=new jt,o=new IE(this.manager);return o.setCrossOrigin(this.crossOrigin),o.setPath(this.path),o.load(e,function(a){r.image=a,r.needsUpdate=!0,t!==void 0&&t(r)},i,s),r}}class qc extends kt{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new Ze(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(t.object.target=this.target.uuid),t}}const nl=new vt,Yh=new H,$h=new H;class jd{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Ce(512,512),this.map=null,this.mapPass=null,this.matrix=new vt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Gc,this._frameExtents=new Ce(1,1),this._viewportCount=1,this._viewports=[new at(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,i=this.matrix;Yh.setFromMatrixPosition(e.matrixWorld),t.position.copy(Yh),$h.setFromMatrixPosition(e.target.matrixWorld),t.lookAt($h),t.updateMatrixWorld(),nl.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(nl),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(nl)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}const Kh=new vt,er=new H,il=new H;class DE extends jd{constructor(){super(new Ot(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new Ce(4,2),this._viewportCount=6,this._viewports=[new at(2,1,1,1),new at(0,1,1,1),new at(3,1,1,1),new at(1,1,1,1),new at(3,0,1,1),new at(1,0,1,1)],this._cubeDirections=[new H(1,0,0),new H(-1,0,0),new H(0,0,1),new H(0,0,-1),new H(0,1,0),new H(0,-1,0)],this._cubeUps=[new H(0,1,0),new H(0,1,0),new H(0,1,0),new H(0,1,0),new H(0,0,1),new H(0,0,-1)]}updateMatrices(e,t=0){const i=this.camera,s=this.matrix,r=e.distance||i.far;r!==i.far&&(i.far=r,i.updateProjectionMatrix()),er.setFromMatrixPosition(e.matrixWorld),i.position.copy(er),il.copy(i.position),il.add(this._cubeDirections[t]),i.up.copy(this._cubeUps[t]),i.lookAt(il),i.updateMatrixWorld(),s.makeTranslation(-er.x,-er.y,-er.z),Kh.multiplyMatrices(i.projectionMatrix,i.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Kh)}}class zr extends qc{constructor(e,t,i=0,s=2){super(e,t),this.isPointLight=!0,this.type="PointLight",this.distance=i,this.decay=s,this.shadow=new DE}get power(){return this.intensity*4*Math.PI}set power(e){this.intensity=e/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(e,t){return super.copy(e,t),this.distance=e.distance,this.decay=e.decay,this.shadow=e.shadow.clone(),this}}class UE extends jd{constructor(){super(new Od(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Hr extends qc{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(kt.DEFAULT_UP),this.updateMatrix(),this.target=new kt,this.shadow=new UE}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Gr extends qc{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class NE{constructor(){this.type="ShapePath",this.color=new Ze,this.subPaths=[],this.currentPath=null}moveTo(e,t){return this.currentPath=new sc,this.subPaths.push(this.currentPath),this.currentPath.moveTo(e,t),this}lineTo(e,t){return this.currentPath.lineTo(e,t),this}quadraticCurveTo(e,t,i,s){return this.currentPath.quadraticCurveTo(e,t,i,s),this}bezierCurveTo(e,t,i,s,r,o){return this.currentPath.bezierCurveTo(e,t,i,s,r,o),this}splineThru(e){return this.currentPath.splineThru(e),this}toShapes(e){function t(m){const b=[];for(let y=0,E=m.length;y<E;y++){const N=m[y],P=new Qn;P.curves=N.curves,b.push(P)}return b}function i(m,b){const y=b.length;let E=!1;for(let N=y-1,P=0;P<y;N=P++){let R=b[N],I=b[P],ne=I.x-R.x,x=I.y-R.y;if(Math.abs(x)>Number.EPSILON){if(x<0&&(R=b[P],ne=-ne,I=b[N],x=-x),m.y<R.y||m.y>I.y)continue;if(m.y===R.y){if(m.x===R.x)return!0}else{const w=x*(m.x-R.x)-ne*(m.y-R.y);if(w===0)return!0;if(w<0)continue;E=!E}}else{if(m.y!==R.y)continue;if(I.x<=m.x&&m.x<=R.x||R.x<=m.x&&m.x<=I.x)return!0}}return E}const s=Rs.isClockWise,r=this.subPaths;if(r.length===0)return[];let o,a,l;const c=[];if(r.length===1)return a=r[0],l=new Qn,l.curves=a.curves,c.push(l),c;let h=!s(r[0].getPoints());h=e?!h:h;const u=[],f=[];let p=[],_=0,M;f[_]=void 0,p[_]=[];for(let m=0,b=r.length;m<b;m++)a=r[m],M=a.getPoints(),o=s(M),o=e?!o:o,o?(!h&&f[_]&&_++,f[_]={s:new Qn,p:M},f[_].s.curves=a.curves,h&&_++,p[_]=[]):p[_].push({h:a,p:M[0]});if(!f[0])return t(r);if(f.length>1){let m=!1,b=0;for(let y=0,E=f.length;y<E;y++)u[y]=[];for(let y=0,E=f.length;y<E;y++){const N=p[y];for(let P=0;P<N.length;P++){const R=N[P];let I=!0;for(let ne=0;ne<f.length;ne++)i(R.p,f[ne].p)&&(y!==ne&&b++,I?(I=!1,u[ne].push(R)):m=!0);I&&u[y].push(R)}}b>0&&m===!1&&(p=u)}let d;for(let m=0,b=f.length;m<b;m++){l=f[m].s,c.push(l),d=p[m];for(let y=0,E=d.length;y<E;y++)l.holes.push(d[y].h)}return c}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Lc}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Lc);class Vr extends Fr{constructor(e){super(e)}load(e,t,i,s){const r=this,o=new LE(this.manager);o.setPath(this.path),o.setRequestHeader(this.requestHeader),o.setWithCredentials(this.withCredentials),o.load(e,function(a){const l=r.parse(JSON.parse(a));t&&t(l)},i,s)}parse(e){return new OE(e)}}class OE{constructor(e){this.isFont=!0,this.type="Font",this.data=e}generateShapes(e,t=100){const i=[],s=FE(e,t,this.data);for(let r=0,o=s.length;r<o;r++)i.push(...s[r].toShapes());return i}}function FE(n,e,t){const i=Array.from(n),s=e/t.resolution,r=(t.boundingBox.yMax-t.boundingBox.yMin+t.underlineThickness)*s,o=[];let a=0,l=0;for(let c=0;c<i.length;c++){const h=i[c];if(h===`
`)a=0,l-=r;else{const u=BE(h,s,a,l,t);a+=u.offsetX,o.push(u.path)}}return o}function BE(n,e,t,i,s){const r=s.glyphs[n]||s.glyphs["?"];if(!r){console.error('THREE.Font: character "'+n+'" does not exists in font family '+s.familyName+".");return}const o=new NE;let a,l,c,h,u,f,p,_;if(r.o){const M=r._cachedOutline||(r._cachedOutline=r.o.split(" "));for(let d=0,m=M.length;d<m;)switch(M[d++]){case"m":a=M[d++]*e+t,l=M[d++]*e+i,o.moveTo(a,l);break;case"l":a=M[d++]*e+t,l=M[d++]*e+i,o.lineTo(a,l);break;case"q":c=M[d++]*e+t,h=M[d++]*e+i,u=M[d++]*e+t,f=M[d++]*e+i,o.quadraticCurveTo(u,f,c,h);break;case"b":c=M[d++]*e+t,h=M[d++]*e+i,u=M[d++]*e+t,f=M[d++]*e+i,p=M[d++]*e+t,_=M[d++]*e+i,o.bezierCurveTo(u,f,p,_,c,h);break}}return{offsetX:r.ha*e,path:o}}class It extends bi{constructor(e,t={}){const i=t.font;if(i===void 0)super();else{const s=i.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(s,t)}this.type="TextGeometry"}}const zE=Ei({__name:"MetalBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=gt(null);let i=null,s=gt(!1),r=gt(!1),o=gt(!1);return $i(()=>{if(t.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:r.value&&(u.rotation.y-=.03),h.render(l,c)};const l=new Or,c=new Ot(75,window.innerWidth/window.innerHeight,.1,1e3),h=new Nr({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(h.domElement);const u=new ct,f=new Gr(16777215,2);l.add(f);const p=new Hr(16777215,4);p.position.set(5,5,5),l.add(p);const _=new zr(16777215,5,50);_.position.set(0,2,4),l.add(_);const M=new Br,d=M.load("/3d-bear-arts/assets/lv2.jpg"),m=M.load("/3d-bear-arts/assets/lv2.jpg");d.wrapS=d.wrapT=cn,m.wrapS=m.wrapT=cn;const b=new He({color:8343336,metalness:0,roughness:.8,bumpMap:d,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:m,envMapIntensity:.7}),y=new He({color:5978654,metalness:0,roughness:.8,bumpMap:d,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:m,envMapIntensity:.7}),E=new He({color:13152668,metalness:.2,roughness:.05,bumpMap:d,bumpScale:.05,clearcoat:1,clearcoatRoughness:.05,map:m,transparent:!0,opacity:.4,transmission:.9,envMapIntensity:1,reflectivity:.9,ior:1.45,side:ht});new He({color:13421772,metalness:1,roughness:.5,clearcoat:.3,clearcoatRoughness:.3});const N=new We(1,32,32,0,Math.PI),P=new j(N,E),R=new j(N,b);P.scale.set(.85,.85,.8),R.scale.set(.85,.85,.8),P.position.y=-.2,R.position.y=-.2,P.rotation.y=Math.PI/2,R.rotation.y=Math.PI*1.5;const I=new Ft(1,32),ne=new j(I,b);ne.scale.set(.85,.85,.8),ne.position.set(0,-.2,0),ne.rotation.y=Math.PI/2;const x=new ct;x.add(P),x.add(R),x.add(ne),u.add(x);const w=new We(.6,32,32,0,Math.PI),$=new j(w,b);$.scale.set(1,.95,.95),$.position.set(0,1,0),$.rotation.y=Math.PI*1.5;const q=new j(w,E);q.scale.set(1,.95,.95),q.position.set(0,1,0),q.rotation.y=Math.PI/2;const Z=new Ft(.6,32),re=new j(Z,b);re.position.set(0,1,0),re.rotation.y=Math.PI/2,re.scale.set(1,.95,.95);const G=new ct;G.add($),G.add(q),G.add(re),u.add(G);const J=new We(.25,32,32),W=new j(J,b);W.position.set(-.45,1.35,-.1),u.add(W);const me=new j(J,E);me.position.set(.45,1.35,-.1),u.add(me);const _e=new We(.25,32,32,Math.PI/2,Math.PI),ge=new j(_e,y);ge.scale.set(1.1,.6,.8),ge.position.set(0,.84,.5),ge.rotation.y=Math.PI;const Le=new We(.25,32,32,Math.PI/2,Math.PI),Oe=new j(Le,E);Oe.scale.set(1.1,.6,.8),Oe.position.set(0,.84,.5),Oe.rotation.y=0;const ae=new Ft(.25,32),de=new j(ae,b);de.scale.set(.8,.6,.8),de.position.set(0,.84,.5),de.rotation.y=Math.PI/2;const xe=new ct;xe.add(ge),xe.add(Oe),xe.add(de),u.add(xe);const O=new Qn;O.moveTo(0,0),O.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),O.bezierCurveTo(-.6,.3,0,.6,0,1),O.bezierCurveTo(0,.6,.6,.3,.6,0),O.bezierCurveTo(.6,-.3,0,-.3,0,0);const le={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new He({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const oe=new bi(O,le),ue=new j(oe,b);ue.scale.set(.1,.1,.1),ue.rotation.z=xt.degToRad(210),ue.rotation.x=xt.degToRad(5),ue.rotation.y=xt.degToRad(-45),ue.position.set(-.4,.9,.45);const Se=new j(oe,y);Se.scale.set(.6,.5,.5),Se.position.set(.35,0,0),Se.rotation.y=Math.PI,Se.rotation.x=Math.PI;const Q=new j(oe,y);Q.scale.set(.2,.2,.2),Q.position.set(.5,-.1,.2),Q.rotation.y=Math.PI,Q.rotation.x=Math.PI,u.add(Q);const g=new ks(1.3,1.2,.6),T=new j(g,b);T.scale.set(.45,.45,.45),T.position.set(.35,-.2,.1),T.rotation.y=Math.PI;const L=new Xc(.15,.025,10,100);new He({color:8343336,metalness:.3,roughness:.4,clearcoat:.5});const D=new j(L,b);D.position.set(.35,.1,.1),D.rotation.z=Math.PI/2,D.rotation.x=Math.PI/8,D.rotation.y=Math.PI/14;const U=new j(L,b);U.position.set(.35,.1,.13),U.rotation.z=Math.PI/2,U.rotation.x=Math.PI/-8,U.rotation.y=Math.PI/12;const Y=new ct;Y.add(T),Y.add(D),Y.add(U),u.add(Y);const K=new We(.35,32,32),S=new j(K,b);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),u.add(S);const v=new j(K,E);v.scale.set(.75,1.25,.65),v.position.set(.7,-.15,.2),u.add(v);const C=new ji(.2,.22,.6,32),V=new j(C,b);V.position.set(-.4,-1.05,0),u.add(V);const B=new j(C,E);B.position.set(.4,-1.05,0),u.add(B);const z=new We(.3,32,32),he=new j(z,b);he.scale.set(1,.72,1.5),he.position.set(-.4,-1.45,.17),u.add(he);const ce=new j(z,E);ce.scale.set(1,.72,1.5),ce.position.set(.4,-1.45,.17),u.add(ce);const pe=new We(.44,32,32),Ae=new j(pe,b);Ae.position.set(-.15,-.45,-.4),u.add(Ae);const fe=new j(pe,E);fe.position.set(.15,-.45,-.4),u.add(fe);const ve=new We(.18,32,32),Pe=new j(ve,b);Pe.position.set(0,-.35,-.8),u.add(Pe),new Vr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(se){const Me=new It("X",{font:se,size:.2,depth:.05});new mn({color:0});const Ee=new j(Me,y);Ee.position.set(-.3,.99,.53),Ee.rotation.x=xt.degToRad(-5),Ee.rotation.y=xt.degToRad(-15),u.add(Ee);const Ve=new It("O",{font:se,size:.2,depth:.05});new mn({color:0});const Je=new j(Ve,y);Je.position.set(.14,.99,.53),Je.rotation.y=xt.degToRad(12),Je.rotation.x=xt.degToRad(-5),u.add(Je)}),Pe.renderOrder=1,u.scale.set(1.35,1.35,1.35),l.add(u),u.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),c.position.set(e.bodyPosition.x,1,e.cameraPosition),c.lookAt(e.bodyPosition.x,0,0),c.position.z=4;const be=()=>{u.rotation.y,u.rotation.x},Ge=()=>{s.value=!0,r.value=!1,o.value=!1},De=()=>{s.value=!1,r.value=!0,o.value=!1},Fe=()=>{s.value=!1,r.value=!1,be()},F=se=>{const Me=window.innerWidth/2;se>Me?Ge():De(),be()},ye=se=>{clearTimeout(i),Fe(),o.value=!0;const Me={x:se.clientX/window.innerWidth*2-1,y:-(se.clientY/window.innerHeight)*2+1};if(o.value){const Ee=Me.x*Math.PI*.2,Ve=Me.y*Math.PI*.2;u.rotation.y=Ee,u.rotation.x=Ve}i=setTimeout(()=>{o.value=!1,F(se.clientX)},500)};window.addEventListener("mousemove",ye);const ee=se=>{if(o.value){const Me={x:se.clientX/window.innerWidth*2-1,y:-(se.clientY/window.innerHeight)*2+1},Ee=Me.x*Math.PI*.2,Ve=Me.y*Math.PI*.2;u.rotation.y=Ee,u.rotation.x=Ve}};window.addEventListener("mousemove",ee),a(),Jt(()=>e.bodyPosition,se=>{u.position.set(se.x,se.y,se.z)}),Jt(()=>e.cameraPosition,se=>{c.position.set(e.bodyPosition.x,1,se),c.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{c.aspect=window.innerWidth/window.innerHeight,c.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,l)=>(zs(),Hs("div",{ref_key:"threeCanvas",ref:t,class:Mi(n.background?"no-bg":"three-canvas")},null,2))}}),HE=Gs(zE,[["__scopeId","data-v-f3beb116"]]),GE=Ei({__name:"PopartBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=gt(null);let i=null,s=gt(!1),r=gt(!1),o=gt(!1);return $i(()=>{if(t.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:r.value&&(u.rotation.y-=.03),h.render(l,c)};const l=new Or,c=new Ot(75,window.innerWidth/window.innerHeight,.1,1e3),h=new Nr({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(h.domElement);const u=new ct,f=new Gr(16777215,2);l.add(f);const p=new Hr(16777215,4);p.position.set(5,5,5),l.add(p);const _=new zr(16777215,5,50);_.position.set(0,2,4),l.add(_);const M=new Br,d=M.load("/3d-bear-arts/assets/pop6.jpg"),m=M.load("/3d-bear-arts/assets/pop7.jpg");d.wrapS=d.wrapT=cn,m.wrapS=m.wrapT=cn;const b=new He({color:16738740,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),y=new He({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),E=new He({color:16766720,map:d,metalness:.3,roughness:.5}),N=new He({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),P=new He({color:9055202,map:d,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new He({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht});const R=new He({color:65535,map:d,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),I=new He({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),ne=new We(1,32,32,0,Math.PI),x=new j(ne,y),w=new j(ne,b);x.scale.set(.85,.85,.8),w.scale.set(.85,.85,.8),x.position.y=-.2,w.position.y=-.2,x.rotation.y=Math.PI/2,w.rotation.y=Math.PI*1.5;const $=new Ft(1,32),q=new j($,b);q.scale.set(.85,.85,.8),q.position.set(0,-.2,0),q.rotation.y=Math.PI/2;const Z=new ct;Z.add(x),Z.add(w),Z.add(q),u.add(Z);const re=new We(.6,32,32,0,Math.PI),G=new j(re,E);G.scale.set(1,.95,.95),G.position.set(0,1,0),G.rotation.y=Math.PI*1.5;const J=new j(re,N);J.scale.set(1,.95,.95),J.position.set(0,1,0),J.rotation.y=Math.PI/2;const W=new Ft(.6,32),me=new j(W,E);me.position.set(0,1,0),me.rotation.y=Math.PI/2,me.scale.set(1,.95,.95);const _e=new ct;_e.add(G),_e.add(J),_e.add(me),u.add(_e);const ge=new We(.25,32,32),Le=new j(ge,b);Le.position.set(-.45,1.35,-.1),u.add(Le);const Oe=new j(ge,y);Oe.position.set(.45,1.35,-.1),u.add(Oe);const ae=new We(.25,32,32,Math.PI/2,Math.PI),de=new j(ae,E);de.scale.set(1.1,.6,.8),de.position.set(0,.84,.5),de.rotation.y=Math.PI;const xe=new We(.25,32,32,Math.PI/2,Math.PI),O=new j(xe,N);O.scale.set(1.1,.6,.8),O.position.set(0,.84,.5),O.rotation.y=0;const le=new Ft(.25,32),oe=new j(le,E);oe.scale.set(.8,.6,.8),oe.position.set(0,.84,.5),oe.rotation.y=Math.PI/2;const ue=new ct;ue.add(de),ue.add(O),ue.add(oe),u.add(ue);const Se=new Qn;Se.moveTo(0,0),Se.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Se.bezierCurveTo(-.6,.3,0,.6,0,1),Se.bezierCurveTo(0,.6,.6,.3,.6,0),Se.bezierCurveTo(.6,-.3,0,-.3,0,0);const Q={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},g=new bi(Se,Q),T=new j(g,E);T.scale.set(.5,.5,.5),T.position.set(.35,0,0),T.rotation.y=Math.PI,T.rotation.x=Math.PI,u.add(T);const L=new j(g,R);L.scale.set(.2,.2,.25),L.position.set(.5,-.3,.4),L.rotation.y=Math.PI,L.rotation.x=Math.PI,u.add(L);const D=new j(g,b);D.scale.set(.25,.25,.27),D.position.set(.4,.3,-.2),D.rotation.y=Math.PI,D.rotation.x=Math.PI,u.add(D);const U=new We(.35,32,32),Y=new j(U,R);Y.scale.set(.75,1.25,.65),Y.position.set(-.7,-.15,.2),u.add(Y);const K=new j(U,I);K.scale.set(.75,1.25,.65),K.position.set(.7,-.15,.2),u.add(K);const S=new ji(.2,.22,.6,32),v=new j(S,E);v.position.set(-.4,-1.05,0),u.add(v);const C=new j(S,N);C.position.set(.4,-1.05,0),u.add(C);const V=new We(.3,32,32),B=new j(V,E);B.scale.set(1,.72,1.5),B.position.set(-.4,-1.45,.17),u.add(B);const z=new j(V,N);z.scale.set(1,.72,1.5),z.position.set(.4,-1.45,.17),u.add(z);const he=new We(.44,32,32),ce=new j(he,b);ce.position.set(-.15,-.45,-.4),u.add(ce);const pe=new j(he,y);pe.position.set(.15,-.45,-.4),u.add(pe);const Ae=new We(.18,32,32),fe=new j(Ae,b);fe.position.set(0,-.35,-.8),u.add(fe),new Vr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ye){const ee=new It("X",{font:ye,size:.2,depth:.05});new mn({color:0});const se=new j(ee,b);se.position.set(-.3,.99,.53),se.rotation.x=xt.degToRad(-5),se.rotation.y=xt.degToRad(-15),u.add(se);const Me=new It("O",{font:ye,size:.2,depth:.05});new mn({color:0});const Ee=new j(Me,R);Ee.position.set(.14,.99,.53),Ee.rotation.y=xt.degToRad(12),Ee.rotation.x=xt.degToRad(-5),u.add(Ee);const Ve=new It("POP",{font:ye,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),Je=new He({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new He({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const ft=new He({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),$e=new He({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),Qe=new j(Ve,Je);Qe.scale.set(.15,.15,.15),Qe.position.set(.03,1.16,.1),Qe.rotateZ(-25),u.add(Qe);const dt=new j(Ve,P);dt.scale.set(.14,.14,.14),dt.rotateZ(45),dt.position.set(.2,-.7,.3),u.add(dt);const bt=new j(Ve,ft);bt.scale.set(.14,.14,.14),bt.rotateZ(45),bt.rotateY(45),bt.position.set(.3,.7,.3),u.add(bt);const Zt=new j(Ve,ft);Zt.scale.set(.15,.15,.15),Zt.rotateZ(45),Zt.rotateY(45),Zt.position.set(.35,-1.5,.3),u.add(Zt);const At=new j(Ve,$e);At.scale.set(.17,.17,.17),At.rotateZ(45),At.rotateY(15),At.position.set(.35,1,.3),u.add(At)}),fe.renderOrder=1,u.scale.set(1.35,1.35,1.35),l.add(u),u.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),c.position.set(e.bodyPosition.x,1,e.cameraPosition),c.lookAt(e.bodyPosition.x,0,0),c.position.z=4;const Pe=()=>{u.rotation.y,u.rotation.x},Te=()=>{s.value=!0,r.value=!1,o.value=!1},be=()=>{s.value=!1,r.value=!0,o.value=!1},Ge=()=>{s.value=!1,r.value=!1,Pe()},De=ye=>{const ee=window.innerWidth/2;ye>ee?Te():be(),Pe()},Fe=ye=>{clearTimeout(i),Ge(),o.value=!0;const ee={x:ye.clientX/window.innerWidth*2-1,y:-(ye.clientY/window.innerHeight)*2+1};if(o.value){const se=ee.x*Math.PI*.2,Me=ee.y*Math.PI*.2;u.rotation.y=se,u.rotation.x=Me}i=setTimeout(()=>{o.value=!1,De(ye.clientX)},1e5)};window.addEventListener("mousemove",Fe);const F=ye=>{if(o.value){const ee={x:ye.clientX/window.innerWidth*2-1,y:-(ye.clientY/window.innerHeight)*2+1},se=ee.x*Math.PI*.2,Me=ee.y*Math.PI*.2;u.rotation.y=se,u.rotation.x=Me}};window.addEventListener("mousemove",F),a(),Jt(()=>e.bodyPosition,ye=>{u.position.set(ye.x,ye.y,ye.z)}),Jt(()=>e.cameraPosition,ye=>{c.position.set(e.bodyPosition.x,1,ye),c.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{c.aspect=window.innerWidth/window.innerHeight,c.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,l)=>(zs(),Hs("div",{ref_key:"threeCanvas",ref:t,class:Mi(n.background?"no-bg":"three-canvas")},null,2))}}),VE=Gs(GE,[["__scopeId","data-v-f9728be4"]]),kE={class:"pixel-controls"},WE={class:"side-buttons"},XE=Ei({__name:"PopBear2",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=gt(null);let i=gt(!1),s=gt(!1),r=gt(!1),o=gt(!1);$i(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),M.render(p,_)};const p=new Or,_=new Ot(75,window.innerWidth/window.innerHeight,.1,1e3),M=new Nr({antialias:!0,alpha:!0});M.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(M.domElement);const d=new ct,m=new Gr(16777215,2);p.add(m);const b=new Hr(16777215,4);b.position.set(5,5,5),p.add(b);const y=new zr(16777215,5,50);y.position.set(0,2,4),p.add(y);const E=new Br,N=E.load("/3d-bear-arts/assets/popbear.jpg"),P=E.load("/3d-bear-arts/assets/popbear.jpg");N.wrapS=N.wrapT=cn,P.wrapS=P.wrapT=cn,P.repeat.set(2,2);const R=new He({color:16738740,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),I=new He({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),ne=new He({color:16766720,map:N,metalness:.3,roughness:.5}),x=new He({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),w=new He({color:9055202,map:N,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new He({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht});const $=new He({color:65535,map:N,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),q=new He({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),Z=new We(1,32,32,0,Math.PI),re=new j(Z,I),G=new j(Z,R);re.scale.set(.85,.85,.8),G.scale.set(.85,.85,.8),re.position.y=-.2,G.position.y=-.2,re.rotation.y=Math.PI/2,G.rotation.y=Math.PI*1.5;const J=new Ft(1,32),W=new j(J,R);W.scale.set(.85,.85,.8),W.position.set(0,-.2,0),W.rotation.y=Math.PI/2;const me=new ct;me.add(re),me.add(G),me.add(W),d.add(me);const _e=new We(.6,32,32,0,Math.PI),ge=new j(_e,ne);ge.scale.set(1,.95,.95),ge.position.set(0,1,0),ge.rotation.y=Math.PI*1.5;const Le=new j(_e,x);Le.scale.set(1,.95,.95),Le.position.set(0,1,0),Le.rotation.y=Math.PI/2;const Oe=new Ft(.6,32),ae=new j(Oe,ne);ae.position.set(0,1,0),ae.rotation.y=Math.PI/2,ae.scale.set(1,.95,.95);const de=new ct;de.add(ge),de.add(Le),de.add(ae),d.add(de);const xe=new We(.25,32,32),O=new j(xe,R);O.position.set(-.45,1.35,-.1),d.add(O);const le=new j(xe,I);le.position.set(.45,1.35,-.1),d.add(le);const oe=new We(.25,32,32,Math.PI/2,Math.PI),ue=new j(oe,ne);ue.scale.set(1.1,.6,.8),ue.position.set(0,.84,.5),ue.rotation.y=Math.PI;const Se=new We(.25,32,32,Math.PI/2,Math.PI),Q=new j(Se,x);Q.scale.set(1.1,.6,.8),Q.position.set(0,.84,.5),Q.rotation.y=0;const g=new Ft(.25,32),T=new j(g,ne);T.scale.set(.8,.6,.8),T.position.set(0,.84,.5),T.rotation.y=Math.PI/2;const L=new ct;L.add(ue),L.add(Q),L.add(T),d.add(L);const D=new Qn;D.moveTo(0,0),D.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),D.bezierCurveTo(-.6,.3,0,.6,0,1),D.bezierCurveTo(0,.6,.6,.3,.6,0),D.bezierCurveTo(.6,-.3,0,-.3,0,0);const U={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},Y=new bi(D,U),K=new j(Y,ne);K.scale.set(.5,.5,.5),K.position.set(.35,0,0),K.rotation.y=Math.PI,K.rotation.x=Math.PI,d.add(K);const S=new j(Y,$);S.scale.set(.2,.2,.25),S.position.set(.5,-.3,.4),S.rotation.y=Math.PI,S.rotation.x=Math.PI,d.add(S);const v=new j(Y,R);v.scale.set(.25,.25,.27),v.position.set(.4,.3,-.2),v.rotation.y=Math.PI,v.rotation.x=Math.PI,d.add(v);const C=new We(.35,32,32),V=new j(C,$);V.scale.set(.75,1.25,.65),V.position.set(-.7,-.15,.2),d.add(V);const B=new j(C,q);B.scale.set(.75,1.25,.65),B.position.set(.7,-.15,.2),d.add(B);const z=new ji(.2,.22,.6,32),he=new j(z,ne);he.position.set(-.4,-1.05,0),d.add(he);const ce=new j(z,x);ce.position.set(.4,-1.05,0),d.add(ce);const pe=new We(.3,32,32),Ae=new j(pe,ne);Ae.scale.set(1,.72,1.5),Ae.position.set(-.4,-1.45,.17),d.add(Ae);const fe=new j(pe,x);fe.scale.set(1,.72,1.5),fe.position.set(.4,-1.45,.17),d.add(fe);const ve=new We(.44,32,32),Pe=new j(ve,R);Pe.position.set(-.15,-.45,-.4),d.add(Pe);const Te=new j(ve,I);Te.position.set(.15,-.45,-.4),d.add(Te);const be=new We(.18,32,32),Ge=new j(be,R);Ge.position.set(0,-.35,-.8),d.add(Ge),new Vr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Fe){const F=new It("X",{font:Fe,size:.2,depth:.05});new mn({color:0});const ye=new j(F,R);ye.position.set(-.3,.99,.53),ye.rotation.x=xt.degToRad(-5),ye.rotation.y=xt.degToRad(-15),d.add(ye);const ee=new It("O",{font:Fe,size:.2,depth:.05});new mn({color:0});const se=new j(ee,$);se.position.set(.14,.99,.53),se.rotation.y=xt.degToRad(12),se.rotation.x=xt.degToRad(-5),d.add(se);const Me=new It("POP",{font:Fe,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),Ee=new He({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new He({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const Ve=new He({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),Je=new He({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),ft=new j(Me,Ee);ft.scale.set(.15,.15,.15),ft.position.set(.03,1.16,.1),ft.rotateZ(-25),d.add(ft);const $e=new j(Me,w);$e.scale.set(.14,.14,.14),$e.rotateZ(45),$e.position.set(.2,-.7,.3),d.add($e);const Qe=new j(Me,Ve);Qe.scale.set(.14,.14,.14),Qe.rotateZ(45),Qe.rotateY(45),Qe.position.set(.3,.7,.3),d.add(Qe);const dt=new j(Me,Ve);dt.scale.set(.15,.15,.15),dt.rotateZ(45),dt.rotateY(45),dt.position.set(.35,-1.5,.3),d.add(dt);const bt=new j(Me,Je);bt.scale.set(.17,.17,.17),bt.rotateZ(45),bt.rotateY(15),bt.position.set(.35,1,.3),d.add(bt)}),Ge.renderOrder=1,d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,f(),Jt(()=>e.bodyPosition,Fe=>{d.position.set(Fe.x,Fe.y,Fe.z)}),Jt(()=>e.cameraPosition,Fe=>{_.position.set(e.bodyPosition.x,1,Fe),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),M.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(zs(),Hs(fn,null,[_t("div",{ref_key:"threeCanvas",ref:t,class:Mi(n.background?"no-bg":"three-canvas")},null,2),_t("div",kE,[_t("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),_t("div",WE,[_t("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),_t("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),_t("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),qE=Gs(XE,[["__scopeId","data-v-67caa51b"]]),YE={class:"pixel-controls"},$E={class:"side-buttons"},KE=Ei({__name:"PopArtBear3",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=gt(null);let i=gt(!1),s=gt(!1),r=gt(!1),o=gt(!1);$i(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),M.render(p,_)};const p=new Or,_=new Ot(75,window.innerWidth/window.innerHeight,.1,1e3),M=new Nr({antialias:!0,alpha:!0});M.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(M.domElement);const d=new ct,m=new ct;p.add(m);const b=new Gr(16777215,2);p.add(b);const y=new Hr(16777215,4);y.position.set(5,5,5),p.add(y);const E=new zr(16777215,5,50);E.position.set(0,2,4),p.add(E);const N=new Br,P=N.load("/3d-bear-arts/assets/pop6.jpg"),R=N.load("/3d-bear-arts/assets/pop7.jpg");P.wrapS=P.wrapT=cn,R.wrapS=R.wrapT=cn,R.repeat.set(2,2);const I=new He({color:16738740,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),ne=new He({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),x=new He({color:16766720,map:P,metalness:.3,roughness:.5}),w=new He({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),$=new He({color:9055202,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new He({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht});const q=new He({color:65535,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Z=new He({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),re=new We(1,32,32,0,Math.PI),G=new j(re,ne),J=new j(re,I);G.scale.set(.85,.85,.8),J.scale.set(.85,.85,.8),G.position.y=-.2,J.position.y=-.2,G.rotation.y=Math.PI/2,J.rotation.y=Math.PI*1.5;const W=new Ft(1,32),me=new j(W,I);me.scale.set(.85,.85,.8),me.position.set(0,-.2,0),me.rotation.y=Math.PI/2;const _e=new ct;_e.add(G),_e.add(J),_e.add(me),d.add(_e);const ge=new We(.6,32,32,0,Math.PI),Le=new j(ge,x);Le.scale.set(1,.95,.95),Le.position.set(0,1,0),Le.rotation.y=Math.PI*1.5;const Oe=new j(ge,w);Oe.scale.set(1,.95,.95),Oe.position.set(0,1,0),Oe.rotation.y=Math.PI/2;const ae=new Ft(.6,32),de=new j(ae,x);de.position.set(0,1,0),de.rotation.y=Math.PI/2,de.scale.set(1,.95,.95);const xe=new ct;xe.add(Le),xe.add(Oe),xe.add(de),d.add(xe);const O=new We(.25,32,32),le=new j(O,I);le.position.set(-.45,1.35,-.1),d.add(le);const oe=new j(O,ne);oe.position.set(.45,1.35,-.1),d.add(oe);const ue=new We(.25,32,32,Math.PI/2,Math.PI),Se=new j(ue,x);Se.scale.set(1.1,.6,.8),Se.position.set(0,.84,.5),Se.rotation.y=Math.PI;const Q=new We(.25,32,32,Math.PI/2,Math.PI),g=new j(Q,w);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=0;const T=new Ft(.25,32),L=new j(T,x);L.scale.set(.8,.6,.8),L.position.set(0,.84,.5),L.rotation.y=Math.PI/2;const D=new ct;D.add(Se),D.add(g),D.add(L),d.add(D);const U=new Qn;U.moveTo(0,0),U.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),U.bezierCurveTo(-.6,.3,0,.6,0,1),U.bezierCurveTo(0,.6,.6,.3,.6,0),U.bezierCurveTo(.6,-.3,0,-.3,0,0);const Y={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},K=new bi(U,Y),S=new j(K,x);S.scale.set(.5,.5,.5),S.position.set(.35,0,0),S.rotation.y=Math.PI,S.rotation.x=Math.PI,d.add(S);const v=new j(K,q);v.scale.set(.2,.2,.25),v.position.set(.5,-.3,.4),v.rotation.y=Math.PI,v.rotation.x=Math.PI,d.add(v);const C=new j(K,I);C.scale.set(.25,.25,.27),C.position.set(.4,.3,-.2),C.rotation.y=Math.PI,C.rotation.x=Math.PI,d.add(C);const V=new We(.35,32,32),B=new j(V,q);B.scale.set(.75,1.25,.65),B.position.set(-.7,-.15,.2),d.add(B);const z=new j(V,Z);z.scale.set(.75,1.25,.65),z.position.set(.7,-.15,.2),d.add(z);const he=new ji(.2,.22,.6,32),ce=new j(he,x);ce.position.set(-.4,-1.05,0),d.add(ce);const pe=new j(he,w);pe.position.set(.4,-1.05,0),d.add(pe);const Ae=new We(.3,32,32),fe=new j(Ae,x);fe.scale.set(1,.72,1.5),fe.position.set(-.4,-1.45,.17),d.add(fe);const ve=new j(Ae,w);ve.scale.set(1,.72,1.5),ve.position.set(.4,-1.45,.17),d.add(ve);const Pe=new We(.44,32,32),Te=new j(Pe,I);Te.position.set(-.15,-.45,-.4),d.add(Te);const be=new j(Pe,ne);be.position.set(.15,-.45,-.4),d.add(be);const Ge=new We(.18,32,32),De=new j(Ge,I);De.position.set(0,-.35,-.8),d.add(De),new Vr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(F){const ye=new It("X",{font:F,size:.2,depth:.05});new mn({color:0});const ee=new j(ye,I);ee.position.set(-.3,.99,.53),ee.rotation.x=xt.degToRad(-5),ee.rotation.y=xt.degToRad(-15),d.add(ee);const se=new It("O",{font:F,size:.2,depth:.05});new mn({color:0});const Me=new j(se,q);Me.position.set(.14,.99,.53),Me.rotation.y=xt.degToRad(12),Me.rotation.x=xt.degToRad(-5),d.add(Me);const Ee=new It("POP",{font:F,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});new It("🐻",{font:F,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});const Ve=new It("BAO      BEAR",{font:F,size:2,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:3}),Je=new He({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new He({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const ft=new He({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),$e=new He({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),Qe=new j(Ee,Je);Qe.scale.set(.15,.15,.15),Qe.position.set(.02,1.16,.1),Qe.rotateZ(-25),d.add(Qe);const dt=new j(Ee,$);dt.scale.set(.14,.14,.14),dt.rotateZ(45),dt.position.set(.2,-.7,.3),d.add(dt);const bt=new j(Ee,ft);bt.scale.set(.14,.14,.14),bt.rotateZ(45),bt.rotateY(45),bt.position.set(.3,.7,.3),d.add(bt);const Zt=new j(Ee,ft);Zt.scale.set(.15,.15,.15),Zt.rotateZ(45),Zt.rotateY(45),Zt.position.set(.35,-1.5,.3),d.add(Zt);const At=new j(Ee,$e);At.scale.set(.17,.17,.17),At.rotateZ(45),At.rotateY(15),At.position.set(.35,1,.3),d.add(At);const Ti=new j(Ve,Je);Ti.scale.set(.7,.7,.7),Ti.position.set(-6,0,-3),m.add(Ti)}),De.renderOrder=1,d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,f(),Jt(()=>e.bodyPosition,F=>{d.position.set(F.x,F.y,F.z)}),Jt(()=>e.cameraPosition,F=>{_.position.set(e.bodyPosition.x,1,F),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),M.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(zs(),Hs(fn,null,[_t("div",{ref_key:"threeCanvas",ref:t,class:Mi(n.background?"no-bg":"three-canvas")},null,2),_t("div",YE,[_t("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),_t("div",$E,[_t("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),_t("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),_t("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),jE=Gs(KE,[["__scopeId","data-v-366e4a40"]]),ZE={class:"pixel-controls"},JE={class:"side-buttons"},QE=Ei({__name:"MetalMachineBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=gt(null);let i=gt(!1),s=gt(!1),r=gt(!1),o=gt(!1);$i(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),M.render(p,_)};const p=new Or,_=new Ot(75,window.innerWidth/window.innerHeight,.1,1e3),M=new Nr({antialias:!0,alpha:!0});M.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(M.domElement);const d=new ct,m=new ct;p.add(m);const b=new Gr(16777215,2);p.add(b);const y=new Hr(16777215,4);y.position.set(5,5,5),p.add(y);const E=new zr(16777215,5,50);E.position.set(0,2,4),p.add(E);const N=new Br,P=N.load("/3d-bear-arts/assets/metal.jpg"),R=N.load("/3d-bear-arts/assets/pop7.jpg");P.wrapS=P.wrapT=cn,R.wrapS=R.wrapT=cn,R.repeat.set(2,2);const I=new Kd({color:13882323,metalness:.9,roughness:.2,map:P}),ne=new He({color:12632256,metalness:1,roughness:.3,clearcoat:.5,clearcoatRoughness:.1,map:P,transparent:!0,opacity:.4});new He({color:16738740,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new He({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),new He({color:16766720,map:P,metalness:.3,roughness:.5}),new He({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),new He({color:9055202,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new He({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht}),new He({color:65535,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new He({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ht});const x=new We(1,32,32,0,Math.PI),w=new j(x,ne),$=new j(x,I);w.scale.set(.85,.85,.8),$.scale.set(.85,.85,.8),w.position.y=-.2,$.position.y=-.2,w.rotation.y=Math.PI/2,$.rotation.y=Math.PI*1.5;const q=new Ft(1,32),Z=new j(q,I);Z.scale.set(.85,.85,.8),Z.position.set(0,-.2,0),Z.rotation.y=Math.PI/2;const re=new ct;re.add(w),re.add($),re.add(Z),d.add(re);const G=new We(.6,32,32,0,Math.PI),J=new j(G,I);J.scale.set(1,.95,.95),J.position.set(0,1,0),J.rotation.y=Math.PI*1.5;const W=new j(G,ne);W.scale.set(1,.95,.95),W.position.set(0,1,0),W.rotation.y=Math.PI/2;const me=new Ft(.6,32),_e=new j(me,I);_e.position.set(0,1,0),_e.rotation.y=Math.PI/2,_e.scale.set(1,.95,.95);const ge=new ct;ge.add(J),ge.add(W),ge.add(_e),d.add(ge);const Le=new We(.25,32,32),Oe=new j(Le,I);Oe.position.set(-.45,1.35,-.1),d.add(Oe);const ae=new j(Le,ne);ae.position.set(.45,1.35,-.1),d.add(ae);const de=new We(.25,32,32,Math.PI/2,Math.PI),xe=new j(de,I);xe.scale.set(1.1,.6,.8),xe.position.set(0,.84,.5),xe.rotation.y=Math.PI;const O=new We(.25,32,32,Math.PI/2,Math.PI),le=new j(O,ne);le.scale.set(1.1,.6,.8),le.position.set(0,.84,.5),le.rotation.y=0;const oe=new Ft(.25,32),ue=new j(oe,I);ue.scale.set(.8,.6,.8),ue.position.set(0,.84,.5),ue.rotation.y=Math.PI/2;const Se=new ct;Se.add(xe),Se.add(le),Se.add(ue),d.add(Se);const Q=new Qn;Q.moveTo(0,0),Q.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Q.bezierCurveTo(-.6,.3,0,.6,0,1),Q.bezierCurveTo(0,.6,.6,.3,.6,0),Q.bezierCurveTo(.6,-.3,0,-.3,0,0);const g={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},T=new bi(Q,g),L=new j(T,I);L.scale.set(.5,.5,.5),L.position.set(.35,0,0),L.rotation.y=Math.PI,L.rotation.x=Math.PI,d.add(L);const D=new j(T,I);D.scale.set(.2,.2,.25),D.position.set(.5,-.3,.4),D.rotation.y=Math.PI,D.rotation.x=Math.PI,d.add(D);const U=new j(T,I);U.scale.set(.25,.25,.27),U.position.set(.4,.3,-.2),U.rotation.y=Math.PI,U.rotation.x=Math.PI,d.add(U);const Y=new We(.35,32,32),K=new j(Y,I);K.scale.set(.75,1.25,.65),K.position.set(-.7,-.15,.2),d.add(K);const S=new j(Y,ne);S.scale.set(.75,1.25,.65),S.position.set(.7,-.15,.2),d.add(S);const v=new ji(.2,.22,.6,32),C=new j(v,I);C.position.set(-.4,-1.05,0),d.add(C);const V=new j(v,ne);V.position.set(.4,-1.05,0),d.add(V);const B=new We(.3,32,32),z=new j(B,I);z.scale.set(1,.72,1.5),z.position.set(-.4,-1.45,.17),d.add(z);const he=new j(B,ne);he.scale.set(1,.72,1.5),he.position.set(.4,-1.45,.17),d.add(he);const ce=new We(.44,32,32),pe=new j(ce,I);pe.position.set(-.15,-.45,-.4),d.add(pe);const Ae=new j(ce,ne);Ae.position.set(.15,-.45,-.4),d.add(Ae);const fe=new We(.18,32,32),ve=new j(fe,I);ve.position.set(0,-.35,-.8),d.add(ve),new Vr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Te){const be=new It("X",{font:Te,size:.2,depth:.05});new mn({color:0});const Ge=new j(be,I);Ge.position.set(-.3,.99,.53),Ge.rotation.x=xt.degToRad(-5),Ge.rotation.y=xt.degToRad(-15),d.add(Ge);const De=new It("O",{font:Te,size:.2,depth:.05});new mn({color:0});const Fe=new j(De,I);Fe.position.set(.14,.99,.53),Fe.rotation.y=xt.degToRad(12),Fe.rotation.x=xt.degToRad(-5),d.add(Fe),new It("POP",{font:Te,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),new It("🐻",{font:Te,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),new It("BAO      BEAR",{font:Te,size:2,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:3}),new He({color:16716947,metalness:.3,roughness:.6,clearcoat:.2}),new He({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),new He({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),new He({color:16753920,metalness:.3,roughness:.6,clearcoat:.2})}),ve.renderOrder=1,d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,f(),Jt(()=>e.bodyPosition,Te=>{d.position.set(Te.x,Te.y,Te.z)}),Jt(()=>e.cameraPosition,Te=>{_.position.set(e.bodyPosition.x,1,Te),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),M.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(zs(),Hs(fn,null,[_t("div",{ref_key:"threeCanvas",ref:t,class:Mi(n.background?"no-bg":"three-canvas")},null,2),_t("div",ZE,[_t("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),_t("div",JE,[_t("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),_t("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),_t("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),ew=Gs(QE,[["__scopeId","data-v-6a0bfde7"]]),tw=[{path:"/3d-bear-arts/leather",name:"Leather",component:HE},{path:"/3d-bear-arts/pop-art",name:"Pop",component:VE},{path:"/3d-bear-arts/pop-art-bear",name:"PopArtBear 2",component:qE},{path:"/3d-bear-arts/pop-art-bear-3",name:"PopArtBear 3",component:jE},{path:"/3d-bear-arts",name:"MetalMachineBear",component:ew}],nw=L0({history:a0(),routes:tw}),Zd=bg(Pg);Zd.use(nw);Zd.mount("#app");
