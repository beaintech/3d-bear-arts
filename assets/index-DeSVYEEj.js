...
`)a=0,l-=s;else{const h=FE(u,r,a,l,t);a+=h.offsetX,o.push(h.path)}}return o}function FE(n,e,t,i,r){const s=r.glyphs[n]||r.glyphs["?"];if(!s){console.error('THREE.Font: character "'+n+'" does not exists in font family '+r.familyName+".");return}const o=new DE;let a,l,c,u,h,f,d,_;if(s.o){const x=s._cachedOutline||(s._cachedOutline=s.o.split(" "));for(let m=0,p=x.length;m<p;)switch(x[m++]){case"m":a=x[m++]*e+t,l=x[m++]*e+i,o.moveTo(a,l);break;case"l":a=x[m++]*e+t,l=x[m++]*e+i,o.lineTo(a,l);break;case"q":c=x[m++]*e+t,u=x[m++]*e+i,h=x[m++]*e+t,f=x[m++]*e+i,o.quadraticCurveTo(h,f,c,u);break;case"b":c=x[m++]*e+t,u=x[m++]*e+i,h=x[m++]*e+t,f=x[m++]*e+i,d=x[m++]*e+t,_=x[m++]*e+i,o.bezierCurveTo(h,f,d,_,c,u);break}}return{offsetX:s.ha*e,path:o}}class Ms extends Sn{constructor(e,t={}){const i=t.font;if(i===void 0)super();else{const r=i.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(r,t)}this.type="TextGeometry"}}const OE=Yn({__name:"PinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Vn(null);return Nr(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.03,o.render(r,s)};const r=new Cs,s=new Et(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Rs({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),e.background?o.setClearColor(8900346):o.setClearColor(0,0),o.toneMapping=Wo,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Ls(16777215,.6);r.add(a);const l=new Ps(16777215,1.5);l.position.set(5,5,5),r.add(l);const c=new Bc(16777215,2,50);c.position.set(0,2,4),r.add(c);const u=new Gt({uniforms:{time:{value:0},color1:{value:new qe(16766720)},color2:{value:new qe(16007990)}},vertexShader:`
        ...
        `,f=new Gt({vertexShader:u,fragmentShader:h}),d=new Gi({color:16738740,metalness:-.8,roughness:.7}),_=new Gi({color:65535,metalness:.4,roughness:.7}),x=new Gn,m=new Ge(1,32,32),p=new me(m,f);p.scale.set(.85,.85,.8),p.position.y=-.2,x.add(p);const T=new Ge(.6,32,32),y=new me(T,f);y.position.set(0,1,0),x.add(y);const S=new Ge(.25,32,32),I=new me(S,d);I.position.set(-.45,1.35,-.1),x.add(I);const P=new me(S,_);P.position.set(.45,1.35,-.1),x.add(P);const R=new Ge(.25,32,32),D=new me(R,f);D.scale.set(1,.6,.8),D.position.set(0,.85,.5),x.add(D);const se=new Ge(.35,32,32),M=new me(se,d);M.scale.set(.75,1.25,.65),M.position.set(-.7,-.15,.2),x.add(M);const b=new me(se,_);b.scale.set(.75,1.25,.65),b.position.set(.7,-.15,.2),x.add(b);const Y=new Yi(.2,.22,.6,32),X=new me(Y,d);X.position.set(-.4,-1.05,0),x.add(X);const Z=new me(Y,_);Z.position.set(.4,-1.05,0),x.add(Z);const re=new Ge(.3,32,32),k=new me(re,d);k.scale.set(1,.72,1.5),k.position.set(-.4,-1.45,.17),x.add(k);const K=new me(re,_);K.scale.set(1,.72,1.5),K.position.set(.4,-1.45,.17),x.add(K);const z=new Ge(.44,32,32),pe=new me(z,d);pe.position.set(-.15,-.45,-.4),x.add(pe);const de=new me(z,_);de.position.set(.15,-.45,-.4),x.add(de);const _e=new Ge(.18,32,32),Ae=new me(_e,f);Ae.position.set(0,-.35,-.8),x.add(Ae),new zc().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function($){const le=new Ms("X",{font:$,size:.18,depth:.05}),ye=new Xn({color:0}),ee=new me(le,ye);ee.position.set(-.3,.95,.53),ee.rotation.x=ri.degToRad(-5),ee.rotation.y=ri.degToRad(-15),x.add(ee);const g=new Ms("+",{font:$,size:.25,depth:.1}),A=new Xn({color:0}),L=new me(g,A);L.position.set(.14,.95,.5),L.rotation.y=ri.degToRad(12),L.rotation.x=ri.degToRad(-5),x.add(L)});const ne=new hn;ne.moveTo(0,0),ne.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),ne.bezierCurveTo(-.6,.3,0,.6,0,1),ne.bezierCurveTo(0,.6,.6,.3,.6,0),ne.bezierCurveTo(.6,-.3,0,-.3,0,0);const fe={depth:.05,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.05,bevelThickness:.05},ve=new Sn(ne,fe),U=new Xn({color:0}),ie=new me(ve,U);ie.scale.set(.1,.1,.1),ie.rotation.z=ri.degToRad(210),ie.rotation.x=ri.degToRad(5),ie.rotation.y=ri.degToRad(-45),ie.position.set(-.4,.9,.45),x.add(ie),r.add(x),i(),s.position.set(0,1,4),s.lookAt(0,0,0),x.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),s.position.set(t.bodyPosition.x,1,t.cameraPosition),s.lookAt(t.bodyPosition.x,0,0),Mn(()=>t.bodyPosition,$=>{x.position.set($.x,$.y,$.z)}),Mn(()=>t.cameraPosition,$=>{s.position.set(t.bodyPosition.x,1,$),s.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(Vi(),Wi("div",{ref_key:"threeContainer",ref:e,class:Ur(n.background?"no-bg":"three-container")},null,2))}}),Zd=Xi(zE,[["__scopeId","data-v-28cc8f47"]]),HE={class:"flex"},GE=Yn({__name:"ThreeScene",setup(n){return Vn(!1),Vn({x:0,y:0,z:0}),Vn(4),(e,t)=>(Vi(),Wi("div",HE,[dt(Kd,{background:!0,cameraPosition:8,bodyPosition:{x:-15,y:0,z:0},class:"bear-page"}),dt(jd,{background:!0,cameraPosition:8,bodyPosition:{x:-15,y:0,z:0},class:"bear-page"}),dt(Zd,{background:!0,cameraPosition:8,bodyPosition:{x:-18,y:0,z:0},class:"bear-page"})]))}}),kE=Xi(GE,[["__scopeId","data-v-9c0f8cfa"]]),VE=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,XE=Yn({__name:"DiamondBear",setup(n){const e=Vn(null);return Nr(()=>{const t=new Cs,i=new Et(75,window.innerWidth/window.innerHeight,.1,1e3),r=new Rs({antialias:!0,alpha:!0});r.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(r.domElement);const s=new Ls(16777215,5);t.add(s);const o=new Ps(16777215,20);o.position.set(5,5,5),t.add(o);const a=new Gt({uniforms:{time:{value:0}},vertexShader:VE,fragmentShader:WE,transparent:!0,opacity:.1}),l=new Gn,c=new Ge(1,32,32),u=new me(c,a);u.scale.set(.85,.85,.8),u.position.y=-.2,l.add(u);const h=new Ge(.6,32,32),f=new me(h,a);f.scale.set(1,.95,.95),f.position.set(0,1,0),l.add(f);const d=new Ge(.25,32,32),_=new me(d,a);_.position.set(-.45,1.35,-.1),l.add(_);const x=new me(d,a);x.position.set(.45,1.35,-.1),l.add(x);const m=new Ge(.25,32,32),p=new me(m,a);p.scale.set(1,.6,.8),p.position.set(0,.85,.5),l.add(p);const T=new Ge(.35,32,32),y=new me(T,a);y.scale.set(.75,1.25,.65),y.position.set(-.7,-.15,.2),l.add(y);const S=new me(T,a);S.scale.set(.75,1.25,.65),S.position.set(.7,-.15,.2),l.add(S);const I=new Ge(.3,32,32),P=new me(I,a);P.scale.set(1,.72,1.5),P.position.set(-.4,-1.45,.17),l.add(P);const R=new me(I,a);R.scale.set(1,.72,1.5),R.position.set(.4,-1.45,.17),l.add(R);const D=new Yi(.2,.22,.6,32),se=new me(D,a);se.position.set(-.4,-1.05,0),l.add(se);const M=new me(D,a);M.position.set(.4,-1.05,0),l.add(M);const b=new Ge(.44,32,32),Y=new me(b,a);Y.position.set(-.15,-.45,-.4),l.add(Y);const X=new me(b,a);X.position.set(.15,-.45,-.4),l.add(X);const Z=new Ge(.18,32,32),re=new me(Z,a);re.position.set(0,-.35,-.75),l.add(re);const k=new Gi({color:16738740,metalness:1,roughness:.44}),K=new Gi({color:16776960,metalness:1,roughness:.44}),z=new hn;z.moveTo(0,.15),z.lineTo(.1,0),z.lineTo(0,-.15),z.lineTo(-.1,0),z.lineTo(0,.15);const pe={depth:.07,bevelEnabled:!1},de=new Sn(z,pe),_e=new me(de,k);_e.position.set(-.25,1,.5),_e.rotation.y=Math.PI/30,l.add(_e);const Ae=new me(de,K);Ae.position.set(.25,1,.5),Ae.rotation.y=Math.PI/30,l.add(Ae),t.add(l),i.position.set(0,1,4),i.lookAt(0,0,0);function Be(){requestAnimationFrame(Be),a.uniforms.time.value+=.1,l.rotation.y+=.02,r.render(t,i)}Be(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(Vi(),Wi("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),qE=Xi(XE,[["__scopeId","data-v-a7796925"]]),Yh=`
  varying vec2 vUv;
        void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `,YE=Yn({__name:"GlassBear",setup(n){const e=Vn(null);return Nr(()=>{const t=new Cs,i=new Et(75,window.innerWidth/window.innerHeight,.1,1e3),r=new Rs({antialias:!0,alpha:!0});r.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(r.domElement);const s=new Ls(16777215,.5);t.add(s);const o=new Ps(16777215,10);o.position.set(5,5,5),t.add(o);const a=new Gt({uniforms:{time:{value:0},opacity:{value:.8}},vertexShader:Yh,fragmentShader:$h,transparent:!0}),l=new Gt({uniforms:{time:{value:0},opacity:{value:.6}},vertexShader:Yh,fragmentShader:$h,transparent:!0,depthWrite:!1}),c=new Gn,u=new Ge(1,32,32),h=new me(u,l);h.scale.set(.85,.85,.8),h.position.y=-.2,c.add(h);const f=new Ge(.6,32,32),d=new me(f,l);d.scale.set(1,.95,.95),d.position.set(0,1,0),c.add(d);const _=new Ge(.25,32,32),x=new me(_,a);x.position.set(-.45,1.35,-.1),c.add(x);const m=new me(_,l);m.position.set(.45,1.35,-.1),c.add(m);const p=new Ge(.25,32,32),T=new me(p,a);T.scale.set(1,.6,.8),T.position.set(0,.85,.5),c.add(T);const y=new Ge(.35,32,32),S=new me(y,a);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),c.add(S);const I=new me(y,a);I.scale.set(.75,1.25,.65),I.position.set(.7,-.15,.2),c.add(I);const P=new Ge(.3,32,32),R=new me(P,a);R.scale.set(1,.72,1.5),R.position.set(-.4,-1.45,.17),c.add(R);const D=new me(P,a);D.scale.set(1,.72,1.5),D.position.set(.4,-1.45,.17),c.add(D);const se=new Yi(.2,.22,.6,32),M=new me(se,a);M.position.set(-.4,-1.05,0),c.add(M);const b=new me(se,a);b.position.set(.4,-1.05,0),c.add(b);const Y=new Ge(.44,32,32);new me(Y,a).position.set(-.15,-.45,-.4),new me(Y,a).position.set(.15,-.45,-.4);const re=new Ge(.18,32,32),k=new me(re,a);k.position.set(0,-.35,-.75),c.add(k);const K=new hn;K.moveTo(0,0),K.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),K.bezierCurveTo(-.6,.3,0,.6,0,1),K.bezierCurveTo(0,.6,.6,.3,.6,0),K.bezierCurveTo(.6,-.3,0,-.3,0,0);const z=new Gi({color:8900331,metalness:1,roughness:.44}),pe=new Gi({color:16776960,metalness:1,roughness:.44}),de=new hn;de.moveTo(0,.15),de.lineTo(.1,0),de.lineTo(0,-.15),de.lineTo(-.1,0),de.lineTo(0,.15);const _e={depth:.07,bevelEnabled:!1},Ae=new Sn(de,_e),Be=new me(Ae,z);Be.position.set(-.25,1,.5),Be.rotation.y=Math.PI/30,c.add(Be);const ne=new me(Ae,pe);ne.position.set(.25,1,.5),ne.rotation.y=Math.PI/30,c.add(ne),new fi({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const fe={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ve=new fi({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),U=new Sn(K,fe),ie=new me(U,ve);ie.scale.set(.5,.5,.5),ie.position.set(0,0,0),ie.rotation.y=Math.PI,ie.rotation.x=Math.PI,c.add(ie);const $=new hn;$.moveTo(0,.6),$.lineTo(.3,.3),$.lineTo(.6,0),$.lineTo(.3,-.3),$.lineTo(0,-.6),$.lineTo(-.3,-.3),$.lineTo(-.6,0),$.lineTo(-.3,.3),$.lineTo(0,.6);const le={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ye=new Sn($,le),ee=new fi({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),g=new me(ye,ee);g.scale.set(.5,.5,.5),g.position.set(0,0,0),t.add(c),i.position.set(0,1,4),i.lookAt(0,0,0);const A=()=>{requestAnimationFrame(A),a.uniforms.time.value+=.03,c.rotation.y+=.03,r.render(t,i)};A(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(Vi(),Wi("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),$E=Xi(YE,[["__scopeId","data-v-fa1425bf"]]),KE=[{path:"/3d-bear-arts",name:"ThreeScene",component:kE},{path:"/3d-bear-arts/pink",name:"PinkBear",component:Kd},{path:"/3d-bear-arts/purple",name:"PurpleBear",component:jd},{path:"/3d-bear-arts/pinkBlue",name:"PinkBlueBear",component:Zd},{path:"/3d-bear-arts/diamond",name:"DiamondBear",component:qE},{path:"/3d-bear-arts/glass",name:"GlassBear",component:$E}],jE=L_({history:a_(),routes:KE}),Jd=Tg(Pg);Jd.use(jE);Jd.mount("#app");
