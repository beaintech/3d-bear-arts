...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ms,depthTest:!1,depthWrite:!1})}function cd(){return new on({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Lu(),fragmentShader:`
		...
		`,blending:ms,depthTest:!1,depthWrite:!1})}function ld(){return new on({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Lu(),fragmentShader:`
...
`)+`
`+f);const S=A+m+r,b=A+f+a,B=vd(s,s.VERTEX_SHADER,S),I=vd(s,s.FRAGMENT_SHADER,b);s.attachShader(x,B),s.attachShader(x,I),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(E){if(n.debug.checkShaderErrors){const U=s.getProgramInfoLog(x).trim(),k=s.getShaderInfoLog(B).trim(),et=s.getShaderInfoLog(I).trim();let rt=!0,$=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(rt=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,B,I);else{const nt=_d(s,B,"vertex"),X=_d(s,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
`)a=0,c-=o;else{const u=wS(h,s,a,c,e);a+=u.offsetX,r.push(u.path)}}return r}function wS(n,t,e,i,s){const o=s.glyphs[n]||s.glyphs["?"];if(!o){console.error('THREE.Font: character "'+n+'" does not exists in font family '+s.familyName+".");return}const r=new xS;let a,c,l,h,u,d,p,v;if(o.o){const x=o._cachedOutline||(o._cachedOutline=o.o.split(" "));for(let m=0,f=x.length;m<f;)switch(x[m++]){case"m":a=x[m++]*t+e,c=x[m++]*t+i,r.moveTo(a,c);break;case"l":a=x[m++]*t+e,c=x[m++]*t+i,r.lineTo(a,c);break;case"q":l=x[m++]*t+e,h=x[m++]*t+i,u=x[m++]*t+e,d=x[m++]*t+i,r.quadraticCurveTo(u,d,l,h);break;case"b":l=x[m++]*t+e,h=x[m++]*t+i,u=x[m++]*t+e,d=x[m++]*t+i,p=x[m++]*t+e,v=x[m++]*t+i,r.bezierCurveTo(u,d,p,v,l,h);break}}return{offsetX:o.ha*t,path:r}}class ke extends Hn{constructor(t,e={}){const i=e.font;if(i===void 0)super();else{const s=i.generateShapes(t,e.size);e.depth===void 0&&e.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),e.depth=e.depth!==void 0?e.depth:e.height!==void 0?e.height:50,e.bevelThickness===void 0&&(e.bevelThickness=10),e.bevelSize===void 0&&(e.bevelSize=8),e.bevelEnabled===void 0&&(e.bevelEnabled=!1),super(s,e)}this.type="TextGeometry"}}const SS=Ln({__name:"MetalBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=null,s=jt(!1),o=jt(!1),r=jt(!1);return Vn(()=>{if(e.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:o.value&&(u.rotation.y-=.03),h.render(c,l)};const c=new Gn,l=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),h=new zn({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(h.domElement);const u=new Xt,d=new hi(16777215,2);c.add(d);const p=new ui(16777215,4);p.position.set(5,5,5),c.add(p);const v=new li(16777215,5,50);v.position.set(0,2,4),c.add(v);const x=new jn,m=x.load("/3d-bear-arts/assets/lv2.jpg"),f=x.load("/3d-bear-arts/assets/lv2.jpg");m.wrapS=m.wrapT=$e,f.wrapS=f.wrapT=$e;const A=new Ot({color:8343336,metalness:0,roughness:.8,bumpMap:m,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:f,envMapIntensity:.7}),S=new Ot({color:5978654,metalness:0,roughness:.8,bumpMap:m,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:f,envMapIntensity:.7}),b=new Ot({color:13152668,metalness:.2,roughness:.05,bumpMap:m,bumpScale:.05,clearcoat:1,clearcoatRoughness:.05,map:f,transparent:!0,opacity:.4,transmission:.9,envMapIntensity:1,reflectivity:.9,ior:1.45,side:be});new Ot({color:13421772,metalness:1,roughness:.5,clearcoat:.3,clearcoatRoughness:.3});const B=new ft(1,32,32,0,Math.PI),I=new y(B,b),R=new y(B,A);I.scale.set(.85,.85,.8),R.scale.set(.85,.85,.8),I.position.y=-.2,R.position.y=-.2,I.rotation.y=Math.PI/2,R.rotation.y=Math.PI*1.5;const z=new Ae(1,32),Q=new y(z,A);Q.scale.set(.85,.85,.8),Q.position.set(0,-.2,0),Q.rotation.y=Math.PI/2;const M=new Xt;M.add(I),M.add(R),M.add(Q),u.add(M);const E=new ft(.6,32,32,0,Math.PI),U=new y(E,A);U.scale.set(1,.95,.95),U.position.set(0,1,0),U.rotation.y=Math.PI*1.5;const k=new y(E,b);k.scale.set(1,.95,.95),k.position.set(0,1,0),k.rotation.y=Math.PI/2;const et=new Ae(.6,32),rt=new y(et,A);rt.position.set(0,1,0),rt.rotation.y=Math.PI/2,rt.scale.set(1,.95,.95);const $=new Xt;$.add(U),$.add(k),$.add(rt),u.add($);const nt=new ft(.25,32,32),X=new y(nt,A);X.position.set(-.45,1.35,-.1),u.add(X);const vt=new y(nt,b);vt.position.set(.45,1.35,-.1),u.add(vt);const xt=new ft(.25,32,32,Math.PI/2,Math.PI),wt=new y(xt,S);wt.scale.set(1.1,.6,.8),wt.position.set(0,.84,.5),wt.rotation.y=Math.PI;const Dt=new ft(.25,32,32,Math.PI/2,Math.PI),Wt=new y(Dt,b);Wt.scale.set(1.1,.6,.8),Wt.position.set(0,.84,.5),Wt.rotation.y=0;const at=new Ae(.25,32),pt=new y(at,A);pt.scale.set(.8,.6,.8),pt.position.set(0,.84,.5),pt.rotation.y=Math.PI/2;const bt=new Xt;bt.add(wt),bt.add(Wt),bt.add(pt),u.add(bt);const O=new Cn;O.moveTo(0,0),O.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),O.bezierCurveTo(-.6,.3,0,.6,0,1),O.bezierCurveTo(0,.6,.6,.3,.6,0),O.bezierCurveTo(.6,-.3,0,-.3,0,0);const lt={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Ot({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const ot=new Hn(O,lt),ht=new y(ot,A);ht.scale.set(.1,.1,.1),ht.rotation.z=le.degToRad(210),ht.rotation.x=le.degToRad(5),ht.rotation.y=le.degToRad(-45),ht.position.set(-.4,.9,.45);const Mt=new y(ot,S);Mt.scale.set(.6,.5,.5),Mt.position.set(.35,0,0),Mt.rotation.y=Math.PI,Mt.rotation.x=Math.PI;const it=new y(ot,S);it.scale.set(.2,.2,.2),it.position.set(.5,-.1,.2),it.rotation.y=Math.PI,it.rotation.x=Math.PI,u.add(it);const g=new yn(1.3,1.2,.6),T=new y(g,A);T.scale.set(.45,.45,.45),T.position.set(.35,-.2,.1),T.rotation.y=Math.PI;const L=new si(.15,.025,10,100);new Ot({color:8343336,metalness:.3,roughness:.4,clearcoat:.5});const F=new y(L,A);F.position.set(.35,.1,.1),F.rotation.z=Math.PI/2,F.rotation.x=Math.PI/8,F.rotation.y=Math.PI/14;const N=new y(L,A);N.position.set(.35,.1,.13),N.rotation.z=Math.PI/2,N.rotation.x=Math.PI/-8,N.rotation.y=Math.PI/12;const K=new Xt;K.add(T),K.add(F),K.add(N),u.add(K);const Z=new ft(.35,32,32),w=new y(Z,A);w.scale.set(.75,1.25,.65),w.position.set(-.7,-.15,.2),u.add(w);const _=new y(Z,b);_.scale.set(.75,1.25,.65),_.position.set(.7,-.15,.2),u.add(_);const C=new ne(.2,.22,.6,32),q=new y(C,A);q.position.set(-.4,-1.05,0),u.add(q);const V=new y(C,b);V.position.set(.4,-1.05,0),u.add(V);const W=new ft(.3,32,32),dt=new y(W,A);dt.scale.set(1,.72,1.5),dt.position.set(-.4,-1.45,.17),u.add(dt);const ct=new y(W,b);ct.scale.set(1,.72,1.5),ct.position.set(.4,-1.45,.17),u.add(ct);const mt=new ft(.44,32,32),At=new y(mt,A);At.position.set(-.15,-.45,-.4),u.add(At);const ut=new y(mt,b);ut.position.set(.15,-.45,-.4),u.add(ut);const _t=new ft(.18,32,32),Lt=new y(_t,A);Lt.position.set(0,-.35,-.8),u.add(Lt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(tt){const St=new ke("X",{font:tt,size:.2,depth:.05});new es({color:0});const Et=new y(St,S);Et.position.set(-.3,.99,.53),Et.rotation.x=le.degToRad(-5),Et.rotation.y=le.degToRad(-15),u.add(Et);const kt=new ke("O",{font:tt,size:.2,depth:.05});new es({color:0});const te=new y(kt,S);te.position.set(.14,.99,.53),te.rotation.y=le.degToRad(12),te.rotation.x=le.degToRad(-5),u.add(te)}),Lt.renderOrder=1,u.scale.set(1.35,1.35,1.35),c.add(u),u.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),l.position.set(t.bodyPosition.x,1,t.cameraPosition),l.lookAt(t.bodyPosition.x,0,0),l.position.z=4;const Rt=()=>{u.rotation.y,u.rotation.x},$t=()=>{s.value=!0,o.value=!1,r.value=!1},zt=()=>{s.value=!1,o.value=!0,r.value=!1},Yt=()=>{s.value=!1,o.value=!1,Rt()},G=tt=>{const St=window.innerWidth/2;tt>St?$t():zt(),Rt()},yt=tt=>{clearTimeout(i),Yt(),r.value=!0;const St={x:tt.clientX/window.innerWidth*2-1,y:-(tt.clientY/window.innerHeight)*2+1};if(r.value){const Et=St.x*Math.PI*.2,kt=St.y*Math.PI*.2;u.rotation.y=Et,u.rotation.x=kt}i=setTimeout(()=>{r.value=!1,G(tt.clientX)},500)};window.addEventListener("mousemove",yt);const st=tt=>{if(r.value){const St={x:tt.clientX/window.innerWidth*2-1,y:-(tt.clientY/window.innerHeight)*2+1},Et=St.x*Math.PI*.2,kt=St.y*Math.PI*.2;u.rotation.y=Et,u.rotation.x=kt}};window.addEventListener("mousemove",st),a(),Ve(()=>t.bodyPosition,tt=>{u.position.set(tt.x,tt.y,tt.z)}),Ve(()=>t.cameraPosition,tt=>{l.position.set(t.bodyPosition.x,1,tt),l.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,c)=>(Wn(),Yn("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),bS=$n(SS,[["__scopeId","data-v-f3beb116"]]),ES=Ln({__name:"PopartBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=null,s=jt(!1),o=jt(!1),r=jt(!1);return Vn(()=>{if(e.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:o.value&&(u.rotation.y-=.03),h.render(c,l)};const c=new Gn,l=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),h=new zn({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(h.domElement);const u=new Xt,d=new hi(16777215,2);c.add(d);const p=new ui(16777215,4);p.position.set(5,5,5),c.add(p);const v=new li(16777215,5,50);v.position.set(0,2,4),c.add(v);const x=new jn,m=x.load("/3d-bear-arts/assets/pop6.jpg"),f=x.load("/3d-bear-arts/assets/pop7.jpg");m.wrapS=m.wrapT=$e,f.wrapS=f.wrapT=$e;const A=new Ot({color:16738740,map:f,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),S=new Ot({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),b=new Ot({color:16766720,map:m,metalness:.3,roughness:.5}),B=new Ot({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),I=new Ot({color:9055202,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new Ot({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be});const R=new Ot({color:65535,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),z=new Ot({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),Q=new ft(1,32,32,0,Math.PI),M=new y(Q,S),E=new y(Q,A);M.scale.set(.85,.85,.8),E.scale.set(.85,.85,.8),M.position.y=-.2,E.position.y=-.2,M.rotation.y=Math.PI/2,E.rotation.y=Math.PI*1.5;const U=new Ae(1,32),k=new y(U,A);k.scale.set(.85,.85,.8),k.position.set(0,-.2,0),k.rotation.y=Math.PI/2;const et=new Xt;et.add(M),et.add(E),et.add(k),u.add(et);const rt=new ft(.6,32,32,0,Math.PI),$=new y(rt,b);$.scale.set(1,.95,.95),$.position.set(0,1,0),$.rotation.y=Math.PI*1.5;const nt=new y(rt,B);nt.scale.set(1,.95,.95),nt.position.set(0,1,0),nt.rotation.y=Math.PI/2;const X=new Ae(.6,32),vt=new y(X,b);vt.position.set(0,1,0),vt.rotation.y=Math.PI/2,vt.scale.set(1,.95,.95);const xt=new Xt;xt.add($),xt.add(nt),xt.add(vt),u.add(xt);const wt=new ft(.25,32,32),Dt=new y(wt,A);Dt.position.set(-.45,1.35,-.1),u.add(Dt);const Wt=new y(wt,S);Wt.position.set(.45,1.35,-.1),u.add(Wt);const at=new ft(.25,32,32,Math.PI/2,Math.PI),pt=new y(at,b);pt.scale.set(1.1,.6,.8),pt.position.set(0,.84,.5),pt.rotation.y=Math.PI;const bt=new ft(.25,32,32,Math.PI/2,Math.PI),O=new y(bt,B);O.scale.set(1.1,.6,.8),O.position.set(0,.84,.5),O.rotation.y=0;const lt=new Ae(.25,32),ot=new y(lt,b);ot.scale.set(.8,.6,.8),ot.position.set(0,.84,.5),ot.rotation.y=Math.PI/2;const ht=new Xt;ht.add(pt),ht.add(O),ht.add(ot),u.add(ht);const Mt=new Cn;Mt.moveTo(0,0),Mt.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Mt.bezierCurveTo(-.6,.3,0,.6,0,1),Mt.bezierCurveTo(0,.6,.6,.3,.6,0),Mt.bezierCurveTo(.6,-.3,0,-.3,0,0);const it={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},g=new Hn(Mt,it),T=new y(g,b);T.scale.set(.5,.5,.5),T.position.set(.35,0,0),T.rotation.y=Math.PI,T.rotation.x=Math.PI,u.add(T);const L=new y(g,R);L.scale.set(.2,.2,.25),L.position.set(.5,-.3,.4),L.rotation.y=Math.PI,L.rotation.x=Math.PI,u.add(L);const F=new y(g,A);F.scale.set(.25,.25,.27),F.position.set(.4,.3,-.2),F.rotation.y=Math.PI,F.rotation.x=Math.PI,u.add(F);const N=new ft(.35,32,32),K=new y(N,R);K.scale.set(.75,1.25,.65),K.position.set(-.7,-.15,.2),u.add(K);const Z=new y(N,z);Z.scale.set(.75,1.25,.65),Z.position.set(.7,-.15,.2),u.add(Z);const w=new ne(.2,.22,.6,32),_=new y(w,b);_.position.set(-.4,-1.05,0),u.add(_);const C=new y(w,B);C.position.set(.4,-1.05,0),u.add(C);const q=new ft(.3,32,32),V=new y(q,b);V.scale.set(1,.72,1.5),V.position.set(-.4,-1.45,.17),u.add(V);const W=new y(q,B);W.scale.set(1,.72,1.5),W.position.set(.4,-1.45,.17),u.add(W);const dt=new ft(.44,32,32),ct=new y(dt,A);ct.position.set(-.15,-.45,-.4),u.add(ct);const mt=new y(dt,S);mt.position.set(.15,-.45,-.4),u.add(mt);const At=new ft(.18,32,32),ut=new y(At,A);ut.position.set(0,-.35,-.8),u.add(ut),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(yt){const st=new ke("X",{font:yt,size:.2,depth:.05});new es({color:0});const tt=new y(st,A);tt.position.set(-.3,.99,.53),tt.rotation.x=le.degToRad(-5),tt.rotation.y=le.degToRad(-15),u.add(tt);const St=new ke("O",{font:yt,size:.2,depth:.05});new es({color:0});const Et=new y(St,R);Et.position.set(.14,.99,.53),Et.rotation.y=le.degToRad(12),Et.rotation.x=le.degToRad(-5),u.add(Et);const kt=new ke("POP",{font:yt,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),te=new Ot({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const se=new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),oe=new Ot({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),ee=new y(kt,te);ee.scale.set(.15,.15,.15),ee.position.set(.03,1.16,.1),ee.rotateZ(-25),u.add(ee);const fe=new y(kt,I);fe.scale.set(.14,.14,.14),fe.rotateZ(45),fe.position.set(.2,-.7,.3),u.add(fe);const ae=new y(kt,se);ae.scale.set(.14,.14,.14),ae.rotateZ(45),ae.rotateY(45),ae.position.set(.3,.7,.3),u.add(ae);const ve=new y(kt,se);ve.scale.set(.15,.15,.15),ve.rotateZ(45),ve.rotateY(45),ve.position.set(.35,-1.5,.3),u.add(ve);const ce=new y(kt,oe);ce.scale.set(.17,.17,.17),ce.rotateZ(45),ce.rotateY(15),ce.position.set(.35,1,.3),u.add(ce)}),ut.renderOrder=1,u.scale.set(1.35,1.35,1.35),c.add(u),u.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),l.position.set(t.bodyPosition.x,1,t.cameraPosition),l.lookAt(t.bodyPosition.x,0,0),l.position.z=4;const Lt=()=>{u.rotation.y,u.rotation.x},Nt=()=>{s.value=!0,o.value=!1,r.value=!1},Rt=()=>{s.value=!1,o.value=!0,r.value=!1},$t=()=>{s.value=!1,o.value=!1,Lt()},zt=yt=>{const st=window.innerWidth/2;yt>st?Nt():Rt(),Lt()},Yt=yt=>{clearTimeout(i),$t(),r.value=!0;const st={x:yt.clientX/window.innerWidth*2-1,y:-(yt.clientY/window.innerHeight)*2+1};if(r.value){const tt=st.x*Math.PI*.2,St=st.y*Math.PI*.2;u.rotation.y=tt,u.rotation.x=St}i=setTimeout(()=>{r.value=!1,zt(yt.clientX)},500)};window.addEventListener("mousemove",Yt);const G=yt=>{if(r.value){const st={x:yt.clientX/window.innerWidth*2-1,y:-(yt.clientY/window.innerHeight)*2+1},tt=st.x*Math.PI*.2,St=st.y*Math.PI*.2;u.rotation.y=tt,u.rotation.x=St}};window.addEventListener("mousemove",G),a(),Ve(()=>t.bodyPosition,yt=>{u.position.set(yt.x,yt.y,yt.z)}),Ve(()=>t.cameraPosition,yt=>{l.position.set(t.bodyPosition.x,1,yt),l.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,c)=>(Wn(),Yn("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),TS=$n(ES,[["__scopeId","data-v-8cfea564"]]),AS={class:"pixel-controls"},PS={class:"side-buttons"},RS=Ln({__name:"PopArtBear3",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);Vn(()=>{if(e.value){let d=function(){requestAnimationFrame(d),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),o.value&&(m.rotation.x-=.03),r.value&&(m.rotation.x+=.03);const tt=yt.getElapsedTime();G.forEach((St,Et)=>{const kt=.2+Math.sin(tt*3+st[Et])*.1;St.scale.set(kt,kt,kt)}),x.render(p,v)};const p=new Gn,v=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zn({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(x.domElement);const m=new Xt,f=new Xt;p.add(f);const A=new hi(16777215,2);p.add(A);const S=new ui(16777215,4);S.position.set(5,5,5),p.add(S);const b=new li(16777215,5,50);b.position.set(0,2,4),p.add(b);const B=new jn,I=B.load("/3d-bear-arts/assets/pop6.jpg"),R=B.load("/3d-bear-arts/assets/pop7.jpg");I.wrapS=I.wrapT=$e,R.wrapS=R.wrapT=$e,R.repeat.set(2,2);const z=new Ot({color:16738740,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Q=new Ot({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),M=new Ot({color:16766720,map:I,metalness:.3,roughness:.5}),E=new Ot({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),U=new Ot({color:9055202,map:I,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),k=new Ot({color:65535,map:I,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),et=new Ot({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),rt=new ft(1,32,32,0,Math.PI),$=new y(rt,Q),nt=new y(rt,z);$.scale.set(.85,.85,.8),nt.scale.set(.85,.85,.8),$.position.y=-.2,nt.position.y=-.2,$.rotation.y=Math.PI/2,nt.rotation.y=Math.PI*1.5;const X=new Ae(1,32),vt=new y(X,z);vt.scale.set(.85,.85,.8),vt.position.set(0,-.2,0),vt.rotation.y=Math.PI/2;const xt=new Xt;xt.add($),xt.add(nt),xt.add(vt),m.add(xt);const wt=new ft(.6,32,32,0,Math.PI),Dt=new y(wt,M);Dt.scale.set(1,.95,.95),Dt.position.set(0,1,0),Dt.rotation.y=Math.PI*1.5;const Wt=new y(wt,E);Wt.scale.set(1,.95,.95),Wt.position.set(0,1,0),Wt.rotation.y=Math.PI/2;const at=new Ae(.6,32),pt=new y(at,M);pt.position.set(0,1,0),pt.rotation.y=Math.PI/2,pt.scale.set(1,.95,.95);const bt=new Xt;bt.add(Dt),bt.add(Wt),bt.add(pt),m.add(bt);const O=new ft(.25,32,32),lt=new y(O,z);lt.position.set(-.45,1.35,-.1),m.add(lt);const ot=new y(O,Q);ot.position.set(.45,1.35,-.1),m.add(ot);const ht=new ft(.25,32,32,Math.PI/2,Math.PI),Mt=new y(ht,M);Mt.scale.set(1.1,.6,.8),Mt.position.set(0,.84,.5),Mt.rotation.y=Math.PI;const it=new ft(.25,32,32,Math.PI/2,Math.PI),g=new y(it,E);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=0;const T=new Ae(.25,32),L=new y(T,M);L.scale.set(.8,.6,.8),L.position.set(0,.84,.5),L.rotation.y=Math.PI/2;const F=new Xt;F.add(Mt),F.add(g),F.add(L),m.add(F);const N=new Cn;N.moveTo(0,0),N.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),N.bezierCurveTo(-.6,.3,0,.6,0,1),N.bezierCurveTo(0,.6,.6,.3,.6,0),N.bezierCurveTo(.6,-.3,0,-.3,0,0);const K={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},Z=new Hn(N,K),w=new y(Z,M);w.scale.set(.5,.5,.5),w.position.set(.3,0,0),w.rotation.y=Math.PI,w.rotation.x=Math.PI,m.add(w);const _=new y(Z,k);_.scale.set(.2,.2,.25),_.position.set(.35,-.3,.4),_.rotation.y=Math.PI,_.rotation.x=Math.PI,m.add(_);const C=new y(Z,z);C.scale.set(.25,.25,.27),C.position.set(.38,.3,-.2),C.rotation.y=Math.PI,C.rotation.x=Math.PI,m.add(C);const q=new ft(.35,32,32),V=new y(q,k);V.scale.set(.75,1.25,.65),V.position.set(-.7,-.15,.2),m.add(V);const W=new y(q,et);W.scale.set(.75,1.25,.65),W.position.set(.7,-.15,.2),m.add(W);const dt=new ne(.2,.22,.6,32),ct=new y(dt,M);ct.position.set(-.4,-1.05,0),m.add(ct);const mt=new y(dt,E);mt.position.set(.4,-1.05,0),m.add(mt);const At=new ft(.3,32,32),ut=new y(At,M);ut.scale.set(1,.72,1.5),ut.position.set(-.4,-1.45,.17),m.add(ut);const _t=new y(At,E);_t.scale.set(1,.72,1.5),_t.position.set(.4,-1.45,.17),m.add(_t);const Lt=new ft(.44,32,32),Nt=new y(Lt,z);Nt.position.set(-.15,-.45,-.4),m.add(Nt);const Rt=new y(Lt,Q);Rt.position.set(.15,-.45,-.4),m.add(Rt);const $t=new ft(.18,32,32),zt=new y($t,z);zt.position.set(0,-.35,-.8),m.add(zt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(tt){const St=new ke("X",{font:tt,size:.2,depth:.05}),Et=new y(St,z);Et.position.set(-.3,.99,.53),Et.rotation.x=le.degToRad(-5),Et.rotation.y=le.degToRad(-15),m.add(Et);const kt=new ke("O",{font:tt,size:.2,depth:.05}),te=new y(kt,k);te.position.set(.14,.99,.53),te.rotation.y=le.degToRad(12),te.rotation.x=le.degToRad(-5),m.add(te);const se=new ke("POP",{font:tt,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});new ke("🐻",{font:tt,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});const oe=new ke("BAO      BEAR",{font:tt,size:2,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:3}),ee=new Ot({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const fe=new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),ae=new Ot({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),ve=new y(se,ee);ve.scale.set(.15,.15,.15),ve.position.set(.02,1.16,.1),ve.rotateZ(-25),m.add(ve);const ce=new y(se,U);ce.scale.set(.14,.14,.14),ce.rotateZ(45),ce.position.set(.2,-.7,.3),m.add(ce);const Pe=new y(se,fe);Pe.scale.set(.14,.14,.14),Pe.rotateZ(45),Pe.rotateY(45),Pe.position.set(.3,.7,.3),m.add(Pe);const me=new y(se,fe);me.scale.set(.15,.15,.15),me.rotateZ(45),me.rotateY(45),me.position.set(.35,-1.5,.3),m.add(me);const Be=new y(se,ae);Be.scale.set(.17,.17,.17),Be.rotateZ(45),Be.rotateY(15),Be.position.set(.35,1,.3),m.add(Be);const Re=new y(oe,ee);Re.scale.set(.7,.7,.7),Re.position.set(-6,0,-3),f.add(Re)}),zt.renderOrder=1,m.scale.set(1.4,1.4,1.4),p.add(m),m.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),v.position.set(t.bodyPosition.x,1,t.cameraPosition),v.lookAt(t.bodyPosition.x,0,0),v.position.z=4,m.rotation.x=.1;const G=[w,_,C],yt=new zp,st=[0,Math.PI/2,Math.PI,0,Math.PI/3];d(),Ve(()=>t.bodyPosition,tt=>{m.position.set(tt.x,tt.y,tt.z)}),Ve(()=>t.cameraPosition,tt=>{v.position.set(t.bodyPosition.x,1,tt),v.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{v.aspect=window.innerWidth/window.innerHeight,v.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,p)=>(Wn(),Yn(fn,null,[Bt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),Bt("div",AS,[Bt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),Bt("div",PS,[Bt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Bt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),Bt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),CS=$n(RS,[["__scopeId","data-v-cb52c927"]]),IS={class:"pixel-controls"},LS={class:"side-buttons"},DS=Ln({__name:"MetalMachineBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);Vn(()=>{if(e.value){let d=function(fe,ae){const ve=new ne(Yt,Yt,G,32);ve.rotateX(Math.PI/2);const ce=new y(ve,fe),Pe=new Xt;for(let Be=0;Be<yt;Be++){const Re=Be/yt*Math.PI*2,je=new yn(st,tt,St),Ne=new y(je,fe);Ne.position.set((Yt+St/26)*Math.cos(Re),(Yt+St/26)*Math.sin(Re),0),Ne.rotation.z=Re,Pe.add(Ne)}const me=new Xt;return me.add(ce),me.add(Pe),me.position.set(ae.x,ae.y,ae.z),me},p=function(){requestAnimationFrame(p),i.value&&(f.rotation.y+=.03),s.value&&(f.rotation.y-=.03),o.value&&(f.rotation.x-=.03),r.value&&(f.rotation.x+=.03),Et.rotation.z-=.02,kt.rotation.z+=.03,te.rotation.z+=.02,se.rotation.z+=.02,oe.rotation.z-=.03,ee.rotation.y+=.04,m.render(v,x)};const v=new Gn,x=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),m=new zn({antialias:!0,alpha:!0});m.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(m.domElement);const f=new Xt,A=new Xt;v.add(A);const S=new hi(16777215,2);v.add(S);const b=new ui(16777215,4);b.position.set(5,5,5),v.add(b);const B=new li(16777215,5,50);B.position.set(0,2,4),v.add(B);const I=new jn,R=I.load("/3d-bear-arts/assets/metal.jpg"),z=I.load("/3d-bear-arts/assets/pop7.jpg"),Q=I.load("/3d-bear-arts/assets/gear.jpg");R.wrapS=R.wrapT=$e,z.wrapS=z.wrapT=$e,z.repeat.set(2,2);const M=new Ot({color:13882323,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:R});Q.mapping=Ta;const E=new Ot({color:"#d3d3d3",metalness:1,roughness:.25,map:R,envMap:Q,clearcoat:.7,clearcoatRoughness:.3}),U=new Ot({color:"#C0C0C0",metalness:1,roughness:.25,envMap:Q,clearcoat:.7,clearcoatRoughness:.3}),k=new Ot({color:"#C0C0C0",metalness:1,roughness:.25,map:R,envMap:Q,transparent:!0,opacity:.8,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),et=new Ot({color:"#C0C0C0",metalness:1,roughness:.5,map:R,envMap:Q,transparent:!0,opacity:.23,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),rt=new Ot({color:13882323,metalness:1,roughness:.25,clearcoat:1,clearcoatRoughness:.05,reflectivity:.9,envMapIntensity:1,side:be});new Ot({color:"#C0C0C0",metalness:1,roughness:.2,transparent:!0,opacity:.4,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45});const $=new Ot({color:"#d3d3d3",metalness:1,roughness:.2,map:Q,envMap:Q,clearcoat:.7,clearcoatRoughness:.3});new Ot({color:12632256,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:Q}),new Ot({color:12632256,metalness:1,roughness:.3,clearcoat:.5,clearcoatRoughness:.1,map:R,transparent:!0,opacity:.3});const nt=new ft(1,32,32,0,Math.PI),X=new y(nt,et),vt=new y(nt,E);X.scale.set(.85,.85,.8),vt.scale.set(.85,.85,.8),X.position.y=-.2,vt.position.y=-.2,X.rotation.y=Math.PI/2,vt.rotation.y=Math.PI*1.5;const xt=new Ae(1,32),wt=new y(xt,k);wt.scale.set(.85,.85,.8),wt.position.set(0,-.2,0),wt.rotation.y=Math.PI/2;const Dt=new Xt;Dt.add(X),Dt.add(vt),Dt.add(wt),f.add(Dt);const Wt=new ft(.6,32,32,0,Math.PI),at=new y(Wt,E);at.scale.set(1,.95,.95),at.position.set(0,1,0),at.rotation.y=Math.PI*1.5;const pt=new y(Wt,et);pt.scale.set(1,.95,.95),pt.position.set(0,1,0),pt.rotation.y=Math.PI/2;const bt=new Ae(.6,32),O=new y(bt,k);O.position.set(0,1,0),O.rotation.y=Math.PI/2,O.scale.set(1,.95,.95);const lt=new Xt;lt.add(at),lt.add(pt),lt.add(O),f.add(lt);const ot=new ft(.25,32,32),ht=new y(ot,E);ht.position.set(-.45,1.35,-.1),f.add(ht);const Mt=new y(ot,k);Mt.position.set(.45,1.35,-.1),f.add(Mt);const it=new ft(.25,32,32,Math.PI/2,Math.PI),g=new y(it,E);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=Math.PI;const T=new ft(.25,32,32,Math.PI/2,Math.PI),L=new y(T,k);L.scale.set(1.1,.6,.8),L.position.set(0,.84,.5),L.rotation.y=0;const F=new Ae(.25,32),N=new y(F,rt);N.scale.set(.8,.6,.8),N.position.set(0,.84,.5),N.rotation.y=Math.PI/2;const K=new Xt;K.add(g),K.add(L),K.add(N),f.add(K);const Z=new Cn;Z.moveTo(0,0),Z.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Z.bezierCurveTo(-.6,.3,0,.6,0,1),Z.bezierCurveTo(0,.6,.6,.3,.6,0),Z.bezierCurveTo(.6,-.3,0,-.3,0,0);const w={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},_=new Hn(Z,w),C=new ft(.35,32,32),q=new y(C,E);q.scale.set(.75,1.25,.65),q.position.set(-.7,-.15,.2),f.add(q);const V=new y(C,k);V.scale.set(.75,1.25,.65),V.position.set(.7,-.15,.2),f.add(V);const W=new ne(.2,.22,.6,32),dt=new y(W,E);dt.position.set(-.4,-1.05,0),f.add(dt);const ct=new y(W,k);ct.position.set(.4,-1.05,0),f.add(ct);const mt=new ft(.3,32,32),At=new y(mt,E);At.scale.set(1,.72,1.5),At.position.set(-.4,-1.45,.17),f.add(At);const ut=new y(mt,k);ut.scale.set(1,.72,1.5),ut.position.set(.4,-1.45,.17),f.add(ut);const _t=new ft(.44,32,32),Lt=new y(_t,E);Lt.position.set(-.15,-.45,-.4),f.add(Lt);const Nt=new y(_t,et);Nt.position.set(.15,-.45,-.4),f.add(Nt);const Rt=new ft(.18,32,32),$t=new y(Rt,E);$t.position.set(0,-.35,-.8),f.add($t),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(fe){const ae=new ke("X",{font:fe,size:.2,depth:.05});new es({color:0});const ve=new y(ae,M);ve.position.set(-.3,.99,.53),ve.rotation.x=le.degToRad(-5),ve.rotation.y=le.degToRad(-15),f.add(ve);const ce=new ke("O",{font:fe,size:.2,depth:.05});new es({color:0});const Pe=new y(ce,M);Pe.position.set(.14,.99,.53),Pe.rotation.y=le.degToRad(12),Pe.rotation.x=le.degToRad(-5),f.add(Pe)}),$t.renderOrder=1;const Yt=1.2,G=.5,yt=8,st=.7,tt=.3,St=.5,Et=d($,{x:-2,y:0,z:0}),kt=d($,{x:0,y:0,z:0}),te=d($,{x:2,y:0,z:0}),se=d($,{x:2,y:0,z:0}),oe=d($,{x:2,y:-2,z:0}),ee=new y(_,U);ee.scale.set(.3,.3,.3),ee.position.set(.25,1.1,0),ee.rotation.y=Math.PI,ee.rotation.x=Math.PI,f.add(ee),Et.position.set(.35,0,0),kt.position.set(.25,-.3,.4),te.position.set(.3,.3,-.2),se.position.set(.25,.17,.4),oe.position.set(.5,-.3,.45),Et.scale.set(.2,.2,.2),kt.scale.set(.18,.18,.18),te.scale.set(.15,.15,.15),se.scale.set(.17,.17,.17),oe.scale.set(.15,.15,.15),kt.rotation.z=Math.PI/4,te.rotation.z=-Math.PI/4,se.rotation.y=-Math.PI/2,oe.rotation.y=-Math.PI/2,f.add(Et),f.add(kt),f.add(te),f.add(se),f.add(oe),f.rotation.x=.1,f.scale.set(1.4,1.4,1.4),v.add(f),f.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),x.position.set(t.bodyPosition.x,1,t.cameraPosition),x.lookAt(t.bodyPosition.x,0,0),x.position.z=4,p(),Ve(()=>t.bodyPosition,fe=>{f.position.set(fe.x,fe.y,fe.z)}),Ve(()=>t.cameraPosition,fe=>{x.position.set(t.bodyPosition.x,1,fe),x.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{x.aspect=window.innerWidth/window.innerHeight,x.updateProjectionMatrix(),m.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,p)=>(Wn(),Yn(fn,null,[Bt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),Bt("div",IS,[Bt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),Bt("div",LS,[Bt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Bt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),Bt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),US=$n(DS,[["__scopeId","data-v-9a57b6d8"]]),NS={class:"pixel-controls"},FS={class:"side-buttons"},OS={class:"directional-buttons"},BS={class:"horizontal-buttons"},zS={class:"directional-buttons-woman"},GS={class:"horizontal-buttons-woman"},HS={class:"directional-buttons-kid"},kS={class:"horizontal-buttons-kid"},aa=.1,ca=.05,la=.08,VS=Ln({__name:"Water",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);const a=po(null),c=jt(!1),l=jt(!1),h=jt(!1),u=jt(!1),d=po(null),p=po(null),v=jt(!1),x=jt(!1),m=jt(!1),f=jt(!1),A=jt(!1),S=jt(!1),b=jt(!1),B=jt(!1),I=new zn({antialias:!0});I.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(I.domElement);const R=new Gn,z=new qe(75,window.innerWidth/window.innerHeight,.1,1e3);z.position.z=5,Vn(()=>{if(e.value){let it=function(){const Tt=new Xt,ye=new ft(.2,32,32),Ee=new Ut({color:16767916}),ge=new y(ye,Ee);ge.position.set(0,1.5,0),Tt.add(ge);const Ie=new ft(.21,32,32,0,Math.PI*2,0,Math.PI/2),pe=new Ut({color:16711680}),Ce=new y(Ie,pe);Ce.position.set(0,1.58,0),Tt.add(Ce);const ze=new ne(.25,.25,.6,32),Te=new Ut({color:16767916}),Fe=new y(ze,Te);Fe.position.set(0,1,0),Tt.add(Fe);const Ke=new ne(.26,.26,.3,32),We=new Ut({color:255}),sn=new y(Ke,We);sn.position.set(0,.65,0),Tt.add(sn);const tn=new ne(.1,.1,.5,32),en=new Ut({color:16767916}),cn=new y(tn,en);cn.position.set(-.15,.25,0),Tt.add(cn);const rn=new y(tn,en);rn.position.set(.15,.25,0),Tt.add(rn);const ln=new ne(.08,.08,.5,32),dn=new y(ln,en);dn.position.set(-.35,1.3,0),dn.rotation.z=Math.PI/4,Tt.add(dn);const bn=new y(ln,en);return bn.position.set(.35,1.3,0),bn.rotation.z=-Math.PI/4,Tt.add(bn),Tt.scale.set(.27,.27,.27),Tt.position.set(-.2,-.1,-.15),Tt},g=function(){const Tt=new Xt,ye=new ft(.18,32,32),Ee=new Ut({color:16767916}),ge=new y(ye,Ee);ge.position.set(0,1.2,.04),Tt.add(ge);const Ie=new ft(.19,32,32,.4,Math.PI*2,0,Math.PI/2),pe=new ne(.18,.18,.4,32),Ce=new Ut({color:9127187}),ze=new y(Ie,Ce);ze.position.set(0,1.28,0),Tt.add(ze);const Te=new y(pe,Ce);Te.position.set(0,1.1,-.01),Tt.add(Te);const Fe=new ne(.18,.2,.5,32),Ke=new Ut({color:16767916}),We=new y(Fe,Ke);We.position.set(0,.85,0),Tt.add(We);const sn=new ft(.08,32,32,0,Math.PI),tn=new Ut({color:16738740}),en=new y(sn,tn);en.position.set(-.09,.98,.15),Tt.add(en);const cn=new y(sn,tn);cn.position.set(.09,.98,.15),Tt.add(cn);const rn=new ne(.22,.22,.25,32),ln=new Ut({color:16738740}),dn=new y(rn,ln);dn.position.set(0,.6,0),Tt.add(dn);const bn=new ne(.1,.1,.6,32),bi=new Ut({color:16767916}),Fi=new y(bn,bi);Fi.position.set(-.09,.5,.2),Fi.rotation.x=Math.PI/2,Tt.add(Fi);const Oi=new y(bn,bi);Oi.position.set(.09,.5,.2),Oi.rotation.x=Math.PI/2,Tt.add(Oi);const Bi=new ne(.08,.08,.35,32),Ei=new y(Bi,bi);Ei.position.set(-.24,.95,.18),Ei.rotation.x=Math.PI/2,Tt.add(Ei);const fi=new y(Bi,bi);return fi.position.set(.2,.85,0),fi.rotation.z=Math.PI/20,Tt.add(fi),Tt.scale.set(.27,.27,.27),Tt.position.set(.2,-.15,-.32),Tt},T=function(){const Tt=new Xt,ye=new ft(.2,32,32),Ee=new Ut({color:16767916}),ge=new y(ye,Ee);ge.position.set(0,1.5,0),Tt.add(ge);const Ie=new ft(.21,32,32,0,Math.PI*2,0,Math.PI/2),pe=new Ut({color:25600}),Ce=new y(Ie,pe);Ce.position.set(0,1.58,0),Tt.add(Ce);const ze=new ne(.22,.22,.5,32),Te=new Ut({color:16767916}),Fe=new y(ze,Te);Fe.position.set(0,1,0),Tt.add(Fe);const Ke=new ne(.23,.23,.3,32),We=new Ut({color:8388736}),sn=new y(Ke,We);sn.position.set(0,.65,0),Tt.add(sn);const tn=new ne(.1,.1,.5,32),en=new Ut({color:16767916}),cn=new y(tn,en);cn.position.set(-.15,.3,-.25),cn.rotation.x=Math.PI/6,Tt.add(cn);const rn=new y(tn,en);rn.position.set(.15,.3,.25),rn.rotation.x=-Math.PI/6,Tt.add(rn);const ln=new ne(.08,.08,.4,32),dn=new y(ln,en);dn.position.set(-.28,1,-.2),dn.rotation.x=Math.PI/6,Tt.add(dn);const bn=new y(ln,en);return bn.position.set(.28,1.3,.1),bn.rotation.z=-Math.PI/8,Tt.add(bn),Tt.scale.set(.15,.15,.15),Tt.position.set(.3,-.25,.25),Tt.rotation.x=Math.PI/12,Tt.rotation.y=Math.PI/2,Tt.rotation.z=-Math.PI/3,Tt},L=function(Tt){let ye=1,Ee=0;function ge(){requestAnimationFrame(ge),Tt.position.x+=.01*ye,Tt.position.x>=.35?(ye=-1,Tt.rotation.y=Math.PI):Tt.position.x<=-.35&&(ye=1,Tt.rotation.y=0),Ee+=.003,Tt.position.y=-.4+Math.sin(Ee)*.1,Z.render(N,K)}ge()},F=function(){requestAnimationFrame(F),i.value&&(w.rotation.y+=.03),s.value&&(w.rotation.y-=.03),o.value&&(w.rotation.x-=.03),r.value&&(w.rotation.x+=.03),ve.uniforms.u_time.value+=.25,j.rotation.y+=.04,Z.render(N,K)};const N=new Gn,K=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),Z=new zn({antialias:!0,alpha:!0});Z.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(Z.domElement);const w=new Xt,_=new Xt;N.add(_);const C=new hi(16777215,2);N.add(C);const q=new ui(16777215,4);q.position.set(5,5,5),N.add(q);const V=new li(16777215,5,50);V.position.set(0,2,4),N.add(V);const W=new jn,dt=W.load("/3d-bear-arts/assets/beach.jpg");dt.repeat.set(.8,1);const ct=W.load("/3d-bear-arts/assets/sun.jpg");dt.wrapS=dt.wrapT=$e,dt.repeat.set(.8,1),ct.wrapS=ct.wrapT=$e;const mt=new Ot({color:11592447,map:dt,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),At=new Ot({color:11592447,map:dt,metalness:.3,roughness:.5,transparent:!0,opacity:.6,side:be,ior:1.33,depthWrite:!1,depthTest:!0}),ut=new Ot({color:11592447,map:dt,metalness:.1,roughness:.6,transparent:!0,opacity:.6,clearcoat:.9,clearcoatRoughness:.4,transmission:.7,ior:1.2,depthTest:!0,envMapIntensity:.8}),_t=new Ot({color:11592447,map:dt,metalness:.1,roughness:.6,transparent:!0,opacity:.3,clearcoat:.9,clearcoatRoughness:.4,ior:1.2,depthWrite:!1,depthTest:!0,envMapIntensity:.6,side:be}),Lt=new Ot({color:11592447,map:dt,metalness:.3,roughness:.5,transparent:!0,opacity:.8,side:be,ior:1.33}),Nt=new Ot({color:11592447,map:dt,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Rt=new ft(1,32,32,0,Math.PI),$t=new y(Rt,_t),zt=new y(Rt,At);$t.scale.set(.85,.85,.8),zt.scale.set(.85,.85,.8),$t.position.y=-.2,zt.position.y=-.2,$t.rotation.y=Math.PI/2,zt.rotation.y=Math.PI*1.5;const Yt=new Ae(1,32),G=new y(Yt,mt);G.scale.set(.85,.85,.8),G.position.set(0,-.2,0),G.rotation.y=Math.PI/2;const yt=new Xt;yt.add($t),yt.add(zt),yt.add(G),w.add(yt);const st=new ft(.6,32,32,0,Math.PI),tt=new y(st,mt);tt.scale.set(1,.95,.95),tt.position.set(0,1,0),tt.rotation.y=Math.PI*1.5;const St=new y(st,ut);St.scale.set(1,.95,.95),St.position.set(0,1,0),St.rotation.y=Math.PI/2;const Et=new Ae(.6,32),kt=new y(Et,mt);kt.position.set(0,1,0),kt.rotation.y=Math.PI/2,kt.scale.set(1,.95,.95);const te=new Xt;te.add(tt),te.add(St),te.add(kt),w.add(te);const se=new ft(.6,32,32,0,Math.PI*2,0,Math.PI/2),oe=new Ot({color:11592447,metalness:.1,roughness:.2,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.9,transmission:.9,ior:1.33,reflectivity:.8,envMapIntensity:1}),ee=new y(se,oe);ee.position.set(0,-.2,0),ee.rotation.x=Math.PI,ee.scale.set(1.25,1.25,1.25),yt.add(ee);const fe=new Ot({color:49151,metalness:.1,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,side:be,transparent:!0,opacity:.7,depthWrite:!1}),ae=new y(Yt,fe);ae.scale.set(.7,.7,.7),ae.position.set(0,-.3,0),ae.rotation.x=Math.PI/2,ae.renderOrder=1,yt.add(ae),w.add(yt);const ve=new on({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:8},u_waveAmplitude:{value:.05},u_waveSpeed:{value:.2}},vertexShader:`
            ...
            `}),ce=new y(Yt,ve);ce.position.set(0,-.3,0),ce.scale.set(.7,.7,.7),ce.rotation.x=-Math.PI/2,ce.renderOrder=1,yt.add(ce);const Pe=new ft(.25,32,32),me=new y(Pe,Lt);me.position.set(-.45,1.35,-.1),w.add(me);const Be=new y(Pe,ut);Be.position.set(.45,1.35,-.1),w.add(Be);const Re=new ft(.25,32,32,Math.PI/2,Math.PI),je=new y(Re,Lt);je.scale.set(1.1,.6,.8),je.position.set(0,.84,.5),je.rotation.y=Math.PI;const Ne=new ft(.25,32,32,Math.PI/2,Math.PI),hn=new y(Ne,ut);hn.scale.set(1.1,.6,.8),hn.position.set(0,.84,.5),hn.rotation.y=0;const Dn=new Ae(.25,32),gn=new y(Dn,At);gn.scale.set(.8,.6,.8),gn.position.set(0,.84,.5),gn.rotation.y=Math.PI/2;const Ct=new Xt;Ct.add(je),Ct.add(hn),Ct.add(gn),w.add(Ct);const he=new Ot({color:8374441,metalness:1,roughness:.25,envMap:ct,clearcoat:.7,clearcoatRoughness:.3}),P=new Cn;P.moveTo(0,0),P.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),P.bezierCurveTo(-.6,.3,0,.6,0,1),P.bezierCurveTo(0,.6,.6,.3,.6,0),P.bezierCurveTo(.6,-.3,0,-.3,0,0);const Y={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},D=new Hn(P,Y),j=new y(D,he);j.scale.set(.2,.2,.2),j.position.set(.25,1.2,0),j.rotation.y=Math.PI,j.rotation.x=Math.PI,w.add(j);const H=new ft(.35,32,32),gt=new y(H,At);gt.scale.set(.75,1.25,.65),gt.position.set(-.7,-.15,.2),w.add(gt);const It=new y(H,_t);It.scale.set(.75,1.25,.65),It.position.set(.7,-.15,.2),w.add(It);const Ft=new ne(.2,.22,.6,32),Ht=new y(Ft,Lt);Ht.position.set(-.4,-1.05,0),w.add(Ht);const Kt=new y(Ft,ut);Kt.position.set(.4,-1.05,0),w.add(Kt);const Qt=new ft(.3,32,32),Vt=new y(Qt,Lt);Vt.scale.set(1,.72,1.5),Vt.position.set(-.4,-1.45,.17),w.add(Vt);const ie=new y(Qt,ut);ie.scale.set(1,.72,1.5),ie.position.set(.4,-1.45,.17),w.add(ie);const de=new ft(.44,32,32),ue=new y(de,Lt);ue.position.set(-.15,-.45,-.4),w.add(ue);const Pt=new y(de,Lt);Pt.position.set(.15,-.45,-.4),w.add(Pt);const qt=new ft(.18,32,32),Gt=new y(qt,Lt);Gt.position.set(0,-.35,-.8),w.add(Gt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Tt){const ye=new ke("X",{font:Tt,size:.2,depth:.05}),Ee=new y(ye,Nt);Ee.position.set(-.3,.99,.53),Ee.rotation.x=le.degToRad(-5),Ee.rotation.y=le.degToRad(-15),w.add(Ee);const ge=new ke("O",{font:Tt,size:.2,depth:.05}),Ie=new y(ge,Nt);Ie.position.set(.14,.99,.53),Ie.rotation.y=le.degToRad(12),Ie.rotation.x=le.degToRad(-5),w.add(Ie)}),a.value=it(),w.add(a.value),N.add(w),d.value=g(),w.add(d.value),p.value=T(),w.add(p.value),L(p.value),w.scale.set(1.4,1.4,1.4),N.add(w),w.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),K.position.set(t.bodyPosition.x,1,t.cameraPosition),K.lookAt(t.bodyPosition.x,0,0),K.position.z=4,w.rotation.x=.1,F(),Ve(()=>t.bodyPosition,Tt=>{w.position.set(Tt.x,Tt.y,Tt.z)}),Ve(()=>t.cameraPosition,Tt=>{K.position.set(t.bodyPosition.x,1,Tt),K.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{K.aspect=window.innerWidth/window.innerHeight,K.updateProjectionMatrix(),Z.setSize(window.innerWidth,window.innerHeight)})}});function Q(){s.value=!0}function M(){i.value=!0}function E(){o.value=!0}function U(){r.value=!0}function k(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}const et=()=>{c.value=!0,console.log(c.value),a.value&&(a.value.rotation.y=0),console.log(a.value)},rt=()=>{l.value=!0,a.value&&(a.value.rotation.y=Math.PI),console.log(a.value)},$=()=>{h.value=!0,a.value&&(a.value.rotation.y=Math.PI/2)},nt=()=>{u.value=!0,a.value&&(a.value.rotation.y=-Math.PI/2)},X=()=>{c.value=!1,l.value=!1,h.value=!1,u.value=!1},vt=()=>{v.value=!0,d.value&&(d.value.rotation.y=Math.PI)},xt=()=>{x.value=!0,d.value&&(d.value.rotation.y=0)},wt=()=>{m.value=!0,d.value&&(d.value.rotation.y=-Math.PI/2)},Dt=()=>{f.value=!0,d.value&&(d.value.rotation.y=Math.PI/2)},Wt=()=>{v.value=!1,x.value=!1,m.value=!1,f.value=!1},at=()=>{requestAnimationFrame(at),a.value&&(c.value&&(a.value.position.z-=aa),l.value&&(a.value.position.z+=aa),h.value&&(a.value.position.x-=aa),u.value&&(a.value.position.x+=aa)),I.render(R,z)},pt=()=>{requestAnimationFrame(pt),d.value&&(v.value&&(d.value.position.z-=ca),x.value&&(d.value.position.z+=ca),m.value&&(d.value.position.x-=ca),f.value&&(d.value.position.x+=ca))};pt(),at();const bt=()=>{A.value=!0,p.value&&(p.value.rotation.y=0)},O=()=>{S.value=!0,p.value&&(p.value.rotation.y=Math.PI)},lt=()=>{b.value=!0,p.value&&(p.value.rotation.y=Math.PI/2)},ot=()=>{B.value=!0,p.value&&(p.value.rotation.y=-Math.PI/2)},ht=()=>{A.value=!1,S.value=!1,b.value=!1,B.value=!1},Mt=()=>{requestAnimationFrame(Mt),p.value&&(A.value&&(p.value.position.z-=la),S.value&&(p.value.position.z+=la),b.value&&(p.value.position.x-=la),B.value&&(p.value.position.x+=la))};return Mt(),(it,g)=>(Wn(),Yn(fn,null,[Bt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),Bt("div",NS,[Bt("button",{class:"pixel-btn up",onMousedown:E,onMouseup:k},"UP",32),Bt("div",FS,[Bt("button",{class:"pixel-btn left",onMousedown:Q,onMouseup:k},"LEFT",32),Bt("button",{class:"pixel-btn right",onMousedown:M,onMouseup:k},"RIGHT",32)]),Bt("button",{class:"pixel-btn down",onMousedown:U,onMouseup:k},"DOWN",32)]),Bt("div",OS,[Bt("button",{id:"move-north",class:"directional-btn north-btn",onMousedown:et,onMouseup:X},"UP",32),Bt("div",BS,[Bt("button",{id:"move-west",class:"directional-btn west-btn",onMousedown:$,onMouseup:X},"LEFT",32),Bt("button",{id:"move-east",class:"directional-btn east-btn",onMousedown:nt,onMouseup:X},"RIGHT",32)]),Bt("button",{id:"move-south",class:"directional-btn south-btn",onMousedown:rt,onMouseup:X},"DOWN",32)]),Bt("div",zS,[Bt("button",{class:"directional-btn-woman north-btn",onMousedown:vt,onMouseup:Wt},"UP",32),Bt("div",GS,[Bt("button",{class:"directional-btn-woman west-btn",onMousedown:wt,onMouseup:Wt},"LEFT",32),Bt("button",{class:"directional-btn-woman east-btn",onMousedown:Dt,onMouseup:Wt},"RIGHT",32)]),Bt("button",{class:"directional-btn-woman south-btn",onMousedown:xt,onMouseup:Wt},"DOWN",32)]),Bt("div",HS,[Bt("button",{class:"directional-btn-kid north-btn",onMousedown:bt,onMouseup:ht},"UP",32),Bt("div",kS,[Bt("button",{class:"directional-btn-kid west-btn",onMousedown:lt,onMouseup:ht},"LEFT",32),Bt("button",{class:"directional-btn-kid east-btn",onMousedown:ot,onMouseup:ht},"RIGHT",32)]),Bt("button",{class:"directional-btn-kid south-btn",onMousedown:O,onMouseup:ht},"DOWN",32)])],64))}}),WS=$n(VS,[["__scopeId","data-v-f25dfda5"]]),XS={class:"pixel-controls"},qS={class:"side-buttons"},jS=Ln({__name:"GhostBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);Vn(()=>{if(e.value){let d=function(me,Be){const Re=new Xt,je=new ft(1,32,32),Ne=new y(je,rt);Ne.scale.set(1,.8,1),Re.add(Ne);const hn=new ne(.1,.1,.5,16),Dn=new Ut({color:9127187}),gn=new y(hn,Dn);return gn.position.set(0,.9,0),Re.add(gn),Re},p=function(){requestAnimationFrame(p),i.value&&(f.rotation.y+=.03),s.value&&(f.rotation.y-=.03),o.value&&(f.rotation.x-=.03),r.value&&(f.rotation.x+=.03),Yt.rotation.z-=.04,G.rotation.z+=.04,yt.rotation.z+=.03,st.rotation.z+=.03,_.rotation.y+=.04,Pe+=ve,f.position.y=t.bodyPosition.y+Math.sin(Pe)*ce;const me=fe.getElapsedTime();ee.forEach((Be,Re)=>{const je=.1+Math.sin(me*3+ae[Re])*.1;Be.scale.set(je,je,je)}),m.render(v,x)};const v=new Gn,x=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),m=new zn({antialias:!0,alpha:!0});m.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(m.domElement);const f=new Xt,A=new Xt;v.add(A);const S=new hi(16777215,2);v.add(S);const b=new ui(16777215,4);b.position.set(5,5,5),v.add(b);const B=new li(16777215,5,50);B.position.set(0,2,4),v.add(B);const I=new jn,R=I.load("/3d-bear-arts/assets/pumpkin.jpg");R.wrapS=R.wrapT=$e,R.repeat.set(.8,.85);const z=I.load("/3d-bear-arts/assets/pumpkin.jpg");z.wrapS=z.wrapT=$e,z.repeat.set(1,1);const Q=I.load("/3d-bear-arts/assets/pumpkin.jpg");Q.wrapS=z.wrapT=$e,Q.repeat.set(2,.8);const M=new Ot({color:16747520,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),E=new Xt,U=new Ot({color:16747520,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),k=new Ot({color:16747520,map:z,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),et=new Ot({color:16747520,map:Q,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.6,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),rt=new Ot({color:16747520,map:Q,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new Ot({color:16766720,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new Ot({color:9109504,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new Ot({color:4915330,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});const $=new ft(1,32,32,0,Math.PI),nt=new y($,et),X=new y($,U);nt.scale.set(.85,.85,.8),X.scale.set(.85,.85,.8),nt.position.y=-.2,X.position.y=-.2,nt.rotation.y=Math.PI/2,X.rotation.y=Math.PI*1.5;const vt=new Ae(1,32),xt=new y(vt,k);xt.scale.set(.85,.85,.8),xt.position.set(0,-.2,0),xt.rotation.y=Math.PI/2;const wt=new Xt;wt.add(nt),wt.add(X),wt.add(xt),f.add(wt);const Dt=new ft(.6,32,32,0,Math.PI),Wt=new y(Dt,U);Wt.scale.set(1,.95,.95),Wt.position.set(0,1,0),Wt.rotation.y=Math.PI*1.5;const at=new y(Dt,et);at.scale.set(1,.95,.95),at.position.set(0,1,0),at.rotation.y=Math.PI/2;const pt=new Ae(.6,32),bt=new y(pt,k);bt.position.set(0,1,0),bt.rotation.y=Math.PI/2,bt.scale.set(1,.95,.95);const O=new Xt;O.add(Wt),O.add(at),O.add(bt),f.add(O);const lt=new ft(.25,32,32),ot=new y(lt,rt);ot.position.set(-.45,1.35,-.1),f.add(ot);const ht=new y(lt,et);ht.position.set(.45,1.35,-.1),f.add(ht);const Mt=new ft(.25,32,32,Math.PI/2,Math.PI),it=new y(Mt,U);it.scale.set(1.1,.6,.8),it.position.set(0,.84,.5),it.rotation.y=Math.PI;const g=new ft(.25,32,32,Math.PI/2,Math.PI),T=new y(g,et);T.scale.set(1.1,.6,.8),T.position.set(0,.84,.5),T.rotation.y=0;const L=new Ae(.25,32),F=new y(L,U);F.scale.set(.8,.6,.8),F.position.set(0,.84,.5),F.rotation.y=Math.PI/2;const N=new Xt;N.add(it),N.add(T),N.add(F),f.add(N);const K=new Cn;K.moveTo(0,0),K.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),K.bezierCurveTo(-.6,.3,0,.6,0,1),K.bezierCurveTo(0,.6,.6,.3,.6,0),K.bezierCurveTo(.6,-.3,0,-.3,0,0);const Z={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},w=new Hn(K,Z),_=new y(w,M);_.scale.set(.3,.3,.3),_.position.set(.25,1.1,0),_.rotation.y=Math.PI,_.rotation.x=Math.PI,f.add(_);const C=new ft(.35,32,32),q=new y(C,k);q.scale.set(.75,1.25,.65),q.position.set(-.7,-.15,.2),f.add(q);const V=new y(C,et);V.scale.set(.75,1.25,.65),V.position.set(.7,-.15,.2),f.add(V);const W=new ne(.2,.22,.6,32),dt=new y(W,k);dt.position.set(-.4,-1.05,0),f.add(dt);const ct=new y(W,et);ct.position.set(.4,-1.05,0),f.add(ct);const mt=new ft(.3,32,32),At=new y(mt,rt);At.scale.set(1,.72,1.5),At.position.set(-.4,-1.45,.17),f.add(At);const ut=new y(mt,et);ut.scale.set(1,.72,1.5),ut.position.set(.4,-1.45,.17),f.add(ut);const _t=new ft(.44,32,32),Lt=new y(_t,U);Lt.position.set(-.15,-.45,-.4),f.add(Lt);const Nt=new y(_t,et);Nt.position.set(.15,-.45,-.4),f.add(Nt);const Rt=new ft(.18,32,32),$t=new y(Rt,rt);$t.position.set(0,-.35,-.8),f.add($t),$t.renderOrder=1,new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(me){const Be=new ke("X",{font:me,size:.2,depth:.05}),Re=new y(Be,k);Re.position.set(-.3,.99,.53),Re.rotation.x=le.degToRad(-5),Re.rotation.y=le.degToRad(-15),f.add(Re);const je=new ke("O",{font:me,size:.2,depth:.05}),Ne=new y(je,k);Ne.position.set(.14,.99,.53),Ne.rotation.y=le.degToRad(12),Ne.rotation.x=le.degToRad(-5),f.add(Ne)}),f.add(E);const Yt=d(),G=d(),yt=d(),st=d();Yt.position.set(.35,-.35,-.3),G.position.set(.25,-.45,.3),yt.position.set(.3,.1,-.2),st.position.set(.25,.18,.4),Yt.scale.set(.3,.3,.3),G.scale.set(.28,.28,.28),yt.scale.set(.25,.25,.25),st.scale.set(.23,.23,.23),G.rotation.z=Math.PI/4,yt.rotation.z=-Math.PI/4,st.rotation.y=-Math.PI/2,f.add(Yt),f.add(G),f.add(yt),f.add(st);const tt=new Cn;tt.moveTo(-.5,0),tt.bezierCurveTo(-.75,.25,-1,.6,-.5,.8),tt.bezierCurveTo(-.25,.85,-.25,.5,-.15,.4),tt.bezierCurveTo(-.05,.6,.05,.6,.15,.4),tt.bezierCurveTo(.25,.5,.25,.85,.5,.8),tt.bezierCurveTo(1,.6,.75,.25,.5,0),tt.bezierCurveTo(.3,-.25,-.3,-.25,-.5,0);const St={depth:.3,bevelEnabled:!1},Et=new Hn(tt,St),kt=new es({color:0}),te=new y(Et,kt);te.scale.set(.3,.3,.6),te.rotation.x=0,te.rotation.z=0,te.position.set(.26,.35,.25),f.add(te);const se=new y(Et,kt);se.scale.set(.5,.5,.5),se.position.set(.4,-.1,.54),f.add(se);const oe=new y(Et,kt);oe.scale.set(.5,.5,.5),oe.position.set(.32,-.35,.65),f.add(oe),f.rotation.x=.1,f.scale.set(1.4,1.4,1.4),v.add(f),f.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),x.position.set(t.bodyPosition.x,1,t.cameraPosition),x.lookAt(t.bodyPosition.x,0,0),x.position.z=4;const ee=[te,se,oe],fe=new zp,ae=[0,Math.PI/2,Math.PI,0,Math.PI/3];let ve=.05,ce=.25,Pe=0;p(),Ve(()=>t.bodyPosition,me=>{f.position.set(me.x,me.y,me.z)}),Ve(()=>t.cameraPosition,me=>{x.position.set(t.bodyPosition.x,1,me),x.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{x.aspect=window.innerWidth/window.innerHeight,x.updateProjectionMatrix(),m.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,p)=>(Wn(),Yn(fn,null,[Bt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),Bt("div",XS,[Bt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),Bt("div",qS,[Bt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Bt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),Bt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),YS=$n(jS,[["__scopeId","data-v-5eff72b3"]]),$S={class:"pixel-controls"},KS={class:"side-buttons"},ZS=Ln({__name:"GhostBallonBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);Vn(()=>{if(e.value){let d=function(){requestAnimationFrame(d),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),o.value&&(m.rotation.x-=.03),r.value&&(m.rotation.x+=.03),Z.rotation.y+=.03,kt+=st,te+=tt,m.position.y=t.bodyPosition.y+Math.sin(kt)*Et,Z.position.y=t.bodyPosition.y+Math.sin(te)*St,Yt.uniforms.u_time.value+=.25,x.render(p,v)};const p=new Gn,v=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zn({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(x.domElement);const m=new Xt,f=new Xt;p.add(f);const A=new hi(16777215,2);p.add(A);const S=new ui(16777215,4);S.position.set(5,5,5),p.add(S);const b=new li(16777215,5,50);b.position.set(0,2,4),p.add(b);const B=new jn,I=B.load("/3d-bear-arts/assets/ghost.jpg");I.wrapS=I.wrapT=$e,I.repeat.set(2,2);const R=B.load("/3d-bear-arts/assets/ghost.jpg");R.wrapS=R.wrapT=$e,R.repeat.set(1,1);const z=new Ot({color:16777215,metalness:0,roughness:.8,clearcoat:.3,clearcoatRoughness:.9,transparent:!0,opacity:.15,transmission:.95,ior:1.1,reflectivity:.2,envMapIntensity:.3,depthTest:!0,depthWrite:!1,side:be}),Q=new Ot({color:16777215,metalness:0,roughness:.8,clearcoat:.3,clearcoatRoughness:.9,transparent:!0,opacity:.1,envMapIntensity:.3}),M=new Ot({color:9109504,map:I,metalness:.9,roughness:.25,clearcoat:.7,clearcoatRoughness:.3}),E=new Ot({color:16777215,metalness:.1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.1,transmission:.95,ior:1,reflectivity:.2,envMapIntensity:.4,depthTest:!0,depthWrite:!1,side:be}),U=new Ot({color:16777215,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.45,transmission:.8,reflectivity:.9,envMapIntensity:1,depthTest:!0,depthWrite:!1,side:be}),k=new Ot({color:16777215,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.45,transmission:.8,reflectivity:.9,envMapIntensity:1,side:be}),et=new ft(1,32,32,0,Math.PI),rt=new y(et,z),$=new y(et,U);rt.scale.set(.85,.85,.8),$.scale.set(.85,.85,.8),rt.position.y=-.2,$.position.y=-.2,rt.rotation.y=Math.PI/2,$.rotation.y=Math.PI*1.5;const nt=new Ae(1,32),X=new y(nt,U);X.scale.set(.85,.85,.8),X.position.set(0,-.2,0),X.rotation.y=Math.PI/2;const vt=new Xt;vt.add(rt),vt.add($),vt.add(X),m.add(vt);const xt=new ft(.6,32,32,0,Math.PI),wt=new y(xt,k);wt.scale.set(1,.95,.95),wt.position.set(0,1,0),wt.rotation.y=Math.PI*1.5;const Dt=new y(xt,Q);Dt.scale.set(1,.95,.95),Dt.position.set(0,1,0),Dt.rotation.y=Math.PI/2;const Wt=new Ae(.6,32),at=new y(Wt,U);at.position.set(0,1,0),at.rotation.y=Math.PI/2,at.scale.set(1,.95,.95);const pt=new Xt;pt.add(wt),pt.add(Dt),pt.add(at),m.add(pt);const bt=new ft(.25,32,32),O=new y(bt,k);O.position.set(-.45,1.35,-.1),m.add(O);const lt=new y(bt,Q);lt.position.set(.45,1.35,-.1),m.add(lt);const ot=new ft(.25,32,32,Math.PI/2,Math.PI),ht=new y(ot,k);ht.scale.set(1.1,.6,.8),ht.position.set(0,.84,.5),ht.rotation.y=Math.PI;const Mt=new ft(.25,32,32,Math.PI/2,Math.PI),it=new y(Mt,Q);it.scale.set(1.1,.6,.8),it.position.set(0,.84,.5),it.rotation.y=0;const g=new Ae(.25,32),T=new y(g,E);T.scale.set(.8,.6,.8),T.position.set(0,.84,.5),T.rotation.y=Math.PI/2;const L=new Xt;L.add(ht),L.add(it),L.add(T),m.add(L);const F=new Cn;F.moveTo(0,0),F.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),F.bezierCurveTo(-.6,.3,0,.6,0,1),F.bezierCurveTo(0,.6,.6,.3,.6,0),F.bezierCurveTo(.6,-.3,0,-.3,0,0);const N={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},K=new Hn(F,N),Z=new y(K,M);Z.scale.set(.35,.35,.35),Z.position.set(0,-.05,0),Z.rotation.y=Math.PI,Z.rotation.x=Math.PI,m.add(Z);const w=new ft(.35,32,32),_=new y(w,U);_.scale.set(.75,1.25,.65),_.position.set(-.7,-.15,.2),m.add(_);const C=new y(w,E);C.scale.set(.75,1.25,.65),C.position.set(.7,-.15,.2),m.add(C);const q=new ne(.2,.22,.6,32),V=new y(q,U);V.position.set(-.4,-1.05,0),m.add(V);const W=new y(q,E);W.position.set(.4,-1.05,0),m.add(W);const dt=new ft(.3,32,32),ct=new y(dt,U);ct.scale.set(1,.72,1.5),ct.position.set(-.4,-1.45,.17),m.add(ct);const mt=new y(dt,E);mt.scale.set(1,.72,1.5),mt.position.set(.4,-1.45,.17),m.add(mt);const At=new ft(.44,32,32),ut=new y(At,E);ut.position.set(-.15,-.45,-.4),m.add(ut);const _t=new y(At,E);_t.position.set(.15,-.45,-.4),m.add(_t);const Lt=new ft(.18,32,32),Nt=new y(Lt,U);Nt.position.set(0,-.35,-.8),m.add(Nt);const Rt=new ft(.6,32,32,0,Math.PI*2,0,Math.PI/2),$t=new Ot({color:9109504,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.8,transmission:.85,ior:1.4,reflectivity:.9,envMapIntensity:1.2}),zt=new y(Rt,$t);zt.position.set(0,-.2,0),zt.rotation.x=Math.PI,zt.scale.set(1.25,1.25,1.25),vt.add(zt);const Yt=new on({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:4},u_waveAmplitude:{value:.5},u_waveSpeed:{value:.3}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),G=new y(nt,Yt);G.position.set(0,-.26,0),G.scale.set(.7,.7,.7),G.rotation.x=-Math.PI/2,G.renderOrder=1,vt.add(G),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(se){const oe=new ke("X",{font:se,size:.2,depth:.05}),ee=new y(oe,U);ee.position.set(-.3,.99,.53),ee.rotation.x=le.degToRad(-5),ee.rotation.y=le.degToRad(-15),m.add(ee);const fe=new ke("O",{font:se,size:.2,depth:.05}),ae=new y(fe,U);ae.position.set(.14,.99,.53),ae.rotation.y=le.degToRad(12),ae.rotation.x=le.degToRad(-5),m.add(ae)}),Nt.renderOrder=1,m.rotation.x=.1,m.scale.set(1.4,1.4,1.4),p.add(m),m.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),v.position.set(t.bodyPosition.x,1,t.cameraPosition),v.lookAt(t.bodyPosition.x,0,0),v.position.z=4;let st=.05,tt=.06,St=.2,Et=.25,kt=0,te=0;d(),Ve(()=>t.bodyPosition,se=>{m.position.set(se.x,se.y,se.z)}),Ve(()=>t.cameraPosition,se=>{v.position.set(t.bodyPosition.x,1,se),v.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{v.aspect=window.innerWidth/window.innerHeight,v.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,p)=>(Wn(),Yn(fn,null,[Bt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),Bt("div",$S,[Bt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),Bt("div",KS,[Bt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Bt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),Bt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),JS=$n(ZS,[["__scopeId","data-v-eb44448e"]]),QS={class:"pixel-controls"},tb={class:"side-buttons"},eb=15,nb=5,ib=Ln({__name:"Santa",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);const a=po(null),c=new zn({antialias:!0});c.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(c.domElement),new Gn;const l=new qe(75,window.innerWidth/window.innerHeight,.1,1e3);l.position.z=5,Vn(()=>{if(e.value){let x=function(){const Ct=new Xt,he=new si(.12,.05,16,100),P=new Ut({color:16777215}),Y=new y(he,P);Y.position.set(0,1.65,0),Y.rotation.x=Math.PI/2,Ct.add(Y);const D=new ai(.15,.3,32),j=new Ut({color:16711680}),H=new y(D,j);H.position.set(0,1.8,0),Ct.add(H);const gt=new ft(.05,32,32),It=new Ut({color:16777215}),Ft=new y(gt,It);return Ft.position.set(0,1.93,0),Ct.add(Ft),Ct.position.set(0,-.1,0),Ct},m=function(){const Ct=new Xt,he=new ft(.15,32,32),P=new Ut({color:16764057}),Y=new y(he,P);Y.position.set(0,.4,0),Ct.add(Y);const D=new ai(.08,.15,32);new Ut({color:16764057});const j=new y(D,Dt);j.position.set(-.1,.55,0),j.rotation.z=Math.PI/6,Ct.add(j);const H=new y(D,Dt);H.position.set(.1,.55,0),H.rotation.z=-Math.PI/6,Ct.add(H);const gt=new ne(.12,.15,.3,32),It=new Ut({color:16764057}),Ft=new y(gt,It);Ft.position.set(0,.2,0),Ct.add(Ft);const Ht=new ne(.05,.05,.2,32),Kt=new Ut({color:16764057}),Qt=new y(Ht,Kt);Qt.position.set(-.07,-.05,.05),Ct.add(Qt);const Vt=new y(Ht,Kt);Vt.position.set(.07,-.05,.05),Ct.add(Vt);const ie=new ne(.04,.04,.2,32),de=new Ut({color:16764057}),ue=new y(ie,Dt);ue.position.set(-.15,.25,0),ue.rotation.z=Math.PI/4,Ct.add(ue);const Pt=new y(ie,de);Pt.position.set(.15,.25,0),Pt.rotation.z=-Math.PI/4,Ct.add(Pt);const qt=new ne(.03,.03,.25,32),Gt=new Ut({color:16764057}),re=new y(qt,Gt);return re.position.set(0,.1,-.2),re.rotation.x=Math.PI/4,Ct.add(re),Ct.scale.set(.75,.75,.75),Ct.position.set(.2,0,.2),Ct},f=function(){const Ct=new Xt,he=new ft(.2,32,32),P=new Ut({color:16764057}),Y=new y(he,P);Y.position.set(0,1,0),Ct.add(Y);const D=new Ut({color:16777215}),j=[{x:0,y:.85,z:.15,size:.12},{x:-.1,y:.88,z:.1,size:.1},{x:.1,y:.88,z:.1,size:.1},{x:-.15,y:.95,z:.1,size:.08},{x:.15,y:.95,z:.1,size:.08}];for(const fi of j){const Ar=new ft(fi.size,16,16),Ws=new y(Ar,D);Ws.position.set(fi.x,fi.y-.06,fi.z-.01),Ct.add(Ws)}const H=new Ut({color:16777215}),gt=new ne(.05,.06,.1,32),It=new y(gt,H);It.position.set(-.06,.93,.18),It.rotation.z=Math.PI/4;const Ft=new ne(.05,.06,.1,32),Ht=new y(Ft,H);Ht.position.set(.06,.93,.18),Ht.rotation.z=-Math.PI/4;const Kt=new si(.12,.05,16,100),Qt=new Ut({color:16777215}),Vt=new y(Kt,Qt);Vt.position.set(0,1.15,0),Vt.rotation.x=Math.PI/2,Ct.add(Vt);const ie=new ai(.15,.3,32),de=new Ut({color:16711680}),ue=new y(ie,de);ue.position.set(0,1.3,0),Ct.add(ue);const Pt=new ft(.05,32,32),qt=new Ut({color:16777215}),Gt=new y(Pt,qt);Gt.position.set(0,1.43,0),Ct.add(Gt);const re=new ne(.2,.25,.6,32),Tt=new Ut({color:16711680}),ye=new y(re,Tt);ye.position.set(0,.5,0),Ct.add(ye);const Ee=new ne(.25,.25,.1,32),ge=new Ut({color:0}),Ie=new y(Ee,ge);Ie.position.set(0,.4,.005),Ct.add(Ie);const pe=new ne(.06,.06,.3,32),Ce=new Ut({color:16711680}),ze=new y(pe,Ce);ze.position.set(-.25,.75,0),ze.rotation.z=Math.PI/4,Ct.add(ze);const Te=new y(pe,Ce);Te.position.set(.25,.75,0),Te.rotation.z=-Math.PI/4,Ct.add(Te);const Fe=new ft(.07,32,32),Ke=new Ut({color:16777215}),We=new y(Fe,Ke);We.position.set(-.35,.85,0),Ct.add(We);const sn=new y(Fe,Ke);sn.position.set(.35,.85,0),Ct.add(sn);const tn=new ne(.1,.1,.15,32),en=new Ut({color:16711680}),cn=new ne(.08,.08,.4,32),rn=new Ut({color:0}),ln=new y(cn,rn);ln.position.set(-.1,.1,0),Ct.add(ln);const dn=new y(tn,en);dn.position.set(-.1,-.05,0),Ct.add(dn);const bn=new y(cn,rn);bn.position.set(.1,.1,0),Ct.add(bn);const bi=new y(tn,en);bi.position.set(.1,-.05,0),Ct.add(bi);const Fi=new ft(.12,32,32),Oi=new Ut({color:16711680}),Bi=new y(Fi,Oi);Bi.scale.set(1,.7,1.5),Bi.position.set(-.1,-.12,.12),Ct.add(Bi);const Ei=new y(Fi,Oi);return Ei.scale.set(1,.7,1.5),Ei.position.set(.1,-.1,.12),Ct.add(Ei),Ct.scale.set(.25,.25,.25),Ct.position.set(.2,.5,-0),Ct},A=function(){let Ct=0;function he(){requestAnimationFrame(he),Ct+=.4,ve.position.y=.45+Math.sin(Ct)*.5,E.render(Q,M)}he()},S=function(Ct){let he=1,P=0;function Y(){requestAnimationFrame(Y),Ct.position.x+=.01*he,Ct.position.x>=.5?(he=-1,Ct.rotation.y=Math.PI):Ct.position.x<=0&&(he=1,Ct.rotation.y=0),P+=1,Ct.position.y=-.2+Math.sin(P)*.01,Ct.position.z=.5,E.render(Q,M)}Y()},b=function(){const Ct=new Xt,he=new yn(.7,.8,.7),P=new Ut({color:9127187}),Y=new y(he,P);Y.position.set(0,.4,0),Ct.add(Y);const D=new ai(.55,.25,4),j=new Ut({color:16777215}),H=new y(D,j);H.position.set(0,.9,0),H.rotation.y=Math.PI/4,Ct.add(H);const gt=new yn(.25,.35,.05),It=new Ut({color:6636321}),Ft=new y(gt,It);Ft.position.set(0,.2,.36),Ct.add(Ft);const Ht=new yn(.15,.15,.05),Kt=new Ut({color:8900331}),Qt=new y(Ht,Kt);Qt.position.set(-.2,.5,.38),Ct.add(Qt);const Vt=new y(Ht,Kt);Vt.position.set(.2,.5,.38),Ct.add(Vt);const ie=new yn(.2,.4,.2),de=new Ut({color:8421504}),ue=new y(ie,de);ue.position.set(0,.95,0),Ct.add(ue);const Pt=new si(.07,.04,32,100),qt=new Ut({color:2263842}),Gt=new y(Pt,qt);return Gt.position.set(0,.45,.38),Ct.add(Gt),Ct.position.set(.22,-.2,0),Ct.scale.set(.5,.5,.5),Ct},B=function(Ct=1,he={x:0,y:0,z:0}){const P=new Xt,Y=new ne(1.2,.9,3,32),D=new Ut({color:25153}),j=new y(Y,D);P.add(j);const H=new ne(1.3,1.3,.2,32),gt=new Ut({color:3355443}),It=new y(H,gt);It.position.y=1.6,P.add(It);const Ft=2,Ht=new ne(1.1,1.1,Ft,32),Kt=new Ut({color:9127187}),Qt=new y(Ht,Kt);return Qt.position.y=0,new jn().load("/3d-bear-arts/assets/starbucks-logo.png",function(ie){ie.repeat.set(4,1),ie.offset.set(.25,0),ie.wrapS=$e,ie.wrapT=$e;const de=new Ut({color:9127187,map:ie,transparent:!0}),ue=new ne(1.1,1.05,1.5,32),Pt=new y(ue,de);Pt.position.y=-.5,P.add(Pt)}),P.scale.set(Ct,Ct,Ct),P.position.set(he.x,he.y,he.z),P},I=function(){let Ct=1;function he(){requestAnimationFrame(he),Ct-=.1,Re.position.y=.5+Math.sin(Ct)*.8,E.render(Q,M)}he()},R=function(){requestAnimationFrame(R);const Ct=Ne.attributes.position.array;for(let he=1;he<Ct.length;he+=3)Ct[he]-=.02,Ct[he]<-10&&(Ct[he]=10);Ne.attributes.position.needsUpdate=!0,E.render(Q,M)},z=function(){requestAnimationFrame(z),i.value&&(U.rotation.y+=.03),s.value&&(U.rotation.y-=.03),o.value&&(U.rotation.x-=.03),r.value&&(U.rotation.x+=.03),a.value&&(a.value.rotation.y+=.7),q.uniforms.u_time.value+=.5,ce.rotation.y+=.45,Be.rotation.y+=.05,Re.rotation.y+=.08,E.render(Q,M)};const Q=new Gn,M=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),E=new zn({antialias:!0,alpha:!0});E.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(E.domElement);const U=new Xt,k=new Xt;Q.add(k);const et=new hi(16777215,2);Q.add(et);const rt=new ui(16777215,4);rt.position.set(5,5,5),Q.add(rt);const $=new li(16777215,5,50);$.position.set(0,2,4),Q.add($);const nt=new jn,X=nt.load("/3d-bear-arts/assets/house.jpg");X.wrapS=X.wrapT=$e,X.repeat.set(1,1),nt.load("/3d-bear-arts/assets/houseenv_texture_5.jpg");const vt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.6,transmission:1,ior:1.33,thickness:.01,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:be}),xt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.35,transmission:1,ior:1.33,thickness:.01,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:be}),wt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.4,transmission:.7,ior:1.33,thickness:.5,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:be}),Dt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.6,transmission:.8,ior:1.33,thickness:.7,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:be}),Wt=new Tr().load(["/3d-bear-arts/assets/house_env_texture_1.jpg","/3d-bear-arts/assets/house_env_texture_4.jpg","/3d-bear-arts/assets/house_env_texture_6.jpg","/3d-bear-arts/assets/house_env_texture_2.jpg","/3d-bear-arts/assets/house_env_texture_5.jpg","/3d-bear-arts/assets/house_env_texture_3.jpg"]);Q.environment=Wt;const at=new Ot({color:16777215,metalness:.05,roughness:.2,transparent:!0,opacity:.5,transmission:.2,ior:1.5,depthWrite:!0,envMapIntensity:1,side:be}),pt=new Ot({color:16777215,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),bt=new ft(1,32,32,0,Math.PI),O=new y(bt,xt),lt=new y(bt,wt);O.scale.set(.85,.85,.8),lt.scale.set(.85,.85,.8),O.position.y=-.2,lt.position.y=-.2,O.rotation.y=Math.PI/2,lt.rotation.y=Math.PI*1.5;const ot=new Ae(1,32),ht=new y(ot,at);ht.scale.set(.85,.85,.8),ht.position.set(0,-.2,0),ht.rotation.y=Math.PI/2;const Mt=new Xt;Mt.add(O),Mt.add(lt),Mt.add(ht),U.add(Mt);const it=new ft(.6,32,32,0,Math.PI),g=new y(it,Dt);g.scale.set(1,.95,.95),g.position.set(0,1,0),g.rotation.y=Math.PI*1.5;const T=new y(it,xt);T.scale.set(1,.95,.95),T.position.set(0,1,0),T.rotation.y=Math.PI/2;const L=new Ae(.6,32),F=new y(L,at);F.position.set(0,1,0),F.rotation.y=Math.PI/2,F.scale.set(1,.95,.95);const N=new Xt;N.add(g),N.add(T),N.add(F),U.add(N);const K=new ft(.6,32,32,0,Math.PI*2,0,Math.PI/2),Z=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.5,clearcoatRoughness:.7,transparent:!1,opacity:.85}),w=new y(K,Z);w.position.set(0,-.2,0),w.rotation.x=Math.PI,w.scale.set(1.25,1.25,1.25),Mt.add(w);const _=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.6,clearcoatRoughness:.8,side:be,transparent:!1,opacity:.8}),C=new y(ot,_);C.scale.set(.7,.7,.7),C.position.set(0,-.3,0),C.rotation.x=Math.PI/2,C.renderOrder=1,Mt.add(C),U.add(Mt);const q=new on({transparent:!0,uniforms:{u_time:{value:0}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),V=new y(ot,q);V.position.set(0,-.2,0),V.scale.set(.7,.7,.7),V.rotation.x=-Math.PI/2,V.renderOrder=2,Mt.add(V);const W=new ft(.25,32,32),dt=new y(W,Dt);dt.position.set(-.45,1.35,-.1),U.add(dt);const ct=new y(W,vt);ct.position.set(.45,1.35,-.1),U.add(ct);const mt=new ft(.25,32,32,Math.PI/2,Math.PI),At=new y(mt,Dt);At.scale.set(1.1,.6,.8),At.position.set(0,.84,.5),At.rotation.y=Math.PI;const ut=new ft(.25,32,32,Math.PI/2,Math.PI),_t=new y(ut,vt);_t.scale.set(1.1,.6,.8),_t.position.set(0,.84,.5),_t.rotation.y=0;const Lt=new Ae(.25,32),Nt=new y(Lt,at);Nt.scale.set(.8,.6,.8),Nt.position.set(0,.84,.5),Nt.rotation.y=Math.PI/2;const Rt=new Xt;Rt.add(At),Rt.add(_t),Rt.add(Nt),U.add(Rt);const $t=new ft(.35,32,32),zt=new y($t,Dt);zt.scale.set(.75,1.25,.65),zt.position.set(-.7,-.15,.2),U.add(zt);const Yt=new y($t,vt);Yt.scale.set(.75,1.25,.65),Yt.position.set(.7,-.15,.2),U.add(Yt);const G=new ne(.2,.22,.6,32),yt=new y(G,Dt);yt.position.set(-.4,-1.05,0),U.add(yt);const st=new y(G,vt);st.position.set(.4,-1.05,0),U.add(st);const tt=new ft(.3,32,32),St=new y(tt,Dt);St.scale.set(1,.72,1.5),St.position.set(-.4,-1.45,.17),U.add(St);const Et=new y(tt,vt);Et.scale.set(1,.72,1.5),Et.position.set(.4,-1.45,.17),U.add(Et);const kt=new ft(.44,32,32),te=new y(kt,Dt);te.position.set(-.15,-.45,-.4),U.add(te);const se=new y(kt,pt);se.position.set(.15,-.45,-.4),U.add(se);const oe=new ft(.18,32,32),ee=new y(oe,Dt);ee.position.set(0,-.35,-.8),U.add(ee),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Ct){const he=new ke("X",{font:Ct,size:.2,depth:.05}),P=new y(he,pt);P.position.set(-.3,.99,.53),P.rotation.x=le.degToRad(-5),P.rotation.y=le.degToRad(-15),U.add(P);const Y=new ke("+",{font:Ct,size:.25,depth:.1}),D=new y(Y,pt);D.position.set(.12,.99,.53),D.rotation.y=le.degToRad(12),D.rotation.x=le.degToRad(-5),U.add(D)});const ae=x();U.add(ae),m();const ve=f();U.add(ve);const ce=f();ce.position.set(-.2,-.1,.5),U.add(ce),A(),a.value=f(),U.add(a.value),S(a.value);const Pe=b();U.add(Pe);const me=b();me.position.set(-.2,-.2,0),me.scale.set(.35,.35,.35),U.add(me);const Be=B(.1,{x:0,y:0,z:1}),Re=B(1.1,{x:0,y:-1.2,z:0});I();const je=1e3,Ne=new Sn,hn=[];for(let Ct=0;Ct<je;Ct++){const he=(Math.random()-.5)*20,P=Math.random()*20,Y=(Math.random()-.5)*20;hn.push(he,P,Y)}Ne.setAttribute("position",new Qe(hn,3));const Dn=new vr({color:16777215,size:.1,transparent:!0,opacity:.8}),gn=new sr(Ne,Dn);U.add(gn),R(),U.scale.set(1.2,1.2,1.2),Q.add(U),U.scale.set(1.4,1.4,1.4),U.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),Q.add(U),U.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),M.position.set(t.bodyPosition.x,1.25,t.cameraPosition),M.lookAt(t.bodyPosition.x,0,0),M.position.z=4,U.rotation.x=.1,z(),Ve(()=>t.bodyPosition,Ct=>{U.position.set(Ct.x,Ct.y,Ct.z)}),Ve(()=>t.cameraPosition,Ct=>{M.position.set(t.bodyPosition.x,1,Ct),M.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{M.aspect=window.innerWidth/window.innerHeight,M.updateProjectionMatrix(),E.setSize(window.innerWidth,window.innerHeight)})}});function h(){s.value=!0}function u(){i.value=!0}function d(){o.value=!0}function p(){r.value=!0}function v(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let x=0;x<eb;x++){const m=document.createElement("div");m.classList.add("confetti"),m.style.left=`${Math.random()*100}vw`,m.style.animationDuration=`${Math.random()*3+4}s`,m.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(m)}for(let x=0;x<nb;x++){const m=document.createElement("div");m.classList.add("light"),document.body.appendChild(m)}return(x,m)=>(Wn(),Yn(fn,null,[Bt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),Bt("div",QS,[Bt("button",{class:"pixel-btn up",onMousedown:d,onMouseup:v},"UP",32),Bt("div",tb,[Bt("button",{class:"pixel-btn left",onMousedown:h,onMouseup:v},"LEFT",32),Bt("button",{class:"pixel-btn right",onMousedown:u,onMouseup:v},"RIGHT",32)]),Bt("button",{class:"pixel-btn down",onMousedown:p,onMouseup:v},"DOWN",32)])],64))}}),sb=$n(ib,[["__scopeId","data-v-28f29b57"]]),ob={class:"pixel-controls"},rb={class:"side-buttons"},ab=15,cb=5,lb=Ln({__name:"Aquar",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);const a=po(null),c=new zn({antialias:!0});c.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(c.domElement),new Gn;const l=new qe(75,window.innerWidth/window.innerHeight,.1,1e3);l.position.z=5,Vn(()=>{if(e.value){let x=function(){const D=new Xt,j=new si(.12,.05,16,100),H=new Ut({color:16777215}),gt=new y(j,H);gt.position.set(0,1.65,0),gt.rotation.x=Math.PI/2,D.add(gt);const It=new ai(.15,.3,32),Ft=new Ut({color:16711680}),Ht=new y(It,Ft);Ht.position.set(0,1.8,0),D.add(Ht);const Kt=new ft(.05,32,32),Qt=new Ut({color:16777215}),Vt=new y(Kt,Qt);return Vt.position.set(0,1.93,0),D.add(Vt),D.position.set(0,-.1,0),D},m=function(){const D=new Xt,j=new ft(.15,32,32),H=new Ut({color:16764057}),gt=new y(j,H);gt.position.set(0,.4,0),D.add(gt);const It=new ai(.08,.15,32);new Ut({color:16764057});const Ft=new y(It,xt);Ft.position.set(-.1,.55,0),Ft.rotation.z=Math.PI/6,D.add(Ft);const Ht=new y(It,xt);Ht.position.set(.1,.55,0),Ht.rotation.z=-Math.PI/6,D.add(Ht);const Kt=new ne(.12,.15,.3,32),Qt=new Ut({color:16764057}),Vt=new y(Kt,Qt);Vt.position.set(0,.2,0),D.add(Vt);const ie=new ne(.05,.05,.2,32),de=new Ut({color:16764057}),ue=new y(ie,de);ue.position.set(-.07,-.05,.05),D.add(ue);const Pt=new y(ie,de);Pt.position.set(.07,-.05,.05),D.add(Pt);const qt=new ne(.04,.04,.2,32),Gt=new Ut({color:16764057}),re=new y(qt,xt);re.position.set(-.15,.25,0),re.rotation.z=Math.PI/4,D.add(re);const Tt=new y(qt,Gt);Tt.position.set(.15,.25,0),Tt.rotation.z=-Math.PI/4,D.add(Tt);const ye=new ne(.03,.03,.25,32),Ee=new Ut({color:16764057}),ge=new y(ye,Ee);return ge.position.set(0,.1,-.2),ge.rotation.x=Math.PI/4,D.add(ge),D.scale.set(.75,.75,.75),D.position.set(.2,0,.2),D},f=function(){const D=new Xt,j=new ft(.2,32,32),H=new Ut({color:16764057}),gt=new y(j,H);gt.position.set(0,1,0),D.add(gt);const It=new Ut({color:16777215}),Ft=[{x:0,y:.85,z:.15,size:.12},{x:-.1,y:.88,z:.1,size:.1},{x:.1,y:.88,z:.1,size:.1},{x:-.15,y:.95,z:.1,size:.08},{x:.15,y:.95,z:.1,size:.08}];for(const Pr of Ft){const kp=new ft(Pr.size,16,16),Fu=new y(kp,It);Fu.position.set(Pr.x,Pr.y-.06,Pr.z-.01),D.add(Fu)}const Ht=new Ut({color:16777215}),Kt=new ne(.05,.06,.1,32),Qt=new y(Kt,Ht);Qt.position.set(-.06,.93,.18),Qt.rotation.z=Math.PI/4;const Vt=new ne(.05,.06,.1,32),ie=new y(Vt,Ht);ie.position.set(.06,.93,.18),ie.rotation.z=-Math.PI/4;const de=new si(.12,.05,16,100),ue=new Ut({color:16777215}),Pt=new y(de,ue);Pt.position.set(0,1.15,0),Pt.rotation.x=Math.PI/2,D.add(Pt);const qt=new ai(.15,.3,32),Gt=new Ut({color:16711680}),re=new y(qt,Gt);re.position.set(0,1.3,0),D.add(re);const Tt=new ft(.05,32,32),ye=new Ut({color:16777215}),Ee=new y(Tt,ye);Ee.position.set(0,1.43,0),D.add(Ee);const ge=new ne(.2,.25,.6,32),Ie=new Ut({color:16711680}),pe=new y(ge,Ie);pe.position.set(0,.5,0),D.add(pe);const Ce=new ne(.25,.25,.1,32),ze=new Ut({color:0}),Te=new y(Ce,ze);Te.position.set(0,.4,.005),D.add(Te);const Fe=new ne(.06,.06,.3,32),Ke=new Ut({color:16711680}),We=new y(Fe,Ke);We.position.set(-.25,.75,0),We.rotation.z=Math.PI/4,D.add(We);const sn=new y(Fe,Ke);sn.position.set(.25,.75,0),sn.rotation.z=-Math.PI/4,D.add(sn);const tn=new ft(.07,32,32),en=new Ut({color:16777215}),cn=new y(tn,en);cn.position.set(-.35,.85,0),D.add(cn);const rn=new y(tn,en);rn.position.set(.35,.85,0),D.add(rn);const ln=new ne(.1,.1,.15,32),dn=new Ut({color:16711680}),bn=new ne(.08,.08,.4,32),bi=new Ut({color:0}),Fi=new y(bn,bi);Fi.position.set(-.1,.1,0),D.add(Fi);const Oi=new y(ln,dn);Oi.position.set(-.1,-.05,0),D.add(Oi);const Bi=new y(bn,bi);Bi.position.set(.1,.1,0),D.add(Bi);const Ei=new y(ln,dn);Ei.position.set(.1,-.05,0),D.add(Ei);const fi=new ft(.12,32,32),Ar=new Ut({color:16711680}),Ws=new y(fi,Ar);Ws.scale.set(1,.7,1.5),Ws.position.set(-.1,-.12,.12),D.add(Ws);const Qa=new y(fi,Ar);return Qa.scale.set(1,.7,1.5),Qa.position.set(.1,-.1,.12),D.add(Qa),D.scale.set(.25,.25,.25),D.position.set(.2,.5,-0),D},A=function(){let D=0;function j(){requestAnimationFrame(j),D+=.4,fe.position.y=.45+Math.sin(D)*.5,E.render(Q,M)}j()},S=function(D){let j=1,H=0;function gt(){requestAnimationFrame(gt),D.position.x+=.01*j,D.position.x>=.5?(j=-1,D.rotation.y=Math.PI):D.position.x<=0&&(j=1,D.rotation.y=0),H+=1,D.position.y=-.2+Math.sin(H)*.01,D.position.z=.5,E.render(Q,M)}gt()},b=function(){const D=new Xt,j=new yn(.7,.8,.7),H=new Ut({color:9127187}),gt=new y(j,H);gt.position.set(0,.4,0),D.add(gt);const It=new ai(.55,.25,4),Ft=new Ut({color:16777215}),Ht=new y(It,Ft);Ht.position.set(0,.9,0),Ht.rotation.y=Math.PI/4,D.add(Ht);const Kt=new yn(.25,.35,.05),Qt=new Ut({color:6636321}),Vt=new y(Kt,Qt);Vt.position.set(0,.2,.36),D.add(Vt);const ie=new yn(.15,.15,.05),de=new Ut({color:8900331}),ue=new y(ie,de);ue.position.set(-.2,.5,.38),D.add(ue);const Pt=new y(ie,de);Pt.position.set(.2,.5,.38),D.add(Pt);const qt=new yn(.2,.4,.2),Gt=new Ut({color:8421504}),re=new y(qt,Gt);re.position.set(0,.95,0),D.add(re);const Tt=new si(.07,.04,32,100),ye=new Ut({color:2263842}),Ee=new y(Tt,ye);return Ee.position.set(0,.45,.38),D.add(Ee),D.position.set(.22,-.2,0),D.scale.set(.5,.5,.5),D},B=function(D=1,j={x:0,y:0,z:0}){const H=new Xt,gt=new ne(1.2,.9,3,32),It=new Ut({color:25153}),Ft=new y(gt,It);H.add(Ft);const Ht=new ne(1.3,1.3,.2,32),Kt=new Ut({color:3355443}),Qt=new y(Ht,Kt);return Qt.position.y=1.6,H.add(Qt),new jn().load("/3d-bear-arts/assets/starbucks-logo.png",function(ie){ie.repeat.set(4,1),ie.offset.set(.25,0),ie.wrapS=$e,ie.wrapT=$e;const de=new Ut({color:9127187,map:ie,transparent:!0}),ue=new ne(1.1,1.05,1.5,32),Pt=new y(ue,de);Pt.position.y=-.5,H.add(Pt)}),H.scale.set(D,D,D),H.position.set(j.x,j.y,j.z),H},I=function(){requestAnimationFrame(I);const D=Re.attributes.position.array;for(let j=1;j<D.length;j+=3)D[j]-=.02,D[j]<-10&&(D[j]=10);Re.attributes.position.needsUpdate=!0,E.render(Q,M)},R=function(){requestAnimationFrame(R);const D=he.attributes.position.array;for(let j=1;j<D.length;j+=3)D[j]-=.02,D[j]<-Ct&&(D[j]=Ct);he.attributes.position.needsUpdate=!0,E.render(Q,M)},z=function(){requestAnimationFrame(z),i.value&&(U.rotation.y+=.03),s.value&&(U.rotation.y-=.03),o.value&&(U.rotation.x-=.03),r.value&&(U.rotation.x+=.03),a.value&&(a.value.rotation.y+=.7),_.uniforms.u_time.value+=.5,ae.rotation.y+=.45,Pe.rotation.y+=.05,me.rotation.y+=.05,U.rotation.y-=.05,E.render(Q,M)};const Q=new Gn,M=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),E=new zn({antialias:!0,alpha:!0});E.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(E.domElement);const U=new Xt,k=new Xt;Q.add(k);const et=new hi(16777215,2);Q.add(et);const rt=new ui(16777215,4);rt.position.set(5,5,5),Q.add(rt);const $=new li(16777215,5,50);$.position.set(0,2,4),Q.add($);const nt=new jn,X=nt.load("/3d-bear-arts/assets/house.jpg");X.wrapS=X.wrapT=$e,X.repeat.set(1,1),nt.load("/3d-bear-arts/assets/houseenv_texture_5.jpg");const vt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.5,transmission:1,ior:1.33,thickness:.01,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:be});new Ot({color:16777215,metalness:.3,map:X,roughness:.05,transparent:!0,opacity:.5,transmission:.7,ior:1.33,thickness:.4,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:be});const xt=new Ot({color:16777215,metalness:.3,roughness:.05,transparent:!0,opacity:.6,transmission:.8,ior:1.33,thickness:.7,depthWrite:!0,envMapIntensity:2,clearcoat:1,clearcoatRoughness:.1,side:be}),wt=new Tr().load(["/3d-bear-arts/assets/house_env_texture_1.jpg","/3d-bear-arts/assets/house_env_texture_4.jpg","/3d-bear-arts/assets/house_env_texture_6.jpg","/3d-bear-arts/assets/house_env_texture_2.jpg","/3d-bear-arts/assets/house_env_texture_5.jpg","/3d-bear-arts/assets/house_env_texture_3.jpg"]);Q.environment=wt;const Dt=new Ot({color:16777215,metalness:.05,roughness:.2,transparent:!0,opacity:.5,transmission:.2,ior:1.5,depthWrite:!0,envMapIntensity:1,side:be}),Wt=new Ot({color:16777215,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),at=new ft(1,32,32,0,Math.PI),pt=new y(at,vt),bt=new y(at,xt);pt.scale.set(.85,.85,.8),bt.scale.set(.85,.85,.8),pt.position.y=-.2,bt.position.y=-.2,pt.rotation.y=Math.PI/2,bt.rotation.y=Math.PI*1.5;const O=new Ae(1,32),lt=new y(O,Dt);lt.scale.set(.85,.85,.8),lt.position.set(0,-.2,0),lt.rotation.y=Math.PI/2;const ot=new Xt;ot.add(pt),ot.add(bt),ot.add(lt),U.add(ot);const ht=new ft(.6,32,32,0,Math.PI),Mt=new y(ht,xt);Mt.scale.set(1,.95,.95),Mt.position.set(0,1,0),Mt.rotation.y=Math.PI*1.5;const it=new y(ht,vt);it.scale.set(1,.95,.95),it.position.set(0,1,0),it.rotation.y=Math.PI/2;const g=new Ae(.6,32),T=new y(g,Dt);T.position.set(0,1,0),T.rotation.y=Math.PI/2,T.scale.set(1,.95,.95);const L=new Xt;L.add(Mt),L.add(it),L.add(T),U.add(L);const F=new ft(.6,32,32,0,Math.PI*2,0,Math.PI/2),N=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.5,clearcoatRoughness:.7,transparent:!1,opacity:.85}),K=new y(F,N);K.position.set(0,-.2,0),K.rotation.x=Math.PI,K.scale.set(1.25,1.25,1.25),ot.add(K);const Z=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.6,clearcoatRoughness:.8,side:be,transparent:!1,opacity:.8}),w=new y(O,Z);w.scale.set(.7,.7,.7),w.position.set(0,-.3,0),w.rotation.x=Math.PI/2,w.renderOrder=1,ot.add(w),U.add(ot);const _=new on({transparent:!0,uniforms:{u_time:{value:0}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
      ...
      `,nt=new on({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:rt,fragmentShader:$,transparent:!1,depthWrite:!0}),X=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,xt=new on({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:X,fragmentShader:vt,transparent:!1,depthWrite:!0}),wt=new ft(1,32,32,0,Math.PI),Dt=new y(wt,E),Wt=new y(wt,M);Dt.scale.set(.85,.85,.8),Wt.scale.set(.85,.85,.8),Dt.position.y=-.2,Wt.position.y=-.2,Dt.rotation.y=Math.PI/2,Wt.rotation.y=Math.PI*1.5;const at=new Ae(1,32),pt=new y(at,k);pt.scale.set(.85,.85,.8),pt.position.set(0,-.2,0),pt.rotation.y=Math.PI/2;const bt=new Xt;bt.add(Dt),bt.add(Wt),bt.add(pt),f.add(bt);const O=new ft(.6,32,32,0,Math.PI),lt=new y(O,M);lt.scale.set(1,.95,.95),lt.position.set(0,1,0),lt.rotation.y=Math.PI*1.5;const ot=new y(O,E);ot.scale.set(1,.95,.95),ot.position.set(0,1,0),ot.rotation.y=Math.PI/2;const ht=new Ae(.6,32),Mt=new y(ht,k);Mt.position.set(0,1,0),Mt.rotation.y=Math.PI/2,Mt.scale.set(1,.95,.95);const it=new Xt;it.add(lt),it.add(ot),it.add(Mt),f.add(it);const g=new ft(.25,32,32),T=new y(g,M);T.position.set(-.45,1.35,-.1),f.add(T);const L=new y(g,E);L.position.set(.45,1.35,-.1),f.add(L);const F=new ft(.25,32,32,Math.PI/2,Math.PI),N=new y(F,M);N.scale.set(1.1,.6,.8),N.position.set(0,.84,.5),N.rotation.y=Math.PI;const K=new ft(.25,32,32,Math.PI/2,Math.PI),Z=new y(K,E);Z.scale.set(1.1,.6,.8),Z.position.set(0,.84,.5),Z.rotation.y=0;const w=new Ae(.25,32),_=new y(w,k);_.scale.set(.8,.6,.8),_.position.set(0,.84,.5),_.rotation.y=Math.PI/2;const C=new Xt;C.add(N),C.add(Z),C.add(_),f.add(C);const q=new Cn;q.moveTo(0,0),q.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),q.bezierCurveTo(-.6,.3,0,.6,0,1),q.bezierCurveTo(0,.6,.6,.3,.6,0),q.bezierCurveTo(.6,-.3,0,-.3,0,0);const V={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},W=new Hn(q,V),dt=new y(W,nt);dt.scale.set(.38,.38,.38),dt.position.set(.35,0,0),dt.rotation.y=Math.PI,dt.rotation.x=Math.PI,f.add(dt);const ct=new y(W,nt);ct.scale.set(.35,.35,.35),ct.position.set(.3,0,0),ct.rotation.y=Math.PI,ct.rotation.x=Math.PI,f.add(ct);const mt=new y(W,M);mt.scale.set(.22,.22,.22),mt.position.set(.27,.4,0),mt.rotation.y=Math.PI,mt.rotation.x=Math.PI,f.add(mt);const At=new y(W,M);At.scale.set(.25,.25,.25),At.position.set(.23,-.5,.3),At.rotation.y=Math.PI,At.rotation.x=Math.PI,f.add(At);const ut=new y(W,M);ut.scale.set(.3,.3,.3),ut.position.set(.23,.2,-.4),ut.rotation.y=Math.PI,ut.rotation.x=Math.PI,f.add(ut);const _t=new ft(.35,32,32),Lt=new y(_t,M);Lt.scale.set(.75,1.25,.65),Lt.position.set(-.7,-.15,.2),f.add(Lt);const Nt=new y(_t,E);Nt.scale.set(.75,1.25,.65),Nt.position.set(.7,-.15,.2),f.add(Nt);const Rt=new ne(.2,.22,.6,32),$t=new y(Rt,M);$t.position.set(-.4,-1.05,0),f.add($t);const zt=new y(Rt,E);zt.position.set(.4,-1.05,0),f.add(zt);const Yt=new ft(.3,32,32),G=new y(Yt,M);G.scale.set(1,.72,1.5),G.position.set(-.4,-1.45,.17),f.add(G);const yt=new y(Yt,E);yt.scale.set(1,.72,1.5),yt.position.set(.4,-1.45,.17),f.add(yt);const st=new ft(.44,32,32),tt=new y(st,M);tt.position.set(-.15,-.45,-.4),f.add(tt);const St=new y(st,E);St.position.set(.15,-.45,-.4),f.add(St);const Et=new ft(.18,32,32),kt=new y(Et,M);kt.position.set(0,-.35,-.8),f.add(kt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ee){const fe=new ke("X",{font:ee,size:.18,depth:.05}),ae=new y(fe,nt);ae.position.set(-.3,.99,.53),ae.rotation.x=le.degToRad(-5),ae.rotation.y=le.degToRad(-15),f.add(ae);const ve=new ke("+",{font:ee,size:.25,depth:.1}),ce=new y(ve,nt);ce.position.set(.14,.99,.53),ce.rotation.y=le.degToRad(12),ce.rotation.x=le.degToRad(-5),f.add(ce)}),kt.renderOrder=1,f.scale.set(1.4,1.4,1.4),v.add(f),f.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),x.position.set(t.bodyPosition.x,1.4,t.cameraPosition),x.lookAt(t.bodyPosition.x,0,0),x.position.z=4;let se=jt(!1);const oe=ee=>{if(se.value){const fe={x:ee.clientX/window.innerWidth*2-1,y:-(ee.clientY/window.innerHeight)*2+1},ae=fe.x*Math.PI*.2,ve=fe.y*Math.PI*.2;f.rotation.y=ae,f.rotation.x=ve}};window.addEventListener("mousemove",oe),et.uniforms.time.value+=.04,p(),Ve(()=>t.bodyPosition,ee=>{f.position.set(ee.x,ee.y,ee.z)}),Ve(()=>t.cameraPosition,ee=>{x.position.set(t.bodyPosition.x,1,ee),x.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{x.aspect=window.innerWidth/window.innerHeight,x.updateProjectionMatrix(),m.setSize(window.innerWidth,window.innerHeight)})}});let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let d=0;d<mb;d++){const p=document.createElement("div");p.classList.add("confetti"),p.style.left=`${Math.random()*100}vw`,p.style.animationDuration=`${Math.random()*3+4}s`,p.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(p)}for(let d=0;d<gb;d++){const p=document.createElement("div");p.classList.add("light"),document.body.appendChild(p)}return(d,p)=>(Wn(),Yn(fn,null,[Bt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),Bt("div",null,[Ge(Gp,{class:"bear-background",color:"#FF69B4"})]),Bt("div",fb,[Bt("button",{class:"pixel-btn up border-gold",onMousedown:l,onMouseup:u},"▲",32),Bt("div",pb,[Bt("button",{class:"pixel-btn left border-silver",onMousedown:a,onMouseup:u},"◀",32),Bt("button",{class:"pixel-btn right border-silver",onMousedown:c,onMouseup:u},"▶",32)]),Bt("button",{class:"pixel-btn down border-gold",onMousedown:h,onMouseup:u},"▼",32)])],64))}}),_b=$n(vb,[["__scopeId","data-v-cb6b3b73"]]),xb={class:"pixel-controls"},yb={class:"side-buttons"},Mb=15,wb=5,Sb=Ln({__name:"Money",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);Vn(()=>{if(e.value){let d=function(){f.visible=!1,z.update(m,v),f.visible=!0,requestAnimationFrame(d)},p=function(){requestAnimationFrame(p),Dt.uniforms.time.value+=.05,vt.uniforms.time.value+=.05,i.value&&(f.rotation.y+=.05),s.value&&(f.rotation.y-=.07),o.value&&(f.rotation.x-=.05),r.value&&(f.rotation.x+=.05),m.render(v,x)};const v=new Gn,x=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),m=new zn({antialias:!0,alpha:!0});m.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(m.domElement);const f=new Xt,A=new hi(16777215,2);v.add(A);const S=new ui(16777215,4);S.position.set(5,5,5),v.add(S);const b=new li(16777215,5,50);b.position.set(0,2,4),v.add(b);const I=new jn().load("/3d-bear-arts/assets/cashwings.jpg"),R=new $a(256,{format:Xn,generateMipmaps:!0,minFilter:Ci}),z=new Ya(1,1e3,R),Q=new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.4,envMap:R.texture,envMapIntensity:1.5});v.add(z),v.environment=R.texture,d();const M=new Tr,E=M.load(["/3d-bear-arts/assets/cash2.jpg","/3d-bear-arts/assets/cash8.jpg","/3d-bear-arts/assets/cash1.jpg","/3d-bear-arts/assets/cash11.jpg","/3d-bear-arts/assets/cash4.jpg","/3d-bear-arts/assets/cash3.jpg"]);v.environment=E;const U=M.load(["/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg"]);v.environment=U;const k=new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:E,reflectivity:1});new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:U,reflectivity:1});const et=new Ot({color:"sliver",map:I,metalness:.3,roughness:.5,transparent:!0,opacity:1}),rt=new Ot({color:"sliver",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,envMap:E,reflectivity:0}),$=new on({uniforms:{time:{value:0},color1:{value:new xe(16766720)},color2:{value:new xe(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,vt=new on({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:nt,fragmentShader:X,transparent:!1,depthWrite:!0}),xt=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,Dt=new on({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:xt,fragmentShader:wt,transparent:!1,depthWrite:!0}),Wt=new ft(1,32,32,0,Math.PI),at=new y(Wt,rt),pt=new y(Wt,k);at.scale.set(.85,.85,.8),pt.scale.set(.85,.85,.8),at.position.y=-.2,pt.position.y=-.2,at.rotation.y=Math.PI/2,pt.rotation.y=Math.PI*1.5;const bt=new Ae(1,32),O=new y(bt,et);O.scale.set(.85,.85,.8),O.position.set(0,-.2,0),O.rotation.y=Math.PI/2;const lt=new Xt;lt.add(at),lt.add(pt),lt.add(O),f.add(lt);const ot=new ft(.6,32,32,0,Math.PI),ht=new y(ot,k);ht.scale.set(1,.95,.95),ht.position.set(0,1,0),ht.rotation.y=Math.PI*1.5;const Mt=new y(ot,rt);Mt.scale.set(1,.95,.95),Mt.position.set(0,1,0),Mt.rotation.y=Math.PI/2;const it=new Ae(.6,32),g=new y(it,et);g.position.set(0,1,0),g.rotation.y=Math.PI/2,g.scale.set(1,.95,.95);const T=new Xt;T.add(ht),T.add(Mt),T.add(g),f.add(T);const L=new ft(.25,32,32),F=new y(L,k);F.position.set(-.45,1.35,-.1),f.add(F);const N=new y(L,rt);N.position.set(.45,1.35,-.1),f.add(N);const K=new ft(.25,32,32,Math.PI/2,Math.PI),Z=new y(K,k);Z.scale.set(1.1,.6,.8),Z.position.set(0,.84,.5),Z.rotation.y=Math.PI;const w=new ft(.25,32,32,Math.PI/2,Math.PI),_=new y(w,rt);_.scale.set(1.1,.6,.8),_.position.set(0,.84,.5),_.rotation.y=0;const C=new Ae(.25,32),q=new y(C,et);q.scale.set(.8,.6,.8),q.position.set(0,.84,.5),q.rotation.y=Math.PI/2;const V=new Xt;V.add(Z),V.add(_),V.add(q),f.add(V);const W=new Cn;W.moveTo(0,0),W.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),W.bezierCurveTo(-.6,.3,0,.6,0,1),W.bezierCurveTo(0,.6,.6,.3,.6,0),W.bezierCurveTo(.6,-.3,0,-.3,0,0);const dt={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ct=new Hn(W,dt),mt=new y(ct,Q);mt.scale.set(.38,.38,.38),mt.position.set(.35,0,0),mt.rotation.y=Math.PI,mt.rotation.x=Math.PI,f.add(mt);const At=new y(ct,k);At.scale.set(.35,.35,.35),At.position.set(.3,0,0),At.rotation.y=Math.PI,At.rotation.x=Math.PI,f.add(At);const ut=new y(ct,k);ut.scale.set(.22,.22,.22),ut.position.set(.27,.4,0),ut.rotation.y=Math.PI,ut.rotation.x=Math.PI,f.add(ut);const _t=new y(ct,k);_t.scale.set(.25,.25,.25),_t.position.set(.23,-.5,.3),_t.rotation.y=Math.PI,_t.rotation.x=Math.PI,f.add(_t);const Lt=new y(ct,k);Lt.scale.set(.3,.3,.3),Lt.position.set(.23,.2,-.4),Lt.rotation.y=Math.PI,Lt.rotation.x=Math.PI,f.add(Lt);const Nt=new ft(.35,32,32),Rt=new y(Nt,k);Rt.scale.set(.75,1.25,.65),Rt.position.set(-.7,-.15,.2),f.add(Rt);const $t=new y(Nt,rt);$t.scale.set(.75,1.25,.65),$t.position.set(.7,-.15,.2),f.add($t);const zt=new ne(.2,.22,.6,32),Yt=new y(zt,k);Yt.position.set(-.4,-1.05,0),f.add(Yt);const G=new y(zt,rt);G.position.set(.4,-1.05,0),f.add(G);const yt=new ft(.3,32,32),st=new y(yt,k);st.scale.set(1,.72,1.5),st.position.set(-.4,-1.45,.17),f.add(st);const tt=new y(yt,rt);tt.scale.set(1,.72,1.5),tt.position.set(.4,-1.45,.17),f.add(tt);const St=new ft(.44,32,32),Et=new y(St,k);Et.position.set(-.15,-.45,-.4),f.add(Et);const kt=new y(St,rt);kt.position.set(.15,-.45,-.4),f.add(kt);const te=new ft(.18,32,32),se=new y(te,k);se.position.set(0,-.35,-.8),f.add(se),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ae){const ve=new ke("X",{font:ae,size:.18,depth:.05}),ce=new y(ve,k);ce.position.set(-.3,.99,.53),ce.rotation.x=le.degToRad(-5),ce.rotation.y=le.degToRad(-15),f.add(ce);const Pe=new ke("+",{font:ae,size:.25,depth:.1}),me=new y(Pe,k);me.position.set(.14,.99,.53),me.rotation.y=le.degToRad(12),me.rotation.x=le.degToRad(-5),f.add(me)}),se.renderOrder=1,f.scale.set(1.4,1.4,1.4),v.add(f),f.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),x.position.set(t.bodyPosition.x,1.4,t.cameraPosition),x.lookAt(t.bodyPosition.x,0,0),x.position.z=4;let ee=jt(!1);const fe=ae=>{if(ee.value){const ve={x:ae.clientX/window.innerWidth*2-1,y:-(ae.clientY/window.innerHeight)*2+1},ce=ve.x*Math.PI*.2,Pe=ve.y*Math.PI*.2;f.rotation.y=ce,f.rotation.x=Pe}};window.addEventListener("mousemove",fe),$.uniforms.time.value+=.04,p(),Ve(()=>t.bodyPosition,ae=>{f.position.set(ae.x,ae.y,ae.z)}),Ve(()=>t.cameraPosition,ae=>{x.position.set(t.bodyPosition.x,1,ae),x.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{x.aspect=window.innerWidth/window.innerHeight,x.updateProjectionMatrix(),m.setSize(window.innerWidth,window.innerHeight)})}});let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}for(let d=0;d<Mb;d++){const p=document.createElement("div");p.classList.add("confetti"),p.style.left=`${Math.random()*100}vw`,p.style.animationDuration=`${Math.random()*3+4}s`,p.style.animationDelay=`${Math.random()*5}s`,document.body.appendChild(p)}for(let d=0;d<wb;d++){const p=document.createElement("div");p.classList.add("light"),document.body.appendChild(p)}return(d,p)=>(Wn(),Yn(fn,null,[Bt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),Bt("div",null,[Ge(Gp,{class:"bear-background",color:"lightgreen"})]),Bt("div",xb,[Bt("button",{class:"pixel-btn up border-gold",onMousedown:l,onMouseup:u},"▲",32),Bt("div",yb,[Bt("button",{class:"pixel-btn left border-silver",onMousedown:a,onMouseup:u},"◀",32),Bt("button",{class:"pixel-btn right border-silver",onMousedown:c,onMouseup:u},"▶",32)]),Bt("button",{class:"pixel-btn down border-gold",onMousedown:h,onMouseup:u},"▼",32)])],64))}}),bb=$n(Sb,[["__scopeId","data-v-063871f2"]]),Eb={class:"pixel-controls"},Tb={class:"side-buttons"},Ab=15,Pb=5,Rb=Ln({__name:"Snowman",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);Vn(()=>{if(e.value){let d=function(){R.visible=!1,et.update(I,b),R.visible=!0,requestAnimationFrame(d)},p=function(){const Pt=document.createElement("canvas"),qt=Pt.getContext("2d");Pt.width=512,Pt.height=512;const Gt=Pt.width/8;for(let Tt=0;Tt<8;Tt++)qt.fillStyle=Tt%2===0?"#FF0000":"#FFFFFF",qt.fillRect(Tt*Gt,0,Gt,Pt.height);const re=new U1(Pt);return re.wrapS=$e,re.wrapT=$e,re.repeat.set(1,0),re},v=function(){const Pt=new Xt,qt=new Ut({color:16777215}),Gt=new Ut({color:0}),re=new Ut({color:16753920}),Tt=new Ut({color:16711680}),ye=new Ut({color:0}),Ee=new y(new ft(.6,32,32),qt);Ee.position.set(0,.6,0),Pt.add(Ee);const ge=new y(new ft(.4,32,32),qt);ge.position.set(0,1.2,0),Pt.add(ge);const Ie=new y(new ft(.3,32,32),qt);Ie.position.set(0,1.7,0),Pt.add(Ie);const pe=new y(new ft(.05,16,16),Gt);pe.position.set(-.1,1.75,.25),Pt.add(pe);const Ce=new y(new ft(.05,16,16),Gt);Ce.position.set(.1,1.75,.25),Pt.add(Ce);const ze=new ai(.05,.2,32),Te=new y(ze,re);Te.position.set(0,1.7,.35),Te.rotation.x=Math.PI/2,Pt.add(Te);for(let ln=0;ln<3;ln++){const dn=new y(new ft(.05,16,16),Gt);dn.position.set(0,1-ln*.3,.4),Pt.add(dn)}const Fe=new si(.3,.08,16,100),Ke=new y(Fe,Tt);Ke.position.set(0,1.45,0),Ke.rotation.x=Math.PI/2,Pt.add(Ke);const We=new yn(.1,.4,.05),sn=new y(We,Tt);sn.position.set(.25,1.3,0),Pt.add(sn);const tn=new ne(.3,.3,.05,32),en=new y(tn,ye);en.position.set(0,1.9,0),Pt.add(en);const cn=new ne(.2,.2,.3,32),rn=new y(cn,ye);return rn.position.set(0,2.05,0),Pt.add(rn),Pt},x=function(){const Pt=new Xt;new Ut({color:16777215});const qt=new Ut({color:0}),Gt=new Ut({color:16753920}),re=new Ut({color:16711680}),Tt=new Ut({color:0}),ye=new y(new ft(.6,32,32),X);ye.position.set(0,.6,0),Pt.add(ye);const Ee=new y(new ft(.4,32,32),X);Ee.position.set(0,1.2,0),Pt.add(Ee);const ge=new y(new ft(.3,32,32),X);ge.position.set(0,1.7,0),Pt.add(ge);const Ie=new y(new ft(.05,16,16),qt);Ie.position.set(-.1,1.75,.25),Pt.add(Ie);const pe=new y(new ft(.05,16,16),qt);pe.position.set(.1,1.75,.25),Pt.add(pe);const Ce=new ai(.05,.2,32),ze=new y(Ce,Gt);ze.position.set(0,1.7,.35),ze.rotation.x=Math.PI/2,Pt.add(ze);for(let rn=0;rn<3;rn++){const ln=new y(new ft(.05,16,16),qt);ln.position.set(0,1-rn*.3,.4),Pt.add(ln)}const Te=new si(.3,.08,16,100),Fe=new y(Te,re);Fe.position.set(0,1.45,0),Fe.rotation.x=Math.PI/2,Pt.add(Fe);const Ke=new yn(.1,.4,.05),We=new y(Ke,re);We.position.set(.25,1.3,0),Pt.add(We);const sn=new ne(.3,.3,.05,32),tn=new y(sn,Tt);tn.position.set(0,1.9,0),Pt.add(tn);const en=new ne(.2,.2,.3,32),cn=new y(en,Tt);return cn.position.set(0,2.05,0),Pt.add(cn),Pt},m=function(){const Pt=new Xt;new Ut({color:16777215});const qt=new Ut({color:16770244}),Gt=new Ut({color:16776960}),re=new Ut({color:16316671}),Tt=new ft(.2,32,32),ye=new y(Tt,qt);ye.position.set(0,1.5,0),Pt.add(ye);const Ee=new ne(.2,.35,.6,32),ge=new y(Ee,qt);ge.position.set(0,1,0),Pt.add(ge);const Ie=new Cn;Ie.moveTo(0,0),Ie.bezierCurveTo(.5,.2,.8,.7,.5,1.5),Ie.bezierCurveTo(.3,1.3,0,.8,0,0);const pe=new Hn(Ie,{depth:.05,bevelEnabled:!1}),Ce=new y(pe,re);Ce.position.set(-.2,1.2,-.05),Ce.rotation.y=Math.PI/12,Ce.rotation.z=Math.PI/4,Ce.scale.set(-.5,.5,.5),Pt.add(Ce);const ze=new y(pe,re);ze.position.set(-.1,1.1,-.05),ze.rotation.y=Math.PI/10,ze.rotation.z=Math.PI/3,ze.scale.set(-.5,.5,.5),Pt.add(ze);const Te=new y(pe,re);Te.position.set(0,1,-.05),Te.rotation.y=Math.PI/8,Te.rotation.z=Math.PI/2.5,Te.scale.set(-.5,.5,.5),Pt.add(Te);const Fe=new y(pe,re);Fe.position.set(.2,1.2,-.05),Fe.rotation.y=-Math.PI/12,Fe.rotation.z=-Math.PI/4,Fe.scale.set(.5,.5,.5),Pt.add(Fe);const Ke=new y(pe,re);Ke.position.set(.1,1.1,-.05),Ke.rotation.y=-Math.PI/10,Ke.rotation.z=-Math.PI/3,Ke.scale.set(.5,.5,.5),Pt.add(Ke);const We=new y(pe,re);We.position.set(0,1,-.05),We.rotation.y=-Math.PI/8,We.rotation.z=-Math.PI/2.5,We.scale.set(.5,.5,.5),Pt.add(We);const sn=new si(.15,.05,16,100),tn=new y(sn,Gt);return tn.position.set(0,1.8,0),tn.rotation.x=Math.PI/2,Pt.add(tn),Pt},f=function(){requestAnimationFrame(f);const Pt=1.5,qt=.5;je+=.03,hn+=.005*gn,hn>qt&&(gn=-1),hn<-qt&&(gn=1),he.position.x=Math.cos(je)*Pt,he.position.z=Math.sin(je)*Pt,he.position.y=hn+1,Ne+=.03,Dn+=.005*Ct,Dn>qt&&(Ct=-1),Dn<-qt&&(Ct=1),P.position.x=Math.cos(Ne)*Pt,P.position.z=Math.sin(Ne)*Pt,P.position.y=Dn+1,he.lookAt(R.position),P.lookAt(R.position),I.render(b,B)},A=function(){requestAnimationFrame(A);const Pt=Kt.attributes.position.array;for(let qt=1;qt<Pt.length;qt+=3)Pt[qt]-=.02,Pt[qt]<-10&&(Pt[qt]=10);Kt.attributes.position.needsUpdate=!0,I.render(b,B)},S=function(){requestAnimationFrame(S),lt.uniforms.time.value+=.05,pt.uniforms.time.value+=.05,i.value&&(R.rotation.y+=.05),s.value&&(R.rotation.y-=.07),o.value&&(R.rotation.x-=.05),r.value&&(R.rotation.x+=.05),I.render(b,B)};const b=new Gn,B=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),I=new zn({antialias:!0,alpha:!0});I.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(I.domElement);const R=new Xt,z=new hi(16777215,2);b.add(z);const Q=new ui(16777215,4);Q.position.set(5,5,5),b.add(Q);const M=new li(16777215,5,50);M.position.set(0,2,4),b.add(M);const U=new jn().load("/3d-bear-arts/assets/cashwings.jpg"),k=new $a(256,{format:Xn,generateMipmaps:!0,minFilter:Ci}),et=new Ya(1,1e3,k);new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.4,envMap:k.texture,envMapIntensity:1.5}),b.add(et),b.environment=k.texture,d();const rt=new Tr,$=rt.load(["/3d-bear-arts/assets/christmas_garden.jpg","/3d-bear-arts/assets/christmas_ground.jpg","/3d-bear-arts/assets/christmas_front.jpg","/3d-bear-arts/assets/christmas_house.jpg","/3d-bear-arts/assets/christmas_tree.jpg","/3d-bear-arts/assets/christmas_sky.jpg"]);rt.load(["/3d-bear-arts/assets/cash2.jpg","/3d-bear-arts/assets/cash8.jpg","/3d-bear-arts/assets/cash1.jpg","/3d-bear-arts/assets/cash11.jpg","/3d-bear-arts/assets/cash4.jpg","/3d-bear-arts/assets/cash3.jpg"]),b.environment=$;const nt=rt.load(["/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg","/3d-bear-arts/assets/cashwings.jpg"]);b.environment=nt;const X=new Ot({color:"white",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:$,reflectivity:1});new Ot({color:"sliver",metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:nt,reflectivity:1});const vt=new Ot({color:"sliver",map:U,metalness:.3,roughness:.5,transparent:!0,opacity:1}),xt=new Ot({color:"white",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.3,envMap:$,reflectivity:0}),wt=new Ot({color:"white",metalness:.75,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.7,envMap:$,reflectivity:0}),Dt=new on({uniforms:{time:{value:0},color1:{value:new xe(16766720)},color2:{value:new xe(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,pt=new on({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:Wt,fragmentShader:at,transparent:!1,depthWrite:!0}),bt=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,lt=new on({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:bt,fragmentShader:O,transparent:!1,depthWrite:!0}),ot=new ft(1,32,32,0,Math.PI),ht=new y(ot,xt),Mt=new y(ot,X);ht.scale.set(.85,.85,.8),Mt.scale.set(.85,.85,.8),ht.position.y=-.2,Mt.position.y=-.2,ht.rotation.y=Math.PI/2,Mt.rotation.y=Math.PI*1.5;const it=new Ae(1,32),g=new y(it,X);g.scale.set(.85,.85,.8),g.position.set(0,-.2,0),g.rotation.y=Math.PI/2;const T=new Xt;T.add(ht),T.add(Mt),T.add(g),R.add(T);const L=new ft(.6,32,32,0,Math.PI),F=new y(L,X);F.scale.set(1,.95,.95),F.position.set(0,1,0),F.rotation.y=Math.PI*1.5;const N=new y(L,xt);N.scale.set(1,.95,.95),N.position.set(0,1,0),N.rotation.y=Math.PI/2;const K=new Ae(.6,32),Z=new y(K,X);Z.position.set(0,1,0),Z.rotation.y=Math.PI/2,Z.scale.set(1,.95,.95);const w=new Xt;w.add(F),w.add(N),w.add(Z),R.add(w);const _=new ft(.25,32,32),C=new y(_,X);C.position.set(-.45,1.35,-.1),R.add(C);const q=new y(_,wt);q.position.set(.45,1.35,-.1),R.add(q);const V=new ft(.25,32,32,Math.PI/2,Math.PI),W=new y(V,X);W.scale.set(1.1,.6,.8),W.position.set(0,.84,.5),W.rotation.y=Math.PI;const dt=new ft(.25,32,32,Math.PI/2,Math.PI),ct=new y(dt,wt);ct.scale.set(1.1,.6,.8),ct.position.set(0,.84,.5),ct.rotation.y=0;const mt=new Ae(.25,32),At=new y(mt,vt);At.scale.set(.8,.6,.8),At.position.set(0,.84,.5),At.rotation.y=Math.PI/2;const ut=new Xt;ut.add(W),ut.add(ct),ut.add(At),R.add(ut);const _t=new Cn;_t.moveTo(0,0),_t.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),_t.bezierCurveTo(-.6,.3,0,.6,0,1),_t.bezierCurveTo(0,.6,.6,.3,.6,0),_t.bezierCurveTo(.6,-.3,0,-.3,0,0);const Lt={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},Nt=new Hn(_t,Lt),Rt=new y(Nt,X);Rt.scale.set(.23,.23,.23),Rt.position.set(.25,1.2,0),Rt.rotation.y=Math.PI,Rt.rotation.x=Math.PI;const $t=new ft(.35,32,32),zt=new y($t,X);zt.scale.set(.75,1.25,.65),zt.position.set(-.7,-.15,.2),R.add(zt);const Yt=new y($t,wt);Yt.scale.set(.75,1.25,.65),Yt.position.set(.7,-.15,.2),R.add(Yt);const G=new ne(.2,.22,.6,32),yt=new y(G,X);yt.position.set(-.4,-1.05,0),R.add(yt);const st=new y(G,wt);st.position.set(.4,-1.05,0),R.add(st);const tt=new ft(.3,32,32),St=new y(tt,X);St.scale.set(1,.72,1.5),St.position.set(-.4,-1.45,.17),R.add(St);const Et=new y(tt,wt);Et.scale.set(1,.72,1.5),Et.position.set(.4,-1.45,.17),R.add(Et);const kt=new ft(.44,32,32),te=new y(kt,X);te.position.set(-.15,-.45,-.4),R.add(te);const se=new y(kt,wt);se.position.set(.15,-.45,-.4),R.add(se);const oe=new ft(.18,32,32),ee=new y(oe,X);ee.position.set(0,-.35,-.8),R.add(ee),ee.renderOrder=1,new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Pt){const qt=new ke("X",{font:Pt,size:.18,depth:.05}),Gt=new y(qt,X);Gt.position.set(-.3,.99,.53),Gt.rotation.x=le.degToRad(-5),Gt.rotation.y=le.degToRad(-15),R.add(Gt);const re=new ke("+",{font:Pt,size:.25,depth:.1}),Tt=new y(re,X);Tt.position.set(.13,.99,.53),Tt.rotation.y=le.degToRad(12),Tt.rotation.x=le.degToRad(-5),R.add(Tt)});const ae=p(),ve=new Ut({map:ae,metalness:.1,roughness:.8}),ce=new si(.5,.1,24,100,Math.PI),Pe=new y(ce,ve);Pe.position.set(0,.54,0),Pe.rotation.x=Math.PI/2,Pe.rotation.y=Math.PI/1,Pe.rotation.z=Math.PI/-2,R.add(Pe);const me=v();me.scale.set(.38,.38,.38),me.position.set(.3,-.45,0),R.add(me);const Be=x();Be.scale.set(.2,.2,.2),Be.position.set(.5,-.3,.3),R.add(Be);const Re=x();Re.scale.set(.12,.12,.12),Re.position.set(.2,-.3,.5),R.add(Re);let je=0,Ne=Math.PI,hn=0,Dn=0,gn=1,Ct=-1;const he=m();he.scale.set(.4,.4,.4),b.add(he);const P=m();P.scale.set(.4,.4,.4),b.add(P),f();const Y=new ft(.6,32,32,0,Math.PI*2,0,Math.PI/2),D=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.5,clearcoatRoughness:.7,transparent:!1,opacity:.85}),j=new y(Y,D);j.position.set(0,-.2,0),j.rotation.x=Math.PI,j.scale.set(1.25,1.25,1.25),T.add(j);const H=new Ot({color:16777215,metalness:.1,roughness:.9,clearcoat:.6,clearcoatRoughness:.8,side:be,transparent:!1,opacity:.8}),gt=new y(it,H);gt.scale.set(.7,.7,.7),gt.position.set(0,-.3,0),gt.rotation.x=Math.PI/2,gt.renderOrder=1,T.add(gt),R.add(T);const It=new on({transparent:!0,uniforms:{u_time:{value:0}},vertexShader:`
        precision mediump float;
        varying vec2 vUv;
        void main() {
            vUv = uv;
