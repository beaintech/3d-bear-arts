...
}`;function NS(n,e,t){let i=new Wc;const s=new Pe,r=new Pe,o=new dt,a=new LS({depthPacking:h_}),l=new IS,c={},h=t.maxTextureSize,u={[Ri]:tn,[tn]:Ri,[ft]:ft},f=new ri({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Pe},radius:{value:4}},vertexShader:DS,fragmentShader:US}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new Mn;_.setAttribute("position",new Bn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new q(_,f),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=hd;let m=this.type;this.render=function(P,R,F){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||P.length===0)return;const J=n.getRenderTarget(),x=n.getActiveCubeFace(),w=n.getActiveMipmapLevel(),j=n.state;j.setBlending(bi),j.buffers.color.setClear(1,1,1,1),j.buffers.depth.setTest(!0),j.setScissorTest(!1);const V=m!==Zn&&this.type===Zn,Z=m===Zn&&this.type!==Zn;for(let ae=0,k=P.length;ae<k;ae++){const Q=P[ae],W=Q.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",Q,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;s.copy(W.mapSize);const me=W.getFrameExtents();if(s.multiply(me),r.copy(W.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/me.x),s.x=r.x*me.x,W.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/me.y),s.y=r.y*me.y,W.mapSize.y=r.y)),W.map===null||V===!0||Z===!0){const _e=this.type!==Zn?{minFilter:_n,magFilter:_n}:{};W.map!==null&&W.map.dispose(),W.map=new Qi(s.x,s.y,_e),W.map.texture.name=Q.name+".shadowMap",W.camera.updateProjectionMatrix()}n.setRenderTarget(W.map),n.clear();const Me=W.getViewportCount();for(let _e=0;_e<Me;_e++){const Ae=W.getViewport(_e);o.set(r.x*Ae.x,r.y*Ae.y,r.x*Ae.z,r.y*Ae.w),j.viewport(o),W.updateMatrices(Q,_e),i=W.getFrustum(),E(R,F,W.camera,Q,this.type)}W.isPointLightShadow!==!0&&this.type===Zn&&b(W,F),W.needsUpdate=!1}m=this.type,d.needsUpdate=!1,n.setRenderTarget(J,x,w)};function b(P,R){const F=e.update(M);f.defines.VSM_SAMPLES!==P.blurSamples&&(f.defines.VSM_SAMPLES=P.blurSamples,p.defines.VSM_SAMPLES=P.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new Qi(s.x,s.y)),f.uniforms.shadow_pass.value=P.map.texture,f.uniforms.resolution.value=P.mapSize,f.uniforms.radius.value=P.radius,n.setRenderTarget(P.mapPass),n.clear(),n.renderBufferDirect(R,null,F,f,M,null),p.uniforms.shadow_pass.value=P.mapPass.texture,p.uniforms.resolution.value=P.mapSize,p.uniforms.radius.value=P.radius,n.setRenderTarget(P.map),n.clear(),n.renderBufferDirect(R,null,F,p,M,null)}function y(P,R,F,J){let x=null;const w=F.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(w!==void 0)x=w;else if(x=F.isPointLight===!0?l:a,n.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const j=x.uuid,V=R.uuid;let Z=c[j];Z===void 0&&(Z={},c[j]=Z);let ae=Z[V];ae===void 0&&(ae=x.clone(),Z[V]=ae,R.addEventListener("dispose",N)),x=ae}if(x.visible=R.visible,x.wireframe=R.wireframe,J===Zn?x.side=R.shadowSide!==null?R.shadowSide:R.side:x.side=R.shadowSide!==null?R.shadowSide:u[R.side],x.alphaMap=R.alphaMap,x.alphaTest=R.alphaTest,x.map=R.map,x.clipShadows=R.clipShadows,x.clippingPlanes=R.clippingPlanes,x.clipIntersection=R.clipIntersection,x.displacementMap=R.displacementMap,x.displacementScale=R.displacementScale,x.displacementBias=R.displacementBias,x.wireframeLinewidth=R.wireframeLinewidth,x.linewidth=R.linewidth,F.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const j=n.properties.get(x);j.light=F}return x}function E(P,R,F,J,x){if(P.visible===!1)return;if(P.layers.test(R.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&x===Zn)&&(!P.frustumCulled||i.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(F.matrixWorldInverse,P.matrixWorld);const V=e.update(P),Z=P.material;if(Array.isArray(Z)){const ae=V.groups;for(let k=0,Q=ae.length;k<Q;k++){const W=ae[k],me=Z[W.materialIndex];if(me&&me.visible){const Me=y(P,me,J,x);P.onBeforeShadow(n,P,R,F,V,Me,W),n.renderBufferDirect(F,null,V,Me,P,W),P.onAfterShadow(n,P,R,F,V,Me,W)}}}else if(Z.visible){const ae=y(P,Z,J,x);P.onBeforeShadow(n,P,R,F,V,ae,null),n.renderBufferDirect(F,null,V,ae,P,null),P.onAfterShadow(n,P,R,F,V,ae,null)}}const j=P.children;for(let V=0,Z=j.length;V<Z;V++)E(j[V],R,F,J,x)}function N(P){P.target.removeEventListener("dispose",N);for(const F in c){const J=c[F],x=P.target.uuid;x in J&&(J[x].dispose(),delete J[x])}}}const FS={[wl]:bl,[Tl]:Cl,[Al]:Pl,[Hs]:Rl,[bl]:wl,[Cl]:Tl,[Pl]:Al,[Rl]:Hs};function OS(n){function e(){let O=!1;const ye=new dt;let te=null;const ne=new dt(0,0,0,0);return{setMask:function(ge){te!==ge&&!O&&(n.colorMask(ge,ge,ge,ge),te=ge)},setLocked:function(ge){O=ge},setClear:function(ge,ve,Ue,Ye,Je){Je===!0&&(ge*=Ye,ve*=Ye,Ue*=Ye),ye.set(ge,ve,Ue,Ye),ne.equals(ye)===!1&&(n.clearColor(ge,ve,Ue,Ye),ne.copy(ye))},reset:function(){O=!1,te=null,ne.set(-1,0,0,0)}}}function t(){let O=!1,ye=!1,te=null,ne=null,ge=null;return{setReversed:function(ve){ye=ve},setTest:function(ve){ve?Se(n.DEPTH_TEST):D(n.DEPTH_TEST)},setMask:function(ve){te!==ve&&!O&&(n.depthMask(ve),te=ve)},setFunc:function(ve){if(ye&&(ve=FS[ve]),ne!==ve){switch(ve){case wl:n.depthFunc(n.NEVER);break;case bl:n.depthFunc(n.ALWAYS);break;case Tl:n.depthFunc(n.LESS);break;case Hs:n.depthFunc(n.LEQUAL);break;case Al:n.depthFunc(n.EQUAL);break;case Rl:n.depthFunc(n.GEQUAL);break;case Cl:n.depthFunc(n.GREATER);break;case Pl:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ne=ve}},setLocked:function(ve){O=ve},setClear:function(ve){ge!==ve&&(n.clearDepth(ve),ge=ve)},reset:function(){O=!1,te=null,ne=null,ge=null}}}function i(){let O=!1,ye=null,te=null,ne=null,ge=null,ve=null,Ue=null,Ye=null,Je=null;return{setTest:function(Xe){O||(Xe?Se(n.STENCIL_TEST):D(n.STENCIL_TEST))},setMask:function(Xe){ye!==Xe&&!O&&(n.stencilMask(Xe),ye=Xe)},setFunc:function(Xe,lt,ct){(te!==Xe||ne!==lt||ge!==ct)&&(n.stencilFunc(Xe,lt,ct),te=Xe,ne=lt,ge=ct)},setOp:function(Xe,lt,ct){(ve!==Xe||Ue!==lt||Ye!==ct)&&(n.stencilOp(Xe,lt,ct),ve=Xe,Ue=lt,Ye=ct)},setLocked:function(Xe){O=Xe},setClear:function(Xe){Je!==Xe&&(n.clearStencil(Xe),Je=Xe)},reset:function(){O=!1,ye=null,te=null,ne=null,ge=null,ve=null,Ue=null,Ye=null,Je=null}}}const s=new e,r=new t,o=new i,a=new WeakMap,l=new WeakMap;let c={},h={},u=new WeakMap,f=[],p=null,_=!1,M=null,d=null,m=null,b=null,y=null,E=null,N=null,P=new et(0,0,0),R=0,F=!1,J=null,x=null,w=null,j=null,V=null;const Z=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let ae=!1,k=0;const Q=n.getParameter(n.VERSION);Q.indexOf("WebGL")!==-1?(k=parseFloat(/^WebGL (\d)/.exec(Q)[1]),ae=k>=1):Q.indexOf("OpenGL ES")!==-1&&(k=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),ae=k>=2);let W=null,me={};const Me=n.getParameter(n.SCISSOR_BOX),_e=n.getParameter(n.VIEWPORT),Ae=new dt().fromArray(Me),Oe=new dt().fromArray(_e);function oe(O,ye,te,ne){const ge=new Uint8Array(4),ve=n.createTexture();n.bindTexture(O,ve),n.texParameteri(O,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(O,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ue=0;Ue<te;Ue++)O===n.TEXTURE_3D||O===n.TEXTURE_2D_ARRAY?n.texImage3D(ye,0,n.RGBA,1,1,ne,0,n.RGBA,n.UNSIGNED_BYTE,ge):n.texImage2D(ye+Ue,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ge);return ve}const fe={};fe[n.TEXTURE_2D]=oe(n.TEXTURE_2D,n.TEXTURE_2D,1),fe[n.TEXTURE_CUBE_MAP]=oe(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),fe[n.TEXTURE_2D_ARRAY]=oe(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),fe[n.TEXTURE_3D]=oe(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),Se(n.DEPTH_TEST),r.setFunc(Hs),L(!1),U($u),Se(n.CULL_FACE),g(bi);function Se(O){c[O]!==!0&&(n.enable(O),c[O]=!0)}function D(O){c[O]!==!1&&(n.disable(O),c[O]=!1)}function le(O,ye){return h[O]!==ye?(n.bindFramebuffer(O,ye),h[O]=ye,O===n.DRAW_FRAMEBUFFER&&(h[n.FRAMEBUFFER]=ye),O===n.FRAMEBUFFER&&(h[n.DRAW_FRAMEBUFFER]=ye),!0):!1}function se(O,ye){let te=f,ne=!1;if(O){te=u.get(ye),te===void 0&&(te=[],u.set(ye,te));const ge=O.textures;if(te.length!==ge.length||te[0]!==n.COLOR_ATTACHMENT0){for(let ve=0,Ue=ge.length;ve<Ue;ve++)te[ve]=n.COLOR_ATTACHMENT0+ve;te.length=ge.length,ne=!0}}else te[0]!==n.BACK&&(te[0]=n.BACK,ne=!0);ne&&n.drawBuffers(te)}function ue(O){return p!==O?(n.useProgram(O),p=O,!0):!1}const Ee={[qi]:n.FUNC_ADD,[O0]:n.FUNC_SUBTRACT,[B0]:n.FUNC_REVERSE_SUBTRACT};Ee[z0]=n.MIN,Ee[H0]=n.MAX;const ee={[G0]:n.ZERO,[k0]:n.ONE,[V0]:n.SRC_COLOR,[Sl]:n.SRC_ALPHA,[K0]:n.SRC_ALPHA_SATURATE,[Y0]:n.DST_COLOR,[X0]:n.DST_ALPHA,[W0]:n.ONE_MINUS_SRC_COLOR,[El]:n.ONE_MINUS_SRC_ALPHA,[$0]:n.ONE_MINUS_DST_COLOR,[q0]:n.ONE_MINUS_DST_ALPHA,[j0]:n.CONSTANT_COLOR,[Z0]:n.ONE_MINUS_CONSTANT_COLOR,[J0]:n.CONSTANT_ALPHA,[Q0]:n.ONE_MINUS_CONSTANT_ALPHA};function g(O,ye,te,ne,ge,ve,Ue,Ye,Je,Xe){if(O===bi){_===!0&&(D(n.BLEND),_=!1);return}if(_===!1&&(Se(n.BLEND),_=!0),O!==F0){if(O!==M||Xe!==F){if((d!==qi||y!==qi)&&(n.blendEquation(n.FUNC_ADD),d=qi,y=qi),Xe)switch(O){case Ds:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ku:n.blendFunc(n.ONE,n.ONE);break;case ju:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Zu:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",O);break}else switch(O){case Ds:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ku:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case ju:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Zu:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",O);break}m=null,b=null,E=null,N=null,P.set(0,0,0),R=0,M=O,F=Xe}return}ge=ge||ye,ve=ve||te,Ue=Ue||ne,(ye!==d||ge!==y)&&(n.blendEquationSeparate(Ee[ye],Ee[ge]),d=ye,y=ge),(te!==m||ne!==b||ve!==E||Ue!==N)&&(n.blendFuncSeparate(ee[te],ee[ne],ee[ve],ee[Ue]),m=te,b=ne,E=ve,N=Ue),(Ye.equals(P)===!1||Je!==R)&&(n.blendColor(Ye.r,Ye.g,Ye.b,Je),P.copy(Ye),R=Je),M=O,F=!1}function T(O,ye){O.side===ft?D(n.CULL_FACE):Se(n.CULL_FACE);let te=O.side===tn;ye&&(te=!te),L(te),O.blending===Ds&&O.transparent===!1?g(bi):g(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),r.setFunc(O.depthFunc),r.setTest(O.depthTest),r.setMask(O.depthWrite),s.setMask(O.colorWrite);const ne=O.stencilWrite;o.setTest(ne),ne&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),Y(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?Se(n.SAMPLE_ALPHA_TO_COVERAGE):D(n.SAMPLE_ALPHA_TO_COVERAGE)}function L(O){J!==O&&(O?n.frontFace(n.CW):n.frontFace(n.CCW),J=O)}function U(O){O!==D0?(Se(n.CULL_FACE),O!==x&&(O===$u?n.cullFace(n.BACK):O===U0?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):D(n.CULL_FACE),x=O}function I(O){O!==w&&(ae&&n.lineWidth(O),w=O)}function Y(O,ye,te){O?(Se(n.POLYGON_OFFSET_FILL),(j!==ye||V!==te)&&(n.polygonOffset(ye,te),j=ye,V=te)):D(n.POLYGON_OFFSET_FILL)}function K(O){O?Se(n.SCISSOR_TEST):D(n.SCISSOR_TEST)}function S(O){O===void 0&&(O=n.TEXTURE0+Z-1),W!==O&&(n.activeTexture(O),W=O)}function v(O,ye,te){te===void 0&&(W===null?te=n.TEXTURE0+Z-1:te=W);let ne=me[te];ne===void 0&&(ne={type:void 0,texture:void 0},me[te]=ne),(ne.type!==O||ne.texture!==ye)&&(W!==te&&(n.activeTexture(te),W=te),n.bindTexture(O,ye||fe[O]),ne.type=O,ne.texture=ye)}function C(){const O=me[W];O!==void 0&&O.type!==void 0&&(n.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function z(){try{n.compressedTexImage2D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function B(){try{n.compressedTexImage3D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function H(){try{n.texSubImage2D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function he(){try{n.texSubImage3D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function ce(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function pe(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function be(){try{n.texStorage2D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function de(){try{n.texStorage3D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function xe(){try{n.texImage2D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Re(){try{n.texImage3D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Le(O){Ae.equals(O)===!1&&(n.scissor(O.x,O.y,O.z,O.w),Ae.copy(O))}function we(O){Oe.equals(O)===!1&&(n.viewport(O.x,O.y,O.z,O.w),Oe.copy(O))}function Ge(O,ye){let te=l.get(ye);te===void 0&&(te=new WeakMap,l.set(ye,te));let ne=te.get(O);ne===void 0&&(ne=n.getUniformBlockIndex(ye,O.name),te.set(O,ne))}function Ie(O,ye){const ne=l.get(ye).get(O);a.get(ye)!==ne&&(n.uniformBlockBinding(ye,ne,O.__bindingPointIndex),a.set(ye,ne))}function Ve(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),c={},W=null,me={},h={},u=new WeakMap,f=[],p=null,_=!1,M=null,d=null,m=null,b=null,y=null,E=null,N=null,P=new et(0,0,0),R=0,F=!1,J=null,x=null,w=null,j=null,V=null,Ae.set(0,0,n.canvas.width,n.canvas.height),Oe.set(0,0,n.canvas.width,n.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:Se,disable:D,bindFramebuffer:le,drawBuffers:se,useProgram:ue,setBlending:g,setMaterial:T,setFlipSided:L,setCullFace:U,setLineWidth:I,setPolygonOffset:Y,setScissorTest:K,activeTexture:S,bindTexture:v,unbindTexture:C,compressedTexImage2D:z,compressedTexImage3D:B,texImage2D:xe,texImage3D:Re,updateUBOMapping:Ge,uniformBlockBinding:Ie,texStorage2D:be,texStorage3D:de,texSubImage2D:H,texSubImage3D:he,compressedTexSubImage2D:ce,compressedTexSubImage3D:pe,scissor:Le,viewport:we,reset:Ve}}function kh(n,e,t,i){const s=BS(i);switch(t){case _d:return n*e;case xd:return n*e;case Md:return n*e*2;case yd:return n*e/s.components*s.byteLength;case Bc:return n*e/s.components*s.byteLength;case Sd:return n*e*2/s.components*s.byteLength;case zc:return n*e*2/s.components*s.byteLength;case vd:return n*e*3/s.components*s.byteLength;case Rn:return n*e*4/s.components*s.byteLength;case Hc:return n*e*4/s.components*s.byteLength;case Co:case Po:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case Lo:case Io:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Ul:case Fl:return Math.max(n,16)*Math.max(e,8)/4;case Dl:case Nl:return Math.max(n,8)*Math.max(e,8)/2;case Ol:case Bl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case zl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Hl:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Gl:return Math.floor((n+4)/5)*Math.floor((e+3)/4)*16;case kl:return Math.floor((n+4)/5)*Math.floor((e+4)/5)*16;case Vl:return Math.floor((n+5)/6)*Math.floor((e+4)/5)*16;case Wl:return Math.floor((n+5)/6)*Math.floor((e+5)/6)*16;case Xl:return Math.floor((n+7)/8)*Math.floor((e+4)/5)*16;case ql:return Math.floor((n+7)/8)*Math.floor((e+5)/6)*16;case Yl:return Math.floor((n+7)/8)*Math.floor((e+7)/8)*16;case $l:return Math.floor((n+9)/10)*Math.floor((e+4)/5)*16;case Kl:return Math.floor((n+9)/10)*Math.floor((e+5)/6)*16;case jl:return Math.floor((n+9)/10)*Math.floor((e+7)/8)*16;case Zl:return Math.floor((n+9)/10)*Math.floor((e+9)/10)*16;case Jl:return Math.floor((n+11)/12)*Math.floor((e+9)/10)*16;case Ql:return Math.floor((n+11)/12)*Math.floor((e+11)/12)*16;case Do:case ec:case tc:return Math.ceil(n/4)*Math.ceil(e/4)*16;case Ed:case nc:return Math.ceil(n/4)*Math.ceil(e/4)*8;case ic:case sc:return Math.ceil(n/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function BS(n){switch(n){case si:case pd:return{byteLength:1,components:1};case Nr:case md:case Vr:return{byteLength:2,components:1};case Fc:case Oc:return{byteLength:2,components:4};case Ji:case Nc:case ei:return{byteLength:4,components:1};case gd:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function zS(n,e,t,i,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Pe,h=new WeakMap;let u;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(S,v){return p?new OffscreenCanvas(S,v):Or("canvas")}function M(S,v,C){let z=1;const B=K(S);if((B.width>C||B.height>C)&&(z=C/Math.max(B.width,B.height)),z<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const H=Math.floor(z*B.width),he=Math.floor(z*B.height);u===void 0&&(u=_(H,he));const ce=v?_(H,he):u;return ce.width=H,ce.height=he,ce.getContext("2d").drawImage(S,0,0,H,he),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+B.width+"x"+B.height+") to ("+H+"x"+he+")."),ce}else return"data"in S&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+B.width+"x"+B.height+")."),S;return S}function d(S){return S.generateMipmaps&&S.minFilter!==_n&&S.minFilter!==Tn}function m(S){n.generateMipmap(S)}function b(S,v,C,z,B=!1){if(S!==null){if(n[S]!==void 0)return n[S];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let H=v;if(v===n.RED&&(C===n.FLOAT&&(H=n.R32F),C===n.HALF_FLOAT&&(H=n.R16F),C===n.UNSIGNED_BYTE&&(H=n.R8)),v===n.RED_INTEGER&&(C===n.UNSIGNED_BYTE&&(H=n.R8UI),C===n.UNSIGNED_SHORT&&(H=n.R16UI),C===n.UNSIGNED_INT&&(H=n.R32UI),C===n.BYTE&&(H=n.R8I),C===n.SHORT&&(H=n.R16I),C===n.INT&&(H=n.R32I)),v===n.RG&&(C===n.FLOAT&&(H=n.RG32F),C===n.HALF_FLOAT&&(H=n.RG16F),C===n.UNSIGNED_BYTE&&(H=n.RG8)),v===n.RG_INTEGER&&(C===n.UNSIGNED_BYTE&&(H=n.RG8UI),C===n.UNSIGNED_SHORT&&(H=n.RG16UI),C===n.UNSIGNED_INT&&(H=n.RG32UI),C===n.BYTE&&(H=n.RG8I),C===n.SHORT&&(H=n.RG16I),C===n.INT&&(H=n.RG32I)),v===n.RGB_INTEGER&&(C===n.UNSIGNED_BYTE&&(H=n.RGB8UI),C===n.UNSIGNED_SHORT&&(H=n.RGB16UI),C===n.UNSIGNED_INT&&(H=n.RGB32UI),C===n.BYTE&&(H=n.RGB8I),C===n.SHORT&&(H=n.RGB16I),C===n.INT&&(H=n.RGB32I)),v===n.RGBA_INTEGER&&(C===n.UNSIGNED_BYTE&&(H=n.RGBA8UI),C===n.UNSIGNED_SHORT&&(H=n.RGBA16UI),C===n.UNSIGNED_INT&&(H=n.RGBA32UI),C===n.BYTE&&(H=n.RGBA8I),C===n.SHORT&&(H=n.RGBA16I),C===n.INT&&(H=n.RGBA32I)),v===n.RGB&&C===n.UNSIGNED_INT_5_9_9_9_REV&&(H=n.RGB9_E5),v===n.RGBA){const he=B?ko:rt.getTransfer(z);C===n.FLOAT&&(H=n.RGBA32F),C===n.HALF_FLOAT&&(H=n.RGBA16F),C===n.UNSIGNED_BYTE&&(H=he===vt?n.SRGB8_ALPHA8:n.RGBA8),C===n.UNSIGNED_SHORT_4_4_4_4&&(H=n.RGBA4),C===n.UNSIGNED_SHORT_5_5_5_1&&(H=n.RGB5_A1)}return(H===n.R16F||H===n.R32F||H===n.RG16F||H===n.RG32F||H===n.RGBA16F||H===n.RGBA32F)&&e.get("EXT_color_buffer_float"),H}function y(S,v){let C;return S?v===null||v===Ji||v===Vs?C=n.DEPTH24_STENCIL8:v===ei?C=n.DEPTH32F_STENCIL8:v===Nr&&(C=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Ji||v===Vs?C=n.DEPTH_COMPONENT24:v===ei?C=n.DEPTH_COMPONENT32F:v===Nr&&(C=n.DEPTH_COMPONENT16),C}function E(S,v){return d(S)===!0||S.isFramebufferTexture&&S.minFilter!==_n&&S.minFilter!==Tn?Math.log2(Math.max(v.width,v.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?v.mipmaps.length:1}function N(S){const v=S.target;v.removeEventListener("dispose",N),R(v),v.isVideoTexture&&h.delete(v)}function P(S){const v=S.target;v.removeEventListener("dispose",P),J(v)}function R(S){const v=i.get(S);if(v.__webglInit===void 0)return;const C=S.source,z=f.get(C);if(z){const B=z[v.__cacheKey];B.usedTimes--,B.usedTimes===0&&F(S),Object.keys(z).length===0&&f.delete(C)}i.remove(S)}function F(S){const v=i.get(S);n.deleteTexture(v.__webglTexture);const C=S.source,z=f.get(C);delete z[v.__cacheKey],o.memory.textures--}function J(S){const v=i.get(S);if(S.depthTexture&&S.depthTexture.dispose(),S.isWebGLCubeRenderTarget)for(let z=0;z<6;z++){if(Array.isArray(v.__webglFramebuffer[z]))for(let B=0;B<v.__webglFramebuffer[z].length;B++)n.deleteFramebuffer(v.__webglFramebuffer[z][B]);else n.deleteFramebuffer(v.__webglFramebuffer[z]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[z])}else{if(Array.isArray(v.__webglFramebuffer))for(let z=0;z<v.__webglFramebuffer.length;z++)n.deleteFramebuffer(v.__webglFramebuffer[z]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let z=0;z<v.__webglColorRenderbuffer.length;z++)v.__webglColorRenderbuffer[z]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[z]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const C=S.textures;for(let z=0,B=C.length;z<B;z++){const H=i.get(C[z]);H.__webglTexture&&(n.deleteTexture(H.__webglTexture),o.memory.textures--),i.remove(C[z])}i.remove(S)}let x=0;function w(){x=0}function j(){const S=x;return S>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+s.maxTextures),x+=1,S}function V(S){const v=[];return v.push(S.wrapS),v.push(S.wrapT),v.push(S.wrapR||0),v.push(S.magFilter),v.push(S.minFilter),v.push(S.anisotropy),v.push(S.internalFormat),v.push(S.format),v.push(S.type),v.push(S.generateMipmaps),v.push(S.premultiplyAlpha),v.push(S.flipY),v.push(S.unpackAlignment),v.push(S.colorSpace),v.join()}function Z(S,v){const C=i.get(S);if(S.isVideoTexture&&I(S),S.isRenderTargetTexture===!1&&S.version>0&&C.__version!==S.version){const z=S.image;if(z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Oe(C,S,v);return}}t.bindTexture(n.TEXTURE_2D,C.__webglTexture,n.TEXTURE0+v)}function ae(S,v){const C=i.get(S);if(S.version>0&&C.__version!==S.version){Oe(C,S,v);return}t.bindTexture(n.TEXTURE_2D_ARRAY,C.__webglTexture,n.TEXTURE0+v)}function k(S,v){const C=i.get(S);if(S.version>0&&C.__version!==S.version){Oe(C,S,v);return}t.bindTexture(n.TEXTURE_3D,C.__webglTexture,n.TEXTURE0+v)}function Q(S,v){const C=i.get(S);if(S.version>0&&C.__version!==S.version){oe(C,S,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,C.__webglTexture,n.TEXTURE0+v)}const W={[qt]:n.REPEAT,[$i]:n.CLAMP_TO_EDGE,[Il]:n.MIRRORED_REPEAT},me={[_n]:n.NEAREST,[c_]:n.NEAREST_MIPMAP_NEAREST,[to]:n.NEAREST_MIPMAP_LINEAR,[Tn]:n.LINEAR,[Ra]:n.LINEAR_MIPMAP_NEAREST,[Ki]:n.LINEAR_MIPMAP_LINEAR},Me={[d_]:n.NEVER,[x_]:n.ALWAYS,[p_]:n.LESS,[bd]:n.LEQUAL,[m_]:n.EQUAL,[v_]:n.GEQUAL,[g_]:n.GREATER,[__]:n.NOTEQUAL};function _e(S,v){if(v.type===ei&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Tn||v.magFilter===Ra||v.magFilter===to||v.magFilter===Ki||v.minFilter===Tn||v.minFilter===Ra||v.minFilter===to||v.minFilter===Ki)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(S,n.TEXTURE_WRAP_S,W[v.wrapS]),n.texParameteri(S,n.TEXTURE_WRAP_T,W[v.wrapT]),(S===n.TEXTURE_3D||S===n.TEXTURE_2D_ARRAY)&&n.texParameteri(S,n.TEXTURE_WRAP_R,W[v.wrapR]),n.texParameteri(S,n.TEXTURE_MAG_FILTER,me[v.magFilter]),n.texParameteri(S,n.TEXTURE_MIN_FILTER,me[v.minFilter]),v.compareFunction&&(n.texParameteri(S,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(S,n.TEXTURE_COMPARE_FUNC,Me[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===_n||v.minFilter!==to&&v.minFilter!==Ki||v.type===ei&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const C=e.get("EXT_texture_filter_anisotropic");n.texParameterf(S,C.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function Ae(S,v){let C=!1;S.__webglInit===void 0&&(S.__webglInit=!0,v.addEventListener("dispose",N));const z=v.source;let B=f.get(z);B===void 0&&(B={},f.set(z,B));const H=V(v);if(H!==S.__cacheKey){B[H]===void 0&&(B[H]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,C=!0),B[H].usedTimes++;const he=B[S.__cacheKey];he!==void 0&&(B[S.__cacheKey].usedTimes--,he.usedTimes===0&&F(v)),S.__cacheKey=H,S.__webglTexture=B[H].texture}return C}function Oe(S,v,C){let z=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(z=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(z=n.TEXTURE_3D);const B=Ae(S,v),H=v.source;t.bindTexture(z,S.__webglTexture,n.TEXTURE0+C);const he=i.get(H);if(H.version!==he.__version||B===!0){t.activeTexture(n.TEXTURE0+C);const ce=rt.getPrimaries(rt.workingColorSpace),pe=v.colorSpace===wi?null:rt.getPrimaries(v.colorSpace),be=v.colorSpace===wi||ce===pe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);let de=M(v.image,!1,s.maxTextureSize);de=Y(v,de);const xe=r.convert(v.format,v.colorSpace),Re=r.convert(v.type);let Le=b(v.internalFormat,xe,Re,v.colorSpace,v.isVideoTexture);_e(z,v);let we;const Ge=v.mipmaps,Ie=v.isVideoTexture!==!0,Ve=he.__version===void 0||B===!0,O=H.dataReady,ye=E(v,de);if(v.isDepthTexture)Le=y(v.format===Ws,v.type),Ve&&(Ie?t.texStorage2D(n.TEXTURE_2D,1,Le,de.width,de.height):t.texImage2D(n.TEXTURE_2D,0,Le,de.width,de.height,0,xe,Re,null));else if(v.isDataTexture)if(Ge.length>0){Ie&&Ve&&t.texStorage2D(n.TEXTURE_2D,ye,Le,Ge[0].width,Ge[0].height);for(let te=0,ne=Ge.length;te<ne;te++)we=Ge[te],Ie?O&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,we.width,we.height,xe,Re,we.data):t.texImage2D(n.TEXTURE_2D,te,Le,we.width,we.height,0,xe,Re,we.data);v.generateMipmaps=!1}else Ie?(Ve&&t.texStorage2D(n.TEXTURE_2D,ye,Le,de.width,de.height),O&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,de.width,de.height,xe,Re,de.data)):t.texImage2D(n.TEXTURE_2D,0,Le,de.width,de.height,0,xe,Re,de.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Ie&&Ve&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ye,Le,Ge[0].width,Ge[0].height,de.depth);for(let te=0,ne=Ge.length;te<ne;te++)if(we=Ge[te],v.format!==Rn)if(xe!==null)if(Ie){if(O)if(v.layerUpdates.size>0){const ge=kh(we.width,we.height,v.format,v.type);for(const ve of v.layerUpdates){const Ue=we.data.subarray(ve*ge/we.data.BYTES_PER_ELEMENT,(ve+1)*ge/we.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,ve,we.width,we.height,1,xe,Ue,0,0)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,we.width,we.height,de.depth,xe,we.data,0,0)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,te,Le,we.width,we.height,de.depth,0,we.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ie?O&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,we.width,we.height,de.depth,xe,Re,we.data):t.texImage3D(n.TEXTURE_2D_ARRAY,te,Le,we.width,we.height,de.depth,0,xe,Re,we.data)}else{Ie&&Ve&&t.texStorage2D(n.TEXTURE_2D,ye,Le,Ge[0].width,Ge[0].height);for(let te=0,ne=Ge.length;te<ne;te++)we=Ge[te],v.format!==Rn?xe!==null?Ie?O&&t.compressedTexSubImage2D(n.TEXTURE_2D,te,0,0,we.width,we.height,xe,we.data):t.compressedTexImage2D(n.TEXTURE_2D,te,Le,we.width,we.height,0,we.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ie?O&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,we.width,we.height,xe,Re,we.data):t.texImage2D(n.TEXTURE_2D,te,Le,we.width,we.height,0,xe,Re,we.data)}else if(v.isDataArrayTexture)if(Ie){if(Ve&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ye,Le,de.width,de.height,de.depth),O)if(v.layerUpdates.size>0){const te=kh(de.width,de.height,v.format,v.type);for(const ne of v.layerUpdates){const ge=de.data.subarray(ne*te/de.data.BYTES_PER_ELEMENT,(ne+1)*te/de.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ne,de.width,de.height,1,xe,Re,ge)}v.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,de.width,de.height,de.depth,xe,Re,de.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Le,de.width,de.height,de.depth,0,xe,Re,de.data);else if(v.isData3DTexture)Ie?(Ve&&t.texStorage3D(n.TEXTURE_3D,ye,Le,de.width,de.height,de.depth),O&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,de.width,de.height,de.depth,xe,Re,de.data)):t.texImage3D(n.TEXTURE_3D,0,Le,de.width,de.height,de.depth,0,xe,Re,de.data);else if(v.isFramebufferTexture){if(Ve)if(Ie)t.texStorage2D(n.TEXTURE_2D,ye,Le,de.width,de.height);else{let te=de.width,ne=de.height;for(let ge=0;ge<ye;ge++)t.texImage2D(n.TEXTURE_2D,ge,Le,te,ne,0,xe,Re,null),te>>=1,ne>>=1}}else if(Ge.length>0){if(Ie&&Ve){const te=K(Ge[0]);t.texStorage2D(n.TEXTURE_2D,ye,Le,te.width,te.height)}for(let te=0,ne=Ge.length;te<ne;te++)we=Ge[te],Ie?O&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,xe,Re,we):t.texImage2D(n.TEXTURE_2D,te,Le,xe,Re,we);v.generateMipmaps=!1}else if(Ie){if(Ve){const te=K(de);t.texStorage2D(n.TEXTURE_2D,ye,Le,te.width,te.height)}O&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,xe,Re,de)}else t.texImage2D(n.TEXTURE_2D,0,Le,xe,Re,de);d(v)&&m(z),he.__version=H.version,v.onUpdate&&v.onUpdate(v)}S.__version=v.version}function oe(S,v,C){if(v.image.length!==6)return;const z=Ae(S,v),B=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,S.__webglTexture,n.TEXTURE0+C);const H=i.get(B);if(B.version!==H.__version||z===!0){t.activeTexture(n.TEXTURE0+C);const he=rt.getPrimaries(rt.workingColorSpace),ce=v.colorSpace===wi?null:rt.getPrimaries(v.colorSpace),pe=v.colorSpace===wi||he===ce?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const be=v.isCompressedTexture||v.image[0].isCompressedTexture,de=v.image[0]&&v.image[0].isDataTexture,xe=[];for(let ne=0;ne<6;ne++)!be&&!de?xe[ne]=M(v.image[ne],!0,s.maxCubemapSize):xe[ne]=de?v.image[ne].image:v.image[ne],xe[ne]=Y(v,xe[ne]);const Re=xe[0],Le=r.convert(v.format,v.colorSpace),we=r.convert(v.type),Ge=b(v.internalFormat,Le,we,v.colorSpace),Ie=v.isVideoTexture!==!0,Ve=H.__version===void 0||z===!0,O=B.dataReady;let ye=E(v,Re);_e(n.TEXTURE_CUBE_MAP,v);let te;if(be){Ie&&Ve&&t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,Ge,Re.width,Re.height);for(let ne=0;ne<6;ne++){te=xe[ne].mipmaps;for(let ge=0;ge<te.length;ge++){const ve=te[ge];v.format!==Rn?Le!==null?Ie?O&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ge,0,0,ve.width,ve.height,Le,ve.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ge,Ge,ve.width,ve.height,0,ve.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ie?O&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ge,0,0,ve.width,ve.height,Le,we,ve.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ge,Ge,ve.width,ve.height,0,Le,we,ve.data)}}}else{if(te=v.mipmaps,Ie&&Ve){te.length>0&&ye++;const ne=K(xe[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,ye,Ge,ne.width,ne.height)}for(let ne=0;ne<6;ne++)if(de){Ie?O&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,xe[ne].width,xe[ne].height,Le,we,xe[ne].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,Ge,xe[ne].width,xe[ne].height,0,Le,we,xe[ne].data);for(let ge=0;ge<te.length;ge++){const Ue=te[ge].image[ne].image;Ie?O&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ge+1,0,0,Ue.width,Ue.height,Le,we,Ue.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ge+1,Ge,Ue.width,Ue.height,0,Le,we,Ue.data)}}else{Ie?O&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,0,0,Le,we,xe[ne]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0,Ge,Le,we,xe[ne]);for(let ge=0;ge<te.length;ge++){const ve=te[ge];Ie?O&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ge+1,0,0,Le,we,ve.image[ne]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ne,ge+1,Ge,Le,we,ve.image[ne])}}}d(v)&&m(n.TEXTURE_CUBE_MAP),H.__version=B.version,v.onUpdate&&v.onUpdate(v)}S.__version=v.version}function fe(S,v,C,z,B,H){const he=r.convert(C.format,C.colorSpace),ce=r.convert(C.type),pe=b(C.internalFormat,he,ce,C.colorSpace);if(!i.get(v).__hasExternalTextures){const de=Math.max(1,v.width>>H),xe=Math.max(1,v.height>>H);B===n.TEXTURE_3D||B===n.TEXTURE_2D_ARRAY?t.texImage3D(B,H,pe,de,xe,v.depth,0,he,ce,null):t.texImage2D(B,H,pe,de,xe,0,he,ce,null)}t.bindFramebuffer(n.FRAMEBUFFER,S),U(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,z,B,i.get(C).__webglTexture,0,L(v)):(B===n.TEXTURE_2D||B>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&B<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,z,B,i.get(C).__webglTexture,H),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Se(S,v,C){if(n.bindRenderbuffer(n.RENDERBUFFER,S),v.depthBuffer){const z=v.depthTexture,B=z&&z.isDepthTexture?z.type:null,H=y(v.stencilBuffer,B),he=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ce=L(v);U(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ce,H,v.width,v.height):C?n.renderbufferStorageMultisample(n.RENDERBUFFER,ce,H,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,H,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,he,n.RENDERBUFFER,S)}else{const z=v.textures;for(let B=0;B<z.length;B++){const H=z[B],he=r.convert(H.format,H.colorSpace),ce=r.convert(H.type),pe=b(H.internalFormat,he,ce,H.colorSpace),be=L(v);C&&U(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,be,pe,v.width,v.height):U(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,be,pe,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,pe,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function D(S,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,S),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Z(v.depthTexture,0);const z=i.get(v.depthTexture).__webglTexture,B=L(v);if(v.depthTexture.format===Us)U(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,z,0,B):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,z,0);else if(v.depthTexture.format===Ws)U(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,z,0,B):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,z,0);else throw new Error("Unknown depthTexture format")}function le(S){const v=i.get(S),C=S.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==S.depthTexture){const z=S.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),z){const B=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,z.removeEventListener("dispose",B)};z.addEventListener("dispose",B),v.__depthDisposeCallback=B}v.__boundDepthTexture=z}if(S.depthTexture&&!v.__autoAllocateDepthBuffer){if(C)throw new Error("target.depthTexture not supported in Cube render targets");D(v.__webglFramebuffer,S)}else if(C){v.__webglDepthbuffer=[];for(let z=0;z<6;z++)if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[z]),v.__webglDepthbuffer[z]===void 0)v.__webglDepthbuffer[z]=n.createRenderbuffer(),Se(v.__webglDepthbuffer[z],S,!1);else{const B=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,H=v.__webglDepthbuffer[z];n.bindRenderbuffer(n.RENDERBUFFER,H),n.framebufferRenderbuffer(n.FRAMEBUFFER,B,n.RENDERBUFFER,H)}}else if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),Se(v.__webglDepthbuffer,S,!1);else{const z=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,B=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,B),n.framebufferRenderbuffer(n.FRAMEBUFFER,z,n.RENDERBUFFER,B)}t.bindFramebuffer(n.FRAMEBUFFER,null)}function se(S,v,C){const z=i.get(S);v!==void 0&&fe(z.__webglFramebuffer,S,S.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),C!==void 0&&le(S)}function ue(S){const v=S.texture,C=i.get(S),z=i.get(v);S.addEventListener("dispose",P);const B=S.textures,H=S.isWebGLCubeRenderTarget===!0,he=B.length>1;if(he||(z.__webglTexture===void 0&&(z.__webglTexture=n.createTexture()),z.__version=v.version,o.memory.textures++),H){C.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(v.mipmaps&&v.mipmaps.length>0){C.__webglFramebuffer[ce]=[];for(let pe=0;pe<v.mipmaps.length;pe++)C.__webglFramebuffer[ce][pe]=n.createFramebuffer()}else C.__webglFramebuffer[ce]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){C.__webglFramebuffer=[];for(let ce=0;ce<v.mipmaps.length;ce++)C.__webglFramebuffer[ce]=n.createFramebuffer()}else C.__webglFramebuffer=n.createFramebuffer();if(he)for(let ce=0,pe=B.length;ce<pe;ce++){const be=i.get(B[ce]);be.__webglTexture===void 0&&(be.__webglTexture=n.createTexture(),o.memory.textures++)}if(S.samples>0&&U(S)===!1){C.__webglMultisampledFramebuffer=n.createFramebuffer(),C.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,C.__webglMultisampledFramebuffer);for(let ce=0;ce<B.length;ce++){const pe=B[ce];C.__webglColorRenderbuffer[ce]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,C.__webglColorRenderbuffer[ce]);const be=r.convert(pe.format,pe.colorSpace),de=r.convert(pe.type),xe=b(pe.internalFormat,be,de,pe.colorSpace,S.isXRRenderTarget===!0),Re=L(S);n.renderbufferStorageMultisample(n.RENDERBUFFER,Re,xe,S.width,S.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ce,n.RENDERBUFFER,C.__webglColorRenderbuffer[ce])}n.bindRenderbuffer(n.RENDERBUFFER,null),S.depthBuffer&&(C.__webglDepthRenderbuffer=n.createRenderbuffer(),Se(C.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(H){t.bindTexture(n.TEXTURE_CUBE_MAP,z.__webglTexture),_e(n.TEXTURE_CUBE_MAP,v);for(let ce=0;ce<6;ce++)if(v.mipmaps&&v.mipmaps.length>0)for(let pe=0;pe<v.mipmaps.length;pe++)fe(C.__webglFramebuffer[ce][pe],S,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,pe);else fe(C.__webglFramebuffer[ce],S,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);d(v)&&m(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(he){for(let ce=0,pe=B.length;ce<pe;ce++){const be=B[ce],de=i.get(be);t.bindTexture(n.TEXTURE_2D,de.__webglTexture),_e(n.TEXTURE_2D,be),fe(C.__webglFramebuffer,S,be,n.COLOR_ATTACHMENT0+ce,n.TEXTURE_2D,0),d(be)&&m(n.TEXTURE_2D)}t.unbindTexture()}else{let ce=n.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ce=S.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(ce,z.__webglTexture),_e(ce,v),v.mipmaps&&v.mipmaps.length>0)for(let pe=0;pe<v.mipmaps.length;pe++)fe(C.__webglFramebuffer[pe],S,v,n.COLOR_ATTACHMENT0,ce,pe);else fe(C.__webglFramebuffer,S,v,n.COLOR_ATTACHMENT0,ce,0);d(v)&&m(ce),t.unbindTexture()}S.depthBuffer&&le(S)}function Ee(S){const v=S.textures;for(let C=0,z=v.length;C<z;C++){const B=v[C];if(d(B)){const H=S.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,he=i.get(B).__webglTexture;t.bindTexture(H,he),m(H),t.unbindTexture()}}}const ee=[],g=[];function T(S){if(S.samples>0){if(U(S)===!1){const v=S.textures,C=S.width,z=S.height;let B=n.COLOR_BUFFER_BIT;const H=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,he=i.get(S),ce=v.length>1;if(ce)for(let pe=0;pe<v.length;pe++)t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,he.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglFramebuffer);for(let pe=0;pe<v.length;pe++){if(S.resolveDepthBuffer&&(S.depthBuffer&&(B|=n.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&(B|=n.STENCIL_BUFFER_BIT)),ce){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,he.__webglColorRenderbuffer[pe]);const be=i.get(v[pe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,be,0)}n.blitFramebuffer(0,0,C,z,0,0,C,z,B,n.NEAREST),l===!0&&(ee.length=0,g.length=0,ee.push(n.COLOR_ATTACHMENT0+pe),S.depthBuffer&&S.resolveDepthBuffer===!1&&(ee.push(H),g.push(H),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,g)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ee))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ce)for(let pe=0;pe<v.length;pe++){t.bindFramebuffer(n.FRAMEBUFFER,he.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.RENDERBUFFER,he.__webglColorRenderbuffer[pe]);const be=i.get(v[pe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,he.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+pe,n.TEXTURE_2D,be,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,he.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&l){const v=S.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function L(S){return Math.min(s.maxSamples,S.samples)}function U(S){const v=i.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function I(S){const v=o.render.frame;h.get(S)!==v&&(h.set(S,v),S.update())}function Y(S,v){const C=S.colorSpace,z=S.format,B=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||C!==Ii&&C!==wi&&(rt.getTransfer(C)===vt?(z!==Rn||B!==si)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",C)),v}function K(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(c.width=S.naturalWidth||S.width,c.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(c.width=S.displayWidth,c.height=S.displayHeight):(c.width=S.width,c.height=S.height),c}this.allocateTextureUnit=j,this.resetTextureUnits=w,this.setTexture2D=Z,this.setTexture2DArray=ae,this.setTexture3D=k,this.setTextureCube=Q,this.rebindTextures=se,this.setupRenderTarget=ue,this.updateRenderTargetMipmap=Ee,this.updateMultisampleRenderTarget=T,this.setupDepthRenderbuffer=le,this.setupFrameBufferTexture=fe,this.useMultisampledRTT=U}function HS(n,e){function t(i,s=wi){let r;const o=rt.getTransfer(s);if(i===si)return n.UNSIGNED_BYTE;if(i===Fc)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Oc)return n.UNSIGNED_SHORT_5_5_5_1;if(i===gd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===pd)return n.BYTE;if(i===md)return n.SHORT;if(i===Nr)return n.UNSIGNED_SHORT;if(i===Nc)return n.INT;if(i===Ji)return n.UNSIGNED_INT;if(i===ei)return n.FLOAT;if(i===Vr)return n.HALF_FLOAT;if(i===_d)return n.ALPHA;if(i===vd)return n.RGB;if(i===Rn)return n.RGBA;if(i===xd)return n.LUMINANCE;if(i===Md)return n.LUMINANCE_ALPHA;if(i===Us)return n.DEPTH_COMPONENT;if(i===Ws)return n.DEPTH_STENCIL;if(i===yd)return n.RED;if(i===Bc)return n.RED_INTEGER;if(i===Sd)return n.RG;if(i===zc)return n.RG_INTEGER;if(i===Hc)return n.RGBA_INTEGER;if(i===Co||i===Po||i===Lo||i===Io)if(o===vt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===Co)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Po)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Lo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Io)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===Co)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Po)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Lo)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Io)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Dl||i===Ul||i===Nl||i===Fl)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===Dl)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Ul)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Nl)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Fl)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Ol||i===Bl||i===zl)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Ol||i===Bl)return o===vt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===zl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Hl||i===Gl||i===kl||i===Vl||i===Wl||i===Xl||i===ql||i===Yl||i===$l||i===Kl||i===jl||i===Zl||i===Jl||i===Ql)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Hl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Gl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===kl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Vl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Wl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Xl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===ql)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Yl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===$l)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Kl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===jl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Zl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Jl)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Ql)return o===vt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Do||i===ec||i===tc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(i===Do)return o===vt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===ec)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===tc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Ed||i===nc||i===ic||i===sc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(i===Do)return r.COMPRESSED_RED_RGTC1_EXT;if(i===nc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===ic)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===sc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Vs?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}class GS extends Ut{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Qe extends Yt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const kS={type:"move"};class nl{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Qe,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Qe,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new G,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new G),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Qe,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new G,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new G),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const M of e.hand.values()){const d=t.getJointPose(M,i),m=this._getHandJoint(c,M);d!==null&&(m.matrix.fromArray(d.transform.matrix),m.matrix.decompose(m.position,m.rotation,m.scale),m.matrixWorldNeedsUpdate=!0,m.jointRadius=d.radius),m.visible=d!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],f=h.position.distanceTo(u.position),p=.02,_=.005;c.inputState.pinching&&f>p+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&f<=p-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,i),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,i),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(kS)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Qe;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}const VS=`
void main() {
...
`)a=0,l-=r;else{const u=HE(h,s,a,l,t);a+=u.offsetX,o.push(u.path)}}return o}function HE(n,e,t,i,s){const r=s.glyphs[n]||s.glyphs["?"];if(!r){console.error('THREE.Font: character "'+n+'" does not exists in font family '+s.familyName+".");return}const o=new OE;let a,l,c,h,u,f,p,_;if(r.o){const M=r._cachedOutline||(r._cachedOutline=r.o.split(" "));for(let d=0,m=M.length;d<m;)switch(M[d++]){case"m":a=M[d++]*e+t,l=M[d++]*e+i,o.moveTo(a,l);break;case"l":a=M[d++]*e+t,l=M[d++]*e+i,o.lineTo(a,l);break;case"q":c=M[d++]*e+t,h=M[d++]*e+i,u=M[d++]*e+t,f=M[d++]*e+i,o.quadraticCurveTo(u,f,c,h);break;case"b":c=M[d++]*e+t,h=M[d++]*e+i,u=M[d++]*e+t,f=M[d++]*e+i,p=M[d++]*e+t,_=M[d++]*e+i,o.bezierCurveTo(u,f,p,_,c,h);break}}return{offsetX:r.ha*e,path:o}}class Vt extends ui{constructor(e,t={}){const i=t.font;if(i===void 0)super();else{const s=i.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(s,t)}this.type="TextGeometry"}}const GE=li({__name:"MetalBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ot(null);let i=null,s=ot(!1),r=ot(!1),o=ot(!1);return Li(()=>{if(t.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:r.value&&(u.rotation.y-=.03),h.render(l,c)};const l=new js,c=new Ut(75,window.innerWidth/window.innerHeight,.1,1e3),h=new Ks({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(h.domElement);const u=new Qe,f=new er(16777215,2);l.add(f);const p=new Qs(16777215,4);p.position.set(5,5,5),l.add(p);const _=new Js(16777215,5,50);_.position.set(0,2,4),l.add(_);const M=new Zs,d=M.load("/3d-bear-arts/assets/lv2.jpg"),m=M.load("/3d-bear-arts/assets/lv2.jpg");d.wrapS=d.wrapT=qt,m.wrapS=m.wrapT=qt;const b=new Fe({color:8343336,metalness:0,roughness:.8,bumpMap:d,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:m,envMapIntensity:.7}),y=new Fe({color:5978654,metalness:0,roughness:.8,bumpMap:d,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:m,envMapIntensity:.7}),E=new Fe({color:13152668,metalness:.2,roughness:.05,bumpMap:d,bumpScale:.05,clearcoat:1,clearcoatRoughness:.05,map:m,transparent:!0,opacity:.4,transmission:.9,envMapIntensity:1,reflectivity:.9,ior:1.45,side:ft});new Fe({color:13421772,metalness:1,roughness:.5,clearcoat:.3,clearcoatRoughness:.3});const N=new ze(1,32,32,0,Math.PI),P=new q(N,E),R=new q(N,b);P.scale.set(.85,.85,.8),R.scale.set(.85,.85,.8),P.position.y=-.2,R.position.y=-.2,P.rotation.y=Math.PI/2,R.rotation.y=Math.PI*1.5;const F=new Rt(1,32),J=new q(F,b);J.scale.set(.85,.85,.8),J.position.set(0,-.2,0),J.rotation.y=Math.PI/2;const x=new Qe;x.add(P),x.add(R),x.add(J),u.add(x);const w=new ze(.6,32,32,0,Math.PI),j=new q(w,b);j.scale.set(1,.95,.95),j.position.set(0,1,0),j.rotation.y=Math.PI*1.5;const V=new q(w,E);V.scale.set(1,.95,.95),V.position.set(0,1,0),V.rotation.y=Math.PI/2;const Z=new Rt(.6,32),ae=new q(Z,b);ae.position.set(0,1,0),ae.rotation.y=Math.PI/2,ae.scale.set(1,.95,.95);const k=new Qe;k.add(j),k.add(V),k.add(ae),u.add(k);const Q=new ze(.25,32,32),W=new q(Q,b);W.position.set(-.45,1.35,-.1),u.add(W);const me=new q(Q,E);me.position.set(.45,1.35,-.1),u.add(me);const Me=new ze(.25,32,32,Math.PI/2,Math.PI),_e=new q(Me,y);_e.scale.set(1.1,.6,.8),_e.position.set(0,.84,.5),_e.rotation.y=Math.PI;const Ae=new ze(.25,32,32,Math.PI/2,Math.PI),Oe=new q(Ae,E);Oe.scale.set(1.1,.6,.8),Oe.position.set(0,.84,.5),Oe.rotation.y=0;const oe=new Rt(.25,32),fe=new q(oe,b);fe.scale.set(.8,.6,.8),fe.position.set(0,.84,.5),fe.rotation.y=Math.PI/2;const Se=new Qe;Se.add(_e),Se.add(Oe),Se.add(fe),u.add(Se);const D=new zn;D.moveTo(0,0),D.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),D.bezierCurveTo(-.6,.3,0,.6,0,1),D.bezierCurveTo(0,.6,.6,.3,.6,0),D.bezierCurveTo(.6,-.3,0,-.3,0,0);const le={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Fe({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const se=new ui(D,le),ue=new q(se,b);ue.scale.set(.1,.1,.1),ue.rotation.z=mt.degToRad(210),ue.rotation.x=mt.degToRad(5),ue.rotation.y=mt.degToRad(-45),ue.position.set(-.4,.9,.45);const Ee=new q(se,y);Ee.scale.set(.6,.5,.5),Ee.position.set(.35,0,0),Ee.rotation.y=Math.PI,Ee.rotation.x=Math.PI;const ee=new q(se,y);ee.scale.set(.2,.2,.2),ee.position.set(.5,-.1,.2),ee.rotation.y=Math.PI,ee.rotation.x=Math.PI,u.add(ee);const g=new os(1.3,1.2,.6),T=new q(g,b);T.scale.set(.45,.45,.45),T.position.set(.35,-.2,.1),T.rotation.y=Math.PI;const L=new $c(.15,.025,10,100);new Fe({color:8343336,metalness:.3,roughness:.4,clearcoat:.5});const U=new q(L,b);U.position.set(.35,.1,.1),U.rotation.z=Math.PI/2,U.rotation.x=Math.PI/8,U.rotation.y=Math.PI/14;const I=new q(L,b);I.position.set(.35,.1,.13),I.rotation.z=Math.PI/2,I.rotation.x=Math.PI/-8,I.rotation.y=Math.PI/12;const Y=new Qe;Y.add(T),Y.add(U),Y.add(I),u.add(Y);const K=new ze(.35,32,32),S=new q(K,b);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),u.add(S);const v=new q(K,E);v.scale.set(.75,1.25,.65),v.position.set(.7,-.15,.2),u.add(v);const C=new oi(.2,.22,.6,32),z=new q(C,b);z.position.set(-.4,-1.05,0),u.add(z);const B=new q(C,E);B.position.set(.4,-1.05,0),u.add(B);const H=new ze(.3,32,32),he=new q(H,b);he.scale.set(1,.72,1.5),he.position.set(-.4,-1.45,.17),u.add(he);const ce=new q(H,E);ce.scale.set(1,.72,1.5),ce.position.set(.4,-1.45,.17),u.add(ce);const pe=new ze(.44,32,32),be=new q(pe,b);be.position.set(-.15,-.45,-.4),u.add(be);const de=new q(pe,E);de.position.set(.15,-.45,-.4),u.add(de);const xe=new ze(.18,32,32),Re=new q(xe,b);Re.position.set(0,-.35,-.8),u.add(Re),new tr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ne){const ge=new Vt("X",{font:ne,size:.2,depth:.05});new xn({color:0});const ve=new q(ge,y);ve.position.set(-.3,.99,.53),ve.rotation.x=mt.degToRad(-5),ve.rotation.y=mt.degToRad(-15),u.add(ve);const Ue=new Vt("O",{font:ne,size:.2,depth:.05});new xn({color:0});const Ye=new q(Ue,y);Ye.position.set(.14,.99,.53),Ye.rotation.y=mt.degToRad(12),Ye.rotation.x=mt.degToRad(-5),u.add(Ye)}),Re.renderOrder=1,u.scale.set(1.35,1.35,1.35),l.add(u),u.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),c.position.set(e.bodyPosition.x,1,e.cameraPosition),c.lookAt(e.bodyPosition.x,0,0),c.position.z=4;const we=()=>{u.rotation.y,u.rotation.x},Ge=()=>{s.value=!0,r.value=!1,o.value=!1},Ie=()=>{s.value=!1,r.value=!0,o.value=!1},Ve=()=>{s.value=!1,r.value=!1,we()},O=ne=>{const ge=window.innerWidth/2;ne>ge?Ge():Ie(),we()},ye=ne=>{clearTimeout(i),Ve(),o.value=!0;const ge={x:ne.clientX/window.innerWidth*2-1,y:-(ne.clientY/window.innerHeight)*2+1};if(o.value){const ve=ge.x*Math.PI*.2,Ue=ge.y*Math.PI*.2;u.rotation.y=ve,u.rotation.x=Ue}i=setTimeout(()=>{o.value=!1,O(ne.clientX)},500)};window.addEventListener("mousemove",ye);const te=ne=>{if(o.value){const ge={x:ne.clientX/window.innerWidth*2-1,y:-(ne.clientY/window.innerHeight)*2+1},ve=ge.x*Math.PI*.2,Ue=ge.y*Math.PI*.2;u.rotation.y=ve,u.rotation.x=Ue}};window.addEventListener("mousemove",te),a(),Xt(()=>e.bodyPosition,ne=>{u.position.set(ne.x,ne.y,ne.z)}),Xt(()=>e.cameraPosition,ne=>{c.position.set(e.bodyPosition.x,1,ne),c.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{c.aspect=window.innerWidth/window.innerHeight,c.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,l)=>(ns(),is("div",{ref_key:"threeCanvas",ref:t,class:ai(n.background?"no-bg":"three-canvas")},null,2))}}),kE=ss(GE,[["__scopeId","data-v-f3beb116"]]),VE=li({__name:"PopartBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ot(null);let i=null,s=ot(!1),r=ot(!1),o=ot(!1);return Li(()=>{if(t.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:r.value&&(u.rotation.y-=.03),h.render(l,c)};const l=new js,c=new Ut(75,window.innerWidth/window.innerHeight,.1,1e3),h=new Ks({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(h.domElement);const u=new Qe,f=new er(16777215,2);l.add(f);const p=new Qs(16777215,4);p.position.set(5,5,5),l.add(p);const _=new Js(16777215,5,50);_.position.set(0,2,4),l.add(_);const M=new Zs,d=M.load("/3d-bear-arts/assets/pop6.jpg"),m=M.load("/3d-bear-arts/assets/pop7.jpg");d.wrapS=d.wrapT=qt,m.wrapS=m.wrapT=qt;const b=new Fe({color:16738740,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),y=new Fe({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ft}),E=new Fe({color:16766720,map:d,metalness:.3,roughness:.5}),N=new Fe({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ft}),P=new Fe({color:9055202,map:d,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new Fe({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ft});const R=new Fe({color:65535,map:d,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),F=new Fe({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ft}),J=new ze(1,32,32,0,Math.PI),x=new q(J,y),w=new q(J,b);x.scale.set(.85,.85,.8),w.scale.set(.85,.85,.8),x.position.y=-.2,w.position.y=-.2,x.rotation.y=Math.PI/2,w.rotation.y=Math.PI*1.5;const j=new Rt(1,32),V=new q(j,b);V.scale.set(.85,.85,.8),V.position.set(0,-.2,0),V.rotation.y=Math.PI/2;const Z=new Qe;Z.add(x),Z.add(w),Z.add(V),u.add(Z);const ae=new ze(.6,32,32,0,Math.PI),k=new q(ae,E);k.scale.set(1,.95,.95),k.position.set(0,1,0),k.rotation.y=Math.PI*1.5;const Q=new q(ae,N);Q.scale.set(1,.95,.95),Q.position.set(0,1,0),Q.rotation.y=Math.PI/2;const W=new Rt(.6,32),me=new q(W,E);me.position.set(0,1,0),me.rotation.y=Math.PI/2,me.scale.set(1,.95,.95);const Me=new Qe;Me.add(k),Me.add(Q),Me.add(me),u.add(Me);const _e=new ze(.25,32,32),Ae=new q(_e,b);Ae.position.set(-.45,1.35,-.1),u.add(Ae);const Oe=new q(_e,y);Oe.position.set(.45,1.35,-.1),u.add(Oe);const oe=new ze(.25,32,32,Math.PI/2,Math.PI),fe=new q(oe,E);fe.scale.set(1.1,.6,.8),fe.position.set(0,.84,.5),fe.rotation.y=Math.PI;const Se=new ze(.25,32,32,Math.PI/2,Math.PI),D=new q(Se,N);D.scale.set(1.1,.6,.8),D.position.set(0,.84,.5),D.rotation.y=0;const le=new Rt(.25,32),se=new q(le,E);se.scale.set(.8,.6,.8),se.position.set(0,.84,.5),se.rotation.y=Math.PI/2;const ue=new Qe;ue.add(fe),ue.add(D),ue.add(se),u.add(ue);const Ee=new zn;Ee.moveTo(0,0),Ee.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Ee.bezierCurveTo(-.6,.3,0,.6,0,1),Ee.bezierCurveTo(0,.6,.6,.3,.6,0),Ee.bezierCurveTo(.6,-.3,0,-.3,0,0);const ee={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},g=new ui(Ee,ee),T=new q(g,E);T.scale.set(.5,.5,.5),T.position.set(.35,0,0),T.rotation.y=Math.PI,T.rotation.x=Math.PI,u.add(T);const L=new q(g,R);L.scale.set(.2,.2,.25),L.position.set(.5,-.3,.4),L.rotation.y=Math.PI,L.rotation.x=Math.PI,u.add(L);const U=new q(g,b);U.scale.set(.25,.25,.27),U.position.set(.4,.3,-.2),U.rotation.y=Math.PI,U.rotation.x=Math.PI,u.add(U);const I=new ze(.35,32,32),Y=new q(I,R);Y.scale.set(.75,1.25,.65),Y.position.set(-.7,-.15,.2),u.add(Y);const K=new q(I,F);K.scale.set(.75,1.25,.65),K.position.set(.7,-.15,.2),u.add(K);const S=new oi(.2,.22,.6,32),v=new q(S,E);v.position.set(-.4,-1.05,0),u.add(v);const C=new q(S,N);C.position.set(.4,-1.05,0),u.add(C);const z=new ze(.3,32,32),B=new q(z,E);B.scale.set(1,.72,1.5),B.position.set(-.4,-1.45,.17),u.add(B);const H=new q(z,N);H.scale.set(1,.72,1.5),H.position.set(.4,-1.45,.17),u.add(H);const he=new ze(.44,32,32),ce=new q(he,b);ce.position.set(-.15,-.45,-.4),u.add(ce);const pe=new q(he,y);pe.position.set(.15,-.45,-.4),u.add(pe);const be=new ze(.18,32,32),de=new q(be,b);de.position.set(0,-.35,-.8),u.add(de),new tr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ye){const te=new Vt("X",{font:ye,size:.2,depth:.05});new xn({color:0});const ne=new q(te,b);ne.position.set(-.3,.99,.53),ne.rotation.x=mt.degToRad(-5),ne.rotation.y=mt.degToRad(-15),u.add(ne);const ge=new Vt("O",{font:ye,size:.2,depth:.05});new xn({color:0});const ve=new q(ge,R);ve.position.set(.14,.99,.53),ve.rotation.y=mt.degToRad(12),ve.rotation.x=mt.degToRad(-5),u.add(ve);const Ue=new Vt("POP",{font:ye,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),Ye=new Fe({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new Fe({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const Je=new Fe({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),Xe=new Fe({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),lt=new q(Ue,Ye);lt.scale.set(.15,.15,.15),lt.position.set(.03,1.16,.1),lt.rotateZ(-25),u.add(lt);const ct=new q(Ue,P);ct.scale.set(.14,.14,.14),ct.rotateZ(45),ct.position.set(.2,-.7,.3),u.add(ct);const zt=new q(Ue,Je);zt.scale.set(.14,.14,.14),zt.rotateZ(45),zt.rotateY(45),zt.position.set(.3,.7,.3),u.add(zt);const Et=new q(Ue,Je);Et.scale.set(.15,.15,.15),Et.rotateZ(45),Et.rotateY(45),Et.position.set(.35,-1.5,.3),u.add(Et);const yt=new q(Ue,Xe);yt.scale.set(.17,.17,.17),yt.rotateZ(45),yt.rotateY(15),yt.position.set(.35,1,.3),u.add(yt)}),de.renderOrder=1,u.scale.set(1.35,1.35,1.35),l.add(u),u.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),c.position.set(e.bodyPosition.x,1,e.cameraPosition),c.lookAt(e.bodyPosition.x,0,0),c.position.z=4;const Re=()=>{u.rotation.y,u.rotation.x},Le=()=>{s.value=!0,r.value=!1,o.value=!1},we=()=>{s.value=!1,r.value=!0,o.value=!1},Ge=()=>{s.value=!1,r.value=!1,Re()},Ie=ye=>{const te=window.innerWidth/2;ye>te?Le():we(),Re()},Ve=ye=>{clearTimeout(i),Ge(),o.value=!0;const te={x:ye.clientX/window.innerWidth*2-1,y:-(ye.clientY/window.innerHeight)*2+1};if(o.value){const ne=te.x*Math.PI*.2,ge=te.y*Math.PI*.2;u.rotation.y=ne,u.rotation.x=ge}i=setTimeout(()=>{o.value=!1,Ie(ye.clientX)},500)};window.addEventListener("mousemove",Ve);const O=ye=>{if(o.value){const te={x:ye.clientX/window.innerWidth*2-1,y:-(ye.clientY/window.innerHeight)*2+1},ne=te.x*Math.PI*.2,ge=te.y*Math.PI*.2;u.rotation.y=ne,u.rotation.x=ge}};window.addEventListener("mousemove",O),a(),Xt(()=>e.bodyPosition,ye=>{u.position.set(ye.x,ye.y,ye.z)}),Xt(()=>e.cameraPosition,ye=>{c.position.set(e.bodyPosition.x,1,ye),c.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{c.aspect=window.innerWidth/window.innerHeight,c.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,l)=>(ns(),is("div",{ref_key:"threeCanvas",ref:t,class:ai(n.background?"no-bg":"three-canvas")},null,2))}}),WE=ss(VE,[["__scopeId","data-v-8cfea564"]]),XE={class:"pixel-controls"},qE={class:"side-buttons"},YE=li({__name:"PopArtBear3",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ot(null);let i=ot(!1),s=ot(!1),r=ot(!1),o=ot(!1);Li(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03);const ne=ye.getElapsedTime();O.forEach((ge,ve)=>{const Ue=.2+Math.sin(ne*3+te[ve])*.1;ge.scale.set(Ue,Ue,Ue)}),M.render(p,_)};const p=new js,_=new Ut(75,window.innerWidth/window.innerHeight,.1,1e3),M=new Ks({antialias:!0,alpha:!0});M.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(M.domElement);const d=new Qe,m=new Qe;p.add(m);const b=new er(16777215,2);p.add(b);const y=new Qs(16777215,4);y.position.set(5,5,5),p.add(y);const E=new Js(16777215,5,50);E.position.set(0,2,4),p.add(E);const N=new Zs,P=N.load("/3d-bear-arts/assets/pop6.jpg"),R=N.load("/3d-bear-arts/assets/pop7.jpg");P.wrapS=P.wrapT=qt,R.wrapS=R.wrapT=qt,R.repeat.set(2,2);const F=new Fe({color:16738740,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),J=new Fe({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ft}),x=new Fe({color:16766720,map:P,metalness:.3,roughness:.5}),w=new Fe({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ft}),j=new Fe({color:9055202,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new Fe({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ft});const V=new Fe({color:65535,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Z=new Fe({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ft}),ae=new ze(1,32,32,0,Math.PI),k=new q(ae,J),Q=new q(ae,F);k.scale.set(.85,.85,.8),Q.scale.set(.85,.85,.8),k.position.y=-.2,Q.position.y=-.2,k.rotation.y=Math.PI/2,Q.rotation.y=Math.PI*1.5;const W=new Rt(1,32),me=new q(W,F);me.scale.set(.85,.85,.8),me.position.set(0,-.2,0),me.rotation.y=Math.PI/2;const Me=new Qe;Me.add(k),Me.add(Q),Me.add(me),d.add(Me);const _e=new ze(.6,32,32,0,Math.PI),Ae=new q(_e,x);Ae.scale.set(1,.95,.95),Ae.position.set(0,1,0),Ae.rotation.y=Math.PI*1.5;const Oe=new q(_e,w);Oe.scale.set(1,.95,.95),Oe.position.set(0,1,0),Oe.rotation.y=Math.PI/2;const oe=new Rt(.6,32),fe=new q(oe,x);fe.position.set(0,1,0),fe.rotation.y=Math.PI/2,fe.scale.set(1,.95,.95);const Se=new Qe;Se.add(Ae),Se.add(Oe),Se.add(fe),d.add(Se);const D=new ze(.25,32,32),le=new q(D,F);le.position.set(-.45,1.35,-.1),d.add(le);const se=new q(D,J);se.position.set(.45,1.35,-.1),d.add(se);const ue=new ze(.25,32,32,Math.PI/2,Math.PI),Ee=new q(ue,x);Ee.scale.set(1.1,.6,.8),Ee.position.set(0,.84,.5),Ee.rotation.y=Math.PI;const ee=new ze(.25,32,32,Math.PI/2,Math.PI),g=new q(ee,w);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=0;const T=new Rt(.25,32),L=new q(T,x);L.scale.set(.8,.6,.8),L.position.set(0,.84,.5),L.rotation.y=Math.PI/2;const U=new Qe;U.add(Ee),U.add(g),U.add(L),d.add(U);const I=new zn;I.moveTo(0,0),I.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),I.bezierCurveTo(-.6,.3,0,.6,0,1),I.bezierCurveTo(0,.6,.6,.3,.6,0),I.bezierCurveTo(.6,-.3,0,-.3,0,0);const Y={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},K=new ui(I,Y),S=new q(K,x);S.scale.set(.5,.5,.5),S.position.set(.3,0,0),S.rotation.y=Math.PI,S.rotation.x=Math.PI,d.add(S);const v=new q(K,V);v.scale.set(.2,.2,.25),v.position.set(.35,-.3,.4),v.rotation.y=Math.PI,v.rotation.x=Math.PI,d.add(v);const C=new q(K,F);C.scale.set(.25,.25,.27),C.position.set(.38,.3,-.2),C.rotation.y=Math.PI,C.rotation.x=Math.PI,d.add(C);const z=new ze(.35,32,32),B=new q(z,V);B.scale.set(.75,1.25,.65),B.position.set(-.7,-.15,.2),d.add(B);const H=new q(z,Z);H.scale.set(.75,1.25,.65),H.position.set(.7,-.15,.2),d.add(H);const he=new oi(.2,.22,.6,32),ce=new q(he,x);ce.position.set(-.4,-1.05,0),d.add(ce);const pe=new q(he,w);pe.position.set(.4,-1.05,0),d.add(pe);const be=new ze(.3,32,32),de=new q(be,x);de.scale.set(1,.72,1.5),de.position.set(-.4,-1.45,.17),d.add(de);const xe=new q(be,w);xe.scale.set(1,.72,1.5),xe.position.set(.4,-1.45,.17),d.add(xe);const Re=new ze(.44,32,32),Le=new q(Re,F);Le.position.set(-.15,-.45,-.4),d.add(Le);const we=new q(Re,J);we.position.set(.15,-.45,-.4),d.add(we);const Ge=new ze(.18,32,32),Ie=new q(Ge,F);Ie.position.set(0,-.35,-.8),d.add(Ie),new tr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ne){const ge=new Vt("X",{font:ne,size:.2,depth:.05});new xn({color:0});const ve=new q(ge,F);ve.position.set(-.3,.99,.53),ve.rotation.x=mt.degToRad(-5),ve.rotation.y=mt.degToRad(-15),d.add(ve);const Ue=new Vt("O",{font:ne,size:.2,depth:.05});new xn({color:0});const Ye=new q(Ue,V);Ye.position.set(.14,.99,.53),Ye.rotation.y=mt.degToRad(12),Ye.rotation.x=mt.degToRad(-5),d.add(Ye);const Je=new Vt("POP",{font:ne,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});new Vt("🐻",{font:ne,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});const Xe=new Vt("BAO      BEAR",{font:ne,size:2,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:3}),lt=new Fe({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new Fe({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const ct=new Fe({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),zt=new Fe({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),Et=new q(Je,lt);Et.scale.set(.15,.15,.15),Et.position.set(.02,1.16,.1),Et.rotateZ(-25),d.add(Et);const yt=new q(Je,j);yt.scale.set(.14,.14,.14),yt.rotateZ(45),yt.position.set(.2,-.7,.3),d.add(yt);const Ft=new q(Je,ct);Ft.scale.set(.14,.14,.14),Ft.rotateZ(45),Ft.rotateY(45),Ft.position.set(.3,.7,.3),d.add(Ft);const nn=new q(Je,ct);nn.scale.set(.15,.15,.15),nn.rotateZ(45),nn.rotateY(45),nn.position.set(.35,-1.5,.3),d.add(nn);const dn=new q(Je,zt);dn.scale.set(.17,.17,.17),dn.rotateZ(45),dn.rotateY(15),dn.position.set(.35,1,.3),d.add(dn);const pn=new q(Xe,lt);pn.scale.set(.7,.7,.7),pn.position.set(-6,0,-3),m.add(pn)}),Ie.renderOrder=1,d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,d.rotation.x=.1;const O=[S,v,C],ye=new FE,te=[0,Math.PI/2,Math.PI,0,Math.PI/3];f(),Xt(()=>e.bodyPosition,ne=>{d.position.set(ne.x,ne.y,ne.z)}),Xt(()=>e.cameraPosition,ne=>{_.position.set(e.bodyPosition.x,1,ne),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),M.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(ns(),is(un,null,[tt("div",{ref_key:"threeCanvas",ref:t,class:ai(n.background?"no-bg":"three-canvas")},null,2),tt("div",XE,[tt("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),tt("div",qE,[tt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),tt("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),tt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),$E=ss(YE,[["__scopeId","data-v-48c1be4c"]]),KE={class:"pixel-controls"},jE={class:"side-buttons"},ZE=li({__name:"MetalMachineBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ot(null);let i=ot(!1),s=ot(!1),r=ot(!1),o=ot(!1);Li(()=>{if(t.value){let f=function(ct,zt){const Et=new oi(Ve,Ve,O,32);Et.rotateX(Math.PI/2);const yt=new q(Et,ct),Ft=new Qe;for(let dn=0;dn<ye;dn++){const pn=dn/ye*Math.PI*2,$r=new os(te,ne,ge),hi=new q($r,ct);hi.position.set((Ve+ge/26)*Math.cos(pn),(Ve+ge/26)*Math.sin(pn),0),hi.rotation.z=pn,Ft.add(hi)}const nn=new Qe;return nn.add(yt),nn.add(Ft),nn.position.set(zt.x,zt.y,zt.z),nn},p=function(){requestAnimationFrame(p),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),r.value&&(m.rotation.x-=.03),o.value&&(m.rotation.x+=.03),ve.rotation.z-=.02,Ue.rotation.z+=.03,Ye.rotation.z+=.02,Je.rotation.z+=.02,Xe.rotation.z-=.03,lt.rotation.y+=.04,d.render(_,M)};const _=new js,M=new Ut(75,window.innerWidth/window.innerHeight,.1,1e3),d=new Ks({antialias:!0,alpha:!0});d.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(d.domElement);const m=new Qe,b=new Qe;_.add(b);const y=new er(16777215,2);_.add(y);const E=new Qs(16777215,4);E.position.set(5,5,5),_.add(E);const N=new Js(16777215,5,50);N.position.set(0,2,4),_.add(N);const P=new Zs,R=P.load("/3d-bear-arts/assets/metal.jpg"),F=P.load("/3d-bear-arts/assets/pop7.jpg"),J=P.load("/3d-bear-arts/assets/gear.jpg");R.wrapS=R.wrapT=qt,F.wrapS=F.wrapT=qt,F.repeat.set(2,2);const x=new Fe({color:13882323,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:R});J.mapping=Ur;const w=new Fe({color:"#d3d3d3",metalness:1,roughness:.25,map:R,envMap:J,clearcoat:.7,clearcoatRoughness:.3}),j=new Fe({color:"#C0C0C0",metalness:1,roughness:.25,envMap:J,clearcoat:.7,clearcoatRoughness:.3}),V=new Fe({color:"#C0C0C0",metalness:1,roughness:.25,map:R,envMap:J,transparent:!0,opacity:.8,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),Z=new Fe({color:"#C0C0C0",metalness:1,roughness:.5,map:R,envMap:J,transparent:!0,opacity:.23,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),ae=new Fe({color:13882323,metalness:1,roughness:.25,clearcoat:1,clearcoatRoughness:.05,reflectivity:.9,envMapIntensity:1,side:ft});new Fe({color:"#C0C0C0",metalness:1,roughness:.2,transparent:!0,opacity:.4,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45});const k=new Fe({color:"#d3d3d3",metalness:1,roughness:.2,map:J,envMap:J,clearcoat:.7,clearcoatRoughness:.3});new Fe({color:12632256,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:J}),new Fe({color:12632256,metalness:1,roughness:.3,clearcoat:.5,clearcoatRoughness:.1,map:R,transparent:!0,opacity:.3});const Q=new ze(1,32,32,0,Math.PI),W=new q(Q,Z),me=new q(Q,w);W.scale.set(.85,.85,.8),me.scale.set(.85,.85,.8),W.position.y=-.2,me.position.y=-.2,W.rotation.y=Math.PI/2,me.rotation.y=Math.PI*1.5;const Me=new Rt(1,32),_e=new q(Me,V);_e.scale.set(.85,.85,.8),_e.position.set(0,-.2,0),_e.rotation.y=Math.PI/2;const Ae=new Qe;Ae.add(W),Ae.add(me),Ae.add(_e),m.add(Ae);const Oe=new ze(.6,32,32,0,Math.PI),oe=new q(Oe,w);oe.scale.set(1,.95,.95),oe.position.set(0,1,0),oe.rotation.y=Math.PI*1.5;const fe=new q(Oe,Z);fe.scale.set(1,.95,.95),fe.position.set(0,1,0),fe.rotation.y=Math.PI/2;const Se=new Rt(.6,32),D=new q(Se,V);D.position.set(0,1,0),D.rotation.y=Math.PI/2,D.scale.set(1,.95,.95);const le=new Qe;le.add(oe),le.add(fe),le.add(D),m.add(le);const se=new ze(.25,32,32),ue=new q(se,w);ue.position.set(-.45,1.35,-.1),m.add(ue);const Ee=new q(se,V);Ee.position.set(.45,1.35,-.1),m.add(Ee);const ee=new ze(.25,32,32,Math.PI/2,Math.PI),g=new q(ee,w);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=Math.PI;const T=new ze(.25,32,32,Math.PI/2,Math.PI),L=new q(T,V);L.scale.set(1.1,.6,.8),L.position.set(0,.84,.5),L.rotation.y=0;const U=new Rt(.25,32),I=new q(U,ae);I.scale.set(.8,.6,.8),I.position.set(0,.84,.5),I.rotation.y=Math.PI/2;const Y=new Qe;Y.add(g),Y.add(L),Y.add(I),m.add(Y);const K=new zn;K.moveTo(0,0),K.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),K.bezierCurveTo(-.6,.3,0,.6,0,1),K.bezierCurveTo(0,.6,.6,.3,.6,0),K.bezierCurveTo(.6,-.3,0,-.3,0,0);const S={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},v=new ui(K,S),C=new ze(.35,32,32),z=new q(C,w);z.scale.set(.75,1.25,.65),z.position.set(-.7,-.15,.2),m.add(z);const B=new q(C,V);B.scale.set(.75,1.25,.65),B.position.set(.7,-.15,.2),m.add(B);const H=new oi(.2,.22,.6,32),he=new q(H,w);he.position.set(-.4,-1.05,0),m.add(he);const ce=new q(H,V);ce.position.set(.4,-1.05,0),m.add(ce);const pe=new ze(.3,32,32),be=new q(pe,w);be.scale.set(1,.72,1.5),be.position.set(-.4,-1.45,.17),m.add(be);const de=new q(pe,V);de.scale.set(1,.72,1.5),de.position.set(.4,-1.45,.17),m.add(de);const xe=new ze(.44,32,32),Re=new q(xe,w);Re.position.set(-.15,-.45,-.4),m.add(Re);const Le=new q(xe,Z);Le.position.set(.15,-.45,-.4),m.add(Le);const we=new ze(.18,32,32),Ge=new q(we,w);Ge.position.set(0,-.35,-.8),m.add(Ge),new tr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ct){const zt=new Vt("X",{font:ct,size:.2,depth:.05});new xn({color:0});const Et=new q(zt,x);Et.position.set(-.3,.99,.53),Et.rotation.x=mt.degToRad(-5),Et.rotation.y=mt.degToRad(-15),m.add(Et);const yt=new Vt("O",{font:ct,size:.2,depth:.05});new xn({color:0});const Ft=new q(yt,x);Ft.position.set(.14,.99,.53),Ft.rotation.y=mt.degToRad(12),Ft.rotation.x=mt.degToRad(-5),m.add(Ft)}),Ge.renderOrder=1;const Ve=1.2,O=.5,ye=8,te=.7,ne=.3,ge=.5,ve=f(k,{x:-2,y:0,z:0}),Ue=f(k,{x:0,y:0,z:0}),Ye=f(k,{x:2,y:0,z:0}),Je=f(k,{x:2,y:0,z:0}),Xe=f(k,{x:2,y:-2,z:0}),lt=new q(v,j);lt.scale.set(.3,.3,.3),lt.position.set(.25,1.1,0),lt.rotation.y=Math.PI,lt.rotation.x=Math.PI,m.add(lt),ve.position.set(.35,0,0),Ue.position.set(.25,-.3,.4),Ye.position.set(.3,.3,-.2),Je.position.set(.25,.17,.4),Xe.position.set(.5,-.3,.45),ve.scale.set(.2,.2,.2),Ue.scale.set(.18,.18,.18),Ye.scale.set(.15,.15,.15),Je.scale.set(.17,.17,.17),Xe.scale.set(.15,.15,.15),Ue.rotation.z=Math.PI/4,Ye.rotation.z=-Math.PI/4,Je.rotation.y=-Math.PI/2,Xe.rotation.y=-Math.PI/2,m.add(ve),m.add(Ue),m.add(Ye),m.add(Je),m.add(Xe),m.rotation.x=.1,m.scale.set(1.4,1.4,1.4),_.add(m),m.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),M.position.set(e.bodyPosition.x,1,e.cameraPosition),M.lookAt(e.bodyPosition.x,0,0),M.position.z=4,p(),Xt(()=>e.bodyPosition,ct=>{m.position.set(ct.x,ct.y,ct.z)}),Xt(()=>e.cameraPosition,ct=>{M.position.set(e.bodyPosition.x,1,ct),M.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{M.aspect=window.innerWidth/window.innerHeight,M.updateProjectionMatrix(),d.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(ns(),is(un,null,[tt("div",{ref_key:"threeCanvas",ref:t,class:ai(n.background?"no-bg":"three-canvas")},null,2),tt("div",KE,[tt("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),tt("div",jE,[tt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),tt("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),tt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),JE=ss(ZE,[["__scopeId","data-v-9a57b6d8"]]),QE={class:"pixel-controls"},ew={class:"side-buttons"},tw=li({__name:"WaterBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ot(null);let i=ot(!1),s=ot(!1),r=ot(!1),o=ot(!1);Li(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),M.render(p,_)};const p=new js,_=new Ut(75,window.innerWidth/window.innerHeight,.1,1e3),M=new Ks({antialias:!0,alpha:!0});M.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(M.domElement);const d=new Qe,m=new Qe;p.add(m);const b=new er(16777215,2);p.add(b);const y=new Qs(16777215,4);y.position.set(5,5,5),p.add(y);const E=new Js(16777215,5,50);E.position.set(0,2,4),p.add(E);const N=new Zs,P=N.load("/3d-bear-arts/assets/sun.jpg"),R=N.load("/3d-bear-arts/assets/gear.jpg"),F=N.load("/3d-bear-arts/assets/underwater.jpg"),J=N.load("/3d-bear-arts/assets/beach.jpg");F.wrapS=F.wrapT=qt,J.wrapS=J.wrapT=qt,J.repeat.set(.8,1),R.mapping=Ur,P.wrapS=P.wrapT=qt;const x=new Fe({color:11592447,metalness:.05,roughness:.4,clearcoat:.9,clearcoatRoughness:.2,reflectivity:.6,map:J,envMapIntensity:.8,side:ft,transparent:!0,opacity:.9}),w=new Fe({color:11592447,metalness:.05,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,reflectivity:.4,map:J,envMapIntensity:.6,side:ft,transparent:!0,opacity:.9,transmission:.5,ior:1.33,depthWrite:!1,depthTest:!0});new Fe({color:11592447,metalness:.05,roughness:.4,clearcoat:.9,clearcoatRoughness:.2,reflectivity:.6,envMapIntensity:.8,map:J,side:ft,transparent:!0,opacity:.9});const j=new Fe({color:8374441,metalness:1,roughness:.25,envMap:R,clearcoat:.7,clearcoatRoughness:.3}),V=new Fe({color:11592447,metalness:.1,roughness:.3,transparent:!0,opacity:.5,clearcoat:.6,clearcoatRoughness:.25,transmission:.6,ior:1.4,depthWrite:!1,depthTest:!0,side:ft}),Z=new Fe({color:11592447,metalness:.1,roughness:.3,transparent:!0,opacity:.5,map:J,clearcoat:.1,clearcoatRoughness:.25,transmission:.6,ior:1.4}),ae=new Fe({color:"#a4d0f5",metalness:0,roughness:.8,map:P,clearcoat:.1,clearcoatRoughness:.7,transmission:.9,opacity:.8,transparent:!0}),k=new Fe({color:"#a4d0f5",metalness:0,roughness:.85,map:J,clearcoat:.1,clearcoatRoughness:.7,transmission:.9,opacity:.6,transparent:!0}),Q=new ze(1,32,32,0,Math.PI),W=new q(Q,V),me=new q(Q,w);W.scale.set(.85,.85,.8),me.scale.set(.85,.85,.8),W.position.y=-.2,me.position.y=-.2,W.rotation.y=Math.PI/2,me.rotation.y=Math.PI*1.5;const Me=new Rt(1,32),_e=new q(Me,k);_e.scale.set(.85,.85,.8),_e.position.set(0,-.2,0),_e.rotation.y=Math.PI/2;const Ae=new Qe;Ae.add(W),Ae.add(me),Ae.add(_e);const Oe=new ze(.6,32,32,0,Math.PI*2,0,Math.PI/2),oe=new Fe({color:6935271,metalness:.1,roughness:.2,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.9,transmission:.9,ior:1.33,reflectivity:.8,envMapIntensity:1}),fe=new q(Oe,oe);fe.position.set(0,-.2,0),fe.rotation.x=Math.PI,fe.scale.set(1.25,1.25,1.25),Ae.add(fe);const Se=new Fe({color:49151,metalness:.1,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,side:ft,transparent:!0,opacity:.7,depthWrite:!1}),D=new q(Me,Se);D.scale.set(.7,.7,.7),D.position.set(0,-.3,0),D.rotation.x=Math.PI/2,D.renderOrder=1,Ae.add(D),d.add(Ae);const le=new ze(.6,32,32,0,Math.PI),se=new q(le,x);se.scale.set(1,.95,.95),se.position.set(0,1,0),se.rotation.y=Math.PI*1.5;const ue=new q(le,Z);ue.scale.set(1,.95,.95),ue.position.set(0,1,0),ue.rotation.y=Math.PI/2;const Ee=new Rt(.6,32),ee=new q(Ee,ae);ee.position.set(0,1,0),ee.rotation.y=Math.PI/2,ee.scale.set(1,.95,.95);const g=new Qe;g.add(se),g.add(ue),g.add(ee),d.add(g);const T=new ze(.25,32,32),L=new q(T,x);L.position.set(-.45,1.35,-.1),d.add(L);const U=new q(T,Z);U.position.set(.45,1.35,-.1),d.add(U);const I=new ze(.25,32,32,Math.PI/2,Math.PI),Y=new q(I,x);Y.scale.set(1.1,.6,.8),Y.position.set(0,.84,.5),Y.rotation.y=Math.PI;const K=new ze(.25,32,32,Math.PI/2,Math.PI),S=new q(K,Z);S.scale.set(1.1,.6,.8),S.position.set(0,.84,.5),S.rotation.y=0;const v=new Rt(.25,32),C=new q(v,ae);C.scale.set(.8,.6,.8),C.position.set(0,.84,.5),C.rotation.y=Math.PI/2;const z=new Qe;z.add(Y),z.add(S),z.add(C),d.add(z);const B=new zn;B.moveTo(0,0),B.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),B.bezierCurveTo(-.6,.3,0,.6,0,1),B.bezierCurveTo(0,.6,.6,.3,.6,0),B.bezierCurveTo(.6,-.3,0,-.3,0,0);const H={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},he=new ui(B,H),ce=new ze(.35,32,32),pe=new q(ce,x);pe.scale.set(.75,1.25,.65),pe.position.set(-.7,-.15,.2),d.add(pe);const be=new q(ce,Z);be.scale.set(.75,1.25,.65),be.position.set(.7,-.15,.2),d.add(be);const de=new oi(.2,.22,.6,32),xe=new q(de,x);xe.position.set(-.4,-1.05,0),d.add(xe);const Re=new q(de,Z);Re.position.set(.4,-1.05,0),d.add(Re);const Le=new ze(.3,32,32),we=new q(Le,x);we.scale.set(1,.72,1.5),we.position.set(-.4,-1.45,.17),d.add(we);const Ge=new q(Le,Z);Ge.scale.set(1,.72,1.5),Ge.position.set(.4,-1.45,.17),d.add(Ge);const Ie=new ze(.44,32,32),Ve=new q(Ie,x);Ve.position.set(-.15,-.45,-.4),d.add(Ve);const O=new q(Ie,Z);O.position.set(.15,-.45,-.4),d.add(O);const ye=new ze(.18,32,32),te=new q(ye,w);te.position.set(0,-.35,-.8),d.add(te),new tr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ve){const Ue=new Vt("X",{font:ve,size:.2,depth:.05});new xn({color:0});const Ye=new q(Ue,x);Ye.position.set(-.3,.99,.53),Ye.rotation.x=mt.degToRad(-5),Ye.rotation.y=mt.degToRad(-15),d.add(Ye);const Je=new Vt("O",{font:ve,size:.2,depth:.05});new xn({color:0});const Xe=new q(Je,w);Xe.position.set(.14,.99,.53),Xe.rotation.y=mt.degToRad(12),Xe.rotation.x=mt.degToRad(-5),d.add(Xe)}),te.renderOrder=1,d.rotation.x=.1;const ge=new q(he,j);ge.scale.set(.3,.3,.3),ge.position.set(.25,1.1,0),ge.rotation.y=Math.PI,ge.rotation.x=Math.PI,d.add(ge),d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,f(),Xt(()=>e.bodyPosition,ve=>{d.position.set(ve.x,ve.y,ve.z)}),Xt(()=>e.cameraPosition,ve=>{_.position.set(e.bodyPosition.x,1,ve),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),M.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(ns(),is(un,null,[tt("div",{ref_key:"threeCanvas",ref:t,class:ai(n.background?"no-bg":"three-canvas")},null,2),tt("div",QE,[tt("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),tt("div",ew,[tt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),tt("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),tt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),nw=ss(tw,[["__scopeId","data-v-08c607ba"]]),iw={class:"pixel-controls"},sw={class:"side-buttons"},rw=li({__name:"Water",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ot(null);let i=ot(!1),s=ot(!1),r=ot(!1),o=ot(!1);Li(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),Ee.uniforms.u_time.value+=.25,M.render(p,_)};const p=new js,_=new Ut(75,window.innerWidth/window.innerHeight,.1,1e3),M=new Ks({antialias:!0,alpha:!0});M.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(M.domElement);const d=new Qe,m=new Qe;p.add(m);const b=new er(16777215,2);p.add(b);const y=new Qs(16777215,4);y.position.set(5,5,5),p.add(y);const E=new Js(16777215,5,50);E.position.set(0,2,4),p.add(E);const N=new Zs,P=N.load("/3d-bear-arts/assets/beach.jpg");P.repeat.set(.8,1);const R=N.load("/3d-bear-arts/assets/sun.jpg");P.wrapS=P.wrapT=qt,R.wrapS=R.wrapT=qt;const F=new Fe({color:11592447,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new Fe({color:11592447,map:P,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ft,depthWrite:!1,depthTest:!0});const J=new Fe({color:11592447,map:P,metalness:.3,roughness:.5,transparent:!0,opacity:.6,side:ft,ior:1.33,depthWrite:!1,depthTest:!0}),x=new Fe({color:11592447,map:P,metalness:.1,roughness:.6,transparent:!0,opacity:.85,clearcoat:.9,clearcoatRoughness:.4,transmission:.7,ior:1.2,depthTest:!0,envMapIntensity:.8}),w=new Fe({color:11592447,map:P,metalness:.1,roughness:.6,transparent:!0,opacity:.85,clearcoat:.9,clearcoatRoughness:.4,transmission:.7,ior:1.2,depthWrite:!1,depthTest:!0,envMapIntensity:.6,side:ft}),j=new Fe({color:11592447,map:P,metalness:.3,roughness:.5,transparent:!0,opacity:.8,side:ft,ior:1.33});new Fe({color:11592447,map:P,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.7,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1});const V=new Fe({color:11592447,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Z=new ze(1,32,32,0,Math.PI),ae=new q(Z,w),k=new q(Z,J);ae.scale.set(.85,.85,.8),k.scale.set(.85,.85,.8),ae.position.y=-.2,k.position.y=-.2,ae.rotation.y=Math.PI/2,k.rotation.y=Math.PI*1.5;const Q=new Rt(1,32),W=new q(Q,F);W.scale.set(.85,.85,.8),W.position.set(0,-.2,0),W.rotation.y=Math.PI/2;const me=new Qe;me.add(ae),me.add(k),me.add(W),d.add(me);const Me=new ze(.6,32,32,0,Math.PI),_e=new q(Me,F);_e.scale.set(1,.95,.95),_e.position.set(0,1,0),_e.rotation.y=Math.PI*1.5;const Ae=new q(Me,x);Ae.scale.set(1,.95,.95),Ae.position.set(0,1,0),Ae.rotation.y=Math.PI/2;const Oe=new Rt(.6,32),oe=new q(Oe,F);oe.position.set(0,1,0),oe.rotation.y=Math.PI/2,oe.scale.set(1,.95,.95);const fe=new Qe;fe.add(_e),fe.add(Ae),fe.add(oe),d.add(fe);const Se=new ze(.6,32,32,0,Math.PI*2,0,Math.PI/2),D=new Fe({color:11592447,metalness:.1,roughness:.2,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.9,transmission:.9,ior:1.33,reflectivity:.8,envMapIntensity:1}),le=new q(Se,D);le.position.set(0,-.2,0),le.rotation.x=Math.PI,le.scale.set(1.25,1.25,1.25),me.add(le);const se=new Fe({color:49151,metalness:.1,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,side:ft,transparent:!0,opacity:.7,depthWrite:!1}),ue=new q(Q,se);ue.scale.set(.7,.7,.7),ue.position.set(0,-.3,0),ue.rotation.x=Math.PI/2,ue.renderOrder=1,me.add(ue),d.add(me);const Ee=new ri({transparent:!0,opacity:.7,uniforms:{u_time:{value:0},u_waveFrequency:{value:4},u_waveAmplitude:{value:.04},u_waveSpeed:{value:1}},vertexShader:`
    ...
    `}),ee=new q(Q,Ee);ee.position.set(0,-.3,0),ee.scale.set(.7,.7,.7),ee.rotation.x=-Math.PI/2,ee.renderOrder=1,me.add(ee);const g=new ze(.25,32,32),T=new q(g,j);T.position.set(-.45,1.35,-.1),d.add(T);const L=new q(g,x);L.position.set(.45,1.35,-.1),d.add(L);const U=new ze(.25,32,32,Math.PI/2,Math.PI),I=new q(U,j);I.scale.set(1.1,.6,.8),I.position.set(0,.84,.5),I.rotation.y=Math.PI;const Y=new ze(.25,32,32,Math.PI/2,Math.PI),K=new q(Y,J);K.scale.set(1.1,.6,.8),K.position.set(0,.84,.5),K.rotation.y=0;const S=new Rt(.25,32),v=new q(S,J);v.scale.set(.8,.6,.8),v.position.set(0,.84,.5),v.rotation.y=Math.PI/2;const C=new Qe;C.add(I),C.add(K),C.add(v),d.add(C);const z=new zn;z.moveTo(0,0),z.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),z.bezierCurveTo(-.6,.3,0,.6,0,1),z.bezierCurveTo(0,.6,.6,.3,.6,0),z.bezierCurveTo(.6,-.3,0,-.3,0,0);const B={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},H=new ui(z,B),he=new q(H,J);he.scale.set(.5,.5,.5),he.position.set(.3,0,0),he.rotation.y=Math.PI,he.rotation.x=Math.PI;const ce=new ze(.35,32,32),pe=new q(ce,J);pe.scale.set(.75,1.25,.65),pe.position.set(-.7,-.15,.2),d.add(pe);const be=new q(ce,J);be.scale.set(.75,1.25,.65),be.position.set(.7,-.15,.2),d.add(be);const de=new oi(.2,.22,.6,32),xe=new q(de,j);xe.position.set(-.4,-1.05,0),d.add(xe);const Re=new q(de,J);Re.position.set(.4,-1.05,0),d.add(Re);const Le=new ze(.3,32,32),we=new q(Le,j);we.scale.set(1,.72,1.5),we.position.set(-.4,-1.45,.17),d.add(we);const Ge=new q(Le,J);Ge.scale.set(1,.72,1.5),Ge.position.set(.4,-1.45,.17),d.add(Ge);const Ie=new ze(.44,32,32),Ve=new q(Ie,j);Ve.position.set(-.15,-.45,-.4),d.add(Ve);const O=new q(Ie,x);O.position.set(.15,-.45,-.4),d.add(O);const ye=new ze(.18,32,32),te=new q(ye,j);te.position.set(0,-.35,-.8),d.add(te),new tr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ge){const ve=new Vt("X",{font:ge,size:.2,depth:.05}),Ue=new q(ve,V);Ue.position.set(-.3,.99,.53),Ue.rotation.x=mt.degToRad(-5),Ue.rotation.y=mt.degToRad(-15),d.add(Ue);const Ye=new Vt("O",{font:ge,size:.2,depth:.05}),Je=new q(Ye,V);Je.position.set(.14,.99,.53),Je.rotation.y=mt.degToRad(12),Je.rotation.x=mt.degToRad(-5),d.add(Je)}),te.renderOrder=1,d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,d.rotation.x=.1,f(),Xt(()=>e.bodyPosition,ge=>{d.position.set(ge.x,ge.y,ge.z)}),Xt(()=>e.cameraPosition,ge=>{_.position.set(e.bodyPosition.x,1,ge),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),M.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(ns(),is(un,null,[tt("div",{ref_key:"threeCanvas",ref:t,class:ai(n.background?"no-bg":"three-canvas")},null,2),tt("div",iw,[tt("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),tt("div",sw,[tt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),tt("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),tt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),ow=ss(rw,[["__scopeId","data-v-7343c7c1"]]),aw=[{path:"/3d-bear-arts/leather",name:"Leather",component:kE},{path:"/3d-bear-arts/pop-art",name:"Pop",component:WE},{path:"/3d-bear-arts/pop-art-bear-3",name:"PopArtBear 3",component:$E},{path:"/3d-bear-arts/machine",name:"MetalMachineBear",component:JE},{path:"/3d-bear-arts/water",name:"Water Bear",component:nw},{path:"/3d-bear-arts/",name:"Water",component:ow}],lw=L0({history:a0(),routes:aw}),Zd=bg(Pg);Zd.use(lw);Zd.mount("#app");
