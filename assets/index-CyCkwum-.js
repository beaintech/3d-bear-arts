...
`)a=0,c-=r;else{const u=Kw(h,s,a,c,t);a+=u.offsetX,o.push(u.path)}}return o}function Kw(n,e,t,i,s){const r=s.glyphs[n]||s.glyphs["?"];if(!r){console.error('THREE.Font: character "'+n+'" does not exists in font family '+s.familyName+".");return}const o=new Yw;let a,c,l,h,u,f,d,_;if(r.o){const M=r._cachedOutline||(r._cachedOutline=r.o.split(" "));for(let m=0,p=M.length;m<p;)switch(M[m++]){case"m":a=M[m++]*e+t,c=M[m++]*e+i,o.moveTo(a,c);break;case"l":a=M[m++]*e+t,c=M[m++]*e+i,o.lineTo(a,c);break;case"q":l=M[m++]*e+t,h=M[m++]*e+i,u=M[m++]*e+t,f=M[m++]*e+i,o.quadraticCurveTo(u,f,l,h);break;case"b":l=M[m++]*e+t,h=M[m++]*e+i,u=M[m++]*e+t,f=M[m++]*e+i,d=M[m++]*e+t,_=M[m++]*e+i,o.bezierCurveTo(u,f,d,_,l,h);break}}return{offsetX:r.ha*e,path:o}}class Ft extends kt{constructor(e,t={}){const i=t.font;if(i===void 0)super();else{const s=i.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(s,t)}this.type="TextGeometry"}}const Zw=Wt({__name:"PinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ut(null);return nn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,h.uniforms.time.value+=.03,o.render(s,r)};const s=new Fn,r=new gt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Nn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=rs,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Bn(16777215,.6);s.add(a);const c=new On(16777215,1.5);c.position.set(5,5,5),s.add(c);const l=new fi(16777215,2,50);l.position.set(0,2,4),s.add(l);const h=new St({uniforms:{time:{value:0},color1:{value:new We(16766720)},color2:{value:new We(16007990)}},vertexShader:`
        ...
        `}),u=new ke({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=new ke({color:13369344,metalness:.4,roughness:.3,clearcoat:.3,clearcoatRoughness:.2,transparent:!0,opacity:.99}),d=new Je,_=new ye(1,32,32),M=new I(_,u);M.scale.set(.85,.85,.8),M.position.y=-.2,d.add(M);const m=new ye(.6,32,32),p=new I(m,u);p.scale.set(1,.95,.95),p.position.set(0,1,0),d.add(p);const w=new ye(.25,32,32),x=new I(w,u);x.position.set(-.45,1.35,-.1),d.add(x);const S=new I(w,u);S.position.set(.45,1.35,-.1),d.add(S);const D=new ye(.25,32,32),C=new I(D,u);C.scale.set(1,.6,.8),C.position.set(0,.85,.5),d.add(C);const A=new Ut;A.moveTo(0,0),A.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),A.bezierCurveTo(-.6,.3,0,.6,0,1),A.bezierCurveTo(0,.6,.6,.3,.6,0),A.bezierCurveTo(.6,-.3,0,-.3,0,0);const F={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ne=new kt(A,F),y=new I(ne,f);y.scale.set(.5,.5,.5),y.position.set(0,.34,.8),y.rotation.y=Math.PI,y.rotation.x=Math.PI,d.add(y);const b=new ye(.35,32,32),X=new I(b,u);X.scale.set(.75,1.25,.65),X.position.set(-.7,-.15,.2),d.add(X);const G=new I(b,u);G.scale.set(.75,1.25,.65),G.position.set(.7,-.15,.2),d.add(G);const J=new dn(.2,.22,.6,32),ie=new I(J,u);ie.position.set(-.4,-1.05,0),d.add(ie);const H=new I(J,u);H.position.set(.4,-1.05,0),d.add(H);const Z=new ye(.3,32,32),z=new I(Z,u);z.scale.set(1,.72,1.5),z.position.set(-.4,-1.45,.17),d.add(z);const me=new I(Z,u);me.scale.set(1,.72,1.5),me.position.set(.4,-1.45,.17),d.add(me);const pe=new ye(.44,32,32),_e=new I(pe,u);_e.position.set(-.15,-.45,-.4),d.add(_e);const Se=new I(pe,u);Se.position.set(.15,-.45,-.4),d.add(Se);const Le=new ye(.18,32,32),te=new I(Le,f);te.position.set(0,-.35,-.8),d.add(te),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function($){const le=new Ft("X",{font:$,size:.2,depth:.05}),xe=new vt({color:0}),Q=new I(le,xe);Q.position.set(-.34,1,.5),d.add(Q)});const de=new ye(.1,32,32),U=new vt({color:0}),se=new I(de,U);se.position.set(.2,1.1,.54),d.add(se),s.add(d),i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),r.position.set(e.bodyPosition.x,1,e.cameraPosition),r.lookAt(e.bodyPosition.x,0,0),bt(()=>e.bodyPosition,$=>{d.position.set($.x,$.y,$.z)}),bt(()=>e.cameraPosition,$=>{r.position.set(e.bodyPosition.x,1,$),r.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,s)=>(Zt(),sn("div",{ref_key:"threeCanvas",ref:t,class:Un(n.background?"no-bg":"three-canvas")},null,2))}}),sp=rn(Zw,[["__scopeId","data-v-d0efbfd4"]]),Jw=Wt({__name:"PurpleBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ut(null);return nn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,h.uniforms.time.value+=.03,o.render(s,r)};const s=new Fn,r=new gt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Nn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=rs,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Bn(16777215,.6);s.add(a);const c=new On(16777215,1.5);c.position.set(5,5,5),s.add(c);const l=new fi(16777215,2,50);l.position.set(0,2,4),s.add(l);const h=new St({uniforms:{time:{value:0},color1:{value:new We(16766720)},color2:{value:new We(16007990)}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,uE=Wt({__name:"DiamondBear",setup(n){const e=ut(null);return nn(()=>{const t=new Fn,i=new gt(75,window.innerWidth/window.innerHeight,.1,1e3),s=new Nn({antialias:!0,alpha:!0});s.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(s.domElement);const r=new Bn(16777215,5);t.add(r);const o=new On(16777215,20);o.position.set(5,5,5),t.add(o);const a=new St({uniforms:{time:{value:0}},vertexShader:cE,fragmentShader:lE,transparent:!0,opacity:.1}),c=new Je,l=new ye(1,32,32),h=new I(l,a);h.scale.set(.85,.85,.8),h.position.y=-.2,c.add(h);const u=new ye(.6,32,32),f=new I(u,a);f.scale.set(1,.95,.95),f.position.set(0,1,0),c.add(f);const d=new ye(.25,32,32),_=new I(d,a);_.position.set(-.45,1.35,-.1),c.add(_);const M=new I(d,a);M.position.set(.45,1.35,-.1),c.add(M);const m=new ye(.25,32,32),p=new I(m,a);p.scale.set(1,.6,.8),p.position.set(0,.85,.5),c.add(p);const w=new ye(.35,32,32),x=new I(w,a);x.scale.set(.75,1.25,.65),x.position.set(-.7,-.15,.2),c.add(x);const S=new I(w,a);S.scale.set(.75,1.25,.65),S.position.set(.7,-.15,.2),c.add(S);const D=new ye(.3,32,32),C=new I(D,a);C.scale.set(1,.72,1.5),C.position.set(-.4,-1.45,.17),c.add(C);const A=new I(D,a);A.scale.set(1,.72,1.5),A.position.set(.4,-1.45,.17),c.add(A);const F=new dn(.2,.22,.6,32),ne=new I(F,a);ne.position.set(-.4,-1.05,0),c.add(ne);const y=new I(F,a);y.position.set(.4,-1.05,0),c.add(y);const b=new ye(.44,32,32),X=new I(b,a);X.position.set(-.15,-.45,-.4),c.add(X);const G=new I(b,a);G.position.set(.15,-.45,-.4),c.add(G);const J=new ye(.18,32,32),ie=new I(J,a);ie.position.set(0,-.35,-.75),c.add(ie);const H=new Dr({color:16738740,metalness:1,roughness:.44}),Z=new Dr({color:16776960,metalness:1,roughness:.44}),z=new Ut;z.moveTo(0,.15),z.lineTo(.1,0),z.lineTo(0,-.15),z.lineTo(-.1,0),z.lineTo(0,.15);const me={depth:.07,bevelEnabled:!1},pe=new kt(z,me),_e=new I(pe,H);_e.position.set(-.25,1,.5),_e.rotation.y=Math.PI/30,c.add(_e);const Se=new I(pe,Z);Se.position.set(.25,1,.5),Se.rotation.y=Math.PI/30,c.add(Se),t.add(c),i.position.set(0,1,4),i.lookAt(0,0,0);function Le(){requestAnimationFrame(Le),a.uniforms.time.value+=.1,c.rotation.y+=.02,s.render(t,i)}Le(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),s.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(Zt(),sn("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),hE=rn(uE,[["__scopeId","data-v-a7796925"]]),ef=`
  varying vec2 vUv;
        void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `,fE=Wt({__name:"GlassBear",setup(n){const e=ut(null);return nn(()=>{const t=new Fn,i=new gt(75,window.innerWidth/window.innerHeight,.1,1e3),s=new Nn({antialias:!0,alpha:!0});s.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(s.domElement);const r=new Bn(16777215,.5);t.add(r);const o=new On(16777215,10);o.position.set(5,5,5),t.add(o);const a=new St({uniforms:{time:{value:0},opacity:{value:.8}},vertexShader:ef,fragmentShader:tf,transparent:!0}),c=new St({uniforms:{time:{value:0},opacity:{value:.6}},vertexShader:ef,fragmentShader:tf,transparent:!0,depthWrite:!1}),l=new Je,h=new ye(1,32,32),u=new I(h,c);u.scale.set(.85,.85,.8),u.position.y=-.2,l.add(u);const f=new ye(.6,32,32),d=new I(f,c);d.scale.set(1,.95,.95),d.position.set(0,1,0),l.add(d);const _=new ye(.25,32,32),M=new I(_,a);M.position.set(-.45,1.35,-.1),l.add(M);const m=new I(_,c);m.position.set(.45,1.35,-.1),l.add(m);const p=new ye(.25,32,32),w=new I(p,a);w.scale.set(1,.6,.8),w.position.set(0,.85,.5),l.add(w);const x=new ye(.35,32,32),S=new I(x,a);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),l.add(S);const D=new I(x,a);D.scale.set(.75,1.25,.65),D.position.set(.7,-.15,.2),l.add(D);const C=new ye(.3,32,32),A=new I(C,a);A.scale.set(1,.72,1.5),A.position.set(-.4,-1.45,.17),l.add(A);const F=new I(C,a);F.scale.set(1,.72,1.5),F.position.set(.4,-1.45,.17),l.add(F);const ne=new dn(.2,.22,.6,32),y=new I(ne,a);y.position.set(-.4,-1.05,0),l.add(y);const b=new I(ne,a);b.position.set(.4,-1.05,0),l.add(b);const X=new ye(.44,32,32);new I(X,a).position.set(-.15,-.45,-.4),new I(X,a).position.set(.15,-.45,-.4);const ie=new ye(.18,32,32),H=new I(ie,a);H.position.set(0,-.35,-.75),l.add(H);const Z=new Ut;Z.moveTo(0,0),Z.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Z.bezierCurveTo(-.6,.3,0,.6,0,1),Z.bezierCurveTo(0,.6,.6,.3,.6,0),Z.bezierCurveTo(.6,-.3,0,-.3,0,0);const z=new Dr({color:8900331,metalness:1,roughness:.44}),me=new Dr({color:16776960,metalness:1,roughness:.44}),pe=new Ut;pe.moveTo(0,.15),pe.lineTo(.1,0),pe.lineTo(0,-.15),pe.lineTo(-.1,0),pe.lineTo(0,.15);const _e={depth:.07,bevelEnabled:!1},Se=new kt(pe,_e),Le=new I(Se,z);Le.position.set(-.25,1,.5),Le.rotation.y=Math.PI/30,l.add(Le);const te=new I(Se,me);te.position.set(.25,1,.5),te.rotation.y=Math.PI/30,l.add(te),new ke({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const he={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},de=new ke({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),U=new kt(Z,he),se=new I(U,de);se.scale.set(.5,.5,.5),se.position.set(0,0,0),se.rotation.y=Math.PI,se.rotation.x=Math.PI,l.add(se);const $=new Ut;$.moveTo(0,.6),$.lineTo(.3,.3),$.lineTo(.6,0),$.lineTo(.3,-.3),$.lineTo(0,-.6),$.lineTo(-.3,-.3),$.lineTo(-.6,0),$.lineTo(-.3,.3),$.lineTo(0,.6);const le={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},xe=new kt($,le),Q=new ke({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),g=new I(xe,Q);g.scale.set(.5,.5,.5),g.position.set(0,0,0),t.add(l),i.position.set(0,1,4),i.lookAt(0,0,0);const T=()=>{requestAnimationFrame(T),a.uniforms.time.value+=.03,l.rotation.y+=.03,s.render(t,i)};T(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),s.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(Zt(),sn("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),dE=rn(fE,[["__scopeId","data-v-fa1425bf"]]),pE=Wt({__name:"BluePinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ut(null);return nn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.02,o.render(s,r)};const s=new Fn,r=new gt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Nn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=rs,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Bn(16777215,.6);s.add(a);const c=new On(16777215,1.5);c.position.set(5,5,5),s.add(c);const l=new fi(16777215,2,50);l.position.set(0,2,4),s.add(l);const h=new ke({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),u=new ke({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=m=>{const p=new Je,w=new ye(1,32,32),x=new I(w,m);x.scale.set(.85,.85,.8),x.position.y=-.2,p.add(x);const S=new ye(.6,32,32),D=new I(S,m);D.scale.set(1,.95,.95),D.position.set(0,1,0),p.add(D);const C=new ye(.25,32,32),A=new I(C,m);A.scale.set(1,.6,.8),A.position.set(0,.85,.5),p.add(A),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(xe){const Q=new Ft("X",{font:xe,size:.18,depth:.05}),g=new vt({color:0}),T=new I(Q,g);T.position.set(-.3,.99,.53),T.rotation.x=Ze.degToRad(-5),T.rotation.y=Ze.degToRad(-15),p.add(T);const L=new Ft("+",{font:xe,size:.25,depth:.1}),O=new vt({color:0}),N=new I(L,O);N.position.set(.14,.99,.53),N.rotation.y=Ze.degToRad(12),N.rotation.x=Ze.degToRad(-5),p.add(N)});const ne=new Ut;ne.moveTo(0,0),ne.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),ne.bezierCurveTo(-.6,.3,0,.6,0,1),ne.bezierCurveTo(0,.6,.6,.3,.6,0),ne.bezierCurveTo(.6,-.3,0,-.3,0,0);const y={depth:.05,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.05,bevelThickness:.05},b=new kt(ne,y),X=new vt({color:0}),G=new I(b,X);G.scale.set(.1,.1,.1),G.rotation.z=Ze.degToRad(210),G.rotation.x=Ze.degToRad(5),G.rotation.y=Ze.degToRad(-45),G.position.set(-.4,.9,.45),p.add(G);const J=new ye(.25,32,32),ie=new I(J,h);ie.position.set(-.45,1.35,-.1),p.add(ie);const H=new I(J,u);H.position.set(.45,1.35,-.1),p.add(H);const Z=new ye(.35,32,32),z=new I(Z,h);z.scale.set(.75,1.25,.65),z.position.set(-.7,-.15,.2),p.add(z);const me=new I(Z,u);me.scale.set(.75,1.25,.65),me.position.set(.7,-.15,.2),p.add(me);const pe=new dn(.2,.22,.6,32),_e=new I(pe,h);_e.position.set(-.4,-1.05,0),p.add(_e);const Se=new I(pe,u);Se.position.set(.4,-1.05,0),p.add(Se);const Le=new ye(.3,32,32),te=new I(Le,h);te.scale.set(1,.72,1.5),te.position.set(-.4,-1.45,.17),p.add(te);const he=new I(Le,u);he.scale.set(1,.72,1.5),he.position.set(.4,-1.45,.17),p.add(he);const de=new ye(.44,32,32),U=new I(de,h);U.position.set(-.15,-.45,-.4),p.add(U);const se=new I(de,u);se.position.set(.15,-.45,-.4),p.add(se);const $=new ye(.18,32,32),le=new I($,m);return le.position.set(0,-.35,-.8),p.add(le),p},d=new Je,_=f(h),M=f(u);_.position.x=-.01,M.position.x=.01,d.add(_),d.add(M),s.add(d),r.position.z=4,i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),r.position.set(e.bodyPosition.x,1,e.cameraPosition),r.lookAt(e.bodyPosition.x,0,0)}}),(i,s)=>(Zt(),sn("div",{ref_key:"threeCanvas",ref:t,class:"three-canvas"},null,512))}}),mE=rn(pE,[["__scopeId","data-v-9e6b205d"]]),gE=Wt({__name:"HalfTransparentBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ut(null);return nn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),p.rotation.y+=.03,h.uniforms.time.value+=.04,o.render(s,r)};const s=new Fn,r=new gt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Nn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=rs,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Bn(16777215,.6);s.add(a);const c=new On(16777215,1.2);c.position.set(5,5,5),s.add(c);const l=new fi(16777215,2,50);l.position.set(0,2,4),s.add(l);const h=new St({uniforms:{time:{value:0},color1:{value:new We(16766720)},color2:{value:new We(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,M=new St({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:d,fragmentShader:_,transparent:!0,depthWrite:!1}),m=new St({uniforms:{time:{value:0},opacity:{value:.4}},vertexShader:d,fragmentShader:_,transparent:!0,depthWrite:!1}),p=new Je,w=new ye(1,32,32,0,Math.PI),x=new I(w,m),S=new I(w,M);x.scale.set(.85,.85,.8),S.scale.set(.85,.85,.8),x.position.y=-.2,S.position.y=-.2,x.rotation.y=Math.PI/2,S.rotation.y=Math.PI*1.5;const D=new Dt(1,32),C=new I(D,M);C.scale.set(.85,.85,.8),C.position.set(0,-.2,0),C.rotation.y=Math.PI/2;const A=new Je;A.add(x),A.add(S),A.add(C),p.add(A);const F=new ye(.6,32,32,0,Math.PI),ne=new I(F,M);ne.scale.set(1,.95,.95),ne.position.set(0,1,0),ne.rotation.y=Math.PI*1.5;const y=new I(F,m);y.scale.set(1,.95,.95),y.position.set(0,1,0),y.rotation.y=Math.PI/2;const b=new Dt(.6,32),X=new I(b,M);X.position.set(0,.97,0),X.rotation.y=Math.PI/2;const G=new Je;G.add(ne),G.add(y),G.add(X),p.add(G);const J=new ye(.25,32,32),ie=new I(J,M);ie.position.set(-.45,1.35,-.1),p.add(ie);const H=new I(J,m);H.position.set(.45,1.35,-.1),p.add(H);const Z=new ye(.25,32,32,Math.PI/2,Math.PI),z=new I(Z,M);z.scale.set(1,.6,.8),z.position.set(0,.82,.5),z.rotation.y=Math.PI;const me=new ye(.25,32,32,Math.PI/2,Math.PI),pe=new I(me,m);pe.scale.set(1,.6,.8),pe.position.set(0,.82,.5),pe.rotation.y=0;const _e=new Dt(.25,32),Se=new I(_e,M);Se.scale.set(1.25,.6,.8),Se.position.set(0,.85,.5),Se.rotation.x=Math.PI/2;const Le=new Je;Le.add(z),Le.add(pe),Le.add(Se),p.add(Le);const te=new Ut;te.moveTo(0,0),te.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),te.bezierCurveTo(-.6,.3,0,.6,0,1),te.bezierCurveTo(0,.6,.6,.3,.6,0),te.bezierCurveTo(.6,-.3,0,-.3,0,0);const he={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new ke({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const de=new kt(te,he),U=new I(de,f);U.scale.set(.5,.5,.5),U.position.set(0,0,0),U.rotation.y=Math.PI,U.rotation.x=Math.PI,p.add(U);const se=new ye(.35,32,32),$=new I(se,M);$.scale.set(.75,1.25,.65),$.position.set(-.7,-.15,.2),p.add($);const le=new I(se,m);le.scale.set(.75,1.25,.65),le.position.set(.7,-.15,.2),p.add(le);const xe=new dn(.2,.22,.6,32),Q=new I(xe,M);Q.position.set(-.4,-1.05,0),p.add(Q);const g=new I(xe,m);g.position.set(.4,-1.05,0),p.add(g);const T=new ye(.3,32,32),L=new I(T,M);L.scale.set(1,.72,1.5),L.position.set(-.4,-1.45,.17),p.add(L);const O=new I(T,m);O.scale.set(1,.72,1.5),O.position.set(.4,-1.45,.17),p.add(O);const N=new ye(.44,32,32),K=new I(N,M);K.position.set(-.15,-.45,-.4),p.add(K);const ee=new I(N,u);ee.position.set(.15,-.45,-.4),p.add(ee);const E=new ye(.18,32,32),v=new I(E,f);v.position.set(0,-.35,-.8),p.add(v),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(V){const k=new Ft("X",{font:V,size:.18,depth:.05}),q=new vt({color:0}),fe=new I(k,q);fe.position.set(-.3,.99,.53),fe.rotation.x=Ze.degToRad(-5),fe.rotation.y=Ze.degToRad(-15),p.add(fe);const ue=new Ft("+",{font:V,size:.25,depth:.1}),ve=new vt({color:0}),Re=new I(ue,ve);Re.position.set(.14,.99,.53),Re.rotation.y=Ze.degToRad(12),Re.rotation.x=Ze.degToRad(-5),p.add(Re)}),s.add(p),i(),p.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),r.position.set(e.bodyPosition.x,1,e.cameraPosition),r.lookAt(e.bodyPosition.x,0,0),bt(()=>e.bodyPosition,V=>{p.position.set(V.x,V.y,V.z)}),bt(()=>e.cameraPosition,V=>{r.position.set(e.bodyPosition.x,1,V),r.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,s)=>(Zt(),sn("div",{ref_key:"threeCanvas",ref:t,class:Un(n.background?"no-bg":"three-canvas")},null,2))}}),_E=rn(gE,[["__scopeId","data-v-7fbce4ad"]]),vE=Wt({__name:"HalfBlueBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ut(null);return nn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),Me&&(x.rotation.y+=.03),o.render(s,r)};const s=new Fn,r=new gt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Nn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=rs,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Bn(16777215,.6);s.add(a);const c=new On(16777215,1.2);c.position.set(5,5,5),s.add(c);const l=new fi(16777215,2,50);l.position.set(0,2,4),s.add(l);const h=new St({uniforms:{time:{value:0},color1:{value:new We(16766720)},color2:{value:new We(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,w=new St({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:m,fragmentShader:p,transparent:!1,depthWrite:!0}),x=new Je,S=new ye(1,32,32,0,Math.PI),D=new I(S,f),C=new I(S,u);D.scale.set(.85,.85,.8),C.scale.set(.85,.85,.8),D.position.y=-.2,C.position.y=-.2,D.rotation.y=Math.PI/2,C.rotation.y=Math.PI*1.5;const A=new Dt(1,32),F=new I(A,u);F.scale.set(.85,.85,.8),F.position.set(0,-.2,0),F.rotation.y=Math.PI/2;const ne=new Je;ne.add(D),ne.add(C),ne.add(F),x.add(ne);const y=new ye(.6,32,32,0,Math.PI),b=new I(y,u);b.scale.set(1,.95,.95),b.position.set(0,1,0),b.rotation.y=Math.PI*1.5;const X=new I(y,f);X.scale.set(1,.95,.95),X.position.set(0,1,0),X.rotation.y=Math.PI/2;const G=new Dt(.6,32),J=new I(G,u);J.position.set(0,1,0),J.rotation.y=Math.PI/2,J.scale.set(1,.95,.95);const ie=new Je;ie.add(b),ie.add(X),ie.add(J),x.add(ie);const H=new ye(.25,32,32),Z=new I(H,u);Z.position.set(-.45,1.35,-.1),x.add(Z);const z=new I(H,f);z.position.set(.45,1.35,-.1),x.add(z);const me=new ye(.25,32,32,Math.PI/2,Math.PI),pe=new I(me,u);pe.scale.set(1.1,.6,.8),pe.position.set(0,.84,.5),pe.rotation.y=Math.PI;const _e=new ye(.25,32,32,Math.PI/2,Math.PI),Se=new I(_e,f);Se.scale.set(1.1,.6,.8),Se.position.set(0,.84,.5),Se.rotation.y=0;const Le=new Dt(.25,32),te=new I(Le,u);te.scale.set(.8,.6,.8),te.position.set(0,.84,.5),te.rotation.y=Math.PI/2;const he=new Je;he.add(pe),he.add(Se),he.add(te),x.add(he);const de=new Ut;de.moveTo(0,0),de.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),de.bezierCurveTo(-.6,.3,0,.6,0,1),de.bezierCurveTo(0,.6,.6,.3,.6,0),de.bezierCurveTo(.6,-.3,0,-.3,0,0);const U={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new ke({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const se=new kt(de,U);new vt({color:0});const $=new I(se,d);$.scale.set(.1,.1,.1),$.rotation.z=Ze.degToRad(210),$.rotation.x=Ze.degToRad(5),$.rotation.y=Ze.degToRad(-45),$.position.set(-.4,.9,.45);const le=new I(se,w);le.scale.set(.5,.5,.5),le.position.set(.35,0,0),le.rotation.y=Math.PI,le.rotation.x=Math.PI,x.add(le);const xe=new I(se,h);xe.scale.set(.35,.35,.35),xe.position.set(.3,0,0),xe.rotation.y=Math.PI,xe.rotation.x=Math.PI;const Q=new I(se,M);Q.scale.set(.25,.25,.25),Q.position.set(.27,.2,0),Q.rotation.y=Math.PI,Q.rotation.x=Math.PI;const g=new I(se,_);g.scale.set(.3,.3,.3),g.position.set(.23,-.5,.3),g.rotation.y=Math.PI,g.rotation.x=Math.PI;const T=new I(se,w);T.scale.set(.4,.4,.4),T.position.set(.27,0,.35),T.rotation.y=Math.PI,T.rotation.x=Math.PI;const L=new ye(.35,32,32),O=new I(L,u);O.scale.set(.75,1.25,.65),O.position.set(-.7,-.15,.2),x.add(O);const N=new I(L,f);N.scale.set(.75,1.25,.65),N.position.set(.7,-.15,.2),x.add(N);const K=new dn(.2,.22,.6,32),ee=new I(K,u);ee.position.set(-.4,-1.05,0),x.add(ee);const E=new I(K,f);E.position.set(.4,-1.05,0),x.add(E);const v=new ye(.3,32,32),P=new I(v,u);P.scale.set(1,.72,1.5),P.position.set(-.4,-1.45,.17),x.add(P);const V=new I(v,f);V.scale.set(1,.72,1.5),V.position.set(.4,-1.45,.17),x.add(V);const k=new ye(.44,32,32),q=new I(k,u);q.position.set(-.15,-.45,-.4),x.add(q);const fe=new I(k,f);fe.position.set(.15,-.45,-.4),x.add(fe);const ue=new ye(.18,32,32),ve=new I(ue,d);ve.position.set(0,-.35,-.8),x.add(ve),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(we){const He=new Ft("X",{font:we,size:.18,depth:.05}),Ne=new vt({color:0}),Ge=new I(He,Ne);Ge.position.set(-.3,.99,.53),Ge.rotation.x=Ze.degToRad(-5),Ge.rotation.y=Ze.degToRad(-15),x.add(Ge);const B=new Ft("+",{font:we,size:.25,depth:.1}),be=new vt({color:0}),oe=new I(B,be);oe.position.set(.14,.99,.53),oe.rotation.y=Ze.degToRad(12),oe.rotation.x=Ze.degToRad(-5),x.add(oe)}),ve.renderOrder=1,x.scale.set(1.2,1.2,1.2),s.add(x),x.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),r.position.set(e.bodyPosition.x,1,e.cameraPosition),r.lookAt(e.bodyPosition.x,0,0),r.position.z=4;const ge={x:0,y:0};let Me=!0,Ie=null;const Ue=we=>{Me=!1,ge.x=we.clientX/window.innerWidth*2-1,ge.y=-(we.clientY/window.innerHeight)*2+1;const He=ge.x*Math.PI*.2,Ne=ge.y*Math.PI*.2;x.rotation.y=He,x.rotation.x=Ne,clearTimeout(Ie),Ie=setTimeout(()=>{Me=!0},500)};window.addEventListener("mousemove",Ue),h.uniforms.time.value+=.04,i(),bt(()=>e.bodyPosition,we=>{x.position.set(we.x,we.y,we.z)}),bt(()=>e.cameraPosition,we=>{r.position.set(e.bodyPosition.x,1,we),r.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,s)=>(Zt(),sn("div",{ref_key:"threeCanvas",ref:t,class:Un(n.background?"no-bg":"three-canvas")},null,2))}}),xE=rn(vE,[["__scopeId","data-v-5bf83852"]]),yE=Wt({__name:"SliverBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ut(null);return nn(()=>{if(t.value){let i=function(){c.visible=!1,M.update(a,r),c.visible=!0,requestAnimationFrame(i)},s=function(){requestAnimationFrame(s),B&&(c.rotation.y+=.03),a.render(r,o)};const r=new Fn,o=new gt(75,window.innerWidth/window.innerHeight,.1,1e3),a=new Nn({antialias:!0,alpha:!0});a.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(a.domElement);const c=new Je,l=new Bn(16777215,2);r.add(l);const h=new On(16777215,4);h.position.set(5,5,5),r.add(h);const u=new fi(16777215,5,50);u.position.set(0,2,4),r.add(u);const d=new ql().load("3d-bear-arts/src/assets/gradient_texture.jpg"),_=new Hd(256,{format:yn,generateMipmaps:!0,minFilter:Ri}),M=new Gd(1,1e3,_);new ke({color:16738740,metalness:1,roughness:.1,clearcoat:1,clearcoatRoughness:.1,envMap:d,envMapIntensity:1.5}),new ke({color:12632256,metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.35,envMap:_.texture,envMapIntensity:1.5}),r.add(M),r.environment=_.texture,i();const p=new Ww().load(["https://threejs.org/examples/textures/cube/Park2/posx.jpg","https://threejs.org/examples/textures/cube/Park2/negx.jpg","https://threejs.org/examples/textures/cube/Park2/posy.jpg","https://threejs.org/examples/textures/cube/Park2/negy.jpg","https://threejs.org/examples/textures/cube/Park2/posz.jpg","https://threejs.org/examples/textures/cube/Park2/negz.jpg"]);r.environment=p;const w=new ke({color:16738740,metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:p,reflectivity:1}),x=new ke({color:16738740,metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,envMap:p,reflectivity:1}),S=new St({uniforms:{time:{value:0},color1:{value:new We(16766720)},color2:{value:new We(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
          ...
          `}),D=new ke({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.89}),C=new ke({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!1,opacity:.99,depthWrite:!0,depthTest:!0}),A=new ke({color:16738740,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!1,opacity:.99,depthWrite:!0,depthTest:!0}),F=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,y=new St({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:F,fragmentShader:ne,transparent:!1,depthWrite:!0}),b=new ye(1,32,32,0,Math.PI),X=new I(b,x),G=new I(b,w);X.scale.set(.85,.85,.8),G.scale.set(.85,.85,.8),X.position.y=-.2,G.position.y=-.2,X.rotation.y=Math.PI/2,G.rotation.y=Math.PI*1.5;const J=new Dt(1,32),ie=new I(J,w);ie.scale.set(.85,.85,.8),ie.position.set(0,-.2,0),ie.rotation.y=Math.PI/2;const H=new Je;H.add(X),H.add(G),H.add(ie),c.add(H);const Z=new ye(.6,32,32,0,Math.PI),z=new I(Z,w);z.scale.set(1,.95,.95),z.position.set(0,1,0),z.rotation.y=Math.PI*1.5;const me=new I(Z,x);me.scale.set(1,.95,.95),me.position.set(0,1,0),me.rotation.y=Math.PI/2;const pe=new Dt(.6,32),_e=new I(pe,w);_e.position.set(0,1,0),_e.rotation.y=Math.PI/2,_e.scale.set(1,.95,.95);const Se=new Je;Se.add(z),Se.add(me),Se.add(_e),c.add(Se);const Le=new ye(.25,32,32),te=new I(Le,w);te.position.set(-.45,1.35,-.1),c.add(te);const he=new I(Le,x);he.position.set(.45,1.35,-.1),c.add(he);const de=new ye(.25,32,32,Math.PI/2,Math.PI),U=new I(de,w);U.scale.set(1.1,.6,.8),U.position.set(0,.84,.5),U.rotation.y=Math.PI;const se=new ye(.25,32,32,Math.PI/2,Math.PI),$=new I(se,x);$.scale.set(1.1,.6,.8),$.position.set(0,.84,.5),$.rotation.y=0;const le=new Dt(.25,32),xe=new I(le,w);xe.scale.set(.8,.6,.8),xe.position.set(0,.84,.5),xe.rotation.y=Math.PI/2;const Q=new Je;Q.add(U),Q.add($),Q.add(xe),c.add(Q);const g=new Ut;g.moveTo(0,0),g.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),g.bezierCurveTo(-.6,.3,0,.6,0,1),g.bezierCurveTo(0,.6,.6,.3,.6,0),g.bezierCurveTo(.6,-.3,0,-.3,0,0);const T={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new ke({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const L=new kt(g,T);new vt({color:0});const O=new I(L,D);O.scale.set(.1,.1,.1),O.rotation.z=Ze.degToRad(210),O.rotation.x=Ze.degToRad(5),O.rotation.y=Ze.degToRad(-45),O.position.set(-.4,.9,.45);const N=new I(L,y);N.scale.set(.5,.5,.5),N.position.set(.35,0,0),N.rotation.y=Math.PI,N.rotation.x=Math.PI,c.add(N);const K=new I(L,S);K.scale.set(.35,.35,.35),K.position.set(.3,0,0),K.rotation.y=Math.PI,K.rotation.x=Math.PI,c.add(K);const ee=new I(L,A);ee.scale.set(.25,.25,.25),ee.position.set(.27,.2,0),ee.rotation.y=Math.PI,ee.rotation.x=Math.PI,c.add(ee);const E=new I(L,C);E.scale.set(.3,.3,.3),E.position.set(.23,-.5,.3),E.rotation.y=Math.PI,E.rotation.x=Math.PI,c.add(E);const v=new I(L,y);v.scale.set(.4,.4,.4),v.position.set(.27,0,.35),v.rotation.y=Math.PI,v.rotation.x=Math.PI;const P=new ye(.35,32,32),V=new I(P,w);V.scale.set(.75,1.25,.65),V.position.set(-.7,-.15,.2),c.add(V);const k=new I(P,x);k.scale.set(.75,1.25,.65),k.position.set(.7,-.15,.2),c.add(k);const q=new dn(.2,.22,.6,32),fe=new I(q,w);fe.position.set(-.4,-1.05,0),c.add(fe);const ue=new I(q,x);ue.position.set(.4,-1.05,0),c.add(ue);const ve=new ye(.3,32,32),Re=new I(ve,w);Re.scale.set(1,.72,1.5),Re.position.set(-.4,-1.45,.17),c.add(Re);const ge=new I(ve,x);ge.scale.set(1,.72,1.5),ge.position.set(.4,-1.45,.17),c.add(ge);const Me=new ye(.44,32,32),Ie=new I(Me,w);Ie.position.set(-.15,-.45,-.4),c.add(Ie);const Ue=new I(Me,x);Ue.position.set(.15,-.45,-.4),c.add(Ue);const we=new ye(.18,32,32),He=new I(we,y);He.position.set(0,-.35,-.8),c.add(He),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ce){const Ee=new Ft("X",{font:ce,size:.18,depth:.05});new vt({color:0});const Ae=new I(Ee,y);Ae.position.set(-.3,.99,.53),Ae.rotation.x=Ze.degToRad(-5),Ae.rotation.y=Ze.degToRad(-15),c.add(Ae);const qe=new Ft("+",{font:ce,size:.25,depth:.1});new vt({color:0});const et=new I(qe,y);et.position.set(.14,.99,.53),et.rotation.y=Ze.degToRad(12),et.rotation.x=Ze.degToRad(-5),c.add(et)}),He.renderOrder=1,c.scale.set(1.2,1.2,1.2),r.add(c),c.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),o.position.set(e.bodyPosition.x,1,e.cameraPosition),o.lookAt(e.bodyPosition.x,0,0),o.position.z=4;const Ge={x:0,y:0};let B=!0,be=null;const oe=ce=>{B=!1,Ge.x=ce.clientX/window.innerWidth*2-1,Ge.y=-(ce.clientY/window.innerHeight)*2+1;const Ee=Ge.x*Math.PI*.2,Ae=Ge.y*Math.PI*.2;c.rotation.y=Ee,c.rotation.x=Ae,clearTimeout(be),be=setTimeout(()=>{B=!0},500)};window.addEventListener("mousemove",oe),S.uniforms.time.value+=.04,s(),bt(()=>e.bodyPosition,ce=>{c.position.set(ce.x,ce.y,ce.z)}),bt(()=>e.cameraPosition,ce=>{o.position.set(e.bodyPosition.x,1,ce),o.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{o.aspect=window.innerWidth/window.innerHeight,o.updateProjectionMatrix(),a.setSize(window.innerWidth,window.innerHeight)})}}),(i,s)=>(Zt(),sn("div",{ref_key:"threeCanvas",ref:t,class:Un(n.background?"no-bg":"three-canvas")},null,2))}}),ME=rn(yE,[["__scopeId","data-v-c37895d8"]]),SE=Wt({__name:"MetalBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ut(null);let i=null,s=ut(!1),r=ut(!1),o=ut(!1);return nn(()=>{if(t.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:r.value&&(u.rotation.y-=.03),h.render(c,l)};const c=new Fn,l=new gt(75,window.innerWidth/window.innerHeight,.1,1e3),h=new Nn({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(h.domElement);const u=new Je,f=new Bn(16777215,2);c.add(f);const d=new On(16777215,4);d.position.set(5,5,5),c.add(d);const _=new fi(16777215,5,50);_.position.set(0,2,4),c.add(_);const M=new ql,m=M.load("/3d-bear-arts/assets/lv2.jpg"),p=M.load("/3d-bear-arts/assets/lv2.jpg");m.wrapS=m.wrapT=es,p.wrapS=p.wrapT=es;const w=new ke({color:8343336,metalness:0,roughness:.8,bumpMap:m,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:p,envMapIntensity:.7}),x=new ke({color:5978654,metalness:0,roughness:.8,bumpMap:m,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:p,envMapIntensity:.7}),S=new ke({color:13152668,metalness:.2,roughness:.05,bumpMap:m,bumpScale:.05,clearcoat:1,clearcoatRoughness:.05,map:p,transparent:!0,opacity:.4,transmission:.9,envMapIntensity:1,reflectivity:.9,ior:1.45,side:en});new ke({color:13421772,metalness:1,roughness:.5,clearcoat:.3,clearcoatRoughness:.3});const D=new ye(1,32,32,0,Math.PI),C=new I(D,S),A=new I(D,w);C.scale.set(.85,.85,.8),A.scale.set(.85,.85,.8),C.position.y=-.2,A.position.y=-.2,C.rotation.y=Math.PI/2,A.rotation.y=Math.PI*1.5;const F=new Dt(1,32),ne=new I(F,w);ne.scale.set(.85,.85,.8),ne.position.set(0,-.2,0),ne.rotation.y=Math.PI/2;const y=new Je;y.add(C),y.add(A),y.add(ne),u.add(y);const b=new ye(.6,32,32,0,Math.PI),X=new I(b,w);X.scale.set(1,.95,.95),X.position.set(0,1,0),X.rotation.y=Math.PI*1.5;const G=new I(b,S);G.scale.set(1,.95,.95),G.position.set(0,1,0),G.rotation.y=Math.PI/2;const J=new Dt(.6,32),ie=new I(J,w);ie.position.set(0,1,0),ie.rotation.y=Math.PI/2,ie.scale.set(1,.95,.95);const H=new Je;H.add(X),H.add(G),H.add(ie),u.add(H);const Z=new ye(.25,32,32),z=new I(Z,w);z.position.set(-.45,1.35,-.1),u.add(z);const me=new I(Z,S);me.position.set(.45,1.35,-.1),u.add(me);const pe=new ye(.25,32,32,Math.PI/2,Math.PI),_e=new I(pe,x);_e.scale.set(1.1,.6,.8),_e.position.set(0,.84,.5),_e.rotation.y=Math.PI;const Se=new ye(.25,32,32,Math.PI/2,Math.PI),Le=new I(Se,S);Le.scale.set(1.1,.6,.8),Le.position.set(0,.84,.5),Le.rotation.y=0;const te=new Dt(.25,32),he=new I(te,w);he.scale.set(.8,.6,.8),he.position.set(0,.84,.5),he.rotation.y=Math.PI/2;const de=new Je;de.add(_e),de.add(Le),de.add(he),u.add(de);const U=new Ut;U.moveTo(0,0),U.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),U.bezierCurveTo(-.6,.3,0,.6,0,1),U.bezierCurveTo(0,.6,.6,.3,.6,0),U.bezierCurveTo(.6,-.3,0,-.3,0,0);const se={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new ke({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const $=new kt(U,se),le=new I($,w);le.scale.set(.1,.1,.1),le.rotation.z=Ze.degToRad(210),le.rotation.x=Ze.degToRad(5),le.rotation.y=Ze.degToRad(-45),le.position.set(-.4,.9,.45);const xe=new I($,x);xe.scale.set(.6,.5,.5),xe.position.set(.35,0,0),xe.rotation.y=Math.PI,xe.rotation.x=Math.PI;const Q=new I($,x);Q.scale.set(.2,.2,.2),Q.position.set(.5,-.1,.2),Q.rotation.y=Math.PI,Q.rotation.x=Math.PI,u.add(Q);const g=new Ys(1.3,1.2,.6),T=new I(g,w);T.scale.set(.45,.45,.45),T.position.set(.35,-.2,.1),T.rotation.y=Math.PI;const L=new Xl(.15,.025,10,100);new ke({color:8343336,metalness:.3,roughness:.4,clearcoat:.5});const O=new I(L,w);O.position.set(.35,.1,.1),O.rotation.z=Math.PI/2,O.rotation.x=Math.PI/8,O.rotation.y=Math.PI/14;const N=new I(L,w);N.position.set(.35,.1,.13),N.rotation.z=Math.PI/2,N.rotation.x=Math.PI/-8,N.rotation.y=Math.PI/12;const K=new Je;K.add(T),K.add(O),K.add(N),u.add(K);const ee=new ye(.35,32,32),E=new I(ee,w);E.scale.set(.75,1.25,.65),E.position.set(-.7,-.15,.2),u.add(E);const v=new I(ee,S);v.scale.set(.75,1.25,.65),v.position.set(.7,-.15,.2),u.add(v);const P=new dn(.2,.22,.6,32),V=new I(P,w);V.position.set(-.4,-1.05,0),u.add(V);const k=new I(P,S);k.position.set(.4,-1.05,0),u.add(k);const q=new ye(.3,32,32),fe=new I(q,w);fe.scale.set(1,.72,1.5),fe.position.set(-.4,-1.45,.17),u.add(fe);const ue=new I(q,S);ue.scale.set(1,.72,1.5),ue.position.set(.4,-1.45,.17),u.add(ue);const ve=new ye(.44,32,32),Re=new I(ve,w);Re.position.set(-.15,-.45,-.4),u.add(Re);const ge=new I(ve,S);ge.position.set(.15,-.45,-.4),u.add(ge);const Me=new ye(.18,32,32),Ie=new I(Me,w);Ie.position.set(0,-.35,-.8),u.add(Ie),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ce){const Ee=new Ft("X",{font:ce,size:.2,depth:.05});new vt({color:0});const Ae=new I(Ee,x);Ae.position.set(-.3,.99,.53),Ae.rotation.x=Ze.degToRad(-5),Ae.rotation.y=Ze.degToRad(-15),u.add(Ae);const qe=new Ft("O",{font:ce,size:.2,depth:.05});new vt({color:0});const et=new I(qe,x);et.position.set(.14,.99,.53),et.rotation.y=Ze.degToRad(12),et.rotation.x=Ze.degToRad(-5),u.add(et)}),Ie.renderOrder=1,u.scale.set(1.35,1.35,1.35),c.add(u),u.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),l.position.set(e.bodyPosition.x,1,e.cameraPosition),l.lookAt(e.bodyPosition.x,0,0),l.position.z=4;const we=()=>{u.rotation.y,u.rotation.x},He=()=>{s.value=!0,r.value=!1,o.value=!1},Ne=()=>{s.value=!1,r.value=!0,o.value=!1},Ge=()=>{s.value=!1,r.value=!1,we()},B=ce=>{const Ee=window.innerWidth/2;ce>Ee?He():Ne(),we()},be=ce=>{clearTimeout(i),Ge(),o.value=!0;const Ee={x:ce.clientX/window.innerWidth*2-1,y:-(ce.clientY/window.innerHeight)*2+1};if(o.value){const Ae=Ee.x*Math.PI*.2,qe=Ee.y*Math.PI*.2;u.rotation.y=Ae,u.rotation.x=qe}i=setTimeout(()=>{o.value=!1,B(ce.clientX)},500)};window.addEventListener("mousemove",be);const oe=ce=>{if(o.value){const Ee={x:ce.clientX/window.innerWidth*2-1,y:-(ce.clientY/window.innerHeight)*2+1},Ae=Ee.x*Math.PI*.2,qe=Ee.y*Math.PI*.2;u.rotation.y=Ae,u.rotation.x=qe}};window.addEventListener("mousemove",oe),a(),bt(()=>e.bodyPosition,ce=>{u.position.set(ce.x,ce.y,ce.z)}),bt(()=>e.cameraPosition,ce=>{l.position.set(e.bodyPosition.x,1,ce),l.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,c)=>(Zt(),sn("div",{ref_key:"threeCanvas",ref:t,class:Un(n.background?"no-bg":"three-canvas")},null,2))}}),wE=rn(SE,[["__scopeId","data-v-f3beb116"]]),EE=Wt({__name:"PopartBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=ut(null);let i=null,s=ut(!1),r=ut(!1),o=ut(!1);return nn(()=>{if(t.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:r.value&&(u.rotation.y-=.03),h.render(c,l)};const c=new Fn,l=new gt(75,window.innerWidth/window.innerHeight,.1,1e3),h=new Nn({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(h.domElement);const u=new Je,f=new Bn(16777215,2);c.add(f);const d=new On(16777215,4);d.position.set(5,5,5),c.add(d);const _=new fi(16777215,5,50);_.position.set(0,2,4),c.add(_);const M=new ql,m=M.load("/3d-bear-arts/assets/pop6.jpg"),p=M.load("/3d-bear-arts/assets/pop7.jpg");m.wrapS=m.wrapT=es,p.wrapS=p.wrapT=es;const w=new ke({color:16738740,map:p,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),x=new ke({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:en}),S=new ke({color:16766720,map:m,metalness:.3,roughness:.5}),D=new ke({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:en}),C=new ke({color:9055202,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new ke({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:en});const A=new ke({color:65535,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),F=new ke({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:en}),ne=new ye(1,32,32,0,Math.PI),y=new I(ne,x),b=new I(ne,w);y.scale.set(.85,.85,.8),b.scale.set(.85,.85,.8),y.position.y=-.2,b.position.y=-.2,y.rotation.y=Math.PI/2,b.rotation.y=Math.PI*1.5;const X=new Dt(1,32),G=new I(X,w);G.scale.set(.85,.85,.8),G.position.set(0,-.2,0),G.rotation.y=Math.PI/2;const J=new Je;J.add(y),J.add(b),J.add(G),u.add(J);const ie=new ye(.6,32,32,0,Math.PI),H=new I(ie,S);H.scale.set(1,.95,.95),H.position.set(0,1,0),H.rotation.y=Math.PI*1.5;const Z=new I(ie,D);Z.scale.set(1,.95,.95),Z.position.set(0,1,0),Z.rotation.y=Math.PI/2;const z=new Dt(.6,32),me=new I(z,S);me.position.set(0,1,0),me.rotation.y=Math.PI/2,me.scale.set(1,.95,.95);const pe=new Je;pe.add(H),pe.add(Z),pe.add(me),u.add(pe);const _e=new ye(.25,32,32),Se=new I(_e,w);Se.position.set(-.45,1.35,-.1),u.add(Se);const Le=new I(_e,x);Le.position.set(.45,1.35,-.1),u.add(Le);const te=new ye(.25,32,32,Math.PI/2,Math.PI),he=new I(te,S);he.scale.set(1.1,.6,.8),he.position.set(0,.84,.5),he.rotation.y=Math.PI;const de=new ye(.25,32,32,Math.PI/2,Math.PI),U=new I(de,x);U.scale.set(1.1,.6,.8),U.position.set(0,.84,.5),U.rotation.y=0;const se=new Dt(.25,32),$=new I(se,S);$.scale.set(.8,.6,.8),$.position.set(0,.84,.5),$.rotation.y=Math.PI/2;const le=new Je;le.add(he),le.add(U),le.add($),u.add(le);const xe=new Ut;xe.moveTo(0,0),xe.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),xe.bezierCurveTo(-.6,.3,0,.6,0,1),xe.bezierCurveTo(0,.6,.6,.3,.6,0),xe.bezierCurveTo(.6,-.3,0,-.3,0,0);const Q={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},g=new kt(xe,Q),T=new I(g,S);T.scale.set(.6,.5,.5),T.position.set(.35,0,0),T.rotation.y=Math.PI,T.rotation.x=Math.PI;const L=new I(g,w);L.scale.set(.2,.2,.2),L.position.set(.5,-.1,.2),L.rotation.y=Math.PI,L.rotation.x=Math.PI,u.add(L);const O=new ye(.35,32,32),N=new I(O,C);N.scale.set(.75,1.25,.65),N.position.set(-.7,-.15,.2),u.add(N);const K=new I(O,F);K.scale.set(.75,1.25,.65),K.position.set(.7,-.15,.2),u.add(K);const ee=new dn(.2,.22,.6,32),E=new I(ee,A);E.position.set(-.4,-1.05,0),u.add(E);const v=new I(ee,D);v.position.set(.4,-1.05,0),u.add(v);const P=new ye(.3,32,32),V=new I(P,A);V.scale.set(1,.72,1.5),V.position.set(-.4,-1.45,.17),u.add(V);const k=new I(P,D);k.scale.set(1,.72,1.5),k.position.set(.4,-1.45,.17),u.add(k);const q=new ye(.44,32,32),fe=new I(q,w);fe.position.set(-.15,-.45,-.4),u.add(fe);const ue=new I(q,x);ue.position.set(.15,-.45,-.4),u.add(ue);const ve=new ye(.18,32,32),Re=new I(ve,w);Re.position.set(0,-.35,-.8),u.add(Re),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(B){const be=new Ft("X",{font:B,size:.2,depth:.05});new vt({color:0});const oe=new I(be,w);oe.position.set(-.3,.99,.53),oe.rotation.x=Ze.degToRad(-5),oe.rotation.y=Ze.degToRad(-15),u.add(oe);const ce=new Ft("O",{font:B,size:.2,depth:.05});new vt({color:0});const Ee=new I(ce,w);Ee.position.set(.14,.99,.53),Ee.rotation.y=Ze.degToRad(12),Ee.rotation.x=Ze.degToRad(-5),u.add(Ee)}),Re.renderOrder=1,u.scale.set(1.35,1.35,1.35),c.add(u),u.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),l.position.set(e.bodyPosition.x,1,e.cameraPosition),l.lookAt(e.bodyPosition.x,0,0),l.position.z=4;const Me=()=>{u.rotation.y,u.rotation.x},Ie=()=>{s.value=!0,r.value=!1,o.value=!1},Ue=()=>{s.value=!1,r.value=!0,o.value=!1},we=()=>{s.value=!1,r.value=!1,Me()},He=B=>{const be=window.innerWidth/2;B>be?Ie():Ue(),Me()},Ne=B=>{clearTimeout(i),we(),o.value=!0;const be={x:B.clientX/window.innerWidth*2-1,y:-(B.clientY/window.innerHeight)*2+1};if(o.value){const oe=be.x*Math.PI*.2,ce=be.y*Math.PI*.2;u.rotation.y=oe,u.rotation.x=ce}i=setTimeout(()=>{o.value=!1,He(B.clientX)},500)};window.addEventListener("mousemove",Ne);const Ge=B=>{if(o.value){const be={x:B.clientX/window.innerWidth*2-1,y:-(B.clientY/window.innerHeight)*2+1},oe=be.x*Math.PI*.2,ce=be.y*Math.PI*.2;u.rotation.y=oe,u.rotation.x=ce}};window.addEventListener("mousemove",Ge),a(),bt(()=>e.bodyPosition,B=>{u.position.set(B.x,B.y,B.z)}),bt(()=>e.cameraPosition,B=>{l.position.set(e.bodyPosition.x,1,B),l.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,c)=>(Zt(),sn("div",{ref_key:"threeCanvas",ref:t,class:Un(n.background?"no-bg":"three-canvas")},null,2))}}),bE=rn(EE,[["__scopeId","data-v-b0298b57"]]),TE=[{path:"/3d-bear-arts",name:"ThreeScene",component:aE},{path:"/3d-bear-arts/half",name:"NewBear",component:xE},{path:"/3d-bear-arts/sliver",name:"SliverBear",component:ME},{path:"/3d-bear-arts/metal",name:"MetalBear",component:wE},{path:"/3d-bear-arts/pop-art",name:"PopArtBear",component:bE},{path:"/3d-bear-arts/halfTransparent",name:"Transparent",component:_E},{path:"/3d-bear-arts/bluePink",name:"BluePinkBear",component:mE},{path:"/3d-bear-arts/diamond",name:"DiamondBear",component:hE},{path:"/3d-bear-arts/pink",name:"PinkBear",component:sp},{path:"/3d-bear-arts/purple",name:"PurpleBear",component:rp},{path:"/3d-bear-arts/glass",name:"GlassBear",component:dE}],AE=qg({history:Sg(),routes:TE}),fp=G0(X0);fp.use(AE);fp.mount("#app");
