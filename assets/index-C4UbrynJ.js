...
`)+`
`+m);const M=b+d+o,w=b+m+a,F=Uh(s,s.VERTEX_SHADER,M),P=Uh(s,s.FRAGMENT_SHADER,w);s.attachShader(x,F),s.attachShader(x,P),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(E){if(n.debug.checkShaderErrors){const q=s.getProgramInfoLog(x).trim(),k=s.getShaderInfoLog(F).trim(),Z=s.getShaderInfoLog(P).trim();let oe=!0,G=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(oe=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,F,P);else{const J=Nh(s,F,"vertex"),X=Nh(s,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
Program Info Log: `+q+`
`+J+`
`+X)}else q!==""?console.warn("THREE.WebGLProgram: Program Info Log:",q):(k===""||Z==="")&&(G=!1);G&&(E.diagnostics={runnable:oe,programLog:q,vertexShader:{log:k,prefix:d},fragmentShader:{log:Z,prefix:m}})}s.deleteShader(F),s.deleteShader(P),O=new Bo(s,x),te=lS(s,x)}let O;this.getUniforms=function(){return O===void 0&&R(this),O};let te;this.getAttributes=function(){return te===void 0&&R(this),te};let y=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return y===!1&&(y=s.getProgramParameter(x,QM)),y},this.destroy=function(){i.releaseStatesOfProgram(this),s.deleteProgram(x),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=eS++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=F,this.fragmentShader=P,this}let yS=0;class MS{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(s)===!1&&(o.add(s),s.usedTimes++),o.has(r)===!1&&(o.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new SS(e),t.set(e,i)),i}}class SS{constructor(e){this.id=yS++,this.code=e,this.usedTimes=0}}function wS(n,e,t,i,s,r,o){const a=new Pd,l=new MS,c=new Set,h=[],u=s.logarithmicDepthBuffer,f=s.reverseDepthBuffer,p=s.vertexTextures;let _=s.precision;const x={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function d(y){return c.add(y),y===0?"uv":`uv${y}`}function m(y,E,q,k,Z){const oe=k.fog,G=Z.geometry,J=y.isMeshStandardMaterial?k.environment:null,X=(y.isMeshStandardMaterial?t:e).get(y.envMap||J),pe=X&&X.mapping===ca?X.image.height:null,ve=x[y.type];y.precision!==null&&(_=s.getMaxPrecision(y.precision),_!==y.precision&&console.warn("THREE.WebGLProgram.getParameters:",y.precision,"not supported, using",_,"instead."));const _e=G.morphAttributes.position||G.morphAttributes.normal||G.morphAttributes.color,Te=_e!==void 0?_e.length:0;let Oe=0;G.morphAttributes.position!==void 0&&(Oe=1),G.morphAttributes.normal!==void 0&&(Oe=2),G.morphAttributes.color!==void 0&&(Oe=3);let se,he,Se,N;if(ve){const nt=Vn[ve];se=nt.vertexShader,he=nt.fragmentShader}else se=y.vertexShader,he=y.fragmentShader,l.update(y),Se=l.getVertexShaderID(y),N=l.getFragmentShaderID(y);const ce=n.getRenderTarget(),ie=Z.isInstancedMesh===!0,ue=Z.isBatchedMesh===!0,we=!!y.map,ee=!!y.matcap,g=!!X,T=!!y.aoMap,L=!!y.lightMap,U=!!y.bumpMap,I=!!y.normalMap,Y=!!y.displacementMap,j=!!y.emissiveMap,S=!!y.metalnessMap,v=!!y.roughnessMap,C=y.anisotropy>0,V=y.clearcoat>0,z=y.dispersion>0,H=y.iridescence>0,de=y.sheen>0,le=y.transmission>0,me=C&&!!y.anisotropyMap,Ee=V&&!!y.clearcoatMap,fe=V&&!!y.clearcoatNormalMap,xe=V&&!!y.clearcoatRoughnessMap,Pe=H&&!!y.iridescenceMap,Re=H&&!!y.iridescenceThicknessMap,be=de&&!!y.sheenColorMap,Be=de&&!!y.sheenRoughnessMap,Ce=!!y.specularMap,ze=!!y.specularColorMap,B=!!y.specularIntensityMap,ye=le&&!!y.transmissionMap,ne=le&&!!y.thicknessMap,Q=!!y.gradientMap,Me=!!y.alphaMap,ge=y.alphaTest>0,Fe=!!y.alphaHash,ke=!!y.extensions;let qe=Di;y.toneMapped&&(ce===null||ce.isXRRenderTarget===!0)&&(qe=n.toneMapping);const Ve={shaderID:ve,shaderType:y.type,shaderName:y.name,vertexShader:se,fragmentShader:he,defines:y.defines,customVertexShaderID:Se,customFragmentShaderID:N,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:_,batching:ue,batchingColor:ue&&Z._colorsTexture!==null,instancing:ie,instancingColor:ie&&Z.instanceColor!==null,instancingMorph:ie&&Z.morphTexture!==null,supportsVertexTextures:p,outputColorSpace:ce===null?n.outputColorSpace:ce.isXRRenderTarget===!0?ce.texture.colorSpace:Bi,alphaToCoverage:!!y.alphaToCoverage,map:we,matcap:ee,envMap:g,envMapMode:g&&X.mapping,envMapCubeUVHeight:pe,aoMap:T,lightMap:L,bumpMap:U,normalMap:I,displacementMap:p&&Y,emissiveMap:j,normalMapObjectSpace:I&&y.normalMapType===p_,normalMapTangentSpace:I&&y.normalMapType===bd,metalnessMap:S,roughnessMap:v,anisotropy:C,anisotropyMap:me,clearcoat:V,clearcoatMap:Ee,clearcoatNormalMap:fe,clearcoatRoughnessMap:xe,dispersion:z,iridescence:H,iridescenceMap:Pe,iridescenceThicknessMap:Re,sheen:de,sheenColorMap:be,sheenRoughnessMap:Be,specularMap:Ce,specularColorMap:ze,specularIntensityMap:B,transmission:le,transmissionMap:ye,thicknessMap:ne,gradientMap:Q,opaque:y.transparent===!1&&y.blending===Hs&&y.alphaToCoverage===!1,alphaMap:Me,alphaTest:ge,alphaHash:Fe,combine:y.combine,mapUv:we&&d(y.map.channel),aoMapUv:T&&d(y.aoMap.channel),lightMapUv:L&&d(y.lightMap.channel),bumpMapUv:U&&d(y.bumpMap.channel),normalMapUv:I&&d(y.normalMap.channel),displacementMapUv:Y&&d(y.displacementMap.channel),emissiveMapUv:j&&d(y.emissiveMap.channel),metalnessMapUv:S&&d(y.metalnessMap.channel),roughnessMapUv:v&&d(y.roughnessMap.channel),anisotropyMapUv:me&&d(y.anisotropyMap.channel),clearcoatMapUv:Ee&&d(y.clearcoatMap.channel),clearcoatNormalMapUv:fe&&d(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:xe&&d(y.clearcoatRoughnessMap.channel),iridescenceMapUv:Pe&&d(y.iridescenceMap.channel),iridescenceThicknessMapUv:Re&&d(y.iridescenceThicknessMap.channel),sheenColorMapUv:be&&d(y.sheenColorMap.channel),sheenRoughnessMapUv:Be&&d(y.sheenRoughnessMap.channel),specularMapUv:Ce&&d(y.specularMap.channel),specularColorMapUv:ze&&d(y.specularColorMap.channel),specularIntensityMapUv:B&&d(y.specularIntensityMap.channel),transmissionMapUv:ye&&d(y.transmissionMap.channel),thicknessMapUv:ne&&d(y.thicknessMap.channel),alphaMapUv:Me&&d(y.alphaMap.channel),vertexTangents:!!G.attributes.tangent&&(I||C),vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!G.attributes.color&&G.attributes.color.itemSize===4,pointsUvs:Z.isPoints===!0&&!!G.attributes.uv&&(we||Me),fog:!!oe,useFog:y.fog===!0,fogExp2:!!oe&&oe.isFogExp2,flatShading:y.flatShading===!0,sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:u,reverseDepthBuffer:f,skinning:Z.isSkinnedMesh===!0,morphTargets:G.morphAttributes.position!==void 0,morphNormals:G.morphAttributes.normal!==void 0,morphColors:G.morphAttributes.color!==void 0,morphTargetsCount:Te,morphTextureStride:Oe,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:y.dithering,shadowMapEnabled:n.shadowMap.enabled&&q.length>0,shadowMapType:n.shadowMap.type,toneMapping:qe,decodeVideoTexture:we&&y.map.isVideoTexture===!0&&ut.getTransfer(y.map.colorSpace)===yt,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===ot,flipSided:y.side===an,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionClipCullDistance:ke&&y.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ke&&y.extensions.multiDraw===!0||ue)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:y.customProgramCacheKey()};return Ve.vertexUv1s=c.has(1),Ve.vertexUv2s=c.has(2),Ve.vertexUv3s=c.has(3),c.clear(),Ve}function b(y){const E=[];if(y.shaderID?E.push(y.shaderID):(E.push(y.customVertexShaderID),E.push(y.customFragmentShaderID)),y.defines!==void 0)for(const q in y.defines)E.push(q),E.push(y.defines[q]);return y.isRawShaderMaterial===!1&&(M(E,y),w(E,y),E.push(n.outputColorSpace)),E.push(y.customProgramCacheKey),E.join()}function M(y,E){y.push(E.precision),y.push(E.outputColorSpace),y.push(E.envMapMode),y.push(E.envMapCubeUVHeight),y.push(E.mapUv),y.push(E.alphaMapUv),y.push(E.lightMapUv),y.push(E.aoMapUv),y.push(E.bumpMapUv),y.push(E.normalMapUv),y.push(E.displacementMapUv),y.push(E.emissiveMapUv),y.push(E.metalnessMapUv),y.push(E.roughnessMapUv),y.push(E.anisotropyMapUv),y.push(E.clearcoatMapUv),y.push(E.clearcoatNormalMapUv),y.push(E.clearcoatRoughnessMapUv),y.push(E.iridescenceMapUv),y.push(E.iridescenceThicknessMapUv),y.push(E.sheenColorMapUv),y.push(E.sheenRoughnessMapUv),y.push(E.specularMapUv),y.push(E.specularColorMapUv),y.push(E.specularIntensityMapUv),y.push(E.transmissionMapUv),y.push(E.thicknessMapUv),y.push(E.combine),y.push(E.fogExp2),y.push(E.sizeAttenuation),y.push(E.morphTargetsCount),y.push(E.morphAttributeCount),y.push(E.numDirLights),y.push(E.numPointLights),y.push(E.numSpotLights),y.push(E.numSpotLightMaps),y.push(E.numHemiLights),y.push(E.numRectAreaLights),y.push(E.numDirLightShadows),y.push(E.numPointLightShadows),y.push(E.numSpotLightShadows),y.push(E.numSpotLightShadowsWithMaps),y.push(E.numLightProbes),y.push(E.shadowMapType),y.push(E.toneMapping),y.push(E.numClippingPlanes),y.push(E.numClipIntersection),y.push(E.depthPacking)}function w(y,E){a.disableAll(),E.supportsVertexTextures&&a.enable(0),E.instancing&&a.enable(1),E.instancingColor&&a.enable(2),E.instancingMorph&&a.enable(3),E.matcap&&a.enable(4),E.envMap&&a.enable(5),E.normalMapObjectSpace&&a.enable(6),E.normalMapTangentSpace&&a.enable(7),E.clearcoat&&a.enable(8),E.iridescence&&a.enable(9),E.alphaTest&&a.enable(10),E.vertexColors&&a.enable(11),E.vertexAlphas&&a.enable(12),E.vertexUv1s&&a.enable(13),E.vertexUv2s&&a.enable(14),E.vertexUv3s&&a.enable(15),E.vertexTangents&&a.enable(16),E.anisotropy&&a.enable(17),E.alphaHash&&a.enable(18),E.batching&&a.enable(19),E.dispersion&&a.enable(20),E.batchingColor&&a.enable(21),y.push(a.mask),a.disableAll(),E.fog&&a.enable(0),E.useFog&&a.enable(1),E.flatShading&&a.enable(2),E.logarithmicDepthBuffer&&a.enable(3),E.reverseDepthBuffer&&a.enable(4),E.skinning&&a.enable(5),E.morphTargets&&a.enable(6),E.morphNormals&&a.enable(7),E.morphColors&&a.enable(8),E.premultipliedAlpha&&a.enable(9),E.shadowMapEnabled&&a.enable(10),E.doubleSided&&a.enable(11),E.flipSided&&a.enable(12),E.useDepthPacking&&a.enable(13),E.dithering&&a.enable(14),E.transmission&&a.enable(15),E.sheen&&a.enable(16),E.opaque&&a.enable(17),E.pointsUvs&&a.enable(18),E.decodeVideoTexture&&a.enable(19),E.alphaToCoverage&&a.enable(20),y.push(a.mask)}function F(y){const E=x[y.type];let q;if(E){const k=Vn[E];q=ov.clone(k.uniforms)}else q=y.uniforms;return q}function P(y,E){let q;for(let k=0,Z=h.length;k<Z;k++){const oe=h[k];if(oe.cacheKey===E){q=oe,++q.usedTimes;break}}return q===void 0&&(q=new xS(n,E,y,r),h.push(q)),q}function R(y){if(--y.usedTimes===0){const E=h.indexOf(y);h[E]=h[h.length-1],h.pop(),y.destroy()}}function O(y){l.remove(y)}function te(){l.dispose()}return{getParameters:m,getProgramCacheKey:b,getUniforms:F,acquireProgram:P,releaseProgram:R,releaseShaderCache:O,programs:h,dispose:te}}function ES(){let n=new WeakMap;function e(o){return n.has(o)}function t(o){let a=n.get(o);return a===void 0&&(a={},n.set(o,a)),a}function i(o){n.delete(o)}function s(o,a,l){n.get(o)[a]=l}function r(){n=new WeakMap}return{has:e,get:t,remove:i,update:s,dispose:r}}function bS(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function Gh(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function Hh(){const n=[];let e=0;const t=[],i=[],s=[];function r(){e=0,t.length=0,i.length=0,s.length=0}function o(u,f,p,_,x,d){let m=n[e];return m===void 0?(m={id:u.id,object:u,geometry:f,material:p,groupOrder:_,renderOrder:u.renderOrder,z:x,group:d},n[e]=m):(m.id=u.id,m.object=u,m.geometry=f,m.material=p,m.groupOrder=_,m.renderOrder=u.renderOrder,m.z=x,m.group=d),e++,m}function a(u,f,p,_,x,d){const m=o(u,f,p,_,x,d);p.transmission>0?i.push(m):p.transparent===!0?s.push(m):t.push(m)}function l(u,f,p,_,x,d){const m=o(u,f,p,_,x,d);p.transmission>0?i.unshift(m):p.transparent===!0?s.unshift(m):t.unshift(m)}function c(u,f){t.length>1&&t.sort(u||bS),i.length>1&&i.sort(f||Gh),s.length>1&&s.sort(f||Gh)}function h(){for(let u=e,f=n.length;u<f;u++){const p=n[u];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:i,transparent:s,init:r,push:a,unshift:l,finish:h,sort:c}}function TS(){let n=new WeakMap;function e(i,s){const r=n.get(i);let o;return r===void 0?(o=new Hh,n.set(i,[o])):s>=r.length?(o=new Hh,r.push(o)):o=r[s],o}function t(){n=new WeakMap}return{get:e,dispose:t}}function AS(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new W,color:new st};break;case"SpotLight":t={position:new W,direction:new W,color:new st,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new W,color:new st,distance:0,decay:0};break;case"HemisphereLight":t={direction:new W,skyColor:new st,groundColor:new st};break;case"RectAreaLight":t={color:new st,position:new W,halfWidth:new W,halfHeight:new W};break}return n[e.id]=t,t}}}function RS(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ue};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ue};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ue,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let CS=0;function PS(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function LS(n){const e=new AS,t=RS(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new W);const s=new W,r=new St,o=new St;function a(c){let h=0,u=0,f=0;for(let te=0;te<9;te++)i.probe[te].set(0,0,0);let p=0,_=0,x=0,d=0,m=0,b=0,M=0,w=0,F=0,P=0,R=0;c.sort(PS);for(let te=0,y=c.length;te<y;te++){const E=c[te],q=E.color,k=E.intensity,Z=E.distance,oe=E.shadow&&E.shadow.map?E.shadow.map.texture:null;if(E.isAmbientLight)h+=q.r*k,u+=q.g*k,f+=q.b*k;else if(E.isLightProbe){for(let G=0;G<9;G++)i.probe[G].addScaledVector(E.sh.coefficients[G],k);R++}else if(E.isDirectionalLight){const G=e.get(E);if(G.color.copy(E.color).multiplyScalar(E.intensity),E.castShadow){const J=E.shadow,X=t.get(E);X.shadowIntensity=J.intensity,X.shadowBias=J.bias,X.shadowNormalBias=J.normalBias,X.shadowRadius=J.radius,X.shadowMapSize=J.mapSize,i.directionalShadow[p]=X,i.directionalShadowMap[p]=oe,i.directionalShadowMatrix[p]=E.shadow.matrix,b++}i.directional[p]=G,p++}else if(E.isSpotLight){const G=e.get(E);G.position.setFromMatrixPosition(E.matrixWorld),G.color.copy(q).multiplyScalar(k),G.distance=Z,G.coneCos=Math.cos(E.angle),G.penumbraCos=Math.cos(E.angle*(1-E.penumbra)),G.decay=E.decay,i.spot[x]=G;const J=E.shadow;if(E.map&&(i.spotLightMap[F]=E.map,F++,J.updateMatrices(E),E.castShadow&&P++),i.spotLightMatrix[x]=J.matrix,E.castShadow){const X=t.get(E);X.shadowIntensity=J.intensity,X.shadowBias=J.bias,X.shadowNormalBias=J.normalBias,X.shadowRadius=J.radius,X.shadowMapSize=J.mapSize,i.spotShadow[x]=X,i.spotShadowMap[x]=oe,w++}x++}else if(E.isRectAreaLight){const G=e.get(E);G.color.copy(q).multiplyScalar(k),G.halfWidth.set(E.width*.5,0,0),G.halfHeight.set(0,E.height*.5,0),i.rectArea[d]=G,d++}else if(E.isPointLight){const G=e.get(E);if(G.color.copy(E.color).multiplyScalar(E.intensity),G.distance=E.distance,G.decay=E.decay,E.castShadow){const J=E.shadow,X=t.get(E);X.shadowIntensity=J.intensity,X.shadowBias=J.bias,X.shadowNormalBias=J.normalBias,X.shadowRadius=J.radius,X.shadowMapSize=J.mapSize,X.shadowCameraNear=J.camera.near,X.shadowCameraFar=J.camera.far,i.pointShadow[_]=X,i.pointShadowMap[_]=oe,i.pointShadowMatrix[_]=E.shadow.matrix,M++}i.point[_]=G,_++}else if(E.isHemisphereLight){const G=e.get(E);G.skyColor.copy(E.color).multiplyScalar(k),G.groundColor.copy(E.groundColor).multiplyScalar(k),i.hemi[m]=G,m++}}d>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=Ie.LTC_FLOAT_1,i.rectAreaLTC2=Ie.LTC_FLOAT_2):(i.rectAreaLTC1=Ie.LTC_HALF_1,i.rectAreaLTC2=Ie.LTC_HALF_2)),i.ambient[0]=h,i.ambient[1]=u,i.ambient[2]=f;const O=i.hash;(O.directionalLength!==p||O.pointLength!==_||O.spotLength!==x||O.rectAreaLength!==d||O.hemiLength!==m||O.numDirectionalShadows!==b||O.numPointShadows!==M||O.numSpotShadows!==w||O.numSpotMaps!==F||O.numLightProbes!==R)&&(i.directional.length=p,i.spot.length=x,i.rectArea.length=d,i.point.length=_,i.hemi.length=m,i.directionalShadow.length=b,i.directionalShadowMap.length=b,i.pointShadow.length=M,i.pointShadowMap.length=M,i.spotShadow.length=w,i.spotShadowMap.length=w,i.directionalShadowMatrix.length=b,i.pointShadowMatrix.length=M,i.spotLightMatrix.length=w+F-P,i.spotLightMap.length=F,i.numSpotLightShadowsWithMaps=P,i.numLightProbes=R,O.directionalLength=p,O.pointLength=_,O.spotLength=x,O.rectAreaLength=d,O.hemiLength=m,O.numDirectionalShadows=b,O.numPointShadows=M,O.numSpotShadows=w,O.numSpotMaps=F,O.numLightProbes=R,i.version=CS++)}function l(c,h){let u=0,f=0,p=0,_=0,x=0;const d=h.matrixWorldInverse;for(let m=0,b=c.length;m<b;m++){const M=c[m];if(M.isDirectionalLight){const w=i.directional[u];w.direction.setFromMatrixPosition(M.matrixWorld),s.setFromMatrixPosition(M.target.matrixWorld),w.direction.sub(s),w.direction.transformDirection(d),u++}else if(M.isSpotLight){const w=i.spot[p];w.position.setFromMatrixPosition(M.matrixWorld),w.position.applyMatrix4(d),w.direction.setFromMatrixPosition(M.matrixWorld),s.setFromMatrixPosition(M.target.matrixWorld),w.direction.sub(s),w.direction.transformDirection(d),p++}else if(M.isRectAreaLight){const w=i.rectArea[_];w.position.setFromMatrixPosition(M.matrixWorld),w.position.applyMatrix4(d),o.identity(),r.copy(M.matrixWorld),r.premultiply(d),o.extractRotation(r),w.halfWidth.set(M.width*.5,0,0),w.halfHeight.set(0,M.height*.5,0),w.halfWidth.applyMatrix4(o),w.halfHeight.applyMatrix4(o),_++}else if(M.isPointLight){const w=i.point[f];w.position.setFromMatrixPosition(M.matrixWorld),w.position.applyMatrix4(d),f++}else if(M.isHemisphereLight){const w=i.hemi[x];w.direction.setFromMatrixPosition(M.matrixWorld),w.direction.transformDirection(d),x++}}}return{setup:a,setupView:l,state:i}}function kh(n){const e=new LS(n),t=[],i=[];function s(h){c.camera=h,t.length=0,i.length=0}function r(h){t.push(h)}function o(h){i.push(h)}function a(){e.setup(t)}function l(h){e.setupView(t,h)}const c={lightsArray:t,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:a,setupLightsView:l,pushLight:r,pushShadow:o}}function IS(n){let e=new WeakMap;function t(s,r=0){const o=e.get(s);let a;return o===void 0?(a=new kh(n),e.set(s,[a])):r>=o.length?(a=new kh(n),o.push(a)):a=o[r],a}function i(){e=new WeakMap}return{get:t,dispose:i}}class DS extends Yr{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=f_,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class US extends Yr{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const NS=`void main() {
	gl_Position = vec4( position, 1.0 );
...
`)a=0,l-=r;else{const u=Gw(h,s,a,l,t);a+=u.offsetX,o.push(u.path)}}return o}function Gw(n,e,t,i,s){const r=s.glyphs[n]||s.glyphs["?"];if(!r){console.error('THREE.Font: character "'+n+'" does not exists in font family '+s.familyName+".");return}const o=new Ow;let a,l,c,h,u,f,p,_;if(r.o){const x=r._cachedOutline||(r._cachedOutline=r.o.split(" "));for(let d=0,m=x.length;d<m;)switch(x[d++]){case"m":a=x[d++]*e+t,l=x[d++]*e+i,o.moveTo(a,l);break;case"l":a=x[d++]*e+t,l=x[d++]*e+i,o.lineTo(a,l);break;case"q":c=x[d++]*e+t,h=x[d++]*e+i,u=x[d++]*e+t,f=x[d++]*e+i,o.quadraticCurveTo(u,f,c,h);break;case"b":c=x[d++]*e+t,h=x[d++]*e+i,u=x[d++]*e+t,f=x[d++]*e+i,p=x[d++]*e+t,_=x[d++]*e+i,o.bezierCurveTo(u,f,p,_,c,h);break}}return{offsetX:r.ha*e,path:o}}class Ut extends wn{constructor(e,t={}){const i=t.font;if(i===void 0)super();else{const s=i.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(s,t)}this.type="TextGeometry"}}const Hw=Bn({__name:"MetalBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=null,s=tt(!1),r=tt(!1),o=tt(!1);return jn(()=>{if(t.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:r.value&&(u.rotation.y-=.03),h.render(l,c)};const l=new Gi,c=new Dt(75,window.innerWidth/window.innerHeight,.1,1e3),h=new zi({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(h.domElement);const u=new $e,f=new Wi(16777215,2);l.add(f);const p=new Vi(16777215,4);p.position.set(5,5,5),l.add(p);const _=new ki(16777215,5,50);_.position.set(0,2,4),l.add(_);const x=new Hi,d=x.load("/3d-bear-arts/assets/lv2.jpg"),m=x.load("/3d-bear-arts/assets/lv2.jpg");d.wrapS=d.wrapT=Ft,m.wrapS=m.wrapT=Ft;const b=new De({color:8343336,metalness:0,roughness:.8,bumpMap:d,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:m,envMapIntensity:.7}),M=new De({color:5978654,metalness:0,roughness:.8,bumpMap:d,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:m,envMapIntensity:.7}),w=new De({color:13152668,metalness:.2,roughness:.05,bumpMap:d,bumpScale:.05,clearcoat:1,clearcoatRoughness:.05,map:m,transparent:!0,opacity:.4,transmission:.9,envMapIntensity:1,reflectivity:.9,ior:1.45,side:ot});new De({color:13421772,metalness:1,roughness:.5,clearcoat:.3,clearcoatRoughness:.3});const F=new Le(1,32,32,0,Math.PI),P=new D(F,w),R=new D(F,b);P.scale.set(.85,.85,.8),R.scale.set(.85,.85,.8),P.position.y=-.2,R.position.y=-.2,P.rotation.y=Math.PI/2,R.rotation.y=Math.PI*1.5;const O=new _t(1,32),te=new D(O,b);te.scale.set(.85,.85,.8),te.position.set(0,-.2,0),te.rotation.y=Math.PI/2;const y=new $e;y.add(P),y.add(R),y.add(te),u.add(y);const E=new Le(.6,32,32,0,Math.PI),q=new D(E,b);q.scale.set(1,.95,.95),q.position.set(0,1,0),q.rotation.y=Math.PI*1.5;const k=new D(E,w);k.scale.set(1,.95,.95),k.position.set(0,1,0),k.rotation.y=Math.PI/2;const Z=new _t(.6,32),oe=new D(Z,b);oe.position.set(0,1,0),oe.rotation.y=Math.PI/2,oe.scale.set(1,.95,.95);const G=new $e;G.add(q),G.add(k),G.add(oe),u.add(G);const J=new Le(.25,32,32),X=new D(J,b);X.position.set(-.45,1.35,-.1),u.add(X);const pe=new D(J,w);pe.position.set(.45,1.35,-.1),u.add(pe);const ve=new Le(.25,32,32,Math.PI/2,Math.PI),_e=new D(ve,M);_e.scale.set(1.1,.6,.8),_e.position.set(0,.84,.5),_e.rotation.y=Math.PI;const Te=new Le(.25,32,32,Math.PI/2,Math.PI),Oe=new D(Te,w);Oe.scale.set(1.1,.6,.8),Oe.position.set(0,.84,.5),Oe.rotation.y=0;const se=new _t(.25,32),he=new D(se,b);he.scale.set(.8,.6,.8),he.position.set(0,.84,.5),he.rotation.y=Math.PI/2;const Se=new $e;Se.add(_e),Se.add(Oe),Se.add(he),u.add(Se);const N=new gn;N.moveTo(0,0),N.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),N.bezierCurveTo(-.6,.3,0,.6,0,1),N.bezierCurveTo(0,.6,.6,.3,.6,0),N.bezierCurveTo(.6,-.3,0,-.3,0,0);const ce={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new De({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const ie=new wn(N,ce),ue=new D(ie,b);ue.scale.set(.1,.1,.1),ue.rotation.z=it.degToRad(210),ue.rotation.x=it.degToRad(5),ue.rotation.y=it.degToRad(-45),ue.position.set(-.4,.9,.45);const we=new D(ie,M);we.scale.set(.6,.5,.5),we.position.set(.35,0,0),we.rotation.y=Math.PI,we.rotation.x=Math.PI;const ee=new D(ie,M);ee.scale.set(.2,.2,.2),ee.position.set(.5,-.1,.2),ee.rotation.y=Math.PI,ee.rotation.x=Math.PI,u.add(ee);const g=new ps(1.3,1.2,.6),T=new D(g,b);T.scale.set(.45,.45,.45),T.position.set(.35,-.2,.1),T.rotation.y=Math.PI;const L=new Zc(.15,.025,10,100);new De({color:8343336,metalness:.3,roughness:.4,clearcoat:.5});const U=new D(L,b);U.position.set(.35,.1,.1),U.rotation.z=Math.PI/2,U.rotation.x=Math.PI/8,U.rotation.y=Math.PI/14;const I=new D(L,b);I.position.set(.35,.1,.13),I.rotation.z=Math.PI/2,I.rotation.x=Math.PI/-8,I.rotation.y=Math.PI/12;const Y=new $e;Y.add(T),Y.add(U),Y.add(I),u.add(Y);const j=new Le(.35,32,32),S=new D(j,b);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),u.add(S);const v=new D(j,w);v.scale.set(.75,1.25,.65),v.position.set(.7,-.15,.2),u.add(v);const C=new Sn(.2,.22,.6,32),V=new D(C,b);V.position.set(-.4,-1.05,0),u.add(V);const z=new D(C,w);z.position.set(.4,-1.05,0),u.add(z);const H=new Le(.3,32,32),de=new D(H,b);de.scale.set(1,.72,1.5),de.position.set(-.4,-1.45,.17),u.add(de);const le=new D(H,w);le.scale.set(1,.72,1.5),le.position.set(.4,-1.45,.17),u.add(le);const me=new Le(.44,32,32),Ee=new D(me,b);Ee.position.set(-.15,-.45,-.4),u.add(Ee);const fe=new D(me,w);fe.position.set(.15,-.45,-.4),u.add(fe);const xe=new Le(.18,32,32),Pe=new D(xe,b);Pe.position.set(0,-.35,-.8),u.add(Pe),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Q){const Me=new Ut("X",{font:Q,size:.2,depth:.05});new Fn({color:0});const ge=new D(Me,M);ge.position.set(-.3,.99,.53),ge.rotation.x=it.degToRad(-5),ge.rotation.y=it.degToRad(-15),u.add(ge);const Fe=new Ut("O",{font:Q,size:.2,depth:.05});new Fn({color:0});const ke=new D(Fe,M);ke.position.set(.14,.99,.53),ke.rotation.y=it.degToRad(12),ke.rotation.x=it.degToRad(-5),u.add(ke)}),Pe.renderOrder=1,u.scale.set(1.35,1.35,1.35),l.add(u),u.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),c.position.set(e.bodyPosition.x,1,e.cameraPosition),c.lookAt(e.bodyPosition.x,0,0),c.position.z=4;const be=()=>{u.rotation.y,u.rotation.x},Be=()=>{s.value=!0,r.value=!1,o.value=!1},Ce=()=>{s.value=!1,r.value=!0,o.value=!1},ze=()=>{s.value=!1,r.value=!1,be()},B=Q=>{const Me=window.innerWidth/2;Q>Me?Be():Ce(),be()},ye=Q=>{clearTimeout(i),ze(),o.value=!0;const Me={x:Q.clientX/window.innerWidth*2-1,y:-(Q.clientY/window.innerHeight)*2+1};if(o.value){const ge=Me.x*Math.PI*.2,Fe=Me.y*Math.PI*.2;u.rotation.y=ge,u.rotation.x=Fe}i=setTimeout(()=>{o.value=!1,B(Q.clientX)},500)};window.addEventListener("mousemove",ye);const ne=Q=>{if(o.value){const Me={x:Q.clientX/window.innerWidth*2-1,y:-(Q.clientY/window.innerHeight)*2+1},ge=Me.x*Math.PI*.2,Fe=Me.y*Math.PI*.2;u.rotation.y=ge,u.rotation.x=Fe}};window.addEventListener("mousemove",ne),a(),Nt(()=>e.bodyPosition,Q=>{u.position.set(Q.x,Q.y,Q.z)}),Nt(()=>e.cameraPosition,Q=>{c.position.set(e.bodyPosition.x,1,Q),c.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{c.aspect=window.innerWidth/window.innerHeight,c.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,l)=>(pi(),mi("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2))}}),kw=gi(Hw,[["__scopeId","data-v-f3beb116"]]),Vw=Bn({__name:"PopartBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=null,s=tt(!1),r=tt(!1),o=tt(!1);return jn(()=>{if(t.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:r.value&&(u.rotation.y-=.03),h.render(l,c)};const l=new Gi,c=new Dt(75,window.innerWidth/window.innerHeight,.1,1e3),h=new zi({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(h.domElement);const u=new $e,f=new Wi(16777215,2);l.add(f);const p=new Vi(16777215,4);p.position.set(5,5,5),l.add(p);const _=new ki(16777215,5,50);_.position.set(0,2,4),l.add(_);const x=new Hi,d=x.load("/3d-bear-arts/assets/pop6.jpg"),m=x.load("/3d-bear-arts/assets/pop7.jpg");d.wrapS=d.wrapT=Ft,m.wrapS=m.wrapT=Ft;const b=new De({color:16738740,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),M=new De({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ot}),w=new De({color:16766720,map:d,metalness:.3,roughness:.5}),F=new De({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ot}),P=new De({color:9055202,map:d,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new De({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ot});const R=new De({color:65535,map:d,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),O=new De({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ot}),te=new Le(1,32,32,0,Math.PI),y=new D(te,M),E=new D(te,b);y.scale.set(.85,.85,.8),E.scale.set(.85,.85,.8),y.position.y=-.2,E.position.y=-.2,y.rotation.y=Math.PI/2,E.rotation.y=Math.PI*1.5;const q=new _t(1,32),k=new D(q,b);k.scale.set(.85,.85,.8),k.position.set(0,-.2,0),k.rotation.y=Math.PI/2;const Z=new $e;Z.add(y),Z.add(E),Z.add(k),u.add(Z);const oe=new Le(.6,32,32,0,Math.PI),G=new D(oe,w);G.scale.set(1,.95,.95),G.position.set(0,1,0),G.rotation.y=Math.PI*1.5;const J=new D(oe,F);J.scale.set(1,.95,.95),J.position.set(0,1,0),J.rotation.y=Math.PI/2;const X=new _t(.6,32),pe=new D(X,w);pe.position.set(0,1,0),pe.rotation.y=Math.PI/2,pe.scale.set(1,.95,.95);const ve=new $e;ve.add(G),ve.add(J),ve.add(pe),u.add(ve);const _e=new Le(.25,32,32),Te=new D(_e,b);Te.position.set(-.45,1.35,-.1),u.add(Te);const Oe=new D(_e,M);Oe.position.set(.45,1.35,-.1),u.add(Oe);const se=new Le(.25,32,32,Math.PI/2,Math.PI),he=new D(se,w);he.scale.set(1.1,.6,.8),he.position.set(0,.84,.5),he.rotation.y=Math.PI;const Se=new Le(.25,32,32,Math.PI/2,Math.PI),N=new D(Se,F);N.scale.set(1.1,.6,.8),N.position.set(0,.84,.5),N.rotation.y=0;const ce=new _t(.25,32),ie=new D(ce,w);ie.scale.set(.8,.6,.8),ie.position.set(0,.84,.5),ie.rotation.y=Math.PI/2;const ue=new $e;ue.add(he),ue.add(N),ue.add(ie),u.add(ue);const we=new gn;we.moveTo(0,0),we.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),we.bezierCurveTo(-.6,.3,0,.6,0,1),we.bezierCurveTo(0,.6,.6,.3,.6,0),we.bezierCurveTo(.6,-.3,0,-.3,0,0);const ee={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},g=new wn(we,ee),T=new D(g,w);T.scale.set(.5,.5,.5),T.position.set(.35,0,0),T.rotation.y=Math.PI,T.rotation.x=Math.PI,u.add(T);const L=new D(g,R);L.scale.set(.2,.2,.25),L.position.set(.5,-.3,.4),L.rotation.y=Math.PI,L.rotation.x=Math.PI,u.add(L);const U=new D(g,b);U.scale.set(.25,.25,.27),U.position.set(.4,.3,-.2),U.rotation.y=Math.PI,U.rotation.x=Math.PI,u.add(U);const I=new Le(.35,32,32),Y=new D(I,R);Y.scale.set(.75,1.25,.65),Y.position.set(-.7,-.15,.2),u.add(Y);const j=new D(I,O);j.scale.set(.75,1.25,.65),j.position.set(.7,-.15,.2),u.add(j);const S=new Sn(.2,.22,.6,32),v=new D(S,w);v.position.set(-.4,-1.05,0),u.add(v);const C=new D(S,F);C.position.set(.4,-1.05,0),u.add(C);const V=new Le(.3,32,32),z=new D(V,w);z.scale.set(1,.72,1.5),z.position.set(-.4,-1.45,.17),u.add(z);const H=new D(V,F);H.scale.set(1,.72,1.5),H.position.set(.4,-1.45,.17),u.add(H);const de=new Le(.44,32,32),le=new D(de,b);le.position.set(-.15,-.45,-.4),u.add(le);const me=new D(de,M);me.position.set(.15,-.45,-.4),u.add(me);const Ee=new Le(.18,32,32),fe=new D(Ee,b);fe.position.set(0,-.35,-.8),u.add(fe),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ye){const ne=new Ut("X",{font:ye,size:.2,depth:.05});new Fn({color:0});const Q=new D(ne,b);Q.position.set(-.3,.99,.53),Q.rotation.x=it.degToRad(-5),Q.rotation.y=it.degToRad(-15),u.add(Q);const Me=new Ut("O",{font:ye,size:.2,depth:.05});new Fn({color:0});const ge=new D(Me,R);ge.position.set(.14,.99,.53),ge.rotation.y=it.degToRad(12),ge.rotation.x=it.degToRad(-5),u.add(ge);const Fe=new Ut("POP",{font:ye,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),ke=new De({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new De({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const qe=new De({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),Ve=new De({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),nt=new D(Fe,ke);nt.scale.set(.15,.15,.15),nt.position.set(.03,1.16,.1),nt.rotateZ(-25),u.add(nt);const rt=new D(Fe,P);rt.scale.set(.14,.14,.14),rt.rotateZ(45),rt.position.set(.2,-.7,.3),u.add(rt);const wt=new D(Fe,qe);wt.scale.set(.14,.14,.14),wt.rotateZ(45),wt.rotateY(45),wt.position.set(.3,.7,.3),u.add(wt);const Et=new D(Fe,qe);Et.scale.set(.15,.15,.15),Et.rotateZ(45),Et.rotateY(45),Et.position.set(.35,-1.5,.3),u.add(Et);const Mt=new D(Fe,Ve);Mt.scale.set(.17,.17,.17),Mt.rotateZ(45),Mt.rotateY(15),Mt.position.set(.35,1,.3),u.add(Mt)}),fe.renderOrder=1,u.scale.set(1.35,1.35,1.35),l.add(u),u.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),c.position.set(e.bodyPosition.x,1,e.cameraPosition),c.lookAt(e.bodyPosition.x,0,0),c.position.z=4;const Pe=()=>{u.rotation.y,u.rotation.x},Re=()=>{s.value=!0,r.value=!1,o.value=!1},be=()=>{s.value=!1,r.value=!0,o.value=!1},Be=()=>{s.value=!1,r.value=!1,Pe()},Ce=ye=>{const ne=window.innerWidth/2;ye>ne?Re():be(),Pe()},ze=ye=>{clearTimeout(i),Be(),o.value=!0;const ne={x:ye.clientX/window.innerWidth*2-1,y:-(ye.clientY/window.innerHeight)*2+1};if(o.value){const Q=ne.x*Math.PI*.2,Me=ne.y*Math.PI*.2;u.rotation.y=Q,u.rotation.x=Me}i=setTimeout(()=>{o.value=!1,Ce(ye.clientX)},500)};window.addEventListener("mousemove",ze);const B=ye=>{if(o.value){const ne={x:ye.clientX/window.innerWidth*2-1,y:-(ye.clientY/window.innerHeight)*2+1},Q=ne.x*Math.PI*.2,Me=ne.y*Math.PI*.2;u.rotation.y=Q,u.rotation.x=Me}};window.addEventListener("mousemove",B),a(),Nt(()=>e.bodyPosition,ye=>{u.position.set(ye.x,ye.y,ye.z)}),Nt(()=>e.cameraPosition,ye=>{c.position.set(e.bodyPosition.x,1,ye),c.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{c.aspect=window.innerWidth/window.innerHeight,c.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,l)=>(pi(),mi("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2))}}),Ww=gi(Vw,[["__scopeId","data-v-8cfea564"]]),Xw={class:"pixel-controls"},qw={class:"side-buttons"},Yw=Bn({__name:"PopArtBear3",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03);const Q=ye.getElapsedTime();B.forEach((Me,ge)=>{const Fe=.2+Math.sin(Q*3+ne[ge])*.1;Me.scale.set(Fe,Fe,Fe)}),x.render(p,_)};const p=new Gi,_=new Dt(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zi({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(x.domElement);const d=new $e,m=new $e;p.add(m);const b=new Wi(16777215,2);p.add(b);const M=new Vi(16777215,4);M.position.set(5,5,5),p.add(M);const w=new ki(16777215,5,50);w.position.set(0,2,4),p.add(w);const F=new Hi,P=F.load("/3d-bear-arts/assets/pop6.jpg"),R=F.load("/3d-bear-arts/assets/pop7.jpg");P.wrapS=P.wrapT=Ft,R.wrapS=R.wrapT=Ft,R.repeat.set(2,2);const O=new De({color:16738740,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),te=new De({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ot}),y=new De({color:16766720,map:P,metalness:.3,roughness:.5}),E=new De({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ot}),q=new De({color:9055202,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),k=new De({color:65535,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Z=new De({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ot}),oe=new Le(1,32,32,0,Math.PI),G=new D(oe,te),J=new D(oe,O);G.scale.set(.85,.85,.8),J.scale.set(.85,.85,.8),G.position.y=-.2,J.position.y=-.2,G.rotation.y=Math.PI/2,J.rotation.y=Math.PI*1.5;const X=new _t(1,32),pe=new D(X,O);pe.scale.set(.85,.85,.8),pe.position.set(0,-.2,0),pe.rotation.y=Math.PI/2;const ve=new $e;ve.add(G),ve.add(J),ve.add(pe),d.add(ve);const _e=new Le(.6,32,32,0,Math.PI),Te=new D(_e,y);Te.scale.set(1,.95,.95),Te.position.set(0,1,0),Te.rotation.y=Math.PI*1.5;const Oe=new D(_e,E);Oe.scale.set(1,.95,.95),Oe.position.set(0,1,0),Oe.rotation.y=Math.PI/2;const se=new _t(.6,32),he=new D(se,y);he.position.set(0,1,0),he.rotation.y=Math.PI/2,he.scale.set(1,.95,.95);const Se=new $e;Se.add(Te),Se.add(Oe),Se.add(he),d.add(Se);const N=new Le(.25,32,32),ce=new D(N,O);ce.position.set(-.45,1.35,-.1),d.add(ce);const ie=new D(N,te);ie.position.set(.45,1.35,-.1),d.add(ie);const ue=new Le(.25,32,32,Math.PI/2,Math.PI),we=new D(ue,y);we.scale.set(1.1,.6,.8),we.position.set(0,.84,.5),we.rotation.y=Math.PI;const ee=new Le(.25,32,32,Math.PI/2,Math.PI),g=new D(ee,E);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=0;const T=new _t(.25,32),L=new D(T,y);L.scale.set(.8,.6,.8),L.position.set(0,.84,.5),L.rotation.y=Math.PI/2;const U=new $e;U.add(we),U.add(g),U.add(L),d.add(U);const I=new gn;I.moveTo(0,0),I.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),I.bezierCurveTo(-.6,.3,0,.6,0,1),I.bezierCurveTo(0,.6,.6,.3,.6,0),I.bezierCurveTo(.6,-.3,0,-.3,0,0);const Y={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},j=new wn(I,Y),S=new D(j,y);S.scale.set(.5,.5,.5),S.position.set(.3,0,0),S.rotation.y=Math.PI,S.rotation.x=Math.PI,d.add(S);const v=new D(j,k);v.scale.set(.2,.2,.25),v.position.set(.35,-.3,.4),v.rotation.y=Math.PI,v.rotation.x=Math.PI,d.add(v);const C=new D(j,O);C.scale.set(.25,.25,.27),C.position.set(.38,.3,-.2),C.rotation.y=Math.PI,C.rotation.x=Math.PI,d.add(C);const V=new Le(.35,32,32),z=new D(V,k);z.scale.set(.75,1.25,.65),z.position.set(-.7,-.15,.2),d.add(z);const H=new D(V,Z);H.scale.set(.75,1.25,.65),H.position.set(.7,-.15,.2),d.add(H);const de=new Sn(.2,.22,.6,32),le=new D(de,y);le.position.set(-.4,-1.05,0),d.add(le);const me=new D(de,E);me.position.set(.4,-1.05,0),d.add(me);const Ee=new Le(.3,32,32),fe=new D(Ee,y);fe.scale.set(1,.72,1.5),fe.position.set(-.4,-1.45,.17),d.add(fe);const xe=new D(Ee,E);xe.scale.set(1,.72,1.5),xe.position.set(.4,-1.45,.17),d.add(xe);const Pe=new Le(.44,32,32),Re=new D(Pe,O);Re.position.set(-.15,-.45,-.4),d.add(Re);const be=new D(Pe,te);be.position.set(.15,-.45,-.4),d.add(be);const Be=new Le(.18,32,32),Ce=new D(Be,O);Ce.position.set(0,-.35,-.8),d.add(Ce),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Q){const Me=new Ut("X",{font:Q,size:.2,depth:.05}),ge=new D(Me,O);ge.position.set(-.3,.99,.53),ge.rotation.x=it.degToRad(-5),ge.rotation.y=it.degToRad(-15),d.add(ge);const Fe=new Ut("O",{font:Q,size:.2,depth:.05}),ke=new D(Fe,k);ke.position.set(.14,.99,.53),ke.rotation.y=it.degToRad(12),ke.rotation.x=it.degToRad(-5),d.add(ke);const qe=new Ut("POP",{font:Q,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});new Ut("🐻",{font:Q,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});const Ve=new Ut("BAO      BEAR",{font:Q,size:2,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:3}),nt=new De({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new De({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const rt=new De({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),wt=new De({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),Et=new D(qe,nt);Et.scale.set(.15,.15,.15),Et.position.set(.02,1.16,.1),Et.rotateZ(-25),d.add(Et);const Mt=new D(qe,q);Mt.scale.set(.14,.14,.14),Mt.rotateZ(45),Mt.position.set(.2,-.7,.3),d.add(Mt);const Lt=new D(qe,rt);Lt.scale.set(.14,.14,.14),Lt.rotateZ(45),Lt.rotateY(45),Lt.position.set(.3,.7,.3),d.add(Lt);const vt=new D(qe,rt);vt.scale.set(.15,.15,.15),vt.rotateZ(45),vt.rotateY(45),vt.position.set(.35,-1.5,.3),d.add(vt);const Vt=new D(qe,wt);Vt.scale.set(.17,.17,.17),Vt.rotateZ(45),Vt.rotateY(15),Vt.position.set(.35,1,.3),d.add(Vt);const bt=new D(Ve,nt);bt.scale.set(.7,.7,.7),bt.position.set(-6,0,-3),m.add(bt)}),Ce.renderOrder=1,d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,d.rotation.x=.1;const B=[S,v,C],ye=new Qd,ne=[0,Math.PI/2,Math.PI,0,Math.PI/3];f(),Nt(()=>e.bodyPosition,Q=>{d.position.set(Q.x,Q.y,Q.z)}),Nt(()=>e.cameraPosition,Q=>{_.position.set(e.bodyPosition.x,1,Q),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[Ke("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),Ke("div",Xw,[Ke("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),Ke("div",qw,[Ke("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Ke("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),Ke("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),$w=gi(Yw,[["__scopeId","data-v-cb52c927"]]),jw={class:"pixel-controls"},Kw={class:"side-buttons"},Zw=Bn({__name:"MetalMachineBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(rt,wt){const Et=new Sn(ze,ze,B,32);Et.rotateX(Math.PI/2);const Mt=new D(Et,rt),Lt=new $e;for(let Vt=0;Vt<ye;Vt++){const bt=Vt/ye*Math.PI*2,_n=new ps(ne,Q,Me),qt=new D(_n,rt);qt.position.set((ze+Me/26)*Math.cos(bt),(ze+Me/26)*Math.sin(bt),0),qt.rotation.z=bt,Lt.add(qt)}const vt=new $e;return vt.add(Mt),vt.add(Lt),vt.position.set(wt.x,wt.y,wt.z),vt},p=function(){requestAnimationFrame(p),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),r.value&&(m.rotation.x-=.03),o.value&&(m.rotation.x+=.03),ge.rotation.z-=.02,Fe.rotation.z+=.03,ke.rotation.z+=.02,qe.rotation.z+=.02,Ve.rotation.z-=.03,nt.rotation.y+=.04,d.render(_,x)};const _=new Gi,x=new Dt(75,window.innerWidth/window.innerHeight,.1,1e3),d=new zi({antialias:!0,alpha:!0});d.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(d.domElement);const m=new $e,b=new $e;_.add(b);const M=new Wi(16777215,2);_.add(M);const w=new Vi(16777215,4);w.position.set(5,5,5),_.add(w);const F=new ki(16777215,5,50);F.position.set(0,2,4),_.add(F);const P=new Hi,R=P.load("/3d-bear-arts/assets/metal.jpg"),O=P.load("/3d-bear-arts/assets/pop7.jpg"),te=P.load("/3d-bear-arts/assets/gear.jpg");R.wrapS=R.wrapT=Ft,O.wrapS=O.wrapT=Ft,O.repeat.set(2,2);const y=new De({color:13882323,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:R});te.mapping=Nr;const E=new De({color:"#d3d3d3",metalness:1,roughness:.25,map:R,envMap:te,clearcoat:.7,clearcoatRoughness:.3}),q=new De({color:"#C0C0C0",metalness:1,roughness:.25,envMap:te,clearcoat:.7,clearcoatRoughness:.3}),k=new De({color:"#C0C0C0",metalness:1,roughness:.25,map:R,envMap:te,transparent:!0,opacity:.8,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),Z=new De({color:"#C0C0C0",metalness:1,roughness:.5,map:R,envMap:te,transparent:!0,opacity:.23,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),oe=new De({color:13882323,metalness:1,roughness:.25,clearcoat:1,clearcoatRoughness:.05,reflectivity:.9,envMapIntensity:1,side:ot});new De({color:"#C0C0C0",metalness:1,roughness:.2,transparent:!0,opacity:.4,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45});const G=new De({color:"#d3d3d3",metalness:1,roughness:.2,map:te,envMap:te,clearcoat:.7,clearcoatRoughness:.3});new De({color:12632256,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:te}),new De({color:12632256,metalness:1,roughness:.3,clearcoat:.5,clearcoatRoughness:.1,map:R,transparent:!0,opacity:.3});const J=new Le(1,32,32,0,Math.PI),X=new D(J,Z),pe=new D(J,E);X.scale.set(.85,.85,.8),pe.scale.set(.85,.85,.8),X.position.y=-.2,pe.position.y=-.2,X.rotation.y=Math.PI/2,pe.rotation.y=Math.PI*1.5;const ve=new _t(1,32),_e=new D(ve,k);_e.scale.set(.85,.85,.8),_e.position.set(0,-.2,0),_e.rotation.y=Math.PI/2;const Te=new $e;Te.add(X),Te.add(pe),Te.add(_e),m.add(Te);const Oe=new Le(.6,32,32,0,Math.PI),se=new D(Oe,E);se.scale.set(1,.95,.95),se.position.set(0,1,0),se.rotation.y=Math.PI*1.5;const he=new D(Oe,Z);he.scale.set(1,.95,.95),he.position.set(0,1,0),he.rotation.y=Math.PI/2;const Se=new _t(.6,32),N=new D(Se,k);N.position.set(0,1,0),N.rotation.y=Math.PI/2,N.scale.set(1,.95,.95);const ce=new $e;ce.add(se),ce.add(he),ce.add(N),m.add(ce);const ie=new Le(.25,32,32),ue=new D(ie,E);ue.position.set(-.45,1.35,-.1),m.add(ue);const we=new D(ie,k);we.position.set(.45,1.35,-.1),m.add(we);const ee=new Le(.25,32,32,Math.PI/2,Math.PI),g=new D(ee,E);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=Math.PI;const T=new Le(.25,32,32,Math.PI/2,Math.PI),L=new D(T,k);L.scale.set(1.1,.6,.8),L.position.set(0,.84,.5),L.rotation.y=0;const U=new _t(.25,32),I=new D(U,oe);I.scale.set(.8,.6,.8),I.position.set(0,.84,.5),I.rotation.y=Math.PI/2;const Y=new $e;Y.add(g),Y.add(L),Y.add(I),m.add(Y);const j=new gn;j.moveTo(0,0),j.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),j.bezierCurveTo(-.6,.3,0,.6,0,1),j.bezierCurveTo(0,.6,.6,.3,.6,0),j.bezierCurveTo(.6,-.3,0,-.3,0,0);const S={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},v=new wn(j,S),C=new Le(.35,32,32),V=new D(C,E);V.scale.set(.75,1.25,.65),V.position.set(-.7,-.15,.2),m.add(V);const z=new D(C,k);z.scale.set(.75,1.25,.65),z.position.set(.7,-.15,.2),m.add(z);const H=new Sn(.2,.22,.6,32),de=new D(H,E);de.position.set(-.4,-1.05,0),m.add(de);const le=new D(H,k);le.position.set(.4,-1.05,0),m.add(le);const me=new Le(.3,32,32),Ee=new D(me,E);Ee.scale.set(1,.72,1.5),Ee.position.set(-.4,-1.45,.17),m.add(Ee);const fe=new D(me,k);fe.scale.set(1,.72,1.5),fe.position.set(.4,-1.45,.17),m.add(fe);const xe=new Le(.44,32,32),Pe=new D(xe,E);Pe.position.set(-.15,-.45,-.4),m.add(Pe);const Re=new D(xe,Z);Re.position.set(.15,-.45,-.4),m.add(Re);const be=new Le(.18,32,32),Be=new D(be,E);Be.position.set(0,-.35,-.8),m.add(Be),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(rt){const wt=new Ut("X",{font:rt,size:.2,depth:.05});new Fn({color:0});const Et=new D(wt,y);Et.position.set(-.3,.99,.53),Et.rotation.x=it.degToRad(-5),Et.rotation.y=it.degToRad(-15),m.add(Et);const Mt=new Ut("O",{font:rt,size:.2,depth:.05});new Fn({color:0});const Lt=new D(Mt,y);Lt.position.set(.14,.99,.53),Lt.rotation.y=it.degToRad(12),Lt.rotation.x=it.degToRad(-5),m.add(Lt)}),Be.renderOrder=1;const ze=1.2,B=.5,ye=8,ne=.7,Q=.3,Me=.5,ge=f(G,{x:-2,y:0,z:0}),Fe=f(G,{x:0,y:0,z:0}),ke=f(G,{x:2,y:0,z:0}),qe=f(G,{x:2,y:0,z:0}),Ve=f(G,{x:2,y:-2,z:0}),nt=new D(v,q);nt.scale.set(.3,.3,.3),nt.position.set(.25,1.1,0),nt.rotation.y=Math.PI,nt.rotation.x=Math.PI,m.add(nt),ge.position.set(.35,0,0),Fe.position.set(.25,-.3,.4),ke.position.set(.3,.3,-.2),qe.position.set(.25,.17,.4),Ve.position.set(.5,-.3,.45),ge.scale.set(.2,.2,.2),Fe.scale.set(.18,.18,.18),ke.scale.set(.15,.15,.15),qe.scale.set(.17,.17,.17),Ve.scale.set(.15,.15,.15),Fe.rotation.z=Math.PI/4,ke.rotation.z=-Math.PI/4,qe.rotation.y=-Math.PI/2,Ve.rotation.y=-Math.PI/2,m.add(ge),m.add(Fe),m.add(ke),m.add(qe),m.add(Ve),m.rotation.x=.1,m.scale.set(1.4,1.4,1.4),_.add(m),m.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),x.position.set(e.bodyPosition.x,1,e.cameraPosition),x.lookAt(e.bodyPosition.x,0,0),x.position.z=4,p(),Nt(()=>e.bodyPosition,rt=>{m.position.set(rt.x,rt.y,rt.z)}),Nt(()=>e.cameraPosition,rt=>{x.position.set(e.bodyPosition.x,1,rt),x.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{x.aspect=window.innerWidth/window.innerHeight,x.updateProjectionMatrix(),d.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[Ke("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),Ke("div",jw,[Ke("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),Ke("div",Kw,[Ke("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Ke("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),Ke("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),Jw=gi(Zw,[["__scopeId","data-v-9a57b6d8"]]),Qw={class:"pixel-controls"},eE={class:"side-buttons"},tE=Bn({__name:"WaterBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),x.render(p,_)};const p=new Gi,_=new Dt(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zi({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(x.domElement);const d=new $e,m=new $e;p.add(m);const b=new Wi(16777215,2);p.add(b);const M=new Vi(16777215,4);M.position.set(5,5,5),p.add(M);const w=new ki(16777215,5,50);w.position.set(0,2,4),p.add(w);const F=new Hi,P=F.load("/3d-bear-arts/assets/sun.jpg"),R=F.load("/3d-bear-arts/assets/gear.jpg"),O=F.load("/3d-bear-arts/assets/underwater.jpg"),te=F.load("/3d-bear-arts/assets/beach.jpg");O.wrapS=O.wrapT=Ft,te.wrapS=te.wrapT=Ft,te.repeat.set(.8,1),R.mapping=Nr,P.wrapS=P.wrapT=Ft;const y=new De({color:11592447,metalness:.05,roughness:.4,clearcoat:.9,clearcoatRoughness:.2,reflectivity:.6,map:te,envMapIntensity:.8,side:ot,transparent:!0,opacity:.9}),E=new De({color:11592447,metalness:.05,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,reflectivity:.4,map:te,envMapIntensity:.6,side:ot,transparent:!0,opacity:.9,transmission:.5,ior:1.33,depthWrite:!1,depthTest:!0});new De({color:11592447,metalness:.05,roughness:.4,clearcoat:.9,clearcoatRoughness:.2,reflectivity:.6,envMapIntensity:.8,map:te,side:ot,transparent:!0,opacity:.9});const q=new De({color:8374441,metalness:1,roughness:.25,envMap:R,clearcoat:.7,clearcoatRoughness:.3}),k=new De({color:11592447,metalness:.1,roughness:.3,transparent:!0,opacity:.5,clearcoat:.6,clearcoatRoughness:.25,transmission:.6,ior:1.4,depthWrite:!1,depthTest:!0,side:ot}),Z=new De({color:11592447,metalness:.1,roughness:.3,transparent:!0,opacity:.5,map:te,clearcoat:.1,clearcoatRoughness:.25,transmission:.6,ior:1.4}),oe=new De({color:"#a4d0f5",metalness:0,roughness:.8,map:P,clearcoat:.1,clearcoatRoughness:.7,transmission:.9,opacity:.8,transparent:!0}),G=new De({color:"#a4d0f5",metalness:0,roughness:.85,map:te,clearcoat:.1,clearcoatRoughness:.7,transmission:.9,opacity:.6,transparent:!0}),J=new Le(1,32,32,0,Math.PI),X=new D(J,k),pe=new D(J,E);X.scale.set(.85,.85,.8),pe.scale.set(.85,.85,.8),X.position.y=-.2,pe.position.y=-.2,X.rotation.y=Math.PI/2,pe.rotation.y=Math.PI*1.5;const ve=new _t(1,32),_e=new D(ve,G);_e.scale.set(.85,.85,.8),_e.position.set(0,-.2,0),_e.rotation.y=Math.PI/2;const Te=new $e;Te.add(X),Te.add(pe),Te.add(_e);const Oe=new Le(.6,32,32,0,Math.PI*2,0,Math.PI/2),se=new De({color:6935271,metalness:.1,roughness:.2,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.9,transmission:.9,ior:1.33,reflectivity:.8,envMapIntensity:1}),he=new D(Oe,se);he.position.set(0,-.2,0),he.rotation.x=Math.PI,he.scale.set(1.25,1.25,1.25),Te.add(he);const Se=new De({color:49151,metalness:.1,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,side:ot,transparent:!0,opacity:.7,depthWrite:!1}),N=new D(ve,Se);N.scale.set(.7,.7,.7),N.position.set(0,-.3,0),N.rotation.x=Math.PI/2,N.renderOrder=1,Te.add(N),d.add(Te);const ce=new Le(.6,32,32,0,Math.PI),ie=new D(ce,y);ie.scale.set(1,.95,.95),ie.position.set(0,1,0),ie.rotation.y=Math.PI*1.5;const ue=new D(ce,Z);ue.scale.set(1,.95,.95),ue.position.set(0,1,0),ue.rotation.y=Math.PI/2;const we=new _t(.6,32),ee=new D(we,oe);ee.position.set(0,1,0),ee.rotation.y=Math.PI/2,ee.scale.set(1,.95,.95);const g=new $e;g.add(ie),g.add(ue),g.add(ee),d.add(g);const T=new Le(.25,32,32),L=new D(T,y);L.position.set(-.45,1.35,-.1),d.add(L);const U=new D(T,Z);U.position.set(.45,1.35,-.1),d.add(U);const I=new Le(.25,32,32,Math.PI/2,Math.PI),Y=new D(I,y);Y.scale.set(1.1,.6,.8),Y.position.set(0,.84,.5),Y.rotation.y=Math.PI;const j=new Le(.25,32,32,Math.PI/2,Math.PI),S=new D(j,Z);S.scale.set(1.1,.6,.8),S.position.set(0,.84,.5),S.rotation.y=0;const v=new _t(.25,32),C=new D(v,oe);C.scale.set(.8,.6,.8),C.position.set(0,.84,.5),C.rotation.y=Math.PI/2;const V=new $e;V.add(Y),V.add(S),V.add(C),d.add(V);const z=new gn;z.moveTo(0,0),z.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),z.bezierCurveTo(-.6,.3,0,.6,0,1),z.bezierCurveTo(0,.6,.6,.3,.6,0),z.bezierCurveTo(.6,-.3,0,-.3,0,0);const H={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},de=new wn(z,H),le=new Le(.35,32,32),me=new D(le,y);me.scale.set(.75,1.25,.65),me.position.set(-.7,-.15,.2),d.add(me);const Ee=new D(le,Z);Ee.scale.set(.75,1.25,.65),Ee.position.set(.7,-.15,.2),d.add(Ee);const fe=new Sn(.2,.22,.6,32),xe=new D(fe,y);xe.position.set(-.4,-1.05,0),d.add(xe);const Pe=new D(fe,Z);Pe.position.set(.4,-1.05,0),d.add(Pe);const Re=new Le(.3,32,32),be=new D(Re,y);be.scale.set(1,.72,1.5),be.position.set(-.4,-1.45,.17),d.add(be);const Be=new D(Re,Z);Be.scale.set(1,.72,1.5),Be.position.set(.4,-1.45,.17),d.add(Be);const Ce=new Le(.44,32,32),ze=new D(Ce,y);ze.position.set(-.15,-.45,-.4),d.add(ze);const B=new D(Ce,Z);B.position.set(.15,-.45,-.4),d.add(B);const ye=new Le(.18,32,32),ne=new D(ye,E);ne.position.set(0,-.35,-.8),d.add(ne),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ge){const Fe=new Ut("X",{font:ge,size:.2,depth:.05});new Fn({color:0});const ke=new D(Fe,y);ke.position.set(-.3,.99,.53),ke.rotation.x=it.degToRad(-5),ke.rotation.y=it.degToRad(-15),d.add(ke);const qe=new Ut("O",{font:ge,size:.2,depth:.05});new Fn({color:0});const Ve=new D(qe,E);Ve.position.set(.14,.99,.53),Ve.rotation.y=it.degToRad(12),Ve.rotation.x=it.degToRad(-5),d.add(Ve)}),ne.renderOrder=1,d.rotation.x=.1;const Me=new D(de,q);Me.scale.set(.3,.3,.3),Me.position.set(.25,1.1,0),Me.rotation.y=Math.PI,Me.rotation.x=Math.PI,d.add(Me),d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,f(),Nt(()=>e.bodyPosition,ge=>{d.position.set(ge.x,ge.y,ge.z)}),Nt(()=>e.cameraPosition,ge=>{_.position.set(e.bodyPosition.x,1,ge),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[Ke("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),Ke("div",Qw,[Ke("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),Ke("div",eE,[Ke("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Ke("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),Ke("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),nE=gi(tE,[["__scopeId","data-v-08c607ba"]]),iE={class:"pixel-controls"},sE={class:"side-buttons"},rE=Bn({__name:"Water",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),we.uniforms.u_time.value+=.25,le.rotation.y+=.04,x.render(p,_)};const p=new Gi,_=new Dt(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zi({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(x.domElement);const d=new $e,m=new $e;p.add(m);const b=new Wi(16777215,2);p.add(b);const M=new Vi(16777215,4);M.position.set(5,5,5),p.add(M);const w=new ki(16777215,5,50);w.position.set(0,2,4),p.add(w);const F=new Hi,P=F.load("/3d-bear-arts/assets/beach.jpg");P.repeat.set(.8,1);const R=F.load("/3d-bear-arts/assets/sun.jpg");P.wrapS=P.wrapT=Ft,P.repeat.set(.8,1),R.wrapS=R.wrapT=Ft;const O=new De({color:11592447,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new De({color:11592447,map:P,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ot,depthWrite:!1,depthTest:!0});const te=new De({color:11592447,map:P,metalness:.3,roughness:.5,transparent:!0,opacity:.6,side:ot,ior:1.33,depthWrite:!1,depthTest:!0}),y=new De({color:11592447,map:P,metalness:.1,roughness:.6,transparent:!0,opacity:.85,clearcoat:.9,clearcoatRoughness:.4,transmission:.7,ior:1.2,depthTest:!0,envMapIntensity:.8}),E=new De({color:11592447,map:P,metalness:.1,roughness:.6,transparent:!0,opacity:.85,clearcoat:.9,clearcoatRoughness:.4,transmission:.7,ior:1.2,depthWrite:!1,depthTest:!0,envMapIntensity:.6,side:ot}),q=new De({color:11592447,map:P,metalness:.3,roughness:.5,transparent:!0,opacity:.8,side:ot,ior:1.33});new De({color:11592447,map:P,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.7,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1});const k=new De({color:11592447,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Z=new Le(1,32,32,0,Math.PI),oe=new D(Z,E),G=new D(Z,te);oe.scale.set(.85,.85,.8),G.scale.set(.85,.85,.8),oe.position.y=-.2,G.position.y=-.2,oe.rotation.y=Math.PI/2,G.rotation.y=Math.PI*1.5;const J=new _t(1,32),X=new D(J,O);X.scale.set(.85,.85,.8),X.position.set(0,-.2,0),X.rotation.y=Math.PI/2;const pe=new $e;pe.add(oe),pe.add(G),pe.add(X),d.add(pe);const ve=new Le(.6,32,32,0,Math.PI),_e=new D(ve,O);_e.scale.set(1,.95,.95),_e.position.set(0,1,0),_e.rotation.y=Math.PI*1.5;const Te=new D(ve,y);Te.scale.set(1,.95,.95),Te.position.set(0,1,0),Te.rotation.y=Math.PI/2;const Oe=new _t(.6,32),se=new D(Oe,O);se.position.set(0,1,0),se.rotation.y=Math.PI/2,se.scale.set(1,.95,.95);const he=new $e;he.add(_e),he.add(Te),he.add(se),d.add(he);const Se=new Le(.6,32,32,0,Math.PI*2,0,Math.PI/2),N=new De({color:11592447,metalness:.1,roughness:.2,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.9,transmission:.9,ior:1.33,reflectivity:.8,envMapIntensity:1}),ce=new D(Se,N);ce.position.set(0,-.2,0),ce.rotation.x=Math.PI,ce.scale.set(1.25,1.25,1.25),pe.add(ce);const ie=new De({color:49151,metalness:.1,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,side:ot,transparent:!0,opacity:.7,depthWrite:!1}),ue=new D(J,ie);ue.scale.set(.7,.7,.7),ue.position.set(0,-.3,0),ue.rotation.x=Math.PI/2,ue.renderOrder=1,pe.add(ue),d.add(pe);const we=new $n({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:8},u_waveAmplitude:{value:.05},u_waveSpeed:{value:1.2}},vertexShader:`
            ...
            `}),ee=new D(J,we);ee.position.set(0,-.3,0),ee.scale.set(.7,.7,.7),ee.rotation.x=-Math.PI/2,ee.renderOrder=1,pe.add(ee);const g=new Le(.25,32,32),T=new D(g,q);T.position.set(-.45,1.35,-.1),d.add(T);const L=new D(g,y);L.position.set(.45,1.35,-.1),d.add(L);const U=new Le(.25,32,32,Math.PI/2,Math.PI),I=new D(U,q);I.scale.set(1.1,.6,.8),I.position.set(0,.84,.5),I.rotation.y=Math.PI;const Y=new Le(.25,32,32,Math.PI/2,Math.PI),j=new D(Y,te);j.scale.set(1.1,.6,.8),j.position.set(0,.84,.5),j.rotation.y=0;const S=new _t(.25,32),v=new D(S,te);v.scale.set(.8,.6,.8),v.position.set(0,.84,.5),v.rotation.y=Math.PI/2;const C=new $e;C.add(I),C.add(j),C.add(v),d.add(C);const V=new De({color:8374441,metalness:1,roughness:.25,envMap:R,clearcoat:.7,clearcoatRoughness:.3}),z=new gn;z.moveTo(0,0),z.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),z.bezierCurveTo(-.6,.3,0,.6,0,1),z.bezierCurveTo(0,.6,.6,.3,.6,0),z.bezierCurveTo(.6,-.3,0,-.3,0,0);const H={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},de=new wn(z,H),le=new D(de,V);le.scale.set(.3,.3,.3),le.position.set(.25,1.1,0),le.rotation.y=Math.PI,le.rotation.x=Math.PI,d.add(le);const me=new Le(.35,32,32),Ee=new D(me,te);Ee.scale.set(.75,1.25,.65),Ee.position.set(-.7,-.15,.2),d.add(Ee);const fe=new D(me,te);fe.scale.set(.75,1.25,.65),fe.position.set(.7,-.15,.2),d.add(fe);const xe=new Sn(.2,.22,.6,32),Pe=new D(xe,q);Pe.position.set(-.4,-1.05,0),d.add(Pe);const Re=new D(xe,q);Re.position.set(.4,-1.05,0),d.add(Re);const be=new Le(.3,32,32),Be=new D(be,q);Be.scale.set(1,.72,1.5),Be.position.set(-.4,-1.45,.17),d.add(Be);const Ce=new D(be,q);Ce.scale.set(1,.72,1.5),Ce.position.set(.4,-1.45,.17),d.add(Ce);const ze=new Le(.44,32,32),B=new D(ze,q);B.position.set(-.15,-.45,-.4),d.add(B);const ye=new D(ze,y);ye.position.set(.15,-.45,-.4),d.add(ye);const ne=new Le(.18,32,32),Q=new D(ne,q);Q.position.set(0,-.35,-.8),d.add(Q),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ge){const Fe=new Ut("X",{font:ge,size:.2,depth:.05}),ke=new D(Fe,k);ke.position.set(-.3,.99,.53),ke.rotation.x=it.degToRad(-5),ke.rotation.y=it.degToRad(-15),d.add(ke);const qe=new Ut("O",{font:ge,size:.2,depth:.05}),Ve=new D(qe,k);Ve.position.set(.14,.99,.53),Ve.rotation.y=it.degToRad(12),Ve.rotation.x=it.degToRad(-5),d.add(Ve)}),d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,d.rotation.x=.1,f(),Nt(()=>e.bodyPosition,ge=>{d.position.set(ge.x,ge.y,ge.z)}),Nt(()=>e.cameraPosition,ge=>{_.position.set(e.bodyPosition.x,1,ge),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[Ke("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),Ke("div",iE,[Ke("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),Ke("div",sE,[Ke("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Ke("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),Ke("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),oE=gi(rE,[["__scopeId","data-v-fa97f0a2"]]),aE={class:"pixel-controls"},lE={class:"side-buttons"},cE=Bn({__name:"GhostBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(vt,Vt){const bt=new $e,_n=new Le(1,32,32),qt=new D(_n,Z);qt.scale.set(1,.8,1),bt.add(qt);const jr=new Sn(.1,.1,.5,16),Kr=new Zd({color:9127187}),Zr=new D(jr,Kr);return Zr.position.set(0,.9,0),bt.add(Zr),bt},p=function(){requestAnimationFrame(p),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),r.value&&(m.rotation.x-=.03),o.value&&(m.rotation.x+=.03),Ce.rotation.z-=.04,ze.rotation.z+=.04,B.rotation.z+=.03,ye.rotation.z+=.03,ne.rotation.z-=.04,Be.rotation.y+=.04,Lt+=Et,m.position.y=e.bodyPosition.y+Math.sin(Lt)*Mt;const vt=rt.getElapsedTime();nt.forEach((Vt,bt)=>{const _n=.2+Math.sin(vt*3+wt[bt])*.1;Vt.scale.set(_n,_n,_n)}),d.render(_,x)};const _=new Gi,x=new Dt(75,window.innerWidth/window.innerHeight,.1,1e3),d=new zi({antialias:!0,alpha:!0});d.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(d.domElement);const m=new $e,b=new $e;_.add(b);const M=new Wi(16777215,2);_.add(M);const w=new Vi(16777215,4);w.position.set(5,5,5),_.add(w);const F=new ki(16777215,5,50);F.position.set(0,2,4),_.add(F);const P=new Hi,R=P.load("/3d-bear-arts/assets/pumpkin.jpg");R.wrapS=R.wrapT=Ft,R.repeat.set(.8,.8);const O=P.load("/3d-bear-arts/assets/pumpkin.jpg");O.wrapS=O.wrapT=Ft,O.repeat.set(1,1);const te=new De({color:16747520,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),y=new $e,E=new De({color:16747520,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),q=new De({color:16747520,map:O,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),k=new De({color:16747520,map:R,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.8,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:ot});new De({color:5597999,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});const Z=new De({color:16766720,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new De({color:9109504,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new De({color:4915330,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});const oe=new Le(1,32,32,0,Math.PI),G=new D(oe,k),J=new D(oe,E);G.scale.set(.85,.85,.8),J.scale.set(.85,.85,.8),G.position.y=-.2,J.position.y=-.2,G.rotation.y=Math.PI/2,J.rotation.y=Math.PI*1.5;const X=new _t(1,32),pe=new D(X,q);pe.scale.set(.85,.85,.8),pe.position.set(0,-.2,0),pe.rotation.y=Math.PI/2;const ve=new $e;ve.add(G),ve.add(J),ve.add(pe),m.add(ve);const _e=new Le(.6,32,32,0,Math.PI),Te=new D(_e,E);Te.scale.set(1,.95,.95),Te.position.set(0,1,0),Te.rotation.y=Math.PI*1.5;const Oe=new D(_e,k);Oe.scale.set(1,.95,.95),Oe.position.set(0,1,0),Oe.rotation.y=Math.PI/2;const se=new _t(.6,32),he=new D(se,q);he.position.set(0,1,0),he.rotation.y=Math.PI/2,he.scale.set(1,.95,.95);const Se=new $e;Se.add(Te),Se.add(Oe),Se.add(he),m.add(Se);const N=new Le(.25,32,32),ce=new D(N,q);ce.position.set(-.45,1.35,-.1),m.add(ce);const ie=new D(N,k);ie.position.set(.45,1.35,-.1),m.add(ie);const ue=new Le(.25,32,32,Math.PI/2,Math.PI),we=new D(ue,E);we.scale.set(1.1,.6,.8),we.position.set(0,.84,.5),we.rotation.y=Math.PI;const ee=new Le(.25,32,32,Math.PI/2,Math.PI),g=new D(ee,k);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=0;const T=new _t(.25,32),L=new D(T,E);L.scale.set(.8,.6,.8),L.position.set(0,.84,.5),L.rotation.y=Math.PI/2;const U=new $e;U.add(we),U.add(g),U.add(L),m.add(U);const I=new gn;I.moveTo(0,0),I.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),I.bezierCurveTo(-.6,.3,0,.6,0,1),I.bezierCurveTo(0,.6,.6,.3,.6,0),I.bezierCurveTo(.6,-.3,0,-.3,0,0);const Y={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},j=new wn(I,Y),S=new Le(.35,32,32),v=new D(S,E);v.scale.set(.75,1.25,.65),v.position.set(-.7,-.15,.2),m.add(v);const C=new D(S,k);C.scale.set(.75,1.25,.65),C.position.set(.7,-.15,.2),m.add(C);const V=new Sn(.2,.22,.6,32),z=new D(V,E);z.position.set(-.4,-1.05,0),m.add(z);const H=new D(V,k);H.position.set(.4,-1.05,0),m.add(H);const de=new Le(.3,32,32),le=new D(de,E);le.scale.set(1,.72,1.5),le.position.set(-.4,-1.45,.17),m.add(le);const me=new D(de,k);me.scale.set(1,.72,1.5),me.position.set(.4,-1.45,.17),m.add(me);const Ee=new Le(.44,32,32),fe=new D(Ee,E);fe.position.set(-.15,-.45,-.4),m.add(fe);const xe=new D(Ee,k);xe.position.set(.15,-.45,-.4),m.add(xe);const Pe=new Le(.18,32,32),Re=new D(Pe,q);Re.position.set(0,-.35,-.8),m.add(Re),Re.renderOrder=1,new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(vt){const Vt=new Ut("X",{font:vt,size:.2,depth:.05}),bt=new D(Vt,q);bt.position.set(-.3,.99,.53),bt.rotation.x=it.degToRad(-5),bt.rotation.y=it.degToRad(-15),m.add(bt);const _n=new Ut("O",{font:vt,size:.2,depth:.05}),qt=new D(_n,q);qt.position.set(.14,.99,.53),qt.rotation.y=it.degToRad(12),qt.rotation.x=it.degToRad(-5),m.add(qt)});const Be=new D(j,te);Be.scale.set(.3,.3,.3),Be.position.set(.25,1.1,0),Be.rotation.y=Math.PI,Be.rotation.x=Math.PI,m.add(Be),m.add(y);const Ce=f(),ze=f(),B=f(),ye=f(),ne=f();Ce.position.set(.35,-.35,-.3),ze.position.set(.25,-.45,.3),B.position.set(.3,.1,-.2),ye.position.set(.25,.18,.4),ne.position.set(.5,-.3,-.45),Ce.scale.set(.3,.3,.3),ze.scale.set(.28,.28,.28),B.scale.set(.25,.25,.25),ye.scale.set(.23,.23,.23),ne.scale.set(.25,.2,.25),ze.rotation.z=Math.PI/4,B.rotation.z=-Math.PI/4,ye.rotation.y=-Math.PI/2,ne.rotation.y=-Math.PI/2,m.add(Ce),m.add(ze),m.add(B),m.add(ye);const Q=new gn;Q.moveTo(-.5,0),Q.bezierCurveTo(-.75,.25,-1,.6,-.5,.8),Q.bezierCurveTo(-.25,.85,-.25,.5,-.15,.4),Q.bezierCurveTo(-.05,.6,.05,.6,.15,.4),Q.bezierCurveTo(.25,.5,.25,.85,.5,.8),Q.bezierCurveTo(1,.6,.75,.25,.5,0),Q.bezierCurveTo(.3,-.25,-.3,-.25,-.5,0);const Me={depth:.1,bevelEnabled:!1},ge=new wn(Q,Me),Fe=new Fn({color:0}),ke=new D(ge,Fe);ke.scale.set(.3,.3,.3),ke.rotation.x=0,ke.rotation.z=0,ke.position.set(.3,.2,.65),m.add(ke);const qe=new D(ge,Fe);qe.scale.set(.5,.5,.5),qe.position.set(.3,-.1,.65),m.add(qe);const Ve=new D(ge,Fe);Ve.scale.set(.5,.5,.5),Ve.position.set(.4,-.35,.65),m.add(Ve),m.rotation.x=.1,m.scale.set(1.4,1.4,1.4),_.add(m),m.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),x.position.set(e.bodyPosition.x,1,e.cameraPosition),x.lookAt(e.bodyPosition.x,0,0),x.position.z=4;const nt=[ke,qe,Ve],rt=new Qd,wt=[0,Math.PI/2,Math.PI,0,Math.PI/3];let Et=.05,Mt=.5,Lt=0;p(),Nt(()=>e.bodyPosition,vt=>{m.position.set(vt.x,vt.y,vt.z)}),Nt(()=>e.cameraPosition,vt=>{x.position.set(e.bodyPosition.x,1,vt),x.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{x.aspect=window.innerWidth/window.innerHeight,x.updateProjectionMatrix(),d.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[Ke("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),Ke("div",aE,[Ke("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),Ke("div",lE,[Ke("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Ke("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),Ke("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),uE=gi(cE,[["__scopeId","data-v-b9121169"]]),hE={class:"pixel-controls"},fE={class:"side-buttons"},dE=Bn({__name:"GhostBallonBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),j.rotation.y+=.03,Fe+=ne,ke+=Q,d.position.y=e.bodyPosition.y+Math.sin(Fe)*ge,j.position.y=e.bodyPosition.y+Math.sin(ke)*Me,ze.uniforms.u_time.value+=.25,x.render(p,_)};const p=new Gi,_=new Dt(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zi({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(x.domElement);const d=new $e,m=new $e;p.add(m);const b=new Wi(16777215,2);p.add(b);const M=new Vi(16777215,4);M.position.set(5,5,5),p.add(M);const w=new ki(16777215,5,50);w.position.set(0,2,4),p.add(w);const F=new Hi,P=F.load("/3d-bear-arts/assets/pumpkin.jpg");P.wrapS=P.wrapT=Ft,P.repeat.set(.8,.8);const R=F.load("/3d-bear-arts/assets/pumpkin.jpg");R.wrapS=R.wrapT=Ft,R.repeat.set(1,1);const O=new De({color:16777215,metalness:0,roughness:.8,clearcoat:.3,clearcoatRoughness:.9,transparent:!0,opacity:.15,transmission:.95,ior:1.1,reflectivity:.2,envMapIntensity:.3,depthTest:!0,depthWrite:!1,side:ot}),te=new De({color:16777215,metalness:0,roughness:.8,clearcoat:.3,clearcoatRoughness:.9,transparent:!0,opacity:.15,envMapIntensity:.3}),y=new De({color:9109504,metalness:.9,roughness:.25,clearcoat:.7,clearcoatRoughness:.3}),E=new De({color:16777215,metalness:.1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.1,transmission:.95,ior:1,reflectivity:.2,envMapIntensity:.4,depthTest:!0,depthWrite:!1,side:ot}),q=new De({color:16777215,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.45,transmission:.8,reflectivity:.9,envMapIntensity:1,depthTest:!0,depthWrite:!1,side:ot}),k=new De({color:16777215,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.45,transmission:.8,reflectivity:.9,envMapIntensity:1,side:ot}),Z=new Le(1,32,32,0,Math.PI),oe=new D(Z,O),G=new D(Z,q);oe.scale.set(.85,.85,.8),G.scale.set(.85,.85,.8),oe.position.y=-.2,G.position.y=-.2,oe.rotation.y=Math.PI/2,G.rotation.y=Math.PI*1.5;const J=new _t(1,32),X=new D(J,q);X.scale.set(.85,.85,.8),X.position.set(0,-.2,0),X.rotation.y=Math.PI/2;const pe=new $e;pe.add(oe),pe.add(G),pe.add(X),d.add(pe);const ve=new Le(.6,32,32,0,Math.PI),_e=new D(ve,k);_e.scale.set(1,.95,.95),_e.position.set(0,1,0),_e.rotation.y=Math.PI*1.5;const Te=new D(ve,te);Te.scale.set(1,.95,.95),Te.position.set(0,1,0),Te.rotation.y=Math.PI/2;const Oe=new _t(.6,32),se=new D(Oe,q);se.position.set(0,1,0),se.rotation.y=Math.PI/2,se.scale.set(1,.95,.95);const he=new $e;he.add(_e),he.add(Te),he.add(se),d.add(he);const Se=new Le(.25,32,32),N=new D(Se,k);N.position.set(-.45,1.35,-.1),d.add(N);const ce=new D(Se,te);ce.position.set(.45,1.35,-.1),d.add(ce);const ie=new Le(.25,32,32,Math.PI/2,Math.PI),ue=new D(ie,k);ue.scale.set(1.1,.6,.8),ue.position.set(0,.84,.5),ue.rotation.y=Math.PI;const we=new Le(.25,32,32,Math.PI/2,Math.PI),ee=new D(we,te);ee.scale.set(1.1,.6,.8),ee.position.set(0,.84,.5),ee.rotation.y=0;const g=new _t(.25,32),T=new D(g,E);T.scale.set(.8,.6,.8),T.position.set(0,.84,.5),T.rotation.y=Math.PI/2;const L=new $e;L.add(ue),L.add(ee),L.add(T),d.add(L);const U=new gn;U.moveTo(0,0),U.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),U.bezierCurveTo(-.6,.3,0,.6,0,1),U.bezierCurveTo(0,.6,.6,.3,.6,0),U.bezierCurveTo(.6,-.3,0,-.3,0,0);const I={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},Y=new wn(U,I),j=new D(Y,y);j.scale.set(.35,.35,.35),j.position.set(0,-.05,0),j.rotation.y=Math.PI,j.rotation.x=Math.PI,d.add(j);const S=new Le(.35,32,32),v=new D(S,q);v.scale.set(.75,1.25,.65),v.position.set(-.7,-.15,.2),d.add(v);const C=new D(S,E);C.scale.set(.75,1.25,.65),C.position.set(.7,-.15,.2),d.add(C);const V=new Sn(.2,.22,.6,32),z=new D(V,q);z.position.set(-.4,-1.05,0),d.add(z);const H=new D(V,E);H.position.set(.4,-1.05,0),d.add(H);const de=new Le(.3,32,32),le=new D(de,q);le.scale.set(1,.72,1.5),le.position.set(-.4,-1.45,.17),d.add(le);const me=new D(de,E);me.scale.set(1,.72,1.5),me.position.set(.4,-1.45,.17),d.add(me);const Ee=new Le(.44,32,32),fe=new D(Ee,E);fe.position.set(-.15,-.45,-.4),d.add(fe);const xe=new D(Ee,E);xe.position.set(.15,-.45,-.4),d.add(xe);const Pe=new Le(.18,32,32),Re=new D(Pe,q);Re.position.set(0,-.35,-.8),d.add(Re);const be=new Le(.6,32,32,0,Math.PI*2,0,Math.PI/2),Be=new De({color:9109504,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.8,transmission:.85,ior:1.4,reflectivity:.9,envMapIntensity:1.2}),Ce=new D(be,Be);Ce.position.set(0,-.2,0),Ce.rotation.x=Math.PI,Ce.scale.set(1.25,1.25,1.25),pe.add(Ce);const ze=new $n({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:4},u_waveAmplitude:{value:.5},u_waveSpeed:{value:.3}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),B=new D(J,ze);B.position.set(0,-.26,0),B.scale.set(.7,.7,.7),B.rotation.x=-Math.PI/2,B.renderOrder=1,pe.add(B),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(qe){const Ve=new Ut("X",{font:qe,size:.2,depth:.05}),nt=new D(Ve,q);nt.position.set(-.3,.99,.53),nt.rotation.x=it.degToRad(-5),nt.rotation.y=it.degToRad(-15),d.add(nt);const rt=new Ut("O",{font:qe,size:.2,depth:.05}),wt=new D(rt,q);wt.position.set(.14,.99,.53),wt.rotation.y=it.degToRad(12),wt.rotation.x=it.degToRad(-5),d.add(wt)}),Re.renderOrder=1,d.rotation.x=.1,d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4;let ne=.04,Q=.06,Me=.2,ge=.2,Fe=0,ke=0;f(),Nt(()=>e.bodyPosition,qe=>{d.position.set(qe.x,qe.y,qe.z)}),Nt(()=>e.cameraPosition,qe=>{_.position.set(e.bodyPosition.x,1,qe),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[Ke("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),Ke("div",hE,[Ke("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),Ke("div",fE,[Ke("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Ke("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),Ke("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),pE=gi(dE,[["__scopeId","data-v-8187abdc"]]),mE=[{path:"/3d-bear-arts/leather",name:"Leather",component:kw},{path:"/3d-bear-arts/pop-art",name:"Pop",component:Ww},{path:"/3d-bear-arts/pop-art-bear-3",name:"PopArtBear 3",component:$w},{path:"/3d-bear-arts/machine",name:"MetalMachineBear",component:Jw},{path:"/3d-bear-arts/water",name:"Water Bear",component:nE},{path:"/3d-bear-arts/",name:"Water",component:oE},{path:"/3d-bear-arts/ghost-bear",name:"GhostBear",component:uE},{path:"/3d-bear-arts/white-ghost-bear",name:"GhostBallonBear",component:pE}],gE=Dg({history:cg(),routes:mE}),ep=A0(I0);ep.use(gE);ep.mount("#app");
