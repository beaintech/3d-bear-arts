...
`)+`
`+m);const M=b+d+o,w=b+m+a,O=Uh(s,s.VERTEX_SHADER,M),P=Uh(s,s.FRAGMENT_SHADER,w);s.attachShader(x,O),s.attachShader(x,P),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(E){if(n.debug.checkShaderErrors){const $=s.getProgramInfoLog(x).trim(),k=s.getShaderInfoLog(O).trim(),J=s.getShaderInfoLog(P).trim();let oe=!0,G=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(oe=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,O,P);else{const Z=Nh(s,O,"vertex"),X=Nh(s,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`;class YS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,i){if(this.texture===null){const s=new on,r=e.properties.get(s);r.__webglTexture=t.texture,(t.depthNear!=i.depthNear||t.depthFar!=i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=s}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new $n({vertexShader:XS,fragmentShader:qS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new D(new ha(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class $S extends tr{constructor(e,t){super();const i=this;let s=null,r=1,o=null,a="local-floor",l=1,c=null,h=null,u=null,f=null,p=null,_=null;const x=new YS,d=t.getContextAttributes();let m=null,b=null;const M=[],w=[],O=new Ue;let P=null;const R=new It;R.layers.enable(1),R.viewport=new pt;const U=new It;U.layers.enable(2),U.viewport=new pt;const ne=[R,U],y=new VS;y.layers.enable(1),y.layers.enable(2);let E=null,$=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(re){let he=M[re];return he===void 0&&(he=new rl,M[re]=he),he.getTargetRaySpace()},this.getControllerGrip=function(re){let he=M[re];return he===void 0&&(he=new rl,M[re]=he),he.getGripSpace()},this.getHand=function(re){let he=M[re];return he===void 0&&(he=new rl,M[re]=he),he.getHandSpace()};function k(re){const he=w.indexOf(re.inputSource);if(he===-1)return;const Se=M[he];Se!==void 0&&(Se.update(re.inputSource,re.frame,c||o),Se.dispatchEvent({type:re.type,data:re.inputSource}))}function J(){s.removeEventListener("select",k),s.removeEventListener("selectstart",k),s.removeEventListener("selectend",k),s.removeEventListener("squeeze",k),s.removeEventListener("squeezestart",k),s.removeEventListener("squeezeend",k),s.removeEventListener("end",J),s.removeEventListener("inputsourceschange",oe);for(let re=0;re<M.length;re++){const he=w[re];he!==null&&(w[re]=null,M[re].disconnect(he))}E=null,$=null,x.reset(),e.setRenderTarget(m),p=null,f=null,u=null,s=null,b=null,Fe.stop(),i.isPresenting=!1,e.setPixelRatio(P),e.setSize(O.width,O.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(re){r=re,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(re){a=re,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(re){c=re},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return u},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(re){if(s=re,s!==null){if(m=e.getRenderTarget(),s.addEventListener("select",k),s.addEventListener("selectstart",k),s.addEventListener("selectend",k),s.addEventListener("squeeze",k),s.addEventListener("squeezestart",k),s.addEventListener("squeezeend",k),s.addEventListener("end",J),s.addEventListener("inputsourceschange",oe),d.xrCompatible!==!0&&await t.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(O),s.renderState.layers===void 0){const he={antialias:d.antialias,alpha:!0,depth:d.depth,stencil:d.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(s,t,he),s.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),b=new us(p.framebufferWidth,p.framebufferHeight,{format:In,type:fi,colorSpace:e.outputColorSpace,stencilBuffer:d.stencil})}else{let he=null,Se=null,F=null;d.depth&&(F=d.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,he=d.stencil?Js:ks,Se=d.stencil?Zs:cs);const le={colorFormat:t.RGBA8,depthFormat:F,scaleFactor:r};u=new XRWebGLBinding(s,t),f=u.createProjectionLayer(le),s.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),b=new us(f.textureWidth,f.textureHeight,{format:In,type:fi,depthTexture:new zd(f.textureWidth,f.textureHeight,Se,void 0,void 0,void 0,void 0,void 0,void 0,he),stencilBuffer:d.stencil,colorSpace:e.outputColorSpace,samples:d.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await s.requestReferenceSpace(a),Fe.setContext(s),Fe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function oe(re){for(let he=0;he<re.removed.length;he++){const Se=re.removed[he],F=w.indexOf(Se);F>=0&&(w[F]=null,M[F].disconnect(Se))}for(let he=0;he<re.added.length;he++){const Se=re.added[he];let F=w.indexOf(Se);if(F===-1){for(let ie=0;ie<M.length;ie++)if(ie>=w.length){w.push(Se),F=ie;break}else if(w[ie]===null){w[ie]=Se,F=ie;break}if(F===-1)break}const le=M[F];le&&le.connect(Se)}}const G=new W,Z=new W;function X(re,he,Se){G.setFromMatrixPosition(he.matrixWorld),Z.setFromMatrixPosition(Se.matrixWorld);const F=G.distanceTo(Z),le=he.projectionMatrix.elements,ie=Se.projectionMatrix.elements,ue=le[14]/(le[10]-1),we=le[14]/(le[10]+1),ee=(le[9]+1)/le[5],g=(le[9]-1)/le[5],T=(le[8]-1)/le[0],L=(ie[8]+1)/ie[0],N=ue*T,I=ue*L,q=F/(-T+L),j=q*-T;if(he.matrixWorld.decompose(re.position,re.quaternion,re.scale),re.translateX(j),re.translateZ(q),re.matrixWorld.compose(re.position,re.quaternion,re.scale),re.matrixWorldInverse.copy(re.matrixWorld).invert(),le[10]===-1)re.projectionMatrix.copy(he.projectionMatrix),re.projectionMatrixInverse.copy(he.projectionMatrixInverse);else{const S=ue+q,v=we+q,C=N-j,V=I+(F-j),B=ee*we/v*S,H=g*we/v*S;re.projectionMatrix.makePerspective(C,V,B,H,S,v),re.projectionMatrixInverse.copy(re.projectionMatrix).invert()}}function pe(re,he){he===null?re.matrixWorld.copy(re.matrix):re.matrixWorld.multiplyMatrices(he.matrixWorld,re.matrix),re.matrixWorldInverse.copy(re.matrixWorld).invert()}this.updateCamera=function(re){if(s===null)return;let he=re.near,Se=re.far;x.texture!==null&&(x.depthNear>0&&(he=x.depthNear),x.depthFar>0&&(Se=x.depthFar)),y.near=U.near=R.near=he,y.far=U.far=R.far=Se,(E!==y.near||$!==y.far)&&(s.updateRenderState({depthNear:y.near,depthFar:y.far}),E=y.near,$=y.far);const F=re.parent,le=y.cameras;pe(y,F);for(let ie=0;ie<le.length;ie++)pe(le[ie],F);le.length===2?X(y,R,U):y.projectionMatrix.copy(R.projectionMatrix),ve(re,y,F)};function ve(re,he,Se){Se===null?re.matrix.copy(he.matrixWorld):(re.matrix.copy(Se.matrixWorld),re.matrix.invert(),re.matrix.multiply(he.matrixWorld)),re.matrix.decompose(re.position,re.quaternion,re.scale),re.updateMatrixWorld(!0),re.projectionMatrix.copy(he.projectionMatrix),re.projectionMatrixInverse.copy(he.projectionMatrixInverse),re.isPerspectiveCamera&&(re.fov=Or*2*Math.atan(1/re.projectionMatrix.elements[5]),re.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(re){l=re,f!==null&&(f.fixedFoveation=re),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=re)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(y)};let _e=null;function Te(re,he){if(h=he.getViewerPose(c||o),_=he,h!==null){const Se=h.views;p!==null&&(e.setRenderTargetFramebuffer(b,p.framebuffer),e.setRenderTarget(b));let F=!1;Se.length!==y.cameras.length&&(y.cameras.length=0,F=!0);for(let ie=0;ie<Se.length;ie++){const ue=Se[ie];let we=null;if(p!==null)we=p.getViewport(ue);else{const g=u.getViewSubImage(f,ue);we=g.viewport,ie===0&&(e.setRenderTargetTextures(b,g.colorTexture,f.ignoreDepthValues?void 0:g.depthStencilTexture),e.setRenderTarget(b))}let ee=ne[ie];ee===void 0&&(ee=new It,ee.layers.enable(ie),ee.viewport=new pt,ne[ie]=ee),ee.matrix.fromArray(ue.transform.matrix),ee.matrix.decompose(ee.position,ee.quaternion,ee.scale),ee.projectionMatrix.fromArray(ue.projectionMatrix),ee.projectionMatrixInverse.copy(ee.projectionMatrix).invert(),ee.viewport.set(we.x,we.y,we.width,we.height),ie===0&&(y.matrix.copy(ee.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),F===!0&&y.cameras.push(ee)}const le=s.enabledFeatures;if(le&&le.includes("depth-sensing")){const ie=u.getDepthInformation(Se[0]);ie&&ie.isValid&&ie.texture&&x.init(e,ie,s.renderState)}}for(let Se=0;Se<M.length;Se++){const F=w[Se],le=M[Se];F!==null&&le!==void 0&&le.update(F,he,c||o)}_e&&_e(re,he),he.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:he}),_=null}const Fe=new Od;Fe.setAnimationLoop(Te),this.setAnimationLoop=function(re){_e=re},this.dispose=function(){}}}const Qi=new Yn,jS=new St;function KS(n,e){function t(d,m){d.matrixAutoUpdate===!0&&d.updateMatrix(),m.value.copy(d.matrix)}function i(d,m){m.color.getRGB(d.fogColor.value,Ud(n)),m.isFog?(d.fogNear.value=m.near,d.fogFar.value=m.far):m.isFogExp2&&(d.fogDensity.value=m.density)}function s(d,m,b,M,w){m.isMeshBasicMaterial||m.isMeshLambertMaterial?r(d,m):m.isMeshToonMaterial?(r(d,m),u(d,m)):m.isMeshPhongMaterial?(r(d,m),h(d,m)):m.isMeshStandardMaterial?(r(d,m),f(d,m),m.isMeshPhysicalMaterial&&p(d,m,w)):m.isMeshMatcapMaterial?(r(d,m),_(d,m)):m.isMeshDepthMaterial?r(d,m):m.isMeshDistanceMaterial?(r(d,m),x(d,m)):m.isMeshNormalMaterial?r(d,m):m.isLineBasicMaterial?(o(d,m),m.isLineDashedMaterial&&a(d,m)):m.isPointsMaterial?l(d,m,b,M):m.isSpriteMaterial?c(d,m):m.isShadowMaterial?(d.color.value.copy(m.color),d.opacity.value=m.opacity):m.isShaderMaterial&&(m.uniformsNeedUpdate=!1)}function r(d,m){d.opacity.value=m.opacity,m.color&&d.diffuse.value.copy(m.color),m.emissive&&d.emissive.value.copy(m.emissive).multiplyScalar(m.emissiveIntensity),m.map&&(d.map.value=m.map,t(m.map,d.mapTransform)),m.alphaMap&&(d.alphaMap.value=m.alphaMap,t(m.alphaMap,d.alphaMapTransform)),m.bumpMap&&(d.bumpMap.value=m.bumpMap,t(m.bumpMap,d.bumpMapTransform),d.bumpScale.value=m.bumpScale,m.side===an&&(d.bumpScale.value*=-1)),m.normalMap&&(d.normalMap.value=m.normalMap,t(m.normalMap,d.normalMapTransform),d.normalScale.value.copy(m.normalScale),m.side===an&&d.normalScale.value.negate()),m.displacementMap&&(d.displacementMap.value=m.displacementMap,t(m.displacementMap,d.displacementMapTransform),d.displacementScale.value=m.displacementScale,d.displacementBias.value=m.displacementBias),m.emissiveMap&&(d.emissiveMap.value=m.emissiveMap,t(m.emissiveMap,d.emissiveMapTransform)),m.specularMap&&(d.specularMap.value=m.specularMap,t(m.specularMap,d.specularMapTransform)),m.alphaTest>0&&(d.alphaTest.value=m.alphaTest);const b=e.get(m),M=b.envMap,w=b.envMapRotation;M&&(d.envMap.value=M,Qi.copy(w),Qi.x*=-1,Qi.y*=-1,Qi.z*=-1,M.isCubeTexture&&M.isRenderTargetTexture===!1&&(Qi.y*=-1,Qi.z*=-1),d.envMapRotation.value.setFromMatrix4(jS.makeRotationFromEuler(Qi)),d.flipEnvMap.value=M.isCubeTexture&&M.isRenderTargetTexture===!1?-1:1,d.reflectivity.value=m.reflectivity,d.ior.value=m.ior,d.refractionRatio.value=m.refractionRatio),m.lightMap&&(d.lightMap.value=m.lightMap,d.lightMapIntensity.value=m.lightMapIntensity,t(m.lightMap,d.lightMapTransform)),m.aoMap&&(d.aoMap.value=m.aoMap,d.aoMapIntensity.value=m.aoMapIntensity,t(m.aoMap,d.aoMapTransform))}function o(d,m){d.diffuse.value.copy(m.color),d.opacity.value=m.opacity,m.map&&(d.map.value=m.map,t(m.map,d.mapTransform))}function a(d,m){d.dashSize.value=m.dashSize,d.totalSize.value=m.dashSize+m.gapSize,d.scale.value=m.scale}function l(d,m,b,M){d.diffuse.value.copy(m.color),d.opacity.value=m.opacity,d.size.value=m.size*b,d.scale.value=M*.5,m.map&&(d.map.value=m.map,t(m.map,d.uvTransform)),m.alphaMap&&(d.alphaMap.value=m.alphaMap,t(m.alphaMap,d.alphaMapTransform)),m.alphaTest>0&&(d.alphaTest.value=m.alphaTest)}function c(d,m){d.diffuse.value.copy(m.color),d.opacity.value=m.opacity,d.rotation.value=m.rotation,m.map&&(d.map.value=m.map,t(m.map,d.mapTransform)),m.alphaMap&&(d.alphaMap.value=m.alphaMap,t(m.alphaMap,d.alphaMapTransform)),m.alphaTest>0&&(d.alphaTest.value=m.alphaTest)}function h(d,m){d.specular.value.copy(m.specular),d.shininess.value=Math.max(m.shininess,1e-4)}function u(d,m){m.gradientMap&&(d.gradientMap.value=m.gradientMap)}function f(d,m){d.metalness.value=m.metalness,m.metalnessMap&&(d.metalnessMap.value=m.metalnessMap,t(m.metalnessMap,d.metalnessMapTransform)),d.roughness.value=m.roughness,m.roughnessMap&&(d.roughnessMap.value=m.roughnessMap,t(m.roughnessMap,d.roughnessMapTransform)),m.envMap&&(d.envMapIntensity.value=m.envMapIntensity)}function p(d,m,b){d.ior.value=m.ior,m.sheen>0&&(d.sheenColor.value.copy(m.sheenColor).multiplyScalar(m.sheen),d.sheenRoughness.value=m.sheenRoughness,m.sheenColorMap&&(d.sheenColorMap.value=m.sheenColorMap,t(m.sheenColorMap,d.sheenColorMapTransform)),m.sheenRoughnessMap&&(d.sheenRoughnessMap.value=m.sheenRoughnessMap,t(m.sheenRoughnessMap,d.sheenRoughnessMapTransform))),m.clearcoat>0&&(d.clearcoat.value=m.clearcoat,d.clearcoatRoughness.value=m.clearcoatRoughness,m.clearcoatMap&&(d.clearcoatMap.value=m.clearcoatMap,t(m.clearcoatMap,d.clearcoatMapTransform)),m.clearcoatRoughnessMap&&(d.clearcoatRoughnessMap.value=m.clearcoatRoughnessMap,t(m.clearcoatRoughnessMap,d.clearcoatRoughnessMapTransform)),m.clearcoatNormalMap&&(d.clearcoatNormalMap.value=m.clearcoatNormalMap,t(m.clearcoatNormalMap,d.clearcoatNormalMapTransform),d.clearcoatNormalScale.value.copy(m.clearcoatNormalScale),m.side===an&&d.clearcoatNormalScale.value.negate())),m.dispersion>0&&(d.dispersion.value=m.dispersion),m.iridescence>0&&(d.iridescence.value=m.iridescence,d.iridescenceIOR.value=m.iridescenceIOR,d.iridescenceThicknessMinimum.value=m.iridescenceThicknessRange[0],d.iridescenceThicknessMaximum.value=m.iridescenceThicknessRange[1],m.iridescenceMap&&(d.iridescenceMap.value=m.iridescenceMap,t(m.iridescenceMap,d.iridescenceMapTransform)),m.iridescenceThicknessMap&&(d.iridescenceThicknessMap.value=m.iridescenceThicknessMap,t(m.iridescenceThicknessMap,d.iridescenceThicknessMapTransform))),m.transmission>0&&(d.transmission.value=m.transmission,d.transmissionSamplerMap.value=b.texture,d.transmissionSamplerSize.value.set(b.width,b.height),m.transmissionMap&&(d.transmissionMap.value=m.transmissionMap,t(m.transmissionMap,d.transmissionMapTransform)),d.thickness.value=m.thickness,m.thicknessMap&&(d.thicknessMap.value=m.thicknessMap,t(m.thicknessMap,d.thicknessMapTransform)),d.attenuationDistance.value=m.attenuationDistance,d.attenuationColor.value.copy(m.attenuationColor)),m.anisotropy>0&&(d.anisotropyVector.value.set(m.anisotropy*Math.cos(m.anisotropyRotation),m.anisotropy*Math.sin(m.anisotropyRotation)),m.anisotropyMap&&(d.anisotropyMap.value=m.anisotropyMap,t(m.anisotropyMap,d.anisotropyMapTransform))),d.specularIntensity.value=m.specularIntensity,d.specularColor.value.copy(m.specularColor),m.specularColorMap&&(d.specularColorMap.value=m.specularColorMap,t(m.specularColorMap,d.specularColorMapTransform)),m.specularIntensityMap&&(d.specularIntensityMap.value=m.specularIntensityMap,t(m.specularIntensityMap,d.specularIntensityMapTransform))}function _(d,m){m.matcap&&(d.matcap.value=m.matcap)}function x(d,m){const b=e.get(m).light;d.referencePosition.value.setFromMatrixPosition(b.matrixWorld),d.nearDistance.value=b.shadow.camera.near,d.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:s}}function ZS(n,e,t,i){let s={},r={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(b,M){const w=M.program;i.uniformBlockBinding(b,w)}function c(b,M){let w=s[b.id];w===void 0&&(_(b),w=h(b),s[b.id]=w,b.addEventListener("dispose",d));const O=M.program;i.updateUBOMapping(b,O);const P=e.render.frame;r[b.id]!==P&&(f(b),r[b.id]=P)}function h(b){const M=u();b.__bindingPointIndex=M;const w=n.createBuffer(),O=b.__size,P=b.usage;return n.bindBuffer(n.UNIFORM_BUFFER,w),n.bufferData(n.UNIFORM_BUFFER,O,P),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,M,w),w}function u(){for(let b=0;b<a;b++)if(o.indexOf(b)===-1)return o.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(b){const M=s[b.id],w=b.uniforms,O=b.__cache;n.bindBuffer(n.UNIFORM_BUFFER,M);for(let P=0,R=w.length;P<R;P++){const U=Array.isArray(w[P])?w[P]:[w[P]];for(let ne=0,y=U.length;ne<y;ne++){const E=U[ne];if(p(E,P,ne,O)===!0){const $=E.__offset,k=Array.isArray(E.value)?E.value:[E.value];let J=0;for(let oe=0;oe<k.length;oe++){const G=k[oe],Z=x(G);typeof G=="number"||typeof G=="boolean"?(E.__data[0]=G,n.bufferSubData(n.UNIFORM_BUFFER,$+J,E.__data)):G.isMatrix3?(E.__data[0]=G.elements[0],E.__data[1]=G.elements[1],E.__data[2]=G.elements[2],E.__data[3]=0,E.__data[4]=G.elements[3],E.__data[5]=G.elements[4],E.__data[6]=G.elements[5],E.__data[7]=0,E.__data[8]=G.elements[6],E.__data[9]=G.elements[7],E.__data[10]=G.elements[8],E.__data[11]=0):(G.toArray(E.__data,J),J+=Z.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,$,E.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(b,M,w,O){const P=b.value,R=M+"_"+w;if(O[R]===void 0)return typeof P=="number"||typeof P=="boolean"?O[R]=P:O[R]=P.clone(),!0;{const U=O[R];if(typeof P=="number"||typeof P=="boolean"){if(U!==P)return O[R]=P,!0}else if(U.equals(P)===!1)return U.copy(P),!0}return!1}function _(b){const M=b.uniforms;let w=0;const O=16;for(let R=0,U=M.length;R<U;R++){const ne=Array.isArray(M[R])?M[R]:[M[R]];for(let y=0,E=ne.length;y<E;y++){const $=ne[y],k=Array.isArray($.value)?$.value:[$.value];for(let J=0,oe=k.length;J<oe;J++){const G=k[J],Z=x(G),X=w%O,pe=X%Z.boundary,ve=X+pe;w+=pe,ve!==0&&O-ve<Z.storage&&(w+=O-ve),$.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),$.__offset=w,w+=Z.storage}}}const P=w%O;return P>0&&(w+=O-P),b.__size=w,b.__cache={},this}function x(b){const M={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(M.boundary=4,M.storage=4):b.isVector2?(M.boundary=8,M.storage=8):b.isVector3||b.isColor?(M.boundary=16,M.storage=12):b.isVector4?(M.boundary=16,M.storage=16):b.isMatrix3?(M.boundary=48,M.storage=48):b.isMatrix4?(M.boundary=64,M.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),M}function d(b){const M=b.target;M.removeEventListener("dispose",d);const w=o.indexOf(M.__bindingPointIndex);o.splice(w,1),n.deleteBuffer(s[M.id]),delete s[M.id],delete r[M.id]}function m(){for(const b in s)n.deleteBuffer(s[b]);o=[],s={},r={}}return{bind:l,update:c,dispose:m}}class zi{constructor(e={}){const{canvas:t=B_(),context:i=null,depth:s=!0,stencil:r=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1}=e;this.isWebGLRenderer=!0;let f;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=i.getContextAttributes().alpha}else f=o;const p=new Uint32Array(4),_=new Int32Array(4);let x=null,d=null;const m=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Hn,this.toneMapping=Di,this.toneMappingExposure=1;const M=this;let w=!1,O=0,P=0,R=null,U=-1,ne=null;const y=new pt,E=new pt;let $=null;const k=new st(0);let J=0,oe=t.width,G=t.height,Z=1,X=null,pe=null;const ve=new pt(0,0,oe,G),_e=new pt(0,0,oe,G);let Te=!1;const Fe=new Yc;let re=!1,he=!1;const Se=new St,F=new St,le=new W,ie=new pt,ue={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let we=!1;function ee(){return R===null?Z:1}let g=i;function T(A,Y){return t.getContext(A,Y)}try{const A={alpha:!0,depth:s,stencil:r,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Oc}`),t.addEventListener("webglcontextlost",Q,!1),t.addEventListener("webglcontextrestored",ye,!1),t.addEventListener("webglcontextcreationerror",ge,!1),g===null){const Y="webgl2";if(g=T(Y,A),g===null)throw T(Y)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(A){throw console.error("THREE.WebGLRenderer: "+A.message),A}let L,N,I,q,j,S,v,C,V,B,H,de,ce,me,be,fe,Me,Ce,Re,Ee,Be,Pe,ze,z;function xe(){L=new iM(g),L.init(),Pe=new kS(g,L),N=new Zy(g,L,e,Pe),I=new zS(g),N.reverseDepthBuffer&&I.buffers.depth.setReversed(!0),q=new oM(g),j=new ES,S=new HS(g,L,I,j,N,Pe,q),v=new Qy(M),C=new nM(M),V=new dv(g),ze=new jy(g,V),B=new sM(g,V,q,ze),H=new lM(g,B,V,q),Re=new aM(g,N,S),fe=new Jy(j),de=new wS(M,v,C,L,N,ze,fe),ce=new KS(M,j),me=new TS,be=new IS(L),Ce=new $y(M,v,C,I,H,f,l),Me=new OS(M,H,N),z=new ZS(g,q,N,I),Ee=new Ky(g,L,q),Be=new rM(g,L,q),q.programs=de.programs,M.capabilities=N,M.extensions=L,M.properties=j,M.renderLists=me,M.shadowMap=Me,M.state=I,M.info=q}xe();const te=new $S(M,g);this.xr=te,this.getContext=function(){return g},this.getContextAttributes=function(){return g.getContextAttributes()},this.forceContextLoss=function(){const A=L.get("WEBGL_lose_context");A&&A.loseContext()},this.forceContextRestore=function(){const A=L.get("WEBGL_lose_context");A&&A.restoreContext()},this.getPixelRatio=function(){return Z},this.setPixelRatio=function(A){A!==void 0&&(Z=A,this.setSize(oe,G,!1))},this.getSize=function(A){return A.set(oe,G)},this.setSize=function(A,Y,se=!0){if(te.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}oe=A,G=Y,t.width=Math.floor(A*Z),t.height=Math.floor(Y*Z),se===!0&&(t.style.width=A+"px",t.style.height=Y+"px"),this.setViewport(0,0,A,Y)},this.getDrawingBufferSize=function(A){return A.set(oe*Z,G*Z).floor()},this.setDrawingBufferSize=function(A,Y,se){oe=A,G=Y,Z=se,t.width=Math.floor(A*se),t.height=Math.floor(Y*se),this.setViewport(0,0,A,Y)},this.getCurrentViewport=function(A){return A.copy(y)},this.getViewport=function(A){return A.copy(ve)},this.setViewport=function(A,Y,se,ae){A.isVector4?ve.set(A.x,A.y,A.z,A.w):ve.set(A,Y,se,ae),I.viewport(y.copy(ve).multiplyScalar(Z).round())},this.getScissor=function(A){return A.copy(_e)},this.setScissor=function(A,Y,se,ae){A.isVector4?_e.set(A.x,A.y,A.z,A.w):_e.set(A,Y,se,ae),I.scissor(E.copy(_e).multiplyScalar(Z).round())},this.getScissorTest=function(){return Te},this.setScissorTest=function(A){I.setScissorTest(Te=A)},this.setOpaqueSort=function(A){X=A},this.setTransparentSort=function(A){pe=A},this.getClearColor=function(A){return A.copy(Ce.getClearColor())},this.setClearColor=function(){Ce.setClearColor.apply(Ce,arguments)},this.getClearAlpha=function(){return Ce.getClearAlpha()},this.setClearAlpha=function(){Ce.setClearAlpha.apply(Ce,arguments)},this.clear=function(A=!0,Y=!0,se=!0){let ae=0;if(A){let K=!1;if(R!==null){const Ae=R.texture.format;K=Ae===Vc||Ae===kc||Ae===Hc}if(K){const Ae=R.texture.type,Oe=Ae===fi||Ae===cs||Ae===Fr||Ae===Zs||Ae===zc||Ae===Gc,Ge=Ce.getClearColor(),He=Ce.getClearAlpha(),qe=Ge.r,$e=Ge.g,We=Ge.b;Oe?(p[0]=qe,p[1]=$e,p[2]=We,p[3]=He,g.clearBufferuiv(g.COLOR,0,p)):(_[0]=qe,_[1]=$e,_[2]=We,_[3]=He,g.clearBufferiv(g.COLOR,0,_))}else ae|=g.COLOR_BUFFER_BIT}Y&&(ae|=g.DEPTH_BUFFER_BIT,g.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),se&&(ae|=g.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),g.clear(ae)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Q,!1),t.removeEventListener("webglcontextrestored",ye,!1),t.removeEventListener("webglcontextcreationerror",ge,!1),me.dispose(),be.dispose(),j.dispose(),v.dispose(),C.dispose(),H.dispose(),ze.dispose(),z.dispose(),de.dispose(),te.dispose(),te.removeEventListener("sessionstart",zt),te.removeEventListener("sessionend",wt),Mt.stop()};function Q(A){A.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),w=!0}function ye(){console.log("THREE.WebGLRenderer: Context Restored."),w=!1;const A=q.autoReset,Y=Me.enabled,se=Me.autoUpdate,ae=Me.needsUpdate,K=Me.type;xe(),q.autoReset=A,Me.enabled=Y,Me.autoUpdate=se,Me.needsUpdate=ae,Me.type=K}function ge(A){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",A.statusMessage)}function Ne(A){const Y=A.target;Y.removeEventListener("dispose",Ne),Ve(Y)}function Ve(A){Ke(A),j.remove(A)}function Ke(A){const Y=j.get(A).programs;Y!==void 0&&(Y.forEach(function(se){de.releaseProgram(se)}),A.isShaderMaterial&&de.releaseShaderCache(A))}this.renderBufferDirect=function(A,Y,se,ae,K,Ae){Y===null&&(Y=ue);const Oe=K.isMesh&&K.matrixWorld.determinant()<0,Ge=Zr(A,Y,se,ae,K);I.setMaterial(ae,Oe);let He=se.index,qe=1;if(ae.wireframe===!0){if(He=B.getWireframeAttribute(se),He===void 0)return;qe=2}const $e=se.drawRange,We=se.attributes.position;let ft=$e.start*qe,xt=($e.start+$e.count)*qe;Ae!==null&&(ft=Math.max(ft,Ae.start*qe),xt=Math.min(xt,(Ae.start+Ae.count)*qe)),He!==null?(ft=Math.max(ft,0),xt=Math.min(xt,He.count)):We!=null&&(ft=Math.max(ft,0),xt=Math.min(xt,We.count));const Tt=xt-ft;if(Tt<0||Tt===1/0)return;ze.setup(K,ae,Ge,se,He);let ln,at=Ee;if(He!==null&&(ln=V.get(He),at=Be,at.setIndex(ln)),K.isMesh)ae.wireframe===!0?(I.setLineWidth(ae.wireframeLinewidth*ee()),at.setMode(g.LINES)):at.setMode(g.TRIANGLES);else if(K.isLine){let Xe=ae.linewidth;Xe===void 0&&(Xe=1),I.setLineWidth(Xe*ee()),K.isLineSegments?at.setMode(g.LINES):K.isLineLoop?at.setMode(g.LINE_LOOP):at.setMode(g.LINE_STRIP)}else K.isPoints?at.setMode(g.POINTS):K.isSprite&&at.setMode(g.TRIANGLES);if(K.isBatchedMesh)if(K._multiDrawInstances!==null)at.renderMultiDrawInstances(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount,K._multiDrawInstances);else if(L.get("WEBGL_multi_draw"))at.renderMultiDraw(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount);else{const Xe=K._multiDrawStarts,Wt=K._multiDrawCounts,lt=K._multiDrawCount,bn=He?V.get(He).bytesPerElement:1,ms=j.get(ae).currentProgram.getUniforms();for(let cn=0;cn<lt;cn++)ms.setValue(g,"_gl_DrawID",cn),at.render(Xe[cn]/bn,Wt[cn])}else if(K.isInstancedMesh)at.renderInstances(ft,Tt,K.count);else if(se.isInstancedBufferGeometry){const Xe=se._maxInstanceCount!==void 0?se._maxInstanceCount:1/0,Wt=Math.min(se.instanceCount,Xe);at.renderInstances(ft,Tt,Wt)}else at.render(ft,Tt)};function ke(A,Y,se){A.transparent===!0&&A.side===rt&&A.forceSinglePass===!1?(A.side=an,A.needsUpdate=!0,qt(A,Y,se),A.side=Ni,A.needsUpdate=!0,qt(A,Y,se),A.side=rt):qt(A,Y,se)}this.compile=function(A,Y,se=null){se===null&&(se=A),d=be.get(se),d.init(Y),b.push(d),se.traverseVisible(function(K){K.isLight&&K.layers.test(Y.layers)&&(d.pushLight(K),K.castShadow&&d.pushShadow(K))}),A!==se&&A.traverseVisible(function(K){K.isLight&&K.layers.test(Y.layers)&&(d.pushLight(K),K.castShadow&&d.pushShadow(K))}),d.setupLights();const ae=new Set;return A.traverse(function(K){if(!(K.isMesh||K.isPoints||K.isLine||K.isSprite))return;const Ae=K.material;if(Ae)if(Array.isArray(Ae))for(let Oe=0;Oe<Ae.length;Oe++){const Ge=Ae[Oe];ke(Ge,se,K),ae.add(Ge)}else ke(Ae,se,K),ae.add(Ae)}),b.pop(),d=null,ae},this.compileAsync=function(A,Y,se=null){const ae=this.compile(A,Y,se);return new Promise(K=>{function Ae(){if(ae.forEach(function(Oe){j.get(Oe).currentProgram.isReady()&&ae.delete(Oe)}),ae.size===0){K(A);return}setTimeout(Ae,10)}L.get("KHR_parallel_shader_compile")!==null?Ae():setTimeout(Ae,10)})};let nt=null;function ot(A){nt&&nt(A)}function zt(){Mt.stop()}function wt(){Mt.start()}const Mt=new Od;Mt.setAnimationLoop(ot),typeof self<"u"&&Mt.setContext(self),this.setAnimationLoop=function(A){nt=A,te.setAnimationLoop(A),A===null?Mt.stop():Mt.start()},te.addEventListener("sessionstart",zt),te.addEventListener("sessionend",wt),this.render=function(A,Y){if(Y!==void 0&&Y.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;if(A.matrixWorldAutoUpdate===!0&&A.updateMatrixWorld(),Y.parent===null&&Y.matrixWorldAutoUpdate===!0&&Y.updateMatrixWorld(),te.enabled===!0&&te.isPresenting===!0&&(te.cameraAutoUpdate===!0&&te.updateCamera(Y),Y=te.getCamera()),A.isScene===!0&&A.onBeforeRender(M,A,Y,R),d=be.get(A,b.length),d.init(Y),b.push(d),F.multiplyMatrices(Y.projectionMatrix,Y.matrixWorldInverse),Fe.setFromProjectionMatrix(F),he=this.localClippingEnabled,re=fe.init(this.clippingPlanes,he),x=me.get(A,m.length),x.init(),m.push(x),te.enabled===!0&&te.isPresenting===!0){const Ae=M.xr.getDepthSensingMesh();Ae!==null&&Pt(Ae,Y,-1/0,M.sortObjects)}Pt(A,Y,0,M.sortObjects),x.finish(),M.sortObjects===!0&&x.sort(X,pe),we=te.enabled===!1||te.isPresenting===!1||te.hasDepthSensing()===!1,we&&Ce.addToRenderList(x,A),this.info.render.frame++,re===!0&&fe.beginShadows();const se=d.state.shadowsArray;Me.render(se,A,Y),re===!0&&fe.endShadows(),this.info.autoReset===!0&&this.info.reset();const ae=x.opaque,K=x.transmissive;if(d.setupLights(),Y.isArrayCamera){const Ae=Y.cameras;if(K.length>0)for(let Oe=0,Ge=Ae.length;Oe<Ge;Oe++){const He=Ae[Oe];Vt(ae,K,A,He)}we&&Ce.render(A);for(let Oe=0,Ge=Ae.length;Oe<Ge;Oe++){const He=Ae[Oe];vt(x,A,He,He.viewport)}}else K.length>0&&Vt(ae,K,A,Y),we&&Ce.render(A),vt(x,A,Y);R!==null&&(S.updateMultisampleRenderTarget(R),S.updateRenderTargetMipmap(R)),A.isScene===!0&&A.onAfterRender(M,A,Y),ze.resetDefaultState(),U=-1,ne=null,b.pop(),b.length>0?(d=b[b.length-1],re===!0&&fe.setGlobalState(M.clippingPlanes,d.state.camera)):d=null,m.pop(),m.length>0?x=m[m.length-1]:x=null};function Pt(A,Y,se,ae){if(A.visible===!1)return;if(A.layers.test(Y.layers)){if(A.isGroup)se=A.renderOrder;else if(A.isLOD)A.autoUpdate===!0&&A.update(Y);else if(A.isLight)d.pushLight(A),A.castShadow&&d.pushShadow(A);else if(A.isSprite){if(!A.frustumCulled||Fe.intersectsSprite(A)){ae&&ie.setFromMatrixPosition(A.matrixWorld).applyMatrix4(F);const Oe=H.update(A),Ge=A.material;Ge.visible&&x.push(A,Oe,Ge,se,ie.z,null)}}else if((A.isMesh||A.isLine||A.isPoints)&&(!A.frustumCulled||Fe.intersectsObject(A))){const Oe=H.update(A),Ge=A.material;if(ae&&(A.boundingSphere!==void 0?(A.boundingSphere===null&&A.computeBoundingSphere(),ie.copy(A.boundingSphere.center)):(Oe.boundingSphere===null&&Oe.computeBoundingSphere(),ie.copy(Oe.boundingSphere.center)),ie.applyMatrix4(A.matrixWorld).applyMatrix4(F)),Array.isArray(Ge)){const He=Oe.groups;for(let qe=0,$e=He.length;qe<$e;qe++){const We=He[qe],ft=Ge[We.materialIndex];ft&&ft.visible&&x.push(A,Oe,ft,se,ie.z,We)}}else Ge.visible&&x.push(A,Oe,Ge,se,ie.z,null)}}const Ae=A.children;for(let Oe=0,Ge=Ae.length;Oe<Ge;Oe++)Pt(Ae[Oe],Y,se,ae)}function vt(A,Y,se,ae){const K=A.opaque,Ae=A.transmissive,Oe=A.transparent;d.setupLightsView(se),re===!0&&fe.setGlobalState(M.clippingPlanes,se),ae&&I.viewport(y.copy(ae)),K.length>0&&Et(K,Y,se),Ae.length>0&&Et(Ae,Y,se),Oe.length>0&&Et(Oe,Y,se),I.buffers.depth.setTest(!0),I.buffers.depth.setMask(!0),I.buffers.color.setMask(!0),I.setPolygonOffset(!1)}function Vt(A,Y,se,ae){if((se.isScene===!0?se.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[ae.id]===void 0&&(d.state.transmissionRenderTarget[ae.id]=new us(1,1,{generateMipmaps:!0,type:L.has("EXT_color_buffer_half_float")||L.has("EXT_color_buffer_float")?Wr:fi,minFilter:os,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ut.workingColorSpace}));const Ae=d.state.transmissionRenderTarget[ae.id],Oe=ae.viewport||y;Ae.setSize(Oe.z,Oe.w);const Ge=M.getRenderTarget();M.setRenderTarget(Ae),M.getClearColor(k),J=M.getClearAlpha(),J<1&&M.setClearColor(16777215,.5),M.clear(),we&&Ce.render(se);const He=M.toneMapping;M.toneMapping=Di;const qe=ae.viewport;if(ae.viewport!==void 0&&(ae.viewport=void 0),d.setupLightsView(ae),re===!0&&fe.setGlobalState(M.clippingPlanes,ae),Et(A,se,ae),S.updateMultisampleRenderTarget(Ae),S.updateRenderTargetMipmap(Ae),L.has("WEBGL_multisampled_render_to_texture")===!1){let $e=!1;for(let We=0,ft=Y.length;We<ft;We++){const xt=Y[We],Tt=xt.object,ln=xt.geometry,at=xt.material,Xe=xt.group;if(at.side===rt&&Tt.layers.test(ae.layers)){const Wt=at.side;at.side=an,at.needsUpdate=!0,_n(Tt,se,ae,ln,at,Xe),at.side=Wt,at.needsUpdate=!0,$e=!0}}$e===!0&&(S.updateMultisampleRenderTarget(Ae),S.updateRenderTargetMipmap(Ae))}M.setRenderTarget(Ge),M.setClearColor(k,J),qe!==void 0&&(ae.viewport=qe),M.toneMapping=He}function Et(A,Y,se){const ae=Y.isScene===!0?Y.overrideMaterial:null;for(let K=0,Ae=A.length;K<Ae;K++){const Oe=A[K],Ge=Oe.object,He=Oe.geometry,qe=ae===null?Oe.material:ae,$e=Oe.group;Ge.layers.test(se.layers)&&_n(Ge,Y,se,He,qe,$e)}}function _n(A,Y,se,ae,K,Ae){A.onBeforeRender(M,Y,se,ae,K,Ae),A.modelViewMatrix.multiplyMatrices(se.matrixWorldInverse,A.matrixWorld),A.normalMatrix.getNormalMatrix(A.modelViewMatrix),K.onBeforeRender(M,Y,se,ae,A,Ae),K.transparent===!0&&K.side===rt&&K.forceSinglePass===!1?(K.side=an,K.needsUpdate=!0,M.renderBufferDirect(se,Y,ae,K,A,Ae),K.side=Ni,K.needsUpdate=!0,M.renderBufferDirect(se,Y,ae,K,A,Ae),K.side=rt):M.renderBufferDirect(se,Y,ae,K,A,Ae),A.onAfterRender(M,Y,se,ae,K,Ae)}function qt(A,Y,se){Y.isScene!==!0&&(Y=ue);const ae=j.get(A),K=d.state.lights,Ae=d.state.shadowsArray,Oe=K.state.version,Ge=de.getParameters(A,K.state,Ae,Y,se),He=de.getProgramCacheKey(Ge);let qe=ae.programs;ae.environment=A.isMeshStandardMaterial?Y.environment:null,ae.fog=Y.fog,ae.envMap=(A.isMeshStandardMaterial?C:v).get(A.envMap||ae.environment),ae.envMapRotation=ae.environment!==null&&A.envMap===null?Y.environmentRotation:A.envMapRotation,qe===void 0&&(A.addEventListener("dispose",Ne),qe=new Map,ae.programs=qe);let $e=qe.get(He);if($e!==void 0){if(ae.currentProgram===$e&&ae.lightsStateVersion===Oe)return Kr(A,Ge),$e}else Ge.uniforms=de.getUniforms(A),A.onBeforeCompile(Ge,M),$e=de.acquireProgram(Ge,He),qe.set(He,$e),ae.uniforms=Ge.uniforms;const We=ae.uniforms;return(!A.isShaderMaterial&&!A.isRawShaderMaterial||A.clipping===!0)&&(We.clippingPlanes=fe.uniform),Kr(A,Ge),ae.needsLights=np(A),ae.lightsStateVersion=Oe,ae.needsLights&&(We.ambientLightColor.value=K.state.ambient,We.lightProbe.value=K.state.probe,We.directionalLights.value=K.state.directional,We.directionalLightShadows.value=K.state.directionalShadow,We.spotLights.value=K.state.spot,We.spotLightShadows.value=K.state.spotShadow,We.rectAreaLights.value=K.state.rectArea,We.ltc_1.value=K.state.rectAreaLTC1,We.ltc_2.value=K.state.rectAreaLTC2,We.pointLights.value=K.state.point,We.pointLightShadows.value=K.state.pointShadow,We.hemisphereLights.value=K.state.hemi,We.directionalShadowMap.value=K.state.directionalShadowMap,We.directionalShadowMatrix.value=K.state.directionalShadowMatrix,We.spotShadowMap.value=K.state.spotShadowMap,We.spotLightMatrix.value=K.state.spotLightMatrix,We.spotLightMap.value=K.state.spotLightMap,We.pointShadowMap.value=K.state.pointShadowMap,We.pointShadowMatrix.value=K.state.pointShadowMatrix),ae.currentProgram=$e,ae.uniformsList=null,$e}function jr(A){if(A.uniformsList===null){const Y=A.currentProgram.getUniforms();A.uniformsList=Bo.seqWithValue(Y.seq,A.uniforms)}return A.uniformsList}function Kr(A,Y){const se=j.get(A);se.outputColorSpace=Y.outputColorSpace,se.batching=Y.batching,se.batchingColor=Y.batchingColor,se.instancing=Y.instancing,se.instancingColor=Y.instancingColor,se.instancingMorph=Y.instancingMorph,se.skinning=Y.skinning,se.morphTargets=Y.morphTargets,se.morphNormals=Y.morphNormals,se.morphColors=Y.morphColors,se.morphTargetsCount=Y.morphTargetsCount,se.numClippingPlanes=Y.numClippingPlanes,se.numIntersection=Y.numClipIntersection,se.vertexAlphas=Y.vertexAlphas,se.vertexTangents=Y.vertexTangents,se.toneMapping=Y.toneMapping}function Zr(A,Y,se,ae,K){Y.isScene!==!0&&(Y=ue),S.resetTextureUnits();const Ae=Y.fog,Oe=ae.isMeshStandardMaterial?Y.environment:null,Ge=R===null?M.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:Bi,He=(ae.isMeshStandardMaterial?C:v).get(ae.envMap||Oe),qe=ae.vertexColors===!0&&!!se.attributes.color&&se.attributes.color.itemSize===4,$e=!!se.attributes.tangent&&(!!ae.normalMap||ae.anisotropy>0),We=!!se.morphAttributes.position,ft=!!se.morphAttributes.normal,xt=!!se.morphAttributes.color;let Tt=Di;ae.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(Tt=M.toneMapping);const ln=se.morphAttributes.position||se.morphAttributes.normal||se.morphAttributes.color,at=ln!==void 0?ln.length:0,Xe=j.get(ae),Wt=d.state.lights;if(re===!0&&(he===!0||A!==ne)){const vn=A===ne&&ae.id===U;fe.setState(ae,A,vn)}let lt=!1;ae.version===Xe.__version?(Xe.needsLights&&Xe.lightsStateVersion!==Wt.state.version||Xe.outputColorSpace!==Ge||K.isBatchedMesh&&Xe.batching===!1||!K.isBatchedMesh&&Xe.batching===!0||K.isBatchedMesh&&Xe.batchingColor===!0&&K.colorTexture===null||K.isBatchedMesh&&Xe.batchingColor===!1&&K.colorTexture!==null||K.isInstancedMesh&&Xe.instancing===!1||!K.isInstancedMesh&&Xe.instancing===!0||K.isSkinnedMesh&&Xe.skinning===!1||!K.isSkinnedMesh&&Xe.skinning===!0||K.isInstancedMesh&&Xe.instancingColor===!0&&K.instanceColor===null||K.isInstancedMesh&&Xe.instancingColor===!1&&K.instanceColor!==null||K.isInstancedMesh&&Xe.instancingMorph===!0&&K.morphTexture===null||K.isInstancedMesh&&Xe.instancingMorph===!1&&K.morphTexture!==null||Xe.envMap!==He||ae.fog===!0&&Xe.fog!==Ae||Xe.numClippingPlanes!==void 0&&(Xe.numClippingPlanes!==fe.numPlanes||Xe.numIntersection!==fe.numIntersection)||Xe.vertexAlphas!==qe||Xe.vertexTangents!==$e||Xe.morphTargets!==We||Xe.morphNormals!==ft||Xe.morphColors!==xt||Xe.toneMapping!==Tt||Xe.morphTargetsCount!==at)&&(lt=!0):(lt=!0,Xe.__version=ae.version);let bn=Xe.currentProgram;lt===!0&&(bn=qt(ae,Y,K));let ms=!1,cn=!1,pa=!1;const At=bn.getUniforms(),_i=Xe.uniforms;if(I.useProgram(bn.program)&&(ms=!0,cn=!0,pa=!0),ae.id!==U&&(U=ae.id,cn=!0),ms||ne!==A){N.reverseDepthBuffer?(Se.copy(A.projectionMatrix),G_(Se),H_(Se),At.setValue(g,"projectionMatrix",Se)):At.setValue(g,"projectionMatrix",A.projectionMatrix),At.setValue(g,"viewMatrix",A.matrixWorldInverse);const vn=At.map.cameraPosition;vn!==void 0&&vn.setValue(g,le.setFromMatrixPosition(A.matrixWorld)),N.logarithmicDepthBuffer&&At.setValue(g,"logDepthBufFC",2/(Math.log(A.far+1)/Math.LN2)),(ae.isMeshPhongMaterial||ae.isMeshToonMaterial||ae.isMeshLambertMaterial||ae.isMeshBasicMaterial||ae.isMeshStandardMaterial||ae.isShaderMaterial)&&At.setValue(g,"isOrthographic",A.isOrthographicCamera===!0),ne!==A&&(ne=A,cn=!0,pa=!0)}if(K.isSkinnedMesh){At.setOptional(g,K,"bindMatrix"),At.setOptional(g,K,"bindMatrixInverse");const vn=K.skeleton;vn&&(vn.boneTexture===null&&vn.computeBoneTexture(),At.setValue(g,"boneTexture",vn.boneTexture,S))}K.isBatchedMesh&&(At.setOptional(g,K,"batchingTexture"),At.setValue(g,"batchingTexture",K._matricesTexture,S),At.setOptional(g,K,"batchingIdTexture"),At.setValue(g,"batchingIdTexture",K._indirectTexture,S),At.setOptional(g,K,"batchingColorTexture"),K._colorsTexture!==null&&At.setValue(g,"batchingColorTexture",K._colorsTexture,S));const ma=se.morphAttributes;if((ma.position!==void 0||ma.normal!==void 0||ma.color!==void 0)&&Re.update(K,se,bn),(cn||Xe.receiveShadow!==K.receiveShadow)&&(Xe.receiveShadow=K.receiveShadow,At.setValue(g,"receiveShadow",K.receiveShadow)),ae.isMeshGouraudMaterial&&ae.envMap!==null&&(_i.envMap.value=He,_i.flipEnvMap.value=He.isCubeTexture&&He.isRenderTargetTexture===!1?-1:1),ae.isMeshStandardMaterial&&ae.envMap===null&&Y.environment!==null&&(_i.envMapIntensity.value=Y.environmentIntensity),cn&&(At.setValue(g,"toneMappingExposure",M.toneMappingExposure),Xe.needsLights&&tp(_i,pa),Ae&&ae.fog===!0&&ce.refreshFogUniforms(_i,Ae),ce.refreshMaterialUniforms(_i,ae,Z,G,d.state.transmissionRenderTarget[A.id]),Bo.upload(g,jr(Xe),_i,S)),ae.isShaderMaterial&&ae.uniformsNeedUpdate===!0&&(Bo.upload(g,jr(Xe),_i,S),ae.uniformsNeedUpdate=!1),ae.isSpriteMaterial&&At.setValue(g,"center",K.center),At.setValue(g,"modelViewMatrix",K.modelViewMatrix),At.setValue(g,"normalMatrix",K.normalMatrix),At.setValue(g,"modelMatrix",K.matrixWorld),ae.isShaderMaterial||ae.isRawShaderMaterial){const vn=ae.uniformsGroups;for(let ga=0,ip=vn.length;ga<ip;ga++){const Qc=vn[ga];z.update(Qc,bn),z.bind(Qc,bn)}}return bn}function tp(A,Y){A.ambientLightColor.needsUpdate=Y,A.lightProbe.needsUpdate=Y,A.directionalLights.needsUpdate=Y,A.directionalLightShadows.needsUpdate=Y,A.pointLights.needsUpdate=Y,A.pointLightShadows.needsUpdate=Y,A.spotLights.needsUpdate=Y,A.spotLightShadows.needsUpdate=Y,A.rectAreaLights.needsUpdate=Y,A.hemisphereLights.needsUpdate=Y}function np(A){return A.isMeshLambertMaterial||A.isMeshToonMaterial||A.isMeshPhongMaterial||A.isMeshStandardMaterial||A.isShadowMaterial||A.isShaderMaterial&&A.lights===!0}this.getActiveCubeFace=function(){return O},this.getActiveMipmapLevel=function(){return P},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(A,Y,se){j.get(A.texture).__webglTexture=Y,j.get(A.depthTexture).__webglTexture=se;const ae=j.get(A);ae.__hasExternalTextures=!0,ae.__autoAllocateDepthBuffer=se===void 0,ae.__autoAllocateDepthBuffer||L.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),ae.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(A,Y){const se=j.get(A);se.__webglFramebuffer=Y,se.__useDefaultFramebuffer=Y===void 0},this.setRenderTarget=function(A,Y=0,se=0){R=A,O=Y,P=se;let ae=!0,K=null,Ae=!1,Oe=!1;if(A){const He=j.get(A);if(He.__useDefaultFramebuffer!==void 0)I.bindFramebuffer(g.FRAMEBUFFER,null),ae=!1;else if(He.__webglFramebuffer===void 0)S.setupRenderTarget(A);else if(He.__hasExternalTextures)S.rebindTextures(A,j.get(A.texture).__webglTexture,j.get(A.depthTexture).__webglTexture);else if(A.depthBuffer){const We=A.depthTexture;if(He.__boundDepthTexture!==We){if(We!==null&&j.has(We)&&(A.width!==We.image.width||A.height!==We.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");S.setupDepthRenderbuffer(A)}}const qe=A.texture;(qe.isData3DTexture||qe.isDataArrayTexture||qe.isCompressedArrayTexture)&&(Oe=!0);const $e=j.get(A).__webglFramebuffer;A.isWebGLCubeRenderTarget?(Array.isArray($e[Y])?K=$e[Y][se]:K=$e[Y],Ae=!0):A.samples>0&&S.useMultisampledRTT(A)===!1?K=j.get(A).__webglMultisampledFramebuffer:Array.isArray($e)?K=$e[se]:K=$e,y.copy(A.viewport),E.copy(A.scissor),$=A.scissorTest}else y.copy(ve).multiplyScalar(Z).floor(),E.copy(_e).multiplyScalar(Z).floor(),$=Te;if(I.bindFramebuffer(g.FRAMEBUFFER,K)&&ae&&I.drawBuffers(A,K),I.viewport(y),I.scissor(E),I.setScissorTest($),Ae){const He=j.get(A.texture);g.framebufferTexture2D(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_CUBE_MAP_POSITIVE_X+Y,He.__webglTexture,se)}else if(Oe){const He=j.get(A.texture),qe=Y||0;g.framebufferTextureLayer(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,He.__webglTexture,se||0,qe)}U=-1},this.readRenderTargetPixels=function(A,Y,se,ae,K,Ae,Oe){if(!(A&&A.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ge=j.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Oe!==void 0&&(Ge=Ge[Oe]),Ge){I.bindFramebuffer(g.FRAMEBUFFER,Ge);try{const He=A.texture,qe=He.format,$e=He.type;if(!N.textureFormatReadable(qe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!N.textureTypeReadable($e)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Y>=0&&Y<=A.width-ae&&se>=0&&se<=A.height-K&&g.readPixels(Y,se,ae,K,Pe.convert(qe),Pe.convert($e),Ae)}finally{const He=R!==null?j.get(R).__webglFramebuffer:null;I.bindFramebuffer(g.FRAMEBUFFER,He)}}},this.readRenderTargetPixelsAsync=async function(A,Y,se,ae,K,Ae,Oe){if(!(A&&A.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ge=j.get(A).__webglFramebuffer;if(A.isWebGLCubeRenderTarget&&Oe!==void 0&&(Ge=Ge[Oe]),Ge){const He=A.texture,qe=He.format,$e=He.type;if(!N.textureFormatReadable(qe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!N.textureTypeReadable($e))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(Y>=0&&Y<=A.width-ae&&se>=0&&se<=A.height-K){I.bindFramebuffer(g.FRAMEBUFFER,Ge);const We=g.createBuffer();g.bindBuffer(g.PIXEL_PACK_BUFFER,We),g.bufferData(g.PIXEL_PACK_BUFFER,Ae.byteLength,g.STREAM_READ),g.readPixels(Y,se,ae,K,Pe.convert(qe),Pe.convert($e),0);const ft=R!==null?j.get(R).__webglFramebuffer:null;I.bindFramebuffer(g.FRAMEBUFFER,ft);const xt=g.fenceSync(g.SYNC_GPU_COMMANDS_COMPLETE,0);return g.flush(),await z_(g,xt,4),g.bindBuffer(g.PIXEL_PACK_BUFFER,We),g.getBufferSubData(g.PIXEL_PACK_BUFFER,0,Ae),g.deleteBuffer(We),g.deleteSync(xt),Ae}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(A,Y=null,se=0){A.isTexture!==!0&&(Oo("WebGLRenderer: copyFramebufferToTexture function signature has changed."),Y=arguments[0]||null,A=arguments[1]);const ae=Math.pow(2,-se),K=Math.floor(A.image.width*ae),Ae=Math.floor(A.image.height*ae),Oe=Y!==null?Y.x:0,Ge=Y!==null?Y.y:0;S.setTexture2D(A,0),g.copyTexSubImage2D(g.TEXTURE_2D,se,0,0,Oe,Ge,K,Ae),I.unbindTexture()},this.copyTextureToTexture=function(A,Y,se=null,ae=null,K=0){A.isTexture!==!0&&(Oo("WebGLRenderer: copyTextureToTexture function signature has changed."),ae=arguments[0]||null,A=arguments[1],Y=arguments[2],K=arguments[3]||0,se=null);let Ae,Oe,Ge,He,qe,$e;se!==null?(Ae=se.max.x-se.min.x,Oe=se.max.y-se.min.y,Ge=se.min.x,He=se.min.y):(Ae=A.image.width,Oe=A.image.height,Ge=0,He=0),ae!==null?(qe=ae.x,$e=ae.y):(qe=0,$e=0);const We=Pe.convert(Y.format),ft=Pe.convert(Y.type);S.setTexture2D(Y,0),g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,Y.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Y.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,Y.unpackAlignment);const xt=g.getParameter(g.UNPACK_ROW_LENGTH),Tt=g.getParameter(g.UNPACK_IMAGE_HEIGHT),ln=g.getParameter(g.UNPACK_SKIP_PIXELS),at=g.getParameter(g.UNPACK_SKIP_ROWS),Xe=g.getParameter(g.UNPACK_SKIP_IMAGES),Wt=A.isCompressedTexture?A.mipmaps[K]:A.image;g.pixelStorei(g.UNPACK_ROW_LENGTH,Wt.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,Wt.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Ge),g.pixelStorei(g.UNPACK_SKIP_ROWS,He),A.isDataTexture?g.texSubImage2D(g.TEXTURE_2D,K,qe,$e,Ae,Oe,We,ft,Wt.data):A.isCompressedTexture?g.compressedTexSubImage2D(g.TEXTURE_2D,K,qe,$e,Wt.width,Wt.height,We,Wt.data):g.texSubImage2D(g.TEXTURE_2D,K,qe,$e,Ae,Oe,We,ft,Wt),g.pixelStorei(g.UNPACK_ROW_LENGTH,xt),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,Tt),g.pixelStorei(g.UNPACK_SKIP_PIXELS,ln),g.pixelStorei(g.UNPACK_SKIP_ROWS,at),g.pixelStorei(g.UNPACK_SKIP_IMAGES,Xe),K===0&&Y.generateMipmaps&&g.generateMipmap(g.TEXTURE_2D),I.unbindTexture()},this.copyTextureToTexture3D=function(A,Y,se=null,ae=null,K=0){A.isTexture!==!0&&(Oo("WebGLRenderer: copyTextureToTexture3D function signature has changed."),se=arguments[0]||null,ae=arguments[1]||null,A=arguments[2],Y=arguments[3],K=arguments[4]||0);let Ae,Oe,Ge,He,qe,$e,We,ft,xt;const Tt=A.isCompressedTexture?A.mipmaps[K]:A.image;se!==null?(Ae=se.max.x-se.min.x,Oe=se.max.y-se.min.y,Ge=se.max.z-se.min.z,He=se.min.x,qe=se.min.y,$e=se.min.z):(Ae=Tt.width,Oe=Tt.height,Ge=Tt.depth,He=0,qe=0,$e=0),ae!==null?(We=ae.x,ft=ae.y,xt=ae.z):(We=0,ft=0,xt=0);const ln=Pe.convert(Y.format),at=Pe.convert(Y.type);let Xe;if(Y.isData3DTexture)S.setTexture3D(Y,0),Xe=g.TEXTURE_3D;else if(Y.isDataArrayTexture||Y.isCompressedArrayTexture)S.setTexture2DArray(Y,0),Xe=g.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,Y.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Y.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,Y.unpackAlignment);const Wt=g.getParameter(g.UNPACK_ROW_LENGTH),lt=g.getParameter(g.UNPACK_IMAGE_HEIGHT),bn=g.getParameter(g.UNPACK_SKIP_PIXELS),ms=g.getParameter(g.UNPACK_SKIP_ROWS),cn=g.getParameter(g.UNPACK_SKIP_IMAGES);g.pixelStorei(g.UNPACK_ROW_LENGTH,Tt.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,Tt.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,He),g.pixelStorei(g.UNPACK_SKIP_ROWS,qe),g.pixelStorei(g.UNPACK_SKIP_IMAGES,$e),A.isDataTexture||A.isData3DTexture?g.texSubImage3D(Xe,K,We,ft,xt,Ae,Oe,Ge,ln,at,Tt.data):Y.isCompressedArrayTexture?g.compressedTexSubImage3D(Xe,K,We,ft,xt,Ae,Oe,Ge,ln,Tt.data):g.texSubImage3D(Xe,K,We,ft,xt,Ae,Oe,Ge,ln,at,Tt),g.pixelStorei(g.UNPACK_ROW_LENGTH,Wt),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,lt),g.pixelStorei(g.UNPACK_SKIP_PIXELS,bn),g.pixelStorei(g.UNPACK_SKIP_ROWS,ms),g.pixelStorei(g.UNPACK_SKIP_IMAGES,cn),K===0&&Y.generateMipmaps&&g.generateMipmap(Xe),I.unbindTexture()},this.initRenderTarget=function(A){j.get(A).__webglFramebuffer===void 0&&S.setupRenderTarget(A)},this.initTexture=function(A){A.isCubeTexture?S.setTextureCube(A,0):A.isData3DTexture?S.setTexture3D(A,0):A.isDataArrayTexture||A.isCompressedArrayTexture?S.setTexture2DArray(A,0):S.setTexture2D(A,0),I.unbindTexture()},this.resetState=function(){O=0,P=0,R=null,I.reset(),ze.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ci}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Wc?"display-p3":"srgb",t.unpackColorSpace=ut.workingColorSpace===ua?"display-p3":"srgb"}}class Gi extends Zt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Yn,this.environmentIntensity=1,this.environmentRotation=new Yn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(t.object.environmentIntensity=this.environmentIntensity),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class Kn{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,t){const i=this.getUtoTmapping(e);return this.getPoint(i,t)}getPoints(e=5){const t=[];for(let i=0;i<=e;i++)t.push(this.getPoint(i/e));return t}getSpacedPoints(e=5){const t=[];for(let i=0;i<=e;i++)t.push(this.getPointAt(i/e));return t}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const t=[];let i,s=this.getPoint(0),r=0;t.push(0);for(let o=1;o<=e;o++)i=this.getPoint(o/e),r+=i.distanceTo(s),t.push(r),s=i;return this.cacheArcLengths=t,t}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,t){const i=this.getLengths();let s=0;const r=i.length;let o;t?o=t:o=e*i[r-1];let a=0,l=r-1,c;for(;a<=l;)if(s=Math.floor(a+(l-a)/2),c=i[s]-o,c<0)a=s+1;else if(c>0)l=s-1;else{l=s;break}if(s=l,i[s]===o)return s/(r-1);const h=i[s],f=i[s+1]-h,p=(o-h)/f;return(s+p)/(r-1)}getTangent(e,t){let s=e-1e-4,r=e+1e-4;s<0&&(s=0),r>1&&(r=1);const o=this.getPoint(s),a=this.getPoint(r),l=t||(o.isVector2?new Ue:new W);return l.copy(a).sub(o).normalize(),l}getTangentAt(e,t){const i=this.getUtoTmapping(e);return this.getTangent(i,t)}computeFrenetFrames(e,t){const i=new W,s=[],r=[],o=[],a=new W,l=new St;for(let p=0;p<=e;p++){const _=p/e;s[p]=this.getTangentAt(_,new W)}r[0]=new W,o[0]=new W;let c=Number.MAX_VALUE;const h=Math.abs(s[0].x),u=Math.abs(s[0].y),f=Math.abs(s[0].z);h<=c&&(c=h,i.set(1,0,0)),u<=c&&(c=u,i.set(0,1,0)),f<=c&&i.set(0,0,1),a.crossVectors(s[0],i).normalize(),r[0].crossVectors(s[0],a),o[0].crossVectors(s[0],r[0]);for(let p=1;p<=e;p++){if(r[p]=r[p-1].clone(),o[p]=o[p-1].clone(),a.crossVectors(s[p-1],s[p]),a.length()>Number.EPSILON){a.normalize();const _=Math.acos(Ht(s[p-1].dot(s[p]),-1,1));r[p].applyMatrix4(l.makeRotationAxis(a,_))}o[p].crossVectors(s[p],r[p])}if(t===!0){let p=Math.acos(Ht(r[0].dot(r[e]),-1,1));p/=e,s[0].dot(a.crossVectors(r[0],r[e]))>0&&(p=-p);for(let _=1;_<=e;_++)r[_].applyMatrix4(l.makeRotationAxis(s[_],p*_)),o[_].crossVectors(s[_],r[_])}return{tangents:s,normals:r,binormals:o}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}class jc extends Kn{constructor(e=0,t=0,i=1,s=1,r=0,o=Math.PI*2,a=!1,l=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=e,this.aY=t,this.xRadius=i,this.yRadius=s,this.aStartAngle=r,this.aEndAngle=o,this.aClockwise=a,this.aRotation=l}getPoint(e,t=new Ue){const i=t,s=Math.PI*2;let r=this.aEndAngle-this.aStartAngle;const o=Math.abs(r)<Number.EPSILON;for(;r<0;)r+=s;for(;r>s;)r-=s;r<Number.EPSILON&&(o?r=0:r=s),this.aClockwise===!0&&!o&&(r===s?r=-s:r=r-s);const a=this.aStartAngle+e*r;let l=this.aX+this.xRadius*Math.cos(a),c=this.aY+this.yRadius*Math.sin(a);if(this.aRotation!==0){const h=Math.cos(this.aRotation),u=Math.sin(this.aRotation),f=l-this.aX,p=c-this.aY;l=f*h-p*u+this.aX,c=f*u+p*h+this.aY}return i.set(l,c)}copy(e){return super.copy(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}toJSON(){const e=super.toJSON();return e.aX=this.aX,e.aY=this.aY,e.xRadius=this.xRadius,e.yRadius=this.yRadius,e.aStartAngle=this.aStartAngle,e.aEndAngle=this.aEndAngle,e.aClockwise=this.aClockwise,e.aRotation=this.aRotation,e}fromJSON(e){return super.fromJSON(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}}class JS extends jc{constructor(e,t,i,s,r,o){super(e,t,i,i,s,r,o),this.isArcCurve=!0,this.type="ArcCurve"}}function Kc(){let n=0,e=0,t=0,i=0;function s(r,o,a,l){n=r,e=a,t=-3*r+3*o-2*a-l,i=2*r-2*o+a+l}return{initCatmullRom:function(r,o,a,l,c){s(o,a,c*(a-r),c*(l-o))},initNonuniformCatmullRom:function(r,o,a,l,c,h,u){let f=(o-r)/c-(a-r)/(c+h)+(a-o)/h,p=(a-o)/h-(l-o)/(h+u)+(l-a)/u;f*=h,p*=h,s(o,a,f,p)},calc:function(r){const o=r*r,a=o*r;return n+e*r+t*o+i*a}}}const To=new W,ol=new Kc,al=new Kc,ll=new Kc;class QS extends Kn{constructor(e=[],t=!1,i="centripetal",s=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=t,this.curveType=i,this.tension=s}getPoint(e,t=new W){const i=t,s=this.points,r=s.length,o=(r-(this.closed?0:1))*e;let a=Math.floor(o),l=o-a;this.closed?a+=a>0?0:(Math.floor(Math.abs(a)/r)+1)*r:l===0&&a===r-1&&(a=r-2,l=1);let c,h;this.closed||a>0?c=s[(a-1)%r]:(To.subVectors(s[0],s[1]).add(s[0]),c=To);const u=s[a%r],f=s[(a+1)%r];if(this.closed||a+2<r?h=s[(a+2)%r]:(To.subVectors(s[r-1],s[r-2]).add(s[r-1]),h=To),this.curveType==="centripetal"||this.curveType==="chordal"){const p=this.curveType==="chordal"?.5:.25;let _=Math.pow(c.distanceToSquared(u),p),x=Math.pow(u.distanceToSquared(f),p),d=Math.pow(f.distanceToSquared(h),p);x<1e-4&&(x=1),_<1e-4&&(_=x),d<1e-4&&(d=x),ol.initNonuniformCatmullRom(c.x,u.x,f.x,h.x,_,x,d),al.initNonuniformCatmullRom(c.y,u.y,f.y,h.y,_,x,d),ll.initNonuniformCatmullRom(c.z,u.z,f.z,h.z,_,x,d)}else this.curveType==="catmullrom"&&(ol.initCatmullRom(c.x,u.x,f.x,h.x,this.tension),al.initCatmullRom(c.y,u.y,f.y,h.y,this.tension),ll.initCatmullRom(c.z,u.z,f.z,h.z,this.tension));return i.set(ol.calc(l),al.calc(l),ll.calc(l)),i}copy(e){super.copy(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const s=e.points[t];this.points.push(s.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,i=this.points.length;t<i;t++){const s=this.points[t];e.points.push(s.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const s=e.points[t];this.points.push(new W().fromArray(s))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}function Wh(n,e,t,i,s){const r=(i-e)*.5,o=(s-t)*.5,a=n*n,l=n*a;return(2*t-2*i+r+o)*l+(-3*t+3*i-2*r-o)*a+r*n+t}function ew(n,e){const t=1-n;return t*t*e}function tw(n,e){return 2*(1-n)*n*e}function nw(n,e){return n*n*e}function br(n,e,t,i){return ew(n,e)+tw(n,t)+nw(n,i)}function iw(n,e){const t=1-n;return t*t*t*e}function sw(n,e){const t=1-n;return 3*t*t*n*e}function rw(n,e){return 3*(1-n)*n*n*e}function ow(n,e){return n*n*n*e}function Tr(n,e,t,i,s){return iw(n,e)+sw(n,t)+rw(n,i)+ow(n,s)}class Wd extends Kn{constructor(e=new Ue,t=new Ue,i=new Ue,s=new Ue){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=e,this.v1=t,this.v2=i,this.v3=s}getPoint(e,t=new Ue){const i=t,s=this.v0,r=this.v1,o=this.v2,a=this.v3;return i.set(Tr(e,s.x,r.x,o.x,a.x),Tr(e,s.y,r.y,o.y,a.y)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class aw extends Kn{constructor(e=new W,t=new W,i=new W,s=new W){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=e,this.v1=t,this.v2=i,this.v3=s}getPoint(e,t=new W){const i=t,s=this.v0,r=this.v1,o=this.v2,a=this.v3;return i.set(Tr(e,s.x,r.x,o.x,a.x),Tr(e,s.y,r.y,o.y,a.y),Tr(e,s.z,r.z,o.z,a.z)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class Xd extends Kn{constructor(e=new Ue,t=new Ue){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=e,this.v2=t}getPoint(e,t=new Ue){const i=t;return e===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(e).add(this.v1)),i}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new Ue){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class lw extends Kn{constructor(e=new W,t=new W){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=e,this.v2=t}getPoint(e,t=new W){const i=t;return e===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(e).add(this.v1)),i}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new W){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class qd extends Kn{constructor(e=new Ue,t=new Ue,i=new Ue){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=e,this.v1=t,this.v2=i}getPoint(e,t=new Ue){const i=t,s=this.v0,r=this.v1,o=this.v2;return i.set(br(e,s.x,r.x,o.x),br(e,s.y,r.y,o.y)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class cw extends Kn{constructor(e=new W,t=new W,i=new W){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=e,this.v1=t,this.v2=i}getPoint(e,t=new W){const i=t,s=this.v0,r=this.v1,o=this.v2;return i.set(br(e,s.x,r.x,o.x),br(e,s.y,r.y,o.y),br(e,s.z,r.z,o.z)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Yd extends Kn{constructor(e=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=e}getPoint(e,t=new Ue){const i=t,s=this.points,r=(s.length-1)*e,o=Math.floor(r),a=r-o,l=s[o===0?o:o-1],c=s[o],h=s[o>s.length-2?s.length-1:o+1],u=s[o>s.length-3?s.length-1:o+2];return i.set(Wh(a,l.x,c.x,h.x,u.x),Wh(a,l.y,c.y,h.y,u.y)),i}copy(e){super.copy(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const s=e.points[t];this.points.push(s.clone())}return this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,i=this.points.length;t<i;t++){const s=this.points[t];e.points.push(s.toArray())}return e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const s=e.points[t];this.points.push(new Ue().fromArray(s))}return this}}var cc=Object.freeze({__proto__:null,ArcCurve:JS,CatmullRomCurve3:QS,CubicBezierCurve:Wd,CubicBezierCurve3:aw,EllipseCurve:jc,LineCurve:Xd,LineCurve3:lw,QuadraticBezierCurve:qd,QuadraticBezierCurve3:cw,SplineCurve:Yd});class uw extends Kn{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(e){this.curves.push(e)}closePath(){const e=this.curves[0].getPoint(0),t=this.curves[this.curves.length-1].getPoint(1);if(!e.equals(t)){const i=e.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new cc[i](t,e))}return this}getPoint(e,t){const i=e*this.getLength(),s=this.getCurveLengths();let r=0;for(;r<s.length;){if(s[r]>=i){const o=s[r]-i,a=this.curves[r],l=a.getLength(),c=l===0?0:1-o/l;return a.getPointAt(c,t)}r++}return null}getLength(){const e=this.getCurveLengths();return e[e.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const e=[];let t=0;for(let i=0,s=this.curves.length;i<s;i++)t+=this.curves[i].getLength(),e.push(t);return this.cacheLengths=e,e}getSpacedPoints(e=40){const t=[];for(let i=0;i<=e;i++)t.push(this.getPoint(i/e));return this.autoClose&&t.push(t[0]),t}getPoints(e=12){const t=[];let i;for(let s=0,r=this.curves;s<r.length;s++){const o=r[s],a=o.isEllipseCurve?e*2:o.isLineCurve||o.isLineCurve3?1:o.isSplineCurve?e*o.points.length:e,l=o.getPoints(a);for(let c=0;c<l.length;c++){const h=l[c];i&&i.equals(h)||(t.push(h),i=h)}}return this.autoClose&&t.length>1&&!t[t.length-1].equals(t[0])&&t.push(t[0]),t}copy(e){super.copy(e),this.curves=[];for(let t=0,i=e.curves.length;t<i;t++){const s=e.curves[t];this.curves.push(s.clone())}return this.autoClose=e.autoClose,this}toJSON(){const e=super.toJSON();e.autoClose=this.autoClose,e.curves=[];for(let t=0,i=this.curves.length;t<i;t++){const s=this.curves[t];e.curves.push(s.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.autoClose=e.autoClose,this.curves=[];for(let t=0,i=e.curves.length;t<i;t++){const s=e.curves[t];this.curves.push(new cc[s.type]().fromJSON(s))}return this}}class uc extends uw{constructor(e){super(),this.type="Path",this.currentPoint=new Ue,e&&this.setFromPoints(e)}setFromPoints(e){this.moveTo(e[0].x,e[0].y);for(let t=1,i=e.length;t<i;t++)this.lineTo(e[t].x,e[t].y);return this}moveTo(e,t){return this.currentPoint.set(e,t),this}lineTo(e,t){const i=new Xd(this.currentPoint.clone(),new Ue(e,t));return this.curves.push(i),this.currentPoint.set(e,t),this}quadraticCurveTo(e,t,i,s){const r=new qd(this.currentPoint.clone(),new Ue(e,t),new Ue(i,s));return this.curves.push(r),this.currentPoint.set(i,s),this}bezierCurveTo(e,t,i,s,r,o){const a=new Wd(this.currentPoint.clone(),new Ue(e,t),new Ue(i,s),new Ue(r,o));return this.curves.push(a),this.currentPoint.set(r,o),this}splineThru(e){const t=[this.currentPoint.clone()].concat(e),i=new Yd(t);return this.curves.push(i),this.currentPoint.copy(e[e.length-1]),this}arc(e,t,i,s,r,o){const a=this.currentPoint.x,l=this.currentPoint.y;return this.absarc(e+a,t+l,i,s,r,o),this}absarc(e,t,i,s,r,o){return this.absellipse(e,t,i,i,s,r,o),this}ellipse(e,t,i,s,r,o,a,l){const c=this.currentPoint.x,h=this.currentPoint.y;return this.absellipse(e+c,t+h,i,s,r,o,a,l),this}absellipse(e,t,i,s,r,o,a,l){const c=new jc(e,t,i,s,r,o,a,l);if(this.curves.length>0){const u=c.getPoint(0);u.equals(this.currentPoint)||this.lineTo(u.x,u.y)}this.curves.push(c);const h=c.getPoint(1);return this.currentPoint.copy(h),this}copy(e){return super.copy(e),this.currentPoint.copy(e.currentPoint),this}toJSON(){const e=super.toJSON();return e.currentPoint=this.currentPoint.toArray(),e}fromJSON(e){return super.fromJSON(e),this.currentPoint.fromArray(e.currentPoint),this}}class _t extends En{constructor(e=1,t=32,i=0,s=Math.PI*2){super(),this.type="CircleGeometry",this.parameters={radius:e,segments:t,thetaStart:i,thetaLength:s},t=Math.max(3,t);const r=[],o=[],a=[],l=[],c=new W,h=new Ue;o.push(0,0,0),a.push(0,0,1),l.push(.5,.5);for(let u=0,f=3;u<=t;u++,f+=3){const p=i+u/t*s;c.x=e*Math.cos(p),c.y=e*Math.sin(p),o.push(c.x,c.y,c.z),a.push(0,0,1),h.x=(o[f]/e+1)/2,h.y=(o[f+1]/e+1)/2,l.push(h.x,h.y)}for(let u=1;u<=t;u++)r.push(u,u+1,0);this.setIndex(r),this.setAttribute("position",new Rt(o,3)),this.setAttribute("normal",new Rt(a,3)),this.setAttribute("uv",new Rt(l,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new _t(e.radius,e.segments,e.thetaStart,e.thetaLength)}}class Sn extends En{constructor(e=1,t=1,i=1,s=32,r=1,o=!1,a=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:t,height:i,radialSegments:s,heightSegments:r,openEnded:o,thetaStart:a,thetaLength:l};const c=this;s=Math.floor(s),r=Math.floor(r);const h=[],u=[],f=[],p=[];let _=0;const x=[],d=i/2;let m=0;b(),o===!1&&(e>0&&M(!0),t>0&&M(!1)),this.setIndex(h),this.setAttribute("position",new Rt(u,3)),this.setAttribute("normal",new Rt(f,3)),this.setAttribute("uv",new Rt(p,2));function b(){const w=new W,O=new W;let P=0;const R=(t-e)/i;for(let U=0;U<=r;U++){const ne=[],y=U/r,E=y*(t-e)+e;for(let $=0;$<=s;$++){const k=$/s,J=k*l+a,oe=Math.sin(J),G=Math.cos(J);O.x=E*oe,O.y=-y*i+d,O.z=E*G,u.push(O.x,O.y,O.z),w.set(oe,R,G).normalize(),f.push(w.x,w.y,w.z),p.push(k,1-y),ne.push(_++)}x.push(ne)}for(let U=0;U<s;U++)for(let ne=0;ne<r;ne++){const y=x[ne][U],E=x[ne+1][U],$=x[ne+1][U+1],k=x[ne][U+1];e>0&&(h.push(y,E,k),P+=3),t>0&&(h.push(E,$,k),P+=3)}c.addGroup(m,P,0),m+=P}function M(w){const O=_,P=new Ue,R=new W;let U=0;const ne=w===!0?e:t,y=w===!0?1:-1;for(let $=1;$<=s;$++)u.push(0,d*y,0),f.push(0,y,0),p.push(.5,.5),_++;const E=_;for(let $=0;$<=s;$++){const J=$/s*l+a,oe=Math.cos(J),G=Math.sin(J);R.x=ne*G,R.y=d*y,R.z=ne*oe,u.push(R.x,R.y,R.z),f.push(0,y,0),P.x=oe*.5+.5,P.y=G*.5*y+.5,p.push(P.x,P.y),_++}for(let $=0;$<s;$++){const k=O+$,J=E+$;w===!0?h.push(J,J+1,k):h.push(J+1,J,k),U+=3}c.addGroup(m,U,w===!0?1:2),m+=U}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Sn(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class gn extends uc{constructor(e){super(e),this.uuid=ds(),this.type="Shape",this.holes=[]}getPointsHoles(e){const t=[];for(let i=0,s=this.holes.length;i<s;i++)t[i]=this.holes[i].getPoints(e);return t}extractPoints(e){return{shape:this.getPoints(e),holes:this.getPointsHoles(e)}}copy(e){super.copy(e),this.holes=[];for(let t=0,i=e.holes.length;t<i;t++){const s=e.holes[t];this.holes.push(s.clone())}return this}toJSON(){const e=super.toJSON();e.uuid=this.uuid,e.holes=[];for(let t=0,i=this.holes.length;t<i;t++){const s=this.holes[t];e.holes.push(s.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.uuid=e.uuid,this.holes=[];for(let t=0,i=e.holes.length;t<i;t++){const s=e.holes[t];this.holes.push(new uc().fromJSON(s))}return this}}const hw={triangulate:function(n,e,t=2){const i=e&&e.length,s=i?e[0]*t:n.length;let r=$d(n,0,s,t,!0);const o=[];if(!r||r.next===r.prev)return o;let a,l,c,h,u,f,p;if(i&&(r=gw(n,e,r,t)),n.length>80*t){a=c=n[0],l=h=n[1];for(let _=t;_<s;_+=t)u=n[_],f=n[_+1],u<a&&(a=u),f<l&&(l=f),u>c&&(c=u),f>h&&(h=f);p=Math.max(c-a,h-l),p=p!==0?32767/p:0}return zr(r,o,t,a,l,p,0),o}};function $d(n,e,t,i,s){let r,o;if(s===Aw(n,e,t,i)>0)for(r=e;r<t;r+=i)o=Xh(r,n[r],n[r+1],o);else for(r=t-i;r>=e;r-=i)o=Xh(r,n[r],n[r+1],o);return o&&da(o,o.next)&&(Hr(o),o=o.next),o}function hs(n,e){if(!n)return n;e||(e=n);let t=n,i;do if(i=!1,!t.steiner&&(da(t,t.next)||bt(t.prev,t,t.next)===0)){if(Hr(t),t=e=t.prev,t===t.next)break;i=!0}else t=t.next;while(i||t!==e);return e}function zr(n,e,t,i,s,r,o){if(!n)return;!o&&r&&Mw(n,i,s,r);let a=n,l,c;for(;n.prev!==n.next;){if(l=n.prev,c=n.next,r?dw(n,i,s,r):fw(n)){e.push(l.i/t|0),e.push(n.i/t|0),e.push(c.i/t|0),Hr(n),n=c.next,a=c.next;continue}if(n=c,n===a){o?o===1?(n=pw(hs(n),e,t),zr(n,e,t,i,s,r,2)):o===2&&mw(n,e,t,i,s,r):zr(hs(n),e,t,i,s,r,1);break}}}function fw(n){const e=n.prev,t=n,i=n.next;if(bt(e,t,i)>=0)return!1;const s=e.x,r=t.x,o=i.x,a=e.y,l=t.y,c=i.y,h=s<r?s<o?s:o:r<o?r:o,u=a<l?a<c?a:c:l<c?l:c,f=s>r?s>o?s:o:r>o?r:o,p=a>l?a>c?a:c:l>c?l:c;let _=i.next;for(;_!==e;){if(_.x>=h&&_.x<=f&&_.y>=u&&_.y<=p&&Fs(s,a,r,l,o,c,_.x,_.y)&&bt(_.prev,_,_.next)>=0)return!1;_=_.next}return!0}function dw(n,e,t,i){const s=n.prev,r=n,o=n.next;if(bt(s,r,o)>=0)return!1;const a=s.x,l=r.x,c=o.x,h=s.y,u=r.y,f=o.y,p=a<l?a<c?a:c:l<c?l:c,_=h<u?h<f?h:f:u<f?u:f,x=a>l?a>c?a:c:l>c?l:c,d=h>u?h>f?h:f:u>f?u:f,m=hc(p,_,e,t,i),b=hc(x,d,e,t,i);let M=n.prevZ,w=n.nextZ;for(;M&&M.z>=m&&w&&w.z<=b;){if(M.x>=p&&M.x<=x&&M.y>=_&&M.y<=d&&M!==s&&M!==o&&Fs(a,h,l,u,c,f,M.x,M.y)&&bt(M.prev,M,M.next)>=0||(M=M.prevZ,w.x>=p&&w.x<=x&&w.y>=_&&w.y<=d&&w!==s&&w!==o&&Fs(a,h,l,u,c,f,w.x,w.y)&&bt(w.prev,w,w.next)>=0))return!1;w=w.nextZ}for(;M&&M.z>=m;){if(M.x>=p&&M.x<=x&&M.y>=_&&M.y<=d&&M!==s&&M!==o&&Fs(a,h,l,u,c,f,M.x,M.y)&&bt(M.prev,M,M.next)>=0)return!1;M=M.prevZ}for(;w&&w.z<=b;){if(w.x>=p&&w.x<=x&&w.y>=_&&w.y<=d&&w!==s&&w!==o&&Fs(a,h,l,u,c,f,w.x,w.y)&&bt(w.prev,w,w.next)>=0)return!1;w=w.nextZ}return!0}function pw(n,e,t){let i=n;do{const s=i.prev,r=i.next.next;!da(s,r)&&jd(s,i,i.next,r)&&Gr(s,r)&&Gr(r,s)&&(e.push(s.i/t|0),e.push(i.i/t|0),e.push(r.i/t|0),Hr(i),Hr(i.next),i=n=r),i=i.next}while(i!==n);return hs(i)}function mw(n,e,t,i,s,r){let o=n;do{let a=o.next.next;for(;a!==o.prev;){if(o.i!==a.i&&Ew(o,a)){let l=Kd(o,a);o=hs(o,o.next),l=hs(l,l.next),zr(o,e,t,i,s,r,0),zr(l,e,t,i,s,r,0);return}a=a.next}o=o.next}while(o!==n)}function gw(n,e,t,i){const s=[];let r,o,a,l,c;for(r=0,o=e.length;r<o;r++)a=e[r]*i,l=r<o-1?e[r+1]*i:n.length,c=$d(n,a,l,i,!1),c===c.next&&(c.steiner=!0),s.push(ww(c));for(s.sort(_w),r=0;r<s.length;r++)t=vw(s[r],t);return t}function _w(n,e){return n.x-e.x}function vw(n,e){const t=xw(n,e);if(!t)return e;const i=Kd(t,n);return hs(i,i.next),hs(t,t.next)}function xw(n,e){let t=e,i=-1/0,s;const r=n.x,o=n.y;do{if(o<=t.y&&o>=t.next.y&&t.next.y!==t.y){const f=t.x+(o-t.y)*(t.next.x-t.x)/(t.next.y-t.y);if(f<=r&&f>i&&(i=f,s=t.x<t.next.x?t:t.next,f===r))return s}t=t.next}while(t!==e);if(!s)return null;const a=s,l=s.x,c=s.y;let h=1/0,u;t=s;do r>=t.x&&t.x>=l&&r!==t.x&&Fs(o<c?r:i,o,l,c,o<c?i:r,o,t.x,t.y)&&(u=Math.abs(o-t.y)/(r-t.x),Gr(t,n)&&(u<h||u===h&&(t.x>s.x||t.x===s.x&&yw(s,t)))&&(s=t,h=u)),t=t.next;while(t!==a);return s}function yw(n,e){return bt(n.prev,n,e.prev)<0&&bt(e.next,n,n.next)<0}function Mw(n,e,t,i){let s=n;do s.z===0&&(s.z=hc(s.x,s.y,e,t,i)),s.prevZ=s.prev,s.nextZ=s.next,s=s.next;while(s!==n);s.prevZ.nextZ=null,s.prevZ=null,Sw(s)}function Sw(n){let e,t,i,s,r,o,a,l,c=1;do{for(t=n,n=null,r=null,o=0;t;){for(o++,i=t,a=0,e=0;e<c&&(a++,i=i.nextZ,!!i);e++);for(l=c;a>0||l>0&&i;)a!==0&&(l===0||!i||t.z<=i.z)?(s=t,t=t.nextZ,a--):(s=i,i=i.nextZ,l--),r?r.nextZ=s:n=s,s.prevZ=r,r=s;t=i}r.nextZ=null,c*=2}while(o>1);return n}function hc(n,e,t,i,s){return n=(n-t)*s|0,e=(e-i)*s|0,n=(n|n<<8)&16711935,n=(n|n<<4)&252645135,n=(n|n<<2)&858993459,n=(n|n<<1)&1431655765,e=(e|e<<8)&16711935,e=(e|e<<4)&252645135,e=(e|e<<2)&858993459,e=(e|e<<1)&1431655765,n|e<<1}function ww(n){let e=n,t=n;do(e.x<t.x||e.x===t.x&&e.y<t.y)&&(t=e),e=e.next;while(e!==n);return t}function Fs(n,e,t,i,s,r,o,a){return(s-o)*(e-a)>=(n-o)*(r-a)&&(n-o)*(i-a)>=(t-o)*(e-a)&&(t-o)*(r-a)>=(s-o)*(i-a)}function Ew(n,e){return n.next.i!==e.i&&n.prev.i!==e.i&&!bw(n,e)&&(Gr(n,e)&&Gr(e,n)&&Tw(n,e)&&(bt(n.prev,n,e.prev)||bt(n,e.prev,e))||da(n,e)&&bt(n.prev,n,n.next)>0&&bt(e.prev,e,e.next)>0)}function bt(n,e,t){return(e.y-n.y)*(t.x-e.x)-(e.x-n.x)*(t.y-e.y)}function da(n,e){return n.x===e.x&&n.y===e.y}function jd(n,e,t,i){const s=Ro(bt(n,e,t)),r=Ro(bt(n,e,i)),o=Ro(bt(t,i,n)),a=Ro(bt(t,i,e));return!!(s!==r&&o!==a||s===0&&Ao(n,t,e)||r===0&&Ao(n,i,e)||o===0&&Ao(t,n,i)||a===0&&Ao(t,e,i))}function Ao(n,e,t){return e.x<=Math.max(n.x,t.x)&&e.x>=Math.min(n.x,t.x)&&e.y<=Math.max(n.y,t.y)&&e.y>=Math.min(n.y,t.y)}function Ro(n){return n>0?1:n<0?-1:0}function bw(n,e){let t=n;do{if(t.i!==n.i&&t.next.i!==n.i&&t.i!==e.i&&t.next.i!==e.i&&jd(t,t.next,n,e))return!0;t=t.next}while(t!==n);return!1}function Gr(n,e){return bt(n.prev,n,n.next)<0?bt(n,e,n.next)>=0&&bt(n,n.prev,e)>=0:bt(n,e,n.prev)<0||bt(n,n.next,e)<0}function Tw(n,e){let t=n,i=!1;const s=(n.x+e.x)/2,r=(n.y+e.y)/2;do t.y>r!=t.next.y>r&&t.next.y!==t.y&&s<(t.next.x-t.x)*(r-t.y)/(t.next.y-t.y)+t.x&&(i=!i),t=t.next;while(t!==n);return i}function Kd(n,e){const t=new fc(n.i,n.x,n.y),i=new fc(e.i,e.x,e.y),s=n.next,r=e.prev;return n.next=e,e.prev=n,t.next=s,s.prev=t,i.next=t,t.prev=i,r.next=i,i.prev=r,i}function Xh(n,e,t,i){const s=new fc(n,e,t);return i?(s.next=i.next,s.prev=i,i.next.prev=s,i.next=s):(s.prev=s,s.next=s),s}function Hr(n){n.next.prev=n.prev,n.prev.next=n.next,n.prevZ&&(n.prevZ.nextZ=n.nextZ),n.nextZ&&(n.nextZ.prevZ=n.prevZ)}function fc(n,e,t){this.i=n,this.x=e,this.y=t,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function Aw(n,e,t,i){let s=0;for(let r=e,o=t-i;r<t;r+=i)s+=(n[o]-n[r])*(n[r+1]+n[o+1]),o=r;return s}class Ws{static area(e){const t=e.length;let i=0;for(let s=t-1,r=0;r<t;s=r++)i+=e[s].x*e[r].y-e[r].x*e[s].y;return i*.5}static isClockWise(e){return Ws.area(e)<0}static triangulateShape(e,t){const i=[],s=[],r=[];qh(e),Yh(i,e);let o=e.length;t.forEach(qh);for(let l=0;l<t.length;l++)s.push(o),o+=t[l].length,Yh(i,t[l]);const a=hw.triangulate(i,s);for(let l=0;l<a.length;l+=3)r.push(a.slice(l,l+3));return r}}function qh(n){const e=n.length;e>2&&n[e-1].equals(n[0])&&n.pop()}function Yh(n,e){for(let t=0;t<e.length;t++)n.push(e[t].x),n.push(e[t].y)}class wn extends En{constructor(e=new gn([new Ue(.5,.5),new Ue(-.5,.5),new Ue(-.5,-.5),new Ue(.5,-.5)]),t={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:e,options:t},e=Array.isArray(e)?e:[e];const i=this,s=[],r=[];for(let a=0,l=e.length;a<l;a++){const c=e[a];o(c)}this.setAttribute("position",new Rt(s,3)),this.setAttribute("uv",new Rt(r,2)),this.computeVertexNormals();function o(a){const l=[],c=t.curveSegments!==void 0?t.curveSegments:12,h=t.steps!==void 0?t.steps:1,u=t.depth!==void 0?t.depth:1;let f=t.bevelEnabled!==void 0?t.bevelEnabled:!0,p=t.bevelThickness!==void 0?t.bevelThickness:.2,_=t.bevelSize!==void 0?t.bevelSize:p-.1,x=t.bevelOffset!==void 0?t.bevelOffset:0,d=t.bevelSegments!==void 0?t.bevelSegments:3;const m=t.extrudePath,b=t.UVGenerator!==void 0?t.UVGenerator:Rw;let M,w=!1,O,P,R,U;m&&(M=m.getSpacedPoints(h),w=!0,f=!1,O=m.computeFrenetFrames(h,!1),P=new W,R=new W,U=new W),f||(d=0,p=0,_=0,x=0);const ne=a.extractPoints(c);let y=ne.shape;const E=ne.holes;if(!Ws.isClockWise(y)){y=y.reverse();for(let ee=0,g=E.length;ee<g;ee++){const T=E[ee];Ws.isClockWise(T)&&(E[ee]=T.reverse())}}const k=Ws.triangulateShape(y,E),J=y;for(let ee=0,g=E.length;ee<g;ee++){const T=E[ee];y=y.concat(T)}function oe(ee,g,T){return g||console.error("THREE.ExtrudeGeometry: vec does not exist"),ee.clone().addScaledVector(g,T)}const G=y.length,Z=k.length;function X(ee,g,T){let L,N,I;const q=ee.x-g.x,j=ee.y-g.y,S=T.x-ee.x,v=T.y-ee.y,C=q*q+j*j,V=q*v-j*S;if(Math.abs(V)>Number.EPSILON){const B=Math.sqrt(C),H=Math.sqrt(S*S+v*v),de=g.x-j/B,ce=g.y+q/B,me=T.x-v/H,be=T.y+S/H,fe=((me-de)*v-(be-ce)*S)/(q*v-j*S);L=de+q*fe-ee.x,N=ce+j*fe-ee.y;const Me=L*L+N*N;if(Me<=2)return new Ue(L,N);I=Math.sqrt(Me/2)}else{let B=!1;q>Number.EPSILON?S>Number.EPSILON&&(B=!0):q<-Number.EPSILON?S<-Number.EPSILON&&(B=!0):Math.sign(j)===Math.sign(v)&&(B=!0),B?(L=-j,N=q,I=Math.sqrt(C)):(L=q,N=j,I=Math.sqrt(C/2))}return new Ue(L/I,N/I)}const pe=[];for(let ee=0,g=J.length,T=g-1,L=ee+1;ee<g;ee++,T++,L++)T===g&&(T=0),L===g&&(L=0),pe[ee]=X(J[ee],J[T],J[L]);const ve=[];let _e,Te=pe.concat();for(let ee=0,g=E.length;ee<g;ee++){const T=E[ee];_e=[];for(let L=0,N=T.length,I=N-1,q=L+1;L<N;L++,I++,q++)I===N&&(I=0),q===N&&(q=0),_e[L]=X(T[L],T[I],T[q]);ve.push(_e),Te=Te.concat(_e)}for(let ee=0;ee<d;ee++){const g=ee/d,T=p*Math.cos(g*Math.PI/2),L=_*Math.sin(g*Math.PI/2)+x;for(let N=0,I=J.length;N<I;N++){const q=oe(J[N],pe[N],L);F(q.x,q.y,-T)}for(let N=0,I=E.length;N<I;N++){const q=E[N];_e=ve[N];for(let j=0,S=q.length;j<S;j++){const v=oe(q[j],_e[j],L);F(v.x,v.y,-T)}}}const Fe=_+x;for(let ee=0;ee<G;ee++){const g=f?oe(y[ee],Te[ee],Fe):y[ee];w?(R.copy(O.normals[0]).multiplyScalar(g.x),P.copy(O.binormals[0]).multiplyScalar(g.y),U.copy(M[0]).add(R).add(P),F(U.x,U.y,U.z)):F(g.x,g.y,0)}for(let ee=1;ee<=h;ee++)for(let g=0;g<G;g++){const T=f?oe(y[g],Te[g],Fe):y[g];w?(R.copy(O.normals[ee]).multiplyScalar(T.x),P.copy(O.binormals[ee]).multiplyScalar(T.y),U.copy(M[ee]).add(R).add(P),F(U.x,U.y,U.z)):F(T.x,T.y,u/h*ee)}for(let ee=d-1;ee>=0;ee--){const g=ee/d,T=p*Math.cos(g*Math.PI/2),L=_*Math.sin(g*Math.PI/2)+x;for(let N=0,I=J.length;N<I;N++){const q=oe(J[N],pe[N],L);F(q.x,q.y,u+T)}for(let N=0,I=E.length;N<I;N++){const q=E[N];_e=ve[N];for(let j=0,S=q.length;j<S;j++){const v=oe(q[j],_e[j],L);w?F(v.x,v.y+M[h-1].y,M[h-1].x+T):F(v.x,v.y,u+T)}}}re(),he();function re(){const ee=s.length/3;if(f){let g=0,T=G*g;for(let L=0;L<Z;L++){const N=k[L];le(N[2]+T,N[1]+T,N[0]+T)}g=h+d*2,T=G*g;for(let L=0;L<Z;L++){const N=k[L];le(N[0]+T,N[1]+T,N[2]+T)}}else{for(let g=0;g<Z;g++){const T=k[g];le(T[2],T[1],T[0])}for(let g=0;g<Z;g++){const T=k[g];le(T[0]+G*h,T[1]+G*h,T[2]+G*h)}}i.addGroup(ee,s.length/3-ee,0)}function he(){const ee=s.length/3;let g=0;Se(J,g),g+=J.length;for(let T=0,L=E.length;T<L;T++){const N=E[T];Se(N,g),g+=N.length}i.addGroup(ee,s.length/3-ee,1)}function Se(ee,g){let T=ee.length;for(;--T>=0;){const L=T;let N=T-1;N<0&&(N=ee.length-1);for(let I=0,q=h+d*2;I<q;I++){const j=G*I,S=G*(I+1),v=g+L+j,C=g+N+j,V=g+N+S,B=g+L+S;ie(v,C,V,B)}}}function F(ee,g,T){l.push(ee),l.push(g),l.push(T)}function le(ee,g,T){ue(ee),ue(g),ue(T);const L=s.length/3,N=b.generateTopUV(i,s,L-3,L-2,L-1);we(N[0]),we(N[1]),we(N[2])}function ie(ee,g,T,L){ue(ee),ue(g),ue(L),ue(g),ue(T),ue(L);const N=s.length/3,I=b.generateSideWallUV(i,s,N-6,N-3,N-2,N-1);we(I[0]),we(I[1]),we(I[3]),we(I[1]),we(I[2]),we(I[3])}function ue(ee){s.push(l[ee*3+0]),s.push(l[ee*3+1]),s.push(l[ee*3+2])}function we(ee){r.push(ee.x),r.push(ee.y)}}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}toJSON(){const e=super.toJSON(),t=this.parameters.shapes,i=this.parameters.options;return Cw(t,i,e)}static fromJSON(e,t){const i=[];for(let r=0,o=e.shapes.length;r<o;r++){const a=t[e.shapes[r]];i.push(a)}const s=e.options.extrudePath;return s!==void 0&&(e.options.extrudePath=new cc[s.type]().fromJSON(s)),new wn(i,e.options)}}const Rw={generateTopUV:function(n,e,t,i,s){const r=e[t*3],o=e[t*3+1],a=e[i*3],l=e[i*3+1],c=e[s*3],h=e[s*3+1];return[new Ue(r,o),new Ue(a,l),new Ue(c,h)]},generateSideWallUV:function(n,e,t,i,s,r){const o=e[t*3],a=e[t*3+1],l=e[t*3+2],c=e[i*3],h=e[i*3+1],u=e[i*3+2],f=e[s*3],p=e[s*3+1],_=e[s*3+2],x=e[r*3],d=e[r*3+1],m=e[r*3+2];return Math.abs(a-h)<Math.abs(o-c)?[new Ue(o,1-l),new Ue(c,1-u),new Ue(f,1-_),new Ue(x,1-m)]:[new Ue(a,1-l),new Ue(h,1-u),new Ue(p,1-_),new Ue(d,1-m)]}};function Cw(n,e,t){if(t.shapes=[],Array.isArray(n))for(let i=0,s=n.length;i<s;i++){const r=n[i];t.shapes.push(r.uuid)}else t.shapes.push(n.uuid);return t.options=Object.assign({},e),e.extrudePath!==void 0&&(t.options.extrudePath=e.extrudePath.toJSON()),t}class Le extends En{constructor(e=1,t=32,i=16,s=0,r=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:i,phiStart:s,phiLength:r,thetaStart:o,thetaLength:a},t=Math.max(3,Math.floor(t)),i=Math.max(2,Math.floor(i));const l=Math.min(o+a,Math.PI);let c=0;const h=[],u=new W,f=new W,p=[],_=[],x=[],d=[];for(let m=0;m<=i;m++){const b=[],M=m/i;let w=0;m===0&&o===0?w=.5/t:m===i&&l===Math.PI&&(w=-.5/t);for(let O=0;O<=t;O++){const P=O/t;u.x=-e*Math.cos(s+P*r)*Math.sin(o+M*a),u.y=e*Math.cos(o+M*a),u.z=e*Math.sin(s+P*r)*Math.sin(o+M*a),_.push(u.x,u.y,u.z),f.copy(u).normalize(),x.push(f.x,f.y,f.z),d.push(P+w,1-M),b.push(c++)}h.push(b)}for(let m=0;m<i;m++)for(let b=0;b<t;b++){const M=h[m][b+1],w=h[m][b],O=h[m+1][b],P=h[m+1][b+1];(m!==0||o>0)&&p.push(M,w,P),(m!==i-1||l<Math.PI)&&p.push(w,O,P)}this.setIndex(p),this.setAttribute("position",new Rt(_,3)),this.setAttribute("normal",new Rt(x,3)),this.setAttribute("uv",new Rt(d,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Le(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class Zc extends En{constructor(e=1,t=.4,i=12,s=48,r=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:e,tube:t,radialSegments:i,tubularSegments:s,arc:r},i=Math.floor(i),s=Math.floor(s);const o=[],a=[],l=[],c=[],h=new W,u=new W,f=new W;for(let p=0;p<=i;p++)for(let _=0;_<=s;_++){const x=_/s*r,d=p/i*Math.PI*2;u.x=(e+t*Math.cos(d))*Math.cos(x),u.y=(e+t*Math.cos(d))*Math.sin(x),u.z=t*Math.sin(d),a.push(u.x,u.y,u.z),h.x=e*Math.cos(x),h.y=e*Math.sin(x),f.subVectors(u,h).normalize(),l.push(f.x,f.y,f.z),c.push(_/s),c.push(p/i)}for(let p=1;p<=i;p++)for(let _=1;_<=s;_++){const x=(s+1)*p+_-1,d=(s+1)*(p-1)+_-1,m=(s+1)*(p-1)+_,b=(s+1)*p+_;o.push(x,d,b),o.push(d,m,b)}this.setIndex(o),this.setAttribute("position",new Rt(a,3)),this.setAttribute("normal",new Rt(l,3)),this.setAttribute("uv",new Rt(c,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Zc(e.radius,e.tube,e.radialSegments,e.tubularSegments,e.arc)}}class Zd extends Yr{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new st(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new st(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=bd,this.normalScale=new Ue(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Yn,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class De extends Zd{constructor(e){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new Ue(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return Ht(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(t){this.ior=(1+.4*t)/(1-.4*t)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new st(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new st(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new st(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._dispersion=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(e)}get anisotropy(){return this._anisotropy}set anisotropy(e){this._anisotropy>0!=e>0&&this.version++,this._anisotropy=e}get clearcoat(){return this._clearcoat}set clearcoat(e){this._clearcoat>0!=e>0&&this.version++,this._clearcoat=e}get iridescence(){return this._iridescence}set iridescence(e){this._iridescence>0!=e>0&&this.version++,this._iridescence=e}get dispersion(){return this._dispersion}set dispersion(e){this._dispersion>0!=e>0&&this.version++,this._dispersion=e}get sheen(){return this._sheen}set sheen(e){this._sheen>0!=e>0&&this.version++,this._sheen=e}get transmission(){return this._transmission}set transmission(e){this._transmission>0!=e>0&&this.version++,this._transmission=e}copy(e){return super.copy(e),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=e.anisotropy,this.anisotropyRotation=e.anisotropyRotation,this.anisotropyMap=e.anisotropyMap,this.clearcoat=e.clearcoat,this.clearcoatMap=e.clearcoatMap,this.clearcoatRoughness=e.clearcoatRoughness,this.clearcoatRoughnessMap=e.clearcoatRoughnessMap,this.clearcoatNormalMap=e.clearcoatNormalMap,this.clearcoatNormalScale.copy(e.clearcoatNormalScale),this.dispersion=e.dispersion,this.ior=e.ior,this.iridescence=e.iridescence,this.iridescenceMap=e.iridescenceMap,this.iridescenceIOR=e.iridescenceIOR,this.iridescenceThicknessRange=[...e.iridescenceThicknessRange],this.iridescenceThicknessMap=e.iridescenceThicknessMap,this.sheen=e.sheen,this.sheenColor.copy(e.sheenColor),this.sheenColorMap=e.sheenColorMap,this.sheenRoughness=e.sheenRoughness,this.sheenRoughnessMap=e.sheenRoughnessMap,this.transmission=e.transmission,this.transmissionMap=e.transmissionMap,this.thickness=e.thickness,this.thicknessMap=e.thicknessMap,this.attenuationDistance=e.attenuationDistance,this.attenuationColor.copy(e.attenuationColor),this.specularIntensity=e.specularIntensity,this.specularIntensityMap=e.specularIntensityMap,this.specularColor.copy(e.specularColor),this.specularColorMap=e.specularColorMap,this}}const jo={enabled:!1,files:{},add:function(n,e){this.enabled!==!1&&(this.files[n]=e)},get:function(n){if(this.enabled!==!1)return this.files[n]},remove:function(n){delete this.files[n]},clear:function(){this.files={}}};class Pw{constructor(e,t,i){const s=this;let r=!1,o=0,a=0,l;const c=[];this.onStart=void 0,this.onLoad=e,this.onProgress=t,this.onError=i,this.itemStart=function(h){a++,r===!1&&s.onStart!==void 0&&s.onStart(h,o,a),r=!0},this.itemEnd=function(h){o++,s.onProgress!==void 0&&s.onProgress(h,o,a),o===a&&(r=!1,s.onLoad!==void 0&&s.onLoad())},this.itemError=function(h){s.onError!==void 0&&s.onError(h)},this.resolveURL=function(h){return l?l(h):h},this.setURLModifier=function(h){return l=h,this},this.addHandler=function(h,u){return c.push(h,u),this},this.removeHandler=function(h){const u=c.indexOf(h);return u!==-1&&c.splice(u,2),this},this.getHandler=function(h){for(let u=0,f=c.length;u<f;u+=2){const p=c[u],_=c[u+1];if(p.global&&(p.lastIndex=0),p.test(h))return _}return null}}}const Lw=new Pw;class $r{constructor(e){this.manager=e!==void 0?e:Lw,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(e,t){const i=this;return new Promise(function(s,r){i.load(e,s,t,r)})}parse(){}setCrossOrigin(e){return this.crossOrigin=e,this}setWithCredentials(e){return this.withCredentials=e,this}setPath(e){return this.path=e,this}setResourcePath(e){return this.resourcePath=e,this}setRequestHeader(e){return this.requestHeader=e,this}}$r.DEFAULT_MATERIAL_NAME="__DEFAULT";const si={};class Iw extends Error{constructor(e,t){super(e),this.response=t}}class Dw extends $r{constructor(e){super(e)}load(e,t,i,s){e===void 0&&(e=""),this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const r=jo.get(e);if(r!==void 0)return this.manager.itemStart(e),setTimeout(()=>{t&&t(r),this.manager.itemEnd(e)},0),r;if(si[e]!==void 0){si[e].push({onLoad:t,onProgress:i,onError:s});return}si[e]=[],si[e].push({onLoad:t,onProgress:i,onError:s});const o=new Request(e,{headers:new Headers(this.requestHeader),credentials:this.withCredentials?"include":"same-origin"}),a=this.mimeType,l=this.responseType;fetch(o).then(c=>{if(c.status===200||c.status===0){if(c.status===0&&console.warn("THREE.FileLoader: HTTP Status 0 received."),typeof ReadableStream>"u"||c.body===void 0||c.body.getReader===void 0)return c;const h=si[e],u=c.body.getReader(),f=c.headers.get("X-File-Size")||c.headers.get("Content-Length"),p=f?parseInt(f):0,_=p!==0;let x=0;const d=new ReadableStream({start(m){b();function b(){u.read().then(({done:M,value:w})=>{if(M)m.close();else{x+=w.byteLength;const O=new ProgressEvent("progress",{lengthComputable:_,loaded:x,total:p});for(let P=0,R=h.length;P<R;P++){const U=h[P];U.onProgress&&U.onProgress(O)}m.enqueue(w),b()}},M=>{m.error(M)})}}});return new Response(d)}else throw new Iw(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`,c)}).then(c=>{switch(l){case"arraybuffer":return c.arrayBuffer();case"blob":return c.blob();case"document":return c.text().then(h=>new DOMParser().parseFromString(h,a));case"json":return c.json();default:if(a===void 0)return c.text();{const u=/charset="?([^;"\s]*)"?/i.exec(a),f=u&&u[1]?u[1].toLowerCase():void 0,p=new TextDecoder(f);return c.arrayBuffer().then(_=>p.decode(_))}}}).then(c=>{jo.add(e,c);const h=si[e];delete si[e];for(let u=0,f=h.length;u<f;u++){const p=h[u];p.onLoad&&p.onLoad(c)}}).catch(c=>{const h=si[e];if(h===void 0)throw this.manager.itemError(e),c;delete si[e];for(let u=0,f=h.length;u<f;u++){const p=h[u];p.onError&&p.onError(c)}this.manager.itemError(e)}).finally(()=>{this.manager.itemEnd(e)}),this.manager.itemStart(e)}setResponseType(e){return this.responseType=e,this}setMimeType(e){return this.mimeType=e,this}}class Uw extends $r{constructor(e){super(e)}load(e,t,i,s){this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const r=this,o=jo.get(e);if(o!==void 0)return r.manager.itemStart(e),setTimeout(function(){t&&t(o),r.manager.itemEnd(e)},0),o;const a=Br("img");function l(){h(),jo.add(e,this),t&&t(this),r.manager.itemEnd(e)}function c(u){h(),s&&s(u),r.manager.itemError(e),r.manager.itemEnd(e)}function h(){a.removeEventListener("load",l,!1),a.removeEventListener("error",c,!1)}return a.addEventListener("load",l,!1),a.addEventListener("error",c,!1),e.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(a.crossOrigin=this.crossOrigin),r.manager.itemStart(e),a.src=e,a}}class Hi extends $r{constructor(e){super(e)}load(e,t,i,s){const r=new on,o=new Uw(this.manager);return o.setCrossOrigin(this.crossOrigin),o.setPath(this.path),o.load(e,function(a){r.image=a,r.needsUpdate=!0,t!==void 0&&t(r)},i,s),r}}class Jc extends Zt{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new st(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(t.object.target=this.target.uuid),t}}const cl=new St,$h=new W,jh=new W;class Jd{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Ue(512,512),this.map=null,this.mapPass=null,this.matrix=new St,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Yc,this._frameExtents=new Ue(1,1),this._viewportCount=1,this._viewports=[new pt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,i=this.matrix;$h.setFromMatrixPosition(e.matrixWorld),t.position.copy($h),jh.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(jh),t.updateMatrixWorld(),cl.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(cl),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(cl)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}const Kh=new St,fr=new W,ul=new W;class Nw extends Jd{constructor(){super(new It(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new Ue(4,2),this._viewportCount=6,this._viewports=[new pt(2,1,1,1),new pt(0,1,1,1),new pt(3,1,1,1),new pt(1,1,1,1),new pt(3,0,1,1),new pt(1,0,1,1)],this._cubeDirections=[new W(1,0,0),new W(-1,0,0),new W(0,0,1),new W(0,0,-1),new W(0,1,0),new W(0,-1,0)],this._cubeUps=[new W(0,1,0),new W(0,1,0),new W(0,1,0),new W(0,1,0),new W(0,0,1),new W(0,0,-1)]}updateMatrices(e,t=0){const i=this.camera,s=this.matrix,r=e.distance||i.far;r!==i.far&&(i.far=r,i.updateProjectionMatrix()),fr.setFromMatrixPosition(e.matrixWorld),i.position.copy(fr),ul.copy(i.position),ul.add(this._cubeDirections[t]),i.up.copy(this._cubeUps[t]),i.lookAt(ul),i.updateMatrixWorld(),s.makeTranslation(-fr.x,-fr.y,-fr.z),Kh.multiplyMatrices(i.projectionMatrix,i.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Kh)}}class ki extends Jc{constructor(e,t,i=0,s=2){super(e,t),this.isPointLight=!0,this.type="PointLight",this.distance=i,this.decay=s,this.shadow=new Nw}get power(){return this.intensity*4*Math.PI}set power(e){this.intensity=e/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(e,t){return super.copy(e,t),this.distance=e.distance,this.decay=e.decay,this.shadow=e.shadow.clone(),this}}class Fw extends Jd{constructor(){super(new Bd(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class Vi extends Jc{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Zt.DEFAULT_UP),this.updateMatrix(),this.target=new Zt,this.shadow=new Fw}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Wi extends Jc{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class Qd{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Zh(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const t=Zh();e=(t-this.oldTime)/1e3,this.oldTime=t,this.elapsedTime+=e}return e}}function Zh(){return performance.now()}class Ow{constructor(){this.type="ShapePath",this.color=new st,this.subPaths=[],this.currentPath=null}moveTo(e,t){return this.currentPath=new uc,this.subPaths.push(this.currentPath),this.currentPath.moveTo(e,t),this}lineTo(e,t){return this.currentPath.lineTo(e,t),this}quadraticCurveTo(e,t,i,s){return this.currentPath.quadraticCurveTo(e,t,i,s),this}bezierCurveTo(e,t,i,s,r,o){return this.currentPath.bezierCurveTo(e,t,i,s,r,o),this}splineThru(e){return this.currentPath.splineThru(e),this}toShapes(e){function t(m){const b=[];for(let M=0,w=m.length;M<w;M++){const O=m[M],P=new gn;P.curves=O.curves,b.push(P)}return b}function i(m,b){const M=b.length;let w=!1;for(let O=M-1,P=0;P<M;O=P++){let R=b[O],U=b[P],ne=U.x-R.x,y=U.y-R.y;if(Math.abs(y)>Number.EPSILON){if(y<0&&(R=b[P],ne=-ne,U=b[O],y=-y),m.y<R.y||m.y>U.y)continue;if(m.y===R.y){if(m.x===R.x)return!0}else{const E=y*(m.x-R.x)-ne*(m.y-R.y);if(E===0)return!0;if(E<0)continue;w=!w}}else{if(m.y!==R.y)continue;if(U.x<=m.x&&m.x<=R.x||R.x<=m.x&&m.x<=U.x)return!0}}return w}const s=Ws.isClockWise,r=this.subPaths;if(r.length===0)return[];let o,a,l;const c=[];if(r.length===1)return a=r[0],l=new gn,l.curves=a.curves,c.push(l),c;let h=!s(r[0].getPoints());h=e?!h:h;const u=[],f=[];let p=[],_=0,x;f[_]=void 0,p[_]=[];for(let m=0,b=r.length;m<b;m++)a=r[m],x=a.getPoints(),o=s(x),o=e?!o:o,o?(!h&&f[_]&&_++,f[_]={s:new gn,p:x},f[_].s.curves=a.curves,h&&_++,p[_]=[]):p[_].push({h:a,p:x[0]});if(!f[0])return t(r);if(f.length>1){let m=!1,b=0;for(let M=0,w=f.length;M<w;M++)u[M]=[];for(let M=0,w=f.length;M<w;M++){const O=p[M];for(let P=0;P<O.length;P++){const R=O[P];let U=!0;for(let ne=0;ne<f.length;ne++)i(R.p,f[ne].p)&&(M!==ne&&b++,U?(U=!1,u[ne].push(R)):m=!0);U&&u[M].push(R)}}b>0&&m===!1&&(p=u)}let d;for(let m=0,b=f.length;m<b;m++){l=f[m].s,c.push(l),d=p[m];for(let M=0,w=d.length;M<w;M++)l.holes.push(d[M].h)}return c}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Oc}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Oc);class Xi extends $r{constructor(e){super(e)}load(e,t,i,s){const r=this,o=new Dw(this.manager);o.setPath(this.path),o.setRequestHeader(this.requestHeader),o.setWithCredentials(this.withCredentials),o.load(e,function(a){const l=r.parse(JSON.parse(a));t&&t(l)},i,s)}parse(e){return new Bw(e)}}class Bw{constructor(e){this.isFont=!0,this.type="Font",this.data=e}generateShapes(e,t=100){const i=[],s=zw(e,t,this.data);for(let r=0,o=s.length;r<o;r++)i.push(...s[r].toShapes());return i}}function zw(n,e,t){const i=Array.from(n),s=e/t.resolution,r=(t.boundingBox.yMax-t.boundingBox.yMin+t.underlineThickness)*s,o=[];let a=0,l=0;for(let c=0;c<i.length;c++){const h=i[c];if(h===`
`)a=0,l-=r;else{const u=Gw(h,s,a,l,t);a+=u.offsetX,o.push(u.path)}}return o}function Gw(n,e,t,i,s){const r=s.glyphs[n]||s.glyphs["?"];if(!r){console.error('THREE.Font: character "'+n+'" does not exists in font family '+s.familyName+".");return}const o=new Ow;let a,l,c,h,u,f,p,_;if(r.o){const x=r._cachedOutline||(r._cachedOutline=r.o.split(" "));for(let d=0,m=x.length;d<m;)switch(x[d++]){case"m":a=x[d++]*e+t,l=x[d++]*e+i,o.moveTo(a,l);break;case"l":a=x[d++]*e+t,l=x[d++]*e+i,o.lineTo(a,l);break;case"q":c=x[d++]*e+t,h=x[d++]*e+i,u=x[d++]*e+t,f=x[d++]*e+i,o.quadraticCurveTo(u,f,c,h);break;case"b":c=x[d++]*e+t,h=x[d++]*e+i,u=x[d++]*e+t,f=x[d++]*e+i,p=x[d++]*e+t,_=x[d++]*e+i,o.bezierCurveTo(u,f,p,_,c,h);break}}return{offsetX:r.ha*e,path:o}}class Dt extends wn{constructor(e,t={}){const i=t.font;if(i===void 0)super();else{const s=i.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(s,t)}this.type="TextGeometry"}}const Hw=Bn({__name:"MetalBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=null,s=tt(!1),r=tt(!1),o=tt(!1);return jn(()=>{if(t.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:r.value&&(u.rotation.y-=.03),h.render(l,c)};const l=new Gi,c=new It(75,window.innerWidth/window.innerHeight,.1,1e3),h=new zi({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(h.domElement);const u=new Ye,f=new Wi(16777215,2);l.add(f);const p=new Vi(16777215,4);p.position.set(5,5,5),l.add(p);const _=new ki(16777215,5,50);_.position.set(0,2,4),l.add(_);const x=new Hi,d=x.load("/3d-bear-arts/assets/lv2.jpg"),m=x.load("/3d-bear-arts/assets/lv2.jpg");d.wrapS=d.wrapT=Nt,m.wrapS=m.wrapT=Nt;const b=new De({color:8343336,metalness:0,roughness:.8,bumpMap:d,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:m,envMapIntensity:.7}),M=new De({color:5978654,metalness:0,roughness:.8,bumpMap:d,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:m,envMapIntensity:.7}),w=new De({color:13152668,metalness:.2,roughness:.05,bumpMap:d,bumpScale:.05,clearcoat:1,clearcoatRoughness:.05,map:m,transparent:!0,opacity:.4,transmission:.9,envMapIntensity:1,reflectivity:.9,ior:1.45,side:rt});new De({color:13421772,metalness:1,roughness:.5,clearcoat:.3,clearcoatRoughness:.3});const O=new Le(1,32,32,0,Math.PI),P=new D(O,w),R=new D(O,b);P.scale.set(.85,.85,.8),R.scale.set(.85,.85,.8),P.position.y=-.2,R.position.y=-.2,P.rotation.y=Math.PI/2,R.rotation.y=Math.PI*1.5;const U=new _t(1,32),ne=new D(U,b);ne.scale.set(.85,.85,.8),ne.position.set(0,-.2,0),ne.rotation.y=Math.PI/2;const y=new Ye;y.add(P),y.add(R),y.add(ne),u.add(y);const E=new Le(.6,32,32,0,Math.PI),$=new D(E,b);$.scale.set(1,.95,.95),$.position.set(0,1,0),$.rotation.y=Math.PI*1.5;const k=new D(E,w);k.scale.set(1,.95,.95),k.position.set(0,1,0),k.rotation.y=Math.PI/2;const J=new _t(.6,32),oe=new D(J,b);oe.position.set(0,1,0),oe.rotation.y=Math.PI/2,oe.scale.set(1,.95,.95);const G=new Ye;G.add($),G.add(k),G.add(oe),u.add(G);const Z=new Le(.25,32,32),X=new D(Z,b);X.position.set(-.45,1.35,-.1),u.add(X);const pe=new D(Z,w);pe.position.set(.45,1.35,-.1),u.add(pe);const ve=new Le(.25,32,32,Math.PI/2,Math.PI),_e=new D(ve,M);_e.scale.set(1.1,.6,.8),_e.position.set(0,.84,.5),_e.rotation.y=Math.PI;const Te=new Le(.25,32,32,Math.PI/2,Math.PI),Fe=new D(Te,w);Fe.scale.set(1.1,.6,.8),Fe.position.set(0,.84,.5),Fe.rotation.y=0;const re=new _t(.25,32),he=new D(re,b);he.scale.set(.8,.6,.8),he.position.set(0,.84,.5),he.rotation.y=Math.PI/2;const Se=new Ye;Se.add(_e),Se.add(Fe),Se.add(he),u.add(Se);const F=new gn;F.moveTo(0,0),F.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),F.bezierCurveTo(-.6,.3,0,.6,0,1),F.bezierCurveTo(0,.6,.6,.3,.6,0),F.bezierCurveTo(.6,-.3,0,-.3,0,0);const le={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new De({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const ie=new wn(F,le),ue=new D(ie,b);ue.scale.set(.1,.1,.1),ue.rotation.z=it.degToRad(210),ue.rotation.x=it.degToRad(5),ue.rotation.y=it.degToRad(-45),ue.position.set(-.4,.9,.45);const we=new D(ie,M);we.scale.set(.6,.5,.5),we.position.set(.35,0,0),we.rotation.y=Math.PI,we.rotation.x=Math.PI;const ee=new D(ie,M);ee.scale.set(.2,.2,.2),ee.position.set(.5,-.1,.2),ee.rotation.y=Math.PI,ee.rotation.x=Math.PI,u.add(ee);const g=new ps(1.3,1.2,.6),T=new D(g,b);T.scale.set(.45,.45,.45),T.position.set(.35,-.2,.1),T.rotation.y=Math.PI;const L=new Zc(.15,.025,10,100);new De({color:8343336,metalness:.3,roughness:.4,clearcoat:.5});const N=new D(L,b);N.position.set(.35,.1,.1),N.rotation.z=Math.PI/2,N.rotation.x=Math.PI/8,N.rotation.y=Math.PI/14;const I=new D(L,b);I.position.set(.35,.1,.13),I.rotation.z=Math.PI/2,I.rotation.x=Math.PI/-8,I.rotation.y=Math.PI/12;const q=new Ye;q.add(T),q.add(N),q.add(I),u.add(q);const j=new Le(.35,32,32),S=new D(j,b);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),u.add(S);const v=new D(j,w);v.scale.set(.75,1.25,.65),v.position.set(.7,-.15,.2),u.add(v);const C=new Sn(.2,.22,.6,32),V=new D(C,b);V.position.set(-.4,-1.05,0),u.add(V);const B=new D(C,w);B.position.set(.4,-1.05,0),u.add(B);const H=new Le(.3,32,32),de=new D(H,b);de.scale.set(1,.72,1.5),de.position.set(-.4,-1.45,.17),u.add(de);const ce=new D(H,w);ce.scale.set(1,.72,1.5),ce.position.set(.4,-1.45,.17),u.add(ce);const me=new Le(.44,32,32),be=new D(me,b);be.position.set(-.15,-.45,-.4),u.add(be);const fe=new D(me,w);fe.position.set(.15,-.45,-.4),u.add(fe);const Me=new Le(.18,32,32),Ce=new D(Me,b);Ce.position.set(0,-.35,-.8),u.add(Ce),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Q){const ye=new Dt("X",{font:Q,size:.2,depth:.05});new Fn({color:0});const ge=new D(ye,M);ge.position.set(-.3,.99,.53),ge.rotation.x=it.degToRad(-5),ge.rotation.y=it.degToRad(-15),u.add(ge);const Ne=new Dt("O",{font:Q,size:.2,depth:.05});new Fn({color:0});const Ve=new D(Ne,M);Ve.position.set(.14,.99,.53),Ve.rotation.y=it.degToRad(12),Ve.rotation.x=it.degToRad(-5),u.add(Ve)}),Ce.renderOrder=1,u.scale.set(1.35,1.35,1.35),l.add(u),u.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),c.position.set(e.bodyPosition.x,1,e.cameraPosition),c.lookAt(e.bodyPosition.x,0,0),c.position.z=4;const Ee=()=>{u.rotation.y,u.rotation.x},Be=()=>{s.value=!0,r.value=!1,o.value=!1},Pe=()=>{s.value=!1,r.value=!0,o.value=!1},ze=()=>{s.value=!1,r.value=!1,Ee()},z=Q=>{const ye=window.innerWidth/2;Q>ye?Be():Pe(),Ee()},xe=Q=>{clearTimeout(i),ze(),o.value=!0;const ye={x:Q.clientX/window.innerWidth*2-1,y:-(Q.clientY/window.innerHeight)*2+1};if(o.value){const ge=ye.x*Math.PI*.2,Ne=ye.y*Math.PI*.2;u.rotation.y=ge,u.rotation.x=Ne}i=setTimeout(()=>{o.value=!1,z(Q.clientX)},500)};window.addEventListener("mousemove",xe);const te=Q=>{if(o.value){const ye={x:Q.clientX/window.innerWidth*2-1,y:-(Q.clientY/window.innerHeight)*2+1},ge=ye.x*Math.PI*.2,Ne=ye.y*Math.PI*.2;u.rotation.y=ge,u.rotation.x=Ne}};window.addEventListener("mousemove",te),a(),Ut(()=>e.bodyPosition,Q=>{u.position.set(Q.x,Q.y,Q.z)}),Ut(()=>e.cameraPosition,Q=>{c.position.set(e.bodyPosition.x,1,Q),c.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{c.aspect=window.innerWidth/window.innerHeight,c.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,l)=>(pi(),mi("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2))}}),kw=gi(Hw,[["__scopeId","data-v-f3beb116"]]),Vw=Bn({__name:"PopartBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=null,s=tt(!1),r=tt(!1),o=tt(!1);return jn(()=>{if(t.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:r.value&&(u.rotation.y-=.03),h.render(l,c)};const l=new Gi,c=new It(75,window.innerWidth/window.innerHeight,.1,1e3),h=new zi({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(h.domElement);const u=new Ye,f=new Wi(16777215,2);l.add(f);const p=new Vi(16777215,4);p.position.set(5,5,5),l.add(p);const _=new ki(16777215,5,50);_.position.set(0,2,4),l.add(_);const x=new Hi,d=x.load("/3d-bear-arts/assets/pop6.jpg"),m=x.load("/3d-bear-arts/assets/pop7.jpg");d.wrapS=d.wrapT=Nt,m.wrapS=m.wrapT=Nt;const b=new De({color:16738740,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),M=new De({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:rt}),w=new De({color:16766720,map:d,metalness:.3,roughness:.5}),O=new De({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:rt}),P=new De({color:9055202,map:d,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new De({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:rt});const R=new De({color:65535,map:d,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),U=new De({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:rt}),ne=new Le(1,32,32,0,Math.PI),y=new D(ne,M),E=new D(ne,b);y.scale.set(.85,.85,.8),E.scale.set(.85,.85,.8),y.position.y=-.2,E.position.y=-.2,y.rotation.y=Math.PI/2,E.rotation.y=Math.PI*1.5;const $=new _t(1,32),k=new D($,b);k.scale.set(.85,.85,.8),k.position.set(0,-.2,0),k.rotation.y=Math.PI/2;const J=new Ye;J.add(y),J.add(E),J.add(k),u.add(J);const oe=new Le(.6,32,32,0,Math.PI),G=new D(oe,w);G.scale.set(1,.95,.95),G.position.set(0,1,0),G.rotation.y=Math.PI*1.5;const Z=new D(oe,O);Z.scale.set(1,.95,.95),Z.position.set(0,1,0),Z.rotation.y=Math.PI/2;const X=new _t(.6,32),pe=new D(X,w);pe.position.set(0,1,0),pe.rotation.y=Math.PI/2,pe.scale.set(1,.95,.95);const ve=new Ye;ve.add(G),ve.add(Z),ve.add(pe),u.add(ve);const _e=new Le(.25,32,32),Te=new D(_e,b);Te.position.set(-.45,1.35,-.1),u.add(Te);const Fe=new D(_e,M);Fe.position.set(.45,1.35,-.1),u.add(Fe);const re=new Le(.25,32,32,Math.PI/2,Math.PI),he=new D(re,w);he.scale.set(1.1,.6,.8),he.position.set(0,.84,.5),he.rotation.y=Math.PI;const Se=new Le(.25,32,32,Math.PI/2,Math.PI),F=new D(Se,O);F.scale.set(1.1,.6,.8),F.position.set(0,.84,.5),F.rotation.y=0;const le=new _t(.25,32),ie=new D(le,w);ie.scale.set(.8,.6,.8),ie.position.set(0,.84,.5),ie.rotation.y=Math.PI/2;const ue=new Ye;ue.add(he),ue.add(F),ue.add(ie),u.add(ue);const we=new gn;we.moveTo(0,0),we.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),we.bezierCurveTo(-.6,.3,0,.6,0,1),we.bezierCurveTo(0,.6,.6,.3,.6,0),we.bezierCurveTo(.6,-.3,0,-.3,0,0);const ee={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},g=new wn(we,ee),T=new D(g,w);T.scale.set(.5,.5,.5),T.position.set(.35,0,0),T.rotation.y=Math.PI,T.rotation.x=Math.PI,u.add(T);const L=new D(g,R);L.scale.set(.2,.2,.25),L.position.set(.5,-.3,.4),L.rotation.y=Math.PI,L.rotation.x=Math.PI,u.add(L);const N=new D(g,b);N.scale.set(.25,.25,.27),N.position.set(.4,.3,-.2),N.rotation.y=Math.PI,N.rotation.x=Math.PI,u.add(N);const I=new Le(.35,32,32),q=new D(I,R);q.scale.set(.75,1.25,.65),q.position.set(-.7,-.15,.2),u.add(q);const j=new D(I,U);j.scale.set(.75,1.25,.65),j.position.set(.7,-.15,.2),u.add(j);const S=new Sn(.2,.22,.6,32),v=new D(S,w);v.position.set(-.4,-1.05,0),u.add(v);const C=new D(S,O);C.position.set(.4,-1.05,0),u.add(C);const V=new Le(.3,32,32),B=new D(V,w);B.scale.set(1,.72,1.5),B.position.set(-.4,-1.45,.17),u.add(B);const H=new D(V,O);H.scale.set(1,.72,1.5),H.position.set(.4,-1.45,.17),u.add(H);const de=new Le(.44,32,32),ce=new D(de,b);ce.position.set(-.15,-.45,-.4),u.add(ce);const me=new D(de,M);me.position.set(.15,-.45,-.4),u.add(me);const be=new Le(.18,32,32),fe=new D(be,b);fe.position.set(0,-.35,-.8),u.add(fe),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(xe){const te=new Dt("X",{font:xe,size:.2,depth:.05});new Fn({color:0});const Q=new D(te,b);Q.position.set(-.3,.99,.53),Q.rotation.x=it.degToRad(-5),Q.rotation.y=it.degToRad(-15),u.add(Q);const ye=new Dt("O",{font:xe,size:.2,depth:.05});new Fn({color:0});const ge=new D(ye,R);ge.position.set(.14,.99,.53),ge.rotation.y=it.degToRad(12),ge.rotation.x=it.degToRad(-5),u.add(ge);const Ne=new Dt("POP",{font:xe,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),Ve=new De({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new De({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const Ke=new De({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),ke=new De({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),nt=new D(Ne,Ve);nt.scale.set(.15,.15,.15),nt.position.set(.03,1.16,.1),nt.rotateZ(-25),u.add(nt);const ot=new D(Ne,P);ot.scale.set(.14,.14,.14),ot.rotateZ(45),ot.position.set(.2,-.7,.3),u.add(ot);const zt=new D(Ne,Ke);zt.scale.set(.14,.14,.14),zt.rotateZ(45),zt.rotateY(45),zt.position.set(.3,.7,.3),u.add(zt);const wt=new D(Ne,Ke);wt.scale.set(.15,.15,.15),wt.rotateZ(45),wt.rotateY(45),wt.position.set(.35,-1.5,.3),u.add(wt);const Mt=new D(Ne,ke);Mt.scale.set(.17,.17,.17),Mt.rotateZ(45),Mt.rotateY(15),Mt.position.set(.35,1,.3),u.add(Mt)}),fe.renderOrder=1,u.scale.set(1.35,1.35,1.35),l.add(u),u.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),c.position.set(e.bodyPosition.x,1,e.cameraPosition),c.lookAt(e.bodyPosition.x,0,0),c.position.z=4;const Ce=()=>{u.rotation.y,u.rotation.x},Re=()=>{s.value=!0,r.value=!1,o.value=!1},Ee=()=>{s.value=!1,r.value=!0,o.value=!1},Be=()=>{s.value=!1,r.value=!1,Ce()},Pe=xe=>{const te=window.innerWidth/2;xe>te?Re():Ee(),Ce()},ze=xe=>{clearTimeout(i),Be(),o.value=!0;const te={x:xe.clientX/window.innerWidth*2-1,y:-(xe.clientY/window.innerHeight)*2+1};if(o.value){const Q=te.x*Math.PI*.2,ye=te.y*Math.PI*.2;u.rotation.y=Q,u.rotation.x=ye}i=setTimeout(()=>{o.value=!1,Pe(xe.clientX)},500)};window.addEventListener("mousemove",ze);const z=xe=>{if(o.value){const te={x:xe.clientX/window.innerWidth*2-1,y:-(xe.clientY/window.innerHeight)*2+1},Q=te.x*Math.PI*.2,ye=te.y*Math.PI*.2;u.rotation.y=Q,u.rotation.x=ye}};window.addEventListener("mousemove",z),a(),Ut(()=>e.bodyPosition,xe=>{u.position.set(xe.x,xe.y,xe.z)}),Ut(()=>e.cameraPosition,xe=>{c.position.set(e.bodyPosition.x,1,xe),c.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{c.aspect=window.innerWidth/window.innerHeight,c.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,l)=>(pi(),mi("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2))}}),Ww=gi(Vw,[["__scopeId","data-v-8cfea564"]]),Xw={class:"pixel-controls"},qw={class:"side-buttons"},Yw=Bn({__name:"PopArtBear3",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03);const Q=xe.getElapsedTime();z.forEach((ye,ge)=>{const Ne=.2+Math.sin(Q*3+te[ge])*.1;ye.scale.set(Ne,Ne,Ne)}),x.render(p,_)};const p=new Gi,_=new It(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zi({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(x.domElement);const d=new Ye,m=new Ye;p.add(m);const b=new Wi(16777215,2);p.add(b);const M=new Vi(16777215,4);M.position.set(5,5,5),p.add(M);const w=new ki(16777215,5,50);w.position.set(0,2,4),p.add(w);const O=new Hi,P=O.load("/3d-bear-arts/assets/pop6.jpg"),R=O.load("/3d-bear-arts/assets/pop7.jpg");P.wrapS=P.wrapT=Nt,R.wrapS=R.wrapT=Nt,R.repeat.set(2,2);const U=new De({color:16738740,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),ne=new De({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:rt}),y=new De({color:16766720,map:P,metalness:.3,roughness:.5}),E=new De({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:rt}),$=new De({color:9055202,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),k=new De({color:65535,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),J=new De({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:rt}),oe=new Le(1,32,32,0,Math.PI),G=new D(oe,ne),Z=new D(oe,U);G.scale.set(.85,.85,.8),Z.scale.set(.85,.85,.8),G.position.y=-.2,Z.position.y=-.2,G.rotation.y=Math.PI/2,Z.rotation.y=Math.PI*1.5;const X=new _t(1,32),pe=new D(X,U);pe.scale.set(.85,.85,.8),pe.position.set(0,-.2,0),pe.rotation.y=Math.PI/2;const ve=new Ye;ve.add(G),ve.add(Z),ve.add(pe),d.add(ve);const _e=new Le(.6,32,32,0,Math.PI),Te=new D(_e,y);Te.scale.set(1,.95,.95),Te.position.set(0,1,0),Te.rotation.y=Math.PI*1.5;const Fe=new D(_e,E);Fe.scale.set(1,.95,.95),Fe.position.set(0,1,0),Fe.rotation.y=Math.PI/2;const re=new _t(.6,32),he=new D(re,y);he.position.set(0,1,0),he.rotation.y=Math.PI/2,he.scale.set(1,.95,.95);const Se=new Ye;Se.add(Te),Se.add(Fe),Se.add(he),d.add(Se);const F=new Le(.25,32,32),le=new D(F,U);le.position.set(-.45,1.35,-.1),d.add(le);const ie=new D(F,ne);ie.position.set(.45,1.35,-.1),d.add(ie);const ue=new Le(.25,32,32,Math.PI/2,Math.PI),we=new D(ue,y);we.scale.set(1.1,.6,.8),we.position.set(0,.84,.5),we.rotation.y=Math.PI;const ee=new Le(.25,32,32,Math.PI/2,Math.PI),g=new D(ee,E);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=0;const T=new _t(.25,32),L=new D(T,y);L.scale.set(.8,.6,.8),L.position.set(0,.84,.5),L.rotation.y=Math.PI/2;const N=new Ye;N.add(we),N.add(g),N.add(L),d.add(N);const I=new gn;I.moveTo(0,0),I.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),I.bezierCurveTo(-.6,.3,0,.6,0,1),I.bezierCurveTo(0,.6,.6,.3,.6,0),I.bezierCurveTo(.6,-.3,0,-.3,0,0);const q={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},j=new wn(I,q),S=new D(j,y);S.scale.set(.5,.5,.5),S.position.set(.3,0,0),S.rotation.y=Math.PI,S.rotation.x=Math.PI,d.add(S);const v=new D(j,k);v.scale.set(.2,.2,.25),v.position.set(.35,-.3,.4),v.rotation.y=Math.PI,v.rotation.x=Math.PI,d.add(v);const C=new D(j,U);C.scale.set(.25,.25,.27),C.position.set(.38,.3,-.2),C.rotation.y=Math.PI,C.rotation.x=Math.PI,d.add(C);const V=new Le(.35,32,32),B=new D(V,k);B.scale.set(.75,1.25,.65),B.position.set(-.7,-.15,.2),d.add(B);const H=new D(V,J);H.scale.set(.75,1.25,.65),H.position.set(.7,-.15,.2),d.add(H);const de=new Sn(.2,.22,.6,32),ce=new D(de,y);ce.position.set(-.4,-1.05,0),d.add(ce);const me=new D(de,E);me.position.set(.4,-1.05,0),d.add(me);const be=new Le(.3,32,32),fe=new D(be,y);fe.scale.set(1,.72,1.5),fe.position.set(-.4,-1.45,.17),d.add(fe);const Me=new D(be,E);Me.scale.set(1,.72,1.5),Me.position.set(.4,-1.45,.17),d.add(Me);const Ce=new Le(.44,32,32),Re=new D(Ce,U);Re.position.set(-.15,-.45,-.4),d.add(Re);const Ee=new D(Ce,ne);Ee.position.set(.15,-.45,-.4),d.add(Ee);const Be=new Le(.18,32,32),Pe=new D(Be,U);Pe.position.set(0,-.35,-.8),d.add(Pe),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Q){const ye=new Dt("X",{font:Q,size:.2,depth:.05}),ge=new D(ye,U);ge.position.set(-.3,.99,.53),ge.rotation.x=it.degToRad(-5),ge.rotation.y=it.degToRad(-15),d.add(ge);const Ne=new Dt("O",{font:Q,size:.2,depth:.05}),Ve=new D(Ne,k);Ve.position.set(.14,.99,.53),Ve.rotation.y=it.degToRad(12),Ve.rotation.x=it.degToRad(-5),d.add(Ve);const Ke=new Dt("POP",{font:Q,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});new Dt("🐻",{font:Q,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});const ke=new Dt("BAO      BEAR",{font:Q,size:2,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:3}),nt=new De({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new De({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const ot=new De({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),zt=new De({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),wt=new D(Ke,nt);wt.scale.set(.15,.15,.15),wt.position.set(.02,1.16,.1),wt.rotateZ(-25),d.add(wt);const Mt=new D(Ke,$);Mt.scale.set(.14,.14,.14),Mt.rotateZ(45),Mt.position.set(.2,-.7,.3),d.add(Mt);const Pt=new D(Ke,ot);Pt.scale.set(.14,.14,.14),Pt.rotateZ(45),Pt.rotateY(45),Pt.position.set(.3,.7,.3),d.add(Pt);const vt=new D(Ke,ot);vt.scale.set(.15,.15,.15),vt.rotateZ(45),vt.rotateY(45),vt.position.set(.35,-1.5,.3),d.add(vt);const Vt=new D(Ke,zt);Vt.scale.set(.17,.17,.17),Vt.rotateZ(45),Vt.rotateY(15),Vt.position.set(.35,1,.3),d.add(Vt);const Et=new D(ke,nt);Et.scale.set(.7,.7,.7),Et.position.set(-6,0,-3),m.add(Et)}),Pe.renderOrder=1,d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,d.rotation.x=.1;const z=[S,v,C],xe=new Qd,te=[0,Math.PI/2,Math.PI,0,Math.PI/3];f(),Ut(()=>e.bodyPosition,Q=>{d.position.set(Q.x,Q.y,Q.z)}),Ut(()=>e.cameraPosition,Q=>{_.position.set(e.bodyPosition.x,1,Q),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[je("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),je("div",Xw,[je("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),je("div",qw,[je("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),je("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),je("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),$w=gi(Yw,[["__scopeId","data-v-cb52c927"]]),jw={class:"pixel-controls"},Kw={class:"side-buttons"},Zw=Bn({__name:"MetalMachineBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(ot,zt){const wt=new Sn(ze,ze,z,32);wt.rotateX(Math.PI/2);const Mt=new D(wt,ot),Pt=new Ye;for(let Vt=0;Vt<xe;Vt++){const Et=Vt/xe*Math.PI*2,_n=new ps(te,Q,ye),qt=new D(_n,ot);qt.position.set((ze+ye/26)*Math.cos(Et),(ze+ye/26)*Math.sin(Et),0),qt.rotation.z=Et,Pt.add(qt)}const vt=new Ye;return vt.add(Mt),vt.add(Pt),vt.position.set(zt.x,zt.y,zt.z),vt},p=function(){requestAnimationFrame(p),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),r.value&&(m.rotation.x-=.03),o.value&&(m.rotation.x+=.03),ge.rotation.z-=.02,Ne.rotation.z+=.03,Ve.rotation.z+=.02,Ke.rotation.z+=.02,ke.rotation.z-=.03,nt.rotation.y+=.04,d.render(_,x)};const _=new Gi,x=new It(75,window.innerWidth/window.innerHeight,.1,1e3),d=new zi({antialias:!0,alpha:!0});d.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(d.domElement);const m=new Ye,b=new Ye;_.add(b);const M=new Wi(16777215,2);_.add(M);const w=new Vi(16777215,4);w.position.set(5,5,5),_.add(w);const O=new ki(16777215,5,50);O.position.set(0,2,4),_.add(O);const P=new Hi,R=P.load("/3d-bear-arts/assets/metal.jpg"),U=P.load("/3d-bear-arts/assets/pop7.jpg"),ne=P.load("/3d-bear-arts/assets/gear.jpg");R.wrapS=R.wrapT=Nt,U.wrapS=U.wrapT=Nt,U.repeat.set(2,2);const y=new De({color:13882323,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:R});ne.mapping=Nr;const E=new De({color:"#d3d3d3",metalness:1,roughness:.25,map:R,envMap:ne,clearcoat:.7,clearcoatRoughness:.3}),$=new De({color:"#C0C0C0",metalness:1,roughness:.25,envMap:ne,clearcoat:.7,clearcoatRoughness:.3}),k=new De({color:"#C0C0C0",metalness:1,roughness:.25,map:R,envMap:ne,transparent:!0,opacity:.8,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),J=new De({color:"#C0C0C0",metalness:1,roughness:.5,map:R,envMap:ne,transparent:!0,opacity:.23,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),oe=new De({color:13882323,metalness:1,roughness:.25,clearcoat:1,clearcoatRoughness:.05,reflectivity:.9,envMapIntensity:1,side:rt});new De({color:"#C0C0C0",metalness:1,roughness:.2,transparent:!0,opacity:.4,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45});const G=new De({color:"#d3d3d3",metalness:1,roughness:.2,map:ne,envMap:ne,clearcoat:.7,clearcoatRoughness:.3});new De({color:12632256,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:ne}),new De({color:12632256,metalness:1,roughness:.3,clearcoat:.5,clearcoatRoughness:.1,map:R,transparent:!0,opacity:.3});const Z=new Le(1,32,32,0,Math.PI),X=new D(Z,J),pe=new D(Z,E);X.scale.set(.85,.85,.8),pe.scale.set(.85,.85,.8),X.position.y=-.2,pe.position.y=-.2,X.rotation.y=Math.PI/2,pe.rotation.y=Math.PI*1.5;const ve=new _t(1,32),_e=new D(ve,k);_e.scale.set(.85,.85,.8),_e.position.set(0,-.2,0),_e.rotation.y=Math.PI/2;const Te=new Ye;Te.add(X),Te.add(pe),Te.add(_e),m.add(Te);const Fe=new Le(.6,32,32,0,Math.PI),re=new D(Fe,E);re.scale.set(1,.95,.95),re.position.set(0,1,0),re.rotation.y=Math.PI*1.5;const he=new D(Fe,J);he.scale.set(1,.95,.95),he.position.set(0,1,0),he.rotation.y=Math.PI/2;const Se=new _t(.6,32),F=new D(Se,k);F.position.set(0,1,0),F.rotation.y=Math.PI/2,F.scale.set(1,.95,.95);const le=new Ye;le.add(re),le.add(he),le.add(F),m.add(le);const ie=new Le(.25,32,32),ue=new D(ie,E);ue.position.set(-.45,1.35,-.1),m.add(ue);const we=new D(ie,k);we.position.set(.45,1.35,-.1),m.add(we);const ee=new Le(.25,32,32,Math.PI/2,Math.PI),g=new D(ee,E);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=Math.PI;const T=new Le(.25,32,32,Math.PI/2,Math.PI),L=new D(T,k);L.scale.set(1.1,.6,.8),L.position.set(0,.84,.5),L.rotation.y=0;const N=new _t(.25,32),I=new D(N,oe);I.scale.set(.8,.6,.8),I.position.set(0,.84,.5),I.rotation.y=Math.PI/2;const q=new Ye;q.add(g),q.add(L),q.add(I),m.add(q);const j=new gn;j.moveTo(0,0),j.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),j.bezierCurveTo(-.6,.3,0,.6,0,1),j.bezierCurveTo(0,.6,.6,.3,.6,0),j.bezierCurveTo(.6,-.3,0,-.3,0,0);const S={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},v=new wn(j,S),C=new Le(.35,32,32),V=new D(C,E);V.scale.set(.75,1.25,.65),V.position.set(-.7,-.15,.2),m.add(V);const B=new D(C,k);B.scale.set(.75,1.25,.65),B.position.set(.7,-.15,.2),m.add(B);const H=new Sn(.2,.22,.6,32),de=new D(H,E);de.position.set(-.4,-1.05,0),m.add(de);const ce=new D(H,k);ce.position.set(.4,-1.05,0),m.add(ce);const me=new Le(.3,32,32),be=new D(me,E);be.scale.set(1,.72,1.5),be.position.set(-.4,-1.45,.17),m.add(be);const fe=new D(me,k);fe.scale.set(1,.72,1.5),fe.position.set(.4,-1.45,.17),m.add(fe);const Me=new Le(.44,32,32),Ce=new D(Me,E);Ce.position.set(-.15,-.45,-.4),m.add(Ce);const Re=new D(Me,J);Re.position.set(.15,-.45,-.4),m.add(Re);const Ee=new Le(.18,32,32),Be=new D(Ee,E);Be.position.set(0,-.35,-.8),m.add(Be),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ot){const zt=new Dt("X",{font:ot,size:.2,depth:.05});new Fn({color:0});const wt=new D(zt,y);wt.position.set(-.3,.99,.53),wt.rotation.x=it.degToRad(-5),wt.rotation.y=it.degToRad(-15),m.add(wt);const Mt=new Dt("O",{font:ot,size:.2,depth:.05});new Fn({color:0});const Pt=new D(Mt,y);Pt.position.set(.14,.99,.53),Pt.rotation.y=it.degToRad(12),Pt.rotation.x=it.degToRad(-5),m.add(Pt)}),Be.renderOrder=1;const ze=1.2,z=.5,xe=8,te=.7,Q=.3,ye=.5,ge=f(G,{x:-2,y:0,z:0}),Ne=f(G,{x:0,y:0,z:0}),Ve=f(G,{x:2,y:0,z:0}),Ke=f(G,{x:2,y:0,z:0}),ke=f(G,{x:2,y:-2,z:0}),nt=new D(v,$);nt.scale.set(.3,.3,.3),nt.position.set(.25,1.1,0),nt.rotation.y=Math.PI,nt.rotation.x=Math.PI,m.add(nt),ge.position.set(.35,0,0),Ne.position.set(.25,-.3,.4),Ve.position.set(.3,.3,-.2),Ke.position.set(.25,.17,.4),ke.position.set(.5,-.3,.45),ge.scale.set(.2,.2,.2),Ne.scale.set(.18,.18,.18),Ve.scale.set(.15,.15,.15),Ke.scale.set(.17,.17,.17),ke.scale.set(.15,.15,.15),Ne.rotation.z=Math.PI/4,Ve.rotation.z=-Math.PI/4,Ke.rotation.y=-Math.PI/2,ke.rotation.y=-Math.PI/2,m.add(ge),m.add(Ne),m.add(Ve),m.add(Ke),m.add(ke),m.rotation.x=.1,m.scale.set(1.4,1.4,1.4),_.add(m),m.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),x.position.set(e.bodyPosition.x,1,e.cameraPosition),x.lookAt(e.bodyPosition.x,0,0),x.position.z=4,p(),Ut(()=>e.bodyPosition,ot=>{m.position.set(ot.x,ot.y,ot.z)}),Ut(()=>e.cameraPosition,ot=>{x.position.set(e.bodyPosition.x,1,ot),x.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{x.aspect=window.innerWidth/window.innerHeight,x.updateProjectionMatrix(),d.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[je("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),je("div",jw,[je("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),je("div",Kw,[je("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),je("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),je("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),Jw=gi(Zw,[["__scopeId","data-v-9a57b6d8"]]),Qw={class:"pixel-controls"},eE={class:"side-buttons"},tE=Bn({__name:"WaterBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),x.render(p,_)};const p=new Gi,_=new It(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zi({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(x.domElement);const d=new Ye,m=new Ye;p.add(m);const b=new Wi(16777215,2);p.add(b);const M=new Vi(16777215,4);M.position.set(5,5,5),p.add(M);const w=new ki(16777215,5,50);w.position.set(0,2,4),p.add(w);const O=new Hi,P=O.load("/3d-bear-arts/assets/sun.jpg"),R=O.load("/3d-bear-arts/assets/gear.jpg"),U=O.load("/3d-bear-arts/assets/underwater.jpg"),ne=O.load("/3d-bear-arts/assets/beach.jpg");U.wrapS=U.wrapT=Nt,ne.wrapS=ne.wrapT=Nt,ne.repeat.set(.8,1),R.mapping=Nr,P.wrapS=P.wrapT=Nt;const y=new De({color:11592447,metalness:.05,roughness:.4,clearcoat:.9,clearcoatRoughness:.2,reflectivity:.6,map:ne,envMapIntensity:.8,side:rt,transparent:!0,opacity:.9}),E=new De({color:11592447,metalness:.05,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,reflectivity:.4,map:ne,envMapIntensity:.6,side:rt,transparent:!0,opacity:.9,transmission:.5,ior:1.33,depthWrite:!1,depthTest:!0});new De({color:11592447,metalness:.05,roughness:.4,clearcoat:.9,clearcoatRoughness:.2,reflectivity:.6,envMapIntensity:.8,map:ne,side:rt,transparent:!0,opacity:.9});const $=new De({color:8374441,metalness:1,roughness:.25,envMap:R,clearcoat:.7,clearcoatRoughness:.3}),k=new De({color:11592447,metalness:.1,roughness:.3,transparent:!0,opacity:.5,clearcoat:.6,clearcoatRoughness:.25,transmission:.6,ior:1.4,depthWrite:!1,depthTest:!0,side:rt}),J=new De({color:11592447,metalness:.1,roughness:.3,transparent:!0,opacity:.5,map:ne,clearcoat:.1,clearcoatRoughness:.25,transmission:.6,ior:1.4}),oe=new De({color:"#a4d0f5",metalness:0,roughness:.8,map:P,clearcoat:.1,clearcoatRoughness:.7,transmission:.9,opacity:.8,transparent:!0}),G=new De({color:"#a4d0f5",metalness:0,roughness:.85,map:ne,clearcoat:.1,clearcoatRoughness:.7,transmission:.9,opacity:.6,transparent:!0}),Z=new Le(1,32,32,0,Math.PI),X=new D(Z,k),pe=new D(Z,E);X.scale.set(.85,.85,.8),pe.scale.set(.85,.85,.8),X.position.y=-.2,pe.position.y=-.2,X.rotation.y=Math.PI/2,pe.rotation.y=Math.PI*1.5;const ve=new _t(1,32),_e=new D(ve,G);_e.scale.set(.85,.85,.8),_e.position.set(0,-.2,0),_e.rotation.y=Math.PI/2;const Te=new Ye;Te.add(X),Te.add(pe),Te.add(_e);const Fe=new Le(.6,32,32,0,Math.PI*2,0,Math.PI/2),re=new De({color:6935271,metalness:.1,roughness:.2,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.9,transmission:.9,ior:1.33,reflectivity:.8,envMapIntensity:1}),he=new D(Fe,re);he.position.set(0,-.2,0),he.rotation.x=Math.PI,he.scale.set(1.25,1.25,1.25),Te.add(he);const Se=new De({color:49151,metalness:.1,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,side:rt,transparent:!0,opacity:.7,depthWrite:!1}),F=new D(ve,Se);F.scale.set(.7,.7,.7),F.position.set(0,-.3,0),F.rotation.x=Math.PI/2,F.renderOrder=1,Te.add(F),d.add(Te);const le=new Le(.6,32,32,0,Math.PI),ie=new D(le,y);ie.scale.set(1,.95,.95),ie.position.set(0,1,0),ie.rotation.y=Math.PI*1.5;const ue=new D(le,J);ue.scale.set(1,.95,.95),ue.position.set(0,1,0),ue.rotation.y=Math.PI/2;const we=new _t(.6,32),ee=new D(we,oe);ee.position.set(0,1,0),ee.rotation.y=Math.PI/2,ee.scale.set(1,.95,.95);const g=new Ye;g.add(ie),g.add(ue),g.add(ee),d.add(g);const T=new Le(.25,32,32),L=new D(T,y);L.position.set(-.45,1.35,-.1),d.add(L);const N=new D(T,J);N.position.set(.45,1.35,-.1),d.add(N);const I=new Le(.25,32,32,Math.PI/2,Math.PI),q=new D(I,y);q.scale.set(1.1,.6,.8),q.position.set(0,.84,.5),q.rotation.y=Math.PI;const j=new Le(.25,32,32,Math.PI/2,Math.PI),S=new D(j,J);S.scale.set(1.1,.6,.8),S.position.set(0,.84,.5),S.rotation.y=0;const v=new _t(.25,32),C=new D(v,oe);C.scale.set(.8,.6,.8),C.position.set(0,.84,.5),C.rotation.y=Math.PI/2;const V=new Ye;V.add(q),V.add(S),V.add(C),d.add(V);const B=new gn;B.moveTo(0,0),B.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),B.bezierCurveTo(-.6,.3,0,.6,0,1),B.bezierCurveTo(0,.6,.6,.3,.6,0),B.bezierCurveTo(.6,-.3,0,-.3,0,0);const H={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},de=new wn(B,H),ce=new Le(.35,32,32),me=new D(ce,y);me.scale.set(.75,1.25,.65),me.position.set(-.7,-.15,.2),d.add(me);const be=new D(ce,J);be.scale.set(.75,1.25,.65),be.position.set(.7,-.15,.2),d.add(be);const fe=new Sn(.2,.22,.6,32),Me=new D(fe,y);Me.position.set(-.4,-1.05,0),d.add(Me);const Ce=new D(fe,J);Ce.position.set(.4,-1.05,0),d.add(Ce);const Re=new Le(.3,32,32),Ee=new D(Re,y);Ee.scale.set(1,.72,1.5),Ee.position.set(-.4,-1.45,.17),d.add(Ee);const Be=new D(Re,J);Be.scale.set(1,.72,1.5),Be.position.set(.4,-1.45,.17),d.add(Be);const Pe=new Le(.44,32,32),ze=new D(Pe,y);ze.position.set(-.15,-.45,-.4),d.add(ze);const z=new D(Pe,J);z.position.set(.15,-.45,-.4),d.add(z);const xe=new Le(.18,32,32),te=new D(xe,E);te.position.set(0,-.35,-.8),d.add(te),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ge){const Ne=new Dt("X",{font:ge,size:.2,depth:.05});new Fn({color:0});const Ve=new D(Ne,y);Ve.position.set(-.3,.99,.53),Ve.rotation.x=it.degToRad(-5),Ve.rotation.y=it.degToRad(-15),d.add(Ve);const Ke=new Dt("O",{font:ge,size:.2,depth:.05});new Fn({color:0});const ke=new D(Ke,E);ke.position.set(.14,.99,.53),ke.rotation.y=it.degToRad(12),ke.rotation.x=it.degToRad(-5),d.add(ke)}),te.renderOrder=1,d.rotation.x=.1;const ye=new D(de,$);ye.scale.set(.3,.3,.3),ye.position.set(.25,1.1,0),ye.rotation.y=Math.PI,ye.rotation.x=Math.PI,d.add(ye),d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,f(),Ut(()=>e.bodyPosition,ge=>{d.position.set(ge.x,ge.y,ge.z)}),Ut(()=>e.cameraPosition,ge=>{_.position.set(e.bodyPosition.x,1,ge),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[je("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),je("div",Qw,[je("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),je("div",eE,[je("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),je("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),je("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),nE=gi(tE,[["__scopeId","data-v-08c607ba"]]),iE={class:"pixel-controls"},sE={class:"side-buttons"},rE=Bn({__name:"Water",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),we.uniforms.u_time.value+=.25,ce.rotation.y+=.04,x.render(p,_)};const p=new Gi,_=new It(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zi({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(x.domElement);const d=new Ye,m=new Ye;p.add(m);const b=new Wi(16777215,2);p.add(b);const M=new Vi(16777215,4);M.position.set(5,5,5),p.add(M);const w=new ki(16777215,5,50);w.position.set(0,2,4),p.add(w);const O=new Hi,P=O.load("/3d-bear-arts/assets/beach.jpg");P.repeat.set(.8,1);const R=O.load("/3d-bear-arts/assets/sun.jpg");P.wrapS=P.wrapT=Nt,P.repeat.set(.8,1),R.wrapS=R.wrapT=Nt;const U=new De({color:11592447,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new De({color:11592447,map:P,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:rt,depthWrite:!1,depthTest:!0});const ne=new De({color:11592447,map:P,metalness:.3,roughness:.5,transparent:!0,opacity:.6,side:rt,ior:1.33,depthWrite:!1,depthTest:!0}),y=new De({color:11592447,map:P,metalness:.1,roughness:.6,transparent:!0,opacity:.85,clearcoat:.9,clearcoatRoughness:.4,transmission:.7,ior:1.2,depthTest:!0,envMapIntensity:.8}),E=new De({color:11592447,map:P,metalness:.1,roughness:.6,transparent:!0,opacity:.85,clearcoat:.9,clearcoatRoughness:.4,transmission:.7,ior:1.2,depthWrite:!1,depthTest:!0,envMapIntensity:.6,side:rt}),$=new De({color:11592447,map:P,metalness:.3,roughness:.5,transparent:!0,opacity:.8,side:rt,ior:1.33});new De({color:11592447,map:P,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.7,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1});const k=new De({color:11592447,map:P,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),J=new Le(1,32,32,0,Math.PI),oe=new D(J,E),G=new D(J,ne);oe.scale.set(.85,.85,.8),G.scale.set(.85,.85,.8),oe.position.y=-.2,G.position.y=-.2,oe.rotation.y=Math.PI/2,G.rotation.y=Math.PI*1.5;const Z=new _t(1,32),X=new D(Z,U);X.scale.set(.85,.85,.8),X.position.set(0,-.2,0),X.rotation.y=Math.PI/2;const pe=new Ye;pe.add(oe),pe.add(G),pe.add(X),d.add(pe);const ve=new Le(.6,32,32,0,Math.PI),_e=new D(ve,U);_e.scale.set(1,.95,.95),_e.position.set(0,1,0),_e.rotation.y=Math.PI*1.5;const Te=new D(ve,y);Te.scale.set(1,.95,.95),Te.position.set(0,1,0),Te.rotation.y=Math.PI/2;const Fe=new _t(.6,32),re=new D(Fe,U);re.position.set(0,1,0),re.rotation.y=Math.PI/2,re.scale.set(1,.95,.95);const he=new Ye;he.add(_e),he.add(Te),he.add(re),d.add(he);const Se=new Le(.6,32,32,0,Math.PI*2,0,Math.PI/2),F=new De({color:11592447,metalness:.1,roughness:.2,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.9,transmission:.9,ior:1.33,reflectivity:.8,envMapIntensity:1}),le=new D(Se,F);le.position.set(0,-.2,0),le.rotation.x=Math.PI,le.scale.set(1.25,1.25,1.25),pe.add(le);const ie=new De({color:49151,metalness:.1,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,side:rt,transparent:!0,opacity:.7,depthWrite:!1}),ue=new D(Z,ie);ue.scale.set(.7,.7,.7),ue.position.set(0,-.3,0),ue.rotation.x=Math.PI/2,ue.renderOrder=1,pe.add(ue),d.add(pe);const we=new $n({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:8},u_waveAmplitude:{value:.05},u_waveSpeed:{value:1.2}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),ee=new D(Z,we);ee.position.set(0,-.3,0),ee.scale.set(.7,.7,.7),ee.rotation.x=-Math.PI/2,ee.renderOrder=1,pe.add(ee);const g=new Le(.25,32,32),T=new D(g,$);T.position.set(-.45,1.35,-.1),d.add(T);const L=new D(g,y);L.position.set(.45,1.35,-.1),d.add(L);const N=new Le(.25,32,32,Math.PI/2,Math.PI),I=new D(N,$);I.scale.set(1.1,.6,.8),I.position.set(0,.84,.5),I.rotation.y=Math.PI;const q=new Le(.25,32,32,Math.PI/2,Math.PI),j=new D(q,ne);j.scale.set(1.1,.6,.8),j.position.set(0,.84,.5),j.rotation.y=0;const S=new _t(.25,32),v=new D(S,ne);v.scale.set(.8,.6,.8),v.position.set(0,.84,.5),v.rotation.y=Math.PI/2;const C=new Ye;C.add(I),C.add(j),C.add(v),d.add(C);const V=new De({color:8374441,metalness:1,roughness:.25,envMap:R,clearcoat:.7,clearcoatRoughness:.3}),B=new gn;B.moveTo(0,0),B.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),B.bezierCurveTo(-.6,.3,0,.6,0,1),B.bezierCurveTo(0,.6,.6,.3,.6,0),B.bezierCurveTo(.6,-.3,0,-.3,0,0);const H={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},de=new wn(B,H),ce=new D(de,V);ce.scale.set(.3,.3,.3),ce.position.set(.25,1.1,0),ce.rotation.y=Math.PI,ce.rotation.x=Math.PI,d.add(ce);const me=new Le(.35,32,32),be=new D(me,ne);be.scale.set(.75,1.25,.65),be.position.set(-.7,-.15,.2),d.add(be);const fe=new D(me,ne);fe.scale.set(.75,1.25,.65),fe.position.set(.7,-.15,.2),d.add(fe);const Me=new Sn(.2,.22,.6,32),Ce=new D(Me,$);Ce.position.set(-.4,-1.05,0),d.add(Ce);const Re=new D(Me,$);Re.position.set(.4,-1.05,0),d.add(Re);const Ee=new Le(.3,32,32),Be=new D(Ee,$);Be.scale.set(1,.72,1.5),Be.position.set(-.4,-1.45,.17),d.add(Be);const Pe=new D(Ee,$);Pe.scale.set(1,.72,1.5),Pe.position.set(.4,-1.45,.17),d.add(Pe);const ze=new Le(.44,32,32),z=new D(ze,$);z.position.set(-.15,-.45,-.4),d.add(z);const xe=new D(ze,y);xe.position.set(.15,-.45,-.4),d.add(xe);const te=new Le(.18,32,32),Q=new D(te,$);Q.position.set(0,-.35,-.8),d.add(Q),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ge){const Ne=new Dt("X",{font:ge,size:.2,depth:.05}),Ve=new D(Ne,k);Ve.position.set(-.3,.99,.53),Ve.rotation.x=it.degToRad(-5),Ve.rotation.y=it.degToRad(-15),d.add(Ve);const Ke=new Dt("O",{font:ge,size:.2,depth:.05}),ke=new D(Ke,k);ke.position.set(.14,.99,.53),ke.rotation.y=it.degToRad(12),ke.rotation.x=it.degToRad(-5),d.add(ke)}),d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4,d.rotation.x=.1,f(),Ut(()=>e.bodyPosition,ge=>{d.position.set(ge.x,ge.y,ge.z)}),Ut(()=>e.cameraPosition,ge=>{_.position.set(e.bodyPosition.x,1,ge),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[je("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),je("div",iE,[je("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),je("div",sE,[je("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),je("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),je("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),oE=gi(rE,[["__scopeId","data-v-fa97f0a2"]]),aE={class:"pixel-controls"},lE={class:"side-buttons"},cE=Bn({__name:"GhostBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(vt,Vt){const Et=new Ye,_n=new Le(1,32,32),qt=new D(_n,J);qt.scale.set(1,.8,1),Et.add(qt);const jr=new Sn(.1,.1,.5,16),Kr=new Zd({color:9127187}),Zr=new D(jr,Kr);return Zr.position.set(0,.9,0),Et.add(Zr),Et},p=function(){requestAnimationFrame(p),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),r.value&&(m.rotation.x-=.03),o.value&&(m.rotation.x+=.03),Pe.rotation.z-=.04,ze.rotation.z+=.04,z.rotation.z+=.03,xe.rotation.z+=.03,te.rotation.z-=.04,Be.rotation.y+=.04,Pt+=wt,m.position.y=e.bodyPosition.y+Math.sin(Pt)*Mt;const vt=ot.getElapsedTime();nt.forEach((Vt,Et)=>{const _n=.2+Math.sin(vt*3+zt[Et])*.1;Vt.scale.set(_n,_n,_n)}),d.render(_,x)};const _=new Gi,x=new It(75,window.innerWidth/window.innerHeight,.1,1e3),d=new zi({antialias:!0,alpha:!0});d.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(d.domElement);const m=new Ye,b=new Ye;_.add(b);const M=new Wi(16777215,2);_.add(M);const w=new Vi(16777215,4);w.position.set(5,5,5),_.add(w);const O=new ki(16777215,5,50);O.position.set(0,2,4),_.add(O);const P=new Hi,R=P.load("/3d-bear-arts/assets/pumpkin.jpg");R.wrapS=R.wrapT=Nt,R.repeat.set(.8,.8);const U=P.load("/3d-bear-arts/assets/pumpkin.jpg");U.wrapS=U.wrapT=Nt,U.repeat.set(1,1);const ne=new De({color:16747520,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),y=new Ye,E=new De({color:16747520,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),$=new De({color:16747520,map:U,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),k=new De({color:16747520,map:R,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.8,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:rt});new De({color:5597999,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});const J=new De({color:16766720,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new De({color:9109504,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),new De({color:4915330,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});const oe=new Le(1,32,32,0,Math.PI),G=new D(oe,k),Z=new D(oe,E);G.scale.set(.85,.85,.8),Z.scale.set(.85,.85,.8),G.position.y=-.2,Z.position.y=-.2,G.rotation.y=Math.PI/2,Z.rotation.y=Math.PI*1.5;const X=new _t(1,32),pe=new D(X,$);pe.scale.set(.85,.85,.8),pe.position.set(0,-.2,0),pe.rotation.y=Math.PI/2;const ve=new Ye;ve.add(G),ve.add(Z),ve.add(pe),m.add(ve);const _e=new Le(.6,32,32,0,Math.PI),Te=new D(_e,E);Te.scale.set(1,.95,.95),Te.position.set(0,1,0),Te.rotation.y=Math.PI*1.5;const Fe=new D(_e,k);Fe.scale.set(1,.95,.95),Fe.position.set(0,1,0),Fe.rotation.y=Math.PI/2;const re=new _t(.6,32),he=new D(re,$);he.position.set(0,1,0),he.rotation.y=Math.PI/2,he.scale.set(1,.95,.95);const Se=new Ye;Se.add(Te),Se.add(Fe),Se.add(he),m.add(Se);const F=new Le(.25,32,32),le=new D(F,$);le.position.set(-.45,1.35,-.1),m.add(le);const ie=new D(F,k);ie.position.set(.45,1.35,-.1),m.add(ie);const ue=new Le(.25,32,32,Math.PI/2,Math.PI),we=new D(ue,E);we.scale.set(1.1,.6,.8),we.position.set(0,.84,.5),we.rotation.y=Math.PI;const ee=new Le(.25,32,32,Math.PI/2,Math.PI),g=new D(ee,k);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=0;const T=new _t(.25,32),L=new D(T,E);L.scale.set(.8,.6,.8),L.position.set(0,.84,.5),L.rotation.y=Math.PI/2;const N=new Ye;N.add(we),N.add(g),N.add(L),m.add(N);const I=new gn;I.moveTo(0,0),I.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),I.bezierCurveTo(-.6,.3,0,.6,0,1),I.bezierCurveTo(0,.6,.6,.3,.6,0),I.bezierCurveTo(.6,-.3,0,-.3,0,0);const q={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},j=new wn(I,q),S=new Le(.35,32,32),v=new D(S,E);v.scale.set(.75,1.25,.65),v.position.set(-.7,-.15,.2),m.add(v);const C=new D(S,k);C.scale.set(.75,1.25,.65),C.position.set(.7,-.15,.2),m.add(C);const V=new Sn(.2,.22,.6,32),B=new D(V,E);B.position.set(-.4,-1.05,0),m.add(B);const H=new D(V,k);H.position.set(.4,-1.05,0),m.add(H);const de=new Le(.3,32,32),ce=new D(de,E);ce.scale.set(1,.72,1.5),ce.position.set(-.4,-1.45,.17),m.add(ce);const me=new D(de,k);me.scale.set(1,.72,1.5),me.position.set(.4,-1.45,.17),m.add(me);const be=new Le(.44,32,32),fe=new D(be,E);fe.position.set(-.15,-.45,-.4),m.add(fe);const Me=new D(be,k);Me.position.set(.15,-.45,-.4),m.add(Me);const Ce=new Le(.18,32,32),Re=new D(Ce,$);Re.position.set(0,-.35,-.8),m.add(Re),Re.renderOrder=1,new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(vt){const Vt=new Dt("X",{font:vt,size:.2,depth:.05}),Et=new D(Vt,$);Et.position.set(-.3,.99,.53),Et.rotation.x=it.degToRad(-5),Et.rotation.y=it.degToRad(-15),m.add(Et);const _n=new Dt("O",{font:vt,size:.2,depth:.05}),qt=new D(_n,$);qt.position.set(.14,.99,.53),qt.rotation.y=it.degToRad(12),qt.rotation.x=it.degToRad(-5),m.add(qt)});const Be=new D(j,ne);Be.scale.set(.3,.3,.3),Be.position.set(.25,1.1,0),Be.rotation.y=Math.PI,Be.rotation.x=Math.PI,m.add(Be),m.add(y);const Pe=f(),ze=f(),z=f(),xe=f(),te=f();Pe.position.set(.35,-.35,-.3),ze.position.set(.25,-.45,.3),z.position.set(.3,.1,-.2),xe.position.set(.25,.18,.4),te.position.set(.5,-.3,-.45),Pe.scale.set(.3,.3,.3),ze.scale.set(.28,.28,.28),z.scale.set(.25,.25,.25),xe.scale.set(.23,.23,.23),te.scale.set(.25,.2,.25),ze.rotation.z=Math.PI/4,z.rotation.z=-Math.PI/4,xe.rotation.y=-Math.PI/2,te.rotation.y=-Math.PI/2,m.add(Pe),m.add(ze),m.add(z),m.add(xe);const Q=new gn;Q.moveTo(-.5,0),Q.bezierCurveTo(-.75,.25,-1,.6,-.5,.8),Q.bezierCurveTo(-.25,.85,-.25,.5,-.15,.4),Q.bezierCurveTo(-.05,.6,.05,.6,.15,.4),Q.bezierCurveTo(.25,.5,.25,.85,.5,.8),Q.bezierCurveTo(1,.6,.75,.25,.5,0),Q.bezierCurveTo(.3,-.25,-.3,-.25,-.5,0);const ye={depth:.1,bevelEnabled:!1},ge=new wn(Q,ye),Ne=new Fn({color:0}),Ve=new D(ge,Ne);Ve.scale.set(.3,.3,.3),Ve.rotation.x=0,Ve.rotation.z=0,Ve.position.set(.3,.2,.65),m.add(Ve);const Ke=new D(ge,Ne);Ke.scale.set(.5,.5,.5),Ke.position.set(.3,-.1,.65),m.add(Ke);const ke=new D(ge,Ne);ke.scale.set(.5,.5,.5),ke.position.set(.4,-.35,.65),m.add(ke),m.rotation.x=.1,m.scale.set(1.4,1.4,1.4),_.add(m),m.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),x.position.set(e.bodyPosition.x,1,e.cameraPosition),x.lookAt(e.bodyPosition.x,0,0),x.position.z=4;const nt=[Ve,Ke,ke],ot=new Qd,zt=[0,Math.PI/2,Math.PI,0,Math.PI/3];let wt=.05,Mt=.5,Pt=0;p(),Ut(()=>e.bodyPosition,vt=>{m.position.set(vt.x,vt.y,vt.z)}),Ut(()=>e.cameraPosition,vt=>{x.position.set(e.bodyPosition.x,1,vt),x.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{x.aspect=window.innerWidth/window.innerHeight,x.updateProjectionMatrix(),d.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[je("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),je("div",aE,[je("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),je("div",lE,[je("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),je("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),je("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),uE=gi(cE,[["__scopeId","data-v-b9121169"]]),hE={class:"pixel-controls"},fE={class:"side-buttons"},dE=Bn({__name:"GhostBallonBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=tt(null);let i=tt(!1),s=tt(!1),r=tt(!1),o=tt(!1);jn(()=>{if(t.value){let f=function(){requestAnimationFrame(f),i.value&&(d.rotation.y+=.03),s.value&&(d.rotation.y-=.03),r.value&&(d.rotation.x-=.03),o.value&&(d.rotation.x+=.03),ze.rotation.y+=.03,ye+=z,ge+=xe,d.position.y=e.bodyPosition.y+Math.sin(ye)*Q,ze.position.y=e.bodyPosition.y+Math.sin(ge)*te,Ee.uniforms.u_time.value+=.25,x.render(p,_)};const p=new Gi,_=new It(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zi({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(x.domElement);const d=new Ye,m=new Ye;p.add(m);const b=new Wi(16777215,2);p.add(b);const M=new Vi(16777215,4);M.position.set(5,5,5),p.add(M);const w=new ki(16777215,5,50);w.position.set(0,2,4),p.add(w);const O=new Hi,P=O.load("/3d-bear-arts/assets/pumpkin.jpg");P.wrapS=P.wrapT=Nt,P.repeat.set(.8,.8);const R=O.load("/3d-bear-arts/assets/pumpkin.jpg");R.wrapS=R.wrapT=Nt,R.repeat.set(1,1),new De({color:16747520,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});const U=new De({color:16777215,metalness:0,roughness:.8,clearcoat:.3,clearcoatRoughness:.9,transparent:!0,opacity:.15,transmission:.95,ior:1.1,reflectivity:.2,envMapIntensity:.3,depthTest:!0,depthWrite:!1,side:rt});new De({color:9109504,metalness:0,roughness:.8,clearcoat:.3,clearcoatRoughness:.9,transparent:!0,opacity:.99,transmission:.95,ior:1.1,reflectivity:.2,envMapIntensity:.3,depthTest:!0,depthWrite:!1,side:rt});const ne=new De({color:9109504,metalness:.9,roughness:.25,clearcoat:.7,clearcoatRoughness:.3}),y=new De({color:16777215,metalness:.1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.1,transmission:.95,ior:1,reflectivity:.2,envMapIntensity:.4,depthTest:!0,depthWrite:!1,side:rt}),E=new De({color:16777215,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.3,transmission:.8,reflectivity:.9,envMapIntensity:1,depthTest:!0,depthWrite:!1,side:rt}),$=new Le(1,32,32,0,Math.PI),k=new D($,U),J=new D($,E);k.scale.set(.85,.85,.8),J.scale.set(.85,.85,.8),k.position.y=-.2,J.position.y=-.2,k.rotation.y=Math.PI/2,J.rotation.y=Math.PI*1.5;const oe=new _t(1,32),G=new D(oe,E);G.scale.set(.85,.85,.8),G.position.set(0,-.2,0),G.rotation.y=Math.PI/2;const Z=new Ye;Z.add(k),Z.add(J),Z.add(G),d.add(Z);const X=new Le(.6,32,32,0,Math.PI),pe=new D(X,E);pe.scale.set(1,.95,.95),pe.position.set(0,1,0),pe.rotation.y=Math.PI*1.5;const ve=new D(X,U);ve.scale.set(1,.95,.95),ve.position.set(0,1,0),ve.rotation.y=Math.PI/2;const _e=new _t(.6,32),Te=new D(_e,E);Te.position.set(0,1,0),Te.rotation.y=Math.PI/2,Te.scale.set(1,.95,.95);const Fe=new Ye;Fe.add(pe),Fe.add(ve),Fe.add(Te),d.add(Fe);const re=new Le(.25,32,32),he=new D(re,E);he.position.set(-.45,1.35,-.1),d.add(he);const Se=new D(re,U);Se.position.set(.45,1.35,-.1),d.add(Se);const F=new Le(.25,32,32,Math.PI/2,Math.PI),le=new D(F,E);le.scale.set(1.1,.6,.8),le.position.set(0,.84,.5),le.rotation.y=Math.PI;const ie=new Le(.25,32,32,Math.PI/2,Math.PI),ue=new D(ie,U);ue.scale.set(1.1,.6,.8),ue.position.set(0,.84,.5),ue.rotation.y=0;const we=new _t(.25,32),ee=new D(we,E);ee.scale.set(.8,.6,.8),ee.position.set(0,.84,.5),ee.rotation.y=Math.PI/2;const g=new Ye;g.add(le),g.add(ue),g.add(ee),d.add(g);const T=new gn;T.moveTo(0,0),T.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),T.bezierCurveTo(-.6,.3,0,.6,0,1),T.bezierCurveTo(0,.6,.6,.3,.6,0),T.bezierCurveTo(.6,-.3,0,-.3,0,0);const L={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},N=new wn(T,L),I=new Le(.35,32,32),q=new D(I,E);q.scale.set(.75,1.25,.65),q.position.set(-.7,-.15,.2),d.add(q);const j=new D(I,y);j.scale.set(.75,1.25,.65),j.position.set(.7,-.15,.2),d.add(j);const S=new Sn(.2,.22,.6,32),v=new D(S,E);v.position.set(-.4,-1.05,0),d.add(v);const C=new D(S,U);C.position.set(.4,-1.05,0),d.add(C);const V=new Le(.3,32,32),B=new D(V,E);B.scale.set(1,.72,1.5),B.position.set(-.4,-1.45,.17),d.add(B);const H=new D(V,U);H.scale.set(1,.72,1.5),H.position.set(.4,-1.45,.17),d.add(H);const de=new Le(.44,32,32),ce=new D(de,y);ce.position.set(-.15,-.45,-.4),d.add(ce);const me=new D(de,y);me.position.set(.15,-.45,-.4),d.add(me);const be=new Le(.18,32,32),fe=new D(be,E);fe.position.set(0,-.35,-.8),d.add(fe);const Me=new Le(.6,32,32,0,Math.PI*2,0,Math.PI/2),Ce=new De({color:9109504,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.8,transmission:.85,ior:1.4,reflectivity:.9,envMapIntensity:1.2}),Re=new D(Me,Ce);Re.position.set(0,-.2,0),Re.rotation.x=Math.PI,Re.scale.set(1.25,1.25,1.25),Z.add(Re);const Ee=new $n({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:4},u_waveAmplitude:{value:.5},u_waveSpeed:{value:.3}},vertexShader:`
                precision mediump float;
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `}),Be=new D(oe,Ee);Be.position.set(0,-.26,0),Be.scale.set(.7,.7,.7),Be.rotation.x=-Math.PI/2,Be.renderOrder=1,Z.add(Be),new Xi().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Ne){const Ve=new Dt("X",{font:Ne,size:.2,depth:.05}),Ke=new D(Ve,U);Ke.position.set(-.3,.99,.53),Ke.rotation.x=it.degToRad(-5),Ke.rotation.y=it.degToRad(-15),d.add(Ke);const ke=new Dt("O",{font:Ne,size:.2,depth:.05}),nt=new D(ke,y);nt.position.set(.14,.99,.53),nt.rotation.y=it.degToRad(12),nt.rotation.x=it.degToRad(-5),d.add(nt)}),fe.renderOrder=1;const ze=new D(N,ne);ze.scale.set(.5,.5,.5),ze.position.set(0,-.05,0),ze.rotation.y=Math.PI,ze.rotation.x=Math.PI,d.add(ze),d.rotation.x=.1,d.scale.set(1.4,1.4,1.4),p.add(d),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),_.position.set(e.bodyPosition.x,1,e.cameraPosition),_.lookAt(e.bodyPosition.x,0,0),_.position.z=4;let z=.04,xe=.06,te=.2,Q=.2,ye=0,ge=0;f(),Ut(()=>e.bodyPosition,Ne=>{d.position.set(Ne.x,Ne.y,Ne.z)}),Ut(()=>e.cameraPosition,Ne=>{_.position.set(e.bodyPosition.x,1,Ne),_.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{_.aspect=window.innerWidth/window.innerHeight,_.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function l(){i.value=!0}function c(){r.value=!0}function h(){o.value=!0}function u(){s.value=!1,i.value=!1,r.value=!1,o.value=!1}return(f,p)=>(pi(),mi(rn,null,[je("div",{ref_key:"threeCanvas",ref:t,class:On(n.background?"no-bg":"three-canvas")},null,2),je("div",hE,[je("button",{class:"pixel-btn up",onMousedown:c,onMouseup:u},"UP",32),je("div",fE,[je("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),je("button",{class:"pixel-btn right",onMousedown:l,onMouseup:u},"RIGHT",32)]),je("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),pE=gi(dE,[["__scopeId","data-v-d6d1c364"]]),mE=[{path:"/3d-bear-arts/leather",name:"Leather",component:kw},{path:"/3d-bear-arts/pop-art",name:"Pop",component:Ww},{path:"/3d-bear-arts/pop-art-bear-3",name:"PopArtBear 3",component:$w},{path:"/3d-bear-arts/machine",name:"MetalMachineBear",component:Jw},{path:"/3d-bear-arts/water",name:"Water Bear",component:nE},{path:"/3d-bear-arts/",name:"Water",component:oE},{path:"/3d-bear-arts/ghost-bear",name:"GhostBear",component:uE},{path:"/3d-bear-arts/white-ghost-bear",name:"GhostBallonBear",component:pE}],gE=Dg({history:cg(),routes:mE}),ep=A0(I0);ep.use(gE);ep.mount("#app");
