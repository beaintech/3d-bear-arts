...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function wh(){return new xt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zc(),fragmentShader:`
		...
		`,blending:yi,depthTest:!1,depthWrite:!1})}function bh(){return new xt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zc(),fragmentShader:`
...
`)a=0,l-=s;else{const h=YE(u,r,a,l,t);a+=h.offsetX,o.push(h.path)}}return o}function YE(n,e,t,i,r){const s=r.glyphs[n]||r.glyphs["?"];if(!s){console.error('THREE.Font: character "'+n+'" does not exists in font family '+r.familyName+".");return}const o=new WE;let a,l,c,u,h,f,d,_;if(s.o){const y=s._cachedOutline||(s._cachedOutline=s.o.split(" "));for(let m=0,p=y.length;m<p;)switch(y[m++]){case"m":a=y[m++]*e+t,l=y[m++]*e+i,o.moveTo(a,l);break;case"l":a=y[m++]*e+t,l=y[m++]*e+i,o.lineTo(a,l);break;case"q":c=y[m++]*e+t,u=y[m++]*e+i,h=y[m++]*e+t,f=y[m++]*e+i,o.quadraticCurveTo(h,f,c,u);break;case"b":c=y[m++]*e+t,u=y[m++]*e+i,h=y[m++]*e+t,f=y[m++]*e+i,d=y[m++]*e+t,_=y[m++]*e+i,o.bezierCurveTo(h,f,d,_,c,u);break}}return{offsetX:s.ha*e,path:o}}class bn extends rn{constructor(e,t={}){const i=t.font;if(i===void 0)super();else{const r=i.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(r,t)}this.type="TextGeometry"}}const $E=sn({__name:"PinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=At(null);return Tn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.03,o.render(r,s)};const r=new Pi,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Ci({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=nr,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Ii(16777215,.6);r.add(a);const l=new Li(16777215,1.5);l.position.set(5,5,5),r.add(l);const c=new Xr(16777215,2,50);c.position.set(0,2,4),r.add(c);const u=new xt({uniforms:{time:{value:0},color1:{value:new ke(16766720)},color2:{value:new ke(16007990)}},vertexShader:`
        ...
        `}),h=new ut({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=new ut({color:13369344,metalness:.4,roughness:.3,clearcoat:.3,clearcoatRoughness:.2,transparent:!0,opacity:.99}),d=new yt,_=new Ce(1,32,32),y=new K(_,h);y.scale.set(.85,.85,.8),y.position.y=-.2,d.add(y);const m=new Ce(.6,32,32),p=new K(m,h);p.scale.set(1,.95,.95),p.position.set(0,1,0),d.add(p);const b=new Ce(.25,32,32),M=new K(b,h);M.position.set(-.45,1.35,-.1),d.add(M);const S=new K(b,h);S.position.set(.45,1.35,-.1),d.add(S);const I=new Ce(.25,32,32),C=new K(I,h);C.scale.set(1,.6,.8),C.position.set(0,.85,.5),d.add(C);const R=new Kt;R.moveTo(0,0),R.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),R.bezierCurveTo(-.6,.3,0,.6,0,1),R.bezierCurveTo(0,.6,.6,.3,.6,0),R.bezierCurveTo(.6,-.3,0,-.3,0,0);const D={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ie=new rn(R,D),x=new K(ie,f);x.scale.set(.5,.5,.5),x.position.set(0,.34,.8),x.rotation.y=Math.PI,x.rotation.x=Math.PI,d.add(x);const w=new Ce(.35,32,32),q=new K(w,h);q.scale.set(.75,1.25,.65),q.position.set(-.7,-.15,.2),d.add(q);const z=new K(w,h);z.scale.set(.75,1.25,.65),z.position.set(.7,-.15,.2),d.add(z);const J=new Hn(.2,.22,.6,32),se=new K(J,h);se.position.set(-.4,-1.05,0),d.add(se);const G=new K(J,h);G.position.set(.4,-1.05,0),d.add(G);const $=new Ce(.3,32,32),O=new K($,h);O.scale.set(1,.72,1.5),O.position.set(-.4,-1.45,.17),d.add(O);const de=new K($,h);de.scale.set(1,.72,1.5),de.position.set(.4,-1.45,.17),d.add(de);const pe=new Ce(.44,32,32),ge=new K(pe,h);ge.position.set(-.15,-.45,-.4),d.add(ge);const Se=new K(pe,h);Se.position.set(.15,-.45,-.4),d.add(Se);const Pe=new Ce(.18,32,32),ee=new K(Pe,f);ee.position.set(0,-.35,-.8),d.add(ee),new qr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(j){const le=new bn("X",{font:j,size:.2,depth:.05}),xe=new Vt({color:0}),Q=new K(le,xe);Q.position.set(-.34,1,.5),d.add(Q)});const he=new Ce(.1,32,32),U=new Vt({color:0}),oe=new K(he,U);oe.position.set(.2,1.1,.54),d.add(oe),r.add(d),i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),qt(()=>e.bodyPosition,j=>{d.position.set(j.x,j.y,j.z)}),qt(()=>e.cameraPosition,j=>{s.position.set(e.bodyPosition.x,1,j),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(hn(),An("div",{ref_key:"threeCanvas",ref:t,class:bi(n.background?"no-bg":"three-canvas")},null,2))}}),Qd=Rn($E,[["__scopeId","data-v-d0efbfd4"]]),KE=sn({__name:"PurpleBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=At(null);return Tn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.03,o.render(r,s)};const r=new Pi,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Ci({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=nr,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Ii(16777215,.6);r.add(a);const l=new Li(16777215,1.5);l.position.set(5,5,5),r.add(l);const c=new Xr(16777215,2,50);c.position.set(0,2,4),r.add(c);const u=new xt({uniforms:{time:{value:0},color1:{value:new ke(16766720)},color2:{value:new ke(16007990)}},vertexShader:`
            ...
            `}),h=new ut({color:10573288,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});new ut({color:16766720,metalness:.4,roughness:.3,clearcoat:.3,clearcoatRoughness:.2,transparent:!0,opacity:.99});const f=new ut({color:16766720,metalness:.05,roughness:10,clearcoat:.6,clearcoatRoughness:.1,opacity:1,transparent:!1}),d=new yt,_=new Ce(1,32,32),y=new K(_,h);y.scale.set(.85,.85,.8),y.position.y=-.2,d.add(y);const m=new Ce(.6,32,32),p=new K(m,h);p.scale.set(1,.95,.95),p.position.set(0,1,0),d.add(p);const b=new Ce(.25,32,32),M=new K(b,h);M.position.set(-.45,1.35,-.1),d.add(M);const S=new K(b,h);S.position.set(.45,1.35,-.1),d.add(S);const I=new Ce(.25,32,32),C=new K(I,h);C.scale.set(1,.6,.8),C.position.set(0,.85,.5),d.add(C);const R=new Kt;R.moveTo(0,0),R.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),R.bezierCurveTo(-.6,.3,0,.6,0,1),R.bezierCurveTo(0,.6,.6,.3,.6,0),R.bezierCurveTo(.6,-.3,0,-.3,0,0);const D={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ie=new rn(R,D),x=new K(ie,u);x.scale.set(.5,.5,.5),x.position.set(0,.34,.8),x.rotation.y=Math.PI,x.rotation.x=Math.PI,d.add(x);const w=new Ce(.35,32,32),q=new K(w,h);q.scale.set(.75,1.25,.65),q.position.set(-.7,-.15,.2),d.add(q);const z=new K(w,h);z.scale.set(.75,1.25,.65),z.position.set(.7,-.15,.2),d.add(z);const J=new Hn(.2,.22,.6,32),se=new K(J,h);se.position.set(-.4,-1.05,0),d.add(se);const G=new K(J,h);G.position.set(.4,-1.05,0),d.add(G);const $=new Ce(.3,32,32),O=new K($,h);O.scale.set(1,.72,1.5),O.position.set(-.4,-1.45,.17),d.add(O);const de=new K($,h);de.scale.set(1,.72,1.5),de.position.set(.4,-1.45,.17),d.add(de);const pe=new Ce(.44,32,32),ge=new K(pe,h);ge.position.set(-.15,-.45,-.4),d.add(ge);const Se=new K(pe,h);Se.position.set(.15,-.45,-.4),d.add(Se);const Pe=new Ce(.18,32,32),ee=new K(Pe,f);ee.position.set(0,-.35,-.8),d.add(ee),new qr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(he){const U=new bn("X",{font:he,size:.2,depth:.05}),oe=new Vt({color:0}),j=new K(U,oe);j.position.set(-.34,1,.5),d.add(j);const le=new bn("O",{font:he,size:.2,depth:.05}),xe=new Vt({color:0}),Q=new K(le,xe);Q.position.set(.16,1,.53),Q.rotation.y=Ct.degToRad(32),d.add(Q)}),r.add(d),i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),qt(()=>e.bodyPosition,he=>{d.position.set(he.x,he.y,he.z)}),qt(()=>e.cameraPosition,he=>{s.position.set(e.bodyPosition.x,1,he),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(hn(),An("div",{ref_key:"threeCanvas",ref:t,class:bi(n.background?"no-bg":"three-canvas")},null,2))}}),ep=Rn(KE,[["__scopeId","data-v-46de1bfd"]]),jE=sn({__name:"BlueBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=At(null);return Tn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.04,o.render(r,s)};const r=new Pi,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Ci({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=nr,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Ii(16777215,.6);r.add(a);const l=new Li(16777215,1.2);l.position.set(5,5,5),r.add(l);const c=new Xr(16777215,2,50);c.position.set(0,2,4),r.add(c);const u=new xt({uniforms:{time:{value:0},color1:{value:new ke(16766720)},color2:{value:new ke(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `}),h=new ut({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=new ut({color:16745921,metalness:.5,roughness:30,clearcoat:.6,clearcoatRoughness:.1,opacity:1,transparent:!1}),d=new yt,_=new Ce(1,32,32),y=new K(_,h);y.scale.set(.85,.85,.8),y.position.y=-.2,d.add(y);const m=new Ce(.6,32,32),p=new K(m,h);p.scale.set(1,.95,.95),p.position.set(0,1,0),d.add(p);const b=new Ce(.25,32,32),M=new K(b,h);M.position.set(-.45,1.35,-.1),d.add(M);const S=new K(b,h);S.position.set(.45,1.35,-.1),d.add(S);const I=new Ce(.25,32,32),C=new K(I,h);C.scale.set(1,.6,.8),C.position.set(0,.85,.5),d.add(C);const R=new Kt;R.moveTo(0,0),R.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),R.bezierCurveTo(-.6,.3,0,.6,0,1),R.bezierCurveTo(0,.6,.6,.3,.6,0),R.bezierCurveTo(.6,-.3,0,-.3,0,0);const D={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ie=new rn(R,D),x=new K(ie,f);x.scale.set(.5,.5,.5),x.position.set(0,.34,.8),x.rotation.y=Math.PI,x.rotation.x=Math.PI,d.add(x);const w=new Ce(.35,32,32),q=new K(w,h);q.scale.set(.75,1.25,.65),q.position.set(-.7,-.15,.2),d.add(q);const z=new K(w,h);z.scale.set(.75,1.25,.65),z.position.set(.7,-.15,.2),d.add(z);const J=new Hn(.2,.22,.6,32),se=new K(J,h);se.position.set(-.4,-1.05,0),d.add(se);const G=new K(J,h);G.position.set(.4,-1.05,0),d.add(G);const $=new Ce(.3,32,32),O=new K($,h);O.scale.set(1,.72,1.5),O.position.set(-.4,-1.45,.17),d.add(O);const de=new K($,h);de.scale.set(1,.72,1.5),de.position.set(.4,-1.45,.17),d.add(de);const pe=new Ce(.44,32,32),ge=new K(pe,h);ge.position.set(-.15,-.45,-.4),d.add(ge);const Se=new K(pe,h);Se.position.set(.15,-.45,-.4),d.add(Se);const Pe=new Ce(.18,32,32),ee=new K(Pe,f);ee.position.set(0,-.35,-.8),d.add(ee),new qr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(he){const U=new bn("X",{font:he,size:.2,depth:.05}),oe=new Vt({color:0}),j=new K(U,oe);j.position.set(-.34,1,.5),d.add(j);const le=new bn("X",{font:he,size:.2,depth:.05}),xe=new Vt({color:0}),Q=new K(le,xe);Q.position.set(.16,1,.53),Q.rotation.y=Ct.degToRad(32),d.add(Q)}),r.add(d),i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),qt(()=>e.bodyPosition,he=>{d.position.set(he.x,he.y,he.z)}),qt(()=>e.cameraPosition,he=>{s.position.set(e.bodyPosition.x,1,he),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(hn(),An("div",{ref_key:"threeCanvas",ref:t,class:bi(n.background?"no-bg":"three-canvas")},null,2))}}),tp=Rn(jE,[["__scopeId","data-v-369ed91d"]]),ZE={key:0,class:"bear-face-container"},JE=sn({__name:"BearFace",setup(n){const e=At(null),t=At(!1),i=()=>{t.value=!0};return Tn(()=>{const r=e.value;if(r){r.width=window.innerWidth,r.height=window.innerHeight*.6;const s=r.getContext("2d");s&&(()=>{const a=r.width/2,l=r.height/1.9,c=r.height/2.5,u=r.height/2.58,h=c*.45,f=c*.18,d=c*.3,_=c*.275,y=d*.35,m=d*.32;s.save(),s.beginPath(),s.rect(0,0,r.width/2,r.height),s.clip(),s.lineWidth=15,s.strokeStyle="#000000",s.beginPath(),s.arc(a-c*.85,l-u*.8,h,0,Math.PI*2,!0),s.stroke(),s.beginPath(),s.arc(a+c*.85,l-c*.8,h,0,Math.PI*2,!0),s.stroke(),s.lineWidth=15,s.beginPath(),s.arc(a,l,u,0,Math.PI*2,!0),s.stroke(),s.lineWidth=15,s.beginPath(),s.arc(a-c*.4,l-c*.2,f,0,Math.PI*2,!0),s.stroke(),s.beginPath(),s.moveTo(a+c*.2,l-c*.3),s.lineTo(a+c*.5,l-c*.05),s.moveTo(a+c*.5,l-c*.3),s.lineTo(a+c*.2,l-c*.05),s.stroke(),s.beginPath(),s.ellipse(a,l+c*.4,_*1.5,_,0,0,Math.PI*2),s.stroke(),s.beginPath(),s.arc(a,l+c*.3,m,0,Math.PI*2,!0),s.stroke(),s.restore(),s.save(),s.beginPath(),s.rect(r.width/2,0,r.width/2,r.height),s.clip(),s.fillStyle="#FF69B4",s.beginPath(),s.arc(a-c*.85,l-c*.8,h,0,Math.PI*2,!0),s.fill(),s.beginPath(),s.arc(a+c*.85,l-c*.8,h,0,Math.PI*2,!0),s.fill(),s.beginPath(),s.arc(a,l,c,0,Math.PI*2,!0),s.fill(),s.fillStyle="#000000",s.beginPath(),s.arc(a-c*.4,l-c*.2,f,0,Math.PI*2,!0),s.fill(),s.lineWidth=15,s.beginPath(),s.moveTo(a+c*.2,l-c*.3),s.lineTo(a+c*.5,l-c*.05),s.moveTo(a+c*.5,l-c*.3),s.lineTo(a+c*.2,l-c*.05),s.strokeStyle="#000000",s.stroke(),s.fillStyle="#F0E68C",s.beginPath(),s.ellipse(a,l+c*.4,d*1.5,d,0,0,Math.PI*2),s.fill(),s.fillStyle="#000000",s.beginPath(),s.arc(a,l+c*.3,y*1.2,0,Math.PI*2,!0),s.fill(),s.restore()})()}}),(r,s)=>t.value?ng("",!0):(hn(),An("div",ZE,[Ms("canvas",{ref_key:"bearCanvas",ref:e},null,512),Ms("button",{onClick:i,class:"pixel-button"},"Enter")]))}}),QE=Rn(JE,[["__scopeId","data-v-9cd3b2cf"]]),np=At(window.matchMedia("only screen and (max-width: 475px)").matches),ip=At(window.matchMedia("only screen and (max-width: 580px)").matches),rp=At(window.matchMedia("only screen and (max-width: 670px)").matches),sp=At(window.matchMedia("only screen and (max-width: 768px)").matches),op=At(window.matchMedia("only screen and (max-width: 850px)").matches),ap=At(window.matchMedia("only screen and (max-width: 1024px)").matches),ew=new ResizeObserver(()=>{np.value=window.matchMedia("only screen and (max-width: 475px)").matches,ip.value=window.matchMedia("only screen and (max-width: 580px)").matches,rp.value=window.matchMedia("only screen and (max-width: 670px)").matches,sp.value=window.matchMedia("only screen and (max-width: 768px)").matches,op.value=window.matchMedia("only screen and (max-width: 850px)").matches,ap.value=window.matchMedia("only screen and (max-width: 1024px)").matches});ew.observe(document.documentElement);Pt(()=>np.value);const Za=Pt(()=>ip.value);Pt(()=>sp.value);Pt(()=>ap.value);Pt(()=>rp.value);const Ja=Pt(()=>op.value),tw={class:"flex"},nw=sn({__name:"ThreeScene",setup(n){const e=At(!0);let t;const i=()=>{e.value=!e.value};return Tn(()=>{t=setInterval(()=>{i()},3e3)}),Mc(()=>{clearInterval(t)}),(r,s)=>(hn(),An("div",tw,[rt(QE,{class:"bear-background"}),rt(Qd,{background:!0,cameraPosition:ln(Za)?13:ln(Ja)?8:6,bodyPosition:{x:-15,y:0,z:0},class:"bear-page"},null,8,["cameraPosition"]),rt(ep,{background:!0,cameraPosition:ln(Za)?10:ln(Ja)?6:4,bodyPosition:{x:-15,y:0,z:0},class:"bear-page"},null,8,["cameraPosition"]),rt(tp,{background:!0,cameraPosition:ln(Za)?13:ln(Ja)?8:6,bodyPosition:{x:-18,y:0,z:0},class:"bear-page"},null,8,["cameraPosition"])]))}}),iw=Rn(nw,[["__scopeId","data-v-d3ef8993"]]),rw=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,ow=sn({__name:"DiamondBear",setup(n){const e=At(null);return Tn(()=>{const t=new Pi,i=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),r=new Ci({antialias:!0,alpha:!0});r.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(r.domElement);const s=new Ii(16777215,5);t.add(s);const o=new Li(16777215,20);o.position.set(5,5,5),t.add(o);const a=new xt({uniforms:{time:{value:0}},vertexShader:rw,fragmentShader:sw,transparent:!0,opacity:.1}),l=new yt,c=new Ce(1,32,32),u=new K(c,a);u.scale.set(.85,.85,.8),u.position.y=-.2,l.add(u);const h=new Ce(.6,32,32),f=new K(h,a);f.scale.set(1,.95,.95),f.position.set(0,1,0),l.add(f);const d=new Ce(.25,32,32),_=new K(d,a);_.position.set(-.45,1.35,-.1),l.add(_);const y=new K(d,a);y.position.set(.45,1.35,-.1),l.add(y);const m=new Ce(.25,32,32),p=new K(m,a);p.scale.set(1,.6,.8),p.position.set(0,.85,.5),l.add(p);const b=new Ce(.35,32,32),M=new K(b,a);M.scale.set(.75,1.25,.65),M.position.set(-.7,-.15,.2),l.add(M);const S=new K(b,a);S.scale.set(.75,1.25,.65),S.position.set(.7,-.15,.2),l.add(S);const I=new Ce(.3,32,32),C=new K(I,a);C.scale.set(1,.72,1.5),C.position.set(-.4,-1.45,.17),l.add(C);const R=new K(I,a);R.scale.set(1,.72,1.5),R.position.set(.4,-1.45,.17),l.add(R);const D=new Hn(.2,.22,.6,32),ie=new K(D,a);ie.position.set(-.4,-1.05,0),l.add(ie);const x=new K(D,a);x.position.set(.4,-1.05,0),l.add(x);const w=new Ce(.44,32,32),q=new K(w,a);q.position.set(-.15,-.45,-.4),l.add(q);const z=new K(w,a);z.position.set(.15,-.45,-.4),l.add(z);const J=new Ce(.18,32,32),se=new K(J,a);se.position.set(0,-.35,-.75),l.add(se);const G=new Cs({color:16738740,metalness:1,roughness:.44}),$=new Cs({color:16776960,metalness:1,roughness:.44}),O=new Kt;O.moveTo(0,.15),O.lineTo(.1,0),O.lineTo(0,-.15),O.lineTo(-.1,0),O.lineTo(0,.15);const de={depth:.07,bevelEnabled:!1},pe=new rn(O,de),ge=new K(pe,G);ge.position.set(-.25,1,.5),ge.rotation.y=Math.PI/30,l.add(ge);const Se=new K(pe,$);Se.position.set(.25,1,.5),Se.rotation.y=Math.PI/30,l.add(Se),t.add(l),i.position.set(0,1,4),i.lookAt(0,0,0);function Pe(){requestAnimationFrame(Pe),a.uniforms.time.value+=.1,l.rotation.y+=.02,r.render(t,i)}Pe(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(hn(),An("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),aw=Rn(ow,[["__scopeId","data-v-a7796925"]]),Zh=`
  ...
  `,lw=sn({__name:"GlassBear",setup(n){const e=At(null);return Tn(()=>{const t=new Pi,i=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),r=new Ci({antialias:!0,alpha:!0});r.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(r.domElement);const s=new Ii(16777215,.5);t.add(s);const o=new Li(16777215,10);o.position.set(5,5,5),t.add(o);const a=new xt({uniforms:{time:{value:0},opacity:{value:.8}},vertexShader:Zh,fragmentShader:Jh,transparent:!0}),l=new xt({uniforms:{time:{value:0},opacity:{value:.6}},vertexShader:Zh,fragmentShader:Jh,transparent:!0,depthWrite:!1}),c=new yt,u=new Ce(1,32,32),h=new K(u,l);h.scale.set(.85,.85,.8),h.position.y=-.2,c.add(h);const f=new Ce(.6,32,32),d=new K(f,l);d.scale.set(1,.95,.95),d.position.set(0,1,0),c.add(d);const _=new Ce(.25,32,32),y=new K(_,a);y.position.set(-.45,1.35,-.1),c.add(y);const m=new K(_,l);m.position.set(.45,1.35,-.1),c.add(m);const p=new Ce(.25,32,32),b=new K(p,a);b.scale.set(1,.6,.8),b.position.set(0,.85,.5),c.add(b);const M=new Ce(.35,32,32),S=new K(M,a);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),c.add(S);const I=new K(M,a);I.scale.set(.75,1.25,.65),I.position.set(.7,-.15,.2),c.add(I);const C=new Ce(.3,32,32),R=new K(C,a);R.scale.set(1,.72,1.5),R.position.set(-.4,-1.45,.17),c.add(R);const D=new K(C,a);D.scale.set(1,.72,1.5),D.position.set(.4,-1.45,.17),c.add(D);const ie=new Hn(.2,.22,.6,32),x=new K(ie,a);x.position.set(-.4,-1.05,0),c.add(x);const w=new K(ie,a);w.position.set(.4,-1.05,0),c.add(w);const q=new Ce(.44,32,32);new K(q,a).position.set(-.15,-.45,-.4),new K(q,a).position.set(.15,-.45,-.4);const se=new Ce(.18,32,32),G=new K(se,a);G.position.set(0,-.35,-.75),c.add(G);const $=new Kt;$.moveTo(0,0),$.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),$.bezierCurveTo(-.6,.3,0,.6,0,1),$.bezierCurveTo(0,.6,.6,.3,.6,0),$.bezierCurveTo(.6,-.3,0,-.3,0,0);const O=new Cs({color:8900331,metalness:1,roughness:.44}),de=new Cs({color:16776960,metalness:1,roughness:.44}),pe=new Kt;pe.moveTo(0,.15),pe.lineTo(.1,0),pe.lineTo(0,-.15),pe.lineTo(-.1,0),pe.lineTo(0,.15);const ge={depth:.07,bevelEnabled:!1},Se=new rn(pe,ge),Pe=new K(Se,O);Pe.position.set(-.25,1,.5),Pe.rotation.y=Math.PI/30,c.add(Pe);const ee=new K(Se,de);ee.position.set(.25,1,.5),ee.rotation.y=Math.PI/30,c.add(ee),new ut({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const fe={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},he=new ut({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),U=new rn($,fe),oe=new K(U,he);oe.scale.set(.5,.5,.5),oe.position.set(0,0,0),oe.rotation.y=Math.PI,oe.rotation.x=Math.PI,c.add(oe);const j=new Kt;j.moveTo(0,.6),j.lineTo(.3,.3),j.lineTo(.6,0),j.lineTo(.3,-.3),j.lineTo(0,-.6),j.lineTo(-.3,-.3),j.lineTo(-.6,0),j.lineTo(-.3,.3),j.lineTo(0,.6);const le={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},xe=new rn(j,le),Q=new ut({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),g=new K(xe,Q);g.scale.set(.5,.5,.5),g.position.set(0,0,0),t.add(c),i.position.set(0,1,4),i.lookAt(0,0,0);const T=()=>{requestAnimationFrame(T),a.uniforms.time.value+=.03,c.rotation.y+=.03,r.render(t,i)};T(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(hn(),An("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),cw=Rn(lw,[["__scopeId","data-v-fa1425bf"]]),uw=sn({__name:"BluePinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=At(null);return Tn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.02,o.render(r,s)};const r=new Pi,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Ci({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=nr,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Ii(16777215,.6);r.add(a);const l=new Li(16777215,1.5);l.position.set(5,5,5),r.add(l);const c=new Xr(16777215,2,50);c.position.set(0,2,4),r.add(c);const u=new ut({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),h=new ut({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=m=>{const p=new yt,b=new Ce(1,32,32),M=new K(b,m);M.scale.set(.85,.85,.8),M.position.y=-.2,p.add(M);const S=new Ce(.6,32,32),I=new K(S,m);I.scale.set(1,.95,.95),I.position.set(0,1,0),p.add(I);const C=new Ce(.25,32,32),R=new K(C,m);R.scale.set(1,.6,.8),R.position.set(0,.85,.5),p.add(R),new qr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(xe){const Q=new bn("X",{font:xe,size:.18,depth:.05}),g=new Vt({color:0}),T=new K(Q,g);T.position.set(-.3,.99,.53),T.rotation.x=Ct.degToRad(-5),T.rotation.y=Ct.degToRad(-15),p.add(T);const L=new bn("+",{font:xe,size:.25,depth:.1}),F=new Vt({color:0}),N=new K(L,F);N.position.set(.14,.99,.53),N.rotation.y=Ct.degToRad(12),N.rotation.x=Ct.degToRad(-5),p.add(N)});const ie=new Kt;ie.moveTo(0,0),ie.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),ie.bezierCurveTo(-.6,.3,0,.6,0,1),ie.bezierCurveTo(0,.6,.6,.3,.6,0),ie.bezierCurveTo(.6,-.3,0,-.3,0,0);const x={depth:.05,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.05,bevelThickness:.05},w=new rn(ie,x),q=new Vt({color:0}),z=new K(w,q);z.scale.set(.1,.1,.1),z.rotation.z=Ct.degToRad(210),z.rotation.x=Ct.degToRad(5),z.rotation.y=Ct.degToRad(-45),z.position.set(-.4,.9,.45),p.add(z);const J=new Ce(.25,32,32),se=new K(J,u);se.position.set(-.45,1.35,-.1),p.add(se);const G=new K(J,h);G.position.set(.45,1.35,-.1),p.add(G);const $=new Ce(.35,32,32),O=new K($,u);O.scale.set(.75,1.25,.65),O.position.set(-.7,-.15,.2),p.add(O);const de=new K($,h);de.scale.set(.75,1.25,.65),de.position.set(.7,-.15,.2),p.add(de);const pe=new Hn(.2,.22,.6,32),ge=new K(pe,u);ge.position.set(-.4,-1.05,0),p.add(ge);const Se=new K(pe,h);Se.position.set(.4,-1.05,0),p.add(Se);const Pe=new Ce(.3,32,32),ee=new K(Pe,u);ee.scale.set(1,.72,1.5),ee.position.set(-.4,-1.45,.17),p.add(ee);const fe=new K(Pe,h);fe.scale.set(1,.72,1.5),fe.position.set(.4,-1.45,.17),p.add(fe);const he=new Ce(.44,32,32),U=new K(he,u);U.position.set(-.15,-.45,-.4),p.add(U);const oe=new K(he,h);oe.position.set(.15,-.45,-.4),p.add(oe);const j=new Ce(.18,32,32),le=new K(j,m);return le.position.set(0,-.35,-.8),p.add(le),p},d=new yt,_=f(u),y=f(h);_.position.x=-.01,y.position.x=.01,d.add(_),d.add(y),r.add(d),s.position.z=4,i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0)}}),(i,r)=>(hn(),An("div",{ref_key:"threeCanvas",ref:t,class:"three-canvas"},null,512))}}),hw=Rn(uw,[["__scopeId","data-v-9e6b205d"]]),fw=sn({__name:"HalfTransparentBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=At(null);return Tn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),p.rotation.y+=.03,u.uniforms.time.value+=.04,o.render(r,s)};const r=new Pi,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Ci({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=nr,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Ii(16777215,.6);r.add(a);const l=new Li(16777215,1.2);l.position.set(5,5,5),r.add(l);const c=new Xr(16777215,2,50);c.position.set(0,2,4),r.add(c);const u=new xt({uniforms:{time:{value:0},color1:{value:new ke(16766720)},color2:{value:new ke(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,y=new xt({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:d,fragmentShader:_,transparent:!0,depthWrite:!1}),m=new xt({uniforms:{time:{value:0},opacity:{value:.4}},vertexShader:d,fragmentShader:_,transparent:!0,depthWrite:!1}),p=new yt,b=new Ce(1,32,32,0,Math.PI),M=new K(b,m),S=new K(b,y);M.scale.set(.85,.85,.8),S.scale.set(.85,.85,.8),M.position.y=-.2,S.position.y=-.2,M.rotation.y=Math.PI/2,S.rotation.y=Math.PI*1.5;const I=new Si(1,32),C=new K(I,y);C.scale.set(.85,.85,.8),C.position.set(0,-.2,0),C.rotation.y=Math.PI/2;const R=new yt;R.add(M),R.add(S),R.add(C),p.add(R);const D=new Ce(.6,32,32,0,Math.PI),ie=new K(D,y);ie.scale.set(1,.95,.95),ie.position.set(0,1,0),ie.rotation.y=Math.PI*1.5;const x=new K(D,m);x.scale.set(1,.95,.95),x.position.set(0,1,0),x.rotation.y=Math.PI/2;const w=new Si(.6,32),q=new K(w,y);q.position.set(0,.97,0),q.rotation.y=Math.PI/2;const z=new yt;z.add(ie),z.add(x),z.add(q),p.add(z);const J=new Ce(.25,32,32),se=new K(J,y);se.position.set(-.45,1.35,-.1),p.add(se);const G=new K(J,m);G.position.set(.45,1.35,-.1),p.add(G);const $=new Ce(.25,32,32,Math.PI/2,Math.PI),O=new K($,y);O.scale.set(1,.6,.8),O.position.set(0,.82,.5),O.rotation.y=Math.PI;const de=new Ce(.25,32,32,Math.PI/2,Math.PI),pe=new K(de,m);pe.scale.set(1,.6,.8),pe.position.set(0,.82,.5),pe.rotation.y=0;const ge=new Si(.25,32),Se=new K(ge,y);Se.scale.set(1.25,.6,.8),Se.position.set(0,.85,.5),Se.rotation.x=Math.PI/2;const Pe=new yt;Pe.add(O),Pe.add(pe),Pe.add(Se),p.add(Pe);const ee=new Kt;ee.moveTo(0,0),ee.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),ee.bezierCurveTo(-.6,.3,0,.6,0,1),ee.bezierCurveTo(0,.6,.6,.3,.6,0),ee.bezierCurveTo(.6,-.3,0,-.3,0,0);const fe={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new ut({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const he=new rn(ee,fe),U=new K(he,f);U.scale.set(.5,.5,.5),U.position.set(0,0,0),U.rotation.y=Math.PI,U.rotation.x=Math.PI,p.add(U);const oe=new Ce(.35,32,32),j=new K(oe,y);j.scale.set(.75,1.25,.65),j.position.set(-.7,-.15,.2),p.add(j);const le=new K(oe,m);le.scale.set(.75,1.25,.65),le.position.set(.7,-.15,.2),p.add(le);const xe=new Hn(.2,.22,.6,32),Q=new K(xe,y);Q.position.set(-.4,-1.05,0),p.add(Q);const g=new K(xe,m);g.position.set(.4,-1.05,0),p.add(g);const T=new Ce(.3,32,32),L=new K(T,y);L.scale.set(1,.72,1.5),L.position.set(-.4,-1.45,.17),p.add(L);const F=new K(T,m);F.scale.set(1,.72,1.5),F.position.set(.4,-1.45,.17),p.add(F);const N=new Ce(.44,32,32),Z=new K(N,y);Z.position.set(-.15,-.45,-.4),p.add(Z);const te=new K(N,h);te.position.set(.15,-.45,-.4),p.add(te);const E=new Ce(.18,32,32),v=new K(E,f);v.position.set(0,-.35,-.8),p.add(v),new qr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(X){const k=new bn("X",{font:X,size:.18,depth:.05}),V=new Vt({color:0}),ue=new K(k,V);ue.position.set(-.3,.99,.53),ue.rotation.x=Ct.degToRad(-5),ue.rotation.y=Ct.degToRad(-15),p.add(ue);const ce=new bn("+",{font:X,size:.25,depth:.1}),ve=new Vt({color:0}),be=new K(ce,ve);be.position.set(.14,.99,.53),be.rotation.y=Ct.degToRad(12),be.rotation.x=Ct.degToRad(-5),p.add(be)}),r.add(p),i(),p.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),qt(()=>e.bodyPosition,X=>{p.position.set(X.x,X.y,X.z)}),qt(()=>e.cameraPosition,X=>{s.position.set(e.bodyPosition.x,1,X),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(hn(),An("div",{ref_key:"threeCanvas",ref:t,class:bi(n.background?"no-bg":"three-canvas")},null,2))}}),dw=Rn(fw,[["__scopeId","data-v-7fbce4ad"]]),pw=sn({__name:"HalfBlueBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=At(null);return Tn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),m.rotation.y+=.03,u.uniforms.time.value+=.04,o.render(r,s)};const r=new Pi,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Ci({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=nr,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Ii(16777215,.6);r.add(a);const l=new Li(16777215,1.2);l.position.set(5,5,5),r.add(l);const c=new Xr(16777215,2,50);c.position.set(0,2,4),r.add(c);const u=new xt({uniforms:{time:{value:0},color1:{value:new ke(16766720)},color2:{value:new ke(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `;new xt({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:_,fragmentShader:y,transparent:!0,depthWrite:!1}),new xt({uniforms:{time:{value:0},opacity:{value:.4}},vertexShader:_,fragmentShader:y,transparent:!0,depthWrite:!1});const m=new yt,p=new Ce(1,32,32,0,Math.PI),b=new K(p,f),M=new K(p,h);b.scale.set(.85,.85,.8),M.scale.set(.85,.85,.8),b.position.y=-.2,M.position.y=-.2,b.rotation.y=Math.PI/2,M.rotation.y=Math.PI*1.5;const S=new Si(1,32),I=new K(S,h);I.scale.set(.85,.85,.8),I.position.set(0,-.2,0),I.rotation.y=Math.PI/2;const C=new yt;C.add(b),C.add(M),C.add(I),m.add(C);const R=new Ce(.6,32,32,0,Math.PI),D=new K(R,h);D.scale.set(1,.95,.95),D.position.set(0,1,0),D.rotation.y=Math.PI*1.5;const ie=new K(R,f);ie.scale.set(1,.95,.95),ie.position.set(0,1,0),ie.rotation.y=Math.PI/2;const x=new Si(.6,32),w=new K(x,h);w.position.set(0,.97,0),w.rotation.y=Math.PI/2;const q=new yt;q.add(D),q.add(ie),q.add(w),m.add(q);const z=new Ce(.25,32,32),J=new K(z,h);J.position.set(-.45,1.35,-.1),m.add(J);const se=new K(z,f);se.position.set(.45,1.35,-.1),m.add(se);const G=new Ce(.25,32,32,Math.PI/2,Math.PI),$=new K(G,h);$.scale.set(1,.6,.8),$.position.set(0,.82,.5),$.rotation.y=Math.PI;const O=new Ce(.25,32,32,Math.PI/2,Math.PI),de=new K(O,f);de.scale.set(1,.6,.8),de.position.set(0,.82,.5),de.rotation.y=0;const pe=new Si(.25,32),ge=new K(pe,h);ge.scale.set(1.25,.6,.8),ge.position.set(0,.85,.5),ge.rotation.x=Math.PI/2;const Se=new yt;Se.add($),Se.add(de),Se.add(ge),m.add(Se);const Pe=new Kt;Pe.moveTo(0,0),Pe.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Pe.bezierCurveTo(-.6,.3,0,.6,0,1),Pe.bezierCurveTo(0,.6,.6,.3,.6,0),Pe.bezierCurveTo(.6,-.3,0,-.3,0,0);const ee={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new ut({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const fe=new rn(Pe,ee),he=new K(fe,d);he.scale.set(.5,.5,.5),he.position.set(0,0,0),he.rotation.y=Math.PI,he.rotation.x=Math.PI,m.add(he);const U=new Ce(.35,32,32),oe=new K(U,h);oe.scale.set(.75,1.25,.65),oe.position.set(-.7,-.15,.2),m.add(oe);const j=new K(U,f);j.scale.set(.75,1.25,.65),j.position.set(.7,-.15,.2),m.add(j);const le=new Hn(.2,.22,.6,32),xe=new K(le,h);xe.position.set(-.4,-1.05,0),m.add(xe);const Q=new K(le,f);Q.position.set(.4,-1.05,0),m.add(Q);const g=new Ce(.3,32,32),T=new K(g,h);T.scale.set(1,.72,1.5),T.position.set(-.4,-1.45,.17),m.add(T);const L=new K(g,f);L.scale.set(1,.72,1.5),L.position.set(.4,-1.45,.17),m.add(L);const F=new Ce(.44,32,32),N=new K(F,h);N.position.set(-.15,-.45,-.4),m.add(N);const Z=new K(F,f);Z.position.set(.15,-.45,-.4),m.add(Z);const te=new Ce(.18,32,32),E=new K(te,d);E.position.set(0,-.35,-.8),m.add(E),new qr().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(P){const X=new bn("X",{font:P,size:.18,depth:.05}),k=new Vt({color:0}),V=new K(X,k);V.position.set(-.3,.99,.53),V.rotation.x=Ct.degToRad(-5),V.rotation.y=Ct.degToRad(-15),m.add(V);const ue=new bn("+",{font:P,size:.25,depth:.1}),ce=new Vt({color:0}),ve=new K(ue,ce);ve.position.set(.14,.99,.53),ve.rotation.y=Ct.degToRad(12),ve.rotation.x=Ct.degToRad(-5),m.add(ve)}),r.add(m),i(),m.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),qt(()=>e.bodyPosition,P=>{m.position.set(P.x,P.y,P.z)}),qt(()=>e.cameraPosition,P=>{s.position.set(e.bodyPosition.x,1,P),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(hn(),An("div",{ref_key:"threeCanvas",ref:t,class:bi(n.background?"no-bg":"three-canvas")},null,2))}}),mw=Rn(pw,[["__scopeId","data-v-772fc40e"]]),gw=[{path:"/3d-bear-arts",name:"ThreeScene",component:iw},{path:"/3d-bear-arts/half",name:"NewBear",component:mw},{path:"/3d-bear-arts/halfTransparent",name:"Transparent",component:dw},{path:"/3d-bear-arts/bluePink",name:"BluePinkBear",component:hw},{path:"/3d-bear-arts/diamond",name:"DiamondBear",component:aw},{path:"/3d-bear-arts/pink",name:"PinkBear",component:Qd},{path:"/3d-bear-arts/purple",name:"PurpleBear",component:ep},{path:"/3d-bear-arts/blue",name:"BlueBear",component:tp},{path:"/3d-bear-arts/glass",name:"GlassBear",component:cw}],_w=k0({history:v0(),routes:gw}),lp=Fg(Gg);lp.use(_w);lp.mount("#app");
