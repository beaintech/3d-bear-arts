...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wi,depthTest:!1,depthWrite:!1})}function bh(){return new ut({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zl(),fragmentShader:`
		...
		`,blending:wi,depthTest:!1,depthWrite:!1})}function Th(){return new ut({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zl(),fragmentShader:`
...
`].filter(is).join(`
`)),o=Jc(o),o=Fh(o,t),o=Oh(o,t),a=Jc(a),a=Fh(a,t),a=Oh(a,t),o=Bh(o),a=Bh(a),t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+p);const M=w+m+o,S=w+p+a,D=Uh(r,r.VERTEX_SHADER,M),C=Uh(r,r.FRAGMENT_SHADER,S);r.attachShader(y,D),r.attachShader(y,C),t.index0AttributeName!==void 0?r.bindAttribLocation(y,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function A(b){if(n.debug.checkShaderErrors){const B=r.getProgramInfoLog(y).trim(),H=r.getShaderInfoLog(D).trim(),Z=r.getShaderInfoLog(C).trim();let re=!0,W=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(re=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,y,D,C);else{const J=Nh(r,D,"vertex"),O=Nh(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
...
Program Info Log: `+B+`
`+J+`
`+O)}else B!==""?console.warn("THREE.WebGLProgram: Program Info Log:",B):(H===""||Z==="")&&(W=!1);W&&(b.diagnostics={runnable:re,programLog:B,vertexShader:{log:H,prefix:m},fragmentShader:{log:Z,prefix:p}})}r.deleteShader(D),r.deleteShader(C),I=new wo(r,y),ne=_S(r,y)}let I;this.getUniforms=function(){return I===void 0&&A(this),I};let ne;this.getAttributes=function(){return ne===void 0&&A(this),ne};let x=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return x===!1&&(x=r.getProgramParameter(y,cS)),x},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(y),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=lS++,this.cacheKey=e,this.usedTimes=1,this.program=y,this.vertexShader=D,this.fragmentShader=C,this}let CS=0;class PS{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new LS(e),t.set(e,i)),i}}class LS{constructor(e){this.id=CS++,this.code=e,this.usedTimes=0}}function IS(n,e,t,i,r,s,o){const a=new Id,c=new PS,l=new Set,u=[],h=r.logarithmicDepthBuffer,f=r.reverseDepthBuffer,d=r.vertexTextures;let _=r.precision;const y={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function m(x){return l.add(x),x===0?"uv":`uv${x}`}function p(x,b,B,H,Z){const re=H.fog,W=Z.geometry,J=x.isMeshStandardMaterial?H.environment:null,O=(x.isMeshStandardMaterial?t:e).get(x.envMap||J),pe=O&&O.mapping===Yo?O.image.height:null,de=y[x.type];x.precision!==null&&(_=r.getMaxPrecision(x.precision),_!==x.precision&&console.warn("THREE.WebGLProgram.getParameters:",x.precision,"not supported, using",_,"instead."));const ge=W.morphAttributes.position||W.morphAttributes.normal||W.morphAttributes.color,Se=ge!==void 0?ge.length:0;let Re=0;W.morphAttributes.position!==void 0&&(Re=1),W.morphAttributes.normal!==void 0&&(Re=2),W.morphAttributes.color!==void 0&&(Re=3);let Q,fe,_e,U;if(de){const $t=Un[de];Q=$t.vertexShader,fe=$t.fragmentShader}else Q=x.vertexShader,fe=x.fragmentShader,c.update(x),_e=c.getVertexShaderID(x),U=c.getFragmentShaderID(x);const oe=n.getRenderTarget(),K=Z.isInstancedMesh===!0,ce=Z.isBatchedMesh===!0,xe=!!x.map,te=!!x.matcap,g=!!O,T=!!x.aoMap,L=!!x.lightMap,F=!!x.bumpMap,N=!!x.normalMap,j=!!x.displacementMap,ee=!!x.emissiveMap,E=!!x.metalnessMap,v=!!x.roughnessMap,P=x.anisotropy>0,X=x.clearcoat>0,V=x.dispersion>0,Y=x.iridescence>0,ue=x.sheen>0,le=x.transmission>0,ve=P&&!!x.anisotropyMap,Te=X&&!!x.clearcoatMap,he=X&&!!x.clearcoatNormalMap,ye=X&&!!x.clearcoatRoughnessMap,Ne=Y&&!!x.iridescenceMap,De=Y&&!!x.iridescenceThicknessMap,Ae=ue&&!!x.sheenColorMap,Be=ue&&!!x.sheenRoughnessMap,Ce=!!x.specularMap,We=!!x.specularColorMap,z=!!x.specularIntensityMap,Pe=le&&!!x.transmissionMap,ae=le&&!!x.thicknessMap,me=!!x.gradientMap,Le=!!x.alphaMap,Ue=x.alphaTest>0,Ke=!!x.alphaHash,yt=!!x.extensions;let Yt=bi;x.toneMapped&&(oe===null||oe.isXRRenderTarget===!0)&&(Yt=n.toneMapping);const je={shaderID:de,shaderType:x.type,shaderName:x.name,vertexShader:Q,fragmentShader:fe,defines:x.defines,customVertexShaderID:_e,customFragmentShaderID:U,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:_,batching:ce,batchingColor:ce&&Z._colorsTexture!==null,instancing:K,instancingColor:K&&Z.instanceColor!==null,instancingMorph:K&&Z.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:oe===null?n.outputColorSpace:oe.isXRRenderTarget===!0?oe.texture.colorSpace:Pi,alphaToCoverage:!!x.alphaToCoverage,map:xe,matcap:te,envMap:g,envMapMode:g&&O.mapping,envMapCubeUVHeight:pe,aoMap:T,lightMap:L,bumpMap:F,normalMap:N,displacementMap:d&&j,emissiveMap:ee,normalMapObjectSpace:N&&x.normalMapType===E_,normalMapTangentSpace:N&&x.normalMapType===Ad,metalnessMap:E,roughnessMap:v,anisotropy:P,anisotropyMap:ve,clearcoat:X,clearcoatMap:Te,clearcoatNormalMap:he,clearcoatRoughnessMap:ye,dispersion:V,iridescence:Y,iridescenceMap:Ne,iridescenceThicknessMap:De,sheen:ue,sheenColorMap:Ae,sheenRoughnessMap:Be,specularMap:Ce,specularColorMap:We,specularIntensityMap:z,transmission:le,transmissionMap:Pe,thicknessMap:ae,gradientMap:me,opaque:x.transparent===!1&&x.blending===Cr&&x.alphaToCoverage===!1,alphaMap:Le,alphaTest:Ue,alphaHash:Ke,combine:x.combine,mapUv:xe&&m(x.map.channel),aoMapUv:T&&m(x.aoMap.channel),lightMapUv:L&&m(x.lightMap.channel),bumpMapUv:F&&m(x.bumpMap.channel),normalMapUv:N&&m(x.normalMap.channel),displacementMapUv:j&&m(x.displacementMap.channel),emissiveMapUv:ee&&m(x.emissiveMap.channel),metalnessMapUv:E&&m(x.metalnessMap.channel),roughnessMapUv:v&&m(x.roughnessMap.channel),anisotropyMapUv:ve&&m(x.anisotropyMap.channel),clearcoatMapUv:Te&&m(x.clearcoatMap.channel),clearcoatNormalMapUv:he&&m(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ye&&m(x.clearcoatRoughnessMap.channel),iridescenceMapUv:Ne&&m(x.iridescenceMap.channel),iridescenceThicknessMapUv:De&&m(x.iridescenceThicknessMap.channel),sheenColorMapUv:Ae&&m(x.sheenColorMap.channel),sheenRoughnessMapUv:Be&&m(x.sheenRoughnessMap.channel),specularMapUv:Ce&&m(x.specularMap.channel),specularColorMapUv:We&&m(x.specularColorMap.channel),specularIntensityMapUv:z&&m(x.specularIntensityMap.channel),transmissionMapUv:Pe&&m(x.transmissionMap.channel),thicknessMapUv:ae&&m(x.thicknessMap.channel),alphaMapUv:Le&&m(x.alphaMap.channel),vertexTangents:!!W.attributes.tangent&&(N||P),vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!W.attributes.color&&W.attributes.color.itemSize===4,pointsUvs:Z.isPoints===!0&&!!W.attributes.uv&&(xe||Le),fog:!!re,useFog:x.fog===!0,fogExp2:!!re&&re.isFogExp2,flatShading:x.flatShading===!0,sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:h,reverseDepthBuffer:f,skinning:Z.isSkinnedMesh===!0,morphTargets:W.morphAttributes.position!==void 0,morphNormals:W.morphAttributes.normal!==void 0,morphColors:W.morphAttributes.color!==void 0,morphTargetsCount:Se,morphTextureStride:Re,numDirLights:b.directional.length,numPointLights:b.point.length,numSpotLights:b.spot.length,numSpotLightMaps:b.spotLightMap.length,numRectAreaLights:b.rectArea.length,numHemiLights:b.hemi.length,numDirLightShadows:b.directionalShadowMap.length,numPointLightShadows:b.pointShadowMap.length,numSpotLightShadows:b.spotShadowMap.length,numSpotLightShadowsWithMaps:b.numSpotLightShadowsWithMaps,numLightProbes:b.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:x.dithering,shadowMapEnabled:n.shadowMap.enabled&&B.length>0,shadowMapType:n.shadowMap.type,toneMapping:Yt,decodeVideoTexture:xe&&x.map.isVideoTexture===!0&&et.getTransfer(x.map.colorSpace)===lt,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Jn,flipSided:x.side===Xt,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:yt&&x.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(yt&&x.extensions.multiDraw===!0||ce)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return je.vertexUv1s=l.has(1),je.vertexUv2s=l.has(2),je.vertexUv3s=l.has(3),l.clear(),je}function w(x){const b=[];if(x.shaderID?b.push(x.shaderID):(b.push(x.customVertexShaderID),b.push(x.customFragmentShaderID)),x.defines!==void 0)for(const B in x.defines)b.push(B),b.push(x.defines[B]);return x.isRawShaderMaterial===!1&&(M(b,x),S(b,x),b.push(n.outputColorSpace)),b.push(x.customProgramCacheKey),b.join()}function M(x,b){x.push(b.precision),x.push(b.outputColorSpace),x.push(b.envMapMode),x.push(b.envMapCubeUVHeight),x.push(b.mapUv),x.push(b.alphaMapUv),x.push(b.lightMapUv),x.push(b.aoMapUv),x.push(b.bumpMapUv),x.push(b.normalMapUv),x.push(b.displacementMapUv),x.push(b.emissiveMapUv),x.push(b.metalnessMapUv),x.push(b.roughnessMapUv),x.push(b.anisotropyMapUv),x.push(b.clearcoatMapUv),x.push(b.clearcoatNormalMapUv),x.push(b.clearcoatRoughnessMapUv),x.push(b.iridescenceMapUv),x.push(b.iridescenceThicknessMapUv),x.push(b.sheenColorMapUv),x.push(b.sheenRoughnessMapUv),x.push(b.specularMapUv),x.push(b.specularColorMapUv),x.push(b.specularIntensityMapUv),x.push(b.transmissionMapUv),x.push(b.thicknessMapUv),x.push(b.combine),x.push(b.fogExp2),x.push(b.sizeAttenuation),x.push(b.morphTargetsCount),x.push(b.morphAttributeCount),x.push(b.numDirLights),x.push(b.numPointLights),x.push(b.numSpotLights),x.push(b.numSpotLightMaps),x.push(b.numHemiLights),x.push(b.numRectAreaLights),x.push(b.numDirLightShadows),x.push(b.numPointLightShadows),x.push(b.numSpotLightShadows),x.push(b.numSpotLightShadowsWithMaps),x.push(b.numLightProbes),x.push(b.shadowMapType),x.push(b.toneMapping),x.push(b.numClippingPlanes),x.push(b.numClipIntersection),x.push(b.depthPacking)}function S(x,b){a.disableAll(),b.supportsVertexTextures&&a.enable(0),b.instancing&&a.enable(1),b.instancingColor&&a.enable(2),b.instancingMorph&&a.enable(3),b.matcap&&a.enable(4),b.envMap&&a.enable(5),b.normalMapObjectSpace&&a.enable(6),b.normalMapTangentSpace&&a.enable(7),b.clearcoat&&a.enable(8),b.iridescence&&a.enable(9),b.alphaTest&&a.enable(10),b.vertexColors&&a.enable(11),b.vertexAlphas&&a.enable(12),b.vertexUv1s&&a.enable(13),b.vertexUv2s&&a.enable(14),b.vertexUv3s&&a.enable(15),b.vertexTangents&&a.enable(16),b.anisotropy&&a.enable(17),b.alphaHash&&a.enable(18),b.batching&&a.enable(19),b.dispersion&&a.enable(20),b.batchingColor&&a.enable(21),x.push(a.mask),a.disableAll(),b.fog&&a.enable(0),b.useFog&&a.enable(1),b.flatShading&&a.enable(2),b.logarithmicDepthBuffer&&a.enable(3),b.reverseDepthBuffer&&a.enable(4),b.skinning&&a.enable(5),b.morphTargets&&a.enable(6),b.morphNormals&&a.enable(7),b.morphColors&&a.enable(8),b.premultipliedAlpha&&a.enable(9),b.shadowMapEnabled&&a.enable(10),b.doubleSided&&a.enable(11),b.flipSided&&a.enable(12),b.useDepthPacking&&a.enable(13),b.dithering&&a.enable(14),b.transmission&&a.enable(15),b.sheen&&a.enable(16),b.opaque&&a.enable(17),b.pointsUvs&&a.enable(18),b.decodeVideoTexture&&a.enable(19),b.alphaToCoverage&&a.enable(20),x.push(a.mask)}function D(x){const b=y[x.type];let B;if(b){const H=Un[b];B=mv.clone(H.uniforms)}else B=x.uniforms;return B}function C(x,b){let B;for(let H=0,Z=u.length;H<Z;H++){const re=u[H];if(re.cacheKey===b){B=re,++B.usedTimes;break}}return B===void 0&&(B=new RS(n,b,x,s),u.push(B)),B}function A(x){if(--x.usedTimes===0){const b=u.indexOf(x);u[b]=u[u.length-1],u.pop(),x.destroy()}}function I(x){c.remove(x)}function ne(){c.dispose()}return{getParameters:p,getProgramCacheKey:w,getUniforms:D,acquireProgram:C,releaseProgram:A,releaseShaderCache:I,programs:u,dispose:ne}}function DS(){let n=new WeakMap;function e(o){return n.has(o)}function t(o){let a=n.get(o);return a===void 0&&(a={},n.set(o,a)),a}function i(o){n.delete(o)}function r(o,a,c){n.get(o)[a]=c}function s(){n=new WeakMap}return{has:e,get:t,remove:i,update:r,dispose:s}}function US(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function Hh(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function Gh(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function o(h,f,d,_,y,m){let p=n[e];return p===void 0?(p={id:h.id,object:h,geometry:f,material:d,groupOrder:_,renderOrder:h.renderOrder,z:y,group:m},n[e]=p):(p.id=h.id,p.object=h,p.geometry=f,p.material=d,p.groupOrder=_,p.renderOrder=h.renderOrder,p.z=y,p.group=m),e++,p}function a(h,f,d,_,y,m){const p=o(h,f,d,_,y,m);d.transmission>0?i.push(p):d.transparent===!0?r.push(p):t.push(p)}function c(h,f,d,_,y,m){const p=o(h,f,d,_,y,m);d.transmission>0?i.unshift(p):d.transparent===!0?r.unshift(p):t.unshift(p)}function l(h,f){t.length>1&&t.sort(h||US),i.length>1&&i.sort(f||Hh),r.length>1&&r.sort(f||Hh)}function u(){for(let h=e,f=n.length;h<f;h++){const d=n[h];if(d.id===null)break;d.id=null,d.object=null,d.geometry=null,d.material=null,d.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:a,unshift:c,finish:u,sort:l}}function NS(){let n=new WeakMap;function e(i,r){const s=n.get(i);let o;return s===void 0?(o=new Gh,n.set(i,[o])):r>=s.length?(o=new Gh,s.push(o)):o=s[r],o}function t(){n=new WeakMap}return{get:e,dispose:t}}function FS(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new k,color:new Ge};break;case"SpotLight":t={position:new k,direction:new k,color:new Ge,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new k,color:new Ge,distance:0,decay:0};break;case"HemisphereLight":t={direction:new k,skyColor:new Ge,groundColor:new Ge};break;case"RectAreaLight":t={color:new Ge,position:new k,halfWidth:new k,halfHeight:new k};break}return n[e.id]=t,t}}}function OS(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new be};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new be};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new be,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let BS=0;function zS(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function HS(n){const e=new FS,t=OS(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)i.probe.push(new k);const r=new k,s=new ft,o=new ft;function a(l){let u=0,h=0,f=0;for(let ne=0;ne<9;ne++)i.probe[ne].set(0,0,0);let d=0,_=0,y=0,m=0,p=0,w=0,M=0,S=0,D=0,C=0,A=0;l.sort(zS);for(let ne=0,x=l.length;ne<x;ne++){const b=l[ne],B=b.color,H=b.intensity,Z=b.distance,re=b.shadow&&b.shadow.map?b.shadow.map.texture:null;if(b.isAmbientLight)u+=B.r*H,h+=B.g*H,f+=B.b*H;else if(b.isLightProbe){for(let W=0;W<9;W++)i.probe[W].addScaledVector(b.sh.coefficients[W],H);A++}else if(b.isDirectionalLight){const W=e.get(b);if(W.color.copy(b.color).multiplyScalar(b.intensity),b.castShadow){const J=b.shadow,O=t.get(b);O.shadowIntensity=J.intensity,O.shadowBias=J.bias,O.shadowNormalBias=J.normalBias,O.shadowRadius=J.radius,O.shadowMapSize=J.mapSize,i.directionalShadow[d]=O,i.directionalShadowMap[d]=re,i.directionalShadowMatrix[d]=b.shadow.matrix,w++}i.directional[d]=W,d++}else if(b.isSpotLight){const W=e.get(b);W.position.setFromMatrixPosition(b.matrixWorld),W.color.copy(B).multiplyScalar(H),W.distance=Z,W.coneCos=Math.cos(b.angle),W.penumbraCos=Math.cos(b.angle*(1-b.penumbra)),W.decay=b.decay,i.spot[y]=W;const J=b.shadow;if(b.map&&(i.spotLightMap[D]=b.map,D++,J.updateMatrices(b),b.castShadow&&C++),i.spotLightMatrix[y]=J.matrix,b.castShadow){const O=t.get(b);O.shadowIntensity=J.intensity,O.shadowBias=J.bias,O.shadowNormalBias=J.normalBias,O.shadowRadius=J.radius,O.shadowMapSize=J.mapSize,i.spotShadow[y]=O,i.spotShadowMap[y]=re,S++}y++}else if(b.isRectAreaLight){const W=e.get(b);W.color.copy(B).multiplyScalar(H),W.halfWidth.set(b.width*.5,0,0),W.halfHeight.set(0,b.height*.5,0),i.rectArea[m]=W,m++}else if(b.isPointLight){const W=e.get(b);if(W.color.copy(b.color).multiplyScalar(b.intensity),W.distance=b.distance,W.decay=b.decay,b.castShadow){const J=b.shadow,O=t.get(b);O.shadowIntensity=J.intensity,O.shadowBias=J.bias,O.shadowNormalBias=J.normalBias,O.shadowRadius=J.radius,O.shadowMapSize=J.mapSize,O.shadowCameraNear=J.camera.near,O.shadowCameraFar=J.camera.far,i.pointShadow[_]=O,i.pointShadowMap[_]=re,i.pointShadowMatrix[_]=b.shadow.matrix,M++}i.point[_]=W,_++}else if(b.isHemisphereLight){const W=e.get(b);W.skyColor.copy(b.color).multiplyScalar(H),W.groundColor.copy(b.groundColor).multiplyScalar(H),i.hemi[p]=W,p++}}m>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=we.LTC_FLOAT_1,i.rectAreaLTC2=we.LTC_FLOAT_2):(i.rectAreaLTC1=we.LTC_HALF_1,i.rectAreaLTC2=we.LTC_HALF_2)),i.ambient[0]=u,i.ambient[1]=h,i.ambient[2]=f;const I=i.hash;(I.directionalLength!==d||I.pointLength!==_||I.spotLength!==y||I.rectAreaLength!==m||I.hemiLength!==p||I.numDirectionalShadows!==w||I.numPointShadows!==M||I.numSpotShadows!==S||I.numSpotMaps!==D||I.numLightProbes!==A)&&(i.directional.length=d,i.spot.length=y,i.rectArea.length=m,i.point.length=_,i.hemi.length=p,i.directionalShadow.length=w,i.directionalShadowMap.length=w,i.pointShadow.length=M,i.pointShadowMap.length=M,i.spotShadow.length=S,i.spotShadowMap.length=S,i.directionalShadowMatrix.length=w,i.pointShadowMatrix.length=M,i.spotLightMatrix.length=S+D-C,i.spotLightMap.length=D,i.numSpotLightShadowsWithMaps=C,i.numLightProbes=A,I.directionalLength=d,I.pointLength=_,I.spotLength=y,I.rectAreaLength=m,I.hemiLength=p,I.numDirectionalShadows=w,I.numPointShadows=M,I.numSpotShadows=S,I.numSpotMaps=D,I.numLightProbes=A,i.version=BS++)}function c(l,u){let h=0,f=0,d=0,_=0,y=0;const m=u.matrixWorldInverse;for(let p=0,w=l.length;p<w;p++){const M=l[p];if(M.isDirectionalLight){const S=i.directional[h];S.direction.setFromMatrixPosition(M.matrixWorld),r.setFromMatrixPosition(M.target.matrixWorld),S.direction.sub(r),S.direction.transformDirection(m),h++}else if(M.isSpotLight){const S=i.spot[d];S.position.setFromMatrixPosition(M.matrixWorld),S.position.applyMatrix4(m),S.direction.setFromMatrixPosition(M.matrixWorld),r.setFromMatrixPosition(M.target.matrixWorld),S.direction.sub(r),S.direction.transformDirection(m),d++}else if(M.isRectAreaLight){const S=i.rectArea[_];S.position.setFromMatrixPosition(M.matrixWorld),S.position.applyMatrix4(m),o.identity(),s.copy(M.matrixWorld),s.premultiply(m),o.extractRotation(s),S.halfWidth.set(M.width*.5,0,0),S.halfHeight.set(0,M.height*.5,0),S.halfWidth.applyMatrix4(o),S.halfHeight.applyMatrix4(o),_++}else if(M.isPointLight){const S=i.point[f];S.position.setFromMatrixPosition(M.matrixWorld),S.position.applyMatrix4(m),f++}else if(M.isHemisphereLight){const S=i.hemi[y];S.direction.setFromMatrixPosition(M.matrixWorld),S.direction.transformDirection(m),y++}}}return{setup:a,setupView:c,state:i}}function kh(n){const e=new HS(n),t=[],i=[];function r(u){l.camera=u,t.length=0,i.length=0}function s(u){t.push(u)}function o(u){i.push(u)}function a(){e.setup(t)}function c(u){e.setupView(t,u)}const l={lightsArray:t,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:l,setupLights:a,setupLightsView:c,pushLight:s,pushShadow:o}}function GS(n){let e=new WeakMap;function t(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new kh(n),e.set(r,[a])):s>=o.length?(a=new kh(n),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:t,dispose:i}}class kS extends Ns{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=M_,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class VS extends Ns{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const WS=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function qS(n,e,t){let i=new Bl;const r=new be,s=new be,o=new st,a=new kS({depthPacking:S_}),c=new VS,l={},u=t.maxTextureSize,h={[Ai]:Xt,[Xt]:Ai,[Jn]:Jn},f=new ut({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new be},radius:{value:4}},vertexShader:WS,fragmentShader:XS}),d=f.clone();d.defines.HORIZONTAL_PASS=1;const _=new Cn;_.setAttribute("position",new Fn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new G(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=pd;let p=this.type;this.render=function(C,A,I){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const ne=n.getRenderTarget(),x=n.getActiveCubeFace(),b=n.getActiveMipmapLevel(),B=n.state;B.setBlending(wi),B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const H=p!==Kn&&this.type===Kn,Z=p===Kn&&this.type!==Kn;for(let re=0,W=C.length;re<W;re++){const J=C[re],O=J.shadow;if(O===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(O.autoUpdate===!1&&O.needsUpdate===!1)continue;r.copy(O.mapSize);const pe=O.getFrameExtents();if(r.multiply(pe),s.copy(O.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/pe.x),r.x=s.x*pe.x,O.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/pe.y),r.y=s.y*pe.y,O.mapSize.y=s.y)),O.map===null||H===!0||Z===!0){const ge=this.type!==Kn?{minFilter:fn,magFilter:fn}:{};O.map!==null&&O.map.dispose(),O.map=new Zi(r.x,r.y,ge),O.map.texture.name=J.name+".shadowMap",O.camera.updateProjectionMatrix()}n.setRenderTarget(O.map),n.clear();const de=O.getViewportCount();for(let ge=0;ge<de;ge++){const Se=O.getViewport(ge);o.set(s.x*Se.x,s.y*Se.y,s.x*Se.z,s.y*Se.w),B.viewport(o),O.updateMatrices(J,ge),i=O.getFrustum(),S(A,I,O.camera,J,this.type)}O.isPointLightShadow!==!0&&this.type===Kn&&w(O,I),O.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(ne,x,b)};function w(C,A){const I=e.update(y);f.defines.VSM_SAMPLES!==C.blurSamples&&(f.defines.VSM_SAMPLES=C.blurSamples,d.defines.VSM_SAMPLES=C.blurSamples,f.needsUpdate=!0,d.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Zi(r.x,r.y)),f.uniforms.shadow_pass.value=C.map.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,n.setRenderTarget(C.mapPass),n.clear(),n.renderBufferDirect(A,null,I,f,y,null),d.uniforms.shadow_pass.value=C.mapPass.texture,d.uniforms.resolution.value=C.mapSize,d.uniforms.radius.value=C.radius,n.setRenderTarget(C.map),n.clear(),n.renderBufferDirect(A,null,I,d,y,null)}function M(C,A,I,ne){let x=null;const b=I.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(b!==void 0)x=b;else if(x=I.isPointLight===!0?c:a,n.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const B=x.uuid,H=A.uuid;let Z=l[B];Z===void 0&&(Z={},l[B]=Z);let re=Z[H];re===void 0&&(re=x.clone(),Z[H]=re,A.addEventListener("dispose",D)),x=re}if(x.visible=A.visible,x.wireframe=A.wireframe,ne===Kn?x.side=A.shadowSide!==null?A.shadowSide:A.side:x.side=A.shadowSide!==null?A.shadowSide:h[A.side],x.alphaMap=A.alphaMap,x.alphaTest=A.alphaTest,x.map=A.map,x.clipShadows=A.clipShadows,x.clippingPlanes=A.clippingPlanes,x.clipIntersection=A.clipIntersection,x.displacementMap=A.displacementMap,x.displacementScale=A.displacementScale,x.displacementBias=A.displacementBias,x.wireframeLinewidth=A.wireframeLinewidth,x.linewidth=A.linewidth,I.isPointLight===!0&&x.isMeshDistanceMaterial===!0){const B=n.properties.get(x);B.light=I}return x}function S(C,A,I,ne,x){if(C.visible===!1)return;if(C.layers.test(A.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&x===Kn)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,C.matrixWorld);const H=e.update(C),Z=C.material;if(Array.isArray(Z)){const re=H.groups;for(let W=0,J=re.length;W<J;W++){const O=re[W],pe=Z[O.materialIndex];if(pe&&pe.visible){const de=M(C,pe,ne,x);C.onBeforeShadow(n,C,A,I,H,de,O),n.renderBufferDirect(I,null,H,de,C,O),C.onAfterShadow(n,C,A,I,H,de,O)}}}else if(Z.visible){const re=M(C,Z,ne,x);C.onBeforeShadow(n,C,A,I,H,re,null),n.renderBufferDirect(I,null,H,re,C,null),C.onAfterShadow(n,C,A,I,H,re,null)}}const B=C.children;for(let H=0,Z=B.length;H<Z;H++)S(B[H],A,I,ne,x)}function D(C){C.target.removeEventListener("dispose",D);for(const I in l){const ne=l[I],x=C.target.uuid;x in ne&&(ne[x].dispose(),delete ne[x])}}}const YS={[mc]:gc,[_c]:yc,[vc]:Mc,[Fr]:xc,[gc]:mc,[yc]:_c,[Mc]:vc,[xc]:Fr};function $S(n){function e(){let z=!1;const Pe=new st;let ae=null;const me=new st(0,0,0,0);return{setMask:function(Le){ae!==Le&&!z&&(n.colorMask(Le,Le,Le,Le),ae=Le)},setLocked:function(Le){z=Le},setClear:function(Le,Ue,Ke,yt,Yt){Yt===!0&&(Le*=yt,Ue*=yt,Ke*=yt),Pe.set(Le,Ue,Ke,yt),me.equals(Pe)===!1&&(n.clearColor(Le,Ue,Ke,yt),me.copy(Pe))},reset:function(){z=!1,ae=null,me.set(-1,0,0,0)}}}function t(){let z=!1,Pe=!1,ae=null,me=null,Le=null;return{setReversed:function(Ue){Pe=Ue},setTest:function(Ue){Ue?_e(n.DEPTH_TEST):U(n.DEPTH_TEST)},setMask:function(Ue){ae!==Ue&&!z&&(n.depthMask(Ue),ae=Ue)},setFunc:function(Ue){if(Pe&&(Ue=YS[Ue]),me!==Ue){switch(Ue){case mc:n.depthFunc(n.NEVER);break;case gc:n.depthFunc(n.ALWAYS);break;case _c:n.depthFunc(n.LESS);break;case Fr:n.depthFunc(n.LEQUAL);break;case vc:n.depthFunc(n.EQUAL);break;case xc:n.depthFunc(n.GEQUAL);break;case yc:n.depthFunc(n.GREATER);break;case Mc:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}me=Ue}},setLocked:function(Ue){z=Ue},setClear:function(Ue){Le!==Ue&&(n.clearDepth(Ue),Le=Ue)},reset:function(){z=!1,ae=null,me=null,Le=null}}}function i(){let z=!1,Pe=null,ae=null,me=null,Le=null,Ue=null,Ke=null,yt=null,Yt=null;return{setTest:function(je){z||(je?_e(n.STENCIL_TEST):U(n.STENCIL_TEST))},setMask:function(je){Pe!==je&&!z&&(n.stencilMask(je),Pe=je)},setFunc:function(je,$t,Hn){(ae!==je||me!==$t||Le!==Hn)&&(n.stencilFunc(je,$t,Hn),ae=je,me=$t,Le=Hn)},setOp:function(je,$t,Hn){(Ue!==je||Ke!==$t||yt!==Hn)&&(n.stencilOp(je,$t,Hn),Ue=je,Ke=$t,yt=Hn)},setLocked:function(je){z=je},setClear:function(je){Yt!==je&&(n.clearStencil(je),Yt=je)},reset:function(){z=!1,Pe=null,ae=null,me=null,Le=null,Ue=null,Ke=null,yt=null,Yt=null}}}const r=new e,s=new t,o=new i,a=new WeakMap,c=new WeakMap;let l={},u={},h=new WeakMap,f=[],d=null,_=!1,y=null,m=null,p=null,w=null,M=null,S=null,D=null,C=new Ge(0,0,0),A=0,I=!1,ne=null,x=null,b=null,B=null,H=null;const Z=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let re=!1,W=0;const J=n.getParameter(n.VERSION);J.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(J)[1]),re=W>=1):J.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),re=W>=2);let O=null,pe={};const de=n.getParameter(n.SCISSOR_BOX),ge=n.getParameter(n.VIEWPORT),Se=new st().fromArray(de),Re=new st().fromArray(ge);function Q(z,Pe,ae,me){const Le=new Uint8Array(4),Ue=n.createTexture();n.bindTexture(z,Ue),n.texParameteri(z,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(z,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Ke=0;Ke<ae;Ke++)z===n.TEXTURE_3D||z===n.TEXTURE_2D_ARRAY?n.texImage3D(Pe,0,n.RGBA,1,1,me,0,n.RGBA,n.UNSIGNED_BYTE,Le):n.texImage2D(Pe+Ke,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Le);return Ue}const fe={};fe[n.TEXTURE_2D]=Q(n.TEXTURE_2D,n.TEXTURE_2D,1),fe[n.TEXTURE_CUBE_MAP]=Q(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),fe[n.TEXTURE_2D_ARRAY]=Q(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),fe[n.TEXTURE_3D]=Q(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),_e(n.DEPTH_TEST),s.setFunc(Fr),L(!1),F(Ku),_e(n.CULL_FACE),g(wi);function _e(z){l[z]!==!0&&(n.enable(z),l[z]=!0)}function U(z){l[z]!==!1&&(n.disable(z),l[z]=!1)}function oe(z,Pe){return u[z]!==Pe?(n.bindFramebuffer(z,Pe),u[z]=Pe,z===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=Pe),z===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=Pe),!0):!1}function K(z,Pe){let ae=f,me=!1;if(z){ae=h.get(Pe),ae===void 0&&(ae=[],h.set(Pe,ae));const Le=z.textures;if(ae.length!==Le.length||ae[0]!==n.COLOR_ATTACHMENT0){for(let Ue=0,Ke=Le.length;Ue<Ke;Ue++)ae[Ue]=n.COLOR_ATTACHMENT0+Ue;ae.length=Le.length,me=!0}}else ae[0]!==n.BACK&&(ae[0]=n.BACK,me=!0);me&&n.drawBuffers(ae)}function ce(z){return d!==z?(n.useProgram(z),d=z,!0):!1}const xe={[Vi]:n.FUNC_ADD,[Kg]:n.FUNC_SUBTRACT,[jg]:n.FUNC_REVERSE_SUBTRACT};xe[Zg]=n.MIN,xe[Jg]=n.MAX;const te={[Qg]:n.ZERO,[e_]:n.ONE,[t_]:n.SRC_COLOR,[dc]:n.SRC_ALPHA,[a_]:n.SRC_ALPHA_SATURATE,[s_]:n.DST_COLOR,[i_]:n.DST_ALPHA,[n_]:n.ONE_MINUS_SRC_COLOR,[pc]:n.ONE_MINUS_SRC_ALPHA,[o_]:n.ONE_MINUS_DST_COLOR,[r_]:n.ONE_MINUS_DST_ALPHA,[c_]:n.CONSTANT_COLOR,[l_]:n.ONE_MINUS_CONSTANT_COLOR,[u_]:n.CONSTANT_ALPHA,[h_]:n.ONE_MINUS_CONSTANT_ALPHA};function g(z,Pe,ae,me,Le,Ue,Ke,yt,Yt,je){if(z===wi){_===!0&&(U(n.BLEND),_=!1);return}if(_===!1&&(_e(n.BLEND),_=!0),z!==$g){if(z!==y||je!==I){if((m!==Vi||M!==Vi)&&(n.blendEquation(n.FUNC_ADD),m=Vi,M=Vi),je)switch(z){case Cr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ju:n.blendFunc(n.ONE,n.ONE);break;case Zu:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Ju:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",z);break}else switch(z){case Cr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case ju:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Zu:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Ju:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",z);break}p=null,w=null,S=null,D=null,C.set(0,0,0),A=0,y=z,I=je}return}Le=Le||Pe,Ue=Ue||ae,Ke=Ke||me,(Pe!==m||Le!==M)&&(n.blendEquationSeparate(xe[Pe],xe[Le]),m=Pe,M=Le),(ae!==p||me!==w||Ue!==S||Ke!==D)&&(n.blendFuncSeparate(te[ae],te[me],te[Ue],te[Ke]),p=ae,w=me,S=Ue,D=Ke),(yt.equals(C)===!1||Yt!==A)&&(n.blendColor(yt.r,yt.g,yt.b,Yt),C.copy(yt),A=Yt),y=z,I=!1}function T(z,Pe){z.side===Jn?U(n.CULL_FACE):_e(n.CULL_FACE);let ae=z.side===Xt;Pe&&(ae=!ae),L(ae),z.blending===Cr&&z.transparent===!1?g(wi):g(z.blending,z.blendEquation,z.blendSrc,z.blendDst,z.blendEquationAlpha,z.blendSrcAlpha,z.blendDstAlpha,z.blendColor,z.blendAlpha,z.premultipliedAlpha),s.setFunc(z.depthFunc),s.setTest(z.depthTest),s.setMask(z.depthWrite),r.setMask(z.colorWrite);const me=z.stencilWrite;o.setTest(me),me&&(o.setMask(z.stencilWriteMask),o.setFunc(z.stencilFunc,z.stencilRef,z.stencilFuncMask),o.setOp(z.stencilFail,z.stencilZFail,z.stencilZPass)),j(z.polygonOffset,z.polygonOffsetFactor,z.polygonOffsetUnits),z.alphaToCoverage===!0?_e(n.SAMPLE_ALPHA_TO_COVERAGE):U(n.SAMPLE_ALPHA_TO_COVERAGE)}function L(z){ne!==z&&(z?n.frontFace(n.CW):n.frontFace(n.CCW),ne=z)}function F(z){z!==Xg?(_e(n.CULL_FACE),z!==x&&(z===Ku?n.cullFace(n.BACK):z===qg?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):U(n.CULL_FACE),x=z}function N(z){z!==b&&(re&&n.lineWidth(z),b=z)}function j(z,Pe,ae){z?(_e(n.POLYGON_OFFSET_FILL),(B!==Pe||H!==ae)&&(n.polygonOffset(Pe,ae),B=Pe,H=ae)):U(n.POLYGON_OFFSET_FILL)}function ee(z){z?_e(n.SCISSOR_TEST):U(n.SCISSOR_TEST)}function E(z){z===void 0&&(z=n.TEXTURE0+Z-1),O!==z&&(n.activeTexture(z),O=z)}function v(z,Pe,ae){ae===void 0&&(O===null?ae=n.TEXTURE0+Z-1:ae=O);let me=pe[ae];me===void 0&&(me={type:void 0,texture:void 0},pe[ae]=me),(me.type!==z||me.texture!==Pe)&&(O!==ae&&(n.activeTexture(ae),O=ae),n.bindTexture(z,Pe||fe[z]),me.type=z,me.texture=Pe)}function P(){const z=pe[O];z!==void 0&&z.type!==void 0&&(n.bindTexture(z.type,null),z.type=void 0,z.texture=void 0)}function X(){try{n.compressedTexImage2D.apply(n,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function V(){try{n.compressedTexImage3D.apply(n,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function Y(){try{n.texSubImage2D.apply(n,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function ue(){try{n.texSubImage3D.apply(n,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function le(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function ve(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function Te(){try{n.texStorage2D.apply(n,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function he(){try{n.texStorage3D.apply(n,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function ye(){try{n.texImage2D.apply(n,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function Ne(){try{n.texImage3D.apply(n,arguments)}catch(z){console.error("THREE.WebGLState:",z)}}function De(z){Se.equals(z)===!1&&(n.scissor(z.x,z.y,z.z,z.w),Se.copy(z))}function Ae(z){Re.equals(z)===!1&&(n.viewport(z.x,z.y,z.z,z.w),Re.copy(z))}function Be(z,Pe){let ae=c.get(Pe);ae===void 0&&(ae=new WeakMap,c.set(Pe,ae));let me=ae.get(z);me===void 0&&(me=n.getUniformBlockIndex(Pe,z.name),ae.set(z,me))}function Ce(z,Pe){const me=c.get(Pe).get(z);a.get(Pe)!==me&&(n.uniformBlockBinding(Pe,me,z.__bindingPointIndex),a.set(Pe,me))}function We(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),l={},O=null,pe={},u={},h=new WeakMap,f=[],d=null,_=!1,y=null,m=null,p=null,w=null,M=null,S=null,D=null,C=new Ge(0,0,0),A=0,I=!1,ne=null,x=null,b=null,B=null,H=null,Se.set(0,0,n.canvas.width,n.canvas.height),Re.set(0,0,n.canvas.width,n.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:_e,disable:U,bindFramebuffer:oe,drawBuffers:K,useProgram:ce,setBlending:g,setMaterial:T,setFlipSided:L,setCullFace:F,setLineWidth:N,setPolygonOffset:j,setScissorTest:ee,activeTexture:E,bindTexture:v,unbindTexture:P,compressedTexImage2D:X,compressedTexImage3D:V,texImage2D:ye,texImage3D:Ne,updateUBOMapping:Be,uniformBlockBinding:Ce,texStorage2D:Te,texStorage3D:he,texSubImage2D:Y,texSubImage3D:ue,compressedTexSubImage2D:le,compressedTexSubImage3D:ve,scissor:De,viewport:Ae,reset:We}}function Vh(n,e,t,i){const r=KS(i);switch(t){case yd:return n*e;case Sd:return n*e;case Ed:return n*e*2;case wd:return n*e/r.components*r.byteLength;case Il:return n*e/r.components*r.byteLength;case bd:return n*e*2/r.components*r.byteLength;case Dl:return n*e*2/r.components*r.byteLength;case Md:return n*e*3/r.components*r.byteLength;case wn:return n*e*4/r.components*r.byteLength;case Ul:return n*e*4/r.components*r.byteLength;case vo:case xo:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case yo:case Mo:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Ac:case Cc:return Math.max(n,16)*Math.max(e,8)/4;case Tc:case Rc:return Math.max(n,8)*Math.max(e,8)/2;case Pc:case Lc:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case Ic:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Dc:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case Uc:return Math.floor((n+4)/5)*Math.floor((e+3)/4)*16;case Nc:return Math.floor((n+4)/5)*Math.floor((e+4)/5)*16;case Fc:return Math.floor((n+5)/6)*Math.floor((e+4)/5)*16;case Oc:return Math.floor((n+5)/6)*Math.floor((e+5)/6)*16;case Bc:return Math.floor((n+7)/8)*Math.floor((e+4)/5)*16;case zc:return Math.floor((n+7)/8)*Math.floor((e+5)/6)*16;case Hc:return Math.floor((n+7)/8)*Math.floor((e+7)/8)*16;case Gc:return Math.floor((n+9)/10)*Math.floor((e+4)/5)*16;case kc:return Math.floor((n+9)/10)*Math.floor((e+5)/6)*16;case Vc:return Math.floor((n+9)/10)*Math.floor((e+7)/8)*16;case Wc:return Math.floor((n+9)/10)*Math.floor((e+9)/10)*16;case Xc:return Math.floor((n+11)/12)*Math.floor((e+9)/10)*16;case qc:return Math.floor((n+11)/12)*Math.floor((e+11)/12)*16;case So:case Yc:case $c:return Math.ceil(n/4)*Math.ceil(e/4)*16;case Td:case Kc:return Math.ceil(n/4)*Math.ceil(e/4)*8;case jc:case Zc:return Math.ceil(n/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function KS(n){switch(n){case ii:case _d:return{byteLength:1,components:1};case ws:case vd:case Is:return{byteLength:2,components:1};case Pl:case Ll:return{byteLength:2,components:4};case ji:case Cl:case Qn:return{byteLength:4,components:1};case xd:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function jS(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new be,u=new WeakMap;let h;const f=new WeakMap;let d=!1;try{d=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(E,v){return d?new OffscreenCanvas(E,v):Uo("canvas")}function y(E,v,P){let X=1;const V=ee(E);if((V.width>P||V.height>P)&&(X=P/Math.max(V.width,V.height)),X<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const Y=Math.floor(X*V.width),ue=Math.floor(X*V.height);h===void 0&&(h=_(Y,ue));const le=v?_(Y,ue):h;return le.width=Y,le.height=ue,le.getContext("2d").drawImage(E,0,0,Y,ue),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+V.width+"x"+V.height+") to ("+Y+"x"+ue+")."),le}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+V.width+"x"+V.height+")."),E;return E}function m(E){return E.generateMipmaps&&E.minFilter!==fn&&E.minFilter!==Mn}function p(E){n.generateMipmap(E)}function w(E,v,P,X,V=!1){if(E!==null){if(n[E]!==void 0)return n[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let Y=v;if(v===n.RED&&(P===n.FLOAT&&(Y=n.R32F),P===n.HALF_FLOAT&&(Y=n.R16F),P===n.UNSIGNED_BYTE&&(Y=n.R8)),v===n.RED_INTEGER&&(P===n.UNSIGNED_BYTE&&(Y=n.R8UI),P===n.UNSIGNED_SHORT&&(Y=n.R16UI),P===n.UNSIGNED_INT&&(Y=n.R32UI),P===n.BYTE&&(Y=n.R8I),P===n.SHORT&&(Y=n.R16I),P===n.INT&&(Y=n.R32I)),v===n.RG&&(P===n.FLOAT&&(Y=n.RG32F),P===n.HALF_FLOAT&&(Y=n.RG16F),P===n.UNSIGNED_BYTE&&(Y=n.RG8)),v===n.RG_INTEGER&&(P===n.UNSIGNED_BYTE&&(Y=n.RG8UI),P===n.UNSIGNED_SHORT&&(Y=n.RG16UI),P===n.UNSIGNED_INT&&(Y=n.RG32UI),P===n.BYTE&&(Y=n.RG8I),P===n.SHORT&&(Y=n.RG16I),P===n.INT&&(Y=n.RG32I)),v===n.RGB_INTEGER&&(P===n.UNSIGNED_BYTE&&(Y=n.RGB8UI),P===n.UNSIGNED_SHORT&&(Y=n.RGB16UI),P===n.UNSIGNED_INT&&(Y=n.RGB32UI),P===n.BYTE&&(Y=n.RGB8I),P===n.SHORT&&(Y=n.RGB16I),P===n.INT&&(Y=n.RGB32I)),v===n.RGBA_INTEGER&&(P===n.UNSIGNED_BYTE&&(Y=n.RGBA8UI),P===n.UNSIGNED_SHORT&&(Y=n.RGBA16UI),P===n.UNSIGNED_INT&&(Y=n.RGBA32UI),P===n.BYTE&&(Y=n.RGBA8I),P===n.SHORT&&(Y=n.RGBA16I),P===n.INT&&(Y=n.RGBA32I)),v===n.RGB&&P===n.UNSIGNED_INT_5_9_9_9_REV&&(Y=n.RGB9_E5),v===n.RGBA){const ue=V?Po:et.getTransfer(X);P===n.FLOAT&&(Y=n.RGBA32F),P===n.HALF_FLOAT&&(Y=n.RGBA16F),P===n.UNSIGNED_BYTE&&(Y=ue===lt?n.SRGB8_ALPHA8:n.RGBA8),P===n.UNSIGNED_SHORT_4_4_4_4&&(Y=n.RGBA4),P===n.UNSIGNED_SHORT_5_5_5_1&&(Y=n.RGB5_A1)}return(Y===n.R16F||Y===n.R32F||Y===n.RG16F||Y===n.RG32F||Y===n.RGBA16F||Y===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function M(E,v){let P;return E?v===null||v===ji||v===zr?P=n.DEPTH24_STENCIL8:v===Qn?P=n.DEPTH32F_STENCIL8:v===ws&&(P=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===ji||v===zr?P=n.DEPTH_COMPONENT24:v===Qn?P=n.DEPTH_COMPONENT32F:v===ws&&(P=n.DEPTH_COMPONENT16),P}function S(E,v){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==fn&&E.minFilter!==Mn?Math.log2(Math.max(v.width,v.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?v.mipmaps.length:1}function D(E){const v=E.target;v.removeEventListener("dispose",D),A(v),v.isVideoTexture&&u.delete(v)}function C(E){const v=E.target;v.removeEventListener("dispose",C),ne(v)}function A(E){const v=i.get(E);if(v.__webglInit===void 0)return;const P=E.source,X=f.get(P);if(X){const V=X[v.__cacheKey];V.usedTimes--,V.usedTimes===0&&I(E),Object.keys(X).length===0&&f.delete(P)}i.remove(E)}function I(E){const v=i.get(E);n.deleteTexture(v.__webglTexture);const P=E.source,X=f.get(P);delete X[v.__cacheKey],o.memory.textures--}function ne(E){const v=i.get(E);if(E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(v.__webglFramebuffer[X]))for(let V=0;V<v.__webglFramebuffer[X].length;V++)n.deleteFramebuffer(v.__webglFramebuffer[X][V]);else n.deleteFramebuffer(v.__webglFramebuffer[X]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[X])}else{if(Array.isArray(v.__webglFramebuffer))for(let X=0;X<v.__webglFramebuffer.length;X++)n.deleteFramebuffer(v.__webglFramebuffer[X]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let X=0;X<v.__webglColorRenderbuffer.length;X++)v.__webglColorRenderbuffer[X]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[X]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const P=E.textures;for(let X=0,V=P.length;X<V;X++){const Y=i.get(P[X]);Y.__webglTexture&&(n.deleteTexture(Y.__webglTexture),o.memory.textures--),i.remove(P[X])}i.remove(E)}let x=0;function b(){x=0}function B(){const E=x;return E>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+r.maxTextures),x+=1,E}function H(E){const v=[];return v.push(E.wrapS),v.push(E.wrapT),v.push(E.wrapR||0),v.push(E.magFilter),v.push(E.minFilter),v.push(E.anisotropy),v.push(E.internalFormat),v.push(E.format),v.push(E.type),v.push(E.generateMipmaps),v.push(E.premultiplyAlpha),v.push(E.flipY),v.push(E.unpackAlignment),v.push(E.colorSpace),v.join()}function Z(E,v){const P=i.get(E);if(E.isVideoTexture&&N(E),E.isRenderTargetTexture===!1&&E.version>0&&P.__version!==E.version){const X=E.image;if(X===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Re(P,E,v);return}}t.bindTexture(n.TEXTURE_2D,P.__webglTexture,n.TEXTURE0+v)}function re(E,v){const P=i.get(E);if(E.version>0&&P.__version!==E.version){Re(P,E,v);return}t.bindTexture(n.TEXTURE_2D_ARRAY,P.__webglTexture,n.TEXTURE0+v)}function W(E,v){const P=i.get(E);if(E.version>0&&P.__version!==E.version){Re(P,E,v);return}t.bindTexture(n.TEXTURE_3D,P.__webglTexture,n.TEXTURE0+v)}function J(E,v){const P=i.get(E);if(E.version>0&&P.__version!==E.version){Q(P,E,v);return}t.bindTexture(n.TEXTURE_CUBE_MAP,P.__webglTexture,n.TEXTURE0+v)}const O={[wc]:n.REPEAT,[Xi]:n.CLAMP_TO_EDGE,[bc]:n.MIRRORED_REPEAT},pe={[fn]:n.NEAREST,[y_]:n.NEAREST_MIPMAP_NEAREST,[Ws]:n.NEAREST_MIPMAP_LINEAR,[Mn]:n.LINEAR,[ma]:n.LINEAR_MIPMAP_NEAREST,[qi]:n.LINEAR_MIPMAP_LINEAR},de={[w_]:n.NEVER,[P_]:n.ALWAYS,[b_]:n.LESS,[Rd]:n.LEQUAL,[T_]:n.EQUAL,[C_]:n.GEQUAL,[A_]:n.GREATER,[R_]:n.NOTEQUAL};function ge(E,v){if(v.type===Qn&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Mn||v.magFilter===ma||v.magFilter===Ws||v.magFilter===qi||v.minFilter===Mn||v.minFilter===ma||v.minFilter===Ws||v.minFilter===qi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(E,n.TEXTURE_WRAP_S,O[v.wrapS]),n.texParameteri(E,n.TEXTURE_WRAP_T,O[v.wrapT]),(E===n.TEXTURE_3D||E===n.TEXTURE_2D_ARRAY)&&n.texParameteri(E,n.TEXTURE_WRAP_R,O[v.wrapR]),n.texParameteri(E,n.TEXTURE_MAG_FILTER,pe[v.magFilter]),n.texParameteri(E,n.TEXTURE_MIN_FILTER,pe[v.minFilter]),v.compareFunction&&(n.texParameteri(E,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(E,n.TEXTURE_COMPARE_FUNC,de[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===fn||v.minFilter!==Ws&&v.minFilter!==qi||v.type===Qn&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const P=e.get("EXT_texture_filter_anisotropic");n.texParameterf(E,P.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function Se(E,v){let P=!1;E.__webglInit===void 0&&(E.__webglInit=!0,v.addEventListener("dispose",D));const X=v.source;let V=f.get(X);V===void 0&&(V={},f.set(X,V));const Y=H(v);if(Y!==E.__cacheKey){V[Y]===void 0&&(V[Y]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,P=!0),V[Y].usedTimes++;const ue=V[E.__cacheKey];ue!==void 0&&(V[E.__cacheKey].usedTimes--,ue.usedTimes===0&&I(v)),E.__cacheKey=Y,E.__webglTexture=V[Y].texture}return P}function Re(E,v,P){let X=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(X=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(X=n.TEXTURE_3D);const V=Se(E,v),Y=v.source;t.bindTexture(X,E.__webglTexture,n.TEXTURE0+P);const ue=i.get(Y);if(Y.version!==ue.__version||V===!0){t.activeTexture(n.TEXTURE0+P);const le=et.getPrimaries(et.workingColorSpace),ve=v.colorSpace===Ei?null:et.getPrimaries(v.colorSpace),Te=v.colorSpace===Ei||le===ve?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te);let he=y(v.image,!1,r.maxTextureSize);he=j(v,he);const ye=s.convert(v.format,v.colorSpace),Ne=s.convert(v.type);let De=w(v.internalFormat,ye,Ne,v.colorSpace,v.isVideoTexture);ge(X,v);let Ae;const Be=v.mipmaps,Ce=v.isVideoTexture!==!0,We=ue.__version===void 0||V===!0,z=Y.dataReady,Pe=S(v,he);if(v.isDepthTexture)De=M(v.format===Hr,v.type),We&&(Ce?t.texStorage2D(n.TEXTURE_2D,1,De,he.width,he.height):t.texImage2D(n.TEXTURE_2D,0,De,he.width,he.height,0,ye,Ne,null));else if(v.isDataTexture)if(Be.length>0){Ce&&We&&t.texStorage2D(n.TEXTURE_2D,Pe,De,Be[0].width,Be[0].height);for(let ae=0,me=Be.length;ae<me;ae++)Ae=Be[ae],Ce?z&&t.texSubImage2D(n.TEXTURE_2D,ae,0,0,Ae.width,Ae.height,ye,Ne,Ae.data):t.texImage2D(n.TEXTURE_2D,ae,De,Ae.width,Ae.height,0,ye,Ne,Ae.data);v.generateMipmaps=!1}else Ce?(We&&t.texStorage2D(n.TEXTURE_2D,Pe,De,he.width,he.height),z&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,he.width,he.height,ye,Ne,he.data)):t.texImage2D(n.TEXTURE_2D,0,De,he.width,he.height,0,ye,Ne,he.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Ce&&We&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Pe,De,Be[0].width,Be[0].height,he.depth);for(let ae=0,me=Be.length;ae<me;ae++)if(Ae=Be[ae],v.format!==wn)if(ye!==null)if(Ce){if(z)if(v.layerUpdates.size>0){const Le=Vh(Ae.width,Ae.height,v.format,v.type);for(const Ue of v.layerUpdates){const Ke=Ae.data.subarray(Ue*Le/Ae.data.BYTES_PER_ELEMENT,(Ue+1)*Le/Ae.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ae,0,0,Ue,Ae.width,Ae.height,1,ye,Ke,0,0)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,ae,0,0,0,Ae.width,Ae.height,he.depth,ye,Ae.data,0,0)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,ae,De,Ae.width,Ae.height,he.depth,0,Ae.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ce?z&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,ae,0,0,0,Ae.width,Ae.height,he.depth,ye,Ne,Ae.data):t.texImage3D(n.TEXTURE_2D_ARRAY,ae,De,Ae.width,Ae.height,he.depth,0,ye,Ne,Ae.data)}else{Ce&&We&&t.texStorage2D(n.TEXTURE_2D,Pe,De,Be[0].width,Be[0].height);for(let ae=0,me=Be.length;ae<me;ae++)Ae=Be[ae],v.format!==wn?ye!==null?Ce?z&&t.compressedTexSubImage2D(n.TEXTURE_2D,ae,0,0,Ae.width,Ae.height,ye,Ae.data):t.compressedTexImage2D(n.TEXTURE_2D,ae,De,Ae.width,Ae.height,0,Ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ce?z&&t.texSubImage2D(n.TEXTURE_2D,ae,0,0,Ae.width,Ae.height,ye,Ne,Ae.data):t.texImage2D(n.TEXTURE_2D,ae,De,Ae.width,Ae.height,0,ye,Ne,Ae.data)}else if(v.isDataArrayTexture)if(Ce){if(We&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Pe,De,he.width,he.height,he.depth),z)if(v.layerUpdates.size>0){const ae=Vh(he.width,he.height,v.format,v.type);for(const me of v.layerUpdates){const Le=he.data.subarray(me*ae/he.data.BYTES_PER_ELEMENT,(me+1)*ae/he.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,me,he.width,he.height,1,ye,Ne,Le)}v.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,he.width,he.height,he.depth,ye,Ne,he.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,De,he.width,he.height,he.depth,0,ye,Ne,he.data);else if(v.isData3DTexture)Ce?(We&&t.texStorage3D(n.TEXTURE_3D,Pe,De,he.width,he.height,he.depth),z&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,he.width,he.height,he.depth,ye,Ne,he.data)):t.texImage3D(n.TEXTURE_3D,0,De,he.width,he.height,he.depth,0,ye,Ne,he.data);else if(v.isFramebufferTexture){if(We)if(Ce)t.texStorage2D(n.TEXTURE_2D,Pe,De,he.width,he.height);else{let ae=he.width,me=he.height;for(let Le=0;Le<Pe;Le++)t.texImage2D(n.TEXTURE_2D,Le,De,ae,me,0,ye,Ne,null),ae>>=1,me>>=1}}else if(Be.length>0){if(Ce&&We){const ae=ee(Be[0]);t.texStorage2D(n.TEXTURE_2D,Pe,De,ae.width,ae.height)}for(let ae=0,me=Be.length;ae<me;ae++)Ae=Be[ae],Ce?z&&t.texSubImage2D(n.TEXTURE_2D,ae,0,0,ye,Ne,Ae):t.texImage2D(n.TEXTURE_2D,ae,De,ye,Ne,Ae);v.generateMipmaps=!1}else if(Ce){if(We){const ae=ee(he);t.texStorage2D(n.TEXTURE_2D,Pe,De,ae.width,ae.height)}z&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ye,Ne,he)}else t.texImage2D(n.TEXTURE_2D,0,De,ye,Ne,he);m(v)&&p(X),ue.__version=Y.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function Q(E,v,P){if(v.image.length!==6)return;const X=Se(E,v),V=v.source;t.bindTexture(n.TEXTURE_CUBE_MAP,E.__webglTexture,n.TEXTURE0+P);const Y=i.get(V);if(V.version!==Y.__version||X===!0){t.activeTexture(n.TEXTURE0+P);const ue=et.getPrimaries(et.workingColorSpace),le=v.colorSpace===Ei?null:et.getPrimaries(v.colorSpace),ve=v.colorSpace===Ei||ue===le?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ve);const Te=v.isCompressedTexture||v.image[0].isCompressedTexture,he=v.image[0]&&v.image[0].isDataTexture,ye=[];for(let me=0;me<6;me++)!Te&&!he?ye[me]=y(v.image[me],!0,r.maxCubemapSize):ye[me]=he?v.image[me].image:v.image[me],ye[me]=j(v,ye[me]);const Ne=ye[0],De=s.convert(v.format,v.colorSpace),Ae=s.convert(v.type),Be=w(v.internalFormat,De,Ae,v.colorSpace),Ce=v.isVideoTexture!==!0,We=Y.__version===void 0||X===!0,z=V.dataReady;let Pe=S(v,Ne);ge(n.TEXTURE_CUBE_MAP,v);let ae;if(Te){Ce&&We&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Pe,Be,Ne.width,Ne.height);for(let me=0;me<6;me++){ae=ye[me].mipmaps;for(let Le=0;Le<ae.length;Le++){const Ue=ae[Le];v.format!==wn?De!==null?Ce?z&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,Le,0,0,Ue.width,Ue.height,De,Ue.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,Le,Be,Ue.width,Ue.height,0,Ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ce?z&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,Le,0,0,Ue.width,Ue.height,De,Ae,Ue.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,Le,Be,Ue.width,Ue.height,0,De,Ae,Ue.data)}}}else{if(ae=v.mipmaps,Ce&&We){ae.length>0&&Pe++;const me=ee(ye[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,Pe,Be,me.width,me.height)}for(let me=0;me<6;me++)if(he){Ce?z&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,0,0,ye[me].width,ye[me].height,De,Ae,ye[me].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,Be,ye[me].width,ye[me].height,0,De,Ae,ye[me].data);for(let Le=0;Le<ae.length;Le++){const Ke=ae[Le].image[me].image;Ce?z&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,Le+1,0,0,Ke.width,Ke.height,De,Ae,Ke.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,Le+1,Be,Ke.width,Ke.height,0,De,Ae,Ke.data)}}else{Ce?z&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,0,0,De,Ae,ye[me]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,Be,De,Ae,ye[me]);for(let Le=0;Le<ae.length;Le++){const Ue=ae[Le];Ce?z&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,Le+1,0,0,De,Ae,Ue.image[me]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+me,Le+1,Be,De,Ae,Ue.image[me])}}}m(v)&&p(n.TEXTURE_CUBE_MAP),Y.__version=V.version,v.onUpdate&&v.onUpdate(v)}E.__version=v.version}function fe(E,v,P,X,V,Y){const ue=s.convert(P.format,P.colorSpace),le=s.convert(P.type),ve=w(P.internalFormat,ue,le,P.colorSpace);if(!i.get(v).__hasExternalTextures){const he=Math.max(1,v.width>>Y),ye=Math.max(1,v.height>>Y);V===n.TEXTURE_3D||V===n.TEXTURE_2D_ARRAY?t.texImage3D(V,Y,ve,he,ye,v.depth,0,ue,le,null):t.texImage2D(V,Y,ve,he,ye,0,ue,le,null)}t.bindFramebuffer(n.FRAMEBUFFER,E),F(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,X,V,i.get(P).__webglTexture,0,L(v)):(V===n.TEXTURE_2D||V>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&V<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,X,V,i.get(P).__webglTexture,Y),t.bindFramebuffer(n.FRAMEBUFFER,null)}function _e(E,v,P){if(n.bindRenderbuffer(n.RENDERBUFFER,E),v.depthBuffer){const X=v.depthTexture,V=X&&X.isDepthTexture?X.type:null,Y=M(v.stencilBuffer,V),ue=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,le=L(v);F(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,le,Y,v.width,v.height):P?n.renderbufferStorageMultisample(n.RENDERBUFFER,le,Y,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,Y,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ue,n.RENDERBUFFER,E)}else{const X=v.textures;for(let V=0;V<X.length;V++){const Y=X[V],ue=s.convert(Y.format,Y.colorSpace),le=s.convert(Y.type),ve=w(Y.internalFormat,ue,le,Y.colorSpace),Te=L(v);P&&F(v)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Te,ve,v.width,v.height):F(v)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Te,ve,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,ve,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function U(E,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,E),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(v.depthTexture).__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Z(v.depthTexture,0);const X=i.get(v.depthTexture).__webglTexture,V=L(v);if(v.depthTexture.format===Pr)F(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,X,0,V):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,X,0);else if(v.depthTexture.format===Hr)F(v)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,X,0,V):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,X,0);else throw new Error("Unknown depthTexture format")}function oe(E){const v=i.get(E),P=E.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==E.depthTexture){const X=E.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),X){const V=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,X.removeEventListener("dispose",V)};X.addEventListener("dispose",V),v.__depthDisposeCallback=V}v.__boundDepthTexture=X}if(E.depthTexture&&!v.__autoAllocateDepthBuffer){if(P)throw new Error("target.depthTexture not supported in Cube render targets");U(v.__webglFramebuffer,E)}else if(P){v.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[X]),v.__webglDepthbuffer[X]===void 0)v.__webglDepthbuffer[X]=n.createRenderbuffer(),_e(v.__webglDepthbuffer[X],E,!1);else{const V=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Y=v.__webglDepthbuffer[X];n.bindRenderbuffer(n.RENDERBUFFER,Y),n.framebufferRenderbuffer(n.FRAMEBUFFER,V,n.RENDERBUFFER,Y)}}else if(t.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),_e(v.__webglDepthbuffer,E,!1);else{const X=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,V=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,V),n.framebufferRenderbuffer(n.FRAMEBUFFER,X,n.RENDERBUFFER,V)}t.bindFramebuffer(n.FRAMEBUFFER,null)}function K(E,v,P){const X=i.get(E);v!==void 0&&fe(X.__webglFramebuffer,E,E.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),P!==void 0&&oe(E)}function ce(E){const v=E.texture,P=i.get(E),X=i.get(v);E.addEventListener("dispose",C);const V=E.textures,Y=E.isWebGLCubeRenderTarget===!0,ue=V.length>1;if(ue||(X.__webglTexture===void 0&&(X.__webglTexture=n.createTexture()),X.__version=v.version,o.memory.textures++),Y){P.__webglFramebuffer=[];for(let le=0;le<6;le++)if(v.mipmaps&&v.mipmaps.length>0){P.__webglFramebuffer[le]=[];for(let ve=0;ve<v.mipmaps.length;ve++)P.__webglFramebuffer[le][ve]=n.createFramebuffer()}else P.__webglFramebuffer[le]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){P.__webglFramebuffer=[];for(let le=0;le<v.mipmaps.length;le++)P.__webglFramebuffer[le]=n.createFramebuffer()}else P.__webglFramebuffer=n.createFramebuffer();if(ue)for(let le=0,ve=V.length;le<ve;le++){const Te=i.get(V[le]);Te.__webglTexture===void 0&&(Te.__webglTexture=n.createTexture(),o.memory.textures++)}if(E.samples>0&&F(E)===!1){P.__webglMultisampledFramebuffer=n.createFramebuffer(),P.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,P.__webglMultisampledFramebuffer);for(let le=0;le<V.length;le++){const ve=V[le];P.__webglColorRenderbuffer[le]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,P.__webglColorRenderbuffer[le]);const Te=s.convert(ve.format,ve.colorSpace),he=s.convert(ve.type),ye=w(ve.internalFormat,Te,he,ve.colorSpace,E.isXRRenderTarget===!0),Ne=L(E);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ne,ye,E.width,E.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+le,n.RENDERBUFFER,P.__webglColorRenderbuffer[le])}n.bindRenderbuffer(n.RENDERBUFFER,null),E.depthBuffer&&(P.__webglDepthRenderbuffer=n.createRenderbuffer(),_e(P.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(Y){t.bindTexture(n.TEXTURE_CUBE_MAP,X.__webglTexture),ge(n.TEXTURE_CUBE_MAP,v);for(let le=0;le<6;le++)if(v.mipmaps&&v.mipmaps.length>0)for(let ve=0;ve<v.mipmaps.length;ve++)fe(P.__webglFramebuffer[le][ve],E,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+le,ve);else fe(P.__webglFramebuffer[le],E,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+le,0);m(v)&&p(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ue){for(let le=0,ve=V.length;le<ve;le++){const Te=V[le],he=i.get(Te);t.bindTexture(n.TEXTURE_2D,he.__webglTexture),ge(n.TEXTURE_2D,Te),fe(P.__webglFramebuffer,E,Te,n.COLOR_ATTACHMENT0+le,n.TEXTURE_2D,0),m(Te)&&p(n.TEXTURE_2D)}t.unbindTexture()}else{let le=n.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(le=E.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(le,X.__webglTexture),ge(le,v),v.mipmaps&&v.mipmaps.length>0)for(let ve=0;ve<v.mipmaps.length;ve++)fe(P.__webglFramebuffer[ve],E,v,n.COLOR_ATTACHMENT0,le,ve);else fe(P.__webglFramebuffer,E,v,n.COLOR_ATTACHMENT0,le,0);m(v)&&p(le),t.unbindTexture()}E.depthBuffer&&oe(E)}function xe(E){const v=E.textures;for(let P=0,X=v.length;P<X;P++){const V=v[P];if(m(V)){const Y=E.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ue=i.get(V).__webglTexture;t.bindTexture(Y,ue),p(Y),t.unbindTexture()}}}const te=[],g=[];function T(E){if(E.samples>0){if(F(E)===!1){const v=E.textures,P=E.width,X=E.height;let V=n.COLOR_BUFFER_BIT;const Y=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=i.get(E),le=v.length>1;if(le)for(let ve=0;ve<v.length;ve++)t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ue.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ue.__webglFramebuffer);for(let ve=0;ve<v.length;ve++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(V|=n.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(V|=n.STENCIL_BUFFER_BIT)),le){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ue.__webglColorRenderbuffer[ve]);const Te=i.get(v[ve]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Te,0)}n.blitFramebuffer(0,0,P,X,0,0,P,X,V,n.NEAREST),c===!0&&(te.length=0,g.length=0,te.push(n.COLOR_ATTACHMENT0+ve),E.depthBuffer&&E.resolveDepthBuffer===!1&&(te.push(Y),g.push(Y),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,g)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,te))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),le)for(let ve=0;ve<v.length;ve++){t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.RENDERBUFFER,ue.__webglColorRenderbuffer[ve]);const Te=i.get(v[ve]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ue.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ve,n.TEXTURE_2D,Te,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ue.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&c){const v=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function L(E){return Math.min(r.maxSamples,E.samples)}function F(E){const v=i.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function N(E){const v=o.render.frame;u.get(E)!==v&&(u.set(E,v),E.update())}function j(E,v){const P=E.colorSpace,X=E.format,V=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||P!==Pi&&P!==Ei&&(et.getTransfer(P)===lt?(X!==wn||V!==ii)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",P)),v}function ee(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(l.width=E.naturalWidth||E.width,l.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(l.width=E.displayWidth,l.height=E.displayHeight):(l.width=E.width,l.height=E.height),l}this.allocateTextureUnit=B,this.resetTextureUnits=b,this.setTexture2D=Z,this.setTexture2DArray=re,this.setTexture3D=W,this.setTextureCube=J,this.rebindTextures=K,this.setupRenderTarget=ce,this.updateRenderTargetMipmap=xe,this.updateMultisampleRenderTarget=T,this.setupDepthRenderbuffer=oe,this.setupFrameBufferTexture=fe,this.useMultisampledRTT=F}function ZS(n,e){function t(i,r=Ei){let s;const o=et.getTransfer(r);if(i===ii)return n.UNSIGNED_BYTE;if(i===Pl)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Ll)return n.UNSIGNED_SHORT_5_5_5_1;if(i===xd)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===_d)return n.BYTE;if(i===vd)return n.SHORT;if(i===ws)return n.UNSIGNED_SHORT;if(i===Cl)return n.INT;if(i===ji)return n.UNSIGNED_INT;if(i===Qn)return n.FLOAT;if(i===Is)return n.HALF_FLOAT;if(i===yd)return n.ALPHA;if(i===Md)return n.RGB;if(i===wn)return n.RGBA;if(i===Sd)return n.LUMINANCE;if(i===Ed)return n.LUMINANCE_ALPHA;if(i===Pr)return n.DEPTH_COMPONENT;if(i===Hr)return n.DEPTH_STENCIL;if(i===wd)return n.RED;if(i===Il)return n.RED_INTEGER;if(i===bd)return n.RG;if(i===Dl)return n.RG_INTEGER;if(i===Ul)return n.RGBA_INTEGER;if(i===vo||i===xo||i===yo||i===Mo)if(o===lt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===vo)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===xo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===yo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Mo)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===vo)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===xo)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===yo)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Mo)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Tc||i===Ac||i===Rc||i===Cc)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Tc)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Ac)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Rc)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Cc)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Pc||i===Lc||i===Ic)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Pc||i===Lc)return o===lt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Ic)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Dc||i===Uc||i===Nc||i===Fc||i===Oc||i===Bc||i===zc||i===Hc||i===Gc||i===kc||i===Vc||i===Wc||i===Xc||i===qc)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Dc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Uc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Nc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Fc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Oc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Bc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===zc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Hc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Gc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===kc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Vc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Wc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Xc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===qc)return o===lt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===So||i===Yc||i===$c)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===So)return o===lt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Yc)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===$c)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Td||i===Kc||i===jc||i===Zc)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===So)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Kc)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===jc)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Zc)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===zr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}class JS extends vt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class mt extends Bt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const QS={type:"move"};class Va{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new mt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new mt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new k,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new k),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new mt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new k,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new k),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,o=null;const a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){o=!0;for(const y of e.hand.values()){const m=t.getJointPose(y,i),p=this._getHandJoint(l,y);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const u=l.joints["index-finger-tip"],h=l.joints["thumb-tip"],f=u.position.distanceTo(h.position),d=.02,_=.005;l.inputState.pinching&&f>d+_?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&f<=d-_&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(QS)))}return a!==null&&(a.visible=r!==null),c!==null&&(c.visible=s!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new mt;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}const eE=`
void main() {
...
}`;class nE{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,i){if(this.texture===null){const r=new Kt,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!=i.depthNear||t.depthFar!=i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new ut({vertexShader:eE,fragmentShader:tE,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new G(new kr(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class iE extends Wr{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",c=1,l=null,u=null,h=null,f=null,d=null,_=null;const y=new nE,m=t.getContextAttributes();let p=null,w=null;const M=[],S=[],D=new be;let C=null;const A=new vt;A.layers.enable(1),A.viewport=new st;const I=new vt;I.layers.enable(2),I.viewport=new st;const ne=[A,I],x=new JS;x.layers.enable(1),x.layers.enable(2);let b=null,B=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let fe=M[Q];return fe===void 0&&(fe=new Va,M[Q]=fe),fe.getTargetRaySpace()},this.getControllerGrip=function(Q){let fe=M[Q];return fe===void 0&&(fe=new Va,M[Q]=fe),fe.getGripSpace()},this.getHand=function(Q){let fe=M[Q];return fe===void 0&&(fe=new Va,M[Q]=fe),fe.getHandSpace()};function H(Q){const fe=S.indexOf(Q.inputSource);if(fe===-1)return;const _e=M[fe];_e!==void 0&&(_e.update(Q.inputSource,Q.frame,l||o),_e.dispatchEvent({type:Q.type,data:Q.inputSource}))}function Z(){r.removeEventListener("select",H),r.removeEventListener("selectstart",H),r.removeEventListener("selectend",H),r.removeEventListener("squeeze",H),r.removeEventListener("squeezestart",H),r.removeEventListener("squeezeend",H),r.removeEventListener("end",Z),r.removeEventListener("inputsourceschange",re);for(let Q=0;Q<M.length;Q++){const fe=S[Q];fe!==null&&(S[Q]=null,M[Q].disconnect(fe))}b=null,B=null,y.reset(),e.setRenderTarget(p),d=null,f=null,h=null,r=null,w=null,Re.stop(),i.isPresenting=!1,e.setPixelRatio(C),e.setSize(D.width,D.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){s=Q,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){a=Q,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||o},this.setReferenceSpace=function(Q){l=Q},this.getBaseLayer=function(){return f!==null?f:d},this.getBinding=function(){return h},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(Q){if(r=Q,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",H),r.addEventListener("selectstart",H),r.addEventListener("selectend",H),r.addEventListener("squeeze",H),r.addEventListener("squeezestart",H),r.addEventListener("squeezeend",H),r.addEventListener("end",Z),r.addEventListener("inputsourceschange",re),m.xrCompatible!==!0&&await t.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(D),r.renderState.layers===void 0){const fe={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};d=new XRWebGLLayer(r,t,fe),r.updateRenderState({baseLayer:d}),e.setPixelRatio(1),e.setSize(d.framebufferWidth,d.framebufferHeight,!1),w=new Zi(d.framebufferWidth,d.framebufferHeight,{format:wn,type:ii,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}else{let fe=null,_e=null,U=null;m.depth&&(U=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,fe=m.stencil?Hr:Pr,_e=m.stencil?zr:ji);const oe={colorFormat:t.RGBA8,depthFormat:U,scaleFactor:s};h=new XRWebGLBinding(r,t),f=h.createProjectionLayer(oe),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),w=new Zi(f.textureWidth,f.textureHeight,{format:wn,type:ii,depthTexture:new Gd(f.textureWidth,f.textureHeight,_e,void 0,void 0,void 0,void 0,void 0,void 0,fe),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}w.isXRRenderTarget=!0,this.setFoveation(c),l=null,o=await r.requestReferenceSpace(a),Re.setContext(r),Re.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return y.getDepthTexture()};function re(Q){for(let fe=0;fe<Q.removed.length;fe++){const _e=Q.removed[fe],U=S.indexOf(_e);U>=0&&(S[U]=null,M[U].disconnect(_e))}for(let fe=0;fe<Q.added.length;fe++){const _e=Q.added[fe];let U=S.indexOf(_e);if(U===-1){for(let K=0;K<M.length;K++)if(K>=S.length){S.push(_e),U=K;break}else if(S[K]===null){S[K]=_e,U=K;break}if(U===-1)break}const oe=M[U];oe&&oe.connect(_e)}}const W=new k,J=new k;function O(Q,fe,_e){W.setFromMatrixPosition(fe.matrixWorld),J.setFromMatrixPosition(_e.matrixWorld);const U=W.distanceTo(J),oe=fe.projectionMatrix.elements,K=_e.projectionMatrix.elements,ce=oe[14]/(oe[10]-1),xe=oe[14]/(oe[10]+1),te=(oe[9]+1)/oe[5],g=(oe[9]-1)/oe[5],T=(oe[8]-1)/oe[0],L=(K[8]+1)/K[0],F=ce*T,N=ce*L,j=U/(-T+L),ee=j*-T;if(fe.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(ee),Q.translateZ(j),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert(),oe[10]===-1)Q.projectionMatrix.copy(fe.projectionMatrix),Q.projectionMatrixInverse.copy(fe.projectionMatrixInverse);else{const E=ce+j,v=xe+j,P=F-ee,X=N+(U-ee),V=te*xe/v*E,Y=g*xe/v*E;Q.projectionMatrix.makePerspective(P,X,V,Y,E,v),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}}function pe(Q,fe){fe===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(fe.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(r===null)return;let fe=Q.near,_e=Q.far;y.texture!==null&&(y.depthNear>0&&(fe=y.depthNear),y.depthFar>0&&(_e=y.depthFar)),x.near=I.near=A.near=fe,x.far=I.far=A.far=_e,(b!==x.near||B!==x.far)&&(r.updateRenderState({depthNear:x.near,depthFar:x.far}),b=x.near,B=x.far);const U=Q.parent,oe=x.cameras;pe(x,U);for(let K=0;K<oe.length;K++)pe(oe[K],U);oe.length===2?O(x,A,I):x.projectionMatrix.copy(A.projectionMatrix),de(Q,x,U)};function de(Q,fe,_e){_e===null?Q.matrix.copy(fe.matrixWorld):(Q.matrix.copy(_e.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(fe.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(fe.projectionMatrix),Q.projectionMatrixInverse.copy(fe.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=bs*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(f===null&&d===null))return c},this.setFoveation=function(Q){c=Q,f!==null&&(f.fixedFoveation=Q),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=Q)},this.hasDepthSensing=function(){return y.texture!==null},this.getDepthSensingMesh=function(){return y.getMesh(x)};let ge=null;function Se(Q,fe){if(u=fe.getViewerPose(l||o),_=fe,u!==null){const _e=u.views;d!==null&&(e.setRenderTargetFramebuffer(w,d.framebuffer),e.setRenderTarget(w));let U=!1;_e.length!==x.cameras.length&&(x.cameras.length=0,U=!0);for(let K=0;K<_e.length;K++){const ce=_e[K];let xe=null;if(d!==null)xe=d.getViewport(ce);else{const g=h.getViewSubImage(f,ce);xe=g.viewport,K===0&&(e.setRenderTargetTextures(w,g.colorTexture,f.ignoreDepthValues?void 0:g.depthStencilTexture),e.setRenderTarget(w))}let te=ne[K];te===void 0&&(te=new vt,te.layers.enable(K),te.viewport=new st,ne[K]=te),te.matrix.fromArray(ce.transform.matrix),te.matrix.decompose(te.position,te.quaternion,te.scale),te.projectionMatrix.fromArray(ce.projectionMatrix),te.projectionMatrixInverse.copy(te.projectionMatrix).invert(),te.viewport.set(xe.x,xe.y,xe.width,xe.height),K===0&&(x.matrix.copy(te.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),U===!0&&x.cameras.push(te)}const oe=r.enabledFeatures;if(oe&&oe.includes("depth-sensing")){const K=h.getDepthInformation(_e[0]);K&&K.isValid&&K.texture&&y.init(e,K,r.renderState)}}for(let _e=0;_e<M.length;_e++){const U=S[_e],oe=M[_e];U!==null&&oe!==void 0&&oe.update(U,fe,l||o)}ge&&ge(Q,fe),fe.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:fe}),_=null}const Re=new zd;Re.setAnimationLoop(Se),this.setAnimationLoop=function(Q){ge=Q},this.dispose=function(){}}}const zi=new Bn,rE=new ft;function sE(n,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,Fd(n)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function r(m,p,w,M,S){p.isMeshBasicMaterial||p.isMeshLambertMaterial?s(m,p):p.isMeshToonMaterial?(s(m,p),h(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p)):p.isMeshStandardMaterial?(s(m,p),f(m,p),p.isMeshPhysicalMaterial&&d(m,p,S)):p.isMeshMatcapMaterial?(s(m,p),_(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),y(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?c(m,p,w,M):p.isSpriteMaterial?l(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Xt&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Xt&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const w=e.get(p),M=w.envMap,S=w.envMapRotation;M&&(m.envMap.value=M,zi.copy(S),zi.x*=-1,zi.y*=-1,zi.z*=-1,M.isCubeTexture&&M.isRenderTargetTexture===!1&&(zi.y*=-1,zi.z*=-1),m.envMapRotation.value.setFromMatrix4(rE.makeRotationFromEuler(zi)),m.flipEnvMap.value=M.isCubeTexture&&M.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function c(m,p,w,M){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*w,m.scale.value=M*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function l(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function h(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function f(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function d(m,p,w){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Xt&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,p){p.matcap&&(m.matcap.value=p.matcap)}function y(m,p){const w=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function oE(n,e,t,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function c(w,M){const S=M.program;i.uniformBlockBinding(w,S)}function l(w,M){let S=r[w.id];S===void 0&&(_(w),S=u(w),r[w.id]=S,w.addEventListener("dispose",m));const D=M.program;i.updateUBOMapping(w,D);const C=e.render.frame;s[w.id]!==C&&(f(w),s[w.id]=C)}function u(w){const M=h();w.__bindingPointIndex=M;const S=n.createBuffer(),D=w.__size,C=w.usage;return n.bindBuffer(n.UNIFORM_BUFFER,S),n.bufferData(n.UNIFORM_BUFFER,D,C),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,M,S),S}function h(){for(let w=0;w<a;w++)if(o.indexOf(w)===-1)return o.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(w){const M=r[w.id],S=w.uniforms,D=w.__cache;n.bindBuffer(n.UNIFORM_BUFFER,M);for(let C=0,A=S.length;C<A;C++){const I=Array.isArray(S[C])?S[C]:[S[C]];for(let ne=0,x=I.length;ne<x;ne++){const b=I[ne];if(d(b,C,ne,D)===!0){const B=b.__offset,H=Array.isArray(b.value)?b.value:[b.value];let Z=0;for(let re=0;re<H.length;re++){const W=H[re],J=y(W);typeof W=="number"||typeof W=="boolean"?(b.__data[0]=W,n.bufferSubData(n.UNIFORM_BUFFER,B+Z,b.__data)):W.isMatrix3?(b.__data[0]=W.elements[0],b.__data[1]=W.elements[1],b.__data[2]=W.elements[2],b.__data[3]=0,b.__data[4]=W.elements[3],b.__data[5]=W.elements[4],b.__data[6]=W.elements[5],b.__data[7]=0,b.__data[8]=W.elements[6],b.__data[9]=W.elements[7],b.__data[10]=W.elements[8],b.__data[11]=0):(W.toArray(b.__data,Z),Z+=J.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,B,b.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function d(w,M,S,D){const C=w.value,A=M+"_"+S;if(D[A]===void 0)return typeof C=="number"||typeof C=="boolean"?D[A]=C:D[A]=C.clone(),!0;{const I=D[A];if(typeof C=="number"||typeof C=="boolean"){if(I!==C)return D[A]=C,!0}else if(I.equals(C)===!1)return I.copy(C),!0}return!1}function _(w){const M=w.uniforms;let S=0;const D=16;for(let A=0,I=M.length;A<I;A++){const ne=Array.isArray(M[A])?M[A]:[M[A]];for(let x=0,b=ne.length;x<b;x++){const B=ne[x],H=Array.isArray(B.value)?B.value:[B.value];for(let Z=0,re=H.length;Z<re;Z++){const W=H[Z],J=y(W),O=S%D,pe=O%J.boundary,de=O+pe;S+=pe,de!==0&&D-de<J.storage&&(S+=D-de),B.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=S,S+=J.storage}}}const C=S%D;return C>0&&(S+=D-C),w.__size=S,w.__cache={},this}function y(w){const M={boundary:0,storage:0};return typeof w=="number"||typeof w=="boolean"?(M.boundary=4,M.storage=4):w.isVector2?(M.boundary=8,M.storage=8):w.isVector3||w.isColor?(M.boundary=16,M.storage=12):w.isVector4?(M.boundary=16,M.storage=16):w.isMatrix3?(M.boundary=48,M.storage=48):w.isMatrix4?(M.boundary=64,M.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),M}function m(w){const M=w.target;M.removeEventListener("dispose",m);const S=o.indexOf(M.__bindingPointIndex);o.splice(S,1),n.deleteBuffer(r[M.id]),delete r[M.id],delete s[M.id]}function p(){for(const w in r)n.deleteBuffer(r[w]);o=[],r={},s={}}return{bind:c,update:l,dispose:p}}class oi{constructor(e={}){const{canvas:t=Y_(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1}=e;this.isWebGLRenderer=!0;let f;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=i.getContextAttributes().alpha}else f=o;const d=new Uint32Array(4),_=new Int32Array(4);let y=null,m=null;const p=[],w=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=In,this.toneMapping=bi,this.toneMappingExposure=1;const M=this;let S=!1,D=0,C=0,A=null,I=-1,ne=null;const x=new st,b=new st;let B=null;const H=new Ge(0);let Z=0,re=t.width,W=t.height,J=1,O=null,pe=null;const de=new st(0,0,re,W),ge=new st(0,0,re,W);let Se=!1;const Re=new Bl;let Q=!1,fe=!1;const _e=new ft,U=new ft,oe=new k,K=new st,ce={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let xe=!1;function te(){return A===null?J:1}let g=i;function T(R,q){return t.getContext(R,q)}try{const R={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Rl}`),t.addEventListener("webglcontextlost",me,!1),t.addEventListener("webglcontextrestored",Le,!1),t.addEventListener("webglcontextcreationerror",Ue,!1),g===null){const q="webgl2";if(g=T(q,R),g===null)throw T(q)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(R){throw console.error("THREE.WebGLRenderer: "+R.message),R}let L,F,N,j,ee,E,v,P,X,V,Y,ue,le,ve,Te,he,ye,Ne,De,Ae,Be,Ce,We,z;function Pe(){L=new fM(g),L.init(),Ce=new ZS(g,L),F=new oM(g,L,e,Ce),N=new $S(g),F.reverseDepthBuffer&&N.buffers.depth.setReversed(!0),j=new mM(g),ee=new DS,E=new jS(g,L,N,ee,F,Ce,j),v=new cM(M),P=new hM(M),X=new Sv(g),We=new rM(g,X),V=new dM(g,X,j,We),Y=new _M(g,V,X,j),De=new gM(g,F,E),he=new aM(ee),ue=new IS(M,v,P,L,F,We,he),le=new sE(M,ee),ve=new NS,Te=new GS(L),Ne=new iM(M,v,P,N,Y,f,c),ye=new qS(M,Y,F),z=new oE(g,j,F,N),Ae=new sM(g,L,j),Be=new pM(g,L,j),j.programs=ue.programs,M.capabilities=F,M.extensions=L,M.properties=ee,M.renderLists=ve,M.shadowMap=ye,M.state=N,M.info=j}Pe();const ae=new iE(M,g);this.xr=ae,this.getContext=function(){return g},this.getContextAttributes=function(){return g.getContextAttributes()},this.forceContextLoss=function(){const R=L.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){const R=L.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return J},this.setPixelRatio=function(R){R!==void 0&&(J=R,this.setSize(re,W,!1))},this.getSize=function(R){return R.set(re,W)},this.setSize=function(R,q,ie=!0){if(ae.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}re=R,W=q,t.width=Math.floor(R*J),t.height=Math.floor(q*J),ie===!0&&(t.style.width=R+"px",t.style.height=q+"px"),this.setViewport(0,0,R,q)},this.getDrawingBufferSize=function(R){return R.set(re*J,W*J).floor()},this.setDrawingBufferSize=function(R,q,ie){re=R,W=q,J=ie,t.width=Math.floor(R*ie),t.height=Math.floor(q*ie),this.setViewport(0,0,R,q)},this.getCurrentViewport=function(R){return R.copy(x)},this.getViewport=function(R){return R.copy(de)},this.setViewport=function(R,q,ie,se){R.isVector4?de.set(R.x,R.y,R.z,R.w):de.set(R,q,ie,se),N.viewport(x.copy(de).multiplyScalar(J).round())},this.getScissor=function(R){return R.copy(ge)},this.setScissor=function(R,q,ie,se){R.isVector4?ge.set(R.x,R.y,R.z,R.w):ge.set(R,q,ie,se),N.scissor(b.copy(ge).multiplyScalar(J).round())},this.getScissorTest=function(){return Se},this.setScissorTest=function(R){N.setScissorTest(Se=R)},this.setOpaqueSort=function(R){O=R},this.setTransparentSort=function(R){pe=R},this.getClearColor=function(R){return R.copy(Ne.getClearColor())},this.setClearColor=function(){Ne.setClearColor.apply(Ne,arguments)},this.getClearAlpha=function(){return Ne.getClearAlpha()},this.setClearAlpha=function(){Ne.setClearAlpha.apply(Ne,arguments)},this.clear=function(R=!0,q=!0,ie=!0){let se=0;if(R){let $=!1;if(A!==null){const Me=A.texture.format;$=Me===Ul||Me===Dl||Me===Il}if($){const Me=A.texture.type,Ie=Me===ii||Me===ji||Me===ws||Me===zr||Me===Pl||Me===Ll,Fe=Ne.getClearColor(),Oe=Ne.getClearAlpha(),ke=Fe.r,Ve=Fe.g,ze=Fe.b;Ie?(d[0]=ke,d[1]=Ve,d[2]=ze,d[3]=Oe,g.clearBufferuiv(g.COLOR,0,d)):(_[0]=ke,_[1]=Ve,_[2]=ze,_[3]=Oe,g.clearBufferiv(g.COLOR,0,_))}else se|=g.COLOR_BUFFER_BIT}q&&(se|=g.DEPTH_BUFFER_BIT,g.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),ie&&(se|=g.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),g.clear(se)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",me,!1),t.removeEventListener("webglcontextrestored",Le,!1),t.removeEventListener("webglcontextcreationerror",Ue,!1),ve.dispose(),Te.dispose(),ee.dispose(),v.dispose(),P.dispose(),Y.dispose(),We.dispose(),z.dispose(),ue.dispose(),ae.dispose(),ae.removeEventListener("sessionstart",Xl),ae.removeEventListener("sessionend",ql),Li.stop()};function me(R){R.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),S=!0}function Le(){console.log("THREE.WebGLRenderer: Context Restored."),S=!1;const R=j.autoReset,q=ye.enabled,ie=ye.autoUpdate,se=ye.needsUpdate,$=ye.type;Pe(),j.autoReset=R,ye.enabled=q,ye.autoUpdate=ie,ye.needsUpdate=se,ye.type=$}function Ue(R){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function Ke(R){const q=R.target;q.removeEventListener("dispose",Ke),yt(q)}function yt(R){Yt(R),ee.remove(R)}function Yt(R){const q=ee.get(R).programs;q!==void 0&&(q.forEach(function(ie){ue.releaseProgram(ie)}),R.isShaderMaterial&&ue.releaseShaderCache(R))}this.renderBufferDirect=function(R,q,ie,se,$,Me){q===null&&(q=ce);const Ie=$.isMesh&&$.matrixWorld.determinant()<0,Fe=up(R,q,ie,se,$);N.setMaterial(se,Ie);let Oe=ie.index,ke=1;if(se.wireframe===!0){if(Oe=V.getWireframeAttribute(ie),Oe===void 0)return;ke=2}const Ve=ie.drawRange,ze=ie.attributes.position;let it=Ve.start*ke,ct=(Ve.start+Ve.count)*ke;Me!==null&&(it=Math.max(it,Me.start*ke),ct=Math.min(ct,(Me.start+Me.count)*ke)),Oe!==null?(it=Math.max(it,0),ct=Math.min(ct,Oe.count)):ze!=null&&(it=Math.max(it,0),ct=Math.min(ct,ze.count));const gt=ct-it;if(gt<0||gt===1/0)return;We.setup($,se,Fe,ie,Oe);let Jt,Ze=Ae;if(Oe!==null&&(Jt=X.get(Oe),Ze=Be,Ze.setIndex(Jt)),$.isMesh)se.wireframe===!0?(N.setLineWidth(se.wireframeLinewidth*te()),Ze.setMode(g.LINES)):Ze.setMode(g.TRIANGLES);else if($.isLine){let He=se.linewidth;He===void 0&&(He=1),N.setLineWidth(He*te()),$.isLineSegments?Ze.setMode(g.LINES):$.isLineLoop?Ze.setMode(g.LINE_LOOP):Ze.setMode(g.LINE_STRIP)}else $.isPoints?Ze.setMode(g.POINTS):$.isSprite&&Ze.setMode(g.TRIANGLES);if($.isBatchedMesh)if($._multiDrawInstances!==null)Ze.renderMultiDrawInstances($._multiDrawStarts,$._multiDrawCounts,$._multiDrawCount,$._multiDrawInstances);else if(L.get("WEBGL_multi_draw"))Ze.renderMultiDraw($._multiDrawStarts,$._multiDrawCounts,$._multiDrawCount);else{const He=$._multiDrawStarts,Pt=$._multiDrawCounts,Je=$._multiDrawCount,_n=Oe?X.get(Oe).bytesPerElement:1,rr=ee.get(se).currentProgram.getUniforms();for(let Qt=0;Qt<Je;Qt++)rr.setValue(g,"_gl_DrawID",Qt),Ze.render(He[Qt]/_n,Pt[Qt])}else if($.isInstancedMesh)Ze.renderInstances(it,gt,$.count);else if(ie.isInstancedBufferGeometry){const He=ie._maxInstanceCount!==void 0?ie._maxInstanceCount:1/0,Pt=Math.min(ie.instanceCount,He);Ze.renderInstances(it,gt,Pt)}else Ze.render(it,gt)};function je(R,q,ie){R.transparent===!0&&R.side===Jn&&R.forceSinglePass===!1?(R.side=Xt,R.needsUpdate=!0,Os(R,q,ie),R.side=Ai,R.needsUpdate=!0,Os(R,q,ie),R.side=Jn):Os(R,q,ie)}this.compile=function(R,q,ie=null){ie===null&&(ie=R),m=Te.get(ie),m.init(q),w.push(m),ie.traverseVisible(function($){$.isLight&&$.layers.test(q.layers)&&(m.pushLight($),$.castShadow&&m.pushShadow($))}),R!==ie&&R.traverseVisible(function($){$.isLight&&$.layers.test(q.layers)&&(m.pushLight($),$.castShadow&&m.pushShadow($))}),m.setupLights();const se=new Set;return R.traverse(function($){if(!($.isMesh||$.isPoints||$.isLine||$.isSprite))return;const Me=$.material;if(Me)if(Array.isArray(Me))for(let Ie=0;Ie<Me.length;Ie++){const Fe=Me[Ie];je(Fe,ie,$),se.add(Fe)}else je(Me,ie,$),se.add(Me)}),w.pop(),m=null,se},this.compileAsync=function(R,q,ie=null){const se=this.compile(R,q,ie);return new Promise($=>{function Me(){if(se.forEach(function(Ie){ee.get(Ie).currentProgram.isReady()&&se.delete(Ie)}),se.size===0){$(R);return}setTimeout(Me,10)}L.get("KHR_parallel_shader_compile")!==null?Me():setTimeout(Me,10)})};let $t=null;function Hn(R){$t&&$t(R)}function Xl(){Li.stop()}function ql(){Li.start()}const Li=new zd;Li.setAnimationLoop(Hn),typeof self<"u"&&Li.setContext(self),this.setAnimationLoop=function(R){$t=R,ae.setAnimationLoop(R),R===null?Li.stop():Li.start()},ae.addEventListener("sessionstart",Xl),ae.addEventListener("sessionend",ql),this.render=function(R,q){if(q!==void 0&&q.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;if(R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),q.parent===null&&q.matrixWorldAutoUpdate===!0&&q.updateMatrixWorld(),ae.enabled===!0&&ae.isPresenting===!0&&(ae.cameraAutoUpdate===!0&&ae.updateCamera(q),q=ae.getCamera()),R.isScene===!0&&R.onBeforeRender(M,R,q,A),m=Te.get(R,w.length),m.init(q),w.push(m),U.multiplyMatrices(q.projectionMatrix,q.matrixWorldInverse),Re.setFromProjectionMatrix(U),fe=this.localClippingEnabled,Q=he.init(this.clippingPlanes,fe),y=ve.get(R,p.length),y.init(),p.push(y),ae.enabled===!0&&ae.isPresenting===!0){const Me=M.xr.getDepthSensingMesh();Me!==null&&Zo(Me,q,-1/0,M.sortObjects)}Zo(R,q,0,M.sortObjects),y.finish(),M.sortObjects===!0&&y.sort(O,pe),xe=ae.enabled===!1||ae.isPresenting===!1||ae.hasDepthSensing()===!1,xe&&Ne.addToRenderList(y,R),this.info.render.frame++,Q===!0&&he.beginShadows();const ie=m.state.shadowsArray;ye.render(ie,R,q),Q===!0&&he.endShadows(),this.info.autoReset===!0&&this.info.reset();const se=y.opaque,$=y.transmissive;if(m.setupLights(),q.isArrayCamera){const Me=q.cameras;if($.length>0)for(let Ie=0,Fe=Me.length;Ie<Fe;Ie++){const Oe=Me[Ie];$l(se,$,R,Oe)}xe&&Ne.render(R);for(let Ie=0,Fe=Me.length;Ie<Fe;Ie++){const Oe=Me[Ie];Yl(y,R,Oe,Oe.viewport)}}else $.length>0&&$l(se,$,R,q),xe&&Ne.render(R),Yl(y,R,q);A!==null&&(E.updateMultisampleRenderTarget(A),E.updateRenderTargetMipmap(A)),R.isScene===!0&&R.onAfterRender(M,R,q),We.resetDefaultState(),I=-1,ne=null,w.pop(),w.length>0?(m=w[w.length-1],Q===!0&&he.setGlobalState(M.clippingPlanes,m.state.camera)):m=null,p.pop(),p.length>0?y=p[p.length-1]:y=null};function Zo(R,q,ie,se){if(R.visible===!1)return;if(R.layers.test(q.layers)){if(R.isGroup)ie=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update(q);else if(R.isLight)m.pushLight(R),R.castShadow&&m.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||Re.intersectsSprite(R)){se&&K.setFromMatrixPosition(R.matrixWorld).applyMatrix4(U);const Ie=Y.update(R),Fe=R.material;Fe.visible&&y.push(R,Ie,Fe,ie,K.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||Re.intersectsObject(R))){const Ie=Y.update(R),Fe=R.material;if(se&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),K.copy(R.boundingSphere.center)):(Ie.boundingSphere===null&&Ie.computeBoundingSphere(),K.copy(Ie.boundingSphere.center)),K.applyMatrix4(R.matrixWorld).applyMatrix4(U)),Array.isArray(Fe)){const Oe=Ie.groups;for(let ke=0,Ve=Oe.length;ke<Ve;ke++){const ze=Oe[ke],it=Fe[ze.materialIndex];it&&it.visible&&y.push(R,Ie,it,ie,K.z,ze)}}else Fe.visible&&y.push(R,Ie,Fe,ie,K.z,null)}}const Me=R.children;for(let Ie=0,Fe=Me.length;Ie<Fe;Ie++)Zo(Me[Ie],q,ie,se)}function Yl(R,q,ie,se){const $=R.opaque,Me=R.transmissive,Ie=R.transparent;m.setupLightsView(ie),Q===!0&&he.setGlobalState(M.clippingPlanes,ie),se&&N.viewport(x.copy(se)),$.length>0&&Fs($,q,ie),Me.length>0&&Fs(Me,q,ie),Ie.length>0&&Fs(Ie,q,ie),N.buffers.depth.setTest(!0),N.buffers.depth.setMask(!0),N.buffers.color.setMask(!0),N.setPolygonOffset(!1)}function $l(R,q,ie,se){if((ie.isScene===!0?ie.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[se.id]===void 0&&(m.state.transmissionRenderTarget[se.id]=new Zi(1,1,{generateMipmaps:!0,type:L.has("EXT_color_buffer_half_float")||L.has("EXT_color_buffer_float")?Is:ii,minFilter:qi,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:et.workingColorSpace}));const Me=m.state.transmissionRenderTarget[se.id],Ie=se.viewport||x;Me.setSize(Ie.z,Ie.w);const Fe=M.getRenderTarget();M.setRenderTarget(Me),M.getClearColor(H),Z=M.getClearAlpha(),Z<1&&M.setClearColor(16777215,.5),M.clear(),xe&&Ne.render(ie);const Oe=M.toneMapping;M.toneMapping=bi;const ke=se.viewport;if(se.viewport!==void 0&&(se.viewport=void 0),m.setupLightsView(se),Q===!0&&he.setGlobalState(M.clippingPlanes,se),Fs(R,ie,se),E.updateMultisampleRenderTarget(Me),E.updateRenderTargetMipmap(Me),L.has("WEBGL_multisampled_render_to_texture")===!1){let Ve=!1;for(let ze=0,it=q.length;ze<it;ze++){const ct=q[ze],gt=ct.object,Jt=ct.geometry,Ze=ct.material,He=ct.group;if(Ze.side===Jn&&gt.layers.test(se.layers)){const Pt=Ze.side;Ze.side=Xt,Ze.needsUpdate=!0,Kl(gt,ie,se,Jt,Ze,He),Ze.side=Pt,Ze.needsUpdate=!0,Ve=!0}}Ve===!0&&(E.updateMultisampleRenderTarget(Me),E.updateRenderTargetMipmap(Me))}M.setRenderTarget(Fe),M.setClearColor(H,Z),ke!==void 0&&(se.viewport=ke),M.toneMapping=Oe}function Fs(R,q,ie){const se=q.isScene===!0?q.overrideMaterial:null;for(let $=0,Me=R.length;$<Me;$++){const Ie=R[$],Fe=Ie.object,Oe=Ie.geometry,ke=se===null?Ie.material:se,Ve=Ie.group;Fe.layers.test(ie.layers)&&Kl(Fe,q,ie,Oe,ke,Ve)}}function Kl(R,q,ie,se,$,Me){R.onBeforeRender(M,q,ie,se,$,Me),R.modelViewMatrix.multiplyMatrices(ie.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),$.onBeforeRender(M,q,ie,se,R,Me),$.transparent===!0&&$.side===Jn&&$.forceSinglePass===!1?($.side=Xt,$.needsUpdate=!0,M.renderBufferDirect(ie,q,se,$,R,Me),$.side=Ai,$.needsUpdate=!0,M.renderBufferDirect(ie,q,se,$,R,Me),$.side=Jn):M.renderBufferDirect(ie,q,se,$,R,Me),R.onAfterRender(M,q,ie,se,$,Me)}function Os(R,q,ie){q.isScene!==!0&&(q=ce);const se=ee.get(R),$=m.state.lights,Me=m.state.shadowsArray,Ie=$.state.version,Fe=ue.getParameters(R,$.state,Me,q,ie),Oe=ue.getProgramCacheKey(Fe);let ke=se.programs;se.environment=R.isMeshStandardMaterial?q.environment:null,se.fog=q.fog,se.envMap=(R.isMeshStandardMaterial?P:v).get(R.envMap||se.environment),se.envMapRotation=se.environment!==null&&R.envMap===null?q.environmentRotation:R.envMapRotation,ke===void 0&&(R.addEventListener("dispose",Ke),ke=new Map,se.programs=ke);let Ve=ke.get(Oe);if(Ve!==void 0){if(se.currentProgram===Ve&&se.lightsStateVersion===Ie)return Zl(R,Fe),Ve}else Fe.uniforms=ue.getUniforms(R),R.onBeforeCompile(Fe,M),Ve=ue.acquireProgram(Fe,Oe),ke.set(Oe,Ve),se.uniforms=Fe.uniforms;const ze=se.uniforms;return(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&(ze.clippingPlanes=he.uniform),Zl(R,Fe),se.needsLights=fp(R),se.lightsStateVersion=Ie,se.needsLights&&(ze.ambientLightColor.value=$.state.ambient,ze.lightProbe.value=$.state.probe,ze.directionalLights.value=$.state.directional,ze.directionalLightShadows.value=$.state.directionalShadow,ze.spotLights.value=$.state.spot,ze.spotLightShadows.value=$.state.spotShadow,ze.rectAreaLights.value=$.state.rectArea,ze.ltc_1.value=$.state.rectAreaLTC1,ze.ltc_2.value=$.state.rectAreaLTC2,ze.pointLights.value=$.state.point,ze.pointLightShadows.value=$.state.pointShadow,ze.hemisphereLights.value=$.state.hemi,ze.directionalShadowMap.value=$.state.directionalShadowMap,ze.directionalShadowMatrix.value=$.state.directionalShadowMatrix,ze.spotShadowMap.value=$.state.spotShadowMap,ze.spotLightMatrix.value=$.state.spotLightMatrix,ze.spotLightMap.value=$.state.spotLightMap,ze.pointShadowMap.value=$.state.pointShadowMap,ze.pointShadowMatrix.value=$.state.pointShadowMatrix),se.currentProgram=Ve,se.uniformsList=null,Ve}function jl(R){if(R.uniformsList===null){const q=R.currentProgram.getUniforms();R.uniformsList=wo.seqWithValue(q.seq,R.uniforms)}return R.uniformsList}function Zl(R,q){const ie=ee.get(R);ie.outputColorSpace=q.outputColorSpace,ie.batching=q.batching,ie.batchingColor=q.batchingColor,ie.instancing=q.instancing,ie.instancingColor=q.instancingColor,ie.instancingMorph=q.instancingMorph,ie.skinning=q.skinning,ie.morphTargets=q.morphTargets,ie.morphNormals=q.morphNormals,ie.morphColors=q.morphColors,ie.morphTargetsCount=q.morphTargetsCount,ie.numClippingPlanes=q.numClippingPlanes,ie.numIntersection=q.numClipIntersection,ie.vertexAlphas=q.vertexAlphas,ie.vertexTangents=q.vertexTangents,ie.toneMapping=q.toneMapping}function up(R,q,ie,se,$){q.isScene!==!0&&(q=ce),E.resetTextureUnits();const Me=q.fog,Ie=se.isMeshStandardMaterial?q.environment:null,Fe=A===null?M.outputColorSpace:A.isXRRenderTarget===!0?A.texture.colorSpace:Pi,Oe=(se.isMeshStandardMaterial?P:v).get(se.envMap||Ie),ke=se.vertexColors===!0&&!!ie.attributes.color&&ie.attributes.color.itemSize===4,Ve=!!ie.attributes.tangent&&(!!se.normalMap||se.anisotropy>0),ze=!!ie.morphAttributes.position,it=!!ie.morphAttributes.normal,ct=!!ie.morphAttributes.color;let gt=bi;se.toneMapped&&(A===null||A.isXRRenderTarget===!0)&&(gt=M.toneMapping);const Jt=ie.morphAttributes.position||ie.morphAttributes.normal||ie.morphAttributes.color,Ze=Jt!==void 0?Jt.length:0,He=ee.get(se),Pt=m.state.lights;if(Q===!0&&(fe===!0||R!==ne)){const ln=R===ne&&se.id===I;he.setState(se,R,ln)}let Je=!1;se.version===He.__version?(He.needsLights&&He.lightsStateVersion!==Pt.state.version||He.outputColorSpace!==Fe||$.isBatchedMesh&&He.batching===!1||!$.isBatchedMesh&&He.batching===!0||$.isBatchedMesh&&He.batchingColor===!0&&$.colorTexture===null||$.isBatchedMesh&&He.batchingColor===!1&&$.colorTexture!==null||$.isInstancedMesh&&He.instancing===!1||!$.isInstancedMesh&&He.instancing===!0||$.isSkinnedMesh&&He.skinning===!1||!$.isSkinnedMesh&&He.skinning===!0||$.isInstancedMesh&&He.instancingColor===!0&&$.instanceColor===null||$.isInstancedMesh&&He.instancingColor===!1&&$.instanceColor!==null||$.isInstancedMesh&&He.instancingMorph===!0&&$.morphTexture===null||$.isInstancedMesh&&He.instancingMorph===!1&&$.morphTexture!==null||He.envMap!==Oe||se.fog===!0&&He.fog!==Me||He.numClippingPlanes!==void 0&&(He.numClippingPlanes!==he.numPlanes||He.numIntersection!==he.numIntersection)||He.vertexAlphas!==ke||He.vertexTangents!==Ve||He.morphTargets!==ze||He.morphNormals!==it||He.morphColors!==ct||He.toneMapping!==gt||He.morphTargetsCount!==Ze)&&(Je=!0):(Je=!0,He.__version=se.version);let _n=He.currentProgram;Je===!0&&(_n=Os(se,q,$));let rr=!1,Qt=!1,Jo=!1;const _t=_n.getUniforms(),ui=He.uniforms;if(N.useProgram(_n.program)&&(rr=!0,Qt=!0,Jo=!0),se.id!==I&&(I=se.id,Qt=!0),rr||ne!==R){F.reverseDepthBuffer?(_e.copy(R.projectionMatrix),K_(_e),j_(_e),_t.setValue(g,"projectionMatrix",_e)):_t.setValue(g,"projectionMatrix",R.projectionMatrix),_t.setValue(g,"viewMatrix",R.matrixWorldInverse);const ln=_t.map.cameraPosition;ln!==void 0&&ln.setValue(g,oe.setFromMatrixPosition(R.matrixWorld)),F.logarithmicDepthBuffer&&_t.setValue(g,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),(se.isMeshPhongMaterial||se.isMeshToonMaterial||se.isMeshLambertMaterial||se.isMeshBasicMaterial||se.isMeshStandardMaterial||se.isShaderMaterial)&&_t.setValue(g,"isOrthographic",R.isOrthographicCamera===!0),ne!==R&&(ne=R,Qt=!0,Jo=!0)}if($.isSkinnedMesh){_t.setOptional(g,$,"bindMatrix"),_t.setOptional(g,$,"bindMatrixInverse");const ln=$.skeleton;ln&&(ln.boneTexture===null&&ln.computeBoneTexture(),_t.setValue(g,"boneTexture",ln.boneTexture,E))}$.isBatchedMesh&&(_t.setOptional(g,$,"batchingTexture"),_t.setValue(g,"batchingTexture",$._matricesTexture,E),_t.setOptional(g,$,"batchingIdTexture"),_t.setValue(g,"batchingIdTexture",$._indirectTexture,E),_t.setOptional(g,$,"batchingColorTexture"),$._colorsTexture!==null&&_t.setValue(g,"batchingColorTexture",$._colorsTexture,E));const Qo=ie.morphAttributes;if((Qo.position!==void 0||Qo.normal!==void 0||Qo.color!==void 0)&&De.update($,ie,_n),(Qt||He.receiveShadow!==$.receiveShadow)&&(He.receiveShadow=$.receiveShadow,_t.setValue(g,"receiveShadow",$.receiveShadow)),se.isMeshGouraudMaterial&&se.envMap!==null&&(ui.envMap.value=Oe,ui.flipEnvMap.value=Oe.isCubeTexture&&Oe.isRenderTargetTexture===!1?-1:1),se.isMeshStandardMaterial&&se.envMap===null&&q.environment!==null&&(ui.envMapIntensity.value=q.environmentIntensity),Qt&&(_t.setValue(g,"toneMappingExposure",M.toneMappingExposure),He.needsLights&&hp(ui,Jo),Me&&se.fog===!0&&le.refreshFogUniforms(ui,Me),le.refreshMaterialUniforms(ui,se,J,W,m.state.transmissionRenderTarget[R.id]),wo.upload(g,jl(He),ui,E)),se.isShaderMaterial&&se.uniformsNeedUpdate===!0&&(wo.upload(g,jl(He),ui,E),se.uniformsNeedUpdate=!1),se.isSpriteMaterial&&_t.setValue(g,"center",$.center),_t.setValue(g,"modelViewMatrix",$.modelViewMatrix),_t.setValue(g,"normalMatrix",$.normalMatrix),_t.setValue(g,"modelMatrix",$.matrixWorld),se.isShaderMaterial||se.isRawShaderMaterial){const ln=se.uniformsGroups;for(let ea=0,dp=ln.length;ea<dp;ea++){const Jl=ln[ea];z.update(Jl,_n),z.bind(Jl,_n)}}return _n}function hp(R,q){R.ambientLightColor.needsUpdate=q,R.lightProbe.needsUpdate=q,R.directionalLights.needsUpdate=q,R.directionalLightShadows.needsUpdate=q,R.pointLights.needsUpdate=q,R.pointLightShadows.needsUpdate=q,R.spotLights.needsUpdate=q,R.spotLightShadows.needsUpdate=q,R.rectAreaLights.needsUpdate=q,R.hemisphereLights.needsUpdate=q}function fp(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return D},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return A},this.setRenderTargetTextures=function(R,q,ie){ee.get(R.texture).__webglTexture=q,ee.get(R.depthTexture).__webglTexture=ie;const se=ee.get(R);se.__hasExternalTextures=!0,se.__autoAllocateDepthBuffer=ie===void 0,se.__autoAllocateDepthBuffer||L.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),se.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(R,q){const ie=ee.get(R);ie.__webglFramebuffer=q,ie.__useDefaultFramebuffer=q===void 0},this.setRenderTarget=function(R,q=0,ie=0){A=R,D=q,C=ie;let se=!0,$=null,Me=!1,Ie=!1;if(R){const Oe=ee.get(R);if(Oe.__useDefaultFramebuffer!==void 0)N.bindFramebuffer(g.FRAMEBUFFER,null),se=!1;else if(Oe.__webglFramebuffer===void 0)E.setupRenderTarget(R);else if(Oe.__hasExternalTextures)E.rebindTextures(R,ee.get(R.texture).__webglTexture,ee.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){const ze=R.depthTexture;if(Oe.__boundDepthTexture!==ze){if(ze!==null&&ee.has(ze)&&(R.width!==ze.image.width||R.height!==ze.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");E.setupDepthRenderbuffer(R)}}const ke=R.texture;(ke.isData3DTexture||ke.isDataArrayTexture||ke.isCompressedArrayTexture)&&(Ie=!0);const Ve=ee.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray(Ve[q])?$=Ve[q][ie]:$=Ve[q],Me=!0):R.samples>0&&E.useMultisampledRTT(R)===!1?$=ee.get(R).__webglMultisampledFramebuffer:Array.isArray(Ve)?$=Ve[ie]:$=Ve,x.copy(R.viewport),b.copy(R.scissor),B=R.scissorTest}else x.copy(de).multiplyScalar(J).floor(),b.copy(ge).multiplyScalar(J).floor(),B=Se;if(N.bindFramebuffer(g.FRAMEBUFFER,$)&&se&&N.drawBuffers(R,$),N.viewport(x),N.scissor(b),N.setScissorTest(B),Me){const Oe=ee.get(R.texture);g.framebufferTexture2D(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,g.TEXTURE_CUBE_MAP_POSITIVE_X+q,Oe.__webglTexture,ie)}else if(Ie){const Oe=ee.get(R.texture),ke=q||0;g.framebufferTextureLayer(g.FRAMEBUFFER,g.COLOR_ATTACHMENT0,Oe.__webglTexture,ie||0,ke)}I=-1},this.readRenderTargetPixels=function(R,q,ie,se,$,Me,Ie){if(!(R&&R.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Fe=ee.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Ie!==void 0&&(Fe=Fe[Ie]),Fe){N.bindFramebuffer(g.FRAMEBUFFER,Fe);try{const Oe=R.texture,ke=Oe.format,Ve=Oe.type;if(!F.textureFormatReadable(ke)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!F.textureTypeReadable(Ve)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}q>=0&&q<=R.width-se&&ie>=0&&ie<=R.height-$&&g.readPixels(q,ie,se,$,Ce.convert(ke),Ce.convert(Ve),Me)}finally{const Oe=A!==null?ee.get(A).__webglFramebuffer:null;N.bindFramebuffer(g.FRAMEBUFFER,Oe)}}},this.readRenderTargetPixelsAsync=async function(R,q,ie,se,$,Me,Ie){if(!(R&&R.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Fe=ee.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Ie!==void 0&&(Fe=Fe[Ie]),Fe){const Oe=R.texture,ke=Oe.format,Ve=Oe.type;if(!F.textureFormatReadable(ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!F.textureTypeReadable(Ve))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(q>=0&&q<=R.width-se&&ie>=0&&ie<=R.height-$){N.bindFramebuffer(g.FRAMEBUFFER,Fe);const ze=g.createBuffer();g.bindBuffer(g.PIXEL_PACK_BUFFER,ze),g.bufferData(g.PIXEL_PACK_BUFFER,Me.byteLength,g.STREAM_READ),g.readPixels(q,ie,se,$,Ce.convert(ke),Ce.convert(Ve),0);const it=A!==null?ee.get(A).__webglFramebuffer:null;N.bindFramebuffer(g.FRAMEBUFFER,it);const ct=g.fenceSync(g.SYNC_GPU_COMMANDS_COMPLETE,0);return g.flush(),await $_(g,ct,4),g.bindBuffer(g.PIXEL_PACK_BUFFER,ze),g.getBufferSubData(g.PIXEL_PACK_BUFFER,0,Me),g.deleteBuffer(ze),g.deleteSync(ct),Me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(R,q=null,ie=0){R.isTexture!==!0&&(Eo("WebGLRenderer: copyFramebufferToTexture function signature has changed."),q=arguments[0]||null,R=arguments[1]);const se=Math.pow(2,-ie),$=Math.floor(R.image.width*se),Me=Math.floor(R.image.height*se),Ie=q!==null?q.x:0,Fe=q!==null?q.y:0;E.setTexture2D(R,0),g.copyTexSubImage2D(g.TEXTURE_2D,ie,0,0,Ie,Fe,$,Me),N.unbindTexture()},this.copyTextureToTexture=function(R,q,ie=null,se=null,$=0){R.isTexture!==!0&&(Eo("WebGLRenderer: copyTextureToTexture function signature has changed."),se=arguments[0]||null,R=arguments[1],q=arguments[2],$=arguments[3]||0,ie=null);let Me,Ie,Fe,Oe,ke,Ve;ie!==null?(Me=ie.max.x-ie.min.x,Ie=ie.max.y-ie.min.y,Fe=ie.min.x,Oe=ie.min.y):(Me=R.image.width,Ie=R.image.height,Fe=0,Oe=0),se!==null?(ke=se.x,Ve=se.y):(ke=0,Ve=0);const ze=Ce.convert(q.format),it=Ce.convert(q.type);E.setTexture2D(q,0),g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,q.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,q.unpackAlignment);const ct=g.getParameter(g.UNPACK_ROW_LENGTH),gt=g.getParameter(g.UNPACK_IMAGE_HEIGHT),Jt=g.getParameter(g.UNPACK_SKIP_PIXELS),Ze=g.getParameter(g.UNPACK_SKIP_ROWS),He=g.getParameter(g.UNPACK_SKIP_IMAGES),Pt=R.isCompressedTexture?R.mipmaps[$]:R.image;g.pixelStorei(g.UNPACK_ROW_LENGTH,Pt.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,Pt.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Fe),g.pixelStorei(g.UNPACK_SKIP_ROWS,Oe),R.isDataTexture?g.texSubImage2D(g.TEXTURE_2D,$,ke,Ve,Me,Ie,ze,it,Pt.data):R.isCompressedTexture?g.compressedTexSubImage2D(g.TEXTURE_2D,$,ke,Ve,Pt.width,Pt.height,ze,Pt.data):g.texSubImage2D(g.TEXTURE_2D,$,ke,Ve,Me,Ie,ze,it,Pt),g.pixelStorei(g.UNPACK_ROW_LENGTH,ct),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,gt),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Jt),g.pixelStorei(g.UNPACK_SKIP_ROWS,Ze),g.pixelStorei(g.UNPACK_SKIP_IMAGES,He),$===0&&q.generateMipmaps&&g.generateMipmap(g.TEXTURE_2D),N.unbindTexture()},this.copyTextureToTexture3D=function(R,q,ie=null,se=null,$=0){R.isTexture!==!0&&(Eo("WebGLRenderer: copyTextureToTexture3D function signature has changed."),ie=arguments[0]||null,se=arguments[1]||null,R=arguments[2],q=arguments[3],$=arguments[4]||0);let Me,Ie,Fe,Oe,ke,Ve,ze,it,ct;const gt=R.isCompressedTexture?R.mipmaps[$]:R.image;ie!==null?(Me=ie.max.x-ie.min.x,Ie=ie.max.y-ie.min.y,Fe=ie.max.z-ie.min.z,Oe=ie.min.x,ke=ie.min.y,Ve=ie.min.z):(Me=gt.width,Ie=gt.height,Fe=gt.depth,Oe=0,ke=0,Ve=0),se!==null?(ze=se.x,it=se.y,ct=se.z):(ze=0,it=0,ct=0);const Jt=Ce.convert(q.format),Ze=Ce.convert(q.type);let He;if(q.isData3DTexture)E.setTexture3D(q,0),He=g.TEXTURE_3D;else if(q.isDataArrayTexture||q.isCompressedArrayTexture)E.setTexture2DArray(q,0),He=g.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}g.pixelStorei(g.UNPACK_FLIP_Y_WEBGL,q.flipY),g.pixelStorei(g.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),g.pixelStorei(g.UNPACK_ALIGNMENT,q.unpackAlignment);const Pt=g.getParameter(g.UNPACK_ROW_LENGTH),Je=g.getParameter(g.UNPACK_IMAGE_HEIGHT),_n=g.getParameter(g.UNPACK_SKIP_PIXELS),rr=g.getParameter(g.UNPACK_SKIP_ROWS),Qt=g.getParameter(g.UNPACK_SKIP_IMAGES);g.pixelStorei(g.UNPACK_ROW_LENGTH,gt.width),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,gt.height),g.pixelStorei(g.UNPACK_SKIP_PIXELS,Oe),g.pixelStorei(g.UNPACK_SKIP_ROWS,ke),g.pixelStorei(g.UNPACK_SKIP_IMAGES,Ve),R.isDataTexture||R.isData3DTexture?g.texSubImage3D(He,$,ze,it,ct,Me,Ie,Fe,Jt,Ze,gt.data):q.isCompressedArrayTexture?g.compressedTexSubImage3D(He,$,ze,it,ct,Me,Ie,Fe,Jt,gt.data):g.texSubImage3D(He,$,ze,it,ct,Me,Ie,Fe,Jt,Ze,gt),g.pixelStorei(g.UNPACK_ROW_LENGTH,Pt),g.pixelStorei(g.UNPACK_IMAGE_HEIGHT,Je),g.pixelStorei(g.UNPACK_SKIP_PIXELS,_n),g.pixelStorei(g.UNPACK_SKIP_ROWS,rr),g.pixelStorei(g.UNPACK_SKIP_IMAGES,Qt),$===0&&q.generateMipmaps&&g.generateMipmap(He),N.unbindTexture()},this.initRenderTarget=function(R){ee.get(R).__webglFramebuffer===void 0&&E.setupRenderTarget(R)},this.initTexture=function(R){R.isCubeTexture?E.setTextureCube(R,0):R.isData3DTexture?E.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?E.setTexture2DArray(R,0):E.setTexture2D(R,0),N.unbindTexture()},this.resetState=function(){D=0,C=0,A=null,N.reset(),We.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ei}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Nl?"display-p3":"srgb",t.unpackColorSpace=et.workingColorSpace===$o?"display-p3":"srgb"}}class ai extends Bt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Bn,this.environmentIntensity=1,this.environmentRotation=new Bn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(t.object.environmentIntensity=this.environmentIntensity),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class zn{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,t){const i=this.getUtoTmapping(e);return this.getPoint(i,t)}getPoints(e=5){const t=[];for(let i=0;i<=e;i++)t.push(this.getPoint(i/e));return t}getSpacedPoints(e=5){const t=[];for(let i=0;i<=e;i++)t.push(this.getPointAt(i/e));return t}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const t=[];let i,r=this.getPoint(0),s=0;t.push(0);for(let o=1;o<=e;o++)i=this.getPoint(o/e),s+=i.distanceTo(r),t.push(s),r=i;return this.cacheArcLengths=t,t}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,t){const i=this.getLengths();let r=0;const s=i.length;let o;t?o=t:o=e*i[s-1];let a=0,c=s-1,l;for(;a<=c;)if(r=Math.floor(a+(c-a)/2),l=i[r]-o,l<0)a=r+1;else if(l>0)c=r-1;else{c=r;break}if(r=c,i[r]===o)return r/(s-1);const u=i[r],f=i[r+1]-u,d=(o-u)/f;return(r+d)/(s-1)}getTangent(e,t){let r=e-1e-4,s=e+1e-4;r<0&&(r=0),s>1&&(s=1);const o=this.getPoint(r),a=this.getPoint(s),c=t||(o.isVector2?new be:new k);return c.copy(a).sub(o).normalize(),c}getTangentAt(e,t){const i=this.getUtoTmapping(e);return this.getTangent(i,t)}computeFrenetFrames(e,t){const i=new k,r=[],s=[],o=[],a=new k,c=new ft;for(let d=0;d<=e;d++){const _=d/e;r[d]=this.getTangentAt(_,new k)}s[0]=new k,o[0]=new k;let l=Number.MAX_VALUE;const u=Math.abs(r[0].x),h=Math.abs(r[0].y),f=Math.abs(r[0].z);u<=l&&(l=u,i.set(1,0,0)),h<=l&&(l=h,i.set(0,1,0)),f<=l&&i.set(0,0,1),a.crossVectors(r[0],i).normalize(),s[0].crossVectors(r[0],a),o[0].crossVectors(r[0],s[0]);for(let d=1;d<=e;d++){if(s[d]=s[d-1].clone(),o[d]=o[d-1].clone(),a.crossVectors(r[d-1],r[d]),a.length()>Number.EPSILON){a.normalize();const _=Math.acos(At(r[d-1].dot(r[d]),-1,1));s[d].applyMatrix4(c.makeRotationAxis(a,_))}o[d].crossVectors(r[d],s[d])}if(t===!0){let d=Math.acos(At(s[0].dot(s[e]),-1,1));d/=e,r[0].dot(a.crossVectors(s[0],s[e]))>0&&(d=-d);for(let _=1;_<=e;_++)s[_].applyMatrix4(c.makeRotationAxis(r[_],d*_)),o[_].crossVectors(r[_],s[_])}return{tangents:r,normals:s,binormals:o}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}class Hl extends zn{constructor(e=0,t=0,i=1,r=1,s=0,o=Math.PI*2,a=!1,c=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=e,this.aY=t,this.xRadius=i,this.yRadius=r,this.aStartAngle=s,this.aEndAngle=o,this.aClockwise=a,this.aRotation=c}getPoint(e,t=new be){const i=t,r=Math.PI*2;let s=this.aEndAngle-this.aStartAngle;const o=Math.abs(s)<Number.EPSILON;for(;s<0;)s+=r;for(;s>r;)s-=r;s<Number.EPSILON&&(o?s=0:s=r),this.aClockwise===!0&&!o&&(s===r?s=-r:s=s-r);const a=this.aStartAngle+e*s;let c=this.aX+this.xRadius*Math.cos(a),l=this.aY+this.yRadius*Math.sin(a);if(this.aRotation!==0){const u=Math.cos(this.aRotation),h=Math.sin(this.aRotation),f=c-this.aX,d=l-this.aY;c=f*u-d*h+this.aX,l=f*h+d*u+this.aY}return i.set(c,l)}copy(e){return super.copy(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}toJSON(){const e=super.toJSON();return e.aX=this.aX,e.aY=this.aY,e.xRadius=this.xRadius,e.yRadius=this.yRadius,e.aStartAngle=this.aStartAngle,e.aEndAngle=this.aEndAngle,e.aClockwise=this.aClockwise,e.aRotation=this.aRotation,e}fromJSON(e){return super.fromJSON(e),this.aX=e.aX,this.aY=e.aY,this.xRadius=e.xRadius,this.yRadius=e.yRadius,this.aStartAngle=e.aStartAngle,this.aEndAngle=e.aEndAngle,this.aClockwise=e.aClockwise,this.aRotation=e.aRotation,this}}class aE extends Hl{constructor(e,t,i,r,s,o){super(e,t,i,i,r,s,o),this.isArcCurve=!0,this.type="ArcCurve"}}function Gl(){let n=0,e=0,t=0,i=0;function r(s,o,a,c){n=s,e=a,t=-3*s+3*o-2*a-c,i=2*s-2*o+a+c}return{initCatmullRom:function(s,o,a,c,l){r(o,a,l*(a-s),l*(c-o))},initNonuniformCatmullRom:function(s,o,a,c,l,u,h){let f=(o-s)/l-(a-s)/(l+u)+(a-o)/u,d=(a-o)/u-(c-o)/(u+h)+(c-a)/h;f*=u,d*=u,r(o,a,f,d)},calc:function(s){const o=s*s,a=o*s;return n+e*s+t*o+i*a}}}const ho=new k,Wa=new Gl,Xa=new Gl,qa=new Gl;class cE extends zn{constructor(e=[],t=!1,i="centripetal",r=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=t,this.curveType=i,this.tension=r}getPoint(e,t=new k){const i=t,r=this.points,s=r.length,o=(s-(this.closed?0:1))*e;let a=Math.floor(o),c=o-a;this.closed?a+=a>0?0:(Math.floor(Math.abs(a)/s)+1)*s:c===0&&a===s-1&&(a=s-2,c=1);let l,u;this.closed||a>0?l=r[(a-1)%s]:(ho.subVectors(r[0],r[1]).add(r[0]),l=ho);const h=r[a%s],f=r[(a+1)%s];if(this.closed||a+2<s?u=r[(a+2)%s]:(ho.subVectors(r[s-1],r[s-2]).add(r[s-1]),u=ho),this.curveType==="centripetal"||this.curveType==="chordal"){const d=this.curveType==="chordal"?.5:.25;let _=Math.pow(l.distanceToSquared(h),d),y=Math.pow(h.distanceToSquared(f),d),m=Math.pow(f.distanceToSquared(u),d);y<1e-4&&(y=1),_<1e-4&&(_=y),m<1e-4&&(m=y),Wa.initNonuniformCatmullRom(l.x,h.x,f.x,u.x,_,y,m),Xa.initNonuniformCatmullRom(l.y,h.y,f.y,u.y,_,y,m),qa.initNonuniformCatmullRom(l.z,h.z,f.z,u.z,_,y,m)}else this.curveType==="catmullrom"&&(Wa.initCatmullRom(l.x,h.x,f.x,u.x,this.tension),Xa.initCatmullRom(l.y,h.y,f.y,u.y,this.tension),qa.initCatmullRom(l.z,h.z,f.z,u.z,this.tension));return i.set(Wa.calc(c),Xa.calc(c),qa.calc(c)),i}copy(e){super.copy(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const r=e.points[t];this.points.push(r.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,i=this.points.length;t<i;t++){const r=this.points[t];e.points.push(r.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const r=e.points[t];this.points.push(new k().fromArray(r))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}function Wh(n,e,t,i,r){const s=(i-e)*.5,o=(r-t)*.5,a=n*n,c=n*a;return(2*t-2*i+s+o)*c+(-3*t+3*i-2*s-o)*a+s*n+t}function lE(n,e){const t=1-n;return t*t*e}function uE(n,e){return 2*(1-n)*n*e}function hE(n,e){return n*n*e}function ps(n,e,t,i){return lE(n,e)+uE(n,t)+hE(n,i)}function fE(n,e){const t=1-n;return t*t*t*e}function dE(n,e){const t=1-n;return 3*t*t*n*e}function pE(n,e){return 3*(1-n)*n*n*e}function mE(n,e){return n*n*n*e}function ms(n,e,t,i,r){return fE(n,e)+dE(n,t)+pE(n,i)+mE(n,r)}class qd extends zn{constructor(e=new be,t=new be,i=new be,r=new be){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=e,this.v1=t,this.v2=i,this.v3=r}getPoint(e,t=new be){const i=t,r=this.v0,s=this.v1,o=this.v2,a=this.v3;return i.set(ms(e,r.x,s.x,o.x,a.x),ms(e,r.y,s.y,o.y,a.y)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class gE extends zn{constructor(e=new k,t=new k,i=new k,r=new k){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=e,this.v1=t,this.v2=i,this.v3=r}getPoint(e,t=new k){const i=t,r=this.v0,s=this.v1,o=this.v2,a=this.v3;return i.set(ms(e,r.x,s.x,o.x,a.x),ms(e,r.y,s.y,o.y,a.y),ms(e,r.z,s.z,o.z,a.z)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this.v3.copy(e.v3),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e.v3=this.v3.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this.v3.fromArray(e.v3),this}}class Yd extends zn{constructor(e=new be,t=new be){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=e,this.v2=t}getPoint(e,t=new be){const i=t;return e===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(e).add(this.v1)),i}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new be){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class _E extends zn{constructor(e=new k,t=new k){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=e,this.v2=t}getPoint(e,t=new k){const i=t;return e===1?i.copy(this.v2):(i.copy(this.v2).sub(this.v1),i.multiplyScalar(e).add(this.v1)),i}getPointAt(e,t){return this.getPoint(e,t)}getTangent(e,t=new k){return t.subVectors(this.v2,this.v1).normalize()}getTangentAt(e,t){return this.getTangent(e,t)}copy(e){return super.copy(e),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class $d extends zn{constructor(e=new be,t=new be,i=new be){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=e,this.v1=t,this.v2=i}getPoint(e,t=new be){const i=t,r=this.v0,s=this.v1,o=this.v2;return i.set(ps(e,r.x,s.x,o.x),ps(e,r.y,s.y,o.y)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class vE extends zn{constructor(e=new k,t=new k,i=new k){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=e,this.v1=t,this.v2=i}getPoint(e,t=new k){const i=t,r=this.v0,s=this.v1,o=this.v2;return i.set(ps(e,r.x,s.x,o.x),ps(e,r.y,s.y,o.y),ps(e,r.z,s.z,o.z)),i}copy(e){return super.copy(e),this.v0.copy(e.v0),this.v1.copy(e.v1),this.v2.copy(e.v2),this}toJSON(){const e=super.toJSON();return e.v0=this.v0.toArray(),e.v1=this.v1.toArray(),e.v2=this.v2.toArray(),e}fromJSON(e){return super.fromJSON(e),this.v0.fromArray(e.v0),this.v1.fromArray(e.v1),this.v2.fromArray(e.v2),this}}class Kd extends zn{constructor(e=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=e}getPoint(e,t=new be){const i=t,r=this.points,s=(r.length-1)*e,o=Math.floor(s),a=s-o,c=r[o===0?o:o-1],l=r[o],u=r[o>r.length-2?r.length-1:o+1],h=r[o>r.length-3?r.length-1:o+2];return i.set(Wh(a,c.x,l.x,u.x,h.x),Wh(a,c.y,l.y,u.y,h.y)),i}copy(e){super.copy(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const r=e.points[t];this.points.push(r.clone())}return this}toJSON(){const e=super.toJSON();e.points=[];for(let t=0,i=this.points.length;t<i;t++){const r=this.points[t];e.points.push(r.toArray())}return e}fromJSON(e){super.fromJSON(e),this.points=[];for(let t=0,i=e.points.length;t<i;t++){const r=e.points[t];this.points.push(new be().fromArray(r))}return this}}var Qc=Object.freeze({__proto__:null,ArcCurve:aE,CatmullRomCurve3:cE,CubicBezierCurve:qd,CubicBezierCurve3:gE,EllipseCurve:Hl,LineCurve:Yd,LineCurve3:_E,QuadraticBezierCurve:$d,QuadraticBezierCurve3:vE,SplineCurve:Kd});class xE extends zn{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(e){this.curves.push(e)}closePath(){const e=this.curves[0].getPoint(0),t=this.curves[this.curves.length-1].getPoint(1);if(!e.equals(t)){const i=e.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new Qc[i](t,e))}return this}getPoint(e,t){const i=e*this.getLength(),r=this.getCurveLengths();let s=0;for(;s<r.length;){if(r[s]>=i){const o=r[s]-i,a=this.curves[s],c=a.getLength(),l=c===0?0:1-o/c;return a.getPointAt(l,t)}s++}return null}getLength(){const e=this.getCurveLengths();return e[e.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const e=[];let t=0;for(let i=0,r=this.curves.length;i<r;i++)t+=this.curves[i].getLength(),e.push(t);return this.cacheLengths=e,e}getSpacedPoints(e=40){const t=[];for(let i=0;i<=e;i++)t.push(this.getPoint(i/e));return this.autoClose&&t.push(t[0]),t}getPoints(e=12){const t=[];let i;for(let r=0,s=this.curves;r<s.length;r++){const o=s[r],a=o.isEllipseCurve?e*2:o.isLineCurve||o.isLineCurve3?1:o.isSplineCurve?e*o.points.length:e,c=o.getPoints(a);for(let l=0;l<c.length;l++){const u=c[l];i&&i.equals(u)||(t.push(u),i=u)}}return this.autoClose&&t.length>1&&!t[t.length-1].equals(t[0])&&t.push(t[0]),t}copy(e){super.copy(e),this.curves=[];for(let t=0,i=e.curves.length;t<i;t++){const r=e.curves[t];this.curves.push(r.clone())}return this.autoClose=e.autoClose,this}toJSON(){const e=super.toJSON();e.autoClose=this.autoClose,e.curves=[];for(let t=0,i=this.curves.length;t<i;t++){const r=this.curves[t];e.curves.push(r.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.autoClose=e.autoClose,this.curves=[];for(let t=0,i=e.curves.length;t<i;t++){const r=e.curves[t];this.curves.push(new Qc[r.type]().fromJSON(r))}return this}}class el extends xE{constructor(e){super(),this.type="Path",this.currentPoint=new be,e&&this.setFromPoints(e)}setFromPoints(e){this.moveTo(e[0].x,e[0].y);for(let t=1,i=e.length;t<i;t++)this.lineTo(e[t].x,e[t].y);return this}moveTo(e,t){return this.currentPoint.set(e,t),this}lineTo(e,t){const i=new Yd(this.currentPoint.clone(),new be(e,t));return this.curves.push(i),this.currentPoint.set(e,t),this}quadraticCurveTo(e,t,i,r){const s=new $d(this.currentPoint.clone(),new be(e,t),new be(i,r));return this.curves.push(s),this.currentPoint.set(i,r),this}bezierCurveTo(e,t,i,r,s,o){const a=new qd(this.currentPoint.clone(),new be(e,t),new be(i,r),new be(s,o));return this.curves.push(a),this.currentPoint.set(s,o),this}splineThru(e){const t=[this.currentPoint.clone()].concat(e),i=new Kd(t);return this.curves.push(i),this.currentPoint.copy(e[e.length-1]),this}arc(e,t,i,r,s,o){const a=this.currentPoint.x,c=this.currentPoint.y;return this.absarc(e+a,t+c,i,r,s,o),this}absarc(e,t,i,r,s,o){return this.absellipse(e,t,i,i,r,s,o),this}ellipse(e,t,i,r,s,o,a,c){const l=this.currentPoint.x,u=this.currentPoint.y;return this.absellipse(e+l,t+u,i,r,s,o,a,c),this}absellipse(e,t,i,r,s,o,a,c){const l=new Hl(e,t,i,r,s,o,a,c);if(this.curves.length>0){const h=l.getPoint(0);h.equals(this.currentPoint)||this.lineTo(h.x,h.y)}this.curves.push(l);const u=l.getPoint(1);return this.currentPoint.copy(u),this}copy(e){return super.copy(e),this.currentPoint.copy(e.currentPoint),this}toJSON(){const e=super.toJSON();return e.currentPoint=this.currentPoint.toArray(),e}fromJSON(e){return super.fromJSON(e),this.currentPoint.fromArray(e.currentPoint),this}}class An extends Cn{constructor(e=1,t=32,i=0,r=Math.PI*2){super(),this.type="CircleGeometry",this.parameters={radius:e,segments:t,thetaStart:i,thetaLength:r},t=Math.max(3,t);const s=[],o=[],a=[],c=[],l=new k,u=new be;o.push(0,0,0),a.push(0,0,1),c.push(.5,.5);for(let h=0,f=3;h<=t;h++,f+=3){const d=i+h/t*r;l.x=e*Math.cos(d),l.y=e*Math.sin(d),o.push(l.x,l.y,l.z),a.push(0,0,1),u.x=(o[f]/e+1)/2,u.y=(o[f+1]/e+1)/2,c.push(u.x,u.y)}for(let h=1;h<=t;h++)s.push(h,h+1,0);this.setIndex(s),this.setAttribute("position",new Rt(o,3)),this.setAttribute("normal",new Rt(a,3)),this.setAttribute("uv",new Rt(c,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new An(e.radius,e.segments,e.thetaStart,e.thetaLength)}}class on extends Cn{constructor(e=1,t=1,i=1,r=32,s=1,o=!1,a=0,c=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:t,height:i,radialSegments:r,heightSegments:s,openEnded:o,thetaStart:a,thetaLength:c};const l=this;r=Math.floor(r),s=Math.floor(s);const u=[],h=[],f=[],d=[];let _=0;const y=[],m=i/2;let p=0;w(),o===!1&&(e>0&&M(!0),t>0&&M(!1)),this.setIndex(u),this.setAttribute("position",new Rt(h,3)),this.setAttribute("normal",new Rt(f,3)),this.setAttribute("uv",new Rt(d,2));function w(){const S=new k,D=new k;let C=0;const A=(t-e)/i;for(let I=0;I<=s;I++){const ne=[],x=I/s,b=x*(t-e)+e;for(let B=0;B<=r;B++){const H=B/r,Z=H*c+a,re=Math.sin(Z),W=Math.cos(Z);D.x=b*re,D.y=-x*i+m,D.z=b*W,h.push(D.x,D.y,D.z),S.set(re,A,W).normalize(),f.push(S.x,S.y,S.z),d.push(H,1-x),ne.push(_++)}y.push(ne)}for(let I=0;I<r;I++)for(let ne=0;ne<s;ne++){const x=y[ne][I],b=y[ne+1][I],B=y[ne+1][I+1],H=y[ne][I+1];e>0&&(u.push(x,b,H),C+=3),t>0&&(u.push(b,B,H),C+=3)}l.addGroup(p,C,0),p+=C}function M(S){const D=_,C=new be,A=new k;let I=0;const ne=S===!0?e:t,x=S===!0?1:-1;for(let B=1;B<=r;B++)h.push(0,m*x,0),f.push(0,x,0),d.push(.5,.5),_++;const b=_;for(let B=0;B<=r;B++){const Z=B/r*c+a,re=Math.cos(Z),W=Math.sin(Z);A.x=ne*W,A.y=m*x,A.z=ne*re,h.push(A.x,A.y,A.z),f.push(0,x,0),C.x=re*.5+.5,C.y=W*.5*x+.5,d.push(C.x,C.y),_++}for(let B=0;B<r;B++){const H=D+B,Z=b+B;S===!0?u.push(Z,Z+1,H):u.push(Z+1,Z,H),I+=3}l.addGroup(p,I,S===!0?1:2),p+=I}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new on(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class kl extends on{constructor(e=1,t=1,i=32,r=1,s=!1,o=0,a=Math.PI*2){super(0,e,t,i,r,s,o,a),this.type="ConeGeometry",this.parameters={radius:e,height:t,radialSegments:i,heightSegments:r,openEnded:s,thetaStart:o,thetaLength:a}}static fromJSON(e){return new kl(e.radius,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}class qt extends el{constructor(e){super(e),this.uuid=tr(),this.type="Shape",this.holes=[]}getPointsHoles(e){const t=[];for(let i=0,r=this.holes.length;i<r;i++)t[i]=this.holes[i].getPoints(e);return t}extractPoints(e){return{shape:this.getPoints(e),holes:this.getPointsHoles(e)}}copy(e){super.copy(e),this.holes=[];for(let t=0,i=e.holes.length;t<i;t++){const r=e.holes[t];this.holes.push(r.clone())}return this}toJSON(){const e=super.toJSON();e.uuid=this.uuid,e.holes=[];for(let t=0,i=this.holes.length;t<i;t++){const r=this.holes[t];e.holes.push(r.toJSON())}return e}fromJSON(e){super.fromJSON(e),this.uuid=e.uuid,this.holes=[];for(let t=0,i=e.holes.length;t<i;t++){const r=e.holes[t];this.holes.push(new el().fromJSON(r))}return this}}const yE={triangulate:function(n,e,t=2){const i=e&&e.length,r=i?e[0]*t:n.length;let s=jd(n,0,r,t,!0);const o=[];if(!s||s.next===s.prev)return o;let a,c,l,u,h,f,d;if(i&&(s=bE(n,e,s,t)),n.length>80*t){a=l=n[0],c=u=n[1];for(let _=t;_<r;_+=t)h=n[_],f=n[_+1],h<a&&(a=h),f<c&&(c=f),h>l&&(l=h),f>u&&(u=f);d=Math.max(l-a,u-c),d=d!==0?32767/d:0}return Ts(s,o,t,a,c,d,0),o}};function jd(n,e,t,i,r){let s,o;if(r===FE(n,e,t,i)>0)for(s=e;s<t;s+=i)o=Xh(s,n[s],n[s+1],o);else for(s=t-i;s>=e;s-=i)o=Xh(s,n[s],n[s+1],o);return o&&jo(o,o.next)&&(Rs(o),o=o.next),o}function Ji(n,e){if(!n)return n;e||(e=n);let t=n,i;do if(i=!1,!t.steiner&&(jo(t,t.next)||pt(t.prev,t,t.next)===0)){if(Rs(t),t=e=t.prev,t===t.next)break;i=!0}else t=t.next;while(i||t!==e);return e}function Ts(n,e,t,i,r,s,o){if(!n)return;!o&&s&&PE(n,i,r,s);let a=n,c,l;for(;n.prev!==n.next;){if(c=n.prev,l=n.next,s?SE(n,i,r,s):ME(n)){e.push(c.i/t|0),e.push(n.i/t|0),e.push(l.i/t|0),Rs(n),n=l.next,a=l.next;continue}if(n=l,n===a){o?o===1?(n=EE(Ji(n),e,t),Ts(n,e,t,i,r,s,2)):o===2&&wE(n,e,t,i,r,s):Ts(Ji(n),e,t,i,r,s,1);break}}}function ME(n){const e=n.prev,t=n,i=n.next;if(pt(e,t,i)>=0)return!1;const r=e.x,s=t.x,o=i.x,a=e.y,c=t.y,l=i.y,u=r<s?r<o?r:o:s<o?s:o,h=a<c?a<l?a:l:c<l?c:l,f=r>s?r>o?r:o:s>o?s:o,d=a>c?a>l?a:l:c>l?c:l;let _=i.next;for(;_!==e;){if(_.x>=u&&_.x<=f&&_.y>=h&&_.y<=d&&br(r,a,s,c,o,l,_.x,_.y)&&pt(_.prev,_,_.next)>=0)return!1;_=_.next}return!0}function SE(n,e,t,i){const r=n.prev,s=n,o=n.next;if(pt(r,s,o)>=0)return!1;const a=r.x,c=s.x,l=o.x,u=r.y,h=s.y,f=o.y,d=a<c?a<l?a:l:c<l?c:l,_=u<h?u<f?u:f:h<f?h:f,y=a>c?a>l?a:l:c>l?c:l,m=u>h?u>f?u:f:h>f?h:f,p=tl(d,_,e,t,i),w=tl(y,m,e,t,i);let M=n.prevZ,S=n.nextZ;for(;M&&M.z>=p&&S&&S.z<=w;){if(M.x>=d&&M.x<=y&&M.y>=_&&M.y<=m&&M!==r&&M!==o&&br(a,u,c,h,l,f,M.x,M.y)&&pt(M.prev,M,M.next)>=0||(M=M.prevZ,S.x>=d&&S.x<=y&&S.y>=_&&S.y<=m&&S!==r&&S!==o&&br(a,u,c,h,l,f,S.x,S.y)&&pt(S.prev,S,S.next)>=0))return!1;S=S.nextZ}for(;M&&M.z>=p;){if(M.x>=d&&M.x<=y&&M.y>=_&&M.y<=m&&M!==r&&M!==o&&br(a,u,c,h,l,f,M.x,M.y)&&pt(M.prev,M,M.next)>=0)return!1;M=M.prevZ}for(;S&&S.z<=w;){if(S.x>=d&&S.x<=y&&S.y>=_&&S.y<=m&&S!==r&&S!==o&&br(a,u,c,h,l,f,S.x,S.y)&&pt(S.prev,S,S.next)>=0)return!1;S=S.nextZ}return!0}function EE(n,e,t){let i=n;do{const r=i.prev,s=i.next.next;!jo(r,s)&&Zd(r,i,i.next,s)&&As(r,s)&&As(s,r)&&(e.push(r.i/t|0),e.push(i.i/t|0),e.push(s.i/t|0),Rs(i),Rs(i.next),i=n=s),i=i.next}while(i!==n);return Ji(i)}function wE(n,e,t,i,r,s){let o=n;do{let a=o.next.next;for(;a!==o.prev;){if(o.i!==a.i&&DE(o,a)){let c=Jd(o,a);o=Ji(o,o.next),c=Ji(c,c.next),Ts(o,e,t,i,r,s,0),Ts(c,e,t,i,r,s,0);return}a=a.next}o=o.next}while(o!==n)}function bE(n,e,t,i){const r=[];let s,o,a,c,l;for(s=0,o=e.length;s<o;s++)a=e[s]*i,c=s<o-1?e[s+1]*i:n.length,l=jd(n,a,c,i,!1),l===l.next&&(l.steiner=!0),r.push(IE(l));for(r.sort(TE),s=0;s<r.length;s++)t=AE(r[s],t);return t}function TE(n,e){return n.x-e.x}function AE(n,e){const t=RE(n,e);if(!t)return e;const i=Jd(t,n);return Ji(i,i.next),Ji(t,t.next)}function RE(n,e){let t=e,i=-1/0,r;const s=n.x,o=n.y;do{if(o<=t.y&&o>=t.next.y&&t.next.y!==t.y){const f=t.x+(o-t.y)*(t.next.x-t.x)/(t.next.y-t.y);if(f<=s&&f>i&&(i=f,r=t.x<t.next.x?t:t.next,f===s))return r}t=t.next}while(t!==e);if(!r)return null;const a=r,c=r.x,l=r.y;let u=1/0,h;t=r;do s>=t.x&&t.x>=c&&s!==t.x&&br(o<l?s:i,o,c,l,o<l?i:s,o,t.x,t.y)&&(h=Math.abs(o-t.y)/(s-t.x),As(t,n)&&(h<u||h===u&&(t.x>r.x||t.x===r.x&&CE(r,t)))&&(r=t,u=h)),t=t.next;while(t!==a);return r}function CE(n,e){return pt(n.prev,n,e.prev)<0&&pt(e.next,n,n.next)<0}function PE(n,e,t,i){let r=n;do r.z===0&&(r.z=tl(r.x,r.y,e,t,i)),r.prevZ=r.prev,r.nextZ=r.next,r=r.next;while(r!==n);r.prevZ.nextZ=null,r.prevZ=null,LE(r)}function LE(n){let e,t,i,r,s,o,a,c,l=1;do{for(t=n,n=null,s=null,o=0;t;){for(o++,i=t,a=0,e=0;e<l&&(a++,i=i.nextZ,!!i);e++);for(c=l;a>0||c>0&&i;)a!==0&&(c===0||!i||t.z<=i.z)?(r=t,t=t.nextZ,a--):(r=i,i=i.nextZ,c--),s?s.nextZ=r:n=r,r.prevZ=s,s=r;t=i}s.nextZ=null,l*=2}while(o>1);return n}function tl(n,e,t,i,r){return n=(n-t)*r|0,e=(e-i)*r|0,n=(n|n<<8)&16711935,n=(n|n<<4)&252645135,n=(n|n<<2)&858993459,n=(n|n<<1)&1431655765,e=(e|e<<8)&16711935,e=(e|e<<4)&252645135,e=(e|e<<2)&858993459,e=(e|e<<1)&1431655765,n|e<<1}function IE(n){let e=n,t=n;do(e.x<t.x||e.x===t.x&&e.y<t.y)&&(t=e),e=e.next;while(e!==n);return t}function br(n,e,t,i,r,s,o,a){return(r-o)*(e-a)>=(n-o)*(s-a)&&(n-o)*(i-a)>=(t-o)*(e-a)&&(t-o)*(s-a)>=(r-o)*(i-a)}function DE(n,e){return n.next.i!==e.i&&n.prev.i!==e.i&&!UE(n,e)&&(As(n,e)&&As(e,n)&&NE(n,e)&&(pt(n.prev,n,e.prev)||pt(n,e.prev,e))||jo(n,e)&&pt(n.prev,n,n.next)>0&&pt(e.prev,e,e.next)>0)}function pt(n,e,t){return(e.y-n.y)*(t.x-e.x)-(e.x-n.x)*(t.y-e.y)}function jo(n,e){return n.x===e.x&&n.y===e.y}function Zd(n,e,t,i){const r=po(pt(n,e,t)),s=po(pt(n,e,i)),o=po(pt(t,i,n)),a=po(pt(t,i,e));return!!(r!==s&&o!==a||r===0&&fo(n,t,e)||s===0&&fo(n,i,e)||o===0&&fo(t,n,i)||a===0&&fo(t,e,i))}function fo(n,e,t){return e.x<=Math.max(n.x,t.x)&&e.x>=Math.min(n.x,t.x)&&e.y<=Math.max(n.y,t.y)&&e.y>=Math.min(n.y,t.y)}function po(n){return n>0?1:n<0?-1:0}function UE(n,e){let t=n;do{if(t.i!==n.i&&t.next.i!==n.i&&t.i!==e.i&&t.next.i!==e.i&&Zd(t,t.next,n,e))return!0;t=t.next}while(t!==n);return!1}function As(n,e){return pt(n.prev,n,n.next)<0?pt(n,e,n.next)>=0&&pt(n,n.prev,e)>=0:pt(n,e,n.prev)<0||pt(n,n.next,e)<0}function NE(n,e){let t=n,i=!1;const r=(n.x+e.x)/2,s=(n.y+e.y)/2;do t.y>s!=t.next.y>s&&t.next.y!==t.y&&r<(t.next.x-t.x)*(s-t.y)/(t.next.y-t.y)+t.x&&(i=!i),t=t.next;while(t!==n);return i}function Jd(n,e){const t=new nl(n.i,n.x,n.y),i=new nl(e.i,e.x,e.y),r=n.next,s=e.prev;return n.next=e,e.prev=n,t.next=r,r.prev=t,i.next=t,t.prev=i,s.next=i,i.prev=s,i}function Xh(n,e,t,i){const r=new nl(n,e,t);return i?(r.next=i.next,r.prev=i,i.next.prev=r,i.next=r):(r.prev=r,r.next=r),r}function Rs(n){n.next.prev=n.prev,n.prev.next=n.next,n.prevZ&&(n.prevZ.nextZ=n.nextZ),n.nextZ&&(n.nextZ.prevZ=n.prevZ)}function nl(n,e,t){this.i=n,this.x=e,this.y=t,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function FE(n,e,t,i){let r=0;for(let s=e,o=t-i;s<t;s+=i)r+=(n[o]-n[s])*(n[s+1]+n[o+1]),o=s;return r}class Ir{static area(e){const t=e.length;let i=0;for(let r=t-1,s=0;s<t;r=s++)i+=e[r].x*e[s].y-e[s].x*e[r].y;return i*.5}static isClockWise(e){return Ir.area(e)<0}static triangulateShape(e,t){const i=[],r=[],s=[];qh(e),Yh(i,e);let o=e.length;t.forEach(qh);for(let c=0;c<t.length;c++)r.push(o),o+=t[c].length,Yh(i,t[c]);const a=yE.triangulate(i,r);for(let c=0;c<a.length;c+=3)s.push(a.slice(c,c+3));return s}}function qh(n){const e=n.length;e>2&&n[e-1].equals(n[0])&&n.pop()}function Yh(n,e){for(let t=0;t<e.length;t++)n.push(e[t].x),n.push(e[t].y)}class jt extends Cn{constructor(e=new qt([new be(.5,.5),new be(-.5,.5),new be(-.5,-.5),new be(.5,-.5)]),t={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:e,options:t},e=Array.isArray(e)?e:[e];const i=this,r=[],s=[];for(let a=0,c=e.length;a<c;a++){const l=e[a];o(l)}this.setAttribute("position",new Rt(r,3)),this.setAttribute("uv",new Rt(s,2)),this.computeVertexNormals();function o(a){const c=[],l=t.curveSegments!==void 0?t.curveSegments:12,u=t.steps!==void 0?t.steps:1,h=t.depth!==void 0?t.depth:1;let f=t.bevelEnabled!==void 0?t.bevelEnabled:!0,d=t.bevelThickness!==void 0?t.bevelThickness:.2,_=t.bevelSize!==void 0?t.bevelSize:d-.1,y=t.bevelOffset!==void 0?t.bevelOffset:0,m=t.bevelSegments!==void 0?t.bevelSegments:3;const p=t.extrudePath,w=t.UVGenerator!==void 0?t.UVGenerator:OE;let M,S=!1,D,C,A,I;p&&(M=p.getSpacedPoints(u),S=!0,f=!1,D=p.computeFrenetFrames(u,!1),C=new k,A=new k,I=new k),f||(m=0,d=0,_=0,y=0);const ne=a.extractPoints(l);let x=ne.shape;const b=ne.holes;if(!Ir.isClockWise(x)){x=x.reverse();for(let te=0,g=b.length;te<g;te++){const T=b[te];Ir.isClockWise(T)&&(b[te]=T.reverse())}}const H=Ir.triangulateShape(x,b),Z=x;for(let te=0,g=b.length;te<g;te++){const T=b[te];x=x.concat(T)}function re(te,g,T){return g||console.error("THREE.ExtrudeGeometry: vec does not exist"),te.clone().addScaledVector(g,T)}const W=x.length,J=H.length;function O(te,g,T){let L,F,N;const j=te.x-g.x,ee=te.y-g.y,E=T.x-te.x,v=T.y-te.y,P=j*j+ee*ee,X=j*v-ee*E;if(Math.abs(X)>Number.EPSILON){const V=Math.sqrt(P),Y=Math.sqrt(E*E+v*v),ue=g.x-ee/V,le=g.y+j/V,ve=T.x-v/Y,Te=T.y+E/Y,he=((ve-ue)*v-(Te-le)*E)/(j*v-ee*E);L=ue+j*he-te.x,F=le+ee*he-te.y;const ye=L*L+F*F;if(ye<=2)return new be(L,F);N=Math.sqrt(ye/2)}else{let V=!1;j>Number.EPSILON?E>Number.EPSILON&&(V=!0):j<-Number.EPSILON?E<-Number.EPSILON&&(V=!0):Math.sign(ee)===Math.sign(v)&&(V=!0),V?(L=-ee,F=j,N=Math.sqrt(P)):(L=j,F=ee,N=Math.sqrt(P/2))}return new be(L/N,F/N)}const pe=[];for(let te=0,g=Z.length,T=g-1,L=te+1;te<g;te++,T++,L++)T===g&&(T=0),L===g&&(L=0),pe[te]=O(Z[te],Z[T],Z[L]);const de=[];let ge,Se=pe.concat();for(let te=0,g=b.length;te<g;te++){const T=b[te];ge=[];for(let L=0,F=T.length,N=F-1,j=L+1;L<F;L++,N++,j++)N===F&&(N=0),j===F&&(j=0),ge[L]=O(T[L],T[N],T[j]);de.push(ge),Se=Se.concat(ge)}for(let te=0;te<m;te++){const g=te/m,T=d*Math.cos(g*Math.PI/2),L=_*Math.sin(g*Math.PI/2)+y;for(let F=0,N=Z.length;F<N;F++){const j=re(Z[F],pe[F],L);U(j.x,j.y,-T)}for(let F=0,N=b.length;F<N;F++){const j=b[F];ge=de[F];for(let ee=0,E=j.length;ee<E;ee++){const v=re(j[ee],ge[ee],L);U(v.x,v.y,-T)}}}const Re=_+y;for(let te=0;te<W;te++){const g=f?re(x[te],Se[te],Re):x[te];S?(A.copy(D.normals[0]).multiplyScalar(g.x),C.copy(D.binormals[0]).multiplyScalar(g.y),I.copy(M[0]).add(A).add(C),U(I.x,I.y,I.z)):U(g.x,g.y,0)}for(let te=1;te<=u;te++)for(let g=0;g<W;g++){const T=f?re(x[g],Se[g],Re):x[g];S?(A.copy(D.normals[te]).multiplyScalar(T.x),C.copy(D.binormals[te]).multiplyScalar(T.y),I.copy(M[te]).add(A).add(C),U(I.x,I.y,I.z)):U(T.x,T.y,h/u*te)}for(let te=m-1;te>=0;te--){const g=te/m,T=d*Math.cos(g*Math.PI/2),L=_*Math.sin(g*Math.PI/2)+y;for(let F=0,N=Z.length;F<N;F++){const j=re(Z[F],pe[F],L);U(j.x,j.y,h+T)}for(let F=0,N=b.length;F<N;F++){const j=b[F];ge=de[F];for(let ee=0,E=j.length;ee<E;ee++){const v=re(j[ee],ge[ee],L);S?U(v.x,v.y+M[u-1].y,M[u-1].x+T):U(v.x,v.y,h+T)}}}Q(),fe();function Q(){const te=r.length/3;if(f){let g=0,T=W*g;for(let L=0;L<J;L++){const F=H[L];oe(F[2]+T,F[1]+T,F[0]+T)}g=u+m*2,T=W*g;for(let L=0;L<J;L++){const F=H[L];oe(F[0]+T,F[1]+T,F[2]+T)}}else{for(let g=0;g<J;g++){const T=H[g];oe(T[2],T[1],T[0])}for(let g=0;g<J;g++){const T=H[g];oe(T[0]+W*u,T[1]+W*u,T[2]+W*u)}}i.addGroup(te,r.length/3-te,0)}function fe(){const te=r.length/3;let g=0;_e(Z,g),g+=Z.length;for(let T=0,L=b.length;T<L;T++){const F=b[T];_e(F,g),g+=F.length}i.addGroup(te,r.length/3-te,1)}function _e(te,g){let T=te.length;for(;--T>=0;){const L=T;let F=T-1;F<0&&(F=te.length-1);for(let N=0,j=u+m*2;N<j;N++){const ee=W*N,E=W*(N+1),v=g+L+ee,P=g+F+ee,X=g+F+E,V=g+L+E;K(v,P,X,V)}}}function U(te,g,T){c.push(te),c.push(g),c.push(T)}function oe(te,g,T){ce(te),ce(g),ce(T);const L=r.length/3,F=w.generateTopUV(i,r,L-3,L-2,L-1);xe(F[0]),xe(F[1]),xe(F[2])}function K(te,g,T,L){ce(te),ce(g),ce(L),ce(g),ce(T),ce(L);const F=r.length/3,N=w.generateSideWallUV(i,r,F-6,F-3,F-2,F-1);xe(N[0]),xe(N[1]),xe(N[3]),xe(N[1]),xe(N[2]),xe(N[3])}function ce(te){r.push(c[te*3+0]),r.push(c[te*3+1]),r.push(c[te*3+2])}function xe(te){s.push(te.x),s.push(te.y)}}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}toJSON(){const e=super.toJSON(),t=this.parameters.shapes,i=this.parameters.options;return BE(t,i,e)}static fromJSON(e,t){const i=[];for(let s=0,o=e.shapes.length;s<o;s++){const a=t[e.shapes[s]];i.push(a)}const r=e.options.extrudePath;return r!==void 0&&(e.options.extrudePath=new Qc[r.type]().fromJSON(r)),new jt(i,e.options)}}const OE={generateTopUV:function(n,e,t,i,r){const s=e[t*3],o=e[t*3+1],a=e[i*3],c=e[i*3+1],l=e[r*3],u=e[r*3+1];return[new be(s,o),new be(a,c),new be(l,u)]},generateSideWallUV:function(n,e,t,i,r,s){const o=e[t*3],a=e[t*3+1],c=e[t*3+2],l=e[i*3],u=e[i*3+1],h=e[i*3+2],f=e[r*3],d=e[r*3+1],_=e[r*3+2],y=e[s*3],m=e[s*3+1],p=e[s*3+2];return Math.abs(a-u)<Math.abs(o-l)?[new be(o,1-c),new be(l,1-h),new be(f,1-_),new be(y,1-p)]:[new be(a,1-c),new be(u,1-h),new be(d,1-_),new be(m,1-p)]}};function BE(n,e,t){if(t.shapes=[],Array.isArray(n))for(let i=0,r=n.length;i<r;i++){const s=n[i];t.shapes.push(s.uuid)}else t.shapes.push(n.uuid);return t.options=Object.assign({},e),e.extrudePath!==void 0&&(t.options.extrudePath=e.extrudePath.toJSON()),t}class Ee extends Cn{constructor(e=1,t=32,i=16,r=0,s=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:i,phiStart:r,phiLength:s,thetaStart:o,thetaLength:a},t=Math.max(3,Math.floor(t)),i=Math.max(2,Math.floor(i));const c=Math.min(o+a,Math.PI);let l=0;const u=[],h=new k,f=new k,d=[],_=[],y=[],m=[];for(let p=0;p<=i;p++){const w=[],M=p/i;let S=0;p===0&&o===0?S=.5/t:p===i&&c===Math.PI&&(S=-.5/t);for(let D=0;D<=t;D++){const C=D/t;h.x=-e*Math.cos(r+C*s)*Math.sin(o+M*a),h.y=e*Math.cos(o+M*a),h.z=e*Math.sin(r+C*s)*Math.sin(o+M*a),_.push(h.x,h.y,h.z),f.copy(h).normalize(),y.push(f.x,f.y,f.z),m.push(C+S,1-M),w.push(l++)}u.push(w)}for(let p=0;p<i;p++)for(let w=0;w<t;w++){const M=u[p][w+1],S=u[p][w],D=u[p+1][w],C=u[p+1][w+1];(p!==0||o>0)&&d.push(M,S,C),(p!==i-1||c<Math.PI)&&d.push(S,D,C)}this.setIndex(d),this.setAttribute("position",new Rt(_,3)),this.setAttribute("normal",new Rt(y,3)),this.setAttribute("uv",new Rt(m,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Ee(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class Cs extends Ns{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Ge(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ge(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Ad,this.normalScale=new be(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Bn,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class tt extends Cs{constructor(e){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new be(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return At(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(t){this.ior=(1+.4*t)/(1-.4*t)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new Ge(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new Ge(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new Ge(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._dispersion=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(e)}get anisotropy(){return this._anisotropy}set anisotropy(e){this._anisotropy>0!=e>0&&this.version++,this._anisotropy=e}get clearcoat(){return this._clearcoat}set clearcoat(e){this._clearcoat>0!=e>0&&this.version++,this._clearcoat=e}get iridescence(){return this._iridescence}set iridescence(e){this._iridescence>0!=e>0&&this.version++,this._iridescence=e}get dispersion(){return this._dispersion}set dispersion(e){this._dispersion>0!=e>0&&this.version++,this._dispersion=e}get sheen(){return this._sheen}set sheen(e){this._sheen>0!=e>0&&this.version++,this._sheen=e}get transmission(){return this._transmission}set transmission(e){this._transmission>0!=e>0&&this.version++,this._transmission=e}copy(e){return super.copy(e),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=e.anisotropy,this.anisotropyRotation=e.anisotropyRotation,this.anisotropyMap=e.anisotropyMap,this.clearcoat=e.clearcoat,this.clearcoatMap=e.clearcoatMap,this.clearcoatRoughness=e.clearcoatRoughness,this.clearcoatRoughnessMap=e.clearcoatRoughnessMap,this.clearcoatNormalMap=e.clearcoatNormalMap,this.clearcoatNormalScale.copy(e.clearcoatNormalScale),this.dispersion=e.dispersion,this.ior=e.ior,this.iridescence=e.iridescence,this.iridescenceMap=e.iridescenceMap,this.iridescenceIOR=e.iridescenceIOR,this.iridescenceThicknessRange=[...e.iridescenceThicknessRange],this.iridescenceThicknessMap=e.iridescenceThicknessMap,this.sheen=e.sheen,this.sheenColor.copy(e.sheenColor),this.sheenColorMap=e.sheenColorMap,this.sheenRoughness=e.sheenRoughness,this.sheenRoughnessMap=e.sheenRoughnessMap,this.transmission=e.transmission,this.transmissionMap=e.transmissionMap,this.thickness=e.thickness,this.thicknessMap=e.thicknessMap,this.attenuationDistance=e.attenuationDistance,this.attenuationColor.copy(e.attenuationColor),this.specularIntensity=e.specularIntensity,this.specularIntensityMap=e.specularIntensityMap,this.specularColor.copy(e.specularColor),this.specularColorMap=e.specularColorMap,this}}const $h={enabled:!1,files:{},add:function(n,e){this.enabled!==!1&&(this.files[n]=e)},get:function(n){if(this.enabled!==!1)return this.files[n]},remove:function(n){delete this.files[n]},clear:function(){this.files={}}};class zE{constructor(e,t,i){const r=this;let s=!1,o=0,a=0,c;const l=[];this.onStart=void 0,this.onLoad=e,this.onProgress=t,this.onError=i,this.itemStart=function(u){a++,s===!1&&r.onStart!==void 0&&r.onStart(u,o,a),s=!0},this.itemEnd=function(u){o++,r.onProgress!==void 0&&r.onProgress(u,o,a),o===a&&(s=!1,r.onLoad!==void 0&&r.onLoad())},this.itemError=function(u){r.onError!==void 0&&r.onError(u)},this.resolveURL=function(u){return c?c(u):u},this.setURLModifier=function(u){return c=u,this},this.addHandler=function(u,h){return l.push(u,h),this},this.removeHandler=function(u){const h=l.indexOf(u);return h!==-1&&l.splice(h,2),this},this.getHandler=function(u){for(let h=0,f=l.length;h<f;h+=2){const d=l[h],_=l[h+1];if(d.global&&(d.lastIndex=0),d.test(u))return _}return null}}}const HE=new zE;class Vl{constructor(e){this.manager=e!==void 0?e:HE,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(e,t){const i=this;return new Promise(function(r,s){i.load(e,r,t,s)})}parse(){}setCrossOrigin(e){return this.crossOrigin=e,this}setWithCredentials(e){return this.withCredentials=e,this}setPath(e){return this.path=e,this}setResourcePath(e){return this.resourcePath=e,this}setRequestHeader(e){return this.requestHeader=e,this}}Vl.DEFAULT_MATERIAL_NAME="__DEFAULT";const $n={};class GE extends Error{constructor(e,t){super(e),this.response=t}}class kE extends Vl{constructor(e){super(e)}load(e,t,i,r){e===void 0&&(e=""),this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const s=$h.get(e);if(s!==void 0)return this.manager.itemStart(e),setTimeout(()=>{t&&t(s),this.manager.itemEnd(e)},0),s;if($n[e]!==void 0){$n[e].push({onLoad:t,onProgress:i,onError:r});return}$n[e]=[],$n[e].push({onLoad:t,onProgress:i,onError:r});const o=new Request(e,{headers:new Headers(this.requestHeader),credentials:this.withCredentials?"include":"same-origin"}),a=this.mimeType,c=this.responseType;fetch(o).then(l=>{if(l.status===200||l.status===0){if(l.status===0&&console.warn("THREE.FileLoader: HTTP Status 0 received."),typeof ReadableStream>"u"||l.body===void 0||l.body.getReader===void 0)return l;const u=$n[e],h=l.body.getReader(),f=l.headers.get("X-File-Size")||l.headers.get("Content-Length"),d=f?parseInt(f):0,_=d!==0;let y=0;const m=new ReadableStream({start(p){w();function w(){h.read().then(({done:M,value:S})=>{if(M)p.close();else{y+=S.byteLength;const D=new ProgressEvent("progress",{lengthComputable:_,loaded:y,total:d});for(let C=0,A=u.length;C<A;C++){const I=u[C];I.onProgress&&I.onProgress(D)}p.enqueue(S),w()}},M=>{p.error(M)})}}});return new Response(m)}else throw new GE(`fetch for "${l.url}" responded with ${l.status}: ${l.statusText}`,l)}).then(l=>{switch(c){case"arraybuffer":return l.arrayBuffer();case"blob":return l.blob();case"document":return l.text().then(u=>new DOMParser().parseFromString(u,a));case"json":return l.json();default:if(a===void 0)return l.text();{const h=/charset="?([^;"\s]*)"?/i.exec(a),f=h&&h[1]?h[1].toLowerCase():void 0,d=new TextDecoder(f);return l.arrayBuffer().then(_=>d.decode(_))}}}).then(l=>{$h.add(e,l);const u=$n[e];delete $n[e];for(let h=0,f=u.length;h<f;h++){const d=u[h];d.onLoad&&d.onLoad(l)}}).catch(l=>{const u=$n[e];if(u===void 0)throw this.manager.itemError(e),l;delete $n[e];for(let h=0,f=u.length;h<f;h++){const d=u[h];d.onError&&d.onError(l)}this.manager.itemError(e)}).finally(()=>{this.manager.itemEnd(e)}),this.manager.itemStart(e)}setResponseType(e){return this.responseType=e,this}setMimeType(e){return this.mimeType=e,this}}class Wl extends Bt{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new Ge(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(t.object.target=this.target.uuid),t}}const Ya=new ft,Kh=new k,jh=new k;class Qd{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new be(512,512),this.map=null,this.mapPass=null,this.matrix=new ft,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Bl,this._frameExtents=new be(1,1),this._viewportCount=1,this._viewports=[new st(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,i=this.matrix;Kh.setFromMatrixPosition(e.matrixWorld),t.position.copy(Kh),jh.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(jh),t.updateMatrixWorld(),Ya.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Ya),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(Ya)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}const Zh=new ft,ts=new k,$a=new k;class VE extends Qd{constructor(){super(new vt(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new be(4,2),this._viewportCount=6,this._viewports=[new st(2,1,1,1),new st(0,1,1,1),new st(3,1,1,1),new st(1,1,1,1),new st(3,0,1,1),new st(1,0,1,1)],this._cubeDirections=[new k(1,0,0),new k(-1,0,0),new k(0,0,1),new k(0,0,-1),new k(0,1,0),new k(0,-1,0)],this._cubeUps=[new k(0,1,0),new k(0,1,0),new k(0,1,0),new k(0,1,0),new k(0,0,1),new k(0,0,-1)]}updateMatrices(e,t=0){const i=this.camera,r=this.matrix,s=e.distance||i.far;s!==i.far&&(i.far=s,i.updateProjectionMatrix()),ts.setFromMatrixPosition(e.matrixWorld),i.position.copy(ts),$a.copy(i.position),$a.add(this._cubeDirections[t]),i.up.copy(this._cubeUps[t]),i.lookAt($a),i.updateMatrixWorld(),r.makeTranslation(-ts.x,-ts.y,-ts.z),Zh.multiplyMatrices(i.projectionMatrix,i.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Zh)}}class nr extends Wl{constructor(e,t,i=0,r=2){super(e,t),this.isPointLight=!0,this.type="PointLight",this.distance=i,this.decay=r,this.shadow=new VE}get power(){return this.intensity*4*Math.PI}set power(e){this.intensity=e/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(e,t){return super.copy(e,t),this.distance=e.distance,this.decay=e.decay,this.shadow=e.shadow.clone(),this}}class WE extends Qd{constructor(){super(new Hd(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class ci extends Wl{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Bt.DEFAULT_UP),this.updateMatrix(),this.target=new Bt,this.shadow=new WE}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class li extends Wl{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class XE{constructor(){this.type="ShapePath",this.color=new Ge,this.subPaths=[],this.currentPath=null}moveTo(e,t){return this.currentPath=new el,this.subPaths.push(this.currentPath),this.currentPath.moveTo(e,t),this}lineTo(e,t){return this.currentPath.lineTo(e,t),this}quadraticCurveTo(e,t,i,r){return this.currentPath.quadraticCurveTo(e,t,i,r),this}bezierCurveTo(e,t,i,r,s,o){return this.currentPath.bezierCurveTo(e,t,i,r,s,o),this}splineThru(e){return this.currentPath.splineThru(e),this}toShapes(e){function t(p){const w=[];for(let M=0,S=p.length;M<S;M++){const D=p[M],C=new qt;C.curves=D.curves,w.push(C)}return w}function i(p,w){const M=w.length;let S=!1;for(let D=M-1,C=0;C<M;D=C++){let A=w[D],I=w[C],ne=I.x-A.x,x=I.y-A.y;if(Math.abs(x)>Number.EPSILON){if(x<0&&(A=w[C],ne=-ne,I=w[D],x=-x),p.y<A.y||p.y>I.y)continue;if(p.y===A.y){if(p.x===A.x)return!0}else{const b=x*(p.x-A.x)-ne*(p.y-A.y);if(b===0)return!0;if(b<0)continue;S=!S}}else{if(p.y!==A.y)continue;if(I.x<=p.x&&p.x<=A.x||A.x<=p.x&&p.x<=I.x)return!0}}return S}const r=Ir.isClockWise,s=this.subPaths;if(s.length===0)return[];let o,a,c;const l=[];if(s.length===1)return a=s[0],c=new qt,c.curves=a.curves,l.push(c),l;let u=!r(s[0].getPoints());u=e?!u:u;const h=[],f=[];let d=[],_=0,y;f[_]=void 0,d[_]=[];for(let p=0,w=s.length;p<w;p++)a=s[p],y=a.getPoints(),o=r(y),o=e?!o:o,o?(!u&&f[_]&&_++,f[_]={s:new qt,p:y},f[_].s.curves=a.curves,u&&_++,d[_]=[]):d[_].push({h:a,p:y[0]});if(!f[0])return t(s);if(f.length>1){let p=!1,w=0;for(let M=0,S=f.length;M<S;M++)h[M]=[];for(let M=0,S=f.length;M<S;M++){const D=d[M];for(let C=0;C<D.length;C++){const A=D[C];let I=!0;for(let ne=0;ne<f.length;ne++)i(A.p,f[ne].p)&&(M!==ne&&w++,I?(I=!1,h[ne].push(A)):p=!0);I&&h[M].push(A)}}w>0&&p===!1&&(d=h)}let m;for(let p=0,w=f.length;p<w;p++){c=f[p].s,l.push(c),m=d[p];for(let M=0,S=m.length;M<S;M++)c.holes.push(m[M].h)}return l}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Rl}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Rl);class ir extends Vl{constructor(e){super(e)}load(e,t,i,r){const s=this,o=new kE(this.manager);o.setPath(this.path),o.setRequestHeader(this.requestHeader),o.setWithCredentials(this.withCredentials),o.load(e,function(a){const c=s.parse(JSON.parse(a));t&&t(c)},i,r)}parse(e){return new qE(e)}}class qE{constructor(e){this.isFont=!0,this.type="Font",this.data=e}generateShapes(e,t=100){const i=[],r=YE(e,t,this.data);for(let s=0,o=r.length;s<o;s++)i.push(...r[s].toShapes());return i}}function YE(n,e,t){const i=Array.from(n),r=e/t.resolution,s=(t.boundingBox.yMax-t.boundingBox.yMin+t.underlineThickness)*r,o=[];let a=0,c=0;for(let l=0;l<i.length;l++){const u=i[l];if(u===`
`)a=0,c-=s;else{const h=$E(u,r,a,c,t);a+=h.offsetX,o.push(h.path)}}return o}function $E(n,e,t,i,r){const s=r.glyphs[n]||r.glyphs["?"];if(!s){console.error('THREE.Font: character "'+n+'" does not exists in font family '+r.familyName+".");return}const o=new XE;let a,c,l,u,h,f,d,_;if(s.o){const y=s._cachedOutline||(s._cachedOutline=s.o.split(" "));for(let m=0,p=y.length;m<p;)switch(y[m++]){case"m":a=y[m++]*e+t,c=y[m++]*e+i,o.moveTo(a,c);break;case"l":a=y[m++]*e+t,c=y[m++]*e+i,o.lineTo(a,c);break;case"q":l=y[m++]*e+t,u=y[m++]*e+i,h=y[m++]*e+t,f=y[m++]*e+i,o.quadraticCurveTo(h,f,l,u);break;case"b":l=y[m++]*e+t,u=y[m++]*e+i,h=y[m++]*e+t,f=y[m++]*e+i,d=y[m++]*e+t,_=y[m++]*e+i,o.bezierCurveTo(h,f,d,_,l,u);break}}return{offsetX:s.ha*e,path:o}}class an extends jt{constructor(e,t={}){const i=t.font;if(i===void 0)super();else{const r=i.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(r,t)}this.type="TextGeometry"}}const KE=Zt({__name:"PinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.03,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.5);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new ut({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `}),h=new tt({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=new tt({color:13369344,metalness:.4,roughness:.3,clearcoat:.3,clearcoatRoughness:.2,transparent:!0,opacity:.99}),d=new mt,_=new Ee(1,32,32),y=new G(_,h);y.scale.set(.85,.85,.8),y.position.y=-.2,d.add(y);const m=new Ee(.6,32,32),p=new G(m,h);p.scale.set(1,.95,.95),p.position.set(0,1,0),d.add(p);const w=new Ee(.25,32,32),M=new G(w,h);M.position.set(-.45,1.35,-.1),d.add(M);const S=new G(w,h);S.position.set(.45,1.35,-.1),d.add(S);const D=new Ee(.25,32,32),C=new G(D,h);C.scale.set(1,.6,.8),C.position.set(0,.85,.5),d.add(C);const A=new qt;A.moveTo(0,0),A.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),A.bezierCurveTo(-.6,.3,0,.6,0,1),A.bezierCurveTo(0,.6,.6,.3,.6,0),A.bezierCurveTo(.6,-.3,0,-.3,0,0);const I={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ne=new jt(A,I),x=new G(ne,f);x.scale.set(.5,.5,.5),x.position.set(0,.34,.8),x.rotation.y=Math.PI,x.rotation.x=Math.PI,d.add(x);const b=new Ee(.35,32,32),B=new G(b,h);B.scale.set(.75,1.25,.65),B.position.set(-.7,-.15,.2),d.add(B);const H=new G(b,h);H.scale.set(.75,1.25,.65),H.position.set(.7,-.15,.2),d.add(H);const Z=new on(.2,.22,.6,32),re=new G(Z,h);re.position.set(-.4,-1.05,0),d.add(re);const W=new G(Z,h);W.position.set(.4,-1.05,0),d.add(W);const J=new Ee(.3,32,32),O=new G(J,h);O.scale.set(1,.72,1.5),O.position.set(-.4,-1.45,.17),d.add(O);const pe=new G(J,h);pe.scale.set(1,.72,1.5),pe.position.set(.4,-1.45,.17),d.add(pe);const de=new Ee(.44,32,32),ge=new G(de,h);ge.position.set(-.15,-.45,-.4),d.add(ge);const Se=new G(de,h);Se.position.set(.15,-.45,-.4),d.add(Se);const Re=new Ee(.18,32,32),Q=new G(Re,f);Q.position.set(0,-.35,-.8),d.add(Q),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(K){const ce=new an("X",{font:K,size:.2,depth:.05}),xe=new dt({color:0}),te=new G(ce,xe);te.position.set(-.34,1,.5),d.add(te)});const _e=new Ee(.1,32,32),U=new dt({color:0}),oe=new G(_e,U);oe.position.set(.2,1.1,.54),d.add(oe),r.add(d),i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),Ot(()=>e.bodyPosition,K=>{d.position.set(K.x,K.y,K.z)}),Ot(()=>e.cameraPosition,K=>{s.position.set(e.bodyPosition.x,1,K),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:ri(n.background?"no-bg":"three-canvas")},null,2))}}),ep=gn(KE,[["__scopeId","data-v-d0efbfd4"]]),jE=Zt({__name:"PurpleBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.03,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.5);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new ut({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `}),h=new tt({color:10573288,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});new tt({color:16766720,metalness:.4,roughness:.3,clearcoat:.3,clearcoatRoughness:.2,transparent:!0,opacity:.99});const f=new tt({color:16766720,metalness:.05,roughness:10,clearcoat:.6,clearcoatRoughness:.1,opacity:1,transparent:!1}),d=new mt,_=new Ee(1,32,32),y=new G(_,h);y.scale.set(.85,.85,.8),y.position.y=-.2,d.add(y);const m=new Ee(.6,32,32),p=new G(m,h);p.scale.set(1,.95,.95),p.position.set(0,1,0),d.add(p);const w=new Ee(.25,32,32),M=new G(w,h);M.position.set(-.45,1.35,-.1),d.add(M);const S=new G(w,h);S.position.set(.45,1.35,-.1),d.add(S);const D=new Ee(.25,32,32),C=new G(D,h);C.scale.set(1,.6,.8),C.position.set(0,.85,.5),d.add(C);const A=new qt;A.moveTo(0,0),A.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),A.bezierCurveTo(-.6,.3,0,.6,0,1),A.bezierCurveTo(0,.6,.6,.3,.6,0),A.bezierCurveTo(.6,-.3,0,-.3,0,0);const I={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ne=new jt(A,I),x=new G(ne,u);x.scale.set(.5,.5,.5),x.position.set(0,.34,.8),x.rotation.y=Math.PI,x.rotation.x=Math.PI,d.add(x);const b=new Ee(.35,32,32),B=new G(b,h);B.scale.set(.75,1.25,.65),B.position.set(-.7,-.15,.2),d.add(B);const H=new G(b,h);H.scale.set(.75,1.25,.65),H.position.set(.7,-.15,.2),d.add(H);const Z=new on(.2,.22,.6,32),re=new G(Z,h);re.position.set(-.4,-1.05,0),d.add(re);const W=new G(Z,h);W.position.set(.4,-1.05,0),d.add(W);const J=new Ee(.3,32,32),O=new G(J,h);O.scale.set(1,.72,1.5),O.position.set(-.4,-1.45,.17),d.add(O);const pe=new G(J,h);pe.scale.set(1,.72,1.5),pe.position.set(.4,-1.45,.17),d.add(pe);const de=new Ee(.44,32,32),ge=new G(de,h);ge.position.set(-.15,-.45,-.4),d.add(ge);const Se=new G(de,h);Se.position.set(.15,-.45,-.4),d.add(Se);const Re=new Ee(.18,32,32),Q=new G(Re,f);Q.position.set(0,-.35,-.8),d.add(Q),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(_e){const U=new an("X",{font:_e,size:.2,depth:.05}),oe=new dt({color:0}),K=new G(U,oe);K.position.set(-.34,1,.5),d.add(K);const ce=new an("O",{font:_e,size:.2,depth:.05}),xe=new dt({color:0}),te=new G(ce,xe);te.position.set(.16,1,.53),te.rotation.y=ht.degToRad(32),d.add(te)}),r.add(d),i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),Ot(()=>e.bodyPosition,_e=>{d.position.set(_e.x,_e.y,_e.z)}),Ot(()=>e.cameraPosition,_e=>{s.position.set(e.bodyPosition.x,1,_e),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:ri(n.background?"no-bg":"three-canvas")},null,2))}}),tp=gn(jE,[["__scopeId","data-v-46de1bfd"]]),ZE=Zt({__name:"BlueBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.04,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.2);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new ut({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,aw=Zt({__name:"DiamondBear",setup(n){const e=Et(null);return pn(()=>{const t=new ai,i=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),r=new oi({antialias:!0,alpha:!0});r.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(r.domElement);const s=new li(16777215,5);t.add(s);const o=new ci(16777215,20);o.position.set(5,5,5),t.add(o);const a=new ut({uniforms:{time:{value:0}},vertexShader:sw,fragmentShader:ow,transparent:!0,opacity:.1}),c=new mt,l=new Ee(1,32,32),u=new G(l,a);u.scale.set(.85,.85,.8),u.position.y=-.2,c.add(u);const h=new Ee(.6,32,32),f=new G(h,a);f.scale.set(1,.95,.95),f.position.set(0,1,0),c.add(f);const d=new Ee(.25,32,32),_=new G(d,a);_.position.set(-.45,1.35,-.1),c.add(_);const y=new G(d,a);y.position.set(.45,1.35,-.1),c.add(y);const m=new Ee(.25,32,32),p=new G(m,a);p.scale.set(1,.6,.8),p.position.set(0,.85,.5),c.add(p);const w=new Ee(.35,32,32),M=new G(w,a);M.scale.set(.75,1.25,.65),M.position.set(-.7,-.15,.2),c.add(M);const S=new G(w,a);S.scale.set(.75,1.25,.65),S.position.set(.7,-.15,.2),c.add(S);const D=new Ee(.3,32,32),C=new G(D,a);C.scale.set(1,.72,1.5),C.position.set(-.4,-1.45,.17),c.add(C);const A=new G(D,a);A.scale.set(1,.72,1.5),A.position.set(.4,-1.45,.17),c.add(A);const I=new on(.2,.22,.6,32),ne=new G(I,a);ne.position.set(-.4,-1.05,0),c.add(ne);const x=new G(I,a);x.position.set(.4,-1.05,0),c.add(x);const b=new Ee(.44,32,32),B=new G(b,a);B.position.set(-.15,-.45,-.4),c.add(B);const H=new G(b,a);H.position.set(.15,-.45,-.4),c.add(H);const Z=new Ee(.18,32,32),re=new G(Z,a);re.position.set(0,-.35,-.75),c.add(re);const W=new Cs({color:16738740,metalness:1,roughness:.44}),J=new Cs({color:16776960,metalness:1,roughness:.44}),O=new qt;O.moveTo(0,.15),O.lineTo(.1,0),O.lineTo(0,-.15),O.lineTo(-.1,0),O.lineTo(0,.15);const pe={depth:.07,bevelEnabled:!1},de=new jt(O,pe),ge=new G(de,W);ge.position.set(-.25,1,.5),ge.rotation.y=Math.PI/30,c.add(ge);const Se=new G(de,J);Se.position.set(.25,1,.5),Se.rotation.y=Math.PI/30,c.add(Se),t.add(c),i.position.set(0,1,4),i.lookAt(0,0,0);function Re(){requestAnimationFrame(Re),a.uniforms.time.value+=.1,c.rotation.y+=.02,r.render(t,i)}Re(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),cw=gn(aw,[["__scopeId","data-v-a7796925"]]),Jh=`
  varying vec2 vUv;
        void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `,lw=Zt({__name:"GlassBear",setup(n){const e=Et(null);return pn(()=>{const t=new ai,i=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),r=new oi({antialias:!0,alpha:!0});r.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(r.domElement);const s=new li(16777215,.5);t.add(s);const o=new ci(16777215,10);o.position.set(5,5,5),t.add(o);const a=new ut({uniforms:{time:{value:0},opacity:{value:.8}},vertexShader:Jh,fragmentShader:Qh,transparent:!0}),c=new ut({uniforms:{time:{value:0},opacity:{value:.6}},vertexShader:Jh,fragmentShader:Qh,transparent:!0,depthWrite:!1}),l=new mt,u=new Ee(1,32,32),h=new G(u,c);h.scale.set(.85,.85,.8),h.position.y=-.2,l.add(h);const f=new Ee(.6,32,32),d=new G(f,c);d.scale.set(1,.95,.95),d.position.set(0,1,0),l.add(d);const _=new Ee(.25,32,32),y=new G(_,a);y.position.set(-.45,1.35,-.1),l.add(y);const m=new G(_,c);m.position.set(.45,1.35,-.1),l.add(m);const p=new Ee(.25,32,32),w=new G(p,a);w.scale.set(1,.6,.8),w.position.set(0,.85,.5),l.add(w);const M=new Ee(.35,32,32),S=new G(M,a);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),l.add(S);const D=new G(M,a);D.scale.set(.75,1.25,.65),D.position.set(.7,-.15,.2),l.add(D);const C=new Ee(.3,32,32),A=new G(C,a);A.scale.set(1,.72,1.5),A.position.set(-.4,-1.45,.17),l.add(A);const I=new G(C,a);I.scale.set(1,.72,1.5),I.position.set(.4,-1.45,.17),l.add(I);const ne=new on(.2,.22,.6,32),x=new G(ne,a);x.position.set(-.4,-1.05,0),l.add(x);const b=new G(ne,a);b.position.set(.4,-1.05,0),l.add(b);const B=new Ee(.44,32,32);new G(B,a).position.set(-.15,-.45,-.4),new G(B,a).position.set(.15,-.45,-.4);const re=new Ee(.18,32,32),W=new G(re,a);W.position.set(0,-.35,-.75),l.add(W);const J=new qt;J.moveTo(0,0),J.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),J.bezierCurveTo(-.6,.3,0,.6,0,1),J.bezierCurveTo(0,.6,.6,.3,.6,0),J.bezierCurveTo(.6,-.3,0,-.3,0,0);const O=new Cs({color:8900331,metalness:1,roughness:.44}),pe=new Cs({color:16776960,metalness:1,roughness:.44}),de=new qt;de.moveTo(0,.15),de.lineTo(.1,0),de.lineTo(0,-.15),de.lineTo(-.1,0),de.lineTo(0,.15);const ge={depth:.07,bevelEnabled:!1},Se=new jt(de,ge),Re=new G(Se,O);Re.position.set(-.25,1,.5),Re.rotation.y=Math.PI/30,l.add(Re);const Q=new G(Se,pe);Q.position.set(.25,1,.5),Q.rotation.y=Math.PI/30,l.add(Q),new tt({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const fe={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},_e=new tt({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),U=new jt(J,fe),oe=new G(U,_e);oe.scale.set(.5,.5,.5),oe.position.set(0,0,0),oe.rotation.y=Math.PI,oe.rotation.x=Math.PI,l.add(oe);const K=new qt;K.moveTo(0,.6),K.lineTo(.3,.3),K.lineTo(.6,0),K.lineTo(.3,-.3),K.lineTo(0,-.6),K.lineTo(-.3,-.3),K.lineTo(-.6,0),K.lineTo(-.3,.3),K.lineTo(0,.6);const ce={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},xe=new jt(K,ce),te=new tt({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),g=new G(xe,te);g.scale.set(.5,.5,.5),g.position.set(0,0,0),t.add(l),i.position.set(0,1,4),i.lookAt(0,0,0);const T=()=>{requestAnimationFrame(T),a.uniforms.time.value+=.03,l.rotation.y+=.03,r.render(t,i)};T(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),uw=gn(lw,[["__scopeId","data-v-fa1425bf"]]),hw=Zt({__name:"BluePinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.02,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.5);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new tt({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),h=new tt({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=m=>{const p=new mt,w=new Ee(1,32,32),M=new G(w,m);M.scale.set(.85,.85,.8),M.position.y=-.2,p.add(M);const S=new Ee(.6,32,32),D=new G(S,m);D.scale.set(1,.95,.95),D.position.set(0,1,0),p.add(D);const C=new Ee(.25,32,32),A=new G(C,m);A.scale.set(1,.6,.8),A.position.set(0,.85,.5),p.add(A),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(xe){const te=new an("X",{font:xe,size:.18,depth:.05}),g=new dt({color:0}),T=new G(te,g);T.position.set(-.3,.99,.53),T.rotation.x=ht.degToRad(-5),T.rotation.y=ht.degToRad(-15),p.add(T);const L=new an("+",{font:xe,size:.25,depth:.1}),F=new dt({color:0}),N=new G(L,F);N.position.set(.14,.99,.53),N.rotation.y=ht.degToRad(12),N.rotation.x=ht.degToRad(-5),p.add(N)});const ne=new qt;ne.moveTo(0,0),ne.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),ne.bezierCurveTo(-.6,.3,0,.6,0,1),ne.bezierCurveTo(0,.6,.6,.3,.6,0),ne.bezierCurveTo(.6,-.3,0,-.3,0,0);const x={depth:.05,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.05,bevelThickness:.05},b=new jt(ne,x),B=new dt({color:0}),H=new G(b,B);H.scale.set(.1,.1,.1),H.rotation.z=ht.degToRad(210),H.rotation.x=ht.degToRad(5),H.rotation.y=ht.degToRad(-45),H.position.set(-.4,.9,.45),p.add(H);const Z=new Ee(.25,32,32),re=new G(Z,u);re.position.set(-.45,1.35,-.1),p.add(re);const W=new G(Z,h);W.position.set(.45,1.35,-.1),p.add(W);const J=new Ee(.35,32,32),O=new G(J,u);O.scale.set(.75,1.25,.65),O.position.set(-.7,-.15,.2),p.add(O);const pe=new G(J,h);pe.scale.set(.75,1.25,.65),pe.position.set(.7,-.15,.2),p.add(pe);const de=new on(.2,.22,.6,32),ge=new G(de,u);ge.position.set(-.4,-1.05,0),p.add(ge);const Se=new G(de,h);Se.position.set(.4,-1.05,0),p.add(Se);const Re=new Ee(.3,32,32),Q=new G(Re,u);Q.scale.set(1,.72,1.5),Q.position.set(-.4,-1.45,.17),p.add(Q);const fe=new G(Re,h);fe.scale.set(1,.72,1.5),fe.position.set(.4,-1.45,.17),p.add(fe);const _e=new Ee(.44,32,32),U=new G(_e,u);U.position.set(-.15,-.45,-.4),p.add(U);const oe=new G(_e,h);oe.position.set(.15,-.45,-.4),p.add(oe);const K=new Ee(.18,32,32),ce=new G(K,m);return ce.position.set(0,-.35,-.8),p.add(ce),p},d=new mt,_=f(u),y=f(h);_.position.x=-.01,y.position.x=.01,d.add(_),d.add(y),r.add(d),s.position.z=4,i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0)}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:"three-canvas"},null,512))}}),fw=gn(hw,[["__scopeId","data-v-9e6b205d"]]),dw=Zt({__name:"HalfTransparentBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),p.rotation.y+=.03,u.uniforms.time.value+=.04,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.2);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new ut({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,y=new ut({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:d,fragmentShader:_,transparent:!0,depthWrite:!1}),m=new ut({uniforms:{time:{value:0},opacity:{value:.4}},vertexShader:d,fragmentShader:_,transparent:!0,depthWrite:!1}),p=new mt,w=new Ee(1,32,32,0,Math.PI),M=new G(w,m),S=new G(w,y);M.scale.set(.85,.85,.8),S.scale.set(.85,.85,.8),M.position.y=-.2,S.position.y=-.2,M.rotation.y=Math.PI/2,S.rotation.y=Math.PI*1.5;const D=new An(1,32),C=new G(D,y);C.scale.set(.85,.85,.8),C.position.set(0,-.2,0),C.rotation.y=Math.PI/2;const A=new mt;A.add(M),A.add(S),A.add(C),p.add(A);const I=new Ee(.6,32,32,0,Math.PI),ne=new G(I,y);ne.scale.set(1,.95,.95),ne.position.set(0,1,0),ne.rotation.y=Math.PI*1.5;const x=new G(I,m);x.scale.set(1,.95,.95),x.position.set(0,1,0),x.rotation.y=Math.PI/2;const b=new An(.6,32),B=new G(b,y);B.position.set(0,.97,0),B.rotation.y=Math.PI/2;const H=new mt;H.add(ne),H.add(x),H.add(B),p.add(H);const Z=new Ee(.25,32,32),re=new G(Z,y);re.position.set(-.45,1.35,-.1),p.add(re);const W=new G(Z,m);W.position.set(.45,1.35,-.1),p.add(W);const J=new Ee(.25,32,32,Math.PI/2,Math.PI),O=new G(J,y);O.scale.set(1,.6,.8),O.position.set(0,.82,.5),O.rotation.y=Math.PI;const pe=new Ee(.25,32,32,Math.PI/2,Math.PI),de=new G(pe,m);de.scale.set(1,.6,.8),de.position.set(0,.82,.5),de.rotation.y=0;const ge=new An(.25,32),Se=new G(ge,y);Se.scale.set(1.25,.6,.8),Se.position.set(0,.85,.5),Se.rotation.x=Math.PI/2;const Re=new mt;Re.add(O),Re.add(de),Re.add(Se),p.add(Re);const Q=new qt;Q.moveTo(0,0),Q.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Q.bezierCurveTo(-.6,.3,0,.6,0,1),Q.bezierCurveTo(0,.6,.6,.3,.6,0),Q.bezierCurveTo(.6,-.3,0,-.3,0,0);const fe={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new tt({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const _e=new jt(Q,fe),U=new G(_e,f);U.scale.set(.5,.5,.5),U.position.set(0,0,0),U.rotation.y=Math.PI,U.rotation.x=Math.PI,p.add(U);const oe=new Ee(.35,32,32),K=new G(oe,y);K.scale.set(.75,1.25,.65),K.position.set(-.7,-.15,.2),p.add(K);const ce=new G(oe,m);ce.scale.set(.75,1.25,.65),ce.position.set(.7,-.15,.2),p.add(ce);const xe=new on(.2,.22,.6,32),te=new G(xe,y);te.position.set(-.4,-1.05,0),p.add(te);const g=new G(xe,m);g.position.set(.4,-1.05,0),p.add(g);const T=new Ee(.3,32,32),L=new G(T,y);L.scale.set(1,.72,1.5),L.position.set(-.4,-1.45,.17),p.add(L);const F=new G(T,m);F.scale.set(1,.72,1.5),F.position.set(.4,-1.45,.17),p.add(F);const N=new Ee(.44,32,32),j=new G(N,y);j.position.set(-.15,-.45,-.4),p.add(j);const ee=new G(N,h);ee.position.set(.15,-.45,-.4),p.add(ee);const E=new Ee(.18,32,32),v=new G(E,f);v.position.set(0,-.35,-.8),p.add(v),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(X){const V=new an("X",{font:X,size:.18,depth:.05}),Y=new dt({color:0}),ue=new G(V,Y);ue.position.set(-.3,.99,.53),ue.rotation.x=ht.degToRad(-5),ue.rotation.y=ht.degToRad(-15),p.add(ue);const le=new an("+",{font:X,size:.25,depth:.1}),ve=new dt({color:0}),Te=new G(le,ve);Te.position.set(.14,.99,.53),Te.rotation.y=ht.degToRad(12),Te.rotation.x=ht.degToRad(-5),p.add(Te)}),r.add(p),i(),p.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),Ot(()=>e.bodyPosition,X=>{p.position.set(X.x,X.y,X.z)}),Ot(()=>e.cameraPosition,X=>{s.position.set(e.bodyPosition.x,1,X),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:ri(n.background?"no-bg":"three-canvas")},null,2))}}),pw=gn(dw,[["__scopeId","data-v-7fbce4ad"]]),mw=Zt({__name:"HalfBlueBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),le&&(w.rotation.y+=.03,u.uniforms.time.value+=.04),o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.2);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new ut({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `}),h=new ut({uniforms:{time:{value:0},color1:{value:new Ge(52945)},color2:{value:new Ge(16738740)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `}),f=new tt({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),d=new tt({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.44}),_=new tt({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});new tt({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const y=new tt({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99,depthWrite:!1,depthTest:!0}),m=`
    varying vec2 vUv;
          void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `;new ut({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:m,fragmentShader:p,transparent:!0,depthWrite:!1}),new ut({uniforms:{time:{value:0},opacity:{value:.4}},vertexShader:m,fragmentShader:p,transparent:!0,depthWrite:!1});const w=new mt,M=new Ee(1,32,32,0,Math.PI),S=new G(M,d),D=new G(M,f);S.scale.set(.85,.85,.8),D.scale.set(.85,.85,.8),S.position.y=-.2,D.position.y=-.2,S.rotation.y=Math.PI/2,D.rotation.y=Math.PI*1.5;const C=new An(1,32),A=new G(C,f);A.scale.set(.85,.85,.8),A.position.set(0,-.2,0),A.rotation.y=Math.PI/2;const I=new mt;I.add(S),I.add(D),I.add(A),w.add(I);const ne=new Ee(.6,32,32,0,Math.PI),x=new G(ne,f);x.scale.set(1,.95,.95),x.position.set(0,1,0),x.rotation.y=Math.PI*1.5;const b=new G(ne,d);b.scale.set(1,.95,.95),b.position.set(0,1,0),b.rotation.y=Math.PI/2;const B=new An(.6,32),H=new G(B,f);H.position.set(0,1,0),H.rotation.y=Math.PI/2,H.scale.set(1,.95,.95);const Z=new mt;Z.add(x),Z.add(b),Z.add(H),w.add(Z);const re=new Ee(.25,32,32),W=new G(re,f);W.position.set(-.45,1.35,-.1),w.add(W);const J=new G(re,d);J.position.set(.45,1.35,-.1),w.add(J);const O=new Ee(.25,32,32,Math.PI/2,Math.PI),pe=new G(O,f);pe.scale.set(1.1,.6,.8),pe.position.set(0,.84,.5),pe.rotation.y=Math.PI;const de=new Ee(.25,32,32,Math.PI/2,Math.PI),ge=new G(de,d);ge.scale.set(1.1,.6,.8),ge.position.set(0,.84,.5),ge.rotation.y=0;const Se=new An(.25,32),Re=new G(Se,f);Re.scale.set(.8,.6,.8),Re.position.set(0,.84,.5),Re.rotation.y=Math.PI/2;const Q=new mt;Q.add(pe),Q.add(ge),Q.add(Re),w.add(Q);const fe=new qt;fe.moveTo(0,0),fe.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),fe.bezierCurveTo(-.6,.3,0,.6,0,1),fe.bezierCurveTo(0,.6,.6,.3,.6,0),fe.bezierCurveTo(.6,-.3,0,-.3,0,0);const _e={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new tt({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const U=new jt(fe,_e);new dt({color:0}),new dt({color:16738740});const oe=new G(U,_);oe.scale.set(.1,.1,.1),oe.rotation.z=ht.degToRad(210),oe.rotation.x=ht.degToRad(5),oe.rotation.y=ht.degToRad(-45),oe.position.set(-.4,.9,.45);const K=new G(U,u);K.scale.set(.35,.35,.35),K.position.set(.3,-.3,0),K.rotation.y=Math.PI,K.rotation.x=Math.PI,w.add(K);const ce=new G(U,h);ce.scale.set(.25,.25,.25),ce.position.set(.27,.2,0),ce.rotation.y=Math.PI,ce.rotation.x=Math.PI,w.add(ce);const xe=new Ee(.35,32,32),te=new G(xe,f);te.scale.set(.75,1.25,.65),te.position.set(-.7,-.15,.2),w.add(te);const g=new G(xe,d);g.scale.set(.75,1.25,.65),g.position.set(.7,-.15,.2),w.add(g);const T=new on(.2,.22,.6,32),L=new G(T,f);L.position.set(-.4,-1.05,0),w.add(L);const F=new G(T,d);F.position.set(.4,-1.05,0),w.add(F);const N=new Ee(.3,32,32),j=new G(N,f);j.scale.set(1,.72,1.5),j.position.set(-.4,-1.45,.17),w.add(j);const ee=new G(N,d);ee.scale.set(1,.72,1.5),ee.position.set(.4,-1.45,.17),w.add(ee);const E=new Ee(.44,32,32),v=new G(E,f);v.position.set(-.15,-.45,-.4),w.add(v);const P=new G(E,d);P.position.set(.15,-.45,-.4),w.add(P);const X=new Ee(.18,32,32),V=new G(X,y);V.position.set(0,-.35,-.8),w.add(V),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(he){const ye=new an("X",{font:he,size:.18,depth:.05}),Ne=new dt({color:0}),De=new G(ye,Ne);De.position.set(-.3,.99,.53),De.rotation.x=ht.degToRad(-5),De.rotation.y=ht.degToRad(-15),w.add(De);const Ae=new an("+",{font:he,size:.25,depth:.1}),Be=new dt({color:0}),Ce=new G(Ae,Be);Ce.position.set(.14,.99,.53),Ce.rotation.y=ht.degToRad(12),Ce.rotation.x=ht.degToRad(-5),w.add(Ce)}),K.renderOrder=0,ce.renderOrder=1,D.renderOrder=0,S.renderOrder=0,x.renderOrder=0,b.renderOrder=0,v.renderOrder=-1,P.renderOrder=-1,V.renderOrder=1,r.add(w),w.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),s.position.z=4;const ue={x:0,y:0};let le=!0,ve=null;const Te=he=>{le=!1,ue.x=he.clientX/window.innerWidth*2-1,ue.y=-(he.clientY/window.innerHeight)*2+1;const ye=ue.x*Math.PI*.2,Ne=ue.y*Math.PI*.2;w.rotation.y=ye,w.rotation.x=Ne,clearTimeout(ve),ve=setTimeout(()=>{le=!0},1e5)};window.addEventListener("mousemove",Te),i(),Ot(()=>e.bodyPosition,he=>{w.position.set(he.x,he.y,he.z)}),Ot(()=>e.cameraPosition,he=>{s.position.set(e.bodyPosition.x,1,he),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:ri(n.background?"no-bg":"three-canvas")},null,2))}}),gw=gn(mw,[["__scopeId","data-v-c0e76b3a"]]),_w=Zt({__name:"SkyBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),B.rotation.y+=.03,C.uniforms.time.value+=.04,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi;o.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(o.domElement);const a=new kr(500,500),c=new ut({uniforms:{color1:{value:new Ge(8900331)},color2:{value:new Ge(16777215)}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `,side:Xt}),l=new G(a,c);l.position.z=-50,l.rotation.x=Math.PI/2,r.add(l);const u=new kr(500,500),h=new dt({color:2263842}),f=new G(u,h);f.rotation.x=-Math.PI/2,r.add(f);const d=new Xr(10,20,10),_=new dt({color:9127187});for(let Be=-20;Be<=20;Be+=20){const Ce=new G(d,_);Ce.position.set(Be,10,-30),r.add(Ce)}const y=new on(1,1,5),m=new dt({color:9127187}),p=new kl(3,6),w=new dt({color:25600});for(let Be=-40;Be<=40;Be+=20){const Ce=new G(y,m);Ce.position.set(Be,2.5,-20),r.add(Ce);const We=new G(p,w);We.position.set(Be,8,-20),r.add(We)}const M=new li(16777215,.6);r.add(M);const S=new ci(16777215,1.2);S.position.set(5,5,5),r.add(S);const D=new nr(16777215,2,50);D.position.set(0,2,4),r.add(D);const C=new ut({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `;new ut({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:x,fragmentShader:b,transparent:!0,depthWrite:!1}),new ut({uniforms:{time:{value:0},opacity:{value:.4}},vertexShader:x,fragmentShader:b,transparent:!0,depthWrite:!1});const B=new mt,H=new Ee(1,32,32,0,Math.PI),Z=new G(H,I),re=new G(H,A);Z.scale.set(.85,.85,.8),re.scale.set(.85,.85,.8),Z.position.y=-.2,re.position.y=-.2,Z.rotation.y=Math.PI/2,re.rotation.y=Math.PI*1.5;const W=new An(1,32),J=new G(W,A);J.scale.set(.85,.85,.8),J.position.set(0,-.2,0),J.rotation.y=Math.PI/2;const O=new mt;O.add(Z),O.add(re),O.add(J),B.add(O);const pe=new Ee(.6,32,32,0,Math.PI),de=new G(pe,A);de.scale.set(1,.95,.95),de.position.set(0,1,0),de.rotation.y=Math.PI*1.5;const ge=new G(pe,I);ge.scale.set(1,.95,.95),ge.position.set(0,1,0),ge.rotation.y=Math.PI/2;const Se=new An(.6,32),Re=new G(Se,A);Re.position.set(0,.97,0),Re.rotation.y=Math.PI/2;const Q=new mt;Q.add(de),Q.add(ge),Q.add(Re),B.add(Q);const fe=new Ee(.25,32,32),_e=new G(fe,A);_e.position.set(-.45,1.35,-.1),B.add(_e);const U=new G(fe,I);U.position.set(.45,1.35,-.1),B.add(U);const oe=new Ee(.25,32,32,Math.PI/2,Math.PI),K=new G(oe,A);K.scale.set(1.1,.6,.8),K.position.set(0,.84,.5),K.rotation.y=Math.PI;const ce=new Ee(.25,32,32,Math.PI/2,Math.PI),xe=new G(ce,I);xe.scale.set(1.1,.6,.8),xe.position.set(0,.84,.5),xe.rotation.y=0;const te=new An(.25,32),g=new G(te,A);g.scale.set(1.25,.6,.8),g.position.set(0,.85,.5),g.rotation.x=Math.PI/2;const T=new mt;T.add(K),T.add(xe),T.add(g),B.add(T);const L=new qt;L.moveTo(0,0),L.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),L.bezierCurveTo(-.6,.3,0,.6,0,1),L.bezierCurveTo(0,.6,.6,.3,.6,0),L.bezierCurveTo(.6,-.3,0,-.3,0,0);const F={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new tt({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const N=new jt(L,F),j=new G(N,ne);j.scale.set(.25,.25,.25),j.position.set(.5,0,0),j.rotation.y=Math.PI,j.rotation.x=Math.PI,B.add(j);const ee=new G(N,ne);ee.scale.set(.25,.25,.25),ee.position.set(0,0,0),ee.rotation.y=Math.PI,ee.rotation.x=Math.PI;const E=new Ee(.35,32,32),v=new G(E,A);v.scale.set(.75,1.25,.65),v.position.set(-.7,-.15,.2),B.add(v);const P=new G(E,I);P.scale.set(.75,1.25,.65),P.position.set(.7,-.15,.2),B.add(P);const X=new on(.2,.22,.6,32),V=new G(X,A);V.position.set(-.4,-1.05,0),B.add(V);const Y=new G(X,I);Y.position.set(.4,-1.05,0),B.add(Y);const ue=new Ee(.3,32,32),le=new G(ue,A);le.scale.set(1,.72,1.5),le.position.set(-.4,-1.45,.17),B.add(le);const ve=new G(ue,I);ve.scale.set(1,.72,1.5),ve.position.set(.4,-1.45,.17),B.add(ve);const Te=new Ee(.44,32,32),he=new G(Te,A);he.position.set(-.15,-.45,-.4),B.add(he);const ye=new G(Te,I);ye.position.set(.15,-.45,-.4),B.add(ye);const Ne=new Ee(.18,32,32),De=new G(Ne,ne);De.position.set(0,-.35,-.8),B.add(De),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Be){const Ce=new an("X",{font:Be,size:.18,depth:.05}),We=new dt({color:0}),z=new G(Ce,We);z.position.set(-.3,.99,.53),z.rotation.x=ht.degToRad(-5),z.rotation.y=ht.degToRad(-15),B.add(z);const Pe=new an("+",{font:Be,size:.25,depth:.1}),ae=new dt({color:0}),me=new G(Pe,ae);me.position.set(.14,.99,.53),me.rotation.y=ht.degToRad(12),me.rotation.x=ht.degToRad(-5),B.add(me)}),r.add(B),i(),B.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),Ot(()=>e.bodyPosition,Be=>{B.position.set(Be.x,Be.y,Be.z)}),Ot(()=>e.cameraPosition,Be=>{s.position.set(e.bodyPosition.x,1,Be),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:ri(n.background?"no-bg":"three-canvas")},null,2))}}),vw=gn(_w,[["__scopeId","data-v-e844f33f"]]),xw=[{path:"/3d-bear-arts",name:"ThreeScene",component:rw},{path:"/3d-bear-arts/half",name:"NewBear",component:gw},{path:"/3d-bear-arts/halfTransparent",name:"Transparent",component:pw},{path:"/3d-bear-arts/bluePink",name:"BluePinkBear",component:fw},{path:"/3d-bear-arts/diamond",name:"DiamondBear",component:cw},{path:"/3d-bear-arts/pink",name:"PinkBear",component:ep},{path:"/3d-bear-arts/purple",name:"PurpleBear",component:tp},{path:"/3d-bear-arts/blue",name:"BlueBear",component:np},{path:"/3d-bear-arts/glass",name:"GlassBear",component:uw},{path:"/3d-bear-arts/sky",name:"SkyBear",component:vw}],yw=Vg({history:xg(),routes:xw}),lp=O0(k0);lp.use(yw);lp.mount("#app");
