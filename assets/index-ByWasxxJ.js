...
`)a=0,c-=r;else{const h=Zw(u,s,a,c,t);a+=h.offsetX,o.push(h.path)}}return o}function Zw(n,e,t,i,s){const r=s.glyphs[n]||s.glyphs["?"];if(!r){console.error('THREE.Font: character "'+n+'" does not exists in font family '+s.familyName+".");return}const o=new $w;let a,c,l,u,h,f,d,_;if(r.o){const y=r._cachedOutline||(r._cachedOutline=r.o.split(" "));for(let m=0,p=y.length;m<p;)switch(y[m++]){case"m":a=y[m++]*e+t,c=y[m++]*e+i,o.moveTo(a,c);break;case"l":a=y[m++]*e+t,c=y[m++]*e+i,o.lineTo(a,c);break;case"q":l=y[m++]*e+t,u=y[m++]*e+i,h=y[m++]*e+t,f=y[m++]*e+i,o.quadraticCurveTo(h,f,l,u);break;case"b":l=y[m++]*e+t,u=y[m++]*e+i,h=y[m++]*e+t,f=y[m++]*e+i,d=y[m++]*e+t,_=y[m++]*e+i,o.bezierCurveTo(h,f,d,_,l,u);break}}return{offsetX:r.ha*e,path:o}}class jt extends $t{constructor(e,t={}){const i=t.font;if(i===void 0)super();else{const s=i.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(s,t)}this.type="TextGeometry"}}const Jw=Kt({__name:"PinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return ln(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.03,o.render(s,r)};const s=new Wn,r=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Vn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=ss,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Yn(16777215,.6);s.add(a);const c=new qn(16777215,1.5);c.position.set(5,5,5),s.add(c);const l=new Ui(16777215,2,50);l.position.set(0,2,4),s.add(l);const u=new mt({uniforms:{time:{value:0},color1:{value:new He(16766720)},color2:{value:new He(16007990)}},vertexShader:`
        ...
        `}),h=new Xe({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=new Xe({color:13369344,metalness:.4,roughness:.3,clearcoat:.3,clearcoatRoughness:.2,transparent:!0,opacity:.99}),d=new ct,_=new we(1,32,32),y=new D(_,h);y.scale.set(.85,.85,.8),y.position.y=-.2,d.add(y);const m=new we(.6,32,32),p=new D(m,h);p.scale.set(1,.95,.95),p.position.set(0,1,0),d.add(p);const b=new we(.25,32,32),x=new D(b,h);x.position.set(-.45,1.35,-.1),d.add(x);const S=new D(b,h);S.position.set(.45,1.35,-.1),d.add(S);const I=new we(.25,32,32),C=new D(I,h);C.scale.set(1,.6,.8),C.position.set(0,.85,.5),d.add(C);const R=new Gt;R.moveTo(0,0),R.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),R.bezierCurveTo(-.6,.3,0,.6,0,1),R.bezierCurveTo(0,.6,.6,.3,.6,0),R.bezierCurveTo(.6,-.3,0,-.3,0,0);const U={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ne=new $t(R,U),M=new D(ne,f);M.scale.set(.5,.5,.5),M.position.set(0,.34,.8),M.rotation.y=Math.PI,M.rotation.x=Math.PI,d.add(M);const E=new we(.35,32,32),q=new D(E,h);q.scale.set(.75,1.25,.65),q.position.set(-.7,-.15,.2),d.add(q);const G=new D(E,h);G.scale.set(.75,1.25,.65),G.position.set(.7,-.15,.2),d.add(G);const j=new Mn(.2,.22,.6,32),se=new D(j,h);se.position.set(-.4,-1.05,0),d.add(se);const H=new D(j,h);H.position.set(.4,-1.05,0),d.add(H);const Z=new we(.3,32,32),B=new D(Z,h);B.scale.set(1,.72,1.5),B.position.set(-.4,-1.45,.17),d.add(B);const ge=new D(Z,h);ge.scale.set(1,.72,1.5),ge.position.set(.4,-1.45,.17),d.add(ge);const fe=new we(.44,32,32),ve=new D(fe,h);ve.position.set(-.15,-.45,-.4),d.add(ve);const Me=new D(fe,h);Me.position.set(.15,-.45,-.4),d.add(Me);const Le=new we(.18,32,32),Q=new D(Le,f);Q.position.set(0,-.35,-.8),d.add(Q),new Ni().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(K){const ce=new jt("X",{font:K,size:.2,depth:.05}),xe=new xt({color:0}),ee=new D(ce,xe);ee.position.set(-.34,1,.5),d.add(ee)});const le=new we(.1,32,32),O=new xt({color:0}),ie=new D(le,O);ie.position.set(.2,1.1,.54),d.add(ie),s.add(d),i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),r.position.set(e.bodyPosition.x,1,e.cameraPosition),r.lookAt(e.bodyPosition.x,0,0),Pt(()=>e.bodyPosition,K=>{d.position.set(K.x,K.y,K.z)}),Pt(()=>e.cameraPosition,K=>{r.position.set(e.bodyPosition.x,1,K),r.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,s)=>(en(),un("div",{ref_key:"threeCanvas",ref:t,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),sp=hn(Jw,[["__scopeId","data-v-d0efbfd4"]]),Qw=Kt({__name:"PurpleBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return ln(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.03,o.render(s,r)};const s=new Wn,r=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Vn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=ss,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Yn(16777215,.6);s.add(a);const c=new qn(16777215,1.5);c.position.set(5,5,5),s.add(c);const l=new Ui(16777215,2,50);l.position.set(0,2,4),s.add(l);const u=new mt({uniforms:{time:{value:0},color1:{value:new He(16766720)},color2:{value:new He(16007990)}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `}),h=new Xe({color:10573288,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});new Xe({color:16766720,metalness:.4,roughness:.3,clearcoat:.3,clearcoatRoughness:.2,transparent:!0,opacity:.99});const f=new Xe({color:16766720,metalness:.05,roughness:10,clearcoat:.6,clearcoatRoughness:.1,opacity:1,transparent:!1}),d=new ct,_=new we(1,32,32),y=new D(_,h);y.scale.set(.85,.85,.8),y.position.y=-.2,d.add(y);const m=new we(.6,32,32),p=new D(m,h);p.scale.set(1,.95,.95),p.position.set(0,1,0),d.add(p);const b=new we(.25,32,32),x=new D(b,h);x.position.set(-.45,1.35,-.1),d.add(x);const S=new D(b,h);S.position.set(.45,1.35,-.1),d.add(S);const I=new we(.25,32,32),C=new D(I,h);C.scale.set(1,.6,.8),C.position.set(0,.85,.5),d.add(C);const R=new Gt;R.moveTo(0,0),R.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),R.bezierCurveTo(-.6,.3,0,.6,0,1),R.bezierCurveTo(0,.6,.6,.3,.6,0),R.bezierCurveTo(.6,-.3,0,-.3,0,0);const U={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ne=new $t(R,U),M=new D(ne,u);M.scale.set(.5,.5,.5),M.position.set(0,.34,.8),M.rotation.y=Math.PI,M.rotation.x=Math.PI,d.add(M);const E=new we(.35,32,32),q=new D(E,h);q.scale.set(.75,1.25,.65),q.position.set(-.7,-.15,.2),d.add(q);const G=new D(E,h);G.scale.set(.75,1.25,.65),G.position.set(.7,-.15,.2),d.add(G);const j=new Mn(.2,.22,.6,32),se=new D(j,h);se.position.set(-.4,-1.05,0),d.add(se);const H=new D(j,h);H.position.set(.4,-1.05,0),d.add(H);const Z=new we(.3,32,32),B=new D(Z,h);B.scale.set(1,.72,1.5),B.position.set(-.4,-1.45,.17),d.add(B);const ge=new D(Z,h);ge.scale.set(1,.72,1.5),ge.position.set(.4,-1.45,.17),d.add(ge);const fe=new we(.44,32,32),ve=new D(fe,h);ve.position.set(-.15,-.45,-.4),d.add(ve);const Me=new D(fe,h);Me.position.set(.15,-.45,-.4),d.add(Me);const Le=new we(.18,32,32),Q=new D(Le,f);Q.position.set(0,-.35,-.8),d.add(Q),new Ni().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(le){const O=new jt("X",{font:le,size:.2,depth:.05}),ie=new xt({color:0}),K=new D(O,ie);K.position.set(-.34,1,.5),d.add(K);const ce=new jt("O",{font:le,size:.2,depth:.05}),xe=new xt({color:0}),ee=new D(ce,xe);ee.position.set(.16,1,.53),ee.rotation.y=Ze.degToRad(32),d.add(ee)}),s.add(d),i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),r.position.set(e.bodyPosition.x,1,e.cameraPosition),r.lookAt(e.bodyPosition.x,0,0),Pt(()=>e.bodyPosition,le=>{d.position.set(le.x,le.y,le.z)}),Pt(()=>e.cameraPosition,le=>{r.position.set(e.bodyPosition.x,1,le),r.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,s)=>(en(),un("div",{ref_key:"threeCanvas",ref:t,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),rp=hn(Qw,[["__scopeId","data-v-46de1bfd"]]),eE=Kt({__name:"BlueBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return ln(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.04,o.render(s,r)};const s=new Wn,r=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Vn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=ss,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Yn(16777215,.6);s.add(a);const c=new qn(16777215,1.2);c.position.set(5,5,5),s.add(c);const l=new Ui(16777215,2,50);l.position.set(0,2,4),s.add(l);const u=new mt({uniforms:{time:{value:0},color1:{value:new He(16766720)},color2:{value:new He(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,uE=Kt({__name:"DiamondBear",setup(n){const e=Et(null);return ln(()=>{const t=new Wn,i=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),s=new Vn({antialias:!0,alpha:!0});s.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(s.domElement);const r=new Yn(16777215,5);t.add(r);const o=new qn(16777215,20);o.position.set(5,5,5),t.add(o);const a=new mt({uniforms:{time:{value:0}},vertexShader:cE,fragmentShader:lE,transparent:!0,opacity:.1}),c=new ct,l=new we(1,32,32),u=new D(l,a);u.scale.set(.85,.85,.8),u.position.y=-.2,c.add(u);const h=new we(.6,32,32),f=new D(h,a);f.scale.set(1,.95,.95),f.position.set(0,1,0),c.add(f);const d=new we(.25,32,32),_=new D(d,a);_.position.set(-.45,1.35,-.1),c.add(_);const y=new D(d,a);y.position.set(.45,1.35,-.1),c.add(y);const m=new we(.25,32,32),p=new D(m,a);p.scale.set(1,.6,.8),p.position.set(0,.85,.5),c.add(p);const b=new we(.35,32,32),x=new D(b,a);x.scale.set(.75,1.25,.65),x.position.set(-.7,-.15,.2),c.add(x);const S=new D(b,a);S.scale.set(.75,1.25,.65),S.position.set(.7,-.15,.2),c.add(S);const I=new we(.3,32,32),C=new D(I,a);C.scale.set(1,.72,1.5),C.position.set(-.4,-1.45,.17),c.add(C);const R=new D(I,a);R.scale.set(1,.72,1.5),R.position.set(.4,-1.45,.17),c.add(R);const U=new Mn(.2,.22,.6,32),ne=new D(U,a);ne.position.set(-.4,-1.05,0),c.add(ne);const M=new D(U,a);M.position.set(.4,-1.05,0),c.add(M);const E=new we(.44,32,32),q=new D(E,a);q.position.set(-.15,-.45,-.4),c.add(q);const G=new D(E,a);G.position.set(.15,-.45,-.4),c.add(G);const j=new we(.18,32,32),se=new D(j,a);se.position.set(0,-.35,-.75),c.add(se);const H=new Dr({color:16738740,metalness:1,roughness:.44}),Z=new Dr({color:16776960,metalness:1,roughness:.44}),B=new Gt;B.moveTo(0,.15),B.lineTo(.1,0),B.lineTo(0,-.15),B.lineTo(-.1,0),B.lineTo(0,.15);const ge={depth:.07,bevelEnabled:!1},fe=new $t(B,ge),ve=new D(fe,H);ve.position.set(-.25,1,.5),ve.rotation.y=Math.PI/30,c.add(ve);const Me=new D(fe,Z);Me.position.set(.25,1,.5),Me.rotation.y=Math.PI/30,c.add(Me),t.add(c),i.position.set(0,1,4),i.lookAt(0,0,0);function Le(){requestAnimationFrame(Le),a.uniforms.time.value+=.1,c.rotation.y+=.02,s.render(t,i)}Le(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),s.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(en(),un("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),hE=hn(uE,[["__scopeId","data-v-a7796925"]]),Qh=`
  ...
  `,fE=Kt({__name:"GlassBear",setup(n){const e=Et(null);return ln(()=>{const t=new Wn,i=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),s=new Vn({antialias:!0,alpha:!0});s.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(s.domElement);const r=new Yn(16777215,.5);t.add(r);const o=new qn(16777215,10);o.position.set(5,5,5),t.add(o);const a=new mt({uniforms:{time:{value:0},opacity:{value:.8}},vertexShader:Qh,fragmentShader:ef,transparent:!0}),c=new mt({uniforms:{time:{value:0},opacity:{value:.6}},vertexShader:Qh,fragmentShader:ef,transparent:!0,depthWrite:!1}),l=new ct,u=new we(1,32,32),h=new D(u,c);h.scale.set(.85,.85,.8),h.position.y=-.2,l.add(h);const f=new we(.6,32,32),d=new D(f,c);d.scale.set(1,.95,.95),d.position.set(0,1,0),l.add(d);const _=new we(.25,32,32),y=new D(_,a);y.position.set(-.45,1.35,-.1),l.add(y);const m=new D(_,c);m.position.set(.45,1.35,-.1),l.add(m);const p=new we(.25,32,32),b=new D(p,a);b.scale.set(1,.6,.8),b.position.set(0,.85,.5),l.add(b);const x=new we(.35,32,32),S=new D(x,a);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),l.add(S);const I=new D(x,a);I.scale.set(.75,1.25,.65),I.position.set(.7,-.15,.2),l.add(I);const C=new we(.3,32,32),R=new D(C,a);R.scale.set(1,.72,1.5),R.position.set(-.4,-1.45,.17),l.add(R);const U=new D(C,a);U.scale.set(1,.72,1.5),U.position.set(.4,-1.45,.17),l.add(U);const ne=new Mn(.2,.22,.6,32),M=new D(ne,a);M.position.set(-.4,-1.05,0),l.add(M);const E=new D(ne,a);E.position.set(.4,-1.05,0),l.add(E);const q=new we(.44,32,32);new D(q,a).position.set(-.15,-.45,-.4),new D(q,a).position.set(.15,-.45,-.4);const se=new we(.18,32,32),H=new D(se,a);H.position.set(0,-.35,-.75),l.add(H);const Z=new Gt;Z.moveTo(0,0),Z.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Z.bezierCurveTo(-.6,.3,0,.6,0,1),Z.bezierCurveTo(0,.6,.6,.3,.6,0),Z.bezierCurveTo(.6,-.3,0,-.3,0,0);const B=new Dr({color:8900331,metalness:1,roughness:.44}),ge=new Dr({color:16776960,metalness:1,roughness:.44}),fe=new Gt;fe.moveTo(0,.15),fe.lineTo(.1,0),fe.lineTo(0,-.15),fe.lineTo(-.1,0),fe.lineTo(0,.15);const ve={depth:.07,bevelEnabled:!1},Me=new $t(fe,ve),Le=new D(Me,B);Le.position.set(-.25,1,.5),Le.rotation.y=Math.PI/30,l.add(Le);const Q=new D(Me,ge);Q.position.set(.25,1,.5),Q.rotation.y=Math.PI/30,l.add(Q),new Xe({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const de={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},le=new Xe({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),O=new $t(Z,de),ie=new D(O,le);ie.scale.set(.5,.5,.5),ie.position.set(0,0,0),ie.rotation.y=Math.PI,ie.rotation.x=Math.PI,l.add(ie);const K=new Gt;K.moveTo(0,.6),K.lineTo(.3,.3),K.lineTo(.6,0),K.lineTo(.3,-.3),K.lineTo(0,-.6),K.lineTo(-.3,-.3),K.lineTo(-.6,0),K.lineTo(-.3,.3),K.lineTo(0,.6);const ce={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},xe=new $t(K,ce),ee=new Xe({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),g=new D(xe,ee);g.scale.set(.5,.5,.5),g.position.set(0,0,0),t.add(l),i.position.set(0,1,4),i.lookAt(0,0,0);const T=()=>{requestAnimationFrame(T),a.uniforms.time.value+=.03,l.rotation.y+=.03,s.render(t,i)};T(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),s.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(en(),un("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),dE=hn(fE,[["__scopeId","data-v-fa1425bf"]]),pE=Kt({__name:"BluePinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return ln(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.02,o.render(s,r)};const s=new Wn,r=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Vn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=ss,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Yn(16777215,.6);s.add(a);const c=new qn(16777215,1.5);c.position.set(5,5,5),s.add(c);const l=new Ui(16777215,2,50);l.position.set(0,2,4),s.add(l);const u=new Xe({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),h=new Xe({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=m=>{const p=new ct,b=new we(1,32,32),x=new D(b,m);x.scale.set(.85,.85,.8),x.position.y=-.2,p.add(x);const S=new we(.6,32,32),I=new D(S,m);I.scale.set(1,.95,.95),I.position.set(0,1,0),p.add(I);const C=new we(.25,32,32),R=new D(C,m);R.scale.set(1,.6,.8),R.position.set(0,.85,.5),p.add(R),new Ni().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(xe){const ee=new jt("X",{font:xe,size:.18,depth:.05}),g=new xt({color:0}),T=new D(ee,g);T.position.set(-.3,.99,.53),T.rotation.x=Ze.degToRad(-5),T.rotation.y=Ze.degToRad(-15),p.add(T);const L=new jt("+",{font:xe,size:.25,depth:.1}),F=new xt({color:0}),N=new D(L,F);N.position.set(.14,.99,.53),N.rotation.y=Ze.degToRad(12),N.rotation.x=Ze.degToRad(-5),p.add(N)});const ne=new Gt;ne.moveTo(0,0),ne.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),ne.bezierCurveTo(-.6,.3,0,.6,0,1),ne.bezierCurveTo(0,.6,.6,.3,.6,0),ne.bezierCurveTo(.6,-.3,0,-.3,0,0);const M={depth:.05,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.05,bevelThickness:.05},E=new $t(ne,M),q=new xt({color:0}),G=new D(E,q);G.scale.set(.1,.1,.1),G.rotation.z=Ze.degToRad(210),G.rotation.x=Ze.degToRad(5),G.rotation.y=Ze.degToRad(-45),G.position.set(-.4,.9,.45),p.add(G);const j=new we(.25,32,32),se=new D(j,u);se.position.set(-.45,1.35,-.1),p.add(se);const H=new D(j,h);H.position.set(.45,1.35,-.1),p.add(H);const Z=new we(.35,32,32),B=new D(Z,u);B.scale.set(.75,1.25,.65),B.position.set(-.7,-.15,.2),p.add(B);const ge=new D(Z,h);ge.scale.set(.75,1.25,.65),ge.position.set(.7,-.15,.2),p.add(ge);const fe=new Mn(.2,.22,.6,32),ve=new D(fe,u);ve.position.set(-.4,-1.05,0),p.add(ve);const Me=new D(fe,h);Me.position.set(.4,-1.05,0),p.add(Me);const Le=new we(.3,32,32),Q=new D(Le,u);Q.scale.set(1,.72,1.5),Q.position.set(-.4,-1.45,.17),p.add(Q);const de=new D(Le,h);de.scale.set(1,.72,1.5),de.position.set(.4,-1.45,.17),p.add(de);const le=new we(.44,32,32),O=new D(le,u);O.position.set(-.15,-.45,-.4),p.add(O);const ie=new D(le,h);ie.position.set(.15,-.45,-.4),p.add(ie);const K=new we(.18,32,32),ce=new D(K,m);return ce.position.set(0,-.35,-.8),p.add(ce),p},d=new ct,_=f(u),y=f(h);_.position.x=-.01,y.position.x=.01,d.add(_),d.add(y),s.add(d),r.position.z=4,i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),r.position.set(e.bodyPosition.x,1,e.cameraPosition),r.lookAt(e.bodyPosition.x,0,0)}}),(i,s)=>(en(),un("div",{ref_key:"threeCanvas",ref:t,class:"three-canvas"},null,512))}}),mE=hn(pE,[["__scopeId","data-v-9e6b205d"]]),gE=Kt({__name:"HalfTransparentBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return ln(()=>{if(t.value){let i=function(){requestAnimationFrame(i),p.rotation.y+=.03,u.uniforms.time.value+=.04,o.render(s,r)};const s=new Wn,r=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Vn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=ss,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Yn(16777215,.6);s.add(a);const c=new qn(16777215,1.2);c.position.set(5,5,5),s.add(c);const l=new Ui(16777215,2,50);l.position.set(0,2,4),s.add(l);const u=new mt({uniforms:{time:{value:0},color1:{value:new He(16766720)},color2:{value:new He(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `});new Xe({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const h=new Xe({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.39});new Xe({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),new Xe({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const f=new Xe({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),d=`
    varying vec2 vUv;
          void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,y=new mt({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:d,fragmentShader:_,transparent:!0,depthWrite:!1}),m=new mt({uniforms:{time:{value:0},opacity:{value:.4}},vertexShader:d,fragmentShader:_,transparent:!0,depthWrite:!1}),p=new ct,b=new we(1,32,32,0,Math.PI),x=new D(b,m),S=new D(b,y);x.scale.set(.85,.85,.8),S.scale.set(.85,.85,.8),x.position.y=-.2,S.position.y=-.2,x.rotation.y=Math.PI/2,S.rotation.y=Math.PI*1.5;const I=new Qt(1,32),C=new D(I,y);C.scale.set(.85,.85,.8),C.position.set(0,-.2,0),C.rotation.y=Math.PI/2;const R=new ct;R.add(x),R.add(S),R.add(C),p.add(R);const U=new we(.6,32,32,0,Math.PI),ne=new D(U,y);ne.scale.set(1,.95,.95),ne.position.set(0,1,0),ne.rotation.y=Math.PI*1.5;const M=new D(U,m);M.scale.set(1,.95,.95),M.position.set(0,1,0),M.rotation.y=Math.PI/2;const E=new Qt(.6,32),q=new D(E,y);q.position.set(0,.97,0),q.rotation.y=Math.PI/2;const G=new ct;G.add(ne),G.add(M),G.add(q),p.add(G);const j=new we(.25,32,32),se=new D(j,y);se.position.set(-.45,1.35,-.1),p.add(se);const H=new D(j,m);H.position.set(.45,1.35,-.1),p.add(H);const Z=new we(.25,32,32,Math.PI/2,Math.PI),B=new D(Z,y);B.scale.set(1,.6,.8),B.position.set(0,.82,.5),B.rotation.y=Math.PI;const ge=new we(.25,32,32,Math.PI/2,Math.PI),fe=new D(ge,m);fe.scale.set(1,.6,.8),fe.position.set(0,.82,.5),fe.rotation.y=0;const ve=new Qt(.25,32),Me=new D(ve,y);Me.scale.set(1.25,.6,.8),Me.position.set(0,.85,.5),Me.rotation.x=Math.PI/2;const Le=new ct;Le.add(B),Le.add(fe),Le.add(Me),p.add(Le);const Q=new Gt;Q.moveTo(0,0),Q.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Q.bezierCurveTo(-.6,.3,0,.6,0,1),Q.bezierCurveTo(0,.6,.6,.3,.6,0),Q.bezierCurveTo(.6,-.3,0,-.3,0,0);const de={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Xe({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const le=new $t(Q,de),O=new D(le,f);O.scale.set(.5,.5,.5),O.position.set(0,0,0),O.rotation.y=Math.PI,O.rotation.x=Math.PI,p.add(O);const ie=new we(.35,32,32),K=new D(ie,y);K.scale.set(.75,1.25,.65),K.position.set(-.7,-.15,.2),p.add(K);const ce=new D(ie,m);ce.scale.set(.75,1.25,.65),ce.position.set(.7,-.15,.2),p.add(ce);const xe=new Mn(.2,.22,.6,32),ee=new D(xe,y);ee.position.set(-.4,-1.05,0),p.add(ee);const g=new D(xe,m);g.position.set(.4,-1.05,0),p.add(g);const T=new we(.3,32,32),L=new D(T,y);L.scale.set(1,.72,1.5),L.position.set(-.4,-1.45,.17),p.add(L);const F=new D(T,m);F.scale.set(1,.72,1.5),F.position.set(.4,-1.45,.17),p.add(F);const N=new we(.44,32,32),J=new D(N,y);J.position.set(-.15,-.45,-.4),p.add(J);const te=new D(N,h);te.position.set(.15,-.45,-.4),p.add(te);const w=new we(.18,32,32),v=new D(w,f);v.position.set(0,-.35,-.8),p.add(v),new Ni().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(W){const V=new jt("X",{font:W,size:.18,depth:.05}),X=new xt({color:0}),ue=new D(V,X);ue.position.set(-.3,.99,.53),ue.rotation.x=Ze.degToRad(-5),ue.rotation.y=Ze.degToRad(-15),p.add(ue);const he=new jt("+",{font:W,size:.25,depth:.1}),_e=new xt({color:0}),Ae=new D(he,_e);Ae.position.set(.14,.99,.53),Ae.rotation.y=Ze.degToRad(12),Ae.rotation.x=Ze.degToRad(-5),p.add(Ae)}),s.add(p),i(),p.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),r.position.set(e.bodyPosition.x,1,e.cameraPosition),r.lookAt(e.bodyPosition.x,0,0),Pt(()=>e.bodyPosition,W=>{p.position.set(W.x,W.y,W.z)}),Pt(()=>e.cameraPosition,W=>{r.position.set(e.bodyPosition.x,1,W),r.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,s)=>(en(),un("div",{ref_key:"threeCanvas",ref:t,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),_E=hn(gE,[["__scopeId","data-v-7fbce4ad"]]),vE=Kt({__name:"HalfBlueBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return ln(()=>{if(t.value){let i=function(){requestAnimationFrame(i),ye&&(x.rotation.y+=.03),o.render(s,r)};const s=new Wn,r=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Vn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=ss,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new Yn(16777215,.6);s.add(a);const c=new qn(16777215,1.2);c.position.set(5,5,5),s.add(c);const l=new Ui(16777215,2,50);l.position.set(0,2,4),s.add(l);const u=new mt({uniforms:{time:{value:0},color1:{value:new He(16766720)},color2:{value:new He(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,b=new mt({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:m,fragmentShader:p,transparent:!1,depthWrite:!0}),x=new ct,S=new we(1,32,32,0,Math.PI),I=new D(S,f),C=new D(S,h);I.scale.set(.85,.85,.8),C.scale.set(.85,.85,.8),I.position.y=-.2,C.position.y=-.2,I.rotation.y=Math.PI/2,C.rotation.y=Math.PI*1.5;const R=new Qt(1,32),U=new D(R,h);U.scale.set(.85,.85,.8),U.position.set(0,-.2,0),U.rotation.y=Math.PI/2;const ne=new ct;ne.add(I),ne.add(C),ne.add(U),x.add(ne);const M=new we(.6,32,32,0,Math.PI),E=new D(M,h);E.scale.set(1,.95,.95),E.position.set(0,1,0),E.rotation.y=Math.PI*1.5;const q=new D(M,f);q.scale.set(1,.95,.95),q.position.set(0,1,0),q.rotation.y=Math.PI/2;const G=new Qt(.6,32),j=new D(G,h);j.position.set(0,1,0),j.rotation.y=Math.PI/2,j.scale.set(1,.95,.95);const se=new ct;se.add(E),se.add(q),se.add(j),x.add(se);const H=new we(.25,32,32),Z=new D(H,h);Z.position.set(-.45,1.35,-.1),x.add(Z);const B=new D(H,f);B.position.set(.45,1.35,-.1),x.add(B);const ge=new we(.25,32,32,Math.PI/2,Math.PI),fe=new D(ge,h);fe.scale.set(1.1,.6,.8),fe.position.set(0,.84,.5),fe.rotation.y=Math.PI;const ve=new we(.25,32,32,Math.PI/2,Math.PI),Me=new D(ve,f);Me.scale.set(1.1,.6,.8),Me.position.set(0,.84,.5),Me.rotation.y=0;const Le=new Qt(.25,32),Q=new D(Le,h);Q.scale.set(.8,.6,.8),Q.position.set(0,.84,.5),Q.rotation.y=Math.PI/2;const de=new ct;de.add(fe),de.add(Me),de.add(Q),x.add(de);const le=new Gt;le.moveTo(0,0),le.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),le.bezierCurveTo(-.6,.3,0,.6,0,1),le.bezierCurveTo(0,.6,.6,.3,.6,0),le.bezierCurveTo(.6,-.3,0,-.3,0,0);const O={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Xe({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const ie=new $t(le,O);new xt({color:0});const K=new D(ie,d);K.scale.set(.1,.1,.1),K.rotation.z=Ze.degToRad(210),K.rotation.x=Ze.degToRad(5),K.rotation.y=Ze.degToRad(-45),K.position.set(-.4,.9,.45);const ce=new D(ie,b);ce.scale.set(.5,.5,.5),ce.position.set(.35,0,0),ce.rotation.y=Math.PI,ce.rotation.x=Math.PI,x.add(ce);const xe=new D(ie,u);xe.scale.set(.35,.35,.35),xe.position.set(.3,0,0),xe.rotation.y=Math.PI,xe.rotation.x=Math.PI;const ee=new D(ie,y);ee.scale.set(.25,.25,.25),ee.position.set(.27,.2,0),ee.rotation.y=Math.PI,ee.rotation.x=Math.PI;const g=new D(ie,_);g.scale.set(.3,.3,.3),g.position.set(.23,-.5,.3),g.rotation.y=Math.PI,g.rotation.x=Math.PI;const T=new D(ie,b);T.scale.set(.4,.4,.4),T.position.set(.27,0,.35),T.rotation.y=Math.PI,T.rotation.x=Math.PI;const L=new we(.35,32,32),F=new D(L,h);F.scale.set(.75,1.25,.65),F.position.set(-.7,-.15,.2),x.add(F);const N=new D(L,f);N.scale.set(.75,1.25,.65),N.position.set(.7,-.15,.2),x.add(N);const J=new Mn(.2,.22,.6,32),te=new D(J,h);te.position.set(-.4,-1.05,0),x.add(te);const w=new D(J,f);w.position.set(.4,-1.05,0),x.add(w);const v=new we(.3,32,32),P=new D(v,h);P.scale.set(1,.72,1.5),P.position.set(-.4,-1.45,.17),x.add(P);const W=new D(v,f);W.scale.set(1,.72,1.5),W.position.set(.4,-1.45,.17),x.add(W);const V=new we(.44,32,32),X=new D(V,h);X.position.set(-.15,-.45,-.4),x.add(X);const ue=new D(V,f);ue.position.set(.15,-.45,-.4),x.add(ue);const he=new we(.18,32,32),_e=new D(he,d);_e.position.set(0,-.35,-.8),x.add(_e),new Ni().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Se){const Ve=new jt("X",{font:Se,size:.18,depth:.05}),Ue=new xt({color:0}),ze=new D(Ve,Ue);ze.position.set(-.3,.99,.53),ze.rotation.x=Ze.degToRad(-5),ze.rotation.y=Ze.degToRad(-15),x.add(ze);const z=new jt("+",{font:Se,size:.25,depth:.1}),Te=new xt({color:0}),ae=new D(z,Te);ae.position.set(.14,.99,.53),ae.rotation.y=Ze.degToRad(12),ae.rotation.x=Ze.degToRad(-5),x.add(ae)}),_e.renderOrder=1,x.scale.set(1.2,1.2,1.2),s.add(x),x.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),r.position.set(e.bodyPosition.x,1,e.cameraPosition),r.lookAt(e.bodyPosition.x,0,0),r.position.z=4;const pe={x:0,y:0};let ye=!0,Ne=null;const Ie=Se=>{ye=!1,pe.x=Se.clientX/window.innerWidth*2-1,pe.y=-(Se.clientY/window.innerHeight)*2+1;const Ve=pe.x*Math.PI*.2,Ue=pe.y*Math.PI*.2;x.rotation.y=Ve,x.rotation.x=Ue,clearTimeout(Ne),Ne=setTimeout(()=>{ye=!0},500)};window.addEventListener("mousemove",Ie),u.uniforms.time.value+=.04,i(),Pt(()=>e.bodyPosition,Se=>{x.position.set(Se.x,Se.y,Se.z)}),Pt(()=>e.cameraPosition,Se=>{r.position.set(e.bodyPosition.x,1,Se),r.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,s)=>(en(),un("div",{ref_key:"threeCanvas",ref:t,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),xE=hn(vE,[["__scopeId","data-v-5bf83852"]]),yE=Kt({__name:"SliverBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return ln(()=>{if(t.value){let i=function(){c.visible=!1,y.update(a,r),c.visible=!0,requestAnimationFrame(i)},s=function(){requestAnimationFrame(s),Te&&(c.rotation.y+=.03),a.render(r,o)};const r=new Wn,o=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),a=new Vn({antialias:!0,alpha:!0});a.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(a.domElement);const c=new ct,l=new Yn(16777215,2);r.add(l);const u=new qn(16777215,4);u.position.set(5,5,5),r.add(u);const h=new Ui(16777215,5,50);h.position.set(0,2,4),r.add(h);const d=new np().load("3d-bear-arts/src/assets/gradient_texture.jpg"),_=new Gd(256,{format:vn,generateMipmaps:!0,minFilter:Ti}),y=new zd(1,1e3,_);new Xe({color:16738740,metalness:1,roughness:.1,clearcoat:1,clearcoatRoughness:.1,envMap:d,envMapIntensity:1.5}),new Xe({color:12632256,metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.35,envMap:_.texture,envMapIntensity:1.5}),r.add(y),r.environment=_.texture,i();const m=new Xw,p=m.load(["https://threejs.org/examples/textures/cube/Park2/posx.jpg","https://threejs.org/examples/textures/cube/Park2/negx.jpg","https://threejs.org/examples/textures/cube/Park2/posy.jpg","https://threejs.org/examples/textures/cube/Park2/negy.jpg","https://threejs.org/examples/textures/cube/Park2/posz.jpg","https://threejs.org/examples/textures/cube/Park2/negz.jpg"]),b=m.load(["path_to_universe_posx.jpg","path_to_universe_negx.jpg","path_to_universe_posy.jpg","path_to_universe_negy.jpg","path_to_universe_posz.jpg","path_to_universe_negz.jpg"]);r.environment=b,r.environment=p;const x=new Xe({color:16738740,metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,envMap:p,reflectivity:1}),S=new Xe({color:16738740,metalness:1,roughness:.05,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,envMap:p,reflectivity:1}),I=new mt({uniforms:{time:{value:0},color1:{value:new He(16766720)},color2:{value:new He(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
          ...
          `}),C=new Xe({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.89}),R=new Xe({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!1,opacity:.99,depthWrite:!0,depthTest:!0}),U=new Xe({color:16738740,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!1,opacity:.99,depthWrite:!0,depthTest:!0}),ne=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,E=new mt({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:ne,fragmentShader:M,transparent:!1,depthWrite:!0}),q=new we(1,32,32,0,Math.PI),G=new D(q,S),j=new D(q,x);G.scale.set(.85,.85,.8),j.scale.set(.85,.85,.8),G.position.y=-.2,j.position.y=-.2,G.rotation.y=Math.PI/2,j.rotation.y=Math.PI*1.5;const se=new Qt(1,32),H=new D(se,x);H.scale.set(.85,.85,.8),H.position.set(0,-.2,0),H.rotation.y=Math.PI/2;const Z=new ct;Z.add(G),Z.add(j),Z.add(H),c.add(Z);const B=new we(.6,32,32,0,Math.PI),ge=new D(B,x);ge.scale.set(1,.95,.95),ge.position.set(0,1,0),ge.rotation.y=Math.PI*1.5;const fe=new D(B,S);fe.scale.set(1,.95,.95),fe.position.set(0,1,0),fe.rotation.y=Math.PI/2;const ve=new Qt(.6,32),Me=new D(ve,x);Me.position.set(0,1,0),Me.rotation.y=Math.PI/2,Me.scale.set(1,.95,.95);const Le=new ct;Le.add(ge),Le.add(fe),Le.add(Me),c.add(Le);const Q=new we(.25,32,32),de=new D(Q,x);de.position.set(-.45,1.35,-.1),c.add(de);const le=new D(Q,S);le.position.set(.45,1.35,-.1),c.add(le);const O=new we(.25,32,32,Math.PI/2,Math.PI),ie=new D(O,x);ie.scale.set(1.1,.6,.8),ie.position.set(0,.84,.5),ie.rotation.y=Math.PI;const K=new we(.25,32,32,Math.PI/2,Math.PI),ce=new D(K,S);ce.scale.set(1.1,.6,.8),ce.position.set(0,.84,.5),ce.rotation.y=0;const xe=new Qt(.25,32),ee=new D(xe,x);ee.scale.set(.8,.6,.8),ee.position.set(0,.84,.5),ee.rotation.y=Math.PI/2;const g=new ct;g.add(ie),g.add(ce),g.add(ee),c.add(g);const T=new Gt;T.moveTo(0,0),T.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),T.bezierCurveTo(-.6,.3,0,.6,0,1),T.bezierCurveTo(0,.6,.6,.3,.6,0),T.bezierCurveTo(.6,-.3,0,-.3,0,0);const L={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Xe({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const F=new $t(T,L);new xt({color:0});const N=new D(F,C);N.scale.set(.1,.1,.1),N.rotation.z=Ze.degToRad(210),N.rotation.x=Ze.degToRad(5),N.rotation.y=Ze.degToRad(-45),N.position.set(-.4,.9,.45);const J=new D(F,E);J.scale.set(.5,.5,.5),J.position.set(.35,0,0),J.rotation.y=Math.PI,J.rotation.x=Math.PI,c.add(J);const te=new D(F,I);te.scale.set(.35,.35,.35),te.position.set(.3,0,0),te.rotation.y=Math.PI,te.rotation.x=Math.PI,c.add(te);const w=new D(F,U);w.scale.set(.25,.25,.25),w.position.set(.27,.2,0),w.rotation.y=Math.PI,w.rotation.x=Math.PI,c.add(w);const v=new D(F,R);v.scale.set(.3,.3,.3),v.position.set(.23,-.5,.3),v.rotation.y=Math.PI,v.rotation.x=Math.PI,c.add(v);const P=new D(F,E);P.scale.set(.4,.4,.4),P.position.set(.27,0,.35),P.rotation.y=Math.PI,P.rotation.x=Math.PI;const W=new we(.35,32,32),V=new D(W,x);V.scale.set(.75,1.25,.65),V.position.set(-.7,-.15,.2),c.add(V);const X=new D(W,S);X.scale.set(.75,1.25,.65),X.position.set(.7,-.15,.2),c.add(X);const ue=new Mn(.2,.22,.6,32),he=new D(ue,x);he.position.set(-.4,-1.05,0),c.add(he);const _e=new D(ue,S);_e.position.set(.4,-1.05,0),c.add(_e);const Ae=new we(.3,32,32),pe=new D(Ae,x);pe.scale.set(1,.72,1.5),pe.position.set(-.4,-1.45,.17),c.add(pe);const ye=new D(Ae,S);ye.scale.set(1,.72,1.5),ye.position.set(.4,-1.45,.17),c.add(ye);const Ne=new we(.44,32,32),Ie=new D(Ne,x);Ie.position.set(-.15,-.45,-.4),c.add(Ie);const Se=new D(Ne,S);Se.position.set(.15,-.45,-.4),c.add(Se);const Ve=new we(.18,32,32),Ue=new D(Ve,E);Ue.position.set(0,-.35,-.8),c.add(Ue),new Ni().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(be){const Pe=new jt("X",{font:be,size:.18,depth:.05});new xt({color:0});const $e=new D(Pe,E);$e.position.set(-.3,.99,.53),$e.rotation.x=Ze.degToRad(-5),$e.rotation.y=Ze.degToRad(-15),c.add($e);const gt=new jt("+",{font:be,size:.25,depth:.1});new xt({color:0});const bt=new D(gt,E);bt.position.set(.14,.99,.53),bt.rotation.y=Ze.degToRad(12),bt.rotation.x=Ze.degToRad(-5),c.add(bt)}),Ue.renderOrder=1,c.scale.set(1.2,1.2,1.2),r.add(c),c.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),o.position.set(e.bodyPosition.x,1,e.cameraPosition),o.lookAt(e.bodyPosition.x,0,0),o.position.z=4;const z={x:0,y:0};let Te=!0,ae=null;const me=be=>{Te=!1,z.x=be.clientX/window.innerWidth*2-1,z.y=-(be.clientY/window.innerHeight)*2+1;const Pe=z.x*Math.PI*.2,$e=z.y*Math.PI*.2;c.rotation.y=Pe,c.rotation.x=$e,clearTimeout(ae),ae=setTimeout(()=>{Te=!0},500)};window.addEventListener("mousemove",me),I.uniforms.time.value+=.04,s(),Pt(()=>e.bodyPosition,be=>{c.position.set(be.x,be.y,be.z)}),Pt(()=>e.cameraPosition,be=>{o.position.set(e.bodyPosition.x,1,be),o.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{o.aspect=window.innerWidth/window.innerHeight,o.updateProjectionMatrix(),a.setSize(window.innerWidth,window.innerHeight)})}}),(i,s)=>(en(),un("div",{ref_key:"threeCanvas",ref:t,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),ME=hn(yE,[["__scopeId","data-v-521e04dc"]]),SE=Kt({__name:"MetalBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return ln(()=>{if(t.value){let i=function(){requestAnimationFrame(i),Se&&(a.rotation.y+=.03),o.render(s,r)};const s=new Wn,r=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new Vn({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),t.value.appendChild(o.domElement);const a=new ct,c=new Yn(16777215,2);s.add(c);const l=new qn(16777215,4);l.position.set(5,5,5),s.add(l);const u=new Ui(16777215,5,50);u.position.set(0,2,4),s.add(u);const h=new np,f=h.load("src/assets/lv2.jpg"),d=h.load("src/assets/lv2.jpg");f.wrapS=f.wrapT=Tr,d.wrapS=d.wrapT=Tr;const _=new Xe({color:8343336,metalness:0,roughness:.8,bumpMap:f,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:d,envMapIntensity:.7}),y=new Xe({color:5978654,metalness:0,roughness:.8,bumpMap:f,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:d,envMapIntensity:.7}),m=new Xe({color:13152668,metalness:.2,roughness:.05,bumpMap:f,bumpScale:.05,clearcoat:1,clearcoatRoughness:.05,map:d,transparent:!0,opacity:.4,transmission:.9,envMapIntensity:1,reflectivity:.9,ior:1.45,side:On});new Xe({color:0,metalness:.2,roughness:.7,bumpMap:f,bumpScale:.15,clearcoat:.2,clearcoatRoughness:.5,reflectivity:.2,envMapIntensity:.3}),new Xe({color:13421772,metalness:1,roughness:.5,clearcoat:.3,clearcoatRoughness:.3});const p=new mt({uniforms:{time:{value:0},color1:{value:new He(16766720)},color2:{value:new He(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `;new mt({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:b,fragmentShader:x,transparent:!1,depthWrite:!0});const S=new we(1,32,32,0,Math.PI),I=new D(S,m),C=new D(S,_);I.scale.set(.85,.85,.8),C.scale.set(.85,.85,.8),I.position.y=-.2,C.position.y=-.2,I.rotation.y=Math.PI/2,C.rotation.y=Math.PI*1.5;const R=new Qt(1,32),U=new D(R,_);U.scale.set(.85,.85,.8),U.position.set(0,-.2,0),U.rotation.y=Math.PI/2;const ne=new ct;ne.add(I),ne.add(C),ne.add(U),a.add(ne);const M=new we(.6,32,32,0,Math.PI),E=new D(M,_);E.scale.set(1,.95,.95),E.position.set(0,1,0),E.rotation.y=Math.PI*1.5;const q=new D(M,m);q.scale.set(1,.95,.95),q.position.set(0,1,0),q.rotation.y=Math.PI/2;const G=new Qt(.6,32),j=new D(G,_);j.position.set(0,1,0),j.rotation.y=Math.PI/2,j.scale.set(1,.95,.95);const se=new ct;se.add(E),se.add(q),se.add(j),a.add(se);const H=new we(.25,32,32),Z=new D(H,_);Z.position.set(-.45,1.35,-.1),a.add(Z);const B=new D(H,m);B.position.set(.45,1.35,-.1),a.add(B);const ge=new we(.25,32,32,Math.PI/2,Math.PI),fe=new D(ge,y);fe.scale.set(1.1,.6,.8),fe.position.set(0,.84,.5),fe.rotation.y=Math.PI;const ve=new we(.25,32,32,Math.PI/2,Math.PI),Me=new D(ve,m);Me.scale.set(1.1,.6,.8),Me.position.set(0,.84,.5),Me.rotation.y=0;const Le=new Qt(.25,32),Q=new D(Le,_);Q.scale.set(.8,.6,.8),Q.position.set(0,.84,.5),Q.rotation.y=Math.PI/2;const de=new ct;de.add(fe),de.add(Me),de.add(Q),a.add(de);const le=new Gt;le.moveTo(0,0),le.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),le.bezierCurveTo(-.6,.3,0,.6,0,1),le.bezierCurveTo(0,.6,.6,.3,.6,0),le.bezierCurveTo(.6,-.3,0,-.3,0,0);const O={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Xe({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const ie=new $t(le,O);new xt({color:0});const K=new D(ie,_);K.scale.set(.1,.1,.1),K.rotation.z=Ze.degToRad(210),K.rotation.x=Ze.degToRad(5),K.rotation.y=Ze.degToRad(-45),K.position.set(-.4,.9,.45);const ce=new D(ie,y);ce.scale.set(.6,.5,.5),ce.position.set(.35,0,0),ce.rotation.y=Math.PI,ce.rotation.x=Math.PI;const xe=new D(ie,y);xe.scale.set(.2,.2,.2),xe.position.set(.3,-.1,.2),xe.rotation.y=Math.PI,xe.rotation.x=Math.PI,a.add(xe);const ee=new qs(1.3,1.2,.6),g=new D(ee,_);g.scale.set(.45,.45,.45),g.position.set(.35,-.2,.1),g.rotation.y=Math.PI;const T=new Xl(.15,.025,10,100);new Xe({color:8343336,metalness:.3,roughness:.4,clearcoat:.5});const L=new D(T,_);L.position.set(.35,.1,.1),L.rotation.z=Math.PI/2,L.rotation.x=Math.PI/8,L.rotation.y=Math.PI/14;const F=new D(T,_);F.position.set(.35,.1,.13),F.rotation.z=Math.PI/2,F.rotation.x=Math.PI/-8,F.rotation.y=Math.PI/12;const N=new ct;N.add(g),N.add(L),N.add(F),a.add(N);const J=new we(.35,32,32),te=new D(J,_);te.scale.set(.75,1.25,.65),te.position.set(-.7,-.15,.2),a.add(te);const w=new D(J,m);w.scale.set(.75,1.25,.65),w.position.set(.7,-.15,.2),a.add(w);const v=new Mn(.2,.22,.6,32),P=new D(v,_);P.position.set(-.4,-1.05,0),a.add(P);const W=new D(v,m);W.position.set(.4,-1.05,0),a.add(W);const V=new we(.3,32,32),X=new D(V,_);X.scale.set(1,.72,1.5),X.position.set(-.4,-1.45,.17),a.add(X);const ue=new D(V,m);ue.scale.set(1,.72,1.5),ue.position.set(.4,-1.45,.17),a.add(ue);const he=new we(.44,32,32),_e=new D(he,_);_e.position.set(-.15,-.45,-.4),a.add(_e);const Ae=new D(he,m);Ae.position.set(.15,-.45,-.4),a.add(Ae);const pe=new we(.18,32,32),ye=new D(pe,_);ye.position.set(0,-.35,-.8),a.add(ye),new Ni().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(ze){const z=new jt("X",{font:ze,size:.2,depth:.05});new xt({color:0});const Te=new D(z,y);Te.position.set(-.3,.99,.53),Te.rotation.x=Ze.degToRad(-5),Te.rotation.y=Ze.degToRad(-15),a.add(Te);const ae=new jt("O",{font:ze,size:.2,depth:.05});new xt({color:0});const me=new D(ae,y);me.position.set(.14,.99,.53),me.rotation.y=Ze.degToRad(12),me.rotation.x=Ze.degToRad(-5),a.add(me)}),ye.renderOrder=1,a.scale.set(1.35,1.35,1.35),s.add(a),a.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),r.position.set(e.bodyPosition.x,1,e.cameraPosition),r.lookAt(e.bodyPosition.x,0,0),r.position.z=4;const Ie={x:0,y:0};let Se=!0,Ve=null;const Ue=ze=>{Se=!1,Ie.x=ze.clientX/window.innerWidth*2-1,Ie.y=-(ze.clientY/window.innerHeight)*2+1;const z=Ie.x*Math.PI*.2,Te=Ie.y*Math.PI*.2;a.rotation.y=z,a.rotation.x=Te,clearTimeout(Ve),Ve=setTimeout(()=>{Se=!0},500)};window.addEventListener("mousemove",Ue),p.uniforms.time.value+=.04,i(),Pt(()=>e.bodyPosition,ze=>{a.position.set(ze.x,ze.y,ze.z)}),Pt(()=>e.cameraPosition,ze=>{r.position.set(e.bodyPosition.x,1,ze),r.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{r.aspect=window.innerWidth/window.innerHeight,r.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,s)=>(en(),un("div",{ref_key:"threeCanvas",ref:t,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),wE=hn(SE,[["__scopeId","data-v-6a196471"]]),EE=[{path:"/3d-bear-arts",name:"ThreeScene",component:aE},{path:"/3d-bear-arts/half",name:"NewBear",component:xE},{path:"/3d-bear-arts/sliver",name:"SliverBear",component:ME},{path:"/3d-bear-arts/metal",name:"MetalBear",component:wE},{path:"/3d-bear-arts/halfTransparent",name:"Transparent",component:_E},{path:"/3d-bear-arts/bluePink",name:"BluePinkBear",component:mE},{path:"/3d-bear-arts/diamond",name:"DiamondBear",component:hE},{path:"/3d-bear-arts/pink",name:"PinkBear",component:sp},{path:"/3d-bear-arts/purple",name:"PurpleBear",component:rp},{path:"/3d-bear-arts/blue",name:"BlueBear",component:op},{path:"/3d-bear-arts/glass",name:"GlassBear",component:dE}],bE=Yg({history:wg(),routes:EE}),dp=H0(q0);dp.use(bE);dp.mount("#app");
