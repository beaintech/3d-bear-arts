...
`)a=0,c-=o;else{const u=wS(h,s,a,c,e);a+=u.offsetX,r.push(u.path)}}return r}function wS(n,t,e,i,s){const o=s.glyphs[n]||s.glyphs["?"];if(!o){console.error('THREE.Font: character "'+n+'" does not exists in font family '+s.familyName+".");return}const r=new xS;let a,c,l,h,u,d,p,v;if(o.o){const x=o._cachedOutline||(o._cachedOutline=o.o.split(" "));for(let m=0,f=x.length;m<f;)switch(x[m++]){case"m":a=x[m++]*t+e,c=x[m++]*t+i,r.moveTo(a,c);break;case"l":a=x[m++]*t+e,c=x[m++]*t+i,r.lineTo(a,c);break;case"q":l=x[m++]*t+e,h=x[m++]*t+i,u=x[m++]*t+e,d=x[m++]*t+i,r.quadraticCurveTo(u,d,l,h);break;case"b":l=x[m++]*t+e,h=x[m++]*t+i,u=x[m++]*t+e,d=x[m++]*t+i,p=x[m++]*t+e,v=x[m++]*t+i,r.bezierCurveTo(u,d,p,v,l,h);break}}return{offsetX:o.ha*t,path:r}}class ke extends Hn{constructor(t,e={}){const i=e.font;if(i===void 0)super();else{const s=i.generateShapes(t,e.size);e.depth===void 0&&e.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),e.depth=e.depth!==void 0?e.depth:e.height!==void 0?e.height:50,e.bevelThickness===void 0&&(e.bevelThickness=10),e.bevelSize===void 0&&(e.bevelSize=8),e.bevelEnabled===void 0&&(e.bevelEnabled=!1),super(s,e)}this.type="TextGeometry"}}const SS=Ln({__name:"MetalBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=null,s=jt(!1),o=jt(!1),r=jt(!1);return Vn(()=>{if(e.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:o.value&&(u.rotation.y-=.03),h.render(c,l)};const c=new Gn,l=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),h=new zn({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(h.domElement);const u=new Xt,d=new hi(16777215,2);c.add(d);const p=new ui(16777215,4);p.position.set(5,5,5),c.add(p);const v=new li(16777215,5,50);v.position.set(0,2,4),c.add(v);const x=new jn,m=x.load("/3d-bear-arts/assets/lv2.jpg"),f=x.load("/3d-bear-arts/assets/lv2.jpg");m.wrapS=m.wrapT=$e,f.wrapS=f.wrapT=$e;const A=new Ot({color:8343336,metalness:0,roughness:.8,bumpMap:m,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:f,envMapIntensity:.7}),S=new Ot({color:5978654,metalness:0,roughness:.8,bumpMap:m,bumpScale:.1,clearcoat:.2,clearcoatRoughness:.9,map:f,envMapIntensity:.7}),b=new Ot({color:13152668,metalness:.2,roughness:.05,bumpMap:m,bumpScale:.05,clearcoat:1,clearcoatRoughness:.05,map:f,transparent:!0,opacity:.4,transmission:.9,envMapIntensity:1,reflectivity:.9,ior:1.45,side:be});new Ot({color:13421772,metalness:1,roughness:.5,clearcoat:.3,clearcoatRoughness:.3});const B=new ft(1,32,32,0,Math.PI),I=new y(B,b),R=new y(B,A);I.scale.set(.85,.85,.8),R.scale.set(.85,.85,.8),I.position.y=-.2,R.position.y=-.2,I.rotation.y=Math.PI/2,R.rotation.y=Math.PI*1.5;const z=new Ae(1,32),Q=new y(z,A);Q.scale.set(.85,.85,.8),Q.position.set(0,-.2,0),Q.rotation.y=Math.PI/2;const M=new Xt;M.add(I),M.add(R),M.add(Q),u.add(M);const E=new ft(.6,32,32,0,Math.PI),U=new y(E,A);U.scale.set(1,.95,.95),U.position.set(0,1,0),U.rotation.y=Math.PI*1.5;const k=new y(E,b);k.scale.set(1,.95,.95),k.position.set(0,1,0),k.rotation.y=Math.PI/2;const et=new Ae(.6,32),rt=new y(et,A);rt.position.set(0,1,0),rt.rotation.y=Math.PI/2,rt.scale.set(1,.95,.95);const $=new Xt;$.add(U),$.add(k),$.add(rt),u.add($);const nt=new ft(.25,32,32),X=new y(nt,A);X.position.set(-.45,1.35,-.1),u.add(X);const vt=new y(nt,b);vt.position.set(.45,1.35,-.1),u.add(vt);const yt=new ft(.25,32,32,Math.PI/2,Math.PI),wt=new y(yt,S);wt.scale.set(1.1,.6,.8),wt.position.set(0,.84,.5),wt.rotation.y=Math.PI;const Dt=new ft(.25,32,32,Math.PI/2,Math.PI),Wt=new y(Dt,b);Wt.scale.set(1.1,.6,.8),Wt.position.set(0,.84,.5),Wt.rotation.y=0;const at=new Ae(.25,32),pt=new y(at,A);pt.scale.set(.8,.6,.8),pt.position.set(0,.84,.5),pt.rotation.y=Math.PI/2;const bt=new Xt;bt.add(wt),bt.add(Wt),bt.add(pt),u.add(bt);const O=new Cn;O.moveTo(0,0),O.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),O.bezierCurveTo(-.6,.3,0,.6,0,1),O.bezierCurveTo(0,.6,.6,.3,.6,0),O.bezierCurveTo(.6,-.3,0,-.3,0,0);const lt={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Ot({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const ot=new Hn(O,lt),ht=new y(ot,A);ht.scale.set(.1,.1,.1),ht.rotation.z=le.degToRad(210),ht.rotation.x=le.degToRad(5),ht.rotation.y=le.degToRad(-45),ht.position.set(-.4,.9,.45);const Mt=new y(ot,S);Mt.scale.set(.6,.5,.5),Mt.position.set(.35,0,0),Mt.rotation.y=Math.PI,Mt.rotation.x=Math.PI;const it=new y(ot,S);it.scale.set(.2,.2,.2),it.position.set(.5,-.1,.2),it.rotation.y=Math.PI,it.rotation.x=Math.PI,u.add(it);const g=new yn(1.3,1.2,.6),T=new y(g,A);T.scale.set(.45,.45,.45),T.position.set(.35,-.2,.1),T.rotation.y=Math.PI;const L=new si(.15,.025,10,100);new Ot({color:8343336,metalness:.3,roughness:.4,clearcoat:.5});const F=new y(L,A);F.position.set(.35,.1,.1),F.rotation.z=Math.PI/2,F.rotation.x=Math.PI/8,F.rotation.y=Math.PI/14;const N=new y(L,A);N.position.set(.35,.1,.13),N.rotation.z=Math.PI/2,N.rotation.x=Math.PI/-8,N.rotation.y=Math.PI/12;const K=new Xt;K.add(T),K.add(F),K.add(N),u.add(K);const Z=new ft(.35,32,32),w=new y(Z,A);w.scale.set(.75,1.25,.65),w.position.set(-.7,-.15,.2),u.add(w);const _=new y(Z,b);_.scale.set(.75,1.25,.65),_.position.set(.7,-.15,.2),u.add(_);const C=new ne(.2,.22,.6,32),q=new y(C,A);q.position.set(-.4,-1.05,0),u.add(q);const V=new y(C,b);V.position.set(.4,-1.05,0),u.add(V);const W=new ft(.3,32,32),dt=new y(W,A);dt.scale.set(1,.72,1.5),dt.position.set(-.4,-1.45,.17),u.add(dt);const ct=new y(W,b);ct.scale.set(1,.72,1.5),ct.position.set(.4,-1.45,.17),u.add(ct);const mt=new ft(.44,32,32),At=new y(mt,A);At.position.set(-.15,-.45,-.4),u.add(At);const ut=new y(mt,b);ut.position.set(.15,-.45,-.4),u.add(ut);const _t=new ft(.18,32,32),Lt=new y(_t,A);Lt.position.set(0,-.35,-.8),u.add(Lt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(tt){const St=new ke("X",{font:tt,size:.2,depth:.05});new es({color:0});const Et=new y(St,S);Et.position.set(-.3,.99,.53),Et.rotation.x=le.degToRad(-5),Et.rotation.y=le.degToRad(-15),u.add(Et);const kt=new ke("O",{font:tt,size:.2,depth:.05});new es({color:0});const te=new y(kt,S);te.position.set(.14,.99,.53),te.rotation.y=le.degToRad(12),te.rotation.x=le.degToRad(-5),u.add(te)}),Lt.renderOrder=1,u.scale.set(1.35,1.35,1.35),c.add(u),u.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),l.position.set(t.bodyPosition.x,1,t.cameraPosition),l.lookAt(t.bodyPosition.x,0,0),l.position.z=4;const Rt=()=>{u.rotation.y,u.rotation.x},$t=()=>{s.value=!0,o.value=!1,r.value=!1},zt=()=>{s.value=!1,o.value=!0,r.value=!1},Yt=()=>{s.value=!1,o.value=!1,Rt()},G=tt=>{const St=window.innerWidth/2;tt>St?$t():zt(),Rt()},xt=tt=>{clearTimeout(i),Yt(),r.value=!0;const St={x:tt.clientX/window.innerWidth*2-1,y:-(tt.clientY/window.innerHeight)*2+1};if(r.value){const Et=St.x*Math.PI*.2,kt=St.y*Math.PI*.2;u.rotation.y=Et,u.rotation.x=kt}i=setTimeout(()=>{r.value=!1,G(tt.clientX)},500)};window.addEventListener("mousemove",xt);const st=tt=>{if(r.value){const St={x:tt.clientX/window.innerWidth*2-1,y:-(tt.clientY/window.innerHeight)*2+1},Et=St.x*Math.PI*.2,kt=St.y*Math.PI*.2;u.rotation.y=Et,u.rotation.x=kt}};window.addEventListener("mousemove",st),a(),Ve(()=>t.bodyPosition,tt=>{u.position.set(tt.x,tt.y,tt.z)}),Ve(()=>t.cameraPosition,tt=>{l.position.set(t.bodyPosition.x,1,tt),l.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,c)=>(Wn(),Yn("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),bS=$n(SS,[["__scopeId","data-v-f3beb116"]]),ES=Ln({__name:"PopartBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=null,s=jt(!1),o=jt(!1),r=jt(!1);return Vn(()=>{if(e.value){let a=function(){requestAnimationFrame(a),s.value?u.rotation.y+=.03:o.value&&(u.rotation.y-=.03),h.render(c,l)};const c=new Gn,l=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),h=new zn({antialias:!0,alpha:!0});h.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(h.domElement);const u=new Xt,d=new hi(16777215,2);c.add(d);const p=new ui(16777215,4);p.position.set(5,5,5),c.add(p);const v=new li(16777215,5,50);v.position.set(0,2,4),c.add(v);const x=new jn,m=x.load("/3d-bear-arts/assets/pop6.jpg"),f=x.load("/3d-bear-arts/assets/pop7.jpg");m.wrapS=m.wrapT=$e,f.wrapS=f.wrapT=$e;const A=new Ot({color:16738740,map:f,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),S=new Ot({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),b=new Ot({color:16766720,map:m,metalness:.3,roughness:.5}),B=new Ot({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),I=new Ot({color:9055202,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9});new Ot({color:9055202,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be});const R=new Ot({color:65535,map:m,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),z=new Ot({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),Q=new ft(1,32,32,0,Math.PI),M=new y(Q,S),E=new y(Q,A);M.scale.set(.85,.85,.8),E.scale.set(.85,.85,.8),M.position.y=-.2,E.position.y=-.2,M.rotation.y=Math.PI/2,E.rotation.y=Math.PI*1.5;const U=new Ae(1,32),k=new y(U,A);k.scale.set(.85,.85,.8),k.position.set(0,-.2,0),k.rotation.y=Math.PI/2;const et=new Xt;et.add(M),et.add(E),et.add(k),u.add(et);const rt=new ft(.6,32,32,0,Math.PI),$=new y(rt,b);$.scale.set(1,.95,.95),$.position.set(0,1,0),$.rotation.y=Math.PI*1.5;const nt=new y(rt,B);nt.scale.set(1,.95,.95),nt.position.set(0,1,0),nt.rotation.y=Math.PI/2;const X=new Ae(.6,32),vt=new y(X,b);vt.position.set(0,1,0),vt.rotation.y=Math.PI/2,vt.scale.set(1,.95,.95);const yt=new Xt;yt.add($),yt.add(nt),yt.add(vt),u.add(yt);const wt=new ft(.25,32,32),Dt=new y(wt,A);Dt.position.set(-.45,1.35,-.1),u.add(Dt);const Wt=new y(wt,S);Wt.position.set(.45,1.35,-.1),u.add(Wt);const at=new ft(.25,32,32,Math.PI/2,Math.PI),pt=new y(at,b);pt.scale.set(1.1,.6,.8),pt.position.set(0,.84,.5),pt.rotation.y=Math.PI;const bt=new ft(.25,32,32,Math.PI/2,Math.PI),O=new y(bt,B);O.scale.set(1.1,.6,.8),O.position.set(0,.84,.5),O.rotation.y=0;const lt=new Ae(.25,32),ot=new y(lt,b);ot.scale.set(.8,.6,.8),ot.position.set(0,.84,.5),ot.rotation.y=Math.PI/2;const ht=new Xt;ht.add(pt),ht.add(O),ht.add(ot),u.add(ht);const Mt=new Cn;Mt.moveTo(0,0),Mt.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Mt.bezierCurveTo(-.6,.3,0,.6,0,1),Mt.bezierCurveTo(0,.6,.6,.3,.6,0),Mt.bezierCurveTo(.6,-.3,0,-.3,0,0);const it={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},g=new Hn(Mt,it),T=new y(g,b);T.scale.set(.5,.5,.5),T.position.set(.35,0,0),T.rotation.y=Math.PI,T.rotation.x=Math.PI,u.add(T);const L=new y(g,R);L.scale.set(.2,.2,.25),L.position.set(.5,-.3,.4),L.rotation.y=Math.PI,L.rotation.x=Math.PI,u.add(L);const F=new y(g,A);F.scale.set(.25,.25,.27),F.position.set(.4,.3,-.2),F.rotation.y=Math.PI,F.rotation.x=Math.PI,u.add(F);const N=new ft(.35,32,32),K=new y(N,R);K.scale.set(.75,1.25,.65),K.position.set(-.7,-.15,.2),u.add(K);const Z=new y(N,z);Z.scale.set(.75,1.25,.65),Z.position.set(.7,-.15,.2),u.add(Z);const w=new ne(.2,.22,.6,32),_=new y(w,b);_.position.set(-.4,-1.05,0),u.add(_);const C=new y(w,B);C.position.set(.4,-1.05,0),u.add(C);const q=new ft(.3,32,32),V=new y(q,b);V.scale.set(1,.72,1.5),V.position.set(-.4,-1.45,.17),u.add(V);const W=new y(q,B);W.scale.set(1,.72,1.5),W.position.set(.4,-1.45,.17),u.add(W);const dt=new ft(.44,32,32),ct=new y(dt,A);ct.position.set(-.15,-.45,-.4),u.add(ct);const mt=new y(dt,S);mt.position.set(.15,-.45,-.4),u.add(mt);const At=new ft(.18,32,32),ut=new y(At,A);ut.position.set(0,-.35,-.8),u.add(ut),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(xt){const st=new ke("X",{font:xt,size:.2,depth:.05});new es({color:0});const tt=new y(st,A);tt.position.set(-.3,.99,.53),tt.rotation.x=le.degToRad(-5),tt.rotation.y=le.degToRad(-15),u.add(tt);const St=new ke("O",{font:xt,size:.2,depth:.05});new es({color:0});const Et=new y(St,R);Et.position.set(.14,.99,.53),Et.rotation.y=le.degToRad(12),Et.rotation.x=le.degToRad(-5),u.add(Et);const kt=new ke("POP",{font:xt,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5}),te=new Ot({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const se=new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),oe=new Ot({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),ee=new y(kt,te);ee.scale.set(.15,.15,.15),ee.position.set(.03,1.16,.1),ee.rotateZ(-25),u.add(ee);const fe=new y(kt,I);fe.scale.set(.14,.14,.14),fe.rotateZ(45),fe.position.set(.2,-.7,.3),u.add(fe);const ae=new y(kt,se);ae.scale.set(.14,.14,.14),ae.rotateZ(45),ae.rotateY(45),ae.position.set(.3,.7,.3),u.add(ae);const ve=new y(kt,se);ve.scale.set(.15,.15,.15),ve.rotateZ(45),ve.rotateY(45),ve.position.set(.35,-1.5,.3),u.add(ve);const ce=new y(kt,oe);ce.scale.set(.17,.17,.17),ce.rotateZ(45),ce.rotateY(15),ce.position.set(.35,1,.3),u.add(ce)}),ut.renderOrder=1,u.scale.set(1.35,1.35,1.35),c.add(u),u.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),l.position.set(t.bodyPosition.x,1,t.cameraPosition),l.lookAt(t.bodyPosition.x,0,0),l.position.z=4;const Lt=()=>{u.rotation.y,u.rotation.x},Nt=()=>{s.value=!0,o.value=!1,r.value=!1},Rt=()=>{s.value=!1,o.value=!0,r.value=!1},$t=()=>{s.value=!1,o.value=!1,Lt()},zt=xt=>{const st=window.innerWidth/2;xt>st?Nt():Rt(),Lt()},Yt=xt=>{clearTimeout(i),$t(),r.value=!0;const st={x:xt.clientX/window.innerWidth*2-1,y:-(xt.clientY/window.innerHeight)*2+1};if(r.value){const tt=st.x*Math.PI*.2,St=st.y*Math.PI*.2;u.rotation.y=tt,u.rotation.x=St}i=setTimeout(()=>{r.value=!1,zt(xt.clientX)},500)};window.addEventListener("mousemove",Yt);const G=xt=>{if(r.value){const st={x:xt.clientX/window.innerWidth*2-1,y:-(xt.clientY/window.innerHeight)*2+1},tt=st.x*Math.PI*.2,St=st.y*Math.PI*.2;u.rotation.y=tt,u.rotation.x=St}};window.addEventListener("mousemove",G),a(),Ve(()=>t.bodyPosition,xt=>{u.position.set(xt.x,xt.y,xt.z)}),Ve(()=>t.cameraPosition,xt=>{l.position.set(t.bodyPosition.x,1,xt),l.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),h.setSize(window.innerWidth,window.innerHeight)})}}),(a,c)=>(Wn(),Yn("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2))}}),TS=$n(ES,[["__scopeId","data-v-8cfea564"]]),AS={class:"pixel-controls"},PS={class:"side-buttons"},RS=Ln({__name:"PopArtBear3",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);Vn(()=>{if(e.value){let d=function(){requestAnimationFrame(d),i.value&&(m.rotation.y+=.03),s.value&&(m.rotation.y-=.03),o.value&&(m.rotation.x-=.03),r.value&&(m.rotation.x+=.03);const tt=xt.getElapsedTime();G.forEach((St,Et)=>{const kt=.2+Math.sin(tt*3+st[Et])*.1;St.scale.set(kt,kt,kt)}),x.render(p,v)};const p=new Gn,v=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),x=new zn({antialias:!0,alpha:!0});x.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(x.domElement);const m=new Xt,f=new Xt;p.add(f);const A=new hi(16777215,2);p.add(A);const S=new ui(16777215,4);S.position.set(5,5,5),p.add(S);const b=new li(16777215,5,50);b.position.set(0,2,4),p.add(b);const B=new jn,I=B.load("/3d-bear-arts/assets/pop6.jpg"),R=B.load("/3d-bear-arts/assets/pop7.jpg");I.wrapS=I.wrapT=$e,R.wrapS=R.wrapT=$e,R.repeat.set(2,2);const z=new Ot({color:16738740,map:R,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Q=new Ot({color:16766720,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),M=new Ot({color:16766720,map:I,metalness:.3,roughness:.5}),E=new Ot({color:16738740,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.5,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),U=new Ot({color:9055202,map:I,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),k=new Ot({color:65535,map:I,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),et=new Ot({color:65535,metalness:.3,roughness:.1,clearcoat:1,clearcoatRoughness:.05,transparent:!0,opacity:.4,transmission:.8,ior:1.45,reflectivity:.9,envMapIntensity:1,side:be}),rt=new ft(1,32,32,0,Math.PI),$=new y(rt,Q),nt=new y(rt,z);$.scale.set(.85,.85,.8),nt.scale.set(.85,.85,.8),$.position.y=-.2,nt.position.y=-.2,$.rotation.y=Math.PI/2,nt.rotation.y=Math.PI*1.5;const X=new Ae(1,32),vt=new y(X,z);vt.scale.set(.85,.85,.8),vt.position.set(0,-.2,0),vt.rotation.y=Math.PI/2;const yt=new Xt;yt.add($),yt.add(nt),yt.add(vt),m.add(yt);const wt=new ft(.6,32,32,0,Math.PI),Dt=new y(wt,M);Dt.scale.set(1,.95,.95),Dt.position.set(0,1,0),Dt.rotation.y=Math.PI*1.5;const Wt=new y(wt,E);Wt.scale.set(1,.95,.95),Wt.position.set(0,1,0),Wt.rotation.y=Math.PI/2;const at=new Ae(.6,32),pt=new y(at,M);pt.position.set(0,1,0),pt.rotation.y=Math.PI/2,pt.scale.set(1,.95,.95);const bt=new Xt;bt.add(Dt),bt.add(Wt),bt.add(pt),m.add(bt);const O=new ft(.25,32,32),lt=new y(O,z);lt.position.set(-.45,1.35,-.1),m.add(lt);const ot=new y(O,Q);ot.position.set(.45,1.35,-.1),m.add(ot);const ht=new ft(.25,32,32,Math.PI/2,Math.PI),Mt=new y(ht,M);Mt.scale.set(1.1,.6,.8),Mt.position.set(0,.84,.5),Mt.rotation.y=Math.PI;const it=new ft(.25,32,32,Math.PI/2,Math.PI),g=new y(it,E);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=0;const T=new Ae(.25,32),L=new y(T,M);L.scale.set(.8,.6,.8),L.position.set(0,.84,.5),L.rotation.y=Math.PI/2;const F=new Xt;F.add(Mt),F.add(g),F.add(L),m.add(F);const N=new Cn;N.moveTo(0,0),N.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),N.bezierCurveTo(-.6,.3,0,.6,0,1),N.bezierCurveTo(0,.6,.6,.3,.6,0),N.bezierCurveTo(.6,-.3,0,-.3,0,0);const K={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},Z=new Hn(N,K),w=new y(Z,M);w.scale.set(.5,.5,.5),w.position.set(.3,0,0),w.rotation.y=Math.PI,w.rotation.x=Math.PI,m.add(w);const _=new y(Z,k);_.scale.set(.2,.2,.25),_.position.set(.35,-.3,.4),_.rotation.y=Math.PI,_.rotation.x=Math.PI,m.add(_);const C=new y(Z,z);C.scale.set(.25,.25,.27),C.position.set(.38,.3,-.2),C.rotation.y=Math.PI,C.rotation.x=Math.PI,m.add(C);const q=new ft(.35,32,32),V=new y(q,k);V.scale.set(.75,1.25,.65),V.position.set(-.7,-.15,.2),m.add(V);const W=new y(q,et);W.scale.set(.75,1.25,.65),W.position.set(.7,-.15,.2),m.add(W);const dt=new ne(.2,.22,.6,32),ct=new y(dt,M);ct.position.set(-.4,-1.05,0),m.add(ct);const mt=new y(dt,E);mt.position.set(.4,-1.05,0),m.add(mt);const At=new ft(.3,32,32),ut=new y(At,M);ut.scale.set(1,.72,1.5),ut.position.set(-.4,-1.45,.17),m.add(ut);const _t=new y(At,E);_t.scale.set(1,.72,1.5),_t.position.set(.4,-1.45,.17),m.add(_t);const Lt=new ft(.44,32,32),Nt=new y(Lt,z);Nt.position.set(-.15,-.45,-.4),m.add(Nt);const Rt=new y(Lt,Q);Rt.position.set(.15,-.45,-.4),m.add(Rt);const $t=new ft(.18,32,32),zt=new y($t,z);zt.position.set(0,-.35,-.8),m.add(zt),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(tt){const St=new ke("X",{font:tt,size:.2,depth:.05}),Et=new y(St,z);Et.position.set(-.3,.99,.53),Et.rotation.x=le.degToRad(-5),Et.rotation.y=le.degToRad(-15),m.add(Et);const kt=new ke("O",{font:tt,size:.2,depth:.05}),te=new y(kt,k);te.position.set(.14,.99,.53),te.rotation.y=le.degToRad(12),te.rotation.x=le.degToRad(-5),m.add(te);const se=new ke("POP",{font:tt,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});new ke("🐻",{font:tt,size:1,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:5});const oe=new ke("BAO      BEAR",{font:tt,size:2,height:.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.1,bevelSize:.1,bevelSegments:3}),ee=new Ot({color:16716947,metalness:.3,roughness:.6,clearcoat:.2});new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2});const fe=new Ot({color:16766720,metalness:.3,roughness:.6,clearcoat:.2}),ae=new Ot({color:16753920,metalness:.3,roughness:.6,clearcoat:.2}),ve=new y(se,ee);ve.scale.set(.15,.15,.15),ve.position.set(.02,1.16,.1),ve.rotateZ(-25),m.add(ve);const ce=new y(se,U);ce.scale.set(.14,.14,.14),ce.rotateZ(45),ce.position.set(.2,-.7,.3),m.add(ce);const Pe=new y(se,fe);Pe.scale.set(.14,.14,.14),Pe.rotateZ(45),Pe.rotateY(45),Pe.position.set(.3,.7,.3),m.add(Pe);const me=new y(se,fe);me.scale.set(.15,.15,.15),me.rotateZ(45),me.rotateY(45),me.position.set(.35,-1.5,.3),m.add(me);const Be=new y(se,ae);Be.scale.set(.17,.17,.17),Be.rotateZ(45),Be.rotateY(15),Be.position.set(.35,1,.3),m.add(Be);const Re=new y(oe,ee);Re.scale.set(.7,.7,.7),Re.position.set(-6,0,-3),f.add(Re)}),zt.renderOrder=1,m.scale.set(1.4,1.4,1.4),p.add(m),m.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),v.position.set(t.bodyPosition.x,1,t.cameraPosition),v.lookAt(t.bodyPosition.x,0,0),v.position.z=4,m.rotation.x=.1;const G=[w,_,C],xt=new zp,st=[0,Math.PI/2,Math.PI,0,Math.PI/3];d(),Ve(()=>t.bodyPosition,tt=>{m.position.set(tt.x,tt.y,tt.z)}),Ve(()=>t.cameraPosition,tt=>{v.position.set(t.bodyPosition.x,1,tt),v.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{v.aspect=window.innerWidth/window.innerHeight,v.updateProjectionMatrix(),x.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,p)=>(Wn(),Yn(fn,null,[Bt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),Bt("div",AS,[Bt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),Bt("div",PS,[Bt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Bt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),Bt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),CS=$n(RS,[["__scopeId","data-v-cb52c927"]]),IS={class:"pixel-controls"},LS={class:"side-buttons"},DS=Ln({__name:"MetalMachineBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);Vn(()=>{if(e.value){let d=function(fe,ae){const ve=new ne(Yt,Yt,G,32);ve.rotateX(Math.PI/2);const ce=new y(ve,fe),Pe=new Xt;for(let Be=0;Be<xt;Be++){const Re=Be/xt*Math.PI*2,je=new yn(st,tt,St),Ne=new y(je,fe);Ne.position.set((Yt+St/26)*Math.cos(Re),(Yt+St/26)*Math.sin(Re),0),Ne.rotation.z=Re,Pe.add(Ne)}const me=new Xt;return me.add(ce),me.add(Pe),me.position.set(ae.x,ae.y,ae.z),me},p=function(){requestAnimationFrame(p),i.value&&(f.rotation.y+=.03),s.value&&(f.rotation.y-=.03),o.value&&(f.rotation.x-=.03),r.value&&(f.rotation.x+=.03),Et.rotation.z-=.02,kt.rotation.z+=.03,te.rotation.z+=.02,se.rotation.z+=.02,oe.rotation.z-=.03,ee.rotation.y+=.04,m.render(v,x)};const v=new Gn,x=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),m=new zn({antialias:!0,alpha:!0});m.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(m.domElement);const f=new Xt,A=new Xt;v.add(A);const S=new hi(16777215,2);v.add(S);const b=new ui(16777215,4);b.position.set(5,5,5),v.add(b);const B=new li(16777215,5,50);B.position.set(0,2,4),v.add(B);const I=new jn,R=I.load("/3d-bear-arts/assets/metal.jpg"),z=I.load("/3d-bear-arts/assets/pop7.jpg"),Q=I.load("/3d-bear-arts/assets/gear.jpg");R.wrapS=R.wrapT=$e,z.wrapS=z.wrapT=$e,z.repeat.set(2,2);const M=new Ot({color:13882323,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:R});Q.mapping=Ta;const E=new Ot({color:"#d3d3d3",metalness:1,roughness:.25,map:R,envMap:Q,clearcoat:.7,clearcoatRoughness:.3}),U=new Ot({color:"#C0C0C0",metalness:1,roughness:.25,envMap:Q,clearcoat:.7,clearcoatRoughness:.3}),k=new Ot({color:"#C0C0C0",metalness:1,roughness:.25,map:R,envMap:Q,transparent:!0,opacity:.8,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),et=new Ot({color:"#C0C0C0",metalness:1,roughness:.5,map:R,envMap:Q,transparent:!0,opacity:.23,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45}),rt=new Ot({color:13882323,metalness:1,roughness:.25,clearcoat:1,clearcoatRoughness:.05,reflectivity:.9,envMapIntensity:1,side:be});new Ot({color:"#C0C0C0",metalness:1,roughness:.2,transparent:!0,opacity:.4,clearcoat:.7,clearcoatRoughness:.3,transmission:.8,ior:1.45});const $=new Ot({color:"#d3d3d3",metalness:1,roughness:.2,map:Q,envMap:Q,clearcoat:.7,clearcoatRoughness:.3});new Ot({color:12632256,metalness:.9,roughness:.2,clearcoat:.5,clearcoatRoughness:.1,map:Q}),new Ot({color:12632256,metalness:1,roughness:.3,clearcoat:.5,clearcoatRoughness:.1,map:R,transparent:!0,opacity:.3});const nt=new ft(1,32,32,0,Math.PI),X=new y(nt,et),vt=new y(nt,E);X.scale.set(.85,.85,.8),vt.scale.set(.85,.85,.8),X.position.y=-.2,vt.position.y=-.2,X.rotation.y=Math.PI/2,vt.rotation.y=Math.PI*1.5;const yt=new Ae(1,32),wt=new y(yt,k);wt.scale.set(.85,.85,.8),wt.position.set(0,-.2,0),wt.rotation.y=Math.PI/2;const Dt=new Xt;Dt.add(X),Dt.add(vt),Dt.add(wt),f.add(Dt);const Wt=new ft(.6,32,32,0,Math.PI),at=new y(Wt,E);at.scale.set(1,.95,.95),at.position.set(0,1,0),at.rotation.y=Math.PI*1.5;const pt=new y(Wt,et);pt.scale.set(1,.95,.95),pt.position.set(0,1,0),pt.rotation.y=Math.PI/2;const bt=new Ae(.6,32),O=new y(bt,k);O.position.set(0,1,0),O.rotation.y=Math.PI/2,O.scale.set(1,.95,.95);const lt=new Xt;lt.add(at),lt.add(pt),lt.add(O),f.add(lt);const ot=new ft(.25,32,32),ht=new y(ot,E);ht.position.set(-.45,1.35,-.1),f.add(ht);const Mt=new y(ot,k);Mt.position.set(.45,1.35,-.1),f.add(Mt);const it=new ft(.25,32,32,Math.PI/2,Math.PI),g=new y(it,E);g.scale.set(1.1,.6,.8),g.position.set(0,.84,.5),g.rotation.y=Math.PI;const T=new ft(.25,32,32,Math.PI/2,Math.PI),L=new y(T,k);L.scale.set(1.1,.6,.8),L.position.set(0,.84,.5),L.rotation.y=0;const F=new Ae(.25,32),N=new y(F,rt);N.scale.set(.8,.6,.8),N.position.set(0,.84,.5),N.rotation.y=Math.PI/2;const K=new Xt;K.add(g),K.add(L),K.add(N),f.add(K);const Z=new Cn;Z.moveTo(0,0),Z.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Z.bezierCurveTo(-.6,.3,0,.6,0,1),Z.bezierCurveTo(0,.6,.6,.3,.6,0),Z.bezierCurveTo(.6,-.3,0,-.3,0,0);const w={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},_=new Hn(Z,w),C=new ft(.35,32,32),q=new y(C,E);q.scale.set(.75,1.25,.65),q.position.set(-.7,-.15,.2),f.add(q);const V=new y(C,k);V.scale.set(.75,1.25,.65),V.position.set(.7,-.15,.2),f.add(V);const W=new ne(.2,.22,.6,32),dt=new y(W,E);dt.position.set(-.4,-1.05,0),f.add(dt);const ct=new y(W,k);ct.position.set(.4,-1.05,0),f.add(ct);const mt=new ft(.3,32,32),At=new y(mt,E);At.scale.set(1,.72,1.5),At.position.set(-.4,-1.45,.17),f.add(At);const ut=new y(mt,k);ut.scale.set(1,.72,1.5),ut.position.set(.4,-1.45,.17),f.add(ut);const _t=new ft(.44,32,32),Lt=new y(_t,E);Lt.position.set(-.15,-.45,-.4),f.add(Lt);const Nt=new y(_t,et);Nt.position.set(.15,-.45,-.4),f.add(Nt);const Rt=new ft(.18,32,32),$t=new y(Rt,E);$t.position.set(0,-.35,-.8),f.add($t),new di().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(fe){const ae=new ke("X",{font:fe,size:.2,depth:.05});new es({color:0});const ve=new y(ae,M);ve.position.set(-.3,.99,.53),ve.rotation.x=le.degToRad(-5),ve.rotation.y=le.degToRad(-15),f.add(ve);const ce=new ke("O",{font:fe,size:.2,depth:.05});new es({color:0});const Pe=new y(ce,M);Pe.position.set(.14,.99,.53),Pe.rotation.y=le.degToRad(12),Pe.rotation.x=le.degToRad(-5),f.add(Pe)}),$t.renderOrder=1;const Yt=1.2,G=.5,xt=8,st=.7,tt=.3,St=.5,Et=d($,{x:-2,y:0,z:0}),kt=d($,{x:0,y:0,z:0}),te=d($,{x:2,y:0,z:0}),se=d($,{x:2,y:0,z:0}),oe=d($,{x:2,y:-2,z:0}),ee=new y(_,U);ee.scale.set(.3,.3,.3),ee.position.set(.25,1.1,0),ee.rotation.y=Math.PI,ee.rotation.x=Math.PI,f.add(ee),Et.position.set(.35,0,0),kt.position.set(.25,-.3,.4),te.position.set(.3,.3,-.2),se.position.set(.25,.17,.4),oe.position.set(.5,-.3,.45),Et.scale.set(.2,.2,.2),kt.scale.set(.18,.18,.18),te.scale.set(.15,.15,.15),se.scale.set(.17,.17,.17),oe.scale.set(.15,.15,.15),kt.rotation.z=Math.PI/4,te.rotation.z=-Math.PI/4,se.rotation.y=-Math.PI/2,oe.rotation.y=-Math.PI/2,f.add(Et),f.add(kt),f.add(te),f.add(se),f.add(oe),f.rotation.x=.1,f.scale.set(1.4,1.4,1.4),v.add(f),f.position.set(t.bodyPosition.x,t.bodyPosition.y,t.bodyPosition.z),x.position.set(t.bodyPosition.x,1,t.cameraPosition),x.lookAt(t.bodyPosition.x,0,0),x.position.z=4,p(),Ve(()=>t.bodyPosition,fe=>{f.position.set(fe.x,fe.y,fe.z)}),Ve(()=>t.cameraPosition,fe=>{x.position.set(t.bodyPosition.x,1,fe),x.lookAt(t.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{x.aspect=window.innerWidth/window.innerHeight,x.updateProjectionMatrix(),m.setSize(window.innerWidth,window.innerHeight)})}});function a(){s.value=!0}function c(){i.value=!0}function l(){o.value=!0}function h(){r.value=!0}function u(){s.value=!1,i.value=!1,o.value=!1,r.value=!1}return(d,p)=>(Wn(),Yn(fn,null,[Bt("div",{ref_key:"threeCanvas",ref:e,class:kn(n.background?"no-bg":"three-canvas")},null,2),Bt("div",IS,[Bt("button",{class:"pixel-btn up",onMousedown:l,onMouseup:u},"UP",32),Bt("div",LS,[Bt("button",{class:"pixel-btn left",onMousedown:a,onMouseup:u},"LEFT",32),Bt("button",{class:"pixel-btn right",onMousedown:c,onMouseup:u},"RIGHT",32)]),Bt("button",{class:"pixel-btn down",onMousedown:h,onMouseup:u},"DOWN",32)])],64))}}),US=$n(DS,[["__scopeId","data-v-9a57b6d8"]]),NS={class:"pixel-controls"},FS={class:"side-buttons"},OS={class:"directional-buttons"},BS={class:"horizontal-buttons"},zS={class:"directional-buttons-woman"},GS={class:"horizontal-buttons-woman"},HS={class:"directional-buttons-kid"},kS={class:"horizontal-buttons-kid"},aa=.1,ca=.05,la=.08,VS=Ln({__name:"Water",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const t=n,e=jt(null);let i=jt(!1),s=jt(!1),o=jt(!1),r=jt(!1);const a=po(null),c=jt(!1),l=jt(!1),h=jt(!1),u=jt(!1),d=po(null),p=po(null),v=jt(!1),x=jt(!1),m=jt(!1),f=jt(!1),A=jt(!1),S=jt(!1),b=jt(!1),B=jt(!1),I=new zn({antialias:!0});I.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(I.domElement);const R=new Gn,z=new qe(75,window.innerWidth/window.innerHeight,.1,1e3);z.position.z=5,Vn(()=>{if(e.value){let it=function(){const Tt=new Xt,ye=new ft(.2,32,32),Ee=new Ut({color:16767916}),ge=new y(ye,Ee);ge.position.set(0,1.5,0),Tt.add(ge);const Ie=new ft(.21,32,32,0,Math.PI*2,0,Math.PI/2),pe=new Ut({color:16711680}),Ce=new y(Ie,pe);Ce.position.set(0,1.58,0),Tt.add(Ce);const ze=new ne(.25,.25,.6,32),Te=new Ut({color:16767916}),Fe=new y(ze,Te);Fe.position.set(0,1,0),Tt.add(Fe);const Ke=new ne(.26,.26,.3,32),We=new Ut({color:255}),sn=new y(Ke,We);sn.position.set(0,.65,0),Tt.add(sn);const tn=new ne(.1,.1,.5,32),en=new Ut({color:16767916}),cn=new y(tn,en);cn.position.set(-.15,.25,0),Tt.add(cn);const rn=new y(tn,en);rn.position.set(.15,.25,0),Tt.add(rn);const ln=new ne(.08,.08,.5,32),dn=new y(ln,en);dn.position.set(-.35,1.3,0),dn.rotation.z=Math.PI/4,Tt.add(dn);const bn=new y(ln,en);return bn.position.set(.35,1.3,0),bn.rotation.z=-Math.PI/4,Tt.add(bn),Tt.scale.set(.27,.27,.27),Tt.position.set(-.2,-.1,-.15),Tt},g=function(){const Tt=new Xt,ye=new ft(.18,32,32),Ee=new Ut({color:16767916}),ge=new y(ye,Ee);ge.position.set(0,1.2,.04),Tt.add(ge);const Ie=new ft(.19,32,32,.4,Math.PI*2,0,Math.PI/2),pe=new ne(.18,.18,.4,32),Ce=new Ut({color:9127187}),ze=new y(Ie,Ce);ze.position.set(0,1.28,0),Tt.add(ze);const Te=new y(pe,Ce);Te.position.set(0,1.1,-.01),Tt.add(Te);const Fe=new ne(.18,.2,.5,32),Ke=new Ut({color:16767916}),We=new y(Fe,Ke);We.position.set(0,.85,0),Tt.add(We);const sn=new ft(.08,32,32,0,Math.PI),tn=new Ut({color:16738740}),en=new y(sn,tn);en.position.set(-.09,.98,.15),Tt.add(en);const cn=new y(sn,tn);cn.position.set(.09,.98,.15),Tt.add(cn);const rn=new ne(.22,.22,.25,32),ln=new Ut({color:16738740}),dn=new y(rn,ln);dn.position.set(0,.6,0),Tt.add(dn);const bn=new ne(.1,.1,.6,32),bi=new Ut({color:16767916}),Fi=new y(bn,bi);Fi.position.set(-.09,.5,.2),Fi.rotation.x=Math.PI/2,Tt.add(Fi);const Oi=new y(bn,bi);Oi.position.set(.09,.5,.2),Oi.rotation.x=Math.PI/2,Tt.add(Oi);const Bi=new ne(.08,.08,.35,32),Ei=new y(Bi,bi);Ei.position.set(-.24,.95,.18),Ei.rotation.x=Math.PI/2,Tt.add(Ei);const fi=new y(Bi,bi);return fi.position.set(.2,.85,0),fi.rotation.z=Math.PI/20,Tt.add(fi),Tt.scale.set(.27,.27,.27),Tt.position.set(.2,-.15,-.32),Tt},T=function(){const Tt=new Xt,ye=new ft(.2,32,32),Ee=new Ut({color:16767916}),ge=new y(ye,Ee);ge.position.set(0,1.5,0),Tt.add(ge);const Ie=new ft(.21,32,32,0,Math.PI*2,0,Math.PI/2),pe=new Ut({color:25600}),Ce=new y(Ie,pe);Ce.position.set(0,1.58,0),Tt.add(Ce);const ze=new ne(.22,.22,.5,32),Te=new Ut({color:16767916}),Fe=new y(ze,Te);Fe.position.set(0,1,0),Tt.add(Fe);const Ke=new ne(.23,.23,.3,32),We=new Ut({color:8388736}),sn=new y(Ke,We);sn.position.set(0,.65,0),Tt.add(sn);const tn=new ne(.1,.1,.5,32),en=new Ut({color:16767916}),cn=new y(tn,en);cn.position.set(-.15,.3,-.25),cn.rotation.x=Math.PI/6,Tt.add(cn);const rn=new y(tn,en);rn.position.set(.15,.3,.25),rn.rotation.x=-Math.PI/6,Tt.add(rn);const ln=new ne(.08,.08,.4,32),dn=new y(ln,en);dn.position.set(-.28,1,-.2),dn.rotation.x=Math.PI/6,Tt.add(dn);const bn=new y(ln,en);return bn.position.set(.28,1.3,.1),bn.rotation.z=-Math.PI/8,Tt.add(bn),Tt.scale.set(.15,.15,.15),Tt.position.set(.3,-.25,.25),Tt.rotation.x=Math.PI/12,Tt.rotation.y=Math.PI/2,Tt.rotation.z=-Math.PI/3,Tt},L=function(Tt){let ye=1,Ee=0;function ge(){requestAnimationFrame(ge),Tt.position.x+=.01*ye,Tt.position.x>=.35?(ye=-1,Tt.rotation.y=Math.PI):Tt.position.x<=-.35&&(ye=1,Tt.rotation.y=0),Ee+=.003,Tt.position.y=-.4+Math.sin(Ee)*.1,Z.render(N,K)}ge()},F=function(){requestAnimationFrame(F),i.value&&(w.rotation.y+=.03),s.value&&(w.rotation.y-=.03),o.value&&(w.rotation.x-=.03),r.value&&(w.rotation.x+=.03),ve.uniforms.u_time.value+=.25,j.rotation.y+=.04,Z.render(N,K)};const N=new Gn,K=new qe(75,window.innerWidth/window.innerHeight,.1,1e3),Z=new zn({antialias:!0,alpha:!0});Z.setSize(window.innerWidth,window.innerHeight),e.value.appendChild(Z.domElement);const w=new Xt,_=new Xt;N.add(_);const C=new hi(16777215,2);N.add(C);const q=new ui(16777215,4);q.position.set(5,5,5),N.add(q);const V=new li(16777215,5,50);V.position.set(0,2,4),N.add(V);const W=new jn,dt=W.load("/3d-bear-arts/assets/beach.jpg");dt.repeat.set(.8,1);const ct=W.load("/3d-bear-arts/assets/sun.jpg");dt.wrapS=dt.wrapT=$e,dt.repeat.set(.8,1),ct.wrapS=ct.wrapT=$e;const mt=new Ot({color:11592447,map:dt,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),At=new Ot({color:11592447,map:dt,metalness:.3,roughness:.5,transparent:!0,opacity:.6,side:be,ior:1.33,depthWrite:!1,depthTest:!0}),ut=new Ot({color:11592447,map:dt,metalness:.1,roughness:.6,transparent:!0,opacity:.6,clearcoat:.9,clearcoatRoughness:.4,transmission:.7,ior:1.2,depthTest:!0,envMapIntensity:.8}),_t=new Ot({color:11592447,map:dt,metalness:.1,roughness:.6,transparent:!0,opacity:.3,clearcoat:.9,clearcoatRoughness:.4,ior:1.2,depthWrite:!1,depthTest:!0,envMapIntensity:.6,side:be}),Lt=new Ot({color:11592447,map:dt,metalness:.3,roughness:.5,transparent:!0,opacity:.8,side:be,ior:1.33}),Nt=new Ot({color:11592447,map:dt,metalness:.2,roughness:.7,clearcoat:.05,clearcoatRoughness:.9}),Rt=new ft(1,32,32,0,Math.PI),$t=new y(Rt,_t),zt=new y(Rt,At);$t.scale.set(.85,.85,.8),zt.scale.set(.85,.85,.8),$t.position.y=-.2,zt.position.y=-.2,$t.rotation.y=Math.PI/2,zt.rotation.y=Math.PI*1.5;const Yt=new Ae(1,32),G=new y(Yt,mt);G.scale.set(.85,.85,.8),G.position.set(0,-.2,0),G.rotation.y=Math.PI/2;const xt=new Xt;xt.add($t),xt.add(zt),xt.add(G),w.add(xt);const st=new ft(.6,32,32,0,Math.PI),tt=new y(st,mt);tt.scale.set(1,.95,.95),tt.position.set(0,1,0),tt.rotation.y=Math.PI*1.5;const St=new y(st,ut);St.scale.set(1,.95,.95),St.position.set(0,1,0),St.rotation.y=Math.PI/2;const Et=new Ae(.6,32),kt=new y(Et,mt);kt.position.set(0,1,0),kt.rotation.y=Math.PI/2,kt.scale.set(1,.95,.95);const te=new Xt;te.add(tt),te.add(St),te.add(kt),w.add(te);const se=new ft(.6,32,32,0,Math.PI*2,0,Math.PI/2),oe=new Ot({color:11592447,metalness:.1,roughness:.2,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.9,transmission:.9,ior:1.33,reflectivity:.8,envMapIntensity:1}),ee=new y(se,oe);ee.position.set(0,-.2,0),ee.rotation.x=Math.PI,ee.scale.set(1.25,1.25,1.25),xt.add(ee);const fe=new Ot({color:49151,metalness:.1,roughness:.5,clearcoat:.7,clearcoatRoughness:.25,side:be,transparent:!0,opacity:.7,depthWrite:!1}),ae=new y(Yt,fe);ae.scale.set(.7,.7,.7),ae.position.set(0,-.3,0),ae.rotation.x=Math.PI/2,ae.renderOrder=1,xt.add(ae),w.add(xt);const ve=new on({transparent:!0,depthWrite:!1,depthTest:!0,uniforms:{u_time:{value:0},u_waveFrequency:{value:8},u_waveAmplitude:{value:.05},u_waveSpeed:{value:.2}},vertexShader:`
      ...
      `,vt=new on({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:nt,fragmentShader:X,transparent:!1,depthWrite:!0}),yt=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
