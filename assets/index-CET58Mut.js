...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wi,depthTest:!1,depthWrite:!1})}function bh(){return new dt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zl(),fragmentShader:`
		...
		`,blending:wi,depthTest:!1,depthWrite:!1})}function Th(){return new dt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zl(),fragmentShader:`
...
`)a=0,c-=s;else{const h=$E(u,r,a,c,t);a+=h.offsetX,o.push(h.path)}}return o}function $E(n,e,t,i,r){const s=r.glyphs[n]||r.glyphs["?"];if(!s){console.error('THREE.Font: character "'+n+'" does not exists in font family '+r.familyName+".");return}const o=new XE;let a,c,l,u,h,f,d,_;if(s.o){const M=s._cachedOutline||(s._cachedOutline=s.o.split(" "));for(let m=0,p=M.length;m<p;)switch(M[m++]){case"m":a=M[m++]*e+t,c=M[m++]*e+i,o.moveTo(a,c);break;case"l":a=M[m++]*e+t,c=M[m++]*e+i,o.lineTo(a,c);break;case"q":l=M[m++]*e+t,u=M[m++]*e+i,h=M[m++]*e+t,f=M[m++]*e+i,o.quadraticCurveTo(h,f,l,u);break;case"b":l=M[m++]*e+t,u=M[m++]*e+i,h=M[m++]*e+t,f=M[m++]*e+i,d=M[m++]*e+t,_=M[m++]*e+i,o.bezierCurveTo(h,f,d,_,l,u);break}}return{offsetX:s.ha*e,path:o}}class an extends jt{constructor(e,t={}){const i=t.font;if(i===void 0)super();else{const r=i.generateShapes(e,t.size);t.depth===void 0&&t.height!==void 0&&console.warn("THREE.TextGeometry: .height is now depreciated. Please use .depth instead"),t.depth=t.depth!==void 0?t.depth:t.height!==void 0?t.height:50,t.bevelThickness===void 0&&(t.bevelThickness=10),t.bevelSize===void 0&&(t.bevelSize=8),t.bevelEnabled===void 0&&(t.bevelEnabled=!1),super(r,t)}this.type="TextGeometry"}}const KE=Zt({__name:"PinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.03,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.5);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new dt({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
        ...
        `}),h=new Ze({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=new Ze({color:13369344,metalness:.4,roughness:.3,clearcoat:.3,clearcoatRoughness:.2,transparent:!0,opacity:.99}),d=new pt,_=new Ee(1,32,32),M=new H(_,h);M.scale.set(.85,.85,.8),M.position.y=-.2,d.add(M);const m=new Ee(.6,32,32),p=new H(m,h);p.scale.set(1,.95,.95),p.position.set(0,1,0),d.add(p);const b=new Ee(.25,32,32),y=new H(b,h);y.position.set(-.45,1.35,-.1),d.add(y);const S=new H(b,h);S.position.set(.45,1.35,-.1),d.add(S);const D=new Ee(.25,32,32),C=new H(D,h);C.scale.set(1,.6,.8),C.position.set(0,.85,.5),d.add(C);const A=new qt;A.moveTo(0,0),A.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),A.bezierCurveTo(-.6,.3,0,.6,0,1),A.bezierCurveTo(0,.6,.6,.3,.6,0),A.bezierCurveTo(.6,-.3,0,-.3,0,0);const I={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ne=new jt(A,I),x=new H(ne,f);x.scale.set(.5,.5,.5),x.position.set(0,.34,.8),x.rotation.y=Math.PI,x.rotation.x=Math.PI,d.add(x);const w=new Ee(.35,32,32),O=new H(w,h);O.scale.set(.75,1.25,.65),O.position.set(-.7,-.15,.2),d.add(O);const G=new H(w,h);G.scale.set(.75,1.25,.65),G.position.set(.7,-.15,.2),d.add(G);const j=new on(.2,.22,.6,32),ie=new H(j,h);ie.position.set(-.4,-1.05,0),d.add(ie);const V=new H(j,h);V.position.set(.4,-1.05,0),d.add(V);const Z=new Ee(.3,32,32),B=new H(Z,h);B.scale.set(1,.72,1.5),B.position.set(-.4,-1.45,.17),d.add(B);const ge=new H(Z,h);ge.scale.set(1,.72,1.5),ge.position.set(.4,-1.45,.17),d.add(ge);const he=new Ee(.44,32,32),_e=new H(he,h);_e.position.set(-.15,-.45,-.4),d.add(_e);const Se=new H(he,h);Se.position.set(.15,-.45,-.4),d.add(Se);const Ue=new Ee(.18,32,32),Q=new H(Ue,f);Q.position.set(0,-.35,-.8),d.add(Q),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(K){const ce=new an("X",{font:K,size:.2,depth:.05}),xe=new gt({color:0}),ee=new H(ce,xe);ee.position.set(-.34,1,.5),d.add(ee)});const de=new Ee(.1,32,32),U=new gt({color:0}),oe=new H(de,U);oe.position.set(.2,1.1,.54),d.add(oe),r.add(d),i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),Ot(()=>e.bodyPosition,K=>{d.position.set(K.x,K.y,K.z)}),Ot(()=>e.cameraPosition,K=>{s.position.set(e.bodyPosition.x,1,K),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:ri(n.background?"no-bg":"three-canvas")},null,2))}}),ep=gn(KE,[["__scopeId","data-v-d0efbfd4"]]),jE=Zt({__name:"PurpleBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.03,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.5);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new dt({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `}),h=new Ze({color:10573288,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});new Ze({color:16766720,metalness:.4,roughness:.3,clearcoat:.3,clearcoatRoughness:.2,transparent:!0,opacity:.99});const f=new Ze({color:16766720,metalness:.05,roughness:10,clearcoat:.6,clearcoatRoughness:.1,opacity:1,transparent:!1}),d=new pt,_=new Ee(1,32,32),M=new H(_,h);M.scale.set(.85,.85,.8),M.position.y=-.2,d.add(M);const m=new Ee(.6,32,32),p=new H(m,h);p.scale.set(1,.95,.95),p.position.set(0,1,0),d.add(p);const b=new Ee(.25,32,32),y=new H(b,h);y.position.set(-.45,1.35,-.1),d.add(y);const S=new H(b,h);S.position.set(.45,1.35,-.1),d.add(S);const D=new Ee(.25,32,32),C=new H(D,h);C.scale.set(1,.6,.8),C.position.set(0,.85,.5),d.add(C);const A=new qt;A.moveTo(0,0),A.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),A.bezierCurveTo(-.6,.3,0,.6,0,1),A.bezierCurveTo(0,.6,.6,.3,.6,0),A.bezierCurveTo(.6,-.3,0,-.3,0,0);const I={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},ne=new jt(A,I),x=new H(ne,u);x.scale.set(.5,.5,.5),x.position.set(0,.34,.8),x.rotation.y=Math.PI,x.rotation.x=Math.PI,d.add(x);const w=new Ee(.35,32,32),O=new H(w,h);O.scale.set(.75,1.25,.65),O.position.set(-.7,-.15,.2),d.add(O);const G=new H(w,h);G.scale.set(.75,1.25,.65),G.position.set(.7,-.15,.2),d.add(G);const j=new on(.2,.22,.6,32),ie=new H(j,h);ie.position.set(-.4,-1.05,0),d.add(ie);const V=new H(j,h);V.position.set(.4,-1.05,0),d.add(V);const Z=new Ee(.3,32,32),B=new H(Z,h);B.scale.set(1,.72,1.5),B.position.set(-.4,-1.45,.17),d.add(B);const ge=new H(Z,h);ge.scale.set(1,.72,1.5),ge.position.set(.4,-1.45,.17),d.add(ge);const he=new Ee(.44,32,32),_e=new H(he,h);_e.position.set(-.15,-.45,-.4),d.add(_e);const Se=new H(he,h);Se.position.set(.15,-.45,-.4),d.add(Se);const Ue=new Ee(.18,32,32),Q=new H(Ue,f);Q.position.set(0,-.35,-.8),d.add(Q),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(de){const U=new an("X",{font:de,size:.2,depth:.05}),oe=new gt({color:0}),K=new H(U,oe);K.position.set(-.34,1,.5),d.add(K);const ce=new an("O",{font:de,size:.2,depth:.05}),xe=new gt({color:0}),ee=new H(ce,xe);ee.position.set(.16,1,.53),ee.rotation.y=ut.degToRad(32),d.add(ee)}),r.add(d),i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),Ot(()=>e.bodyPosition,de=>{d.position.set(de.x,de.y,de.z)}),Ot(()=>e.cameraPosition,de=>{s.position.set(e.bodyPosition.x,1,de),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:ri(n.background?"no-bg":"three-canvas")},null,2))}}),tp=gn(jE,[["__scopeId","data-v-46de1bfd"]]),ZE=Zt({__name:"BlueBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.03,u.uniforms.time.value+=.04,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.2);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new dt({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`,aw=Zt({__name:"DiamondBear",setup(n){const e=Et(null);return pn(()=>{const t=new ai,i=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),r=new oi({antialias:!0,alpha:!0});r.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(r.domElement);const s=new li(16777215,5);t.add(s);const o=new ci(16777215,20);o.position.set(5,5,5),t.add(o);const a=new dt({uniforms:{time:{value:0}},vertexShader:sw,fragmentShader:ow,transparent:!0,opacity:.1}),c=new pt,l=new Ee(1,32,32),u=new H(l,a);u.scale.set(.85,.85,.8),u.position.y=-.2,c.add(u);const h=new Ee(.6,32,32),f=new H(h,a);f.scale.set(1,.95,.95),f.position.set(0,1,0),c.add(f);const d=new Ee(.25,32,32),_=new H(d,a);_.position.set(-.45,1.35,-.1),c.add(_);const M=new H(d,a);M.position.set(.45,1.35,-.1),c.add(M);const m=new Ee(.25,32,32),p=new H(m,a);p.scale.set(1,.6,.8),p.position.set(0,.85,.5),c.add(p);const b=new Ee(.35,32,32),y=new H(b,a);y.scale.set(.75,1.25,.65),y.position.set(-.7,-.15,.2),c.add(y);const S=new H(b,a);S.scale.set(.75,1.25,.65),S.position.set(.7,-.15,.2),c.add(S);const D=new Ee(.3,32,32),C=new H(D,a);C.scale.set(1,.72,1.5),C.position.set(-.4,-1.45,.17),c.add(C);const A=new H(D,a);A.scale.set(1,.72,1.5),A.position.set(.4,-1.45,.17),c.add(A);const I=new on(.2,.22,.6,32),ne=new H(I,a);ne.position.set(-.4,-1.05,0),c.add(ne);const x=new H(I,a);x.position.set(.4,-1.05,0),c.add(x);const w=new Ee(.44,32,32),O=new H(w,a);O.position.set(-.15,-.45,-.4),c.add(O);const G=new H(w,a);G.position.set(.15,-.45,-.4),c.add(G);const j=new Ee(.18,32,32),ie=new H(j,a);ie.position.set(0,-.35,-.75),c.add(ie);const V=new Cs({color:16738740,metalness:1,roughness:.44}),Z=new Cs({color:16776960,metalness:1,roughness:.44}),B=new qt;B.moveTo(0,.15),B.lineTo(.1,0),B.lineTo(0,-.15),B.lineTo(-.1,0),B.lineTo(0,.15);const ge={depth:.07,bevelEnabled:!1},he=new jt(B,ge),_e=new H(he,V);_e.position.set(-.25,1,.5),_e.rotation.y=Math.PI/30,c.add(_e);const Se=new H(he,Z);Se.position.set(.25,1,.5),Se.rotation.y=Math.PI/30,c.add(Se),t.add(c),i.position.set(0,1,4),i.lookAt(0,0,0);function Ue(){requestAnimationFrame(Ue),a.uniforms.time.value+=.1,c.rotation.y+=.02,r.render(t,i)}Ue(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),cw=gn(aw,[["__scopeId","data-v-a7796925"]]),Jh=`
  varying vec2 vUv;
        void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `,lw=Zt({__name:"GlassBear",setup(n){const e=Et(null);return pn(()=>{const t=new ai,i=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),r=new oi({antialias:!0,alpha:!0});r.setSize(window.innerWidth,window.innerHeight),e.value&&e.value.appendChild(r.domElement);const s=new li(16777215,.5);t.add(s);const o=new ci(16777215,10);o.position.set(5,5,5),t.add(o);const a=new dt({uniforms:{time:{value:0},opacity:{value:.8}},vertexShader:Jh,fragmentShader:Qh,transparent:!0}),c=new dt({uniforms:{time:{value:0},opacity:{value:.6}},vertexShader:Jh,fragmentShader:Qh,transparent:!0,depthWrite:!1}),l=new pt,u=new Ee(1,32,32),h=new H(u,c);h.scale.set(.85,.85,.8),h.position.y=-.2,l.add(h);const f=new Ee(.6,32,32),d=new H(f,c);d.scale.set(1,.95,.95),d.position.set(0,1,0),l.add(d);const _=new Ee(.25,32,32),M=new H(_,a);M.position.set(-.45,1.35,-.1),l.add(M);const m=new H(_,c);m.position.set(.45,1.35,-.1),l.add(m);const p=new Ee(.25,32,32),b=new H(p,a);b.scale.set(1,.6,.8),b.position.set(0,.85,.5),l.add(b);const y=new Ee(.35,32,32),S=new H(y,a);S.scale.set(.75,1.25,.65),S.position.set(-.7,-.15,.2),l.add(S);const D=new H(y,a);D.scale.set(.75,1.25,.65),D.position.set(.7,-.15,.2),l.add(D);const C=new Ee(.3,32,32),A=new H(C,a);A.scale.set(1,.72,1.5),A.position.set(-.4,-1.45,.17),l.add(A);const I=new H(C,a);I.scale.set(1,.72,1.5),I.position.set(.4,-1.45,.17),l.add(I);const ne=new on(.2,.22,.6,32),x=new H(ne,a);x.position.set(-.4,-1.05,0),l.add(x);const w=new H(ne,a);w.position.set(.4,-1.05,0),l.add(w);const O=new Ee(.44,32,32);new H(O,a).position.set(-.15,-.45,-.4),new H(O,a).position.set(.15,-.45,-.4);const ie=new Ee(.18,32,32),V=new H(ie,a);V.position.set(0,-.35,-.75),l.add(V);const Z=new qt;Z.moveTo(0,0),Z.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Z.bezierCurveTo(-.6,.3,0,.6,0,1),Z.bezierCurveTo(0,.6,.6,.3,.6,0),Z.bezierCurveTo(.6,-.3,0,-.3,0,0);const B=new Cs({color:8900331,metalness:1,roughness:.44}),ge=new Cs({color:16776960,metalness:1,roughness:.44}),he=new qt;he.moveTo(0,.15),he.lineTo(.1,0),he.lineTo(0,-.15),he.lineTo(-.1,0),he.lineTo(0,.15);const _e={depth:.07,bevelEnabled:!1},Se=new jt(he,_e),Ue=new H(Se,B);Ue.position.set(-.25,1,.5),Ue.rotation.y=Math.PI/30,l.add(Ue);const Q=new H(Se,ge);Q.position.set(.25,1,.5),Q.rotation.y=Math.PI/30,l.add(Q),new Ze({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const fe={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},de=new Ze({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),U=new jt(Z,fe),oe=new H(U,de);oe.scale.set(.5,.5,.5),oe.position.set(0,0,0),oe.rotation.y=Math.PI,oe.rotation.x=Math.PI,l.add(oe);const K=new qt;K.moveTo(0,.6),K.lineTo(.3,.3),K.lineTo(.6,0),K.lineTo(.3,-.3),K.lineTo(0,-.6),K.lineTo(-.3,-.3),K.lineTo(-.6,0),K.lineTo(-.3,.3),K.lineTo(0,.6);const ce={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1},xe=new jt(K,ce),ee=new Ze({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1}),g=new H(xe,ee);g.scale.set(.5,.5,.5),g.position.set(0,0,0),t.add(l),i.position.set(0,1,4),i.lookAt(0,0,0);const T=()=>{requestAnimationFrame(T),a.uniforms.time.value+=.03,l.rotation.y+=.03,r.render(t,i)};T(),window.addEventListener("resize",()=>{i.aspect=window.innerWidth/window.innerHeight,i.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)})}),(t,i)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:e,class:"three-container"},null,512))}}),uw=gn(lw,[["__scopeId","data-v-fa1425bf"]]),hw=Zt({__name:"BluePinkBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),d.rotation.y+=.02,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.5);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new Ze({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),h=new Ze({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=m=>{const p=new pt,b=new Ee(1,32,32),y=new H(b,m);y.scale.set(.85,.85,.8),y.position.y=-.2,p.add(y);const S=new Ee(.6,32,32),D=new H(S,m);D.scale.set(1,.95,.95),D.position.set(0,1,0),p.add(D);const C=new Ee(.25,32,32),A=new H(C,m);A.scale.set(1,.6,.8),A.position.set(0,.85,.5),p.add(A),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(xe){const ee=new an("X",{font:xe,size:.18,depth:.05}),g=new gt({color:0}),T=new H(ee,g);T.position.set(-.3,.99,.53),T.rotation.x=ut.degToRad(-5),T.rotation.y=ut.degToRad(-15),p.add(T);const L=new an("+",{font:xe,size:.25,depth:.1}),F=new gt({color:0}),N=new H(L,F);N.position.set(.14,.99,.53),N.rotation.y=ut.degToRad(12),N.rotation.x=ut.degToRad(-5),p.add(N)});const ne=new qt;ne.moveTo(0,0),ne.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),ne.bezierCurveTo(-.6,.3,0,.6,0,1),ne.bezierCurveTo(0,.6,.6,.3,.6,0),ne.bezierCurveTo(.6,-.3,0,-.3,0,0);const x={depth:.05,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.05,bevelThickness:.05},w=new jt(ne,x),O=new gt({color:0}),G=new H(w,O);G.scale.set(.1,.1,.1),G.rotation.z=ut.degToRad(210),G.rotation.x=ut.degToRad(5),G.rotation.y=ut.degToRad(-45),G.position.set(-.4,.9,.45),p.add(G);const j=new Ee(.25,32,32),ie=new H(j,u);ie.position.set(-.45,1.35,-.1),p.add(ie);const V=new H(j,h);V.position.set(.45,1.35,-.1),p.add(V);const Z=new Ee(.35,32,32),B=new H(Z,u);B.scale.set(.75,1.25,.65),B.position.set(-.7,-.15,.2),p.add(B);const ge=new H(Z,h);ge.scale.set(.75,1.25,.65),ge.position.set(.7,-.15,.2),p.add(ge);const he=new on(.2,.22,.6,32),_e=new H(he,u);_e.position.set(-.4,-1.05,0),p.add(_e);const Se=new H(he,h);Se.position.set(.4,-1.05,0),p.add(Se);const Ue=new Ee(.3,32,32),Q=new H(Ue,u);Q.scale.set(1,.72,1.5),Q.position.set(-.4,-1.45,.17),p.add(Q);const fe=new H(Ue,h);fe.scale.set(1,.72,1.5),fe.position.set(.4,-1.45,.17),p.add(fe);const de=new Ee(.44,32,32),U=new H(de,u);U.position.set(-.15,-.45,-.4),p.add(U);const oe=new H(de,h);oe.position.set(.15,-.45,-.4),p.add(oe);const K=new Ee(.18,32,32),ce=new H(K,m);return ce.position.set(0,-.35,-.8),p.add(ce),p},d=new pt,_=f(u),M=f(h);_.position.x=-.01,M.position.x=.01,d.add(_),d.add(M),r.add(d),s.position.z=4,i(),d.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0)}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:"three-canvas"},null,512))}}),fw=gn(hw,[["__scopeId","data-v-9e6b205d"]]),dw=Zt({__name:"HalfTransparentBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),p.rotation.y+=.03,u.uniforms.time.value+=.04,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.2);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new dt({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `});new Ze({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const h=new Ze({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.39});new Ze({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),new Ze({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const f=new Ze({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),d=`
    varying vec2 vUv;
          void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,M=new dt({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:d,fragmentShader:_,transparent:!0,depthWrite:!1}),m=new dt({uniforms:{time:{value:0},opacity:{value:.4}},vertexShader:d,fragmentShader:_,transparent:!0,depthWrite:!1}),p=new pt,b=new Ee(1,32,32,0,Math.PI),y=new H(b,m),S=new H(b,M);y.scale.set(.85,.85,.8),S.scale.set(.85,.85,.8),y.position.y=-.2,S.position.y=-.2,y.rotation.y=Math.PI/2,S.rotation.y=Math.PI*1.5;const D=new An(1,32),C=new H(D,M);C.scale.set(.85,.85,.8),C.position.set(0,-.2,0),C.rotation.y=Math.PI/2;const A=new pt;A.add(y),A.add(S),A.add(C),p.add(A);const I=new Ee(.6,32,32,0,Math.PI),ne=new H(I,M);ne.scale.set(1,.95,.95),ne.position.set(0,1,0),ne.rotation.y=Math.PI*1.5;const x=new H(I,m);x.scale.set(1,.95,.95),x.position.set(0,1,0),x.rotation.y=Math.PI/2;const w=new An(.6,32),O=new H(w,M);O.position.set(0,.97,0),O.rotation.y=Math.PI/2;const G=new pt;G.add(ne),G.add(x),G.add(O),p.add(G);const j=new Ee(.25,32,32),ie=new H(j,M);ie.position.set(-.45,1.35,-.1),p.add(ie);const V=new H(j,m);V.position.set(.45,1.35,-.1),p.add(V);const Z=new Ee(.25,32,32,Math.PI/2,Math.PI),B=new H(Z,M);B.scale.set(1,.6,.8),B.position.set(0,.82,.5),B.rotation.y=Math.PI;const ge=new Ee(.25,32,32,Math.PI/2,Math.PI),he=new H(ge,m);he.scale.set(1,.6,.8),he.position.set(0,.82,.5),he.rotation.y=0;const _e=new An(.25,32),Se=new H(_e,M);Se.scale.set(1.25,.6,.8),Se.position.set(0,.85,.5),Se.rotation.x=Math.PI/2;const Ue=new pt;Ue.add(B),Ue.add(he),Ue.add(Se),p.add(Ue);const Q=new qt;Q.moveTo(0,0),Q.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),Q.bezierCurveTo(-.6,.3,0,.6,0,1),Q.bezierCurveTo(0,.6,.6,.3,.6,0),Q.bezierCurveTo(.6,-.3,0,-.3,0,0);const fe={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Ze({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const de=new jt(Q,fe),U=new H(de,f);U.scale.set(.5,.5,.5),U.position.set(0,0,0),U.rotation.y=Math.PI,U.rotation.x=Math.PI,p.add(U);const oe=new Ee(.35,32,32),K=new H(oe,M);K.scale.set(.75,1.25,.65),K.position.set(-.7,-.15,.2),p.add(K);const ce=new H(oe,m);ce.scale.set(.75,1.25,.65),ce.position.set(.7,-.15,.2),p.add(ce);const xe=new on(.2,.22,.6,32),ee=new H(xe,M);ee.position.set(-.4,-1.05,0),p.add(ee);const g=new H(xe,m);g.position.set(.4,-1.05,0),p.add(g);const T=new Ee(.3,32,32),L=new H(T,M);L.scale.set(1,.72,1.5),L.position.set(-.4,-1.45,.17),p.add(L);const F=new H(T,m);F.scale.set(1,.72,1.5),F.position.set(.4,-1.45,.17),p.add(F);const N=new Ee(.44,32,32),J=new H(N,M);J.position.set(-.15,-.45,-.4),p.add(J);const te=new H(N,h);te.position.set(.15,-.45,-.4),p.add(te);const E=new Ee(.18,32,32),v=new H(E,f);v.position.set(0,-.35,-.8),p.add(v),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(X){const W=new an("X",{font:X,size:.18,depth:.05}),q=new gt({color:0}),ue=new H(W,q);ue.position.set(-.3,.99,.53),ue.rotation.x=ut.degToRad(-5),ue.rotation.y=ut.degToRad(-15),p.add(ue);const le=new an("+",{font:X,size:.25,depth:.1}),ve=new gt({color:0}),we=new H(le,ve);we.position.set(.14,.99,.53),we.rotation.y=ut.degToRad(12),we.rotation.x=ut.degToRad(-5),p.add(we)}),r.add(p),i(),p.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),Ot(()=>e.bodyPosition,X=>{p.position.set(X.x,X.y,X.z)}),Ot(()=>e.cameraPosition,X=>{s.position.set(e.bodyPosition.x,1,X),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:ri(n.background?"no-bg":"three-canvas")},null,2))}}),pw=gn(dw,[["__scopeId","data-v-7fbce4ad"]]),mw=Zt({__name:"HalfBlueBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:5},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),pe&&(y.rotation.y+=.03),o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi({antialias:!0,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.toneMapping=er,o.toneMappingExposure=1.25,t.value.appendChild(o.domElement);const a=new li(16777215,.6);r.add(a);const c=new ci(16777215,1.2);c.position.set(5,5,5),r.add(c);const l=new nr(16777215,2,50);l.position.set(0,2,4),r.add(l);const u=new dt({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
          varying vec2 vUv;
          void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `}),h=new Ze({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),f=new Ze({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.35}),d=new Ze({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),_=new Ze({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!1,opacity:.99,depthWrite:!0,depthTest:!0}),M=new Ze({color:16738740,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!1,opacity:.99,depthWrite:!0,depthTest:!0});new Ze({color:16738740,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!1,opacity:.99,depthWrite:!0,depthTest:!0});const m=`
    varying vec2 vUv;
          void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,b=new dt({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:m,fragmentShader:p,transparent:!1,depthWrite:!0}),y=new pt,S=new Ee(1,32,32,0,Math.PI),D=new H(S,f),C=new H(S,h);D.scale.set(.85,.85,.8),C.scale.set(.85,.85,.8),D.position.y=-.2,C.position.y=-.2,D.rotation.y=Math.PI/2,C.rotation.y=Math.PI*1.5;const A=new An(1,32),I=new H(A,h);I.scale.set(.85,.85,.8),I.position.set(0,-.2,0),I.rotation.y=Math.PI/2;const ne=new pt;ne.add(D),ne.add(C),ne.add(I),y.add(ne);const x=new Ee(.6,32,32,0,Math.PI),w=new H(x,h);w.scale.set(1,.95,.95),w.position.set(0,1,0),w.rotation.y=Math.PI*1.5;const O=new H(x,f);O.scale.set(1,.95,.95),O.position.set(0,1,0),O.rotation.y=Math.PI/2;const G=new An(.6,32),j=new H(G,h);j.position.set(0,1,0),j.rotation.y=Math.PI/2,j.scale.set(1,.95,.95);const ie=new pt;ie.add(w),ie.add(O),ie.add(j),y.add(ie);const V=new Ee(.25,32,32),Z=new H(V,h);Z.position.set(-.45,1.35,-.1),y.add(Z);const B=new H(V,f);B.position.set(.45,1.35,-.1),y.add(B);const ge=new Ee(.25,32,32,Math.PI/2,Math.PI),he=new H(ge,h);he.scale.set(1.1,.6,.8),he.position.set(0,.84,.5),he.rotation.y=Math.PI;const _e=new Ee(.25,32,32,Math.PI/2,Math.PI),Se=new H(_e,f);Se.scale.set(1.1,.6,.8),Se.position.set(0,.84,.5),Se.rotation.y=0;const Ue=new An(.25,32),Q=new H(Ue,h);Q.scale.set(.8,.6,.8),Q.position.set(0,.84,.5),Q.rotation.y=Math.PI/2;const fe=new pt;fe.add(he),fe.add(Se),fe.add(Q),y.add(fe);const de=new qt;de.moveTo(0,0),de.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),de.bezierCurveTo(-.6,.3,0,.6,0,1),de.bezierCurveTo(0,.6,.6,.3,.6,0),de.bezierCurveTo(.6,-.3,0,-.3,0,0);const U={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Ze({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const oe=new jt(de,U);new gt({color:0});const K=new H(oe,d);K.scale.set(.1,.1,.1),K.rotation.z=ut.degToRad(210),K.rotation.x=ut.degToRad(5),K.rotation.y=ut.degToRad(-45),K.position.set(-.4,.9,.45);const ce=new H(oe,b);ce.scale.set(.5,.5,.5),ce.position.set(.3,0,0),ce.rotation.y=Math.PI,ce.rotation.x=Math.PI,y.add(ce),new H(oe,u),ce.scale.set(.35,.35,.35),ce.position.set(.3,0,0),ce.rotation.y=Math.PI,ce.rotation.x=Math.PI;const xe=new H(oe,M);xe.scale.set(.25,.25,.25),xe.position.set(.27,.2,0),xe.rotation.y=Math.PI,xe.rotation.x=Math.PI;const ee=new H(oe,_);ee.scale.set(.3,.3,.3),ee.position.set(.23,-.5,.3),ee.rotation.y=Math.PI,ee.rotation.x=Math.PI;const g=new H(oe,b);g.scale.set(.4,.4,.4),g.position.set(.27,0,.35),g.rotation.y=Math.PI,g.rotation.x=Math.PI;const T=new Ee(.35,32,32),L=new H(T,h);L.scale.set(.75,1.25,.65),L.position.set(-.7,-.15,.2),y.add(L);const F=new H(T,f);F.scale.set(.75,1.25,.65),F.position.set(.7,-.15,.2),y.add(F);const N=new on(.2,.22,.6,32),J=new H(N,h);J.position.set(-.4,-1.05,0),y.add(J);const te=new H(N,f);te.position.set(.4,-1.05,0),y.add(te);const E=new Ee(.3,32,32),v=new H(E,h);v.scale.set(1,.72,1.5),v.position.set(-.4,-1.45,.17),y.add(v);const P=new H(E,f);P.scale.set(1,.72,1.5),P.position.set(.4,-1.45,.17),y.add(P);const X=new Ee(.44,32,32),W=new H(X,h);W.position.set(-.15,-.45,-.4),y.add(W);const q=new H(X,f);q.position.set(.15,-.45,-.4),y.add(q);const ue=new Ee(.18,32,32),le=new H(ue,b);le.position.set(0,-.35,-.8),y.add(le),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Ae){const Re=new an("X",{font:Ae,size:.18,depth:.05}),Oe=new gt({color:0}),Pe=new H(Re,Oe);Pe.position.set(-.3,.99,.53),Pe.rotation.x=ut.degToRad(-5),Pe.rotation.y=ut.degToRad(-15),y.add(Pe);const We=new an("+",{font:Ae,size:.25,depth:.1}),z=new gt({color:0}),Ce=new H(We,z);Ce.position.set(.14,.99,.53),Ce.rotation.y=ut.degToRad(12),Ce.rotation.x=ut.degToRad(-5),y.add(Ce)}),le.renderOrder=1,y.scale.set(1.2,1.2,1.2),r.add(y),y.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),s.position.z=4;const we={x:0,y:0};let pe=!0,ye=null;const Ne=Ae=>{pe=!1,we.x=Ae.clientX/window.innerWidth*2-1,we.y=-(Ae.clientY/window.innerHeight)*2+1;const Re=we.x*Math.PI*.2,Oe=we.y*Math.PI*.2;y.rotation.y=Re,y.rotation.x=Oe,clearTimeout(ye),ye=setTimeout(()=>{pe=!0},1e3)};window.addEventListener("mousemove",Ne),u.uniforms.time.value+=.04,i(),Ot(()=>e.bodyPosition,Ae=>{y.position.set(Ae.x,Ae.y,Ae.z)}),Ot(()=>e.cameraPosition,Ae=>{s.position.set(e.bodyPosition.x,1,Ae),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:ri(n.background?"no-bg":"three-canvas")},null,2))}}),gw=gn(mw,[["__scopeId","data-v-d18cb54d"]]),_w=Zt({__name:"SkyBear",props:{background:{type:Boolean,default:!1},cameraPosition:{type:Number,default:4},bodyPosition:{type:Object,default:()=>({x:0,y:0,z:0})}},setup(n){const e=n,t=Et(null);return pn(()=>{if(t.value){let i=function(){requestAnimationFrame(i),O.rotation.y+=.03,C.uniforms.time.value+=.04,o.render(r,s)};const r=new ai,s=new vt(75,window.innerWidth/window.innerHeight,.1,1e3),o=new oi;o.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(o.domElement);const a=new kr(500,500),c=new dt({uniforms:{color1:{value:new Ge(8900331)},color2:{value:new Ge(16777215)}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
  ...
  `,side:Xt}),l=new H(a,c);l.position.z=-50,l.rotation.x=Math.PI/2,r.add(l);const u=new kr(500,500),h=new gt({color:2263842}),f=new H(u,h);f.rotation.x=-Math.PI/2,r.add(f);const d=new Xr(10,20,10),_=new gt({color:9127187});for(let Oe=-20;Oe<=20;Oe+=20){const Pe=new H(d,_);Pe.position.set(Oe,10,-30),r.add(Pe)}const M=new on(1,1,5),m=new gt({color:9127187}),p=new kl(3,6),b=new gt({color:25600});for(let Oe=-40;Oe<=40;Oe+=20){const Pe=new H(M,m);Pe.position.set(Oe,2.5,-20),r.add(Pe);const We=new H(p,b);We.position.set(Oe,8,-20),r.add(We)}const y=new li(16777215,.6);r.add(y);const S=new ci(16777215,1.2);S.position.set(5,5,5),r.add(S);const D=new nr(16777215,2,50);D.position.set(0,2,4),r.add(D);const C=new dt({uniforms:{time:{value:0},color1:{value:new Ge(16766720)},color2:{value:new Ge(16007990)}},vertexShader:`
            varying vec2 vUv;
            void main() {
              vUv = uv;
              gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
          ...
          `}),A=new Ze({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),I=new Ze({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.39});new Ze({color:16738740,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),new Ze({color:52945,metalness:.2,roughness:.5,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99});const ne=new Ze({color:13369344,metalness:.2,roughness:.6,clearcoat:.1,clearcoatRoughness:.8,transparent:!0,opacity:.99}),x=`
      varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `;new dt({uniforms:{time:{value:0},opacity:{value:1}},vertexShader:x,fragmentShader:w,transparent:!0,depthWrite:!1}),new dt({uniforms:{time:{value:0},opacity:{value:.4}},vertexShader:x,fragmentShader:w,transparent:!0,depthWrite:!1});const O=new pt,G=new Ee(1,32,32,0,Math.PI),j=new H(G,I),ie=new H(G,A);j.scale.set(.85,.85,.8),ie.scale.set(.85,.85,.8),j.position.y=-.2,ie.position.y=-.2,j.rotation.y=Math.PI/2,ie.rotation.y=Math.PI*1.5;const V=new An(1,32),Z=new H(V,A);Z.scale.set(.85,.85,.8),Z.position.set(0,-.2,0),Z.rotation.y=Math.PI/2;const B=new pt;B.add(j),B.add(ie),B.add(Z),O.add(B);const ge=new Ee(.6,32,32,0,Math.PI),he=new H(ge,A);he.scale.set(1,.95,.95),he.position.set(0,1,0),he.rotation.y=Math.PI*1.5;const _e=new H(ge,I);_e.scale.set(1,.95,.95),_e.position.set(0,1,0),_e.rotation.y=Math.PI/2;const Se=new An(.6,32),Ue=new H(Se,A);Ue.position.set(0,.97,0),Ue.rotation.y=Math.PI/2;const Q=new pt;Q.add(he),Q.add(_e),Q.add(Ue),O.add(Q);const fe=new Ee(.25,32,32),de=new H(fe,A);de.position.set(-.45,1.35,-.1),O.add(de);const U=new H(fe,I);U.position.set(.45,1.35,-.1),O.add(U);const oe=new Ee(.25,32,32,Math.PI/2,Math.PI),K=new H(oe,A);K.scale.set(1.1,.6,.8),K.position.set(0,.84,.5),K.rotation.y=Math.PI;const ce=new Ee(.25,32,32,Math.PI/2,Math.PI),xe=new H(ce,I);xe.scale.set(1.1,.6,.8),xe.position.set(0,.84,.5),xe.rotation.y=0;const ee=new An(.25,32),g=new H(ee,A);g.scale.set(1.25,.6,.8),g.position.set(0,.85,.5),g.rotation.x=Math.PI/2;const T=new pt;T.add(K),T.add(xe),T.add(g),O.add(T);const L=new qt;L.moveTo(0,0),L.bezierCurveTo(0,-.3,-.6,-.3,-.6,0),L.bezierCurveTo(-.6,.3,0,.6,0,1),L.bezierCurveTo(0,.6,.6,.3,.6,0),L.bezierCurveTo(.6,-.3,0,-.3,0,0);const F={depth:.4,bevelEnabled:!0,bevelSegments:2,steps:2,bevelSize:.1,bevelThickness:.1};new Ze({color:16777215,metalness:0,roughness:.1,clearcoat:1,clearcoatRoughness:.1,transparent:!0,opacity:.85,reflectivity:1,envMapIntensity:1});const N=new jt(L,F),J=new H(N,ne);J.scale.set(.25,.25,.25),J.position.set(.5,0,0),J.rotation.y=Math.PI,J.rotation.x=Math.PI,O.add(J);const te=new H(N,ne);te.scale.set(.25,.25,.25),te.position.set(0,0,0),te.rotation.y=Math.PI,te.rotation.x=Math.PI;const E=new Ee(.35,32,32),v=new H(E,A);v.scale.set(.75,1.25,.65),v.position.set(-.7,-.15,.2),O.add(v);const P=new H(E,I);P.scale.set(.75,1.25,.65),P.position.set(.7,-.15,.2),O.add(P);const X=new on(.2,.22,.6,32),W=new H(X,A);W.position.set(-.4,-1.05,0),O.add(W);const q=new H(X,I);q.position.set(.4,-1.05,0),O.add(q);const ue=new Ee(.3,32,32),le=new H(ue,A);le.scale.set(1,.72,1.5),le.position.set(-.4,-1.45,.17),O.add(le);const ve=new H(ue,I);ve.scale.set(1,.72,1.5),ve.position.set(.4,-1.45,.17),O.add(ve);const we=new Ee(.44,32,32),pe=new H(we,A);pe.position.set(-.15,-.45,-.4),O.add(pe);const ye=new H(we,I);ye.position.set(.15,-.45,-.4),O.add(ye);const Ne=new Ee(.18,32,32),Ae=new H(Ne,ne);Ae.position.set(0,-.35,-.8),O.add(Ae),new ir().load("https://threejs.org/examples/fonts/helvetiker_bold.typeface.json",function(Oe){const Pe=new an("X",{font:Oe,size:.18,depth:.05}),We=new gt({color:0}),z=new H(Pe,We);z.position.set(-.3,.99,.53),z.rotation.x=ut.degToRad(-5),z.rotation.y=ut.degToRad(-15),O.add(z);const Ce=new an("+",{font:Oe,size:.25,depth:.1}),ae=new gt({color:0}),me=new H(Ce,ae);me.position.set(.14,.99,.53),me.rotation.y=ut.degToRad(12),me.rotation.x=ut.degToRad(-5),O.add(me)}),r.add(O),i(),O.position.set(e.bodyPosition.x,e.bodyPosition.y,e.bodyPosition.z),s.position.set(e.bodyPosition.x,1,e.cameraPosition),s.lookAt(e.bodyPosition.x,0,0),Ot(()=>e.bodyPosition,Oe=>{O.position.set(Oe.x,Oe.y,Oe.z)}),Ot(()=>e.cameraPosition,Oe=>{s.position.set(e.bodyPosition.x,1,Oe),s.lookAt(e.bodyPosition.x,0,0)}),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)})}}),(i,r)=>(cn(),mn("div",{ref_key:"threeCanvas",ref:t,class:ri(n.background?"no-bg":"three-canvas")},null,2))}}),vw=gn(_w,[["__scopeId","data-v-e844f33f"]]),xw=[{path:"/3d-bear-arts",name:"ThreeScene",component:rw},{path:"/3d-bear-arts/half",name:"NewBear",component:gw},{path:"/3d-bear-arts/halfTransparent",name:"Transparent",component:pw},{path:"/3d-bear-arts/bluePink",name:"BluePinkBear",component:fw},{path:"/3d-bear-arts/diamond",name:"DiamondBear",component:cw},{path:"/3d-bear-arts/pink",name:"PinkBear",component:ep},{path:"/3d-bear-arts/purple",name:"PurpleBear",component:tp},{path:"/3d-bear-arts/blue",name:"BlueBear",component:np},{path:"/3d-bear-arts/glass",name:"GlassBear",component:uw},{path:"/3d-bear-arts/sky",name:"SkyBear",component:vw}],yw=Vg({history:xg(),routes:xw}),lp=O0(k0);lp.use(yw);lp.mount("#app");
