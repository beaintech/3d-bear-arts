...
function __VLS_template() {
    ...
    /** @type { [typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ] } */
    // @ts-ignore
    const __VLS_43 = __VLS_asFunctionalComponent(__VLS_42, new __VLS_42({ to: ("/3d-bear-arts/santa"), }));
    const __VLS_44 = __VLS_43({ to: ("/3d-bear-arts/santa"), }, ...__VLS_functionalComponentArgsRest(__VLS_43));
    ...
    /** @type { [typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, typeof __VLS_components.RouterLink, typeof __VLS_components.routerLink, ] } */
    // @ts-ignore
    const __VLS_55 = __VLS_asFunctionalComponent(__VLS_54, new __VLS_54({ to: ("/3d-bear-arts/bears"), }));
    const __VLS_56 = __VLS_55({ to: ("/3d-bear-arts/bears"), }, ...__VLS_functionalComponentArgsRest(__VLS_55));
